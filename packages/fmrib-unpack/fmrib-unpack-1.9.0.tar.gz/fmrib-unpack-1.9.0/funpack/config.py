...
CLI_ARGUMENT_HELP = {
    ...
    '--column/--remove_unknown options after processing.',

    'remove_unknown' :
    'Remove variables which are not listed in variable table. Implied if '
    'variables are specified using --variable, --column or --category.',
    ...
    'pass_through' : '*DEPRECATED* Do not perform any cleaning or processing '
                     'on the data - implies --skip_insertna, '
                     '--skip_childvalues, --skip_clean_funcs, '
                     '--skip_recoding, and --skip_processing. This option is '
                     'deprecated and will be removed in a future version of '
                     'FUNPACK. The same behaviour can be achieved by running '
                     'FUNPACK without specifying any cleaning/processing '
                     'steps.',
