    ...
    def do(self,data):
        try:
            ...
            for tfs_project in projects:
                ...
                pprint ("Scrum Project's Application Reference Created")
