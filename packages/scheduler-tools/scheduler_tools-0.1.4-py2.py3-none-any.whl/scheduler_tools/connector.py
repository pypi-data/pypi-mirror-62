...
class Connector:
    ...
    def __init__(self, dask_prefs: dict = None, prefs: PathDict = None):
        ...
        if prefs is None:
            ...
            prefs['localfolder'] = Path('~/.aics_dask').expanduser()
        ...
        if dask_prefs is None:
            dask_prefs = {'cluster_obj_name': {},'cluster_conf': {}, 'worker_conf': {}, 'remote_conf': {}}
            ...
            dask_prefs['remote_conf']['path'] = f"/home/{prefs['gateway']['user']}/.aics_dask"
