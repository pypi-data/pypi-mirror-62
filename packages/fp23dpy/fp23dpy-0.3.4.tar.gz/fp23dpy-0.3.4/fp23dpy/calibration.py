...
class Calibration(dict):
    ...
    allowed_keys = ['T', 'gamma', 'theta', 'Tlim', 'phi', 'scale', 'scale_unit', 'absolute_phase', 'principal_point']
...
if os.environ.get('DISPLAY'): ## check if visual plots can be produced, if not do not try to load matplotlib stuff
