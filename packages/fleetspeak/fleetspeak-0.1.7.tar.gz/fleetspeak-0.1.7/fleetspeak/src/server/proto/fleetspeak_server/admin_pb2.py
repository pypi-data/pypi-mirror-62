...
_CLIENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_contact_streaming_to', full_name='fleetspeak.server.Client.last_contact_streaming_to', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_clock', full_name='fleetspeak.server.Client.last_clock', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blacklisted', full_name='fleetspeak.server.Client.blacklisted', index=6,
...
_DELETEPENDINGMESSAGESREQUEST = _descriptor.Descriptor(
  name='DeletePendingMessagesRequest',
  full_name='fleetspeak.server.DeletePendingMessagesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='client_ids', full_name='fleetspeak.server.DeletePendingMessagesRequest.client_ids', index=0,
      number=1, type=12, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADMIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='DeletePendingMessages',
    full_name='fleetspeak.server.Admin.DeletePendingMessages',
    index=6,
    containing_service=None,
