...
class ListEventTypesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEventTypes.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codestar-notifications.html#CodeStarNotifications.Paginator.ListEventTypes.paginate)
        """
...
class ListNotificationRulesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListNotificationRules.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codestar-notifications.html#CodeStarNotifications.Paginator.ListNotificationRules.paginate)
        """
...
class ListTargetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTargets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codestar-notifications.html#CodeStarNotifications.Paginator.ListTargets.paginate)
        """
