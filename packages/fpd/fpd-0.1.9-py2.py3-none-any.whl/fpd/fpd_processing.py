...
def disc_edge_properties(im, sigma=2, cyx=None, r=None, n_angles=90, r_res_pix=0.25, plot=True):
    ...
    o0 = d_median
    p0 = (a0, ph0, o0)
    popt, pcov = curve_fit(f=circ_function, xdata=angles, ydata=r_vals, p0=p0)
    ...
    if plot:
        ...
        plt.title('cyx: (%0.4f, %0.4f) -> (%0.4f +/- %0.4f, %0.4f +/- %0.4f)\ncr = %0.4f -> %0.4f +/- %0.4f' %(cyx[0], cyx[1], cyx_opt[0], cyx_opt[1], cyx_opt_err[0], cyx_opt_err[1], r, r_opt, r_opt_err))
        plt.tight_layout()
