...
class Matrix(object):
    ...
    @staticmethod
    def rotateAroundCenter(center, axis, angle):
        return _VisusKernelPy.Matrix_rotateAroundCenter(center, axis, angle)
...
def Matrix_rotateAroundCenter(center, axis, angle):
    return _VisusKernelPy.Matrix_rotateAroundCenter(center, axis, angle)
...
class Position(object):
    ...
    def computeVolume(self):
        return _VisusKernelPy.Position_computeVolume(self)
