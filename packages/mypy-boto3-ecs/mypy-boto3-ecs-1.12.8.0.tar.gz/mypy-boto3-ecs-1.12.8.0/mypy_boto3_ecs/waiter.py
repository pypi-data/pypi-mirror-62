...
class ServicesInactiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ServicesInactive.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecs.html#ECS.Waiter.ServicesInactive.wait)
        """
...
class ServicesStableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ServicesStable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecs.html#ECS.Waiter.ServicesStable.wait)
        """
...
class TasksRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [TasksRunning.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecs.html#ECS.Waiter.TasksRunning.wait)
        """
...
class TasksStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [TasksStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecs.html#ECS.Waiter.TasksStopped.wait)
        """
