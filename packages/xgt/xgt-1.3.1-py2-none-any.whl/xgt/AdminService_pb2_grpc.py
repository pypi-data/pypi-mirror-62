...
class AdminServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ResetConfigSetting = channel.unary_unary(
        '/xgt.AdminService/ResetConfigSetting',
        request_serializer=AdminService__pb2.ResetConfigSettingRequest.SerializeToString,
        response_deserializer=AdminService__pb2.ResetConfigSettingResponse.FromString,
        )
...
class AdminServiceServicer(object):
  ...
  def ResetConfigSetting(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_AdminServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'ResetConfigSetting': grpc.unary_unary_rpc_method_handler(
          servicer.ResetConfigSetting,
          request_deserializer=AdminService__pb2.ResetConfigSettingRequest.FromString,
          response_serializer=AdminService__pb2.ResetConfigSettingResponse.SerializeToString,
      ),
  }
