...
if DEFAULT_BOT_NAME is not None:
    warnings.warn(  # v2.0
        'please update your environment variable to use "slack_bot_name" instead of "botname" as it is more descriptive',
        DeprecationWarning,
        stacklevel=2,
    )
else:
    DEFAULT_BOT_NAME = os.getenv('slack_bot_name')
