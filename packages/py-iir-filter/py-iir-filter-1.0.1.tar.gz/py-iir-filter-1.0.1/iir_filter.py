...
class IIR2_filter:
    ...
    def filter(self,v):
        ...
        input=input - (self.denominator1 * self.buffer1)
        output=output + (self.numerator2 * self.buffer2)
        input=input - (self.denominator2 * self.buffer2)
        output=output + input * self.numerator0
