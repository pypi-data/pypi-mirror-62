...
class Document_attributesManager(CommonManagetWithLookUpFieldsManager):
    ...
    def update_document_attributes(self, document_attribute):
        with transaction.atomic():
            ...
            document_attributes.value_str = document_attribute.get('value_str')
            if document_attribute.get('value_int') != None:
                document_attributes.value_int = document_attribute.get('value_int')
            else:
                document_attributes.value_int = StrToNumber(document_attribute.get('value_str'))
    ...
    def createFromRequest(self, request, removed=None, propsArr: List = None):
        ...
        if data.get('value_int') != None and data.get('value_str') == None:
            data.setdefault('value_str', str(data.get('value_int')))
        elif data.get('value_int') == None and data.get('value_str') != None:
            data.setdefault('value_int', StrToNumber(data.get('value_str')))
