        ...
        if isinstance(operationitem_id, list):
            ...
            with transaction.atomic():
                for operationitem in operationitem_id:
                    ...
                    delAttr(_data, 'resource__full_name')
...
class Operation_resources(AuditModel):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['operationitem'], condition=Q(location=None) & Q(resource=None), name='Operation_resources_unique_constraint_0'),
            UniqueConstraint(fields=['operationitem', 'resource'], condition=Q(location=None), name='Operation_resources_unique_constraint_1'),
            UniqueConstraint(fields=['location', 'operationitem'], condition=Q(resource=None), name='Operation_resources_unique_constraint_2'),
            UniqueConstraint(fields=['location', 'operationitem', 'resource'], name='Operation_resources_unique_constraint_3'),
        ]
