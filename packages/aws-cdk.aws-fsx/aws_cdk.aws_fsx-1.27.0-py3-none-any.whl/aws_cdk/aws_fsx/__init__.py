...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-fsx", "1.27.0", __name__, "aws-fsx@1.27.0.jsii.tgz")
...
class CfnFileSystem(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-fsx.CfnFileSystem"):
    ...
    class LustreConfigurationProperty():
        def __init__(self, *, deployment_type: typing.Optional[str]=None, export_path: typing.Optional[str]=None, imported_file_chunk_size: typing.Optional[jsii.Number]=None, import_path: typing.Optional[str]=None, per_unit_storage_throughput: typing.Optional[jsii.Number]=None, weekly_maintenance_start_time: typing.Optional[str]=None):
            """
