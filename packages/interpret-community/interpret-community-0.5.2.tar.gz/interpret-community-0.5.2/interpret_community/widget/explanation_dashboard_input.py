...
class ExplanationDashboardInput:
    ...
    def __init__(
        ...
        if dataset_explanation is not None:
            if dataset is None:
                dataset = dataset_explanation[ExplanationDashboardInterface.MLI_DATASET_X_KEY]
            if true_y is None:
                true_y = dataset_explanation[ExplanationDashboardInterface.MLI_DATASET_Y_KEY]
        ...
        if features is not None:
            ...
            self.dashboard_input[ExplanationDashboardInterface.FEATURE_NAMES] = features
