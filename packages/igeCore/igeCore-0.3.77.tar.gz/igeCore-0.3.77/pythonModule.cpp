...
namespace pyxie
{
    ...
    static PyObject* pyxie_gameToDevScale(PyObject* self)
    {
        pyxieSystemInfo& sysinfo = pyxieSystemInfo::Instance();
        float scale_w = sysinfo.GetGameW() / sysinfo.GetDeviceW();
        float scale_h = sysinfo.GetGameH() / sysinfo.GetDeviceH();
        ...
        v = PyFloat_FromDouble((double)scale_w);
        if (v == NULL) {
            Py_DECREF(retval);
            return NULL;
        }
        ...
        v = PyFloat_FromDouble((double)scale_h);
        if (v == NULL) {
            Py_DECREF(retval);
            return NULL;
        }
	...
	static PyMethodDef pyxie_methods[] = {
        ...
        { "gameToDevScale", (PyCFunction)pyxie_gameToDevScale, METH_NOARGS, gameToDevScale_doc},
