...
from azureml.train.automl.exceptions import ConfigException, FileNotFoundException, UserErrorException
    ...
    try:
        ...
        if calling_in_client_runtime:
            ...
            if not os.path.exists(script_path):
                ...
                raise ConfigException('The provided user script references files that are not in the project folder.')
    except Exception as e:
        raise UserErrorException('Exception while executing user script.')
