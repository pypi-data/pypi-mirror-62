...
function GetOciSubcommands_lb() {
    $ociSubcommands = @{
        'lb' = 'backend backend-health backend-set backend-set-health certificate health-checker hostname listener listener-rule load-balancer load-balancer-health nsg path-route-set policy protocol rule-set shape work-request'
...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb backend-set create' = 'backends from-json health-checker-interval-in-ms health-checker-port health-checker-protocol health-checker-response-body-regex health-checker-retries health-checker-return-code health-checker-timeout-in-ms health-checker-url-path help lb-cookie-session-persistence-configuration load-balancer-id max-wait-seconds name policy session-persistence-cookie-name session-persistence-disable-fallback ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
        ...
        'lb backend-set update' = 'backend-set-name backends force from-json health-checker-interval-in-ms health-checker-port health-checker-protocol health-checker-response-body-regex health-checker-retries health-checker-return-code health-checker-timeout-in-ms health-checker-url-path help lb-cookie-session-persistence-configuration load-balancer-id max-wait-seconds policy session-persistence-cookie-name session-persistence-disable-fallback ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
        ...
        'lb load-balancer create' = 'backend-sets certificates compartment-id defined-tags display-name freeform-tags from-json help hostnames ip-mode is-private listeners max-wait-seconds nsg-ids path-route-sets rule-sets shape-name subnet-ids wait-for-state wait-interval-seconds'
