...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance update' = 'agent-config defined-tags display-name extended-metadata force freeform-tags from-json help if-match instance-id max-wait-seconds metadata shape wait-for-state wait-interval-seconds'
