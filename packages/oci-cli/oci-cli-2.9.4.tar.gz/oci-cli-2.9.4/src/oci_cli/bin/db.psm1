...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape backup backup-destination data-guard-association database db-home exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-container-database create' = 'autonomous-exadata-infrastructure-id backup-config compartment-id defined-tags display-name freeform-tags from-json help maintenance-window-details max-wait-seconds patch-model service-level-agreement-type wait-for-state wait-interval-seconds'
        ...
        'db autonomous-database list' = 'all autonomous-container-database-id compartment-id db-version db-workload display-name from-json help is-free-tier lifecycle-state limit page page-size sort-by sort-order'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-free-tier license-model max-wait-seconds nsg-ids wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window backup-destination character-set db-home-id db-name db-system-id db-unique-name db-version db-workload from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source vm-cluster-id wait-for-state wait-interval-seconds'
        ...
        'db db-home create' = 'db-system-id db-version display-name from-json help max-wait-seconds source wait-for-state wait-interval-seconds'
