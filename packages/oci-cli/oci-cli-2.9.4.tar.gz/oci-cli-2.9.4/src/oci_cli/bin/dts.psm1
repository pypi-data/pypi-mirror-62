...
function GetOciSubcommands_dts() {
    $ociSubcommands = @{
        ...
        'dts export' = 'change-compartment configure-physical-appliance create create-policy delete generate-manifest list request-appliance setup-notifications show update'
