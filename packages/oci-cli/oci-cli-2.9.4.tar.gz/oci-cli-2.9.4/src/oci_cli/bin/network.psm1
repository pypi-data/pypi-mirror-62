...
function GetOciSubcommands_network() {
    $ociSubcommands = @{
        ...
        'network ip-sec-connection' = 'change-compartment create delete get get-config get-status list update'
