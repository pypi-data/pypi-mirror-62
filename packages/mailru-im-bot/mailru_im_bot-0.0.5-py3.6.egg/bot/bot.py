...
class Bot(object):
    ...
    def get_chat_blocked_users(self, chat_id):
        return self.http_session.get(
            url="{}/chats/chats/getBlockedUsers".format(self.api_base_url),
            params={
                "token": self.token,
                "chatId": chat_id
            },
    ...
    def get_chat_pending_users(self, chat_id):
        return self.http_session.get(
            url="{}/chats/chats/getPendingUsers".format(self.api_base_url),
            params={
                "token": self.token,
                "chatId": chat_id
            },
    ...
    def set_chat_about(self, chat_id, about):
        return self.http_session.get(
            url="{}/chats/set".format(self.api_base_url),
            params={
                "token": self.token,
                "chatId": chat_id,
                "about": about
