...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda-nodejs", "1.27.0", __name__, "aws-lambda-nodejs@1.27.0.jsii.tgz")
...
__all__ = ["NodejsFunction", "NodejsFunctionProps", "__jsii_assembly__"]
