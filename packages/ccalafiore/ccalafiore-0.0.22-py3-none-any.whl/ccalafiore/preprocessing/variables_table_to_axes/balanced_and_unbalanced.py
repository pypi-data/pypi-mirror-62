...
from ccalafiore.preprocessing.variables_table_to_axes.balanced_or_unbalanced import (
    from_2_arrays as v2a_from_2_arrays)
# from ccalafiore.preprocessing.variables_table_to_axes.balanced import from_2_arrays as v2a_balanced_from_2_arrays
# from ccalafiore.preprocessing.variables_table_to_axes.unbalanced import from_2_arrays as v2a_unbalanced_from_2_arrays
    ...
    if format_and_check:
        ...
        if array_variables_adding_axes_balanced is not None:
            ...
            try:
                ...
                # check point 1
                if np.sum(axes_inserting_array_not_object[0] == axes_inserting_array_not_object) > 1:
        ...
        if array_variables_adding_axes_unbalanced is not None:
            ...
            try:
                ...
                # check point 2
                if np.sum(axes_inserting_array_object[0] == axes_inserting_array_object) > 1:
        ...
        if variables_table_adding_axes_balanced is not None:
            ...
            try:
                ...
                variables_table_adding_axes_balanced[variables_table_adding_axes_balanced < 0] += (
                    n_variables_table_in_array_variables_adding_axes_balanced)
                # check point 3
                if np.sum(variables_table_adding_axes_balanced[0] == variables_table_adding_axes_balanced) > 1:
        ...
        if variables_table_adding_axes_unbalanced is not None:
            ...
            try:
                ...
                variables_table_adding_axes_unbalanced[variables_table_adding_axes_unbalanced < 0] += (
                    n_variables_table_in_array_variables_adding_axes_balanced)
                # check point 4
                if np.sum(variables_table_adding_axes_unbalanced[0] == variables_table_adding_axes_unbalanced) > 1:
