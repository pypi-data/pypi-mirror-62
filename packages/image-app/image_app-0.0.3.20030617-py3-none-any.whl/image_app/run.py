...
rect = list((341, 199, 411, 216))
image = Image.open('../example/11123.png')
image = Image.open('../example/wenzi.png')
...
print(area_py.spreading_area(img, rect, 1, 2, 1))
# print(area_py.relarge_area(img, rect, 1, 2, 1))

# area_py.muli_relarge_area(img, rect, factor_info={0: 2, 2: 1})
aa = area_py.par_relarge_area(img, rect, (1, 1), par=(rect[2] - rect[0] + 1) / (rect[3] - rect[1] + 1))
print(aa)
