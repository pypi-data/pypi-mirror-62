    ...
    def test_0060_render_email(self):
        ...
        with app.test_request_context('/'):
            ...
            self.assertEqual(
                ...
                ('Dummy subject of email'.encode('iso-8859-1'), 'iso-8859-1'))
    ...
    def test_0070_render_email_unicode(self):
        ...
        with app.test_request_context('/'):
            ...
            self.assertEqual(decode_header(email_message['Subject'])[0],
                ('Dummy sübject øf email'.encode('iso-8859-1'), 'iso-8859-1'))
            self.assertEqual(decode_header(email_message['To'])[0],
                #('receiver@m9s.biz'.encode('UTF-8'), 'iso-8859-1'))
                ('receiver@m9s.biz'.encode('iso-8859-1'), 'iso-8859-1'))
