...
class StringField(Field):
    ...
    def to_django(self):
        ...
        return django_fields.TextField(name=self._field_name, null=self.nullable, primary_key=self.is_index)
...
class DateTimeField(Field):
    ...
    def to_django(self):
        return django_fields.DateTimeField(name=self._field_name,null=self.nullable, primary_key=self.is_index)
