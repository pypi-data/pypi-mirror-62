...
class Connector:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:'str',_D:_B,_E:_B,_F:_B,_H:'list[CountryModifyConsentsInfo]',_I:'list[CountryAuthInfo]',_J:'bool',_G:'list[CountryPaymentTypes]',_K:_B,_L:_B};attribute_map={_C:_C,_D:_D,_E:_E,_F:_F,_H:'modifyConsentsInfo',_I:'authInfo',_J:'consentRevocation',_G:_G,_K:'aspspIds',_L:'requiredPsuHeaders'}
	def __init__(A,name=_A,environments=_A,countries=_A,scopes=_A,modify_consents_info=_A,auth_info=_A,consent_revocation=_A,payments=_A,aspsp_ids=_A,required_psu_headers=_A):
		'Connector - a model defined in Swagger';J=required_psu_headers;I=aspsp_ids;H=payments;G=consent_revocation;F=auth_info;E=modify_consents_info;D=scopes;C=countries;B=environments;A._name=_A;A._environments=_A;A._countries=_A;A._scopes=_A;A._modify_consents_info=_A;A._auth_info=_A;A._consent_revocation=_A;A._payments=_A;A._aspsp_ids=_A;A._required_psu_headers=_A;A.discriminator=_A
		...
		if H is not _A:A.payments=H
		if I is not _A:A.aspsp_ids=I
		if J is not _A:A.required_psu_headers=J
	@property
