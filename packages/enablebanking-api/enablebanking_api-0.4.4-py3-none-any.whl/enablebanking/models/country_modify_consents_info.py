...
class CountryModifyConsentsInfo:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_B:'str',_C:'ModifyConsentsInfo'};attribute_map={_B:_B,_C:_C}
	def __init__(A,country=_A,info=_A):'CountryModifyConsentsInfo - a model defined in Swagger';A._country=_A;A._info=_A;A.discriminator=_A;A.country=country;A.info=info
	@property
	def country(self):'Gets the country of this CountryModifyConsentsInfo.  # noqa: E501\n\n        Country ISO 3166-1 alpha-2 code  # noqa: E501\n\n        :return: The country of this CountryModifyConsentsInfo.  # noqa: E501\n        :rtype: str\n        ';return self._country
	@country.setter
	def country(self,country):
		'Sets the country of this CountryModifyConsentsInfo.\n\n        Country ISO 3166-1 alpha-2 code  # noqa: E501\n\n        :param country: The country of this CountryModifyConsentsInfo.  # noqa: E501\n        :type: str\n        ';A=country
		if A is _A:raise ValueError('Invalid value for `country`, must not be `None`')
		self._country=A
	@property
	def info(self):'Gets the info of this CountryModifyConsentsInfo.  # noqa: E501\n\n\n        :return: The info of this CountryModifyConsentsInfo.  # noqa: E501\n        :rtype: ModifyConsentsInfo\n        ';return self._info
	@info.setter
	def info(self,info):
		'Sets the info of this CountryModifyConsentsInfo.\n\n\n        :param info: The info of this CountryModifyConsentsInfo.  # noqa: E501\n        :type: ModifyConsentsInfo\n        '
		if info is _A:raise ValueError('Invalid value for `info`, must not be `None`')
		self._info=info
	def to_dict(D):
		...
		if issubclass(CountryModifyConsentsInfo,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,CountryModifyConsentsInfo):return False
