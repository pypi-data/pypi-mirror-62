...
import pprint,re
class AuthInfo:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_B:_D,_C:_D};attribute_map={_B:_B,_C:'userIdRequired'}
	def __init__(A,access=_A,user_id_required=_A):'AuthInfo - a model defined in Swagger';A._access=_A;A._user_id_required=_A;A.discriminator=_A;A.access=access;A.user_id_required=user_id_required
	@property
	def access(self):'Gets the access of this AuthInfo.  # noqa: E501\n\n        Shows if access parameter is supported in `getAuth` method  # noqa: E501\n\n        :return: The access of this AuthInfo.  # noqa: E501\n        :rtype: bool\n        ';return self._access
	@access.setter
	def access(self,access):
		'Sets the access of this AuthInfo.\n\n        Shows if access parameter is supported in `getAuth` method  # noqa: E501\n\n        :param access: The access of this AuthInfo.  # noqa: E501\n        :type: bool\n        ';A=access
		if A is _A:raise ValueError('Invalid value for `access`, must not be `None`')
		self._access=A
	@property
	def user_id_required(self):'Gets the user_id_required of this AuthInfo.  # noqa: E501\n\n        Shows if it is necessary to provide user id in `getAuth` method  # noqa: E501\n\n        :return: The user_id_required of this AuthInfo.  # noqa: E501\n        :rtype: bool\n        ';return self._user_id_required
	@user_id_required.setter
	def user_id_required(self,user_id_required):
		'Sets the user_id_required of this AuthInfo.\n\n        Shows if it is necessary to provide user id in `getAuth` method  # noqa: E501\n\n        :param user_id_required: The user_id_required of this AuthInfo.  # noqa: E501\n        :type: bool\n        ';A=user_id_required
		if A is _A:raise ValueError('Invalid value for `user_id_required`, must not be `None`')
		self._user_id_required=A
	def to_dict(D):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,AuthInfo):return False
