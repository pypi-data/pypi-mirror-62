...
_N='server_sign_cert_thumbprint'
_M='server_sign_cert_path'
...
class PekaoConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_B,_D:_B,_E:_B,_F:_B,_G:_B,_H:_B,_I:_B,_J:_B,_K:_B,_L:_B,_M:_B,_N:_B};attribute_map={_C:'clientId',_D:'clientSecret',_E:'certPath',_F:'keyPath',_G:'signKeyPath',_H:'signPubKeySerial',_I:'signFingerprint',_J:'signCertUrl',_K:'paymentAuthRedirectUri',_L:'paymentAuthState',_M:'serverSignCertPath',_N:'serverSignCertThumbprint'}
	def __init__(A,client_id=_A,client_secret=_A,cert_path=_A,key_path=_A,sign_key_path=_A,sign_pub_key_serial=_A,sign_fingerprint=_A,sign_cert_url=_A,payment_auth_redirect_uri=_A,payment_auth_state=_A,server_sign_cert_path=_A,server_sign_cert_thumbprint=_A):
		'PekaoConnectorSettings - a model defined in Swagger';E=server_sign_cert_thumbprint;D=server_sign_cert_path;C=payment_auth_state;B=payment_auth_redirect_uri;A._client_id=_A;A._client_secret=_A;A._cert_path=_A;A._key_path=_A;A._sign_key_path=_A;A._sign_pub_key_serial=_A;A._sign_fingerprint=_A;A._sign_cert_url=_A;A._payment_auth_redirect_uri=_A;A._payment_auth_state=_A;A._server_sign_cert_path=_A;A._server_sign_cert_thumbprint=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.cert_path=cert_path;A.key_path=key_path;A.sign_key_path=sign_key_path;A.sign_pub_key_serial=sign_pub_key_serial;A.sign_fingerprint=sign_fingerprint;A.sign_cert_url=sign_cert_url
		if B is not _A:A.payment_auth_redirect_uri=B
		if C is not _A:A.payment_auth_state=C
		if D is not _A:A.server_sign_cert_path=D
		if E is not _A:A.server_sign_cert_thumbprint=E
	@property
	...
	@property
	def server_sign_cert_path(self):'Gets the server_sign_cert_path of this PekaoConnectorSettings.  # noqa: E501\n\n        Path/URI for a server public pem certificate which is used for verification of a signature in a response received from a server.  # noqa: E501\n\n        :return: The server_sign_cert_path of this PekaoConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._server_sign_cert_path
	@server_sign_cert_path.setter
	def server_sign_cert_path(self,server_sign_cert_path):'Sets the server_sign_cert_path of this PekaoConnectorSettings.\n\n        Path/URI for a server public pem certificate which is used for verification of a signature in a response received from a server.  # noqa: E501\n\n        :param server_sign_cert_path: The server_sign_cert_path of this PekaoConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._server_sign_cert_path=server_sign_cert_path
	@property
	def server_sign_cert_thumbprint(self):'Gets the server_sign_cert_thumbprint of this PekaoConnectorSettings.  # noqa: E501\n\n        Thimbprint of a server signature pem certificate provided in the `serverSignCertPath` parameter  # noqa: E501\n\n        :return: The server_sign_cert_thumbprint of this PekaoConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._server_sign_cert_thumbprint
	@server_sign_cert_thumbprint.setter
	def server_sign_cert_thumbprint(self,server_sign_cert_thumbprint):'Sets the server_sign_cert_thumbprint of this PekaoConnectorSettings.\n\n        Thimbprint of a server signature pem certificate provided in the `serverSignCertPath` parameter  # noqa: E501\n\n        :param server_sign_cert_thumbprint: The server_sign_cert_thumbprint of this PekaoConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._server_sign_cert_thumbprint=server_sign_cert_thumbprint
	def to_dict(D):
