...
class PartyIdentification:
	...
	def __init__(A,name=_A,postal_address=_A,organisation_id=_A,private_id=_A):
		'PartyIdentification - a model defined in Swagger';D=private_id;C=organisation_id;B=postal_address;A._name=_A;A._postal_address=_A;A._organisation_id=_A;A._private_id=_A;A.discriminator=_A
