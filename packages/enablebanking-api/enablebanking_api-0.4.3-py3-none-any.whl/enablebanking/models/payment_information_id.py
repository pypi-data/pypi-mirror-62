...
class PaymentInformationId:
	...
	def __init__(A):'PaymentInformationId - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(PaymentInformationId,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,PaymentInformationId):return False
