...
import pprint,re
class AddressType:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    allowed enum values\n    ';BUSINESS='Business';CORRESPONDENCE='Correspondence';DELIVERYTO='DeliveryTo';MAILTO='MailTo';POBOX='POBox';POSTAL='Postal';RESIDENTIAL='Residential';STATEMENT='Statement';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={};attribute_map={}
	def __init__(A):'AddressType - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(AddressType,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,AddressType):return False
