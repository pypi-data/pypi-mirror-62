...
class RequestedExecutionDate:
	...
	def __init__(A):'RequestedExecutionDate - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(RequestedExecutionDate,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,RequestedExecutionDate):return False
