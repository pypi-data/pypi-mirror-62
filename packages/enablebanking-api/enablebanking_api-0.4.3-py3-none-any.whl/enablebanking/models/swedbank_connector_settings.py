...
class SwedbankConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_B,_D:_B,_E:_B,_F:_B};attribute_map={_C:_C,_D:'clientId',_E:'clientSecret',_F:'tppRedirectUri'}
	def __init__(A,country=_A,client_id=_A,client_secret=_A,tpp_redirect_uri=_A):
		'SwedbankConnectorSettings - a model defined in Swagger';B=tpp_redirect_uri;A._country=_A;A._client_id=_A;A._client_secret=_A;A._tpp_redirect_uri=_A;A.discriminator=_A;A.country=country;A.client_id=client_id;A.client_secret=client_secret
