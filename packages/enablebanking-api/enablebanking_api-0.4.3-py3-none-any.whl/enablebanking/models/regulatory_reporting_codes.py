...
class RegulatoryReportingCodes:
	...
	def __init__(A):'RegulatoryReportingCodes - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(RegulatoryReportingCodes,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,RegulatoryReportingCodes):return False
