...
class Auth:
	...
	def __init__(A,url=_A,code=_A):
		'Auth - a model defined in Swagger';A._url=_A;A._code=_A;A.discriminator=_A
	...
	@property
	def code(self):'Gets the code of this Auth.  # noqa: E501\n\n        Order reference code. Used for DECOUPLED authorization flow  # noqa: E501\n\n        :return: The code of this Auth.  # noqa: E501\n        :rtype: str\n        ';return self._code
	@code.setter
	def code(self,code):'Sets the code of this Auth.\n\n        Order reference code. Used for DECOUPLED authorization flow  # noqa: E501\n\n        :param code: The code of this Auth.  # noqa: E501\n        :type: str\n        ';self._code=code
	def to_dict(D):
