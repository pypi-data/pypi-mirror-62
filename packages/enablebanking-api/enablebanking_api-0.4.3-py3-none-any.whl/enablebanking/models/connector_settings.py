...
_f='AktiaConnectorSettings'
_e='SBABConnectorSettings'
_d='PekaoConnectorSettings'
_c='DanskeBankConnectorSettings'
_b='POPPankkiConnectorSettings'
_a='SPankkiConnectorSettings'
_Z='HandelsbankenConnectorSettings'
_Y='SEBConnectorSettings'
_X='LHVConnectorSettings'
_W='ResursConnectorSettings'
_V='KIRConnectorSettings'
_U='OPConnectorSettings'
_T='INGPolandConnectorSettings'
_S='ICABankenConnectorSettings'
_R='SaastopankkiConnectorSettings'
_Q='OmaSpConnectorSettings'
_P='SwedbankConnectorSettings'
_O='BNPParibasPolandConnectorSettings'
_N='NordeaConnectorSettings'
_M='PKOConnectorSettings'
_L='YaConnectorSettings'
_K='KomplettConnectorSettings'
_J='SEBSwedenConnectorSettings'
_I='AliorConnectorSettings'
...
class ConnectorSettings:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_D:'bool',_E:_C,_F:_C,_G:_C,_B:_C};attribute_map={_D:_D,_E:'consentId',_F:'accessToken',_G:'refreshToken',_B:_B};discriminator_value_class_map={_H:_H,_I:_I,_J:_J,_K:_K,_L:_L,_M:_M,_N:_N,_O:_O,_P:_P,_Q:_Q,_R:_R,_S:_S,_T:_T,_U:_U,_V:_V,_W:_W,_X:_X,_Y:_Y,_Z:_Z,_a:_a,_b:_b,_c:_c,_d:_d,_e:_e,_f:_f}
