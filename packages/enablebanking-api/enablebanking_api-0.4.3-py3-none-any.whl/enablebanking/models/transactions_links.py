...
class TransactionsLinks:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_H:_B,_I:_B,_C:_B,_D:_B,_E:_B,_F:_B,_G:_B};attribute_map={_H:'self',_I:'parent-list',_C:_C,_D:_D,_E:_E,_F:_F,_G:_G}
	def __init__(A,_self=_A,parent_list=_A,balances=_A,first=_A,last=_A,next=_A,prev=_A):
		'TransactionsLinks - a model defined in Swagger';D=first;C=balances;B=parent_list;A.__self=_A;A._parent_list=_A;A._balances=_A;A._first=_A;A._last=_A;A._next=_A;A._prev=_A;A.discriminator=_A;A._self=_self
		if B is not _A:A.parent_list=B
		if C is not _A:A.balances=C
		if D is not _A:A.first=D
		if last is not _A:A.last=last
		if next is not _A:A.next=next
		if prev is not _A:A.prev=prev
	@property
	def _self(self):'Gets the _self of this TransactionsLinks.  # noqa: E501\n\n        link to the transactions of a given account  # noqa: E501\n\n        :return: The _self of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self.__self
	@_self.setter
	def _self(self,_self):
		...
		self.__self=A
	@property
	def parent_list(self):'Gets the parent_list of this TransactionsLinks.  # noqa: E501\n\n        link to the list of all available accounts  # noqa: E501\n\n        :return: The parent_list of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._parent_list
	@parent_list.setter
	def parent_list(self,parent_list):'Sets the parent_list of this TransactionsLinks.\n\n        link to the list of all available accounts  # noqa: E501\n\n        :param parent_list: The parent_list of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._parent_list=parent_list
	@property
	def balances(self):'Gets the balances of this TransactionsLinks.  # noqa: E501\n\n        link to the balances of a given account  # noqa: E501\n\n        :return: The balances of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._balances
	@balances.setter
	def balances(self,balances):'Sets the balances of this TransactionsLinks.\n\n        link to the balances of a given account  # noqa: E501\n\n        :param balances: The balances of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._balances=balances
	@property
	def first(self):'Gets the first of this TransactionsLinks.  # noqa: E501\n\n        link to the first page of the transactions result  # noqa: E501\n\n        :return: The first of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._first
	@first.setter
	def first(self,first):'Sets the first of this TransactionsLinks.\n\n        link to the first page of the transactions result  # noqa: E501\n\n        :param first: The first of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._first=first
	@property
	def last(self):'Gets the last of this TransactionsLinks.  # noqa: E501\n\n        link to the last page of the transactions result  # noqa: E501\n\n        :return: The last of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._last
	@last.setter
	def last(self,last):'Sets the last of this TransactionsLinks.\n\n        link to the last page of the transactions result  # noqa: E501\n\n        :param last: The last of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._last=last
	@property
	def next(self):'Gets the next of this TransactionsLinks.  # noqa: E501\n\n        link to the next page of the transactions result  # noqa: E501\n\n        :return: The next of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._next
	@next.setter
	def next(self,next):'Sets the next of this TransactionsLinks.\n\n        link to the next page of the transactions result  # noqa: E501\n\n        :param next: The next of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._next=next
	@property
	def prev(self):'Gets the prev of this TransactionsLinks.  # noqa: E501\n\n        link to the previous page of the transactions result  # noqa: E501\n\n        :return: The prev of this TransactionsLinks.  # noqa: E501\n        :rtype: GenericLink\n        ';return self._prev
	@prev.setter
	def prev(self,prev):'Sets the prev of this TransactionsLinks.\n\n        link to the previous page of the transactions result  # noqa: E501\n\n        :param prev: The prev of this TransactionsLinks.  # noqa: E501\n        :type: GenericLink\n        ';self._prev=prev
	def to_dict(D):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,TransactionsLinks):return False
