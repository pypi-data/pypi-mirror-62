...
class AliorConnectorSettings(ConnectorSettings):
	...
	def __init__(A,client_id=_A,client_secret=_A,cert_path=_A,key_path=_A,sign_key_path=_A,sign_pub_key_serial=_A,sign_fingerprint=_A,sign_cert_url=_A,payment_auth_redirect_uri=_A,payment_auth_state=_A):
		'AliorConnectorSettings - a model defined in Swagger';C=payment_auth_state;B=payment_auth_redirect_uri;A._client_id=_A;A._client_secret=_A;A._cert_path=_A;A._key_path=_A;A._sign_key_path=_A;A._sign_pub_key_serial=_A;A._sign_fingerprint=_A;A._sign_cert_url=_A;A._payment_auth_redirect_uri=_A;A._payment_auth_state=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.cert_path=cert_path;A.key_path=key_path;A.sign_key_path=sign_key_path;A.sign_pub_key_serial=sign_pub_key_serial;A.sign_fingerprint=sign_fingerprint;A.sign_cert_url=sign_cert_url
		if B is not _A:A.payment_auth_redirect_uri=B
		if C is not _A:A.payment_auth_state=C
	@property
	def client_id(self):'Gets the client_id of this AliorConnectorSettings.  # noqa: E501\n\n        API client ID (obtained from Alior Developer Portal)  # noqa: E501\n\n        :return: The client_id of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_id
	@client_id.setter
	def client_id(self,client_id):
		'Sets the client_id of this AliorConnectorSettings.\n\n        API client ID (obtained from Alior Developer Portal)  # noqa: E501\n\n        :param client_id: The client_id of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_id
		if A is _A:raise ValueError('Invalid value for `client_id`, must not be `None`')
		self._client_id=A
	@property
	def client_secret(self):'Gets the client_secret of this AliorConnectorSettings.  # noqa: E501\n\n        API client secret (obtained from Alior Developer Portal)  # noqa: E501\n\n        :return: The client_secret of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_secret
	@client_secret.setter
	def client_secret(self,client_secret):
		'Sets the client_secret of this AliorConnectorSettings.\n\n        API client secret (obtained from Alior Developer Portal)  # noqa: E501\n\n        :param client_secret: The client_secret of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_secret
		if A is _A:raise ValueError('Invalid value for `client_secret`, must not be `None`')
		self._client_secret=A
	@property
	def cert_path(self):'Gets the cert_path of this AliorConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate in PEM format  # noqa: E501\n\n        :return: The cert_path of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._cert_path
	@cert_path.setter
	def cert_path(self,cert_path):
		'Sets the cert_path of this AliorConnectorSettings.\n\n        Path to QWAC certificate in PEM format  # noqa: E501\n\n        :param cert_path: The cert_path of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=cert_path
		if A is _A:raise ValueError('Invalid value for `cert_path`, must not be `None`')
		self._cert_path=A
	@property
	def key_path(self):'Gets the key_path of this AliorConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate private key in PEM format  # noqa: E501\n\n        :return: The key_path of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._key_path
	@key_path.setter
	def key_path(self,key_path):
		'Sets the key_path of this AliorConnectorSettings.\n\n        Path to QWAC certificate private key in PEM format  # noqa: E501\n\n        :param key_path: The key_path of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=key_path
		if A is _A:raise ValueError('Invalid value for `key_path`, must not be `None`')
		self._key_path=A
	@property
	def sign_key_path(self):'Gets the sign_key_path of this AliorConnectorSettings.  # noqa: E501\n\n        Path to QSeal certificate in PEM format  # noqa: E501\n\n        :return: The sign_key_path of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_key_path
	@sign_key_path.setter
	def sign_key_path(self,sign_key_path):
		'Sets the sign_key_path of this AliorConnectorSettings.\n\n        Path to QSeal certificate in PEM format  # noqa: E501\n\n        :param sign_key_path: The sign_key_path of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_key_path
		if A is _A:raise ValueError('Invalid value for `sign_key_path`, must not be `None`')
		self._sign_key_path=A
	@property
	def sign_pub_key_serial(self):'Gets the sign_pub_key_serial of this AliorConnectorSettings.  # noqa: E501\n\n        Public serial key of the QSeal certificate located in signKeyPath  # noqa: E501\n\n        :return: The sign_pub_key_serial of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_pub_key_serial
	@sign_pub_key_serial.setter
	def sign_pub_key_serial(self,sign_pub_key_serial):
		'Sets the sign_pub_key_serial of this AliorConnectorSettings.\n\n        Public serial key of the QSeal certificate located in signKeyPath  # noqa: E501\n\n        :param sign_pub_key_serial: The sign_pub_key_serial of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_pub_key_serial
		if A is _A:raise ValueError('Invalid value for `sign_pub_key_serial`, must not be `None`')
		self._sign_pub_key_serial=A
	@property
	def sign_fingerprint(self):'Gets the sign_fingerprint of this AliorConnectorSettings.  # noqa: E501\n\n        Fingerprint of the QSeal certificate (base64 encoded with padding)  # noqa: E501\n\n        :return: The sign_fingerprint of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_fingerprint
	@sign_fingerprint.setter
	def sign_fingerprint(self,sign_fingerprint):
		'Sets the sign_fingerprint of this AliorConnectorSettings.\n\n        Fingerprint of the QSeal certificate (base64 encoded with padding)  # noqa: E501\n\n        :param sign_fingerprint: The sign_fingerprint of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_fingerprint
		if A is _A:raise ValueError('Invalid value for `sign_fingerprint`, must not be `None`')
		self._sign_fingerprint=A
	@property
	def sign_cert_url(self):'Gets the sign_cert_url of this AliorConnectorSettings.  # noqa: E501\n\n        Public URL where QSeal certificate can be found  # noqa: E501\n\n        :return: The sign_cert_url of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_cert_url
	@sign_cert_url.setter
	def sign_cert_url(self,sign_cert_url):
		'Sets the sign_cert_url of this AliorConnectorSettings.\n\n        Public URL where QSeal certificate can be found  # noqa: E501\n\n        :param sign_cert_url: The sign_cert_url of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_cert_url
		if A is _A:raise ValueError('Invalid value for `sign_cert_url`, must not be `None`')
		self._sign_cert_url=A
	@property
	def payment_auth_redirect_uri(self):'Gets the payment_auth_redirect_uri of this AliorConnectorSettings.  # noqa: E501\n\n        Payment redirect URI  # noqa: E501\n\n        :return: The payment_auth_redirect_uri of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_redirect_uri
	@payment_auth_redirect_uri.setter
	def payment_auth_redirect_uri(self,payment_auth_redirect_uri):'Sets the payment_auth_redirect_uri of this AliorConnectorSettings.\n\n        Payment redirect URI  # noqa: E501\n\n        :param payment_auth_redirect_uri: The payment_auth_redirect_uri of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_redirect_uri=payment_auth_redirect_uri
	@property
	def payment_auth_state(self):'Gets the payment_auth_state of this AliorConnectorSettings.  # noqa: E501\n\n        Payment authentication state  # noqa: E501\n\n        :return: The payment_auth_state of this AliorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_state
	@payment_auth_state.setter
	def payment_auth_state(self,payment_auth_state):'Sets the payment_auth_state of this AliorConnectorSettings.\n\n        Payment authentication state  # noqa: E501\n\n        :param payment_auth_state: The payment_auth_state of this AliorConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_state=payment_auth_state
	def to_dict(D):
		...
		if issubclass(AliorConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,AliorConnectorSettings):return False
