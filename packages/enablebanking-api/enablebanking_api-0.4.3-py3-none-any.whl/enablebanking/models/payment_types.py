...
class PaymentTypes:
	...
	def __init__(A,country=_A,payment_types=_A):'PaymentTypes - a model defined in Swagger';A._country=_A;A._payment_types=_A;A.discriminator=_A;A.country=country;A.payment_types=payment_types
	@property
	def country(self):'Gets the country of this PaymentTypes.  # noqa: E501\n\n        Country ISO 3166-1 alpha-2 code  # noqa: E501\n\n        :return: The country of this PaymentTypes.  # noqa: E501\n        :rtype: str\n        ';return self._country
	@country.setter
	def country(self,country):
		'Sets the country of this PaymentTypes.\n\n        Country ISO 3166-1 alpha-2 code  # noqa: E501\n\n        :param country: The country of this PaymentTypes.  # noqa: E501\n        :type: str\n        ';A=country
		if A is _A:raise ValueError('Invalid value for `country`, must not be `None`')
		self._country=A
	@property
	def payment_types(self):'Gets the payment_types of this PaymentTypes.  # noqa: E501\n\n        List of payment types for the country  # noqa: E501\n\n        :return: The payment_types of this PaymentTypes.  # noqa: E501\n        :rtype: list[PaymentTypeInformation]\n        ';return self._payment_types
	@payment_types.setter
	def payment_types(self,payment_types):
		'Sets the payment_types of this PaymentTypes.\n\n        List of payment types for the country  # noqa: E501\n\n        :param payment_types: The payment_types of this PaymentTypes.  # noqa: E501\n        :type: list[PaymentTypeInformation]\n        ';A=payment_types
	...
	def to_dict(D):
		...
		if issubclass(PaymentTypes,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,PaymentTypes):return False
