...
class PaymentTypeInformation:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_B:'PriorityCode',_C:'ServiceLevelCode',_D:'CategoryPurposeCode',_E:'LocalInstrumentCode'};attribute_map={_B:'instructionPriority',_C:'serviceLevel',_D:'categoryPurpose',_E:'localInstrument'}
	def __init__(A,instruction_priority=_A,service_level=_A,category_purpose=_A,local_instrument=_A):
		'PaymentTypeInformation - a model defined in Swagger';E=local_instrument;D=category_purpose;C=service_level;B=instruction_priority;A._instruction_priority=_A;A._service_level=_A;A._category_purpose=_A;A._local_instrument=_A;A.discriminator=_A
		if B is not _A:A.instruction_priority=B
		if C is not _A:A.service_level=C
		if D is not _A:A.category_purpose=D
		if E is not _A:A.local_instrument=E
	@property
