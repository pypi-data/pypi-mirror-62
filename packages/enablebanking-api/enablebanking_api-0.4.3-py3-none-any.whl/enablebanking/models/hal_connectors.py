...
class HalConnectors:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_B:'list[Connector]',_C:'ConnectorsLinks'};attribute_map={_B:_B,_C:'_links'}
	def __init__(A,connectors=_A,links=_A):
		'HalConnectors - a model defined in Swagger';B=links;A._connectors=_A;A._links=_A;A.discriminator=_A;A.connectors=connectors
		if B is not _A:A.links=B
	@property
	def connectors(self):'Gets the connectors of this HalConnectors.  # noqa: E501\n\n        List of connectors  # noqa: E501\n\n        :return: The connectors of this HalConnectors.  # noqa: E501\n        :rtype: list[Connector]\n        ';return self._connectors
	@connectors.setter
	def connectors(self,connectors):
		'Sets the connectors of this HalConnectors.\n\n        List of connectors  # noqa: E501\n\n        :param connectors: The connectors of this HalConnectors.  # noqa: E501\n        :type: list[Connector]\n        ';A=connectors
		if A is _A:raise ValueError('Invalid value for `connectors`, must not be `None`')
		self._connectors=A
	@property
	def links(self):'Gets the links of this HalConnectors.  # noqa: E501\n\n\n        :return: The links of this HalConnectors.  # noqa: E501\n        :rtype: ConnectorsLinks\n        ';return self._links
	@links.setter
	def links(self,links):'Sets the links of this HalConnectors.\n\n\n        :param links: The links of this HalConnectors.  # noqa: E501\n        :type: ConnectorsLinks\n        ';self._links=links
	def to_dict(D):
		...
		if issubclass(HalConnectors,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,HalConnectors):return False
