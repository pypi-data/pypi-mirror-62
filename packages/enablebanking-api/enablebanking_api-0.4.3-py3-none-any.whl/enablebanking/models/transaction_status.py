...
class TransactionStatus:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    allowed enum values\n    ';BOOK='BOOK';CNCL='CNCL';HOLD='HOLD';OTHR='OTHR';PDNG='PDNG';RJCT='RJCT';SCHD='SCHD';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={};attribute_map={}
	def __init__(A):'TransactionStatus - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,TransactionStatus):return False
