...
class ExecutionRule:
	...
	def __init__(A):'ExecutionRule - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(ExecutionRule,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,ExecutionRule):return False
