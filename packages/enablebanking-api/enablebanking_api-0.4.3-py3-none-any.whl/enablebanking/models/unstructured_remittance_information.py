...
class UnstructuredRemittanceInformation:
	...
	def __init__(A):'UnstructuredRemittanceInformation - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(UnstructuredRemittanceInformation,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,UnstructuredRemittanceInformation):return False
