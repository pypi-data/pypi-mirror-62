...
class CategoryPurposeCode:
	...
	def __init__(A):'CategoryPurposeCode - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(CategoryPurposeCode,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,CategoryPurposeCode):return False
