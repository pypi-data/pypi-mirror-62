...
class LocalInstrumentCode:
	...
	def __init__(A):'LocalInstrumentCode - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(LocalInstrumentCode,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,LocalInstrumentCode):return False
