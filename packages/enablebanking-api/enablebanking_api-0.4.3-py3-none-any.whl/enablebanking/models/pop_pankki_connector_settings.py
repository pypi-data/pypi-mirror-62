...
class POPPankkiConnectorSettings(ConnectorSettings):
	...
	def __init__(A,client_id=_A,client_secret=_A,ocp_apim_subscription_key=_A,tpp_redirect_uri=_A):
		'POPPankkiConnectorSettings - a model defined in Swagger';B=tpp_redirect_uri;A._client_id=_A;A._client_secret=_A;A._ocp_apim_subscription_key=_A;A._tpp_redirect_uri=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.ocp_apim_subscription_key=ocp_apim_subscription_key
