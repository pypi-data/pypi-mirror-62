...
class ServiceLevelCode:
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    allowed enum values\n    ';BKTR='BKTR';G001='G001';G002='G002';G003='G003';G004='G004';NUGP='NUGP';NURG='NURG';PRPT='PRPT';SDVA='SDVA';SEPA='SEPA';SVDE='SVDE';URGP='URGP';URNS='URNS';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={};attribute_map={}
	def __init__(A):'ServiceLevelCode - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(ServiceLevelCode,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,ServiceLevelCode):return False
