...
class FundsAvailabilityInformation:
	...
	def __init__(A):'FundsAvailabilityInformation - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(FundsAvailabilityInformation,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,FundsAvailabilityInformation):return False
