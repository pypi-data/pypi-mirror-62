...
class SPankkiConnectorSettings(ConnectorSettings):
	...
	def __init__(A,client_id=_A,x_api_key=_A,cert_path=_A,key_path=_A,sign_key_path=_A,sign_pub_key_serial=_A,payment_auth_redirect_uri=_A,payment_auth_state=_A):
		'SPankkiConnectorSettings - a model defined in Swagger';C=payment_auth_state;B=payment_auth_redirect_uri;A._client_id=_A;A._x_api_key=_A;A._cert_path=_A;A._key_path=_A;A._sign_key_path=_A;A._sign_pub_key_serial=_A;A._payment_auth_redirect_uri=_A;A._payment_auth_state=_A;A.discriminator=_A;A.client_id=client_id;A.x_api_key=x_api_key;A.cert_path=cert_path;A.key_path=key_path;A.sign_key_path=sign_key_path;A.sign_pub_key_serial=sign_pub_key_serial
		if B is not _A:A.payment_auth_redirect_uri=B
		if C is not _A:A.payment_auth_state=C
	@property
	def client_id(self):'Gets the client_id of this SPankkiConnectorSettings.  # noqa: E501\n\n        API client ID (obtained at Open Banking Market)  # noqa: E501\n\n        :return: The client_id of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_id
	@client_id.setter
	def client_id(self,client_id):
		'Sets the client_id of this SPankkiConnectorSettings.\n\n        API client ID (obtained at Open Banking Market)  # noqa: E501\n\n        :param client_id: The client_id of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_id
		if A is _A:raise ValueError('Invalid value for `client_id`, must not be `None`')
		self._client_id=A
	@property
	def x_api_key(self):'Gets the x_api_key of this SPankkiConnectorSettings.  # noqa: E501\n\n        API client key (obtained at Open Banking Market)  # noqa: E501\n\n        :return: The x_api_key of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._x_api_key
	@x_api_key.setter
	def x_api_key(self,x_api_key):
		'Sets the x_api_key of this SPankkiConnectorSettings.\n\n        API client key (obtained at Open Banking Market)  # noqa: E501\n\n        :param x_api_key: The x_api_key of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=x_api_key
		if A is _A:raise ValueError('Invalid value for `x_api_key`, must not be `None`')
		self._x_api_key=A
	@property
	def cert_path(self):'Gets the cert_path of this SPankkiConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate in PEM format. Test certificate (for accessing sandbox environment) can be downloaded from Open Banking Market.   # noqa: E501\n\n        :return: The cert_path of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._cert_path
	@cert_path.setter
	def cert_path(self,cert_path):
		'Sets the cert_path of this SPankkiConnectorSettings.\n\n        Path to QWAC certificate in PEM format. Test certificate (for accessing sandbox environment) can be downloaded from Open Banking Market.   # noqa: E501\n\n        :param cert_path: The cert_path of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=cert_path
		if A is _A:raise ValueError('Invalid value for `cert_path`, must not be `None`')
		self._cert_path=A
	@property
	def key_path(self):'Gets the key_path of this SPankkiConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate private key in PEM format.   # noqa: E501\n\n        :return: The key_path of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._key_path
	@key_path.setter
	def key_path(self,key_path):
		'Sets the key_path of this SPankkiConnectorSettings.\n\n        Path to QWAC certificate private key in PEM format.   # noqa: E501\n\n        :param key_path: The key_path of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=key_path
		if A is _A:raise ValueError('Invalid value for `key_path`, must not be `None`')
		self._key_path=A
	@property
	def sign_key_path(self):'Gets the sign_key_path of this SPankkiConnectorSettings.  # noqa: E501\n\n        Path to QSeal certificate in PEM format. Test certificate (for accessing sandbox environment) can be downloaded from Open Banking Market.   # noqa: E501\n\n        :return: The sign_key_path of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_key_path
	@sign_key_path.setter
	def sign_key_path(self,sign_key_path):
		'Sets the sign_key_path of this SPankkiConnectorSettings.\n\n        Path to QSeal certificate in PEM format. Test certificate (for accessing sandbox environment) can be downloaded from Open Banking Market.   # noqa: E501\n\n        :param sign_key_path: The sign_key_path of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_key_path
		if A is _A:raise ValueError('Invalid value for `sign_key_path`, must not be `None`')
		self._sign_key_path=A
	@property
	def sign_pub_key_serial(self):'Gets the sign_pub_key_serial of this SPankkiConnectorSettings.  # noqa: E501\n\n        Public serial key of the QSeal certificate located in signKeyPath. The serial must be presented as a decimal string. The following command can be use for extracting it from QSeal certificate in PEM format:  <code>echo "obase=10; ibase=16; \\`openssl x509 -in qseal-crt.pem -serial -noout \\| awk -F "=" \'{print $2}\'\\`" \\| bc</code>   # noqa: E501\n\n        :return: The sign_pub_key_serial of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_pub_key_serial
	@sign_pub_key_serial.setter
	def sign_pub_key_serial(self,sign_pub_key_serial):
		'Sets the sign_pub_key_serial of this SPankkiConnectorSettings.\n\n        Public serial key of the QSeal certificate located in signKeyPath. The serial must be presented as a decimal string. The following command can be use for extracting it from QSeal certificate in PEM format:  <code>echo "obase=10; ibase=16; \\`openssl x509 -in qseal-crt.pem -serial -noout \\| awk -F "=" \'{print $2}\'\\`" \\| bc</code>   # noqa: E501\n\n        :param sign_pub_key_serial: The sign_pub_key_serial of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_pub_key_serial
		if A is _A:raise ValueError('Invalid value for `sign_pub_key_serial`, must not be `None`')
		self._sign_pub_key_serial=A
	@property
	def payment_auth_redirect_uri(self):'Gets the payment_auth_redirect_uri of this SPankkiConnectorSettings.  # noqa: E501\n\n        URI where clients are redirected to after payment authorization.  # noqa: E501\n\n        :return: The payment_auth_redirect_uri of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_redirect_uri
	@payment_auth_redirect_uri.setter
	def payment_auth_redirect_uri(self,payment_auth_redirect_uri):'Sets the payment_auth_redirect_uri of this SPankkiConnectorSettings.\n\n        URI where clients are redirected to after payment authorization.  # noqa: E501\n\n        :param payment_auth_redirect_uri: The payment_auth_redirect_uri of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_redirect_uri=payment_auth_redirect_uri
	@property
	def payment_auth_state(self):'Gets the payment_auth_state of this SPankkiConnectorSettings.  # noqa: E501\n\n        This value returned to paymentAuthRedirectUri after payment authorization.  # noqa: E501\n\n        :return: The payment_auth_state of this SPankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_state
	@payment_auth_state.setter
	def payment_auth_state(self,payment_auth_state):'Sets the payment_auth_state of this SPankkiConnectorSettings.\n\n        This value returned to paymentAuthRedirectUri after payment authorization.  # noqa: E501\n\n        :param payment_auth_state: The payment_auth_state of this SPankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_state=payment_auth_state
	def to_dict(D):
		...
		if issubclass(SPankkiConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,SPankkiConnectorSettings):return False
