...
class BookingInformation:
	...
	def __init__(A):'BookingInformation - a model defined in Swagger';A.discriminator=None
	def to_dict(D):
		...
		if issubclass(BookingInformation,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,BookingInformation):return False
