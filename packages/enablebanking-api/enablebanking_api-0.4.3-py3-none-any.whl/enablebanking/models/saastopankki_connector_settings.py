...
class SaastopankkiConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_B,_D:_B,_E:_B,_F:_B};attribute_map={_C:'clientId',_D:'clientSecret',_E:'ocpApimSubscriptionKey',_F:'tppRedirectUri'}
	def __init__(A,client_id=_A,client_secret=_A,ocp_apim_subscription_key=_A,tpp_redirect_uri=_A):
		'SaastopankkiConnectorSettings - a model defined in Swagger';B=tpp_redirect_uri;A._client_id=_A;A._client_secret=_A;A._ocp_apim_subscription_key=_A;A._tpp_redirect_uri=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.ocp_apim_subscription_key=ocp_apim_subscription_key
		if B is not _A:A.tpp_redirect_uri=B
	@property
	def client_id(self):'Gets the client_id of this SaastopankkiConnectorSettings.  # noqa: E501\n\n        API client ID (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :return: The client_id of this SaastopankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_id
	@client_id.setter
	def client_id(self,client_id):
		'Sets the client_id of this SaastopankkiConnectorSettings.\n\n        API client ID (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :param client_id: The client_id of this SaastopankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_id
		if A is _A:raise ValueError('Invalid value for `client_id`, must not be `None`')
		self._client_id=A
	@property
	def client_secret(self):'Gets the client_secret of this SaastopankkiConnectorSettings.  # noqa: E501\n\n        API client secret (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :return: The client_secret of this SaastopankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_secret
	@client_secret.setter
	def client_secret(self,client_secret):
		'Sets the client_secret of this SaastopankkiConnectorSettings.\n\n        API client secret (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :param client_secret: The client_secret of this SaastopankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_secret
		if A is _A:raise ValueError('Invalid value for `client_secret`, must not be `None`')
		self._client_secret=A
	@property
	def ocp_apim_subscription_key(self):'Gets the ocp_apim_subscription_key of this SaastopankkiConnectorSettings.  # noqa: E501\n\n        API subscription key (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :return: The ocp_apim_subscription_key of this SaastopankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._ocp_apim_subscription_key
	@ocp_apim_subscription_key.setter
	def ocp_apim_subscription_key(self,ocp_apim_subscription_key):
		'Sets the ocp_apim_subscription_key of this SaastopankkiConnectorSettings.\n\n        API subscription key (obtained from Samlink Developer Portal)  # noqa: E501\n\n        :param ocp_apim_subscription_key: The ocp_apim_subscription_key of this SaastopankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=ocp_apim_subscription_key
	...
	@property
	def tpp_redirect_uri(self):'Gets the tpp_redirect_uri of this SaastopankkiConnectorSettings.  # noqa: E501\n\n        URI where clients are redirected to after giving consent.  # noqa: E501\n\n        :return: The tpp_redirect_uri of this SaastopankkiConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._tpp_redirect_uri
	@tpp_redirect_uri.setter
	def tpp_redirect_uri(self,tpp_redirect_uri):'Sets the tpp_redirect_uri of this SaastopankkiConnectorSettings.\n\n        URI where clients are redirected to after giving consent.  # noqa: E501\n\n        :param tpp_redirect_uri: The tpp_redirect_uri of this SaastopankkiConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._tpp_redirect_uri=tpp_redirect_uri
	def to_dict(D):
		...
		if issubclass(SaastopankkiConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,SaastopankkiConnectorSettings):return False
