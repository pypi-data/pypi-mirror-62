...
# Tangled on Tue Feb 25 14:12:01 2020
import pylab as pl 
import pandas as pd
import numpy as np
...
# Tangled on Tue Feb 25 14:12:05 2020
import pandas as pd
import warnings
import sys
...
def estimate_reduced_form(y,z,return_v=False,return_se=False,VERBOSE=False):
  ...
  for i,Item in enumerate(y.columns):
      ...
      for constant in stdev[stdev==0].index.tolist():
          warnings.warn("No variation in %s" % constant)
...
# Tangled on Tue Feb 25 14:12:09 2020
import pandas as pd
...
# Tangled on Tue Feb 25 14:12:15 2020
...
# Tangled on Tue Feb 25 14:12:16 2020
# -*- coding: utf-8 -*-
...
# Tangled on Tue Feb 25 14:12:17 2020
import xarray as xr
import pandas as pd
