...
class DescribeBackupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeBackups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/fsx.html#FSx.Paginator.DescribeBackups.paginate)
        """
...
class DescribeFileSystemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeFileSystems.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/fsx.html#FSx.Paginator.DescribeFileSystems.paginate)
        """
...
class ListTagsForResourcePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTagsForResource.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/fsx.html#FSx.Paginator.ListTagsForResource.paginate)
        """
