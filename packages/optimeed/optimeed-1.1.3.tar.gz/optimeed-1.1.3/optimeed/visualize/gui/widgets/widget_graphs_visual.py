...
class widget_graphs_visual(QtWidgets.QWidget):
    ...
    def exportGraphs(self):
        ...
        if dlg:
            ...
            # Export txt
            self.export_txt(filename_txt)
            # Export svg
            self.export_svg(filename_svg)
            # Export png
            self.export_png(filename_svg, filename_png)
            # Export pdf
            self.export_pdf(filename_svg, filename_pdf)
            # Export tikz
    ...
    @staticmethod
    def export_pdf(filename_svg, filename_pdf):
    ...
    @staticmethod
    def export_png(filename_svg, filename_png):
    ...
    def export_tikz(self, foldername_tikz):
        ...
        def additionalTraceOptions(graphId, traceId):
            ...
            return theStr
        export_to_tikz_groupGraphs(self.theGraphs, foldername_tikz, additionalAxisOptions=additionalAxisOptions, additionalTraceOptions=additionalTraceOptions)
