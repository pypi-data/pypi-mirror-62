...
class TraceVisual(QtCore.QObject):
    ...
    def __init__(self, theColor, theData, theWGPlot, highlight_last):
        """
    ...
    def get_color(self):
        ...
        theColorToUse = self.get_data().get_color()
        if theColorToUse is None:
            theColorToUse = self.theColor
        return theColorToUse
