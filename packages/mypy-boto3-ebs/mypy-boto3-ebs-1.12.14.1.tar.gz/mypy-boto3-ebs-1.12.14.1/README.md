...
[boto3.EBS 1.12.14](https://boto3.amazonaws.com/v1/documentation/api/1.12.14/reference/services/ebs.html#EBS) service
...
```bash
python -m pip install boto3-stubs[mypy-boto3-ebs]
```
