...
from spell.cli.utils.parse_utils import ParseException, parse_conditions
...
@stop_condition_option
@click.pass_context
def run(ctx, command, args, machine_type, pip_packages, requirements_file, apt_packages, stop_condition,
        docker_image, framework, python2, python3, commit_ref, description, envvars, raw_resources, background,
        conda_file, force, verbose, idempotent, provider, tensorboard_dir, distributed, run_type="user", **kwargs):
    """
    ...
    run_req = create_run_request(ctx, command, args, machine_type, pip_packages, requirements_file, apt_packages,
                                 ...
                                 raw_resources, conda_file, force, verbose, idempotent, provider,
                                 run_type, tensorboard_dir=tensorboard_dir, distributed=distributed,
                                 stop_conditions=stop_conditions, **kwargs)
...
def create_run_request(ctx, command, args, machine_type, pip_packages, requirements_file, apt_packages,
                       ...
                       github_url, github_ref, distributed=None, tensorboard_dir=None, stop_conditions=None,
                       **kwargs):
    ...
    if git_repo is None:
        ...
        workspace_id, commit_hash, commit_message, uncommitted_hash = git_utils.push_workspace(
            ...
            force=force, include_uncommitted=ctx.obj["include_uncommitted"],
        )
