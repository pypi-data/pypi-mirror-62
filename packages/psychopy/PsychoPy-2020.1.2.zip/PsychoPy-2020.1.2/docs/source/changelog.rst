...
:noncompat:`CHANGES, which are identified in this red text, typically indicate things that alter the PsychoPy behaviour in a way that could break compatibility. Be especially wary of those!`
...
- hardware.keyboard.Keyboard class,
  based on C code from the Psychtoolbox project (ported to Python by Mario Kleiner):
