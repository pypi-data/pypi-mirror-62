"""
   ...
   48、wander： 在屏幕内漫游，它是gotorandom的慢版。
   ...
   它有4个别名,mouse_position、mouseposition、mousepos、getmousepos、getmouseposition。
...
def _Rootinit(self,layout=1):
    ...
    if layout == 1 :             # 如果是布局1,直接把self.displayframe等于self
      self.displayframe = self
        ...
        self.rightframe.pack(side=TK.RIGHT,expand=1,fill='both') # 新的组件可放在这框架中       
        ...
        self.bottomframe.pack(side=TK.BOTTOM,expand=1,fill='both') # 新的组件可放在这框架中       
...
def TurtleScreen__init__(self, cv, mode=_CFG["mode"],
    ...
    self._shapes = {
                ...
                "line":  Shape("polygon",((-50,0),(0,0),(50,0))),
...
def txt2image(txt,filename,fontfile="msyh.ttf",fontsize=18,color=(25,0,255,255)):
    """
