...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ecr-assets", "1.27.0", __name__, "aws-ecr-assets@1.27.0.jsii.tgz")
...
class DockerImageAssetProps(DockerImageAssetOptions):
    def __init__(self, *, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[aws_cdk.assets.FollowMode]=None, extra_hash: typing.Optional[str]=None, build_args: typing.Optional[typing.Mapping[str,str]]=None, file: typing.Optional[str]=None, repository_name: typing.Optional[str]=None, target: typing.Optional[str]=None, directory: str):
...
__all__ = ["DockerImageAsset", "DockerImageAssetOptions", "DockerImageAssetProps", "__jsii_assembly__"]
