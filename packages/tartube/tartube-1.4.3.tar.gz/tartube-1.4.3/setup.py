...
# Add everything in ../icons
params = []
for path in glob.glob('icons/dialogue/*'):
    params.append(('/usr/share/tartube/icons/dialogue/', [path]))
for path in glob.glob('icons/large/*'):
    params.append(('/usr/share/tartube/icons/large/', [path]))
for path in glob.glob('icons/locale/*'):
    params.append(('/usr/share/tartube/icons/locale/', [path]))
for path in glob.glob('icons/small/*'):
    params.append(('/usr/share/tartube/icons/small/', [path]))
for path in glob.glob('icons/status/*'):
    params.append(('/usr/share/tartube/icons/status/', [path]))
for path in glob.glob('icons/toolbar/*'):
    params.append(('/usr/share/tartube/icons/toolbar/', [path]))
for path in glob.glob('icons/win/*'):
    params.append(('/usr/share/tartube/icons/win/', [path]))

# Add the man page
params.append(("share/man/man1", ['share/man/tartube.1']))
