...
config_class = ''
root_file = 'stream_zipper'

pypi_url = ['https://pypi.org/project/stream-zipper/']
...
package_settings = dict(
    ...
    description="Package which allows you to take several file streams and turn them into a single zipfile stream",
    long_description=long_description,
    long_description_content_type="text/markdown",
    license="BSD-3-Clause",
    url="https://github.com/MauriceBenink/python_stream_zipper",
    classifiers=[
    ...
    python_requires='>=3.6',
    install_requires=['io', 'itertools', 'zipfile'],
)
