...
class WebsiteApp(Flask):
    ...
    def __init__(self, config: dict, fbase='webapp'):
        ...
        self.load_controllers(conf.get('controllers_dir'), fbase, index=config.get('routing.__index__'))
    ...
    def load_controllers(self, path=None, index=None, class_name="Controller", fbase=None):
