...
one is to verify that the `psychopy.sound` wrapping isn't
using some extra tuning trick that we have missed in our own
`PsychToolboxInterface` wrapping. (Judging by the performance
I've seen so far, it isn't.)
"""
