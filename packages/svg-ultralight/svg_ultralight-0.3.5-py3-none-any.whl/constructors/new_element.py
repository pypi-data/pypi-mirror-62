...
def _set_params(elem: etree.Element, **params: Union[str, float]) -> None:
    ...
    :param params: element attribute names and values ``{'name': 'value'}``. Knows
        what to do with 'text' keyword.V :effects: updates ``elem``
...
def new_element(tag: str, **params: Union[str, float]) -> etree.Element:
    ...
    :param params: element attribute names and values ``{'name': 'value'}``
