...
[boto3.EC2 1.12.14](https://boto3.amazonaws.com/v1/documentation/api/1.12.14/reference/services/ec2.html#EC2) service
...
```bash
python -m pip install boto3-stubs[mypy-boto3-ec2]
```
