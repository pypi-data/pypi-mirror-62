...
class _CNTKModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        miniBatcher (object): Minibatcher to use (default: FixedMiniBatchTransformer_a9eff937c5ed)
    ...
    def __init__(self, batchInput=True, convertOutputToDenseVector=True, feedDict={"ARGUMENT_0":"ARGUMENT_0"}, fetchDict={"OUTPUT_0":"OUTPUT_0"}, miniBatcher=None, model=None, shapeOutput=False):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cntk.CNTKModel")
        self._cache = {}
        ...
        self.miniBatcher = Param(self, "miniBatcher", "miniBatcher: Minibatcher to use (default: FixedMiniBatchTransformer_a9eff937c5ed)", generateTypeConverter("miniBatcher", self._cache, complexTypeConverter))
    ...
    def getMiniBatcher(self):
        ...
        Returns:
            ...
            object: Minibatcher to use (default: FixedMiniBatchTransformer_a9eff937c5ed)
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.cntk.CNTKModel"
