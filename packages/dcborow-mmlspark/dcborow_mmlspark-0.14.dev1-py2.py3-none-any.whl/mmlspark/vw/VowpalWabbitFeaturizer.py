...
class VowpalWabbitFeaturizer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        inputCols (list): The names of the input columns (default: [Ljava.lang.String;@6ec221c0)
        ...
        stringSplitInputCols (list): Input cols that should be split at word boundaries (default: [Ljava.lang.String;@50213d38)
    ...
    def __init__(self, inputCols=[], numBits=30, outputCol="features", prefixStringsWithColumnName=True, preserveOrderNumBits=0, seed=0, stringSplitInputCols=[], sumCollisions=True):
        ...
        self.inputCols = Param(self, "inputCols", "inputCols: The names of the input columns (default: [Ljava.lang.String;@6ec221c0)")
        ...
        self.stringSplitInputCols = Param(self, "stringSplitInputCols", "stringSplitInputCols: Input cols that should be split at word boundaries (default: [Ljava.lang.String;@50213d38)")
    ...
    def getInputCols(self):
        ...
        Returns:
            ...
            list: The names of the input columns (default: [Ljava.lang.String;@6ec221c0)
        """
    ...
    def getStringSplitInputCols(self):
        ...
        Returns:
            ...
            list: Input cols that should be split at word boundaries (default: [Ljava.lang.String;@50213d38)
        """
