...
class RecognizeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        backoffs (list): array of backoffs to use in the handler (default: [I@5195b874)
    ...
    @keyword_only
    def __init__(self, backoffs=[100,500,1000], concurrency=1, concurrentTimeout=100.0, errorCol=None, imageBytes=None, imageUrl=None, maxPollingRetries=1000, mode=None, outputCol=None, pollingDelay=300, subscriptionKey=None, timeout=60.0, url=None):
        super(RecognizeText, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cognitive.RecognizeText")
        self.backoffs = Param(self, "backoffs", "backoffs: array of backoffs to use in the handler (default: [I@5195b874)")
        ...
        self.pollingDelay = Param(self, "pollingDelay", "pollingDelay: number of milliseconds to wait between polling (default: 300)")
    ...
    @keyword_only
    def setParams(self, backoffs=[100,500,1000], concurrency=1, concurrentTimeout=100.0, errorCol=None, imageBytes=None, imageUrl=None, maxPollingRetries=1000, mode=None, outputCol=None, pollingDelay=300, subscriptionKey=None, timeout=60.0, url=None):
        """
    ...
    def getBackoffs(self):
        ...
        Returns:
            ...
            list: array of backoffs to use in the handler (default: [I@5195b874)
        """
    ...
    def getPollingDelay(self):
        ...
        Returns:
            ...
            int: number of milliseconds to wait between polling (default: 300)
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.cognitive.RecognizeText"
