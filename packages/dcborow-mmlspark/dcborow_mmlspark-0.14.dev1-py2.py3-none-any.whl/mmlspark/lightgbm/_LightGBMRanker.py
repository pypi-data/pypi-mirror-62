...
@inherit_doc
class _LightGBMRanker(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    """
    ...
    Args:
        ...
        categoricalSlotIndexes (list): List of categorical column indexes, the slot index in the features column (default: [I@3ff9e219)
        categoricalSlotNames (list): List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@26011635)
        ...
        evalAt (list): NDCG and MAP evaluation positions, separated by comma (default: [I@7f010a67)
        ...
        labelGain (list): graded relevance for each label in NDCG (default: [D@1e1c3e5d)
        ...
        maxBinByFeature (list): Max number of bins for each feature (default: [I@55a56891)
        maxDeltaStep (double): Used to limit the max output of tree leaves (default: 0.0)
        maxDepth (int): Max depth (default: -1)
        maxPosition (int): optimized NDCG at this position (default: 20)
        ...
        objective (str): The Objective. For regression applications, this can be: regression_l2, regression_l1, huber, fair, poisson, quantile, mape, gamma or tweedie. For classification applications, this can be: binary, multiclass, or multiclassova.  (default: lambdarank)
        ...
        slotNames (list): List of slot names in the features column (default: [Ljava.lang.String;@6061c8a2)
    ...
    @keyword_only
    def __init__(self, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, binSampleCount=200000, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=[], categoricalSlotNames=[], defaultListenPort=12400, earlyStoppingRound=0, evalAt=[1,2,3,4,5], featureFraction=1.0, featuresCol="features", groupCol=None, improvementTolerance=0.0, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", labelGain=[], lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxBinByFeature=[], maxDeltaStep=0.0, maxDepth=-1, maxPosition=20, metric="", minDataInLeaf=20, minGainToSplit=0.0, minSumHessianInLeaf=0.001, modelString="", negBaggingFraction=1.0, numBatches=0, numIterations=100, numLeaves=31, objective="lambdarank", parallelism="data_parallel", posBaggingFraction=1.0, predictionCol="prediction", repartitionByGroupingColumn=True, slotNames=[], timeout=1200.0, topK=20, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        super(_LightGBMRanker, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.lightgbm.LightGBMRanker")
        ...
        self.binSampleCount = Param(self, "binSampleCount", "binSampleCount: Number of samples considered at computing histogram bins (default: 200000)")
        ...
        self.categoricalSlotIndexes = Param(self, "categoricalSlotIndexes", "categoricalSlotIndexes: List of categorical column indexes, the slot index in the features column (default: [I@3ff9e219)")
        self._setDefault(categoricalSlotIndexes=[])
        self.categoricalSlotNames = Param(self, "categoricalSlotNames", "categoricalSlotNames: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@26011635)")
        ...
        self.evalAt = Param(self, "evalAt", "evalAt: NDCG and MAP evaluation positions, separated by comma (default: [I@7f010a67)")
        ...
        self.groupCol = Param(self, "groupCol", "groupCol: The name of the group column")
        self.improvementTolerance = Param(self, "improvementTolerance", "improvementTolerance: Tolerance to consider improvement in metric (default: 0.0)")
        ...
        self.labelGain = Param(self, "labelGain", "labelGain: graded relevance for each label in NDCG (default: [D@1e1c3e5d)")
        ...
        self.maxBinByFeature = Param(self, "maxBinByFeature", "maxBinByFeature: Max number of bins for each feature (default: [I@55a56891)")
        self._setDefault(maxBinByFeature=[])
        self.maxDeltaStep = Param(self, "maxDeltaStep", "maxDeltaStep: Used to limit the max output of tree leaves (default: 0.0)")
        ...
        self.maxPosition = Param(self, "maxPosition", "maxPosition: optimized NDCG at this position (default: 20)")
        self._setDefault(maxPosition=20)
        self.metric = Param(self, "metric", "metric: Metrics to be evaluated on the evaluation data.  Options are: empty string or not specified means that metric corresponding to specified objective will be used (this is possible only for pre-defined objective functions, otherwise no evaluation metric will be added). None (string, not a None value) means that no metric will be registered, aliases: na, null, custom. l1, absolute loss, aliases: mean_absolute_error, mae, regression_l1. l2, square loss, aliases: mean_squared_error, mse, regression_l2, regression. rmse, root square loss, aliases: root_mean_squared_error, l2_root. quantile, Quantile regression. mape, MAPE loss, aliases: mean_absolute_percentage_error. huber, Huber loss. fair, Fair loss. poisson, negative log-likelihood for Poisson regression. gamma, negative log-likelihood for Gamma regression. gamma_deviance, residual deviance for Gamma regression. tweedie, negative log-likelihood for Tweedie regression. ndcg, NDCG, aliases: lambdarank. map, MAP, aliases: mean_average_precision. auc, AUC. binary_logloss, log loss, aliases: binary. binary_error, for one sample: 0 for correct classification, 1 for error classification. multi_logloss, log loss for multi-class classification, aliases: multiclass, softmax, multiclassova, multiclass_ova, ova, ovr. multi_error, error rate for multi-class classification. cross_entropy, cross-entropy (with optional linear weights), aliases: xentropy. cross_entropy_lambda, intensity-weighted cross-entropy, aliases: xentlambda. kullback_leibler, Kullback-Leibler divergence, aliases: kldiv.  (default: )")
        self._setDefault(metric="")
        self.minDataInLeaf = Param(self, "minDataInLeaf", "minDataInLeaf: Minimal number of data in one leaf. Can be used to deal with over-fitting. (default: 20)")
        self._setDefault(minDataInLeaf=20)
        self.minGainToSplit = Param(self, "minGainToSplit", "minGainToSplit: The minimal gain to perform split (default: 0.0)")
        ...
        self.negBaggingFraction = Param(self, "negBaggingFraction", "negBaggingFraction: Negative Bagging fraction (default: 1.0)")
        ...
        self.objective = Param(self, "objective", "objective: The Objective. For regression applications, this can be: regression_l2, regression_l1, huber, fair, poisson, quantile, mape, gamma or tweedie. For classification applications, this can be: binary, multiclass, or multiclassova.  (default: lambdarank)")
        ...
        self.posBaggingFraction = Param(self, "posBaggingFraction", "posBaggingFraction: Positive Bagging fraction (default: 1.0)")
        ...
        self.repartitionByGroupingColumn = Param(self, "repartitionByGroupingColumn", "repartitionByGroupingColumn: Repartition training data according to grouping column, on by default. (default: true)")
        self._setDefault(repartitionByGroupingColumn=True)
        self.slotNames = Param(self, "slotNames", "slotNames: List of slot names in the features column (default: [Ljava.lang.String;@6061c8a2)")
        ...
        self.topK = Param(self, "topK", "topK: The top_k value used in Voting parallel, set this to larger value for more accurate result, but it will slow down the training speed. It should be greater than 0 (default: 20)")
    ...
    @keyword_only
    def setParams(self, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, binSampleCount=200000, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=[], categoricalSlotNames=[], defaultListenPort=12400, earlyStoppingRound=0, evalAt=[1,2,3,4,5], featureFraction=1.0, featuresCol="features", groupCol=None, improvementTolerance=0.0, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", labelGain=[], lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxBinByFeature=[], maxDeltaStep=0.0, maxDepth=-1, maxPosition=20, metric="", minDataInLeaf=20, minGainToSplit=0.0, minSumHessianInLeaf=0.001, modelString="", negBaggingFraction=1.0, numBatches=0, numIterations=100, numLeaves=31, objective="lambdarank", parallelism="data_parallel", posBaggingFraction=1.0, predictionCol="prediction", repartitionByGroupingColumn=True, slotNames=[], timeout=1200.0, topK=20, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        """
    ...
    def getBinSampleCount(self):
        ...
        Returns:
            ...
            int: Number of samples considered at computing histogram bins (default: 200000)
        """
    ...
    def getCategoricalSlotIndexes(self):
        ...
        Returns:
            ...
            list: List of categorical column indexes, the slot index in the features column (default: [I@3ff9e219)
        """
    ...
    def getCategoricalSlotNames(self):
        ...
        Returns:
            ...
            list: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@26011635)
        """
    ...
    def getEvalAt(self):
        ...
        Returns:
            ...
            list: NDCG and MAP evaluation positions, separated by comma (default: [I@7f010a67)
        """
    ...
    def getGroupCol(self):
        ...
        Returns:
            ...
            str: The name of the group column
        """
    ...
    def getImprovementTolerance(self):
        ...
        Returns:
            ...
            double: Tolerance to consider improvement in metric (default: 0.0)
        """
    ...
    def getLabelGain(self):
        ...
        Returns:
            ...
            list: graded relevance for each label in NDCG (default: [D@1e1c3e5d)
        """
    ...
    def getMaxBinByFeature(self):
        ...
        Returns:
            ...
            list: Max number of bins for each feature (default: [I@55a56891)
        """
    ...
    def getMaxDeltaStep(self):
        ...
        Returns:
            ...
            double: Used to limit the max output of tree leaves (default: 0.0)
        """
    ...
    def getMaxPosition(self):
        ...
        Returns:
            ...
            int: optimized NDCG at this position (default: 20)
        """
    ...
    def getMinDataInLeaf(self):
        ...
        Returns:
            ...
            int: Minimal number of data in one leaf. Can be used to deal with over-fitting. (default: 20)
        """
    ...
    def getMinGainToSplit(self):
        ...
        Returns:
            ...
            double: The minimal gain to perform split (default: 0.0)
        """
    ...
    def getNegBaggingFraction(self):
        ...
        Returns:
            ...
            double: Negative Bagging fraction (default: 1.0)
        """
    ...
    def getObjective(self):
        ...
        Returns:
            ...
            str: The Objective. For regression applications, this can be: regression_l2, regression_l1, huber, fair, poisson, quantile, mape, gamma or tweedie. For classification applications, this can be: binary, multiclass, or multiclassova.  (default: lambdarank)
        """
    ...
    def getPosBaggingFraction(self):
        ...
        Returns:
            ...
            double: Positive Bagging fraction (default: 1.0)
        """
    ...
    def getRepartitionByGroupingColumn(self):
        ...
        Returns:
            ...
            bool: Repartition training data according to grouping column, on by default. (default: true)
        """
    ...
    def getSlotNames(self):
        ...
        Returns:
            ...
            list: List of slot names in the features column (default: [Ljava.lang.String;@6061c8a2)
        """
    ...
    def getTopK(self):
        ...
        Returns:
            ...
            int: The top_k value used in Voting parallel, set this to larger value for more accurate result, but it will slow down the training speed. It should be greater than 0 (default: 20)
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.lightgbm.LightGBMRanker"

    @staticmethod
    def _from_java(java_stage):
        module_name=_LightGBMRanker.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".LightGBMRanker"
        return from_java(java_stage, module_name)

    def _create_model(self, java_model):
        return _LightGBMRankerModel(java_model)


class _LightGBMRankerModel(ComplexParamsMixin, JavaModel, JavaMLWritable, JavaMLReadable):
    """
    Model fitted by :class:`_LightGBMRanker`.
    ...
    def getJavaPackage():
        """ Returns package name String. """
        return "com.microsoft.ml.spark.lightgbm.LightGBMRankerModel"
