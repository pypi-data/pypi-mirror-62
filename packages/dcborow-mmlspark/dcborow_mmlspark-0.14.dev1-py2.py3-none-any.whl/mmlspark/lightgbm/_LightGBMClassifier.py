...
class _LightGBMClassifier(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        categoricalSlotIndexes (list): List of categorical column indexes, the slot index in the features column (default: [I@66023a14)
        categoricalSlotNames (list): List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@664d6822)
        ...
        maxBinByFeature (list): Max number of bins for each feature (default: [I@56bfbfb5)
        ...
        slotNames (list): List of slot names in the features column (default: [Ljava.lang.String;@5bbed138)
    ...
    def __init__(self, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, binSampleCount=200000, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=[], categoricalSlotNames=[], defaultListenPort=12400, earlyStoppingRound=0, featureFraction=1.0, featuresCol="features", improvementTolerance=0.0, initScoreCol=None, isProvideTrainingMetric=False, isUnbalance=False, labelCol="label", lambdaL1=0.0, lambdaL2=0.0, leafPredictionCol="", learningRate=0.1, maxBin=255, maxBinByFeature=[], maxDeltaStep=0.0, maxDepth=-1, metric="", minDataInLeaf=20, minGainToSplit=0.0, minSumHessianInLeaf=0.001, modelString="", negBaggingFraction=1.0, numBatches=0, numIterations=100, numLeaves=31, objective="binary", parallelism="data_parallel", posBaggingFraction=1.0, predictionCol="prediction", probabilityCol="probability", rawPredictionCol="rawPrediction", repartitionByGroupingColumn=True, slotNames=[], thresholds=None, timeout=1200.0, topK=20, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        ...
        self.categoricalSlotIndexes = Param(self, "categoricalSlotIndexes", "categoricalSlotIndexes: List of categorical column indexes, the slot index in the features column (default: [I@66023a14)")
        self._setDefault(categoricalSlotIndexes=[])
        self.categoricalSlotNames = Param(self, "categoricalSlotNames", "categoricalSlotNames: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@664d6822)")
        ...
        self.leafPredictionCol = Param(self, "leafPredictionCol", "leafPredictionCol: Predicted leaf indices's column name (default: )")
        ...
        self.maxBinByFeature = Param(self, "maxBinByFeature", "maxBinByFeature: Max number of bins for each feature (default: [I@56bfbfb5)")
        ...
        self.objective = Param(self, "objective", "objective: The Objective. For regression applications, this can be: regression_l2, regression_l1, huber, fair, poisson, quantile, mape, gamma or tweedie. For classification applications, this can be: binary, multiclass, or multiclassova.  (default: binary)")
        ...
        self.slotNames = Param(self, "slotNames", "slotNames: List of slot names in the features column (default: [Ljava.lang.String;@5bbed138)")
    ...
    def getCategoricalSlotIndexes(self):
        ...
        Returns:
            ...
            list: List of categorical column indexes, the slot index in the features column (default: [I@66023a14)
        """
    ...
    def getCategoricalSlotNames(self):
        ...
        Returns:
            ...
            list: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@664d6822)
        """
    ...
    def getLeafPredictionCol(self):
        ...
        Returns:
            ...
            str: Predicted leaf indices's column name (default: )
        """
    ...
    def getMaxBinByFeature(self):
        ...
        Returns:
            ...
            list: Max number of bins for each feature (default: [I@56bfbfb5)
        """
    ...
    def getObjective(self):
        ...
        Returns:
            ...
            str: The Objective. For regression applications, this can be: regression_l2, regression_l1, huber, fair, poisson, quantile, mape, gamma or tweedie. For classification applications, this can be: binary, multiclass, or multiclassova.  (default: binary)
        """
    ...
    def getSlotNames(self):
        ...
        Returns:
            ...
            list: List of slot names in the features column (default: [Ljava.lang.String;@5bbed138)
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.lightgbm.LightGBMClassifier"
...
class _LightGBMClassificationModel(ComplexParamsMixin, JavaModel, JavaMLWritable, JavaMLReadable):
    ...
    def getJavaPackage():
        """ Returns package name String. """
        return "com.microsoft.ml.spark.lightgbm.LightGBMClassificationModel"
