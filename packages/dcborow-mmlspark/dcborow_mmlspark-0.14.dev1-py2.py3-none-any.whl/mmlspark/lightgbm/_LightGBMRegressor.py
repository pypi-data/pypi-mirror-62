...
class _LightGBMRegressor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        categoricalSlotIndexes (list): List of categorical column indexes, the slot index in the features column (default: [I@6b13f3f0)
        categoricalSlotNames (list): List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@58224e68)
        ...
        maxBinByFeature (list): Max number of bins for each feature (default: [I@731beee5)
        ...
        slotNames (list): List of slot names in the features column (default: [Ljava.lang.String;@43c2e05b)
    ...
    @keyword_only
    def __init__(self, alpha=0.9, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, binSampleCount=200000, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=[], categoricalSlotNames=[], defaultListenPort=12400, earlyStoppingRound=0, featureFraction=1.0, featuresCol="features", improvementTolerance=0.0, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxBinByFeature=[], maxDeltaStep=0.0, maxDepth=-1, metric="", minDataInLeaf=20, minGainToSplit=0.0, minSumHessianInLeaf=0.001, modelString="", negBaggingFraction=1.0, numBatches=0, numIterations=100, numLeaves=31, objective="regression", parallelism="data_parallel", posBaggingFraction=1.0, predictionCol="prediction", repartitionByGroupingColumn=True, slotNames=[], timeout=1200.0, topK=20, tweedieVariancePower=1.5, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        ...
        self.categoricalSlotIndexes = Param(self, "categoricalSlotIndexes", "categoricalSlotIndexes: List of categorical column indexes, the slot index in the features column (default: [I@6b13f3f0)")
        self._setDefault(categoricalSlotIndexes=[])
        self.categoricalSlotNames = Param(self, "categoricalSlotNames", "categoricalSlotNames: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@58224e68)")
        ...
        self.maxBinByFeature = Param(self, "maxBinByFeature", "maxBinByFeature: Max number of bins for each feature (default: [I@731beee5)")
        ...
        self.slotNames = Param(self, "slotNames", "slotNames: List of slot names in the features column (default: [Ljava.lang.String;@43c2e05b)")
    ...
    @keyword_only
    def setParams(self, alpha=0.9, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, binSampleCount=200000, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=[], categoricalSlotNames=[], defaultListenPort=12400, earlyStoppingRound=0, featureFraction=1.0, featuresCol="features", improvementTolerance=0.0, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxBinByFeature=[], maxDeltaStep=0.0, maxDepth=-1, metric="", minDataInLeaf=20, minGainToSplit=0.0, minSumHessianInLeaf=0.001, modelString="", negBaggingFraction=1.0, numBatches=0, numIterations=100, numLeaves=31, objective="regression", parallelism="data_parallel", posBaggingFraction=1.0, predictionCol="prediction", repartitionByGroupingColumn=True, slotNames=[], timeout=1200.0, topK=20, tweedieVariancePower=1.5, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        """
    ...
    def getCategoricalSlotIndexes(self):
        ...
        Returns:
            ...
            list: List of categorical column indexes, the slot index in the features column (default: [I@6b13f3f0)
        """
    ...
    def getCategoricalSlotNames(self):
        ...
        Returns:
            ...
            list: List of categorical column slot names, the slot name in the features column (default: [Ljava.lang.String;@58224e68)
        """
    ...
    def getMaxBinByFeature(self):
        ...
        Returns:
            ...
            list: Max number of bins for each feature (default: [I@731beee5)
        """
    ...
    def getSlotNames(self):
        ...
        Returns:
            ...
            list: List of slot names in the features column (default: [Ljava.lang.String;@43c2e05b)
        """
