...
class _SimpleHTTPTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        inputParser (object): format to parse the column to (default: JSONInputParser_c39a90f8f9c9)
    ...
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, flattenOutputBatches=None, handler=None, inputCol=None, inputParser=None, miniBatcher=None, outputCol=None, outputParser=None, timeout=60.0):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.io.http.SimpleHTTPTransformer")
        self._cache = {}
        ...
        self.inputParser = Param(self, "inputParser", "inputParser: format to parse the column to (default: JSONInputParser_c39a90f8f9c9)", generateTypeConverter("inputParser", self._cache, complexTypeConverter))
    ...
    def getInputParser(self):
        ...
        Returns:
            ...
            object: format to parse the column to (default: JSONInputParser_c39a90f8f9c9)
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.io.http.SimpleHTTPTransformer"
