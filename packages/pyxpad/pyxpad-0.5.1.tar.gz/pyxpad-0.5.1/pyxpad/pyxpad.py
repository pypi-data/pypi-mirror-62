...
class PyXPad(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None, loadfile=None, ignoreconfig=False):
        ...
        self.actionPlot.setToolTip(self.handlePlot.__doc__.strip())
        self.actionOPlot.triggered.connect(self.handleOPlot)
        self.actionOPlot.setToolTip(self.handleOPlot.__doc__.strip())
        self.actionMPlot.triggered.connect(self.handleMPlot)
        self.actionMPlot.setToolTip(self.handleMPlot.__doc__.strip())
        self.actionXYPlot.triggered.connect(self.handleXYPlot)
        self.actionXYPlot.setToolTip(self.handleXYPlot.__doc__.strip())
        self.actionZPlot.triggered.connect(self.handleZPlot)
        self.actionZPlot.setToolTip(self.handleZPlot.__doc__.strip())
        self.actionContour.triggered.connect(self.handleContour)
        self.actionContour.setToolTip(self.handleContour.__doc__.strip())
        self.actionContour_filled.triggered.connect(self.handleContourf)
        self.actionContour_filled.setToolTip(self.handleContourf.__doc__.strip())
        self.actionClearFig.triggered.connect(self.handleClearFig)
        self.actionClearFig.setToolTip(self.handleClearFig.__doc__.strip())

        # Command menu
        self.actionDeleteTrace.triggered.connect(self.handleDeleteTrace)
        self.actionDeleteTrace.setToolTip(self.handleDeleteTrace.__doc__.strip())
        self.actionChop.triggered.connect(self.handleChop)
        self.actionChop.setToolTip(self.handleChop.__doc__.strip())
        self.actionIntegrate.triggered.connect(self.handleIntegrate)
        self.actionIntegrate.setToolTip(self.handleIntegrate.__doc__.strip())
        self.actionDf_dt.triggered.connect(self.handleDifferentiate)
        self.actionDf_dt.setToolTip(self.handleDifferentiate.__doc__.strip())
        self.actionAdd.triggered.connect(self.handleAdd)
        self.actionAdd.setToolTip(self.handleAdd.__doc__.strip())
        self.actionMultiply.triggered.connect(self.handleMultiply)
        self.actionMultiply.setToolTip(self.handleMultiply.__doc__.strip())
        self.actionSubtract.triggered.connect(self.handleSubtract)
        self.actionSubtract.setToolTip(self.handleSubtract.__doc__.strip())
        self.actionDivide.triggered.connect(self.handleDivide)
        self.actionDivide.setToolTip(self.handleDivide.__doc__.strip())
        self.actionFFTP.triggered.connect(self.handleFFTP)
        self.actionFFTP.setToolTip(self.handleFFTP.__doc__.strip())
        self.actionRunFFT.triggered.connect(self.handleRunFFT)
        self.actionRunFFT.setToolTip(self.handleRunFFT.__doc__.strip())
        self.actionReciprocal.triggered.connect(self.handleReciprocal)
        self.actionReciprocal.setToolTip(self.handleReciprocal.__doc__.strip())
        self.actionExponential.triggered.connect(self.handleExponential)
        self.actionExponential.setToolTip(self.handleExponential.__doc__.strip())
        self.actionAbsolute.triggered.connect(self.handleAbsolute)
        self.actionAbsolute.setToolTip(self.handleAbsolute.__doc__.strip())
        self.actionArctan.triggered.connect(self.handleArctan)
        self.actionArctan.setToolTip(self.handleArctan.__doc__.strip())
        self.actionNlog.triggered.connect(self.handleNlog)
        self.actionNlog.setToolTip(self.handleNlog.__doc__.strip())
        self.actionNorm.triggered.connect(self.handleNorm)
        self.actionNorm.setToolTip(self.handleNorm.__doc__.strip())
        self.actionInvert.triggered.connect(self.handleInvert)
        self.actionInvert.setToolTip(self.handleInvert.__doc__.strip())
        self.actionAddCon.triggered.connect(self.handleAddCon)
        self.actionAddCon.setToolTip(self.handleAddCon.__doc__.strip())
        self.actionSubCon.triggered.connect(self.handleSubCon)
        self.actionSubCon.setToolTip(self.handleSubCon.__doc__.strip())
        self.actionMulCon.triggered.connect(self.handleMulCon)
        self.actionMulCon.setToolTip(self.handleMulCon.__doc__.strip())
        self.actionDivCon.triggered.connect(self.handleDivCon)
        self.actionDivCon.setToolTip(self.handleDivCon.__doc__.strip())
        self.actionPowCon.triggered.connect(self.handlePowCon)
        self.actionPowCon.setToolTip(self.handlePowCon.__doc__.strip())
        self.actionChangeName.triggered.connect(self.handleChangeName)
        self.actionChangeName.setToolTip(self.handleChangeName.__doc__.strip())
        self.actionChangeUnits.triggered.connect(self.handleChangeUnit)
        self.actionChangeUnits.setToolTip(self.handleChangeUnit.__doc__.strip())
        self.actionClip.triggered.connect(self.handleClip)
        self.actionClip.setToolTip(self.handleClip.__doc__.strip())
        self.actionStats.triggered.connect(self.handleStats)
        self.actionStats.setToolTip(self.handleStats.__doc__.strip())
        self.actionTimeOff.triggered.connect(self.handleTimeOff)
        self.actionTimeOff.setToolTip(self.handleTimeOff.__doc__.strip())
