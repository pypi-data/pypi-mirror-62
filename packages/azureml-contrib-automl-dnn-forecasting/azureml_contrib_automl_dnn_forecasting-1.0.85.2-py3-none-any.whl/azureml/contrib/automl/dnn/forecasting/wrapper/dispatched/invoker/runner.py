...
def run() -> None:
    ...
    logger.info("Arguments passed to driver script: {0}".format((args_dict)))
    logger.info("DNN parameters {0}".format(str(params)))
    ...
    logger.info("Run settings passed to driver script: {}".format(settings))
