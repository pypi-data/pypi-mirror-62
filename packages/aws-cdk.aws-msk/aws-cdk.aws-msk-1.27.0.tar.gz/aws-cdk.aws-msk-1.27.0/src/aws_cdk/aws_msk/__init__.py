...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-msk", "1.27.0", __name__, "aws-msk@1.27.0.jsii.tgz")
...
class CfnCluster(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-msk.CfnCluster"):
    ...
    class JmxExporterProperty():
        def __init__(self, *, enabled_in_broker: typing.Union[bool, aws_cdk.core.IResolvable]):
            """
    ...
    class OpenMonitoringProperty():
        def __init__(self, *, prometheus: typing.Union[aws_cdk.core.IResolvable, "CfnCluster.PrometheusProperty"]):
            """
    ...
    class PrometheusProperty():
        def __init__(self, *, jmx_exporter: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.JmxExporterProperty"]]]=None, node_exporter: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.NodeExporterProperty"]]]=None):
            """
