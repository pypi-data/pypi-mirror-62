...
class Location(Node):
    ...
    def factory_reset(self, ttl_s, access_point=None):
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_message('Configuration', mask=0x0,
                                                 adv_en=0x19,
                                                 schedule=b'\xeb\x73\x0c\x54'
                                                          b'\x02\xce\x64\xc8'
                                                          b'\x00\x00\x00\x00'
                                                          b'\x00\x00\x00\x00'
                                                          b'\x00\x00\x00\x00'
    ...
    def multicast_factory_reset(cls, vers, gws, ttl_s=60, access_point=None,
        ...
        Returns:
            ...
            :class:`.DownlinkMessage` when sent to an individual AP.
        """
        pld = cls._get_spec(vers).build_message('Configuration', mask=0x0,
                                                adv_en=0x19,
                                                schedule=b'\xeb\x73\x0c\x54'
                                                         b'\x02\xce\x64\xc8'
                                                         b'\x00\x00\x00\x00'
                                                         ...
                                                         b'\x00',
                                                heartbeat_int=0x0)
        return cls._send_multicast_message(pld, ttl_s, gws, access_point,
                                           ap_vers, gws)
