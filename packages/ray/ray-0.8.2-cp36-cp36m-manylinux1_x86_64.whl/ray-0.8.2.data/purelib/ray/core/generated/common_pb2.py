...
_COREWORKERSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='num_executed_tasks', full_name='ray.rpc.CoreWorkerStats.num_executed_tasks', index=12,
    ...
    _descriptor.FieldDescriptor(
      name='actor_title', full_name='ray.rpc.CoreWorkerStats.actor_title', index=13,
