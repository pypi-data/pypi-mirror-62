...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.4.0-alpha.1583178841+g1cd7451'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.4.0-alpha.1583178841+g1cd7451`
                """)
            else:
                raise
