...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.4.0-alpha.1582297170+gfc0e9a8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.4.0-alpha.1582297170+gfc0e9a8`
                """)
            else:
                raise
