...
class TestInputError(unittest.TestCase):
    ...
    def test_initially_input_error_has_all_fields_empty(self):
        ...
        self.assertFalse(ie.has_columns_that_would_be_overwritten())
    ...
    def test_add_column_that_would_be_overwritten(self):
        ie = InputDataError()
        ie.add_column_that_would_be_overwritten('bubble')
        ie.add_column_that_would_be_overwritten('bubble')
        ie.add_column_that_would_be_overwritten('rock')
        self.assertFalse(ie.has_missing_columns())
        self.assertFalse(ie.has_columns_with_nan())
        self.assertFalse(ie.has_columns_with_wrong_format())
        self.assertTrue(ie.has_columns_that_would_be_overwritten())
        self.assertCountEqual(['bubble', 'rock'], ie.get_columns_that_would_be_overwritten())
        self.assertFalse(ie.is_empty())
    ...
    def test_add(self):
        ...
        ie2.add_column_that_would_be_overwritten('stone')
        ...
        self.assertCountEqual(['stone'], ie.get_columns_that_would_be_overwritten())
        ...
        self.assertCountEqual(['stone'], ie2.get_columns_that_would_be_overwritten())
