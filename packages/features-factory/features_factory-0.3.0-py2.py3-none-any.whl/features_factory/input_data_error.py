...
class InputDataError:
    ...
    def __init__(self):
        ...
        self._columns_that_would_be_overwritten = set()
    ...
    def __add__(self, other):
        ...
        ies_sum._columns_that_would_be_overwritten = \
            ies_sum._columns_that_would_be_overwritten.union(other._columns_that_would_be_overwritten)
    ...
    def is_empty(self) -> bool:
        return False if any((self.has_missing_columns(),
                             ...
                             self.has_columns_with_wrong_format(),
                             self.has_columns_that_would_be_overwritten())) else True
    ...
    def has_columns_that_would_be_overwritten(self):
        return True if len(self._columns_that_would_be_overwritten) > 0 else False
    ...
    def get_columns_that_would_be_overwritten(self) -> Tuple:
        return tuple(self._columns_that_would_be_overwritten)
    ...
    def add_column_that_would_be_overwritten(self, column_name: str):
        self._columns_that_would_be_overwritten.add(column_name)
    ...
    def to_string(self) -> str:
        ...
        if self.has_columns_that_would_be_overwritten():
            lines.append(' * columns that would be overwritten = '
                         + ', '.join(self.get_columns_that_would_be_overwritten()))
