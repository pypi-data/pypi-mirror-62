...
class ListAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/chime.html#Chime.Paginator.ListAccounts.paginate)
        """
...
class ListUsersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListUsers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/chime.html#Chime.Paginator.ListUsers.paginate)
        """
