...
setup(
    ...
    install_requires=["mo-dots>=3.51.20059","mo-files>=3.51.20059","mo-future>=3.51.20059","mo-json>=3.51.20059","mo-kwargs>=3.47.20042","mo-logs>=3.51.20059","mo-threads>=3.51.20059","mo-times>=3.51.20059","requests"],
    license='MPL 2.0',
