...
def _get_page_num_charity_china_trust() -> int:
    ...
    :rtype: int
    """
    url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/e/csmhedoSort.html"
    payload_params = {
        "aafx0103": "",
        "field": "aafx0104",
        "sort": "desc",
...
def _get_page_num_charity_china_plan() -> int:
    ...
    :rtype: int
    """
    url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/c/csmhcquerylist.html"
    payload_params = {
        "aaex9102_03": "",
        "aaex8104": "1",
    }
    ...
    for page in range(1, page_num):
        ...
        temp_list = [
            _get_charity_china_plan_detail(
                "http://cishan.chinanpo.gov.cn" + item["href"]
            )
...
def _get_page_num_charity_china_progress() -> int:
    ...
    :rtype: int
    """
    url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/b/csmhbquerylist.html"
    payload_params = {
        "aaex8102_03": "",
        "aaex8104": "1",
    }
...
def _get_charity_china_progress_detail(url: str = "") -> Tuple[str]:
    ...
    :rtype:
    """
    # url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/b/csmhbdetail.html?id=ff80808170367b4c01703a5a9158053e"
    r = requests.get(url)
    soup = BeautifulSoup(r.text, "lxml")
...
def _get_page_num_charity_china_report() -> int:
    ...
    :rtype: int
    """
    url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/d/csmhddoSort.html"
    payload_params = {
        "search_condit": "",
        "field": "",
        "sort": "desc",
...
def charity_china_platform() -> pd.DataFrame:
    ...
    :rtype:
    """
    url = "http://cishan.chinanpo.gov.cn/biz/ma/csmh/h/csmhhindex.html"
    r = requests.get(url)
    soup = BeautifulSoup(r.text, "lxml")
