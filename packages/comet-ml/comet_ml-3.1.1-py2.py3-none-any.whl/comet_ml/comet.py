...
from ._logging import OS_PACKAGE_MSG_SENDING_ERROR, STREAMER_WAIT_FOR_FINISH_FAILED
...
from .file_uploader import upload_file_like_thread, upload_file_thread
...
from .utils import wait_for_empty
...
class Streamer(BaseStreamer):
    ...
    def _check_heartbeat(self):
        ...
        if next_beat < now:
            if self.closed is True:
                LOGGER.warning("Websocket connection heartbeat while closed")
