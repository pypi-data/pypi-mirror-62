...
class Experiment(BaseExperiment):
    ...
    def _setup_streamer(self):
        ...
        self.rest_api_client = get_rest_api_client("v2", comet_api_key=self.api_key)
    ...
    def display(self, clear=False, wait=True, new=0, autoraise=True, tab=None):
        ...
        if self._in_jupyter_environment():
            ...
            display(
                IFrame(
                    src=get_global_experiment()._get_experiment_url(tab),
                    width="100%",
                    height="800px",
                )
            )
            ...
            webbrowser.open(
                get_global_experiment()._get_experiment_url(tab),
                new=new,
                autoraise=autoraise,
            )
