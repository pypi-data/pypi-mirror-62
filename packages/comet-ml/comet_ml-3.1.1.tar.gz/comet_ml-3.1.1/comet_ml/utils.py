...
from ._typing import IO, Any, Dict, Generator, Optional, Set, Tuple
...
def convert_to_scalar(user_data):
    # type: (Any) -> Any
    """ Try to ensure that the given user_data is converted back to a Python scalar
    """
