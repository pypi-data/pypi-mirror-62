...
class BaseExperiment(object):
    ...
    def log_figure(self, figure_name=None, figure=None, overwrite=False, step=None):
        # type: (Optional[str], Optional[Any], bool, Optional[int]) -> Optional[Dict[str, Dict[str, str]]]
        """
    ...
    def log_asset_data(
        self, data, file_name=None, overwrite=False, step=None, metadata=None
    ):
        """
        ...
        Args:
            ...
            step: Optional. Used to associate the asset to a specific step.
            metadata: Some additional data to attach to the the asset data.
                Must be JSON-encodable.
    ...
    def log_asset(
        ...
        # type: (Any, Optional[str], bool, bool, Optional[int]) -> Optional[Dict[str, str]]
        """
    ...
    def _log_asset(
        ...
        # type: (Any, Optional[str], bool, bool, str, Optional[int], bool) -> Optional[Dict[str, str]]
        if not self.alive:
            return None
    ...
    def log_audio(
        ...
        # type: (Any, Optional[int], Optional[str], Any, bool, bool, Optional[int]) -> Optional[Dict[str, Optional[str]]]
        """
    ...
    def log_image(
        ...
        # type: (Any, Optional[str], bool, str, float, Tuple[int, int], str, Tuple[int, int], str, bool, Optional[int]) -> Optional[Dict[str, Dict[str, str]]]
        """
