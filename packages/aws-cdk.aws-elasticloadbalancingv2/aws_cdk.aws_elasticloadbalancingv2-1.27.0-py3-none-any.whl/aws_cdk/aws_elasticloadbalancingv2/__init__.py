...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2", "1.27.0", __name__, "aws-elasticloadbalancingv2@1.27.0.jsii.tgz")
...
class ApplicationLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, security_group_id: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None):
...
class CfnListener(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.CfnListener"):
    ...
    class TargetGroupStickinessConfigProperty():
        def __init__(self, *, duration_seconds: typing.Optional[jsii.Number]=None, enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None):
            """
    ...
    class TargetGroupTupleProperty():
        def __init__(self, *, target_group_arn: typing.Optional[str]=None, weight: typing.Optional[jsii.Number]=None):
            """
...
class NetworkLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None):
        """Properties to reference an existing load balancer.
