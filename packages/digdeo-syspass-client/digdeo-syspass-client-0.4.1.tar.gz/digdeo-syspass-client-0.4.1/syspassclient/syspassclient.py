...
class SyspassClient(syspassclient.Object, syspassclient.Utils):
    def __init__(self):
        ...
        # Initialize
        self.api_url = syspassclient.config.get_data()['api_url']
        self.authToken = syspassclient.config.get_data()['authToken']
        self.tokenPass = syspassclient.config.get_data()['tokenPass']
        self.debug = syspassclient.config.get_data()['debug']
        self.debug_level = syspassclient.config.get_data()['debug_level']
        self.verbose = syspassclient.config.get_data()['verbose']
        self.verbose_level = syspassclient.config.get_data()['verbose_level']
