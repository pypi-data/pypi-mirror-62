...
class Utils(syspassclient.CheckType):
    ...
    def look_for_parameters_type(self, **parameters):
        ...
        for parameter, value in parameters.items():
            ...
            # Test parameter type:
            # Str type
            if syspassclient.config.get_data()[parameters["method"]]["params_details"][parameter]["type"].lower() == "str":
            ...
            # Int Type
            elif syspassclient.config.get_data()[parameters["method"]]["params_details"][parameter]["type"].lower() == "int":
            ...
            # List
            elif syspassclient.config.get_data()[parameters["method"]]["params_details"][parameter]["type"].lower() == "array":
    ...
    def look_for_parameters_injection(**parameters):
        ...
        for parameter, value in parameters.items():
            if parameter == "method":
                continue
            if parameter not in syspassclient.config.get_data()[parameters["method"]]["params_details"]:
                raise (
                    AttributeError(
    ...
    def required_parameters(method):
        ...
        """
        requirement_list = []
        for parameter in syspassclient.config.get_data()[method]["params_details"]:
            if syspassclient.config.get_data()[method]["params_details"][parameter]["required"] is True:
