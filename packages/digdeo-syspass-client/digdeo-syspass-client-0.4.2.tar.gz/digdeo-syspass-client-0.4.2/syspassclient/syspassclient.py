...
class SyspassClient(syspassclient.Object, syspassclient.Utils, metaclass=Singleton):
    def __init__(self):
        ...
        self.debug = syspassclient.config.debug
        self.debug_level = syspassclient.config.debug_level
        self.verbose = syspassclient.config.verbose
        self.verbose_level = syspassclient.config.verbose_level
