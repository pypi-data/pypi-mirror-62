...
class BotLongpoll:
    CLASS_BY_EVENT_TYPE = {
        BotsEventType.MESSAGE_NEW.value: BotMessageEvent,
        BotsEventType.MESSAGE_REPLY.value: BotMessageEvent,
        BotsEventType.MESSAGE_EDIT.value: BotMessageEvent,
    }
