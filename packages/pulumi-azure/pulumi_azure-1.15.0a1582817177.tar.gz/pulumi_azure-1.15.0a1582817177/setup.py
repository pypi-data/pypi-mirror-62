...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.15.0-alpha.1582817177+g70c3b1b5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.15.0-alpha.1582817177+g70c3b1b5`
                """)
            else:
                raise
