...
Usage::
    ...
    from mypy_boto3.guardduty.type_defs import AccountDetailTypeDef

    data: AccountDetailTypeDef = {...}
"""
import sys
...
_RequiredGetFilterResponseTypeDef = TypedDict(
    ...
    {"Name": str, "Action": Literal["NOOP", "ARCHIVE"], "FindingCriteria": FindingCriteriaTypeDef},
)
...
PortProbeDetailTypeDef = TypedDict(
    "PortProbeDetailTypeDef",
    {"LocalPortDetails": LocalPortDetailsTypeDef, "RemoteIpDetails": RemoteIpDetailsTypeDef},
    total=False,
)
...
_RequiredListPublishingDestinationsResponseTypeDef = TypedDict(
    "_RequiredListPublishingDestinationsResponseTypeDef", {"Destinations": List[DestinationTypeDef]}
)
...
StopMonitoringMembersResponseTypeDef = TypedDict(
    "StopMonitoringMembersResponseTypeDef", {"UnprocessedAccounts": List[UnprocessedAccountTypeDef]}
)
