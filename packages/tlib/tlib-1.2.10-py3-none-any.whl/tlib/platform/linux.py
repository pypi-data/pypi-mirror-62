...
def get_cpu_usage(intvl_in_sec=1):
    ...
    """
    decorators.needlinux(True)
    unittest.TestCase.assertGreater(intvl_in_sec, 0)
    ret = []
...
def get_net_through(str_interface):
    ...
    if rx_bytes < 0 or tx_bytes < 0:
        ...
        warnings.warn(msg, RuntimeWarning)
    unittest.TestCase.assertGreaterEqual(rx_bytes, 0)
    unittest.TestCase.assertGreaterEqual(tx_bytes, 0)
...
def get_net_transmit_speed(str_interface, intvl_in_sec=1):
    ...
    ::
        import tlib
        print tlib.linux.get_net_transmit_speed('eth1', 5)
