...
Report bugs at https://github.com/joseph-fox/pushjack.
...
The best way to send feedback is to file an issue at https://github.com/joseph-fox/pushjack.
...
Ready to contribute? Here's how to set up ``pushjack-http2`` for local development.

1. Fork the ``pushjack-http2`` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:joseph-fox/pushjack.git
