...
class ShaftSectionDamageResults(_1.APIBase):
    ...
    def left_end(self) -> '_37.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_37.ShaftSectionEndDamageResults)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None
    ...
    def right_end(self) -> '_37.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_37.ShaftSectionEndDamageResults)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
