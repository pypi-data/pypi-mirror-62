...
class ShaftSectionEndDamageResults(_1.APIBase):
    ...
    @property
    def section_end(self) -> '_1369.SectionEnd':
        ...
        return constructor.new(_1369.SectionEnd)(value) if value else None
    ...
    @property
    def stress_concentration_factors(self) -> '_17.ShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_17.ShaftAxialBendingTorsionalComponentValues)(self.wrapped.StressConcentrationFactors) if self.wrapped.StressConcentrationFactors else None
    ...
    @property
    def din743201212_alternate_strength(self) -> '_42.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_42.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212AlternateStrength) if self.wrapped.DIN743201212AlternateStrength else None

    @property
    def din743201212_yielding_strength(self) -> '_42.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_42.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212YieldingStrength) if self.wrapped.DIN743201212YieldingStrength else None

    @property
    def din743201212_influence_factor_for_mean_stress_sensitivity(self) -> '_17.ShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_17.ShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212InfluenceFactorForMeanStressSensitivity) if self.wrapped.DIN743201212InfluenceFactorForMeanStressSensitivity else None

    @property
    def fkm_guideline_6th_edition_2012_cyclic_degree_of_utilization_for_finite_life(self) -> '_18.ShaftAxialBendingXBendingYTorsionalComponentValues':
        ...
        return constructor.new(_18.ShaftAxialBendingXBendingYTorsionalComponentValues)(self.wrapped.FKMGuideline6thEdition2012CyclicDegreeOfUtilizationForFiniteLife) if self.wrapped.FKMGuideline6thEdition2012CyclicDegreeOfUtilizationForFiniteLife else None

    @property
    def fkm_guideline_6th_edition_2012_cyclic_degree_of_utilization_for_infinite_life(self) -> '_18.ShaftAxialBendingXBendingYTorsionalComponentValues':
        ...
        return constructor.new(_18.ShaftAxialBendingXBendingYTorsionalComponentValues)(self.wrapped.FKMGuideline6thEdition2012CyclicDegreeOfUtilizationForInfiniteLife) if self.wrapped.FKMGuideline6thEdition2012CyclicDegreeOfUtilizationForInfiniteLife else None
    ...
    def stress_cycles(self) -> 'List[_29.ShaftPointStressCycleReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StressCycles, constructor.new(_29.ShaftPointStressCycleReporting))
        return value

    @property
    def din743201212_yielding_amplitude(self) -> 'List[_42.StressMeasurementShaftAxialBendingTorsionalComponentValues]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DIN743201212YieldingAmplitude, constructor.new(_42.StressMeasurementShaftAxialBendingTorsionalComponentValues))
        return value
