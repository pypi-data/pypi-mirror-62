...
class SimpleShaftDefinition(_1323.NamedDatabaseItem):
    '''SimpleShaftDefinition
    ...
    @property
    def shaft_material(self) -> '_25.ShaftMaterial':
        ...
        return constructor.new(_25.ShaftMaterial)(self.wrapped.ShaftMaterial) if self.wrapped.ShaftMaterial else None

    @property
    def default_surface_roughness(self) -> '_40.ShaftSurfaceRoughness':
        ...
        return constructor.new(_40.ShaftSurfaceRoughness)(self.wrapped.DefaultSurfaceRoughness) if self.wrapped.DefaultSurfaceRoughness else None
    ...
    def outer_profile(self) -> '_30.ShaftProfile':
        ...
        return constructor.new(_30.ShaftProfile)(self.wrapped.OuterProfile) if self.wrapped.OuterProfile else None
    ...
    def inner_profile(self) -> '_30.ShaftProfile':
        ...
        return constructor.new(_30.ShaftProfile)(self.wrapped.InnerProfile) if self.wrapped.InnerProfile else None

    @property
    def design_shaft_sections(self) -> 'List[_10.DesignShaftSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignShaftSections, constructor.new(_10.DesignShaftSection))
        return value
    ...
    def radial_holes(self) -> 'List[_33.ShaftRadialHole]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RadialHoles, constructor.new(_33.ShaftRadialHole))
        return value

    @property
    def grooves(self) -> 'List[_23.ShaftGroove]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Grooves, constructor.new(_23.ShaftGroove))
        return value

    @property
    def surface_finish_sections(self) -> 'List[_39.ShaftSurfaceFinishSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SurfaceFinishSections, constructor.new(_39.ShaftSurfaceFinishSection))
        return value

    @property
    def generic_stress_concentration_factors(self) -> 'List[_15.GenericStressConcentrationFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GenericStressConcentrationFactors, constructor.new(_15.GenericStressConcentrationFactor))
        return value
