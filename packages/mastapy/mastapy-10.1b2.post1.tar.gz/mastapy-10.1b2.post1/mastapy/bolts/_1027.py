...
class BoltGeometry(_1323.NamedDatabaseItem):
    '''BoltGeometry
    ...
    @property
    def standard_size(self) -> '_1043.StandardSizes':
        '''StandardSizes: 'StandardSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StandardSize)
        return constructor.new(_1043.StandardSizes)(value) if value else None

    @standard_size.setter
    def standard_size(self, value: '_1043.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.StandardSize = value

    @property
    def bolt_sections(self) -> 'List[_1031.BoltSection]':
        '''List[BoltSection]: 'BoltSections' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltSections, constructor.new(_1031.BoltSection))
        return value

    @bolt_sections.setter
    def bolt_sections(self, value: 'List[_1031.BoltSection]'):
        value = value if value else None
    ...
    @property
    def bolt_shank_type(self) -> '_1032.BoltShankType':
        ...
        return constructor.new(_1032.BoltShankType)(value) if value else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1032.BoltShankType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_head_cap(self) -> '_1038.HeadCapTypes':
        ...
        return constructor.new(_1038.HeadCapTypes)(value) if value else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1038.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1045.ThreadTypes':
        '''ThreadTypes: 'TypeOfThread' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfThread)
        return constructor.new(_1045.ThreadTypes)(value) if value else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1045.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1033.BoltTypes':
        ...
        return constructor.new(_1033.BoltTypes)(value) if value else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1033.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
