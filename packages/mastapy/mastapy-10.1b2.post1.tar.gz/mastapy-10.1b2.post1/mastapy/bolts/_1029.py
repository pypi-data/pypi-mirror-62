...
from mastapy.bolts import _1044, _1026
...
class BoltMaterial(_1026.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1044.StrengthGrades':
        ...
        return constructor.new(_1044.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1044.StrengthGrades'):
