...
from mastapy.bolts import _1026
...
class ClampedSectionMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1026.BoltedJointMaterial':
        ...
        return constructor.new(_1026.BoltedJointMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1026.BoltedJointMaterial':
        ...
        return constructor.new(_1026.BoltedJointMaterial)(method_result) if method_result else None

    def can_be_removed(self, bolted_joint_material: '_1026.BoltedJointMaterial') -> 'bool':
    ...
    def rename(self, bolted_joint_material: '_1026.BoltedJointMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bolted_joint_material: '_1026.BoltedJointMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_1026.BoltedJointMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1026.BoltedJointMaterial))

    def save_changes(self, bolted_joint_material: '_1026.BoltedJointMaterial'):
