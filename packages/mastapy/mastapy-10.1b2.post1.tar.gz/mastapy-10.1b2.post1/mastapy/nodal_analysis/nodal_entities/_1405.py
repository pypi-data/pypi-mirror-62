...
from mastapy.nodal_analysis import _1340
from mastapy.nodal_analysis.nodal_entities import _1420
...
class Bar(_1420.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1340.BarGeometry':
        ...
        return constructor.new(_1340.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
