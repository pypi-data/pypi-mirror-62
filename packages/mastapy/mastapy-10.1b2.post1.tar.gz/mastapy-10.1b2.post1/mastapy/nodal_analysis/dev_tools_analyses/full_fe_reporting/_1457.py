...
from mastapy.fe_tools.enums import _959
...
class ElementPropertiesBase(_1.APIBase):
    ...
    @property
    def class_(self) -> '_959.ElementPropertyClass':
        ...
        return constructor.new(_959.ElementPropertyClass)(value) if value else None
