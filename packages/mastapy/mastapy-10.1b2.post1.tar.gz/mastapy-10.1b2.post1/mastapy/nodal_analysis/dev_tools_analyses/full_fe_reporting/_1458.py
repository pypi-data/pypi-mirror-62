...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _955
...
class ElementPropertiesBeam(_1465.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_955.BeamSectionType':
        ...
        return constructor.new(_955.BeamSectionType)(value) if value else None
