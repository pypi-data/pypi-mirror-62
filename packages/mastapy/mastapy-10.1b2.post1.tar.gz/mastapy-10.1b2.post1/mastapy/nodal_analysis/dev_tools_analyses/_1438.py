...
class FEModel(_1.APIBase):
    ...
    @property
    def rigid_element_properties(self) -> 'List[_1461.ElementPropertiesRigid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1461.ElementPropertiesRigid))
        return value

    @property
    def solid_element_properties(self) -> 'List[_1463.ElementPropertiesSolid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1463.ElementPropertiesSolid))
        return value

    @property
    def shell_element_properties(self) -> 'List[_1462.ElementPropertiesShell]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1462.ElementPropertiesShell))
        return value

    @property
    def beam_element_properties(self) -> 'List[_1458.ElementPropertiesBeam]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1458.ElementPropertiesBeam))
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1464.ElementPropertiesSpringDashpot]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1464.ElementPropertiesSpringDashpot))
        return value

    @property
    def mass_element_properties(self) -> 'List[_1460.ElementPropertiesMass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1460.ElementPropertiesMass))
        return value

    @property
    def interface_element_properties(self) -> 'List[_1459.ElementPropertiesInterface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1459.ElementPropertiesInterface))
        return value

    @property
    def other_element_properties(self) -> 'List[_1457.ElementPropertiesBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1457.ElementPropertiesBase))
        return value

    @property
    def materials(self) -> 'List[_1466.MaterialPropertiesReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1466.MaterialPropertiesReporting))
        return value

    @property
    def contact_pairs(self) -> 'List[_1455.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1455.ContactPairReporting))
        return value
