...
from mastapy.nodal_analysis.dev_tools_analyses import _1438
from mastapy.nodal_analysis.component_mode_synthesis import _1471, _1468
...
class FullFEModel(_1.APIBase):
    ...
    @property
    def fe_model(self) -> '_1438.FEModel':
        ...
        return constructor.new(_1438.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1471.CMSOptions':
        ...
        return constructor.new(_1471.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1468.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1468.CMSElementFaceGroup))
        return value
