...
from mastapy.nodal_analysis.system_solvers import _1394
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1394.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
