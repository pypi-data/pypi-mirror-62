...
from mastapy.nodal_analysis.system_solvers import _1396
...
class SingularVectorAnalysis(_1.APIBase):
    ...
    @property
    def largest_singular_vector_components(self) -> 'List[_1396.SingularDegreeOfFreedomAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectorComponents, constructor.new(_1396.SingularDegreeOfFreedomAnalysis))
        return value
