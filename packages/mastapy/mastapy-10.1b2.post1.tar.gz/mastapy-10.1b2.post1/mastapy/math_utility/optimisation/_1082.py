...
from mastapy.math_utility.optimisation import _1088
...
class InputSetter(_1.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1088.ParetoOptimisationInput':
        ...
        return constructor.new(_1088.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
