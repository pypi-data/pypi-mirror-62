...
class PIDControlSettings(_1.APIBase):
    ...
    @property
    def update_method(self) -> '_1071.PIDControlUpdateMethod':
        ...
        return constructor.new(_1071.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1071.PIDControlUpdateMethod'):
