...
from mastapy.utility.units_and_measurements.measurements import _1229
...
class DutyCyclePropertySummaryStress(_1328.DutyCyclePropertySummary['_1229.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
