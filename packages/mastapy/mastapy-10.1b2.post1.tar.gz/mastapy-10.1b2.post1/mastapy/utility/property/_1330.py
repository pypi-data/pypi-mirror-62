...
from mastapy.utility.units_and_measurements.measurements import _1208
...
class DutyCyclePropertySummaryPercentage(_1328.DutyCyclePropertySummary['_1208.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
