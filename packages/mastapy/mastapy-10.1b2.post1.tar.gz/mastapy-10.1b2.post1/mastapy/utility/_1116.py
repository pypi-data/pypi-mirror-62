...
from mastapy.utility import _1126, _1115
...
class EnvironmentSummary(_1.APIBase):
    ...
    @property
    def current_culture(self) -> '_1126.NumberFormatInfoSummary':
        ...
        return constructor.new(_1126.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1115.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1115.DispatcherHelper))
        return value
