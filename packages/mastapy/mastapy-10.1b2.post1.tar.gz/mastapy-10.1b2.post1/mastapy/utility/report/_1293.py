...
class UserTextRow(_1285.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1292.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1292.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1292.HeadingSize'):
