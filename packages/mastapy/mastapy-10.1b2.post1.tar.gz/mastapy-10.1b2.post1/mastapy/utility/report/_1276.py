...
from mastapy.utility.report import _1277, _1280
...
TItem = TypeVar('TItem', bound='_1280.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1277.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
