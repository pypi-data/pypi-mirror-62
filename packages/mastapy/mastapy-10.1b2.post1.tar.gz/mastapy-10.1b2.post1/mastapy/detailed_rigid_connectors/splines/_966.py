...
from mastapy.detailed_rigid_connectors.splines import _976, _985, _993
...
class DIN5480SplineHalfDesign(_993.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_976.ManufacturingTypes':
        ...
        return constructor.new(_976.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_976.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_985.FinishingMethods':
        ...
        return constructor.new(_985.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_985.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
