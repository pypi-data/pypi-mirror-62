...
from mastapy.detailed_rigid_connectors.splines import _969, _994
...
class SAESplineJointDesign(_994.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_969.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_969.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_969.FitTypes'):
