...
class DetailedRigidConnectorDesign(_1.APIBase):
    ...
    @property
    def halves(self) -> 'List[_962.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_962.DetailedRigidConnectorHalfDesign))
        return value
