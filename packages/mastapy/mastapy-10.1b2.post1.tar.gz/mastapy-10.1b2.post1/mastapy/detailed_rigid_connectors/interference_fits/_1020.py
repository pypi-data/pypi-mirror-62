...
from mastapy.bearings.tolerances import _1528, _1516, _1521
...
class InterferenceFitHalfDesign(_962.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1021.StressRegions':
        ...
        return constructor.new(_1021.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1528.SupportTolerance':
        ...
        return constructor.new(_1528.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1516.InnerSupportTolerance':
        ...
        if _1516.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1516.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1521.OuterSupportTolerance':
        ...
        if _1521.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1521.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
