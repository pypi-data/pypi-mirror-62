...
from mastapy.detailed_rigid_connectors.interference_fits import _1018, _1017, _1022
...
class InterferenceFitDesign(_961.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1018.CalculationMethods':
        ...
        return constructor.new(_1018.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1018.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1017.AssemblyMethods':
        ...
        return constructor.new(_1017.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1017.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
