...
class GeneralTransmissionProperties(_1.APIBase):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_67.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_67.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_67.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @gearing_type.setter
    def gearing_type(self, value: '_63.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def air_properties(self) -> '_51.AirProperties':
        ...
        return constructor.new(_51.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
