...
class ComponentMaterialDatabase(_1.APIBase):
    ...
    def item(self) -> '_77.Material':
        ...
        return constructor.new(_77.Material)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_77.Material':
        ...
        return constructor.new(_77.Material)(method_result) if method_result else None

    def can_be_removed(self, material: '_77.Material') -> 'bool':
    ...
    def rename(self, material: '_77.Material', new_name: 'str') -> 'bool':
    ...
    def remove(self, material: '_77.Material'):
    ...
    def get_all_items(self) -> 'Iterable[_77.Material]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_77.Material))

    def save_changes(self, material: '_77.Material'):
