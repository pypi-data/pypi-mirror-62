...
from mastapy.utility.databases import _1323
...
class LubricationDetail(_1323.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_59.DensitySpecificationMethod':
        ...
        return constructor.new(_59.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_59.DensitySpecificationMethod'):
    ...
    @property
    def grease_contamination_level(self) -> '_65.GreaseContaminationOptions':
        ...
        return constructor.new(_65.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_65.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_52.BearingLubricationCondition':
        ...
        return constructor.new(_52.BearingLubricationCondition)(value) if value else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_52.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_72.LubricantViscosityClassification':
        ...
        return constructor.new(_72.LubricantViscosityClassification)(value) if value else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_72.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_grade_agma(self) -> '_71.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_71.LubricantViscosityClassAGMA)(value) if value else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_71.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_74.LubricantViscosityClassSAE':
        ...
        return constructor.new(_74.LubricantViscosityClassSAE)(value) if value else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_74.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def delivery(self) -> '_70.LubricantDelivery':
        ...
        return constructor.new(_70.LubricantDelivery)(value) if value else None

    @property
    def agma925a03_lubricant_type(self) -> '_47.AGMALubricantType':
        ...
        return constructor.new(_47.AGMALubricantType)(value) if value else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_47.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def isotr139892000isotr1514412014_lubricant_type(self) -> '_68.ISOLubricantType':
        ...
        return constructor.new(_68.ISOLubricantType)(value) if value else None

    @isotr139892000isotr1514412014_lubricant_type.setter
    def isotr139892000isotr1514412014_lubricant_type(self, value: '_68.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
