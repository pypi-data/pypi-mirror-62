...
from mastapy.bearings.bearing_results.rolling import _1607, _1606, _1596
...
class LoadedFourPointContactBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1607.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1606.LoadedFourPointContactBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1606.LoadedFourPointContactBallBearingRaceResults))
        return value
