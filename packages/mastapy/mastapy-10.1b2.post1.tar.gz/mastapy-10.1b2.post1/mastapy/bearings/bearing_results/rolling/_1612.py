...
from mastapy.bearings.bearing_results.rolling import _1611, _1600
...
class LoadedNeedleRollerBearingRow(_1600.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1611.LoadedNeedleRollerBearingResults':
