...
class GreaseLifeAndRelubricationInterval(_1684.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1676.Grease':
        ...
        return constructor.new(_1676.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1679.InitialFill':
        ...
        return constructor.new(_1679.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1678.GreaseQuantity':
        ...
        return constructor.new(_1678.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
