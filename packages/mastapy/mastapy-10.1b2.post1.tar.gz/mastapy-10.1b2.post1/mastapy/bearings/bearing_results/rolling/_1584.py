...
from mastapy.bearings.bearing_results.rolling import _1574
...
class LoadedAsymmetricSphericalRollerBearingStripLoadResults(_1574.LoadedAbstractSphericalRollerBearingStripLoadResults):
    '''LoadedAsymmetricSphericalRollerBearingStripLoadResults
