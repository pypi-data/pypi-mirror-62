...
class ISO14179SettingsDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1571.ISO14179Settings':
        ...
        return constructor.new(_1571.ISO14179Settings)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1571.ISO14179Settings':
        ...
        return constructor.new(_1571.ISO14179Settings)(method_result) if method_result else None

    def can_be_removed(self, iso14179_settings: '_1571.ISO14179Settings') -> 'bool':
    ...
    def rename(self, iso14179_settings: '_1571.ISO14179Settings', new_name: 'str') -> 'bool':
    ...
    def remove(self, iso14179_settings: '_1571.ISO14179Settings'):
    ...
    def get_all_items(self) -> 'Iterable[_1571.ISO14179Settings]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1571.ISO14179Settings))

    def save_changes(self, iso14179_settings: '_1571.ISO14179Settings'):
