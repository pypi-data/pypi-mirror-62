...
from mastapy.bearings.bearing_results.rolling import _1576, _1596
...
class LoadedAngularContactBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1576.LoadedAngularContactBallBearingResults':
