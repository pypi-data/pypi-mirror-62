...
from mastapy.bearings.bearing_results.rolling import _1633, _1620
...
class LoadedSphericalRollerThrustBearingRow(_1620.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1633.LoadedSphericalRollerThrustBearingResults':
