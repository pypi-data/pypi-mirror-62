...
from mastapy.bearings.bearing_results.rolling import _1645, _1596
...
class LoadedThrustBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1645.LoadedThrustBallBearingResults':
