...
from mastapy.bearings.bearing_results.rolling import _1614
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1614.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
