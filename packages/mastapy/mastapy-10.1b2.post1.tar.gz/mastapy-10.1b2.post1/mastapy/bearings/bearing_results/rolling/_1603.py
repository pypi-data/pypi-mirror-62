...
from mastapy.bearings.bearing_results.rolling import _1602, _1596
...
class LoadedDeepGrooveBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1602.LoadedDeepGrooveBallBearingResults':
