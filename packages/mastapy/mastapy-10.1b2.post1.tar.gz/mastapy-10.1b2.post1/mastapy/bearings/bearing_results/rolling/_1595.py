...
from mastapy.bearings.bearing_results.rolling import _1666, _1623
...
class LoadedBallBearingResults(_1623.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1666.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1666.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
