...
class BallBearingRaceContactGeometry(_1.APIBase):
    ...
    @property
    def race_centre(self) -> '_1048.Vector2D[_1191.LengthShort]':
        ...
        return constructor.new(_1048.Vector2D)[_1191.LengthShort](self.wrapped.RaceCentre) if self.wrapped.RaceCentre else None

    @property
    def ball_centre(self) -> '_1048.Vector2D[_1191.LengthShort]':
        ...
        return constructor.new(_1048.Vector2D)[_1191.LengthShort](self.wrapped.BallCentre) if self.wrapped.BallCentre else None
