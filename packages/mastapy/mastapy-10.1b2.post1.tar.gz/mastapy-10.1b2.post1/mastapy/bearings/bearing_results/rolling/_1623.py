...
from mastapy.bearings import _1497
from mastapy.bearings.bearing_results.rolling import (
    _1655, _1570, _1568, _1651,
    _1624, _1658
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1691, _1689, _1695, _1694,
    _1690, _1696, _1692
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.skf_module import _1686
from mastapy.bearings.bearing_results import _1555
...
class LoadedRollingBearingResults(_1555.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    def oil_dip_coefficient(self, value: 'float'):
        self.wrapped.OilDipCoefficient = float(value) if value else 0.0
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1497.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1497.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def change_in_element_diameter_after_thermal_expansion(self) -> 'float':
        '''float: 'ChangeInElementDiameterAfterThermalExpansion' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ChangeInElementDiameterAfterThermalExpansion
    ...
    @property
    def change_in_radial_internal_clearance_under_operating_conditions(self) -> 'float':
        '''float: 'ChangeInRadialInternalClearanceUnderOperatingConditions' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ChangeInRadialInternalClearanceUnderOperatingConditions

    @property
    def change_in_axial_internal_clearance_under_operating_conditions(self) -> 'float':
        '''float: 'ChangeInAxialInternalClearanceUnderOperatingConditions' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ChangeInAxialInternalClearanceUnderOperatingConditions

    @property
    def operating_radial_internal_clearance(self) -> 'float':
        '''float: 'OperatingRadialInternalClearance' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.OperatingRadialInternalClearance

    @property
    def operating_axial_internal_clearance(self) -> 'float':
        '''float: 'OperatingAxialInternalClearance' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.OperatingAxialInternalClearance

    @property
    def maximum_radial_internal_clearance(self) -> 'float':
        '''float: 'MaximumRadialInternalClearance' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.MaximumRadialInternalClearance

    @property
    def minimum_radial_internal_clearance(self) -> 'float':
        '''float: 'MinimumRadialInternalClearance' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.MinimumRadialInternalClearance

    @property
    def outer_race_fitting_at_assembly(self) -> '_1655.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1655.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtAssembly) if self.wrapped.OuterRaceFittingAtAssembly else None

    @property
    def outer_race_fitting_at_operating_conditions(self) -> '_1655.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1655.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtOperatingConditions) if self.wrapped.OuterRaceFittingAtOperatingConditions else None

    @property
    def inner_race_fitting_at_assembly(self) -> '_1570.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1570.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtAssembly) if self.wrapped.InnerRaceFittingAtAssembly else None

    @property
    def inner_race_fitting_at_operating_conditions(self) -> '_1570.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1570.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtOperatingConditions) if self.wrapped.InnerRaceFittingAtOperatingConditions else None

    @property
    def din732(self) -> '_1568.DIN732Results':
        ...
        return constructor.new(_1568.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1691.ISO2812007Results':
        ...
        return constructor.new(_1691.ISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1689.BallISO2812007Results':
        ...
        if _1689.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1689.BallISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1695.RollerISO2812007Results':
        ...
        if _1695.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1695.RollerISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def isots162812008(self) -> '_1694.ISOTS162812008Results':
        ...
        return constructor.new(_1694.ISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1690.BallISOTS162812008Results':
        ...
        if _1690.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1690.BallISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1696.RollerISOTS162812008Results':
        ...
        if _1696.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1696.RollerISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def iso762006(self) -> '_1692.ISO762006Results':
        ...
        return constructor.new(_1692.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1651.MaximumStaticContactStress':
        ...
        return constructor.new(_1651.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1686.SKFModuleResults':
        ...
        return constructor.new(_1686.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1624.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1624.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1658.RaceFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1658.RaceFittingThermalResults))
        return value
