...
from mastapy.bearings.bearing_results.rolling import _1648, _1620
...
class LoadedToroidalRollerBearingRow(_1620.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1648.LoadedToroidalRollerBearingResults':
