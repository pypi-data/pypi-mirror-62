...
from mastapy.bearings.bearing_results.rolling import _1626, _1596
...
class LoadedSelfAligningBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1626.LoadedSelfAligningBallBearingResults':
