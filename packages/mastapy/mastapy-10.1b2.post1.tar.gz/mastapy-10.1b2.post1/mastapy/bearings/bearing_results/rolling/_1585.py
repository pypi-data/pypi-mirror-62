...
from mastapy.bearings.bearing_results.rolling import _1613
...
class LoadedAxialThrustCylindricalRollerBearingDutyCycle(_1613.LoadedNonBarrelRollerBearingDutyCycle):
    '''LoadedAxialThrustCylindricalRollerBearingDutyCycle
