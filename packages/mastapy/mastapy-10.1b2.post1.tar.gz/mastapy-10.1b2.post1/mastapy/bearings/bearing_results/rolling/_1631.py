...
from mastapy.bearings.bearing_results.rolling import _1630, _1620
...
class LoadedSphericalRollerRadialBearingRow(_1620.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1630.LoadedSphericalRollerRadialBearingResults':
