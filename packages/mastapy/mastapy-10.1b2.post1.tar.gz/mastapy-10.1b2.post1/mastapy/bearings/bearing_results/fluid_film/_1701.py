...
from mastapy.bearings.bearing_results.fluid_film import _1702
...
class LoadedPlainJournalBearingResults(_1555.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1702.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1702.LoadedPlainJournalBearingRow))
        return value
