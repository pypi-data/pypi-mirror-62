...
class LoadedPlainJournalBearingRow(_1.APIBase):
    ...
    def row(self) -> '_1493.BearingRow':
        ...
        return constructor.new(_1493.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
