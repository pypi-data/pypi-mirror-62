...
from mastapy.bearings.bearing_designs.concept import _1767, _1769
...
class ConceptAxialClearanceBearing(_1769.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1767.BearingNodePosition':
        ...
        return constructor.new(_1767.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1767.BearingNodePosition'):
