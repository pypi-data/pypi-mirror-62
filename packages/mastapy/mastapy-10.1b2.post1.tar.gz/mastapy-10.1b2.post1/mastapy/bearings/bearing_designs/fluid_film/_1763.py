...
from mastapy.bearings.bearing_results import _1546
...
class PlainJournalHousing(_1.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1546.DefaultOrUserInput':
        ...
        return constructor.new(_1546.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1546.DefaultOrUserInput'):
