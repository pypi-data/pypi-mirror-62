...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1748, _1747
...
class XmlBearingTypeMapping(_1.APIBase):
    ...
    @property
    def files(self) -> 'List[_1748.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1748.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1747.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1747.AbstractXmlVariableAssignment))
        return value
