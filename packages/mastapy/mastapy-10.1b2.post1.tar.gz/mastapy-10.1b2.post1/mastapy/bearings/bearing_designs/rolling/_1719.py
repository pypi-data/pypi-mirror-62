...
from mastapy.bearings.bearing_designs.rolling import _1720, _1737
...
class BallBearing(_1737.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1720.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1720.BallBearingShoulderDefinition))
        return value
