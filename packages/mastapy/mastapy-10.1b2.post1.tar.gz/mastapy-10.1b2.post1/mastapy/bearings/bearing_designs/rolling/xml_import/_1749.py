...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1750
...
class RollingBearingImporter(_1.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1750.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1750.XmlBearingTypeMapping))
        return value
