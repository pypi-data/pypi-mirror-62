...
from mastapy.bearings import _1502
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings.bearing_designs.rolling import _1719
...
class ThrustBallBearing(_1719.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1502.OuterRingMounting':
        ...
        return constructor.new(_1502.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1502.OuterRingMounting'):
