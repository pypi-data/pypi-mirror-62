...
from mastapy.bearings.tolerances import _1514, _1511
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings import _1501
...
class InterferenceTolerance(_1511.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1514.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1514.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1501.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1501.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1501.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
