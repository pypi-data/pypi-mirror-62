...
from mastapy.bearings import _1484, _1508, _1498
from mastapy.math_utility import _1047
...
class RollingBearingDatabase(_1.APIBase):
    ...
    def get_all_items(self) -> 'Iterable[_1737.RollingBearing]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1737.RollingBearing))

    def save_changes(self, rolling_bearing: '_1737.RollingBearing'):
    ...
    def add_to_database(self, bearing: '_1737.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1737.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1484.BearingCatalog', type_: '_1508.RollingBearingType', bore_range: '_1047.Range', outer_diameter_range: '_1047.Range', width_range: '_1047.Range', dynamic_capacity_range: '_1047.Range', number_of_rows: 'int', material_type: '_1498.HybridSteelAll') -> 'List[_1737.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1484.BearingCatalog', type_: '_1508.RollingBearingType') -> 'List[_1737.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1737.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1484.BearingCatalog') -> '_1737.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        return constructor.new(_1737.RollingBearing)(method_result) if method_result else None

    def search_for_rolling_bearing_with_catalog(self, catalog: '_1484.BearingCatalog') -> 'List[_1737.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1737.RollingBearing))

    def create_bearing(self, type_: '_1508.RollingBearingType', designation: Optional['str'] = 'None') -> '_1737.RollingBearing':
