...
from mastapy.gears.materials import _382, _375
...
class CylindricalGearMaterial(_375.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_382.ManufactureRating':
        ...
        return constructor.new(_382.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_382.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_382.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_382.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_382.ManufactureRating':
    ...
    def machine_process_development(self, value: '_382.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_382.ManufactureRating':
    ...
    def manufacturability(self, value: '_382.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
