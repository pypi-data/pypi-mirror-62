...
class CylindricalGearPlasticMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_383.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_383.PlasticCylindricalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_383.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_383.PlasticCylindricalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, plastic_cylindrical_gear_material: '_383.PlasticCylindricalGearMaterial') -> 'bool':
    ...
    def rename(self, plastic_cylindrical_gear_material: '_383.PlasticCylindricalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, plastic_cylindrical_gear_material: '_383.PlasticCylindricalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_383.PlasticCylindricalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_383.PlasticCylindricalGearMaterial))

    def save_changes(self, plastic_cylindrical_gear_material: '_383.PlasticCylindricalGearMaterial'):
