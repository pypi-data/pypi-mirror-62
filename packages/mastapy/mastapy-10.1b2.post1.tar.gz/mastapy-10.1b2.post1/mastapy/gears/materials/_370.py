...
class BevelGearMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_369.BevelGearMaterial':
        ...
        return constructor.new(_369.BevelGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_369.BevelGearMaterial':
        ...
        return constructor.new(_369.BevelGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_material: '_369.BevelGearMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_material: '_369.BevelGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_material: '_369.BevelGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_369.BevelGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_369.BevelGearMaterial))

    def save_changes(self, bevel_gear_material: '_369.BevelGearMaterial'):
