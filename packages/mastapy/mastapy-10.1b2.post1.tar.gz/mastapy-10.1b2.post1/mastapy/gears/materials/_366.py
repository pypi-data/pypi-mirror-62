...
from mastapy.materials import _48, _49, _50
...
class AGMACylindricalGearMaterial(_373.CylindricalGearMaterial):
    ...
    @property
    def material_application(self) -> '_48.AGMAMaterialApplications':
        ...
        return constructor.new(_48.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_48.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_49.AGMAMaterialClasses':
        ...
        return constructor.new(_49.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_49.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_50.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_50.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_50.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
