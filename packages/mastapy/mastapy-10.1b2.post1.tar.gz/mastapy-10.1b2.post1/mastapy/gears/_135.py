...
class GearSetOptimiser(_1.APIBase):
    ...
    def perform_strength_optimisation(self, number_of_results: 'int', use_current_design_as_starting_point: Optional['bool'] = False) -> '_134.GearSetOptimisationResults':
        ...
        return constructor.new(_134.GearSetOptimisationResults)(method_result) if method_result else None

    def perform_strength_optimisation_with_progress(self, number_of_results: 'int', progress: '_6479.TaskProgress', use_current_design_as_starting_point: Optional['bool'] = False) -> '_134.GearSetOptimisationResults':
        ''' 'PerformStrengthOptimisation' is the original name of this method.
