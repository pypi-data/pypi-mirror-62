...
from mastapy.math_utility.optimisation import _1082
...
class OptimisationTarget(_1.APIBase, Generic[T]):
    ...
    @property
    def input_setters(self) -> 'List[_1082.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1082.InputSetter)[T])
        return value
