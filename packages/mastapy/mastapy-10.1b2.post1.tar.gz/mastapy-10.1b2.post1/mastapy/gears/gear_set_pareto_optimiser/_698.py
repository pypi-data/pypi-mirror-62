...
from mastapy.gears.gear_set_pareto_optimiser import _674
...
class StraightBevelGearSetParetoOptimiser(_674.GearSetParetoOptimiser):
    '''StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_723.StraightBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_723.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_723.StraightBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_723.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_723.StraightBevelGearSetDesign))
        return value
