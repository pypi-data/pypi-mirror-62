...
class MicroGeometryDesignSpaceSearchCandidate(_669.DesignSpaceSearchCandidateBase['_627.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_627.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_627.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_for_slider(self) -> '_842.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
