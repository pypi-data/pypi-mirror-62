...
class GearSetOptimiserCandidate(_669.DesignSpaceSearchCandidateBase['_158.AbstractGearSetRating', 'GearSetOptimiserCandidate']):
    '''GearSetOptimiserCandidate
    ...
    def candidate_of_type_conical_gear_set_duty_cycle_rating(self) -> '_325.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_325.ConicalGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
    ...
    def candidate_of_type_conical_gear_set_rating(self) -> '_326.ConicalGearSetRating':
        ...
        return constructor.new(_326.ConicalGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
    ...
    def candidate_of_type_concept_gear_set_duty_cycle_rating(self) -> '_336.ConceptGearSetDutyCycleRating':
        ...
        return constructor.new(_336.ConceptGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
    ...
    def candidate_of_type_concept_gear_set_rating(self) -> '_337.ConceptGearSetRating':
        ...
        return constructor.new(_337.ConceptGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
    ...
    def candidate_of_type_bevel_gear_set_rating(self) -> '_340.BevelGearSetRating':
        ...
        return constructor.new(_340.BevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
    ...
    def candidate_of_type_agma_gleason_conical_gear_set_rating(self) -> '_351.AGMAGleasonConicalGearSetRating':
        ...
        return constructor.new(_351.AGMAGleasonConicalGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
