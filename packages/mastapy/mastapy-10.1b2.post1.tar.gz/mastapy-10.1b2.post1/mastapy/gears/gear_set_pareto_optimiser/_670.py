...
class FaceGearSetParetoOptimiser(_674.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_751.FaceGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_751.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_751.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_751.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_751.FaceGearSetDesign))
        return value
