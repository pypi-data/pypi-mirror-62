...
class CylindricalGearSpecification(_1.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_825.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_825.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_792.FinishToothThicknessDesignSpecification':
        ...
        if _792.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_792.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_824.ToothThicknessSpecification':
        ...
        if _824.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_824.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
