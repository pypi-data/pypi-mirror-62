...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _522
...
class ShaperSimulationCalculator(_482.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_522.CylindricalGearShaperTangible':
        ...
        return constructor.new(_522.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
