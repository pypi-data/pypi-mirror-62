...
from mastapy.gears.gear_designs.cylindrical import _825, _792, _824
...
class PlungeShaverCalculationInputs(_1.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_136.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_136.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_483.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_483.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_825.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_825.ToothThicknessSpecificationBase)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_792.FinishToothThicknessDesignSpecification':
        ...
        if _792.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_792.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_824.ToothThicknessSpecification':
        ...
        if _824.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_824.ToothThicknessSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
