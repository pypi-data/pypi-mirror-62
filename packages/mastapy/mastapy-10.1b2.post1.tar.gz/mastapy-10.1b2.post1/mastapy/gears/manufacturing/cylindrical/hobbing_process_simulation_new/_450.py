...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _441, _445
...
class HobbingProcessProfileCalculation(_445.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
