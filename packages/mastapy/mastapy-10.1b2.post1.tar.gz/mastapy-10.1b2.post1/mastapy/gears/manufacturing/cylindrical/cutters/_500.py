...
class CustomisableEdgeProfile(_1.APIBase):
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_515.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_515.MutatableCommon))
        return value
