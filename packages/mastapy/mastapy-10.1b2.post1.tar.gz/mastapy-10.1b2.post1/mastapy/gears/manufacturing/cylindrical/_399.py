...
class CylindricalManufacturedGearSetDutyCycle(_952.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalManufacturedGearSetDutyCycle
    ...
    @property
    def rating(self) -> '_264.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def manufacturing_configuration(self) -> '_404.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_404.CylindricalSetManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
