...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _524, _526, _521
...
class CylindricalGearGrindingWorm(_508.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_524.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_524.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
