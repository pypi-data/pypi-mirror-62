...
from mastapy.gears.manufacturing.cylindrical.cutters import _504
...
class CylindricalWormGrinderDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_504.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_504.CylindricalGearGrindingWorm)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_504.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_504.CylindricalGearGrindingWorm)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_grinding_worm: '_504.CylindricalGearGrindingWorm') -> 'bool':
    ...
    def rename(self, cylindrical_gear_grinding_worm: '_504.CylindricalGearGrindingWorm', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_grinding_worm: '_504.CylindricalGearGrindingWorm'):
    ...
    def get_all_items(self) -> 'Iterable[_504.CylindricalGearGrindingWorm]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_504.CylindricalGearGrindingWorm))

    def save_changes(self, cylindrical_gear_grinding_worm: '_504.CylindricalGearGrindingWorm'):
