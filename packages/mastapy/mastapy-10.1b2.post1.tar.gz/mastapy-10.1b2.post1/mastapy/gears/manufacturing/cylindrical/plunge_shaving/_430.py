...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _422, _428
...
class PlungeShaverOutputs(_1.APIBase):
    ...
    @property
    def profile_modification_on_conjugate_shaver_chart_left_flank(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank else None

    @property
    def profile_modification_on_conjugate_shaver_chart_right_flank(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank else None
    ...
    @property
    def calculation_details(self) -> '_428.PlungeShaverGeneration':
        ...
        return constructor.new(_428.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails else None
