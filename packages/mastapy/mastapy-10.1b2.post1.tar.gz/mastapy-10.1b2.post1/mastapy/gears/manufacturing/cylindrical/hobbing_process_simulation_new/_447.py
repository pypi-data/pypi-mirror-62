...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _439, _445
...
class HobbingProcessLeadCalculation(_445.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
