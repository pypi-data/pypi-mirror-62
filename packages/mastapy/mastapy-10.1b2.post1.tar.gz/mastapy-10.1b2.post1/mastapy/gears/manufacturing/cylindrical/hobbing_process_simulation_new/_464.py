...
class ProcessSimulationInput(_1.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_442.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_442.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_442.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_438.AnalysisMethod':
        ...
        return constructor.new(_438.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_438.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_469.RackMountingError':
        ...
        return constructor.new(_469.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_444.GearMountingError':
        ...
        return constructor.new(_444.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_443.CutterHeadSlideError':
        ...
        return constructor.new(_443.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
