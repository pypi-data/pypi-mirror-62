...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _464, _451, _478
...
class ProcessCalculation(_1.APIBase):
    ...
    @property
    def inputs(self) -> '_464.ProcessSimulationInput':
        ...
        return constructor.new(_464.ProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_451.HobbingProcessSimulationInput':
        ...
        if _451.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_451.HobbingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_478.WormGrindingProcessSimulationInput':
        ...
        if _478.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_478.WormGrindingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None
