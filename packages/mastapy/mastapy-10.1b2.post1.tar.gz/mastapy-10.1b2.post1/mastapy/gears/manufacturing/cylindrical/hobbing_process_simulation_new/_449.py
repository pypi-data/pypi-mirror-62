...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _440, _445
...
class HobbingProcessPitchCalculation(_445.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
