...
from mastapy.gears.gear_designs.cylindrical import _761
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _435, _421
...
class PlungeShaverGeneration(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_761.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_761.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_435.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_435.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_421.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_421.CalculationError))
        return value
