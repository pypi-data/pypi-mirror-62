...
from mastapy.gears.gear_designs.cylindrical import _819, _776
...
class ShavingDynamicsViewModel(_549.ShavingDynamicsViewModelBase, Generic[T]):
    '''ShavingDynamicsViewModel
    ...
    def selected_measurement_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThicknessType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ThicknessType.implicit_type()
    ...
    def selected_measurement_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ThicknessType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ThicknessType.implicit_type().type_()
    ...
    @property
    def chart_display_method(self) -> '_776.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_776.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def active_profile_range_calculation_source(self) -> '_527.ActiveProfileRangeCalculationSource':
        ...
        return constructor.new(_527.ActiveProfileRangeCalculationSource)(value) if value else None

    @active_profile_range_calculation_source.setter
    def active_profile_range_calculation_source(self, value: '_527.ActiveProfileRangeCalculationSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def calculation(self) -> '_544.ShavingDynamicsCalculation[T]':
        ...
        return constructor.new(_544.ShavingDynamicsCalculation)[T](self.wrapped.Calculation) if self.wrapped.Calculation else None

    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_530.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _530.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
        ...
        return constructor.new(_530.ConventionalShavingDynamicsCalculationForDesignedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None

    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_531.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _531.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
        ...
        return constructor.new(_531.ConventionalShavingDynamicsCalculationForHobbedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None

    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_536.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _536.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
        ...
        return constructor.new(_536.PlungeShavingDynamicsCalculationForDesignedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None

    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_537.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _537.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
        ...
        return constructor.new(_537.PlungeShavingDynamicsCalculationForHobbedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None
