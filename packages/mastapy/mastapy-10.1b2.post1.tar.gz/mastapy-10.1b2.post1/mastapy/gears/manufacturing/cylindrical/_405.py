...
class CylindricalShaperDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_510.CylindricalGearShaper':
        ...
        return constructor.new(_510.CylindricalGearShaper)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_510.CylindricalGearShaper':
        ...
        return constructor.new(_510.CylindricalGearShaper)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaper: '_510.CylindricalGearShaper') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaper: '_510.CylindricalGearShaper', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaper: '_510.CylindricalGearShaper'):
    ...
    def get_all_items(self) -> 'Iterable[_510.CylindricalGearShaper]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_510.CylindricalGearShaper))

    def save_changes(self, cylindrical_gear_shaper: '_510.CylindricalGearShaper'):
