...
from mastapy.gears.manufacturing.cylindrical import _413, _414
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_413.MicroGeometryInputsLead':
        ...
        return constructor.new(_413.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_414.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_414.MicroGeometryInputsProfile))
        return value
