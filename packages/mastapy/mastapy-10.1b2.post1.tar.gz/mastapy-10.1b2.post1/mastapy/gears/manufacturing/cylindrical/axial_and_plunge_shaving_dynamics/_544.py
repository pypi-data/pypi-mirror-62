...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _540, _539, _543
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _483
...
class ShavingDynamicsCalculation(_1.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_540.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_540.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_540.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_540.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_483.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_483.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None

    @property
    def shaver(self) -> '_511.CylindricalGearShaver':
        ...
        return constructor.new(_511.CylindricalGearShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def life_shaver(self) -> '_511.CylindricalGearShaver':
        ...
        return constructor.new(_511.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None

    @property
    def new_cutter_start_of_shaving(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
