...
from mastapy.gears.manufacturing.cylindrical import _389
from mastapy.gears.manufacturing.cylindrical.cutters import _499
...
class MutatableCommon(_499.CurveInLinkedList):
    '''MutatableCommon
    ...
    def section(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections.implicit_type()
    ...
    def section(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections.implicit_type().type_()
