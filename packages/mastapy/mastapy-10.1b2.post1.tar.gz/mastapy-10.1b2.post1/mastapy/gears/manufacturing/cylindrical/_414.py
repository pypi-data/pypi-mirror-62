...
from mastapy.gears.manufacturing.cylindrical import _412, _416
...
class MicroGeometryInputsProfile(_412.MicroGeometryInputs['_416.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
