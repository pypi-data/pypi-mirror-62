...
class WormGrinderSimulationCalculator(_493.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_524.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_524.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
