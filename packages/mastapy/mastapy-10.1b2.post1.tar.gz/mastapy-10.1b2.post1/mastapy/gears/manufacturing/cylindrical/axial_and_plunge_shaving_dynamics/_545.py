...
class ShavingDynamicsCalculationForDesignedGears(_544.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_542.ShaverRedressing[T]':
        ...
        return constructor.new(_542.ShaverRedressing)[T](self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_528.AxialShaverRedressing':
        ...
        if _528.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_528.AxialShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_535.PlungeShaverRedressing':
        ...
        if _535.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_535.PlungeShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None
