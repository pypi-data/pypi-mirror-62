...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _599
...
class BasicConicalGearMachineSettingsGenerated(_599.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
