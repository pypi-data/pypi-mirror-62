...
from mastapy.gears.manufacturing.bevel.control_parameters import _595
...
class ConicalManufacturingSGTControlParameters(_595.ConicalGearManufacturingControlParameters):
    '''ConicalManufacturingSGTControlParameters
