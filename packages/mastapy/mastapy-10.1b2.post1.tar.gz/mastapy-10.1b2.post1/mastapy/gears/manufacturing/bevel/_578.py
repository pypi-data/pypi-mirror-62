...
class ManufacturingMachineDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_577.ManufacturingMachine':
        ...
        return constructor.new(_577.ManufacturingMachine)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_577.ManufacturingMachine':
        ...
        return constructor.new(_577.ManufacturingMachine)(method_result) if method_result else None

    def can_be_removed(self, manufacturing_machine: '_577.ManufacturingMachine') -> 'bool':
    ...
    def rename(self, manufacturing_machine: '_577.ManufacturingMachine', new_name: 'str') -> 'bool':
    ...
    def remove(self, manufacturing_machine: '_577.ManufacturingMachine'):
    ...
    def get_all_items(self) -> 'Iterable[_577.ManufacturingMachine]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_577.ManufacturingMachine))

    def save_changes(self, manufacturing_machine: '_577.ManufacturingMachine'):
