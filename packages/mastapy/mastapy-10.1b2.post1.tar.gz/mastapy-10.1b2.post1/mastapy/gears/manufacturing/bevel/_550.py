...
class AbstractTCA(_1.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_885.ConicalMeshMisalignments':
        ...
        return constructor.new(_885.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
