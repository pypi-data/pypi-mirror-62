...
from mastapy.gears.manufacturing.bevel.cutters import _591, _592
...
class ConicalPinionManufacturingConfig(_554.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_563.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_563.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig else None

    @property
    def pinion_concave_ob_configuration(self) -> '_559.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_559.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None

    @property
    def pinion_convex_ib_configuration(self) -> '_559.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_559.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None

    @property
    def pinion_finish_cutter(self) -> '_591.PinionFinishCutter':
        ...
        return constructor.new(_591.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter else None

    @property
    def pinion_rough_cutter(self) -> '_592.PinionRoughCutter':
        ...
        return constructor.new(_592.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter else None
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_588.PinionRoughMachineSetting':
        ...
        return constructor.new(_588.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting else None
