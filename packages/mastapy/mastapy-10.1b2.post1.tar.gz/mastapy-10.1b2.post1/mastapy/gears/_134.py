...
class GearSetOptimisationResults(_1.APIBase):
    ...
    @property
    def results(self) -> 'List[_133.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_133.GearSetOptimisationResult))
        return value
