...
class WormDesign(_713.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_153.WormAddendumFactor':
        ...
        return constructor.new(_153.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_153.WormAddendumFactor'):
