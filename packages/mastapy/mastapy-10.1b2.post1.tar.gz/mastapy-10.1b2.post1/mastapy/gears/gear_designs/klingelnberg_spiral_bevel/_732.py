...
from mastapy.gears.gear_designs.klingelnberg_conical import _740
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_740.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
