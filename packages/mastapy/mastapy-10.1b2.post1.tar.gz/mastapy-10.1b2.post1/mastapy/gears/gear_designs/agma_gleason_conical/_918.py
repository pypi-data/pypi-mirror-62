...
from mastapy.gears import _117
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _862, _866, _870
...
class AGMAGleasonConicalGearDesign(_879.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_889.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_889.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_889.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_878.ConicalGearCutter':
        ...
        return constructor.new(_878.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_591.PinionFinishCutter':
        ...
        if _591.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_591.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_592.PinionRoughCutter':
        ...
        if _592.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_592.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_593.WheelFinishCutter':
        ...
        if _593.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_593.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_594.WheelRoughCutter':
        ...
        if _594.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new(_594.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_888.DummyConicalGearCutter':
        ...
        if _888.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_888.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def accuracy_grades(self) -> '_117.AccuracyGrades':
        ...
        return constructor.new(_117.AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_862.AGMA20151AccuracyGrades':
        ...
        if _862.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_862.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_866.CylindricalAccuracyGrades':
        ...
        if _866.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_866.CylindricalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_870.ISO1328AccuracyGrades':
        ...
        if _870.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_870.ISO1328AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_917.AGMAGleasonConicalAccuracyGrades':
        ...
        if _917.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_917.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def bevel_gear_material(self) -> '_375.GearMaterial':
        ...
        return constructor.new(_375.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_366.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_366.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_367.BevelGearISOMaterial':
        ...
        return constructor.new(_367.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_369.BevelGearMaterial':
        ...
        return constructor.new(_369.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_373.CylindricalGearMaterial':
        ...
        return constructor.new(_373.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_377.ISOCylindricalGearMaterial':
        ...
        if _377.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_377.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_381.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _381.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_381.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_383.PlasticCylindricalGearMaterial':
        ...
        if _383.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_383.PlasticCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
