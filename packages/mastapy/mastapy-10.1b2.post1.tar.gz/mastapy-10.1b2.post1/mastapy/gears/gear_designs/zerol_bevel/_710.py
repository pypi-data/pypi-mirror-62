...
from mastapy.gears import _155
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.zerol_bevel import _708, _709
...
class ZerolBevelGearSetDesign(_907.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_155.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_155.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_155.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_708.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_708.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_708.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_708.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_709.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_709.ZerolBevelGearMeshDesign))
        return value
