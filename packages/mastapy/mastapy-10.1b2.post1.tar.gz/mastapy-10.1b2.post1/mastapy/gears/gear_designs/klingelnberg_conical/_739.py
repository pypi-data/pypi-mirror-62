...
from mastapy.gears.gear_designs.conical import _893, _881
...
class KlingelnbergConicalGearSetDesign(_881.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_893.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_893.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_893.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_738.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_738.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_738.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_738.KlingelnbergConicalGearMeshDesign))
        return value
