...
from mastapy.gears.gear_designs.cylindrical import _758
...
class TiffAnalysisSettings(_1122.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_758.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_758.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
