...
class CylindricalGearMicroGeometryMap(_1.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_849.MeasuredMapDataTypes':
        ...
        return constructor.new(_849.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_849.MeasuredMapDataTypes'):
    ...
    @property
    def zero_bias_relief(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
