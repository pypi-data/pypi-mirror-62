...
class MicroGeometryViewingOptions(_1.APIBase):
    ...
    @property
    def gear_option(self) -> '_844.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_844.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_844.DrawDefiningGearOrBoth'):
