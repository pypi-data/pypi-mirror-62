...
from mastapy.gears.gear_designs.cylindrical import _813, _814, _812
...
class Scuffing(_1122.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_813.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_813.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_814.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_814.ScuffingTemperatureMethodsISO)(value) if value else None

    @scuffing_temperature_method_iso.setter
    def scuffing_temperature_method_iso(self, value: '_814.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
