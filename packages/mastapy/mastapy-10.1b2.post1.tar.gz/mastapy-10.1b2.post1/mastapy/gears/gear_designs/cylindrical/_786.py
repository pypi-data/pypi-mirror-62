...
from mastapy.gears.gear_designs.cylindrical import _823, _755
...
class CylindricalMeshLinearBacklashSpecification(_823.TolerancedValueSpecification['_755.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
