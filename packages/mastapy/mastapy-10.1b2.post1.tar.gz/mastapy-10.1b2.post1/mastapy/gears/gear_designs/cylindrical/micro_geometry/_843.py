...
class CylindricalGearSetMicroGeometryDutyCycle(_952.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def meshes(self) -> 'List[_836.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_836.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
