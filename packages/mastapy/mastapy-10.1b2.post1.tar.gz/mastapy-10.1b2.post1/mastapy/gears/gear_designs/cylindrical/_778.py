...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _842
...
class CylindricalGearSetDesign(_706.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_754.AddendumModificationDistributionRule':
        ...
        return constructor.new(_754.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_754.AddendumModificationDistributionRule'):
    ...
    @property
    def gear_fit_system(self) -> '_793.GearFitSystems':
        ...
        return constructor.new(_793.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_793.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_842.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_811.Scuffing':
        ...
        return constructor.new(_811.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_806.Micropitting':
        ...
        return constructor.new(_806.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_827.Usage':
        ...
        return constructor.new(_827.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_804.LtcaSettings':
        ...
        return constructor.new(_804.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_404.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_404.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_767.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_767.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_767.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_767.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_264.CylindricalGearSetDutyCycleRating') -> '_779.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_779.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
