...
from mastapy.gears import _138, _121
from mastapy.math_utility.measured_ranges import _1107
...
class CylindricalGearMeshDesign(_705.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_777.CylindricalGearProfileModifications':
        ...
        return constructor.new(_777.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_777.CylindricalGearProfileModifications'):
    ...
    def lubrication_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LubricationMethods':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_LubricationMethods.implicit_type()
    ...
    def lubrication_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_LubricationMethods.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_LubricationMethods.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_mechanism_housing(self) -> '_826.TypeOfMechanismHousing':
        ...
        return constructor.new(_826.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_826.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_121.CentreDistanceChangeMethod':
        ...
        return constructor.new(_121.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_121.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_755.BacklashSpecification':
        ...
        return constructor.new(_755.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1107.ShortLengthRange':
        ...
        return constructor.new(_1107.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_785.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_785.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_767.CylindricalGearDesign':
        ...
        return constructor.new(_767.CylindricalGearDesign)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_b(self) -> '_767.CylindricalGearDesign':
        ...
        return constructor.new(_767.CylindricalGearDesign)(self.wrapped.GearB) if self.wrapped.GearB else None
