...
class CylindricalGearAbstractRack(_1.APIBase):
    ...
    @property
    def gear(self) -> '_767.CylindricalGearDesign':
        ...
        return constructor.new(_767.CylindricalGearDesign)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def shaper_for_agma_rating(self) -> '_510.CylindricalGearShaper':
        ...
        return constructor.new(_510.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
