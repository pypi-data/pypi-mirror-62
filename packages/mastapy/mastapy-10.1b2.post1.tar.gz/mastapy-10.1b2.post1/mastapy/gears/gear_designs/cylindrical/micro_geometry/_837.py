...
from mastapy.gears.gear_designs.cylindrical import _767, _775
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _832, _852
...
class CylindricalGearMicroGeometry(_943.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_767.CylindricalGearDesign':
        ...
        return constructor.new(_767.CylindricalGearDesign)(self.wrapped.CylindricalGear) if self.wrapped.CylindricalGear else None

    @property
    def left_flank(self) -> '_832.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_832.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_832.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_832.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def profile_control_point(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None

    @property
    def flanks(self) -> 'List[_832.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_832.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_852.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_852.MeshedCylindricalGearMicroGeometry))
        return value
