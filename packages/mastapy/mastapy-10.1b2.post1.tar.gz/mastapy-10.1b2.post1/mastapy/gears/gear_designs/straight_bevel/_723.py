...
from mastapy.gears.gear_designs.straight_bevel import _721, _722
...
class StraightBevelGearSetDesign(_907.BevelGearSetDesign):
    '''StraightBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_721.StraightBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_721.StraightBevelGearDesign))
        return value
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_722.StraightBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_722.StraightBevelGearMeshDesign))
        return value
