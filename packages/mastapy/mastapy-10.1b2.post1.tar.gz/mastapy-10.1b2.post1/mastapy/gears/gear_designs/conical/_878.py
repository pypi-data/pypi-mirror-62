...
class ConicalGearCutter(_1.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_887.CutterGaugeLengths':
        ...
        return constructor.new(_887.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_887.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_886.CutterBladeType':
        ...
        return constructor.new(_886.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_886.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_895.TopremEntryType':
        ...
        return constructor.new(_895.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_895.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_896.TopremLetter':
        ...
        return constructor.new(_896.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_896.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_896.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_896.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
