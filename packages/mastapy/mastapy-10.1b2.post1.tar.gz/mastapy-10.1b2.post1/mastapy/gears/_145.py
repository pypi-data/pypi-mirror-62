...
class PocketingPowerLossCoefficients(_1323.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    def extrapolation_options(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ExtrapolationOptions':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ExtrapolationOptions.implicit_type()
    ...
    def extrapolation_options(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ExtrapolationOptions.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ExtrapolationOptions.implicit_type().type_()
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_149.SpecificationForTheEffectOfOilKinematicViscosity]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecificationsForTheEffectOfOilKinematicViscosity, constructor.new(_149.SpecificationForTheEffectOfOilKinematicViscosity))
        return value
