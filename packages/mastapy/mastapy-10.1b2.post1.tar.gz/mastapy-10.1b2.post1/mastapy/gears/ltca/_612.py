...
class GearMeshLoadedContactLine(_1.APIBase):
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_613.GearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_613.GearMeshLoadedContactPoint))
        return value
