...
from mastapy.gears.ltca import _611, _609
from mastapy.gears import _129
from mastapy.nodal_analysis import _1371
from mastapy.gears.analysis import _945
...
class GearMeshLoadDistributionAnalysis(_945.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1063.FourierSeries':
        ...
        return constructor.new(_1063.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_611.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_611.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_609.GearLoadDistributionAnalysis', flank: '_129.GearFlanks', stress_type: '_1371.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_609.GearLoadDistributionAnalysis', stress_type: '_1371.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
