...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _850
from mastapy._internal import constructor, conversion
from mastapy.gears.ltca.cylindrical import _625
...
class CylindricalMeshLoadDistributionAtRotation(_611.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_850.MeshAlignment':
        ...
        return constructor.new(_850.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None

    @property
    def loaded_contact_lines(self) -> 'List[_625.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_625.CylindricalGearMeshLoadedContactLine))
        return value
