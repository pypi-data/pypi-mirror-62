...
from mastapy.gears.ltca import _604, _610
from mastapy.gears.ltca.cylindrical import _626, _628
from mastapy.math_utility import _1048
...
class CylindricalGearMeshLoadDistributionAnalysis(_610.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_651.CylindricalMeshLoadCase':
        ...
        return constructor.new(_651.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_604.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_604.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_604.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_604.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_628.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_628.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_604.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_604.CylindricalMeshedGearLoadDistributionAnalysis))
        return value

    @property
    def transmission_error_against_rotation(self) -> 'List[_1048.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorAgainstRotation, constructor.new(_1048.Vector2D))
        return value
