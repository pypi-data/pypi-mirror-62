...
class CylindricalGearLoadDistributionAnalysis(_609.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_260.CylindricalGearRating':
        ...
        return constructor.new(_260.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
