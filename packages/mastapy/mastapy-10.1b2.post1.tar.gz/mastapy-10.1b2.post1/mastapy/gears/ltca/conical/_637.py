...
from mastapy.gears.manufacturing.bevel import _562
...
class ConicalMeshLoadDistributionAnalysis(_610.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_654.ConicalMeshLoadCase':
        ...
        return constructor.new(_654.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None

    @property
    def conical_mesh_manufacturing_analysis(self) -> '_562.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_562.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_636.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_636.ConicalMeshedGearLoadDistributionAnalysis))
        return value
