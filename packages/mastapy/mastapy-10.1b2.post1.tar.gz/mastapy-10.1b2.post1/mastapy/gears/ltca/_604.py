...
from mastapy.gears.cylindrical import _934, _933
...
class CylindricalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_934.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_934.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_933.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_933.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_603.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1064.GriddedSurface':
        ...
        return constructor.new(_1064.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_603.ContactResultType', include_tip_contact: 'bool') -> '_1064.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_603.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
