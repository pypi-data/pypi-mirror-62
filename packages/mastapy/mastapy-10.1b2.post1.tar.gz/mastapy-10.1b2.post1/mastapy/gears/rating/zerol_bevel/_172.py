...
class ZerolBevelGearMeshRating(_338.BevelGearMeshRating):
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_709.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_709.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
