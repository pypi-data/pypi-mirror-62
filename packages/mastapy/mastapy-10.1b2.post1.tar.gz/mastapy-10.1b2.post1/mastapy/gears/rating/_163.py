...
from mastapy.gears.load_case import _642
from mastapy.gears.load_case.worm import _645
from mastapy._internal.cast_exception import CastException
from mastapy.gears.load_case.face import _648
from mastapy.gears.load_case.cylindrical import _651
from mastapy.gears.load_case.conical import _654
from mastapy.gears.load_case.concept import _657
from mastapy.gears.load_case.bevel import _659
...
class GearMeshRating(_156.AbstractGearMeshRating):
    '''GearMeshRating
    ...
    @property
    def mesh_load_case(self) -> '_642.MeshLoadCase':
        ...
        return constructor.new(_642.MeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_worm_mesh_load_case(self) -> '_645.WormMeshLoadCase':
        ...
        if _645.WormMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
        ...
        return constructor.new(_645.WormMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_face_mesh_load_case(self) -> '_648.FaceMeshLoadCase':
        ...
        if _648.FaceMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
        ...
        return constructor.new(_648.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_cylindrical_mesh_load_case(self) -> '_651.CylindricalMeshLoadCase':
        ...
        if _651.CylindricalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_conical_mesh_load_case(self) -> '_654.ConicalMeshLoadCase':
        ...
        if _654.ConicalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
        ...
        return constructor.new(_654.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_concept_mesh_load_case(self) -> '_657.ConceptMeshLoadCase':
        ...
        if _657.ConceptMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
        ...
        return constructor.new(_657.ConceptMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_bevel_mesh_load_case(self) -> '_659.BevelMeshLoadCase':
        ...
        if _659.BevelMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
        ...
        return constructor.new(_659.BevelMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None
