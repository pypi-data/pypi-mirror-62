...
class AGMAGleasonConicalGearMeshRating(_323.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_894.LoadDistributionFactorMethods':
        ...
        return constructor.new(_894.LoadDistributionFactorMethods)(value) if value else None
