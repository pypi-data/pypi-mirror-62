...
class WormGearMeshRating(_163.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_714.WormGearMeshDesign':
        ...
        return constructor.new(_714.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
