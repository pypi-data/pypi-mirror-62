...
from mastapy.gears.rating.iso_10300 import _228, _227
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.hypoid.standards import _246
...
class HypoidGearMeshRating(_349.AGMAGleasonConicalGearMeshRating):
    ...
    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b1(self) -> '_228.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_228.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b2(self) -> '_227.Iso10300MeshSingleFlankRatingHypoidMethodB2':
        ...
        return constructor.new(_227.Iso10300MeshSingleFlankRatingHypoidMethodB2)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2 else None

    @property
    def gleason_hypoid_mesh_single_flank_rating(self) -> '_246.GleasonHypoidMeshSingleFlankRating':
        ...
        return constructor.new(_246.GleasonHypoidMeshSingleFlankRating)(self.wrapped.GleasonHypoidMeshSingleFlankRating) if self.wrapped.GleasonHypoidMeshSingleFlankRating else None

    @property
    def hypoid_gear_mesh(self) -> '_742.HypoidGearMeshDesign':
        ...
        return constructor.new(_742.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
    ...
    @property
    def hypoid_gear_ratings(self) -> 'List[_242.HypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearRatings, constructor.new(_242.HypoidGearRating))
        return value
