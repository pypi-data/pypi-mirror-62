...
from mastapy.gears.rating.hypoid import _241, _242
...
class HypoidGearSetRating(_351.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_241.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_241.HypoidGearMeshRating))
        return value
