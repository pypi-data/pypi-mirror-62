...
class ConceptGearMeshRating(_163.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_902.ConceptGearMeshDesign':
        ...
        return constructor.new(_902.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
