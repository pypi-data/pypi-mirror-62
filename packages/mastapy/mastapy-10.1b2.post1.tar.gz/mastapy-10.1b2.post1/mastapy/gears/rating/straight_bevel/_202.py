...
class StraightBevelGearMeshRating(_338.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_722.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_722.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
