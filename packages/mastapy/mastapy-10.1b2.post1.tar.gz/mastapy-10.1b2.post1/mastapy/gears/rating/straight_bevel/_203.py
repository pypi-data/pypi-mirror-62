...
class StraightBevelGearRating(_339.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_721.StraightBevelGearDesign':
        ...
        return constructor.new(_721.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
