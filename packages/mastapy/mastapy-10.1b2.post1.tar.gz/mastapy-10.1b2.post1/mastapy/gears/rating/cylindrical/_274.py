...
class MeshRatingForReports(_1.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_258.CylindricalGearMeshRating':
        ...
        return constructor.new(_258.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
