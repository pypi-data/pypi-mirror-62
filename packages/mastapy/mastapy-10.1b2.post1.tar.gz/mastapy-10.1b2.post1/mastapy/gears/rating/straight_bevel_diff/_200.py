...
from mastapy.gears.rating.straight_bevel_diff import _198, _199
...
class StraightBevelDiffGearSetRating(_326.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_198.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_198.StraightBevelDiffGearMeshRating))
        return value
