...
from mastapy.gears import _127, _126
...
class CylindricalMeshLoadCase(_642.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_127.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_127.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_127.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_803.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_803.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
