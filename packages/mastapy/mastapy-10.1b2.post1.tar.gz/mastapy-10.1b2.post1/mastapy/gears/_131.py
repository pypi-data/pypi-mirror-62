...
from mastapy.gears.rating.cylindrical import _276, _262
from mastapy.gears.gear_designs.cylindrical import _822, _771
from mastapy.materials import _75, _64
...
class GearSetDesignGroup(_1.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_276.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_276.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_276.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_822.TolerancedMetalMeasurements':
        ...
        return constructor.new(_822.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_822.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_64.GeneralTransmissionProperties':
        ...
        return constructor.new(_64.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_262.CylindricalGearRatingSettings':
        ...
        return constructor.new(_262.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
