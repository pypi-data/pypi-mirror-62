...
class StraightBevelGear(_2036.BevelGear):
    '''StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_721.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_721.StraightBevelGearDesign':
        ...
        return constructor.new(_721.StraightBevelGearDesign)(self.wrapped.StraightBevelGearDesign) if self.wrapped.StraightBevelGearDesign else None
