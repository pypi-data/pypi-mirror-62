...
class KlingelnbergCycloPalloidHypoidGear(_2053.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidHypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_733.KlingelnbergCycloPalloidHypoidGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_733.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_733.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign else None
