...
class ZerolBevelGear(_2036.BevelGear):
    '''ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_708.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_708.ZerolBevelGearDesign':
        ...
        return constructor.new(_708.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGearDesign) if self.wrapped.ZerolBevelGearDesign else None
