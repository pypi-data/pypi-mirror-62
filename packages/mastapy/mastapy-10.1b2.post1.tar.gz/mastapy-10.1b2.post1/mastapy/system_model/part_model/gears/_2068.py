...
class WormGear(_2047.Gear):
    ...
    @property
    def active_gear_design(self) -> '_713.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_713.WormGearDesign':
        ...
        return constructor.new(_713.WormGearDesign)(self.wrapped.WormGearDesign) if self.wrapped.WormGearDesign else None
