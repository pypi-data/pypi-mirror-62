...
from mastapy.system_model.part_model.gears import _2047
...
class CylindricalGear(_2047.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_767.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_767.CylindricalGearDesign':
        ...
        return constructor.new(_767.CylindricalGearDesign)(self.wrapped.CylindricalGearDesign) if self.wrapped.CylindricalGearDesign else None
