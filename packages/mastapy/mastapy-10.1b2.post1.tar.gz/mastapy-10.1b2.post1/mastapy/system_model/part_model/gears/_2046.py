...
from mastapy.system_model.part_model.gears import _2045, _2049
...
class FaceGearSet(_2049.GearSet):
    '''FaceGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_751.FaceGearSetDesign':
    ...
    @property
    def face_gears(self) -> 'List[_2045.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2045.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1851.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1851.FaceGearMesh))
        return value
