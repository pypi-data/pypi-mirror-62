...
from mastapy.system_model.part_model.couplings import _2114, _2116
...
class SynchroniserHalf(_2116.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2114.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2114.SynchroniserCone))
        return value
