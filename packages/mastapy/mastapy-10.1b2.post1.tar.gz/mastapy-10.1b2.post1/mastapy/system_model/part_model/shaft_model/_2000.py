...
class Shaft(_1960.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1977.GuideImage':
        ...
        return constructor.new(_1977.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None

    @property
    def active_definition(self) -> '_41.SimpleShaftDefinition':
        ...
        return constructor.new(_41.SimpleShaftDefinition)(self.wrapped.ActiveDefinition) if self.wrapped.ActiveDefinition else None
    ...
    def mount_component(self, component: '_1984.MountableComponent', offset: 'float'):
