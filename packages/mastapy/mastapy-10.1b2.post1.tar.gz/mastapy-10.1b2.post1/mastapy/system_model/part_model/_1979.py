...
from mastapy.system_model.part_model import _1960
...
class ImportedFEComponent(_1960.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    def current_fe(self, value: 'list_with_selected_item.ListWithSelectedItem_ImportedFE.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ImportedFE.TYPE
    ...
    @property
    def default_active_imported_fe(self) -> '_1913.ImportedFE':
        ...
        return constructor.new(_1913.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1913.ImportedFE':
        ...
        return constructor.new(_1913.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_1913.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1913.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1913.ImportedFE') -> 'bool':
