...
from mastapy.system_model.part_model.part_groups import _2004, _2005, _2008
...
class ConcentricPartGroupParallelToThis(_1.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2004.ConcentricOrParallelPartGroup':
        ...
        return constructor.new(_2004.ConcentricOrParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2005.ConcentricPartGroup':
        ...
        if _2005.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2005.ConcentricPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2008.ParallelPartGroup':
        ...
        if _2008.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2008.ParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None
