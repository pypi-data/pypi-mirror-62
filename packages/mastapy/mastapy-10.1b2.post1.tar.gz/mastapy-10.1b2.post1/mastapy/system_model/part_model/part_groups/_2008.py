...
from mastapy.system_model.part_model.part_groups import _2005, _2007, _2004
...
class ParallelPartGroup(_2004.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2005.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2005.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2007.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2007.DesignMeasurements))
        return value
