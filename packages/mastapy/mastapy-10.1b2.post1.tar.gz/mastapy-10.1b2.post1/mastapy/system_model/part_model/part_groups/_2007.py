...
class DesignMeasurements(_1.APIBase):
    ...
    @property
    def component_connections(self) -> 'List[_1814.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1814.ComponentMeasurer))
        return value
