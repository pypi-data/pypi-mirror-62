...
from mastapy.geometry import _114
from mastapy.system_model.part_model.projections import _2003
from mastapy.system_model.part_model.part_groups import _2008
...
class RootAssembly(_1958.Assembly):
    '''RootAssembly
    ...
    @property
    def packaging_limits(self) -> '_114.PackagingLimits':
        ...
        return constructor.new(_114.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2003.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2003.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2008.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2008.ParallelPartGroup))
        return value
