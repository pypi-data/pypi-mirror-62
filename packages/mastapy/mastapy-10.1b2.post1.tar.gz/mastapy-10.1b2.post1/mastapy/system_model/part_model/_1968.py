...
from mastapy.system_model.part_model import _1969
...
class ComponentsConnectedResult(_1.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_1969.ConnectedSockets':
        ...
        return constructor.new(_1969.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
