...
class FlexiblePinAssembly(_1995.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2042.CylindricalGear':
        ...
        return constructor.new(_2042.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
