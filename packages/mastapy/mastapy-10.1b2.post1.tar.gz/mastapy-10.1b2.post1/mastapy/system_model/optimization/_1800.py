...
from mastapy.system_model.optimization import _1799
...
class OptimizationStep(_1.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1799.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1799.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1799.MicroGeometryOptimisationTarget'):
