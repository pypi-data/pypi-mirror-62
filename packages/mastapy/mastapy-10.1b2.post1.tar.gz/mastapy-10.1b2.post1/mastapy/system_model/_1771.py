...
from mastapy.utility_gui import _1478
from mastapy import _4, _6479, _1
...
from mastapy.system_model.part_model import (
    _1994, _1991, _1993, _1987,
    _1958, _1959, _1960, _1963,
    _1965, _1966, _1967, _1970,
    _1971, _1974, _1975, _1976,
    _1979, _1982, _1983, _1984,
    _1986, _1988, _1990, _1995,
    _1996, _1997
)
from mastapy.gears import _125, _131
from mastapy.gears.materials import _378
from mastapy.utility import _1120, _1119, _1118
from mastapy.system_model import _1790, _1789
from mastapy.shafts import _35
from mastapy.detailed_rigid_connectors.splines import _965
from mastapy._internal.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _2029, _2050, _2030, _2031,
    _2032, _2033, _2034, _2035,
    _2036, _2037, _2038, _2039,
...
from mastapy.system_model.imported_fes import _1893
from mastapy.bearings.bearing_results.rolling import _1573
from mastapy.system_model.part_model.configurations import _2125, _2123, _2126
...
from mastapy.utility.model_validation import _1295
from mastapy.system_model.database_access import _1810
from mastapy.bearings.bearing_designs.rolling import _1737
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2455
...
from mastapy.gears.gear_designs.creation_options import _871, _874, _873
...
class Design(_1.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1478.MASTAGUI':
        ...
        return constructor.new(_1478.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_378.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_378.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_378.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_378.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1120.FileHistoryItem':
        ...
        return constructor.new(_1120.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1790.TransmissionTemperatureSet':
        ...
        return constructor.new(_1790.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_965.DetailedSplineJointSettings':
        ...
        return constructor.new(_965.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1119.FileHistory':
        ...
        return constructor.new(_1119.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2029.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2029.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1789.SystemReporting':
        ...
        return constructor.new(_1789.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1893.BatchOperations':
        ...
        return constructor.new(_1893.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1573.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1573.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2029.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2029.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2125.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2125.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2123.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2123.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2126.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2126.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5215.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5215.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_6162.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_6162.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_5216.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5216.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_1993.RootAssembly':
        ...
        return constructor.new(_1993.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2050.GearSetConfiguration':
        ...
        return constructor.new(_2050.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @property
    def status(self) -> '_1295.Status':
        ...
        return constructor.new(_1295.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1810.Databases':
        ...
        return constructor.new(_1810.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    def remove_bearing_from_database(self, rolling_bearing: '_1737.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5215.DesignState':
        ...
        return constructor.new(_5215.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5216.DutyCycle':
        ...
        return constructor.new(_5216.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1295.Status':
        ...
        return constructor.new(_1295.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6479.TaskProgress') -> '_1295.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2455.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2455.SynchroniserShift':
        ...
        return constructor.new(_2455.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2455.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5215.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5216.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1958.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1958.Assembly.TYPE](), constructor.new(_1958.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1118.ExternalFullFEFileOption'] = _1118.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2085.BeltCreationOptions':
        ...
        return constructor.new(_2085.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2087.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2087.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2088.ShaftCreationOptions':
        ...
        return constructor.new(_2088.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_871.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_871.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2086.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2086.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_874.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_874.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None

    def new_hypoid_gear_set_creation_options(self) -> '_873.HypoidGearSetCreationOptions':
        ...
        return constructor.new(_873.HypoidGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(method_result) if method_result else None
