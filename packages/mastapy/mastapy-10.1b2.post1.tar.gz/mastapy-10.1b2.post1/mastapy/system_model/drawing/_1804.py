...
from mastapy.system_model.drawing import _1808
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_1.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2286.ShaftSystemDeflection':
        ...
        return constructor.new(_2286.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection else None

    @property
    def node_results(self) -> 'List[_1808.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1808.ShaftDeflectionDrawingNodeItem))
        return value
