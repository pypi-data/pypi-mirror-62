...
class RollingRingConnectionGearWhineAnalysis(_5310.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2280.RollingRingConnectionSystemDeflection':
