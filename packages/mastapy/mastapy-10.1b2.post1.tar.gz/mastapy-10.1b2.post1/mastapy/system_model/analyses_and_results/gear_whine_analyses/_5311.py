...
from mastapy.system_model.analyses_and_results.system_deflections import _2256, _2259, _2262
...
class KlingelnbergCycloPalloidConicalGearGearWhineAnalysis(_5262.ConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2053.KlingelnbergCycloPalloidConicalGear':
    ...
    @property
    def system_deflection_results(self) -> '_2256.KlingelnbergCycloPalloidConicalGearSystemDeflection':
