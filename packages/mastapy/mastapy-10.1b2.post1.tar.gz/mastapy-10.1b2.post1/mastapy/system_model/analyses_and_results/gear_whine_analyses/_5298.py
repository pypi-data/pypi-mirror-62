...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5254, _5231
...
class GearMeshTEExcitationDetail(_5231.AbstractPeriodicExcitationDetail):
    '''GearMeshTEExcitationDetail
    ...
    def get_compliance_and_force_data(self, excitation_type: '_6175.TEExcitationType') -> '_5254.ComplianceAndForceData':
        ...
        return constructor.new(_5254.ComplianceAndForceData)(method_result) if method_result else None
