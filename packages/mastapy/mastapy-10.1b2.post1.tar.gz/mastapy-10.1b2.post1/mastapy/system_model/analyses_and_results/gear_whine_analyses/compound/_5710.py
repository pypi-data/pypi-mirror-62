...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5704
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundGearWhineAnalysis(_5704.KlingelnbergCycloPalloidConicalGearMeshCompoundGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5318.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5318.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5318.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5318.KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis))
        return value
