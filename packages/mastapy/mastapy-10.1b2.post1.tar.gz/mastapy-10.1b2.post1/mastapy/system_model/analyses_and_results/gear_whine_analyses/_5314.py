...
class KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis(_5311.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2259.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
