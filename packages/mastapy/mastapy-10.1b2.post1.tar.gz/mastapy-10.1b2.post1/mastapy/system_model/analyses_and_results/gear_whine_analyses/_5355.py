...
class StraightBevelGearMeshGearWhineAnalysis(_5246.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2298.StraightBevelGearMeshSystemDeflection':
