...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5385
...
class ResultLocationSelectionGroup(_1.APIBase):
    ...
    @property
    def response_locations(self) -> 'List[_5385.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResponseLocations, constructor.new(_5385.ResultNodeSelection))
        return value
