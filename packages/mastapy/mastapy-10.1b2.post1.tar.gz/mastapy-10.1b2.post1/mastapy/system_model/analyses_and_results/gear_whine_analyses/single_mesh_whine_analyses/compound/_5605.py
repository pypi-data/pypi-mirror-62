...
class SpringDamperHalfCompoundSingleMeshWhineAnalysis(_5546.CouplingHalfCompoundSingleMeshWhineAnalysis):
    '''SpringDamperHalfCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5483.SpringDamperHalfSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5483.SpringDamperHalfSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_5483.SpringDamperHalfSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_5483.SpringDamperHalfSingleMeshWhineAnalysis))
        return value
