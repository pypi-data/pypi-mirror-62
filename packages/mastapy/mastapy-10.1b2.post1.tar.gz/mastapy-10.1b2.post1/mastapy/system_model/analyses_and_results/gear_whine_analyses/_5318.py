...
class KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis(_5312.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2260.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
