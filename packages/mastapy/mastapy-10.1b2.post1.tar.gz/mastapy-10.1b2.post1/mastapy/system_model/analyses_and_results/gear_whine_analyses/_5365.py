...
class TorqueConverterPumpGearWhineAnalysis(_5269.CouplingHalfGearWhineAnalysis):
    '''TorqueConverterPumpGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2311.TorqueConverterPumpSystemDeflection':
