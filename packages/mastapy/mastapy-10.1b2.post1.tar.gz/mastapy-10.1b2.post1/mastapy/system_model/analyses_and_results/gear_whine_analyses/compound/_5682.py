...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5651
...
class CVTCompoundGearWhineAnalysis(_5651.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
