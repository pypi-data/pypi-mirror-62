...
class BevelDifferentialSunGearGearWhineAnalysis(_5240.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2198.BevelDifferentialSunGearSystemDeflection':
