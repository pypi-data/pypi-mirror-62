...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5351, _5352, _5247
...
class StraightBevelDiffGearSetGearWhineAnalysis(_5247.BevelGearSetGearWhineAnalysis):
    '''StraightBevelDiffGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2296.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5351.StraightBevelDiffGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5351.StraightBevelDiffGearGearWhineAnalysis))
        return value

    @property
    def straight_bevel_diff_gears_gear_whine_analysis(self) -> 'List[_5351.StraightBevelDiffGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsGearWhineAnalysis, constructor.new(_5351.StraightBevelDiffGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5352.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5352.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_gear_whine_analysis(self) -> 'List[_5352.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesGearWhineAnalysis, constructor.new(_5352.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value
