...
class ZerolBevelGearMeshGearWhineAnalysis(_5246.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2321.ZerolBevelGearMeshSystemDeflection':
