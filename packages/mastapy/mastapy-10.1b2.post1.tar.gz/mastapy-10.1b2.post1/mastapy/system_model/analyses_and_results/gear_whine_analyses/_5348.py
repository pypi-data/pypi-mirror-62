...
class SpringDamperConnectionGearWhineAnalysis(_5267.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2292.SpringDamperConnectionSystemDeflection':
