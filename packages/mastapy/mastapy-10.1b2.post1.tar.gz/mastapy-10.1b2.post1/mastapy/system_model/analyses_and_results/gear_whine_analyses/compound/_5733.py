...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5643
...
class SpecialisedAssemblyCompoundGearWhineAnalysis(_5643.AbstractAssemblyCompoundGearWhineAnalysis):
    '''SpecialisedAssemblyCompoundGearWhineAnalysis
