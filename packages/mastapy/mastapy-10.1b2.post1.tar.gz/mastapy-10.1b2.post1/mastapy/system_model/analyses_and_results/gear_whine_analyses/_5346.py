...
class SpiralBevelGearMeshGearWhineAnalysis(_5246.BevelGearMeshGearWhineAnalysis):
    '''SpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2289.SpiralBevelGearMeshSystemDeflection':
