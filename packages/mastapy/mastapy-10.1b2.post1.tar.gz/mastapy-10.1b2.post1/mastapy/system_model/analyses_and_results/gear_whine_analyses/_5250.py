...
class ClutchConnectionGearWhineAnalysis(_5267.CouplingConnectionGearWhineAnalysis):
    '''ClutchConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2204.ClutchConnectionSystemDeflection':
