...
class SynchroniserHalfGearWhineAnalysis(_5361.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2303.SynchroniserHalfSystemDeflection':
