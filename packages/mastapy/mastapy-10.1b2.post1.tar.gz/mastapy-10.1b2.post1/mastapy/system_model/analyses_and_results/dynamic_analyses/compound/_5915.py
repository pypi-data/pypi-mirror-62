...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5793
...
class ClutchCompoundDynamicAnalysis(_5931.CouplingCompoundDynamicAnalysis):
    '''ClutchCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5793.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5793.ClutchDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_5793.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_5793.ClutchDynamicAnalysis))
        return value
