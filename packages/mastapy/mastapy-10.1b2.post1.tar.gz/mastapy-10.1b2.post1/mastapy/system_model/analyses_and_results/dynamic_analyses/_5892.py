...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5890, _5891, _5828
...
class WormGearSetDynamicAnalysis(_5828.GearSetDynamicAnalysis):
    '''WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_5890.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsDynamicAnalysis, constructor.new(_5890.WormGearDynamicAnalysis))
        return value

    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_5891.WormGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesDynamicAnalysis, constructor.new(_5891.WormGearMeshDynamicAnalysis))
        return value
