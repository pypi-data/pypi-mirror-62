...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5900
...
class BevelGearSetCompoundDynamicAnalysis(_5900.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
