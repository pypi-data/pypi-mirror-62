...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5782
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5910
...
class BevelDifferentialGearCompoundDynamicAnalysis(_5910.BevelGearCompoundDynamicAnalysis):
    '''BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5782.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5782.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5782.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5782.BevelDifferentialGearDynamicAnalysis))
        return value
