...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5775
...
class BevelGearDynamicAnalysis(_5775.AGMAGleasonConicalGearDynamicAnalysis):
    '''BevelGearDynamicAnalysis
