...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5903
...
class CVTBeltConnectionCompoundDynamicAnalysis(_5903.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
