...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5779
...
class BearingCompoundDynamicAnalysis(_5930.ConnectorCompoundDynamicAnalysis):
    '''BearingCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5779.BearingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5779.BearingDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5779.BearingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5779.BearingDynamicAnalysis))
        return value
