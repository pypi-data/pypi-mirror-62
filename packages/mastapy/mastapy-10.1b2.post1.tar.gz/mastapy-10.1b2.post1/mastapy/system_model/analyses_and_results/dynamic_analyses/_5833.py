...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5774
...
class ImportedFEComponentDynamicAnalysis(_5774.AbstractShaftOrHousingDynamicAnalysis):
    '''ImportedFEComponentDynamicAnalysis
