...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4561
...
class RootAssemblyCompoundModalAnalysisAtASpeed(_4561.AssemblyCompoundModalAnalysisAtASpeed):
    '''RootAssemblyCompoundModalAnalysisAtASpeed
