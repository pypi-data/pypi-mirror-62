...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4462, _4461, _4487
...
class ConceptGearSetModalAnalysisAtASpeed(_4487.GearSetModalAnalysisAtASpeed):
    '''ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_4462.ConceptGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtASpeed, constructor.new(_4462.ConceptGearModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_4461.ConceptGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtASpeed, constructor.new(_4461.ConceptGearMeshModalAnalysisAtASpeed))
        return value
