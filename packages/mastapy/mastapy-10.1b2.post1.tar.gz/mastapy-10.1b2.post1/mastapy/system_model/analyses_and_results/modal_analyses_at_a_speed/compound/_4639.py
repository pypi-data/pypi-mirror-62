...
class RollingRingAssemblyCompoundModalAnalysisAtASpeed(_4646.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    '''RollingRingAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4518.RollingRingAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4518.RollingRingAssemblyModalAnalysisAtASpeed))
        return value

    @property
    def assembly_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4518.RollingRingAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisAtASpeedLoadCases, constructor.new(_4518.RollingRingAssemblyModalAnalysisAtASpeed))
        return value
