...
TMeasurement = TypeVar('TMeasurement', bound='_1138.MeasurementBase')


class WhineWaterfallReferenceValues(_4803.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
