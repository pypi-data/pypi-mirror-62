...
from mastapy.utility.modal_analysis import _1298
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2160.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1298.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1298.DesignEntityExcitationDescription))
        return value
