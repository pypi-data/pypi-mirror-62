...
from mastapy.system_model.analyses_and_results.modal_analyses import _4809, _4808, _4693
...
class ZerolBevelGearSetModalAnalysis(_4693.BevelGearSetModalAnalysis):
    '''ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4809.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysis, constructor.new(_4809.ZerolBevelGearModalAnalysis))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4808.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysis, constructor.new(_4808.ZerolBevelGearMeshModalAnalysis))
        return value
