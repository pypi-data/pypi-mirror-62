...
from mastapy.nodal_analysis import _1342, _1341
...
class ModalAnalysisBarModelFEExportOptions(_1.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1341.BarModelAnalysisType':
        ...
        return constructor.new(_1341.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1341.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1433.EigenvalueOptions':
        ...
        return constructor.new(_1433.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
