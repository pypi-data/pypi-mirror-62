...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4815
...
class CalculateFullFEResultsForMode(_1.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4815.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4815.ModalCMSResultsForModeAndFE))
        return value
