...
class CouplingModalAnalysis(_4775.SpecialisedAssemblyModalAnalysis):
    '''CouplingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2224.CouplingSystemDeflection':
