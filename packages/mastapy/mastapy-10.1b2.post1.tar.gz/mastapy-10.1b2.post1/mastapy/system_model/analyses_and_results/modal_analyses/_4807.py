...
from mastapy.system_model.analyses_and_results.modal_analyses import _4806, _4805, _4732
...
class WormGearSetModalAnalysis(_4732.GearSetModalAnalysis):
    '''WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4806.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_4806.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4805.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_4805.WormGearMeshModalAnalysis))
        return value
