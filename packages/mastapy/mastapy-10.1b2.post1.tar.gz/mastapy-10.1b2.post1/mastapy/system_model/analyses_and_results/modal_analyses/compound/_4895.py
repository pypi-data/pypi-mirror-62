...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4857
...
class OilSealCompoundModalAnalysis(_4857.ConnectorCompoundModalAnalysis):
    '''OilSealCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4755.OilSealModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4755.OilSealModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4755.OilSealModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4755.OilSealModalAnalysis))
        return value
