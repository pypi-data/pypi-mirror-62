...
class CouplingConnectionModalAnalysis(_4738.InterMountableComponentConnectionModalAnalysis):
    '''CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2222.CouplingConnectionSystemDeflection':
