...
from mastapy.system_model.analyses_and_results.modal_analyses import _4750, _4682
...
class RootAssemblyModalAnalysis(_4682.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_4750.ModalAnalysis':
        ...
        return constructor.new(_4750.ModalAnalysis)(self.wrapped.ModalAnalysisInputs) if self.wrapped.ModalAnalysisInputs else None
