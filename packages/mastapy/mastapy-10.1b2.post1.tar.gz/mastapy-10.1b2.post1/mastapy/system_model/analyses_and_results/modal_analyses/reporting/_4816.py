...
class PerModeResultsReport(_1264.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1320.TableAndChartOptions':
    ...
    def display_option(self, value: '_1320.TableAndChartOptions'):
