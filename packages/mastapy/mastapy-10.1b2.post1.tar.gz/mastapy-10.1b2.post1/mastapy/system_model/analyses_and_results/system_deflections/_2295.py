...
class StraightBevelDiffGearMeshSystemDeflection(_2199.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3294.StraightBevelDiffGearMeshPowerFlow':
    ...
    @property
    def rating(self) -> '_198.StraightBevelDiffGearMeshRating':
