...
from mastapy.nodal_analysis.nodal_entities import _1405
...
class ShaftSectionSystemDeflection(_1405.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2284.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2284.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2284.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2284.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
