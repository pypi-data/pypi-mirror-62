...
from mastapy.system_model.analyses_and_results.power_flows import _3195, _3253, _3285
...
class AbstractShaftOrHousingSystemDeflection(_2208.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3195.AbstractShaftOrHousingPowerFlow':
