...
from mastapy.system_model.analyses_and_results.power_flows import _3207
...
class BevelDifferentialSunGearSystemDeflection(_2196.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3207.BevelDifferentialSunGearPowerFlow':
