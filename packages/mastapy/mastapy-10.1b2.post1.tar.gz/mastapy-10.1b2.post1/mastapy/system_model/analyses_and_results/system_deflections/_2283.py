...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2332
...
class ShaftHubConnectionSystemDeflection(_2221.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3284.ShaftHubConnectionPowerFlow':
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2332.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2332.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2332.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2332.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2332.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2332.SplineFlankContactReporting))
        return value
