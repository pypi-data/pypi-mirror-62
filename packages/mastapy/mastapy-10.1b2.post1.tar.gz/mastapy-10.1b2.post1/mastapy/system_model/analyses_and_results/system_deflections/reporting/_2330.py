...
class RigidlyConnectedComponentGroupSystemDeflection(_2160.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2208.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2208.ComponentSystemDeflection))
        return value
