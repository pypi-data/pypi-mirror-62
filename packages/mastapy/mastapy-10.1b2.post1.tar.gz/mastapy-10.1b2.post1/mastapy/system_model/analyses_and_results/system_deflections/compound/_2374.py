...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2384
...
class CylindricalGearCompoundSystemDeflection(_2384.GearCompoundSystemDeflection):
    '''CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_255.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_duty_cycle_rating(self) -> '_255.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_255.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2234.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2234.CylindricalGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2234.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2234.CylindricalGearSystemDeflection))
        return value
