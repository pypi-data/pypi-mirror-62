...
from mastapy.system_model.drawing import _1807, _1805
...
class SystemDeflectionDrawStyle(_1805.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1807.ScalingDrawStyle':
        ...
        return constructor.new(_1807.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
