...
from mastapy.system_model.analyses_and_results.system_deflections import _2300, _2298, _2200
...
class StraightBevelGearSetSystemDeflection(_2200.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3299.StraightBevelGearSetPowerFlow':
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2300.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2300.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2298.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2298.StraightBevelGearMeshSystemDeflection))
        return value
