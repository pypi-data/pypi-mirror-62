...
from mastapy.system_model.analyses_and_results.power_flows import _3206
...
class BevelDifferentialPlanetGearSystemDeflection(_2196.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3206.BevelDifferentialPlanetGearPowerFlow':
