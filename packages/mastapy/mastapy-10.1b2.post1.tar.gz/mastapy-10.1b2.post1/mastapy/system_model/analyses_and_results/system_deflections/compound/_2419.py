...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2338
...
class RootAssemblyCompoundSystemDeflection(_2338.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3406.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3406.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1944.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1944.RaceBearingFESystemDeflection))
        return value
