...
from mastapy.utility.report import _1264
...
class ShaftSystemDeflectionSectionsReport(_1264.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1320.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1320.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1320.TableAndChartOptions'):
