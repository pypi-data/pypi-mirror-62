...
from mastapy.gears.manufacturing.cylindrical import _396
...
class CylindricalGearSystemDeflection(_2247.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3237.CylindricalGearPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_396.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_396.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None
