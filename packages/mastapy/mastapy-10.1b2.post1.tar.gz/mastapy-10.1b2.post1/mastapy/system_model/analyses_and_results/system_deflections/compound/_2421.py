...
class ShaftDutyCycleSystemDeflection(_1.APIBase):
    ...
    @property
    def shaft_design(self) -> '_2000.Shaft':
        ...
        return constructor.new(_2000.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign else None

    @property
    def shaft_damage_results(self) -> '_20.ShaftDamageResults':
        ...
        return constructor.new(_20.ShaftDamageResults)(self.wrapped.ShaftDamageResults) if self.wrapped.ShaftDamageResults else None

    @property
    def shaft_static_analyses(self) -> 'List[_2286.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2286.ShaftSystemDeflection))
        return value
