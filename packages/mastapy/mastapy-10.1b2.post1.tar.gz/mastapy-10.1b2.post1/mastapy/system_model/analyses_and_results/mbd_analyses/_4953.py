...
from mastapy.nodal_analysis import _1361
...
class BeltConnectionMultiBodyDynamicsAnalysis(_5011.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1361.LoadingStatus':
        ...
        return constructor.new(_1361.LoadingStatus)(value) if value else None
