...
from mastapy.system_model.analyses_and_results.analysis_cases import _6466
...
class ConnectionMultiBodyDynamicsAnalysis(_6466.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5027.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5027.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
