...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4956
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5103
...
class BevelDifferentialGearCompoundMultiBodyDynamicsAnalysis(_5103.BevelGearCompoundMultiBodyDynamicsAnalysis):
    '''BevelDifferentialGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4956.BevelDifferentialGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4956.BevelDifferentialGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4956.BevelDifferentialGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4956.BevelDifferentialGearMultiBodyDynamicsAnalysis))
        return value
