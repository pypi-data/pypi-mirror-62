...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5000, _5049
...
class GearSetMultiBodyDynamicsAnalysis(_5049.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5000.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5000.GearMultiBodyDynamicsAnalysis))
        return value
