...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5072, _4982
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_4982.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5072.TorqueConverterStatus':
        ...
        return constructor.new(_5072.TorqueConverterStatus)(value) if value else None
