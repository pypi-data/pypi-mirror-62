...
class GearMultiBodyDynamicsAnalysis(_5026.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5086.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5086.DynamicTorqueResultAtTime))
        return value
