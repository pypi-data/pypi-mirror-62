...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5148
...
class RollingRingConnectionCompoundMultiBodyDynamicsAnalysis(_5148.InterMountableComponentConnectionCompoundMultiBodyDynamicsAnalysis):
    '''RollingRingConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5040.RollingRingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5040.RollingRingConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5040.RollingRingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5040.RollingRingConnectionMultiBodyDynamicsAnalysis))
        return value
