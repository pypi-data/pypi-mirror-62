...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5010, _5048, _5043
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.analysis_cases import _6460
...
class MBDRunUpAnalysisOptions(_6460.AbstractAnalysisOptions['_6176.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5010.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5010.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5010.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5048.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5048.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5048.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5043.RunUpDrivingMode':
        ...
        return constructor.new(_5043.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5043.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
