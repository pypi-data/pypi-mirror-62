...
from mastapy.nodal_analysis import _1356
...
class GearMeshMultiBodyDynamicsAnalysis(_5011.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''GearMeshMultiBodyDynamicsAnalysis
    ...
    @property
    def contact_status(self) -> '_1356.GearMeshContactStatus':
