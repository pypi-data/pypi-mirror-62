...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5083
...
class DynamicTorqueResultAtTime(_5083.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
