...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5085, _5087
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_4981.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5085.DynamicForceVector3DResult':
        ...
        return constructor.new(_5085.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5087.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5087.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
