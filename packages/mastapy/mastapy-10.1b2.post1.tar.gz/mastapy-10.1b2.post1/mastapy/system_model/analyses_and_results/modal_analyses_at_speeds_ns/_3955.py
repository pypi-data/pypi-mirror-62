...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3954, _3953, _3960
...
class BevelDifferentialGearSetModalAnalysesAtSpeeds(_3960.BevelGearSetModalAnalysesAtSpeeds):
    '''BevelDifferentialGearSetModalAnalysesAtSpeeds
    ...
    @property
    def bevel_differential_gears_modal_analyses_at_speeds(self) -> 'List[_3954.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysesAtSpeeds, constructor.new(_3954.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value

    @property
    def bevel_differential_meshes_modal_analyses_at_speeds(self) -> 'List[_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysesAtSpeeds, constructor.new(_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value
