...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4074
...
class RootAssemblyCompoundModalAnalysesAtSpeeds(_4074.AssemblyCompoundModalAnalysesAtSpeeds):
    '''RootAssemblyCompoundModalAnalysesAtSpeeds
