...
class ConnectionModalAnalysesAtSpeeds(_6465.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4044.StabilityAnalysis':
        ...
        return constructor.new(_4044.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
