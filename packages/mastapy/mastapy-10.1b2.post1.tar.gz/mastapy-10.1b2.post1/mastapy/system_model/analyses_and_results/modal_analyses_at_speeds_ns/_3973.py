...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3972, _3971, _3998
...
class ConceptGearSetModalAnalysesAtSpeeds(_3998.GearSetModalAnalysesAtSpeeds):
    '''ConceptGearSetModalAnalysesAtSpeeds
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_3972.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_3972.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_3971.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_3971.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
