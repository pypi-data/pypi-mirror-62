...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3954
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4083
...
class BevelDifferentialGearCompoundModalAnalysesAtSpeeds(_4083.BevelGearCompoundModalAnalysesAtSpeeds):
    '''BevelDifferentialGearCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3954.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3954.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_3954.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_3954.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value
