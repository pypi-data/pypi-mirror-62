...
class ConceptCouplingConnectionCompoundModalAnalysesAtSpeeds(_4105.CouplingConnectionCompoundModalAnalysesAtSpeeds):
    '''ConceptCouplingConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3968.ConceptCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3968.ConceptCouplingConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_3968.ConceptCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_3968.ConceptCouplingConnectionModalAnalysesAtSpeeds))
        return value
