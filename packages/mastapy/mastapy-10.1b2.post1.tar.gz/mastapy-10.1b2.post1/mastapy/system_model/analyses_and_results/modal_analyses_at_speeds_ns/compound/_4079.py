...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3953
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4084
...
class BevelDifferentialGearMeshCompoundModalAnalysesAtSpeeds(_4084.BevelGearMeshCompoundModalAnalysesAtSpeeds):
    '''BevelDifferentialGearMeshCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_3953.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value
