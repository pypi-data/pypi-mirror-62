...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3944
...
class SpecialisedAssemblyModalAnalysesAtSpeeds(_3944.AbstractAssemblyModalAnalysesAtSpeeds):
    '''SpecialisedAssemblyModalAnalysesAtSpeeds
