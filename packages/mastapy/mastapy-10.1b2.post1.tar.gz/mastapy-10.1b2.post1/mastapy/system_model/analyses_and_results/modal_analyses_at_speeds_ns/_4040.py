...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4039, _4038, _3960
...
class SpiralBevelGearSetModalAnalysesAtSpeeds(_3960.BevelGearSetModalAnalysesAtSpeeds):
    '''SpiralBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def spiral_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4039.SpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysesAtSpeeds, constructor.new(_4039.SpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def spiral_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4038.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4038.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
