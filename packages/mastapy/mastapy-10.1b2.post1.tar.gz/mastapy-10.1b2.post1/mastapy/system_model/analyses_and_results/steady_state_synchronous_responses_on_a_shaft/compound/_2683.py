...
class SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft(_2668.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2113.Synchroniser':
    ...
    @property
    def assembly_design(self) -> '_2113.Synchroniser':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2565.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2565.SynchroniserSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2565.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2565.SynchroniserSteadyStateSynchronousResponseOnAShaft))
        return value
