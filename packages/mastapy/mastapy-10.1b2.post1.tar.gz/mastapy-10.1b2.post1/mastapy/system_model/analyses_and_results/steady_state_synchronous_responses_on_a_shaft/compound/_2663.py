...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2637.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1831.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_1831.RollingRingConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2540.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2540.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2540.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2540.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
