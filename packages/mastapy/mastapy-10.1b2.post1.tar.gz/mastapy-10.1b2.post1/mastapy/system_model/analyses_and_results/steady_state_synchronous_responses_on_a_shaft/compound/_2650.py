...
from mastapy.system_model.part_model import _1986
...
class OilSealCompoundSteadyStateSynchronousResponseOnAShaft(_2612.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    '''OilSealCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1986.OilSeal':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2528.OilSealSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2528.OilSealSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2528.OilSealSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2528.OilSealSteadyStateSynchronousResponseOnAShaft))
        return value
