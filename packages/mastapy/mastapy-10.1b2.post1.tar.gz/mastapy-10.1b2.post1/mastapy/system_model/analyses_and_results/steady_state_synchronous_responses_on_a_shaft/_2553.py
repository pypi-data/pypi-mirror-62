...
class SteadyStateSynchronousResponseOnAShaft(_6474.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    def options(self) -> '_3042.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3042.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
