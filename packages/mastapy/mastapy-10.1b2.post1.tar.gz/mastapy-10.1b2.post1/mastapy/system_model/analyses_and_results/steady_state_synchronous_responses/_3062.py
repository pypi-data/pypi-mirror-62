...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3063, _3061, _2995
...
class WormGearSetSteadyStateSynchronousResponse(_2995.GearSetSteadyStateSynchronousResponse):
    '''WormGearSetSteadyStateSynchronousResponse
    ...
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3063.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3063.WormGearSteadyStateSynchronousResponse))
        return value
    ...
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3061.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3061.WormGearMeshSteadyStateSynchronousResponse))
        return value
