...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3048, _3046, _2957
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2957.BevelGearSetSteadyStateSynchronousResponse):
    '''StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3048.StraightBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSteadyStateSynchronousResponse, constructor.new(_3048.StraightBevelGearSteadyStateSynchronousResponse))
        return value
    ...
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3046.StraightBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3046.StraightBevelGearMeshSteadyStateSynchronousResponse))
        return value
