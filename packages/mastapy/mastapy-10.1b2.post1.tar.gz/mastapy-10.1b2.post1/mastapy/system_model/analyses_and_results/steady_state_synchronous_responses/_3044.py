...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3045, _3043, _2957
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponse(_2957.BevelGearSetSteadyStateSynchronousResponse):
    '''StraightBevelDiffGearSetSteadyStateSynchronousResponse
    ...
    def straight_bevel_diff_gears_steady_state_synchronous_response(self) -> 'List[_3045.StraightBevelDiffGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSteadyStateSynchronousResponse, constructor.new(_3045.StraightBevelDiffGearSteadyStateSynchronousResponse))
        return value
    ...
    def straight_bevel_diff_meshes_steady_state_synchronous_response(self) -> 'List[_3043.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSteadyStateSynchronousResponse, constructor.new(_3043.StraightBevelDiffGearMeshSteadyStateSynchronousResponse))
        return value
