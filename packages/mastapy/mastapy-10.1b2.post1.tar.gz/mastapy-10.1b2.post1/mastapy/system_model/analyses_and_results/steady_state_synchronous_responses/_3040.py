...
class SteadyStateSynchronousResponse(_6461.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    def steady_state_analysis_options(self) -> '_3042.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3042.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
