...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3040, _2947
...
class RootAssemblySteadyStateSynchronousResponse(_2947.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    def steady_state_synchronous_response_inputs(self) -> '_3040.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3040.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs else None
