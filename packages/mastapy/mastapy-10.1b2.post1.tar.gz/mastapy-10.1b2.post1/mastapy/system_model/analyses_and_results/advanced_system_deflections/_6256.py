...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6254, _6255, _6267
...
class CylindricalGearSetAdvancedSystemDeflection(_6267.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_778.CylindricalGearSetDesign':
    ...
    @property
    def micro_geometry(self) -> '_842.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6254.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6254.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6255.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6255.CylindricalGearMeshAdvancedSystemDeflection))
        return value
