...
class ZerolBevelGearAdvancedSystemDeflection(_6227.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2323.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2323.ZerolBevelGearSystemDeflection))
        return value
