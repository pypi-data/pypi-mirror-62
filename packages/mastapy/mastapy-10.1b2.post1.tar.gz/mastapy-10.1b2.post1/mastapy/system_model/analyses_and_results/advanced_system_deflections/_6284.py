...
class MassDiscAdvancedSystemDeflection(_6331.VirtualComponentAdvancedSystemDeflection):
    '''MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2264.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2264.MassDiscSystemDeflection))
        return value
