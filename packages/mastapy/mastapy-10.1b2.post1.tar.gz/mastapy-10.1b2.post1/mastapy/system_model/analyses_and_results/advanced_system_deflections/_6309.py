...
class SpringDamperAdvancedSystemDeflection(_6248.CouplingAdvancedSystemDeflection):
    '''SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6161.SpringDamperLoadCase':
        ...
        return constructor.new(_6161.SpringDamperLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2294.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2294.SpringDamperSystemDeflection))
        return value
