...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6240, _6241, _6267
...
class ConceptGearSetAdvancedSystemDeflection(_6267.GearSetAdvancedSystemDeflection):
    '''ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_6240.ConceptGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsAdvancedSystemDeflection, constructor.new(_6240.ConceptGearAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_6241.ConceptGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesAdvancedSystemDeflection, constructor.new(_6241.ConceptGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2214.ConceptGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2214.ConceptGearSetSystemDeflection))
        return value
