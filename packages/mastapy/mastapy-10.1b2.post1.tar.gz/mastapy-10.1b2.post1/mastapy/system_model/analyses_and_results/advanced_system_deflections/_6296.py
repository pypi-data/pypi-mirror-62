...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6328, _6331
...
class PowerLoadAdvancedSystemDeflection(_6331.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_6328.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_6328.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2277.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2277.PowerLoadSystemDeflection))
        return value
