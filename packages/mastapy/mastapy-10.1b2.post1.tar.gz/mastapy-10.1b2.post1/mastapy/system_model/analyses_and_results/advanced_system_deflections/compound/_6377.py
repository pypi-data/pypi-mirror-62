...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _6346
...
class CVTCompoundAdvancedSystemDeflection(_6346.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
