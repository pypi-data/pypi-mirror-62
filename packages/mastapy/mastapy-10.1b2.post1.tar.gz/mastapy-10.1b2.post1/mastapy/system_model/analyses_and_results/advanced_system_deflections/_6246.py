...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6212
...
class ConnectionAdvancedSystemDeflection(_6465.ConnectionStaticLoadAnalysisCase):
    '''ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6212.AdvancedSystemDeflection':
        ...
        return constructor.new(_6212.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None
