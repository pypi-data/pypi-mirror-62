...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3742, _3741, _3753
...
class CylindricalGearSetModalAnalysesAtStiffnesses(_3753.GearSetModalAnalysesAtStiffnesses):
    '''CylindricalGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def cylindrical_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3742.CylindricalGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtStiffnesses, constructor.new(_3742.CylindricalGearModalAnalysesAtStiffnesses))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3741.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtStiffnesses, constructor.new(_3741.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
