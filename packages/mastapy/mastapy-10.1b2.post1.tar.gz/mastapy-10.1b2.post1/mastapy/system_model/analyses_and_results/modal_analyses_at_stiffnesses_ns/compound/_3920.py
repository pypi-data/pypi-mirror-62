...
class StraightBevelDiffGearCompoundModalAnalysesAtStiffnesses(_3837.BevelGearCompoundModalAnalysesAtStiffnesses):
    '''StraightBevelDiffGearCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3800.StraightBevelDiffGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3800.StraightBevelDiffGearModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3800.StraightBevelDiffGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3800.StraightBevelDiffGearModalAnalysesAtStiffnesses))
        return value
