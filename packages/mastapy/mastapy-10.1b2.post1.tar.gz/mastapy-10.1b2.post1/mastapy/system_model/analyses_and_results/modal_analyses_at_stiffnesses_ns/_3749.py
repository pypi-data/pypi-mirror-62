...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3748, _3747, _3753
...
class FaceGearSetModalAnalysesAtStiffnesses(_3753.GearSetModalAnalysesAtStiffnesses):
    '''FaceGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def face_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3748.FaceGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtStiffnesses, constructor.new(_3748.FaceGearModalAnalysesAtStiffnesses))
        return value

    @property
    def face_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3747.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtStiffnesses, constructor.new(_3747.FaceGearMeshModalAnalysesAtStiffnesses))
        return value
