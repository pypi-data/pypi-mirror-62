...
class TorqueConverterCompoundPowerFlow(_3355.CouplingCompoundPowerFlow):
    '''TorqueConverterCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3308.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3308.TorqueConverterPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3308.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3308.TorqueConverterPowerFlow))
        return value
