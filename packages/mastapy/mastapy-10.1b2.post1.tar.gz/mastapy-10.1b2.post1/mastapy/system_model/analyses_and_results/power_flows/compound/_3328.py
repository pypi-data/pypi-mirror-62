...
from mastapy.system_model.analyses_and_results.power_flows import _3204
from mastapy.system_model.analyses_and_results.power_flows.compound import _3333
...
class BevelDifferentialGearCompoundPowerFlow(_3333.BevelGearCompoundPowerFlow):
    '''BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3204.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3204.BevelDifferentialGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3204.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3204.BevelDifferentialGearPowerFlow))
        return value
