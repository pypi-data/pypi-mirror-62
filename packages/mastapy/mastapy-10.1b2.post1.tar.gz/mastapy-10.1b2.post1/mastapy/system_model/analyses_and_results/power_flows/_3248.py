...
from mastapy.system_model.analyses_and_results.power_flows import _3246, _3247, _3287
...
class GearSetPowerFlow(_3287.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3246.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3246.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3247.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3247.GearPowerFlow))
        return value
