...
class ConicalGearSetCompoundPowerFlow(_3373.GearSetCompoundPowerFlow):
    '''ConicalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_325.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_325.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_325.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
