...
class SpringDamperConnectionCompoundPowerFlow(_3356.CouplingConnectionCompoundPowerFlow):
    '''SpringDamperConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3291.SpringDamperConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3291.SpringDamperConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3291.SpringDamperConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3291.SpringDamperConnectionPowerFlow))
        return value
