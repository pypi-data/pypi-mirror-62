...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3319
...
class SpecialisedAssemblyCompoundPowerFlow(_3319.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
