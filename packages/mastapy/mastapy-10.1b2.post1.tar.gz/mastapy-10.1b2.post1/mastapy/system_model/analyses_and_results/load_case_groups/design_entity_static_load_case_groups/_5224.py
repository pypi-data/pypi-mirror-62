...
from mastapy.system_model.part_model import _1959
...
TAssembly = TypeVar('TAssembly', bound='_1959.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6024.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5227.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
