...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5223, _5222, _5210, _5221,
    _5211
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _6162, _6032, _6144, _6143,
    _6069, _6071, _6073, _6114
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5225, _5228, _5229
from mastapy.system_model.part_model import (
    _1963, _1991, _1990, _1979
)
from mastapy.system_model.part_model.gears import _2043, _2042
...
class AbstractStaticLoadCaseGroup(_5211.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_5223.SystemOptimiserTargets':
        ...
        return constructor.new(_5223.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_5223.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_5222.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_5222.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_5222.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_6162.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoadsLimitedByMaxNumberOfLoadCasesToDisplay, constructor.new(_6162.StaticLoadCase))
        return value

    @property
    def bearings(self) -> 'List[_5225.ComponentStaticLoadCaseGroup[_1963.Bearing, _6032.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_5225.ComponentStaticLoadCaseGroup)[_1963.Bearing, _6032.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_5225.ComponentStaticLoadCaseGroup[_1991.PowerLoad, _6144.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_5225.ComponentStaticLoadCaseGroup)[_1991.PowerLoad, _6144.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_5225.ComponentStaticLoadCaseGroup[_1990.PointLoad, _6143.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_5225.ComponentStaticLoadCaseGroup)[_1990.PointLoad, _6143.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_5228.GearSetStaticLoadCaseGroup[_2043.CylindricalGearSet, _2042.CylindricalGear, _6069.CylindricalGearLoadCase, _1849.CylindricalGearMesh, _6071.CylindricalGearMeshLoadCase, _6073.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_5228.GearSetStaticLoadCaseGroup)[_2043.CylindricalGearSet, _2042.CylindricalGear, _6069.CylindricalGearLoadCase, _1849.CylindricalGearMesh, _6071.CylindricalGearMeshLoadCase, _6073.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_5229.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_5229.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_5225.ComponentStaticLoadCaseGroup[_1979.ImportedFEComponent, _6114.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_5225.ComponentStaticLoadCaseGroup)[_1979.ImportedFEComponent, _6114.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_5210.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5210.AbstractDesignStateLoadCaseGroup))
        return value

    @property
    def loaded_gear_sets(self) -> 'List[_3363.CylindricalGearSetCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedGearSets, constructor.new(_3363.CylindricalGearSetCompoundPowerFlow))
        return value

    @property
    def system_optimisation_gear_sets(self) -> 'List[_5221.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_5221.SystemOptimisationGearSet))
        return value
