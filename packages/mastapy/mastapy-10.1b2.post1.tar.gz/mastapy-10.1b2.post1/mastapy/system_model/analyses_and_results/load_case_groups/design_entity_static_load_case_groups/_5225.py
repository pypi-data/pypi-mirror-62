...
TReal = TypeVar('TReal', bound='_1967.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6049.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5227.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
