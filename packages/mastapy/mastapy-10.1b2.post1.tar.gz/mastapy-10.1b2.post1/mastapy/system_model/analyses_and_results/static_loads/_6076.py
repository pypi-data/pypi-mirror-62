...
class DataFromJMAGPerSpeed(_1.APIBase):
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_6075.DataFromJMAGPerMeanTorque]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPerMeanTorque, constructor.new(_6075.DataFromJMAGPerMeanTorque))
        return value
