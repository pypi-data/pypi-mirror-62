...
from mastapy.system_model.analyses_and_results.static_loads import _6187, _6188, _6101
...
class WormGearSetLoadCase(_6101.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6187.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6187.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6188.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6188.WormGearMeshLoadCase))
        return value
