...
from mastapy.system_model.analyses_and_results.static_loads import _6111, _6112, _6029
...
class HypoidGearSetLoadCase(_6029.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6111.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6111.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6112.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6112.HypoidGearMeshLoadCase))
        return value
