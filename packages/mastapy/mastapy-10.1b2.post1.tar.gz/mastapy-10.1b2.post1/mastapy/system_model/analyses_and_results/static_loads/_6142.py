...
class PointLoadHarmonicLoadData(_6155.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1058.DegreesOfFreedom':
        ...
        return constructor.new(_1058.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1058.DegreesOfFreedom'):
