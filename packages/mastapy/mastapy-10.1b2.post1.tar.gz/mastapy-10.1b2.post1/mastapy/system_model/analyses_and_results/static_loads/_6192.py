...
from mastapy.system_model.analyses_and_results.static_loads import _6190, _6191, _6042
...
class ZerolBevelGearSetLoadCase(_6042.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6190.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6190.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6191.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6191.ZerolBevelGearMeshLoadCase))
        return value
