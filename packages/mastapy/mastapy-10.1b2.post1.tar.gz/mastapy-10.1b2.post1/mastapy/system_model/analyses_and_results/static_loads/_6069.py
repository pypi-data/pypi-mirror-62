...
from mastapy.system_model.analyses_and_results.static_loads import _6070, _6096
...
class CylindricalGearLoadCase(_6096.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6070.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_837.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_837.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
