...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4952
from mastapy.system_model.part_model import _1963
from mastapy.bearings.tolerances import _1522, _1527
...
class BearingLoadCase(_6062.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def include_fitting_effects(self) -> '_1125.LoadCaseOverrideOption':
        ...
        return constructor.new(_1125.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1125.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1125.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1125.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1125.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1125.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_4952.BearingStiffnessModel':
        ...
        return constructor.new(_4952.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_4952.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_4952.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1522.RaceDetail':
        ...
        return constructor.new(_1522.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1522.RaceDetail':
        ...
        return constructor.new(_1522.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1522.RaceDetail':
        ...
        return constructor.new(_1522.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1522.RaceDetail':
        ...
        return constructor.new(_1522.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
