...
from mastapy.system_model.imported_fes import _1891, _1913
...
class ImportedFEComponentLoadCase(_6025.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1891.AngleSource':
        ...
        return constructor.new(_1891.AngleSource)(value) if value else None
