...
from mastapy.system_model.analyses_and_results.static_loads import _6091, _6092, _6101
...
class FaceGearSetLoadCase(_6101.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6091.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6091.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6092.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6092.FaceGearMeshLoadCase))
        return value
