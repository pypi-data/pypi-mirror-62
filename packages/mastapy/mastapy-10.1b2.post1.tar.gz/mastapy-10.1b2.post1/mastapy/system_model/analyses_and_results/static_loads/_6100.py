...
from mastapy.system_model.analyses_and_results.static_loads import _6098, _6099, _6104
...
class GearSetHarmonicLoadData(_6104.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6099.GearMeshTEOrderType':
        ...
        return constructor.new(_6099.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6099.GearMeshTEOrderType'):
