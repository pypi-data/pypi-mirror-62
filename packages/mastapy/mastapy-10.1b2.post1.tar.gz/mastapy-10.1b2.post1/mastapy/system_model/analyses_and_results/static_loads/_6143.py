...
from mastapy.nodal_analysis.varying_input_components import _1379, _1380
from mastapy.system_model.analyses_and_results.static_loads import _6142, _6186
...
class PointLoadLoadCase(_6186.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def force_specification_options(self) -> 'enum_with_selected_value.EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification.implicit_type()
    ...
    def force_specification_options(self, value: 'enum_with_selected_value.EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification.implicit_type().type_()
    ...
    @property
    def force_x(self) -> '_1379.ForceInputComponent':
        ...
        return constructor.new(_1379.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None

    @property
    def force_y(self) -> '_1379.ForceInputComponent':
        ...
        return constructor.new(_1379.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None

    @property
    def axial_load(self) -> '_1379.ForceInputComponent':
        ...
        return constructor.new(_1379.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None

    @property
    def moment_x(self) -> '_1380.MomentInputComponent':
        ...
        return constructor.new(_1380.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None

    @property
    def moment_y(self) -> '_1380.MomentInputComponent':
        ...
        return constructor.new(_1380.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None

    @property
    def moment_z(self) -> '_1380.MomentInputComponent':
        ...
        return constructor.new(_1380.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6142.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6142.PointLoadHarmonicLoadData)(method_result) if method_result else None
