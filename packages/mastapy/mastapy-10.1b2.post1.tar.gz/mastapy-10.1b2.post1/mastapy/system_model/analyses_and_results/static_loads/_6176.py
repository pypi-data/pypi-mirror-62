...
class TimeSeriesLoadCase(_6023.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5023.MBDAnalysisOptions':
        ...
        return constructor.new(_5023.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
