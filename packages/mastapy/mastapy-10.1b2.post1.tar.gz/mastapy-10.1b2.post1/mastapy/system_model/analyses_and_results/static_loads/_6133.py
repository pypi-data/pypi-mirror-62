...
class PartLoadCase(_2162.PartAnalysis):
    '''PartLoadCase
    ...
    def harmonic_excitation_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType.implicit_type()
    ...
    def harmonic_excitation_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType.implicit_type().type_()
    ...
    @property
    def static_load_case(self) -> '_6162.StaticLoadCase':
        ...
        return constructor.new(_6162.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_6176.TimeSeriesLoadCase':
        ...
        return constructor.new(_6176.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None

    def get_harmonic_load_data_for_import(self) -> '_6104.HarmonicLoadDataBase':
        ...
        return constructor.new(_6104.HarmonicLoadDataBase)(method_result) if method_result else None
