...
from mastapy.system_model.analyses_and_results.static_loads import _6081, _6087
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6081.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
