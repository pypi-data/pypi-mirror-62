...
from mastapy.gears.gear_designs.conical import _891, _885
...
class ConicalGearMeshLoadCase(_6098.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_891.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_891.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None

    @property
    def user_specified_misalignments(self) -> '_885.ConicalMeshMisalignments':
        ...
        return constructor.new(_885.ConicalMeshMisalignments)(self.wrapped.UserSpecifiedMisalignments) if self.wrapped.UserSpecifiedMisalignments else None
