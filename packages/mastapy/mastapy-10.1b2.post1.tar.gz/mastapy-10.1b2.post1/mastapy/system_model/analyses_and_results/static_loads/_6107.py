...
from mastapy.system_model.analyses_and_results.static_loads import _6110, _6106, _6087
...
T = TypeVar('T', bound='_6087.ElectricMachineHarmonicLoadImportOptionsBase')


class HarmonicLoadDataImportFromMotorPackages(_6106.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
