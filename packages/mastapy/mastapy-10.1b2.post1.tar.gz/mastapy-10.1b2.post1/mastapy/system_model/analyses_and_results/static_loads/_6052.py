...
class ConceptCouplingLoadCase(_6065.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1773.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1773.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1773.ConceptCouplingSpeedRatioSpecificationMethod'):
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1112.PIDControlSettings':
        ...
        return constructor.new(_1112.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
