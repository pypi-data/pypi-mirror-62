...
from mastapy.system_model.analyses_and_results.static_loads import _6053, _6054, _6101
...
class ConceptGearSetLoadCase(_6101.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6053.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6053.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6054.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6054.ConceptGearMeshLoadCase))
        return value
