...
class GearSetLoadCase(_6154.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_4999.GearMeshStiffnessModel':
        ...
        return constructor.new(_4999.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_4999.GearMeshStiffnessModel'):
