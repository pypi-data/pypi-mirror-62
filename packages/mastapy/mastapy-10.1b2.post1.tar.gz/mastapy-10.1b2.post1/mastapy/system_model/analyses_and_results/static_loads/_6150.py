...
from mastapy.nodal_analysis.varying_input_components import _1379, _1378, _1383
from mastapy.math_utility.control import _1112
from mastapy.system_model.analyses_and_results.static_loads import _6162, _6073, _6031
...
class RootAssemblyLoadCase(_6031.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def assembly_design(self) -> '_1993.RootAssembly':
    ...
    @property
    def brake_force_input_values(self) -> '_1379.ForceInputComponent':
        ...
        return constructor.new(_1379.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1378.AngleInputComponent':
        ...
        return constructor.new(_1378.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1112.PIDControlSettings':
        ...
        return constructor.new(_1112.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1383.VelocityInputComponent':
        ...
        return constructor.new(_1383.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None

    @property
    def load_case(self) -> '_6162.StaticLoadCase':
        ...
        return constructor.new(_6162.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None

    @property
    def supercharger_rotor_sets(self) -> 'List[_6073.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6073.CylindricalGearSetLoadCase))
        return value
