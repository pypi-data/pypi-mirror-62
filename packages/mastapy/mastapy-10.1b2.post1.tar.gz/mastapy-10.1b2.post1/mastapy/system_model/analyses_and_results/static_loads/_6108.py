...
from mastapy.system_model.analyses_and_results.static_loads import _6076, _6107, _6088
...
class HarmonicLoadDataJMAGImport(_6107.HarmonicLoadDataImportFromMotorPackages['_6088.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6076.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6076.DataFromJMAGPerSpeed))
        return value
