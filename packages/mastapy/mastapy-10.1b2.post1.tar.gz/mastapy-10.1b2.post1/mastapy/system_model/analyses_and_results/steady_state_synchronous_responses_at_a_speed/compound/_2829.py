...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2707
...
class BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed(_2911.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_2089.BeltDrive':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2707.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2707.BeltDriveSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2707.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2707.BeltDriveSteadyStateSynchronousResponseAtASpeed))
        return value
