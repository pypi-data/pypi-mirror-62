...
from mastapy.system_model.connections_and_sockets.couplings import _1881
...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_2857.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1881.SpringDamperConnection':
    ...
    @property
    def connection_design(self) -> '_1881.SpringDamperConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2793.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2793.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2793.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2793.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
