...
from mastapy.system_model.part_model.couplings import _2115, _2117
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2115.SynchroniserHalf':
        ...
        return constructor.new(_2115.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2117.SynchroniserSleeve':
        ...
        return constructor.new(_2117.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
