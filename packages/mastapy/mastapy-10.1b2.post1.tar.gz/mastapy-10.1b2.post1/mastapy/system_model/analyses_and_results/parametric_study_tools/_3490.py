...
class DutyCycleResultsForAllGearSets(_1.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_949.GearSetGroupDutyCycle':
        ...
        return constructor.new(_949.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
