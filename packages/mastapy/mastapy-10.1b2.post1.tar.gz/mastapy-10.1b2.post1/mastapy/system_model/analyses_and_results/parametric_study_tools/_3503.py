...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3444
...
class HypoidGearParametricStudyTool(_3444.AGMAGleasonConicalGearParametricStudyTool):
    '''HypoidGearParametricStudyTool
