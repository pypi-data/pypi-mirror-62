...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3455
...
class StraightBevelDiffGearMeshParametricStudyTool(_3455.BevelGearMeshParametricStudyTool):
    '''StraightBevelDiffGearMeshParametricStudyTool
