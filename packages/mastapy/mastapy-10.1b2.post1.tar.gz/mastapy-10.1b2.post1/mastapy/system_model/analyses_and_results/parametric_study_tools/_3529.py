...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3521, _3518
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results import _2156
...
class ParametricStudyVariable(_2156.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3521.ParametricStudyDimension':
        ...
        return constructor.new(_3521.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3521.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3518.MonteCarloDistribution':
        ...
        return constructor.new(_3518.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3518.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
