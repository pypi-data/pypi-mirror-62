...
from mastapy.system_model.analyses_and_results.static_loads import _6030, _6132
from mastapy.system_model import _1778
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3528, _3529
...
class ParametricStudyToolOptions(_1.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6132.ParametricStudyType':
        ...
        return constructor.new(_6132.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6132.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1778.ExternalFullFELoader':
        ...
        return constructor.new(_1778.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3528.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3528.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3529.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3529.ParametricStudyVariable))
        return value
