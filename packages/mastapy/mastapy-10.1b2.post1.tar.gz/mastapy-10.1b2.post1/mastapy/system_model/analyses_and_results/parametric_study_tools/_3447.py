...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3475
...
class BearingParametricStudyTool(_3475.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1549.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1549.LoadedBearingDutyCycle))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2191.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2191.BearingSystemDeflection))
        return value
