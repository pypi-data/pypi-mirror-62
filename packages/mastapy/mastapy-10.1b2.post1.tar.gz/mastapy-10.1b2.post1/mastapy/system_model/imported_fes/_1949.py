...
from mastapy.system_model.imported_fes import _1942, _1941
...
class SystemDeflectionFEExportOptions(_1.APIBase):
    ...
    def default_type_of_result_to_export(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BoundaryConditionType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_BoundaryConditionType.implicit_type()
    ...
    def default_type_of_result_to_export(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BoundaryConditionType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_BoundaryConditionType.implicit_type().type_()
    ...
    @property
    def nodes(self) -> 'List[_1942.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1942.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1941.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1941.PerLinkExportOptions))
        return value
