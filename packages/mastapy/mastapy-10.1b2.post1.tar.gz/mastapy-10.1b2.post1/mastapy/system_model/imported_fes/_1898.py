...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1455
...
class ContactPairWithSelection(_1.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1455.ContactPairReporting':
        ...
        return constructor.new(_1455.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
