...
from mastapy.system_model.analyses_and_results.static_loads import _6181, _6110
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.imported_fes import _1925
from mastapy.math_utility import _1070
from mastapy.units_and_measurements import _6480
...
class ElectricMachineDataSet(_1.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6181.TorqueRippleInputType':
        ...
        return constructor.new(_6181.TorqueRippleInputType)(value) if value else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6181.TorqueRippleInputType'):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType') -> '_1070.MultipleFourierSeriesInterpolator':
        ...
        return constructor.new(_1070.MultipleFourierSeriesInterpolator)(method_result) if method_result else None

    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6480.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6480.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType', node: '_1925.ImportedFEStiffnessNode') -> '_1070.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType', node: '_1925.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6480.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_stiffness_node(self, harmonic_load_data_type: '_6110.HarmonicLoadDataType', node: '_1925.ImportedFEStiffnessNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6480.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
