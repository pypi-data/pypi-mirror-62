...
from mastapy.system_model.imported_fes.version_comparer import _1953
...
class LoadCaseResults(_1.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_1953.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_1953.ImportedFEResults))
        return value
