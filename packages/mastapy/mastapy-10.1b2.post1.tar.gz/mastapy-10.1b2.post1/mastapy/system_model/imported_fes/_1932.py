...
class IndependentMastaCreatedCondensationNode(_1.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1454.RigidCouplingType':
        ...
        return constructor.new(_1454.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1454.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1925.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1925.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
