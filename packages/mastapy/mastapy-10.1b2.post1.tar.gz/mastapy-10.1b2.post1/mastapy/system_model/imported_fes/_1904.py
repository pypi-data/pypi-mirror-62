...
class ElectricMachineDynamicLoadData(_1.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_1903.ElectricMachineDataSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataSets, constructor.new(_1903.ElectricMachineDataSet))
        return value

    def add_electric_machine_data_set(self, name: 'str') -> '_1903.ElectricMachineDataSet':
        ...
        return constructor.new(_1903.ElectricMachineDataSet)(method_result) if method_result else None
