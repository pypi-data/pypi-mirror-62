...
from mastapy.system_model.imported_fes import _1902, _1901
...
class NodeBoundaryConditionStaticAnalysis(_1.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_1902.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_1902.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_1901.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_1901.DegreeOfFreedomBoundaryConditionAngular))
        return value
