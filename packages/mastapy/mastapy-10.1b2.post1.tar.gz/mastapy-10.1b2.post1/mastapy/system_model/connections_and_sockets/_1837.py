...
from mastapy.system_model.connections_and_sockets import _1838
...
class SocketConnectionOptions(_1.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_1838.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_1838.SocketConnectionSelection))
        return value
