...
class FaceGearMesh(_1853.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_747.FaceGearMeshDesign':
        ...
        return constructor.new(_747.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
