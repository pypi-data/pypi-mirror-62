...
from mastapy.utility.cad_export import _1442
...
class CustomReportCadDrawing(_1396.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1442.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1442.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1442.StockDrawings'):
