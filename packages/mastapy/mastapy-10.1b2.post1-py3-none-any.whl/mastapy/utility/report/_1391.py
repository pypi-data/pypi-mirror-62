...
from mastapy.utility.report import _1392, _1393
...
T = TypeVar('T', bound='_1393.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1392.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
