...
from mastapy.utility.report import _1413, _1416
...
TItem = TypeVar('TItem', bound='_1416.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1413.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
