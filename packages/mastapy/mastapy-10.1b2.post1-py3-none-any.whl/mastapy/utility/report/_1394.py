...
from mastapy.utility.report import _1395, _1398
...
TItem = TypeVar('TItem', bound='_1398.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1395.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
