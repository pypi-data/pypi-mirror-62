...
from mastapy.utility.report import _1427, _1421
...
class UserTextRow(_1421.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1427.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1427.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1427.HeadingSize'):
