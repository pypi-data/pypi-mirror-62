...
from mastapy.html import _238
from mastapy._internal.implicit import overridable
from mastapy.utility.report import _1386
...
class CustomReportText(_1386.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_238.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_238.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_238.HeadingType'):
