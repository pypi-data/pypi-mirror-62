...
from mastapy.utility.report import _1410, _1403
...
class UserTextRow(_1403.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1410.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1410.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1410.HeadingSize'):
