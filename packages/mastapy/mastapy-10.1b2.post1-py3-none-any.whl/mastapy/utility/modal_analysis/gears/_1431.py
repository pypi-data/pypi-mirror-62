...
from mastapy.utility.modal_analysis.gears import _1432, _1436
...
class GearMeshForTE(_1436.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1432.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1432.GearOrderForTE))
        return value
