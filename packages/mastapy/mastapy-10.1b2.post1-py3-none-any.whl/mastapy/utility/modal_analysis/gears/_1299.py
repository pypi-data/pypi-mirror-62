...
from mastapy.utility.modal_analysis.gears import _1300, _1304
...
class GearMeshForTE(_1304.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1300.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1300.GearOrderForTE))
        return value
