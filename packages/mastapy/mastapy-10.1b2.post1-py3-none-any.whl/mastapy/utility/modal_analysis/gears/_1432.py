...
from mastapy.utility.modal_analysis.gears import _1433, _1436, _1438
...
class GearOrderForTE(_1438.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1433.GearPositions':
        ...
        return constructor.new(_1433.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1436.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1436.OrderForTE))
        return value
