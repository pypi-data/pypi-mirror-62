...
from mastapy.utility.modal_analysis.gears import _1301, _1304, _1306
...
class GearOrderForTE(_1306.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1301.GearPositions':
        ...
        return constructor.new(_1301.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1304.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1304.OrderForTE))
        return value
