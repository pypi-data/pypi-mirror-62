...
from mastapy.utility.modal_analysis.gears import _1418, _1421, _1423
...
class GearOrderForTE(_1423.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1418.GearPositions':
        ...
        return constructor.new(_1418.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1421.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1421.OrderForTE))
        return value
