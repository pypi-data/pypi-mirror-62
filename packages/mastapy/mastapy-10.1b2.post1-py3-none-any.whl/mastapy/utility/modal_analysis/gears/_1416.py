...
from mastapy.utility.modal_analysis.gears import _1417, _1421
...
class GearMeshForTE(_1421.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1417.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1417.GearOrderForTE))
        return value
