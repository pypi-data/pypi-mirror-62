...
from mastapy.utility import _1271, _1261
...
class EnvironmentSummary(_1.APIBase):
    ...
    @property
    def current_culture(self) -> '_1271.NumberFormatInfoSummary':
        ...
        return constructor.new(_1271.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1261.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1261.DispatcherHelper))
        return value
