...
class Status(_1.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1296.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1296.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1296.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1296.StatusItem))
        return value
