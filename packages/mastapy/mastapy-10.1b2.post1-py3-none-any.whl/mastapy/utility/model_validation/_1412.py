...
from mastapy.utility.model_validation import _1413
...
class Status(_1.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1413.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1413.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1413.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1413.StatusItem))
        return value
