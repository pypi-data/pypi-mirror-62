...
from mastapy.utility.units_and_measurements.measurements import _1359
...
class DutyCyclePropertySummaryStress(_1454.DutyCyclePropertySummary['_1359.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
