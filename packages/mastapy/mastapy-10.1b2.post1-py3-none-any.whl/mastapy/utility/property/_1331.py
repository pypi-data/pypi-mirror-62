...
from mastapy.utility.units_and_measurements.measurements import _1148
...
class DutyCyclePropertySummarySmallAngle(_1328.DutyCyclePropertySummary['_1148.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
