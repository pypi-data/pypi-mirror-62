...
from mastapy.utility.units_and_measurements.measurements import _1291
...
class DutyCyclePropertySummarySmallAngle(_1448.DutyCyclePropertySummary['_1291.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
