...
from mastapy.utility.units_and_measurements.measurements import _1289
...
class DutyCyclePropertySummaryForce(_1443.DutyCyclePropertySummary['_1289.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
