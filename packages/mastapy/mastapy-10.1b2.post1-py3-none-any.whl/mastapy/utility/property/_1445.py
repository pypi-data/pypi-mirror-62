...
from mastapy.utility.units_and_measurements.measurements import _1329
...
class DutyCyclePropertySummaryPercentage(_1443.DutyCyclePropertySummary['_1329.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
