...
from mastapy.utility.units_and_measurements.measurements import _1368
...
class DutyCyclePropertySummaryStress(_1448.DutyCyclePropertySummary['_1368.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
