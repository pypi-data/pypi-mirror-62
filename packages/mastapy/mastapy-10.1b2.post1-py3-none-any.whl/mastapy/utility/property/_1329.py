...
from mastapy.utility.units_and_measurements.measurements import _1168
...
class DutyCyclePropertySummaryForce(_1328.DutyCyclePropertySummary['_1168.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
