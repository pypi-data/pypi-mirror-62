...
from mastapy.utility.units_and_measurements.measurements import _1303
...
class DutyCyclePropertySummaryForce(_1454.DutyCyclePropertySummary['_1303.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
