...
from mastapy.utility.units_and_measurements.measurements import _1347
...
class DutyCyclePropertySummaryStress(_1443.DutyCyclePropertySummary['_1347.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
