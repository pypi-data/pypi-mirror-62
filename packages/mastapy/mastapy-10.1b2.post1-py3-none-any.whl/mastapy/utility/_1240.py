...
from mastapy.utility import _1241
...
class FileHistory(_1.APIBase):
    ...
    @property
    def items(self) -> 'List[_1241.FileHistoryItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1241.FileHistoryItem))
        return value
