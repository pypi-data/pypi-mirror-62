...
from mastapy.utility import _1247, _1236
...
class EnvironmentSummary(_1.APIBase):
    ...
    @property
    def current_culture(self) -> '_1247.NumberFormatInfoSummary':
        ...
        return constructor.new(_1247.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1236.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1236.DispatcherHelper))
        return value
