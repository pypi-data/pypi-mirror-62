...
class MeasurementBase(_1.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1273.RoundingMethods':
        ...
        return constructor.new(_1273.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1273.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1386.Unit':
        ...
        return constructor.new(_1386.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
