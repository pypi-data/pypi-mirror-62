...
from mastapy.utility.units_and_measurements import _1068
...
from mastapy.utility import _74
...
class MeasurementSettings(_74.PerMachineSettings):
    '''MeasurementSettings
    ...
    @property
    def current_selected_measurement(self) -> '_1068.MeasurementBase':
        ...
        return constructor.new(_1068.MeasurementBase)(self.wrapped.CurrentSelectedMeasurement) if self.wrapped.CurrentSelectedMeasurement else None
    ...
    @property
    def current_selected_measurement_of_type_length_short(self) -> '_1079.LengthShort':
        ...
        return constructor.new(_1079.LengthShort)(self.wrapped.CurrentSelectedMeasurement) if self.wrapped.CurrentSelectedMeasurement else None
    ...
    @property
    def current_selected_measurement_of_type_number(self) -> '_1080.Number':
        ...
        return constructor.new(_1080.Number)(self.wrapped.CurrentSelectedMeasurement) if self.wrapped.CurrentSelectedMeasurement else None
