...
class MeasurementBase(_1.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1131.RoundingMethods':
        ...
        return constructor.new(_1131.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1131.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1143.Unit':
        ...
        return constructor.new(_1143.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
