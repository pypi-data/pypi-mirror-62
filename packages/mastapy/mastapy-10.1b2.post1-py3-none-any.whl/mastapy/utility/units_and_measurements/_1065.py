...
from mastapy.utility.units_and_measurements import _1285
...
class MeasurementBase(_1.APIBase):
    ...
    @property
    def current_unit(self) -> '_1285.Unit':
        ...
        return constructor.new(_1285.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
