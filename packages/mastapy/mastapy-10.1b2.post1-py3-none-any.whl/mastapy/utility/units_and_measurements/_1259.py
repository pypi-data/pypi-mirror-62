...
from mastapy.utility import _1252
...
class MeasurementBase(_1.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1252.RoundingMethods':
        ...
        return constructor.new(_1252.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1252.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1264.Unit':
        ...
        return constructor.new(_1264.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
