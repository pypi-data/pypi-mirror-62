...
from mastapy.utility import _1276
...
class MeasurementBase(_1.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1276.RoundingMethods':
        ...
        return constructor.new(_1276.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1276.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1286.Unit':
        ...
        return constructor.new(_1286.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
