...
class KlingelnbergCycloPalloidHypoidGearRating(_438.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_457.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_457.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
