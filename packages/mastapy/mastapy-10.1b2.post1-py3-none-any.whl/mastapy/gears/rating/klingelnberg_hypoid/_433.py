...
class KlingelnbergCycloPalloidHypoidGearRating(_435.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_456.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_456.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
