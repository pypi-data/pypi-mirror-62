...
from mastapy.gears.rating.klingelnberg_hypoid import _337, _338
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_342.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_337.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_337.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value
