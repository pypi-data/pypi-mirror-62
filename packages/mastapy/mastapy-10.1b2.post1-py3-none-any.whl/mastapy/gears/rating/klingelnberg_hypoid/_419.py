...
from mastapy.gears.gear_designs.klingelnberg_hypoid import _432
...
class KlingelnbergCycloPalloidHypoidGearMeshRating(_421.KlingelnbergCycloPalloidConicalGearMeshRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_432.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_432.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMesh) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMesh else None
