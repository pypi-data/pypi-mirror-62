...
from mastapy.gears.rating.klingelnberg_hypoid import _432, _433
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_411.KlingelnbergCycloPalloidConicalGearSetRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_432.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_432.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value
