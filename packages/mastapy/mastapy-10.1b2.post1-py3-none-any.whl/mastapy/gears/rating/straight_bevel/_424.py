...
class StraightBevelGearMeshRating(_431.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_430.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_430.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
