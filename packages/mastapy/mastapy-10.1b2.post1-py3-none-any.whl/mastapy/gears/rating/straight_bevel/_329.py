...
class StraightBevelGearRating(_465.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_843.StraightBevelGearDesign':
        ...
        return constructor.new(_843.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
