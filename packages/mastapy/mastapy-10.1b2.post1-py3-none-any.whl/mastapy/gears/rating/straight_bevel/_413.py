...
from mastapy.gears.rating.straight_bevel import _411, _412
...
class StraightBevelGearSetRating(_431.BevelGearSetRating):
    '''StraightBevelGearSetRating
    ...
    @property
    def straight_bevel_mesh_ratings(self) -> 'List[_411.StraightBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshRatings, constructor.new(_411.StraightBevelGearMeshRating))
        return value
