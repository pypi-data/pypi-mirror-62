...
from mastapy.gears.gear_designs.straight_bevel import _429
...
class StraightBevelGearMeshRating(_414.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_429.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_429.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
