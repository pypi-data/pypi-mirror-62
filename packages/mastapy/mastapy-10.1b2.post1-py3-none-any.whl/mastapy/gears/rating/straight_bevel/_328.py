...
class StraightBevelGearMeshRating(_464.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_844.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_844.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
