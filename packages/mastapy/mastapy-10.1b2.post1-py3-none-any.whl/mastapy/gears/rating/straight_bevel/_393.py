...
from mastapy.gears.rating.straight_bevel import _416, _417
from mastapy.gears.rating.bevel import _444
...
class StraightBevelGearSetRating(_444.BevelGearSetRating):
    '''StraightBevelGearSetRating
    ...
    @property
    def straight_bevel_gear_set(self) -> '_383.StraightBevelGearSetDesign':
        ...
        return constructor.new(_383.StraightBevelGearSetDesign)(self.wrapped.StraightBevelGearSet) if self.wrapped.StraightBevelGearSet else None

    @property
    def straight_bevel_mesh_ratings(self) -> 'List[_416.StraightBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshRatings, constructor.new(_416.StraightBevelGearMeshRating))
        return value
