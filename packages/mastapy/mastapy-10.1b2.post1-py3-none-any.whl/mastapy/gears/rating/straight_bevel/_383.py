...
from mastapy.gears.gear_designs.straight_bevel import _373
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.straight_bevel import _415, _417
...
class StraightBevelGearSetRating(_430.BevelGearSetRating):
    ...
    @property
    def straight_bevel_gear_set(self) -> '_373.StraightBevelGearSetDesign':
        ...
        return constructor.new(_373.StraightBevelGearSetDesign)(self.wrapped.StraightBevelGearSet) if self.wrapped.StraightBevelGearSet else None

    @property
    def straight_bevel_mesh_ratings(self) -> 'List[_415.StraightBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshRatings, constructor.new(_415.StraightBevelGearMeshRating))
        return value
