...
from mastapy.gears.rating.bevel import _429
...
class StraightBevelGearRating(_429.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_428.StraightBevelGearDesign':
        ...
        return constructor.new(_428.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
