...
class StraightBevelGearRating(_410.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_455.StraightBevelGearDesign':
        ...
        return constructor.new(_455.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
