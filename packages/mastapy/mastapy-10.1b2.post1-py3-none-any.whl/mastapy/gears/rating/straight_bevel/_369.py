...
from mastapy.gears.gear_designs.straight_bevel import _357
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.straight_bevel import _419, _420
...
class StraightBevelGearSetRating(_416.BevelGearSetRating):
    '''StraightBevelGearSetRating
    ...
    @property
    def straight_bevel_mesh_ratings(self) -> 'List[_419.StraightBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshRatings, constructor.new(_419.StraightBevelGearMeshRating))
        return value

    @property
    def straight_bevel_gear_ratings(self) -> 'List[_420.StraightBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearRatings, constructor.new(_420.StraightBevelGearRating))
        return value
