...
from mastapy.gears.rating import _287, _282
...
class MeshDutyCycleRating(_282.AbstractGearMeshRating):
    '''MeshDutyCycleRating
    ...
    @property
    def gear_duty_cycle_ratings(self) -> 'List[_287.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleRatings, constructor.new(_287.GearDutyCycleRating))
        return value
