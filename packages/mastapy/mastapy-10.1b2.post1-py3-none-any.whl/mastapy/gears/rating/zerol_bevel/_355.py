...
class ZerolBevelGearRating(_420.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_416.ZerolBevelGearDesign':
        ...
        return constructor.new(_416.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
