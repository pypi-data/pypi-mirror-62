...
class ZerolBevelGearMeshRating(_464.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_831.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_831.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
