...
class ZerolBevelGearRating(_339.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_708.ZerolBevelGearDesign':
        ...
        return constructor.new(_708.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
