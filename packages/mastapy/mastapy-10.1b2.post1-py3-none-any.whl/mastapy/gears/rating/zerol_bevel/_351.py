...
class ZerolBevelGearRating(_427.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_426.ZerolBevelGearDesign':
        ...
        return constructor.new(_426.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
