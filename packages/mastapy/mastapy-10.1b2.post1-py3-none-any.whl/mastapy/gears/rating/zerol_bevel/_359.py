...
class ZerolBevelGearMeshRating(_431.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_437.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_437.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
