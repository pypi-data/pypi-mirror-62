...
class ZerolBevelGearRating(_465.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_830.ZerolBevelGearDesign':
        ...
        return constructor.new(_830.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
