...
class ZerolBevelGearRating(_433.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_432.ZerolBevelGearDesign':
        ...
        return constructor.new(_432.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
