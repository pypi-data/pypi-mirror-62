...
class ZerolBevelGearRating(_446.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_447.ZerolBevelGearDesign':
        ...
        return constructor.new(_447.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
