...
class ZerolBevelGearMeshRating(_431.BevelGearMeshRating):
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_432.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_432.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
