...
from mastapy.gears.gear_designs.zerol_bevel import _424
...
class ZerolBevelGearMeshRating(_425.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_424.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_424.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
