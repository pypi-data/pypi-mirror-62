...
from mastapy.gears.gear_designs.face import _495
...
class FaceGearRating(_337.GearRating):
    ...
    @property
    def face_gear(self) -> '_495.FaceGearDesign':
        ...
        return constructor.new(_495.FaceGearDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None
