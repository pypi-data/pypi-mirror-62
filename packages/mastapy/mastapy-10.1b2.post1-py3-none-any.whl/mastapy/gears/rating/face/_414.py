...
class FaceGearSetRating(_342.GearSetRating):
    ...
    @property
    def face_gear_set(self) -> '_375.FaceGearSetDesign':
        ...
        return constructor.new(_375.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
