...
from mastapy.gears.rating.face import _474, _475
...
class FaceGearSetRating(_344.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_gear_set(self) -> '_383.FaceGearSetDesign':
        ...
        return constructor.new(_383.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None

    @property
    def face_mesh_ratings(self) -> 'List[_474.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_474.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_475.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_475.FaceGearRating))
        return value
