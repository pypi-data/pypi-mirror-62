...
from mastapy.gears.gear_designs.face import _374
from mastapy.gears.rating.face import _478, _479
...
class FaceGearSetRating(_340.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_gear_set(self) -> '_374.FaceGearSetDesign':
        ...
        return constructor.new(_374.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None

    @property
    def face_mesh_ratings(self) -> 'List[_478.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_478.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_479.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_479.FaceGearRating))
        return value
