...
from mastapy.gears.rating import _283, _282
...
class AbstractGearSetRating(_1060.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_283.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_283.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_282.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_282.AbstractGearMeshRating))
        return value
