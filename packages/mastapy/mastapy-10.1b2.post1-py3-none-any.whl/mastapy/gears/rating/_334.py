...
from mastapy.gears.rating import _333, _332
...
class AbstractGearSetRating(_390.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_333.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_333.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_332.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_332.AbstractGearMeshRating))
        return value
