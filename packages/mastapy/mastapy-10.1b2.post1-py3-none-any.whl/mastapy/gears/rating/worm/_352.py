...
from mastapy.gears.gear_designs.worm import _452
...
class WormGearMeshRating(_339.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_452.WormGearMeshDesign':
        ...
        return constructor.new(_452.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
