...
from mastapy.gears.gear_designs.worm import _466
...
class WormGearMeshRating(_338.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_466.WormGearMeshDesign':
        ...
        return constructor.new(_466.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
