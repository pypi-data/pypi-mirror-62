...
from mastapy.gears.gear_designs.worm import _454
...
class WormGearMeshRating(_341.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_454.WormGearMeshDesign':
        ...
        return constructor.new(_454.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
