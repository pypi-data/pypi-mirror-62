...
class WormGearRating(_340.GearRating):
    '''WormGearRating
    ...
    @property
    def worm_gear(self) -> '_477.WormGearDesign':
        ...
        return constructor.new(_477.WormGearDesign)(self.wrapped.WormGear) if self.wrapped.WormGear else None
