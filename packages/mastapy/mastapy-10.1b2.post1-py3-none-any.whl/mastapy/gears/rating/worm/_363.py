...
class WormGearMeshRating(_339.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_463.WormGearMeshDesign':
        ...
        return constructor.new(_463.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
