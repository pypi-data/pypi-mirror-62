...
from mastapy.gears.gear_designs.worm import _470
...
class WormGearRating(_339.GearRating):
    ...
    @property
    def worm_gear(self) -> '_470.WormGearDesign':
        ...
        return constructor.new(_470.WormGearDesign)(self.wrapped.WormGear) if self.wrapped.WormGear else None
