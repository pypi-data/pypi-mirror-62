...
from mastapy.gears.gear_designs.worm import _456
...
class WormGearMeshRating(_337.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_456.WormGearMeshDesign':
        ...
        return constructor.new(_456.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
