...
from mastapy.gears.rating.worm import _354, _353
...
class WormGearDutyCycleRating(_335.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_354.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_354.WormGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def worm_gear_set_design_duty_cycle(self) -> '_354.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_354.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None
