...
class WormGearRating(_164.GearRating):
    '''WormGearRating
    ...
    @property
    def worm_gear(self) -> '_713.WormGearDesign':
        ...
        return constructor.new(_713.WormGearDesign)(self.wrapped.WormGear) if self.wrapped.WormGear else None
