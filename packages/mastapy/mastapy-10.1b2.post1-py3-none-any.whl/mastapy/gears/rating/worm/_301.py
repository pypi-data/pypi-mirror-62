...
from mastapy.gears.rating.worm import _304, _303
...
class WormGearDutyCycleRating(_287.GearDutyCycleRating):
    '''WormGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_304.WormGearSetDutyCycleRating':
    ...
    @property
    def worm_gear_set_design_duty_cycle(self) -> '_304.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_304.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_303.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_303.WormGearRating))
        return value

    @property
    def worm_gear_ratings(self) -> 'List[_303.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearRatings, constructor.new(_303.WormGearRating))
        return value
