...
from mastapy.gears.rating.worm import _352, _351
...
class WormGearDutyCycleRating(_334.GearDutyCycleRating):
    ...
    @property
    def gear_ratings(self) -> 'List[_351.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_351.WormGearRating))
        return value
