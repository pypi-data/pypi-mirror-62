...
from mastapy.gears.gear_designs.worm import _471
...
class WormGearMeshRating(_336.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_471.WormGearMeshDesign':
        ...
        return constructor.new(_471.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None

    @property
    def worm_gear_ratings(self) -> 'List[_351.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearRatings, constructor.new(_351.WormGearRating))
        return value
