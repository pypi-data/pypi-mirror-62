...
class WormMeshDutyCycleRating(_342.MeshDutyCycleRating):
    '''WormMeshDutyCycleRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_361.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_361.WormGearMeshRating))
        return value
