...
from mastapy.gears.rating import _337, _334
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.worm import _382, _381
...
class WormGearDutyCycleRating(_334.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_382.WormGearSetDutyCycleRating':
    ...
    @property
    def worm_gear_set_design_duty_cycle(self) -> '_382.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_382.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_381.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_381.WormGearRating))
        return value

    @property
    def worm_gear_ratings(self) -> 'List[_381.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearRatings, constructor.new(_381.WormGearRating))
        return value
