...
from mastapy.gears.rating.klingelnberg_conical import _426
...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_426.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_525.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_525.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear else None
