...
from mastapy.gears.rating.klingelnberg_conical import _341
...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_341.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_851.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_851.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear else None
