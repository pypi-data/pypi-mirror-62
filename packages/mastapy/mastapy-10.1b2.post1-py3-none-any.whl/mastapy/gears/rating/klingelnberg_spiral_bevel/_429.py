...
from mastapy.gears.rating.klingelnberg_conical import _435
...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_435.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_524.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_524.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear else None
