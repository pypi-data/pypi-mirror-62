...
from mastapy.gears.rating.bevel.standards import _554, _552
from mastapy.gears.rating.iso_10300 import _438, _436
...
class BevelGearMeshRating(_558.AGMAGleasonConicalGearMeshRating):
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_554.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_554.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_552.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_552.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_438.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_438.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_436.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_436.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 else None
