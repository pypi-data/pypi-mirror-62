...
from mastapy.gears.rating.bevel.standards import _569, _567
from mastapy.gears.rating.iso_10300 import _448, _446
...
class BevelGearMeshRating(_538.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_569.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_569.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_567.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_567.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_448.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_448.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_446.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_446.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 else None
