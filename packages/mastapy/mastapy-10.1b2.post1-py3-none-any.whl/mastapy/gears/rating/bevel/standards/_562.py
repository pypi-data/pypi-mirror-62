...
from mastapy.gears.rating.bevel.standards import _561, _564
...
class GleasonSpiralBevelMeshSingleFlankRating(_564.SpiralBevelMeshSingleFlankRating):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_561.GleasonSpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_561.GleasonSpiralBevelGearSingleFlankRating))
        return value

    @property
    def gleason_bevel_gear_single_flank_ratings(self) -> 'List[_561.GleasonSpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GleasonBevelGearSingleFlankRatings, constructor.new(_561.GleasonSpiralBevelGearSingleFlankRating))
        return value
