...
from mastapy.gears.rating.bevel.standards import _557, _564
...
class AGMASpiralBevelMeshSingleFlankRating(_564.SpiralBevelMeshSingleFlankRating):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_557.AGMASpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_557.AGMASpiralBevelGearSingleFlankRating))
        return value

    @property
    def agma_bevel_gear_single_flank_ratings(self) -> 'List[_557.AGMASpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMABevelGearSingleFlankRatings, constructor.new(_557.AGMASpiralBevelGearSingleFlankRating))
        return value
