...
from mastapy.gears.rating.bevel.standards import _566, _564
...
class BevelGearMeshRating(_570.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_566.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_566.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_564.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_564.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None
