...
class ConicalMeshDutyCycleRating(_294.MeshDutyCycleRating):
    '''ConicalMeshDutyCycleRating
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_449.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_449.ConicalGearMeshRating))
        return value
