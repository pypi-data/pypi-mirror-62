...
class ConicalMeshDutyCycleRating(_341.MeshDutyCycleRating):
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_473.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_473.ConicalGearMeshRating))
        return value
