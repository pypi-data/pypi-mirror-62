...
from mastapy.gears.gear_designs.conical import _877
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_877.ConicalFlanks':
        ...
        return constructor.new(_877.ConicalFlanks)(value) if value else None
