...
from mastapy.gears.gear_designs.conical import _998
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_998.ConicalFlanks':
        ...
        return constructor.new(_998.ConicalFlanks)(value) if value else None
