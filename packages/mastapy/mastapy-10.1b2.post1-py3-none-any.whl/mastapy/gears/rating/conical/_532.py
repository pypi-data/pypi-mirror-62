...
from mastapy.gears.gear_designs.conical import _666
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_666.ConicalFlanks':
        ...
        return constructor.new(_666.ConicalFlanks)(value) if value else None
