...
from mastapy.gears.gear_designs.conical import _647
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_647.ConicalFlanks':
        ...
        return constructor.new(_647.ConicalFlanks)(value) if value else None
