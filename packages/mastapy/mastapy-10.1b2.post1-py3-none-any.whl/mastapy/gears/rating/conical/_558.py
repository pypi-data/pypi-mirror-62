...
class ConicalMeshDutyCycleRating(_346.MeshDutyCycleRating):
    '''ConicalMeshDutyCycleRating
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_469.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_469.ConicalGearMeshRating))
        return value
