...
from mastapy.gears.load_case.conical import _347
...
class ConicalGearMeshRating(_336.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_347.ConicalMeshLoadCase':
        ...
        return constructor.new(_347.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def conical_mesh_load_case(self) -> '_347.ConicalMeshLoadCase':
        ...
        return constructor.new(_347.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None
