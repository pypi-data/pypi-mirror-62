...
from mastapy.gears.gear_designs.conical import _652
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_652.ConicalFlanks':
        ...
        return constructor.new(_652.ConicalFlanks)(value) if value else None
