...
from mastapy.gears.gear_designs.conical import _663
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_663.ConicalFlanks':
        ...
        return constructor.new(_663.ConicalFlanks)(value) if value else None
