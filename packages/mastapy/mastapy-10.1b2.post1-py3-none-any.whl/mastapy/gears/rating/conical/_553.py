...
class ConicalMeshDutyCycleRating(_343.MeshDutyCycleRating):
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_468.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_468.ConicalGearMeshRating))
        return value
