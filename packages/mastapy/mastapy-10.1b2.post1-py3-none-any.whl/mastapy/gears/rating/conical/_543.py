...
from mastapy.gears.rating.conical import _415, _481
...
class ConicalGearDutyCycleRating(_334.GearDutyCycleRating):
    '''ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_415.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_415.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_415.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_415.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle else None
    ...
    @property
    def gear_ratings(self) -> 'List[_481.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_481.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_481.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_481.ConicalGearRating))
        return value
