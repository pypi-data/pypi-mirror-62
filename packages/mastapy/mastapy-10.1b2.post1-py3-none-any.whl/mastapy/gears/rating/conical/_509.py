...
from mastapy.gears.gear_designs.conical import _658
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_658.ConicalFlanks':
        ...
        return constructor.new(_658.ConicalFlanks)(value) if value else None
