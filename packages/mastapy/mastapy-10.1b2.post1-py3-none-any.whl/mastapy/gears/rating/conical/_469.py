...
class ConicalGearMeshRating(_341.GearMeshRating):
    '''ConicalGearMeshRating
    ...
    @property
    def mesh_load_case(self) -> '_414.ConicalMeshLoadCase':
        ...
        return constructor.new(_414.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None
