...
from mastapy.gears.rating.conical import _378, _457
...
class ConicalGearDutyCycleRating(_333.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_378.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_378.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_378.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_378.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle else None
    ...
    @property
    def gear_ratings(self) -> 'List[_457.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_457.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_457.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_457.ConicalGearRating))
        return value
