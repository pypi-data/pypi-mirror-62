...
from mastapy.gears.load_case.conical import _349
...
class ConicalGearMeshRating(_338.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_349.ConicalMeshLoadCase':
        ...
        return constructor.new(_349.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def conical_mesh_load_case(self) -> '_349.ConicalMeshLoadCase':
        ...
        return constructor.new(_349.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None
