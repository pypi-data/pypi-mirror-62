...
from mastapy.gears.gear_designs.conical import _714
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_714.ConicalFlanks':
        ...
        return constructor.new(_714.ConicalFlanks)(value) if value else None
