...
from mastapy.gears.gear_designs.conical import _667
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_667.ConicalFlanks':
        ...
        return constructor.new(_667.ConicalFlanks)(value) if value else None
