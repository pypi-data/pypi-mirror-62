...
class MeshSingleFlankRating(_1.APIBase):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_343.GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_343.GearSingleFlankRating))
        return value
