...
from mastapy.gears.rating.conical import _518
...
T = TypeVar('T', bound='_377.VirtualCylindricalGearBasic')


class ISO10300SingleFlankRating(_518.ConicalGearSingleFlankRating, Generic[T]):
    '''ISO10300SingleFlankRating
