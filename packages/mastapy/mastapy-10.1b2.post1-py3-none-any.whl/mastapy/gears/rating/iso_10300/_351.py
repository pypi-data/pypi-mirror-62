...
from mastapy.gears.rating.conical import _456
from mastapy.gears.rating.virtual_cylindrical_gears import _318
...
T = TypeVar('T', bound='_318.VirtualCylindricalGearBasic')


class ISO10300MeshSingleFlankRating(_456.ConicalMeshSingleFlankRating, Generic[T]):
    '''ISO10300MeshSingleFlankRating
