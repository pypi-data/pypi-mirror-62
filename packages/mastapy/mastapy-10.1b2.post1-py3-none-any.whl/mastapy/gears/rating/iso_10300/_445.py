...
from mastapy.gears.rating.conical import _524
from mastapy.gears.rating.virtual_cylindrical_gears import _370
...
T = TypeVar('T', bound='_370.VirtualCylindricalGearBasic')


class ISO10300MeshSingleFlankRating(_524.ConicalMeshSingleFlankRating, Generic[T]):
    '''ISO10300MeshSingleFlankRating
