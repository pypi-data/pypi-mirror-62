...
from mastapy.gears.rating.conical import _523
...
T = TypeVar('T', bound='_397.VirtualCylindricalGearBasic')


class ISO10300RateableMesh(_523.ConicalRateableMesh, Generic[T]):
    '''ISO10300RateableMesh
