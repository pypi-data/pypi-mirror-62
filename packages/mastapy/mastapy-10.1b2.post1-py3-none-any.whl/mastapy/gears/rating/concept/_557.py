...
class ConceptGearMeshRating(_339.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_581.ConceptGearMeshDesign':
        ...
        return constructor.new(_581.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
