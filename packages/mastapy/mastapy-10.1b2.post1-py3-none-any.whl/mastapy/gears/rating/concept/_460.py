...
from mastapy.gears.gear_designs.concept import _1023
...
class ConceptGearMeshRating(_289.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_1023.ConceptGearMeshDesign':
        ...
        return constructor.new(_1023.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
