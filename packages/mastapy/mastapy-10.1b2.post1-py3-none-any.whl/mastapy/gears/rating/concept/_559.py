...
from mastapy.gears.gear_designs.concept import _585
...
class ConceptGearRating(_339.GearRating):
    ...
    @property
    def concept_gear(self) -> '_585.ConceptGearDesign':
        ...
        return constructor.new(_585.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
