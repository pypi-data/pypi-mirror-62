...
from mastapy.gears.rating.concept import _564, _565
...
class ConceptGearSetRating(_344.GearSetRating):
    '''ConceptGearSetRating
    ...
    @property
    def concept_mesh_ratings(self) -> 'List[_564.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_564.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_565.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_565.ConceptGearRating))
        return value

    @property
    def concept_gear_ratings(self) -> 'List[_565.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_565.ConceptGearRating))
        return value
