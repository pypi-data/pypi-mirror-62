...
class ConceptGearRating(_337.GearRating):
    ...
    @property
    def concept_gear(self) -> '_583.ConceptGearDesign':
        ...
        return constructor.new(_583.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
