...
class ConceptGearRating(_340.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concept_gear(self) -> '_582.ConceptGearDesign':
        ...
        return constructor.new(_582.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
