...
class ConceptGearMeshRating(_336.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_580.ConceptGearMeshDesign':
        ...
        return constructor.new(_580.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None

    @property
    def concept_gear_ratings(self) -> 'List[_550.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_550.ConceptGearRating))
        return value
