...
from mastapy.gears.gear_designs.concept import _575
...
class ConceptGearMeshRating(_335.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_575.ConceptGearMeshDesign':
        ...
        return constructor.new(_575.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
