...
from mastapy.gears.gear_designs.concept import _601
...
class ConceptGearMeshRating(_339.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_601.ConceptGearMeshDesign':
        ...
        return constructor.new(_601.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
