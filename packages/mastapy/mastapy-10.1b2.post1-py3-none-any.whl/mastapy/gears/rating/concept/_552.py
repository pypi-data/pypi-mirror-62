...
class ConceptGearRating(_336.GearRating):
    ...
    @property
    def concept_gear(self) -> '_579.ConceptGearDesign':
        ...
        return constructor.new(_579.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
