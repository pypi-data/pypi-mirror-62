...
class MeshSingleFlankRating(_1.APIBase):
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_293.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_293.CoefficientOfFrictionCalculationMethod)(value) if value else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_293.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_345.GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_345.GearSingleFlankRating))
        return value
