...
from mastapy.gears.rating import _157, _156
...
class AbstractGearSetRating(_939.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_157.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_157.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_156.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_156.AbstractGearMeshRating))
        return value
