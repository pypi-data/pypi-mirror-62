...
from mastapy.gears.rating.conical import _450
...
class StraightBevelDiffGearRating(_450.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_839.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_839.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
