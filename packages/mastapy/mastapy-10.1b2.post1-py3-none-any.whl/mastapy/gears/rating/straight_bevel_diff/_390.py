...
from mastapy.gears.rating.straight_bevel_diff import _420, _421
...
class StraightBevelDiffGearSetRating(_402.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_376.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_376.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet else None

    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_420.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_420.StraightBevelDiffGearMeshRating))
        return value
