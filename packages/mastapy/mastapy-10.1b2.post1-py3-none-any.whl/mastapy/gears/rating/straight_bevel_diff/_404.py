...
from mastapy.gears.rating.conical import _462
...
class StraightBevelDiffGearRating(_462.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_461.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_461.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
