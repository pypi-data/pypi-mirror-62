...
from mastapy.gears.gear_designs.straight_bevel_diff import _483
from mastapy.gears.rating.conical import _484
...
class StraightBevelDiffGearRating(_484.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_483.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_483.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
