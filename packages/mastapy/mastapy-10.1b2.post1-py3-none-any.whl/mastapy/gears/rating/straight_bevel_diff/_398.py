...
from mastapy.gears.gear_designs.straight_bevel_diff import _371
from mastapy.gears.rating.straight_bevel_diff import _396, _397
...
class StraightBevelDiffGearSetRating(_482.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_371.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_371.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet else None
    ...
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_396.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_396.StraightBevelDiffGearMeshRating))
        return value
