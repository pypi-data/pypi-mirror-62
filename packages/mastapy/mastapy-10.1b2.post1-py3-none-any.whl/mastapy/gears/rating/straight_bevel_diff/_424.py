...
from mastapy.gears.rating.conical import _477
...
class StraightBevelDiffGearRating(_477.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_476.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_476.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
