...
class StraightBevelDiffGearRating(_486.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_485.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_485.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
