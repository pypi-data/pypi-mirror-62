...
from mastapy.gears.gear_designs.straight_bevel_diff import _464
from mastapy.gears.rating.straight_bevel_diff import _399, _397
from mastapy.gears.rating.conical import _465
...
class StraightBevelDiffGearMeshRating(_465.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_464.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_464.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None

    @property
    def meshed_gears(self) -> 'List[_399.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_399.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_399.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_399.StraightBevelDiffMeshedGearRating))
        return value
    ...
    def straight_bevel_diff_gear_ratings(self) -> 'List[_397.StraightBevelDiffGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearRatings, constructor.new(_397.StraightBevelDiffGearRating))
        return value
