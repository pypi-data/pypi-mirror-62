...
from mastapy.gears.rating.cylindrical import _506
...
class CylindricalGearRating(_340.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_506.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_506.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
