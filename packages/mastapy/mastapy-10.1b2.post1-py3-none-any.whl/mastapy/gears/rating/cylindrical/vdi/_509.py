...
from mastapy.gears.rating.cylindrical.din3990 import _547
...
class VDI2737InternalGearSingleFlankRating(_1.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_543.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_543.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_539.ISO63361996GearSingleFlankRating':
        ...
        if _539.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_539.ISO63361996GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_540.ISO63362006GearSingleFlankRating':
        ...
        if _540.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_540.ISO63362006GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_541.ISO63362019GearSingleFlankRating':
        ...
        if _541.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_541.ISO63362019GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_547.DIN3990GearSingleFlankRating':
        ...
        if _547.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_547.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
