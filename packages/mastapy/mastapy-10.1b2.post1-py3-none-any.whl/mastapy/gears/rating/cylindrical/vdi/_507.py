...
from mastapy.gears.rating.cylindrical.din3990 import _544
...
class VDI2737InternalGearSingleFlankRating(_1.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_538.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_538.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
    ...
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_531.ISO63361996GearSingleFlankRating':
        ...
        if _531.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_533.ISO63362006GearSingleFlankRating':
        ...
        if _533.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_533.ISO63362006GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_534.ISO63362019GearSingleFlankRating':
        ...
        if _534.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_534.ISO63362019GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_544.DIN3990GearSingleFlankRating':
        ...
        if _544.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_544.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
