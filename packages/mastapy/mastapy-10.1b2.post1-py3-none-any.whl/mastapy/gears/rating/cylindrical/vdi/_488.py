...
from mastapy.gears.rating.cylindrical.din3990 import _541
...
class VDI2737InternalGearSingleFlankRating(_1.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_537.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_537.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_541.DIN3990GearSingleFlankRating':
        ...
        return constructor.new(_541.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
