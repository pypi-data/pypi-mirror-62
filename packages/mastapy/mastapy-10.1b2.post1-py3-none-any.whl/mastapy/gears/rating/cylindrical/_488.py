...
from mastapy.gears.rating.cylindrical import _500
...
class CylindricalGearScuffingResults(_1.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_500.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_500.ScuffingResultsRow))
        return value
