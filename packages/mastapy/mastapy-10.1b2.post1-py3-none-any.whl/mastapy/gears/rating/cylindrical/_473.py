...
from mastapy.gears.rating import _338, _335
from mastapy.gears.rating.cylindrical import _425, _479, _516
...
class CylindricalGearDutyCycleRating(_335.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_425.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_425.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_425.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_425.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_479.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_479.CylindricalGearRating))
        return value

    @property
    def cylindrical_gear_ratings(self) -> 'List[_479.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearRatings, constructor.new(_479.CylindricalGearRating))
        return value

    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_516.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_516.MeshRatingForReports))
        return value
