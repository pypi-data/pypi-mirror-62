...
from mastapy.gears.gear_designs.cylindrical import _378
...
class CylindricalGearSetDutyCycleRating(_338.GearSetDutyCycleRating):
    ...
    @property
    def optimisations(self) -> '_512.CylindricalGearSetRatingOptimisationHelper':
        ...
        return constructor.new(_512.CylindricalGearSetRatingOptimisationHelper)(self.wrapped.Optimisations) if self.wrapped.Optimisations else None

    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_485.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshDutyCycleRatings, constructor.new(_485.CylindricalMeshDutyCycleRating))
        return value

    @property
    def cylindrical_mesh_duty_cycle_ratings(self) -> 'List[_485.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshDutyCycleRatings, constructor.new(_485.CylindricalMeshDutyCycleRating))
        return value
