...
from mastapy.gears.rating.cylindrical.optimisation import _540
...
class SafetyFactorOptimisationStepResultShortLength(_540.SafetyFactorOptimisationStepResult):
    '''SafetyFactorOptimisationStepResultShortLength
