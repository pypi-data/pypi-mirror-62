...
from mastapy.gears.rating.cylindrical.optimisation import _534
...
class SafetyFactorOptimisationStepResultShortLength(_534.SafetyFactorOptimisationStepResult):
    '''SafetyFactorOptimisationStepResultShortLength
