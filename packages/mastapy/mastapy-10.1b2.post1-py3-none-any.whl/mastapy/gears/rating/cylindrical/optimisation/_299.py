...
from mastapy.gears.rating import _171
...
class SafetyFactorOptimisationStepResult(_1.APIBase):
    ...
    @property
    def safety_factors(self) -> '_171.SafetyFactorResults':
        ...
        return constructor.new(_171.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def normalised_safety_factors(self) -> '_171.SafetyFactorResults':
        ...
        return constructor.new(_171.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors else None
