...
from mastapy.gears.rating import _297
...
class SafetyFactorOptimisationStepResult(_1.APIBase):
    ...
    @property
    def safety_factors(self) -> '_297.SafetyFactorResults':
        ...
        return constructor.new(_297.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def normalised_safety_factors(self) -> '_297.SafetyFactorResults':
        ...
        return constructor.new(_297.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors else None
