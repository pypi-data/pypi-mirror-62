...
class CylindricalGearSetRatingOptimisationHelper(_1.APIBase):
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_521.OptimisationResultsPair[_528.SafetyFactorOptimisationStepResultNumber]':
        ...
        return constructor.new(_521.OptimisationResultsPair)[_528.SafetyFactorOptimisationStepResultNumber](self.wrapped.ProfileShiftCoefficientOptimisationResults) if self.wrapped.ProfileShiftCoefficientOptimisationResults else None

    @property
    def helix_angle_optimisation_results(self) -> '_521.OptimisationResultsPair[_527.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_521.OptimisationResultsPair)[_527.SafetyFactorOptimisationStepResultAngle](self.wrapped.HelixAngleOptimisationResults) if self.wrapped.HelixAngleOptimisationResults else None

    @property
    def normal_module_optimisation_results(self) -> '_521.OptimisationResultsPair[_529.SafetyFactorOptimisationStepResultShortLength]':
        ...
        return constructor.new(_521.OptimisationResultsPair)[_529.SafetyFactorOptimisationStepResultShortLength](self.wrapped.NormalModuleOptimisationResults) if self.wrapped.NormalModuleOptimisationResults else None

    @property
    def pressure_angle_optimisation_results(self) -> '_521.OptimisationResultsPair[_527.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_521.OptimisationResultsPair)[_527.SafetyFactorOptimisationStepResultAngle](self.wrapped.PressureAngleOptimisationResults) if self.wrapped.PressureAngleOptimisationResults else None
