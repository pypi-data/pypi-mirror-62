...
class CylindricalGearSetDutyCycleRating(_341.GearSetDutyCycleRating):
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_490.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshDutyCycleRatings, constructor.new(_490.CylindricalMeshDutyCycleRating))
        return value

    @property
    def cylindrical_mesh_duty_cycle_ratings(self) -> 'List[_490.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshDutyCycleRatings, constructor.new(_490.CylindricalMeshDutyCycleRating))
        return value
