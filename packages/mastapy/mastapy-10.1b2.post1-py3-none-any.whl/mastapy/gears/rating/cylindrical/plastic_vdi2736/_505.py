...
from mastapy.gears.gear_designs.cylindrical import _563
...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_533.ISO6336AbstractMeshSingleFlankRating):
    '''PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    @property
    def type_of_mechanism_housing(self) -> '_563.TypeOfMechanismHousing':
        ...
        return constructor.new(_563.TypeOfMechanismHousing)(value) if value else None
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_504.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_504.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value

    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_504.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlasticVDI2736CylindricalGearSingleFlankRatings, constructor.new(_504.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value
