...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _513
from mastapy.materials import _272, _273
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_536.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_336.FlankLoadingState':
        ...
        return constructor.new(_336.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_513.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_513.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
