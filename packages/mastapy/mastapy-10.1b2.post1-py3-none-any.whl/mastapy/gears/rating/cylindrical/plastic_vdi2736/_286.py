...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _290
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_310.ISO6336AbstractGearSingleFlankRating):
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_160.FlankLoadingState':
        ...
        return constructor.new(_160.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_290.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_290.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
