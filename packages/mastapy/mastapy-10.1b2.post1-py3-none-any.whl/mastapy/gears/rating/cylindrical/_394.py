...
from mastapy.gears import _253
from mastapy.gears.gear_designs.cylindrical import _933, _932
from mastapy.materials import _217
from mastapy.gears.rating.cylindrical import _389, _388, _392
from mastapy.gears.rating import _295
...
class CylindricalMeshSingleFlankRating(_295.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_253.ContactRatioDataSource':
        ...
        return constructor.new(_253.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_933.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_933.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def lubrication_detail(self) -> '_217.LubricationDetail':
        ...
        return constructor.new(_217.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_389.CylindricalGearScuffingResults':
        ...
        return constructor.new(_389.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_389.CylindricalGearScuffingResults':
        ...
        return constructor.new(_389.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None

    @property
    def rating_settings(self) -> '_388.CylindricalGearRatingSettings':
        ...
        return constructor.new(_388.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_392.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_392.CylindricalGearSingleFlankRating))
        return value
