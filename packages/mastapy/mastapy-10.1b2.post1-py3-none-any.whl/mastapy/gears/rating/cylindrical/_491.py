...
from mastapy.gears.gear_designs.cylindrical import _552, _553
from mastapy.materials import _263
from mastapy.gears.rating.cylindrical import _488, _21, _489
from mastapy.gears.rating import _345
...
class CylindricalMeshSingleFlankRating(_345.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_294.ContactRatioDataSource':
        ...
        return constructor.new(_294.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_552.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_552.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    def lubrication_detail(self) -> '_263.LubricationDetail':
        ...
        return constructor.new(_263.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_488.CylindricalGearScuffingResults':
        ...
        return constructor.new(_488.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_488.CylindricalGearScuffingResults':
        ...
        return constructor.new(_488.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_489.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_489.CylindricalGearSingleFlankRating))
        return value
