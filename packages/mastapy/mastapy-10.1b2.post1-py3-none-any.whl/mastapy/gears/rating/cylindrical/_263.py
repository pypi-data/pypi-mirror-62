...
class CylindricalGearScuffingResults(_1.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_279.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_279.ScuffingResultsRow))
        return value
