...
from mastapy.gears.rating.cylindrical import _280
...
class ScuffingResultsRow(_1.APIBase):
    ...
    @property
    def pinion(self) -> '_280.ScuffingResultsRowGear':
        ...
        return constructor.new(_280.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
