...
from mastapy.gears.gear_designs.cylindrical import _812, _811
from mastapy.materials import _75
from mastapy.gears.rating.cylindrical import _263, _262, _266
...
class CylindricalMeshSingleFlankRating(_169.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_124.ContactRatioDataSource':
        ...
        return constructor.new(_124.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_812.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_812.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def lubrication_detail(self) -> '_75.LubricationDetail':
        ...
        return constructor.new(_75.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_263.CylindricalGearScuffingResults':
        ...
        return constructor.new(_263.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_263.CylindricalGearScuffingResults':
        ...
        return constructor.new(_263.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None

    @property
    def rating_settings(self) -> '_262.CylindricalGearRatingSettings':
        ...
        return constructor.new(_262.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_266.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_266.CylindricalGearSingleFlankRating))
        return value
