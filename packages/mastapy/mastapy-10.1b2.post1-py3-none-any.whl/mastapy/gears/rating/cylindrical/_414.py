...
class CylindricalGearSetRating(_339.GearSetRating):
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_500.VDI2737InternalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VDICylindricalGearSingleFlankRatings, constructor.new(_500.VDI2737InternalGearSingleFlankRating))
        return value
