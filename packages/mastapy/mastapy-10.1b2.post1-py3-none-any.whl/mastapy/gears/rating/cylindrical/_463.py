...
from mastapy.gears.rating.cylindrical import _400, _468, _488
...
class CylindricalGearDutyCycleRating(_334.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_400.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_400.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_400.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_468.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_468.CylindricalGearRating))
        return value
