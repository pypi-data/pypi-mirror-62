...
from mastapy.gears.rating.cylindrical import _388, _384, _386
from mastapy.gears.rating.cylindrical.optimisation import _422
from mastapy.gears.gear_designs.cylindrical import _899
...
class CylindricalGearSetRating(_292.GearSetRating):
    '''CylindricalGearSetRating
    ...
    @property
    def optimisations(self) -> '_422.CylindricalGearSetRatingOptimisationHelper':
        ...
        return constructor.new(_422.CylindricalGearSetRatingOptimisationHelper)(self.wrapped.Optimisations) if self.wrapped.Optimisations else None
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_410.VDI2737InternalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VDICylindricalGearSingleFlankRatings, constructor.new(_410.VDI2737InternalGearSingleFlankRating))
        return value

    @property
    def cylindrical_mesh_ratings(self) -> 'List[_384.CylindricalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshRatings, constructor.new(_384.CylindricalGearMeshRating))
        return value
