...
from mastapy.gears.rating.cylindrical import _399, _482, _498
...
class CylindricalGearDutyCycleRating(_339.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_399.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_399.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_399.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_399.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_482.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_482.CylindricalGearRating))
        return value

    @property
    def cylindrical_gear_ratings(self) -> 'List[_482.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearRatings, constructor.new(_482.CylindricalGearRating))
        return value
