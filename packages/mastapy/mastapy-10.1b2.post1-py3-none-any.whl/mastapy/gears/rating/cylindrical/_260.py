...
from mastapy.gears.rating import _162, _164
from mastapy.gears.rating.cylindrical import _283
...
class CylindricalGearRating(_164.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_283.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_283.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
