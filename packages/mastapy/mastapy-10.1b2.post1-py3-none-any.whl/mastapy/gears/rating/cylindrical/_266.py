...
class CylindricalGearSingleFlankRating(_167.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_261.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_261.CylindricalGearRatingGeometryDataSource)(value) if value else None
