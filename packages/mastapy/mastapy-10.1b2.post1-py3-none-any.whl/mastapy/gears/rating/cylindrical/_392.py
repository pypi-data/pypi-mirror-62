...
from mastapy.gears.rating.cylindrical import _387
...
class CylindricalGearSingleFlankRating(_293.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_222.MetalPlasticType':
        ...
        return constructor.new(_222.MetalPlasticType)(value) if value else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_387.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_387.CylindricalGearRatingGeometryDataSource)(value) if value else None
