...
from mastapy.gears.gear_designs.cylindrical import _648
...
class ScuffingResultsRowGear(_1.APIBase):
    ...
    @property
    def profile_measurement(self) -> '_648.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_648.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
