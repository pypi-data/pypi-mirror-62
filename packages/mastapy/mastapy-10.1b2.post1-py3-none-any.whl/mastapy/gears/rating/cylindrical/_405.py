...
from mastapy.gears.rating.cylindrical import _406
...
class ScuffingResultsRow(_1.APIBase):
    ...
    @property
    def pinion(self) -> '_406.ScuffingResultsRowGear':
        ...
        return constructor.new(_406.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
