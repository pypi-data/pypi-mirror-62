...
from mastapy.gears.rating.cylindrical import _501
from mastapy.gears.gear_designs.cylindrical import _577
...
class CylindricalGearRating(_337.GearRating):
    ...
    @property
    def vdi2737_safety_factor(self) -> '_501.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_501.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None

    @property
    def cylindrical_gear(self) -> '_577.CylindricalGearDesign':
        ...
        return constructor.new(_577.CylindricalGearDesign)(self.wrapped.CylindricalGear) if self.wrapped.CylindricalGear else None
