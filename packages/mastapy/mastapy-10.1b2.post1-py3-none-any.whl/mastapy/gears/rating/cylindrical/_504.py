...
from mastapy.gears.rating.cylindrical import _505
...
class ScuffingResultsRow(_1.APIBase):
    ...
    @property
    def pinion(self) -> '_505.ScuffingResultsRowGear':
        ...
        return constructor.new(_505.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
