...
from mastapy.gears.rating.cylindrical import _409
...
class CylindricalGearRating(_290.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_409.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_409.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
