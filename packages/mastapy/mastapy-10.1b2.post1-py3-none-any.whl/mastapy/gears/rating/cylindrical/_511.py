...
class CylindricalMeshDutyCycleRating(_344.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_477.CylindricalGearMeshRating':
        ...
        return constructor.new(_477.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
