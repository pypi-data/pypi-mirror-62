...
class CylindricalGearMicroPittingResults(_1.APIBase):
    ...
    @property
    def micro_pitting_results_row(self) -> 'List[_497.MicroPittingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroPittingResultsRow, constructor.new(_497.MicroPittingResultsRow))
        return value
