...
from mastapy.gears.rating.cylindrical import _520
...
class ScuffingResultsRow(_1.APIBase):
    ...
    @property
    def pinion(self) -> '_520.ScuffingResultsRowGear':
        ...
        return constructor.new(_520.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
