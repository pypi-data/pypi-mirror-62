...
class CylindricalGearRatingSettings(_68.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_502.TipReliefScuffingOptions':
        ...
        return constructor.new(_502.TipReliefScuffingOptions)(value) if value else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_502.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_493.DynamicFactorMethods':
        ...
        return constructor.new(_493.DynamicFactorMethods)(value) if value else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_493.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_494.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_494.GearBlankFactorCalculationOptions)(value) if value else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_494.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_499.ScuffingMethods':
        ...
        return constructor.new(_499.ScuffingMethods)(value) if value else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_499.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def permissible_bending_stress_method(self) -> '_498.RatingMethod':
        ...
        return constructor.new(_498.RatingMethod)(value) if value else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_498.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_505.ToothThicknesses':
        ...
        return constructor.new(_505.ToothThicknesses)(value) if value else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_505.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
