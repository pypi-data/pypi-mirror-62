...
from mastapy.gears import _126, _144
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.cylindrical import _268, _265, _260
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _285, _287, _289
...
from mastapy.gears.load_case.cylindrical import _651
from mastapy.gears.rating.cylindrical.vdi import _284
...
class CylindricalGearMeshRating(_163.GearMeshRating):
    '''CylindricalGearMeshRating
    ...
    @property
    def active_flank(self) -> '_126.CylindricalFlanks':
        ...
        return constructor.new(_126.CylindricalFlanks)(value) if value else None
    ...
    @property
    def load_sharing_factor_source(self) -> '_144.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_144.PlanetaryRatingLoadSharingOption)(value) if value else None
    ...
    @property
    def cylindrical_mesh_single_flank_rating(self) -> '_268.CylindricalMeshSingleFlankRating':
        ...
        return constructor.new(_268.CylindricalMeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None

    @property
    def cylindrical_mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None

    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_287.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _287.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_287.PlasticGearVDI2736AbstractMeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None

    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_289.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _289.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_289.PlasticPlasticVDI2736MeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None
    ...
    def cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_318.DIN3990MeshSingleFlankRating':
        ...
        return constructor.new(_318.DIN3990MeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None
    ...
    def cylindrical_mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_320.AGMA2101MeshSingleFlankRating':
        ...
        return constructor.new(_320.AGMA2101MeshSingleFlankRating)(self.wrapped.CylindricalMeshSingleFlankRating) if self.wrapped.CylindricalMeshSingleFlankRating else None

    @property
    def mesh_load_case(self) -> '_651.CylindricalMeshLoadCase':
        ...
        return constructor.new(_651.CylindricalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def gear_set_rating(self) -> '_265.CylindricalGearSetRating':
        ...
        return constructor.new(_265.CylindricalGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating else None

    @property
    def vdi_cylindrical_gear_single_flank_rating(self) -> '_284.VDI2737InternalGearSingleFlankRating':
        ...
        return constructor.new(_284.VDI2737InternalGearSingleFlankRating)(self.wrapped.VDICylindricalGearSingleFlankRating) if self.wrapped.VDICylindricalGearSingleFlankRating else None
    ...
    def isodin_cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_318.DIN3990MeshSingleFlankRating':
        ...
        return constructor.new(_318.DIN3990MeshSingleFlankRating)(self.wrapped.ISODINCylindricalMeshSingleFlankRating) if self.wrapped.ISODINCylindricalMeshSingleFlankRating else None

    @property
    def mesh_single_flank_rating(self) -> '_268.CylindricalMeshSingleFlankRating':
        ...
        return constructor.new(_268.CylindricalMeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None

    @property
    def mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_285.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None

    @property
    def mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_287.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _287.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_287.PlasticGearVDI2736AbstractMeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None

    @property
    def mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_289.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _289.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
        ...
        return constructor.new(_289.PlasticPlasticVDI2736MeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None
    ...
    def mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_318.DIN3990MeshSingleFlankRating':
        ...
        return constructor.new(_318.DIN3990MeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None
    ...
    def mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_320.AGMA2101MeshSingleFlankRating':
        ...
        return constructor.new(_320.AGMA2101MeshSingleFlankRating)(self.wrapped.MeshSingleFlankRating) if self.wrapped.MeshSingleFlankRating else None
    ...
    @property
    def cylindrical_gear_mesh(self) -> '_773.CylindricalGearMeshDesign':
        ...
        return constructor.new(_773.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMesh) if self.wrapped.CylindricalGearMesh else None

    @property
    def cylindrical_gear_ratings(self) -> 'List[_260.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearRatings, constructor.new(_260.CylindricalGearRating))
        return value
