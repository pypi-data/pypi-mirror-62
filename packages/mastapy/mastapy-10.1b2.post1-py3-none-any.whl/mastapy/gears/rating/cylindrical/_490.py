...
class CylindricalMeshDutyCycleRating(_344.MeshDutyCycleRating):
    ...
    @property
    def highest_torque_load_case(self) -> '_484.CylindricalGearMeshRating':
        ...
        return constructor.new(_484.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
