...
from mastapy.gears.rating.cylindrical import _385
from mastapy.gears.rating.cylindrical.iso6336 import _433, _438, _437
...
class ISO6336AbstractMetalMeshSingleFlankRating(_437.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_935.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_935.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_385.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_385.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_433.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_433.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_438.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_438.ISO6336AbstractMetalGearSingleFlankRating))
        return value
