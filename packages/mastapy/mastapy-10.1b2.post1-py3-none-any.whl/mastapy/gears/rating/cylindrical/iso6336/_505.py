...
from mastapy.gears.gear_designs.cylindrical import _676
from mastapy.gears.rating.cylindrical import _473
from mastapy.gears.rating.cylindrical.iso6336 import _500, _539, _538
...
class ISO6336AbstractMetalMeshSingleFlankRating(_538.ISO6336AbstractMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_676.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_676.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_473.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_473.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_500.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_500.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None
