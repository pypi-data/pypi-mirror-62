...
from mastapy.gears.gear_designs.cylindrical import _669
from mastapy.gears.rating.cylindrical import _474
from mastapy.gears.rating.cylindrical.iso6336 import _484, _537, _536
...
class ISO6336AbstractMetalMeshSingleFlankRating(_536.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_669.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_669.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_484.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_484.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_537.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_537.ISO6336AbstractMetalGearSingleFlankRating))
        return value
