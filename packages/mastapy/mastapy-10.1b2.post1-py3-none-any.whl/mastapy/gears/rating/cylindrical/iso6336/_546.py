...
from mastapy.gears.rating.cylindrical import _371, _495
...
class ISO6336RateableMesh(_495.CylindricalRateableMesh):
    '''ISO6336RateableMesh
    ...
    def misalignment_contact_pattern_enhancement(self, value: '_371.MisalignmentContactPatternEnhancements'):
