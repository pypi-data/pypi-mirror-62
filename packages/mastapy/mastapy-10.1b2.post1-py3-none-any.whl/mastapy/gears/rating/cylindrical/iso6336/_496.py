...
from mastapy.gears.gear_designs.cylindrical import _619
from mastapy.gears.rating.cylindrical import _478
from mastapy.gears.rating.cylindrical.iso6336 import _493, _545, _495
...
class ISO6336AbstractMetalMeshSingleFlankRating(_495.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_619.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_619.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_478.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_478.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_493.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_493.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_545.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_545.ISO6336AbstractMetalGearSingleFlankRating))
        return value
