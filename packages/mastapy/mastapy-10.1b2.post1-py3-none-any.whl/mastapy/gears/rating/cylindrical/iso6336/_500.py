...
from mastapy.gears.gear_designs.cylindrical import _675
from mastapy.gears.rating.cylindrical import _470
from mastapy.gears.rating.cylindrical.iso6336 import _495, _528, _542
...
class ISO6336AbstractMetalMeshSingleFlankRating(_542.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_675.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_675.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_470.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_470.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_528.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_528.ISO6336AbstractMetalGearSingleFlankRating))
        return value
