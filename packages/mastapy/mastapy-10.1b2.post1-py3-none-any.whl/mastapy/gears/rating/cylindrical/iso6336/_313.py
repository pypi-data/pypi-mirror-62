...
class ISO6336AbstractMetalMeshSingleFlankRating(_311.ISO6336AbstractMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_814.ScuffingTemperatureMethodsISO':
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_259.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_259.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None
