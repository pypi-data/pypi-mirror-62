...
from mastapy.gears.rating.cylindrical import _371, _494
from mastapy.gears.rating.cylindrical.iso6336 import _542
...
class ISO6336AbstractMeshSingleFlankRating(_494.CylindricalMeshSingleFlankRating):
    '''ISO6336AbstractMeshSingleFlankRating
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_371.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_371.MisalignmentContactPatternEnhancements)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_542.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_542.ISO6336AbstractGearSingleFlankRating))
        return value

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_542.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_542.ISO6336AbstractGearSingleFlankRating))
        return value
