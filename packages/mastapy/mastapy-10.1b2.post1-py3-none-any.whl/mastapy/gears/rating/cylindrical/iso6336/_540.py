...
from mastapy.gears.gear_designs.cylindrical import _681
from mastapy.gears.rating.cylindrical import _485
from mastapy.gears.rating.cylindrical.iso6336 import _503, _539, _538
...
class ISO6336AbstractMetalMeshSingleFlankRating(_538.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_681.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_681.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_485.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_485.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_503.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_503.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_539.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_539.ISO6336AbstractMetalGearSingleFlankRating))
        return value
