...
from mastapy.gears.rating.cylindrical import _321, _488
...
class ISO6336RateableMesh(_488.CylindricalRateableMesh):
    '''ISO6336RateableMesh
    ...
    def misalignment_contact_pattern_enhancement(self, value: '_321.MisalignmentContactPatternEnhancements'):
