...
from mastapy.gears.rating.cylindrical import _353, _492
...
class ISO6336RateableMesh(_492.CylindricalRateableMesh):
    '''ISO6336RateableMesh
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_353.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_353.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_353.MisalignmentContactPatternEnhancements'):
