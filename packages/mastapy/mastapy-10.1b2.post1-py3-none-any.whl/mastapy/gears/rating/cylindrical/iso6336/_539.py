...
from mastapy.gears.gear_designs.cylindrical import _663
from mastapy.gears.rating.cylindrical import _485
from mastapy.gears.rating.cylindrical.iso6336 import _517, _538, _537
...
class ISO6336AbstractMetalMeshSingleFlankRating(_537.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_663.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_663.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_517.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_517.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_538.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_538.ISO6336AbstractMetalGearSingleFlankRating))
        return value
