...
from mastapy.gears.rating.cylindrical import _415, _486, _496
...
class CylindricalGearDutyCycleRating(_337.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_415.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_415.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_415.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_496.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_496.MeshRatingForReports))
        return value
