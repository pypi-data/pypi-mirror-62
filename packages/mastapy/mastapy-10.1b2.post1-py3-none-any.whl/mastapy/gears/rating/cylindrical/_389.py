...
from mastapy.gears.rating.cylindrical import _405
...
class CylindricalGearScuffingResults(_1.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_405.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_405.ScuffingResultsRow))
        return value
