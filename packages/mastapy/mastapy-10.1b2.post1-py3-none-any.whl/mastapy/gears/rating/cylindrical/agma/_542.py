...
from mastapy.gears.gear_designs.cylindrical import _578, _579
...
class AGMA2101MeshSingleFlankRating(_480.CylindricalMeshSingleFlankRating):
    ...
    @property
    def profile_modification(self) -> '_578.CylindricalGearProfileModifications':
        ...
        return constructor.new(_578.CylindricalGearProfileModifications)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_579.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_579.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_541.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_541.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_541.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_541.AGMA2101GearSingleFlankRating))
        return value
