...
from mastapy.gears.gear_designs.cylindrical import _581, _582
from mastapy.materials import _244
from mastapy.gears.rating.cylindrical.agma import _545
...
class AGMA2101MeshSingleFlankRating(_479.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def profile_modification(self) -> '_581.CylindricalGearProfileModifications':
        ...
        return constructor.new(_581.CylindricalGearProfileModifications)(value) if value else None

    @property
    def gearing_type(self) -> '_244.GearingTypes':
        ...
        return constructor.new(_244.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_582.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_582.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_545.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_545.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_545.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_545.AGMA2101GearSingleFlankRating))
        return value
