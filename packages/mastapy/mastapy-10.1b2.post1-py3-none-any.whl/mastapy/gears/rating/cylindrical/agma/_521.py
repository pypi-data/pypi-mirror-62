...
from mastapy.gears.gear_designs.cylindrical import _570, _571
from mastapy.materials import _249
from mastapy.gears.rating.cylindrical.agma import _548
...
class AGMA2101MeshSingleFlankRating(_494.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    def gearing_type(self) -> '_249.GearingTypes':
        ...
        return constructor.new(_249.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_571.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_571.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_548.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_548.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_548.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_548.AGMA2101GearSingleFlankRating))
        return value
