...
from mastapy.gears.gear_designs.cylindrical import _583, _584
from mastapy.materials import _247
from mastapy.gears.rating.cylindrical.agma import _552
...
class AGMA2101MeshSingleFlankRating(_488.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_584.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_584.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_552.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_552.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_552.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_552.AGMA2101GearSingleFlankRating))
        return value
