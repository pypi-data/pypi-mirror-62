...
class AGMA2101MeshSingleFlankRating(_480.CylindricalMeshSingleFlankRating):
    ...
    @property
    def gearing_type(self) -> '_243.GearingTypes':
        ...
        return constructor.new(_243.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_580.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_580.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_542.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_542.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_542.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_542.AGMA2101GearSingleFlankRating))
        return value
