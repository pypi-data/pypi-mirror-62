...
from mastapy.gears.gear_designs.cylindrical import _599, _600
from mastapy.materials import _248
from mastapy.gears.rating.cylindrical.agma import _546
...
class AGMA2101MeshSingleFlankRating(_491.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_600.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_600.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_546.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_546.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_546.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_546.AGMA2101GearSingleFlankRating))
        return value
