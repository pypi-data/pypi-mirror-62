...
from mastapy.gears.gear_designs.cylindrical import _615, _616
from mastapy.materials import _248
from mastapy.gears.rating.cylindrical.agma import _554
...
class AGMA2101MeshSingleFlankRating(_487.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def profile_modification(self) -> '_615.CylindricalGearProfileModifications':
        ...
        return constructor.new(_615.CylindricalGearProfileModifications)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_616.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_616.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_554.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_554.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_554.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_554.AGMA2101GearSingleFlankRating))
        return value
