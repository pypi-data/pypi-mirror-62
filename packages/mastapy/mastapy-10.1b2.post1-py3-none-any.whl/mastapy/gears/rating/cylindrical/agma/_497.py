...
from mastapy.gears.gear_designs.cylindrical import _576, _577
from mastapy.materials import _245
from mastapy.gears.rating.cylindrical.agma import _544
...
class AGMA2101MeshSingleFlankRating(_485.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def profile_modification(self) -> '_576.CylindricalGearProfileModifications':
        ...
        return constructor.new(_576.CylindricalGearProfileModifications)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_577.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_577.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_544.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_544.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_544.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_544.AGMA2101GearSingleFlankRating))
        return value
