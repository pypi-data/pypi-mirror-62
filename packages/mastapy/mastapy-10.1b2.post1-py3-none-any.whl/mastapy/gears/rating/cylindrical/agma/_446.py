...
from mastapy.gears.gear_designs.cylindrical import _898, _934
from mastapy.materials import _205
from mastapy.gears.rating.cylindrical.agma import _445
...
class AGMA2101MeshSingleFlankRating(_394.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_934.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_934.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_445.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_445.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_445.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_445.AGMA2101GearSingleFlankRating))
        return value
