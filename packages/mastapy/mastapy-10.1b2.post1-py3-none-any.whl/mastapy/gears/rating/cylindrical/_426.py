...
class CylindricalGearSetRating(_342.GearSetRating):
    ...
    @property
    def rating_settings(self) -> '_19.CylindricalGearRatingSettings':
        ...
        return constructor.new(_19.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_499.VDI2737InternalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VDICylindricalGearSingleFlankRatings, constructor.new(_499.VDI2737InternalGearSingleFlankRating))
        return value

    @property
    def cylindrical_mesh_ratings(self) -> 'List[_477.CylindricalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshRatings, constructor.new(_477.CylindricalGearMeshRating))
        return value
