...
class CylindricalMeshDutyCycleRating(_294.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_384.CylindricalGearMeshRating':
        ...
        return constructor.new(_384.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
