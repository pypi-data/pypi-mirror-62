...
from mastapy.gears.rating.virtual_cylindrical_gears import _367
...
class KlingelnbergSpiralBevelVirtualCylindricalGear(_367.KlingelnbergVirtualCylindricalGear):
    '''KlingelnbergSpiralBevelVirtualCylindricalGear
