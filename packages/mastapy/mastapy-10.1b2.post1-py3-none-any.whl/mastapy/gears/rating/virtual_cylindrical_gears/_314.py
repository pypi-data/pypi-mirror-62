...
from mastapy.gears.rating.virtual_cylindrical_gears import _315
...
class KlingelnbergSpiralBevelVirtualCylindricalGear(_315.KlingelnbergVirtualCylindricalGear):
    '''KlingelnbergSpiralBevelVirtualCylindricalGear
