...
from mastapy.gears.rating.agma_gleason_conical import _476
...
class HypoidGearRating(_476.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_863.HypoidGearDesign':
        ...
        return constructor.new(_863.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
