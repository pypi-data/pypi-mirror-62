...
from mastapy.gears.rating.hypoid import _452, _454
...
class HypoidGearSetRating(_562.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_387.HypoidGearSetDesign':
        ...
        return constructor.new(_387.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_452.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_452.HypoidGearMeshRating))
        return value
