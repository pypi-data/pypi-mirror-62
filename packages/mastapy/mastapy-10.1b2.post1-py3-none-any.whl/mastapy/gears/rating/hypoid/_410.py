...
from mastapy.gears.gear_designs.hypoid import _376
from mastapy.gears.rating.hypoid import _457, _458
...
class HypoidGearSetRating(_514.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_376.HypoidGearSetDesign':
        ...
        return constructor.new(_376.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_457.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_457.HypoidGearMeshRating))
        return value
