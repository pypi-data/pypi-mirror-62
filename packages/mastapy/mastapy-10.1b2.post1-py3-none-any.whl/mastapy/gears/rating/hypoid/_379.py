...
from mastapy.gears.gear_designs.hypoid import _369
from mastapy.gears.rating.hypoid import _454, _456
from mastapy.gears.rating.agma_gleason_conical import _504
...
class HypoidGearSetRating(_504.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_369.HypoidGearSetDesign':
        ...
        return constructor.new(_369.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_454.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_454.HypoidGearMeshRating))
        return value

    @property
    def hypoid_gear_ratings(self) -> 'List[_456.HypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearRatings, constructor.new(_456.HypoidGearRating))
        return value
