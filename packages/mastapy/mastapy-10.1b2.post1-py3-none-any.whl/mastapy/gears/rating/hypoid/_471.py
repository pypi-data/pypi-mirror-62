...
class HypoidGearRating(_568.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_586.HypoidGearDesign':
        ...
        return constructor.new(_586.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
