...
from mastapy.gears.rating.hypoid import _470, _471
...
class HypoidGearSetRating(_422.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_470.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_470.HypoidGearMeshRating))
        return value
