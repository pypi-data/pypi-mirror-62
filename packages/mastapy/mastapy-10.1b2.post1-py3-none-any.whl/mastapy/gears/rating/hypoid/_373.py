...
from mastapy.gears.rating.hypoid import _459, _460
from mastapy.gears.rating.agma_gleason_conical import _496
...
class HypoidGearSetRating(_496.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_459.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_459.HypoidGearMeshRating))
        return value
