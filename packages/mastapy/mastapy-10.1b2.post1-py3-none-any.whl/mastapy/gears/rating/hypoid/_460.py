...
class HypoidGearRating(_493.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_492.HypoidGearDesign':
        ...
        return constructor.new(_492.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
