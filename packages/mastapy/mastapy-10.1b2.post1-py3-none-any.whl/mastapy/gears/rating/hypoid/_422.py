...
from mastapy.gears.rating.hypoid import _463, _464
from mastapy.gears.rating.agma_gleason_conical import _432
...
class HypoidGearSetRating(_432.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_463.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_463.HypoidGearMeshRating))
        return value
