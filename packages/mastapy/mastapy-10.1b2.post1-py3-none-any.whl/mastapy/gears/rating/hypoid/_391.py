...
from mastapy.gears.gear_designs.hypoid import _373
from mastapy.gears.rating.hypoid import _466, _467
from mastapy.gears.rating.agma_gleason_conical import _401
...
class HypoidGearSetRating(_401.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_373.HypoidGearSetDesign':
        ...
        return constructor.new(_373.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_466.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_466.HypoidGearMeshRating))
        return value
