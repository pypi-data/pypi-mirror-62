...
from mastapy.gears.gear_designs.hypoid import _394
from mastapy.gears.rating.hypoid import _456, _459
from mastapy.gears.rating.agma_gleason_conical import _482
...
class HypoidGearSetRating(_482.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_394.HypoidGearSetDesign':
        ...
        return constructor.new(_394.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_456.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_456.HypoidGearMeshRating))
        return value

    @property
    def hypoid_gear_ratings(self) -> 'List[_459.HypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearRatings, constructor.new(_459.HypoidGearRating))
        return value
