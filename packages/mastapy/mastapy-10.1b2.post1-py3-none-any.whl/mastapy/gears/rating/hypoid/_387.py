...
from mastapy.gears.gear_designs.hypoid import _377
from mastapy.gears.rating.hypoid import _453, _457
from mastapy.gears.rating.agma_gleason_conical import _493
...
class HypoidGearSetRating(_493.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_377.HypoidGearSetDesign':
        ...
        return constructor.new(_377.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None
