...
from mastapy.gears.rating.hypoid.standards import _466
from mastapy.gears.gear_designs.hypoid import _569
from mastapy.gears.rating.conical import _522
from mastapy.gears.rating.hypoid import _464
...
class HypoidGearMeshRating(_570.AGMAGleasonConicalGearMeshRating):
    '''HypoidGearMeshRating
    ...
    @property
    def gleason_hypoid_mesh_single_flank_rating(self) -> '_466.GleasonHypoidMeshSingleFlankRating':
        ...
        return constructor.new(_466.GleasonHypoidMeshSingleFlankRating)(self.wrapped.GleasonHypoidMeshSingleFlankRating) if self.wrapped.GleasonHypoidMeshSingleFlankRating else None

    @property
    def hypoid_gear_mesh(self) -> '_569.HypoidGearMeshDesign':
        ...
        return constructor.new(_569.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
    ...
    @property
    def gears_in_mesh(self) -> 'List[_522.ConicalMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_522.ConicalMeshedGearRating))
        return value

    @property
    def hypoid_gear_ratings(self) -> 'List[_464.HypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearRatings, constructor.new(_464.HypoidGearRating))
        return value
