...
from mastapy.gears.rating.virtual_cylindrical_gears import _373
...
class KlingelnbergConicalMeshSingleFlankRating(_342.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_373.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_373.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
