...
from mastapy.gears.rating.virtual_cylindrical_gears import _316
...
class KlingelnbergConicalMeshSingleFlankRating(_295.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_316.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_316.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
