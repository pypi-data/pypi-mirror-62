...
from mastapy.gears.rating.virtual_cylindrical_gears import _375
...
class KlingelnbergConicalMeshSingleFlankRating(_342.MeshSingleFlankRating):
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_375.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_375.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
