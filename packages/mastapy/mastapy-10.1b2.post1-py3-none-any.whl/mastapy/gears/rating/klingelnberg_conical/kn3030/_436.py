...
class KlingelnbergConicalMeshSingleFlankRating(_345.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_395.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_395.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
