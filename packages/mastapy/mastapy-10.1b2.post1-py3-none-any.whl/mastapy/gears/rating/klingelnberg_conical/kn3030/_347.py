...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _346, _343
...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_343.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_346.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_346.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_346.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_346.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value
