...
from mastapy.gears.rating import _339, _334
...
class MeshDutyCycleRating(_334.AbstractGearMeshRating):
    '''MeshDutyCycleRating
    ...
    @property
    def gear_duty_cycle_ratings(self) -> 'List[_339.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleRatings, constructor.new(_339.GearDutyCycleRating))
        return value
