...
class SpiralBevelGearMeshRating(_431.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_457.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_457.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
