...
from mastapy.gears.rating.spiral_bevel import _414, _415
...
class SpiralBevelGearSetRating(_431.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_414.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_414.SpiralBevelGearMeshRating))
        return value
