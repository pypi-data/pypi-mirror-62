...
class SpiralBevelGearRating(_339.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_725.SpiralBevelGearDesign':
        ...
        return constructor.new(_725.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
