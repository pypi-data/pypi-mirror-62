...
from mastapy.gears.gear_designs.spiral_bevel import _366
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.spiral_bevel import _419, _420
...
class SpiralBevelGearSetRating(_425.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_set(self) -> '_366.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_366.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet else None

    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_419.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_419.SpiralBevelGearMeshRating))
        return value
