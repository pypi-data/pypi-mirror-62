...
class SpiralBevelGearRating(_407.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_521.SpiralBevelGearDesign':
        ...
        return constructor.new(_521.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
