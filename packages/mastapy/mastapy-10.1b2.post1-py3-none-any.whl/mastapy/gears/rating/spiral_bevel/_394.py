...
from mastapy.gears.rating.spiral_bevel import _418, _420
...
class SpiralBevelGearSetRating(_444.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_set(self) -> '_384.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_384.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet else None
