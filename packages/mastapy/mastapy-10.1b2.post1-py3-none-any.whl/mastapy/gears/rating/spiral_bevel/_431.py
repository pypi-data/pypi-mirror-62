...
class SpiralBevelGearRating(_427.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_497.SpiralBevelGearDesign':
        ...
        return constructor.new(_497.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
