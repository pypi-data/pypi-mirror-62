...
class SpiralBevelGearRating(_465.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_847.SpiralBevelGearDesign':
        ...
        return constructor.new(_847.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
