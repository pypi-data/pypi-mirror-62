...
class SpiralBevelGearMeshRating(_338.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_726.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_726.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
