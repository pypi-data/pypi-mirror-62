...
from mastapy.gears.gear_designs.spiral_bevel import _487
...
class SpiralBevelGearMeshRating(_407.BevelGearMeshRating):
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_487.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_487.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
