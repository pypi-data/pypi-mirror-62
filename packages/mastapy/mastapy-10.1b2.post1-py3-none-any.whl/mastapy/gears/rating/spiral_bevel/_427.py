...
class SpiralBevelGearRating(_446.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_460.SpiralBevelGearDesign':
        ...
        return constructor.new(_460.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
