...
class SpiralBevelGearRating(_433.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_475.SpiralBevelGearDesign':
        ...
        return constructor.new(_475.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
