...
class SpiralBevelGearMeshRating(_464.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_848.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_848.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
