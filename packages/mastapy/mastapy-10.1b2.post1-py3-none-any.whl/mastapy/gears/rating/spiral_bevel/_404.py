...
class SpiralBevelGearRating(_421.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_466.SpiralBevelGearDesign':
        ...
        return constructor.new(_466.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
