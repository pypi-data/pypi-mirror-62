...
class SpiralBevelGearRating(_419.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_498.SpiralBevelGearDesign':
        ...
        return constructor.new(_498.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
