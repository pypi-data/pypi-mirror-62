...
from mastapy.gears.rating import _323, _322
from mastapy.gears.analysis import _412
...
class AbstractGearSetRating(_412.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_323.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_323.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_322.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_322.AbstractGearMeshRating))
        return value
