...
from mastapy.gears.gear_designs.conical import _602
...
class AGMAGleasonConicalGearMeshRating(_486.ConicalGearMeshRating):
    ...
    @property
    def load_distribution_factor_method(self) -> '_602.LoadDistributionFactorMethods':
        ...
        return constructor.new(_602.LoadDistributionFactorMethods)(value) if value else None
