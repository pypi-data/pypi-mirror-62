...
from mastapy.gears.gear_designs.conical import _1015
...
class AGMAGleasonConicalGearMeshRating(_449.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1015.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1015.LoadDistributionFactorMethods)(value) if value else None
