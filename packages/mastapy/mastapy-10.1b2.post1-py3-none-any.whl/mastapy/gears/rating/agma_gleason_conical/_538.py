...
from mastapy.gears.gear_designs.conical import _617
...
class AGMAGleasonConicalGearMeshRating(_469.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_617.LoadDistributionFactorMethods':
        ...
        return constructor.new(_617.LoadDistributionFactorMethods)(value) if value else None
