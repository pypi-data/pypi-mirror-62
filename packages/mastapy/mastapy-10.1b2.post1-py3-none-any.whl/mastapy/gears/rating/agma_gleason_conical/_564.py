...
from mastapy.gears.gear_designs.conical import _579
from mastapy.gears.rating.conical import _458
...
class AGMAGleasonConicalGearMeshRating(_458.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_579.LoadDistributionFactorMethods':
        ...
        return constructor.new(_579.LoadDistributionFactorMethods)(value) if value else None
