...
from mastapy.gears.gear_designs.conical import _582
...
class AGMAGleasonConicalGearMeshRating(_473.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_582.LoadDistributionFactorMethods':
        ...
        return constructor.new(_582.LoadDistributionFactorMethods)(value) if value else None
