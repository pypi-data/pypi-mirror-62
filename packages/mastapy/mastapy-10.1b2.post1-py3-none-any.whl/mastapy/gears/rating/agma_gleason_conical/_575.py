...
from mastapy.gears.gear_designs.conical import _604
...
class AGMAGleasonConicalGearMeshRating(_468.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_604.LoadDistributionFactorMethods':
        ...
        return constructor.new(_604.LoadDistributionFactorMethods)(value) if value else None
