...
from mastapy.gears.gear_designs.conical import _580
...
class AGMAGleasonConicalGearMeshRating(_465.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_580.LoadDistributionFactorMethods':
        ...
        return constructor.new(_580.LoadDistributionFactorMethods)(value) if value else None
