...
from mastapy.gears.rating import _293
...
class MeshSingleFlankRating(_1.APIBase):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_293.GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_293.GearSingleFlankRating))
        return value
