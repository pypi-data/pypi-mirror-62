...
class PlanetaryDetail(_1.APIBase):
    ...
    @property
    def planet_delta_angles(self) -> 'List[_314.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_314.NamedPlanetAngle))
        return value
