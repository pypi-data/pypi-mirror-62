...
from mastapy.gears.fe_model import _1085
from mastapy.gears.fe_model.cylindrical import _1086
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1087
from mastapy.gears.gear_designs import _638, _954
...
class GearSetDesign(_954.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_729.SMTBitmap':
        ...
        return constructor.new(_729.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def ltcafe_model(self) -> '_1085.GearSetFEModel':
        ...
        return constructor.new(_1085.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1086.CylindricalGearSetFEModel':
        ...
        if _1086.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1086.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1087.ConicalSetFEModel':
        ...
        if _1087.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1087.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_638.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_638.GearDesign))
        return value
