...
from mastapy.gears.gear_designs.straight_bevel_diff import _502, _485
...
class StraightBevelDiffGearSetDesign(_406.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_485.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_485.StraightBevelDiffGearMeshDesign))
        return value
