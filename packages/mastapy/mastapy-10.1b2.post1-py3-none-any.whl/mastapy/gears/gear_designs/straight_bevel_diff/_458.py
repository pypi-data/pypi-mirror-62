...
from mastapy.gears.gear_designs.straight_bevel_diff import _368, _461, _959
...
class StraightBevelDiffGearMeshDesign(_880.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_461.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_461.StraightBevelDiffGearDesign))
        return value
