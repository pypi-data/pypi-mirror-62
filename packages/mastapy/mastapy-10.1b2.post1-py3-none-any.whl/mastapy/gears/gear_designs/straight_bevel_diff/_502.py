...
from mastapy.gears.gear_designs.bevel import _1105, _644
...
class StraightBevelDiffGearDesign(_644.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1105.EdgeRadiusType':
        ...
        return constructor.new(_1105.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1105.EdgeRadiusType'):
