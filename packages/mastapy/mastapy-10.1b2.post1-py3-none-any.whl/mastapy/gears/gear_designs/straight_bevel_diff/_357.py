...
from mastapy.gears.gear_designs.straight_bevel_diff import _483, _467
from mastapy.gears.gear_designs.bevel import _369
...
class StraightBevelDiffGearSetDesign(_369.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_483.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_483.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_467.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_467.StraightBevelDiffGearMeshDesign))
        return value
