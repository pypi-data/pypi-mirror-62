...
from mastapy.gears.gear_designs.bevel import _1103, _1023
...
class StraightBevelDiffGearDesign(_1023.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1103.EdgeRadiusType':
        ...
        return constructor.new(_1103.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1103.EdgeRadiusType'):
