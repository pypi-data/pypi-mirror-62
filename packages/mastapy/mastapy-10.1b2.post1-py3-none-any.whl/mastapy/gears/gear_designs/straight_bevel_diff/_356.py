...
from mastapy.gears.gear_designs.straight_bevel_diff import _451, _440
from mastapy.gears.gear_designs.bevel import _1012
...
class StraightBevelDiffGearSetDesign(_1012.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_451.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_451.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_440.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_440.StraightBevelDiffGearMeshDesign))
        return value
