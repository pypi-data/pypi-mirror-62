...
from mastapy.gears.gear_designs.straight_bevel_diff import _394, _502, _954
...
class StraightBevelDiffGearMeshDesign(_966.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_954.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_954.StraightBevelDiffMeshedGearDesign))
        return value
