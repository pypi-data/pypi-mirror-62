...
from mastapy.gears.gear_designs.straight_bevel_diff import _396, _480, _947
from mastapy.gears.gear_designs.bevel import _964
...
class StraightBevelDiffGearMeshDesign(_964.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_396.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_396.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet else None

    @property
    def straight_bevel_diff_gears(self) -> 'List[_480.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_480.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_947.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_947.StraightBevelDiffMeshedGearDesign))
        return value
