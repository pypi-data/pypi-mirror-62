...
from mastapy.gears.gear_designs.straight_bevel_diff import _376, _491, _961
...
class StraightBevelDiffGearMeshDesign(_951.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    def straight_bevel_diff_meshed_gears(self) -> 'List[_961.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_961.StraightBevelDiffMeshedGearDesign))
        return value
