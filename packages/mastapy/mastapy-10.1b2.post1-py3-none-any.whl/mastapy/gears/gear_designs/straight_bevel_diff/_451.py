...
from mastapy.gears.gear_designs.bevel import _1102, _1068
...
class StraightBevelDiffGearDesign(_1068.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1102.EdgeRadiusType':
        ...
        return constructor.new(_1102.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1102.EdgeRadiusType'):
