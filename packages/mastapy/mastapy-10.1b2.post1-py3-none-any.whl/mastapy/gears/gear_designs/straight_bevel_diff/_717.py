...
from mastapy.gears.gear_designs.bevel import _910, _905
...
class StraightBevelDiffGearDesign(_905.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_910.EdgeRadiusType':
        ...
        return constructor.new(_910.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_910.EdgeRadiusType'):
