...
from mastapy.gears.gear_designs.bevel import _1031, _1026
...
class StraightBevelDiffGearDesign(_1026.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1031.EdgeRadiusType':
        ...
        return constructor.new(_1031.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1031.EdgeRadiusType'):
