...
from mastapy.gears.gear_designs.bevel import _1055, _665
...
class StraightBevelDiffGearDesign(_665.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1055.EdgeRadiusType':
        ...
        return constructor.new(_1055.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1055.EdgeRadiusType'):
