...
from mastapy.gears.gear_designs.straight_bevel_diff import _480, _457
...
class StraightBevelDiffGearSetDesign(_987.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_457.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_457.StraightBevelDiffGearMeshDesign))
        return value
