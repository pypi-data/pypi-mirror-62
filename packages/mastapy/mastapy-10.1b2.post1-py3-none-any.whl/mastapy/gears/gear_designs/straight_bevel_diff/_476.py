...
from mastapy.gears.gear_designs.bevel import _1108, _613
...
class StraightBevelDiffGearDesign(_613.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1108.EdgeRadiusType':
        ...
        return constructor.new(_1108.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1108.EdgeRadiusType'):
