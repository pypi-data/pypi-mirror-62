...
from mastapy.gears.gear_designs.straight_bevel_diff import _491, _469
from mastapy.gears.gear_designs.bevel import _1064
...
class StraightBevelDiffGearSetDesign(_1064.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_491.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_491.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_gears(self) -> 'List[_491.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_491.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_469.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_469.StraightBevelDiffGearMeshDesign))
        return value
