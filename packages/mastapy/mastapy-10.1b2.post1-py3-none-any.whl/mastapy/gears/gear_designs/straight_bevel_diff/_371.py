...
from mastapy.gears.gear_designs.straight_bevel_diff import _480, _464
from mastapy.gears.gear_designs.bevel import _1009
...
class StraightBevelDiffGearSetDesign(_1009.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_480.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_480.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_464.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_464.StraightBevelDiffGearMeshDesign))
        return value
