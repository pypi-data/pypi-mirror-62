...
from mastapy.gears.gear_designs.face import _383, _970, _969
...
class FaceGearSetMicroGeometry(_742.GearSetImplementationDetail):
    '''FaceGearSetMicroGeometry
    ...
    @property
    def face_gear_micro_geometries(self) -> 'List[_970.FaceGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearMicroGeometries, constructor.new(_970.FaceGearMicroGeometry))
        return value

    @property
    def face_mesh_micro_geometries(self) -> 'List[_969.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_969.FaceGearMeshMicroGeometry))
        return value
