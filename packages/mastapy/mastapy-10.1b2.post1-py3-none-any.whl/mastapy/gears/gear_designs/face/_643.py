...
from mastapy.gears.gear_designs.face import _966, _569
...
class FaceGearWheelDesign(_569.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_966.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_966.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_966.FaceGearDiameterFaceWidthSpecificationMethod'):
