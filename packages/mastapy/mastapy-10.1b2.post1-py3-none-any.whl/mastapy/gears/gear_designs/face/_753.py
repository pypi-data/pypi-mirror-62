...
from mastapy.gears.gear_designs.face import _746, _745
...
class FaceGearWheelDesign(_745.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_746.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_746.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_746.FaceGearDiameterFaceWidthSpecificationMethod'):
