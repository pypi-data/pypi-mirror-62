...
class FaceGearSetDesign(_392.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_640.FaceGearPinionDesign':
        ...
        return constructor.new(_640.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_641.FaceGearWheelDesign':
        ...
        return constructor.new(_641.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_972.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_972.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_568.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_568.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_568.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_568.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_558.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_558.FaceGearMeshDesign))
        return value
