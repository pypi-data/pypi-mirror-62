...
from mastapy.gears.gear_designs.face import _968, _505
...
class FaceGearWheelDesign(_505.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_968.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_968.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_968.FaceGearDiameterFaceWidthSpecificationMethod'):
