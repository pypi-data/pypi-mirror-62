...
class FaceGearSetDesign(_368.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_601.FaceGearPinionDesign':
        ...
        return constructor.new(_601.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_602.FaceGearWheelDesign':
        ...
        return constructor.new(_602.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_967.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_967.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_518.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_518.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_518.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_518.FaceGearDesign))
        return value
