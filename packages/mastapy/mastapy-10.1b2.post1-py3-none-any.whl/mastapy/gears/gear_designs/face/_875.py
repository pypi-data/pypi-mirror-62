...
from mastapy.gears.gear_designs.face import _868, _867
...
class FaceGearWheelDesign(_867.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_868.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_868.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_868.FaceGearDiameterFaceWidthSpecificationMethod'):
