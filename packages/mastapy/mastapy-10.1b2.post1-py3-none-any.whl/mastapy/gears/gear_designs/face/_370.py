...
class FaceGearSetDesign(_356.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_632.FaceGearPinionDesign':
        ...
        return constructor.new(_632.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_633.FaceGearWheelDesign':
        ...
        return constructor.new(_633.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_968.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_968.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_576.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_576.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_576.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_576.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_575.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_575.FaceGearMeshDesign))
        return value
