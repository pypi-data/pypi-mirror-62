...
from mastapy.gears.gear_designs.face import _961, _575
...
class FaceGearWheelDesign(_575.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_961.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_961.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_961.FaceGearDiameterFaceWidthSpecificationMethod'):
