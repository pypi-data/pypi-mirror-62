...
from mastapy.gears.gear_designs.face import _362, _574
...
class FaceGearMeshDesign(_946.GearMeshDesign):
    ...
    @property
    def face_gear_set(self) -> '_362.FaceGearSetDesign':
        ...
        return constructor.new(_362.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
