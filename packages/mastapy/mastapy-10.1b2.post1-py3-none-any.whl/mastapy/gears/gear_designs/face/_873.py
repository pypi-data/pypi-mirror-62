...
class FaceGearSetDesign(_829.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_872.FaceGearPinionDesign':
        ...
        return constructor.new(_872.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_875.FaceGearWheelDesign':
        ...
        return constructor.new(_875.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_874.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_874.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_867.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_867.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_867.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_867.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_869.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_869.FaceGearMeshDesign))
        return value
