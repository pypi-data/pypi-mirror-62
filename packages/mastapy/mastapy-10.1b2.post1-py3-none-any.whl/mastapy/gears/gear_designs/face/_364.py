...
class FaceGearSetDesign(_354.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_642.FaceGearPinionDesign':
        ...
        return constructor.new(_642.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_643.FaceGearWheelDesign':
        ...
        return constructor.new(_643.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_974.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_974.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_569.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_569.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_569.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_569.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_567.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_567.FaceGearMeshDesign))
        return value
