...
class FaceGearSetDesign(_364.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_609.FaceGearPinionDesign':
        ...
        return constructor.new(_609.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_610.FaceGearWheelDesign':
        ...
        return constructor.new(_610.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None
    ...
    @property
    def gears(self) -> 'List[_508.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_508.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_508.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_508.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_504.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_504.FaceGearMeshDesign))
        return value
