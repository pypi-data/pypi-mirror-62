...
from mastapy.gears.gear_designs.face import _364, _569
...
class FaceGearMeshDesign(_955.GearMeshDesign):
    ...
    @property
    def face_gear_set(self) -> '_364.FaceGearSetDesign':
        ...
        return constructor.new(_364.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
