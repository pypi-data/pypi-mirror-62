...
from mastapy.gears.gear_designs.face import _401, _964, _963
...
class FaceGearSetMicroGeometry(_742.GearSetImplementationDetail):
    ...
    @property
    def face_gear_set_design(self) -> '_401.FaceGearSetDesign':
        ...
        return constructor.new(_401.FaceGearSetDesign)(self.wrapped.FaceGearSetDesign) if self.wrapped.FaceGearSetDesign else None
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_963.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_963.FaceGearMeshMicroGeometry))
        return value
