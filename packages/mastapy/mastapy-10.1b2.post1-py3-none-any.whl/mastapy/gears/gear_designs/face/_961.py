...
from mastapy.gears.gear_designs.face import _476, _969, _962
...
class FaceGearMeshMicroGeometry(_700.GearMeshImplementationDetail):
    '''FaceGearMeshMicroGeometry
    ...
    @property
    def face_mesh(self) -> '_476.FaceGearMeshDesign':
        ...
        return constructor.new(_476.FaceGearMeshDesign)(self.wrapped.FaceMesh) if self.wrapped.FaceMesh else None
