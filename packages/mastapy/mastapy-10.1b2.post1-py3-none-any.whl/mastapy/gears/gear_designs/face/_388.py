...
class FaceGearSetDesign(_380.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_668.FaceGearPinionDesign':
        ...
        return constructor.new(_668.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_669.FaceGearWheelDesign':
        ...
        return constructor.new(_669.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None
    ...
    @property
    def gears(self) -> 'List[_495.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_495.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_495.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_495.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_476.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_476.FaceGearMeshDesign))
        return value
