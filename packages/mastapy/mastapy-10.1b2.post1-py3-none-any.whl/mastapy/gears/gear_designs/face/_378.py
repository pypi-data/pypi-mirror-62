...
from mastapy.gears.gear_designs import _369
...
class FaceGearSetDesign(_369.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_615.FaceGearPinionDesign':
        ...
        return constructor.new(_615.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_616.FaceGearWheelDesign':
        ...
        return constructor.new(_616.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_965.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_965.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_575.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_575.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_575.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_575.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_574.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_574.FaceGearMeshDesign))
        return value
