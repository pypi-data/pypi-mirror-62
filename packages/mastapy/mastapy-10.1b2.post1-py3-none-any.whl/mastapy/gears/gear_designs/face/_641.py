...
from mastapy.gears.gear_designs.face import _962, _568
...
class FaceGearWheelDesign(_568.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_962.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_962.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_962.FaceGearDiameterFaceWidthSpecificationMethod'):
