...
from mastapy.gears.gear_designs.face import _751, _745
...
class FaceGearMeshDesign(_705.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_751.FaceGearSetDesign':
        ...
        return constructor.new(_751.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
