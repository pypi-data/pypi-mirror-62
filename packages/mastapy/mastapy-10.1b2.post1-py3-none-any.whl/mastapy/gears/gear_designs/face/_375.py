...
class FaceGearSetDesign(_365.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_592.FaceGearPinionDesign':
        ...
        return constructor.new(_592.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_593.FaceGearWheelDesign':
        ...
        return constructor.new(_593.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_970.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_970.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_540.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_540.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_540.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_540.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_522.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_522.FaceGearMeshDesign))
        return value
