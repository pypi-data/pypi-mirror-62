...
class FaceGearSetDesign(_373.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_661.FaceGearPinionDesign':
        ...
        return constructor.new(_661.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_662.FaceGearWheelDesign':
        ...
        return constructor.new(_662.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_975.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_975.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_505.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_505.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_505.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_505.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_496.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_496.FaceGearMeshDesign))
        return value
