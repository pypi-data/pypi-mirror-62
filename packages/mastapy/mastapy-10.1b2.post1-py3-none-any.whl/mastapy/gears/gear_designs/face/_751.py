...
class FaceGearSetDesign(_706.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_750.FaceGearPinionDesign':
        ...
        return constructor.new(_750.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_753.FaceGearWheelDesign':
        ...
        return constructor.new(_753.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_752.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_752.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_745.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_745.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_745.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_745.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_747.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_747.FaceGearMeshDesign))
        return value
