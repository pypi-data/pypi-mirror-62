...
from mastapy.gears.gear_designs.face import _873, _871, _870
...
class FaceGearSetMicroGeometry(_1074.GearSetImplementationDetail):
    '''FaceGearSetMicroGeometry
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_870.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_870.FaceGearMeshMicroGeometry))
        return value
