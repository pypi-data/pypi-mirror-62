...
class FaceGearSetDesign(_353.GearSetDesign):
    ...
    @property
    def pinion(self) -> '_648.FaceGearPinionDesign':
        ...
        return constructor.new(_648.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_649.FaceGearWheelDesign':
        ...
        return constructor.new(_649.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None
    ...
    @property
    def gears(self) -> 'List[_574.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_574.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_574.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_574.FaceGearDesign))
        return value
