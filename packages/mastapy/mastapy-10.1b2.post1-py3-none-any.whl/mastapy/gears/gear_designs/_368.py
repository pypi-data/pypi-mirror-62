...
from mastapy.gears.fe_model import _1078
from mastapy.gears.fe_model.cylindrical import _1079
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1080
...
class GearSetDesign(_945.GearDesignComponent):
    ...
    @property
    def gear_set_drawing(self) -> '_711.SMTBitmap':
        ...
        return constructor.new(_711.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def ltcafe_model(self) -> '_1078.GearSetFEModel':
        ...
        return constructor.new(_1078.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1079.CylindricalGearSetFEModel':
        ...
        return constructor.new(_1079.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1080.ConicalSetFEModel':
        ...
        return constructor.new(_1080.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_598.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_598.GearDesign))
        return value
