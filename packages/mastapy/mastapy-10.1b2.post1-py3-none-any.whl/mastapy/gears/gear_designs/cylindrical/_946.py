...
from mastapy.gears.gear_designs.cylindrical import _904
from mastapy.utility.units_and_measurements.measurements import _1312, _1328
...
class ToothThicknessSpecificationBase(_1.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter else None

    @property
    def chordal_span(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan else None

    @property
    def over_balls(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls else None

    @property
    def transverse_thickness(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter else None

    @property
    def profile_shift_coefficient(self) -> '_904.CylindricalGearToothThicknessSpecification[_1328.Number]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1328.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient else None

    @property
    def profile_shift(self) -> '_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]':
        ...
        return constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift else None

    @property
    def tooth_thickness(self) -> 'List[_904.CylindricalGearToothThicknessSpecification[_1312.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_904.CylindricalGearToothThicknessSpecification)[_1312.LengthShort])
        return value
