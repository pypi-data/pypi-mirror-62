...
from mastapy.gears.gear_designs.cylindrical import _798
from mastapy.utility import _1114
...
class CaseHardeningPropertiesForFEAnalysis(_1114.CachedIndependentReportablePropertiesBase['CaseHardeningPropertiesForFEAnalysis']):
    '''CaseHardeningPropertiesForFEAnalysis
    ...
    @property
    def surface_material_properties(self) -> '_798.HardenedMaterialProperties':
        ...
        return constructor.new(_798.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_798.HardenedMaterialProperties':
        ...
        return constructor.new(_798.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
