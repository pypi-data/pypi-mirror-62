...
from mastapy.gears.gear_designs.cylindrical import _584, _619, _556
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.utility import _337
...
class Scuffing(_337.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_584.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_584.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_619.ScuffingTemperatureMethodsISO':
    ...
    def scuffing_temperature_method_iso(self, value: '_619.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
