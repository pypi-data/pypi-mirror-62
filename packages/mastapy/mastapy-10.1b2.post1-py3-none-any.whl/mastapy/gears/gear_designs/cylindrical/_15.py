...
class CylindricalGearDesignConstraintSettings(_67.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_983.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_983.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
