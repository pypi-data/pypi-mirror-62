...
class CylindricalGearAbstractRack(_1.APIBase):
    ...
    @property
    def gear(self) -> '_888.CylindricalGearDesign':
        ...
        return constructor.new(_888.CylindricalGearDesign)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def shaper_for_agma_rating(self) -> '_636.CylindricalGearShaper':
        ...
        return constructor.new(_636.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
