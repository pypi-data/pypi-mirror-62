...
class CylindricalGearCuttingOptions(_1.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_763.CylindricalGearAbstractRack':
        ...
        return constructor.new(_763.CylindricalGearAbstractRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_764.CylindricalGearBasicRack':
        ...
        if _764.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_764.CylindricalGearBasicRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_774.CylindricalGearPinionTypeCutter':
        ...
        if _774.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_774.CylindricalGearPinionTypeCutter)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_817.StandardRack':
        ...
        if _817.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_817.StandardRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def manufacturing_configuration_selection(self) -> '_780.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_780.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None

    @property
    def manufacturing_configuration(self) -> '_391.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_391.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
