...
class CylindricalGearBasicRack(_763.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_757.BasicRackProfiles':
        ...
        return constructor.new(_757.BasicRackProfiles)(value) if value else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_757.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_821.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_821.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_821.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_774.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_774.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
