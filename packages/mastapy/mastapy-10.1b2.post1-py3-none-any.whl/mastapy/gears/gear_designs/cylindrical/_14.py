...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1064
from mastapy.gears.manufacturing.cylindrical.cutters import _740
...
class CylindricalGearDefaults(_67.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_1064.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1064.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_740.RoughCutterCreationSettings':
        ...
        return constructor.new(_740.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
