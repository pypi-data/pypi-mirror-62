...
from mastapy.gears.gear_designs.cylindrical import _1007, _1006, _577
...
class CylindricalPlanetGearDesign(_577.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_313.PlanetaryDetail':
        ...
        return constructor.new(_313.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None
