...
from mastapy.gears.gear_designs.cylindrical import _1010, _1009, _588
...
class CylindricalPlanetGearDesign(_588.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_320.PlanetaryDetail':
        ...
        return constructor.new(_320.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None
