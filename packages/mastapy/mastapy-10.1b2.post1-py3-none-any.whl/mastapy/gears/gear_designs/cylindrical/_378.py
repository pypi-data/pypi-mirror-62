...
from mastapy.gears.gear_designs.cylindrical import (
    _968, _991, _547, _1003,
    _1019, _1001, _582, _577,
    _981
)
...
from mastapy.gears.gear_designs import _368
...
class CylindricalGearSetDesign(_368.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_524.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_524.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_524.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_547.Scuffing':
        ...
        return constructor.new(_547.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None
    ...
    @property
    def gears(self) -> 'List[_582.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_582.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_582.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_582.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_413.CylindricalGearSetDutyCycleRating') -> '_981.CylindricalGearSetMacroGeometryOptimiser':
