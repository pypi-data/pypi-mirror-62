...
class CylindricalGearDesignConstraintSettings(_1248.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_890.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_890.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
