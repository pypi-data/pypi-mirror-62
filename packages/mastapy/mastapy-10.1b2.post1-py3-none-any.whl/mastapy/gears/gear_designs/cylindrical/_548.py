...
from mastapy.gears.gear_designs.cylindrical import _580, _669, _547
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.utility import _325
...
class Scuffing(_325.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_580.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_580.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_669.ScuffingTemperatureMethodsISO':
    ...
    def scuffing_temperature_method_iso(self, value: '_669.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
