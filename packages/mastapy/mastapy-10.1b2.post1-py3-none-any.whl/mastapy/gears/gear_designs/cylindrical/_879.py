...
from mastapy.gears.gear_designs.cylindrical import _919
from mastapy.utility import _1235
...
class CaseHardeningPropertiesForFEAnalysis(_1235.CachedIndependentReportablePropertiesBase['CaseHardeningPropertiesForFEAnalysis']):
    '''CaseHardeningPropertiesForFEAnalysis
    ...
    @property
    def surface_material_properties(self) -> '_919.HardenedMaterialProperties':
        ...
        return constructor.new(_919.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_919.HardenedMaterialProperties':
        ...
        return constructor.new(_919.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
