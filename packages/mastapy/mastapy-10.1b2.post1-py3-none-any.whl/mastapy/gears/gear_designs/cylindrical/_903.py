...
from mastapy.gears.gear_designs.cylindrical import _902
from mastapy.utility.report import _1405
...
class CylindricalGearTableWithMGCharts(_1405.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_902.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_902.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_902.CylindricalGearTableMGItemDetail'):
