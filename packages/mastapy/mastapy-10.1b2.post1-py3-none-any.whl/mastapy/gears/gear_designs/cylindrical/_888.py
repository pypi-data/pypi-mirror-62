...
from mastapy.geometry.twod import _244
from mastapy.gears import _265, _246
...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _958
from mastapy.gears.manufacturing.cylindrical import _517
...
class CylindricalGearDesign(_826.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def internal_external(self) -> '_244.InternalExternalType':
        ...
        return constructor.new(_244.InternalExternalType)(value) if value else None

    @internal_external.setter
    def internal_external(self, value: '_244.InternalExternalType'):
    ...
    @property
    def iso6336_geometry(self) -> '_921.ISO6336GeometryBase':
        ...
        return constructor.new(_921.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_920.ISO6336Geometry':
        ...
        if _920.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_920.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_922.ISO6336GeometryForShapedGears':
        ...
        if _922.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_922.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_923.ISO6336GeometryManufactured':
        ...
        if _923.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_923.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def surface_roughness(self) -> '_939.SurfaceRoughness':
        ...
        return constructor.new(_939.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None

    @property
    def cylindrical_gear_set(self) -> '_899.CylindricalGearSetDesign':
        ...
        return constructor.new(_899.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def cylindrical_gear_micro_geometry(self) -> '_958.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_958.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_517.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_517.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_501.GearMaterial':
        ...
        return constructor.new(_501.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_492.AGMACylindricalGearMaterial':
        ...
        if _492.AGMACylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_492.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_493.BevelGearISOMaterial':
        ...
        if _493.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_493.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_495.BevelGearMaterial':
        ...
        if _495.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_495.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_cylindrical_gear_material(self) -> '_499.CylindricalGearMaterial':
        ...
        if _499.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_499.CylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_503.ISOCylindricalGearMaterial':
        ...
        if _503.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_503.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_507.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _507.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_507.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_509.PlasticCylindricalGearMaterial':
        ...
        if _509.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_509.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def system_of_gear_fits(self) -> '_988.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_988.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_991.ISO1328AccuracyGrades':
        ...
        return constructor.new(_991.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_983.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_983.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_985.CylindricalAccuracyGrader':
        ...
        return constructor.new(_985.CylindricalAccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_981.AGMA2000AccuracyGrader':
        ...
        if _981.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_981.AGMA2000AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_982.AGMA20151AccuracyGrader':
        ...
        if _982.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_982.AGMA20151AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_984.AGMAISO13282013AccuracyGrader':
        ...
        if _984.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_984.AGMAISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_986.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _986.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_986.CylindricalAccuracyGraderWithProfileFormAndSlope)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_989.ISO13282013AccuracyGrader':
        ...
        if _989.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_989.ISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_990.ISO1328AccuracyGrader':
        ...
        if _990.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_990.ISO1328AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grades_specified_accuracy(self) -> '_246.AccuracyGrades':
        ...
        return constructor.new(_246.AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_983.AGMA20151AccuracyGrades':
        ...
        if _983.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_983.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_987.CylindricalAccuracyGrades':
        ...
        if _987.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_987.CylindricalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_991.ISO1328AccuracyGrades':
        ...
        if _991.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_991.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1038.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1038.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_1038.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def tip_form(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def tiff_analysis_settings(self) -> '_941.TiffAnalysisSettings':
        ...
        return constructor.new(_941.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_913.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_913.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_945.ToothThicknessSpecification':
        ...
        return constructor.new(_945.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None

    @property
    def finish_stock_specification(self) -> '_912.FinishStockSpecification':
        ...
        return constructor.new(_912.FinishStockSpecification)(self.wrapped.FinishStockSpecification) if self.wrapped.FinishStockSpecification else None

    @property
    def cylindrical_gear_cutting_options(self) -> '_886.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_886.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def cylindrical_meshes(self) -> 'List[_894.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_894.CylindricalGearMeshDesign))
        return value
