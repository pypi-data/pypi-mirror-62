...
class CylindricalGearDesignConstraintSettings(_1127.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_769.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_769.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
