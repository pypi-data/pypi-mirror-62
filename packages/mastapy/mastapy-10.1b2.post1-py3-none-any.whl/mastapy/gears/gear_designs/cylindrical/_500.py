...
from mastapy.gears import _310, _292
...
class CylindricalGearMeshDesign(_951.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_583.CylindricalGearProfileModifications':
        ...
        return constructor.new(_583.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_583.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_585.TypeOfMechanismHousing':
        ...
        return constructor.new(_585.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_585.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_292.CentreDistanceChangeMethod':
        ...
        return constructor.new(_292.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_292.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_974.BacklashSpecification':
        ...
        return constructor.new(_974.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_996.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_996.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_506.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_506.CylindricalGearDesign':
