...
from mastapy.gears.gear_designs.cylindrical import _585, _681, _562
...
class Scuffing(_351.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_585.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_585.ScuffingTemperatureMethodsAGMA)(value) if value else None

    @scuffing_temperature_method_agma.setter
    def scuffing_temperature_method_agma(self, value: '_585.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_681.ScuffingTemperatureMethodsISO':
    ...
    def scuffing_temperature_method_iso(self, value: '_681.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
