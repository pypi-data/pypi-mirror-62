...
from mastapy.gears import _267, _250
from mastapy.math_utility.measured_ranges import _1228
from mastapy.gears.gear_designs import _828
...
class CylindricalGearMeshDesign(_828.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_898.CylindricalGearProfileModifications':
        ...
        return constructor.new(_898.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_898.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_947.TypeOfMechanismHousing':
        ...
        return constructor.new(_947.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_947.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_250.CentreDistanceChangeMethod':
        ...
        return constructor.new(_250.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_250.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_877.BacklashSpecification':
        ...
        return constructor.new(_877.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1228.ShortLengthRange':
        ...
        return constructor.new(_1228.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_906.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_906.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_888.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_888.CylindricalGearDesign':
