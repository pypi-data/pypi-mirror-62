...
from mastapy.math_utility import _905
...
class CylindricalPlanetaryGearSetDesign(_363.CylindricalGearSetDesign):
    '''CylindricalPlanetaryGearSetDesign
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_905.FourierSeries':
        ...
        return constructor.new(_905.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
