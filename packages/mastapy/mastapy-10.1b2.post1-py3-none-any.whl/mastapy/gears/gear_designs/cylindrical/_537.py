...
from mastapy.gears.gear_designs.cylindrical import _577, _653, _536
...
class Scuffing(_334.IndependentReportablePropertiesBase['Scuffing']):
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_577.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_577.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_653.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_653.ScuffingTemperatureMethodsISO)(value) if value else None

    @scuffing_temperature_method_iso.setter
    def scuffing_temperature_method_iso(self, value: '_653.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
