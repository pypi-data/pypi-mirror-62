...
from mastapy.gears.gear_designs.cylindrical import _1005, _1004, _582
...
class CylindricalPlanetGearDesign(_582.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_319.PlanetaryDetail':
        ...
        return constructor.new(_319.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None

    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_1005.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_1005.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_1004.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_1004.NamedPlanetAssemblyIndex))
        return value
