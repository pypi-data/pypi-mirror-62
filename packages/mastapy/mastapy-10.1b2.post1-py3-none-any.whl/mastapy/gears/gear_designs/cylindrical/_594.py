...
from mastapy.geometry.twod import _287
from mastapy.gears import _308, _289
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical import (
    _1003, _1002, _1004, _1005,
    _1016, _601, _376, _1017,
    _732, _733, _754, _979,
    _587
)
...
class CylindricalGearDesign(_588.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def internal_external(self) -> '_287.InternalExternalType':
        ...
        return constructor.new(_287.InternalExternalType)(value) if value else None

    @internal_external.setter
    def internal_external(self, value: '_287.InternalExternalType'):
    ...
    @property
    def iso6336_geometry(self) -> '_1003.ISO6336GeometryBase':
        ...
        return constructor.new(_1003.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_1002.ISO6336Geometry':
        ...
        if _1002.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_1002.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_1004.ISO6336GeometryForShapedGears':
        ...
        if _1004.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_1004.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_1005.ISO6336GeometryManufactured':
        ...
        if _1005.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_1005.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None
    ...
    @property
    def tip_diameter_reporting(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None
    ...
    @property
    def cylindrical_gear_micro_geometry(self) -> '_1030.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1030.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_627.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_627.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_614.GearMaterial':
        ...
        return constructor.new(_614.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_605.AGMACylindricalGearMaterial':
        ...
        if _605.AGMACylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_605.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_606.BevelGearISOMaterial':
        ...
        if _606.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_606.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_608.BevelGearMaterial':
        ...
        if _608.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_608.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_cylindrical_gear_material(self) -> '_612.CylindricalGearMaterial':
        ...
        if _612.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_612.CylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_615.ISOCylindricalGearMaterial':
        ...
        if _615.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_615.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_619.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _619.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_619.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_621.PlasticCylindricalGearMaterial':
        ...
        if _621.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_621.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def iso_accuracy_grade(self) -> '_1064.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1064.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None
    ...
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_1053.AGMA2000AccuracyGrader':
        ...
        if _1053.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_1054.AGMA20151AccuracyGrader':
        ...
        if _1054.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_1056.AGMAISO13282013AccuracyGrader':
        ...
        if _1056.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_1058.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _1058.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_1058.CylindricalAccuracyGraderWithProfileFormAndSlope)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None
    ...
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_1061.ISO13282013AccuracyGrader':
        ...
        if _1061.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_1062.ISO1328AccuracyGrader':
        ...
        if _1062.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy(self) -> '_289.AccuracyGrades':
        ...
        return constructor.new(_289.AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None
    ...
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_1055.AGMA20151AccuracyGrades':
        ...
        if _1055.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_1059.CylindricalAccuracyGrades':
        ...
        if _1059.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_1059.CylindricalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_1064.ISO1328AccuracyGrades':
        ...
        if _1064.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_1064.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None
    ...
    @property
    def tip_form(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def tiff_analysis_settings(self) -> '_1017.TiffAnalysisSettings':
        ...
        return constructor.new(_1017.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_732.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_732.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_733.ToothThicknessSpecification':
        ...
        return constructor.new(_733.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_979.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_979.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def cylindrical_meshes(self) -> 'List[_587.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_587.CylindricalGearMeshDesign))
        return value
