...
from mastapy.gears.gear_designs.cylindrical import _776, _805
from mastapy.gears import _147, _137, _118
from mastapy.utility.units_and_measurements import _1140
...
class CylindricalGearDesignSettings(_1127.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def cylindrical_gear_profile_measurement(self) -> '_776.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_776.CylindricalGearProfileMeasurementType)(value) if value else None

    @cylindrical_gear_profile_measurement.setter
    def cylindrical_gear_profile_measurement(self, value: '_776.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CylindricalGearProfileMeasurement = value

    @property
    def agma_quality_grade_type(self) -> '_147.QualityGradeTypes':
        ...
        return constructor.new(_147.QualityGradeTypes)(value) if value else None

    @agma_quality_grade_type.setter
    def agma_quality_grade_type(self, value: '_147.QualityGradeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMAQualityGradeType = value

    @property
    def tolerance_rounding_system(self) -> '_1140.MeasurementSystem':
        ...
        return constructor.new(_1140.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1140.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def agma_tolerances_standard(self) -> '_118.AGMAToleranceStandard':
        ...
        return constructor.new(_118.AGMAToleranceStandard)(value) if value else None

    @agma_tolerances_standard.setter
    def agma_tolerances_standard(self, value: '_118.AGMAToleranceStandard'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_805.MicroGeometryConvention':
        ...
        return constructor.new(_805.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_805.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self) -> '_361.MainProfileReliefEndsAtTheStartOfTipReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self, value: '_361.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_364.ParabolicTipReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_364.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self) -> '_360.MainProfileReliefEndsAtTheStartOfRootReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self, value: '_360.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_363.ParabolicRootReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_363.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
