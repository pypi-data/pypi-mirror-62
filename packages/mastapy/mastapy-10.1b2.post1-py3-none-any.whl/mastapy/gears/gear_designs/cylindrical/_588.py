...
from mastapy.gears import _313, _290
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical import (
    _1002, _1001, _1003, _1004,
    _1018, _615, _375, _1019,
    _717, _718, _766, _979,
    _583
)
...
from mastapy.gears.gear_designs import _601
...
class CylindricalGearDesign(_601.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def hand(self) -> '_313.Hand':
        '''Hand: 'Hand' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Hand)
        return constructor.new(_313.Hand)(value) if value else None

    @hand.setter
    def hand(self, value: '_313.Hand'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_1001.ISO6336Geometry':
        ...
        if _1001.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_1003.ISO6336GeometryForShapedGears':
        ...
        if _1003.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_1004.ISO6336GeometryManufactured':
        ...
        if _1004.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def surface_roughness(self) -> '_1018.SurfaceRoughness':
        ...
        return constructor.new(_1018.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_615.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_615.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_615.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_615.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None

    @property
    def cylindrical_gear_set(self) -> '_375.CylindricalGearSetDesign':
        ...
        return constructor.new(_375.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def cylindrical_gear_micro_geometry(self) -> '_1032.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1032.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None
    ...
    @property
    def lowest_start_of_active_profile(self) -> '_615.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_615.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_604.GearMaterial':
        ...
        return constructor.new(_604.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_594.AGMACylindricalGearMaterial':
        ...
        if _594.AGMACylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_594.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_595.BevelGearISOMaterial':
        ...
        if _595.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_595.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_597.BevelGearMaterial':
        ...
        if _597.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_597.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_cylindrical_gear_material(self) -> '_602.CylindricalGearMaterial':
        ...
        if _602.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_602.CylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_605.ISOCylindricalGearMaterial':
        ...
        if _605.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_605.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def tip_form(self) -> '_615.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_615.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_615.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_615.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def tiff_analysis_settings(self) -> '_1019.TiffAnalysisSettings':
        ...
        return constructor.new(_1019.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_717.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_717.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_718.ToothThicknessSpecification':
        ...
        return constructor.new(_718.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None

    @property
    def finish_stock_specification(self) -> '_766.FinishStockSpecification':
        ...
        return constructor.new(_766.FinishStockSpecification)(self.wrapped.FinishStockSpecification) if self.wrapped.FinishStockSpecification else None
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_583.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_583.CylindricalGearMeshDesign))
        return value
