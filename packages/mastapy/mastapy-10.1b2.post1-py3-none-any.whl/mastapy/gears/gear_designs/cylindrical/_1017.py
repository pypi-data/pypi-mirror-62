...
class TiffAnalysisSettings(_329.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_974.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_974.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
