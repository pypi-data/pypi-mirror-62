...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1055
from mastapy.gears.manufacturing.cylindrical.cutters import _729
...
class CylindricalGearDefaults(_73.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_1055.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1055.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_729.RoughCutterCreationSettings':
        ...
        return constructor.new(_729.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
