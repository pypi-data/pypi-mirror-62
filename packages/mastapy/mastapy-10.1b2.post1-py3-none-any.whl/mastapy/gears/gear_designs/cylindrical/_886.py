...
class CylindricalGearCuttingOptions(_1.APIBase):
    ...
    def geometry_specification_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_GeometrySpecificationType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_GeometrySpecificationType.implicit_type()
    ...
    def geometry_specification_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_GeometrySpecificationType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_GeometrySpecificationType.implicit_type().type_()
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_884.CylindricalGearAbstractRack':
        ...
        return constructor.new(_884.CylindricalGearAbstractRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_885.CylindricalGearBasicRack':
        ...
        if _885.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_885.CylindricalGearBasicRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_895.CylindricalGearPinionTypeCutter':
        ...
        if _895.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_895.CylindricalGearPinionTypeCutter)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_938.StandardRack':
        ...
        if _938.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_938.StandardRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def manufacturing_configuration_selection(self) -> '_901.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_901.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None

    @property
    def manufacturing_configuration(self) -> '_517.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_517.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
