...
class CylindricalGearDesignConstraintsDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_769.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_769.CylindricalGearDesignConstraints)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_769.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_769.CylindricalGearDesignConstraints)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_design_constraints: '_769.CylindricalGearDesignConstraints') -> 'bool':
    ...
    def rename(self, cylindrical_gear_design_constraints: '_769.CylindricalGearDesignConstraints', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_design_constraints: '_769.CylindricalGearDesignConstraints'):
    ...
    def get_all_items(self) -> 'Iterable[_769.CylindricalGearDesignConstraints]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_769.CylindricalGearDesignConstraints))

    def save_changes(self, cylindrical_gear_design_constraints: '_769.CylindricalGearDesignConstraints'):
