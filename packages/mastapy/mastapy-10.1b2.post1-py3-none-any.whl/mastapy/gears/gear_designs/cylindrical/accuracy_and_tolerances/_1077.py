...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1074
...
class ISO13282013AccuracyGrader(_1074.CylindricalAccuracyGraderWithProfileFormAndSlope):
    '''ISO13282013AccuracyGrader
