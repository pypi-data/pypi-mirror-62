...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _864
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_864.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
