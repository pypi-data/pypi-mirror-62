...
from mastapy.gears.gear_designs.cylindrical import _1009, _1008, _508
...
class CylindricalPlanetGearDesign(_508.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_1009.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_1009.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_1008.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_1008.NamedPlanetAssemblyIndex))
        return value
