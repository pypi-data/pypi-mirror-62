...
class CrossedAxisCylindricalGearPair(_1.APIBase):
    ...
    @property
    def shaver(self) -> '_609.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_609.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
