...
from mastapy.gears import _251
from mastapy.materials.efficiency import _237
from mastapy.gears.rating.cylindrical.iso6336 import _429
...
class CylindricalGearSetDesign(_829.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_876.AddendumModificationDistributionRule':
        ...
        return constructor.new(_876.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_876.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_237.EfficiencyRatingMethod':
    ...
    def efficiency_rating_method(self, value: '_237.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_429.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_429.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_429.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_914.GearFitSystems':
        ...
        return constructor.new(_914.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_914.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_963.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_963.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_932.Scuffing':
        ...
        return constructor.new(_932.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_927.Micropitting':
        ...
        return constructor.new(_927.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_948.Usage':
        ...
        return constructor.new(_948.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_925.LtcaSettings':
        ...
        return constructor.new(_925.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_530.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_530.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_888.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_888.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_888.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_888.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_390.CylindricalGearSetDutyCycleRating') -> '_900.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_900.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
