...
class TiffAnalysisSettings(_320.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_979.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_979.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
