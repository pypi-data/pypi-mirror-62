...
class CylindricalGearDesignConstraintSettings(_68.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_981.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_981.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
