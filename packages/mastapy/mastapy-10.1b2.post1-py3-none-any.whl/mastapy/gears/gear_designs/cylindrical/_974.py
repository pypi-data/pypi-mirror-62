...
class CaseHardeningPropertiesForFEAnalysis(_1073.CachedIndependentReportablePropertiesBase['CaseHardeningPropertiesForFEAnalysis']):
    ...
    def surface_material_properties(self) -> '_1001.HardenedMaterialProperties':
        ...
        return constructor.new(_1001.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None
    ...
    def core_material_properties(self) -> '_1001.HardenedMaterialProperties':
        ...
        return constructor.new(_1001.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
