...
from mastapy.gears import _315, _292
...
class CylindricalGearMeshDesign(_956.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_584.CylindricalGearProfileModifications':
        ...
        return constructor.new(_584.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_584.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_581.TypeOfMechanismHousing':
        ...
        return constructor.new(_581.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_581.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_991.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_991.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_588.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_588.CylindricalGearDesign':
