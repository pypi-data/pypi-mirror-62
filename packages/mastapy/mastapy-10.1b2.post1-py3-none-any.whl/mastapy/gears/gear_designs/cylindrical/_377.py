...
class CylindricalPlanetaryGearSetDesign(_376.CylindricalGearSetDesign):
    '''CylindricalPlanetaryGearSetDesign
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_877.FourierSeries':
        ...
        return constructor.new(_877.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
