...
from mastapy.utility.units_and_measurements.measurements import _1098, _1105
...
class ToothThicknessSpecificationBase(_1.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter else None

    @property
    def chordal_span(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan else None

    @property
    def over_balls(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls else None

    @property
    def transverse_thickness(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter else None

    @property
    def profile_shift_coefficient(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1105.Number]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1105.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient else None

    @property
    def profile_shift(self) -> '_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]':
        ...
        return constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift else None

    @property
    def tooth_thickness(self) -> 'List[_1009.CylindricalGearToothThicknessSpecification[_1098.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_1009.CylindricalGearToothThicknessSpecification)[_1098.LengthShort])
        return value
