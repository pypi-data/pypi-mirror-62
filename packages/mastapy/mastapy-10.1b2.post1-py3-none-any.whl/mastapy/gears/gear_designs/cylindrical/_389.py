...
from mastapy.gears.gear_designs.cylindrical import (
    _970, _993, _517, _1005,
    _1020, _1003, _577, _556,
    _983
)
...
class CylindricalGearSetDesign(_380.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_526.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_526.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_526.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_1036.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1036.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_517.Scuffing':
        ...
        return constructor.new(_517.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None
    ...
    @property
    def gears(self) -> 'List[_577.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_577.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_577.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_577.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_400.CylindricalGearSetDutyCycleRating') -> '_983.CylindricalGearSetMacroGeometryOptimiser':
