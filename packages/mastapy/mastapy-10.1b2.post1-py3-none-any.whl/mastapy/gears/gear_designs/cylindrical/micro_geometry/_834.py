...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _833
...
class CylindricalGearLeadModificationAtProfilePosition(_833.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_775.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
