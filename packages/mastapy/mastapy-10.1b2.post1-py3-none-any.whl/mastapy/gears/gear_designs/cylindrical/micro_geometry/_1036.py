...
class CylindricalGearSetMicroGeometryDutyCycle(_737.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def meshes(self) -> 'List[_1029.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1029.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
