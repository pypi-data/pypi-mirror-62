...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1060
...
class MeshedCylindricalGearMicroGeometry(_1.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_1060.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1060.MeshedCylindricalGearFlankMicroGeometry))
        return value
