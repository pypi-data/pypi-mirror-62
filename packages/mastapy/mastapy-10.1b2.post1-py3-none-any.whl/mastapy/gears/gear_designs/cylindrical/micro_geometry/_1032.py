...
class CylindricalGearMicroGeometryMap(_1.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_1042.MeasuredMapDataTypes':
        ...
        return constructor.new(_1042.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_1042.MeasuredMapDataTypes'):
    ...
    @property
    def zero_bias_relief(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
