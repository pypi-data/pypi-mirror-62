...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _970
...
class CylindricalGearMicroGeometryMap(_1.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_970.MeasuredMapDataTypes':
        ...
        return constructor.new(_970.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_970.MeasuredMapDataTypes'):
    ...
    @property
    def zero_bias_relief(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
