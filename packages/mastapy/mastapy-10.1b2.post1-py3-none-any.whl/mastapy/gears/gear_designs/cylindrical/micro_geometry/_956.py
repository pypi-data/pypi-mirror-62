...
from mastapy.gears.gear_designs.cylindrical import _897, _894
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _963, _958
...
class CylindricalGearMeshMicroGeometry(_1068.GearMeshImplementationDetail):
    '''CylindricalGearMeshMicroGeometry
    ...
    @property
    def profile_measured_as(self) -> '_897.CylindricalGearProfileMeasurementType':
    ...
    @property
    def cylindrical_mesh(self) -> '_894.CylindricalGearMeshDesign':
        ...
        return constructor.new(_894.CylindricalGearMeshDesign)(self.wrapped.CylindricalMesh) if self.wrapped.CylindricalMesh else None
    ...
    @property
    def cylindrical_gear_micro_geometries(self) -> 'List[_958.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMicroGeometries, constructor.new(_958.CylindricalGearMicroGeometry))
        return value

    @property
    def gear_a(self) -> '_958.CylindricalGearMicroGeometry':
    ...
    @property
    def gear_b(self) -> '_958.CylindricalGearMicroGeometry':
