...
class MicroGeometryViewingOptions(_1.APIBase):
    ...
    @property
    def gear_option(self) -> '_1037.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_1037.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_1037.DrawDefiningGearOrBoth'):
