...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _965
...
class MicroGeometryViewingOptions(_1.APIBase):
    ...
    @property
    def gear_option(self) -> '_965.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_965.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_965.DrawDefiningGearOrBoth'):
    ...
    def contact_results(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ContactResultType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ContactResultType.implicit_type()
    ...
    def contact_results(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ContactResultType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ContactResultType.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
    ...
    def root_stress_results_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_StressResultsType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_StressResultsType.implicit_type()
    ...
    def root_stress_results_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_StressResultsType.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_StressResultsType.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
