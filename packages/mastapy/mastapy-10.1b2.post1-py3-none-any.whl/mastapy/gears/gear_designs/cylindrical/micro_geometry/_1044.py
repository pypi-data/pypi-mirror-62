...
class MeshedCylindricalGearFlankMicroGeometry(_1.APIBase):
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1047.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormReliefPoints, constructor.new(_1047.ProfileFormReliefWithDeviation))
        return value

    @property
    def involute_inspection_points(self) -> 'List[_1052.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InvoluteInspectionPoints, constructor.new(_1052.TotalProfileReliefWithDeviation))
        return value
