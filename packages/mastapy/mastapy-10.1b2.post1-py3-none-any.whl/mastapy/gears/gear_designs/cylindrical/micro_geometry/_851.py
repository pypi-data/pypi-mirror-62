...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _859, _854
...
class MeshedCylindricalGearFlankMicroGeometry(_1.APIBase):
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_854.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormReliefPoints, constructor.new(_854.ProfileFormReliefWithDeviation))
        return value

    @property
    def involute_inspection_points(self) -> 'List[_859.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InvoluteInspectionPoints, constructor.new(_859.TotalProfileReliefWithDeviation))
        return value
