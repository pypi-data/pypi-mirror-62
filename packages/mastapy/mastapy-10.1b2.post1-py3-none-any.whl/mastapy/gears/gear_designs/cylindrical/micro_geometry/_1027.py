...
class CylindricalGearLeadModificationAtProfilePosition(_1026.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
