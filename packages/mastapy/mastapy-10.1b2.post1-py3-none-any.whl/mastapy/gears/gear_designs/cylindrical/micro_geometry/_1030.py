...
from mastapy.gears.gear_designs.cylindrical import _594, _601
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1025, _1045
...
class CylindricalGearMicroGeometry(_757.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_594.CylindricalGearDesign':
        ...
        return constructor.new(_594.CylindricalGearDesign)(self.wrapped.CylindricalGear) if self.wrapped.CylindricalGear else None

    @property
    def left_flank(self) -> '_1025.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1025.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_1025.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1025.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def profile_control_point(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None

    @property
    def flanks(self) -> 'List[_1025.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1025.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_1045.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_1045.MeshedCylindricalGearMicroGeometry))
        return value
