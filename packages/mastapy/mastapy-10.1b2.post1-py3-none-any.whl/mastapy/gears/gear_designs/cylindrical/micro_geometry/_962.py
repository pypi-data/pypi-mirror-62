...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _961
...
class CylindricalGearProfileModificationAtFaceWidthPosition(_961.CylindricalGearProfileModification):
    '''CylindricalGearProfileModificationAtFaceWidthPosition
