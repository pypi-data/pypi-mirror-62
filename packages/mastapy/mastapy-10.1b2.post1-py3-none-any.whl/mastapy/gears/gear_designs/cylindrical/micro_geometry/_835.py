...
from mastapy.gears.gear_designs.cylindrical import _776, _773
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _842, _837
...
class CylindricalGearMeshMicroGeometry(_947.GearMeshImplementationDetail):
    '''CylindricalGearMeshMicroGeometry
    ...
    @property
    def profile_measured_as(self) -> '_776.CylindricalGearProfileMeasurementType':
    ...
    @property
    def cylindrical_mesh(self) -> '_773.CylindricalGearMeshDesign':
        ...
        return constructor.new(_773.CylindricalGearMeshDesign)(self.wrapped.CylindricalMesh) if self.wrapped.CylindricalMesh else None
    ...
    @property
    def cylindrical_gear_micro_geometries(self) -> 'List[_837.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMicroGeometries, constructor.new(_837.CylindricalGearMicroGeometry))
        return value

    @property
    def gear_a(self) -> '_837.CylindricalGearMicroGeometry':
    ...
    @property
    def gear_b(self) -> '_837.CylindricalGearMicroGeometry':
