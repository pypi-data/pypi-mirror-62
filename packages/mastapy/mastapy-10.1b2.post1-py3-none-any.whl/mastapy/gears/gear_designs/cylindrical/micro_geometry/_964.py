...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _957
...
class CylindricalGearSetMicroGeometryDutyCycle(_1073.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def meshes(self) -> 'List[_957.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_957.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
