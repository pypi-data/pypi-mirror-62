...
from mastapy.gears.analysis import _1065
...
class CylindricalGearMeshMicroGeometryDutyCycle(_1065.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_750.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_750.CylindricalGearMeshLoadDistributionAnalysis))
        return value
