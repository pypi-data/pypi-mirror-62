...
class CylindricalGearBiasModification(_565.BiasModification):
    '''CylindricalGearBiasModification
    ...
    @property
    def zero_bias_relief(self) -> '_618.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_618.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
