...
class MeshedCylindricalGearMicroGeometry(_1.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_1044.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1044.MeshedCylindricalGearFlankMicroGeometry))
        return value
