...
from mastapy.gears.gear_designs.cylindrical import _618
...
class CylindricalGearLeadModificationAtProfilePosition(_1021.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_618.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_618.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
