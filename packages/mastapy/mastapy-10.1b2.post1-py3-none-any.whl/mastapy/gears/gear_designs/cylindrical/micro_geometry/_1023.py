...
from mastapy.gears.gear_designs.cylindrical import _558
...
class CylindricalGearBiasModification(_564.BiasModification):
    '''CylindricalGearBiasModification
    ...
    @property
    def zero_bias_relief(self) -> '_558.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_558.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
