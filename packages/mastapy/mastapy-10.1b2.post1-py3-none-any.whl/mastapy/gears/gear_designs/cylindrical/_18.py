...
from mastapy.gears.gear_designs.cylindrical import _738, _1007
from mastapy.gears import _323, _309, _290
from mastapy.utility.units_and_measurements import _1092
...
class CylindricalGearDesignSettings(_68.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def cylindrical_gear_profile_measurement(self) -> '_738.CylindricalGearProfileMeasurementType':
    ...
    def cylindrical_gear_profile_measurement(self, value: '_738.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CylindricalGearProfileMeasurement = value

    @property
    def agma_quality_grade_type(self) -> '_323.QualityGradeTypes':
        ...
        return constructor.new(_323.QualityGradeTypes)(value) if value else None

    @agma_quality_grade_type.setter
    def agma_quality_grade_type(self, value: '_323.QualityGradeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMAQualityGradeType = value

    @property
    def tolerance_rounding_system(self) -> '_1092.MeasurementSystem':
        ...
        return constructor.new(_1092.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1092.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def agma_tolerances_standard(self) -> '_290.AGMAToleranceStandard':
        ...
        return constructor.new(_290.AGMAToleranceStandard)(value) if value else None

    @agma_tolerances_standard.setter
    def agma_tolerances_standard(self, value: '_290.AGMAToleranceStandard'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_1007.MicroGeometryConvention':
        ...
        return constructor.new(_1007.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_1007.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_603.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_603.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_603.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_602.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_602.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_602.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
