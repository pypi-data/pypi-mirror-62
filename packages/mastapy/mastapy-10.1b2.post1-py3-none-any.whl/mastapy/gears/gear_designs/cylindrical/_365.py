...
from mastapy.gears.gear_designs.cylindrical import (
    _975, _999, _587, _1011,
    _1024, _1009, _554, _522,
    _989
)
...
from mastapy.gears.rating.cylindrical.iso6336 import _538
...
from mastapy.gears.gear_designs import _354
...
class CylindricalGearSetDesign(_354.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_975.AddendumModificationDistributionRule':
        ...
        return constructor.new(_975.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_975.AddendumModificationDistributionRule'):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_538.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_538.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_538.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_999.GearFitSystems':
        ...
        return constructor.new(_999.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_999.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_587.Scuffing':
        ...
        return constructor.new(_587.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1011.Micropitting':
        ...
        return constructor.new(_1011.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None
    ...
    @property
    def ltca_settings(self) -> '_1009.LtcaSettings':
        ...
        return constructor.new(_1009.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None
    ...
    @property
    def gears(self) -> 'List[_554.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_554.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_554.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_554.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_393.CylindricalGearSetDutyCycleRating') -> '_989.CylindricalGearSetMacroGeometryOptimiser':
