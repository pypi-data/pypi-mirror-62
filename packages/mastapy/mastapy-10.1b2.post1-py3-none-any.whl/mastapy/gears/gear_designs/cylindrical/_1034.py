...
class Usage(_320.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_327.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_327.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1028.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1028.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1028.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
