...
from mastapy.gears.manufacturing.cylindrical.cutters import _741
...
class CylindricalGearDefaults(_68.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_741.RoughCutterCreationSettings':
        ...
        return constructor.new(_741.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
