...
from mastapy.gears.rating.cylindrical import _394
from mastapy.gears.gear_designs import _364
...
class CylindricalGearSetDesign(_364.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def efficiency_rating_method(self) -> '_281.EfficiencyRatingMethod':
        ...
        return constructor.new(_281.EfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method.setter
    def efficiency_rating_method(self, value: '_281.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_531.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_531.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_531.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_995.GearFitSystems':
        ...
        return constructor.new(_995.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_995.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_1037.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1037.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_563.Scuffing':
        ...
        return constructor.new(_563.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1008.Micropitting':
        ...
        return constructor.new(_1008.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_1022.Usage':
        ...
        return constructor.new(_1022.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_1006.LtcaSettings':
        ...
        return constructor.new(_1006.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_640.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_640.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_588.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_588.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_588.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_588.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_394.CylindricalGearSetDutyCycleRating') -> '_985.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_985.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
