...
class CylindricalGearDesignConstraintSettings(_73.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_976.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_976.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
