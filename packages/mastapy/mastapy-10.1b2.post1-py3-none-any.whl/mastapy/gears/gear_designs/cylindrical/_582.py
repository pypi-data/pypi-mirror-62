...
from mastapy.gears.gear_designs.cylindrical import (
    _998, _997, _999, _1000,
    _1015, _604, _378, _1016,
    _690, _691, _752, _976,
    _577
)
...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    ...
    _1053, _1054, _1056, _1061,
    _1062
)
from mastapy.gears.gear_designs.agma_gleason_conical import _1085
from mastapy.gears.gear_designs import _598
...
class CylindricalGearDesign(_598.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def iso6336_geometry(self) -> '_998.ISO6336GeometryBase':
        ...
        return constructor.new(_998.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_997.ISO6336Geometry':
        ...
        return constructor.new(_997.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None
    ...
    @property
    def tip_diameter_reporting(self) -> '_604.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_604.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_604.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_604.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None

    @property
    def cylindrical_gear_set(self) -> '_378.CylindricalGearSetDesign':
        ...
        return constructor.new(_378.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None
    ...
    @property
    def lowest_start_of_active_profile(self) -> '_604.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_604.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None
    ...
    @property
    def tip_form(self) -> '_604.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_604.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_604.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_604.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None
    ...
    @property
    def finished_tooth_thickness_specification(self) -> '_690.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_690.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_691.ToothThicknessSpecification':
        ...
        return constructor.new(_691.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_577.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_577.CylindricalGearMeshDesign))
        return value
