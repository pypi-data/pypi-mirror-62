...
from mastapy.gears.gear_designs.cylindrical import _890
...
class CylindricalGearDesignConstraintsDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_890.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_890.CylindricalGearDesignConstraints)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_890.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_890.CylindricalGearDesignConstraints)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_design_constraints: '_890.CylindricalGearDesignConstraints') -> 'bool':
    ...
    def rename(self, cylindrical_gear_design_constraints: '_890.CylindricalGearDesignConstraints', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_design_constraints: '_890.CylindricalGearDesignConstraints'):
    ...
    def get_all_items(self) -> 'Iterable[_890.CylindricalGearDesignConstraints]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_890.CylindricalGearDesignConstraints))

    def save_changes(self, cylindrical_gear_design_constraints: '_890.CylindricalGearDesignConstraints'):
