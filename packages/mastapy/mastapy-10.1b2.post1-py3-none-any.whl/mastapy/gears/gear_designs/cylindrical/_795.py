...
class GearSetFCAImportSetup(_1.APIBase):
    ...
    @property
    def meshes(self) -> 'List[_773.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_773.CylindricalGearMeshDesign))
        return value
