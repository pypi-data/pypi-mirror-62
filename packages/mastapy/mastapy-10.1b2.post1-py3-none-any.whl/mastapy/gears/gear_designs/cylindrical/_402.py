...
from mastapy.gears.gear_designs.cylindrical import (
    _973, _1000, _557, _1012,
    _1024, _1010, _506, _500,
    _986
)
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import list_with_selected_item, overridable
from mastapy.gears import _294
from mastapy.materials.efficiency import _279
from mastapy.gears.rating.cylindrical.iso6336 import _540
...
from mastapy.gears.gear_designs import _392
...
class CylindricalGearSetDesign(_392.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_973.AddendumModificationDistributionRule':
        ...
        return constructor.new(_973.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_973.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_279.EfficiencyRatingMethod':
        ...
        return constructor.new(_279.EfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method.setter
    def efficiency_rating_method(self, value: '_279.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_540.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_540.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_540.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_1000.GearFitSystems':
        ...
        return constructor.new(_1000.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_1000.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_1039.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1039.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_557.Scuffing':
        ...
        return constructor.new(_557.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1012.Micropitting':
        ...
        return constructor.new(_1012.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_1024.Usage':
        ...
        return constructor.new(_1024.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None
    ...
    def ltca_settings(self) -> '_1010.LtcaSettings':
        ...
        return constructor.new(_1010.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_630.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_630.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_506.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_506.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_506.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_506.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_425.CylindricalGearSetDutyCycleRating') -> '_986.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_986.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
