...
class CylindricalGearAbstractRack(_1.APIBase):
    ...
    @property
    def gear(self) -> '_594.CylindricalGearDesign':
        ...
        return constructor.new(_594.CylindricalGearDesign)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def shaper_for_agma_rating(self) -> '_747.CylindricalGearShaper':
        ...
        return constructor.new(_747.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
