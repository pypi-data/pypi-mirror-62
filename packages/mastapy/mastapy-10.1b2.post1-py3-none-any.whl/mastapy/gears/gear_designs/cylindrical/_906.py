...
class CylindricalMeshedGear(_1.APIBase):
    ...
    @property
    def lowest_point_of_fewest_tooth_contacts(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.LowestPointOfFewestToothContacts) if self.wrapped.LowestPointOfFewestToothContacts else None

    @property
    def highest_point_of_fewest_tooth_contacts(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.HighestPointOfFewestToothContacts) if self.wrapped.HighestPointOfFewestToothContacts else None

    @property
    def start_of_active_profile(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.StartOfActiveProfile) if self.wrapped.StartOfActiveProfile else None

    @property
    def end_of_active_profile(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.EndOfActiveProfile) if self.wrapped.EndOfActiveProfile else None
