...
from mastapy.math_utility import _923
...
class CylindricalPlanetaryGearSetDesign(_389.CylindricalGearSetDesign):
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_923.FourierSeries':
        ...
        return constructor.new(_923.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
