...
from mastapy.gears.gear_designs.cylindrical import _879
...
class TiffAnalysisSettings(_1243.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_879.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_879.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
