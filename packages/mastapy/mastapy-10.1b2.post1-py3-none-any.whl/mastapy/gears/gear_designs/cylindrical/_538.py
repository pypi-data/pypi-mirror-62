...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    _1058, _1061, _1053, _1055,
    _1051, _1052, _1059, _1060,
    _1054
)
from mastapy.gears.gear_designs.agma_gleason_conical import _1081
from mastapy.gears.gear_designs import _630
...
class CylindricalGearDesign(_630.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def surface_roughness(self) -> '_1015.SurfaceRoughness':
        ...
        return constructor.new(_1015.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_597.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_597.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_597.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_597.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None

    @property
    def cylindrical_gear_set(self) -> '_389.CylindricalGearSetDesign':
        ...
        return constructor.new(_389.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def cylindrical_gear_micro_geometry(self) -> '_1029.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1029.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_610.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_610.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_597.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_597.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None
    ...
    @property
    def material_of_type_bevel_gear_material(self) -> '_588.BevelGearMaterial':
        ...
        return constructor.new(_588.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_586.BevelGearISOMaterial':
        ...
        return constructor.new(_586.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_585.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_585.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def system_of_gear_fits(self) -> '_1058.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1058.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_1061.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1061.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_1053.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_1053.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_1055.CylindricalAccuracyGrader':
        ...
        return constructor.new(_1055.CylindricalAccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_1051.AGMA2000AccuracyGrader':
        ...
        return constructor.new(_1051.AGMA2000AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_1052.AGMA20151AccuracyGrader':
        ...
        return constructor.new(_1052.AGMA20151AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_1059.ISO13282013AccuracyGrader':
        ...
        return constructor.new(_1059.ISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_1060.ISO1328AccuracyGrader':
        ...
        return constructor.new(_1060.ISO1328AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_1054.AGMAISO13282013AccuracyGrader':
        ...
        return constructor.new(_1054.AGMAISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1081.AGMAGleasonConicalAccuracyGrades':
        ...
        return constructor.new(_1081.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_1053.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_1053.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_1061.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1061.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def tip_form(self) -> '_597.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_597.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_597.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_597.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def tiff_analysis_settings(self) -> '_1016.TiffAnalysisSettings':
        ...
        return constructor.new(_1016.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_707.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_707.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_708.ToothThicknessSpecification':
        ...
        return constructor.new(_708.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_976.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_976.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def cylindrical_meshes(self) -> 'List[_506.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_506.CylindricalGearMeshDesign))
        return value
