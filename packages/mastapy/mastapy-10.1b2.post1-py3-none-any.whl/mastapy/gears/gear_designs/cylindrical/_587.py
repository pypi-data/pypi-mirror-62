...
from mastapy.gears import _310, _291
...
class CylindricalGearMeshDesign(_955.GearMeshDesign):
    ...
    @property
    def profile_modification(self) -> '_599.CylindricalGearProfileModifications':
        ...
        return constructor.new(_599.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_599.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_579.TypeOfMechanismHousing':
        ...
        return constructor.new(_579.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_579.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_291.CentreDistanceChangeMethod':
        ...
        return constructor.new(_291.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_291.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_972.BacklashSpecification':
        ...
        return constructor.new(_972.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_992.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_992.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_594.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_594.CylindricalGearDesign':
