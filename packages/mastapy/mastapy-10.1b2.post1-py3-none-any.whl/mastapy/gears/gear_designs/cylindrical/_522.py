...
from mastapy.gears import _311, _293
from mastapy.math_utility.measured_ranges import _1093
...
class CylindricalGearMeshDesign(_955.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_570.CylindricalGearProfileModifications':
        ...
        return constructor.new(_570.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_570.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_636.TypeOfMechanismHousing':
        ...
        return constructor.new(_636.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_636.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_293.CentreDistanceChangeMethod':
        ...
        return constructor.new(_293.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_293.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_976.BacklashSpecification':
        ...
        return constructor.new(_976.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1093.ShortLengthRange':
        ...
        return constructor.new(_1093.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_995.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_995.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_554.CylindricalGearDesign':
        ...
        return constructor.new(_554.CylindricalGearDesign)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_b(self) -> '_554.CylindricalGearDesign':
        ...
        return constructor.new(_554.CylindricalGearDesign)(self.wrapped.GearB) if self.wrapped.GearB else None
