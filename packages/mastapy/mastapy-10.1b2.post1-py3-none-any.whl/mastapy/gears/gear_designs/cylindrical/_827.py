...
from mastapy.gears.gear_designs.cylindrical import _816
...
class Usage(_1122.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_148.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_148.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_816.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_816.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_816.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
