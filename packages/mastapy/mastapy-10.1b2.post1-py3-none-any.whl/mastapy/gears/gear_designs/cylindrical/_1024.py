...
from mastapy.utility import _307
...
class Usage(_307.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1018.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1018.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1018.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
