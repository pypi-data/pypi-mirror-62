...
class CylindricalGearTableWithMGCharts(_1229.CustomTable):
    ...
    @property
    def item_detail(self) -> '_986.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_986.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_986.CylindricalGearTableMGItemDetail'):
