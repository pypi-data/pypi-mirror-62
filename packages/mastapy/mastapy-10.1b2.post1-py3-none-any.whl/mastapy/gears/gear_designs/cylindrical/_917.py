...
from mastapy.gears.gear_designs.cylindrical import _880, _915
...
class GearSetManufacturingConfigurationSetup(_1.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_880.CreateNewSuitableCutterOption':
        ...
        return constructor.new(_880.CreateNewSuitableCutterOption)(value) if value else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_880.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CreateNewSuitableCutters = value

    @property
    def use_as_design_mode_geometry(self) -> '_880.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_880.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_915.GearManufacturingConfigSetupViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_915.GearManufacturingConfigSetupViewModel))
        return value
