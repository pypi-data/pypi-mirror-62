...
from mastapy.gears.gear_designs.cylindrical import (
    _970, _995, _526, _1007,
    _1020, _1005, _508, _501,
    _983
)
...
from mastapy.gears.rating.cylindrical import _382
from mastapy.gears.gear_designs import _356
...
class CylindricalGearSetDesign(_356.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def micropitting(self) -> '_1007.Micropitting':
        ...
        return constructor.new(_1007.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None
    ...
    @property
    def ltca_settings(self) -> '_1005.LtcaSettings':
        ...
        return constructor.new(_1005.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None
    ...
    @property
    def gears(self) -> 'List[_508.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_508.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_508.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_508.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_382.CylindricalGearSetDutyCycleRating') -> '_983.CylindricalGearSetMacroGeometryOptimiser':
