...
from mastapy.gears.gear_designs.cylindrical import (
    _971, _996, _553, _1008,
    _1020, _1006, _594, _587,
    _984
)
...
class CylindricalGearSetDesign(_365.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_971.AddendumModificationDistributionRule':
        ...
        return constructor.new(_971.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_971.AddendumModificationDistributionRule'):
    ...
    @property
    def gear_fit_system(self) -> '_996.GearFitSystems':
        ...
        return constructor.new(_996.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_996.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_553.Scuffing':
        ...
        return constructor.new(_553.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None
    ...
    def usage(self) -> '_1020.Usage':
        ...
        return constructor.new(_1020.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None
    ...
    @property
    def gears(self) -> 'List[_594.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_594.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_594.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_594.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_415.CylindricalGearSetDutyCycleRating') -> '_984.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_984.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
