...
class CrossedAxisCylindricalGearPair(_1.APIBase):
    ...
    @property
    def shaver(self) -> '_724.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_724.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
