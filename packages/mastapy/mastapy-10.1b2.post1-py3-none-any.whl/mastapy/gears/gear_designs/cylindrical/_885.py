...
class CylindricalGearBasicRack(_884.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_878.BasicRackProfiles':
        ...
        return constructor.new(_878.BasicRackProfiles)(value) if value else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_878.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_942.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_942.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_942.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_895.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_895.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
