...
class CrossedAxisCylindricalGearPair(_1.APIBase):
    ...
    @property
    def shaver(self) -> '_483.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_483.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
