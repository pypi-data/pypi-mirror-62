...
from mastapy.gears.gear_designs.cylindrical import (
    _976, _1013, _526, _1024,
    _1034, _1022, _600, _571,
    _989
)
...
from mastapy.gears.rating.cylindrical.iso6336 import _544
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1049
from mastapy.gears.manufacturing.cylindrical import _628
from mastapy.gears.rating.cylindrical import _399
from mastapy.gears.gear_designs import _373
...
class CylindricalGearSetDesign(_373.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_976.AddendumModificationDistributionRule':
        ...
        return constructor.new(_976.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_976.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_280.EfficiencyRatingMethod':
    ...
    def efficiency_rating_method(self, value: '_280.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_544.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_544.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_544.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_1013.GearFitSystems':
        ...
        return constructor.new(_1013.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_1013.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_1049.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1049.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_526.Scuffing':
        ...
        return constructor.new(_526.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1024.Micropitting':
        ...
        return constructor.new(_1024.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_1034.Usage':
        ...
        return constructor.new(_1034.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_1022.LtcaSettings':
        ...
        return constructor.new(_1022.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_628.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_628.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_600.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_600.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_600.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_600.CylindricalGearDesign))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_571.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_571.CylindricalGearMeshDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_399.CylindricalGearSetDutyCycleRating') -> '_989.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_989.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
