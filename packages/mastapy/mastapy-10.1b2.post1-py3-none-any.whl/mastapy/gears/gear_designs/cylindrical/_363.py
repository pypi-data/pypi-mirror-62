...
from mastapy.gears.gear_designs.cylindrical import (
    _968, _991, _577, _1003,
    _1019, _1001, _522, _506,
    _981
)
...
from mastapy.gears.rating.cylindrical import _376
...
class CylindricalGearSetDesign(_353.GearSetDesign):
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_968.AddendumModificationDistributionRule':
        ...
        return constructor.new(_968.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_968.AddendumModificationDistributionRule'):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_533.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_533.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_533.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_991.GearFitSystems':
        ...
        return constructor.new(_991.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_991.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_1034.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1034.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_577.Scuffing':
        ...
        return constructor.new(_577.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1003.Micropitting':
        ...
        return constructor.new(_1003.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_1019.Usage':
        ...
        return constructor.new(_1019.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_1001.LtcaSettings':
        ...
        return constructor.new(_1001.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_623.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_623.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_522.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_522.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_522.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_522.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_376.CylindricalGearSetDutyCycleRating') -> '_981.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_981.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
