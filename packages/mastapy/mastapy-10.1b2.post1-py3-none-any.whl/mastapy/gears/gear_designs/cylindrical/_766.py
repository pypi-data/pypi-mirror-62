...
from mastapy.gears.gear_designs.cylindrical import _793
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _867
...
class CylindricalGearDefaults(_1127.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_867.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_867.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_518.RoughCutterCreationSettings':
        ...
        return constructor.new(_518.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
