...
class CylindricalGearBasicRack(_977.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_973.BasicRackProfiles':
        ...
        return constructor.new(_973.BasicRackProfiles)(value) if value else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_973.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_1018.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1018.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1018.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_983.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_983.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
