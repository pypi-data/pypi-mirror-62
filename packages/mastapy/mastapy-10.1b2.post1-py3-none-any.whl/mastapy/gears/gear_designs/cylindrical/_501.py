...
from mastapy.gears import _312, _289
...
class CylindricalGearMeshDesign(_941.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_610.CylindricalGearProfileModifications':
        ...
        return constructor.new(_610.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_610.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_551.TypeOfMechanismHousing':
        ...
        return constructor.new(_551.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_551.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_a(self) -> '_508.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_508.CylindricalGearDesign':
