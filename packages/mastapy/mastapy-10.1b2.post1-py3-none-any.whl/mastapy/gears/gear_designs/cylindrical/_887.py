...
from mastapy.gears.gear_designs.cylindrical import _914
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _988
from mastapy.gears.manufacturing.cylindrical.cutters import _644
...
class CylindricalGearDefaults(_1248.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_988.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_988.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_644.RoughCutterCreationSettings':
        ...
        return constructor.new(_644.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
