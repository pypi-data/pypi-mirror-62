...
from mastapy.utility.report import _1149
...
class CylindricalGearTableWithMGCharts(_1149.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_987.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_987.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_987.CylindricalGearTableMGItemDetail'):
