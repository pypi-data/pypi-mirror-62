...
from mastapy.gears.gear_designs.cylindrical import _379
...
class CylindricalPlanetaryGearSetDesign(_379.CylindricalGearSetDesign):
    '''CylindricalPlanetaryGearSetDesign
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_894.FourierSeries':
        ...
        return constructor.new(_894.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
