...
class SelectedDesignConstraintsCollection(_1127.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_702.DesignConstraintsCollection':
        ...
        return constructor.new(_702.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
