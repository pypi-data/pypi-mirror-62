...
from mastapy.gears.gear_designs import _638, _945
...
class GearSetDesign(_945.GearDesignComponent):
    ...
    @property
    def gear_set_drawing(self) -> '_730.SMTBitmap':
        ...
        return constructor.new(_730.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
