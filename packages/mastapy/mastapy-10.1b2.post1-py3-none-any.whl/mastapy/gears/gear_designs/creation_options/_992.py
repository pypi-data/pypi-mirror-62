...
from mastapy.gears.gear_designs.creation_options import _993
...
class CylindricalGearPairCreationOptions(_993.GearSetCreationOptions['_899.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
    ...
    def derived_parameter(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption.implicit_type()
    ...
    def derived_parameter(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption.implicit_type().type_()
