...
from mastapy.gears.gear_designs.creation_options import _1069
...
class SpiralBevelGearSetCreationOptions(_1069.GearSetCreationOptions['_369.SpiralBevelGearSetDesign']):
    '''SpiralBevelGearSetCreationOptions
