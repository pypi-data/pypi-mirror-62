...
from mastapy.gears.gear_designs.creation_options import _1063
...
class CylindricalGearPairCreationOptions(_1063.GearSetCreationOptions['_363.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
