...
from mastapy.gears.gear_designs.zerol_bevel import _374, _426, _959
...
class ZerolBevelGearMeshDesign(_951.BevelGearMeshDesign):
    '''ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_meshed_gears(self) -> 'List[_959.ZerolBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshedGears, constructor.new(_959.ZerolBevelMeshedGearDesign))
        return value
