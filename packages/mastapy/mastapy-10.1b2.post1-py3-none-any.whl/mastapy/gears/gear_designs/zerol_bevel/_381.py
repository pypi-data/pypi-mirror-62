...
from mastapy.gears.gear_designs.zerol_bevel import _415, _406
...
class ZerolBevelGearSetDesign(_964.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_415.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_415.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_406.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_406.ZerolBevelGearMeshDesign))
        return value
