...
from mastapy.gears.gear_designs.zerol_bevel import _832, _830, _833
...
class ZerolBevelGearMeshDesign(_1027.BevelGearMeshDesign):
    '''ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_meshed_gears(self) -> 'List[_833.ZerolBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshedGears, constructor.new(_833.ZerolBevelMeshedGearDesign))
        return value
