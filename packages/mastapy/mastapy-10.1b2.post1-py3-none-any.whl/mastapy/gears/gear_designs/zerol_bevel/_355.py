...
from mastapy.gears.gear_designs.zerol_bevel import _442, _432
...
class ZerolBevelGearSetDesign(_369.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_442.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_442.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_442.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_442.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_432.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_432.ZerolBevelGearMeshDesign))
        return value
