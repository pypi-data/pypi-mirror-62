...
from mastapy.gears.gear_designs.zerol_bevel import _393, _409, _952
...
class ZerolBevelGearMeshDesign(_966.BevelGearMeshDesign):
    ...
    def zerol_bevel_meshed_gears(self) -> 'List[_952.ZerolBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshedGears, constructor.new(_952.ZerolBevelMeshedGearDesign))
        return value
