...
from mastapy.gears.gear_designs.zerol_bevel import _406, _404
...
class ZerolBevelGearSetDesign(_1012.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_406.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_406.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_406.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_406.ZerolBevelGearDesign))
        return value
