...
from mastapy.gears.gear_designs.zerol_bevel import _420, _385
...
class ZerolBevelGearSetDesign(_1009.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_420.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_420.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_385.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_385.ZerolBevelGearMeshDesign))
        return value
