...
from mastapy.gears.gear_designs.zerol_bevel import _416, _413
...
class ZerolBevelGearSetDesign(_1064.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_416.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_416.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_416.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_416.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_413.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_413.ZerolBevelGearMeshDesign))
        return value
