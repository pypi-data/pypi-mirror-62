...
from mastapy.gears.gear_designs.zerol_bevel import _430, _425
from mastapy.gears.gear_designs.bevel import _987
...
class ZerolBevelGearSetDesign(_987.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_321.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_321.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_321.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_430.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_430.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_430.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_430.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_425.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_425.ZerolBevelGearMeshDesign))
        return value
