...
from mastapy.gears.gear_designs import _702
...
class DesignConstraintCollectionDatabase(_1.APIBase):
    '''DesignConstraintCollectionDatabase
    ...
    @property
    def item(self) -> '_702.DesignConstraintsCollection':
        ...
        return constructor.new(_702.DesignConstraintsCollection)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_702.DesignConstraintsCollection':
        ...
        return constructor.new(_702.DesignConstraintsCollection)(method_result) if method_result else None

    def can_be_removed(self, design_constraints_collection: '_702.DesignConstraintsCollection') -> 'bool':
    ...
    def rename(self, design_constraints_collection: '_702.DesignConstraintsCollection', new_name: 'str') -> 'bool':
    ...
    def remove(self, design_constraints_collection: '_702.DesignConstraintsCollection'):
    ...
    def get_all_items(self) -> 'Iterable[_702.DesignConstraintsCollection]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_702.DesignConstraintsCollection))

    def save_changes(self, design_constraints_collection: '_702.DesignConstraintsCollection'):
