...
class GearSetDesign(_946.GearDesignComponent):
    ...
    @property
    def gear_set_drawing(self) -> '_731.SMTBitmap':
        ...
        return constructor.new(_731.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def gears(self) -> 'List[_612.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_612.GearDesign))
        return value
