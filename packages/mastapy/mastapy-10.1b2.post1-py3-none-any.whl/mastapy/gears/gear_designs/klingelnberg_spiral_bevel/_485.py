...
from mastapy.gears.gear_designs.klingelnberg_conical import _641
...
class KlingelnbergCycloPalloidSpiralBevelGearDesign(_641.KlingelnbergConicalGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearDesign
