...
from mastapy.gears.gear_designs.klingelnberg_conical import _862
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_862.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
