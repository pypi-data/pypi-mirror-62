...
from mastapy.gears.gear_designs.klingelnberg_conical import _966
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_966.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
