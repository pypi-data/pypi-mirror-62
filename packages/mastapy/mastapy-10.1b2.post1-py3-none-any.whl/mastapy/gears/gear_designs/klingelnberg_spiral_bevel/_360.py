...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _485, _469
from mastapy.gears.gear_designs.klingelnberg_conical import _362
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(_362.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_485.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_485.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_485.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGears, constructor.new(_485.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_469.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_469.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_469.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_469.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value
