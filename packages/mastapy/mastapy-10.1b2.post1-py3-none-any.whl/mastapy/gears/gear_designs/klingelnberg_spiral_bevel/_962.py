...
from mastapy.gears.gear_designs.klingelnberg_conical import _964
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_964.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
