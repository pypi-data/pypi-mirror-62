...
from mastapy.gears.gear_designs.klingelnberg_conical import _960
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_960.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
