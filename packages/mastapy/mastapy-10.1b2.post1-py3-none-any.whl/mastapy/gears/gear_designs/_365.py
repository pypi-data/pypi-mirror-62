...
from mastapy.gears.fe_model import _1087
from mastapy.gears.fe_model.cylindrical import _1088
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1089
...
class GearSetDesign(_954.GearDesignComponent):
    ...
    @property
    def gear_set_drawing(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def ltcafe_model(self) -> '_1087.GearSetFEModel':
        ...
        return constructor.new(_1087.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1088.CylindricalGearSetFEModel':
        ...
        if _1088.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1088.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1089.ConicalSetFEModel':
        ...
        if _1089.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1089.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_588.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_588.GearDesign))
        return value
