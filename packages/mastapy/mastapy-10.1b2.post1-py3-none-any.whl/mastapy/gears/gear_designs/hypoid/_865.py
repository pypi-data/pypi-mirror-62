...
from mastapy.gears.gear_designs.hypoid import _863, _864
...
class HypoidGearSetDesign(_1041.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_863.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_863.HypoidGearDesign))
        return value
    ...
    @property
    def meshes(self) -> 'List[_864.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_864.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_864.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_864.HypoidGearMeshDesign))
        return value
