...
from mastapy.gears.gear_designs.hypoid import _478, _550
...
class HypoidGearSetDesign(_1109.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_478.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_478.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_478.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_478.HypoidGearDesign))
        return value
