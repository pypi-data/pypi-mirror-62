...
from mastapy.gears.gear_designs.hypoid import _741, _742
...
class HypoidGearSetDesign(_920.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_741.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_741.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_741.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_741.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_742.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_742.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_742.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_742.HypoidGearMeshDesign))
        return value
