...
from mastapy.gears.gear_designs.hypoid import _580, _579
...
class HypoidGearSetDesign(_380.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def meshes(self) -> 'List[_579.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_579.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_579.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_579.HypoidGearMeshDesign))
        return value
