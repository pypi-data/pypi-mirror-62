...
from mastapy.gears.gear_designs.hypoid import _492, _588
...
class HypoidGearSetDesign(_370.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def meshes(self) -> 'List[_588.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_588.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_588.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_588.HypoidGearMeshDesign))
        return value
