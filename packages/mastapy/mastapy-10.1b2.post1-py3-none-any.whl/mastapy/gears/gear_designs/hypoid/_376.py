...
from mastapy.gears.gear_designs.hypoid import _467, _550
...
class HypoidGearSetDesign(_1111.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_467.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_467.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_467.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_467.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_550.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_550.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_550.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_550.HypoidGearMeshDesign))
        return value
