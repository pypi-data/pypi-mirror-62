...
from mastapy.gears.gear_designs.hypoid import _560, _557
...
class HypoidGearSetDesign(_1110.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_560.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_560.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_560.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_560.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_557.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_557.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_557.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_557.HypoidGearMeshDesign))
        return value
