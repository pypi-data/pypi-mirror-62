...
from mastapy.gears.gear_designs.hypoid import _471, _537
...
class HypoidGearSetDesign(_389.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def meshes(self) -> 'List[_537.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_537.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_537.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_537.HypoidGearMeshDesign))
        return value
