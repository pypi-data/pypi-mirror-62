...
from mastapy.gears.gear_designs.hypoid import _492, _583
...
class HypoidGearSetDesign(_1113.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_492.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_492.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_492.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_492.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_583.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_583.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_583.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_583.HypoidGearMeshDesign))
        return value
