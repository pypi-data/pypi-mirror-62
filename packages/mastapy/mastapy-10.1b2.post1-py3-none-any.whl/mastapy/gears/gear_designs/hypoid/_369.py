...
from mastapy.gears.gear_designs.hypoid import _485, _552
...
class HypoidGearSetDesign(_1105.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_485.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_485.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_485.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_485.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_552.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_552.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_552.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_552.HypoidGearMeshDesign))
        return value
