...
from mastapy.gears.gear_designs.hypoid import _483, _569
...
class HypoidGearSetDesign(_407.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_483.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_483.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_483.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_483.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_569.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_569.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_569.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_569.HypoidGearMeshDesign))
        return value
