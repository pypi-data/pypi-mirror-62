...
from mastapy.gears.gear_designs.hypoid import _586, _583
...
class HypoidGearSetDesign(_381.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_586.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_586.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_586.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_586.HypoidGearDesign))
        return value
