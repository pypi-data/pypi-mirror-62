...
from mastapy.gears.gear_designs.hypoid import _471, _598
...
class HypoidGearSetDesign(_1107.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_471.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_471.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_471.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_471.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_598.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_598.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_598.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_598.HypoidGearMeshDesign))
        return value
