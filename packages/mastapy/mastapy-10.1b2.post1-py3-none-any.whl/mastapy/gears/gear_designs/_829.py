...
from mastapy.gears import _260
from mastapy.gears.fe_model import _1046
from mastapy.gears.fe_model.cylindrical import _1049
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1052
...
class GearSetDesign(_827.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def transmission_properties_gears(self) -> '_260.GearSetDesignGroup':
        ...
        return constructor.new(_260.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_1046.GearSetFEModel':
        ...
        return constructor.new(_1046.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1049.CylindricalGearSetFEModel':
        ...
        if _1049.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1049.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1052.ConicalSetFEModel':
        ...
        if _1052.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1052.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_826.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_826.GearDesign))
        return value
