...
from mastapy.gears.gear_designs import _630, _944
...
class GearSetDesign(_944.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gears(self) -> 'List[_630.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_630.GearDesign))
        return value
