...
from mastapy.gears.gear_designs.conical import _867
...
class ConicalGearSetDesign(_368.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_867.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_867.ConicalGearMeshDesign))
        return value
