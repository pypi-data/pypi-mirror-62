...
from mastapy.gears.gear_designs.bevel import _1106, _1110, _1109
...
class ConicalGearMeshDesign(_955.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    @property
    def driven_machine_characteristic_gleason(self) -> '_1106.DrivenMachineCharacteristicGleason':
        ...
        return constructor.new(_1106.DrivenMachineCharacteristicGleason)(value) if value else None

    @driven_machine_characteristic_gleason.setter
    def driven_machine_characteristic_gleason(self, value: '_1106.DrivenMachineCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristicGleason = value

    @property
    def prime_mover_characteristic_gleason(self) -> '_1110.PrimeMoverCharacteristicGleason':
        ...
        return constructor.new(_1110.PrimeMoverCharacteristicGleason)(value) if value else None

    @prime_mover_characteristic_gleason.setter
    def prime_mover_characteristic_gleason(self, value: '_1110.PrimeMoverCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristicGleason = value

    @property
    def prime_mover_characteristic(self) -> '_1109.MachineCharacteristicAGMAKlingelnberg':
        ...
        return constructor.new(_1109.MachineCharacteristicAGMAKlingelnberg)(value) if value else None

    @prime_mover_characteristic.setter
    def prime_mover_characteristic(self, value: '_1109.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristic = value

    @property
    def driven_machine_characteristic(self) -> '_1109.MachineCharacteristicAGMAKlingelnberg':
    ...
    def driven_machine_characteristic(self, value: '_1109.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
