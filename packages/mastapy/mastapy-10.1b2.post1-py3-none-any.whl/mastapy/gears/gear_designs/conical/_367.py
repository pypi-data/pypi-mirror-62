...
from mastapy.gears.gear_designs.conical import _931
...
class ConicalGearSetDesign(_354.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_931.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_931.ConicalGearMeshDesign))
        return value
