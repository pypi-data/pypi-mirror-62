...
from mastapy.gears.gear_designs.bevel import _1103, _1110, _1109
...
class ConicalGearMeshDesign(_945.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    @property
    def driven_machine_characteristic_gleason(self) -> '_1103.DrivenMachineCharacteristicGleason':
        ...
        return constructor.new(_1103.DrivenMachineCharacteristicGleason)(value) if value else None

    @driven_machine_characteristic_gleason.setter
    def driven_machine_characteristic_gleason(self, value: '_1103.DrivenMachineCharacteristicGleason'):
