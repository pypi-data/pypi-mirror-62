...
class ConicalGearCutter(_1.APIBase):
    ...
    @property
    def input_toprem_as(self) -> '_1097.TopremEntryType':
        ...
        return constructor.new(_1097.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1097.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_964.TopremLetter':
        ...
        return constructor.new(_964.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_964.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_964.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_964.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
