...
from mastapy.gears.gear_designs.conical.micro_geometry import _1100, _1099, _1098
...
class ConicalGearFlankMicroGeometry(_567.FlankMicroGeometry):
    ...
    @property
    def profile_relief(self) -> '_1100.ConicalGearProfileModification':
        ...
        return constructor.new(_1100.ConicalGearProfileModification)(self.wrapped.ProfileRelief) if self.wrapped.ProfileRelief else None

    @property
    def lead_relief(self) -> '_1099.ConicalGearLeadModification':
        ...
        return constructor.new(_1099.ConicalGearLeadModification)(self.wrapped.LeadRelief) if self.wrapped.LeadRelief else None

    @property
    def bias(self) -> '_1098.ConicalGearBiasModification':
        ...
        return constructor.new(_1098.ConicalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None

    @property
    def gear_design(self) -> '_1084.ConicalGearDesign':
        ...
        return constructor.new(_1084.ConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_zerol_bevel_gear_design(self) -> '_420.ZerolBevelGearDesign':
        ...
        return constructor.new(_420.ZerolBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    @property
    def gear_design_of_type_spiral_bevel_gear_design(self) -> '_466.SpiralBevelGearDesign':
        ...
        return constructor.new(_466.SpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_525.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_525.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_448.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_448.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_hypoid_gear_design(self) -> '_467.HypoidGearDesign':
        ...
        return constructor.new(_467.HypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
