...
class ConicalGearFlankMicroGeometry(_575.FlankMicroGeometry):
    '''ConicalGearFlankMicroGeometry
    ...
    @property
    def gear_design(self) -> '_643.ConicalGearDesign':
        ...
        return constructor.new(_643.ConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_zerol_bevel_gear_design(self) -> '_409.ZerolBevelGearDesign':
        ...
        if _409.ZerolBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_409.ZerolBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_502.StraightBevelDiffGearDesign':
        ...
        if _502.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_502.StraightBevelDiffGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_straight_bevel_gear_design(self) -> '_455.StraightBevelGearDesign':
        ...
        if _455.StraightBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_455.StraightBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_spiral_bevel_gear_design(self) -> '_501.SpiralBevelGearDesign':
        ...
        if _501.SpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_501.SpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_509.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _509.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_509.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_487.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _487.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_487.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_639.KlingelnbergConicalGearDesign':
        ...
        if _639.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_639.KlingelnbergConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_hypoid_gear_design(self) -> '_483.HypoidGearDesign':
        ...
        if _483.HypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_483.HypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_bevel_gear_design(self) -> '_644.BevelGearDesign':
        ...
        if _644.BevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_644.BevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_645.AGMAGleasonConicalGearDesign':
        ...
        if _645.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_645.AGMAGleasonConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
