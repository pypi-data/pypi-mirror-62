...
from mastapy.gears.manufacturing.bevel import _700
...
class ConicalGearDesign(_826.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_700.FlankMeasurementBorder':
        ...
        return constructor.new(_700.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
