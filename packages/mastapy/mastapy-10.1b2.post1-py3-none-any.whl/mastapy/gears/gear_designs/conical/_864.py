...
from mastapy.gears.gear_designs.conical import _947
...
class ConicalGearSetDesign(_356.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_947.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_947.ConicalGearMeshDesign))
        return value
