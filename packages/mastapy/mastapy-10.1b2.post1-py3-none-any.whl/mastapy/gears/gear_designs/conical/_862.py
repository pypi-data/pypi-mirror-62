...
from mastapy.gears.gear_designs.conical import _925
...
class ConicalGearSetDesign(_369.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_925.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_925.ConicalGearMeshDesign))
        return value
