...
from mastapy.gears.manufacturing.bevel import _829
...
class ConicalGearDesign(_638.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_829.FlankMeasurementBorder':
        ...
        return constructor.new(_829.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
