...
from mastapy.gears.gear_designs.conical import _946
...
class ConicalGearSetDesign(_380.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_946.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_946.ConicalGearMeshDesign))
        return value
