...
from mastapy.gears.gear_designs.conical import _965
...
class ConicalGearSetDesign(_392.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_965.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_965.ConicalGearMeshDesign))
        return value
