...
class ConicalGearCutter(_1.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1095.CutterGaugeLengths':
        ...
        return constructor.new(_1095.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1095.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1094.CutterBladeType':
        ...
        return constructor.new(_1094.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1094.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def outer_toprem_letter_concave(self) -> '_988.TopremLetter':
        ...
        return constructor.new(_988.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_988.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_988.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_988.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
