...
from mastapy.gears.gear_designs.bevel import _1104, _1107, _1108
...
class ConicalGearMeshDesign(_957.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    @property
    def prime_mover_characteristic_gleason(self) -> '_1107.PrimeMoverCharacteristicGleason':
        ...
        return constructor.new(_1107.PrimeMoverCharacteristicGleason)(value) if value else None

    @prime_mover_characteristic_gleason.setter
    def prime_mover_characteristic_gleason(self, value: '_1107.PrimeMoverCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristicGleason = value

    @property
    def prime_mover_characteristic(self) -> '_1108.MachineCharacteristicAGMAKlingelnberg':
        ...
        return constructor.new(_1108.MachineCharacteristicAGMAKlingelnberg)(value) if value else None

    @prime_mover_characteristic.setter
    def prime_mover_characteristic(self, value: '_1108.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristic = value

    @property
    def driven_machine_characteristic(self) -> '_1108.MachineCharacteristicAGMAKlingelnberg':
    ...
    def driven_machine_characteristic(self, value: '_1108.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
