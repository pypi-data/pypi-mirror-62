...
from mastapy.gears.gear_designs.bevel import _1104, _1109, _1110
...
class ConicalGearMeshDesign(_951.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    @property
    def prime_mover_characteristic_gleason(self) -> '_1109.PrimeMoverCharacteristicGleason':
        ...
        return constructor.new(_1109.PrimeMoverCharacteristicGleason)(value) if value else None

    @prime_mover_characteristic_gleason.setter
    def prime_mover_characteristic_gleason(self, value: '_1109.PrimeMoverCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
