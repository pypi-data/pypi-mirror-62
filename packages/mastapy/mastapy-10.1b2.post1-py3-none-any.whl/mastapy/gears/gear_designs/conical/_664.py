...
from mastapy.gears.manufacturing.bevel import _830
from mastapy.gears.gear_designs import _657
...
class ConicalGearDesign(_657.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def surface_roughness(self) -> '_1030.SurfaceRoughness':
        ...
        return constructor.new(_1030.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def flank_measurement_border(self) -> '_830.FlankMeasurementBorder':
        ...
        return constructor.new(_830.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
