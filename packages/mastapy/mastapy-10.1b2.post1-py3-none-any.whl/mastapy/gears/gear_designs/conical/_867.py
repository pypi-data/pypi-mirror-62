...
from mastapy.gears.gear_designs.bevel import _1102, _1107, _1106
...
class ConicalGearMeshDesign(_946.GearMeshDesign):
    ...
    @property
    def driven_machine_characteristic_gleason(self) -> '_1102.DrivenMachineCharacteristicGleason':
        ...
        return constructor.new(_1102.DrivenMachineCharacteristicGleason)(value) if value else None

    @driven_machine_characteristic_gleason.setter
    def driven_machine_characteristic_gleason(self, value: '_1102.DrivenMachineCharacteristicGleason'):
    ...
    @property
    def prime_mover_characteristic(self) -> '_1106.MachineCharacteristicAGMAKlingelnberg':
        ...
        return constructor.new(_1106.MachineCharacteristicAGMAKlingelnberg)(value) if value else None

    @prime_mover_characteristic.setter
    def prime_mover_characteristic(self, value: '_1106.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristic = value

    @property
    def driven_machine_characteristic(self) -> '_1106.MachineCharacteristicAGMAKlingelnberg':
    ...
    def driven_machine_characteristic(self, value: '_1106.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
