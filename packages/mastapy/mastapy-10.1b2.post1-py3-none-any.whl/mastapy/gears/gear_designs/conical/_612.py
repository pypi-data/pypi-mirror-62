...
from mastapy.gears.manufacturing.bevel import _828
...
class ConicalGearDesign(_601.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_828.FlankMeasurementBorder':
        ...
        return constructor.new(_828.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
