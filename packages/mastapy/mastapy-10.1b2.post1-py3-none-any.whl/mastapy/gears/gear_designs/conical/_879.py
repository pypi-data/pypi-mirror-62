...
from mastapy.gears.gear_designs.cylindrical import _818
...
class ConicalGearDesign(_703.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_574.FlankMeasurementBorder':
        ...
        return constructor.new(_574.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
