...
from mastapy.gears.gear_designs.conical import _949
...
class ConicalGearSetDesign(_373.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_949.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_949.ConicalGearMeshDesign))
        return value
