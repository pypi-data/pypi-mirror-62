...
from mastapy.gears.gear_designs.conical import _1001
...
class ConicalGearSetDesign(_829.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_1001.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1001.ConicalGearMeshDesign))
        return value
