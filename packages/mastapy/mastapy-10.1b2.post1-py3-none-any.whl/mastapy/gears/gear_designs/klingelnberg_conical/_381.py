...
from mastapy.gears.gear_designs.conical import _1097, _386
...
class KlingelnbergConicalGearSetDesign(_386.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1097.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1097.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1097.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_950.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_950.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_950.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_950.KlingelnbergConicalGearMeshDesign))
        return value
