...
from mastapy.gears.gear_designs.conical import _1014, _1002
...
class KlingelnbergConicalGearSetDesign(_1002.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1014.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1014.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1014.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_860.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_860.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_860.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_860.KlingelnbergConicalGearMeshDesign))
        return value
