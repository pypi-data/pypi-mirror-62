...
from mastapy.gears.gear_designs.conical import _1087, _404
...
class KlingelnbergConicalGearSetDesign(_404.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1087.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1087.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1087.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_959.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_959.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_959.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_959.KlingelnbergConicalGearMeshDesign))
        return value
