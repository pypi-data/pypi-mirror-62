...
from mastapy.gears.gear_designs.conical import _645
...
class KlingelnbergConicalGearDesign(_645.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_608.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_608.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
