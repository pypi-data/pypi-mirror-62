...
from mastapy.gears.gear_designs.conical import _1093, _847
...
class KlingelnbergConicalGearSetDesign(_847.ConicalGearSetDesign):
    ...
    @property
    def gear_finish(self) -> '_1093.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1093.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1093.KlingelnbergFinishingMethods'):
