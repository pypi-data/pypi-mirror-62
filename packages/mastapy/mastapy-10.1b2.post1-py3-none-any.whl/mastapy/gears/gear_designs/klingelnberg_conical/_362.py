...
from mastapy.gears.gear_designs.conical import _1090, _367
...
class KlingelnbergConicalGearSetDesign(_367.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1090.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1090.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1090.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_932.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_932.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_932.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_932.KlingelnbergConicalGearMeshDesign))
        return value
