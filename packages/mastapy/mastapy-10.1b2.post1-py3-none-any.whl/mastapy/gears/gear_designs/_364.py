...
from mastapy.gears.fe_model import _1090
from mastapy.gears.fe_model.cylindrical import _1091
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1092
...
class GearSetDesign(_955.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_738.SMTBitmap':
        ...
        return constructor.new(_738.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def ltcafe_model(self) -> '_1090.GearSetFEModel':
        ...
        return constructor.new(_1090.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1091.CylindricalGearSetFEModel':
        ...
        if _1091.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1091.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1092.ConicalSetFEModel':
        ...
        if _1092.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1092.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_601.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_601.GearDesign))
        return value
