...
from mastapy.gears.fe_model import _994
from mastapy.gears.fe_model.cylindrical import _995
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _996
...
class GearSetDesign(_956.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def transmission_properties_gears(self) -> '_308.GearSetDesignGroup':
        ...
        return constructor.new(_308.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_994.GearSetFEModel':
        ...
        return constructor.new(_994.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_995.CylindricalGearSetFEModel':
        ...
        if _995.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_995.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_996.ConicalSetFEModel':
        ...
        if _996.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_996.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_657.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_657.GearDesign))
        return value
