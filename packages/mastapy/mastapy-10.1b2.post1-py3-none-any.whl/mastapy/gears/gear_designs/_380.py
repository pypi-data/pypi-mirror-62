...
from mastapy.gears.fe_model import _1081
from mastapy.gears.fe_model.cylindrical import _1082
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1083
...
class GearSetDesign(_943.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_718.SMTBitmap':
        ...
        return constructor.new(_718.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def transmission_properties_gears(self) -> '_301.GearSetDesignGroup':
        ...
        return constructor.new(_301.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_1081.GearSetFEModel':
        ...
        return constructor.new(_1081.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1082.CylindricalGearSetFEModel':
        ...
        return constructor.new(_1082.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1083.ConicalSetFEModel':
        ...
        return constructor.new(_1083.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_655.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_655.GearDesign))
        return value
