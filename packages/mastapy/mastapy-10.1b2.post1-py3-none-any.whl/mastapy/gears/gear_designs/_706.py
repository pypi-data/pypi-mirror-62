...
from mastapy.gears.fe_model import _925
from mastapy.gears.fe_model.cylindrical import _928
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _931
from mastapy.gears.gear_designs import _703, _704
...
class GearSetDesign(_704.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def transmission_properties_gears(self) -> '_131.GearSetDesignGroup':
        ...
        return constructor.new(_131.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_925.GearSetFEModel':
        ...
        return constructor.new(_925.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_928.CylindricalGearSetFEModel':
        ...
        if _928.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_928.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_931.ConicalSetFEModel':
        ...
        if _931.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_931.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_703.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_703.GearDesign))
        return value
