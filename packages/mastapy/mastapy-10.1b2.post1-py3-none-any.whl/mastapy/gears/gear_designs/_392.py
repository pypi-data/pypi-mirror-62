...
from mastapy.gears.fe_model import _1088
from mastapy.gears.fe_model.cylindrical import _1089
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1090
...
class GearSetDesign(_950.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_744.SMTBitmap':
        ...
        return constructor.new(_744.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    @property
    def transmission_properties_gears(self) -> '_303.GearSetDesignGroup':
        ...
        return constructor.new(_303.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_1088.GearSetFEModel':
        ...
        return constructor.new(_1088.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1089.CylindricalGearSetFEModel':
        ...
        if _1089.CylindricalGearSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1089.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1090.ConicalSetFEModel':
        ...
        if _1090.ConicalSetFEModel.TYPE not in self.wrapped.LTCAFEModel.__class__.__mro__:
        ...
        return constructor.new(_1090.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_636.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_636.GearDesign))
        return value
