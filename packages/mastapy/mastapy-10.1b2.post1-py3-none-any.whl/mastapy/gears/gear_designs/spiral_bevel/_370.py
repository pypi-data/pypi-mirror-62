...
from mastapy.gears.gear_designs.spiral_bevel import _460, _457
...
class SpiralBevelGearSetDesign(_380.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_460.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_460.SpiralBevelGearDesign))
        return value
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_457.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_457.SpiralBevelGearMeshDesign))
        return value
