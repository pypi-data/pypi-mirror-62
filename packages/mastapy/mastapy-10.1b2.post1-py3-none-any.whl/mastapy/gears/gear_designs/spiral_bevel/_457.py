...
from mastapy.gears.gear_designs.spiral_bevel import _370, _460, _961
...
class SpiralBevelGearMeshDesign(_880.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_gear_set(self) -> '_370.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_370.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet else None

    @property
    def spiral_bevel_gears(self) -> 'List[_460.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_460.SpiralBevelGearDesign))
        return value
