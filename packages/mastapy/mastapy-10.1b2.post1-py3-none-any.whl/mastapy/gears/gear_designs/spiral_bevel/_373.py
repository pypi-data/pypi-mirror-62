...
from mastapy.gears.gear_designs.spiral_bevel import _466, _449
...
class SpiralBevelGearSetDesign(_1009.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_466.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_466.SpiralBevelGearDesign))
        return value
