...
from mastapy.gears.gear_designs.spiral_bevel import _725, _726
...
class SpiralBevelGearSetDesign(_907.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_725.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_725.SpiralBevelGearDesign))
        return value
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_726.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_726.SpiralBevelGearMeshDesign))
        return value
