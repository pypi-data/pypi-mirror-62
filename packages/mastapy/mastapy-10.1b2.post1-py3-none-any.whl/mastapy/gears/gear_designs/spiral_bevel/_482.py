...
from mastapy.gears.gear_designs.spiral_bevel import _396, _501, _956
...
class SpiralBevelGearMeshDesign(_966.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_956.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_956.SpiralBevelMeshedGearDesign))
        return value
