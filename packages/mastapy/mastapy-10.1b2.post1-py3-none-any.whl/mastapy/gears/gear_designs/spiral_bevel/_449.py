...
from mastapy.gears.gear_designs.spiral_bevel import _373, _466, _952
...
class SpiralBevelGearMeshDesign(_966.BevelGearMeshDesign):
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_466.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_466.SpiralBevelGearDesign))
        return value
