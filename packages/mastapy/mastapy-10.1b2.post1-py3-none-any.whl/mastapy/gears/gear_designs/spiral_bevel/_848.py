...
from mastapy.gears.gear_designs.spiral_bevel import _849, _847, _850
...
class SpiralBevelGearMeshDesign(_1027.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_850.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_850.SpiralBevelMeshedGearDesign))
        return value
