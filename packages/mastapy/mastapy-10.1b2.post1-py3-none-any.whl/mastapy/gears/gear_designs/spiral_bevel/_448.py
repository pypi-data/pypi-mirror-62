...
from mastapy.gears.gear_designs.spiral_bevel import _359, _463, _961
...
class SpiralBevelGearMeshDesign(_933.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_463.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_463.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_961.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_961.SpiralBevelMeshedGearDesign))
        return value
