...
class AGMAGleasonConicalGearDesign(_612.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_1098.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_1098.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_1098.FrontEndTypes'):
    ...
    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1097.DummyConicalGearCutter':
        ...
        if _1097.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_1097.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def bevel_gear_material(self) -> '_604.GearMaterial':
        ...
        return constructor.new(_604.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_594.AGMACylindricalGearMaterial':
        ...
        if _594.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_594.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_595.BevelGearISOMaterial':
        ...
        if _595.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_595.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_597.BevelGearMaterial':
        ...
        if _597.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_597.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_602.CylindricalGearMaterial':
        ...
        if _602.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_602.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_605.ISOCylindricalGearMaterial':
        ...
        if _605.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_605.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
