...
class AGMAGleasonConicalGearDesign(_643.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def cutter(self) -> '_902.ConicalGearCutter':
        ...
        return constructor.new(_902.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_852.PinionFinishCutter':
        ...
        if _852.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_852.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_853.PinionRoughCutter':
        ...
        if _853.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_853.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_842.WheelFinishCutter':
        ...
        if _842.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_842.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_841.WheelRoughCutter':
        ...
        if _841.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new(_841.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1094.DummyConicalGearCutter':
        ...
        return constructor.new(_1094.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def bevel_gear_material(self) -> '_599.GearMaterial':
        ...
        return constructor.new(_599.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_590.AGMACylindricalGearMaterial':
        ...
        if _590.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_590.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_591.BevelGearISOMaterial':
        ...
        if _591.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_591.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_593.BevelGearMaterial':
        ...
        if _593.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_593.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_597.CylindricalGearMaterial':
        ...
        if _597.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_597.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_600.ISOCylindricalGearMaterial':
        ...
        if _600.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_600.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_606.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _606.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_606.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_608.PlasticCylindricalGearMaterial':
        ...
        if _608.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_608.PlasticCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
