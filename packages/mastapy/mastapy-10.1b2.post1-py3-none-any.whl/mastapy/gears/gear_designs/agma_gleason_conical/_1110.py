...
from mastapy.gears import _318, _316
from mastapy.gears.gear_designs.conical import _1090, _847
...
class AGMAGleasonConicalGearSetDesign(_847.ConicalGearSetDesign):
    ...
    @property
    def tooth_taper(self) -> '_318.SpiralBevelToothTaper':
        ...
        return constructor.new(_318.SpiralBevelToothTaper)(value) if value else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_318.SpiralBevelToothTaper'):
    ...
    @property
    def reliability_requirement_agma(self) -> '_316.SafetyRequirementsAGMA':
        ...
        return constructor.new(_316.SafetyRequirementsAGMA)(value) if value else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_316.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_1109.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1109.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_1109.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1109.AGMAGleasonConicalGearMeshDesign))
        return value
