...
class AGMAGleasonConicalGearDesign(_1084.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_844.PinionFinishCutter':
        ...
        return constructor.new(_844.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_845.PinionRoughCutter':
        ...
        return constructor.new(_845.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_830.WheelFinishCutter':
        ...
        return constructor.new(_830.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_829.WheelRoughCutter':
        ...
        return constructor.new(_829.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_587.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_587.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_588.BevelGearISOMaterial':
        ...
        return constructor.new(_588.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
