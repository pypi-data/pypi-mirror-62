...
from mastapy.gears import _151, _148
from mastapy.gears.gear_designs.conical import _890, _881
from mastapy.gleason_smt_link import _110
...
class AGMAGleasonConicalGearSetDesign(_881.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def tooth_taper(self) -> '_151.SpiralBevelToothTaper':
        ...
        return constructor.new(_151.SpiralBevelToothTaper)(value) if value else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_151.SpiralBevelToothTaper'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothTaper = value

    @property
    def reliability_requirement_gleason(self) -> '_890.GleasonSafetyRequirements':
        ...
        return constructor.new(_890.GleasonSafetyRequirements)(value) if value else None

    @reliability_requirement_gleason.setter
    def reliability_requirement_gleason(self, value: '_890.GleasonSafetyRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ReliabilityRequirementGleason = value

    @property
    def reliability_requirement_agma(self) -> '_148.SafetyRequirementsAGMA':
        ...
        return constructor.new(_148.SafetyRequirementsAGMA)(value) if value else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_148.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def manufacturing_method(self) -> '_110.CutterMethod':
        ...
        return constructor.new(_110.CutterMethod)(value) if value else None

    @manufacturing_method.setter
    def manufacturing_method(self, value: '_110.CutterMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_919.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_919.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_919.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_919.AGMAGleasonConicalGearMeshDesign))
        return value
