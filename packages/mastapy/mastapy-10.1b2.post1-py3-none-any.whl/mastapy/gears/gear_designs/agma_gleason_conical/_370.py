...
from mastapy.gears.gear_designs.conical import _1098, _367
from mastapy.gleason_smt_link import _283
from mastapy.gears.gear_designs.agma_gleason_conical import _934
...
class AGMAGleasonConicalGearSetDesign(_367.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_934.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_934.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_934.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_934.AGMAGleasonConicalGearMeshDesign))
        return value
