...
from mastapy.gears import _320, _318
from mastapy.gears.gear_designs.conical import _1096, _404
from mastapy.gleason_smt_link import _281
from mastapy.gears.gear_designs.agma_gleason_conical import _967
...
class AGMAGleasonConicalGearSetDesign(_404.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def tooth_taper(self) -> '_320.SpiralBevelToothTaper':
        ...
        return constructor.new(_320.SpiralBevelToothTaper)(value) if value else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_320.SpiralBevelToothTaper'):
    ...
    @property
    def reliability_requirement_agma(self) -> '_318.SafetyRequirementsAGMA':
        ...
        return constructor.new(_318.SafetyRequirementsAGMA)(value) if value else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_318.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def manufacturing_method(self) -> '_281.CutterMethod':
        ...
        return constructor.new(_281.CutterMethod)(value) if value else None

    @manufacturing_method.setter
    def manufacturing_method(self, value: '_281.CutterMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_967.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_967.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_967.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_967.AGMAGleasonConicalGearMeshDesign))
        return value
