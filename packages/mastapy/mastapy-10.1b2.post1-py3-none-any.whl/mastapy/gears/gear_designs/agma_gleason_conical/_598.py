...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1055, _1059, _1064
...
class AGMAGleasonConicalGearDesign(_596.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def cutter(self) -> '_870.ConicalGearCutter':
        ...
        return constructor.new(_870.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_845.PinionFinishCutter':
        ...
        if _845.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_845.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_846.PinionRoughCutter':
        ...
        if _846.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_846.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_847.WheelFinishCutter':
        ...
        if _847.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_847.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_848.WheelRoughCutter':
        ...
        if _848.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new(_848.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_1055.AGMA20151AccuracyGrades':
        ...
        if _1055.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_1059.CylindricalAccuracyGrades':
        ...
        if _1059.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_1059.CylindricalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_1064.ISO1328AccuracyGrades':
        ...
        if _1064.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_1064.ISO1328AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1085.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1085.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_1085.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def bevel_gear_material(self) -> '_614.GearMaterial':
        ...
        return constructor.new(_614.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_605.AGMACylindricalGearMaterial':
        ...
        if _605.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_605.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_606.BevelGearISOMaterial':
        ...
        if _606.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_606.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_608.BevelGearMaterial':
        ...
        if _608.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_608.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_612.CylindricalGearMaterial':
        ...
        if _612.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_612.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_615.ISOCylindricalGearMaterial':
        ...
        if _615.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_615.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_619.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _619.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_619.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_621.PlasticCylindricalGearMaterial':
        ...
        if _621.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_621.PlasticCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
