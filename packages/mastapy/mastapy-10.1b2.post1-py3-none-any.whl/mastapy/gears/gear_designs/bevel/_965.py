...
class BevelGearSetDesign(_1105.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1069.BacklashDistributionRule':
        ...
        return constructor.new(_1069.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1069.BacklashDistributionRule'):
