...
from mastapy.gears.gear_designs.agma_gleason_conical import _647
...
class BevelGearDesign(_647.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1108.FinishingMethods':
        ...
        return constructor.new(_1108.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1108.FinishingMethods'):
