...
class BevelGearSetDesign(_407.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_319.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_319.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_319.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
