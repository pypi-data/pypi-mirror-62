...
from mastapy.gears.gear_designs.bevel import _1102
...
class BevelGearDesign(_1108.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1102.FinishingMethods':
        ...
        return constructor.new(_1102.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1102.FinishingMethods'):
