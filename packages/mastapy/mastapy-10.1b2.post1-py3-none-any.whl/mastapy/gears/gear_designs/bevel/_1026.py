...
from mastapy.gears.gear_designs.bevel import _1032
...
class BevelGearDesign(_1039.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1032.FinishingMethods':
        ...
        return constructor.new(_1032.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1032.FinishingMethods'):
