...
from mastapy.gears.gear_designs.agma_gleason_conical import _1089
...
class BevelGearDesign(_1089.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1105.FinishingMethods':
        ...
        return constructor.new(_1105.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1105.FinishingMethods'):
