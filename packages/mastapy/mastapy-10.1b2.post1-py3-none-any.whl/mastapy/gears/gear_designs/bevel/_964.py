...
from mastapy.gears.gear_designs.bevel import _1106, _1107, _1105
...
class BevelGearSetDesign(_1110.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1078.BacklashDistributionRule':
        ...
        return constructor.new(_1078.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1078.BacklashDistributionRule'):
    ...
    @property
    def round_cutter_specifications(self) -> '_1107.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1107.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1107.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_317.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_317.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_317.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1105.ToothProportionsInputMethod':
        ...
        return constructor.new(_1105.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1105.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
