...
from mastapy.gears.gear_designs.bevel import _1109, _1110, _1108
from mastapy.gears import _323
from mastapy.gears.gear_designs.agma_gleason_conical import _1111
...
class BevelGearSetDesign(_1111.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def round_cutter_specifications(self) -> '_1110.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1110.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1110.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_323.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_323.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_323.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1108.ToothProportionsInputMethod':
        ...
        return constructor.new(_1108.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1108.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
