...
from mastapy.gears.gear_designs.agma_gleason_conical import _380
...
class BevelGearSetDesign(_380.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_324.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_324.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_324.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
