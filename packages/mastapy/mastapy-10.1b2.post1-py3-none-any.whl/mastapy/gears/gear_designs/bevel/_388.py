...
from mastapy.gears.gear_designs.bevel import _1111, _1112, _1110
...
class BevelGearSetDesign(_389.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1085.BacklashDistributionRule':
        ...
        return constructor.new(_1085.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1085.BacklashDistributionRule'):
    ...
    @property
    def round_cutter_specifications(self) -> '_1112.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1112.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1112.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_328.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_328.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_328.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1110.ToothProportionsInputMethod':
        ...
        return constructor.new(_1110.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1110.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
