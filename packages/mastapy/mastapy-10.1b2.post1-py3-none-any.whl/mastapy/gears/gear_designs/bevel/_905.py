...
from mastapy.gears.gear_designs.bevel import _911
...
class BevelGearDesign(_918.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_911.FinishingMethods':
        ...
        return constructor.new(_911.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_911.FinishingMethods'):
