...
from mastapy.gears.gear_designs.bevel import _1110, _1111, _1109
from mastapy.gears import _321
from mastapy.gears.gear_designs.agma_gleason_conical import _1113
...
class BevelGearSetDesign(_1113.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1066.BacklashDistributionRule':
        ...
        return constructor.new(_1066.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1066.BacklashDistributionRule'):
    ...
    @property
    def round_cutter_specifications(self) -> '_1111.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1111.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1111.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1109.ToothProportionsInputMethod':
        ...
        return constructor.new(_1109.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1109.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
