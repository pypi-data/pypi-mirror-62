...
class BevelGearSetDesign(_1109.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def backlash_distribution_rule(self) -> '_1063.BacklashDistributionRule':
        ...
        return constructor.new(_1063.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1063.BacklashDistributionRule'):
