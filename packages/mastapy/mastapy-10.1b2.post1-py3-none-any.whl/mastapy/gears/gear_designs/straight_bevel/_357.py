...
from mastapy.gears.gear_designs.straight_bevel import _442, _425
...
class StraightBevelGearSetDesign(_1012.BevelGearSetDesign):
    '''StraightBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_442.StraightBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_442.StraightBevelGearDesign))
        return value
