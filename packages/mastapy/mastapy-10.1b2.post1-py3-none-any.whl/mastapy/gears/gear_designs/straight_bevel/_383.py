...
from mastapy.gears.gear_designs.straight_bevel import _445, _443
...
class StraightBevelGearSetDesign(_964.BevelGearSetDesign):
    '''StraightBevelGearSetDesign
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_443.StraightBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_443.StraightBevelGearMeshDesign))
        return value
