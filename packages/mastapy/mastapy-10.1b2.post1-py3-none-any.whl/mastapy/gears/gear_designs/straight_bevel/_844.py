...
from mastapy.gears.gear_designs.straight_bevel import _845, _843, _846
...
class StraightBevelGearMeshDesign(_1027.BevelGearMeshDesign):
    '''StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_846.StraightBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshedGears, constructor.new(_846.StraightBevelMeshedGearDesign))
        return value
