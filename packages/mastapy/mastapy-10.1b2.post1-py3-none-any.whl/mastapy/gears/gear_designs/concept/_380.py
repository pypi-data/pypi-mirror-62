...
from mastapy.gears.gear_designs.concept import _581, _578
...
class ConceptGearSetDesign(_368.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_581.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_581.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_581.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_581.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_578.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_578.ConceptGearMeshDesign))
        return value
