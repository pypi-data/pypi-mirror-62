...
from mastapy.gears.gear_designs.concept import _1022, _1023
...
class ConceptGearSetDesign(_829.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1022.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1022.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_1022.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1022.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_1023.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1023.ConceptGearMeshDesign))
        return value
