...
from mastapy.gears.gear_designs.concept import _391, _583
...
class ConceptGearMeshDesign(_944.GearMeshDesign):
    '''ConceptGearMeshDesign
    ...
    @property
    def concept_gear_set(self) -> '_391.ConceptGearSetDesign':
        ...
        return constructor.new(_391.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
