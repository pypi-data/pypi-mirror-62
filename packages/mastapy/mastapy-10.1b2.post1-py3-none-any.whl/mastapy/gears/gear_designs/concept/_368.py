...
from mastapy.gears.gear_designs.concept import _585, _568
...
class ConceptGearSetDesign(_354.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_585.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_585.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_585.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_585.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_568.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_568.ConceptGearMeshDesign))
        return value
