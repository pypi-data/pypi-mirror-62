...
from mastapy.gears.gear_designs.concept import _587, _582
...
class ConceptGearSetDesign(_364.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_587.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_587.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_587.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_587.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_582.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_582.ConceptGearMeshDesign))
        return value
