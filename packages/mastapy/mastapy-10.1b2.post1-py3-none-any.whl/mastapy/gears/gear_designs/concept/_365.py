...
from mastapy.gears.gear_designs.concept import _579, _575
...
class ConceptGearSetDesign(_353.GearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_579.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_579.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_579.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_579.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_575.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_575.ConceptGearMeshDesign))
        return value
