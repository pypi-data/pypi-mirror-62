...
from mastapy.gears.gear_designs.concept import _612, _609
...
class ConceptGearSetDesign(_356.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_612.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_612.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_612.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_612.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_609.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_609.ConceptGearMeshDesign))
        return value
