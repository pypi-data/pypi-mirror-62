...
from mastapy.gears.gear_designs.concept import _618, _601
...
class ConceptGearSetDesign(_392.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_618.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_618.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_618.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_618.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_601.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_601.ConceptGearMeshDesign))
        return value
