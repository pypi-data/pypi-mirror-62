...
from mastapy.gears.gear_designs.concept import _368, _585
...
class ConceptGearMeshDesign(_955.GearMeshDesign):
    ...
    @property
    def concept_gear_set(self) -> '_368.ConceptGearSetDesign':
        ...
        return constructor.new(_368.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
