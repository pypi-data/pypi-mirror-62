...
from mastapy.gears.gear_designs.concept import _583, _580
...
class ConceptGearSetDesign(_380.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_583.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_583.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_583.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_583.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_580.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_580.ConceptGearMeshDesign))
        return value
