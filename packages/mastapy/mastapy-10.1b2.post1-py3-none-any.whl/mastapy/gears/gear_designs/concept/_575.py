...
from mastapy.gears.gear_designs.concept import _365, _579
...
class ConceptGearMeshDesign(_946.GearMeshDesign):
    ...
    @property
    def concept_gear_set(self) -> '_365.ConceptGearSetDesign':
        ...
        return constructor.new(_365.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
