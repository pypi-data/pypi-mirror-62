...
from mastapy.gears.gear_designs.concept import _901, _902
...
class ConceptGearSetDesign(_706.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_901.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_901.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_901.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_901.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_902.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_902.ConceptGearMeshDesign))
        return value
