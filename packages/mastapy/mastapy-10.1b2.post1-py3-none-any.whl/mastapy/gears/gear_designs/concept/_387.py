...
from mastapy.gears.gear_designs.concept import _636, _634
...
class ConceptGearSetDesign(_373.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_636.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_636.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_636.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_636.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_634.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_634.ConceptGearMeshDesign))
        return value
