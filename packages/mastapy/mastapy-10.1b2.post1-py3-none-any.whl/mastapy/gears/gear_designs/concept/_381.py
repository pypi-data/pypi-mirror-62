...
from mastapy.gears.gear_designs.concept import _581, _577
...
class ConceptGearSetDesign(_369.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def concept_meshes(self) -> 'List[_577.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_577.ConceptGearMeshDesign))
        return value
