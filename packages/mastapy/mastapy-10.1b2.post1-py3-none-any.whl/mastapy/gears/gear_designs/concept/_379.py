...
from mastapy.gears.gear_designs.concept import _582, _581
...
class ConceptGearSetDesign(_365.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_582.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_582.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_582.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_582.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_581.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_581.ConceptGearMeshDesign))
        return value
