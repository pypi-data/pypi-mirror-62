...
from mastapy.gears.gear_designs.concept import _903, _901
...
class ConceptGearMeshDesign(_705.GearMeshDesign):
    '''ConceptGearMeshDesign
    ...
    @property
    def concept_gear_set(self) -> '_903.ConceptGearSetDesign':
        ...
        return constructor.new(_903.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
