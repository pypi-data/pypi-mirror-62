...
class WormDesign(_450.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_326.WormAddendumFactor':
        ...
        return constructor.new(_326.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_326.WormAddendumFactor'):
