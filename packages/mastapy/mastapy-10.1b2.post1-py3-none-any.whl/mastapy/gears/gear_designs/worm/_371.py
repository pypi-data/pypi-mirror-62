...
from mastapy.gears.gear_designs.worm import _471, _454
...
class WormGearSetDesign(_369.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_471.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_471.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_471.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_471.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_454.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_454.WormGearMeshDesign))
        return value
