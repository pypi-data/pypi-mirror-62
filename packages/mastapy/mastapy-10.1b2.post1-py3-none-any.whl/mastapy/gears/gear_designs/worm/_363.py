...
from mastapy.gears.gear_designs.worm import _456, _452
...
class WormGearSetDesign(_392.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def worm_type(self) -> '_328.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_328.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_328.WormType'):
    ...
    @property
    def gears(self) -> 'List[_456.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_456.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_456.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_456.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_452.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_452.WormGearMeshDesign))
        return value
