...
class WormGearMeshDesign(_945.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_385.WormGearSetDesign':
        ...
        return constructor.new(_385.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_631.WormDesign':
        ...
        return constructor.new(_631.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_632.WormWheelDesign':
        ...
        return constructor.new(_632.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
