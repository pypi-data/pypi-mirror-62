...
from mastapy.gears.gear_designs.worm import _835, _836
...
class WormGearSetDesign(_829.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_835.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_835.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_835.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_835.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_836.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_836.WormGearMeshDesign))
        return value
