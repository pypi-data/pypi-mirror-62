...
class WormGearMeshDesign(_957.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_658.WormDesign':
        ...
        return constructor.new(_658.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_659.WormWheelDesign':
        ...
        return constructor.new(_659.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
