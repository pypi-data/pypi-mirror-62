...
from mastapy.gears.gear_designs.worm import _713, _714
...
class WormGearSetDesign(_706.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_713.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_713.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_713.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_713.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_714.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_714.WormGearMeshDesign))
        return value
