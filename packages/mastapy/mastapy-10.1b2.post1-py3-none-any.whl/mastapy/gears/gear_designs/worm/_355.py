...
from mastapy.gears.gear_designs.worm import _426, _418
...
class WormGearSetDesign(_353.GearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_426.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_426.WormGearDesign))
        return value
