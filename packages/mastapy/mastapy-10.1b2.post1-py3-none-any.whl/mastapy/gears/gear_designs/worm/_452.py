...
class WormGearMeshDesign(_951.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_637.WormDesign':
        ...
        return constructor.new(_637.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_638.WormWheelDesign':
        ...
        return constructor.new(_638.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
