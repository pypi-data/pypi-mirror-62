...
class WormDesign(_459.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_327.WormAddendumFactor':
        ...
        return constructor.new(_327.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_327.WormAddendumFactor'):
