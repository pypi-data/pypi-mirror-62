...
class WormDesign(_456.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_323.WormAddendumFactor':
        ...
        return constructor.new(_323.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_323.WormAddendumFactor'):
