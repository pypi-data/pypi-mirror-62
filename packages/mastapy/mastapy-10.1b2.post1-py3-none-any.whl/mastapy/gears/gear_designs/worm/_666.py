...
class WormDesign(_477.WormGearDesign):
    ...
    @property
    def addendum_factor(self) -> '_320.WormAddendumFactor':
        ...
        return constructor.new(_320.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_320.WormAddendumFactor'):
