...
class WormGearMeshDesign(_828.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_834.WormDesign':
        ...
        return constructor.new(_834.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_838.WormWheelDesign':
        ...
        return constructor.new(_838.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
