...
class WormGearMeshDesign(_944.GearMeshDesign):
    ...
    @property
    def worm_gear_set(self) -> '_379.WormGearSetDesign':
        ...
        return constructor.new(_379.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_666.WormDesign':
        ...
        return constructor.new(_666.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_667.WormWheelDesign':
        ...
        return constructor.new(_667.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
