...
from mastapy.gears.gear_designs.worm import _477
...
class WormDesign(_477.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_328.WormAddendumFactor':
        ...
        return constructor.new(_328.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_328.WormAddendumFactor'):
