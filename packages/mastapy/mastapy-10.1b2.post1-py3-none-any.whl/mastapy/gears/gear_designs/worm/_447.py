...
class WormGearMeshDesign(_946.GearMeshDesign):
    ...
    @property
    def worm_gear_set(self) -> '_370.WormGearSetDesign':
        ...
        return constructor.new(_370.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_599.WormDesign':
        ...
        return constructor.new(_599.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_600.WormWheelDesign':
        ...
        return constructor.new(_600.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
