...
from mastapy.gears.gear_designs.worm import _477, _463
...
class WormGearSetDesign(_365.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_477.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_477.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_477.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_477.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_463.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_463.WormGearMeshDesign))
        return value
