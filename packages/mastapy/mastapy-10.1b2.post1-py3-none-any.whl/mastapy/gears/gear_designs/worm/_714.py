...
class WormGearMeshDesign(_705.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_715.WormGearSetDesign':
        ...
        return constructor.new(_715.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_712.WormDesign':
        ...
        return constructor.new(_712.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_716.WormWheelDesign':
        ...
        return constructor.new(_716.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
