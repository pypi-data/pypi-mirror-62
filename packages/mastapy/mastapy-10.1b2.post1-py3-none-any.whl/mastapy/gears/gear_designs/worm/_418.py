...
class WormGearMeshDesign(_946.GearMeshDesign):
    ...
    def worm(self) -> '_646.WormDesign':
        ...
        return constructor.new(_646.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_647.WormWheelDesign':
        ...
        return constructor.new(_647.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None

    @property
    def worm_gears(self) -> 'List[_426.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_426.WormGearDesign))
        return value
