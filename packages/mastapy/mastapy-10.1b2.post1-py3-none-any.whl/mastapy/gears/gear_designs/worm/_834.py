...
class WormDesign(_835.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_279.WormAddendumFactor':
        ...
        return constructor.new(_279.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_279.WormAddendumFactor'):
