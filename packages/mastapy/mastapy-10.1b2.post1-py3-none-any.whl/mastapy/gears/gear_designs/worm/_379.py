...
from mastapy.gears.gear_designs.worm import _477, _471
...
class WormGearSetDesign(_380.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def worm_meshes(self) -> 'List[_471.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_471.WormGearMeshDesign))
        return value
