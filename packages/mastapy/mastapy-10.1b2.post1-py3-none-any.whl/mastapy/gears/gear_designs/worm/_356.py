...
from mastapy.gears.gear_designs.worm import _470, _466
...
class WormGearSetDesign(_354.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_470.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_470.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_466.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_466.WormGearMeshDesign))
        return value
