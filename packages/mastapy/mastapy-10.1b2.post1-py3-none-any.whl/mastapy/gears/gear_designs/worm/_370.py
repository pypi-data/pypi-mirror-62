...
from mastapy.gears.gear_designs.worm import _450, _447
...
class WormGearSetDesign(_368.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_450.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_450.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_450.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_450.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_447.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_447.WormGearMeshDesign))
        return value
