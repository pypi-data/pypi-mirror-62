...
class WormGearMeshDesign(_955.GearMeshDesign):
    ...
    def worm(self) -> '_589.WormDesign':
        ...
        return constructor.new(_589.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_590.WormWheelDesign':
        ...
        return constructor.new(_590.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
