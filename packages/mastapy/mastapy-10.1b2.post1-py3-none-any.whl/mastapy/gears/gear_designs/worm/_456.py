...
class WormGearMeshDesign(_956.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_366.WormGearSetDesign':
        ...
        return constructor.new(_366.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_606.WormDesign':
        ...
        return constructor.new(_606.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_607.WormWheelDesign':
        ...
        return constructor.new(_607.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
