...
class WormDesign(_473.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_331.WormAddendumFactor':
        ...
        return constructor.new(_331.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_331.WormAddendumFactor'):
