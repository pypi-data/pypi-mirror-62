...
from mastapy.gears.gear_designs.worm import _459, _456
...
class WormGearSetDesign(_364.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_459.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_459.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_459.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_459.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_456.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_456.WormGearMeshDesign))
        return value
