...
from mastapy.gears.rating.cylindrical import _402, _388
from mastapy.gears.gear_designs.cylindrical import _943, _892
from mastapy.materials import _217, _206
...
class GearSetDesignGroup(_1.APIBase):
    ...
    def micro_geometry_model_in_system_deflection(self) -> 'enum_with_selected_value.EnumWithSelectedValue_MicroGeometryModel':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_MicroGeometryModel.implicit_type()
    ...
    def micro_geometry_model_in_system_deflection(self, value: 'enum_with_selected_value.EnumWithSelectedValue_MicroGeometryModel.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_MicroGeometryModel.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
        self.wrapped.MicroGeometryModelInSystemDeflection = value

    @property
    def misalignment_contact_pattern_enhancement(self) -> '_402.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_402.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_402.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_943.TolerancedMetalMeasurements':
        ...
        return constructor.new(_943.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_943.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_206.GeneralTransmissionProperties':
        ...
        return constructor.new(_206.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_388.CylindricalGearRatingSettings':
        ...
        return constructor.new(_388.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None

    @property
    def cylindrical_gear_design_constraint_settings(self) -> '_892.CylindricalGearDesignConstraintSettings':
        ...
        return constructor.new(_892.CylindricalGearDesignConstraintSettings)(self.wrapped.CylindricalGearDesignConstraintSettings) if self.wrapped.CylindricalGearDesignConstraintSettings else None
