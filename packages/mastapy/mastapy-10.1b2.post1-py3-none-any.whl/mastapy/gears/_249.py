...
from mastapy.gears.materials import _511
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.hypoid import _370
from mastapy.gears.rating.iso_10300 import _357, _349, _364
...
class BevelHypoidGearRatingSettings(_1248.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_511.RatingMethods':
        ...
        return constructor.new(_511.RatingMethods)(value) if value else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_511.RatingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelGearRatingMethod = value

    @property
    def hypoid_gear_rating_method(self) -> '_370.HypoidRatingMethod':
        ...
        return constructor.new(_370.HypoidRatingMethod)(value) if value else None

    @hypoid_gear_rating_method.setter
    def hypoid_gear_rating_method(self, value: '_370.HypoidRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso_rating_method_for_bevel_gears(self) -> '_357.ISO10300RatingMethod':
        ...
        return constructor.new(_357.ISO10300RatingMethod)(value) if value else None

    @iso_rating_method_for_bevel_gears.setter
    def iso_rating_method_for_bevel_gears(self, value: '_357.ISO10300RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ISORatingMethodForBevelGears = value

    @property
    def iso_rating_method_for_hypoid_gears(self) -> '_357.ISO10300RatingMethod':
    ...
    def iso_rating_method_for_hypoid_gears(self, value: '_357.ISO10300RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ISORatingMethodForHypoidGears = value

    @property
    def bevel_general_load_factors_k_method(self) -> '_349.GeneralLoadFactorCalculationMethod':
        ...
        return constructor.new(_349.GeneralLoadFactorCalculationMethod)(value) if value else None

    @bevel_general_load_factors_k_method.setter
    def bevel_general_load_factors_k_method(self, value: '_349.GeneralLoadFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelGeneralLoadFactorsKMethod = value

    @property
    def hypoid_general_load_factors_k_method(self) -> '_349.GeneralLoadFactorCalculationMethod':
    ...
    def hypoid_general_load_factors_k_method(self, value: '_349.GeneralLoadFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HypoidGeneralLoadFactorsKMethod = value

    @property
    def bevel_pitting_factor_calculation_method(self) -> '_364.PittingFactorCalculationMethod':
        ...
        return constructor.new(_364.PittingFactorCalculationMethod)(value) if value else None

    @bevel_pitting_factor_calculation_method.setter
    def bevel_pitting_factor_calculation_method(self, value: '_364.PittingFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelPittingFactorCalculationMethod = value

    @property
    def hypoid_pitting_factor_calculation_method(self) -> '_364.PittingFactorCalculationMethod':
    ...
    def hypoid_pitting_factor_calculation_method(self, value: '_364.PittingFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
