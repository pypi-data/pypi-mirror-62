...
from mastapy.gears.analysis import _742
...
class GearFEModel(_742.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1114.GearMeshingElementOptions':
        ...
        return constructor.new(_1114.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_321.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_299.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_299.GearFlanks', progress: '_321.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
