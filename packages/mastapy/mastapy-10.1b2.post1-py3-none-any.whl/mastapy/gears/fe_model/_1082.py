...
from mastapy.gears.analysis import _733
...
class GearSetFEModel(_733.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_342.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
