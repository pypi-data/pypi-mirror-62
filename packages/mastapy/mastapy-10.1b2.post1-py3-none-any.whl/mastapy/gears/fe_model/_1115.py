...
class GearFEModel(_757.GearImplementationDetail):
    '''GearFEModel
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_301.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_301.GearFlanks', progress: '_320.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
