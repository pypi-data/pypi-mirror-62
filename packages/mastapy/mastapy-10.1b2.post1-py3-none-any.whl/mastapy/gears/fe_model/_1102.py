...
class GearSetFEModel(_753.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_334.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
