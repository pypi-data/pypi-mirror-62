...
from mastapy.gears.fe_model import _924
...
class GearFEModel(_943.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_924.GearMeshingElementOptions':
        ...
        return constructor.new(_924.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_129.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_129.GearFlanks', progress: '_6479.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
