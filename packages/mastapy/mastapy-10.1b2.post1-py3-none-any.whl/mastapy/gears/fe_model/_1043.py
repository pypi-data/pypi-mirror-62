...
from mastapy.gears.fe_model import _1045
...
class GearFEModel(_1064.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1045.GearMeshingElementOptions':
        ...
        return constructor.new(_1045.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_258.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_258.GearFlanks', progress: '_6318.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6318.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
