...
class GearFEModel(_741.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1116.GearMeshingElementOptions':
        ...
        return constructor.new(_1116.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_306.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_306.GearFlanks', progress: '_323.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_323.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
