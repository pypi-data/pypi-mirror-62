...
class CylindricalGearSetFEModel(_1102.GearSetFEModel):
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_980.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_980.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
