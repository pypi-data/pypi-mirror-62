...
class CylindricalGearSetFEModel(_1088.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_987.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_987.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
