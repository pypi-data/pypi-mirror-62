...
from mastapy.gears.ltca import _107
...
class CylindricalGearMeshFEModel(_1116.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for(self, gear: '_1115.GearFEModel', flank: '_301.GearFlanks') -> 'List[_107.GearContactStiffness]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor(gear.wrapped if gear else None, flank), constructor.new(_107.GearContactStiffness))

    def stiffness_wrt_contacts_for_with_progress(self, gear: '_1115.GearFEModel', flank: '_301.GearFlanks', progress: '_320.TaskProgress') -> 'List[_107.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
        ...
        flank = conversion.mp_to_pn_enum(flank)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor(gear.wrapped if gear else None, flank, progress.wrapped if progress else None), constructor.new(_107.GearContactStiffness))
