...
class CylindricalGearSetFEModel(_1085.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_990.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_990.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
