...
class CylindricalGearSetFEModel(_1090.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_986.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_986.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
