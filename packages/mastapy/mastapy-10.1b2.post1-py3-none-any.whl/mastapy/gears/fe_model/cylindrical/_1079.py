...
class CylindricalGearSetFEModel(_1078.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    def manufacturing_configuration_selection(self) -> '_982.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_982.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
