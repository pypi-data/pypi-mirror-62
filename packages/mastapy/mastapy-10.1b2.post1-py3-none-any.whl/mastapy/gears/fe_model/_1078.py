...
from mastapy.gears.fe_model import _1114, _1113
...
class GearSetFEModel(_735.GearSetImplementationDetail):
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1114.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1114.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1113.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1113.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_318.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
