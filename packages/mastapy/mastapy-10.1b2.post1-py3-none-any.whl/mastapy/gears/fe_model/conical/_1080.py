...
class ConicalSetFEModel(_1078.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1120.FlankDataSource':
        ...
        return constructor.new(_1120.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1120.FlankDataSource'):
