...
from mastapy.gears.fe_model.conical import _932
...
class ConicalSetFEModel(_925.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_932.FlankDataSource':
        ...
        return constructor.new(_932.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_932.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
