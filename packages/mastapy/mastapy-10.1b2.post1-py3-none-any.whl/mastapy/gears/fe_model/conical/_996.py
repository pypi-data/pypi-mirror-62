...
from mastapy.gears.fe_model.conical import _1121
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import list_with_selected_item
from mastapy.gears.manufacturing.bevel import _824
...
class ConicalSetFEModel(_994.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1121.FlankDataSource':
        ...
        return constructor.new(_1121.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1121.FlankDataSource'):
