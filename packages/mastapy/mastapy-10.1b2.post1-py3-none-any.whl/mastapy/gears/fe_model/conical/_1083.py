...
class ConicalSetFEModel(_1081.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1119.FlankDataSource':
        ...
        return constructor.new(_1119.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1119.FlankDataSource'):
