...
from mastapy.nodal_analysis import _1347
from mastapy.gears.fe_model import _923, _922
...
class GearSetFEModel(_953.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def element_order(self) -> '_1347.ElementOrder':
        '''ElementOrder: 'ElementOrder' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ElementOrder)
        return constructor.new(_1347.ElementOrder)(value) if value else None

    @element_order.setter
    def element_order(self, value: '_1347.ElementOrder'):
    ...
    @property
    def mesh_fe_models(self) -> 'List[_923.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_923.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_922.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_922.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6479.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
