...
from mastapy.gears.fe_model import _1115, _1114
...
class GearSetFEModel(_742.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1115.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1115.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1114.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1114.GearFEModel))
        return value
