...
from mastapy.gears.fe_model import _1044, _1043
...
class GearSetFEModel(_1074.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1044.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1044.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1043.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1043.GearFEModel))
        return value
