...
from mastapy.gears.fe_model import _1113, _1112
from mastapy import _321
from mastapy.gears.analysis import _719
...
class GearSetFEModel(_719.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1113.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1113.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1112.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1112.GearFEModel))
        return value
