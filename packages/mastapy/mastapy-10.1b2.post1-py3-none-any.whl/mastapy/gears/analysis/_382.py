...
from mastapy.utility.model_validation import _1389
...
class AbstractGearSetAnalysis(_1.APIBase):
    ...
    def status(self) -> '_1389.Status':
        ...
        return constructor.new(_1389.Status)(self.wrapped.Status) if self.wrapped.Status else None
