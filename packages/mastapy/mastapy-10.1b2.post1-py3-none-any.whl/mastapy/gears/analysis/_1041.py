...
from mastapy.gears.analysis import _1043, _350
...
class GearMeshDesignAnalysis(_350.AbstractGearMeshAnalysis):
    '''GearMeshDesignAnalysis
    ...
    @property
    def gear_a(self) -> '_1043.GearDesignAnalysis':
        ...
        return constructor.new(_1043.GearDesignAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_b(self) -> '_1043.GearDesignAnalysis':
        ...
        return constructor.new(_1043.GearDesignAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None
