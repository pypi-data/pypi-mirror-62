...
class GearSetGroupDutyCycle(_1.APIBase):
    ...
    @property
    def loaded_rating_duty_cycles(self) -> 'List[_291.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedRatingDutyCycles, constructor.new(_291.GearSetDutyCycleRating))
        return value

    @property
    def rating_duty_cycles(self) -> 'List[_291.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RatingDutyCycles, constructor.new(_291.GearSetDutyCycleRating))
        return value
