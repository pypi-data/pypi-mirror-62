...
class SpiralBevelGearSetParetoOptimiser(_928.GearSetParetoOptimiser):
    '''SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_370.SpiralBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_370.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_370.SpiralBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_370.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_370.SpiralBevelGearSetDesign))
        return value
