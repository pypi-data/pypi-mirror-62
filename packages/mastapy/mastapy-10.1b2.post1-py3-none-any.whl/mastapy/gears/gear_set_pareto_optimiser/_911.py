...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _395
from mastapy.gears.rating.klingelnberg_hypoid import _396
from mastapy.gears.rating.hypoid import _397
from mastapy.gears.rating.face import _398, _399
from mastapy.gears.rating.cylindrical import _400, _401
from mastapy.gears.rating.conical import _402
from mastapy.gears.rating.concept import _403, _404
...
class GearSetOptimiserCandidate(_907.DesignSpaceSearchCandidateBase['_331.AbstractGearSetRating', 'GearSetOptimiserCandidate']):
    '''GearSetOptimiserCandidate
    ...
    @property
    def candidate(self) -> '_331.AbstractGearSetRating':
        ...
        return constructor.new(_331.AbstractGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_zerol_bevel_gear_set_rating(self) -> '_347.ZerolBevelGearSetRating':
        ...
        return constructor.new(_347.ZerolBevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_worm_gear_set_duty_cycle_rating(self) -> '_352.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_352.WormGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_worm_gear_set_rating(self) -> '_353.WormGearSetRating':
        ...
        return constructor.new(_353.WormGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_straight_bevel_diff_gear_set_rating(self) -> '_392.StraightBevelDiffGearSetRating':
        ...
        return constructor.new(_392.StraightBevelDiffGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_straight_bevel_gear_set_rating(self) -> '_393.StraightBevelGearSetRating':
        ...
        return constructor.new(_393.StraightBevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_spiral_bevel_gear_set_rating(self) -> '_394.SpiralBevelGearSetRating':
        ...
        return constructor.new(_394.SpiralBevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_rating(self) -> '_395.KlingelnbergCycloPalloidSpiralBevelGearSetRating':
        ...
        return constructor.new(_395.KlingelnbergCycloPalloidSpiralBevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_rating(self) -> '_396.KlingelnbergCycloPalloidHypoidGearSetRating':
        ...
        return constructor.new(_396.KlingelnbergCycloPalloidHypoidGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_hypoid_gear_set_rating(self) -> '_397.HypoidGearSetRating':
        ...
        return constructor.new(_397.HypoidGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_face_gear_set_duty_cycle_rating(self) -> '_398.FaceGearSetDutyCycleRating':
        ...
        return constructor.new(_398.FaceGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_face_gear_set_rating(self) -> '_399.FaceGearSetRating':
        ...
        return constructor.new(_399.FaceGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_cylindrical_gear_set_duty_cycle_rating(self) -> '_400.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_400.CylindricalGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_cylindrical_gear_set_rating(self) -> '_401.CylindricalGearSetRating':
        ...
        return constructor.new(_401.CylindricalGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_conical_gear_set_duty_cycle_rating(self) -> '_402.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_402.ConicalGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_concept_gear_set_duty_cycle_rating(self) -> '_403.ConceptGearSetDutyCycleRating':
        ...
        return constructor.new(_403.ConceptGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_concept_gear_set_rating(self) -> '_404.ConceptGearSetRating':
        ...
        return constructor.new(_404.ConceptGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
