...
class StraightBevelGearSetParetoOptimiser(_800.GearSetParetoOptimiser):
    '''StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_845.StraightBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_845.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_845.StraightBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_845.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_845.StraightBevelGearSetDesign))
        return value
