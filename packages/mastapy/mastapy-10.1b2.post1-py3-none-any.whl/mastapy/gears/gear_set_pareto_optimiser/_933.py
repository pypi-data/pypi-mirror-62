...
class MicroGeometryDesignSpaceSearchCandidate(_923.DesignSpaceSearchCandidateBase['_889.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_889.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_889.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_for_slider(self) -> '_1035.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1035.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
