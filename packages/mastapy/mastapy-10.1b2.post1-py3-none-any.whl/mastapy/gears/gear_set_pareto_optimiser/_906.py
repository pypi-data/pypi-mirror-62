...
from mastapy.math_utility.optimisation import _948, _965, _1050
...
class DesignSpaceSearchBase(_1.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_915.LargerOrSmaller':
        ...
        return constructor.new(_915.LargerOrSmaller)(value) if value else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_915.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_948.ParetoOptimisationStrategy':
        ...
        return constructor.new(_948.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None

    @property
    def optimisation_targets(self) -> 'List[_927.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_927.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_965.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_965.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_942.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_942.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_904.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_904.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_939.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_939.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1050.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1050.ParetoOptimisationFilter))
        return value
