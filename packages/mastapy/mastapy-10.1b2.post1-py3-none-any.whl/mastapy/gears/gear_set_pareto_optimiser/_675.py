...
class HypoidGearSetParetoOptimiser(_674.GearSetParetoOptimiser):
    '''HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_743.HypoidGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_743.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_743.HypoidGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_743.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_743.HypoidGearSetDesign))
        return value
