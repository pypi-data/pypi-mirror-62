...
from mastapy.gears.gear_designs.cylindrical import _389
...
class CylindricalGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    '''CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_389.CylindricalGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_389.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_389.CylindricalGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_389.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_389.CylindricalGearSetDesign))
        return value
