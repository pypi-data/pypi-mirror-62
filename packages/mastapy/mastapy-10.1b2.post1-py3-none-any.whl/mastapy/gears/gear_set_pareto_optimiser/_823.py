...
class SpiralBevelGearSetParetoOptimiser(_800.GearSetParetoOptimiser):
    '''SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_849.SpiralBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_849.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_849.SpiralBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_849.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_849.SpiralBevelGearSetDesign))
        return value
