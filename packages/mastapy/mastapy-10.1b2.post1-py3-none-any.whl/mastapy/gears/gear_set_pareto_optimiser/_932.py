...
from mastapy.gears.ltca.cylindrical import _886, _885, _889
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1035
from mastapy.gears.gear_set_pareto_optimiser import _922, _933
...
class MicroGeometryDesignSpaceSearch(_922.DesignSpaceSearchBase['_889.CylindricalGearSetLoadDistributionAnalysis', '_933.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_889.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_889.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_1035.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1035.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_1035.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1035.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1035.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1035.CylindricalGearSetMicroGeometry))
        return value
