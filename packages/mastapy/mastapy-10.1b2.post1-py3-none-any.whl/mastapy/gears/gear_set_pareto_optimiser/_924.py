...
class FaceGearSetParetoOptimiser(_928.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_375.FaceGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_375.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_375.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_375.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_375.FaceGearSetDesign))
        return value
