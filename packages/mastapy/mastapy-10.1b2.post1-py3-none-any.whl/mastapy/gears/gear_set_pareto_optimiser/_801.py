...
class HypoidGearSetParetoOptimiser(_800.GearSetParetoOptimiser):
    '''HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_865.HypoidGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_865.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_865.HypoidGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_865.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_865.HypoidGearSetDesign))
        return value
