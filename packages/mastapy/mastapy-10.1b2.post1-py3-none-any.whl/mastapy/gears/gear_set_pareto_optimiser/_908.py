...
class FaceGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self) -> '_388.FaceGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_388.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_388.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_388.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_388.FaceGearSetDesign))
        return value
