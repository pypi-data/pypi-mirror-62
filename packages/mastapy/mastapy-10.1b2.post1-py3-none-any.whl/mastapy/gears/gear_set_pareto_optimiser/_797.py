...
from mastapy.gears.gear_set_pareto_optimiser import _798
...
class GearNameMapper(_1.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_798.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_798.GearNamePicker))
        return value
