...
from mastapy.math_utility.optimisation import _1211
...
class ParetoStraightBevelGearSetOptimisationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1211.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1211.ParetoOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1211.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1211.ParetoOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, pareto_optimisation_strategy: '_1211.ParetoOptimisationStrategy') -> 'bool':
    ...
    def rename(self, pareto_optimisation_strategy: '_1211.ParetoOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, pareto_optimisation_strategy: '_1211.ParetoOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1211.ParetoOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1211.ParetoOptimisationStrategy))

    def save_changes(self, pareto_optimisation_strategy: '_1211.ParetoOptimisationStrategy'):
