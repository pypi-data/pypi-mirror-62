...
from mastapy.gears.ltca.cylindrical import _750, _749, _753
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _963
from mastapy.gears.gear_set_pareto_optimiser import _794, _805
...
class MicroGeometryDesignSpaceSearch(_794.DesignSpaceSearchBase['_753.CylindricalGearSetLoadDistributionAnalysis', '_805.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_753.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_753.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_963.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_963.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_963.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_963.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_963.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_963.CylindricalGearSetMicroGeometry))
        return value
