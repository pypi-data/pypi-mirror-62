...
class GearNameMapper(_1.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_910.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_910.GearNamePicker))
        return value
