...
from mastapy.math_utility.optimisation import _1211, _1203, _1208
...
class DesignSpaceSearchBase(_1.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_803.LargerOrSmaller':
        ...
        return constructor.new(_803.LargerOrSmaller)(value) if value else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_803.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1211.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1211.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None

    @property
    def optimisation_targets(self) -> 'List[_810.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_810.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1203.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1203.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_825.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_825.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_792.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_792.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_822.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_822.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1208.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1208.ParetoOptimisationFilter))
        return value
