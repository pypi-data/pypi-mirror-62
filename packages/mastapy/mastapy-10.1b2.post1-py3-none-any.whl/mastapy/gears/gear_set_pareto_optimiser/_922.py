...
from mastapy.math_utility.optimisation import _969, _1013, _1084
...
class DesignSpaceSearchBase(_1.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_931.LargerOrSmaller':
        ...
        return constructor.new(_931.LargerOrSmaller)(value) if value else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_931.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_969.ParetoOptimisationStrategy':
        ...
        return constructor.new(_969.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None

    @property
    def optimisation_targets(self) -> 'List[_938.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_938.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1013.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1013.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_953.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_953.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_920.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_920.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_950.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_950.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1084.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1084.ParetoOptimisationFilter))
        return value
