...
from mastapy.gears.gear_set_pareto_optimiser import _800
...
class CylindricalGearSetParetoOptimiser(_800.GearSetParetoOptimiser):
    '''CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_899.CylindricalGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_899.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_899.CylindricalGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_899.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_899.CylindricalGearSetDesign))
        return value
