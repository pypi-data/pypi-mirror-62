...
class SpiralBevelGearSetParetoOptimiser(_674.GearSetParetoOptimiser):
    '''SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_727.SpiralBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_727.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_727.SpiralBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_727.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_727.SpiralBevelGearSetDesign))
        return value
