...
from mastapy.gears.ltca.cylindrical import _624, _623, _627
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _842
from mastapy.gears.gear_set_pareto_optimiser import _668, _679
...
class MicroGeometryDesignSpaceSearch(_668.DesignSpaceSearchBase['_627.CylindricalGearSetLoadDistributionAnalysis', '_679.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_627.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_627.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_842.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_842.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_842.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_842.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_842.CylindricalGearSetMicroGeometry))
        return value
