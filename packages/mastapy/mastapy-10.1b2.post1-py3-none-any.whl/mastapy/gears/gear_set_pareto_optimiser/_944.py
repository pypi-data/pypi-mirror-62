...
from mastapy.math_utility.optimisation import _969
...
class ParetoHypoidGearSetOptimisationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_969.ParetoOptimisationStrategy':
        ...
        return constructor.new(_969.ParetoOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_969.ParetoOptimisationStrategy':
        ...
        return constructor.new(_969.ParetoOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, pareto_optimisation_strategy: '_969.ParetoOptimisationStrategy') -> 'bool':
    ...
    def rename(self, pareto_optimisation_strategy: '_969.ParetoOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, pareto_optimisation_strategy: '_969.ParetoOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_969.ParetoOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_969.ParetoOptimisationStrategy))

    def save_changes(self, pareto_optimisation_strategy: '_969.ParetoOptimisationStrategy'):
