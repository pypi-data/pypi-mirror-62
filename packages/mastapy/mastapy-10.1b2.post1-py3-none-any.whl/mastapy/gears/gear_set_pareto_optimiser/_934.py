...
class MicroGeometryDesignSpaceSearchChartInformation(_920.ChartInfoBase['_889.CylindricalGearSetLoadDistributionAnalysis', '_933.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_932.MicroGeometryDesignSpaceSearch':
