...
from mastapy.gears import _262
...
class GearSetOptimisationResults(_1.APIBase):
    ...
    @property
    def results(self) -> 'List[_262.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_262.GearSetOptimisationResult))
        return value
