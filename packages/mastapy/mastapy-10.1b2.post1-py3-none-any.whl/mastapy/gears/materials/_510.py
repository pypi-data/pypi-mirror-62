...
from mastapy.materials import _233, _230, _231
from mastapy.gears.materials import _509
...
class PlasticSNCurve(_1.APIBase):
    ...
    @property
    def lubricant(self) -> '_233.VDI2736LubricantType':
        ...
        return constructor.new(_233.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_233.VDI2736LubricantType'):
    ...
    @property
    def material(self) -> '_509.PlasticCylindricalGearMaterial':
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_230.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_230.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_231.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_231.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_230.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_230.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_231.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_231.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
