...
class BevelGearISOMaterial(_584.BevelGearMaterial):
    ...
    @property
    def quality_grade(self) -> '_264.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_264.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_264.QualityGrade'):
