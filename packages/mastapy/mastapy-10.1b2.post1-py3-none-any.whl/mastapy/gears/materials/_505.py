...
class ISOTR1417912001CoefficientOfFrictionConstantsDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_504.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_504.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_504.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_504.ISOTR1417912001CoefficientOfFrictionConstants)(method_result) if method_result else None

    def can_be_removed(self, isotr1417912001_coefficient_of_friction_constants: '_504.ISOTR1417912001CoefficientOfFrictionConstants') -> 'bool':
    ...
    def rename(self, isotr1417912001_coefficient_of_friction_constants: '_504.ISOTR1417912001CoefficientOfFrictionConstants', new_name: 'str') -> 'bool':
    ...
    def remove(self, isotr1417912001_coefficient_of_friction_constants: '_504.ISOTR1417912001CoefficientOfFrictionConstants'):
    ...
    def get_all_items(self) -> 'Iterable[_504.ISOTR1417912001CoefficientOfFrictionConstants]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_504.ISOTR1417912001CoefficientOfFrictionConstants))

    def save_changes(self, isotr1417912001_coefficient_of_friction_constants: '_504.ISOTR1417912001CoefficientOfFrictionConstants'):
