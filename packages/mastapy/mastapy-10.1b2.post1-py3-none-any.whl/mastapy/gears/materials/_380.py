...
class KlingelnbergConicalGearMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_381.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_381.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_381.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_381.KlingelnbergCycloPalloidConicalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, klingelnberg_cyclo_palloid_conical_gear_material: '_381.KlingelnbergCycloPalloidConicalGearMaterial') -> 'bool':
    ...
    def rename(self, klingelnberg_cyclo_palloid_conical_gear_material: '_381.KlingelnbergCycloPalloidConicalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, klingelnberg_cyclo_palloid_conical_gear_material: '_381.KlingelnbergCycloPalloidConicalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_381.KlingelnbergCycloPalloidConicalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_381.KlingelnbergCycloPalloidConicalGearMaterial))

    def save_changes(self, klingelnberg_cyclo_palloid_conical_gear_material: '_381.KlingelnbergCycloPalloidConicalGearMaterial'):
