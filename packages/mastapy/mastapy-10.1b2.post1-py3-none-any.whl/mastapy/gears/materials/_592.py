...
from mastapy.gears.materials import _609, _598
...
class BevelGearMaterial(_598.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_609.SNCurveDefinition':
        ...
        return constructor.new(_609.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_609.SNCurveDefinition'):
