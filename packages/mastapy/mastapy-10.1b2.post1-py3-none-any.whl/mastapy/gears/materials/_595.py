...
class BevelGearISOMaterial(_597.BevelGearMaterial):
    '''BevelGearISOMaterial
    ...
    @property
    def quality_grade(self) -> '_268.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_268.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_268.QualityGrade'):
