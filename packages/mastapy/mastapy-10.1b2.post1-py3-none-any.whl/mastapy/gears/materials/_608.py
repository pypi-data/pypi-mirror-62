...
from mastapy.gears.materials import _624, _614
...
class BevelGearMaterial(_614.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_624.SNCurveDefinition':
        ...
        return constructor.new(_624.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_624.SNCurveDefinition'):
