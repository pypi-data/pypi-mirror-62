...
class BevelGearIsoMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_582.BevelGearISOMaterial':
        ...
        return constructor.new(_582.BevelGearISOMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_582.BevelGearISOMaterial':
        ...
        return constructor.new(_582.BevelGearISOMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_iso_material: '_582.BevelGearISOMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_iso_material: '_582.BevelGearISOMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_iso_material: '_582.BevelGearISOMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_582.BevelGearISOMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_582.BevelGearISOMaterial))

    def save_changes(self, bevel_gear_iso_material: '_582.BevelGearISOMaterial'):
