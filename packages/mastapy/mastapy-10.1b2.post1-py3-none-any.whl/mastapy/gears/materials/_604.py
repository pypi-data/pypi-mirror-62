...
from mastapy.materials import _80, _71
...
class GearMaterial(_71.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
