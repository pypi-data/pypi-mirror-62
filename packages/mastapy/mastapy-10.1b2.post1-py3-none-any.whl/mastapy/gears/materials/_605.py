...
from mastapy.materials import _230, _231, _235
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.gears.materials import _612
...
class AGMACylindricalGearMaterial(_612.CylindricalGearMaterial):
    ...
    @property
    def material_application(self) -> '_230.AGMAMaterialApplications':
        ...
        return constructor.new(_230.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_230.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_231.AGMAMaterialClasses':
        ...
        return constructor.new(_231.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_231.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_235.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_235.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_235.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
