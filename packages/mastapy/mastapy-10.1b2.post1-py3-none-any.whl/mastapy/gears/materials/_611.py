...
from mastapy.gears.materials import _615
...
class CylindricalGearISOMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_615.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_615.ISOCylindricalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_615.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_615.ISOCylindricalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, iso_cylindrical_gear_material: '_615.ISOCylindricalGearMaterial') -> 'bool':
    ...
    def rename(self, iso_cylindrical_gear_material: '_615.ISOCylindricalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, iso_cylindrical_gear_material: '_615.ISOCylindricalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_615.ISOCylindricalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_615.ISOCylindricalGearMaterial))

    def save_changes(self, iso_cylindrical_gear_material: '_615.ISOCylindricalGearMaterial'):
