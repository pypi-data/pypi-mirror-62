...
class PlasticSNCurve(_1.APIBase):
    ...
    @property
    def material(self) -> '_606.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_606.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
