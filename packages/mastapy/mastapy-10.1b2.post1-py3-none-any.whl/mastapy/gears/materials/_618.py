...
from mastapy.gears.materials import _619
...
class KlingelnbergConicalGearMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_619.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_619.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_619.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_619.KlingelnbergCycloPalloidConicalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, klingelnberg_cyclo_palloid_conical_gear_material: '_619.KlingelnbergCycloPalloidConicalGearMaterial') -> 'bool':
    ...
    def rename(self, klingelnberg_cyclo_palloid_conical_gear_material: '_619.KlingelnbergCycloPalloidConicalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, klingelnberg_cyclo_palloid_conical_gear_material: '_619.KlingelnbergCycloPalloidConicalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_619.KlingelnbergCycloPalloidConicalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_619.KlingelnbergCycloPalloidConicalGearMaterial))

    def save_changes(self, klingelnberg_cyclo_palloid_conical_gear_material: '_619.KlingelnbergCycloPalloidConicalGearMaterial'):
