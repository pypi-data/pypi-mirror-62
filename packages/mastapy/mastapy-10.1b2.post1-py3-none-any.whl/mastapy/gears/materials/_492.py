...
from mastapy.materials import _190, _191, _192
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.gears.materials import _499
...
class AGMACylindricalGearMaterial(_499.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_190.AGMAMaterialApplications':
        ...
        return constructor.new(_190.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_190.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_191.AGMAMaterialClasses':
        ...
        return constructor.new(_191.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_191.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_192.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_192.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_192.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
