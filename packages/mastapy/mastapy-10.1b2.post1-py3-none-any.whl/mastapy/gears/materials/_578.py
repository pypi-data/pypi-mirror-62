...
from mastapy.materials import _274, _270, _271
...
class PlasticSNCurve(_1.APIBase):
    ...
    @property
    def lubricant(self) -> '_274.VDI2736LubricantType':
        ...
        return constructor.new(_274.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_274.VDI2736LubricantType'):
