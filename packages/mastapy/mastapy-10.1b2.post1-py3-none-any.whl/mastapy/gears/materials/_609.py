...
class BevelGearMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_608.BevelGearMaterial':
        ...
        return constructor.new(_608.BevelGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_608.BevelGearMaterial':
        ...
        return constructor.new(_608.BevelGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_material: '_608.BevelGearMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_material: '_608.BevelGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_material: '_608.BevelGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_608.BevelGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_608.BevelGearMaterial))

    def save_changes(self, bevel_gear_material: '_608.BevelGearMaterial'):
