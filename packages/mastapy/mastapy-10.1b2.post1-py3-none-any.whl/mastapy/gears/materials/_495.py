...
from mastapy.gears.materials import _514, _501
...
class BevelGearMaterial(_501.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_514.SNCurveDefinition':
        ...
        return constructor.new(_514.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_514.SNCurveDefinition'):
