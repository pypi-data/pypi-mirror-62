...
from mastapy.gears.materials import _388, _375
...
class BevelGearMaterial(_375.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_388.SNCurveDefinition':
        ...
        return constructor.new(_388.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_388.SNCurveDefinition'):
