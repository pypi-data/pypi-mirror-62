...
from mastapy.gears.materials import _622
...
class RawMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_622.RawMaterial':
        ...
        return constructor.new(_622.RawMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_622.RawMaterial':
        ...
        return constructor.new(_622.RawMaterial)(method_result) if method_result else None

    def can_be_removed(self, raw_material: '_622.RawMaterial') -> 'bool':
    ...
    def rename(self, raw_material: '_622.RawMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, raw_material: '_622.RawMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_622.RawMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_622.RawMaterial))

    def save_changes(self, raw_material: '_622.RawMaterial'):
