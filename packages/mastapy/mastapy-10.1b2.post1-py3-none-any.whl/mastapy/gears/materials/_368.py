...
from mastapy.gears.materials import _367
...
class BevelGearIsoMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_367.BevelGearISOMaterial':
        ...
        return constructor.new(_367.BevelGearISOMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_367.BevelGearISOMaterial':
        ...
        return constructor.new(_367.BevelGearISOMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_iso_material: '_367.BevelGearISOMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_iso_material: '_367.BevelGearISOMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_iso_material: '_367.BevelGearISOMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_367.BevelGearISOMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_367.BevelGearISOMaterial))

    def save_changes(self, bevel_gear_iso_material: '_367.BevelGearISOMaterial'):
