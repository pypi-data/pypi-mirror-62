...
class BevelGearIsoMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_590.BevelGearISOMaterial':
        ...
        return constructor.new(_590.BevelGearISOMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_590.BevelGearISOMaterial':
        ...
        return constructor.new(_590.BevelGearISOMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_iso_material: '_590.BevelGearISOMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_iso_material: '_590.BevelGearISOMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_iso_material: '_590.BevelGearISOMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_590.BevelGearISOMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_590.BevelGearISOMaterial))

    def save_changes(self, bevel_gear_iso_material: '_590.BevelGearISOMaterial'):
