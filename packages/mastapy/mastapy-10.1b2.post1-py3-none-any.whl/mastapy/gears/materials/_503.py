...
class ISOCylindricalGearMaterial(_499.CylindricalGearMaterial):
    '''ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self) -> '_225.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_225.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_225.QualityGrade'):
