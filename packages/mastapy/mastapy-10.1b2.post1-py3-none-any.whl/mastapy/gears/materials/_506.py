...
from mastapy.gears.materials import _507
...
class KlingelnbergConicalGearMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_507.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_507.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_507.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_507.KlingelnbergCycloPalloidConicalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, klingelnberg_cyclo_palloid_conical_gear_material: '_507.KlingelnbergCycloPalloidConicalGearMaterial') -> 'bool':
    ...
    def rename(self, klingelnberg_cyclo_palloid_conical_gear_material: '_507.KlingelnbergCycloPalloidConicalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, klingelnberg_cyclo_palloid_conical_gear_material: '_507.KlingelnbergCycloPalloidConicalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_507.KlingelnbergCycloPalloidConicalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_507.KlingelnbergCycloPalloidConicalGearMaterial))

    def save_changes(self, klingelnberg_cyclo_palloid_conical_gear_material: '_507.KlingelnbergCycloPalloidConicalGearMaterial'):
