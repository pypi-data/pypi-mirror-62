...
from mastapy.materials import _229, _230, _231
...
class AGMACylindricalGearMaterial(_595.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_229.AGMAMaterialApplications':
        ...
        return constructor.new(_229.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_229.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_230.AGMAMaterialClasses':
        ...
        return constructor.new(_230.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_230.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_231.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_231.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_231.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
