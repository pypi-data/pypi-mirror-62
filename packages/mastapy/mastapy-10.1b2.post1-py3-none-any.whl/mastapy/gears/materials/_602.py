...
from mastapy.gears.materials import _620, _604
...
class CylindricalGearMaterial(_604.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_620.ManufactureRating':
        ...
        return constructor.new(_620.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_620.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_620.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_620.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_620.ManufactureRating':
    ...
    def machine_process_development(self, value: '_620.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_620.ManufactureRating':
    ...
    def manufacturability(self, value: '_620.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
