...
from mastapy.materials import _276, _272, _273
from mastapy.gears.materials import _621
...
class PlasticSNCurve(_1.APIBase):
    ...
    @property
    def lubricant(self) -> '_276.VDI2736LubricantType':
        ...
        return constructor.new(_276.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_276.VDI2736LubricantType'):
    ...
    @property
    def material(self) -> '_621.PlasticCylindricalGearMaterial':
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_272.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_272.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_273.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_273.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_272.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_272.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_273.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_273.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
