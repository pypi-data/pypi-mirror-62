...
from mastapy.materials import _228, _219
...
class GearMaterial(_219.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_228.SNCurve':
        ...
        return constructor.new(_228.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_228.SNCurve':
        ...
        return constructor.new(_228.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
