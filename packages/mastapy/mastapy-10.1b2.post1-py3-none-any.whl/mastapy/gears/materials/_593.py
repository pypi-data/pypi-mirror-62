...
from mastapy.materials import _233, _234, _236
...
class AGMACylindricalGearMaterial(_600.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_233.AGMAMaterialApplications':
        ...
        return constructor.new(_233.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_233.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_234.AGMAMaterialClasses':
        ...
        return constructor.new(_234.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_234.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def grade(self) -> '_236.AGMAMaterialGrade':
        ...
        return constructor.new(_236.AGMAMaterialGrade)(value) if value else None
