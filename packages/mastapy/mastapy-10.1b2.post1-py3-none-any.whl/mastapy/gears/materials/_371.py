...
from mastapy.gears.materials import _366
...
class CylindricalGearAGMAMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_366.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_366.AGMACylindricalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_366.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_366.AGMACylindricalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, agma_cylindrical_gear_material: '_366.AGMACylindricalGearMaterial') -> 'bool':
    ...
    def rename(self, agma_cylindrical_gear_material: '_366.AGMACylindricalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, agma_cylindrical_gear_material: '_366.AGMACylindricalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_366.AGMACylindricalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_366.AGMACylindricalGearMaterial))

    def save_changes(self, agma_cylindrical_gear_material: '_366.AGMACylindricalGearMaterial'):
