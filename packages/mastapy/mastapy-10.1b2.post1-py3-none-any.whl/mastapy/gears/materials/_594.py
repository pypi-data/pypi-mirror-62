...
from mastapy.materials import _231, _232, _233
...
class AGMACylindricalGearMaterial(_602.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_231.AGMAMaterialApplications':
        ...
        return constructor.new(_231.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_231.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_232.AGMAMaterialClasses':
        ...
        return constructor.new(_232.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_232.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_233.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_233.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_233.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
