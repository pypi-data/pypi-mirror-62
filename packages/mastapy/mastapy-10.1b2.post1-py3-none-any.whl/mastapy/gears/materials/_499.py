...
from mastapy.gears.materials import _508, _501
...
class CylindricalGearMaterial(_501.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_508.ManufactureRating':
        ...
        return constructor.new(_508.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_508.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_508.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_508.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_508.ManufactureRating':
    ...
    def machine_process_development(self, value: '_508.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_508.ManufactureRating':
    ...
    def manufacturability(self, value: '_508.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
