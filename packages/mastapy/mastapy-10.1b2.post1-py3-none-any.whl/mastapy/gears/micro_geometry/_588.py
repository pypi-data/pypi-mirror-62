...
class ProfileModification(_585.Modification):
    '''ProfileModification
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief(self) -> '_583.MainProfileReliefEndsAtTheStartOfTipReliefOption':
        ...
        return constructor.new(_583.MainProfileReliefEndsAtTheStartOfTipReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_tip_relief.setter
    def main_profile_modification_ends_at_the_start_of_tip_relief(self, value: '_583.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_587.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_587.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_587.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief(self) -> '_582.MainProfileReliefEndsAtTheStartOfRootReliefOption':
        ...
        return constructor.new(_582.MainProfileReliefEndsAtTheStartOfRootReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_root_relief.setter
    def main_profile_modification_ends_at_the_start_of_root_relief(self, value: '_582.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_586.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_586.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_586.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
