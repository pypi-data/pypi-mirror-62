...
class ProfileModification(_590.Modification):
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_592.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_592.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_592.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_591.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_591.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_591.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
