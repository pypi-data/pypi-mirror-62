...
from mastapy.gears import _271
...
class PlanetaryDetail(_1.APIBase):
    ...
    @property
    def planet_delta_angles(self) -> 'List[_271.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_271.NamedPlanetAngle))
        return value
