...
class GearSetOptimisationResults(_1.APIBase):
    ...
    @property
    def results(self) -> 'List[_305.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_305.GearSetOptimisationResult))
        return value
