...
class CylindricalHobDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_635.CylindricalGearHobDesign':
        ...
        return constructor.new(_635.CylindricalGearHobDesign)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_635.CylindricalGearHobDesign':
        ...
        return constructor.new(_635.CylindricalGearHobDesign)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_hob_design: '_635.CylindricalGearHobDesign') -> 'bool':
    ...
    def rename(self, cylindrical_gear_hob_design: '_635.CylindricalGearHobDesign', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_hob_design: '_635.CylindricalGearHobDesign'):
    ...
    def get_all_items(self) -> 'Iterable[_635.CylindricalGearHobDesign]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_635.CylindricalGearHobDesign))

    def save_changes(self, cylindrical_gear_hob_design: '_635.CylindricalGearHobDesign'):
