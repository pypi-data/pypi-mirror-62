...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _677, _683
...
class HobbingProcessLeadCalculation(_683.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
