...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _685, _727
...
class WormGrindingProcessProfileCalculation(_727.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_791.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_791.CylindricalGearProfileMeasurementType)(value) if value else None

    @chart_display_method.setter
    def chart_display_method(self, value: '_791.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_685.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_685.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_685.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_685.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
