...
T = TypeVar('T', bound='_590.ProcessSimulationInput')
...
class ProcessSimulationNew(_1.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_587.ProcessLeadCalculation':
        ...
        return constructor.new(_587.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None

    @property
    def profile_calculation(self) -> '_589.ProcessProfileCalculation':
        ...
        return constructor.new(_589.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None

    @property
    def pitch_calculation(self) -> '_588.ProcessPitchCalculation':
        ...
        return constructor.new(_588.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None

    @property
    def gear_tooth_shape_calculation(self) -> '_586.ProcessGearShape':
        ...
        return constructor.new(_586.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None

    @property
    def total_modification_calculation(self) -> '_593.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_593.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
