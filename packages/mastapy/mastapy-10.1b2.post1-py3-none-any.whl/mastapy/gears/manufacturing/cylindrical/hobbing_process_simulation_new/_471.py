...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _432
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _473
...
class WormGrindingCutterCalculation(_473.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_432.PointOfInterest':
        ...
        return constructor.new(_432.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
