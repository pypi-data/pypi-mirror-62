...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _703, _689, _719
...
class ProcessCalculation(_1.APIBase):
    ...
    @property
    def inputs(self) -> '_703.ProcessSimulationInput':
        ...
        return constructor.new(_703.ProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_689.HobbingProcessSimulationInput':
        ...
        if _689.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_689.HobbingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_719.WormGrindingProcessSimulationInput':
        ...
        if _719.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_719.WormGrindingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None
