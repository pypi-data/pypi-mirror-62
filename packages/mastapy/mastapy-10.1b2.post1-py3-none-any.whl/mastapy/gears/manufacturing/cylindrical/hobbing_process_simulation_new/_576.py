...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _567, _571
...
class HobbingProcessProfileCalculation(_571.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
