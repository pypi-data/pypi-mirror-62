...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _571
...
class HobbingProcessTotalModificationCalculation(_571.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
