...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _565, _571
...
class HobbingProcessLeadCalculation(_571.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
