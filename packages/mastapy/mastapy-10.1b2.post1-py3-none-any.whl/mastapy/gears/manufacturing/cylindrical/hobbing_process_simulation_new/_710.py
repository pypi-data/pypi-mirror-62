...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _670
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _712
...
class WormGrindingCutterCalculation(_712.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_670.PointOfInterest':
        ...
        return constructor.new(_670.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
