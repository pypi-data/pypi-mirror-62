...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _566, _599
...
class WormGrindingProcessPitchCalculation(_599.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_566.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_566.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_566.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_566.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
