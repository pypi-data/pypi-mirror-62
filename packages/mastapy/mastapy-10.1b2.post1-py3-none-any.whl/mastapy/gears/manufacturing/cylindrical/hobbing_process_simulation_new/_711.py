...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _677, _712
...
class WormGrindingLeadCalculation(_712.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_677.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_677.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_677.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_677.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
