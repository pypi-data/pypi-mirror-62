...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _590, _577, _604
...
class ProcessCalculation(_1.APIBase):
    ...
    @property
    def inputs(self) -> '_590.ProcessSimulationInput':
        ...
        return constructor.new(_590.ProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_577.HobbingProcessSimulationInput':
        ...
        if _577.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_577.HobbingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_604.WormGrindingProcessSimulationInput':
        ...
        if _604.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_604.WormGrindingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None
