...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _566, _571
...
class HobbingProcessPitchCalculation(_571.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
