...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _678, _683
...
class HobbingProcessPitchCalculation(_683.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
