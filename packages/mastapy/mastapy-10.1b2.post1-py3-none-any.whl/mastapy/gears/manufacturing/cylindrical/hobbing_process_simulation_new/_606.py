...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _592, _605
...
class WormGrindingProcessSimulationViewModel(_592.ProcessSimulationViewModel['_605.WormGrindingProcessSimulationNew']):
    '''WormGrindingProcessSimulationViewModel
