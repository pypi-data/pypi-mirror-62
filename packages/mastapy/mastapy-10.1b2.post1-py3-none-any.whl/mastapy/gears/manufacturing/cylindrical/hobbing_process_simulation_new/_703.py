...
class ProcessSimulationInput(_1.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_680.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_680.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_680.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_676.AnalysisMethod':
        ...
        return constructor.new(_676.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_676.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_708.RackMountingError':
        ...
        return constructor.new(_708.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_682.GearMountingError':
        ...
        return constructor.new(_682.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_681.CutterHeadSlideError':
        ...
        return constructor.new(_681.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
