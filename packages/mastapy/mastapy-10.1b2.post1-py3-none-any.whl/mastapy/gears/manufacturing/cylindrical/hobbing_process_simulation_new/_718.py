...
from mastapy.gears.gear_designs.cylindrical import _738
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _679, _712
...
class WormGrindingProcessProfileCalculation(_712.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_679.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_679.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_679.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_679.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
