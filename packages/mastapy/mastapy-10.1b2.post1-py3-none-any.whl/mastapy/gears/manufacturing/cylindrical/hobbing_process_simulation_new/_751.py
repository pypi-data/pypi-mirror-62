...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _720, _750
...
class WormGrindingProcessSimulationViewModel(_720.ProcessSimulationViewModel['_750.WormGrindingProcessSimulationNew']):
    '''WormGrindingProcessSimulationViewModel
