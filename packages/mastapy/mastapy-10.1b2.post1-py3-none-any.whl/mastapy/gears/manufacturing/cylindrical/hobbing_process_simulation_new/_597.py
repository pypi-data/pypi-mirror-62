...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _558
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _599
...
class WormGrindingCutterCalculation(_599.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_558.PointOfInterest':
        ...
        return constructor.new(_558.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
