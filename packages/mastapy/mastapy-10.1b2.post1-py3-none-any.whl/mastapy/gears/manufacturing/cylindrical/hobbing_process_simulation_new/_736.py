...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _718
...
class WormGrindingProcessTotalModificationCalculation(_718.WormGrindingProcessCalculation):
    '''WormGrindingProcessTotalModificationCalculation
