...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _596, _590
...
class WormGrindingProcessSimulationInput(_590.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_596.WormGrinderManufactureError':
        ...
        return constructor.new(_596.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
