...
from mastapy.gears.gear_designs.cylindrical import _743
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _680, _714
...
class WormGrindingProcessProfileCalculation(_714.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_743.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_743.CylindricalGearProfileMeasurementType)(value) if value else None

    @chart_display_method.setter
    def chart_display_method(self, value: '_743.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_680.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_680.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_680.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_680.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
