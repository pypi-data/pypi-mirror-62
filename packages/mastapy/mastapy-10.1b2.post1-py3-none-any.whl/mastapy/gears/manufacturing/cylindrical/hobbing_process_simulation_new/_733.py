...
from mastapy.gears.gear_designs.cylindrical import _746
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _682, _718
...
class WormGrindingProcessProfileCalculation(_718.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_746.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_746.CylindricalGearProfileMeasurementType)(value) if value else None

    @chart_display_method.setter
    def chart_display_method(self, value: '_746.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_682.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_682.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_682.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_682.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
