...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _709, _703
...
class WormGrindingProcessSimulationInput(_703.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_709.WormGrinderManufactureError':
        ...
        return constructor.new(_709.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
