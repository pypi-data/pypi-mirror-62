...
class ProcessSimulationInput(_1.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_568.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_568.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_568.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_564.AnalysisMethod':
        ...
        return constructor.new(_564.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_564.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_595.RackMountingError':
        ...
        return constructor.new(_595.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_570.GearMountingError':
        ...
        return constructor.new(_570.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_569.CutterHeadSlideError':
        ...
        return constructor.new(_569.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
