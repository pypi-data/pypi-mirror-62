...
class ProcessProfileCalculation(_1.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_441.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_441.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None

    @property
    def left_flank_accuracy_calculation(self) -> '_441.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_441.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
