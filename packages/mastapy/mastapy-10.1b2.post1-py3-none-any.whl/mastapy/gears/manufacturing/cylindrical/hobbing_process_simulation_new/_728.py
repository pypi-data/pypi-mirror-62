...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _715, _709
...
class WormGrindingProcessSimulationInput(_709.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_715.WormGrinderManufactureError':
        ...
        return constructor.new(_715.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
