...
from mastapy.gears.gear_designs.cylindrical import _897
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _567, _599
...
class WormGrindingProcessProfileCalculation(_599.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_567.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_567.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_567.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_567.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
