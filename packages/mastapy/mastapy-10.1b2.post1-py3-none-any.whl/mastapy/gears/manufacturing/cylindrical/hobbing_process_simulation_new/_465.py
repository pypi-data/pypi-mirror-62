...
T = TypeVar('T', bound='_464.ProcessSimulationInput')
...
class ProcessSimulationNew(_1.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_461.ProcessLeadCalculation':
        ...
        return constructor.new(_461.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None

    @property
    def profile_calculation(self) -> '_463.ProcessProfileCalculation':
        ...
        return constructor.new(_463.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None

    @property
    def pitch_calculation(self) -> '_462.ProcessPitchCalculation':
        ...
        return constructor.new(_462.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None

    @property
    def gear_tooth_shape_calculation(self) -> '_460.ProcessGearShape':
        ...
        return constructor.new(_460.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None

    @property
    def total_modification_calculation(self) -> '_467.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_467.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
