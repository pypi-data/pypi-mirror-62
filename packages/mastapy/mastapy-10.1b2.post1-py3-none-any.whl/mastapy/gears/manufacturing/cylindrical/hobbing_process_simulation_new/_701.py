...
class ProcessPitchCalculation(_1.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_678.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_678.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None

    @property
    def left_flank_accuracy_calculation(self) -> '_678.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_678.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
