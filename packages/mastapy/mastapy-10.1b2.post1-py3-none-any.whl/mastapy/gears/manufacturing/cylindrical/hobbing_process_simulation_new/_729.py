...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _716
...
class WormGrindingProcessTotalModificationCalculation(_716.WormGrindingProcessCalculation):
    '''WormGrindingProcessTotalModificationCalculation
