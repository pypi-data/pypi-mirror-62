...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _679, _683
...
class HobbingProcessProfileCalculation(_683.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
