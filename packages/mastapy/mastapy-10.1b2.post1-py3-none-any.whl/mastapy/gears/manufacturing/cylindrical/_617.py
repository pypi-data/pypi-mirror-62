...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _663
from mastapy._internal import constructor, conversion
from mastapy.gears.manufacturing.cylindrical import _652, _653
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_measurement_method(self) -> '_663.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_663.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_663.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_663.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_663.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lead_micro_geometry(self) -> '_652.MicroGeometryInputsLead':
        ...
        return constructor.new(_652.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_653.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_653.MicroGeometryInputsProfile))
        return value
