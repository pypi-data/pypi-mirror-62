...
class SuitableCutterSetup(_1.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_742.ManufacturingOperationConstraints':
        ...
        return constructor.new(_742.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
