...
from mastapy.gears.manufacturing.cylindrical import _529, _528, _516
...
from mastapy.gears.gear_designs.cylindrical import _912, _888
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _616, _613, _620, _610
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _544, _545, _546
...
class CylindricalGearManufacturingConfig(_1064.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    def roughing_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CylindricalMftRoughingMethods.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_CylindricalMftRoughingMethods.implicit_type().type_()
    ...
    def finishing_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CylindricalMftFinishingMethods.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_CylindricalMftFinishingMethods.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def rough_cutter(self) -> '_635.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_635.CylindricalGearRealCutterDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_629.CylindricalGearFormGrindingWheel':
        ...
        if _629.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_629.CylindricalGearFormGrindingWheel)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_630.CylindricalGearGrindingWorm':
        ...
        if _630.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_630.CylindricalGearGrindingWorm)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_631.CylindricalGearHobDesign':
        ...
        if _631.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_631.CylindricalGearHobDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_632.CylindricalGearPlungeShaver':
        ...
        if _632.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_632.CylindricalGearPlungeShaver)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_634.CylindricalGearRackDesign':
        ...
        if _634.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_634.CylindricalGearRackDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_636.CylindricalGearShaper':
        ...
        if _636.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_636.CylindricalGearShaper)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_637.CylindricalGearShaver':
        ...
        if _637.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_637.CylindricalGearShaver)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_640.InvoluteCutterDesign':
        ...
        if _640.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_640.InvoluteCutterDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def finish_cutter(self) -> '_635.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_635.CylindricalGearRealCutterDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_629.CylindricalGearFormGrindingWheel':
        ...
        if _629.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_629.CylindricalGearFormGrindingWheel)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_630.CylindricalGearGrindingWorm':
        ...
        if _630.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_630.CylindricalGearGrindingWorm)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_631.CylindricalGearHobDesign':
        ...
        if _631.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_631.CylindricalGearHobDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_632.CylindricalGearPlungeShaver':
        ...
        if _632.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_632.CylindricalGearPlungeShaver)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_634.CylindricalGearRackDesign':
        ...
        if _634.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_634.CylindricalGearRackDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_636.CylindricalGearShaper':
        ...
        if _636.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_636.CylindricalGearShaper)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_637.CylindricalGearShaver':
        ...
        if _637.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_637.CylindricalGearShaver)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_640.InvoluteCutterDesign':
        ...
        if _640.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_640.InvoluteCutterDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None
    ...
    @property
    def rough_cutter_simulation(self) -> '_616.GearCutterSimulation':
        ...
        return constructor.new(_616.GearCutterSimulation)(self.wrapped.RoughCutterSimulation) if self.wrapped.RoughCutterSimulation else None

    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_613.FinishCutterSimulation':
        ...
        if _613.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_613.FinishCutterSimulation)(self.wrapped.RoughCutterSimulation) if self.wrapped.RoughCutterSimulation else None

    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_620.RoughCutterSimulation':
        ...
        if _620.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_620.RoughCutterSimulation)(self.wrapped.RoughCutterSimulation) if self.wrapped.RoughCutterSimulation else None

    @property
    def rough_process_simulation(self) -> '_544.CutterProcessSimulation':
        ...
        return constructor.new(_544.CutterProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None

    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_545.FormWheelGrindingProcessSimulation':
        ...
        if _545.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_545.FormWheelGrindingProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None

    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_546.ShapingProcessSimulation':
        ...
        if _546.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_546.ShapingProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None

    @property
    def finish_cutter_simulation(self) -> '_616.GearCutterSimulation':
        ...
        return constructor.new(_616.GearCutterSimulation)(self.wrapped.FinishCutterSimulation) if self.wrapped.FinishCutterSimulation else None

    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_613.FinishCutterSimulation':
        ...
        if _613.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_613.FinishCutterSimulation)(self.wrapped.FinishCutterSimulation) if self.wrapped.FinishCutterSimulation else None

    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_620.RoughCutterSimulation':
        ...
        if _620.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_620.RoughCutterSimulation)(self.wrapped.FinishCutterSimulation) if self.wrapped.FinishCutterSimulation else None

    @property
    def finish_process_simulation(self) -> '_544.CutterProcessSimulation':
        ...
        return constructor.new(_544.CutterProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_545.FormWheelGrindingProcessSimulation':
        ...
        if _545.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_545.FormWheelGrindingProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_546.ShapingProcessSimulation':
        ...
        if _546.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_546.ShapingProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def design(self) -> '_888.CylindricalGearDesign':
        ...
        return constructor.new(_888.CylindricalGearDesign)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def rough_gear_specification(self) -> '_610.CylindricalGearSpecification':
        ...
        return constructor.new(_610.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_610.CylindricalGearSpecification':
        ...
        return constructor.new(_610.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_516.CylindricalGearBlank':
        ...
        return constructor.new(_516.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None
