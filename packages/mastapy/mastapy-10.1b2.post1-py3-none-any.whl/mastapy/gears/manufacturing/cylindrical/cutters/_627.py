...
from mastapy.gears.manufacturing.cylindrical.cutters import _629
...
class CylindricalFormedWheelGrinderDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_629.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_629.CylindricalGearFormGrindingWheel)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_629.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_629.CylindricalGearFormGrindingWheel)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_form_grinding_wheel: '_629.CylindricalGearFormGrindingWheel') -> 'bool':
    ...
    def rename(self, cylindrical_gear_form_grinding_wheel: '_629.CylindricalGearFormGrindingWheel', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_form_grinding_wheel: '_629.CylindricalGearFormGrindingWheel'):
    ...
    def get_all_items(self) -> 'Iterable[_629.CylindricalGearFormGrindingWheel]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_629.CylindricalGearFormGrindingWheel))

    def save_changes(self, cylindrical_gear_form_grinding_wheel: '_629.CylindricalGearFormGrindingWheel'):
