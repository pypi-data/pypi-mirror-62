...
from mastapy.gears.manufacturing.cylindrical.cutters import _752, _751, _662
...
class RackShape(_774.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_752.CylindricalGearRackDesign':
