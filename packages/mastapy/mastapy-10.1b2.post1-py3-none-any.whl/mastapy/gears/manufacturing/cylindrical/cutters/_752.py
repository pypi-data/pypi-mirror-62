...
from mastapy.gears import _308, _330
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _780, _776, _779
...
class CylindricalGearRackDesign(_749.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_330.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_330.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_330.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
