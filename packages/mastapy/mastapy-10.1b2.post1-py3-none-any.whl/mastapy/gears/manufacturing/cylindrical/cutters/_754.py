...
class CylindricalGearPlungeShaverDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_734.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_734.CylindricalGearPlungeShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_734.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_734.CylindricalGearPlungeShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_plunge_shaver: '_734.CylindricalGearPlungeShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_plunge_shaver: '_734.CylindricalGearPlungeShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_plunge_shaver: '_734.CylindricalGearPlungeShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_734.CylindricalGearPlungeShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_734.CylindricalGearPlungeShaver))

    def save_changes(self, cylindrical_gear_plunge_shaver: '_734.CylindricalGearPlungeShaver'):
