...
class CutterShapeDefinition(_1.APIBase):
    ...
    @property
    def design(self) -> '_696.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_696.CylindricalGearRealCutterDesign)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_697.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_697.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_698.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_698.CylindricalGearGrindingWorm)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_699.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_699.CylindricalGearPlungeShaver)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_700.CylindricalGearShaper':
        ...
        return constructor.new(_700.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_701.CylindricalGearShaver':
        ...
        return constructor.new(_701.CylindricalGearShaver)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def fillet_points(self) -> 'List[_769.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_769.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_769.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_769.NamedPoint))
        return value
