...
class CylindricalGearPlungeShaverDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_506.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_506.CylindricalGearPlungeShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_506.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_506.CylindricalGearPlungeShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_plunge_shaver: '_506.CylindricalGearPlungeShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_plunge_shaver: '_506.CylindricalGearPlungeShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_plunge_shaver: '_506.CylindricalGearPlungeShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_506.CylindricalGearPlungeShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_506.CylindricalGearPlungeShaver))

    def save_changes(self, cylindrical_gear_plunge_shaver: '_506.CylindricalGearPlungeShaver'):
