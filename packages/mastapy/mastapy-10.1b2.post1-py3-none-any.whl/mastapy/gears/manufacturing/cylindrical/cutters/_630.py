...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _650, _652, _647
...
class CylindricalGearGrindingWorm(_634.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_650.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_650.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
