...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _780
...
class CylindricalGearHobShape(_780.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_662.CylindricalGearHobDesign':
