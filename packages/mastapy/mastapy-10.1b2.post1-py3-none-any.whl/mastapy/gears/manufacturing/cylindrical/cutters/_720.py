...
class CylindricalGearShaper(_759.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_813.ShaperEdgeTypes':
        ...
        return constructor.new(_813.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_813.ShaperEdgeTypes'):
