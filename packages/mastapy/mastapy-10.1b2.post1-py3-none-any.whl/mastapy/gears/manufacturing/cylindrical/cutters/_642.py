...
from mastapy.geometry.twod.curves import _245
from mastapy.gears.manufacturing.cylindrical.cutters import _641
...
class MutatableCurve(_641.MutatableCommon):
    '''MutatableCurve
    ...
    def curve_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes.implicit_type()
    ...
    def curve_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes.implicit_type().type_()
