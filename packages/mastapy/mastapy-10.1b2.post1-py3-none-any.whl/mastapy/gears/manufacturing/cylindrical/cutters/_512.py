...
class CylindricalGearShaverDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_511.CylindricalGearShaver':
        ...
        return constructor.new(_511.CylindricalGearShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_511.CylindricalGearShaver':
        ...
        return constructor.new(_511.CylindricalGearShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaver: '_511.CylindricalGearShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaver: '_511.CylindricalGearShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaver: '_511.CylindricalGearShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_511.CylindricalGearShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_511.CylindricalGearShaver))

    def save_changes(self, cylindrical_gear_shaver: '_511.CylindricalGearShaver'):
