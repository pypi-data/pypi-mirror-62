...
from mastapy.gears.manufacturing.cylindrical.cutters import _765, _767
...
class CylindricalGearRealCutterDesign(_767.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_drawing(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_765.CustomisableEdgeProfile':
        ...
        return constructor.new(_765.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
