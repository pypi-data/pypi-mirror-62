...
class CylindricalWormGrinderDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_751.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_751.CylindricalGearGrindingWorm)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_751.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_751.CylindricalGearGrindingWorm)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_grinding_worm: '_751.CylindricalGearGrindingWorm') -> 'bool':
    ...
    def rename(self, cylindrical_gear_grinding_worm: '_751.CylindricalGearGrindingWorm', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_grinding_worm: '_751.CylindricalGearGrindingWorm'):
    ...
    def get_all_items(self) -> 'Iterable[_751.CylindricalGearGrindingWorm]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_751.CylindricalGearGrindingWorm))

    def save_changes(self, cylindrical_gear_grinding_worm: '_751.CylindricalGearGrindingWorm'):
