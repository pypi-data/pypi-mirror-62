...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _521, _526, _524
...
class CylindricalGearHobDesign(_508.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_410.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_410.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_410.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_521.CylindricalGearHobShape':
        ...
        return constructor.new(_521.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_526.RackShape':
        ...
        return constructor.new(_526.RackShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_521.CylindricalGearHobShape':
        ...
        if _521.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_521.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_524.CylindricalGearWormGrinderShape':
        ...
        if _524.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_524.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def maximum_hob_material_shape(self) -> '_521.CylindricalGearHobShape':
        ...
        return constructor.new(_521.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_521.CylindricalGearHobShape':
        ...
        return constructor.new(_521.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
