...
from mastapy.gears.gear_designs.cylindrical import _372
...
class RoughCutterCreationSettings(_1.APIBase):
    ...
    @property
    def rough_thickness_used_to_generate_cutter(self) -> '_372.TolerancedMetalMeasurements':
        ...
        return constructor.new(_372.TolerancedMetalMeasurements)(value) if value else None

    @rough_thickness_used_to_generate_cutter.setter
    def rough_thickness_used_to_generate_cutter(self, value: '_372.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RoughThicknessUsedToGenerateCutter = value

    @property
    def finish_thickness_used_to_generate_cutter(self) -> '_372.TolerancedMetalMeasurements':
    ...
    def finish_thickness_used_to_generate_cutter(self, value: '_372.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishThicknessUsedToGenerateCutter = value

    @property
    def rough_tool_clearances(self) -> '_744.ManufacturingOperationConstraints':
        ...
        return constructor.new(_744.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances else None

    @property
    def finish_tool_clearances(self) -> '_744.ManufacturingOperationConstraints':
        ...
        return constructor.new(_744.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances else None
