...
from mastapy.gears import _265, _280
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _652, _647, _650
...
class CylindricalGearRackDesign(_635.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_280.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_280.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_280.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
