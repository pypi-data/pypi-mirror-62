...
class CylindricalFormedWheelGrinderDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_503.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_503.CylindricalGearFormGrindingWheel)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_503.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_503.CylindricalGearFormGrindingWheel)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_form_grinding_wheel: '_503.CylindricalGearFormGrindingWheel') -> 'bool':
    ...
    def rename(self, cylindrical_gear_form_grinding_wheel: '_503.CylindricalGearFormGrindingWheel', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_form_grinding_wheel: '_503.CylindricalGearFormGrindingWheel'):
    ...
    def get_all_items(self) -> 'Iterable[_503.CylindricalGearFormGrindingWheel]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_503.CylindricalGearFormGrindingWheel))

    def save_changes(self, cylindrical_gear_form_grinding_wheel: '_503.CylindricalGearFormGrindingWheel'):
