...
from mastapy.gears.manufacturing.cylindrical.cutters import _640
...
class CylindricalGearShaper(_640.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_936.ShaperEdgeTypes':
        ...
        return constructor.new(_936.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_936.ShaperEdgeTypes'):
