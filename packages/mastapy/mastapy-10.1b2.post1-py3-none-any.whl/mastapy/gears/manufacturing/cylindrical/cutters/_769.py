...
class CylindricalGearShaverDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_748.CylindricalGearShaver':
        ...
        return constructor.new(_748.CylindricalGearShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_748.CylindricalGearShaver':
        ...
        return constructor.new(_748.CylindricalGearShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaver: '_748.CylindricalGearShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaver: '_748.CylindricalGearShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaver: '_748.CylindricalGearShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_748.CylindricalGearShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_748.CylindricalGearShaver))

    def save_changes(self, cylindrical_gear_shaver: '_748.CylindricalGearShaver'):
