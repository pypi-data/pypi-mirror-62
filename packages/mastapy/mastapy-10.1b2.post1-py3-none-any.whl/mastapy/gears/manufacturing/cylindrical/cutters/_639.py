...
from mastapy.gears.manufacturing.cylindrical.cutters import _630
...
class CylindricalWormGrinderDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_630.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_630.CylindricalGearGrindingWorm)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_630.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_630.CylindricalGearGrindingWorm)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_grinding_worm: '_630.CylindricalGearGrindingWorm') -> 'bool':
    ...
    def rename(self, cylindrical_gear_grinding_worm: '_630.CylindricalGearGrindingWorm', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_grinding_worm: '_630.CylindricalGearGrindingWorm'):
    ...
    def get_all_items(self) -> 'Iterable[_630.CylindricalGearGrindingWorm]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_630.CylindricalGearGrindingWorm))

    def save_changes(self, cylindrical_gear_grinding_worm: '_630.CylindricalGearGrindingWorm'):
