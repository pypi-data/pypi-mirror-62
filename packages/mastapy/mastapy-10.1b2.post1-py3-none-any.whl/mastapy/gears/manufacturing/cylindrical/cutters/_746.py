...
from mastapy.gears.gear_designs.cylindrical import _869
from mastapy._internal.implicit import overridable
from mastapy.gears.manufacturing.cylindrical.cutters import _765
...
class CylindricalGearShaper(_765.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_869.ShaperEdgeTypes':
        ...
        return constructor.new(_869.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_869.ShaperEdgeTypes'):
