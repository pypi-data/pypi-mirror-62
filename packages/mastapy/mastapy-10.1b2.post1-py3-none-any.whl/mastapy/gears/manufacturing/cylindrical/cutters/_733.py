...
from mastapy.gears.gear_designs.cylindrical import _808
from mastapy._internal.implicit import overridable
from mastapy.gears.manufacturing.cylindrical.cutters import _735
...
class CylindricalGearShaper(_735.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_808.ShaperEdgeTypes':
        ...
        return constructor.new(_808.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_808.ShaperEdgeTypes'):
