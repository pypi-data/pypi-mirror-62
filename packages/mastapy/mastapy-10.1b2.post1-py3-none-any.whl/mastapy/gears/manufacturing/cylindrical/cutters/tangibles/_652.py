...
from mastapy.gears.manufacturing.cylindrical.cutters import _634, _630, _631
...
class RackShape(_645.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_634.CylindricalGearRackDesign':
