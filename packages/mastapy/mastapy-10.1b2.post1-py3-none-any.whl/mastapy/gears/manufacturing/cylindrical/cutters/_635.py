...
from mastapy.gears.manufacturing.cylindrical.cutters import _626, _628
...
class CylindricalGearRealCutterDesign(_628.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    @property
    def nominal_cutter_shape(self) -> '_645.CutterShapeDefinition':
        ...
        return constructor.new(_645.CutterShapeDefinition)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_646.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _646.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_646.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_647.CylindricalGearHobShape':
        ...
        if _647.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_647.CylindricalGearHobShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_648.CylindricalGearShaperTangible':
        ...
        if _648.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_648.CylindricalGearShaperTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_649.CylindricalGearShaverTangible':
        ...
        if _649.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_649.CylindricalGearShaverTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_650.CylindricalGearWormGrinderShape':
        ...
        if _650.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_650.CylindricalGearWormGrinderShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_652.RackShape':
        ...
        if _652.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new(_652.RackShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def customised_cutting_edge_profile(self) -> '_626.CustomisableEdgeProfile':
        ...
        return constructor.new(_626.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
