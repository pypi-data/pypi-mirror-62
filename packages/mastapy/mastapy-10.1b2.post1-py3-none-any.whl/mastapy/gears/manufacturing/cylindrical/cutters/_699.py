...
class CylindricalGearPlungeShaver(_701.CylindricalGearShaver):
    '''CylindricalGearPlungeShaver
    ...
    @property
    def right_flank_micro_geometry(self) -> '_607.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_607.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None

    @property
    def left_flank_micro_geometry(self) -> '_607.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_607.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def micro_geometry(self) -> 'List[_607.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_607.CylindricalGearSpecifiedMicroGeometry))
        return value
