...
from mastapy.gears.manufacturing.cylindrical import _536
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _647, _652, _650
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.cylindrical.cutters import _634
...
class CylindricalGearHobDesign(_634.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_536.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_536.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_536.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_647.CylindricalGearHobShape':
        ...
        return constructor.new(_647.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_652.RackShape':
        ...
        return constructor.new(_652.RackShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_647.CylindricalGearHobShape':
        ...
        if _647.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_647.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_650.CylindricalGearWormGrinderShape':
        ...
        if _650.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_650.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def maximum_hob_material_shape(self) -> '_647.CylindricalGearHobShape':
        ...
        return constructor.new(_647.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_647.CylindricalGearHobShape':
        ...
        return constructor.new(_647.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
