...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _766, _765, _763
...
class CylindricalGearGrindingWorm(_754.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_766.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_766.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None

    @property
    def nominal_rack_shape(self) -> '_765.RackShape':
        ...
        return constructor.new(_765.RackShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_763.CylindricalGearHobShape':
        ...
        return constructor.new(_763.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None
