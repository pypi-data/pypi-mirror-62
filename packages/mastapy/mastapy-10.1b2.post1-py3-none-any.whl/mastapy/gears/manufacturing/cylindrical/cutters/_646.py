...
from mastapy.gears.manufacturing.cylindrical import _651
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _775, _780, _778
...
class CylindricalGearHobDesign(_750.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_651.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_651.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_651.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_775.CylindricalGearHobShape':
        ...
        return constructor.new(_775.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_780.RackShape':
        ...
        return constructor.new(_780.RackShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_775.CylindricalGearHobShape':
        ...
        if _775.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_775.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_778.CylindricalGearWormGrinderShape':
        ...
        if _778.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_778.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def maximum_hob_material_shape(self) -> '_775.CylindricalGearHobShape':
        ...
        return constructor.new(_775.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_775.CylindricalGearHobShape':
        ...
        return constructor.new(_775.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
