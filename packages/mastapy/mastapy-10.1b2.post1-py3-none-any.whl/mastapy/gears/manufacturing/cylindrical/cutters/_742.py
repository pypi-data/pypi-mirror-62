...
from mastapy.gears.manufacturing.cylindrical.cutters import _767
...
class CylindricalGearShaper(_767.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_792.ShaperEdgeTypes':
        ...
        return constructor.new(_792.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_792.ShaperEdgeTypes'):
