...
from mastapy.gears import _136, _154
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _526, _521, _524
...
class CylindricalGearRackDesign(_509.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_154.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_154.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_154.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
