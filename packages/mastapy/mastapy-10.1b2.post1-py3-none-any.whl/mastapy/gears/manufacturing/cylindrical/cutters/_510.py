...
from mastapy.gears.gear_designs.cylindrical import _815
...
class CylindricalGearShaper(_514.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_815.ShaperEdgeTypes':
        ...
        return constructor.new(_815.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_815.ShaperEdgeTypes'):
