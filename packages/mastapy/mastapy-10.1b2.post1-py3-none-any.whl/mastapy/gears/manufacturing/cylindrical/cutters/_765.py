...
from mastapy.gears.manufacturing.cylindrical.cutters import _771
...
class CustomisableEdgeProfile(_1.APIBase):
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_771.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_771.MutatableCommon))
        return value
