...
from mastapy.gears.manufacturing.cylindrical.cutters import _651
...
class CylindricalGearHobShape(_769.RackShape):
    ...
    @property
    def design(self) -> '_651.CylindricalGearHobDesign':
        ...
        return constructor.new(_651.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
