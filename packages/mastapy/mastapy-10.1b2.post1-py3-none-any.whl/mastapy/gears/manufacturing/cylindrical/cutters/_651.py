...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _755, _769, _768
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.cylindrical.cutters import _757
...
class CylindricalGearHobDesign(_757.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_629.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_629.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_629.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_755.CylindricalGearHobShape':
        ...
        return constructor.new(_755.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_755.CylindricalGearHobShape':
        ...
        return constructor.new(_755.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_768.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_768.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def maximum_hob_material_shape(self) -> '_755.CylindricalGearHobShape':
        ...
        return constructor.new(_755.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_755.CylindricalGearHobShape':
        ...
        return constructor.new(_755.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
