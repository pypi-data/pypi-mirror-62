...
class CylindricalGearPlungeShaverDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_632.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_632.CylindricalGearPlungeShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_632.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_632.CylindricalGearPlungeShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_plunge_shaver: '_632.CylindricalGearPlungeShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_plunge_shaver: '_632.CylindricalGearPlungeShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_plunge_shaver: '_632.CylindricalGearPlungeShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_632.CylindricalGearPlungeShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_632.CylindricalGearPlungeShaver))

    def save_changes(self, cylindrical_gear_plunge_shaver: '_632.CylindricalGearPlungeShaver'):
