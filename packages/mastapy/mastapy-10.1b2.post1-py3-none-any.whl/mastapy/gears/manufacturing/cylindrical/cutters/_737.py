...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _767, _769, _753
...
class CylindricalGearGrindingWorm(_755.CylindricalGearRackDesign):
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_753.CylindricalGearHobShape':
        ...
        return constructor.new(_753.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None
