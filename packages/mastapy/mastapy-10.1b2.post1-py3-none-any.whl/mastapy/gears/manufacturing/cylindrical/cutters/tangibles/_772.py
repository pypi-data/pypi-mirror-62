...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _771
...
class CylindricalGearFormedWheelGrinderTangible(_771.CutterShapeDefinition):
    '''CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self) -> '_759.CylindricalGearFormGrindingWheel':
