...
from mastapy.gears.manufacturing.cylindrical.cutters import _748, _750
...
class CylindricalGearRealCutterDesign(_750.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_drawing(self) -> '_752.SMTBitmap':
        ...
        return constructor.new(_752.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_763.CylindricalGearHobShape':
        ...
        return constructor.new(_763.CylindricalGearHobShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_767.CylindricalGearShaperTangible':
        ...
        return constructor.new(_767.CylindricalGearShaperTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_768.CylindricalGearShaverTangible':
        ...
        return constructor.new(_768.CylindricalGearShaverTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_748.CustomisableEdgeProfile':
        ...
        return constructor.new(_748.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
