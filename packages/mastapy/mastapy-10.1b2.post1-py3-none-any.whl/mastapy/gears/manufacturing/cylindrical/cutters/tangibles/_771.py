...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _779
...
class CutterShapeDefinition(_1.APIBase):
    ...
    @property
    def design(self) -> '_763.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_763.CylindricalGearRealCutterDesign)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_759.CylindricalGearFormGrindingWheel':
        ...
        if _759.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_759.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_760.CylindricalGearGrindingWorm':
        ...
        if _760.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_760.CylindricalGearGrindingWorm)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_hob_design(self) -> '_635.CylindricalGearHobDesign':
        ...
        if _635.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_745.CylindricalGearPlungeShaver':
        ...
        if _745.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_745.CylindricalGearPlungeShaver)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_762.CylindricalGearRackDesign':
        ...
        if _762.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_762.CylindricalGearRackDesign)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_742.CylindricalGearShaper':
        ...
        if _742.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_742.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_764.CylindricalGearShaver':
        ...
        if _764.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_764.CylindricalGearShaver)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def design_of_type_involute_cutter_design(self) -> '_767.InvoluteCutterDesign':
        ...
        if _767.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
        ...
        return constructor.new(_767.InvoluteCutterDesign)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def fillet_points(self) -> 'List[_779.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_779.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_779.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_779.NamedPoint))
        return value
