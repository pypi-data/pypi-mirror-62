...
class RoughCutterCreationSettings(_1.APIBase):
    ...
    @property
    def rough_tool_clearances(self) -> '_742.ManufacturingOperationConstraints':
        ...
        return constructor.new(_742.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances else None

    @property
    def finish_tool_clearances(self) -> '_742.ManufacturingOperationConstraints':
        ...
        return constructor.new(_742.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances else None
