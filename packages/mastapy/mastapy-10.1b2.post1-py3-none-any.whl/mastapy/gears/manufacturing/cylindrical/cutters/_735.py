...
from mastapy.gears.gear_designs.cylindrical import _708, _709, _710
...
class InvoluteCutterDesign(_728.CylindricalGearRealCutterDesign):
    '''InvoluteCutterDesign
    ...
    @property
    def tooth_thickness(self) -> '_708.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_708.ToothThicknessSpecificationBase)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_709.FinishToothThicknessDesignSpecification':
        ...
        if _709.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_709.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_710.ToothThicknessSpecification':
        ...
        if _710.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_710.ToothThicknessSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
