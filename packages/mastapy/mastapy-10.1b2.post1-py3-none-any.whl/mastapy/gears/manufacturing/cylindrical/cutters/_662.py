...
from mastapy.gears.manufacturing.cylindrical import _646
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _776, _780, _779
...
class CylindricalGearHobDesign(_752.CylindricalGearRackDesign):
    ...
    @property
    def hob_edge_type(self) -> '_646.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_646.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_646.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_776.CylindricalGearHobShape':
        ...
        return constructor.new(_776.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_776.CylindricalGearHobShape':
        ...
        if _776.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_776.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_779.CylindricalGearWormGrinderShape':
        ...
        if _779.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new(_779.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None

    @property
    def maximum_hob_material_shape(self) -> '_776.CylindricalGearHobShape':
        ...
        return constructor.new(_776.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_776.CylindricalGearHobShape':
        ...
        return constructor.new(_776.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
