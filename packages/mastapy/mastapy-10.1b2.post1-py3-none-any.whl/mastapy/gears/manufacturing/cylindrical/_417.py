...
class SuitableCutterSetup(_1.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_492.ManufacturingOperationConstraints':
        ...
        return constructor.new(_492.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
