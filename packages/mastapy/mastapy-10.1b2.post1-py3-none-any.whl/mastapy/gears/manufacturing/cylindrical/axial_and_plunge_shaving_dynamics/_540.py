...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _541
...
class RollAngleRangeRelativeToAccuracy(_1.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_541.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_541.RollAngleReportObject))
        return value
