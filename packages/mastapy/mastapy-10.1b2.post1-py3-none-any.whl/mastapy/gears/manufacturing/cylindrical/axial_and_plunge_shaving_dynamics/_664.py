...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _660, _674, _659
...
class PlungeShavingDynamicsViewModel(_674.ShavingDynamicsViewModel['_659.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_660.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_660.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
