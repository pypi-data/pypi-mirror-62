...
from mastapy.gears.gear_designs.cylindrical import _883
...
class ShavingDynamics(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_883.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_883.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
