...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _666, _665, _669
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _609
...
class ShavingDynamicsCalculation(_1.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_666.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_666.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_666.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_666.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_609.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_609.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_637.CylindricalGearShaver':
        ...
        return constructor.new(_637.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None

    @property
    def new_cutter_start_of_shaving(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
