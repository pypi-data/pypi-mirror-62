...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _788, _802, _787
...
class PlungeShavingDynamicsViewModel(_802.ShavingDynamicsViewModel['_787.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_788.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_788.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
