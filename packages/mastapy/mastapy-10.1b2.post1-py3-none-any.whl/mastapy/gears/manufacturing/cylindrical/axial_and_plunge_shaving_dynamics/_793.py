...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _797
...
class RedressingSettings(_1.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_748.CylindricalGearShaver':
        ...
        return constructor.new(_748.CylindricalGearShaver)(self.wrapped.RedressedShaver) if self.wrapped.RedressedShaver else None
