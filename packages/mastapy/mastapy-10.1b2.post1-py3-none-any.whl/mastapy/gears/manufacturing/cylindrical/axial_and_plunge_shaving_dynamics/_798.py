...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _794, _793, _797
...
class ShavingDynamicsCalculation(_1.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_794.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_794.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_794.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_794.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_724.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_724.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_748.CylindricalGearShaver':
        ...
        return constructor.new(_748.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None

    @property
    def new_cutter_start_of_shaving(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
