...
class ShavingDynamicsCalculationForDesignedGears(_798.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_601.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_601.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_796.ShaverRedressing[T]':
        ...
        return constructor.new(_796.ShaverRedressing)[T](self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_782.AxialShaverRedressing':
        ...
        if _782.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_782.AxialShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_789.PlungeShaverRedressing':
        ...
        if _789.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_789.PlungeShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None
