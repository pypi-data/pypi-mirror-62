...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _795
...
class RollAngleRangeRelativeToAccuracy(_1.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_795.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_795.RollAngleReportObject))
        return value
