...
from mastapy.gears.gear_designs.cylindrical import _871
...
class ShavingDynamics(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_871.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_871.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
