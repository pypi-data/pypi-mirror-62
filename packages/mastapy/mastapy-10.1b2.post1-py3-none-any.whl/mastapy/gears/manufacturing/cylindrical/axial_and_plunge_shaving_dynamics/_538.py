...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _534, _548, _533
...
class PlungeShavingDynamicsViewModel(_548.ShavingDynamicsViewModel['_533.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_534.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_534.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
