...
from mastapy.gears.gear_designs.cylindrical import _762
...
class ShavingDynamics(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_762.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_762.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
