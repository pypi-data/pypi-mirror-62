...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _543
...
class RedressingSettings(_1.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_511.CylindricalGearShaver':
        ...
        return constructor.new(_511.CylindricalGearShaver)(self.wrapped.RedressedShaver) if self.wrapped.RedressedShaver else None
