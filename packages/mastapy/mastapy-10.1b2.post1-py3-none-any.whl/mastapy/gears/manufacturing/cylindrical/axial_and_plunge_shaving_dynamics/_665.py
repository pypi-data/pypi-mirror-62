...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _669
...
class RedressingSettings(_1.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_637.CylindricalGearShaver':
        ...
        return constructor.new(_637.CylindricalGearShaver)(self.wrapped.RedressedShaver) if self.wrapped.RedressedShaver else None
