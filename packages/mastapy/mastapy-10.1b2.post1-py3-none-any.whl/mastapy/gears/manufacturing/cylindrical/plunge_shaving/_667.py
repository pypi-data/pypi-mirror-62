...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _661, _660, _670
...
class PlungeShaverInputsAndMicroGeometry(_1.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_670.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestLeftFlank, constructor.new(_670.PointOfInterest))
        return value

    @property
    def points_of_interest_right_flank(self) -> 'List[_670.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestRightFlank, constructor.new(_670.PointOfInterest))
        return value
