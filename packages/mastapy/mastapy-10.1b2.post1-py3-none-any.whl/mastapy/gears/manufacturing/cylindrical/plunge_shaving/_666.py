...
from mastapy.gears.gear_designs.cylindrical import _735
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _673, _657
...
class PlungeShaverGeneration(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_735.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_735.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_673.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_673.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_657.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_657.CalculationError))
        return value
