...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _550, _556
from mastapy._internal import constructor, conversion
from mastapy.gears.manufacturing.cylindrical import _518
from mastapy.gears.manufacturing.cylindrical.cutters import _632
...
class RealPlungeShaverOutputs(_556.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self) -> '_550.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_550.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_550.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_550.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_550.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_micro_geometry(self) -> '_518.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_518.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def right_flank_micro_geometry(self) -> '_518.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_518.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None

    @property
    def shaver(self) -> '_632.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_632.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def micro_geometry(self) -> 'List[_518.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_518.CylindricalGearSpecifiedMicroGeometry))
        return value
