...
class PlungeShaverSettings(_1.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_660.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_660.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadDisplayMethod = value

    @property
    def profile_display_method(self) -> '_660.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_660.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
