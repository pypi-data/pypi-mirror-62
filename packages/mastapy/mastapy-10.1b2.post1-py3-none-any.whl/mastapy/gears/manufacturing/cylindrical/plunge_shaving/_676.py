...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _673
...
class ShaverPointOfInterest(_1.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_673.PointOfInterest':
        ...
        return constructor.new(_673.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear else None
