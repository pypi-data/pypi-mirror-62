...
from mastapy.gears.gear_designs.cylindrical import _882
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _561, _547
...
class PlungeShaverGeneration(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_882.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_882.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_561.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_561.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_547.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_547.CalculationError))
        return value
