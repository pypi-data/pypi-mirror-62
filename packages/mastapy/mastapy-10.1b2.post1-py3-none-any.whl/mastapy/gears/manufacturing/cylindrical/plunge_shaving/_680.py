...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _674
...
class VirtualPlungeShaverOutputs(_674.PlungeShaverOutputs):
    '''VirtualPlungeShaverOutputs
    ...
    @property
    def lead_modification_on_conjugate_shaver_chart_left_flank(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank) if self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank else None

    @property
    def lead_modification_on_conjugate_shaver_chart_right_flank(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartRightFlank) if self.wrapped.LeadModificationOnConjugateShaverChartRightFlank else None
