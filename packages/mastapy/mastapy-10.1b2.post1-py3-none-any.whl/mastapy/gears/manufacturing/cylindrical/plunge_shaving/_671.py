...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _660, _668
from mastapy._internal import constructor, conversion
from mastapy.gears.manufacturing.cylindrical import _628
from mastapy.gears.manufacturing.cylindrical.cutters import _744
...
class RealPlungeShaverOutputs(_668.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self) -> '_660.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_660.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_660.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_660.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_660.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_micro_geometry(self) -> '_628.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_628.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def right_flank_micro_geometry(self) -> '_628.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_628.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None

    @property
    def shaver(self) -> '_744.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_744.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def micro_geometry(self) -> 'List[_628.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_628.CylindricalGearSpecifiedMicroGeometry))
        return value
