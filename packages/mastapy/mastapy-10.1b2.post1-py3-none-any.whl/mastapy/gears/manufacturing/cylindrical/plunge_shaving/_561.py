...
class ShaverPointOfInterest(_1.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_558.PointOfInterest':
        ...
        return constructor.new(_558.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear else None
