...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _676
...
class ShaverPointOfInterest(_1.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_676.PointOfInterest':
        ...
        return constructor.new(_676.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear else None
