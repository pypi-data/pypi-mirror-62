...
from mastapy.gears.gear_designs.cylindrical import _696
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _662, _647
...
class PlungeShaverGeneration(_1.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_696.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_696.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_662.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_662.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_647.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_647.CalculationError))
        return value
