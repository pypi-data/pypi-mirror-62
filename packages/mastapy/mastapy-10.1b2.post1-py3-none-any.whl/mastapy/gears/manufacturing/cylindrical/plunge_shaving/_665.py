...
from mastapy.gears.gear_designs.cylindrical import _731, _732, _733
...
class PlungeShaverCalculationInputs(_1.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_308.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_308.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_724.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_724.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_731.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_731.ToothThicknessSpecificationBase)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_732.FinishToothThicknessDesignSpecification':
        ...
        if _732.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_732.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_733.ToothThicknessSpecification':
        ...
        if _733.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_733.ToothThicknessSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
