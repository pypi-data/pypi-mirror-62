...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _551, _550, _558
...
class PlungeShaverInputsAndMicroGeometry(_1.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_558.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestLeftFlank, constructor.new(_558.PointOfInterest))
        return value

    @property
    def points_of_interest_right_flank(self) -> 'List[_558.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestRightFlank, constructor.new(_558.PointOfInterest))
        return value
