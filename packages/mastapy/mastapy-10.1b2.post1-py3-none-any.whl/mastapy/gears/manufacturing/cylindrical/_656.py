...
from mastapy.gears.manufacturing.cylindrical.cutters import _743
...
class SuitableCutterSetup(_1.APIBase):
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_743.RoughCutterCreationSettings':
        ...
        return constructor.new(_743.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None

    @property
    def tool_clearances(self) -> '_744.ManufacturingOperationConstraints':
        ...
        return constructor.new(_744.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
