...
from mastapy.gears.manufacturing.cylindrical.cutters import _636
...
class CylindricalShaperDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_636.CylindricalGearShaper':
        ...
        return constructor.new(_636.CylindricalGearShaper)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_636.CylindricalGearShaper':
        ...
        return constructor.new(_636.CylindricalGearShaper)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaper: '_636.CylindricalGearShaper') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaper: '_636.CylindricalGearShaper', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaper: '_636.CylindricalGearShaper'):
    ...
    def get_all_items(self) -> 'Iterable[_636.CylindricalGearShaper]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_636.CylindricalGearShaper))

    def save_changes(self, cylindrical_gear_shaper: '_636.CylindricalGearShaper'):
