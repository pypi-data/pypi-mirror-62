...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _550
from mastapy._internal import constructor, conversion
from mastapy.gears.manufacturing.cylindrical import _539, _540
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_539.MicroGeometryInputsLead':
        ...
        return constructor.new(_539.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_540.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_540.MicroGeometryInputsProfile))
        return value
