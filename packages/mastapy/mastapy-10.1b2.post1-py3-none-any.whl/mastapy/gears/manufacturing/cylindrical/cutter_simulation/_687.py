...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _760
...
class CylindricalManufacturedVirtualGearInMesh(_1.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_760.VirtualSimulationCalculator':
        ...
        return constructor.new(_760.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
