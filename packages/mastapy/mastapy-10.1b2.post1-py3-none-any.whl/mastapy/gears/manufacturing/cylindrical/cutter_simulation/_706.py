...
from mastapy.gears.gear_designs.cylindrical import _727, _728, _729
...
class CylindricalGearSpecification(_1.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_727.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_727.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_728.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_728.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_729.ToothThicknessSpecification':
        ...
        return constructor.new(_729.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
