...
class ShaperSimulationCalculator(_725.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_776.CylindricalGearShaperTangible':
        ...
        return constructor.new(_776.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
