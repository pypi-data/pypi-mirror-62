...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _754
...
class CylindricalManufacturedVirtualGearInMesh(_1.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_754.VirtualSimulationCalculator':
        ...
        return constructor.new(_754.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
