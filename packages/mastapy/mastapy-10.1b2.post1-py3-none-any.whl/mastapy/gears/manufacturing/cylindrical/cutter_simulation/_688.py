...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _707, _753
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _778
...
class CutterSimulationCalc(_1.APIBase):
    ...
    @property
    def gear(self) -> '_707.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_707.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_753.FinishStockPoint':
        ...
        return constructor.new(_753.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None

    @property
    def stock_removed_at_designed_sap(self) -> '_753.FinishStockPoint':
        ...
        return constructor.new(_753.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_753.FinishStockPoint':
        ...
        return constructor.new(_753.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None

    @property
    def gear_fillet_points(self) -> 'List[_778.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_778.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_753.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_753.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_753.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_753.FinishStockPoint))
        return value
