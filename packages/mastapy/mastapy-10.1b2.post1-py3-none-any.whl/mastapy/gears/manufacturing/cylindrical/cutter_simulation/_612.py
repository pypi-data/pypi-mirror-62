...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _623
...
class CylindricalManufacturedVirtualGearInMesh(_1.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_623.VirtualSimulationCalculator':
        ...
        return constructor.new(_623.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
