...
from mastapy.gears.gear_designs.cylindrical import _721, _722, _723
...
class CylindricalGearSpecification(_1.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_721.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_721.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_722.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_722.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_723.ToothThicknessSpecification':
        ...
        return constructor.new(_723.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
