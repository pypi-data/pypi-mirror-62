...
class WormGrinderSimulationCalculator(_759.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_779.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_779.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
