...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _520
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _482
...
class FormWheelGrindingSimulationCalculator(_482.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_520.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_520.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
