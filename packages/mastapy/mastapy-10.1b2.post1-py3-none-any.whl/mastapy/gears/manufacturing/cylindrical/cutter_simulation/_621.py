...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _648
...
class ShaperSimulationCalculator(_608.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_648.CylindricalGearShaperTangible':
        ...
        return constructor.new(_648.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
