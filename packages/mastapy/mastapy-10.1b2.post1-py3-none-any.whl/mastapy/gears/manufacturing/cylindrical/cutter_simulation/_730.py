...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _775
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _723
...
class FormWheelGrindingSimulationCalculator(_723.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_775.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_775.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
