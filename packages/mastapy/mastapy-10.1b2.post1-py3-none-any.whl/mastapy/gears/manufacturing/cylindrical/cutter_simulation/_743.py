...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _753
...
class HobSimulationCalculator(_744.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_753.CylindricalGearHobShape':
        ...
        return constructor.new(_753.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
