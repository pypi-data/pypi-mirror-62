...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _772
...
class FormWheelGrindingSimulationCalculator(_725.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_772.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_772.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
