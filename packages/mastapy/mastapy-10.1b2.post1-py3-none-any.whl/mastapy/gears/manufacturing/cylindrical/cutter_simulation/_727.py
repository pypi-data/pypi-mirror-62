...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _762
...
class CylindricalManufacturedVirtualGearInMesh(_1.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_762.VirtualSimulationCalculator':
        ...
        return constructor.new(_762.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
