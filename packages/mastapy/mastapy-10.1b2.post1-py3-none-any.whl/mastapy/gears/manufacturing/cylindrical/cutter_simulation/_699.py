...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _673, _732
...
class CutterSimulationCalc(_1.APIBase):
    ...
    @property
    def gear(self) -> '_673.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_673.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_732.FinishStockPoint':
        ...
        return constructor.new(_732.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None

    @property
    def stock_removed_at_designed_sap(self) -> '_732.FinishStockPoint':
        ...
        return constructor.new(_732.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_732.FinishStockPoint':
        ...
        return constructor.new(_732.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None
    ...
    @property
    def finish_stock_indexed_arcs(self) -> 'List[_732.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_732.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_732.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_732.FinishStockPoint))
        return value
