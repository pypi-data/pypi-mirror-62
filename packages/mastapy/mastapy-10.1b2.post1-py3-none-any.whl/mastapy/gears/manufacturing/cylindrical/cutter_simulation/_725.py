...
class CylindricalGearSpecification(_1.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_731.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_731.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_732.FinishToothThicknessDesignSpecification':
        ...
        if _732.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_732.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_733.ToothThicknessSpecification':
        ...
        if _733.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_733.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
