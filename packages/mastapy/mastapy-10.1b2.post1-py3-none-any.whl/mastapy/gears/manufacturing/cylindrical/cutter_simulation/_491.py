...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _521
...
class HobSimulationCalculator(_493.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_521.CylindricalGearHobShape':
        ...
        return constructor.new(_521.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
