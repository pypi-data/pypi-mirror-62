...
class CylindricalManufacturedVirtualGearInMesh(_1.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_747.VirtualSimulationCalculator':
        ...
        return constructor.new(_747.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
