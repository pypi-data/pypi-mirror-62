...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _777
...
class ShaperSimulationCalculator(_723.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_777.CylindricalGearShaperTangible':
        ...
        return constructor.new(_777.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
