...
from mastapy.gears.manufacturing.cylindrical import _627, _626, _611
...
from mastapy.gears.gear_designs.cylindrical import _736, _600
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _737, _738, _739, _740
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _647, _648, _649
from mastapy.gears.analysis import _741
...
class CylindricalGearManufacturingConfig(_741.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    @property
    def rough_cutter(self) -> '_728.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_728.CylindricalGearRealCutterDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_729.CylindricalGearFormGrindingWheel':
        ...
        if _729.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_729.CylindricalGearFormGrindingWheel)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_730.CylindricalGearGrindingWorm':
        ...
        if _730.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_730.CylindricalGearGrindingWorm)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_731.CylindricalGearPlungeShaver':
        ...
        if _731.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_731.CylindricalGearPlungeShaver)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_732.CylindricalGearRackDesign':
        ...
        if _732.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_732.CylindricalGearRackDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_733.CylindricalGearShaper':
        ...
        if _733.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_733.CylindricalGearShaper)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None
    ...
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_734.CylindricalGearShaver':
        ...
        if _734.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_735.InvoluteCutterDesign':
        ...
        if _735.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
        ...
        return constructor.new(_735.InvoluteCutterDesign)(self.wrapped.RoughCutter) if self.wrapped.RoughCutter else None

    @property
    def finish_cutter(self) -> '_728.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_728.CylindricalGearRealCutterDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_729.CylindricalGearFormGrindingWheel':
        ...
        if _729.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_729.CylindricalGearFormGrindingWheel)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_730.CylindricalGearGrindingWorm':
        ...
        if _730.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_730.CylindricalGearGrindingWorm)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_731.CylindricalGearPlungeShaver':
        ...
        if _731.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_731.CylindricalGearPlungeShaver)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_732.CylindricalGearRackDesign':
        ...
        if _732.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_732.CylindricalGearRackDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_733.CylindricalGearShaper':
        ...
        if _733.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_733.CylindricalGearShaper)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None
    ...
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_734.CylindricalGearShaver':
        ...
        if _734.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_735.InvoluteCutterDesign':
        ...
        if _735.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
        ...
        return constructor.new(_735.InvoluteCutterDesign)(self.wrapped.FinishCutter) if self.wrapped.FinishCutter else None

    @property
    def finish_stock_specification(self) -> '_736.FinishStockSpecification':
        ...
        return constructor.new(_736.FinishStockSpecification)(self.wrapped.FinishStockSpecification) if self.wrapped.FinishStockSpecification else None
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_739.RoughCutterSimulation':
        ...
        if _739.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_739.RoughCutterSimulation)(self.wrapped.RoughCutterSimulation) if self.wrapped.RoughCutterSimulation else None

    @property
    def rough_process_simulation(self) -> '_647.CutterProcessSimulation':
        ...
        return constructor.new(_647.CutterProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None

    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_648.FormWheelGrindingProcessSimulation':
        ...
        if _648.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_648.FormWheelGrindingProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None

    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_649.ShapingProcessSimulation':
        ...
        if _649.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_649.ShapingProcessSimulation)(self.wrapped.RoughProcessSimulation) if self.wrapped.RoughProcessSimulation else None
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_739.RoughCutterSimulation':
        ...
        if _739.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
        ...
        return constructor.new(_739.RoughCutterSimulation)(self.wrapped.FinishCutterSimulation) if self.wrapped.FinishCutterSimulation else None

    @property
    def finish_process_simulation(self) -> '_647.CutterProcessSimulation':
        ...
        return constructor.new(_647.CutterProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_648.FormWheelGrindingProcessSimulation':
        ...
        if _648.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_648.FormWheelGrindingProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_649.ShapingProcessSimulation':
        ...
        if _649.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
        ...
        return constructor.new(_649.ShapingProcessSimulation)(self.wrapped.FinishProcessSimulation) if self.wrapped.FinishProcessSimulation else None

    @property
    def design(self) -> '_600.CylindricalGearDesign':
        ...
        return constructor.new(_600.CylindricalGearDesign)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def rough_gear_specification(self) -> '_740.CylindricalGearSpecification':
        ...
        return constructor.new(_740.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_740.CylindricalGearSpecification':
        ...
        return constructor.new(_740.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_611.CylindricalGearBlank':
        ...
        return constructor.new(_611.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None
