...
from mastapy.gears.manufacturing.cylindrical import _641, _642
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_641.MicroGeometryInputsLead':
        ...
        return constructor.new(_641.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_642.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_642.MicroGeometryInputsProfile))
        return value
