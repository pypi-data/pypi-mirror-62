...
from mastapy.gears.manufacturing.cylindrical import _649, _650
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_649.MicroGeometryInputsLead':
        ...
        return constructor.new(_649.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_650.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_650.MicroGeometryInputsProfile))
        return value
