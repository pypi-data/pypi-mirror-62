...
class SuitableCutterSetup(_1.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_741.ManufacturingOperationConstraints':
        ...
        return constructor.new(_741.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
