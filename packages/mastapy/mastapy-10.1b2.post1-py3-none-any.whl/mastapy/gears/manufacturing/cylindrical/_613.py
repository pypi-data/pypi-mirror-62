...
from mastapy.gears.manufacturing.cylindrical import _642, _643
...
class CylindricalGearSpecifiedMicroGeometry(_1.APIBase):
    ...
    @property
    def lead_measurement_method(self) -> '_653.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_653.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_653.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_653.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_653.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lead_micro_geometry(self) -> '_642.MicroGeometryInputsLead':
        ...
        return constructor.new(_642.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry else None

    @property
    def profile_micro_geometry(self) -> 'List[_643.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_643.MicroGeometryInputsProfile))
        return value
