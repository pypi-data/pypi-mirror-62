...
from mastapy.gears.manufacturing.cylindrical.cutters import _747
...
class CylindricalShaperDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_747.CylindricalGearShaper':
        ...
        return constructor.new(_747.CylindricalGearShaper)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_747.CylindricalGearShaper':
        ...
        return constructor.new(_747.CylindricalGearShaper)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaper: '_747.CylindricalGearShaper') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaper: '_747.CylindricalGearShaper', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaper: '_747.CylindricalGearShaper'):
    ...
    def get_all_items(self) -> 'Iterable[_747.CylindricalGearShaper]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_747.CylindricalGearShaper))

    def save_changes(self, cylindrical_gear_shaper: '_747.CylindricalGearShaper'):
