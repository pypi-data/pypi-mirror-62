...
from mastapy.gears.manufacturing.bevel import _699, _683
...
class ConicalMeshManufacturingAnalysis(_1066.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_699.EaseOffBasedTCA':
        ...
        return constructor.new(_699.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_683.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_683.ConicalMeshedGearManufacturingAnalysis))
        return value
