...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _845, _849
...
class ConicalMeshFlankManufacturingConfig(_803.ConicalMeshFlankMicroGeometryConfig):
    ...
    @property
    def control_parameters(self) -> '_839.ConicalGearManufacturingControlParameters':
        ...
        return constructor.new(_839.ConicalGearManufacturingControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_sgm_control_parameters(self) -> '_840.ConicalManufacturingSGMControlParameters':
        ...
        return constructor.new(_840.ConicalManufacturingSGMControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_sgt_control_parameters(self) -> '_841.ConicalManufacturingSGTControlParameters':
        ...
        return constructor.new(_841.ConicalManufacturingSGTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_smt_control_parameters(self) -> '_842.ConicalManufacturingSMTControlParameters':
        ...
        return constructor.new(_842.ConicalManufacturingSMTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def specified_phoenix_style_machine_settings(self) -> '_845.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_845.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedPhoenixStyleMachineSettings) if self.wrapped.SpecifiedPhoenixStyleMachineSettings else None

    @property
    def specified_cradle_style_machine_settings(self) -> '_849.CradleStyleConicalMachineSettingsGenerated':
        ...
        return constructor.new(_849.CradleStyleConicalMachineSettingsGenerated)(self.wrapped.SpecifiedCradleStyleMachineSettings) if self.wrapped.SpecifiedCradleStyleMachineSettings else None
