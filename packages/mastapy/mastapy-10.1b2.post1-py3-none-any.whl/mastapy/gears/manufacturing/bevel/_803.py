...
from mastapy.gears.gear_designs.conical.micro_geometry import _865
...
class ConicalMeshFlankMicroGeometryConfig(_1.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_865.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_865.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
