...
from mastapy.gears.gear_designs.conical.micro_geometry import _898
...
class ConicalMeshFlankMicroGeometryConfig(_1.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_898.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_898.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
