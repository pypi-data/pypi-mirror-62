...
class AbstractTCA(_1.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_907.ConicalMeshMisalignments':
        ...
        return constructor.new(_907.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
