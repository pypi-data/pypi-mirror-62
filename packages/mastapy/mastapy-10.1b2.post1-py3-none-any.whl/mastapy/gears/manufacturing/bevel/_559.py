...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _601, _602
...
class ConicalMeshFlankManufacturingConfig(_560.ConicalMeshFlankMicroGeometryConfig):
    '''ConicalMeshFlankManufacturingConfig
    ...
    @property
    def control_parameters(self) -> '_595.ConicalGearManufacturingControlParameters':
        ...
        return constructor.new(_595.ConicalGearManufacturingControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_sgm_control_parameters(self) -> '_596.ConicalManufacturingSGMControlParameters':
        ...
        if _596.ConicalManufacturingSGMControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
        ...
        return constructor.new(_596.ConicalManufacturingSGMControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_sgt_control_parameters(self) -> '_597.ConicalManufacturingSGTControlParameters':
        ...
        if _597.ConicalManufacturingSGTControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
        ...
        return constructor.new(_597.ConicalManufacturingSGTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def control_parameters_of_type_conical_manufacturing_smt_control_parameters(self) -> '_598.ConicalManufacturingSMTControlParameters':
        ...
        if _598.ConicalManufacturingSMTControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
        ...
        return constructor.new(_598.ConicalManufacturingSMTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None

    @property
    def specified_phoenix_style_machine_settings(self) -> '_601.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_601.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedPhoenixStyleMachineSettings) if self.wrapped.SpecifiedPhoenixStyleMachineSettings else None
