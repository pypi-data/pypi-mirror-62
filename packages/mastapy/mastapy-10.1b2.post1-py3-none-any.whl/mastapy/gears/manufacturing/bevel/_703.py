...
from mastapy.gears.manufacturing.bevel import _702, _716
...
class ManufacturingMachine(_1439.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_702.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_702.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_702.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_716.WheelFormatMachineTypes':
        ...
        return constructor.new(_716.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_716.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
