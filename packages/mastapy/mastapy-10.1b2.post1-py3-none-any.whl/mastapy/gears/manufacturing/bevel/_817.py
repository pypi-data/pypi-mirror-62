...
from mastapy.gears.manufacturing.bevel import _826, _819
...
class ConicalMeshManufacturingConfig(_819.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_826.ConicalWheelManufacturingConfig':
