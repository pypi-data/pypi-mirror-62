...
from mastapy.gears.manufacturing.bevel import _572, _565
...
class ConicalMeshManufacturingConfig(_565.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_572.ConicalWheelManufacturingConfig':
