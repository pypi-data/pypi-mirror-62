...
class AbstractTCA(_1.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_1006.ConicalMeshMisalignments':
        ...
        return constructor.new(_1006.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
