...
from mastapy.gears.manufacturing.bevel import _831
...
class ManufacturingMachineDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_831.ManufacturingMachine':
        ...
        return constructor.new(_831.ManufacturingMachine)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_831.ManufacturingMachine':
        ...
        return constructor.new(_831.ManufacturingMachine)(method_result) if method_result else None

    def can_be_removed(self, manufacturing_machine: '_831.ManufacturingMachine') -> 'bool':
    ...
    def rename(self, manufacturing_machine: '_831.ManufacturingMachine', new_name: 'str') -> 'bool':
    ...
    def remove(self, manufacturing_machine: '_831.ManufacturingMachine'):
    ...
    def get_all_items(self) -> 'Iterable[_831.ManufacturingMachine]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_831.ManufacturingMachine))

    def save_changes(self, manufacturing_machine: '_831.ManufacturingMachine'):
