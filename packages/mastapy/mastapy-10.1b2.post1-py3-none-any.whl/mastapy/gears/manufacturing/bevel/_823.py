...
from mastapy.gears.gear_designs.conical import _957, _958
from mastapy._internal import constructor, conversion
from mastapy.gears.manufacturing.bevel import _808, _817, _825
...
class ConicalSetManufacturingConfig(_825.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_808.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_808.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_817.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_817.ConicalMeshManufacturingConfig))
        return value
