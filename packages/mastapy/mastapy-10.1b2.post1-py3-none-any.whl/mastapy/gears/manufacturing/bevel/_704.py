...
from mastapy.gears.manufacturing.bevel import _703
...
class ManufacturingMachineDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_703.ManufacturingMachine':
        ...
        return constructor.new(_703.ManufacturingMachine)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_703.ManufacturingMachine':
        ...
        return constructor.new(_703.ManufacturingMachine)(method_result) if method_result else None

    def can_be_removed(self, manufacturing_machine: '_703.ManufacturingMachine') -> 'bool':
    ...
    def rename(self, manufacturing_machine: '_703.ManufacturingMachine', new_name: 'str') -> 'bool':
    ...
    def remove(self, manufacturing_machine: '_703.ManufacturingMachine'):
    ...
    def get_all_items(self) -> 'Iterable[_703.ManufacturingMachine]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_703.ManufacturingMachine))

    def save_changes(self, manufacturing_machine: '_703.ManufacturingMachine'):
