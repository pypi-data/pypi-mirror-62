...
class ConicalGearMicroGeometryConfigBase(_742.GearImplementationDetail):
    '''ConicalGearMicroGeometryConfigBase
    ...
    @property
    def flank_measurement_border(self) -> '_814.FlankMeasurementBorder':
        ...
        return constructor.new(_814.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
