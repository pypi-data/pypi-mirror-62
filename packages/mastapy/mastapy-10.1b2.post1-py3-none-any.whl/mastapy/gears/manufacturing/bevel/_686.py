...
from mastapy.gears.gear_designs.conical.micro_geometry import _1019
...
class ConicalMeshFlankMicroGeometryConfig(_1.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_1019.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_1019.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
