...
class ConicalSetMicroGeometryConfigBase(_953.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_128.DeflectionFromBendingOption':
        ...
        return constructor.new(_128.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_128.DeflectionFromBendingOption'):
