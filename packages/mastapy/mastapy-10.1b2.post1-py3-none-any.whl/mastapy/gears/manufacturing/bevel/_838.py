...
from mastapy.gears.gear_designs.conical import _988
...
class PinionFinishMachineSettings(_293.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_988.TopremLetter':
