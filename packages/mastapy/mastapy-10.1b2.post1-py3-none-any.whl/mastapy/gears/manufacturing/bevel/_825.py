...
class ConicalSetMicroGeometryConfigBase(_746.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_300.DeflectionFromBendingOption':
        ...
        return constructor.new(_300.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_300.DeflectionFromBendingOption'):
