...
from mastapy.gears.gear_designs.conical import _1017
from mastapy.gears import _252
...
class PinionFinishMachineSettings(_252.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_1017.TopremLetter':
