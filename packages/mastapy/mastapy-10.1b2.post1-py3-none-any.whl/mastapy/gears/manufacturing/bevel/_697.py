...
from mastapy.gears import _257
...
class ConicalSetMicroGeometryConfigBase(_1074.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_257.DeflectionFromBendingOption':
        ...
        return constructor.new(_257.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_257.DeflectionFromBendingOption'):
