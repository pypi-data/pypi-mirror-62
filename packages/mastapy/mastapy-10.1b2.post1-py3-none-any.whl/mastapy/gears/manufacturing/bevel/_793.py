...
from mastapy.gears.gear_designs.conical import _921
...
class AbstractTCA(_1.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_921.ConicalMeshMisalignments':
        ...
        return constructor.new(_921.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
