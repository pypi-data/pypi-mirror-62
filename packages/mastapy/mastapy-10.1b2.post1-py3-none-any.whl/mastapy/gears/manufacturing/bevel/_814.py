...
from mastapy.gears.gear_designs.conical.micro_geometry import _875
...
class ConicalMeshFlankMicroGeometryConfig(_1.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_875.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_875.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
