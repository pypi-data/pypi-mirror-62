...
from mastapy.gears.manufacturing.bevel import _830, _844
...
class ManufacturingMachine(_94.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_830.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_830.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_830.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_844.WheelFormatMachineTypes':
        ...
        return constructor.new(_844.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_844.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
