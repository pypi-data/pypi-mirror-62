...
from mastapy.gears.gear_designs.conical import _883, _882
from mastapy._internal import conversion, enum_with_selected_value_runtime, constructor
from mastapy.gears.manufacturing.bevel import _554, _563, _571
...
class ConicalSetManufacturingConfig(_571.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_554.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_554.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_563.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_563.ConicalMeshManufacturingConfig))
        return value
