...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _853
...
class BasicConicalGearMachineSettingsGenerated(_853.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
