...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _725
...
class BasicConicalGearMachineSettingsGenerated(_725.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
