...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _832
...
class BasicConicalGearMachineSettingsGenerated(_832.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
