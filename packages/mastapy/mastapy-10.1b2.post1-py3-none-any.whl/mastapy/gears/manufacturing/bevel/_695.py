...
from mastapy.gears.gear_designs.conical import _1004, _1003
from mastapy._internal import conversion, enum_with_selected_value_runtime, constructor
from mastapy.gears.manufacturing.bevel import _680, _689, _697
...
class ConicalSetManufacturingConfig(_697.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_680.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_680.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_689.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_689.ConicalMeshManufacturingConfig))
        return value
