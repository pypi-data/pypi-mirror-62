...
from mastapy.gears.manufacturing.bevel.cutters import _848, _847
...
class ConicalWheelManufacturingConfig(_808.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_848.WheelRoughCutter':
        ...
        return constructor.new(_848.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter else None

    @property
    def wheel_finish_cutter(self) -> '_847.WheelFinishCutter':
        ...
        return constructor.new(_847.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter else None
    ...
    @property
    def specified_machine_settings(self) -> '_853.BasicConicalGearMachineSettings':
        ...
        return constructor.new(_853.BasicConicalGearMachineSettings)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None

    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_854.BasicConicalGearMachineSettingsFormate':
        ...
        if _854.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
        ...
        return constructor.new(_854.BasicConicalGearMachineSettingsFormate)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None

    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_855.BasicConicalGearMachineSettingsGenerated':
        ...
        if _855.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
        ...
        return constructor.new(_855.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None
