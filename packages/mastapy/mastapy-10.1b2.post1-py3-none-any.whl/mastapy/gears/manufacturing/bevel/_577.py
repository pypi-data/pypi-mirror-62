...
from mastapy.gears.manufacturing.bevel import _576, _590
...
class ManufacturingMachine(_1323.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_576.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_576.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_576.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_590.WheelFormatMachineTypes':
        ...
        return constructor.new(_590.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_590.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
