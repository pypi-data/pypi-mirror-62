...
class CylindricalMeshLoadCase(_351.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_965.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_965.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
