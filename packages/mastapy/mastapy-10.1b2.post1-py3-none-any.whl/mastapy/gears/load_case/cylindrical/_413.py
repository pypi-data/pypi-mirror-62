...
from mastapy.gears import _304, _297
from mastapy.gears.gear_designs.cylindrical import _931
...
class CylindricalMeshLoadCase(_410.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_304.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_304.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_304.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_931.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_931.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
