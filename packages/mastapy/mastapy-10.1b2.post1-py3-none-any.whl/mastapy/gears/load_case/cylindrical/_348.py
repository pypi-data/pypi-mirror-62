...
from mastapy.gears import _299, _298
...
class CylindricalMeshLoadCase(_345.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_299.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_299.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_299.CylindricalMisalignmentDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MisalignmentSource = value

    @property
    def active_flank(self) -> '_298.CylindricalFlanks':
        ...
        return constructor.new(_298.CylindricalFlanks)(value) if value else None
    ...
    @property
    def load_case_modifiable_settings(self) -> '_957.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_957.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
