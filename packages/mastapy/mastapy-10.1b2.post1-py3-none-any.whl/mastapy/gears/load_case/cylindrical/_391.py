...
from mastapy.gears.gear_designs.cylindrical import _926
from mastapy.gears.load_case import _388
...
class CylindricalMeshLoadCase(_388.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_926.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_926.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
