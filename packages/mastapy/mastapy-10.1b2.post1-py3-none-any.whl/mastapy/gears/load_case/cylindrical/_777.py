...
from mastapy.gears import _256, _255
...
class CylindricalMeshLoadCase(_768.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_256.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_256.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_256.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_924.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_924.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
