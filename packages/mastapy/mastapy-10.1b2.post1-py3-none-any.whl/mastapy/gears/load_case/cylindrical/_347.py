...
from mastapy.gears import _298, _297
...
class CylindricalMeshLoadCase(_344.MeshLoadCase):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_936.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_936.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
