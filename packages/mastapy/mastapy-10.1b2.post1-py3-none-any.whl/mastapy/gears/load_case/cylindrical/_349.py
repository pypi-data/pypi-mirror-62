...
from mastapy.gears import _298, _296
...
class CylindricalMeshLoadCase(_346.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_298.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_298.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_298.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_989.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_989.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
