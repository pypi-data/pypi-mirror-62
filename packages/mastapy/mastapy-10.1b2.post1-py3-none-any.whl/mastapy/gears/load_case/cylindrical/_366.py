...
from mastapy.gears import _297, _294
from mastapy.gears.gear_designs.cylindrical import _920
...
class CylindricalMeshLoadCase(_363.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_297.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_297.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_297.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_920.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_920.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
