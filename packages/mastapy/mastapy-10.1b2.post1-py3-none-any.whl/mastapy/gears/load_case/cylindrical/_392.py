...
from mastapy.gears import _301, _294
...
class CylindricalMeshLoadCase(_389.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_946.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_946.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
