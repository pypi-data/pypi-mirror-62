...
from mastapy.gears import _296, _294
...
class CylindricalMeshLoadCase(_343.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_949.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_949.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
