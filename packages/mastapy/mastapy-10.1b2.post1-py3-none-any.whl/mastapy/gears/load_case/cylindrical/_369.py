...
from mastapy.gears.load_case import _366
...
class CylindricalMeshLoadCase(_366.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_970.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_970.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
