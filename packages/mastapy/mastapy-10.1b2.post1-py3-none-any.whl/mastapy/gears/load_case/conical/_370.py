...
from mastapy.gears.gear_designs.conical import _991, _896
...
class ConicalMeshLoadCase(_366.MeshLoadCase):
    '''ConicalMeshLoadCase
    ...
    @property
    def active_flank(self) -> '_991.ActiveConicalFlank':
        ...
        return constructor.new(_991.ActiveConicalFlank)(value) if value else None
