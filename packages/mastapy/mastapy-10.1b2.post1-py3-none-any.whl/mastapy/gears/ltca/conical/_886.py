...
from mastapy.gears.load_case.conical import _414
from mastapy.gears.manufacturing.bevel import _817
from mastapy.gears.ltca.conical import _885
...
class ConicalMeshLoadDistributionAnalysis(_865.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_414.ConicalMeshLoadCase':
        ...
        return constructor.new(_414.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None

    @property
    def conical_mesh_manufacturing_analysis(self) -> '_817.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_817.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_885.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_885.ConicalMeshedGearLoadDistributionAnalysis))
        return value
