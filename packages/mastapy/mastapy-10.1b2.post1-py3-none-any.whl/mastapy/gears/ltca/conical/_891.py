...
from mastapy.gears.cylindrical import _1080, _1081
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1080.GearLTCAContactCharts':
        ...
        return constructor.new(_1080.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1081.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1081.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
