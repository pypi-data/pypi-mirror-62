...
from mastapy.gears.cylindrical import _936, _935
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_936.GearLTCAContactCharts':
        ...
        return constructor.new(_936.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_935.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_935.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
