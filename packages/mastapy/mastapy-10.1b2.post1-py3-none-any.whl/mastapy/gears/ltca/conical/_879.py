...
from mastapy.gears.cylindrical import _1045, _1046
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1045.GearLTCAContactCharts':
        ...
        return constructor.new(_1045.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1046.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1046.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
