...
from mastapy.gears.cylindrical import _1082, _1083
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1082.GearLTCAContactCharts':
        ...
        return constructor.new(_1082.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1083.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1083.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
