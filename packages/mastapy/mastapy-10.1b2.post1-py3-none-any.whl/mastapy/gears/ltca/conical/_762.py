...
from mastapy.gears.cylindrical import _1057, _1056
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1057.GearLTCAContactCharts':
        ...
        return constructor.new(_1057.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1056.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1056.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
