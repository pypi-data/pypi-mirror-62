...
from mastapy.gears.load_case.conical import _367
...
class ConicalMeshLoadDistributionAnalysis(_857.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_367.ConicalMeshLoadCase':
        ...
        return constructor.new(_367.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None
    ...
    @property
    def meshed_gears(self) -> 'List[_879.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_879.ConicalMeshedGearLoadDistributionAnalysis))
        return value
