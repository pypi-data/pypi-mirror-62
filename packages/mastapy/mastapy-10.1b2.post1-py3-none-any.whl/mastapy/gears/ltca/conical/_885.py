...
from mastapy.gears.cylindrical import _900, _901
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_900.GearLTCAContactCharts':
        ...
        return constructor.new(_900.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_901.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_901.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
