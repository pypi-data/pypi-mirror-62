...
from mastapy.gears.ltca.conical import _896
...
class ConicalMeshLoadDistributionAnalysis(_862.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_816.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_816.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_896.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_896.ConicalMeshedGearLoadDistributionAnalysis))
        return value
