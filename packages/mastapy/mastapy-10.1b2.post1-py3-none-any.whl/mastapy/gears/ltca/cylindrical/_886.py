...
from mastapy.gears.ltca import _858, _862
from mastapy.gears.ltca.cylindrical import _888, _890
...
class CylindricalGearMeshLoadDistributionAnalysis(_862.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_349.CylindricalMeshLoadCase':
        ...
        return constructor.new(_349.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_858.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_858.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_858.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_858.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_890.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_890.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_858.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_858.CylindricalMeshedGearLoadDistributionAnalysis))
        return value

    @property
    def transmission_error_against_rotation(self) -> 'List[_1063.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorAgainstRotation, constructor.new(_1063.Vector2D))
        return value
