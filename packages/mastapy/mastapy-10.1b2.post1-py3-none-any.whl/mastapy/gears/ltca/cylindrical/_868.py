...
class CylindricalGearLoadDistributionAnalysis(_856.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_468.CylindricalGearRating':
        ...
        return constructor.new(_468.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
