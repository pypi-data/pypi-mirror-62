...
class CylindricalGearLoadDistributionAnalysis(_862.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_488.CylindricalGearRating':
        ...
        return constructor.new(_488.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
