...
from mastapy.gears.ltca import _867
...
class CylindricalGearMeshLoadedContactLine(_867.GearMeshLoadedContactLine):
    '''CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_877.CylindricalGearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_877.CylindricalGearMeshLoadedContactPoint))
        return value
