...
from mastapy.gears.ltca.cylindrical import _887
...
class CylindricalMeshLoadDistributionAtRotation(_863.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_1043.MeshAlignment':
        ...
        return constructor.new(_1043.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None

    @property
    def loaded_contact_lines(self) -> 'List[_887.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_887.CylindricalGearMeshLoadedContactLine))
        return value
