...
from mastapy.gears.ltca import _739
...
class CylindricalGearMeshLoadedContactPoint(_739.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement else None

    @property
    def gear_b_profile_measurement(self) -> '_896.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_896.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement else None
