...
from mastapy.gears.ltca import _740
...
class CylindricalGearSetLoadDistributionAnalysis(_740.GearSetLoadDistributionAnalysis):
    '''CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def meshes(self) -> 'List[_750.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_750.CylindricalGearMeshLoadDistributionAnalysis))
        return value
