...
from mastapy.gears.ltca import _738
...
class CylindricalGearMeshLoadedContactLine(_738.GearMeshLoadedContactLine):
    '''CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_752.CylindricalGearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_752.CylindricalGearMeshLoadedContactPoint))
        return value
