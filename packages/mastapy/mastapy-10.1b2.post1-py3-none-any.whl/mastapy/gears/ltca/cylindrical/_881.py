...
from mastapy.gears.load_case.cylindrical import _348
from mastapy.gears.ltca import _859, _863
from mastapy.gears.ltca.cylindrical import _883, _885
from mastapy.math_utility import _1016
...
class CylindricalGearMeshLoadDistributionAnalysis(_863.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_486.CylindricalGearMeshRating':
        ...
        return constructor.new(_486.CylindricalGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def cylindrical_mesh_load_case(self) -> '_348.CylindricalMeshLoadCase':
        ...
        return constructor.new(_348.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_859.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_859.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_859.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_859.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_883.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_883.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_885.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_885.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_859.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_859.CylindricalMeshedGearLoadDistributionAnalysis))
        return value

    @property
    def transmission_error_against_rotation(self) -> 'List[_1016.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorAgainstRotation, constructor.new(_1016.Vector2D))
        return value
