...
from mastapy.gears.ltca.cylindrical import _883
...
class CylindricalGearMeshLoadedContactLine(_865.GearMeshLoadedContactLine):
    '''CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_883.CylindricalGearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_883.CylindricalGearMeshLoadedContactPoint))
        return value
