...
class CylindricalGearLoadDistributionAnalysis(_735.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_386.CylindricalGearRating':
        ...
        return constructor.new(_386.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
