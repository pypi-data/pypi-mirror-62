...
from mastapy.gears.gear_designs.cylindrical import _559
...
class CylindricalGearMeshLoadedContactPoint(_860.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_559.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_559.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement else None

    @property
    def gear_b_profile_measurement(self) -> '_559.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_559.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement else None
