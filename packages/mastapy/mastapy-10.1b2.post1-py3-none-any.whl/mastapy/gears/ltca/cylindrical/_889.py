...
from mastapy.gears.ltca.cylindrical import _886
from mastapy.gears.ltca import _866
...
class CylindricalGearSetLoadDistributionAnalysis(_866.GearSetLoadDistributionAnalysis):
    '''CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def meshes(self) -> 'List[_886.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_886.CylindricalGearMeshLoadDistributionAnalysis))
        return value
