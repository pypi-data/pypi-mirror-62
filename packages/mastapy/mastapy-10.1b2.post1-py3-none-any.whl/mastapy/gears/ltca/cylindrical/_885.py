...
class CylindricalGearLoadDistributionAnalysis(_861.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_486.CylindricalGearRating':
        ...
        return constructor.new(_486.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
