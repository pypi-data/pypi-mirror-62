...
from mastapy.gears.ltca import _737, _735
from mastapy.gears import _258
from mastapy.nodal_analysis import _79
from mastapy.gears.analysis import _1066
...
class GearMeshLoadDistributionAnalysis(_1066.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1184.FourierSeries':
        ...
        return constructor.new(_1184.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_737.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_737.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_735.GearLoadDistributionAnalysis', flank: '_258.GearFlanks', stress_type: '_79.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_735.GearLoadDistributionAnalysis', stress_type: '_79.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
