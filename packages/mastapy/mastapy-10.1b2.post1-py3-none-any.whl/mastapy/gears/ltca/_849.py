...
from mastapy.gears.cylindrical import _889, _890
from mastapy.gears.ltca import _848
from mastapy.math_utility import _891
...
class CylindricalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_889.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_889.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_890.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_890.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_848.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_891.GriddedSurface':
        ...
        return constructor.new(_891.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_848.ContactResultType', include_tip_contact: 'bool') -> '_891.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_848.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
