...
class GearMeshLoadDistributionAtRotation(_1.APIBase):
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_864.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_864.GearMeshLoadedContactLine))
        return value
