...
from mastapy.gears.cylindrical import _922, _923
from mastapy.gears.ltca import _850
from mastapy.math_utility import _924
...
class CylindricalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_922.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_922.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_923.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_923.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_850.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_924.GriddedSurface':
        ...
        return constructor.new(_924.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_850.ContactResultType', include_tip_contact: 'bool') -> '_924.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
