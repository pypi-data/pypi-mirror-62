...
from mastapy.gears.cylindrical import _1055, _1054
from mastapy.gears.ltca import _729
from mastapy.math_utility import _1185
...
class CylindricalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1055.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_1055.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1054.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1054.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_729.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1185.GriddedSurface':
        ...
        return constructor.new(_1185.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_729.ContactResultType', include_tip_contact: 'bool') -> '_1185.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_729.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
