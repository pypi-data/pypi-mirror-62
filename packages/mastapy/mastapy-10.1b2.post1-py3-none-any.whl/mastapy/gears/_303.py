...
from mastapy.materials import _263, _249
...
class GearSetDesignGroup(_1.APIBase):
    ...
    @property
    def general_transmission_properties(self) -> '_249.GeneralTransmissionProperties':
        ...
        return constructor.new(_249.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None
