...
from mastapy.nodal_analysis import _83, _103, _101
...
class FEMeshingOptions(_1.APIBase):
    ...
    @property
    def element_order(self) -> '_83.ElementOrder':
        '''ElementOrder: 'ElementOrder' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ElementOrder)
        return constructor.new(_83.ElementOrder)(value) if value else None

    @element_order.setter
    def element_order(self, value: '_83.ElementOrder'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ElementOrder = value

    @property
    def element_shape(self) -> '_103.VolumeElementShape':
        ...
        return constructor.new(_103.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_103.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_101.MeshingDiameterForGear':
        ...
        return constructor.new(_101.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_101.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
