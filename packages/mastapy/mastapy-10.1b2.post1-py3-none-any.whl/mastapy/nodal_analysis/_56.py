...
from mastapy.nodal_analysis import _54, _84, _70
...
class FEMeshingOptions(_1.APIBase):
    ...
    @property
    def element_order(self) -> '_54.ElementOrder':
        '''ElementOrder: 'ElementOrder' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ElementOrder)
        return constructor.new(_54.ElementOrder)(value) if value else None

    @element_order.setter
    def element_order(self, value: '_54.ElementOrder'):
