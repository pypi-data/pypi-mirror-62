...
from mastapy.nodal_analysis import _1357, _1365
...
class FEStiffness(_1.APIBase):
    ...
    @property
    def gravity_force_source(self) -> '_1357.GravityForceSource':
        ...
        return constructor.new(_1357.GravityForceSource)(value) if value else None
    ...
    @property
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(self.wrapped.StiffnessInFECoordinateSystemMNRad) if self.wrapped.StiffnessInFECoordinateSystemMNRad else None

    @property
    def mass_matrix_mn_rad_s_kg(self) -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(self.wrapped.MassMatrixMNRadSKg) if self.wrapped.MassMatrixMNRadSKg else None
    ...
    @property
    def stiffness_matrix(self) -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None
