...
class TransientSolverOptions(_1.APIBase):
    ...
    @property
    def damping_scaling_for_initial_transients(self) -> '_52.DampingScalingTypeForInitialTransients':
        ...
        return constructor.new(_52.DampingScalingTypeForInitialTransients)(value) if value else None

    @damping_scaling_for_initial_transients.setter
    def damping_scaling_for_initial_transients(self, value: '_52.DampingScalingTypeForInitialTransients'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
