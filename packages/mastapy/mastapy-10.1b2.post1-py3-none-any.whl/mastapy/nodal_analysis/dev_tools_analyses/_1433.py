...
from mastapy.nodal_analysis.dev_tools_analyses import _1451
...
class EigenvalueOptions(_1.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_1451.MassMatrixType':
        ...
        return constructor.new(_1451.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_1451.MassMatrixType'):
