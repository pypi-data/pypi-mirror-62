...
class FEModelTabDrawStyle(_1.APIBase):
    ...
    @property
    def draw_style(self) -> '_177.DrawStyleForImportedFE':
        ...
        return constructor.new(_177.DrawStyleForImportedFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None
