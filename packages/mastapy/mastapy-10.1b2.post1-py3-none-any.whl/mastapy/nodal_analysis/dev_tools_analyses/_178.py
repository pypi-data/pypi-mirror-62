...
from mastapy.nodal_analysis import _102
from mastapy._internal import constructor, conversion
from mastapy.nodal_analysis.dev_tools_analyses import _196
...
class EigenvalueOptions(_1.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_196.MassMatrixType':
        ...
        return constructor.new(_196.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_196.MassMatrixType'):
