...
class DrawStyleForImportedFE(_1.APIBase):
    ...
    @property
    def line_option(self) -> '_55.FEMeshElementEntityOption':
        ...
        return constructor.new(_55.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_55.FEMeshElementEntityOption'):
