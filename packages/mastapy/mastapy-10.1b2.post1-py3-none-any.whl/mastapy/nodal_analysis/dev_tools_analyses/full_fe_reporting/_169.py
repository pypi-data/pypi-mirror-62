...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _175, _165
...
class ElementPropertiesRigid(_165.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_175.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_175.RigidElementNodeDegreesOfFreedom))
        return value
