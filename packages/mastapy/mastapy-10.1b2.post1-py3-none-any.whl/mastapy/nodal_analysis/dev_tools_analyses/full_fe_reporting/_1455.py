...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _956, _957
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_956.ContactPairMasterType':
        ...
        return constructor.new(_956.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_957.ContactPairSlaveType':
        ...
        return constructor.new(_957.ContactPairSlaveType)(value) if value else None
