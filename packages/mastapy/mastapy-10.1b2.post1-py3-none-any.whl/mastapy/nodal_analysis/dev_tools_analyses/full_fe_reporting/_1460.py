...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1457
...
class ElementPropertiesMass(_1457.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1066.InertiaTensor':
        ...
        return constructor.new(_1066.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
