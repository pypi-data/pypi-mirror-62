...
from mastapy.fe_tools.enums import _1080
...
class ElementPropertiesBase(_1.APIBase):
    ...
    @property
    def class_(self) -> '_1080.ElementPropertyClass':
        ...
        return constructor.new(_1080.ElementPropertyClass)(value) if value else None
