...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _232
...
class ElementPropertiesBeam(_210.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_232.BeamSectionType':
        ...
        return constructor.new(_232.BeamSectionType)(value) if value else None
