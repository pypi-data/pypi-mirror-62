...
from mastapy.fe_tools.enums import _231
...
class ElementPropertiesBase(_1.APIBase):
    ...
    @property
    def class_(self) -> '_231.ElementPropertyClass':
        ...
        return constructor.new(_231.ElementPropertyClass)(value) if value else None
