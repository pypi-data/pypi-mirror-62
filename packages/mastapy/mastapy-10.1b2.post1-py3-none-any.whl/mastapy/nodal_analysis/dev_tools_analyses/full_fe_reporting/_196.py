...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _248, _249
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_248.ContactPairMasterType':
        ...
        return constructor.new(_248.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_249.ContactPairSlaveType':
        ...
        return constructor.new(_249.ContactPairSlaveType)(value) if value else None
