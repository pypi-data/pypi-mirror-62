...
from mastapy.fe_tools.enums import _228
...
class ElementPropertiesBase(_1.APIBase):
    ...
    @property
    def class_(self) -> '_228.ElementPropertyClass':
        ...
        return constructor.new(_228.ElementPropertyClass)(value) if value else None
