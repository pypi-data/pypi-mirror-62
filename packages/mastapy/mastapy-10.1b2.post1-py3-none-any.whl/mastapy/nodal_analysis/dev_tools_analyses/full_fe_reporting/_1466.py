...
from mastapy.fe_tools.enums import _960
...
class MaterialPropertiesReporting(_1.APIBase):
    ...
    @property
    def class_(self) -> '_960.MaterialPropertyClass':
        ...
        return constructor.new(_960.MaterialPropertyClass)(value) if value else None
