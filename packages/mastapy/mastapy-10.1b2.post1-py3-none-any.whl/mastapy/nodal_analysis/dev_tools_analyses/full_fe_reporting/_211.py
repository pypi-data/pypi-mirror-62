...
from mastapy.fe_tools.enums import _233
...
class MaterialPropertiesReporting(_1.APIBase):
    ...
    @property
    def class_(self) -> '_233.MaterialPropertyClass':
        ...
        return constructor.new(_233.MaterialPropertyClass)(value) if value else None
