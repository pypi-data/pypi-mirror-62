...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _213, _205
...
class ElementPropertiesRigid(_205.ElementPropertiesBase):
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_213.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_213.RigidElementNodeDegreesOfFreedom))
        return value
