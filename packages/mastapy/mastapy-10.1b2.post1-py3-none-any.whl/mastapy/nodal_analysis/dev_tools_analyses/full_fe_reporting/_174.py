...
from mastapy.fe_tools.enums import _1081
...
class MaterialPropertiesReporting(_1.APIBase):
    ...
    @property
    def class_(self) -> '_1081.MaterialPropertyClass':
        ...
        return constructor.new(_1081.MaterialPropertyClass)(value) if value else None
