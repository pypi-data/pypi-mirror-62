...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _252, _253
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_252.ContactPairMasterType':
        ...
        return constructor.new(_252.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_253.ContactPairSlaveType':
        ...
        return constructor.new(_253.ContactPairSlaveType)(value) if value else None
