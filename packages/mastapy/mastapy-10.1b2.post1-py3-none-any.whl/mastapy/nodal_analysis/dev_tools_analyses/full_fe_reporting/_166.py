...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1076
...
class ElementPropertiesBeam(_173.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1076.BeamSectionType':
        ...
        return constructor.new(_1076.BeamSectionType)(value) if value else None
