...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _165
...
class ElementPropertiesMass(_165.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1187.InertiaTensor':
        ...
        return constructor.new(_1187.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
