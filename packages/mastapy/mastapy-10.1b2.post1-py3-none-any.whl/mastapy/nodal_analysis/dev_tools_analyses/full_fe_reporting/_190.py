...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _247
...
class ElementPropertiesBeam(_210.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_247.BeamSectionType':
        ...
        return constructor.new(_247.BeamSectionType)(value) if value else None
