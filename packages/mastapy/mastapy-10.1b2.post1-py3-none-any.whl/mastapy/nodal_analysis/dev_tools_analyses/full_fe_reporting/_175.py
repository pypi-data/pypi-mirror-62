...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _164
...
class RigidElementNodeDegreesOfFreedom(_1.APIBase):
    ...
    @property
    def type_(self) -> '_164.DegreeOfFreedomType':
        ...
        return constructor.new(_164.DegreeOfFreedomType)(value) if value else None
