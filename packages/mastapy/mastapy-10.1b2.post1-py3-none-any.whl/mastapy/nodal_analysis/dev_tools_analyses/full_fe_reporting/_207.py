...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _234
...
class ElementPropertiesShell(_210.ElementPropertiesWithMaterial):
    ...
    @property
    def wall_type(self) -> '_234.ElementPropertiesShellWallType':
        ...
        return constructor.new(_234.ElementPropertiesShellWallType)(value) if value else None
