...
from mastapy.fe_tools.enums import _258
...
class MaterialPropertiesReporting(_1.APIBase):
    ...
    @property
    def class_(self) -> '_258.MaterialPropertyClass':
        ...
        return constructor.new(_258.MaterialPropertyClass)(value) if value else None
