...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _202
...
class ElementPropertiesMass(_202.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_215.InertiaTensor':
        ...
        return constructor.new(_215.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
