...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1467, _1457
...
class ElementPropertiesRigid(_1457.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1467.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1467.RigidElementNodeDegreesOfFreedom))
        return value
