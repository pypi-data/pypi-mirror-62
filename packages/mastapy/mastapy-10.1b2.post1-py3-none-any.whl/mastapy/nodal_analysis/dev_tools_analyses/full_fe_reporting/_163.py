...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1077, _1078
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_1077.ContactPairMasterType':
        ...
        return constructor.new(_1077.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_1078.ContactPairSlaveType':
        ...
        return constructor.new(_1078.ContactPairSlaveType)(value) if value else None
