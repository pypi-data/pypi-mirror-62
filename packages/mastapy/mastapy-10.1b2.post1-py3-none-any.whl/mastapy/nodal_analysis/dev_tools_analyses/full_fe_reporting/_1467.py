...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1456
...
class RigidElementNodeDegreesOfFreedom(_1.APIBase):
    ...
    @property
    def type_(self) -> '_1456.DegreeOfFreedomType':
        ...
        return constructor.new(_1456.DegreeOfFreedomType)(value) if value else None
