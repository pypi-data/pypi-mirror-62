...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _212, _202
...
class ElementPropertiesRigid(_202.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_212.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_212.RigidElementNodeDegreesOfFreedom))
        return value
