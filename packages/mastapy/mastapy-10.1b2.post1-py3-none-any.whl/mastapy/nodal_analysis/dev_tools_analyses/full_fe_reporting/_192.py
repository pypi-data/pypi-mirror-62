...
from mastapy.math_utility import _212
...
class ElementPropertiesMass(_194.ElementPropertiesBase):
    ...
    @property
    def inertia(self) -> '_212.InertiaTensor':
        ...
        return constructor.new(_212.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
