...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _203, _204
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_203.ContactPairMasterType':
        ...
        return constructor.new(_203.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_204.ContactPairSlaveType':
        ...
        return constructor.new(_204.ContactPairSlaveType)(value) if value else None
