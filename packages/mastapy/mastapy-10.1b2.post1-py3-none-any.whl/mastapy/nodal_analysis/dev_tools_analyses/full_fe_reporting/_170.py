...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1079
...
class ElementPropertiesShell(_173.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_1079.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1079.ElementPropertiesShellWallType)(value) if value else None
