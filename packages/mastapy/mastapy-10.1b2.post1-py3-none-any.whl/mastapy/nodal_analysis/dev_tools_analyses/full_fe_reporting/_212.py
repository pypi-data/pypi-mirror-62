...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _201
...
class RigidElementNodeDegreesOfFreedom(_1.APIBase):
    ...
    @property
    def type_(self) -> '_201.DegreeOfFreedomType':
        ...
        return constructor.new(_201.DegreeOfFreedomType)(value) if value else None
