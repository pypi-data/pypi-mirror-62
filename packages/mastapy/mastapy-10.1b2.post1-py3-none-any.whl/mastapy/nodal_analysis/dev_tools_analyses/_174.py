...
class DrawStyleForImportedFE(_1.APIBase):
    ...
    @property
    def line_option(self) -> '_84.FEMeshElementEntityOption':
        ...
        return constructor.new(_84.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_84.FEMeshElementEntityOption'):
