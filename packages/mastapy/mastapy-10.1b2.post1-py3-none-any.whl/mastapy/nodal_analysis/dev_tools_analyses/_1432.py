...
from mastapy.nodal_analysis import _1348
...
class DrawStyleForImportedFE(_1.APIBase):
    ...
    @property
    def line_option(self) -> '_1348.FEMeshElementEntityOption':
        ...
        return constructor.new(_1348.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1348.FEMeshElementEntityOption'):
