...
from mastapy.nodal_analysis.dev_tools_analyses import _140
...
class FEModelInstanceDrawStyle(_1.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_140.DrawStyleForImportedFE':
        ...
        return constructor.new(_140.DrawStyleForImportedFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
