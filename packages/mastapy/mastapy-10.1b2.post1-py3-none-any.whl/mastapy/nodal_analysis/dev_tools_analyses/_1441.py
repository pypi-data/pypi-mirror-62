...
class FEModelInstanceDrawStyle(_1.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_1432.DrawStyleForImportedFE':
        ...
        return constructor.new(_1432.DrawStyleForImportedFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
