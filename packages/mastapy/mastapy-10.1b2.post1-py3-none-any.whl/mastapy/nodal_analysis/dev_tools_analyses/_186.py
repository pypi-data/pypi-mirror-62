...
class FEModelInstanceDrawStyle(_1.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_177.DrawStyleForImportedFE':
        ...
        return constructor.new(_177.DrawStyleForImportedFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
