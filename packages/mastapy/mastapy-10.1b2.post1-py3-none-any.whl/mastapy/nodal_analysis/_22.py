...
from mastapy.nodal_analysis import _85, _86
...
class AnalysisSettings(_67.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_shaft_reliability(self) -> '_86.RatingTypeForShaftReliability':
        ...
        return constructor.new(_86.RatingTypeForShaftReliability)(value) if value else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_86.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
