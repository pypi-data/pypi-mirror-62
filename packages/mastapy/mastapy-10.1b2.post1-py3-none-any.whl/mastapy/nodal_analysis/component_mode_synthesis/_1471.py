...
class CMSOptions(_1.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1057.DataPrecision':
        ...
        return constructor.new(_1057.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1057.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1433.EigenvalueOptions':
        ...
        return constructor.new(_1433.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
