...
from mastapy.math_utility import _297
...
class CMSOptions(_1.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_297.DataPrecision':
        ...
        return constructor.new(_297.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_297.DataPrecision'):
