...
from mastapy.nodal_analysis.component_mode_synthesis import _217, _213
...
class FullFEModel(_1.APIBase):
    ...
    def fe_model(self) -> '_183.FEModel':
        ...
        return constructor.new(_183.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_217.CMSOptions':
        ...
        return constructor.new(_217.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_213.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_213.CMSElementFaceGroup))
        return value
