...
from mastapy.math_utility import _1178
...
class CMSOptions(_1.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1178.DataPrecision':
        ...
        return constructor.new(_1178.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1178.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_141.EigenvalueOptions':
        ...
        return constructor.new(_141.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
