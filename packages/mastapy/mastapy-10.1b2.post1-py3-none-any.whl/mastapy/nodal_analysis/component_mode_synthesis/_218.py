...
from mastapy.math_utility import _271
...
class CMSOptions(_1.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_271.DataPrecision':
        ...
        return constructor.new(_271.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_271.DataPrecision'):
    ...
    def internal_mode_options(self) -> '_178.EigenvalueOptions':
        ...
        return constructor.new(_178.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
