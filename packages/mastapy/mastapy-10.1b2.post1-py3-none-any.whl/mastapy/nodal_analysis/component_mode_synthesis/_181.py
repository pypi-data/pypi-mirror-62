...
from mastapy.nodal_analysis.dev_tools_analyses import _146
from mastapy.nodal_analysis.component_mode_synthesis import _179, _176
...
class FullFEModel(_1.APIBase):
    ...
    @property
    def fe_model(self) -> '_146.FEModel':
        ...
        return constructor.new(_146.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_179.CMSOptions':
        ...
        return constructor.new(_179.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_176.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_176.CMSElementFaceGroup))
        return value
