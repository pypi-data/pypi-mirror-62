...
from mastapy.nodal_analysis import _119
from mastapy.nodal_analysis.system_solvers import _132
...
class TransientSolver(_132.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_119.TransientSolverStatus':
        ...
        return constructor.new(_119.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_119.TransientSolverStatus'):
