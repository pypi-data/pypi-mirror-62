...
from mastapy.nodal_analysis.system_solvers import _1387
...
class TransientSolver(_1387.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1373.TransientSolverStatus':
        ...
        return constructor.new(_1373.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1373.TransientSolverStatus'):
