...
class SingularVectorAnalysis(_1.APIBase):
    ...
    @property
    def largest_singular_vector_components(self) -> 'List[_142.SingularDegreeOfFreedomAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectorComponents, constructor.new(_142.SingularDegreeOfFreedomAnalysis))
        return value
