...
class TransientSolverOptions(_1.APIBase):
    ...
    @property
    def solver_tolerance_input_method(self) -> '_120.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_120.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_120.TransientSolverToleranceInputMethod'):
    ...
    @property
    def result_logging_frequency(self) -> '_115.ResultLoggingFrequency':
        ...
        return constructor.new(_115.ResultLoggingFrequency)(value) if value else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_115.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
