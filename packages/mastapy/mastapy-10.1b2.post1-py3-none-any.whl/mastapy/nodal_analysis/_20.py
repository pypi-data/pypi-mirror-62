...
from mastapy.nodal_analysis import _88, _89
...
class AnalysisSettings(_73.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_88.RatingTypeForBearingReliability':
        ...
        return constructor.new(_88.RatingTypeForBearingReliability)(value) if value else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_88.RatingTypeForBearingReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_89.RatingTypeForShaftReliability':
        ...
        return constructor.new(_89.RatingTypeForShaftReliability)(value) if value else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_89.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
