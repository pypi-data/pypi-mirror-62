...
class TransientSolverOptions(_1.APIBase):
    ...
    def integration_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod.implicit_type()
    ...
    def integration_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod.implicit_type().type_()
    ...
    @property
    def solver_tolerance_input_method(self) -> '_1374.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_1374.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_1374.TransientSolverToleranceInputMethod'):
    ...
    @property
    def damping_scaling_for_initial_transients(self) -> '_1345.DampingScalingTypeForInitialTransients':
        ...
        return constructor.new(_1345.DampingScalingTypeForInitialTransients)(value) if value else None

    @damping_scaling_for_initial_transients.setter
    def damping_scaling_for_initial_transients(self, value: '_1345.DampingScalingTypeForInitialTransients'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def result_logging_frequency(self) -> '_1368.ResultLoggingFrequency':
        ...
        return constructor.new(_1368.ResultLoggingFrequency)(value) if value else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_1368.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
