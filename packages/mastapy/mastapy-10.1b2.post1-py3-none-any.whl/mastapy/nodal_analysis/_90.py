...
from mastapy.nodal_analysis import _95, _104
...
class FEStiffness(_1.APIBase):
    ...
    @property
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_104.NodalMatrix':
        ...
        return constructor.new(_104.NodalMatrix)(self.wrapped.StiffnessInFECoordinateSystemMNRad) if self.wrapped.StiffnessInFECoordinateSystemMNRad else None

    @property
    def mass_matrix_mn_rad_s_kg(self) -> '_104.NodalMatrix':
        ...
        return constructor.new(_104.NodalMatrix)(self.wrapped.MassMatrixMNRadSKg) if self.wrapped.MassMatrixMNRadSKg else None
    ...
    @property
    def stiffness_matrix(self) -> '_104.NodalMatrix':
        ...
        return constructor.new(_104.NodalMatrix)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None
