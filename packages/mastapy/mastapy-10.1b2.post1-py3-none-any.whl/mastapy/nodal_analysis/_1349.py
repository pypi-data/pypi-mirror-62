...
from mastapy.nodal_analysis import _1347, _1376, _1363
...
class FEMeshingOptions(_1.APIBase):
    ...
    @property
    def element_shape(self) -> '_1376.VolumeElementShape':
        ...
        return constructor.new(_1376.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_1376.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_1363.MeshingDiameterForGear':
        ...
        return constructor.new(_1363.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_1363.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
