...
from mastapy.math_utility.stiffness_calculators import _1080
from mastapy._internal import constructor
from mastapy.nodal_analysis.nodal_entities import _1404
...
class SurfaceToSurfaceContactStiffnessEntity(_1404.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1080.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1080.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
