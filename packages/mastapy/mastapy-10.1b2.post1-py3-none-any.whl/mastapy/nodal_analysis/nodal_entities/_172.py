...
from mastapy.math_utility.stiffness_calculators import _218
...
class SurfaceToSurfaceContactStiffnessEntity(_149.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_218.SurfaceToSurfaceContact':
        ...
        return constructor.new(_218.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
