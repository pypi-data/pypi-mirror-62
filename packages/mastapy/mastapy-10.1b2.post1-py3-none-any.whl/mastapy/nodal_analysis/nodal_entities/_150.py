...
class Bar(_157.NodalComponent):
    ...
    @property
    def bar_geometry(self) -> '_74.BarGeometry':
        ...
        return constructor.new(_74.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
