...
class Bar(_128.NodalComponent):
    ...
    @property
    def bar_geometry(self) -> '_47.BarGeometry':
        ...
        return constructor.new(_47.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
