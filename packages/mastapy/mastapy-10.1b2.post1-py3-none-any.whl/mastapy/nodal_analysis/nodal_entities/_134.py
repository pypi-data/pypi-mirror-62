...
from mastapy.math_utility.stiffness_calculators import _1201
...
class SurfaceToSurfaceContactStiffnessEntity(_112.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1201.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1201.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
