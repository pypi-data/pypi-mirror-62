...
class LineContactStiffnessEntity(_149.ArbitraryNodalComponent):
    '''LineContactStiffnessEntity
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_104.NodalMatrix':
        ...
        return constructor.new(_104.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
