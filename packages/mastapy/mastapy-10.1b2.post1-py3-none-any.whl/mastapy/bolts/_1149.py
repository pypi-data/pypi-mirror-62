...
from mastapy.bolts import _1148
...
class BoltGeometryDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1148.BoltGeometry':
        ...
        return constructor.new(_1148.BoltGeometry)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1148.BoltGeometry':
        ...
        return constructor.new(_1148.BoltGeometry)(method_result) if method_result else None

    def can_be_removed(self, bolt_geometry: '_1148.BoltGeometry') -> 'bool':
    ...
    def rename(self, bolt_geometry: '_1148.BoltGeometry', new_name: 'str') -> 'bool':
    ...
    def remove(self, bolt_geometry: '_1148.BoltGeometry'):
    ...
    def get_all_items(self) -> 'Iterable[_1148.BoltGeometry]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1148.BoltGeometry))

    def save_changes(self, bolt_geometry: '_1148.BoltGeometry'):
