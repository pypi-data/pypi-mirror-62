...
class LoadedBolt(_1.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1146.AxialLoadType':
        ...
        return constructor.new(_1146.AxialLoadType)(value) if value else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1146.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1161.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1161.JointTypes)(value) if value else None

    @joint_type.setter
    def joint_type(self, value: '_1161.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1167.TighteningTechniques':
        ...
        return constructor.new(_1167.TighteningTechniques)(value) if value else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1167.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1157.DetailedBoltDesign':
        ...
        return constructor.new(_1157.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt else None
