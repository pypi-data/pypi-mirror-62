...
from mastapy.bolts import _1165, _1147
...
class BoltMaterial(_1147.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1165.StrengthGrades':
        ...
        return constructor.new(_1165.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1165.StrengthGrades'):
