...
from mastapy.bolts import _1150
...
class BoltMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1150.BoltMaterial':
        ...
        return constructor.new(_1150.BoltMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1150.BoltMaterial':
        ...
        return constructor.new(_1150.BoltMaterial)(method_result) if method_result else None

    def can_be_removed(self, bolt_material: '_1150.BoltMaterial') -> 'bool':
    ...
    def rename(self, bolt_material: '_1150.BoltMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bolt_material: '_1150.BoltMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_1150.BoltMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1150.BoltMaterial))

    def save_changes(self, bolt_material: '_1150.BoltMaterial'):
