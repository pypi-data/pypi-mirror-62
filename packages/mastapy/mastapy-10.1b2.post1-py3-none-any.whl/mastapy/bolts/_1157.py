...
class DetailedBoltDesign(_1.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1163.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1163.RolledBeforeOrAfterHeatTreament)(value) if value else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1163.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1160.JointGeometries':
        ...
        return constructor.new(_1160.JointGeometries)(value) if value else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1160.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1155.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1155.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1155.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1148.BoltGeometry':
        ...
        return constructor.new(_1148.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry else None
    ...
    @property
    def material_of_nut(self) -> '_1147.BoltedJointMaterial':
        ...
        return constructor.new(_1147.BoltedJointMaterial)(self.wrapped.MaterialOfNut) if self.wrapped.MaterialOfNut else None

    @property
    def material_of_bolt(self) -> '_1150.BoltMaterial':
        ...
        return constructor.new(_1150.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt else None

    @property
    def material_of_tapped_thread(self) -> '_1147.BoltedJointMaterial':
        ...
        return constructor.new(_1147.BoltedJointMaterial)(self.wrapped.MaterialOfTappedThread) if self.wrapped.MaterialOfTappedThread else None

    @property
    def clamped_sections(self) -> 'List[_1155.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1155.ClampedSection))
        return value
