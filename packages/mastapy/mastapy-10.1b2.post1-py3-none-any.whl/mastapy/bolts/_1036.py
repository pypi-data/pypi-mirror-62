...
class DetailedBoltDesign(_1.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1042.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1042.RolledBeforeOrAfterHeatTreament)(value) if value else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1042.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1039.JointGeometries':
        ...
        return constructor.new(_1039.JointGeometries)(value) if value else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1039.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1034.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1034.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1034.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1027.BoltGeometry':
        ...
        return constructor.new(_1027.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry else None
    ...
    @property
    def material_of_nut(self) -> '_1026.BoltedJointMaterial':
        ...
        return constructor.new(_1026.BoltedJointMaterial)(self.wrapped.MaterialOfNut) if self.wrapped.MaterialOfNut else None

    @property
    def material_of_bolt(self) -> '_1029.BoltMaterial':
        ...
        return constructor.new(_1029.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt else None

    @property
    def material_of_tapped_thread(self) -> '_1026.BoltedJointMaterial':
        ...
        return constructor.new(_1026.BoltedJointMaterial)(self.wrapped.MaterialOfTappedThread) if self.wrapped.MaterialOfTappedThread else None

    @property
    def clamped_sections(self) -> 'List[_1034.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1034.ClampedSection))
        return value
