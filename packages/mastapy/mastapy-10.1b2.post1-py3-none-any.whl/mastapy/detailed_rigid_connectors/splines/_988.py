...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _995
from mastapy.detailed_rigid_connectors import _962
...
class SplineHalfDesign(_962.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_972.HeatTreatmentTypes':
        ...
        return constructor.new(_972.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_972.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_995.FitAndTolerance':
        ...
        return constructor.new(_995.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
