...
from mastapy.detailed_rigid_connectors.splines import _1093
...
class SplineMaterial(_219.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1093.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1093.HeatTreatmentTypes'):
