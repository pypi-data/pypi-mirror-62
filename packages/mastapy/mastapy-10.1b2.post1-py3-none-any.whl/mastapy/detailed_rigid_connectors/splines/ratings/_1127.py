...
from mastapy.detailed_rigid_connectors.splines.ratings import _1126
from mastapy.detailed_rigid_connectors.rating import _1131
...
class SplineJointRating(_1131.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1126.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1126.SplineHalfRating))
        return value
