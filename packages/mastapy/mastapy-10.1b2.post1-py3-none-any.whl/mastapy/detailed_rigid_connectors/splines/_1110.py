...
from mastapy.detailed_rigid_connectors.splines import (
    _1089, _1100, _1112, _1104,
    _1101, _1108, _1109, _1084,
    _1087, _1091, _1094, _1102,
    _1114
)
...
class SplineJointDesign(_1082.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    def dudley_maximum_effective_length_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption.implicit_type()
    ...
    def dudley_maximum_effective_length_option(self, value: 'enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption.implicit_type().type_()
    ...
    @property
    def root_type(self) -> '_1100.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1100.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_1100.RootTypes'):
    ...
    def spline_rating_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes.implicit_type()
    ...
    def spline_rating_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def torque_cycles(self) -> '_1104.SAETorqueCycles':
        ...
        return constructor.new(_1104.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1104.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1101.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1101.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1101.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1108.SplineFixtureTypes':
        ...
        return constructor.new(_1108.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1108.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1109.SplineHalfDesign':
        ...
        return constructor.new(_1109.SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1084.CustomSplineHalfDesign':
        ...
        if _1084.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1084.CustomSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1087.DIN5480SplineHalfDesign':
        ...
        if _1087.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1087.DIN5480SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1091.GBT3478SplineHalfDesign':
        ...
        if _1091.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1091.GBT3478SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1094.ISO4156SplineHalfDesign':
        ...
        if _1094.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1094.ISO4156SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1102.SAESplineHalfDesign':
        ...
        if _1102.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1102.SAESplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1114.StandardSplineHalfDesign':
        ...
        if _1114.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1114.StandardSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def internal_half(self) -> '_1109.SplineHalfDesign':
        ...
        return constructor.new(_1109.SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1084.CustomSplineHalfDesign':
        ...
        if _1084.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1084.CustomSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1087.DIN5480SplineHalfDesign':
        ...
        if _1087.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1087.DIN5480SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1091.GBT3478SplineHalfDesign':
        ...
        if _1091.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1091.GBT3478SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1094.ISO4156SplineHalfDesign':
        ...
        if _1094.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1094.ISO4156SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1102.SAESplineHalfDesign':
        ...
        if _1102.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1102.SAESplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1114.StandardSplineHalfDesign':
        ...
        if _1114.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1114.StandardSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None
