...
from mastapy.detailed_rigid_connectors.splines import _1097, _1106, _1114
...
class DIN5480SplineHalfDesign(_1114.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1097.ManufacturingTypes':
        ...
        return constructor.new(_1097.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1097.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1106.FinishingMethods':
        ...
        return constructor.new(_1106.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1106.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
