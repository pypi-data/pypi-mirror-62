...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1117
from mastapy.detailed_rigid_connectors.splines import _1114
...
class SAESplineHalfDesign(_1114.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1117.SAESplineTolerances':
        ...
        return constructor.new(_1117.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
