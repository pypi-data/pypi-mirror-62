...
from mastapy.detailed_rigid_connectors.splines import _972
...
class SplineMaterial(_77.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_972.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_972.HeatTreatmentTypes'):
