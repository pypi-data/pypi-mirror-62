...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _996
from mastapy.detailed_rigid_connectors.splines import _993
...
class SAESplineHalfDesign(_993.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_996.SAESplineTolerances':
        ...
        return constructor.new(_996.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
