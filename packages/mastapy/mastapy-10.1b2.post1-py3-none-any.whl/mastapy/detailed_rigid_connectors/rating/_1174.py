...
class ShaftHubConnectionRating(_1.APIBase):
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1153.SplineJointDesign':
        ...
        if _1153.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
        ...
        return constructor.new(_1153.SplineJointDesign)(self.wrapped.JointDesign) if self.wrapped.JointDesign else None

    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1158.StandardSplineJointDesign':
        ...
        if _1158.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
        ...
        return constructor.new(_1158.StandardSplineJointDesign)(self.wrapped.JointDesign) if self.wrapped.JointDesign else None
    ...
    def joint_design_of_type_keyed_joint_design(self) -> '_1175.KeyedJointDesign':
        ...
        if _1175.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    def joint_design_of_type_interference_fit_design(self) -> '_1183.InterferenceFitDesign':
        ...
        if _1183.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
