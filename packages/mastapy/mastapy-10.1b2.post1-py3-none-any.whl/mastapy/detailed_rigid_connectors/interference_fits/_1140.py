...
from mastapy.detailed_rigid_connectors.interference_fits import _1139, _1138, _1143
...
class InterferenceFitDesign(_1082.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1139.CalculationMethods':
        ...
        return constructor.new(_1139.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1139.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1138.AssemblyMethods':
        ...
        return constructor.new(_1138.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1138.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def joint_interface_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_Table4JointInterfaceTypes':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_Table4JointInterfaceTypes.implicit_type()
    ...
    def joint_interface_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_Table4JointInterfaceTypes.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_Table4JointInterfaceTypes.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
