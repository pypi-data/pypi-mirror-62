...
from mastapy.detailed_rigid_connectors.interference_fits import _1142
from mastapy.bearings.tolerances import _1502, _1490, _1495
...
class InterferenceFitHalfDesign(_1083.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1142.StressRegions':
        ...
        return constructor.new(_1142.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1502.SupportTolerance':
        ...
        return constructor.new(_1502.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1490.InnerSupportTolerance':
        ...
        if _1490.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1490.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1495.OuterSupportTolerance':
        ...
        if _1495.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1495.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
