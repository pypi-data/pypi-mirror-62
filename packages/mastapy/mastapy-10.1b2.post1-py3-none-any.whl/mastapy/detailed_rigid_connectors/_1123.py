...
from mastapy.detailed_rigid_connectors import _1124
...
class DetailedRigidConnectorDesign(_1.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_752.SMTBitmap':
        ...
        return constructor.new(_752.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_1124.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_1124.DetailedRigidConnectorHalfDesign))
        return value
