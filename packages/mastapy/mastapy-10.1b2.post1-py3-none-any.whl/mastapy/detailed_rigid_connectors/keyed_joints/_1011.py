...
from mastapy.detailed_rigid_connectors.keyed_joints import _1014, _1012
...
class KeyedJointDesign(_1019.InterferenceFitDesign):
    '''KeyedJointDesign
