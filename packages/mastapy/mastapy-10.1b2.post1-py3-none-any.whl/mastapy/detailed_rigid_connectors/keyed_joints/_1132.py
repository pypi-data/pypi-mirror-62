...
from mastapy.detailed_rigid_connectors.keyed_joints import _1135, _1133
...
class KeyedJointDesign(_1140.InterferenceFitDesign):
    '''KeyedJointDesign
