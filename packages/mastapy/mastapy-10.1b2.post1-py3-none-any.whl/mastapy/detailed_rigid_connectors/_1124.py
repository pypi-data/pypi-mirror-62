...
class DetailedRigidConnectorDesign(_1.APIBase):
    ...
    @property
    def halves(self) -> 'List[_1125.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_1125.DetailedRigidConnectorHalfDesign))
        return value
