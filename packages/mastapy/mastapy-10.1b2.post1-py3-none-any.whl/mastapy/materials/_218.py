...
class LubricationDetailDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_217.LubricationDetail':
        ...
        return constructor.new(_217.LubricationDetail)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_217.LubricationDetail':
        ...
        return constructor.new(_217.LubricationDetail)(method_result) if method_result else None

    def can_be_removed(self, lubrication_detail: '_217.LubricationDetail') -> 'bool':
    ...
    def rename(self, lubrication_detail: '_217.LubricationDetail', new_name: 'str') -> 'bool':
    ...
    def remove(self, lubrication_detail: '_217.LubricationDetail'):
    ...
    def get_all_items(self) -> 'Iterable[_217.LubricationDetail]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_217.LubricationDetail))

    def save_changes(self, lubrication_detail: '_217.LubricationDetail'):
