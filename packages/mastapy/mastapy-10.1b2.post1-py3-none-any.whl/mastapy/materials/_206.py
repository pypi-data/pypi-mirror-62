...
class GeneralTransmissionProperties(_1.APIBase):
    ...
    @property
    def transmission_application(self) -> '_232.TransmissionApplications':
        ...
        return constructor.new(_232.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_232.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_209.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_209.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_209.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_235.WindTurbineStandards':
        ...
        return constructor.new(_235.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_235.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_236.WorkingCharacteristics':
        ...
        return constructor.new(_236.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_236.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_236.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_236.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_205.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_205.GearingTypes)(value) if value else None

    @gearing_type.setter
    def gearing_type(self, value: '_205.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_234.VehicleDynamicsProperties':
        ...
        return constructor.new(_234.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_193.AirProperties':
        ...
        return constructor.new(_193.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
