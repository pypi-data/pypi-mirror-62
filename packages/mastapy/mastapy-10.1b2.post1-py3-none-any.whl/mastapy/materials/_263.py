...
class LubricationDetail(_94.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_244.DensitySpecificationMethod':
        ...
        return constructor.new(_244.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_244.DensitySpecificationMethod'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_268.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_268.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_268.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_267.OilFiltrationOptions':
        ...
        return constructor.new(_267.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_267.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_250.GreaseContaminationOptions':
        ...
        return constructor.new(_250.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_250.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_237.BearingLubricationCondition':
        ...
        return constructor.new(_237.BearingLubricationCondition)(value) if value else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_237.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def lubricant_viscosity_classification(self) -> '_260.LubricantViscosityClassification':
        ...
        return constructor.new(_260.LubricantViscosityClassification)(value) if value else None
    ...
    def lubricant_grade_agma(self) -> '_259.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_259.LubricantViscosityClassAGMA)(value) if value else None
    ...
    def lubricant_grade_sae(self) -> '_262.LubricantViscosityClassSAE':
        ...
        return constructor.new(_262.LubricantViscosityClassSAE)(value) if value else None
    ...
    def delivery(self) -> '_258.LubricantDelivery':
        ...
        return constructor.new(_258.LubricantDelivery)(value) if value else None

    @property
    def agma925a03_lubricant_type(self) -> '_229.AGMALubricantType':
        ...
        return constructor.new(_229.AGMALubricantType)(value) if value else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_229.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def isotr139892000isotr1514412014_lubricant_type(self) -> '_256.ISOLubricantType':
        ...
        return constructor.new(_256.ISOLubricantType)(value) if value else None

    @isotr139892000isotr1514412014_lubricant_type.setter
    def isotr139892000isotr1514412014_lubricant_type(self, value: '_256.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
