...
from mastapy.materials import _188
...
class AcousticRadiationEfficiency(_1.APIBase):
    ...
    @property
    def input_type(self) -> '_188.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_188.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_188.AcousticRadiationEfficiencyInputType'):
