...
class BearingMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_238.BearingMaterial':
        ...
        return constructor.new(_238.BearingMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_238.BearingMaterial':
        ...
        return constructor.new(_238.BearingMaterial)(method_result) if method_result else None

    def can_be_removed(self, bearing_material: '_238.BearingMaterial') -> 'bool':
    ...
    def rename(self, bearing_material: '_238.BearingMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bearing_material: '_238.BearingMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_238.BearingMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_238.BearingMaterial))

    def save_changes(self, bearing_material: '_238.BearingMaterial'):
