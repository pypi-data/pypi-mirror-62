...
class LubricationDetailDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_75.LubricationDetail':
        ...
        return constructor.new(_75.LubricationDetail)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_75.LubricationDetail':
        ...
        return constructor.new(_75.LubricationDetail)(method_result) if method_result else None

    def can_be_removed(self, lubrication_detail: '_75.LubricationDetail') -> 'bool':
    ...
    def rename(self, lubrication_detail: '_75.LubricationDetail', new_name: 'str') -> 'bool':
    ...
    def remove(self, lubrication_detail: '_75.LubricationDetail'):
    ...
    def get_all_items(self) -> 'Iterable[_75.LubricationDetail]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_75.LubricationDetail))

    def save_changes(self, lubrication_detail: '_75.LubricationDetail'):
