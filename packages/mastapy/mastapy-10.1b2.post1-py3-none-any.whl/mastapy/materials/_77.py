...
from mastapy.materials import _79, _66
...
class Material(_1323.NamedDatabaseItem):
    '''Material
    ...
    @property
    def surface_hardness_type(self) -> '_66.HardnessType':
        ...
        return constructor.new(_66.HardnessType)(value) if value else None

    @surface_hardness_type.setter
    def surface_hardness_type(self, value: '_66.HardnessType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
