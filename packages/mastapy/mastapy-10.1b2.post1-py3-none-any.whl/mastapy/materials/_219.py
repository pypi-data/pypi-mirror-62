...
from mastapy.materials import _221, _208
...
class Material(_1439.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_221.MaterialStandards':
        '''MaterialStandards: 'Standard' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Standard)
        return constructor.new(_221.MaterialStandards)(value) if value else None

    @standard.setter
    def standard(self, value: '_221.MaterialStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Standard = value

    @property
    def surface_hardness_type(self) -> '_208.HardnessType':
        '''HardnessType: 'SurfaceHardnessType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SurfaceHardnessType)
        return constructor.new(_208.HardnessType)(value) if value else None

    @surface_hardness_type.setter
    def surface_hardness_type(self, value: '_208.HardnessType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SurfaceHardnessType = value
