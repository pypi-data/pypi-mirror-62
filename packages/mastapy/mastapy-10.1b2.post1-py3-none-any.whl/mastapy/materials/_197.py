...
class ComponentMaterialDatabase(_1.APIBase):
    ...
    def item(self) -> '_219.Material':
        ...
        return constructor.new(_219.Material)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_219.Material':
        ...
        return constructor.new(_219.Material)(method_result) if method_result else None

    def can_be_removed(self, material: '_219.Material') -> 'bool':
    ...
    def rename(self, material: '_219.Material', new_name: 'str') -> 'bool':
    ...
    def remove(self, material: '_219.Material'):
    ...
    def get_all_items(self) -> 'Iterable[_219.Material]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_219.Material))

    def save_changes(self, material: '_219.Material'):
