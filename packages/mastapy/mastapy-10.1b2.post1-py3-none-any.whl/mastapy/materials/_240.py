...
from mastapy.materials import _66
...
class ComponentMaterialDatabase(_1.APIBase):
    ...
    def item(self) -> '_66.Material':
        ...
        return constructor.new(_66.Material)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_66.Material':
        ...
        return constructor.new(_66.Material)(method_result) if method_result else None

    def can_be_removed(self, material: '_66.Material') -> 'bool':
    ...
    def rename(self, material: '_66.Material', new_name: 'str') -> 'bool':
    ...
    def remove(self, material: '_66.Material'):
    ...
    def get_all_items(self) -> 'Iterable[_66.Material]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_66.Material))

    def save_changes(self, material: '_66.Material'):
