...
from mastapy.utility.databases import _1439
...
class LubricationDetail(_1439.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_201.DensitySpecificationMethod':
        ...
        return constructor.new(_201.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_201.DensitySpecificationMethod'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_224.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_224.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_224.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_223.OilFiltrationOptions':
        ...
        return constructor.new(_223.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_223.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_207.GreaseContaminationOptions':
        ...
        return constructor.new(_207.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_207.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_194.BearingLubricationCondition':
        ...
        return constructor.new(_194.BearingLubricationCondition)(value) if value else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_194.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_214.LubricantViscosityClassification':
        ...
        return constructor.new(_214.LubricantViscosityClassification)(value) if value else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_214.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def lubricant_definition(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LubricantDefinition':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_LubricantDefinition.implicit_type()
    ...
    def lubricant_definition(self, value: 'enum_with_selected_value.EnumWithSelectedValue_LubricantDefinition.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_LubricantDefinition.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
        self.wrapped.LubricantDefinition = value

    @property
    def lubricant_grade_agma(self) -> '_213.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_213.LubricantViscosityClassAGMA)(value) if value else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_213.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_216.LubricantViscosityClassSAE':
        ...
        return constructor.new(_216.LubricantViscosityClassSAE)(value) if value else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_216.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def lubricant_grade_iso(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LubricantViscosityClassISO':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_LubricantViscosityClassISO.implicit_type()
    ...
    def lubricant_grade_iso(self, value: 'enum_with_selected_value.EnumWithSelectedValue_LubricantViscosityClassISO.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_LubricantViscosityClassISO.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
        self.wrapped.LubricantGradeISO = value

    @property
    def delivery(self) -> '_212.LubricantDelivery':
        ...
        return constructor.new(_212.LubricantDelivery)(value) if value else None

    @property
    def agma925a03_lubricant_type(self) -> '_189.AGMALubricantType':
        ...
        return constructor.new(_189.AGMALubricantType)(value) if value else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_189.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def isotr139892000isotr1514412014_lubricant_type(self) -> '_210.ISOLubricantType':
        ...
        return constructor.new(_210.ISOLubricantType)(value) if value else None

    @isotr139892000isotr1514412014_lubricant_type.setter
    def isotr139892000isotr1514412014_lubricant_type(self, value: '_210.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
