...
class GeneralTransmissionProperties(_1.APIBase):
    ...
    @property
    def transmission_application(self) -> '_275.TransmissionApplications':
        ...
        return constructor.new(_275.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_275.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_255.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_255.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_255.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_278.WindTurbineStandards':
        ...
        return constructor.new(_278.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_278.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_279.WorkingCharacteristics':
        ...
        return constructor.new(_279.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_279.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_279.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_279.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_248.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_248.GearingTypes)(value) if value else None

    @gearing_type.setter
    def gearing_type(self, value: '_248.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_277.VehicleDynamicsProperties':
        ...
        return constructor.new(_277.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_236.AirProperties':
        ...
        return constructor.new(_236.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
