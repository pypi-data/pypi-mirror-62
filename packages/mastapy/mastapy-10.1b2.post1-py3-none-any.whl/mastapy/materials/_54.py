...
class BearingMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_53.BearingMaterial':
        ...
        return constructor.new(_53.BearingMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_53.BearingMaterial':
        ...
        return constructor.new(_53.BearingMaterial)(method_result) if method_result else None

    def can_be_removed(self, bearing_material: '_53.BearingMaterial') -> 'bool':
    ...
    def rename(self, bearing_material: '_53.BearingMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bearing_material: '_53.BearingMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_53.BearingMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_53.BearingMaterial))

    def save_changes(self, bearing_material: '_53.BearingMaterial'):
