...
from mastapy.materials import _46
...
class AcousticRadiationEfficiency(_1.APIBase):
    ...
    @property
    def input_type(self) -> '_46.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_46.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_46.AcousticRadiationEfficiencyInputType'):
