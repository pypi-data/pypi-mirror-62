...
class BearingMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_195.BearingMaterial':
        ...
        return constructor.new(_195.BearingMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_195.BearingMaterial':
        ...
        return constructor.new(_195.BearingMaterial)(method_result) if method_result else None

    def can_be_removed(self, bearing_material: '_195.BearingMaterial') -> 'bool':
    ...
    def rename(self, bearing_material: '_195.BearingMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bearing_material: '_195.BearingMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_195.BearingMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_195.BearingMaterial))

    def save_changes(self, bearing_material: '_195.BearingMaterial'):
