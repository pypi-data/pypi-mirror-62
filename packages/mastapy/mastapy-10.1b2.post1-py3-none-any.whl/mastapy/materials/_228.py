...
from mastapy.materials import _229
...
class SNCurve(_1.APIBase):
    ...
    @property
    def points(self) -> 'List[_229.SNCurvePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Points, constructor.new(_229.SNCurvePoint))
        return value
