...
from mastapy.math_utility import _1171
from mastapy._internal import constructor, conversion
from mastapy.system_model import _1738
...
T = TypeVar('T', bound='_1914.Component')
...
class RelativeComponentAlignment(_1.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1171.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1171.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1738.RelativeOffsetOption':
        ...
        return constructor.new(_1738.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1738.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
