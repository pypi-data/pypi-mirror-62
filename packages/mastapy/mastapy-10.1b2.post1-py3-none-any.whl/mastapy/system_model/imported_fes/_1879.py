...
from mastapy.utility.enums import _1437
from mastapy.nodal_analysis.component_mode_synthesis import _185
from mastapy.nodal_analysis.dev_tools_analyses import _152
from mastapy.system_model.imported_fes import _1885, _1875
from mastapy.math_utility.measured_vectors import _1227
from mastapy.utility.units_and_measurements.measurements import (
    _1289, _1358, _1315, _1269
)
...
class ImportedFEWithSelectionStaticAnalysis(_1875.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_185.StaticCMSResults':
        ...
        return constructor.new(_185.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_152.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_152.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1885.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1885.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1885.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1885.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1227.VectorWithLinearAndAngularComponents[_1289.Force, _1358.Torque]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1289.Force, _1358.Torque])
        return value

    @property
    def displacement_results(self) -> 'List[_1227.VectorWithLinearAndAngularComponents[_1315.LengthVeryShort, _1269.AngleSmall]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1315.LengthVeryShort, _1269.AngleSmall])
        return value
