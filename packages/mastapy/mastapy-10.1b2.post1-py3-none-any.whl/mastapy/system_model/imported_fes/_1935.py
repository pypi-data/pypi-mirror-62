...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1466
...
class MaterialPropertiesWithSelection(_1.APIBase):
    ...
    @property
    def material_properties(self) -> '_1466.MaterialPropertiesReporting':
        ...
        return constructor.new(_1466.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
