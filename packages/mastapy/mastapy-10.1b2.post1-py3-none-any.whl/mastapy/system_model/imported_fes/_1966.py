...
from mastapy.system_model.imported_fes import _1957, _1971
...
class ImportedFEElectricMachineStatorLink(_1971.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1957.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1957.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
