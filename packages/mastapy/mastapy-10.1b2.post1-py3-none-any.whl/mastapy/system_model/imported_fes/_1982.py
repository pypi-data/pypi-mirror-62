...
from mastapy.nodal_analysis.dev_tools_analyses import _188, _179
from mastapy.nodal_analysis import _87
from mastapy.system_model.imported_fes import _1979
...
class ImportedFEWithSelectionModalAnalysis(_1979.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_188.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_188.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None

    @property
    def eigenvalue_options(self) -> '_179.EigenvalueOptions':
        ...
        return constructor.new(_179.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None

    @property
    def fe_modal_frequencies(self) -> 'List[_87.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_87.FEModalFrequencyComparison))
        return value
