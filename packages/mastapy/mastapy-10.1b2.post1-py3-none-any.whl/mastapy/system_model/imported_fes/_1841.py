...
class BatchOperations(_1.APIBase):
    ...
    @property
    def fe_components(self) -> 'List[_1855.FEComponentWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_1855.FEComponentWithBatchOptions))
        return value

    @property
    def fe_components_with_external_files(self) -> 'List[_1855.FEComponentWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponentsWithExternalFiles, constructor.new(_1855.FEComponentWithBatchOptions))
        return value
