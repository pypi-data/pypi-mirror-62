...
from mastapy.system_model.imported_fes import (
    _1842, _1874, _1898, _1836,
    _1838, _1899, _1894, _1873,
    _1834, _1858, _1860, _1880,
    _1879, _1876, _1877, _1878
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1918, _1914, _1926
from mastapy.nodal_analysis import _56, _59
from mastapy.nodal_analysis.component_mode_synthesis import _181
from mastapy.system_model import _1737
from mastapy.math_utility import _1174
from mastapy.materials import _187
...
from mastapy.utility.units_and_measurements.measurements import (
    _1292, _1361, _1311, _1268
)
from mastapy import _6318
...
class ImportedFE(_59.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1842.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1842.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1842.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1836.AlignmentMethod':
        ...
        return constructor.new(_1836.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1836.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_56.FEMeshingOptions':
        ...
        return constructor.new(_56.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_181.FullFEModel':
        ...
        return constructor.new(_181.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1737.RelativeComponentAlignment[_1914.Component]':
        ...
        return constructor.new(_1737.RelativeComponentAlignment)[_1914.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1838.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1838.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_1899.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1899.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_187.AcousticRadiationEfficiency':
        ...
        return constructor.new(_187.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1894.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1894.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_1945.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1945.Shaft))
        return value

    @property
    def links(self) -> 'List[_1834.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1834.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1227.VectorWithLinearAndAngularComponents[_1292.ForcePerUnitTemperature, _1361.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1292.ForcePerUnitTemperature, _1361.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1227.VectorWithLinearAndAngularComponents[_1311.LengthPerUnitTemperature, _1268.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1311.LengthPerUnitTemperature, _1268.AnglePerUnitTemperature])
        return value

    @property
    def geometries(self) -> 'List[_1858.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1858.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1860.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1860.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1880.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1880.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1926.ImportedFEComponent':
        ...
        return constructor.new(_1926.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6318.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1879.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1879.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1876.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1876.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1877.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1877.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1878.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1878.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1873.ImportedFEStiffnessNode') -> 'List[_1834.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1834.ImportedFELink))
