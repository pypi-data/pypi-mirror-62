...
from mastapy.utility.units_and_measurements import _1386
from mastapy.system_model.imported_fes import (
    _1845, _1876, _1900, _1839,
    _1841, _1901, _1896, _1875,
    _1837, _1861, _1863, _1882,
    _1881, _1878, _1879, _1880
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1920, _1916, _1928
from mastapy.nodal_analysis import _86, _91
from mastapy.nodal_analysis.component_mode_synthesis import _222
from mastapy.system_model import _1740
from mastapy.math_utility import _1216
from mastapy.materials import _228
...
from mastapy.utility.units_and_measurements.measurements import (
    _1306, _1372, _1324, _1282
)
from mastapy import _318
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_1845.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1845.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1845.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1839.AlignmentMethod':
        ...
        return constructor.new(_1839.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1839.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_86.FEMeshingOptions':
        ...
        return constructor.new(_86.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_222.FullFEModel':
        ...
        return constructor.new(_222.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1740.RelativeComponentAlignment[_1916.Component]':
        ...
        return constructor.new(_1740.RelativeComponentAlignment)[_1916.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1841.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1841.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_1901.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1901.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_228.AcousticRadiationEfficiency':
        ...
        return constructor.new(_228.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1896.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1896.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_1875.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1875.ImportedFEStiffnessNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_1946.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1946.Shaft))
        return value

    @property
    def links(self) -> 'List[_1837.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1837.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1306.ForcePerUnitTemperature, _1372.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1306.ForcePerUnitTemperature, _1372.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1324.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1324.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature])
        return value

    @property
    def geometries(self) -> 'List[_1861.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1861.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1863.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1863.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1882.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1882.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1928.ImportedFEComponent':
        ...
        return constructor.new(_1928.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_318.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1881.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1881.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1878.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1878.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1879.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1879.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1880.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1880.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None
    ...
    def links_for(self, node: '_1875.ImportedFEStiffnessNode') -> 'List[_1837.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1837.ImportedFELink))
