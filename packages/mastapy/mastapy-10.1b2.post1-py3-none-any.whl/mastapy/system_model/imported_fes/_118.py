...
from mastapy.system_model.imported_fes import (
    _1842, _1873, _1897, _1836,
    _1838, _1898, _1893, _1872,
    _1834, _1858, _1860, _1879,
    _1878, _1875, _1876, _1877
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1917, _1913, _1925
from mastapy.nodal_analysis import _85, _90
...
class ImportedFE(_90.FEStiffness):
    '''ImportedFE
    ...
    @property
    def fe_meshing_options(self) -> '_85.FEMeshingOptions':
        ...
        return constructor.new(_85.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None
    ...
    @property
    def alignment_to_component(self) -> '_1737.RelativeComponentAlignment[_1913.Component]':
        ...
        return constructor.new(_1737.RelativeComponentAlignment)[_1913.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None
    ...
    @property
    def export(self) -> '_1898.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1898.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1893.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1893.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_1872.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1872.ImportedFEStiffnessNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_1943.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1943.Shaft))
        return value
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1305.ForcePerUnitTemperature, _1369.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1305.ForcePerUnitTemperature, _1369.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1323.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1323.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature])
        return value
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1879.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1879.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1925.ImportedFEComponent':
        ...
        return constructor.new(_1925.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_328.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1878.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1878.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1875.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1875.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1876.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1876.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1877.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1877.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1872.ImportedFEStiffnessNode') -> 'List[_1834.ImportedFELink]':
