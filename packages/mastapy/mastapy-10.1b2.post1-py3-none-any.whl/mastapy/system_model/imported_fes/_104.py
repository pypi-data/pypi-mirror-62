...
from mastapy.system_model.imported_fes import (
    _1947, _1978, _2002, _1839,
    _1944, _2003, _1998, _1977,
    _1837, _1963, _1965, _1984,
    _1983, _1980, _1981, _1982
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1863, _1861, _1867
...
from mastapy.math_utility.measured_vectors import _1257
from mastapy.utility.units_and_measurements.measurements import (
    _1315, _1382, _1334, _1290
)
from mastapy import _323
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_1947.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1947.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1947.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_to_component(self) -> '_1740.RelativeComponentAlignment[_1861.Component]':
        ...
        return constructor.new(_1740.RelativeComponentAlignment)[_1861.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1944.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1944.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_2003.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_2003.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1998.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1998.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_1977.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1977.ImportedFEStiffnessNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_1877.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1877.Shaft))
        return value
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1257.VectorWithLinearAndAngularComponents[_1315.ForcePerUnitTemperature, _1382.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1257.VectorWithLinearAndAngularComponents)[_1315.ForcePerUnitTemperature, _1382.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1257.VectorWithLinearAndAngularComponents[_1334.LengthPerUnitTemperature, _1290.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1257.VectorWithLinearAndAngularComponents)[_1334.LengthPerUnitTemperature, _1290.AnglePerUnitTemperature])
        return value

    @property
    def geometries(self) -> 'List[_1963.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1963.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1965.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1965.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1984.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1984.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1867.ImportedFEComponent':
        ...
        return constructor.new(_1867.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_323.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1983.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1983.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1980.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1980.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1981.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1981.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1982.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1982.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1977.ImportedFEStiffnessNode') -> 'List[_1837.ImportedFELink]':
