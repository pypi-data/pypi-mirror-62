...
from mastapy.utility.units_and_measurements import _1286
...
from mastapy.nodal_analysis import _86, _89
...
from mastapy.utility.units_and_measurements.measurements import (
    _1314, _1382, _1333, _1290
)
from mastapy import _321
...
class ImportedFE(_89.FEStiffness):
    '''ImportedFE
    ...
    @property
    def cms_model(self) -> '_219.FullFEModel':
        ...
        return constructor.new(_219.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1314.ForcePerUnitTemperature, _1382.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1314.ForcePerUnitTemperature, _1382.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1254.VectorWithLinearAndAngularComponents[_1333.LengthPerUnitTemperature, _1290.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1333.LengthPerUnitTemperature, _1290.AnglePerUnitTemperature])
        return value
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_321.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
