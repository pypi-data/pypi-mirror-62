...
from mastapy.system_model.imported_fes import _1904, _1919
...
class ImportedFEElectricMachineStatorLink(_1919.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1904.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1904.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
