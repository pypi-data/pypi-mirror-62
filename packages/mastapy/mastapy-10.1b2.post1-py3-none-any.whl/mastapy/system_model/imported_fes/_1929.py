...
from mastapy.nodal_analysis.dev_tools_analyses import _1440
...
class ImportedFEWithSelectionForHarmonicAnalysis(_1927.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1440.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1440.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
