...
from mastapy.nodal_analysis.fe_export_utility import _175, _176
from mastapy._internal import constructor, conversion
from mastapy.utility.units_and_measurements import _1286
from mastapy.system_model.imported_fes import _1994, _1993
...
class SystemDeflectionFEExportOptions(_1.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1994.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1994.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1993.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1993.PerLinkExportOptions))
        return value
