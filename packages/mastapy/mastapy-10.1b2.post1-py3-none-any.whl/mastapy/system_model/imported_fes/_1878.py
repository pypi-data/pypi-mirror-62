...
from mastapy.nodal_analysis.dev_tools_analyses import _150, _141
from mastapy.nodal_analysis import _57
from mastapy.system_model.imported_fes import _1875
...
class ImportedFEWithSelectionModalAnalysis(_1875.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_150.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_150.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_57.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_57.FEModalFrequencyComparison))
        return value
