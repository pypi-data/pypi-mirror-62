...
class ImportedFEWithSelectionForHarmonicAnalysis(_1979.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_186.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_186.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
