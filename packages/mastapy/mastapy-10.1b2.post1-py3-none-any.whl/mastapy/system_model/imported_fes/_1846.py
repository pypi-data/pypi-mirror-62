...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _163
...
class ContactPairWithSelection(_1.APIBase):
    ...
    @property
    def contact_pair(self) -> '_163.ContactPairReporting':
        ...
        return constructor.new(_163.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
