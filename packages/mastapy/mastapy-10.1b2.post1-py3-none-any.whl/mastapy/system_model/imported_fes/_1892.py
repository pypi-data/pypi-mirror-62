...
class BaseFEWithSelection(_1.APIBase):
    ...
    @property
    def node_selection(self) -> '_1447.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_1447.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection else None
    ...
    @property
    def transparency_draw_style(self) -> '_1446.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_1446.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle else None

    @property
    def component_draw_style(self) -> '_1439.FEModelComponentDrawStyle':
        ...
        return constructor.new(_1439.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle else None
