...
from mastapy.nodal_analysis import _85, _91
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def cms_model(self) -> '_223.FullFEModel':
        ...
        return constructor.new(_223.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    @property
    def acoustic_radiation_efficiency(self) -> '_230.AcousticRadiationEfficiency':
        ...
        return constructor.new(_230.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None
