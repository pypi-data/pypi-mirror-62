...
class MaterialPropertiesWithSelection(_1.APIBase):
    ...
    @property
    def material_properties(self) -> '_174.MaterialPropertiesReporting':
        ...
        return constructor.new(_174.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
