...
class IndependentMastaCreatedCondensationNode(_1.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_200.RigidCouplingType':
        ...
        return constructor.new(_200.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_200.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1977.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1977.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
