...
class LoadCaseResults(_1.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_1901.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_1901.ImportedFEResults))
        return value
