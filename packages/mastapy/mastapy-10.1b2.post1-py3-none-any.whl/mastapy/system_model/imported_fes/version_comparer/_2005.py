...
from mastapy.system_model.imported_fes.version_comparer import _2009
...
class ImportedFEResults(_1.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_2009.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_2009.NodeComparisonResult))
        return value
