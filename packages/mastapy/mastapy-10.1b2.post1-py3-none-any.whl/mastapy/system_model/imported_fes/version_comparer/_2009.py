...
from mastapy.math_utility.measured_vectors import _1251, _1257
...
class NodeComparisonResult(_1.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1257.VectorWithLinearAndAngularComponents[_1337.LengthVeryShort, _1291.AngleSmall]':
        ...
        return constructor.new(_1257.VectorWithLinearAndAngularComponents)[_1337.LengthVeryShort, _1291.AngleSmall](self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
