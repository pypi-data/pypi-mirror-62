...
from mastapy.math_utility.measured_vectors import _1224, _1227
...
class NodeComparisonResult(_1.APIBase):
    ...
    @property
    def original_result(self) -> '_1224.NodeResults':
        ...
        return constructor.new(_1224.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult else None

    @property
    def new_result(self) -> '_1224.NodeResults':
        ...
        return constructor.new(_1224.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult else None

    @property
    def displacement_change(self) -> '_1227.VectorWithLinearAndAngularComponents[_1315.LengthVeryShort, _1269.AngleSmall]':
        ...
        return constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1315.LengthVeryShort, _1269.AngleSmall](self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
