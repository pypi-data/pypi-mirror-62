...
from mastapy.utility.units_and_measurements.measurements import _1328, _1283
...
class NodeComparisonResult(_1.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1254.VectorWithLinearAndAngularComponents[_1328.LengthVeryShort, _1283.AngleSmall]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1328.LengthVeryShort, _1283.AngleSmall](self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
