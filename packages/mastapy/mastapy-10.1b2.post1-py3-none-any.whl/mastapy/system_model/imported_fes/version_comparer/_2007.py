...
from mastapy.system_model.imported_fes.version_comparer import _2005
...
class LoadCaseResults(_1.APIBase):
    ...
    @property
    def imported_fe_results(self) -> 'List[_2005.ImportedFEResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEResults, constructor.new(_2005.ImportedFEResults))
        return value
