...
from mastapy.system_model.imported_fes.version_comparer import _1911
...
class DesignResults(_1.APIBase):
    ...
    @property
    def load_cases(self) -> 'List[_1911.LoadCaseResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_1911.LoadCaseResults))
        return value
