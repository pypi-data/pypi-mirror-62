...
from mastapy.system_model.imported_fes.version_comparer import _1905
...
class ImportedFEResults(_1.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_1905.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1905.NodeComparisonResult))
        return value
