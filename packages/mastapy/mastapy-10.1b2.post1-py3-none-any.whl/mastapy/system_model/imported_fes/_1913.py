...
from mastapy.utility.units_and_measurements import _1143
from mastapy.system_model.imported_fes import (
    _1894, _1926, _1950, _1888,
    _1890, _1951, _1946, _1925,
    _1886, _1910, _1912, _1932,
    _1931, _1928, _1929, _1930
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1971, _1967, _1979
from mastapy.nodal_analysis import _1349, _1352
from mastapy.nodal_analysis.component_mode_synthesis import _1473
from mastapy.system_model import _1787
from mastapy.math_utility import _1053
from mastapy.materials import _45, _88
...
from mastapy.utility.units_and_measurements.measurements import (
    _1171, _1243, _1190, _1147
)
from mastapy import _6479
...
class ImportedFE(_1352.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1894.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1894.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1894.BearingNodeAlignmentOption'):
    ...
    def type_(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ImportedFEType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ImportedFEType.implicit_type()
    ...
    def type_(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ImportedFEType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ImportedFEType.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
    ...
    def thermal_expansion_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThermalExpansionOption':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ThermalExpansionOption.implicit_type()
    ...
    def thermal_expansion_option(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ThermalExpansionOption.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ThermalExpansionOption.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def alignment_method(self) -> '_1888.AlignmentMethod':
        ...
        return constructor.new(_1888.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1888.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_1349.FEMeshingOptions':
        ...
        return constructor.new(_1349.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1473.FullFEModel':
        ...
        return constructor.new(_1473.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1787.RelativeComponentAlignment[_1967.Component]':
        ...
        return constructor.new(_1787.RelativeComponentAlignment)[_1967.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1890.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1890.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1053.CoordinateSystem3D':
        ...
        return constructor.new(_1053.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1951.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1951.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_45.AcousticRadiationEfficiency':
        ...
        return constructor.new(_45.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1946.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1946.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2000.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2000.Shaft))
        return value

    @property
    def links(self) -> 'List[_1886.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1886.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1106.VectorWithLinearAndAngularComponents[_1171.ForcePerUnitTemperature, _1243.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1171.ForcePerUnitTemperature, _1243.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1106.VectorWithLinearAndAngularComponents[_1190.LengthPerUnitTemperature, _1147.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1190.LengthPerUnitTemperature, _1147.AnglePerUnitTemperature])
        return value

    @property
    def geometries(self) -> 'List[_1910.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1910.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1912.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1912.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1932.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1932.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1979.ImportedFEComponent':
        ...
        return constructor.new(_1979.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6479.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1931.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1931.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1928.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1928.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1929.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1929.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1930.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1930.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1925.ImportedFEStiffnessNode') -> 'List[_1886.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1886.ImportedFELink))
