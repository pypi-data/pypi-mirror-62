...
from mastapy.nodal_analysis.dev_tools_analyses import _1442, _1433
from mastapy.nodal_analysis import _1350
from mastapy.system_model.imported_fes import _1927
...
class ImportedFEWithSelectionModalAnalysis(_1927.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1442.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1442.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_1350.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1350.FEModalFrequencyComparison))
        return value
