...
class MaterialPropertiesWithSelection(_1.APIBase):
    ...
    @property
    def material_properties(self) -> '_213.MaterialPropertiesReporting':
        ...
        return constructor.new(_213.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
