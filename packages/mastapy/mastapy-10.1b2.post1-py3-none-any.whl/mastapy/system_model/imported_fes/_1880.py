...
class IndependentMastaCreatedCondensationNode(_1.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_162.RigidCouplingType':
        ...
        return constructor.new(_162.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_162.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1873.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1873.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
