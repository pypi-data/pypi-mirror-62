...
from mastapy.nodal_analysis.dev_tools_analyses import _148
...
class ImportedFEWithSelectionForHarmonicAnalysis(_1875.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_148.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_148.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
