...
class ImportedFEWithSelection(_1892.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1913.ImportedFE':
        ...
        return constructor.new(_1913.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1905.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1905.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1938.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1938.NodeGroupWithSelection))
        return value
