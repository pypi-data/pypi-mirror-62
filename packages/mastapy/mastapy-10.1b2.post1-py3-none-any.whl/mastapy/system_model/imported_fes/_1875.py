...
class ImportedFEWithSelection(_1840.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1861.ImportedFE':
        ...
        return constructor.new(_1861.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1853.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1853.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1886.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1886.NodeGroupWithSelection))
        return value
