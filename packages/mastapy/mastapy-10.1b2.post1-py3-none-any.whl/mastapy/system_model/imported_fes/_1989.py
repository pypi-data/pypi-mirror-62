...
from mastapy.system_model.imported_fes import _1955, _1954
...
class NodeBoundaryConditionStaticAnalysis(_1.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_1955.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_1955.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_1954.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_1954.DegreeOfFreedomBoundaryConditionAngular))
        return value
