...
class ImportedFEWithSelection(_1946.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_104.ImportedFE':
        ...
        return constructor.new(_104.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1958.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1958.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1990.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1990.NodeGroupWithSelection))
        return value
