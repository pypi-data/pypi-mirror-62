...
from mastapy.system_model.imported_fes import _1896
...
class BearingRaceNodeLink(_1.APIBase):
    ...
    @property
    def race_position(self) -> '_1896.BearingRacePosition':
        ...
        return constructor.new(_1896.BearingRacePosition)(value) if value else None
