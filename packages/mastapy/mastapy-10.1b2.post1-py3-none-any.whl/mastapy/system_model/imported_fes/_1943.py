...
from mastapy.system_model.imported_fes import _1889, _1895
...
class RaceBearingFE(_1.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1889.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1889.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1889.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1895.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1895.BearingRaceNodeLink))
        return value
