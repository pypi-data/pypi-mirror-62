...
from mastapy.system_model.imported_fes import _1840, _1948
...
class RaceBearingFE(_1.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1840.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1840.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1840.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1948.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1948.BearingRaceNodeLink))
        return value
