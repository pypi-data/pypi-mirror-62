...
from mastapy.system_model.imported_fes import _1845
from mastapy.math_utility import _1172, _1171
...
class AlignConnectedComponentOptions(_1.APIBase):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1172.Axis':
        ...
        return constructor.new(_1172.Axis)(value) if value else None

    @first_component_alignment_axis.setter
    def first_component_alignment_axis(self, value: '_1172.Axis'):
    ...
    @property
    def first_fe_alignment_axis(self) -> '_1171.AlignmentAxis':
        ...
        return constructor.new(_1171.AlignmentAxis)(value) if value else None

    @first_fe_alignment_axis.setter
    def first_fe_alignment_axis(self, value: '_1171.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1172.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1172.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1171.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1171.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
