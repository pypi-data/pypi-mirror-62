...
from mastapy.nodal_analysis.component_mode_synthesis import _1477
from mastapy.nodal_analysis.dev_tools_analyses import _1444
from mastapy.system_model.imported_fes import _1937, _1927
from mastapy.math_utility.measured_vectors import _1106
from mastapy.utility.units_and_measurements.measurements import (
    _1168, _1240, _1194, _1148
)
...
class ImportedFEWithSelectionStaticAnalysis(_1927.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    def contour_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption.implicit_type()
    ...
    def contour_option(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption.implicit_type().type_()
    ...
    @property
    def full_fe_results(self) -> '_1477.StaticCMSResults':
        ...
        return constructor.new(_1477.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_1444.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_1444.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1937.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1937.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1937.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1937.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1106.VectorWithLinearAndAngularComponents[_1168.Force, _1240.Torque]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1168.Force, _1240.Torque])
        return value

    @property
    def displacement_results(self) -> 'List[_1106.VectorWithLinearAndAngularComponents[_1194.LengthVeryShort, _1148.AngleSmall]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1194.LengthVeryShort, _1148.AngleSmall])
        return value
