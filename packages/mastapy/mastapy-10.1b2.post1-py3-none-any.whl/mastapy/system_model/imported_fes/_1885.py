...
from mastapy.system_model.imported_fes import _1850, _1849
...
class NodeBoundaryConditionStaticAnalysis(_1.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_1850.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_1850.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_1849.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_1849.DegreeOfFreedomBoundaryConditionAngular))
        return value
