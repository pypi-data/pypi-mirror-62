...
from mastapy.nodal_analysis.component_mode_synthesis import _218
from mastapy.system_model import _1740
from mastapy.math_utility import _1216
from mastapy.materials import _224
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def cms_model(self) -> '_218.FullFEModel':
        ...
        return constructor.new(_218.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    @property
    def acoustic_radiation_efficiency(self) -> '_224.AcousticRadiationEfficiency':
        ...
        return constructor.new(_224.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_342.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
