...
from mastapy.utility.enums import _1444
...
from mastapy.system_model.imported_fes import _1989, _1979
from mastapy.math_utility.measured_vectors import _1257
from mastapy.utility.units_and_measurements.measurements import (
    _1312, _1379, _1337, _1291
)
...
class ImportedFEWithSelectionStaticAnalysis(_1979.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_225.StaticCMSResults':
        ...
        return constructor.new(_225.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_190.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_190.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1989.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1989.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1989.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1989.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1257.VectorWithLinearAndAngularComponents[_1312.Force, _1379.Torque]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1257.VectorWithLinearAndAngularComponents)[_1312.Force, _1379.Torque])
        return value

    @property
    def displacement_results(self) -> 'List[_1257.VectorWithLinearAndAngularComponents[_1337.LengthVeryShort, _1291.AngleSmall]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1257.VectorWithLinearAndAngularComponents)[_1337.LengthVeryShort, _1291.AngleSmall])
        return value
