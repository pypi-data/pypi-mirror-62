...
from mastapy.system_model import _1747
...
T = TypeVar('T', bound='_1922.Component')
...
class RelativeComponentAlignment(_1.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self) -> '_1747.RelativeOffsetOption':
        ...
        return constructor.new(_1747.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1747.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
