...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _5055, _5054, _4950
...
class ZerolBevelGearSetModalAnalysesAtStiffnesses(_4950.BevelGearSetModalAnalysesAtStiffnesses):
    '''ZerolBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_5055.ZerolBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtStiffnesses, constructor.new(_5055.ZerolBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_5054.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_5054.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
