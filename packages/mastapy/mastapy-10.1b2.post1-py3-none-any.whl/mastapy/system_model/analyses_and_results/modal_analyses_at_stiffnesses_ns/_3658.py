...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3679
...
class GearModalAnalysesAtStiffnesses(_3679.MountableComponentModalAnalysesAtStiffnesses):
    '''GearModalAnalysesAtStiffnesses
