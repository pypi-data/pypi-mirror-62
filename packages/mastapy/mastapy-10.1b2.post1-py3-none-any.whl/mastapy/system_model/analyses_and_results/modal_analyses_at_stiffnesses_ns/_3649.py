...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3648, _3647, _3659
...
class CylindricalGearSetModalAnalysesAtStiffnesses(_3659.GearSetModalAnalysesAtStiffnesses):
    '''CylindricalGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def cylindrical_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3648.CylindricalGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtStiffnesses, constructor.new(_3648.CylindricalGearModalAnalysesAtStiffnesses))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3647.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtStiffnesses, constructor.new(_3647.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
