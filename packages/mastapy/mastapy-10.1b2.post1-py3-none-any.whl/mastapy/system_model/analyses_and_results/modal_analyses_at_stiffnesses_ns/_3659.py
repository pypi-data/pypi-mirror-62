...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3695
...
class GearSetModalAnalysesAtStiffnesses(_3695.SpecialisedAssemblyModalAnalysesAtStiffnesses):
    '''GearSetModalAnalysesAtStiffnesses
