...
class ConnectionModalAnalysesAtStiffnesses(_3269.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_4974.CriticalSpeedAnalysis':
        ...
        return constructor.new(_4974.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None
