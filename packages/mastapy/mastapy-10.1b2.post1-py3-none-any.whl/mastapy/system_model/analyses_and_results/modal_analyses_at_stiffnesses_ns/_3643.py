...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3677
...
class CriticalSpeedAnalysis(_6313.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def modal_analyses_at_stiffnesses_options(self) -> '_3677.ModalAnalysesAtStiffnessesOptions':
        ...
        return constructor.new(_3677.ModalAnalysesAtStiffnessesOptions)(self.wrapped.ModalAnalysesAtStiffnessesOptions) if self.wrapped.ModalAnalysesAtStiffnessesOptions else None
