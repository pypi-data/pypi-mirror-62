...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _5052, _5051, _4990
...
class WormGearSetModalAnalysesAtStiffnesses(_4990.GearSetModalAnalysesAtStiffnesses):
    '''WormGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def worm_gears_modal_analyses_at_stiffnesses(self) -> 'List[_5052.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtStiffnesses, constructor.new(_5052.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def worm_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_5051.WormGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtStiffnesses, constructor.new(_5051.WormGearMeshModalAnalysesAtStiffnesses))
        return value
