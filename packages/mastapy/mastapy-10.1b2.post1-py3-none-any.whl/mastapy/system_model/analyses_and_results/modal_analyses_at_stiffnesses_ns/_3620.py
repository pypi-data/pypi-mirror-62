...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3608
...
class BevelGearModalAnalysesAtStiffnesses(_3608.AGMAGleasonConicalGearModalAnalysesAtStiffnesses):
    '''BevelGearModalAnalysesAtStiffnesses
