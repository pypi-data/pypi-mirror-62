...
class CriticalSpeedAnalysis(_3151.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def modal_analyses_at_stiffnesses_options(self) -> '_5008.ModalAnalysesAtStiffnessesOptions':
        ...
        return constructor.new(_5008.ModalAnalysesAtStiffnessesOptions)(self.wrapped.ModalAnalysesAtStiffnessesOptions) if self.wrapped.ModalAnalysesAtStiffnessesOptions else None
