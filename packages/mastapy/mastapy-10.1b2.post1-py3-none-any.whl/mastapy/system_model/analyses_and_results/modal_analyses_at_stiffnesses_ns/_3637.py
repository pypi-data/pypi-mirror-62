...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3659
...
class ConicalGearSetModalAnalysesAtStiffnesses(_3659.GearSetModalAnalysesAtStiffnesses):
    '''ConicalGearSetModalAnalysesAtStiffnesses
