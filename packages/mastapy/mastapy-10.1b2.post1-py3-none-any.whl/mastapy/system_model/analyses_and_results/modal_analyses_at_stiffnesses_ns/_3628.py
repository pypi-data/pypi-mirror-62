...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3681
...
class ComponentModalAnalysesAtStiffnesses(_3681.PartModalAnalysesAtStiffnesses):
    '''ComponentModalAnalysesAtStiffnesses
