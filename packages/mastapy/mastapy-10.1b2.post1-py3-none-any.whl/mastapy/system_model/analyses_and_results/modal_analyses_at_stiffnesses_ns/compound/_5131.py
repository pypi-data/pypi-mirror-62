...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _5143
...
class PlanetaryConnectionCompoundModalAnalysesAtStiffnesses(_5143.ShaftToMountableComponentConnectionCompoundModalAnalysesAtStiffnesses):
    '''PlanetaryConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5013.PlanetaryConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5013.PlanetaryConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_5013.PlanetaryConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_5013.PlanetaryConnectionModalAnalysesAtStiffnesses))
        return value
