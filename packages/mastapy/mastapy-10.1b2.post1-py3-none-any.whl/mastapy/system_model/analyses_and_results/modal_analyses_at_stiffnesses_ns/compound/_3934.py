...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _3860
...
class TorqueConverterPumpCompoundModalAnalysesAtStiffnesses(_3860.CouplingHalfCompoundModalAnalysesAtStiffnesses):
    '''TorqueConverterPumpCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_2119.TorqueConverterPump':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3813.TorqueConverterPumpModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3813.TorqueConverterPumpModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3813.TorqueConverterPumpModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3813.TorqueConverterPumpModalAnalysesAtStiffnesses))
        return value
