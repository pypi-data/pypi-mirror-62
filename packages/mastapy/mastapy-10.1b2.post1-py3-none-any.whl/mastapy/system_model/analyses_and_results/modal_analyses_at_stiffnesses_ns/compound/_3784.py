...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3664
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _3727
...
class ImportedFEComponentCompoundModalAnalysesAtStiffnesses(_3727.AbstractShaftOrHousingCompoundModalAnalysesAtStiffnesses):
    '''ImportedFEComponentCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3664.ImportedFEComponentModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3664.ImportedFEComponentModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3664.ImportedFEComponentModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3664.ImportedFEComponentModalAnalysesAtStiffnesses))
        return value
