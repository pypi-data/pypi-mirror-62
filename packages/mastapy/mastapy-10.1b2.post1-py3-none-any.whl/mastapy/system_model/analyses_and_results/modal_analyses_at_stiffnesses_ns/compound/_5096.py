...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _5065
...
class CVTCompoundModalAnalysesAtStiffnesses(_5065.BeltDriveCompoundModalAnalysesAtStiffnesses):
    '''CVTCompoundModalAnalysesAtStiffnesses
