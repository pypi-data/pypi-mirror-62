...
class StraightBevelDiffGearMeshCompoundModalAnalysesAtStiffnesses(_5072.BevelGearMeshCompoundModalAnalysesAtStiffnesses):
    '''StraightBevelDiffGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5033.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5033.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_5033.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_5033.StraightBevelDiffGearMeshModalAnalysesAtStiffnesses))
        return value
