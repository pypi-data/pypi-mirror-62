...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _5174, _5175, _5073
...
class ZerolBevelGearSetCompoundModalAnalysesAtStiffnesses(_5073.BevelGearSetCompoundModalAnalysesAtStiffnesses):
    ...
    @property
    def zerol_bevel_gears_compound_modal_analyses_at_stiffnesses(self) -> 'List[_5174.ZerolBevelGearCompoundModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCompoundModalAnalysesAtStiffnesses, constructor.new(_5174.ZerolBevelGearCompoundModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_compound_modal_analyses_at_stiffnesses(self) -> 'List[_5175.ZerolBevelGearMeshCompoundModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCompoundModalAnalysesAtStiffnesses, constructor.new(_5175.ZerolBevelGearMeshCompoundModalAnalysesAtStiffnesses))
        return value
