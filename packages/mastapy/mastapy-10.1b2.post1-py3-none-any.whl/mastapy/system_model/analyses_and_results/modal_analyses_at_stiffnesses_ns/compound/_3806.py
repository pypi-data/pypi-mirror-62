...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3688
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _3813
...
class RollingRingAssemblyCompoundModalAnalysesAtStiffnesses(_3813.SpecialisedAssemblyCompoundModalAnalysesAtStiffnesses):
    '''RollingRingAssemblyCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3688.RollingRingAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3688.RollingRingAssemblyModalAnalysesAtStiffnesses))
        return value

    @property
    def assembly_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3688.RollingRingAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtStiffnessesLoadCases, constructor.new(_3688.RollingRingAssemblyModalAnalysesAtStiffnesses))
        return value
