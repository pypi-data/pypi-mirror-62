...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _5048
...
class TorqueConverterTurbineCompoundModalAnalysesAtStiffnesses(_5094.CouplingHalfCompoundModalAnalysesAtStiffnesses):
    '''TorqueConverterTurbineCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5048.TorqueConverterTurbineModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5048.TorqueConverterTurbineModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_5048.TorqueConverterTurbineModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_5048.TorqueConverterTurbineModalAnalysesAtStiffnesses))
        return value
