...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3689
...
class RollingRingConnectionCompoundModalAnalysesAtStiffnesses(_3785.InterMountableComponentConnectionCompoundModalAnalysesAtStiffnesses):
    '''RollingRingConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3689.RollingRingConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3689.RollingRingConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3689.RollingRingConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3689.RollingRingConnectionModalAnalysesAtStiffnesses))
        return value
