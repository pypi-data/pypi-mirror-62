...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3643, _3610
...
class RootAssemblyModalAnalysesAtStiffnesses(_3610.AssemblyModalAnalysesAtStiffnesses):
    '''RootAssemblyModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses_inputs(self) -> '_3643.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3643.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnessesInputs) if self.wrapped.ModalAnalysesAtStiffnessesInputs else None
