...
from mastapy.nodal_analysis import _94, _78
from mastapy.scripting import _738
...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2385, _2386, _2335, _2339,
    _2271
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2519
...
class CylindricalGearMeshSystemDeflection(_2271.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_738.SMTBitmap':
        ...
        return constructor.new(_738.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def connection_load_case(self) -> '_2254.CylindricalGearMeshLoadCase':
        ...
        return constructor.new(_2254.CylindricalGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def gear_a(self) -> '_2385.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2385.CylindricalGearSystemDeflection)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2386.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2386.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2386.CylindricalGearSystemDeflectionTimestep)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2335.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2335.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2335.CylindricalGearSystemDeflectionWithLTCAResults)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2339.CylindricalPlanetGearSystemDeflection':
        ...
        if _2339.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2339.CylindricalPlanetGearSystemDeflection)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_b(self) -> '_2385.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2385.CylindricalGearSystemDeflection)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2386.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2386.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2386.CylindricalGearSystemDeflectionTimestep)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2335.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2335.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2335.CylindricalGearSystemDeflectionWithLTCAResults)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2339.CylindricalPlanetGearSystemDeflection':
        ...
        if _2339.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2339.CylindricalPlanetGearSystemDeflection)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def misalignment_data(self) -> '_78.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_78.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_78.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_78.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_78.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_78.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2385.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2385.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2519.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2519.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2519.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2519.MeshDeflectionResults))
        return value
