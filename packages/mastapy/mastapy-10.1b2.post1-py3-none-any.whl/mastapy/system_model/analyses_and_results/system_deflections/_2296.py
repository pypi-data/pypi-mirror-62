...
from mastapy.system_model.analyses_and_results.system_deflections import _2297, _2295, _2200
...
class StraightBevelDiffGearSetSystemDeflection(_2200.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3296.StraightBevelDiffGearSetPowerFlow':
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2297.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2297.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2295.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2295.StraightBevelDiffGearMeshSystemDeflection))
        return value
