...
from mastapy.gears.ltca.conical import _889
...
class ConicalGearSystemDeflection(_2342.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_889.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_889.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
