...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2270
from mastapy.math_utility.measured_vectors import _1224, _1223
...
class ComponentSystemDeflection(_2213.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    @property
    def component_design(self) -> '_1914.Component':
    ...
    @property
    def rigidly_connected_components(self) -> '_2270.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2270.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents else None

    @property
    def node_results(self) -> 'List[_1224.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1224.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1223.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1223.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1223.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1223.ForceResults))
        return value
