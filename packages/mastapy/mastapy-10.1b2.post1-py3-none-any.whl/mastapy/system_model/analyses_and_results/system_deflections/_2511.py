...
from mastapy.system_model.analyses_and_results.analysis_cases import _3385
...
class SystemDeflection(_3385.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2513.SystemDeflectionOptions':
        ...
        return constructor.new(_2513.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
