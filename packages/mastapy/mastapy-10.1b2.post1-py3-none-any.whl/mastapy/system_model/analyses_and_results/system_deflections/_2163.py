...
class ConnectionSystemDeflection(_6303.ConnectionFEAnalysis):
    '''ConnectionSystemDeflection
    ...
    @property
    def system_deflection(self) -> '_2247.SystemDeflection':
        ...
        return constructor.new(_2247.SystemDeflection)(self.wrapped.SystemDeflection) if self.wrapped.SystemDeflection else None
