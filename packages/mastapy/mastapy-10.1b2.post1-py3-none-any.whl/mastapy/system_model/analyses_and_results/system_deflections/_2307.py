...
from mastapy.system_model.analyses_and_results.analysis_cases import _6468
...
class SystemDeflection(_6468.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2309.SystemDeflectionOptions':
        ...
        return constructor.new(_2309.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
