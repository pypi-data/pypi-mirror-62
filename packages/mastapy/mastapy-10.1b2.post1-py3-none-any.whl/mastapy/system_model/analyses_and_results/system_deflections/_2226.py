...
from mastapy.math_utility.measured_vectors import _1103
...
class CVTPulleySystemDeflection(_2278.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def component_design(self) -> '_2099.CVTPulley':
    ...
    @property
    def power_flow_results(self) -> '_3234.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1103.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FixedSheaveContactResults, constructor.new(_1103.NodeResults))
        return value

    @property
    def moving_sheave_contact_results(self) -> 'List[_1103.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MovingSheaveContactResults, constructor.new(_1103.NodeResults))
        return value
