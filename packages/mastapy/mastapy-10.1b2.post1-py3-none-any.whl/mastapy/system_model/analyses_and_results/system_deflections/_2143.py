...
from mastapy.system_model.analyses_and_results.system_deflections import _2131
...
class BevelGearSetSystemDeflection(_2131.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
