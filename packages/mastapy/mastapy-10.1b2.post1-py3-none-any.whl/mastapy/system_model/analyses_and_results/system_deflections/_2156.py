...
class ConceptGearMeshSystemDeflection(_2188.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_460.ConceptGearMeshRating':
        ...
        return constructor.new(_460.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
