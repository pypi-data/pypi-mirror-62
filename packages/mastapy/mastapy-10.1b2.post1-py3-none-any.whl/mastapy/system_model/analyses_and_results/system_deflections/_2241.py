...
from mastapy.gears.gear_designs.conical import _885
...
class FaceGearMeshSystemDeflection(_2245.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3242.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3242.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_250.FaceGearMeshRating':
