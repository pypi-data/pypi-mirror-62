...
class ConicalGearSystemDeflection(_2335.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_877.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_877.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
