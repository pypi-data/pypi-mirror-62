...
from mastapy.system_model.analyses_and_results.system_deflections import _2378, _2298, _2160
...
class StraightBevelDiffGearSetSystemDeflection(_2160.BevelGearSetSystemDeflection):
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2378.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2378.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2298.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2298.StraightBevelDiffGearMeshSystemDeflection))
        return value
