...
from mastapy.gears.ltca.cylindrical import _880
...
class CylindricalGearSystemDeflectionWithLTCAResults(_2386.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_880.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_880.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
