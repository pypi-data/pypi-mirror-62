...
class BeltConnectionSystemDeflection(_2253.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3201.BeltConnectionPowerFlow':
        ...
        return constructor.new(_3201.BeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
