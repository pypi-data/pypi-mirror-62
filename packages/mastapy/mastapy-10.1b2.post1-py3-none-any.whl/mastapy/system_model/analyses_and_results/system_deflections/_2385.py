...
class CylindricalGearSystemDeflection(_2341.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def manufacturing_analysis(self) -> '_632.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_632.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None
