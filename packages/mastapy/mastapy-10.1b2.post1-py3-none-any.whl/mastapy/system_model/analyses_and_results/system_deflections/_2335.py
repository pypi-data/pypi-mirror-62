...
class CylindricalGearSystemDeflectionWithLTCAResults(_2385.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_885.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_885.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
