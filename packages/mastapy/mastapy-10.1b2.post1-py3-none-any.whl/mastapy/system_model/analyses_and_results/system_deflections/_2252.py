...
from mastapy.math_utility.measured_vectors import _1106, _1101
...
class ImportedFEComponentSystemDeflection(_2186.AbstractShaftOrHousingSystemDeflection):
    '''ImportedFEComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3253.ImportedFEComponentPowerFlow':
    ...
    @property
    def stiffness_in_world_coordinate_system_mn_rad(self) -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(self.wrapped.StiffnessInWorldCoordinateSystemMNRad) if self.wrapped.StiffnessInWorldCoordinateSystemMNRad else None

    @property
    def mass_in_world_coordinate_system_mn_rad_s_kg(self) -> '_1365.NodalMatrix':
        ...
        return constructor.new(_1365.NodalMatrix)(self.wrapped.MassInWorldCoordinateSystemMNRadSKg) if self.wrapped.MassInWorldCoordinateSystemMNRadSKg else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1106.VectorWithLinearAndAngularComponents[_1168.Force, _1240.Torque]]':
        '''List[VectorWithLinearAndAngularComponents[Force, Torque]]: 'AppliedInternalForcesInWorldCoordinateSystem' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1168.Force, _1240.Torque])
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1101.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1101.ForceAndDisplacementResults))
        return value
