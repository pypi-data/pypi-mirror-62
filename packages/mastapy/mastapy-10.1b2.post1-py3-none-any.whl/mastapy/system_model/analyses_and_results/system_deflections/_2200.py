...
class BevelGearSetSystemDeflection(_2188.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3210.BevelGearSetPowerFlow':
