...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2279
...
class PlanetCarrierWindup(_1.APIBase):
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2279.PlanetPinWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinWindUps, constructor.new(_2279.PlanetPinWindup))
        return value
