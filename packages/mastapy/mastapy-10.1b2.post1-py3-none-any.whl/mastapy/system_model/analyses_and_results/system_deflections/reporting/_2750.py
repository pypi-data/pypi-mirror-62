...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2749
...
class MeshDeflectionResults(_1.APIBase):
    ...
    @property
    def gears(self) -> 'List[_2749.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2749.GearInMeshDeflectionResults))
        return value
