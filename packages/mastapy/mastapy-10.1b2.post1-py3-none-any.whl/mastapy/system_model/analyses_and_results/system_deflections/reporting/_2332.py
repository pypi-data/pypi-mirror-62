...
class SplineFlankContactReporting(_1.APIBase):
    ...
    @property
    def relative_deflection_wcs(self) -> '_1106.VectorWithLinearAndAngularComponents[_1194.LengthVeryShort, _1148.AngleSmall]':
        ...
        return constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1194.LengthVeryShort, _1148.AngleSmall](self.wrapped.RelativeDeflectionWCS) if self.wrapped.RelativeDeflectionWCS else None

    @property
    def relative_deflection_lcs(self) -> '_1106.VectorWithLinearAndAngularComponents[_1194.LengthVeryShort, _1148.AngleSmall]':
        ...
        return constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1194.LengthVeryShort, _1148.AngleSmall](self.wrapped.RelativeDeflectionLCS) if self.wrapped.RelativeDeflectionLCS else None

    @property
    def force_on_inner_wcs(self) -> '_1106.VectorWithLinearAndAngularComponents[_1168.Force, _1240.Torque]':
        ...
        return constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1168.Force, _1240.Torque](self.wrapped.ForceOnInnerWCS) if self.wrapped.ForceOnInnerWCS else None

    @property
    def force_on_inner_contact_coordinate_system(self) -> '_1106.VectorWithLinearAndAngularComponents[_1168.Force, _1240.Torque]':
        ...
        return constructor.new(_1106.VectorWithLinearAndAngularComponents)[_1168.Force, _1240.Torque](self.wrapped.ForceOnInnerContactCoordinateSystem) if self.wrapped.ForceOnInnerContactCoordinateSystem else None
