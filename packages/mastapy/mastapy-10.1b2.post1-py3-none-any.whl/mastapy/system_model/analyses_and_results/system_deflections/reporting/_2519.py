...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2518
...
class MeshDeflectionResults(_1.APIBase):
    ...
    @property
    def gears(self) -> 'List[_2518.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2518.GearInMeshDeflectionResults))
        return value
