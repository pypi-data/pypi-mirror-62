...
from mastapy.system_model.analyses_and_results import _2113
...
class RigidlyConnectedComponentGroupSystemDeflection(_2113.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2161.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2161.ComponentSystemDeflection))
        return value
