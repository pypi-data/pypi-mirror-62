...
from mastapy.system_model.analyses_and_results import _2114
...
class RigidlyConnectedComponentGroupSystemDeflection(_2114.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2162.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2162.ComponentSystemDeflection))
        return value
