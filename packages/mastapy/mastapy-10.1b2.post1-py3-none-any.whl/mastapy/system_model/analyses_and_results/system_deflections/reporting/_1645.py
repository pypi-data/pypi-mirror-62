...
from mastapy.utility.enums import _60
from mastapy._internal import constructor, conversion
from mastapy.utility.report import _63
...
class ShaftSystemDeflectionSectionsReport(_63.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_60.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_60.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_60.TableAndChartOptions'):
