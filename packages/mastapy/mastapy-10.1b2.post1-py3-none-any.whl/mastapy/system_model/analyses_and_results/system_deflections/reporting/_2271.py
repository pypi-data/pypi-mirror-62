...
from mastapy.utility.enums import _1436
from mastapy._internal import constructor, conversion
from mastapy.utility.report import _1382
...
class ShaftSystemDeflectionSectionsReport(_1382.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1436.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1436.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1436.TableAndChartOptions'):
