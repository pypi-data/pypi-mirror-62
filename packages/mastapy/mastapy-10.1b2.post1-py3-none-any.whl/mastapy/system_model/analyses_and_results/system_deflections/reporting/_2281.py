...
class SplineFlankContactReporting(_1.APIBase):
    ...
    @property
    def relative_deflection_wcs(self) -> '_1254.VectorWithLinearAndAngularComponents[_1324.LengthVeryShort, _1280.AngleSmall]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1324.LengthVeryShort, _1280.AngleSmall](self.wrapped.RelativeDeflectionWCS) if self.wrapped.RelativeDeflectionWCS else None

    @property
    def relative_deflection_lcs(self) -> '_1254.VectorWithLinearAndAngularComponents[_1324.LengthVeryShort, _1280.AngleSmall]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1324.LengthVeryShort, _1280.AngleSmall](self.wrapped.RelativeDeflectionLCS) if self.wrapped.RelativeDeflectionLCS else None

    @property
    def force_on_inner_wcs(self) -> '_1254.VectorWithLinearAndAngularComponents[_1300.Force, _1366.Torque]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1300.Force, _1366.Torque](self.wrapped.ForceOnInnerWCS) if self.wrapped.ForceOnInnerWCS else None

    @property
    def force_on_inner_contact_coordinate_system(self) -> '_1254.VectorWithLinearAndAngularComponents[_1300.Force, _1366.Torque]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1300.Force, _1366.Torque](self.wrapped.ForceOnInnerContactCoordinateSystem) if self.wrapped.ForceOnInnerContactCoordinateSystem else None
