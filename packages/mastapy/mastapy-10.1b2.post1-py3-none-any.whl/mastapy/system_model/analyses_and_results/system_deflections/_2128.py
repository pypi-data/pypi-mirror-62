...
from mastapy.system_model.analyses_and_results.system_deflections import _2151, _2213
...
class AbstractAssemblySystemDeflection(_2213.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2270.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2270.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2151.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2151.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2151.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2151.ComponentSystemDeflection))
        return value
