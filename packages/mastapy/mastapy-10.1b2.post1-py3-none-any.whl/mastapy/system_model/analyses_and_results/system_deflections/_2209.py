...
from mastapy.system_model.drawing import _1804
...
class ConcentricPartGroupCombinationSystemDeflectionResults(_1.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1804.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1804.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
