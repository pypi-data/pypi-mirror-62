...
class ConicalGearSystemDeflection(_2190.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_760.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_760.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
