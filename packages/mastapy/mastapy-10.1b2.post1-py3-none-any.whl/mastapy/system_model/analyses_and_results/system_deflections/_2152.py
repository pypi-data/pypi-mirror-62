...
class ConcentricPartGroupCombinationSystemDeflectionResults(_1.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1754.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1754.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
