...
from mastapy.system_model.analyses_and_results.system_deflections import _2132
...
class BevelGearSystemDeflection(_2132.AGMAGleasonConicalGearSystemDeflection):
    '''BevelGearSystemDeflection
