...
class ShaftSectionSystemDeflection(_147.Bar):
    ...
    @property
    def left_end(self) -> '_2233.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2233.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2233.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2233.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
