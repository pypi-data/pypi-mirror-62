...
class ConicalGearSystemDeflection(_2336.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_875.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_875.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
