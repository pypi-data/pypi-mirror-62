...
from mastapy.system_model.drawing import _1766, _1764
...
class SystemDeflectionDrawStyle(_1764.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1766.ScalingDrawStyle':
        ...
        return constructor.new(_1766.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
