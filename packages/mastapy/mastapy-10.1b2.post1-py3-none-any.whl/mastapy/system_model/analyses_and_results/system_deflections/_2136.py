...
from mastapy.system_model.analyses_and_results.system_deflections import _2135, _2228
...
class BeltDriveSystemDeflection(_2228.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def belts(self) -> 'List[_2135.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2135.BeltConnectionSystemDeflection))
        return value
