...
from mastapy.system_model.analyses_and_results.analysis_cases import _3149
...
class SystemDeflection(_3149.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2395.SystemDeflectionOptions':
        ...
        return constructor.new(_2395.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
