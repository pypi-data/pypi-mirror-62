...
from mastapy.math_utility.measured_vectors import _117
...
class GearSystemDeflection(_2297.MountableComponentSystemDeflection):
    '''GearSystemDeflection
    ...
    @property
    def mesh_point_results_in_wcs(self) -> 'List[_117.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshPointResultsInWCS, constructor.new(_117.ForceAndDisplacementResults))
        return value
