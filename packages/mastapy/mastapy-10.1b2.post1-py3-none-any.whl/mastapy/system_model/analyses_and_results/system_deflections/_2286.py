...
from mastapy.system_model.analyses_and_results.system_deflections import _2284, _2285, _2186
from mastapy.shafts import _20
from mastapy.math_utility.measured_vectors import _1102
...
class ShaftSystemDeflection(_2186.AbstractShaftOrHousingSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None
    ...
    @property
    def power_flow_results(self) -> '_3285.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2284.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2284.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2284.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2284.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2284.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2284.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2285.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2285.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2284.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2284.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1102.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1102.ForceResults))
        return value
