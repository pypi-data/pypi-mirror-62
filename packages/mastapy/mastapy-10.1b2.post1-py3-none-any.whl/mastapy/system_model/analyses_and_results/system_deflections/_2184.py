...
from mastapy.gears.gear_designs.conical import _1006
...
from mastapy.system_model.analyses_and_results.system_deflections import _2188
...
class FaceGearMeshSystemDeflection(_2188.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_376.FaceGearMeshRating':
        ...
        return constructor.new(_376.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
