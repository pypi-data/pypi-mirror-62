...
from mastapy.system_model.analyses_and_results.system_deflections import _2130
...
class BevelGearMeshSystemDeflection(_2130.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
