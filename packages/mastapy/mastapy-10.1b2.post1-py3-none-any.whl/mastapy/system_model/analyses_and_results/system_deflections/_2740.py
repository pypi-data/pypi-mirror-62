...
from mastapy.system_model.analyses_and_results.analysis_cases import _3736
...
class SystemDeflection(_3736.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2744.SystemDeflectionOptions':
        ...
        return constructor.new(_2744.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
