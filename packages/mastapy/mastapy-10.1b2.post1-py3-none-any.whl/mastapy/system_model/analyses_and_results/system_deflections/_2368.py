...
from mastapy.system_model.analyses_and_results.system_deflections import _2366, _2247, _2160
...
class StraightBevelDiffGearSetSystemDeflection(_2160.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2366.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2366.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2247.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2247.StraightBevelDiffGearMeshSystemDeflection))
        return value
