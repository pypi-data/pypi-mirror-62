...
class HypoidGearSystemDeflection(_2150.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2347.HypoidGearLoadCase':
        ...
        return constructor.new(_2347.HypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
