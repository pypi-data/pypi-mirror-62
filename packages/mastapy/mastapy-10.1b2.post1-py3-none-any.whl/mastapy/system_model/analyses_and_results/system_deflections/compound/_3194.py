...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2973
from mastapy.system_model.imported_fes import _1996
...
class RootAssemblyCompoundSystemDeflection(_2404.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_2973.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_2973.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1996.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1996.RaceBearingFESystemDeflection))
        return value
