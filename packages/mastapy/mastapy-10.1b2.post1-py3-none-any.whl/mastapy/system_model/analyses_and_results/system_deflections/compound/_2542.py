...
class ClutchHalfCompoundSystemDeflection(_2563.CouplingHalfCompoundSystemDeflection):
    '''ClutchHalfCompoundSystemDeflection
    ...
    @property
    def component_design(self) -> '_2034.ClutchHalf':
        ...
        return constructor.new(_2034.ClutchHalf)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2160.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2160.ClutchHalfSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2160.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2160.ClutchHalfSystemDeflection))
        return value
