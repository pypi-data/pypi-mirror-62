...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3020
...
class RootAssemblyCompoundSystemDeflection(_2529.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3020.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3020.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None
