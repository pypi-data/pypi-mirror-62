...
class ConicalGearCompoundSystemDeflection(_2806.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_544.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_544.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_544.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
