...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2307
...
class BearingCompoundSystemDeflection(_2307.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1523.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1523.LoadedBearingDutyCycle)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2134.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2134.BearingSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2134.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2134.BearingSystemDeflection))
        return value
