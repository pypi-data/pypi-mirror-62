...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2281
...
class CVTCompoundSystemDeflection(_2281.BeltDriveCompoundSystemDeflection):
    '''CVTCompoundSystemDeflection
