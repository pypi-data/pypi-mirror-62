...
from mastapy.system_model.analyses_and_results.system_deflections import _2173
...
class ConceptGearMeshCompoundSystemDeflection(_2695.GearMeshCompoundSystemDeflection):
    '''ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2173.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2173.ConceptGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2173.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2173.ConceptGearMeshSystemDeflection))
        return value
