...
from mastapy.system_model.analyses_and_results.system_deflections import _2178
...
class ZerolBevelGearCompoundSystemDeflection(_2657.BevelGearCompoundSystemDeflection):
    '''ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2178.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2178.ZerolBevelGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2178.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2178.ZerolBevelGearSystemDeflection))
        return value
