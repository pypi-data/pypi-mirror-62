...
class WormGearCompoundSystemDeflection(_2450.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_353.WormGearDutyCycleRating':
        ...
        return constructor.new(_353.WormGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def worm_duty_cycle_rating(self) -> '_353.WormGearDutyCycleRating':
        ...
        return constructor.new(_353.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2383.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2383.WormGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2383.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2383.WormGearSystemDeflection))
        return value
