...
class ConicalGearCompoundSystemDeflection(_2384.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_322.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_322.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_322.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
