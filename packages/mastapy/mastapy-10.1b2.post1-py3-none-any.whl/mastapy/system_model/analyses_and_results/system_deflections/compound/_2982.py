...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2792
...
class TorqueConverterPumpCompoundSystemDeflection(_2792.CouplingHalfCompoundSystemDeflection):
    '''TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2209.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2209.TorqueConverterPumpSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2209.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2209.TorqueConverterPumpSystemDeflection))
        return value
