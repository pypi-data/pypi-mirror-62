...
class StraightBevelDiffGearCompoundSystemDeflection(_2414.BevelGearCompoundSystemDeflection):
    '''StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_design(self) -> '_2008.StraightBevelDiffGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2372.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2372.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2372.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2372.StraightBevelDiffGearSystemDeflection))
        return value
