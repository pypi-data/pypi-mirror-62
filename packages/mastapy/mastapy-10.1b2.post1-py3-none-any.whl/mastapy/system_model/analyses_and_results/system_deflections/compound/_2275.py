...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2303
...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2303.ConicalGearCompoundSystemDeflection):
    '''AGMAGleasonConicalGearCompoundSystemDeflection
