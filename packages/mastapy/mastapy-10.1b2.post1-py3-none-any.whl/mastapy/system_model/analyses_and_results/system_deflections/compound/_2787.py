...
class ConicalGearSetCompoundSystemDeflection(_2808.GearSetCompoundSystemDeflection):
    '''ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_402.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_402.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
