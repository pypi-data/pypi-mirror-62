...
from mastapy.gears.rating.face import _464
...
class GearCompoundSystemDeflection(_2610.MountableComponentCompoundSystemDeflection):
    '''GearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_333.GearDutyCycleRating':
        ...
        return constructor.new(_333.GearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def duty_cycle_rating_of_type_worm_gear_duty_cycle_rating(self) -> '_350.WormGearDutyCycleRating':
        ...
        return constructor.new(_350.WormGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def duty_cycle_rating_of_type_face_gear_duty_cycle_rating(self) -> '_464.FaceGearDutyCycleRating':
        ...
        return constructor.new(_464.FaceGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def duty_cycle_rating_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_469.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_469.CylindricalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def duty_cycle_rating_of_type_conical_gear_duty_cycle_rating(self) -> '_547.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_547.ConicalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None
