...
class ConicalGearCompoundSystemDeflection(_2582.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_547.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_547.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_547.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
