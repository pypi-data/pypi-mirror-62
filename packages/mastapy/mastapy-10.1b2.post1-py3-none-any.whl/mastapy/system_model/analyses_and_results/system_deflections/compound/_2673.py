...
class ConicalGearCompoundSystemDeflection(_2694.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_550.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_550.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_550.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
