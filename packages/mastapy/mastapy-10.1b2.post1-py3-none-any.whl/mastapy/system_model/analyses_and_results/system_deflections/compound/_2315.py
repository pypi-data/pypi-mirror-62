...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2325
...
class CylindricalGearMeshCompoundSystemDeflection(_2325.GearMeshCompoundSystemDeflection):
    '''CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_393.CylindricalMeshDutyCycleRating':
        ...
        return constructor.new(_393.CylindricalMeshDutyCycleRating)(self.wrapped.CylindricalMeshRating) if self.wrapped.CylindricalMeshRating else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2171.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2171.CylindricalGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2171.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2171.CylindricalGearMeshSystemDeflection))
        return value
