...
from mastapy.bearings.bearing_results import _1528
...
class BearingCompoundSystemDeflection(_2677.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1528.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1528.LoadedBearingDutyCycle)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2151.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2151.BearingSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2151.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2151.BearingSystemDeflection))
        return value
