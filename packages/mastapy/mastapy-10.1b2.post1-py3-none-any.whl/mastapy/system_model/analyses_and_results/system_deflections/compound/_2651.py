...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2648, _2650, _2535
...
class StraightBevelGearSetCompoundSystemDeflection(_2535.BevelGearSetCompoundSystemDeflection):
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2648.StraightBevelGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundSystemDeflection, constructor.new(_2648.StraightBevelGearCompoundSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2650.StraightBevelGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundSystemDeflection, constructor.new(_2650.StraightBevelGearMeshCompoundSystemDeflection))
        return value
