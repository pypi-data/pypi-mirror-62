...
class GearCompoundSystemDeflection(_2826.MountableComponentCompoundSystemDeflection):
    '''GearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_463.CylindricalGearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_conical_gear_duty_cycle_rating(self) -> '_544.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_544.ConicalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def duty_cycle_rating_of_type_concept_gear_duty_cycle_rating(self) -> '_547.ConceptGearDutyCycleRating':
        ...
        return constructor.new(_547.ConceptGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None
