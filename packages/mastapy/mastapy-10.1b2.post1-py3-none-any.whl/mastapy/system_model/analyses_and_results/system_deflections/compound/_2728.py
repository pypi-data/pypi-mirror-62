...
class ShaftDutyCycleSystemDeflection(_1.APIBase):
    ...
    @property
    def shaft_design(self) -> '_1952.Shaft':
        ...
        return constructor.new(_1952.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign else None
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2076.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2076.ShaftSystemDeflection))
        return value
