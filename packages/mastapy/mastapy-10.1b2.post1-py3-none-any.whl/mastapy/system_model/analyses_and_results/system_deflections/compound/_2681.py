...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2531
...
class CVTBeltConnectionCompoundSystemDeflection(_2531.BeltConnectionCompoundSystemDeflection):
    '''CVTBeltConnectionCompoundSystemDeflection
