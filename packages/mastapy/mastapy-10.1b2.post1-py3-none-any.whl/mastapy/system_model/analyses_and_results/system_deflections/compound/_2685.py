...
from mastapy.gears.rating.cylindrical import _490
...
class CylindricalGearMeshCompoundSystemDeflection(_2695.GearMeshCompoundSystemDeflection):
    '''CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_490.CylindricalMeshDutyCycleRating':
        ...
        return constructor.new(_490.CylindricalMeshDutyCycleRating)(self.wrapped.CylindricalMeshRating) if self.wrapped.CylindricalMeshRating else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2381.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2381.CylindricalGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2381.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2381.CylindricalGearMeshSystemDeflection))
        return value
