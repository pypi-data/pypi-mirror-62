...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2756
...
class ImportedFEComponentCompoundSystemDeflection(_2756.AbstractShaftOrHousingCompoundSystemDeflection):
    '''ImportedFEComponentCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2282.ImportedFEComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2282.ImportedFEComponentSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2282.ImportedFEComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2282.ImportedFEComponentSystemDeflection))
        return value
