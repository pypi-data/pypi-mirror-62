...
from mastapy.system_model.imported_fes import _1894
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2760
...
class RootAssemblyCompoundSystemDeflection(_2760.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3162.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3162.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1894.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1894.RaceBearingFESystemDeflection))
        return value
