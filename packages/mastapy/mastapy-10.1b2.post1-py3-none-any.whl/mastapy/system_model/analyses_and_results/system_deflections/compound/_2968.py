...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2769
...
class StraightBevelDiffGearCompoundSystemDeflection(_2769.BevelGearCompoundSystemDeflection):
    '''StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2360.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2360.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2360.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2360.StraightBevelDiffGearSystemDeflection))
        return value
