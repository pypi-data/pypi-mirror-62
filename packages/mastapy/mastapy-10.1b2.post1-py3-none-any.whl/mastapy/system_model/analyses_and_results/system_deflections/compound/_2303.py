...
class ConicalGearCompoundSystemDeflection(_2324.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_448.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_448.ConicalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def conical_duty_cycle_rating(self) -> '_448.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_448.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
