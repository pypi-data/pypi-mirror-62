...
class StraightBevelGearCompoundSystemDeflection(_2414.BevelGearCompoundSystemDeflection):
    '''StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def component_design(self) -> '_2010.StraightBevelGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2376.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2376.StraightBevelGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2376.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2376.StraightBevelGearSystemDeflection))
        return value
