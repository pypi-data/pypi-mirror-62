...
from mastapy.gears.rating.conical import _378
...
class ConicalGearSetCompoundSystemDeflection(_2584.GearSetCompoundSystemDeflection):
    '''ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_378.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_378.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
