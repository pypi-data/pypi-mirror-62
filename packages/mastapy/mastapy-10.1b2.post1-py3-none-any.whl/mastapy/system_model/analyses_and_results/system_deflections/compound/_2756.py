...
class WormGearCompoundSystemDeflection(_2694.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_360.WormGearDutyCycleRating':
    ...
    @property
    def worm_duty_cycle_rating(self) -> '_360.WormGearDutyCycleRating':
        ...
        return constructor.new(_360.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2378.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2378.WormGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2378.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2378.WormGearSystemDeflection))
        return value
