...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2341
...
class CVTCompoundSystemDeflection(_2341.BeltDriveCompoundSystemDeflection):
    '''CVTCompoundSystemDeflection
