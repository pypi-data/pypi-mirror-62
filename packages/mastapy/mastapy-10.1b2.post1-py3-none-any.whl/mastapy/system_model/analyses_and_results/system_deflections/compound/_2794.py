...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2763
...
class CVTCompoundSystemDeflection(_2763.BeltDriveCompoundSystemDeflection):
    '''CVTCompoundSystemDeflection
