...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3030
from mastapy.system_model.imported_fes import _1900
...
class RootAssemblyCompoundSystemDeflection(_2411.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3030.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3030.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1900.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1900.RaceBearingFESystemDeflection))
        return value
