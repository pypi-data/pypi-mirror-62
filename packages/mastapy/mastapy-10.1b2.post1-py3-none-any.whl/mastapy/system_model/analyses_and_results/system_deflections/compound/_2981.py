...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2791
...
class TorqueConverterConnectionCompoundSystemDeflection(_2791.CouplingConnectionCompoundSystemDeflection):
    '''TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2233.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2233.TorqueConverterConnectionSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2233.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2233.TorqueConverterConnectionSystemDeflection))
        return value
