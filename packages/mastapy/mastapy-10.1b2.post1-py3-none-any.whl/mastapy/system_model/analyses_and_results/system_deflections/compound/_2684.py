...
class CylindricalGearCompoundSystemDeflection(_2694.GearCompoundSystemDeflection):
    '''CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_481.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_duty_cycle_rating(self) -> '_481.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_481.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating else None
