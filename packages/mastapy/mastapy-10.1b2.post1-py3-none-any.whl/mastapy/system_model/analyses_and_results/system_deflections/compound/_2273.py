...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2346
...
class AbstractAssemblyCompoundSystemDeflection(_2346.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
