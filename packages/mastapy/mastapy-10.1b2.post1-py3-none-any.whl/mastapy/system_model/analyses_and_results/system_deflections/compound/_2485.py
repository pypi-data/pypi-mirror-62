...
class ShaftDutyCycleSystemDeflection(_1.APIBase):
    ...
    @property
    def shaft_design(self) -> '_1946.Shaft':
        ...
        return constructor.new(_1946.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign else None
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2069.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2069.ShaftSystemDeflection))
        return value
