...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2638, _2639, _2460
...
class WormGearSetCompoundSystemDeflection(_2460.GearSetCompoundSystemDeflection):
    '''WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gear_set_rating(self) -> '_382.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_382.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetRating) if self.wrapped.WormGearSetRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2220.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2220.WormGearSetSystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2220.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2220.WormGearSetSystemDeflection))
        return value
