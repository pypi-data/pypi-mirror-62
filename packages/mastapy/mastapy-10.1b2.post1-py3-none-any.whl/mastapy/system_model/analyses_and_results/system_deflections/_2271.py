...
class PartToPartShearCouplingConnectionSystemDeflection(_2222.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3269.PartToPartShearCouplingConnectionPowerFlow':
