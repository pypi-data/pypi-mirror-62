...
class CylindricalGearSystemDeflectionWithLTCAResults(_2177.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_749.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_749.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
