...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2350.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2359.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
        ...
        return constructor.new(_2359.KlingelnbergCycloPalloidSpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
