...
from mastapy.gears.manufacturing.cylindrical import _526
from mastapy.system_model.analyses_and_results.system_deflections import _2177, _2171, _2189
...
class CylindricalGearSetSystemDeflection(_2189.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def manufacturing_analysis(self) -> '_526.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_526.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2177.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2177.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2171.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2171.CylindricalGearMeshSystemDeflection))
        return value
