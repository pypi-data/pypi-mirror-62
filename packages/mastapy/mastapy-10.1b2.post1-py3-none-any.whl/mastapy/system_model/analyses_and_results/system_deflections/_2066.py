...
from mastapy.system_model.analyses_and_results.system_deflections import _2233, _2067, _2137
...
class ShaftSystemDeflection(_2137.AbstractShaftOrHousingSystemDeflection):
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_729.SMTBitmap':
        ...
        return constructor.new(_729.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None

    @property
    def component_design(self) -> '_1943.Shaft':
    ...
    @property
    def component_load_case(self) -> '_2374.ShaftLoadCase':
        ...
        return constructor.new(_2374.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2233.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2233.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2233.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2233.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2233.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2233.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2233.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2233.ShaftSectionEndResultsSystemDeflection))
        return value
