...
class StraightBevelDiffGearSystemDeflection(_2161.BevelGearSystemDeflection):
    ...
    @property
    def component_detailed_analysis(self) -> '_424.StraightBevelDiffGearRating':
        ...
        return constructor.new(_424.StraightBevelDiffGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
