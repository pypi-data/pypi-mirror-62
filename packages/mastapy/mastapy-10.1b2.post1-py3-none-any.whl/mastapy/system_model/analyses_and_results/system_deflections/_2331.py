...
class ConicalGearSystemDeflection(_2341.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_894.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_894.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
