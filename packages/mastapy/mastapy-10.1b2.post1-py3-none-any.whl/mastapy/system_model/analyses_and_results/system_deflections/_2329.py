...
class CylindricalGearSystemDeflectionWithLTCAResults(_2385.CylindricalGearSystemDeflection):
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_868.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_868.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
