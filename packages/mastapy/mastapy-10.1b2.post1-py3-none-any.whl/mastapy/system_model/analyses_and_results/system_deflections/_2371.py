...
class StraightBevelGearSystemDeflection(_2162.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2372.StraightBevelGearLoadCase':
        ...
        return constructor.new(_2372.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
