...
from mastapy.system_model.analyses_and_results.system_deflections import _2196, _2194, _2200
...
class BevelDifferentialGearSetSystemDeflection(_2200.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3205.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2196.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2196.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2194.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2194.BevelDifferentialGearMeshSystemDeflection))
        return value
