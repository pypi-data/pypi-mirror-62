...
from mastapy.nodal_analysis import _63, _51
...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2267
...
class CylindricalGearMeshSystemDeflection(_2188.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def loaded_flank(self) -> '_63.GearMeshContactStatus':
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def gear_a(self) -> '_2177.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2177.CylindricalGearSystemDeflection)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2178.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2178.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2178.CylindricalGearSystemDeflectionTimestep)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2179.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2179.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2179.CylindricalGearSystemDeflectionWithLTCAResults)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2180.CylindricalPlanetGearSystemDeflection':
        ...
        if _2180.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearA.__class__.__mro__:
        ...
        return constructor.new(_2180.CylindricalPlanetGearSystemDeflection)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_b(self) -> '_2177.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2177.CylindricalGearSystemDeflection)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2178.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2178.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2178.CylindricalGearSystemDeflectionTimestep)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2179.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2179.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2179.CylindricalGearSystemDeflectionWithLTCAResults)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2180.CylindricalPlanetGearSystemDeflection':
        ...
        if _2180.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearB.__class__.__mro__:
        ...
        return constructor.new(_2180.CylindricalPlanetGearSystemDeflection)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def misalignment_data(self) -> '_51.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_51.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_51.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_51.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_51.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_51.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2177.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2177.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2267.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2267.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2267.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2267.MeshDeflectionResults))
        return value
