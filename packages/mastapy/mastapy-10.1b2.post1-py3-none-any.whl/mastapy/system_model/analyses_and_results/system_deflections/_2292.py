...
class SpringDamperConnectionSystemDeflection(_2222.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3291.SpringDamperConnectionPowerFlow':
