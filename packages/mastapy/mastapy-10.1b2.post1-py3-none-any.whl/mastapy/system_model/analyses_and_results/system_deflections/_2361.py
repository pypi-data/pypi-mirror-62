...
class StraightBevelDiffGearSystemDeflection(_2155.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2362.StraightBevelDiffGearLoadCase':
        ...
        return constructor.new(_2362.StraightBevelDiffGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_410.StraightBevelDiffGearRating':
        ...
        return constructor.new(_410.StraightBevelDiffGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
