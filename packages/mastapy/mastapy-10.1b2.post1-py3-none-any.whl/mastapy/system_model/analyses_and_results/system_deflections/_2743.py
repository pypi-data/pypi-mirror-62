...
from mastapy.system_model.drawing import _1760, _1758
...
class SystemDeflectionDrawStyle(_1758.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1760.ScalingDrawStyle':
        ...
        return constructor.new(_1760.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
