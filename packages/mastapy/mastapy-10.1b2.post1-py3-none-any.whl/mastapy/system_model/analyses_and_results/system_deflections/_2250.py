...
from mastapy.system_model.analyses_and_results.system_deflections import _2251, _2249, _2188
...
class HypoidGearSetSystemDeflection(_2188.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3252.HypoidGearSetPowerFlow':
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2251.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2251.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2249.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2249.HypoidGearMeshSystemDeflection))
        return value
