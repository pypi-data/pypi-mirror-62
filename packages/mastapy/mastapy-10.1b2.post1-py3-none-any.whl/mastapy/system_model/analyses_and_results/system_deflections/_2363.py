...
class SpiralBevelGearSystemDeflection(_2162.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2364.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_2364.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
