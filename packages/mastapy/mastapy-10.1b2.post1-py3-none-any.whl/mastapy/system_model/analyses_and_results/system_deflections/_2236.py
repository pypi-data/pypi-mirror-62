...
class CylindricalGearSystemDeflectionWithLTCAResults(_2234.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_623.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_623.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
