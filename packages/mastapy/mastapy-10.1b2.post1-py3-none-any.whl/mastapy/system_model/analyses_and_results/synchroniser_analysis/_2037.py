...
from mastapy.system_model.analyses_and_results.load_case_groups import _2034
from mastapy.system_model.part_model.couplings import _2054, _2056
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2054.SynchroniserHalf':
        ...
        return constructor.new(_2054.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2056.SynchroniserSleeve':
        ...
        return constructor.new(_2056.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
