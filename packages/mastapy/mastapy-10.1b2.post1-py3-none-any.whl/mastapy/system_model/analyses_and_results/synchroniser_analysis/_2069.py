...
from mastapy.system_model.analyses_and_results.load_case_groups import _2066
from mastapy.system_model.part_model.couplings import _2030, _2032
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2030.SynchroniserHalf':
        ...
        return constructor.new(_2030.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2032.SynchroniserSleeve':
        ...
        return constructor.new(_2032.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
