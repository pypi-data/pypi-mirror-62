...
from mastapy.system_model.analyses_and_results.load_case_groups import _2041
from mastapy.system_model.part_model.couplings import _2061, _2063
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2061.SynchroniserHalf':
        ...
        return constructor.new(_2061.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2063.SynchroniserSleeve':
        ...
        return constructor.new(_2063.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
