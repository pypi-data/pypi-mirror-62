...
from mastapy.system_model.part_model.couplings import _1934, _1936
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_1934.SynchroniserHalf':
        ...
        return constructor.new(_1934.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_1936.SynchroniserSleeve':
        ...
        return constructor.new(_1936.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
