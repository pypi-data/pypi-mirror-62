...
from mastapy.system_model.analyses_and_results.load_case_groups import _2060
from mastapy.system_model.part_model.couplings import _2047, _2049
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2047.SynchroniserHalf':
        ...
        return constructor.new(_2047.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2049.SynchroniserSleeve':
        ...
        return constructor.new(_2049.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
