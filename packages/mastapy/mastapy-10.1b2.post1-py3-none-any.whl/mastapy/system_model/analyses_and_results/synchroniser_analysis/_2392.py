...
from mastapy.system_model.part_model.couplings import _2058, _2060
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2058.SynchroniserHalf':
        ...
        return constructor.new(_2058.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2060.SynchroniserSleeve':
        ...
        return constructor.new(_2060.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
