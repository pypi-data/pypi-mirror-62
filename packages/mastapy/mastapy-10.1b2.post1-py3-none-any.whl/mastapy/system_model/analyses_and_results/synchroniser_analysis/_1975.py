...
from mastapy.system_model.analyses_and_results.load_case_groups import _1971
from mastapy.system_model.part_model.couplings import _2032, _2034
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2032.SynchroniserHalf':
        ...
        return constructor.new(_2032.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None
