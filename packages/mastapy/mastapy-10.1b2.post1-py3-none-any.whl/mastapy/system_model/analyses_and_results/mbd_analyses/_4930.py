...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4837
...
class StraightBevelDiffGearMultiBodyDynamicsAnalysis(_4837.BevelGearMultiBodyDynamicsAnalysis):
    '''StraightBevelDiffGearMultiBodyDynamicsAnalysis
