...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4945, _4858
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_4858.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_4945.TorqueConverterStatus':
        ...
        return constructor.new(_4945.TorqueConverterStatus)(value) if value else None
