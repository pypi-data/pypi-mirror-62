...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4822
...
class BevelGearMeshMultiBodyDynamicsAnalysis(_4822.AGMAGleasonConicalGearMeshMultiBodyDynamicsAnalysis):
    '''BevelGearMeshMultiBodyDynamicsAnalysis
