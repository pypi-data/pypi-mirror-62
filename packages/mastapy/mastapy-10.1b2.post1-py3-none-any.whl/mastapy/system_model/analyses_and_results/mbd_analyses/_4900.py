...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4886, _4921, _4916
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.analysis_cases import _6299
from mastapy.system_model.analyses_and_results.static_loads import _6022
...
class MBDRunUpAnalysisOptions(_6299.AbstractAnalysisOptions['_6022.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_4886.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_4886.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_4886.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_4921.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_4921.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_4921.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_4916.RunUpDrivingMode':
        ...
        return constructor.new(_4916.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_4916.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
