...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4903
from mastapy.system_model.analyses_and_results.analysis_cases import _6305
...
class ConnectionMultiBodyDynamicsAnalysis(_6305.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_4903.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_4903.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
