...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _6052, _6054
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5951.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_6052.DynamicForceVector3DResult':
        ...
        return constructor.new(_6052.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_6054.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_6054.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
