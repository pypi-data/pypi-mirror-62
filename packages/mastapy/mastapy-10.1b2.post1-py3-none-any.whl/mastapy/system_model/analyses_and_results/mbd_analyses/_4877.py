...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4876, _4922
...
class GearSetMultiBodyDynamicsAnalysis(_4922.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_4876.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_4876.GearMultiBodyDynamicsAnalysis))
        return value
