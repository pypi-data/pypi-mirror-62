...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5970, _6016
...
class GearSetMultiBodyDynamicsAnalysis(_6016.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5970.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5970.GearMultiBodyDynamicsAnalysis))
        return value
