...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _4961
...
class MBDAnalysisOptions(_1.APIBase):
    ...
    @property
    def analysis_type(self) -> '_4825.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4825.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4825.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_4883.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_4883.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_4883.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_4884.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_4884.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_4884.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_interface_options(self) -> '_4961.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_4961.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_4900.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_4900.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4611.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4611.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
