...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4924, _4923, _4838
...
class SpiralBevelGearSetMultiBodyDynamicsAnalysis(_4838.BevelGearSetMultiBodyDynamicsAnalysis):
    '''SpiralBevelGearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_4924.SpiralBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_4924.SpiralBevelGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def spiral_bevel_gears_multi_body_dynamics_analysis(self) -> 'List[_4924.SpiralBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsMultiBodyDynamicsAnalysis, constructor.new(_4924.SpiralBevelGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def spiral_bevel_meshes_multi_body_dynamics_analysis(self) -> 'List[_4923.SpiralBevelGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesMultiBodyDynamicsAnalysis, constructor.new(_4923.SpiralBevelGearMeshMultiBodyDynamicsAnalysis))
        return value
