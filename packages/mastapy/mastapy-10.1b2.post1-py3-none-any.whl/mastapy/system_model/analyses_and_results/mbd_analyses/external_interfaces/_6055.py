...
class DynamicExternalInterfaceOptions(_1.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5979.InputSignalFilterLevel':
        ...
        return constructor.new(_5979.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5979.InputSignalFilterLevel'):
