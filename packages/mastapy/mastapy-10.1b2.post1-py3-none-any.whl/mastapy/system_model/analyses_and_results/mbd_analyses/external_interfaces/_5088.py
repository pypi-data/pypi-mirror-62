...
class DynamicExternalInterfaceOptions(_1.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5009.InputSignalFilterLevel':
        ...
        return constructor.new(_5009.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5009.InputSignalFilterLevel'):
