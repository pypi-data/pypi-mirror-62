...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4885
...
class DynamicExternalInterfaceOptions(_1.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_4885.InputSignalFilterLevel':
        ...
        return constructor.new(_4885.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_4885.InputSignalFilterLevel'):
