...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5997, _5921
...
class RootAssemblyMultiBodyDynamicsAnalysis(_5921.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5997.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5997.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
