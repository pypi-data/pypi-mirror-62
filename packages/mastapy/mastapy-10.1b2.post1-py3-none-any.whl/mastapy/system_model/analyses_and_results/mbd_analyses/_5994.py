...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5980, _6015, _6010
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.analysis_cases import _3270
from mastapy.system_model.analyses_and_results.static_loads import _5218
...
class MBDRunUpAnalysisOptions(_3270.AbstractAnalysisOptions['_5218.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5980.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5980.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5980.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_6015.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_6015.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_6015.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_6010.RunUpDrivingMode':
        ...
        return constructor.new(_6010.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_6010.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
