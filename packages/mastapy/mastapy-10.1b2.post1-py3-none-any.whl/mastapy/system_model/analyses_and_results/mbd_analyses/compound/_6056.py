...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6130
...
class AbstractAssemblyCompoundMultiBodyDynamicsAnalysis(_6130.PartCompoundMultiBodyDynamicsAnalysis):
    '''AbstractAssemblyCompoundMultiBodyDynamicsAnalysis
