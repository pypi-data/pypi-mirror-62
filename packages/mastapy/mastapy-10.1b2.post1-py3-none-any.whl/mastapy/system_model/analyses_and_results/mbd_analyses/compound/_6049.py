...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6122
...
class AbstractAssemblyCompoundMultiBodyDynamicsAnalysis(_6122.PartCompoundMultiBodyDynamicsAnalysis):
    '''AbstractAssemblyCompoundMultiBodyDynamicsAnalysis
