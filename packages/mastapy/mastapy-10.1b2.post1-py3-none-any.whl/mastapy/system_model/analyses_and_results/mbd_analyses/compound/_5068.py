...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4943
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4997
...
class TorqueConverterCompoundMultiBodyDynamicsAnalysis(_4997.CouplingCompoundMultiBodyDynamicsAnalysis):
    '''TorqueConverterCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4943.TorqueConverterMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4943.TorqueConverterMultiBodyDynamicsAnalysis))
        return value

    @property
    def assembly_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4943.TorqueConverterMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4943.TorqueConverterMultiBodyDynamicsAnalysis))
        return value
