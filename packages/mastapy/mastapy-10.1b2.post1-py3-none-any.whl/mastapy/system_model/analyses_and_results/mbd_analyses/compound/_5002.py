...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5041
...
class CVTPulleyCompoundMultiBodyDynamicsAnalysis(_5041.PulleyCompoundMultiBodyDynamicsAnalysis):
    '''CVTPulleyCompoundMultiBodyDynamicsAnalysis
