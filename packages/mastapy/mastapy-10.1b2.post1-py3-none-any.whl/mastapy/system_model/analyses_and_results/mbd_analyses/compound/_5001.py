...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4970
...
class CVTCompoundMultiBodyDynamicsAnalysis(_4970.BeltDriveCompoundMultiBodyDynamicsAnalysis):
    '''CVTCompoundMultiBodyDynamicsAnalysis
