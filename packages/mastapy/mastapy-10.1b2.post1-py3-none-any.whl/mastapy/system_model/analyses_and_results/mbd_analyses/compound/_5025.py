...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4892
...
class KlingelnbergCycloPalloidHypoidGearCompoundMultiBodyDynamicsAnalysis(_5022.KlingelnbergCycloPalloidConicalGearCompoundMultiBodyDynamicsAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4892.KlingelnbergCycloPalloidHypoidGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4892.KlingelnbergCycloPalloidHypoidGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4892.KlingelnbergCycloPalloidHypoidGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4892.KlingelnbergCycloPalloidHypoidGearMultiBodyDynamicsAnalysis))
        return value
