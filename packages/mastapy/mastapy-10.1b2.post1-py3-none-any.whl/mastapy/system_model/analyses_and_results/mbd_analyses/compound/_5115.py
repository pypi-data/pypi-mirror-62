...
class ConceptCouplingHalfCompoundMultiBodyDynamicsAnalysis(_5126.CouplingHalfCompoundMultiBodyDynamicsAnalysis):
    '''ConceptCouplingHalfCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4972.ConceptCouplingHalfMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4972.ConceptCouplingHalfMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4972.ConceptCouplingHalfMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4972.ConceptCouplingHalfMultiBodyDynamicsAnalysis))
        return value
