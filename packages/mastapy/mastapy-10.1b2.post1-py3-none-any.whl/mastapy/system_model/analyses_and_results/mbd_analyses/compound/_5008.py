...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4869
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4985
...
class ExternalCADModelCompoundMultiBodyDynamicsAnalysis(_4985.ComponentCompoundMultiBodyDynamicsAnalysis):
    '''ExternalCADModelCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4869.ExternalCADModelMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4869.ExternalCADModelMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4869.ExternalCADModelMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4869.ExternalCADModelMultiBodyDynamicsAnalysis))
        return value
