...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4967
...
class RootAssemblyCompoundMultiBodyDynamicsAnalysis(_4967.AssemblyCompoundMultiBodyDynamicsAnalysis):
    '''RootAssemblyCompoundMultiBodyDynamicsAnalysis
