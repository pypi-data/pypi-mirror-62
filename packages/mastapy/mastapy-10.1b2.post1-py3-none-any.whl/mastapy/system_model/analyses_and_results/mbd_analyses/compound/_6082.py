...
class ConceptCouplingConnectionCompoundMultiBodyDynamicsAnalysis(_6093.CouplingConnectionCompoundMultiBodyDynamicsAnalysis):
    '''ConceptCouplingConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5941.ConceptCouplingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5941.ConceptCouplingConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5941.ConceptCouplingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5941.ConceptCouplingConnectionMultiBodyDynamicsAnalysis))
        return value
