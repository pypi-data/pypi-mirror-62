...
class SynchroniserCompoundMultiBodyDynamicsAnalysis(_5179.SpecialisedAssemblyCompoundMultiBodyDynamicsAnalysis):
    '''SynchroniserCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5065.SynchroniserMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5065.SynchroniserMultiBodyDynamicsAnalysis))
        return value

    @property
    def assembly_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5065.SynchroniserMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5065.SynchroniserMultiBodyDynamicsAnalysis))
        return value
