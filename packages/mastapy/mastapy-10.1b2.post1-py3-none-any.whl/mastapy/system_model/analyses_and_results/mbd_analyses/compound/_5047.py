...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4918
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4996
...
class ShaftHubConnectionCompoundMultiBodyDynamicsAnalysis(_4996.ConnectorCompoundMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4918.ShaftHubConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4918.ShaftHubConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4918.ShaftHubConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4918.ShaftHubConnectionMultiBodyDynamicsAnalysis))
        return value
