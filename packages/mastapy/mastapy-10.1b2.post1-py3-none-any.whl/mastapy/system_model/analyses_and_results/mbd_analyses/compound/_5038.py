...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4908
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5033
...
class PlanetCarrierCompoundMultiBodyDynamicsAnalysis(_5033.MountableComponentCompoundMultiBodyDynamicsAnalysis):
    '''PlanetCarrierCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4908.PlanetCarrierMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4908.PlanetCarrierMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4908.PlanetCarrierMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4908.PlanetCarrierMultiBodyDynamicsAnalysis))
        return value
