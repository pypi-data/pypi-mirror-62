...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4954
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _4976
...
class ZerolBevelGearCompoundMultiBodyDynamicsAnalysis(_4976.BevelGearCompoundMultiBodyDynamicsAnalysis):
    '''ZerolBevelGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4954.ZerolBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4954.ZerolBevelGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4954.ZerolBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4954.ZerolBevelGearMultiBodyDynamicsAnalysis))
        return value
