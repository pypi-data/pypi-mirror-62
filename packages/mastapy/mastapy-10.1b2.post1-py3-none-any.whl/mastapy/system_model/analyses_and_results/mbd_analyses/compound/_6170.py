...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6045
...
class WormGearCompoundMultiBodyDynamicsAnalysis(_6108.GearCompoundMultiBodyDynamicsAnalysis):
    '''WormGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6045.WormGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6045.WormGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_6045.WormGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_6045.WormGearMultiBodyDynamicsAnalysis))
        return value
