...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6031
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6162
...
class SynchroniserHalfCompoundMultiBodyDynamicsAnalysis(_6162.SynchroniserPartCompoundMultiBodyDynamicsAnalysis):
    '''SynchroniserHalfCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6031.SynchroniserHalfMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6031.SynchroniserHalfMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_6031.SynchroniserHalfMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_6031.SynchroniserHalfMultiBodyDynamicsAnalysis))
        return value
