...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6064
...
class CVTCompoundMultiBodyDynamicsAnalysis(_6064.BeltDriveCompoundMultiBodyDynamicsAnalysis):
    '''CVTCompoundMultiBodyDynamicsAnalysis
