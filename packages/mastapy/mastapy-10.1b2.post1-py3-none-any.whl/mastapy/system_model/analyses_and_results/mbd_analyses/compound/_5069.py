...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4941
...
class TorqueConverterConnectionCompoundMultiBodyDynamicsAnalysis(_4998.CouplingConnectionCompoundMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4941.TorqueConverterConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4941.TorqueConverterConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4941.TorqueConverterConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4941.TorqueConverterConnectionMultiBodyDynamicsAnalysis))
        return value
