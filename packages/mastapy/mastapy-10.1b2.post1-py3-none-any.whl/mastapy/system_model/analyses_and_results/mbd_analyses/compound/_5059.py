...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4933
...
class StraightBevelGearCompoundMultiBodyDynamicsAnalysis(_4976.BevelGearCompoundMultiBodyDynamicsAnalysis):
    '''StraightBevelGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4933.StraightBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4933.StraightBevelGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4933.StraightBevelGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4933.StraightBevelGearMultiBodyDynamicsAnalysis))
        return value
