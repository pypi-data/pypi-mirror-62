...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6137
...
class CVTPulleyCompoundMultiBodyDynamicsAnalysis(_6137.PulleyCompoundMultiBodyDynamicsAnalysis):
    '''CVTPulleyCompoundMultiBodyDynamicsAnalysis
