...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5035
...
class AbstractAssemblyCompoundMultiBodyDynamicsAnalysis(_5035.PartCompoundMultiBodyDynamicsAnalysis):
    '''AbstractAssemblyCompoundMultiBodyDynamicsAnalysis
