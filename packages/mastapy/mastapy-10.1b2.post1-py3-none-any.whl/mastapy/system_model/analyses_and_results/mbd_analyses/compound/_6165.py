...
class TorqueConverterConnectionCompoundMultiBodyDynamicsAnalysis(_6093.CouplingConnectionCompoundMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6035.TorqueConverterConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6035.TorqueConverterConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_6035.TorqueConverterConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_6035.TorqueConverterConnectionMultiBodyDynamicsAnalysis))
        return value
