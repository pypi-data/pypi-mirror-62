...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4947
...
class UnbalancedMassCompoundMultiBodyDynamicsAnalysis(_5073.VirtualComponentCompoundMultiBodyDynamicsAnalysis):
    '''UnbalancedMassCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4947.UnbalancedMassMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4947.UnbalancedMassMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4947.UnbalancedMassMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4947.UnbalancedMassMultiBodyDynamicsAnalysis))
        return value
