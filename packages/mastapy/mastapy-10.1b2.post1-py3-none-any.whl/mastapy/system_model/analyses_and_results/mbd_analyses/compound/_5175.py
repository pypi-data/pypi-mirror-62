...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5094
...
class RootAssemblyCompoundMultiBodyDynamicsAnalysis(_5094.AssemblyCompoundMultiBodyDynamicsAnalysis):
    '''RootAssemblyCompoundMultiBodyDynamicsAnalysis
