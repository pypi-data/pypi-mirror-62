...
class CylindricalGearCompoundMultiBodyDynamicsAnalysis(_6108.GearCompoundMultiBodyDynamicsAnalysis):
    '''CylindricalGearCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5959.CylindricalGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5959.CylindricalGearMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5959.CylindricalGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5959.CylindricalGearMultiBodyDynamicsAnalysis))
        return value
