...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5104
...
class BevelDifferentialGearMeshCompoundMultiBodyDynamicsAnalysis(_5104.BevelGearMeshCompoundMultiBodyDynamicsAnalysis):
    '''BevelDifferentialGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4955.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4955.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4955.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4955.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis))
        return value
