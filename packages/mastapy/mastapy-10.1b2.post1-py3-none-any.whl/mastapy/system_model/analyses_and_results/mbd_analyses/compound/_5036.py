...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4906
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5048
...
class PlanetaryConnectionCompoundMultiBodyDynamicsAnalysis(_5048.ShaftToMountableComponentConnectionCompoundMultiBodyDynamicsAnalysis):
    '''PlanetaryConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4906.PlanetaryConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4906.PlanetaryConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4906.PlanetaryConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4906.PlanetaryConnectionMultiBodyDynamicsAnalysis))
        return value
