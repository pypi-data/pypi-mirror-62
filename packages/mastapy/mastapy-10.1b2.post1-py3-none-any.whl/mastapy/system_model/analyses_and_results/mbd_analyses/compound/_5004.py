...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4864
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5014
...
class CylindricalGearMeshCompoundMultiBodyDynamicsAnalysis(_5014.GearMeshCompoundMultiBodyDynamicsAnalysis):
    '''CylindricalGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4864.CylindricalGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4864.CylindricalGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4864.CylindricalGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4864.CylindricalGearMeshMultiBodyDynamicsAnalysis))
        return value
