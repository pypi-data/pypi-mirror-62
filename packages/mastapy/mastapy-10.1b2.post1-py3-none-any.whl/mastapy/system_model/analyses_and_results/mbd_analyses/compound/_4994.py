...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5015
...
class ConicalGearSetCompoundMultiBodyDynamicsAnalysis(_5015.GearSetCompoundMultiBodyDynamicsAnalysis):
    '''ConicalGearSetCompoundMultiBodyDynamicsAnalysis
