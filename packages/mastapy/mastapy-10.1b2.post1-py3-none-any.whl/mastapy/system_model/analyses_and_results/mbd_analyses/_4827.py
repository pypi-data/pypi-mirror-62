...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _4958
...
class BearingMultiBodyDynamicsAnalysis(_4857.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
