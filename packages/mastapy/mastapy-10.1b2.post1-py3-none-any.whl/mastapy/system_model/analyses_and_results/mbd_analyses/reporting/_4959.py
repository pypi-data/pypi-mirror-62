...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _4956
...
class DynamicTorqueResultAtTime(_4956.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
