...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _6050
...
class DynamicTorqueResultAtTime(_6050.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
