...
from mastapy.system_model.analyses_and_results.analysis_cases import _6134
...
class ConnectionMultiBodyDynamicsAnalysis(_6134.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5997.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5997.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
