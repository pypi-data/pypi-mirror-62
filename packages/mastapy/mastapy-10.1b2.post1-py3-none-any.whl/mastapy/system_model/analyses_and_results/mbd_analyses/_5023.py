...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5088
...
class MBDAnalysisOptions(_1.APIBase):
    ...
    def bearing_stiffness_model(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BearingStiffnessModel':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_BearingStiffnessModel.implicit_type()
    ...
    def bearing_stiffness_model(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BearingStiffnessModel.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_BearingStiffnessModel.implicit_type().type_()
    ...
    def gear_mesh_stiffness_model(self) -> 'enum_with_selected_value.EnumWithSelectedValue_GearMeshStiffnessModel':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_GearMeshStiffnessModel.implicit_type()
    ...
    def gear_mesh_stiffness_model(self, value: 'enum_with_selected_value.EnumWithSelectedValue_GearMeshStiffnessModel.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_GearMeshStiffnessModel.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def analysis_type(self) -> '_4949.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4949.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4949.AnalysisTypes'):
    ...
    def include_shaft_and_housing_flexibilities(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ShaftAndHousingFlexibilityOption':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ShaftAndHousingFlexibilityOption.implicit_type()
    ...
    def include_shaft_and_housing_flexibilities(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ShaftAndHousingFlexibilityOption.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ShaftAndHousingFlexibilityOption.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def method_to_define_period(self) -> '_5007.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5007.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5007.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5008.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5008.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5008.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_1372.TransientSolverOptions':
        ...
        return constructor.new(_1372.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_5088.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5088.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5024.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5024.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4729.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4729.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
