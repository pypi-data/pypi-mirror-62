...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4911, _4922
...
class BeltDriveMultiBodyDynamicsAnalysis(_4922.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''BeltDriveMultiBodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_4911.PulleyMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_4911.PulleyMultiBodyDynamicsAnalysis))
        return value
