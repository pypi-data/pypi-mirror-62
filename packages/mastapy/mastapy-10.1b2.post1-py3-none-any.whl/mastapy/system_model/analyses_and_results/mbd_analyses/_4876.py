...
class GearMultiBodyDynamicsAnalysis(_4902.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_4959.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_4959.DynamicTorqueResultAtTime))
        return value
