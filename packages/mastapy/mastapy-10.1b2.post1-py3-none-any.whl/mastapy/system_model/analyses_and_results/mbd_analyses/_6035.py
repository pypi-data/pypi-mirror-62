...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6039, _5952
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5952.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_6039.TorqueConverterStatus':
        ...
        return constructor.new(_6039.TorqueConverterStatus)(value) if value else None
