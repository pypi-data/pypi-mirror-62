...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _5923, _5969, _5920, _6011,
    _5977, _5978, _5994
)
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _1944
from mastapy.nodal_analysis import _118
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _6055
from mastapy.system_model.analyses_and_results.modal_analyses import _5894
...
class MBDAnalysisOptions(_1.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5920.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_5920.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_5920.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5977.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5977.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5977.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5978.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5978.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5978.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_118.TransientSolverOptions':
        ...
        return constructor.new(_118.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_6055.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_6055.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5994.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5994.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_5894.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_5894.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
