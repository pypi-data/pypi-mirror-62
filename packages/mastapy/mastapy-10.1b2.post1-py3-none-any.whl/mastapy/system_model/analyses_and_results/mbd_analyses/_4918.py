...
from mastapy.system_model.analyses_and_results.static_loads import _5997
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _4958, _4960
from mastapy.system_model.analyses_and_results.mbd_analyses import _4857
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_4857.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def component_design(self) -> '_2053.ShaftHubConnection':
    ...
    @property
    def component_load_case(self) -> '_5997.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_5997.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def peak_dynamic_force(self) -> '_4958.DynamicForceVector3DResult':
        ...
        return constructor.new(_4958.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_4960.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_4960.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
