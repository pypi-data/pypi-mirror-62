...
from mastapy.system_model.analyses_and_results import _2159
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_6479.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1774.DesignEntity') -> '_2159.DesignEntityAnalysis':
        ...
        return constructor.new(_2159.DesignEntityAnalysis)(method_result) if method_result else None

    def results_for_design_entity_analysis(self, design_entity_analysis: '_2159.DesignEntityAnalysis') -> '_2159.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
