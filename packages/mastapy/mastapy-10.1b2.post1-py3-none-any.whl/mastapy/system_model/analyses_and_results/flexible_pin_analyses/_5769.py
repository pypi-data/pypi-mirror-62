...
class FlexiblePinAnalysisManufactureLevel(_5765.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3482.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3482.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
