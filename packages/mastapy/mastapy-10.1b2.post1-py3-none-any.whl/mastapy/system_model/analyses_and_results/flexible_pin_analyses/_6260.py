...
class FlexiblePinAnalysisManufactureLevel(_6256.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4027.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4027.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
