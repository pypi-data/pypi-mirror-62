...
class FlexiblePinAnalysisManufactureLevel(_6250.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4016.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4016.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
