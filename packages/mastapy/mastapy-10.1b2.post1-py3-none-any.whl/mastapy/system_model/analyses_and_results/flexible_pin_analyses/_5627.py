...
class FlexiblePinAnalysisManufactureLevel(_5623.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3394.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3394.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
