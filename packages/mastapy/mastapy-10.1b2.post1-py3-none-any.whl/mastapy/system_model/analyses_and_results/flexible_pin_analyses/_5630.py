...
from mastapy.system_model.analyses_and_results.load_case_groups import _5086
from mastapy.system_model.part_model import _1938
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2356
from mastapy.system_model.analyses_and_results.system_deflections import _2222
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5622
...
class WindTurbineCertificationReport(_5622.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_1938.RootAssembly':
        ...
        return constructor.new(_1938.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2356.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2356.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2222.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2222.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2222.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2222.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
