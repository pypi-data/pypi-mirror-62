...
from mastapy.system_model.analyses_and_results.load_case_groups import _2068
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6255
...
class WindTurbineCertificationReport(_6255.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_1945.RootAssembly':
        ...
        return constructor.new(_1945.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2608.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2608.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2248.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2248.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2248.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2248.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
