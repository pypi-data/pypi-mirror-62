...
class BevelGearMeshSteadyStateSynchronousResponseAtASpeed(_4425.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed):
    '''BevelGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_design(self) -> '_1802.BevelGearMesh':
