...
from mastapy.system_model.connections_and_sockets.gears import _1855
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2754
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _2824
...
class HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_2824.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1855.HypoidGearMesh':
    ...
    @property
    def connection_design(self) -> '_1855.HypoidGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2754.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2754.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2754.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2754.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
