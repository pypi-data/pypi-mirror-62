...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_4557.BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4432.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4432.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_4432.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_4432.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
