...
from mastapy.system_model.analyses_and_results.analysis_cases import _6302
...
class ConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_6302.ConnectionCompoundAnalysis):
    '''ConnectionCompoundSteadyStateSynchronousResponseAtASpeed
