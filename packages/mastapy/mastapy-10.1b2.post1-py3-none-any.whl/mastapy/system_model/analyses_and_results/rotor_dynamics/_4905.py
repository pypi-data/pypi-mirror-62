...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _4903
...
class ShaftModalComplexShape(_4903.ShaftComplexShape['_1079.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
