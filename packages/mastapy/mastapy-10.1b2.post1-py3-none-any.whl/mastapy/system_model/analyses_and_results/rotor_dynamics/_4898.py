...
from mastapy.utility.units_and_measurements.measurements import _1105
...
class ShaftModalComplexShape(_4896.ShaftComplexShape['_1105.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
