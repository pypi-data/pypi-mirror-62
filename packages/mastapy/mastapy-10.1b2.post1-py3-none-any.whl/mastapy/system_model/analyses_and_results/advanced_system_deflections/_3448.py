...
class BearingAdvancedSystemDeflection(_3452.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1534.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1534.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None
