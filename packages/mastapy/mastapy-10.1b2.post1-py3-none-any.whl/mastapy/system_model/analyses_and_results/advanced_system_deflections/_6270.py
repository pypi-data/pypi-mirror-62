...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6216
...
class HypoidGearMeshAdvancedSystemDeflection(_6216.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    '''HypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6112.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_6112.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2249.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2249.HypoidGearMeshSystemDeflection))
        return value
