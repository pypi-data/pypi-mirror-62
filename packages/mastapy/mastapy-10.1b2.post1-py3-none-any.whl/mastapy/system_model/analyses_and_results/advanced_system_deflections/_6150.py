...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6148, _6149, _6074
...
class SpiralBevelGearSetAdvancedSystemDeflection(_6074.BevelGearSetAdvancedSystemDeflection):
    '''SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_333.SpiralBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_333.SpiralBevelGearSetRating':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_6148.SpiralBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsAdvancedSystemDeflection, constructor.new(_6148.SpiralBevelGearAdvancedSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_6149.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesAdvancedSystemDeflection, constructor.new(_6149.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2230.SpiralBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2230.SpiralBevelGearSetSystemDeflection))
        return value
