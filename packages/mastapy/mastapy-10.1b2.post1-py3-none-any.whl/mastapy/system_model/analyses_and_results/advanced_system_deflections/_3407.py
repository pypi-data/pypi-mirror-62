...
class SpringDamperAdvancedSystemDeflection(_3399.CouplingAdvancedSystemDeflection):
    '''SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2261.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2261.SpringDamperSystemDeflection))
        return value
