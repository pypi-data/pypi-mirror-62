...
from mastapy.gears.rating.klingelnberg_hypoid import _434
...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_3298.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_434.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_434.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2211.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2211.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
