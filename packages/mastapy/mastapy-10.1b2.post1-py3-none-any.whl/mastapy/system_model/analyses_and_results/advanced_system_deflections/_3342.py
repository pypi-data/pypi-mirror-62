...
class BevelGearAdvancedSystemDeflection(_3336.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''BevelGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1884.BevelGear':
