...
class GuideDxfModelAdvancedSystemDeflection(_6081.ComponentAdvancedSystemDeflection):
    '''GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2191.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2191.GuideDxfModelSystemDeflection))
        return value
