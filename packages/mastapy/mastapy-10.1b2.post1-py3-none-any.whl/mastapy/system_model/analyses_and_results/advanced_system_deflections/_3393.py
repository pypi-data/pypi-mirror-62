...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3392, _3444, _3483
...
class ZerolBevelGearSetAdvancedSystemDeflection(_3483.BevelGearSetAdvancedSystemDeflection):
    '''ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_361.ZerolBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_361.ZerolBevelGearSetRating':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_3392.ZerolBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsAdvancedSystemDeflection, constructor.new(_3392.ZerolBevelGearAdvancedSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_3444.ZerolBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesAdvancedSystemDeflection, constructor.new(_3444.ZerolBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2232.ZerolBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2232.ZerolBevelGearSetSystemDeflection))
        return value
