...
class SpiralBevelGearMeshAdvancedSystemDeflection(_6073.BevelGearMeshAdvancedSystemDeflection):
    '''SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_331.SpiralBevelGearMeshRating':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2229.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2229.SpiralBevelGearMeshSystemDeflection))
        return value
