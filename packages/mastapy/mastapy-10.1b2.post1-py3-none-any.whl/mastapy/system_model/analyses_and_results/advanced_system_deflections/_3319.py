...
class MassDiscAdvancedSystemDeflection(_3330.VirtualComponentAdvancedSystemDeflection):
    '''MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2322.MassDiscLoadCase':
        ...
        return constructor.new(_2322.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2218.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2218.MassDiscSystemDeflection))
        return value
