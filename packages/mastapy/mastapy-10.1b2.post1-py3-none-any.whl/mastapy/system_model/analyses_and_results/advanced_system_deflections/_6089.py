...
from mastapy.gears.gear_designs.conical import _996
...
class ConicalGearMeshAdvancedSystemDeflection(_6111.GearMeshAdvancedSystemDeflection):
    '''ConicalGearMeshAdvancedSystemDeflection
    ...
    @property
    def active_flank(self) -> '_996.ActiveConicalFlank':
    ...
    @property
    def inactive_flank(self) -> '_996.ActiveConicalFlank':
