...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6099, _6100, _6112
...
class CylindricalGearSetAdvancedSystemDeflection(_6112.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_899.CylindricalGearSetDesign':
        ...
        return constructor.new(_899.CylindricalGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None

    @property
    def micro_geometry(self) -> '_963.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_963.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6099.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6099.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6100.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6100.CylindricalGearMeshAdvancedSystemDeflection))
        return value
