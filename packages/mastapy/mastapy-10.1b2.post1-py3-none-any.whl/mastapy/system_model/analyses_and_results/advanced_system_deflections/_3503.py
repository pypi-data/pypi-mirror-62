...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3502, _3432, _3483
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_3483.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_3502.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsAdvancedSystemDeflection, constructor.new(_3502.StraightBevelDiffGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_3432.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesAdvancedSystemDeflection, constructor.new(_3432.StraightBevelDiffGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2380.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2380.StraightBevelDiffGearSetSystemDeflection))
        return value
