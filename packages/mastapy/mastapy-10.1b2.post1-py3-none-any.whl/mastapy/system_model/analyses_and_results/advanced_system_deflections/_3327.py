...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6307, _3316
...
class RootAssemblyAdvancedSystemDeflection(_3316.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6307.AdvancedSystemDeflection':
        ...
        return constructor.new(_6307.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
