...
class TransmissionErrorToOtherPowerLoad(_1.APIBase):
    '''TransmissionErrorToOtherPowerLoad
    ...
    @property
    def fourier_series_of_te(self) -> '_1184.FourierSeries':
        ...
        return constructor.new(_1184.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE else None
