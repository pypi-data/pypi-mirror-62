...
from mastapy.gears.gear_designs.cylindrical import _587, _594
from mastapy.gears.ltca.cylindrical import _888
...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3486, _3445
...
class CylindricalGearMeshAdvancedSystemDeflection(_3445.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def inactive_flank(self) -> '_296.CylindricalFlanks':
    ...
    @property
    def contact_chart_max_pressure_gear_a(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearA) if self.wrapped.ContactChartMaxPressureGearA else None
    ...
    @property
    def contact_chart_max_pressure_gear_b(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearB) if self.wrapped.ContactChartMaxPressureGearB else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_a(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearA) if self.wrapped.ContactChartGapToLoadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_b(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearB) if self.wrapped.ContactChartGapToLoadedFlankGearB else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_a(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearA) if self.wrapped.ContactChartGapToUnloadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_b(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearB) if self.wrapped.ContactChartGapToUnloadedFlankGearB else None
    ...
    @property
    def gear_mesh_design(self) -> '_587.CylindricalGearMeshDesign':
        ...
        return constructor.new(_587.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_888.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_888.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure else None

    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_877.FourierSeries':
        ...
        return constructor.new(_877.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2190.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2190.CylindricalGearMeshSystemDeflectionTimestep))
        return value

    @property
    def gear_designs(self) -> 'List[_594.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDesigns, constructor.new(_594.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_3486.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_3486.CylindricalGearAdvancedSystemDeflection))
        return value
