...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3337
...
class BevelGearSetAdvancedSystemDeflection(_3337.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''BevelGearSetAdvancedSystemDeflection
