...
class ShaftHubConnectionAdvancedSystemDeflection(_3312.ConnectorAdvancedSystemDeflection):
    '''ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2250.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_2250.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2249.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2249.ShaftHubConnectionSystemDeflection))
        return value
