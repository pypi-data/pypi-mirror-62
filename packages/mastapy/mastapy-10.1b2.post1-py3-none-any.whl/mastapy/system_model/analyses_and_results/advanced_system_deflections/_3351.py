...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3336
...
class HypoidGearAdvancedSystemDeflection(_3336.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2358.HypoidGearLoadCase':
        ...
        return constructor.new(_2358.HypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2205.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2205.HypoidGearSystemDeflection))
        return value
