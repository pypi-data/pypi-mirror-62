...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_6073.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_324.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_324.StraightBevelDiffGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2235.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2235.StraightBevelDiffGearMeshSystemDeflection))
        return value
