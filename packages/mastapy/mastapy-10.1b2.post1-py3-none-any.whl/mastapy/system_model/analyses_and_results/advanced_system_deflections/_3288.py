...
class TorqueConverterConnectionAdvancedSystemDeflection(_3286.CouplingConnectionAdvancedSystemDeflection):
    '''TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2286.TorqueConverterConnectionLoadCase':
        ...
        return constructor.new(_2286.TorqueConverterConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2285.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2285.TorqueConverterConnectionSystemDeflection))
        return value
