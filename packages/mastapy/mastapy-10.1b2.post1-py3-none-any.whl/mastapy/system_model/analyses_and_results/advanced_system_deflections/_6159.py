...
from mastapy.system_model.analyses_and_results.static_loads import _6014
from mastapy.gears.rating.straight_bevel import _330
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6157, _6158, _6074
...
class StraightBevelGearSetAdvancedSystemDeflection(_6074.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6014.StraightBevelGearSetLoadCase':
        ...
        return constructor.new(_6014.StraightBevelGearSetLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def rating(self) -> '_330.StraightBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_330.StraightBevelGearSetRating':
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_6157.StraightBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsAdvancedSystemDeflection, constructor.new(_6157.StraightBevelGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_6158.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesAdvancedSystemDeflection, constructor.new(_6158.StraightBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2239.StraightBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2239.StraightBevelGearSetSystemDeflection))
        return value
