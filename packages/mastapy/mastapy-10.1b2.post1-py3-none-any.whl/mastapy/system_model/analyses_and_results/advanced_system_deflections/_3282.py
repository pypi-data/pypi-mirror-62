...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3280
...
class RollingRingConnectionAdvancedSystemDeflection(_3280.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2277.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_2277.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2231.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2231.RollingRingConnectionSystemDeflection))
        return value
