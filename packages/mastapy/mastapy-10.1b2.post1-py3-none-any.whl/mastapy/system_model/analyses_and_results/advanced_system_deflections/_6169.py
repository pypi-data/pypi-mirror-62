...
class TorqueConverterTurbineAdvancedSystemDeflection(_6095.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2253.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2253.TorqueConverterTurbineSystemDeflection))
        return value
