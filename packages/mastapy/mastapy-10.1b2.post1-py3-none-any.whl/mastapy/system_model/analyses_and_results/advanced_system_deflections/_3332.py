...
from mastapy.system_model.part_model.gears import _1886
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads import _2339
from mastapy.gears.rating.concept import _565
...
class ConceptGearAdvancedSystemDeflection(_3349.GearAdvancedSystemDeflection):
    '''ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1886.ConceptGear':
    ...
    @property
    def component_load_case(self) -> '_2339.ConceptGearLoadCase':
        ...
        return constructor.new(_2339.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_565.ConceptGearRating':
        ...
        return constructor.new(_565.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2169.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2169.ConceptGearSystemDeflection))
        return value
