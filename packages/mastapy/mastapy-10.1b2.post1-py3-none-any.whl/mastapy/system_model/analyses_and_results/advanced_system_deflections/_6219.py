...
class BearingAdvancedSystemDeflection(_6247.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1549.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1549.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None
