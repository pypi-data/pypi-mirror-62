...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3271
...
class SynchroniserSleeveAdvancedSystemDeflection(_3271.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2264.SynchroniserSleeveLoadCase':
        ...
        return constructor.new(_2264.SynchroniserSleeveLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2263.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2263.SynchroniserSleeveSystemDeflection))
        return value
