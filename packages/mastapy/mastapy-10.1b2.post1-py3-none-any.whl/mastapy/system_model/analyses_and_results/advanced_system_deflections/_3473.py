...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3472, _3430, _3490
...
class ConceptGearSetAdvancedSystemDeflection(_3490.GearSetAdvancedSystemDeflection):
    '''ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_420.ConceptGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_420.ConceptGearSetRating':
        ...
        return constructor.new(_420.ConceptGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_3472.ConceptGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsAdvancedSystemDeflection, constructor.new(_3472.ConceptGearAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_3430.ConceptGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesAdvancedSystemDeflection, constructor.new(_3430.ConceptGearMeshAdvancedSystemDeflection))
        return value
