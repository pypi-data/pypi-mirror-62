...
from mastapy.system_model.analyses_and_results.static_loads import _2376
...
class StraightBevelGearAdvancedSystemDeflection(_3342.BevelGearAdvancedSystemDeflection):
    '''StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2376.StraightBevelGearLoadCase':
        ...
        return constructor.new(_2376.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_429.StraightBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2375.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2375.StraightBevelGearSystemDeflection))
        return value
