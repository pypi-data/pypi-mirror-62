...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3497, _3440, _3494
...
class KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection(_3494.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_409.KlingelnbergCycloPalloidSpiralBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_409.KlingelnbergCycloPalloidSpiralBevelGearSetRating':
        ...
        return constructor.new(_409.KlingelnbergCycloPalloidSpiralBevelGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_3497.KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsAdvancedSystemDeflection, constructor.new(_3497.KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_3440.KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesAdvancedSystemDeflection, constructor.new(_3440.KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2225.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2225.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection))
        return value
