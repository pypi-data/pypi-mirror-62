...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3321
...
class PlanetCarrierAdvancedSystemDeflection(_3321.MountableComponentAdvancedSystemDeflection):
    '''PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2327.PlanetCarrierLoadCase':
        ...
        return constructor.new(_2327.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2226.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2226.PlanetCarrierSystemDeflection))
        return value
