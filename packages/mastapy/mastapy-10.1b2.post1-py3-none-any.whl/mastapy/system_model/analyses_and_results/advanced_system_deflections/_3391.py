...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3508, _3443, _3490
...
class WormGearSetAdvancedSystemDeflection(_3490.GearSetAdvancedSystemDeflection):
    '''WormGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_383.WormGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_383.WormGearSetRating':
        ...
        return constructor.new(_383.WormGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_3508.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_3508.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_3443.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_3443.WormGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2220.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2220.WormGearSetSystemDeflection))
        return value
