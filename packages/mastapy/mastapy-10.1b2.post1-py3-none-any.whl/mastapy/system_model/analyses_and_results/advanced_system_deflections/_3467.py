...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6313, _3456
...
class RootAssemblyAdvancedSystemDeflection(_3456.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6313.AdvancedSystemDeflection':
        ...
        return constructor.new(_6313.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
