...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6061
...
class HypoidGearMeshAdvancedSystemDeflection(_6061.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    '''HypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_367.HypoidGearMeshRating':
        ...
        return constructor.new(_367.HypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2192.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2192.HypoidGearMeshSystemDeflection))
        return value
