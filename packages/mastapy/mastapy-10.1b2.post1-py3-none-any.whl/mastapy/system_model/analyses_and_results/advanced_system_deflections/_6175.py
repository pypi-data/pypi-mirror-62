...
from mastapy.gears.rating.worm import _302
...
class WormGearMeshAdvancedSystemDeflection(_6111.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_302.WormGearMeshRating':
        ...
        return constructor.new(_302.WormGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2258.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2258.WormGearMeshSystemDeflection))
        return value
