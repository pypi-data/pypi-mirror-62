...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6057
...
class ConnectionAdvancedSystemDeflection(_6304.ConnectionStaticLoadAnalysisCase):
    '''ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6057.AdvancedSystemDeflection':
        ...
        return constructor.new(_6057.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None
