...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_6228.BevelGearMeshAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    def component_detailed_analysis(self) -> '_338.BevelGearMeshRating':
        ...
        return constructor.new(_338.BevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2194.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2194.BevelDifferentialGearMeshSystemDeflection))
        return value
