...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_3493.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_433.KlingelnbergCycloPalloidHypoidGearRating':
        ...
        return constructor.new(_433.KlingelnbergCycloPalloidHypoidGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2222.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2222.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value
