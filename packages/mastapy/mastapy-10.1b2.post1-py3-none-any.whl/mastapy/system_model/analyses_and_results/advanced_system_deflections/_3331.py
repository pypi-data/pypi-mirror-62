...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3307
...
class ShaftAdvancedSystemDeflection(_3307.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2069.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2069.ShaftSystemDeflection))
        return value
