...
class PointLoadAdvancedSystemDeflection(_3330.VirtualComponentAdvancedSystemDeflection):
    '''PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2328.PointLoadLoadCase':
        ...
        return constructor.new(_2328.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2227.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2227.PointLoadSystemDeflection))
        return value
