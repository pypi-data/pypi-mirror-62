...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(_3493.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_429.KlingelnbergCycloPalloidSpiralBevelGearRating':
        ...
        return constructor.new(_429.KlingelnbergCycloPalloidSpiralBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2227.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2227.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
