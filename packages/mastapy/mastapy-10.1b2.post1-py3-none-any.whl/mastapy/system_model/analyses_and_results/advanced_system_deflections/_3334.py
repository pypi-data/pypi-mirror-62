...
class FaceGearAdvancedSystemDeflection(_3349.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2341.FaceGearLoadCase':
        ...
        return constructor.new(_2341.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_475.FaceGearRating':
        ...
        return constructor.new(_475.FaceGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2197.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2197.FaceGearSystemDeflection))
        return value
