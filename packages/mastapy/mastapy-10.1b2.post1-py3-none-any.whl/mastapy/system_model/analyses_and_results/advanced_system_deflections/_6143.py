...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6057, _6063
...
class RootAssemblyAdvancedSystemDeflection(_6063.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6057.AdvancedSystemDeflection':
        ...
        return constructor.new(_6057.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
