...
from mastapy.gears.rating.concept import _564
...
class ConceptGearMeshAdvancedSystemDeflection(_3305.GearMeshAdvancedSystemDeflection):
    '''ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_564.ConceptGearMeshRating':
        ...
        return constructor.new(_564.ConceptGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2166.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2166.ConceptGearMeshSystemDeflection))
        return value
