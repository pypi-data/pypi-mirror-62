...
from mastapy.gears.rating.hypoid import _461
from mastapy.system_model.analyses_and_results.system_deflections import _2203
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3295
...
class HypoidGearMeshAdvancedSystemDeflection(_3295.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    '''HypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2296.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_2296.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_461.HypoidGearMeshRating':
        ...
        return constructor.new(_461.HypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2203.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2203.HypoidGearMeshSystemDeflection))
        return value
