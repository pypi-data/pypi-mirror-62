...
class ZerolBevelGearMeshAdvancedSystemDeflection(_3293.BevelGearMeshAdvancedSystemDeflection):
    '''ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2307.ZerolBevelGearMeshLoadCase':
        ...
        return constructor.new(_2307.ZerolBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_350.ZerolBevelGearMeshRating':
        ...
        return constructor.new(_350.ZerolBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2306.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2306.ZerolBevelGearMeshSystemDeflection))
        return value
