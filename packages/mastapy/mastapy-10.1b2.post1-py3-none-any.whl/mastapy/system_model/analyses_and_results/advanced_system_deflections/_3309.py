...
class BoltAdvancedSystemDeflection(_3311.ComponentAdvancedSystemDeflection):
    '''BoltAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2312.BoltLoadCase':
        ...
        return constructor.new(_2312.BoltLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2156.BoltSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2156.BoltSystemDeflection))
        return value
