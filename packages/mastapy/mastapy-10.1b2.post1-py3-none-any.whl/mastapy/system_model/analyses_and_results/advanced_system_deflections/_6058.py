...
from mastapy.gears.ltca import _743
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6172
...
class AdvancedSystemDeflectionOptions(_1.APIBase):
    '''AdvancedSystemDeflectionOptions
    ...
    @property
    def use_advanced_ltca(self) -> '_743.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_743.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_743.UseAdvancedLTCAOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAdvancedLTCA = value

    @property
    def use_variable_bearing_stiffness(self) -> '_6172.UseVariableBearingStiffnessOptions':
        ...
        return constructor.new(_6172.UseVariableBearingStiffnessOptions)(value) if value else None

    @use_variable_bearing_stiffness.setter
    def use_variable_bearing_stiffness(self, value: '_6172.UseVariableBearingStiffnessOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def specified_gear_set(self, value: 'list_with_selected_item.ListWithSelectedItem_GearSet.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_GearSet.TYPE
