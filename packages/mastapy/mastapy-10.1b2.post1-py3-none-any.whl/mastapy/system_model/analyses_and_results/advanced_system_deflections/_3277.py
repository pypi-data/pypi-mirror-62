...
class BeltConnectionAdvancedSystemDeflection(_3280.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''BeltConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2272.BeltConnectionLoadCase':
        ...
        return constructor.new(_2272.BeltConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2145.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2145.BeltConnectionSystemDeflection))
        return value
