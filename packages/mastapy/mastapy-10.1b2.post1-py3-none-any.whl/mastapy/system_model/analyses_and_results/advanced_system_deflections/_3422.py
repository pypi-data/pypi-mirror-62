...
class RollingRingConnectionAdvancedSystemDeflection(_3420.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2285.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_2285.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2245.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2245.RollingRingConnectionSystemDeflection))
        return value
