...
class TorqueConverterPumpAdvancedSystemDeflection(_6250.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6179.TorqueConverterPumpLoadCase':
        ...
        return constructor.new(_6179.TorqueConverterPumpLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2311.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2311.TorqueConverterPumpSystemDeflection))
        return value
