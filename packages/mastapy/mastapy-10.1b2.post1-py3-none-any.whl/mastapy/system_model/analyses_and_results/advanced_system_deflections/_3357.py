...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(_3353.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_433.KlingelnbergCycloPalloidSpiralBevelGearRating':
        ...
        return constructor.new(_433.KlingelnbergCycloPalloidSpiralBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2216.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2216.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
