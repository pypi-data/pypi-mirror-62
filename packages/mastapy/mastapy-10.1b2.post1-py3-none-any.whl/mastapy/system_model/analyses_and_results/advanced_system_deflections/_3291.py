...
from mastapy.gears.rating.face import _474
...
class FaceGearMeshAdvancedSystemDeflection(_3305.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_474.FaceGearMeshRating':
        ...
        return constructor.new(_474.FaceGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2195.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2195.FaceGearMeshSystemDeflection))
        return value
