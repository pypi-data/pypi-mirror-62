...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6131
...
class PlanetCarrierAdvancedSystemDeflection(_6131.MountableComponentAdvancedSystemDeflection):
    '''PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2215.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2215.PlanetCarrierSystemDeflection))
        return value
