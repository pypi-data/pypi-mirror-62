...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3312
...
class BearingAdvancedSystemDeflection(_3312.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1522.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1522.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None

    @property
    def component_design(self) -> '_1858.Bearing':
    ...
    @property
    def component_load_case(self) -> '_2311.BearingLoadCase':
        ...
        return constructor.new(_2311.BearingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2144.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2144.BearingSystemDeflection))
        return value
