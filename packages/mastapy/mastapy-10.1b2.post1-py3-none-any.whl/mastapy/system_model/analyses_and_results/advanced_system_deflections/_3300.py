...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _432
from mastapy.system_model.analyses_and_results.system_deflections import _2214
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3298
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection(_3298.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_design(self) -> '_1813.KlingelnbergCycloPalloidSpiralBevelGearMesh':
    ...
    @property
    def connection_load_case(self) -> '_2299.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_2299.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_432.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_432.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2214.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2214.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
