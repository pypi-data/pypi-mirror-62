...
class ZerolBevelGearAdvancedSystemDeflection(_6072.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2015.ZerolBevelGear':
    ...
    @property
    def component_load_case(self) -> '_6035.ZerolBevelGearLoadCase':
        ...
        return constructor.new(_6035.ZerolBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_299.ZerolBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2263.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2263.ZerolBevelGearSystemDeflection))
        return value
