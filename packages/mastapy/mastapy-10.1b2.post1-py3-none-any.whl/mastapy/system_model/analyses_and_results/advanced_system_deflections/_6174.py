...
from mastapy.gears.rating.worm import _303
from mastapy.system_model.analyses_and_results.system_deflections import _2260
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6110
...
class WormGearAdvancedSystemDeflection(_6110.GearAdvancedSystemDeflection):
    '''WormGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6032.WormGearLoadCase':
        ...
        return constructor.new(_6032.WormGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_303.WormGearRating':
        ...
        return constructor.new(_303.WormGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2260.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2260.WormGearSystemDeflection))
        return value
