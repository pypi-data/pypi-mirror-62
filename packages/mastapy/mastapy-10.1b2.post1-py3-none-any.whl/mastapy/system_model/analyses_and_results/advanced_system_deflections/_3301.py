...
from mastapy.gears.rating.spiral_bevel import _430
...
class SpiralBevelGearMeshAdvancedSystemDeflection(_3293.BevelGearMeshAdvancedSystemDeflection):
    '''SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2301.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_2301.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_430.SpiralBevelGearMeshRating':
        ...
        return constructor.new(_430.SpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2300.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2300.SpiralBevelGearMeshSystemDeflection))
        return value
