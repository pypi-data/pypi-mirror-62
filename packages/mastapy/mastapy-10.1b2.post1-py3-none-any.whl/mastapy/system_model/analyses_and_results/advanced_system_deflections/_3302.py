...
from mastapy.gears.rating.straight_bevel import _428
...
class StraightBevelGearMeshAdvancedSystemDeflection(_3293.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2303.StraightBevelGearMeshLoadCase':
        ...
        return constructor.new(_2303.StraightBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_428.StraightBevelGearMeshRating':
        ...
        return constructor.new(_428.StraightBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2302.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2302.StraightBevelGearMeshSystemDeflection))
        return value
