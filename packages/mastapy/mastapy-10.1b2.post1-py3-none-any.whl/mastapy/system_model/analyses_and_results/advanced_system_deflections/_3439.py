...
from mastapy.gears.rating.klingelnberg_hypoid import _432
...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_3438.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_432.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_432.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2219.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2219.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
