...
from mastapy.system_model.analyses_and_results.static_loads import _6025
...
class TorqueConverterPumpAdvancedSystemDeflection(_6095.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6025.TorqueConverterPumpLoadCase':
        ...
        return constructor.new(_6025.TorqueConverterPumpLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2251.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2251.TorqueConverterPumpSystemDeflection))
        return value
