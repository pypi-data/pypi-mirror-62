...
class DatumAdvancedSystemDeflection(_3311.ComponentAdvancedSystemDeflection):
    '''DatumAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2316.DatumLoadCase':
        ...
        return constructor.new(_2316.DatumLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2192.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2192.DatumSystemDeflection))
        return value
