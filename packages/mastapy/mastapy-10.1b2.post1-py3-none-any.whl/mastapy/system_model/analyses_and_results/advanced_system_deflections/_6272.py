...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6211
...
class ImportedFEComponentAdvancedSystemDeflection(_6211.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ImportedFEComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2252.ImportedFEComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2252.ImportedFEComponentSystemDeflection))
        return value
