...
class WormGearMeshAdvancedSystemDeflection(_6266.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6188.WormGearMeshLoadCase':
        ...
        return constructor.new(_6188.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2318.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2318.WormGearMeshSystemDeflection))
        return value
