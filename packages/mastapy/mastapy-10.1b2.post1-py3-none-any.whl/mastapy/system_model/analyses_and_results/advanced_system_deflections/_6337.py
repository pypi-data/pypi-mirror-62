...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6335, _6336, _6229
...
class ZerolBevelGearSetAdvancedSystemDeflection(_6229.BevelGearSetAdvancedSystemDeflection):
    '''ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_174.ZerolBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_174.ZerolBevelGearSetRating':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_6335.ZerolBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsAdvancedSystemDeflection, constructor.new(_6335.ZerolBevelGearAdvancedSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_6336.ZerolBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesAdvancedSystemDeflection, constructor.new(_6336.ZerolBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2322.ZerolBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2322.ZerolBevelGearSetSystemDeflection))
        return value
