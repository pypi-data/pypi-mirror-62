...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3311
...
class ExternalCADModelAdvancedSystemDeflection(_3311.ComponentAdvancedSystemDeflection):
    '''ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2317.ExternalCADModelLoadCase':
        ...
        return constructor.new(_2317.ExternalCADModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2193.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2193.ExternalCADModelSystemDeflection))
        return value
