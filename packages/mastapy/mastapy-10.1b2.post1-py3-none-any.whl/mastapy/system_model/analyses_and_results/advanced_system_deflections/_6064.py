...
class BearingAdvancedSystemDeflection(_6092.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1523.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1523.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None
