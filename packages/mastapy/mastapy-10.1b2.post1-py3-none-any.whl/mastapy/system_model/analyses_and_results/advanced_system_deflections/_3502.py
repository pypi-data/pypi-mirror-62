...
from mastapy.gears.rating.straight_bevel_diff import _404
...
class StraightBevelDiffGearAdvancedSystemDeflection(_3482.BevelGearAdvancedSystemDeflection):
    '''StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_404.StraightBevelDiffGearRating':
        ...
        return constructor.new(_404.StraightBevelDiffGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
