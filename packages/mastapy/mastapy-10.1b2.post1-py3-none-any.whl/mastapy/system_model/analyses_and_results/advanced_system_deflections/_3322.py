...
class OilSealAdvancedSystemDeflection(_3312.ConnectorAdvancedSystemDeflection):
    '''OilSealAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2325.OilSealLoadCase':
        ...
        return constructor.new(_2325.OilSealLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2223.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2223.OilSealSystemDeflection))
        return value
