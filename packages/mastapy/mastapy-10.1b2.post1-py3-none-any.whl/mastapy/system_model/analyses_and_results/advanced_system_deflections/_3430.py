...
class ConceptGearMeshAdvancedSystemDeflection(_3445.GearMeshAdvancedSystemDeflection):
    '''ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_557.ConceptGearMeshRating':
        ...
        return constructor.new(_557.ConceptGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2173.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2173.ConceptGearMeshSystemDeflection))
        return value
