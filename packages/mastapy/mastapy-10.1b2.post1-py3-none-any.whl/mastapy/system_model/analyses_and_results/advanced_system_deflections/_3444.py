...
class ZerolBevelGearMeshAdvancedSystemDeflection(_3433.BevelGearMeshAdvancedSystemDeflection):
    '''ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2315.ZerolBevelGearMeshLoadCase':
        ...
        return constructor.new(_2315.ZerolBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_359.ZerolBevelGearMeshRating':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2314.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2314.ZerolBevelGearMeshSystemDeflection))
        return value
