...
class TorqueConverterPumpAdvancedSystemDeflection(_3260.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2267.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2267.TorqueConverterPumpSystemDeflection))
        return value
