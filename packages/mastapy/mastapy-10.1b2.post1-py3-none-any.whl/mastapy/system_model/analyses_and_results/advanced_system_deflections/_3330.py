...
class VirtualComponentAdvancedSystemDeflection(_3321.MountableComponentAdvancedSystemDeflection):
    '''VirtualComponentAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1876.VirtualComponent':
