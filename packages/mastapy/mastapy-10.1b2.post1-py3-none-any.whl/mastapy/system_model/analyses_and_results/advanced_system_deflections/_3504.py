...
class StraightBevelGearAdvancedSystemDeflection(_3482.BevelGearAdvancedSystemDeflection):
    '''StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2382.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2382.StraightBevelGearSystemDeflection))
        return value
