...
class SpringDamperConnectionAdvancedSystemDeflection(_6249.CouplingConnectionAdvancedSystemDeflection):
    '''SpringDamperConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6159.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_6159.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2292.SpringDamperConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2292.SpringDamperConnectionSystemDeflection))
        return value
