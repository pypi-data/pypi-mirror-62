...
from mastapy.gears.gear_designs.cylindrical import _571, _600
from mastapy.gears.ltca.cylindrical import _877
from mastapy.math_utility import _972
...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3346, _3305
...
class CylindricalGearMeshAdvancedSystemDeflection(_3305.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def active_flank(self) -> '_297.CylindricalFlanks':
        ...
        return constructor.new(_297.CylindricalFlanks)(value) if value else None

    @property
    def inactive_flank(self) -> '_297.CylindricalFlanks':
    ...
    @property
    def contact_chart_max_pressure_gear_a(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearA) if self.wrapped.ContactChartMaxPressureGearA else None
    ...
    @property
    def contact_chart_max_pressure_gear_b(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearB) if self.wrapped.ContactChartMaxPressureGearB else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_a(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearA) if self.wrapped.ContactChartGapToLoadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_b(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearB) if self.wrapped.ContactChartGapToLoadedFlankGearB else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_a(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearA) if self.wrapped.ContactChartGapToUnloadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_b(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearB) if self.wrapped.ContactChartGapToUnloadedFlankGearB else None
    ...
    @property
    def gear_mesh_design(self) -> '_571.CylindricalGearMeshDesign':
        ...
        return constructor.new(_571.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_877.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_877.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure else None

    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_972.FourierSeries':
        ...
        return constructor.new(_972.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod else None
    ...
    @property
    def component_detailed_analysis(self) -> '_480.CylindricalGearMeshRating':
        ...
        return constructor.new(_480.CylindricalGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2183.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2183.CylindricalGearMeshSystemDeflectionTimestep))
        return value

    @property
    def gear_designs(self) -> 'List[_600.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDesigns, constructor.new(_600.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_3346.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_3346.CylindricalGearAdvancedSystemDeflection))
        return value
