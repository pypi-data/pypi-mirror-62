...
class SpiralBevelGearAdvancedSystemDeflection(_6072.BevelGearAdvancedSystemDeflection):
    '''SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_332.SpiralBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2231.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2231.SpiralBevelGearSystemDeflection))
        return value
