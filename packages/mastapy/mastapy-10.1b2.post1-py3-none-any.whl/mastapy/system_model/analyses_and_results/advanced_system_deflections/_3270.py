...
class SynchroniserHalfAdvancedSystemDeflection(_3271.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2260.SynchroniserHalfLoadCase':
        ...
        return constructor.new(_2260.SynchroniserHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2259.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2259.SynchroniserHalfSystemDeflection))
        return value
