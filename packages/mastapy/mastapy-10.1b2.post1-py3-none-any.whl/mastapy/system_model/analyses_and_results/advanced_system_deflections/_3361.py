...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3360, _3301, _3343
...
class SpiralBevelGearSetAdvancedSystemDeflection(_3343.BevelGearSetAdvancedSystemDeflection):
    '''SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_392.SpiralBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_392.SpiralBevelGearSetRating':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_3360.SpiralBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsAdvancedSystemDeflection, constructor.new(_3360.SpiralBevelGearAdvancedSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_3301.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesAdvancedSystemDeflection, constructor.new(_3301.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2369.SpiralBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2369.SpiralBevelGearSetSystemDeflection))
        return value
