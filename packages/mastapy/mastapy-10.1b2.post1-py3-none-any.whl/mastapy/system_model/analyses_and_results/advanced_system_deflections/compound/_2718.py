...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_2710.BevelGearMeshCompoundAdvancedSystemDeflection):
    '''SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1816.SpiralBevelGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3434.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3434.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_3434.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_3434.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value
