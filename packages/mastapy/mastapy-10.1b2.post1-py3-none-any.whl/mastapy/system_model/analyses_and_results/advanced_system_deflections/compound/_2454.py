...
class WormGearCompoundAdvancedSystemDeflection(_2435.GearCompoundAdvancedSystemDeflection):
    '''WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_360.WormGearDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_360.WormGearDutyCycleRating':
        ...
        return constructor.new(_360.WormGearDutyCycleRating)(self.wrapped.WormGearDutyCycleRating) if self.wrapped.WormGearDutyCycleRating else None
