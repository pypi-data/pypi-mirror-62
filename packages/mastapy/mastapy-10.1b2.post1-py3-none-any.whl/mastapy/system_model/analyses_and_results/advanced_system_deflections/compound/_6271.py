...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6151
...
class SpringDamperCompoundAdvancedSystemDeflection(_6215.CouplingCompoundAdvancedSystemDeflection):
    '''SpringDamperCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6151.SpringDamperAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6151.SpringDamperAdvancedSystemDeflection))
        return value

    @property
    def assembly_advanced_system_deflection_load_cases(self) -> 'List[_6151.SpringDamperAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAdvancedSystemDeflectionLoadCases, constructor.new(_6151.SpringDamperAdvancedSystemDeflection))
        return value
