...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2437, _2501, _2423
...
class HypoidGearSetCompoundAdvancedSystemDeflection(_2423.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection):
    '''HypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_2437.HypoidGearCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsCompoundAdvancedSystemDeflection, constructor.new(_2437.HypoidGearCompoundAdvancedSystemDeflection))
        return value

    @property
    def hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_2501.HypoidGearMeshCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesCompoundAdvancedSystemDeflection, constructor.new(_2501.HypoidGearMeshCompoundAdvancedSystemDeflection))
        return value
