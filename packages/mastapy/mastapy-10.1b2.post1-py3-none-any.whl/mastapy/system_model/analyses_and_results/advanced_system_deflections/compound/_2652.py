...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection(_2651.KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1812.KlingelnbergCycloPalloidHypoidGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3432.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3432.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_advanced_system_deflection_load_cases(self) -> 'List[_3432.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedSystemDeflectionLoadCases, constructor.new(_3432.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection))
        return value
