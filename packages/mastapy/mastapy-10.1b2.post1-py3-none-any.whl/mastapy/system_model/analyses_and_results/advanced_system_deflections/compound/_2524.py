...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2529
...
class ConicalGearSetCompoundAdvancedSystemDeflection(_2529.GearSetCompoundAdvancedSystemDeflection):
    '''ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_417.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_417.ConicalGearSetDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating else None

    @property
    def conical_gear_duty_cycle_rating(self) -> '_417.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_417.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
