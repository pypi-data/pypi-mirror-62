...
class ConicalGearSetCompoundAdvancedSystemDeflection(_6391.GearSetCompoundAdvancedSystemDeflection):
    '''ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_325.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_325.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_325.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
