...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _6233
...
class ConicalGearSetCompoundAdvancedSystemDeflection(_6233.GearSetCompoundAdvancedSystemDeflection):
    '''ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_451.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_451.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_451.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
