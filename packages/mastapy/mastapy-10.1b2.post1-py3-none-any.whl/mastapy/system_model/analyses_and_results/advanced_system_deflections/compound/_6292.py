...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6174
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _6231
...
class WormGearCompoundAdvancedSystemDeflection(_6231.GearCompoundAdvancedSystemDeflection):
    '''WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_301.WormGearDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_301.WormGearDutyCycleRating':
        ...
        return constructor.new(_301.WormGearDutyCycleRating)(self.wrapped.WormGearDutyCycleRating) if self.wrapped.WormGearDutyCycleRating else None

    @property
    def component_design(self) -> '_2013.WormGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6174.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6174.WormGearAdvancedSystemDeflection))
        return value

    @property
    def component_advanced_system_deflection_load_cases(self) -> 'List[_6174.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAdvancedSystemDeflectionLoadCases, constructor.new(_6174.WormGearAdvancedSystemDeflection))
        return value
