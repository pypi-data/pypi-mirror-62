...
class SpringDamperHalfCompoundAdvancedSystemDeflection(_2677.CouplingHalfCompoundAdvancedSystemDeflection):
    '''SpringDamperHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2030.SpringDamperHalf':
