...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2418, _2494, _2436
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_2436.GearSetCompoundAdvancedSystemDeflection):
    '''ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_2418.ConceptGearCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundAdvancedSystemDeflection, constructor.new(_2418.ConceptGearCompoundAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_2494.ConceptGearMeshCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundAdvancedSystemDeflection, constructor.new(_2494.ConceptGearMeshCompoundAdvancedSystemDeflection))
        return value
