...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2551
...
class CVTCompoundAdvancedSystemDeflection(_2551.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
