...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2607
...
class CVTCompoundAdvancedSystemDeflection(_2607.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
