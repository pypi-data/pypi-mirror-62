...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3458
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2393
...
class ImportedFEComponentCompoundAdvancedSystemDeflection(_2393.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    '''ImportedFEComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3458.ImportedFEComponentAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3458.ImportedFEComponentAdvancedSystemDeflection))
        return value

    @property
    def component_advanced_system_deflection_load_cases(self) -> 'List[_3458.ImportedFEComponentAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAdvancedSystemDeflectionLoadCases, constructor.new(_3458.ImportedFEComponentAdvancedSystemDeflection))
        return value
