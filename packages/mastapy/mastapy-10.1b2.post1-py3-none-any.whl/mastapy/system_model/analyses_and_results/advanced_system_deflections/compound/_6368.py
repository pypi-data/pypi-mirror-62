...
class ConicalGearCompoundAdvancedSystemDeflection(_6389.GearCompoundAdvancedSystemDeflection):
    '''ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_322.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_322.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_322.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
