...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2671
...
class CVTCompoundAdvancedSystemDeflection(_2671.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
