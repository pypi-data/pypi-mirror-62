...
from mastapy.system_model.analyses_and_results.analysis_cases import _3142
...
class ConnectionCompoundAdvancedSystemDeflection(_3142.ConnectionCompoundAnalysis):
    '''ConnectionCompoundAdvancedSystemDeflection
