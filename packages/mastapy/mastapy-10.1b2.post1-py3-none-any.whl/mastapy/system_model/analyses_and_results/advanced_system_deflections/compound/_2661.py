...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_2641.BevelGearCompoundAdvancedSystemDeflection):
    '''StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2006.StraightBevelDiffGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3495.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3495.StraightBevelDiffGearAdvancedSystemDeflection))
        return value

    @property
    def component_advanced_system_deflection_load_cases(self) -> 'List[_3495.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAdvancedSystemDeflectionLoadCases, constructor.new(_3495.StraightBevelDiffGearAdvancedSystemDeflection))
        return value
