...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6093
...
class TorqueConverterAdvancedSystemDeflection(_6093.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2252.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2252.TorqueConverterSystemDeflection))
        return value
