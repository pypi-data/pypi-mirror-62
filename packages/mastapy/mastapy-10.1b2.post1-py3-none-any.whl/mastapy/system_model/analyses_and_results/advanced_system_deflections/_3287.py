...
class SpringDamperConnectionAdvancedSystemDeflection(_3286.CouplingConnectionAdvancedSystemDeflection):
    '''SpringDamperConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2284.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_2284.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2283.SpringDamperConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2283.SpringDamperConnectionSystemDeflection))
        return value
