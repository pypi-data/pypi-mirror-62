...
class ZerolBevelGearAdvancedSystemDeflection(_3482.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_360.ZerolBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2224.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2224.ZerolBevelGearSystemDeflection))
        return value
