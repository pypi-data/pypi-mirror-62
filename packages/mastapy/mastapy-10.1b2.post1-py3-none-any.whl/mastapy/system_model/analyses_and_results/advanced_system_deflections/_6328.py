...
class TransmissionErrorToOtherPowerLoad(_1.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1063.FourierSeries':
        ...
        return constructor.new(_1063.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE else None
