...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6062
...
class BevelGearSetAdvancedSystemDeflection(_6062.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''BevelGearSetAdvancedSystemDeflection
