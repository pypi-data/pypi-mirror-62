...
class OilSealAdvancedSystemDeflection(_3452.ConnectorAdvancedSystemDeflection):
    '''OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2236.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2236.OilSealSystemDeflection))
        return value
