...
from mastapy.gears.rating.face import _478
...
class FaceGearMeshAdvancedSystemDeflection(_3445.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2297.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2297.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_478.FaceGearMeshRating':
        ...
        return constructor.new(_478.FaceGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2202.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2202.FaceGearMeshSystemDeflection))
        return value
