...
class ShaftHubConnectionAdvancedSystemDeflection(_6092.ConnectorAdvancedSystemDeflection):
    '''ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2223.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2223.ShaftHubConnectionSystemDeflection))
        return value
