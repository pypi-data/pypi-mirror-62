...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3504, _3442, _3483
...
class StraightBevelGearSetAdvancedSystemDeflection(_3483.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_3504.StraightBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsAdvancedSystemDeflection, constructor.new(_3504.StraightBevelGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_3442.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesAdvancedSystemDeflection, constructor.new(_3442.StraightBevelGearMeshAdvancedSystemDeflection))
        return value
