...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _428
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection(_3438.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2307.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_2307.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_428.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_428.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2223.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2223.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
