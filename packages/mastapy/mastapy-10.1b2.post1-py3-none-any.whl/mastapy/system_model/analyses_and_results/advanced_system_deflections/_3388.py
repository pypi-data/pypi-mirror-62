...
from mastapy.system_model.analyses_and_results.static_loads import _2201
...
class ClutchAdvancedSystemDeflection(_3392.CouplingAdvancedSystemDeflection):
    '''ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_2201.ClutchLoadCase':
        ...
        return constructor.new(_2201.ClutchLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2160.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2160.ClutchSystemDeflection))
        return value
