...
class UnbalancedMassAdvancedSystemDeflection(_6173.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6030.UnbalancedMassLoadCase':
        ...
        return constructor.new(_6030.UnbalancedMassLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2256.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2256.UnbalancedMassSystemDeflection))
        return value
