...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5683, _5682, _5708
...
class ConceptGearSetModalAnalysisAtASpeed(_5708.GearSetModalAnalysisAtASpeed):
    '''ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5683.ConceptGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtASpeed, constructor.new(_5683.ConceptGearModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5682.ConceptGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtASpeed, constructor.new(_5682.ConceptGearMeshModalAnalysisAtASpeed))
        return value
