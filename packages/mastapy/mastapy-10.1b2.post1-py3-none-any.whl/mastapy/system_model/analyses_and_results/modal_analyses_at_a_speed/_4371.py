...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4370, _4369, _4375
...
class FaceGearSetModalAnalysisAtASpeed(_4375.GearSetModalAnalysisAtASpeed):
    '''FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_4370.FaceGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtASpeed, constructor.new(_4370.FaceGearModalAnalysisAtASpeed))
        return value

    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_4369.FaceGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtASpeed, constructor.new(_4369.FaceGearMeshModalAnalysisAtASpeed))
        return value
