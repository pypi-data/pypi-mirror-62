...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5754, _5753, _5671
...
class StraightBevelGearSetModalAnalysisAtASpeed(_5671.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5754.StraightBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtASpeed, constructor.new(_5754.StraightBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5753.StraightBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtASpeed, constructor.new(_5753.StraightBevelGearMeshModalAnalysisAtASpeed))
        return value
