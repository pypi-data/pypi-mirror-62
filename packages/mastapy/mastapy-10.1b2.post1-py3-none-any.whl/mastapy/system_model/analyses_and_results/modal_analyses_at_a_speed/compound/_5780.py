...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5661
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5808
...
class BearingCompoundModalAnalysisAtASpeed(_5808.ConnectorCompoundModalAnalysisAtASpeed):
    '''BearingCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5661.BearingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5661.BearingModalAnalysisAtASpeed))
        return value

    @property
    def component_modal_analysis_at_a_speed_load_cases(self) -> 'List[_5661.BearingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtASpeedLoadCases, constructor.new(_5661.BearingModalAnalysisAtASpeed))
        return value
