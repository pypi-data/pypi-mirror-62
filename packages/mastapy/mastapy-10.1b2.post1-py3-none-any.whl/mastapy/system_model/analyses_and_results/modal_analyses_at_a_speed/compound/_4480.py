...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4449
...
class CVTCompoundModalAnalysisAtASpeed(_4449.BeltDriveCompoundModalAnalysisAtASpeed):
    '''CVTCompoundModalAnalysisAtASpeed
