...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4446
...
class RootAssemblyCompoundModalAnalysisAtASpeed(_4446.AssemblyCompoundModalAnalysisAtASpeed):
    '''RootAssemblyCompoundModalAnalysisAtASpeed
