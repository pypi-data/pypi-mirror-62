...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5827
...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5827.GearSetCompoundModalAnalysisAtASpeed):
    '''ConicalGearSetCompoundModalAnalysisAtASpeed
