...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4494
...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_4494.GearSetCompoundModalAnalysisAtASpeed):
    '''ConicalGearSetCompoundModalAnalysisAtASpeed
