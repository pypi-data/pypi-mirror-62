...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_4591.CouplingCompoundModalAnalysisAtASpeed):
    '''ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4460.ConceptCouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4460.ConceptCouplingModalAnalysisAtASpeed))
        return value

    @property
    def assembly_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4460.ConceptCouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisAtASpeedLoadCases, constructor.new(_4460.ConceptCouplingModalAnalysisAtASpeed))
        return value
