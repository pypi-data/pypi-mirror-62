...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4385
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed(_4502.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4385.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4385.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_modal_analysis_at_a_speed_load_cases(self) -> 'List[_4385.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtASpeedLoadCases, constructor.new(_4385.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value
