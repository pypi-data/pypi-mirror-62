...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5782
...
class CVTCompoundModalAnalysisAtASpeed(_5782.BeltDriveCompoundModalAnalysisAtASpeed):
    '''CVTCompoundModalAnalysisAtASpeed
