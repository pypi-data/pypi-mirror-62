...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5766
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5885
...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5885.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5766.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5766.UnbalancedMassModalAnalysisAtASpeed))
        return value

    @property
    def component_modal_analysis_at_a_speed_load_cases(self) -> 'List[_5766.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisAtASpeedLoadCases, constructor.new(_5766.UnbalancedMassModalAnalysisAtASpeed))
        return value
