...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4364, _4363, _4375
...
class CylindricalGearSetModalAnalysisAtASpeed(_4375.GearSetModalAnalysisAtASpeed):
    '''CylindricalGearSetModalAnalysisAtASpeed
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_4364.CylindricalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtASpeed, constructor.new(_4364.CylindricalGearModalAnalysisAtASpeed))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_4363.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtASpeed, constructor.new(_4363.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
