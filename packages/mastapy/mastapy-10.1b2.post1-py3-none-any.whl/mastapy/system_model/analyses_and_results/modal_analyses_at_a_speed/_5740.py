...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5726, _5660
...
class RootAssemblyModalAnalysisAtASpeed(_5660.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_5726.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_5726.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
