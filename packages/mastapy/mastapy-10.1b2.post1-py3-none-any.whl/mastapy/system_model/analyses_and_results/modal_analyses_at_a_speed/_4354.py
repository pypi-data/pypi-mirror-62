...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4375
...
class ConicalGearSetModalAnalysisAtASpeed(_4375.GearSetModalAnalysisAtASpeed):
    '''ConicalGearSetModalAnalysisAtASpeed
