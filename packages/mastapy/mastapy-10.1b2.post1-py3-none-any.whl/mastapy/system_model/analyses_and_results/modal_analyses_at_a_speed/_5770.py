...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5769, _5768, _5708
...
class WormGearSetModalAnalysisAtASpeed(_5708.GearSetModalAnalysisAtASpeed):
    '''WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_5769.WormGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtASpeed, constructor.new(_5769.WormGearModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_5768.WormGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtASpeed, constructor.new(_5768.WormGearMeshModalAnalysisAtASpeed))
        return value
