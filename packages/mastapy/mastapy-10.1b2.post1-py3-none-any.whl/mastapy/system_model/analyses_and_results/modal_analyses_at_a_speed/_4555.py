...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4554, _4553, _4450
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_4450.BevelGearSetModalAnalysisAtASpeed):
    '''ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4554.ZerolBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysisAtASpeed, constructor.new(_4554.ZerolBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4553.ZerolBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysisAtASpeed, constructor.new(_4553.ZerolBevelGearMeshModalAnalysisAtASpeed))
        return value
