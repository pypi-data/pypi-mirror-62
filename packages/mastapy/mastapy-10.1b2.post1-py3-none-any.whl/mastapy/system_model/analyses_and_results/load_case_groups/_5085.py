...
from mastapy.system_model.analyses_and_results.load_case_groups import _5083, _5084, _5080
...
class DesignState(_5080.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5083.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5083.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5084.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5084.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1823.ClutchConnection') -> '_5083.ClutchEngagementStatus':
        ...
        return constructor.new(_5083.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_1987.CylindricalGear') -> '_5084.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5084.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6008.StaticLoadCase':
        ...
        return constructor.new(_6008.StaticLoadCase)(method_result) if method_result else None
