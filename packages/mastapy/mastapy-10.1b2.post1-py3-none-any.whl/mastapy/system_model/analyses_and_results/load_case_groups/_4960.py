...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4925
from mastapy.system_model.analyses_and_results.static_loads import _2338, _6069, _4928
...
class AbstractLoadCaseGroup(_1.APIBase):
    ...
    @property
    def parametric_analysis_options(self) -> '_4925.ParametricStudyToolOptions':
        ...
        return constructor.new(_4925.ParametricStudyToolOptions)(self.wrapped.ParametricAnalysisOptions) if self.wrapped.ParametricAnalysisOptions else None

    @property
    def load_case_root_assemblies(self) -> 'List[_2338.RootAssemblyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseRootAssemblies, constructor.new(_2338.RootAssemblyLoadCase))
        return value
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_320.TaskProgress') -> 'List[_6069.LoadCase]':
    ...
    def analysis_of(self, analysis_type: '_4928.AnalysisType') -> '_2089.CompoundAnalysis':
        ...
        return constructor.new(_2089.CompoundAnalysis)(method_result) if method_result else None
