...
from mastapy.system_model.analyses_and_results.load_case_groups import _4926, _2075
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6243
...
class DutyCycle(_2075.AbstractStaticLoadCaseGroup):
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4926.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4926.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6243.TimeSeriesImporter':
        ...
        return constructor.new(_6243.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_2042.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_2042.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_4926.SubGroupInSingleDesignState'):
