...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6230
...
class DutyCycle(_2075.AbstractStaticLoadCaseGroup):
    ...
    @property
    def time_series_importer(self) -> '_6230.TimeSeriesImporter':
        ...
        return constructor.new(_6230.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_2067.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_2067.StaticLoadCase'):
