...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _6181, _6180, _6174, _6179,
    _5018
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _1972, _2267, _2299, _2297,
    _2330, _2246, _2332, _2283
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _6183, _6186, _6187
from mastapy.system_model.part_model import (
    _1912, _1938, _1937, _1928
)
from mastapy.system_model.part_model.gears import _1989, _1988
...
class AbstractStaticLoadCaseGroup(_5018.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_6181.SystemOptimiserTargets':
        ...
        return constructor.new(_6181.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_6181.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_6180.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_6180.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_6180.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_1972.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoadsLimitedByMaxNumberOfLoadCasesToDisplay, constructor.new(_1972.StaticLoadCase))
        return value

    @property
    def bearings(self) -> 'List[_6183.ComponentStaticLoadCaseGroup[_1912.Bearing, _2267.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_6183.ComponentStaticLoadCaseGroup)[_1912.Bearing, _2267.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_6183.ComponentStaticLoadCaseGroup[_1938.PowerLoad, _2299.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_6183.ComponentStaticLoadCaseGroup)[_1938.PowerLoad, _2299.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_6183.ComponentStaticLoadCaseGroup[_1937.PointLoad, _2297.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_6183.ComponentStaticLoadCaseGroup)[_1937.PointLoad, _2297.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_6186.GearSetStaticLoadCaseGroup[_1989.CylindricalGearSet, _1988.CylindricalGear, _2330.CylindricalGearLoadCase, _1802.CylindricalGearMesh, _2246.CylindricalGearMeshLoadCase, _2332.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_6186.GearSetStaticLoadCaseGroup)[_1989.CylindricalGearSet, _1988.CylindricalGear, _2330.CylindricalGearLoadCase, _1802.CylindricalGearMesh, _2246.CylindricalGearMeshLoadCase, _2332.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_6187.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_6187.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_6183.ComponentStaticLoadCaseGroup[_1928.ImportedFEComponent, _2283.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_6183.ComponentStaticLoadCaseGroup)[_1928.ImportedFEComponent, _2283.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_6174.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_6174.AbstractDesignStateLoadCaseGroup))
        return value

    @property
    def loaded_gear_sets(self) -> 'List[_3182.CylindricalGearSetCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedGearSets, constructor.new(_3182.CylindricalGearSetCompoundPowerFlow))
        return value

    @property
    def system_optimisation_gear_sets(self) -> 'List[_6179.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_6179.SystemOptimisationGearSet))
        return value
