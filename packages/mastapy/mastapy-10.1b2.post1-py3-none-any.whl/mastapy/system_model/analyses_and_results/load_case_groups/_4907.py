...
class AbstractDesignStateLoadCaseGroup(_2477.AbstractStaticLoadCaseGroup):
    '''AbstractDesignStateLoadCaseGroup
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
