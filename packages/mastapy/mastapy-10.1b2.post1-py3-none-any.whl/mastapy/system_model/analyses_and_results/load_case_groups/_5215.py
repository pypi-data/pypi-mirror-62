...
from mastapy.system_model.analyses_and_results.load_case_groups import _5213, _5214, _5210
...
class DesignState(_5210.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5213.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5213.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5214.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5214.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1873.ClutchConnection') -> '_5213.ClutchEngagementStatus':
        ...
        return constructor.new(_5213.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2042.CylindricalGear') -> '_5214.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5214.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6162.StaticLoadCase':
        ...
        return constructor.new(_6162.StaticLoadCase)(method_result) if method_result else None
