...
from mastapy.system_model.analyses_and_results.load_case_groups import _6175, _6176, _4930
...
from mastapy.system_model.analyses_and_results.static_loads import _2045
...
class DesignState(_4930.AbstractDesignStateLoadCaseGroup):
    ...
    def clutch_engagement_status_for(self, clutch_connection: '_1832.ClutchConnection') -> '_6175.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_1993.CylindricalGear') -> '_6176.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_2045.StaticLoadCase':
        ...
        return constructor.new(_2045.StaticLoadCase)(method_result) if method_result else None
