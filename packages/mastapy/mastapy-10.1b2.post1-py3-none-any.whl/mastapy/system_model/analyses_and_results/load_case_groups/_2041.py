...
from mastapy.system_model.analyses_and_results.load_case_groups import _6181, _6182, _4925
...
from mastapy.system_model.analyses_and_results.static_loads import _2042
...
class DesignState(_4925.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_6181.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_6181.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_6182.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_6182.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1832.ClutchConnection') -> '_6181.ClutchEngagementStatus':
        ...
        return constructor.new(_6181.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_1994.CylindricalGear') -> '_6182.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_6182.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_2042.StaticLoadCase':
        ...
        return constructor.new(_2042.StaticLoadCase)(method_result) if method_result else None
