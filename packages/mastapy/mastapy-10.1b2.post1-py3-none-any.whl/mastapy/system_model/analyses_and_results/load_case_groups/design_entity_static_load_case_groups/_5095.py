...
TReal = TypeVar('TReal', bound='_1914.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_5901.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5097.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
