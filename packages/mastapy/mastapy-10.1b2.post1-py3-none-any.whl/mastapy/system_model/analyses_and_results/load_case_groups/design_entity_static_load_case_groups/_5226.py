...
TConnection = TypeVar('TConnection', bound='_1815.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6061.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5227.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
