...
from mastapy.system_model.connections_and_sockets import _1774
...
TConnection = TypeVar('TConnection', bound='_1774.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_2282.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_6186.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
