...
TAssembly = TypeVar('TAssembly', bound='_1909.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_2310.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_6178.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
