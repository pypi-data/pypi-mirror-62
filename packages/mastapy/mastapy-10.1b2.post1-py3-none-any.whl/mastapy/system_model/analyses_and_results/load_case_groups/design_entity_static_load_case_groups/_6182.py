...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _6185
...
TAssembly = TypeVar('TAssembly', bound='_1915.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_2274.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_6185.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
