...
TConnection = TypeVar('TConnection', bound='_1768.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_2275.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_6179.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
