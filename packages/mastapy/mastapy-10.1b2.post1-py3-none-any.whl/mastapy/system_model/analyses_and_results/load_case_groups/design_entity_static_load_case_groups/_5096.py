...
from mastapy.system_model.analyses_and_results.static_loads import _5913
...
TConnection = TypeVar('TConnection', bound='_1765.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_5913.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5097.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
