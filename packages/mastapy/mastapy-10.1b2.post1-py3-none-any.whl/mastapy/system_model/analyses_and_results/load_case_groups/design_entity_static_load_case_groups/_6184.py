...
TReal = TypeVar('TReal', bound='_1922.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_2322.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_6186.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
