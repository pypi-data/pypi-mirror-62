...
from mastapy.system_model.part_model import _1907
from mastapy.system_model.analyses_and_results.static_loads import _5876
...
TAssembly = TypeVar('TAssembly', bound='_1907.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_5876.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5097.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
