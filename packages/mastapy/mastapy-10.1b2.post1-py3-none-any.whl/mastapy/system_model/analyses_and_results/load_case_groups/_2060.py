...
from mastapy.system_model.analyses_and_results.load_case_groups import _6169, _6170, _6168
...
class DesignState(_6168.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_2061.StaticLoadCase':
        ...
        return constructor.new(_2061.StaticLoadCase)(method_result) if method_result else None
