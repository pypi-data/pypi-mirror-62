...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _6175, _6174, _6168, _6173,
    _4954
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _2061, _2313, _2331, _2330,
    _2354, _2297, _2355, _2323
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _6177, _6180, _6181
...
class AbstractStaticLoadCaseGroup(_4954.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_6175.SystemOptimiserTargets':
        ...
        return constructor.new(_6175.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_6175.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_6174.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_6174.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_6174.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_loads(self) -> 'List[_2061.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_2061.StaticLoadCase))
        return value

    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_2061.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoadsLimitedByMaxNumberOfLoadCasesToDisplay, constructor.new(_2061.StaticLoadCase))
        return value

    @property
    def bearings(self) -> 'List[_6177.ComponentStaticLoadCaseGroup[_1912.Bearing, _2313.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_6177.ComponentStaticLoadCaseGroup)[_1912.Bearing, _2313.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_6177.ComponentStaticLoadCaseGroup[_1938.PowerLoad, _2331.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_6177.ComponentStaticLoadCaseGroup)[_1938.PowerLoad, _2331.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_6177.ComponentStaticLoadCaseGroup[_1937.PointLoad, _2330.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_6177.ComponentStaticLoadCaseGroup)[_1937.PointLoad, _2330.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_6180.GearSetStaticLoadCaseGroup[_1989.CylindricalGearSet, _1988.CylindricalGear, _2354.CylindricalGearLoadCase, _1802.CylindricalGearMesh, _2297.CylindricalGearMeshLoadCase, _2355.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_6180.GearSetStaticLoadCaseGroup)[_1989.CylindricalGearSet, _1988.CylindricalGear, _2354.CylindricalGearLoadCase, _1802.CylindricalGearMesh, _2297.CylindricalGearMeshLoadCase, _2355.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_6181.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_6181.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_6177.ComponentStaticLoadCaseGroup[_1928.ImportedFEComponent, _2323.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_6177.ComponentStaticLoadCaseGroup)[_1928.ImportedFEComponent, _2323.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_6168.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_6168.AbstractDesignStateLoadCaseGroup))
        return value

    @property
    def loaded_gear_sets(self) -> 'List[_3183.CylindricalGearSetCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedGearSets, constructor.new(_3183.CylindricalGearSetCompoundPowerFlow))
        return value

    @property
    def system_optimisation_gear_sets(self) -> 'List[_6173.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_6173.SystemOptimisationGearSet))
        return value
