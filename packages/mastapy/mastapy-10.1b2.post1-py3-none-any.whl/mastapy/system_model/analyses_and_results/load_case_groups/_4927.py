...
class AbstractDesignStateLoadCaseGroup(_2070.AbstractStaticLoadCaseGroup):
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_744.SMTBitmap':
        ...
        return constructor.new(_744.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
