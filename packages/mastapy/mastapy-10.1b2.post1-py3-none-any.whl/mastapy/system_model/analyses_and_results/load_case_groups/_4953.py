...
from mastapy.system_model.analyses_and_results.static_loads import _4921
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import _4952
...
class GroupOfTimeSeriesLoadCases(_4952.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_4921.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_4921.TimeSeriesLoadCase))
        return value
