...
from mastapy.system_model.analyses_and_results.load_case_groups import _6170, _6171, _6169
...
class DesignState(_6169.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_6170.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_6170.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_6171.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_6171.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1823.ClutchConnection') -> '_6170.ClutchEngagementStatus':
        ...
        return constructor.new(_6170.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2005.CylindricalGear') -> '_6171.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_6171.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
