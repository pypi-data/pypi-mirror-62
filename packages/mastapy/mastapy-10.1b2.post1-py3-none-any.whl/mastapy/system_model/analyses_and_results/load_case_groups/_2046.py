...
from mastapy.system_model.analyses_and_results.load_case_groups import _4931, _2075
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6212
...
class DutyCycle(_2075.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4931.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4931.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6212.TimeSeriesImporter':
        ...
        return constructor.new(_6212.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_2045.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_2045.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_4931.SubGroupInSingleDesignState'):
