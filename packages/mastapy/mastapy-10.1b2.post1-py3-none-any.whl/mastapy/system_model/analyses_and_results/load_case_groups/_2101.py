...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _6176, _6175, _6169, _6174,
    _4952
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _1969, _2351, _2369, _2368,
    _2388, _2339, _2389, _2361
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _6178, _6181, _6182
from mastapy.system_model.part_model import (
    _1909, _1935, _1934, _1925
)
...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3120
...
class AbstractStaticLoadCaseGroup(_4952.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_6176.SystemOptimiserTargets':
        ...
        return constructor.new(_6176.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_6176.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_6175.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_6175.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_6175.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearings(self) -> 'List[_6178.ComponentStaticLoadCaseGroup[_1909.Bearing, _2351.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_6178.ComponentStaticLoadCaseGroup)[_1909.Bearing, _2351.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_6178.ComponentStaticLoadCaseGroup[_1935.PowerLoad, _2369.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_6178.ComponentStaticLoadCaseGroup)[_1935.PowerLoad, _2369.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_6178.ComponentStaticLoadCaseGroup[_1934.PointLoad, _2368.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_6178.ComponentStaticLoadCaseGroup)[_1934.PointLoad, _2368.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_6181.GearSetStaticLoadCaseGroup[_1980.CylindricalGearSet, _2005.CylindricalGear, _2388.CylindricalGearLoadCase, _1799.CylindricalGearMesh, _2339.CylindricalGearMeshLoadCase, _2389.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_6181.GearSetStaticLoadCaseGroup)[_1980.CylindricalGearSet, _2005.CylindricalGear, _2388.CylindricalGearLoadCase, _1799.CylindricalGearMesh, _2339.CylindricalGearMeshLoadCase, _2389.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_6182.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_6182.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_6178.ComponentStaticLoadCaseGroup[_1925.ImportedFEComponent, _2361.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_6178.ComponentStaticLoadCaseGroup)[_1925.ImportedFEComponent, _2361.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_6169.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_6169.AbstractDesignStateLoadCaseGroup))
        return value

    @property
    def loaded_gear_sets(self) -> 'List[_3120.CylindricalGearSetCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedGearSets, constructor.new(_3120.CylindricalGearSetCompoundPowerFlow))
        return value

    @property
    def system_optimisation_gear_sets(self) -> 'List[_6174.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_6174.SystemOptimisationGearSet))
        return value
