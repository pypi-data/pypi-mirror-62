...
from mastapy.system_model.analyses_and_results.load_case_groups import _4960
...
class GroupOfTimeSeriesLoadCases(_4960.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_5218.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_5218.TimeSeriesLoadCase))
        return value
