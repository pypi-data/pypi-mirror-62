...
from mastapy.system_model.analyses_and_results.static_loads import _4924
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import _5019
...
class GroupOfTimeSeriesLoadCases(_5019.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_4924.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_4924.TimeSeriesLoadCase))
        return value
