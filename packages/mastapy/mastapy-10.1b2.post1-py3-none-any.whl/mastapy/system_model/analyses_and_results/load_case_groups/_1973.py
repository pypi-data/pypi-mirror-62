...
from mastapy.system_model.analyses_and_results.load_case_groups import _4927, _2102
...
class DutyCycle(_2102.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def time_series_importer(self) -> '_6223.TimeSeriesImporter':
        ...
        return constructor.new(_6223.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_1972.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_1972.StaticLoadCase'):
