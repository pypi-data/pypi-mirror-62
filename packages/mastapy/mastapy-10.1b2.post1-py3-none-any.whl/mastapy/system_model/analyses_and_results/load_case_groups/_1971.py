...
from mastapy.system_model.analyses_and_results.load_case_groups import _6175, _6176, _6174
...
class DesignState(_6174.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_6175.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_6175.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_6176.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_6176.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1826.ClutchConnection') -> '_6175.ClutchEngagementStatus':
        ...
        return constructor.new(_6175.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_1988.CylindricalGear') -> '_6176.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_6176.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None

    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_1972.StaticLoadCase':
        ...
        return constructor.new(_1972.StaticLoadCase)(method_result) if method_result else None
