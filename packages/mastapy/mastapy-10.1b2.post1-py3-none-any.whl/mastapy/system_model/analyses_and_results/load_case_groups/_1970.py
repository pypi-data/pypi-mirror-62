...
from mastapy.system_model.analyses_and_results.load_case_groups import _4916, _2101
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6237
...
class DutyCycle(_2101.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4916.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4916.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6237.TimeSeriesImporter':
        ...
        return constructor.new(_6237.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None
    ...
    def remove_design_state_sub_group(self, sub_group: '_4916.SubGroupInSingleDesignState'):
