...
from mastapy.system_model.analyses_and_results.load_case_groups import _5081
...
class GroupOfTimeSeriesLoadCases(_5081.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6022.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6022.TimeSeriesLoadCase))
        return value
