...
from mastapy.system_model.analyses_and_results.load_case_groups import _4908, _2477
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6225
...
class DutyCycle(_2477.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4908.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4908.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6225.TimeSeriesImporter':
        ...
        return constructor.new(_6225.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_1849.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_4908.SubGroupInSingleDesignState'):
