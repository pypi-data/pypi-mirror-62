...
from mastapy.system_model.analyses_and_results.load_case_groups import _2070
...
class AbstractDesignStateLoadCaseGroup(_2070.AbstractStaticLoadCaseGroup):
    '''AbstractDesignStateLoadCaseGroup
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_711.SMTBitmap':
        ...
        return constructor.new(_711.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
