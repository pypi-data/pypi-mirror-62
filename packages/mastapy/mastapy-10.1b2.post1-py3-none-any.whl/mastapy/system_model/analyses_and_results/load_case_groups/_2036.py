...
from mastapy.system_model.analyses_and_results.load_case_groups import _4928, _2070
...
class DutyCycle(_2070.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4928.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4928.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6224.TimeSeriesImporter':
        ...
        return constructor.new(_6224.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_2035.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_2035.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_4928.SubGroupInSingleDesignState'):
