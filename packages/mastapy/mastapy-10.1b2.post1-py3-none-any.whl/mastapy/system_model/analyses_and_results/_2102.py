...
class DesignEntityAnalysis(_1.APIBase):
    ...
    @property
    def safety_factors(self) -> '_226.SafetyFactorGroup':
        ...
        return constructor.new(_226.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def component_design(self) -> '_1724.DesignEntity':
        ...
        return constructor.new(_1724.DesignEntity)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def component_design_of_type_connection(self) -> '_1765.Connection':
        ...
        if _1765.Connection.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_part(self) -> '_1933.Part':
        ...
        if _1933.Part.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
