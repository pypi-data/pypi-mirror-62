...
class PointLoadSteadyStateSynchronousResponseOnAShaft(_2868.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_load_case(self) -> '_2299.PointLoadLoadCase':
        ...
        return constructor.new(_2299.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
