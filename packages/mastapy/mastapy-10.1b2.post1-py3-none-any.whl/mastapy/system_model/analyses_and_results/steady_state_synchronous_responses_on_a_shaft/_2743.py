...
from mastapy.system_model.analyses_and_results.static_loads import _2253
...
class RollingRingAssemblySteadyStateSynchronousResponseOnAShaft(_2844.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''RollingRingAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2253.RollingRingAssemblyLoadCase':
        ...
        return constructor.new(_2253.RollingRingAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
