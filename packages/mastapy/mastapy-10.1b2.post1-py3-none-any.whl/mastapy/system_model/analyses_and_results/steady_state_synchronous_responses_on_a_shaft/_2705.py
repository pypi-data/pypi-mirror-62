...
class GuideDxfModelSteadyStateSynchronousResponseOnAShaft(_2662.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''GuideDxfModelSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2321.GuideDxfModelLoadCase':
        ...
        return constructor.new(_2321.GuideDxfModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
