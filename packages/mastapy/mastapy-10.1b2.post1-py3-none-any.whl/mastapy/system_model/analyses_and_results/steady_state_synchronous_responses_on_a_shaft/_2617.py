...
from mastapy.system_model.analyses_and_results.static_loads import _2427
...
class MassDiscSteadyStateSynchronousResponseOnAShaft(_2868.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MassDiscSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2427.MassDiscLoadCase':
        ...
        return constructor.new(_2427.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
