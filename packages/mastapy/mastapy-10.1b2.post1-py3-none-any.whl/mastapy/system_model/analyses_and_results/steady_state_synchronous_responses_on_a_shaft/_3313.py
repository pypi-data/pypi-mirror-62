...
class PulleySteadyStateSynchronousResponseOnAShaft(_3270.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''PulleySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2196.PulleyLoadCase':
        ...
        return constructor.new(_2196.PulleyLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
