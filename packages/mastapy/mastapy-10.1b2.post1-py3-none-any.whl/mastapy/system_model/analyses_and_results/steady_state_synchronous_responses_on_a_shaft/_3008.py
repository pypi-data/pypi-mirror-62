...
class BevelGearSteadyStateSynchronousResponseOnAShaft(_2996.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft):
    '''BevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1982.BevelGear':
        ...
        return constructor.new(_1982.BevelGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
