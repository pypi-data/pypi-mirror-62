...
class DatumSteadyStateSynchronousResponseOnAShaft(_3015.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''DatumSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2274.DatumLoadCase':
        ...
        return constructor.new(_2274.DatumLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
