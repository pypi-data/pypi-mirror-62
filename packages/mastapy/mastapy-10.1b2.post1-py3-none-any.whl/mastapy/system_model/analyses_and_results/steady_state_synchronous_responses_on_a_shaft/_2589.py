...
from mastapy.system_model.analyses_and_results.static_loads import _2442
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2590, _2587, _2594
...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_2594.GearSetSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def assembly_load_case(self) -> '_2442.FaceGearSetLoadCase':
        ...
        return constructor.new(_2442.FaceGearSetLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2590.FaceGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSteadyStateSynchronousResponseOnAShaft, constructor.new(_2590.FaceGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2587.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSteadyStateSynchronousResponseOnAShaft, constructor.new(_2587.FaceGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
