...
class RollingRingConnectionSteadyStateSynchronousResponseOnAShaft(_3293.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2232.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_2232.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
