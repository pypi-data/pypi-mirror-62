...
class SpringDamperHalfSteadyStateSynchronousResponseOnAShaft(_3028.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperHalfSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2198.SpringDamperHalfLoadCase':
        ...
        return constructor.new(_2198.SpringDamperHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
