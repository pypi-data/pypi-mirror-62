...
class ClutchHalfSteadyStateSynchronousResponseOnAShaft(_3028.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''ClutchHalfSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2176.ClutchHalfLoadCase':
        ...
        return constructor.new(_2176.ClutchHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
