...
class StraightBevelGearSteadyStateSynchronousResponseOnAShaft(_3008.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2365.StraightBevelGearLoadCase':
        ...
        return constructor.new(_2365.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
