...
class PowerLoadSteadyStateSynchronousResponseOnAShaft(_3104.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PowerLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2299.PowerLoadLoadCase':
        ...
        return constructor.new(_2299.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
