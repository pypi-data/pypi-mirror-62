...
from mastapy.system_model.analyses_and_results.static_loads import _2302
...
class SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(_2533.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2302.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_2302.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
