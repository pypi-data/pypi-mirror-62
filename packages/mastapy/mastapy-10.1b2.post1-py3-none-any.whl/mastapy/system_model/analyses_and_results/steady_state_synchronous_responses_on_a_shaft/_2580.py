...
from mastapy.system_model.analyses_and_results.static_loads import _2404
...
class CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft(_2593.GearMeshSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def connection_load_case(self) -> '_2404.CylindricalGearMeshLoadCase':
        ...
        return constructor.new(_2404.CylindricalGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
