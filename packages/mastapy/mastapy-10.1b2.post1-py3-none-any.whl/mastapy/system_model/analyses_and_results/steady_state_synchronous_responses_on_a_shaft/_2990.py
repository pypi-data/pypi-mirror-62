...
class WormGearSteadyStateSynchronousResponseOnAShaft(_2810.GearSteadyStateSynchronousResponseOnAShaft):
    '''WormGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2385.WormGearLoadCase':
        ...
        return constructor.new(_2385.WormGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
