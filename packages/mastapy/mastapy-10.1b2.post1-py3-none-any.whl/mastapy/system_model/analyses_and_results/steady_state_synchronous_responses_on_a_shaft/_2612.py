...
from mastapy.system_model.analyses_and_results.static_loads import _2462
...
class KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft(_2608.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    '''KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2462.KlingelnbergCycloPalloidHypoidGearLoadCase':
        ...
        return constructor.new(_2462.KlingelnbergCycloPalloidHypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
