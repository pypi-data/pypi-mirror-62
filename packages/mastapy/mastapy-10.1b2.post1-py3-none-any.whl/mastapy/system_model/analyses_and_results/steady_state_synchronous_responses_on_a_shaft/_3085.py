...
class SpringDamperSteadyStateSynchronousResponseOnAShaft(_3029.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2196.SpringDamperLoadCase':
        ...
        return constructor.new(_2196.SpringDamperLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
