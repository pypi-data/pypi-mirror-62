...
class SynchroniserHalfSteadyStateSynchronousResponseOnAShaft(_3338.SynchroniserPartSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserHalfSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2210.SynchroniserHalfLoadCase':
        ...
        return constructor.new(_2210.SynchroniserHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
