...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2993
...
class ImportedFEComponentSteadyStateSynchronousResponseOnAShaft(_2993.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft):
    '''ImportedFEComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2283.ImportedFEComponentLoadCase':
        ...
        return constructor.new(_2283.ImportedFEComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
