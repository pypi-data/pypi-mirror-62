...
class AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft(_2423.ConicalGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_design(self) -> '_1789.AGMAGleasonConicalGearMesh':
