...
class BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft(_2700.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2346.BevelDifferentialGearLoadCase':
        ...
        return constructor.new(_2346.BevelDifferentialGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
