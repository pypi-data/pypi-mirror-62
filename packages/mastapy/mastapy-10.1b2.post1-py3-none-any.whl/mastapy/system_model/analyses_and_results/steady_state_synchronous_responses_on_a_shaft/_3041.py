...
class FaceGearSteadyStateSynchronousResponseOnAShaft(_3045.GearSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2314.FaceGearLoadCase':
        ...
        return constructor.new(_2314.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
