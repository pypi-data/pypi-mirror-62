...
class RollingRingSteadyStateSynchronousResponseOnAShaft(_3270.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2200.RollingRingLoadCase':
        ...
        return constructor.new(_2200.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
