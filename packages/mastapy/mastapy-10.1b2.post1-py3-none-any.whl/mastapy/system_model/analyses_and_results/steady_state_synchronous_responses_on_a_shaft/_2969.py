...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3377
...
class SteadyStateSynchronousResponseOnAShaft(_3378.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3377.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3377.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
