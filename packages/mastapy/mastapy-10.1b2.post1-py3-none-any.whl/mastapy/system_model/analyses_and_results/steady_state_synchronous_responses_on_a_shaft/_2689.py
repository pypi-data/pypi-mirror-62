...
class CylindricalGearSteadyStateSynchronousResponseOnAShaft(_2703.GearSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2354.CylindricalGearLoadCase':
        ...
        return constructor.new(_2354.CylindricalGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
