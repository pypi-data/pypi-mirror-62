...
from mastapy.system_model.analyses_and_results.static_loads import _2458
...
class HypoidGearSteadyStateSynchronousResponseOnAShaft(_2526.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft):
    '''HypoidGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2458.HypoidGearLoadCase':
        ...
        return constructor.new(_2458.HypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
