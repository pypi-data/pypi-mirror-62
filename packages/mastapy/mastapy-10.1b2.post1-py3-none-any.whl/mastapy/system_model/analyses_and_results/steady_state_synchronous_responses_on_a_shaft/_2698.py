...
class FaceGearSteadyStateSynchronousResponseOnAShaft(_2703.GearSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2342.FaceGearLoadCase':
        ...
        return constructor.new(_2342.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
