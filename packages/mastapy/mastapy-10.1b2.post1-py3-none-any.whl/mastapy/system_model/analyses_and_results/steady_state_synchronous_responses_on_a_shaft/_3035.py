...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3045
...
class CylindricalGearSteadyStateSynchronousResponseOnAShaft(_3045.GearSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2330.CylindricalGearLoadCase':
        ...
        return constructor.new(_2330.CylindricalGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
