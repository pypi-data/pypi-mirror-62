...
class TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft(_2792.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2287.TorqueConverterConnectionLoadCase':
        ...
        return constructor.new(_2287.TorqueConverterConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
