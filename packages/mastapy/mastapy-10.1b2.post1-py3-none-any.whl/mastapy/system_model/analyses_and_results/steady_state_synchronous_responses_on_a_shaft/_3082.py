...
class SpiralBevelGearSteadyStateSynchronousResponseOnAShaft(_3008.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''SpiralBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2357.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_2357.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
