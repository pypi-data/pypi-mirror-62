...
class PointLoadSteadyStateSynchronousResponseOnAShaft(_3104.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PointLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2297.PointLoadLoadCase':
        ...
        return constructor.new(_2297.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
