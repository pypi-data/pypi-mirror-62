...
class SpiralBevelGearSteadyStateSynchronousResponseOnAShaft(_2535.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''SpiralBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2369.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_2369.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
