...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _4454
...
class SteadyStateSynchronousResponseOnAShaft(_4455.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_4454.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_4454.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
