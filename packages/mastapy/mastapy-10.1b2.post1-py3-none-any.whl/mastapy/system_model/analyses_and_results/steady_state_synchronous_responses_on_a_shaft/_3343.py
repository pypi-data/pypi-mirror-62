...
class TorqueConverterSteadyStateSynchronousResponseOnAShaft(_3271.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2216.TorqueConverterLoadCase':
        ...
        return constructor.new(_2216.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
