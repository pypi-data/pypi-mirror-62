...
from mastapy.system_model.analyses_and_results.static_loads import _2432
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2620
...
class PlanetCarrierSteadyStateSynchronousResponseOnAShaft(_2620.MountableComponentSteadyStateSynchronousResponseOnAShaft):
    '''PlanetCarrierSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2432.PlanetCarrierLoadCase':
        ...
        return constructor.new(_2432.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
