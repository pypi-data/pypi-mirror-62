...
class ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft(_3269.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2236.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_2236.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
