...
class BeltDriveSteadyStateSynchronousResponseOnAShaft(_3321.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''BeltDriveSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2182.BeltDriveLoadCase':
        ...
        return constructor.new(_2182.BeltDriveLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
