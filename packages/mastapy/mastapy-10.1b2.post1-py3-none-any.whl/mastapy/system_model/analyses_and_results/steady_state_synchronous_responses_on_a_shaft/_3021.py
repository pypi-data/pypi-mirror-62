...
class ConceptGearSteadyStateSynchronousResponseOnAShaft(_3045.GearSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2311.ConceptGearLoadCase':
        ...
        return constructor.new(_2311.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
