...
class BoltSteadyStateSynchronousResponseOnAShaft(_3015.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''BoltSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2268.BoltLoadCase':
        ...
        return constructor.new(_2268.BoltLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
