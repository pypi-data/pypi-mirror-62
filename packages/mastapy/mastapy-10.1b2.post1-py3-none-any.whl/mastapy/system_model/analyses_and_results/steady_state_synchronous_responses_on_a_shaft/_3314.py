...
class RollingRingAssemblySteadyStateSynchronousResponseOnAShaft(_3321.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''RollingRingAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2202.RollingRingAssemblyLoadCase':
        ...
        return constructor.new(_2202.RollingRingAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
