...
from mastapy.system_model.analyses_and_results.static_loads import _2433
...
class PointLoadSteadyStateSynchronousResponseOnAShaft(_2868.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PointLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2433.PointLoadLoadCase':
        ...
        return constructor.new(_2433.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
