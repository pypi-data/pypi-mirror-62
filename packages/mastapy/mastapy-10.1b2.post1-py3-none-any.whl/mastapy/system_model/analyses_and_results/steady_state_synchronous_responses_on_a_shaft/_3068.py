...
class PlanetCarrierSteadyStateSynchronousResponseOnAShaft(_3063.MountableComponentSteadyStateSynchronousResponseOnAShaft):
    '''PlanetCarrierSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2295.PlanetCarrierLoadCase':
        ...
        return constructor.new(_2295.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
