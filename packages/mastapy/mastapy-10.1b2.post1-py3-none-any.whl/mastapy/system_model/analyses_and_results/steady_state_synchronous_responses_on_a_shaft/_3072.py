...
class RollingRingAssemblySteadyStateSynchronousResponseOnAShaft(_3079.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''RollingRingAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2194.RollingRingAssemblyLoadCase':
        ...
        return constructor.new(_2194.RollingRingAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
