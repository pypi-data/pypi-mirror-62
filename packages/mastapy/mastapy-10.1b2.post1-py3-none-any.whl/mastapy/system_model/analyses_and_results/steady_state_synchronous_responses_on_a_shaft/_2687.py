...
class BeltConnectionSteadyStateSynchronousResponseOnAShaft(_2815.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''BeltConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2274.BeltConnectionLoadCase':
        ...
        return constructor.new(_2274.BeltConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
