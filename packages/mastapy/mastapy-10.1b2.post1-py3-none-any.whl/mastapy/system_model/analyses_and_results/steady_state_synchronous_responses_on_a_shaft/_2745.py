...
class RollingRingSteadyStateSynchronousResponseOnAShaft(_2679.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2252.RollingRingLoadCase':
        ...
        return constructor.new(_2252.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
