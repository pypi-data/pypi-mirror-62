...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3054
...
class KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponseOnAShaft(_3054.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    '''KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2352.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
        ...
        return constructor.new(_2352.KlingelnbergCycloPalloidSpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
