...
class SpringDamperSteadyStateSynchronousResponseOnAShaft(_3271.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2204.SpringDamperLoadCase':
        ...
        return constructor.new(_2204.SpringDamperLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
