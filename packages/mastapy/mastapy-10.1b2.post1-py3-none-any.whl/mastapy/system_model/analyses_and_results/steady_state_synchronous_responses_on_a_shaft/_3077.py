...
class ShaftSteadyStateSynchronousResponseOnAShaft(_2993.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft):
    '''ShaftSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2309.ShaftLoadCase':
        ...
        return constructor.new(_2309.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
