...
class BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft(_4382.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3236.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3236.BeltDriveSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_3236.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_3236.BeltDriveSteadyStateSynchronousResponseOnAShaft))
        return value
