...
from mastapy.system_model.analyses_and_results.analysis_cases import _4522
...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_4522.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseOnAShaft
