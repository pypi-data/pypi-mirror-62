...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3867
...
class SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(_3867.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2058.SpringDamper':
    ...
    @property
    def assembly_design(self) -> '_2058.SpringDamper':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3327.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3327.SpringDamperSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_3327.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_3327.SpringDamperSteadyStateSynchronousResponseOnAShaft))
        return value
