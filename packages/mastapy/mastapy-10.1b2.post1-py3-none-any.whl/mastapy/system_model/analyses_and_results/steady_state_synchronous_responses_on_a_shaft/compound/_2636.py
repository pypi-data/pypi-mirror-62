...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _2579
...
class ImportedFEComponentCompoundSteadyStateSynchronousResponseOnAShaft(_2579.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ImportedFEComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2514.ImportedFEComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2514.ImportedFEComponentSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2514.ImportedFEComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2514.ImportedFEComponentSteadyStateSynchronousResponseOnAShaft))
        return value
