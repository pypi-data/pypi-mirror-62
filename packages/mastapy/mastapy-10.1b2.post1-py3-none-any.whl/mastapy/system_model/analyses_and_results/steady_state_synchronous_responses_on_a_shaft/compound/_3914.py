...
from mastapy.system_model.analyses_and_results.analysis_cases import _4528
...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_4528.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseOnAShaft
