...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3611
...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_4330.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_design(self) -> '_1921.ConceptCoupling':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3611.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3611.ConceptCouplingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_3611.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_3611.ConceptCouplingSteadyStateSynchronousResponseOnAShaft))
        return value
