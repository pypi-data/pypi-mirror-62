...
from mastapy.system_model.analyses_and_results.analysis_cases import _3384
...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3384.ConnectionCompoundAnalysis):
    '''ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
