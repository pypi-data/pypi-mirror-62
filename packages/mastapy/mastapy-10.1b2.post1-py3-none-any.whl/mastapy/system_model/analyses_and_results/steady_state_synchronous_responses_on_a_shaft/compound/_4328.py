...
from mastapy.system_model.analyses_and_results.analysis_cases import _3250
...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3250.ConnectionCompoundAnalysis):
    '''ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
