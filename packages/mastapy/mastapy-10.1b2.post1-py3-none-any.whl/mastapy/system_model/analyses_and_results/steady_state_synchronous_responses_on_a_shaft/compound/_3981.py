...
from mastapy.system_model.analyses_and_results.analysis_cases import _4593
...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_4593.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseOnAShaft
