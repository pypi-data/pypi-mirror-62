...
class ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_4331.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3247.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3247.ClutchConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_3247.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_3247.ClutchConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
