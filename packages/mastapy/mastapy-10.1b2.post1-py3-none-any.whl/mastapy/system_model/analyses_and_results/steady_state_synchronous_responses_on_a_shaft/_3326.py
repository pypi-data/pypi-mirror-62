...
class SpringDamperHalfSteadyStateSynchronousResponseOnAShaft(_3270.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperHalfSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2206.SpringDamperHalfLoadCase':
        ...
        return constructor.new(_2206.SpringDamperHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
