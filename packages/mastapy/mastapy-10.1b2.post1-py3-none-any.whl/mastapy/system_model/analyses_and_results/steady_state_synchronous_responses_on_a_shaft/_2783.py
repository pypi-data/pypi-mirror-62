...
from mastapy.system_model.analyses_and_results.static_loads import _2183
...
class ClutchSteadyStateSynchronousResponseOnAShaft(_3271.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''ClutchSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2183.ClutchLoadCase':
        ...
        return constructor.new(_2183.ClutchLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
