...
class ClutchConnectionSteadyStateSynchronousResponseOnAShaft(_3027.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''ClutchConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2227.ClutchConnectionLoadCase':
        ...
        return constructor.new(_2227.ClutchConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
