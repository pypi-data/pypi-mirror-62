...
class SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(_2776.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2264.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_2264.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
