...
class PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft(_2841.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def connection_load_case(self) -> '_2224.PlanetaryConnectionLoadCase':
        ...
        return constructor.new(_2224.PlanetaryConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
