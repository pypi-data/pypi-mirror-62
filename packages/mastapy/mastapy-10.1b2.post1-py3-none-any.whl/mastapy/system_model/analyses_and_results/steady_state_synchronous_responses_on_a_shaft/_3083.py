...
class SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft(_3027.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2232.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_2232.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
