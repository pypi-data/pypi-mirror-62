...
from mastapy.system_model.analyses_and_results.static_loads import _2454
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2582, _2580, _2594
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_2594.GearSetSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def assembly_load_case(self) -> '_2454.CylindricalGearSetLoadCase':
        ...
        return constructor.new(_2454.CylindricalGearSetLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2582.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSteadyStateSynchronousResponseOnAShaft, constructor.new(_2582.CylindricalGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2580.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSteadyStateSynchronousResponseOnAShaft, constructor.new(_2580.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
