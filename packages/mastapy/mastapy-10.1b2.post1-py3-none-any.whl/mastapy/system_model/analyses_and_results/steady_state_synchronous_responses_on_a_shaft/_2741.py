...
class PulleySteadyStateSynchronousResponseOnAShaft(_2679.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''PulleySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2249.PulleyLoadCase':
        ...
        return constructor.new(_2249.PulleyLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
