...
class MassDiscSteadyStateSynchronousResponseOnAShaft(_3104.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MassDiscSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2285.MassDiscLoadCase':
        ...
        return constructor.new(_2285.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
