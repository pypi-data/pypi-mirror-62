...
class PlanetCarrierSteadyStateSynchronousResponseOnAShaft(_2730.MountableComponentSteadyStateSynchronousResponseOnAShaft):
    '''PlanetCarrierSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2328.PlanetCarrierLoadCase':
        ...
        return constructor.new(_2328.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
