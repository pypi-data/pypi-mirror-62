...
class WormGearSteadyStateSynchronousResponseOnAShaft(_3045.GearSteadyStateSynchronousResponseOnAShaft):
    '''WormGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2373.WormGearLoadCase':
        ...
        return constructor.new(_2373.WormGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
