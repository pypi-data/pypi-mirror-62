...
class UnbalancedMassSteadyStateSynchronousResponseOnAShaft(_3104.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''UnbalancedMassSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2305.UnbalancedMassLoadCase':
        ...
        return constructor.new(_2305.UnbalancedMassLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
