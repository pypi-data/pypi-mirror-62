...
class CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft(_2700.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2296.CylindricalGearMeshLoadCase':
        ...
        return constructor.new(_2296.CylindricalGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
