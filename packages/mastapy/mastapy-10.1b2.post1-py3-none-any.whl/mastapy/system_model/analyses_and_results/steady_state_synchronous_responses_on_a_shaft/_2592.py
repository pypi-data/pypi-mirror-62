...
class PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft(_2721.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2324.PlanetaryConnectionLoadCase':
        ...
        return constructor.new(_2324.PlanetaryConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
