...
class GuideDxfModelSteadyStateSynchronousResponseOnAShaft(_3257.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''GuideDxfModelSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2289.GuideDxfModelLoadCase':
        ...
        return constructor.new(_2289.GuideDxfModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
