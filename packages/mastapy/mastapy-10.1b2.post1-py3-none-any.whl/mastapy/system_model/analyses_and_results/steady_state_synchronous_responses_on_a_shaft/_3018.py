...
from mastapy.system_model.analyses_and_results.static_loads import _2177
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3029
...
class ConceptCouplingSteadyStateSynchronousResponseOnAShaft(_3029.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''ConceptCouplingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2177.ConceptCouplingLoadCase':
        ...
        return constructor.new(_2177.ConceptCouplingLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
