...
class ClutchConnectionSteadyStateSynchronousResponseOnAShaft(_3269.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''ClutchConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2235.ClutchConnectionLoadCase':
        ...
        return constructor.new(_2235.ClutchConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
