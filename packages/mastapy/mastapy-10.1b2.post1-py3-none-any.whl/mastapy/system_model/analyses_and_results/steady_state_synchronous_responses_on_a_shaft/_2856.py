...
class SteadyStateSynchronousResponseOnAShaft(_3151.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3150.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3150.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
