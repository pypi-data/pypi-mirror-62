...
from mastapy.system_model.analyses_and_results.static_loads import _2389
...
class PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft(_2841.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2389.PlanetaryConnectionLoadCase':
        ...
        return constructor.new(_2389.PlanetaryConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
