...
class RollingRingAssemblySteadyStateSynchronousResponseOnAShaft(_2843.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''RollingRingAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2374.RollingRingAssemblyLoadCase':
        ...
        return constructor.new(_2374.RollingRingAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
