...
class ConceptGearMeshSteadyStateSynchronousResponseOnAShaft(_3043.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2236.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_2236.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
