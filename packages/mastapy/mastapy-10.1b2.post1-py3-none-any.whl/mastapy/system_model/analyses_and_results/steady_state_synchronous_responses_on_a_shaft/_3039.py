...
class FaceGearMeshSteadyStateSynchronousResponseOnAShaft(_3043.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2238.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2238.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
