...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3291, _3289, _2765
...
class HypoidGearSetSteadyStateSynchronousResponseOnAShaft(_2765.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    '''HypoidGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    def hypoid_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3291.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSteadyStateSynchronousResponseOnAShaft, constructor.new(_3291.HypoidGearSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    def hypoid_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3289.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSteadyStateSynchronousResponseOnAShaft, constructor.new(_3289.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
