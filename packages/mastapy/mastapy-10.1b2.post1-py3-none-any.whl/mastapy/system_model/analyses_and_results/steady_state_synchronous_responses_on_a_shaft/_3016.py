...
class ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft(_3027.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2228.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_2228.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
