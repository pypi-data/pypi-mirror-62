...
class SynchroniserSteadyStateSynchronousResponseOnAShaft(_3321.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2208.SynchroniserLoadCase':
        ...
        return constructor.new(_2208.SynchroniserLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
