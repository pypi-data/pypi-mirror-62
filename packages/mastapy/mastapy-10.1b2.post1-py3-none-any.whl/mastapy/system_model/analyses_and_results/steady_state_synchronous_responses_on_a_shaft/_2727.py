...
class MassDiscSteadyStateSynchronousResponseOnAShaft(_2869.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MassDiscSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2323.MassDiscLoadCase':
        ...
        return constructor.new(_2323.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
