...
class MeasurementComponentSteadyStateSynchronousResponseOnAShaft(_2869.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MeasurementComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2324.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2324.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
