...
class BoltedJointSteadyStateSynchronousResponseOnAShaft(_2962.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''BoltedJointSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2315.BoltedJointLoadCase':
        ...
        return constructor.new(_2315.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
