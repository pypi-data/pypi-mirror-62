...
from mastapy.system_model.analyses_and_results.static_loads import _2426
...
class ImportedFEComponentSteadyStateSynchronousResponseOnAShaft(_2521.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft):
    '''ImportedFEComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2426.ImportedFEComponentLoadCase':
        ...
        return constructor.new(_2426.ImportedFEComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
