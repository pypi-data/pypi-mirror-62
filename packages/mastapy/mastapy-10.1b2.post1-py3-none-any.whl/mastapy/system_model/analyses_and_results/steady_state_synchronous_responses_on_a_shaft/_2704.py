...
class ClutchConnectionSteadyStateSynchronousResponseOnAShaft(_2791.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''ClutchConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2282.ClutchConnectionLoadCase':
        ...
        return constructor.new(_2282.ClutchConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
