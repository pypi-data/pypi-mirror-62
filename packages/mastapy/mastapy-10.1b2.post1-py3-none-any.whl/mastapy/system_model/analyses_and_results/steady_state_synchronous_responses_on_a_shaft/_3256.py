...
class CoaxialConnectionSteadyStateSynchronousResponseOnAShaft(_3320.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''CoaxialConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2224.CoaxialConnectionLoadCase':
        ...
        return constructor.new(_2224.CoaxialConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
