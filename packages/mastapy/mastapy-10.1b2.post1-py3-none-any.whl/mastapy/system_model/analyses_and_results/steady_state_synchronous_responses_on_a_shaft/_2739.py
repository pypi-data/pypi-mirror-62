...
class PointLoadSteadyStateSynchronousResponseOnAShaft(_2869.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PointLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2329.PointLoadLoadCase':
        ...
        return constructor.new(_2329.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
