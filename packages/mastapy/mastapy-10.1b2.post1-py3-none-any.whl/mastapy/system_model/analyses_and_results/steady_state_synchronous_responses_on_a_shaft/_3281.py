...
class FaceGearMeshSteadyStateSynchronousResponseOnAShaft(_3285.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2246.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2246.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
