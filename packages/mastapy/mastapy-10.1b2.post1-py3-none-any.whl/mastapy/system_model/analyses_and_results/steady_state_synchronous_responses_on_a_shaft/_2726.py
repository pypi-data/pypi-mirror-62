...
class KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponseOnAShaft(_2717.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_load_case(self) -> '_2365.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
        ...
        return constructor.new(_2365.KlingelnbergCycloPalloidSpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
