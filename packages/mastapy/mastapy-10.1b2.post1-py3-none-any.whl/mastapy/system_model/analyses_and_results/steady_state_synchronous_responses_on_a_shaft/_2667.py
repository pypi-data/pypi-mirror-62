...
class ConceptGearMeshSteadyStateSynchronousResponseOnAShaft(_2700.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2289.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_2289.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
