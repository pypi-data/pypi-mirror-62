...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2994
...
class HypoidGearMeshSteadyStateSynchronousResponseOnAShaft(_2994.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''HypoidGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2248.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_2248.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
