...
class ShaftSteadyStateSynchronousResponseOnAShaft(_2520.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft):
    '''ShaftSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2339.ShaftLoadCase':
        ...
        return constructor.new(_2339.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
