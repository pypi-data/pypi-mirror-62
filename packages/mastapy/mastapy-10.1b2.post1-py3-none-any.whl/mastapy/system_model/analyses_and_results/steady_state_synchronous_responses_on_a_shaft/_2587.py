...
from mastapy.system_model.analyses_and_results.static_loads import _2399
...
class FaceGearMeshSteadyStateSynchronousResponseOnAShaft(_2593.GearMeshSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def connection_load_case(self) -> '_2399.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2399.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
