...
class TorqueConverterSteadyStateSynchronousResponseOnAShaft(_3029.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2208.TorqueConverterLoadCase':
        ...
        return constructor.new(_2208.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
