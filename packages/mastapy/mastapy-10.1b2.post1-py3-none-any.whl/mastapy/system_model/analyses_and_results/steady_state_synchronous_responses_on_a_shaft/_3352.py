...
from mastapy.system_model.analyses_and_results.static_loads import _2179
...
class ZerolBevelGearSteadyStateSynchronousResponseOnAShaft(_2778.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''ZerolBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2179.ZerolBevelGearLoadCase':
        ...
        return constructor.new(_2179.ZerolBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
