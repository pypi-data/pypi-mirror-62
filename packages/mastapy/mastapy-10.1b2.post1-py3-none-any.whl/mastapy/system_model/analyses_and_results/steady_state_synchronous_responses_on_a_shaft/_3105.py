...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3043
...
class WormGearMeshSteadyStateSynchronousResponseOnAShaft(_3043.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''WormGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2260.WormGearMeshLoadCase':
        ...
        return constructor.new(_2260.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
