...
class ClutchSteadyStateSynchronousResponseOnAShaft(_3029.CouplingSteadyStateSynchronousResponseOnAShaft):
    '''ClutchSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2175.ClutchLoadCase':
        ...
        return constructor.new(_2175.ClutchLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
