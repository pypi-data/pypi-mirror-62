...
class ConceptCouplingHalfSteadyStateSynchronousResponseOnAShaft(_3270.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''ConceptCouplingHalfSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2186.ConceptCouplingHalfLoadCase':
        ...
        return constructor.new(_2186.ConceptCouplingHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
