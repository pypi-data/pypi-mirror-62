...
class SynchroniserSteadyStateSynchronousResponseOnAShaft(_3079.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2200.SynchroniserLoadCase':
        ...
        return constructor.new(_2200.SynchroniserLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
