...
class SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft(_2979.SynchroniserPartSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2265.SynchroniserSleeveLoadCase':
        ...
        return constructor.new(_2265.SynchroniserSleeveLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
