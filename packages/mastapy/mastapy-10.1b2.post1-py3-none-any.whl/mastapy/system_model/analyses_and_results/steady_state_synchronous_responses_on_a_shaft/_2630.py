...
class PulleySteadyStateSynchronousResponseOnAShaft(_2573.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''PulleySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2371.PulleyLoadCase':
        ...
        return constructor.new(_2371.PulleyLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
