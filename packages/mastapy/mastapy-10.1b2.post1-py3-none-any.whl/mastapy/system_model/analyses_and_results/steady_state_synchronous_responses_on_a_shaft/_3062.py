...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3104
...
class MeasurementComponentSteadyStateSynchronousResponseOnAShaft(_3104.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MeasurementComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2287.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2287.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
