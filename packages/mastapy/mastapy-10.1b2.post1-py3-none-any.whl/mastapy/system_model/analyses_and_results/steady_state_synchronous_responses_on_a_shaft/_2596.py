...
class PowerLoadSteadyStateSynchronousResponseOnAShaft(_3342.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PowerLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1935.PowerLoad':
        ...
        return constructor.new(_1935.PowerLoad)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_load_case(self) -> '_2369.PowerLoadLoadCase':
        ...
        return constructor.new(_2369.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
