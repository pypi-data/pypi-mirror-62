...
from mastapy.system_model.analyses_and_results.static_loads import _2428
...
class MeasurementComponentSteadyStateSynchronousResponseOnAShaft(_2868.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MeasurementComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2428.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2428.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
