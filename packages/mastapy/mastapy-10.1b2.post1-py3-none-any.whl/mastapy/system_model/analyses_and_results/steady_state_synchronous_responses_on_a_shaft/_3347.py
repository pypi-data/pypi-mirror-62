...
class WormGearMeshSteadyStateSynchronousResponseOnAShaft(_3285.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''WormGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2268.WormGearMeshLoadCase':
        ...
        return constructor.new(_2268.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
