...
from mastapy.system_model.analyses_and_results.static_loads import _2405
...
class HypoidGearMeshSteadyStateSynchronousResponseOnAShaft(_2523.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''HypoidGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2405.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_2405.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
