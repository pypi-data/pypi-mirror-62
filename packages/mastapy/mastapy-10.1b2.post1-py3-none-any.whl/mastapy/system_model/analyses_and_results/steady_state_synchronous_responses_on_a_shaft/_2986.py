...
class UnbalancedMassSteadyStateSynchronousResponseOnAShaft(_2987.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''UnbalancedMassSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2336.UnbalancedMassLoadCase':
        ...
        return constructor.new(_2336.UnbalancedMassLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
