...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3096
...
class SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft(_3096.SynchroniserPartSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2206.SynchroniserSleeveLoadCase':
        ...
        return constructor.new(_2206.SynchroniserSleeveLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
