...
class ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft(_2672.ConnectorSteadyStateSynchronousResponseOnAShaft):
    '''ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2192.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_2192.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
