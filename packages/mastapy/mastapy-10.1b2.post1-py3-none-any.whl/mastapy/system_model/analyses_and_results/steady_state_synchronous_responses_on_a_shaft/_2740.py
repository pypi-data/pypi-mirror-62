...
class PowerLoadSteadyStateSynchronousResponseOnAShaft(_2869.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PowerLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2330.PowerLoadLoadCase':
        ...
        return constructor.new(_2330.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
