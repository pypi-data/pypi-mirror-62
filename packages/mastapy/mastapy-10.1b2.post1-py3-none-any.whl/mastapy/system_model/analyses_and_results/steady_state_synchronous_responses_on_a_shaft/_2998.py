...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3026
...
class BearingSteadyStateSynchronousResponseOnAShaft(_3026.ConnectorSteadyStateSynchronousResponseOnAShaft):
    '''BearingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2267.BearingLoadCase':
        ...
        return constructor.new(_2267.BearingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
