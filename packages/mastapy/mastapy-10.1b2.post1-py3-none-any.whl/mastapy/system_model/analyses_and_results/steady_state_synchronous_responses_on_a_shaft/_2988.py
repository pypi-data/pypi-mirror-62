...
class WormGearMeshSteadyStateSynchronousResponseOnAShaft(_2808.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''WormGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2306.WormGearMeshLoadCase':
        ...
        return constructor.new(_2306.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
