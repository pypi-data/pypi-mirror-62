...
class GuideDxfModelSteadyStateSynchronousResponseOnAShaft(_3015.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''GuideDxfModelSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2281.GuideDxfModelLoadCase':
        ...
        return constructor.new(_2281.GuideDxfModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
