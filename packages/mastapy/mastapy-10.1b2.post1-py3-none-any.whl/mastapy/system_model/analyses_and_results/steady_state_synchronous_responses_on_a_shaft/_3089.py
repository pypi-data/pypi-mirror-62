...
class StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft(_3008.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2361.StraightBevelDiffGearLoadCase':
        ...
        return constructor.new(_2361.StraightBevelDiffGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
