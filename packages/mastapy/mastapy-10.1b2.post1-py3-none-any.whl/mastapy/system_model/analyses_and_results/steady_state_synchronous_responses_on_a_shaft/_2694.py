...
class ExternalCADModelSteadyStateSynchronousResponseOnAShaft(_2662.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''ExternalCADModelSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2318.ExternalCADModelLoadCase':
        ...
        return constructor.new(_2318.ExternalCADModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
