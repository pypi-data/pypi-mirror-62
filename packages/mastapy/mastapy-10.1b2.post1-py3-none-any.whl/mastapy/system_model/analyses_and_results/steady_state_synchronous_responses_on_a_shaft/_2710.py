...
class ImportedFEComponentSteadyStateSynchronousResponseOnAShaft(_2520.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft):
    '''ImportedFEComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2322.ImportedFEComponentLoadCase':
        ...
        return constructor.new(_2322.ImportedFEComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
