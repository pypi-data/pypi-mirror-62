...
from mastapy.system_model.analyses_and_results.static_loads import _2290
...
class FaceGearMeshSteadyStateSynchronousResponseOnAShaft(_2700.GearMeshSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2290.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2290.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
