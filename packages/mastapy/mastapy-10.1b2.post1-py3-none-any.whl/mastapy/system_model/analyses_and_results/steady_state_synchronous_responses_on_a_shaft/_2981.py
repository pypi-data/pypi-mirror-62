...
class SynchroniserSteadyStateSynchronousResponseOnAShaft(_2962.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2259.SynchroniserLoadCase':
        ...
        return constructor.new(_2259.SynchroniserLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
