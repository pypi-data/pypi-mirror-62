...
from mastapy.system_model.analyses_and_results.static_loads import _2430
...
class OilSealSteadyStateSynchronousResponseOnAShaft(_2570.ConnectorSteadyStateSynchronousResponseOnAShaft):
    '''OilSealSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2430.OilSealLoadCase':
        ...
        return constructor.new(_2430.OilSealLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
