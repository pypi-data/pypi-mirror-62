...
class StraightBevelGearSteadyStateSynchronousResponseOnAShaft(_2535.BevelGearSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2377.StraightBevelGearLoadCase':
        ...
        return constructor.new(_2377.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
