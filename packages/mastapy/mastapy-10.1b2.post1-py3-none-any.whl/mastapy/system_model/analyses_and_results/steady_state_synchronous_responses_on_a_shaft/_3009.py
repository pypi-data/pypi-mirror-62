...
class BoltedJointSteadyStateSynchronousResponseOnAShaft(_3079.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''BoltedJointSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2269.BoltedJointLoadCase':
        ...
        return constructor.new(_2269.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
