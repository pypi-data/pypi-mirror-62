...
class ConceptGearSteadyStateSynchronousResponseOnAShaft(_2703.GearSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2340.ConceptGearLoadCase':
        ...
        return constructor.new(_2340.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
