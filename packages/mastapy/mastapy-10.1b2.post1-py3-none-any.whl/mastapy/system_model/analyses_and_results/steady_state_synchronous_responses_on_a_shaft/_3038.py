...
class ExternalCADModelSteadyStateSynchronousResponseOnAShaft(_3015.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''ExternalCADModelSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2276.ExternalCADModelLoadCase':
        ...
        return constructor.new(_2276.ExternalCADModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
