...
from mastapy.system_model.analyses_and_results.static_loads import _2390
...
class RollingRingConnectionSteadyStateSynchronousResponseOnAShaft(_2604.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2390.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_2390.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
