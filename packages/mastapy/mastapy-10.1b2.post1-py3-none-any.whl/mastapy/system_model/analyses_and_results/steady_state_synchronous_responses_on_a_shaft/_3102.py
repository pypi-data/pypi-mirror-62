...
from mastapy.system_model.analyses_and_results.static_loads import _2212
...
class TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(_3028.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2212.TorqueConverterTurbineLoadCase':
        ...
        return constructor.new(_2212.TorqueConverterTurbineLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
