...
from mastapy.system_model.part_model.couplings import _2033, _2032, _2034
...
class SynchroniserPartSteadyStateSynchronousResponseOnAShaft(_3028.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''SynchroniserPartSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2033.SynchroniserPart':
        ...
        return constructor.new(_2033.SynchroniserPart)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
