...
from mastapy.system_model.analyses_and_results.static_loads import _2434
...
class PowerLoadSteadyStateSynchronousResponseOnAShaft(_2868.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''PowerLoadSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2434.PowerLoadLoadCase':
        ...
        return constructor.new(_2434.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
