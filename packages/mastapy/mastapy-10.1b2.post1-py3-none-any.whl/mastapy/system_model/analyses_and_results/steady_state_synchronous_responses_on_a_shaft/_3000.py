...
class BeltDriveSteadyStateSynchronousResponseOnAShaft(_3079.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    '''BeltDriveSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_load_case(self) -> '_2174.BeltDriveLoadCase':
        ...
        return constructor.new(_2174.BeltDriveLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
