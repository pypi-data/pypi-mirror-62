...
class KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft(_2717.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_load_case(self) -> '_2363.KlingelnbergCycloPalloidHypoidGearLoadCase':
        ...
        return constructor.new(_2363.KlingelnbergCycloPalloidHypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
