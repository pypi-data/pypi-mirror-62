...
class RollingRingSteadyStateSynchronousResponseOnAShaft(_3028.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2192.RollingRingLoadCase':
        ...
        return constructor.new(_2192.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
