...
from mastapy.system_model.analyses_and_results.static_loads import _2453
...
class CylindricalGearSteadyStateSynchronousResponseOnAShaft(_2595.GearSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_load_case(self) -> '_2453.CylindricalGearLoadCase':
        ...
        return constructor.new(_2453.CylindricalGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
