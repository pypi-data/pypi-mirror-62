...
class StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft(_2776.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2248.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_2248.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
