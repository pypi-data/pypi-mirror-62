...
from mastapy.system_model.analyses_and_results.static_loads import _2223
...
class BeltConnectionSteadyStateSynchronousResponseOnAShaft(_3293.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''BeltConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2223.BeltConnectionLoadCase':
        ...
        return constructor.new(_2223.BeltConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
