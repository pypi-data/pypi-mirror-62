...
class DatumSteadyStateSynchronousResponseOnAShaft(_2662.ComponentSteadyStateSynchronousResponseOnAShaft):
    '''DatumSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2317.DatumLoadCase':
        ...
        return constructor.new(_2317.DatumLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
