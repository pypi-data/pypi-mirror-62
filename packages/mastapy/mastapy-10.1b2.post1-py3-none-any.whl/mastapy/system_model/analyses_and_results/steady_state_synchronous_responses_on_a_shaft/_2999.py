...
from mastapy.system_model.analyses_and_results.static_loads import _2215
...
class BeltConnectionSteadyStateSynchronousResponseOnAShaft(_3051.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    '''BeltConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2215.BeltConnectionLoadCase':
        ...
        return constructor.new(_2215.BeltConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
