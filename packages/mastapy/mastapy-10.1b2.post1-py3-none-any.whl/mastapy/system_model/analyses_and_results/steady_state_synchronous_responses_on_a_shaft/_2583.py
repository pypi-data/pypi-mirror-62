...
from mastapy.system_model.analyses_and_results.static_loads import _2397
...
class KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft(_2580.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    '''KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2397.KlingelnbergCycloPalloidHypoidGearLoadCase':
        ...
        return constructor.new(_2397.KlingelnbergCycloPalloidHypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
