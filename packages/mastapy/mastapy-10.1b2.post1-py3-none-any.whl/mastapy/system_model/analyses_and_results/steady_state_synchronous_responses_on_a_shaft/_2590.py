...
from mastapy.system_model.analyses_and_results.static_loads import _2441
...
class FaceGearSteadyStateSynchronousResponseOnAShaft(_2595.GearSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def component_load_case(self) -> '_2441.FaceGearLoadCase':
        ...
        return constructor.new(_2441.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
