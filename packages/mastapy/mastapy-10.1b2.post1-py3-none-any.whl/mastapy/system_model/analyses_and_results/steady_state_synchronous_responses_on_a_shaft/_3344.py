...
class TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(_3270.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2220.TorqueConverterTurbineLoadCase':
        ...
        return constructor.new(_2220.TorqueConverterTurbineLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
