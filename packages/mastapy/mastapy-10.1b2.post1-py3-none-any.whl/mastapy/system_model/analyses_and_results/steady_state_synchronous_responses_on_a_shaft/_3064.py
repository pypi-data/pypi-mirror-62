...
class OilSealSteadyStateSynchronousResponseOnAShaft(_3026.ConnectorSteadyStateSynchronousResponseOnAShaft):
    '''OilSealSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2291.OilSealLoadCase':
        ...
        return constructor.new(_2291.OilSealLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
