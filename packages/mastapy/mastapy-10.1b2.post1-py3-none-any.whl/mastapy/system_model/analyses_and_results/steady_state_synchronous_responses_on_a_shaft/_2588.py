...
class MeasurementComponentSteadyStateSynchronousResponseOnAShaft(_3342.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    '''MeasurementComponentSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1928.MeasurementComponent':
        ...
        return constructor.new(_1928.MeasurementComponent)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_load_case(self) -> '_2363.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2363.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
