...
class BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft(_2776.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2243.BevelDifferentialGearMeshLoadCase':
        ...
        return constructor.new(_2243.BevelDifferentialGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
