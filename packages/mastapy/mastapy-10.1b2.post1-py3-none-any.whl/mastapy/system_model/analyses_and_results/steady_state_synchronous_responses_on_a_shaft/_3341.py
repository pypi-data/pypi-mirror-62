...
class TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft(_3269.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_load_case(self) -> '_2242.TorqueConverterConnectionLoadCase':
        ...
        return constructor.new(_2242.TorqueConverterConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
