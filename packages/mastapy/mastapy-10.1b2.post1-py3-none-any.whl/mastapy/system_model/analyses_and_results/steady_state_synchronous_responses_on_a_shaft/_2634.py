...
class RollingRingSteadyStateSynchronousResponseOnAShaft(_2573.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_load_case(self) -> '_2373.RollingRingLoadCase':
        ...
        return constructor.new(_2373.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
