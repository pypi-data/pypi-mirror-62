...
from mastapy.system_model.analyses_and_results import _2102
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_6318.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1724.DesignEntity') -> '_2102.DesignEntityAnalysis':
        ...
        return constructor.new(_2102.DesignEntityAnalysis)(method_result) if method_result else None

    def results_for_design_entity_analysis(self, design_entity_analysis: '_2102.DesignEntityAnalysis') -> '_2102.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
