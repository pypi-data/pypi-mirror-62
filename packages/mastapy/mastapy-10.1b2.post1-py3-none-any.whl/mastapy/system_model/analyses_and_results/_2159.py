...
class DesignEntityAnalysis(_1.APIBase):
    ...
    @property
    def component_design(self) -> '_1774.DesignEntity':
        ...
        return constructor.new(_1774.DesignEntity)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def component_design_of_type_connection(self) -> '_1815.Connection':
        ...
        if _1815.Connection.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_part(self) -> '_1987.Part':
        ...
        if _1987.Part.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
