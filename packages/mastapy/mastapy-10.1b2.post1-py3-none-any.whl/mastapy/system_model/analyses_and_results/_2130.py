...
from mastapy.system_model.analyses_and_results.analysis_cases import _6467
...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_6479.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1774.DesignEntity') -> 'Iterable[_6467.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_6467.DesignEntityCompoundAnalysis))
