...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3897
...
class ConicalGearModalAnalysesAtSpeeds(_3897.GearModalAnalysesAtSpeeds):
    '''ConicalGearModalAnalysesAtSpeeds
