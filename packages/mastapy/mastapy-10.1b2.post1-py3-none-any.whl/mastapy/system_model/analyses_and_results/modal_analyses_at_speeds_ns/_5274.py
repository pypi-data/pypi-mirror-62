...
class StabilityAnalysis(_3151.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def modal_analyses_at_speeds_options(self) -> '_5249.ModalAnalysesAtSpeedsOptions':
        ...
        return constructor.new(_5249.ModalAnalysesAtSpeedsOptions)(self.wrapped.ModalAnalysesAtSpeedsOptions) if self.wrapped.ModalAnalysesAtSpeedsOptions else None
