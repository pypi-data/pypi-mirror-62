...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5253
...
class ComponentModalAnalysesAtSpeeds(_5253.PartModalAnalysesAtSpeeds):
    '''ComponentModalAnalysesAtSpeeds
