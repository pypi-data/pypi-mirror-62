...
class CylindricalGearMeshModalAnalysesAtSpeeds(_5229.GearMeshModalAnalysesAtSpeeds):
    '''CylindricalGearMeshModalAnalysesAtSpeeds
    ...
    @property
    def connection_load_case(self) -> '_2255.CylindricalGearMeshLoadCase':
        ...
        return constructor.new(_2255.CylindricalGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
