...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3893, _3892, _3898
...
class FaceGearSetModalAnalysesAtSpeeds(_3898.GearSetModalAnalysesAtSpeeds):
    '''FaceGearSetModalAnalysesAtSpeeds
    ...
    @property
    def face_gears_modal_analyses_at_speeds(self) -> 'List[_3893.FaceGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtSpeeds, constructor.new(_3893.FaceGearModalAnalysesAtSpeeds))
        return value

    @property
    def face_meshes_modal_analyses_at_speeds(self) -> 'List[_3892.FaceGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtSpeeds, constructor.new(_3892.FaceGearMeshModalAnalysesAtSpeeds))
        return value
