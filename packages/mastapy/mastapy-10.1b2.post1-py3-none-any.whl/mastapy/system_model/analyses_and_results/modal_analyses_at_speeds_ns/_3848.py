...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3876
...
class AGMAGleasonConicalGearSetModalAnalysesAtSpeeds(_3876.ConicalGearSetModalAnalysesAtSpeeds):
    '''AGMAGleasonConicalGearSetModalAnalysesAtSpeeds
