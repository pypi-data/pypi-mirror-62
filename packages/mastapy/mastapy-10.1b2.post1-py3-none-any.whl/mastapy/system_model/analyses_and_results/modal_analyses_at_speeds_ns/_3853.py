...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3858
...
class BevelDifferentialGearMeshModalAnalysesAtSpeeds(_3858.BevelGearMeshModalAnalysesAtSpeeds):
    '''BevelDifferentialGearMeshModalAnalysesAtSpeeds
