...
class CylindricalGearModalAnalysesAtSpeeds(_5230.GearModalAnalysesAtSpeeds):
    '''CylindricalGearModalAnalysesAtSpeeds
    ...
    @property
    def component_load_case(self) -> '_2337.CylindricalGearLoadCase':
        ...
        return constructor.new(_2337.CylindricalGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
