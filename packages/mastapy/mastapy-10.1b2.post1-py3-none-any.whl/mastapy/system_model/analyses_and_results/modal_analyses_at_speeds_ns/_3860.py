...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3848
...
class BevelGearSetModalAnalysesAtSpeeds(_3848.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''BevelGearSetModalAnalysesAtSpeeds
