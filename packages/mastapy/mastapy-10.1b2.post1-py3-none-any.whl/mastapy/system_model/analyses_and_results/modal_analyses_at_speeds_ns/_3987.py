...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3986, _3985, _3998
...
class CylindricalGearSetModalAnalysesAtSpeeds(_3998.GearSetModalAnalysesAtSpeeds):
    '''CylindricalGearSetModalAnalysesAtSpeeds
    ...
    @property
    def cylindrical_gears_modal_analyses_at_speeds(self) -> 'List[_3986.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtSpeeds, constructor.new(_3986.CylindricalGearModalAnalysesAtSpeeds))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_speeds(self) -> 'List[_3985.CylindricalGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtSpeeds, constructor.new(_3985.CylindricalGearMeshModalAnalysesAtSpeeds))
        return value
