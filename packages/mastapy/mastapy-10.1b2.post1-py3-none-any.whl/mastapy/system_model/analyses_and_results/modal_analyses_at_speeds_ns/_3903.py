...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3845
...
class ImportedFEComponentModalAnalysesAtSpeeds(_3845.AbstractShaftOrHousingModalAnalysesAtSpeeds):
    '''ImportedFEComponentModalAnalysesAtSpeeds
