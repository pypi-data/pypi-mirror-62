...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3920
...
class ComponentModalAnalysesAtSpeeds(_3920.PartModalAnalysesAtSpeeds):
    '''ComponentModalAnalysesAtSpeeds
