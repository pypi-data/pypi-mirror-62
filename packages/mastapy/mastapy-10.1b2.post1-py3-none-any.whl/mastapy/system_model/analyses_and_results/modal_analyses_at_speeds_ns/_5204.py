...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5203, _5202, _5231
...
class ConceptGearSetModalAnalysesAtSpeeds(_5231.GearSetModalAnalysesAtSpeeds):
    '''ConceptGearSetModalAnalysesAtSpeeds
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_5203.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_5203.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_5202.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_5202.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
