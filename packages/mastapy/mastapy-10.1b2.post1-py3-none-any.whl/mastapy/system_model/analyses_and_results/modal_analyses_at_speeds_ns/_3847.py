...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3875
...
class AGMAGleasonConicalGearModalAnalysesAtSpeeds(_3875.ConicalGearModalAnalysesAtSpeeds):
    '''AGMAGleasonConicalGearModalAnalysesAtSpeeds
