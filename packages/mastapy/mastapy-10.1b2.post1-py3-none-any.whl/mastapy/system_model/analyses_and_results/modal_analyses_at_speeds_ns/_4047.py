...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4046, _4045, _3960
...
class StraightBevelDiffGearSetModalAnalysesAtSpeeds(_3960.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelDiffGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_diff_gears_modal_analyses_at_speeds(self) -> 'List[_4046.StraightBevelDiffGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysesAtSpeeds, constructor.new(_4046.StraightBevelDiffGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analyses_at_speeds(self) -> 'List[_4045.StraightBevelDiffGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysesAtSpeeds, constructor.new(_4045.StraightBevelDiffGearMeshModalAnalysesAtSpeeds))
        return value
