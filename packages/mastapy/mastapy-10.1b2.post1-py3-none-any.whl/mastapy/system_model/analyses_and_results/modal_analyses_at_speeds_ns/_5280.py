...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5279, _5278, _5191
...
class StraightBevelGearSetModalAnalysesAtSpeeds(_5191.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_5279.StraightBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtSpeeds, constructor.new(_5279.StraightBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_5278.StraightBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtSpeeds, constructor.new(_5278.StraightBevelGearMeshModalAnalysesAtSpeeds))
        return value
