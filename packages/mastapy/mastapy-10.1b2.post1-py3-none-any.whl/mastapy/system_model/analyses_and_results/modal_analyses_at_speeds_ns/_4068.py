...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4067, _4066, _3960
...
class ZerolBevelGearSetModalAnalysesAtSpeeds(_3960.BevelGearSetModalAnalysesAtSpeeds):
    '''ZerolBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4067.ZerolBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtSpeeds, constructor.new(_4067.ZerolBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4066.ZerolBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4066.ZerolBevelGearMeshModalAnalysesAtSpeeds))
        return value
