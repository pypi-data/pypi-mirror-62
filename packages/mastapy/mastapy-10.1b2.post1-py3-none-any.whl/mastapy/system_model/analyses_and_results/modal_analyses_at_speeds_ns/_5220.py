...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5217, _5216, _5231
...
class CylindricalGearSetModalAnalysesAtSpeeds(_5231.GearSetModalAnalysesAtSpeeds):
    '''CylindricalGearSetModalAnalysesAtSpeeds
    ...
    @property
    def cylindrical_gears_modal_analyses_at_speeds(self) -> 'List[_5217.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtSpeeds, constructor.new(_5217.CylindricalGearModalAnalysesAtSpeeds))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_speeds(self) -> 'List[_5216.CylindricalGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtSpeeds, constructor.new(_5216.CylindricalGearMeshModalAnalysesAtSpeeds))
        return value
