...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4049, _4048, _3960
...
class StraightBevelGearSetModalAnalysesAtSpeeds(_3960.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4049.StraightBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtSpeeds, constructor.new(_4049.StraightBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4048.StraightBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4048.StraightBevelGearMeshModalAnalysesAtSpeeds))
        return value
