...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4019
...
class ConicalGearSetCompoundModalAnalysesAtSpeeds(_4019.GearSetCompoundModalAnalysesAtSpeeds):
    '''ConicalGearSetCompoundModalAnalysesAtSpeeds
