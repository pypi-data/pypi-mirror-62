...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3870
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4001
...
class ConceptCouplingCompoundModalAnalysesAtSpeeds(_4001.CouplingCompoundModalAnalysesAtSpeeds):
    '''ConceptCouplingCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3870.ConceptCouplingModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3870.ConceptCouplingModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_3870.ConceptCouplingModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_3870.ConceptCouplingModalAnalysesAtSpeeds))
        return value
