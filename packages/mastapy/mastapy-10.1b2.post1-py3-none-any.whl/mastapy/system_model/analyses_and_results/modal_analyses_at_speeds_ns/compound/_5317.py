...
class BoltedJointCompoundModalAnalysesAtSpeeds(_5386.SpecialisedAssemblyCompoundModalAnalysesAtSpeeds):
    '''BoltedJointCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5192.BoltedJointModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5192.BoltedJointModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_5192.BoltedJointModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_5192.BoltedJointModalAnalysesAtSpeeds))
        return value
