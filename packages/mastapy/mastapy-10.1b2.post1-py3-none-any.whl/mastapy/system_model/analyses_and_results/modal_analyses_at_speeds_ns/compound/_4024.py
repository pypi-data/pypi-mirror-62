...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3903
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _3967
...
class ImportedFEComponentCompoundModalAnalysesAtSpeeds(_3967.AbstractShaftOrHousingCompoundModalAnalysesAtSpeeds):
    '''ImportedFEComponentCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3903.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3903.ImportedFEComponentModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_3903.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_3903.ImportedFEComponentModalAnalysesAtSpeeds))
        return value
