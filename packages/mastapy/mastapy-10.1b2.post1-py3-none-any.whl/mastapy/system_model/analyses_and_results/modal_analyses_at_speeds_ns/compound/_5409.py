...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5291
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5410
...
class UnbalancedMassCompoundModalAnalysesAtSpeeds(_5410.VirtualComponentCompoundModalAnalysesAtSpeeds):
    '''UnbalancedMassCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5291.UnbalancedMassModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5291.UnbalancedMassModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_5291.UnbalancedMassModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_5291.UnbalancedMassModalAnalysesAtSpeeds))
        return value
