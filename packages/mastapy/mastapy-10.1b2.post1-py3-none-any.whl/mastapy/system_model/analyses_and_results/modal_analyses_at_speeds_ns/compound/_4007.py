...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3886
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4017
...
class CylindricalGearCompoundModalAnalysesAtSpeeds(_4017.GearCompoundModalAnalysesAtSpeeds):
    '''CylindricalGearCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3886.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3886.CylindricalGearModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_3886.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_3886.CylindricalGearModalAnalysesAtSpeeds))
        return value
