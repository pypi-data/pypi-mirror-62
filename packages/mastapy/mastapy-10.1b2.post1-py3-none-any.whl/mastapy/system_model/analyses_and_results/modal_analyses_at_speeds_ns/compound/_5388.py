...
class SpiralBevelGearMeshCompoundModalAnalysesAtSpeeds(_5314.BevelGearMeshCompoundModalAnalysesAtSpeeds):
    '''SpiralBevelGearMeshCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5268.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5268.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_5268.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_5268.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
