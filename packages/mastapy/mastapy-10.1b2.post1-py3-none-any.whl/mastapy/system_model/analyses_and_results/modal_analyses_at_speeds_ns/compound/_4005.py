...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _3974
...
class CVTCompoundModalAnalysesAtSpeeds(_3974.BeltDriveCompoundModalAnalysesAtSpeeds):
    '''CVTCompoundModalAnalysesAtSpeeds
