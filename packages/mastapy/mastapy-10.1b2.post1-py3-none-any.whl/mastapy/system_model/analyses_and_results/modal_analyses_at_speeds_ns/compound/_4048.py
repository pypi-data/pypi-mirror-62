...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3928
...
class RollingRingConnectionCompoundModalAnalysesAtSpeeds(_4025.InterMountableComponentConnectionCompoundModalAnalysesAtSpeeds):
    '''RollingRingConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3928.RollingRingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3928.RollingRingConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_3928.RollingRingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_3928.RollingRingConnectionModalAnalysesAtSpeeds))
        return value
