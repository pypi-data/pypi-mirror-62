...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5307
...
class CVTCompoundModalAnalysesAtSpeeds(_5307.BeltDriveCompoundModalAnalysesAtSpeeds):
    '''CVTCompoundModalAnalysesAtSpeeds
