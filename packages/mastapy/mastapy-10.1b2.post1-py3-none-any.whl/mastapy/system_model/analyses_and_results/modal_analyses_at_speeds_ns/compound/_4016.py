...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3895
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4053
...
class FlexiblePinAssemblyCompoundModalAnalysesAtSpeeds(_4053.SpecialisedAssemblyCompoundModalAnalysesAtSpeeds):
    '''FlexiblePinAssemblyCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3895.FlexiblePinAssemblyModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3895.FlexiblePinAssemblyModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_3895.FlexiblePinAssemblyModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_3895.FlexiblePinAssemblyModalAnalysesAtSpeeds))
        return value
