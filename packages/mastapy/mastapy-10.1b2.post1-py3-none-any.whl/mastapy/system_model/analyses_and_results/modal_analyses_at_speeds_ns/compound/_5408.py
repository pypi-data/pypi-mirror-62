...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5290
...
class TorqueConverterTurbineCompoundModalAnalysesAtSpeeds(_5336.CouplingHalfCompoundModalAnalysesAtSpeeds):
    '''TorqueConverterTurbineCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5290.TorqueConverterTurbineModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5290.TorqueConverterTurbineModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_5290.TorqueConverterTurbineModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_5290.TorqueConverterTurbineModalAnalysesAtSpeeds))
        return value
