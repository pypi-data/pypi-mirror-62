...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5352
...
class ConicalGearSetCompoundModalAnalysesAtSpeeds(_5352.GearSetCompoundModalAnalysesAtSpeeds):
    '''ConicalGearSetCompoundModalAnalysesAtSpeeds
