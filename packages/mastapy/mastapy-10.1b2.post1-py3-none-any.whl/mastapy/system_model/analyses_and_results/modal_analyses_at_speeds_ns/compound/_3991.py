...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3868
...
class ConceptCouplingConnectionCompoundModalAnalysesAtSpeeds(_4002.CouplingConnectionCompoundModalAnalysesAtSpeeds):
    '''ConceptCouplingConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3868.ConceptCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3868.ConceptCouplingConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_3868.ConceptCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_3868.ConceptCouplingConnectionModalAnalysesAtSpeeds))
        return value
