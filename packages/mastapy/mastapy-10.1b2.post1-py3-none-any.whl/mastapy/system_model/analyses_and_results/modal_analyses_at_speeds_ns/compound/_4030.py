...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3908
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds(_4027.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysesAtSpeeds):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3908.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3908.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_3908.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_3908.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value
