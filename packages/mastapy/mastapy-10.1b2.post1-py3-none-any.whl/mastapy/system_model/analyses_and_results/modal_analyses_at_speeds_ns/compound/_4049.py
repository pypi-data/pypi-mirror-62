...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _3971
...
class RootAssemblyCompoundModalAnalysesAtSpeeds(_3971.AssemblyCompoundModalAnalysesAtSpeeds):
    '''RootAssemblyCompoundModalAnalysesAtSpeeds
