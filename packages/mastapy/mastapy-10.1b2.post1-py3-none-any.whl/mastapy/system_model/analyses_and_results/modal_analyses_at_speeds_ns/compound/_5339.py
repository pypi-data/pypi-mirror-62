...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5378
...
class CVTPulleyCompoundModalAnalysesAtSpeeds(_5378.PulleyCompoundModalAnalysesAtSpeeds):
    '''CVTPulleyCompoundModalAnalysesAtSpeeds
