...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5300
...
class ImportedFEComponentCompoundModalAnalysesAtSpeeds(_5300.AbstractShaftOrHousingCompoundModalAnalysesAtSpeeds):
    '''ImportedFEComponentCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5236.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5236.ImportedFEComponentModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_5236.ImportedFEComponentModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_5236.ImportedFEComponentModalAnalysesAtSpeeds))
        return value
