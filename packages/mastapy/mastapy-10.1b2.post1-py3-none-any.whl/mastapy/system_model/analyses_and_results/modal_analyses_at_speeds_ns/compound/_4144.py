...
class PartToPartShearCouplingConnectionCompoundModalAnalysesAtSpeeds(_4105.CouplingConnectionCompoundModalAnalysesAtSpeeds):
    '''PartToPartShearCouplingConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4021.PartToPartShearCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4021.PartToPartShearCouplingConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4021.PartToPartShearCouplingConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4021.PartToPartShearCouplingConnectionModalAnalysesAtSpeeds))
        return value
