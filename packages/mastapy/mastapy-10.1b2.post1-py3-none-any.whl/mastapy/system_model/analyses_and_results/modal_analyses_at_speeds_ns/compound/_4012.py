...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3891
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _3989
...
class ExternalCADModelCompoundModalAnalysesAtSpeeds(_3989.ComponentCompoundModalAnalysesAtSpeeds):
    '''ExternalCADModelCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3891.ExternalCADModelModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3891.ExternalCADModelModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_3891.ExternalCADModelModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_3891.ExternalCADModelModalAnalysesAtSpeeds))
        return value
