...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5274, _5180
...
class RootAssemblyModalAnalysesAtSpeeds(_5180.AssemblyModalAnalysesAtSpeeds):
    '''RootAssemblyModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds_inputs(self) -> '_5274.StabilityAnalysis':
        ...
        return constructor.new(_5274.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeedsInputs) if self.wrapped.ModalAnalysesAtSpeedsInputs else None
