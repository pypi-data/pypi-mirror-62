...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3941
...
class ConnectionModalAnalysesAtSpeeds(_6304.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_3941.StabilityAnalysis':
        ...
        return constructor.new(_3941.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
