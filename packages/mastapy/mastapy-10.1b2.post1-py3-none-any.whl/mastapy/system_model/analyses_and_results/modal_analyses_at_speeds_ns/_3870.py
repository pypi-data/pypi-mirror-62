...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3881
...
class ConceptCouplingModalAnalysesAtSpeeds(_3881.CouplingModalAnalysesAtSpeeds):
    '''ConceptCouplingModalAnalysesAtSpeeds
