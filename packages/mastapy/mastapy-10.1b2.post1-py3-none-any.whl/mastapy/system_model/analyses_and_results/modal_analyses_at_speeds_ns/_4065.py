...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4064, _4063, _3998
...
class WormGearSetModalAnalysesAtSpeeds(_3998.GearSetModalAnalysesAtSpeeds):
    '''WormGearSetModalAnalysesAtSpeeds
    ...
    @property
    def worm_gears_modal_analyses_at_speeds(self) -> 'List[_4064.WormGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtSpeeds, constructor.new(_4064.WormGearModalAnalysesAtSpeeds))
        return value

    @property
    def worm_meshes_modal_analyses_at_speeds(self) -> 'List[_4063.WormGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtSpeeds, constructor.new(_4063.WormGearMeshModalAnalysesAtSpeeds))
        return value
