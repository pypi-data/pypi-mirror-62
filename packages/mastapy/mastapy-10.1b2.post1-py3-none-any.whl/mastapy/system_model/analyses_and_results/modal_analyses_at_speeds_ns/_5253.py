...
class PartModalAnalysesAtSpeeds(_4592.PartStaticLoadAnalysisCase):
    '''PartModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_5274.StabilityAnalysis':
        ...
        return constructor.new(_5274.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
