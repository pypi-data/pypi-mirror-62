...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3854, _3853, _3860
...
class BevelDifferentialGearSetModalAnalysesAtSpeeds(_3860.BevelGearSetModalAnalysesAtSpeeds):
    '''BevelDifferentialGearSetModalAnalysesAtSpeeds
    ...
    @property
    def bevel_differential_gears_modal_analyses_at_speeds(self) -> 'List[_3854.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysesAtSpeeds, constructor.new(_3854.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value

    @property
    def bevel_differential_meshes_modal_analyses_at_speeds(self) -> 'List[_3853.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysesAtSpeeds, constructor.new(_3853.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value
