...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3878
...
class ShaftHubConnectionModalAnalysesAtSpeeds(_3878.ConnectorModalAnalysesAtSpeeds):
    '''ShaftHubConnectionModalAnalysesAtSpeeds
