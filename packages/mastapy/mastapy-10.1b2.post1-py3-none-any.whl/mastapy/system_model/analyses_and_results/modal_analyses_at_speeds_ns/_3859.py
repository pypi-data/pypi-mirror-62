...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3847
...
class BevelGearModalAnalysesAtSpeeds(_3847.AGMAGleasonConicalGearModalAnalysesAtSpeeds):
    '''BevelGearModalAnalysesAtSpeeds
