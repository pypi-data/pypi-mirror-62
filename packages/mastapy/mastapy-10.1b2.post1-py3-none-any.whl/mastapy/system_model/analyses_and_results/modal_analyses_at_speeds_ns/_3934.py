...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3844
...
class SpecialisedAssemblyModalAnalysesAtSpeeds(_3844.AbstractAssemblyModalAnalysesAtSpeeds):
    '''SpecialisedAssemblyModalAnalysesAtSpeeds
