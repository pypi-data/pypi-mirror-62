...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5179
...
class BevelGearSetModalAnalysesAtSpeeds(_5179.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''BevelGearSetModalAnalysesAtSpeeds
