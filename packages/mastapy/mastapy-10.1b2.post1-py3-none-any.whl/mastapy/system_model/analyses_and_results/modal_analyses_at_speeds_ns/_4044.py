...
class StabilityAnalysis(_6474.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def modal_analyses_at_speeds_options(self) -> '_4016.ModalAnalysesAtSpeedsOptions':
        ...
        return constructor.new(_4016.ModalAnalysesAtSpeedsOptions)(self.wrapped.ModalAnalysesAtSpeedsOptions) if self.wrapped.ModalAnalysesAtSpeedsOptions else None
