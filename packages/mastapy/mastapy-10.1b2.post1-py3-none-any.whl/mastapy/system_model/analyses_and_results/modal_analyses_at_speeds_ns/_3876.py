...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3898
...
class ConicalGearSetModalAnalysesAtSpeeds(_3898.GearSetModalAnalysesAtSpeeds):
    '''ConicalGearSetModalAnalysesAtSpeeds
