...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5205
...
class AGMAGleasonConicalGearMeshModalAnalysesAtSpeeds(_5205.ConicalGearMeshModalAnalysesAtSpeeds):
    '''AGMAGleasonConicalGearMeshModalAnalysesAtSpeeds
