...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3941, _3849
...
class RootAssemblyModalAnalysesAtSpeeds(_3849.AssemblyModalAnalysesAtSpeeds):
    '''RootAssemblyModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds_inputs(self) -> '_3941.StabilityAnalysis':
        ...
        return constructor.new(_3941.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeedsInputs) if self.wrapped.ModalAnalysesAtSpeedsInputs else None
