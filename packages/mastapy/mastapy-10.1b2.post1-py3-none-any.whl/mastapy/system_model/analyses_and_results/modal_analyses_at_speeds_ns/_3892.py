...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3896
...
class FaceGearMeshModalAnalysesAtSpeeds(_3896.GearMeshModalAnalysesAtSpeeds):
    '''FaceGearMeshModalAnalysesAtSpeeds
