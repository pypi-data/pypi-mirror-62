...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5276, _5275, _5191
...
class StraightBevelDiffGearSetModalAnalysesAtSpeeds(_5191.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelDiffGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_diff_gears_modal_analyses_at_speeds(self) -> 'List[_5276.StraightBevelDiffGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysesAtSpeeds, constructor.new(_5276.StraightBevelDiffGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analyses_at_speeds(self) -> 'List[_5275.StraightBevelDiffGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysesAtSpeeds, constructor.new(_5275.StraightBevelDiffGearMeshModalAnalysesAtSpeeds))
        return value
