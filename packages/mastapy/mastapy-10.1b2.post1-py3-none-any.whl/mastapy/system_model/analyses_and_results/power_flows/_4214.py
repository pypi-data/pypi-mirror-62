...
from mastapy.system_model.analyses_and_results.power_flows import _4213, _4151, _4192
...
class StraightBevelGearSetPowerFlow(_4192.BevelGearSetPowerFlow):
    '''StraightBevelGearSetPowerFlow
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4213.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsPowerFlow, constructor.new(_4213.StraightBevelGearPowerFlow))
        return value

    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4151.StraightBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesPowerFlow, constructor.new(_4151.StraightBevelGearMeshPowerFlow))
        return value
