...
from mastapy.system_model.analyses_and_results.power_flows import _4909
...
class PartPowerFlow(_4592.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
    ...
    @property
    def power_flow(self) -> '_4909.PowerFlow':
        ...
        return constructor.new(_4909.PowerFlow)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow else None
