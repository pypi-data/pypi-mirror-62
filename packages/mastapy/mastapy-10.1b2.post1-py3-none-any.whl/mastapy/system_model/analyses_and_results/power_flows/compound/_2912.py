...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2075, _4930, _2044, _2046,
    _4931
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3159
...
class RootAssemblyCompoundPowerFlow(_3159.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_2044.DesignState':
        ...
        if _2044.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_2044.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_2046.DutyCycle':
        ...
        if _2046.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_2046.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
