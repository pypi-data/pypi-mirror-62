...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3191
...
class CylindricalPlanetGearCompoundPowerFlow(_3191.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
