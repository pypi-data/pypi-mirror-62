...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3148
...
class BearingCompoundPowerFlow(_3148.ConnectorCompoundPowerFlow):
    '''BearingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4180.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4180.BearingPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4180.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4180.BearingPowerFlow))
        return value
