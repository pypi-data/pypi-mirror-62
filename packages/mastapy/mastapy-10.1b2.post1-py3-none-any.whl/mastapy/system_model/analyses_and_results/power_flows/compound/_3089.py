...
class ConceptCouplingCompoundPowerFlow(_3091.CouplingCompoundPowerFlow):
    '''ConceptCouplingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4170.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4170.ConceptCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4170.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4170.ConceptCouplingPowerFlow))
        return value
