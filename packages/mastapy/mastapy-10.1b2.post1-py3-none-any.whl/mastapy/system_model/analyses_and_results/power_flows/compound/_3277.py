...
from mastapy.system_model.analyses_and_results.power_flows import _3155
from mastapy.system_model.analyses_and_results.power_flows.compound import _3287
...
class CylindricalGearMeshCompoundPowerFlow(_3287.GearMeshCompoundPowerFlow):
    '''CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3155.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3155.CylindricalGearMeshPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3155.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3155.CylindricalGearMeshPowerFlow))
        return value
