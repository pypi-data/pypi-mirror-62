...
from mastapy.system_model.analyses_and_results.power_flows import _3164
...
class FlexiblePinAssemblyCompoundPowerFlow(_3322.SpecialisedAssemblyCompoundPowerFlow):
    '''FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3164.FlexiblePinAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3164.FlexiblePinAssemblyPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3164.FlexiblePinAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3164.FlexiblePinAssemblyPowerFlow))
        return value
