...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3051
...
class BevelGearSetCompoundPowerFlow(_3051.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
