...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2983
...
class BevelGearSetCompoundPowerFlow(_2983.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
