...
from mastapy.system_model.analyses_and_results.power_flows import _4277
from mastapy.system_model.analyses_and_results.power_flows.compound import _3056
...
class StraightBevelGearCompoundPowerFlow(_3056.BevelGearCompoundPowerFlow):
    '''StraightBevelGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4277.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4277.StraightBevelGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4277.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4277.StraightBevelGearPowerFlow))
        return value
