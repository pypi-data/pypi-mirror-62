...
class BoltedJointCompoundPowerFlow(_2974.SpecialisedAssemblyCompoundPowerFlow):
    '''BoltedJointCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4148.BoltedJointPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4148.BoltedJointPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4148.BoltedJointPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4148.BoltedJointPowerFlow))
        return value
