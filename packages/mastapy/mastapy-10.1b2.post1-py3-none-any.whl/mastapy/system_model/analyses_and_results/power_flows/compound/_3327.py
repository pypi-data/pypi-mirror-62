...
class BeltDriveCompoundPowerFlow(_3410.SpecialisedAssemblyCompoundPowerFlow):
    '''BeltDriveCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3202.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3202.BeltDrivePowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3202.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3202.BeltDrivePowerFlow))
        return value
