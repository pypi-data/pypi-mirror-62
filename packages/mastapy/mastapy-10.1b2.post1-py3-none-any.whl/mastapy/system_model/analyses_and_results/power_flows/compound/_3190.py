...
class ConicalGearSetCompoundPowerFlow(_3195.GearSetCompoundPowerFlow):
    '''ConicalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_417.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_417.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_417.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
