...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3060
...
class CylindricalPlanetGearCompoundPowerFlow(_3060.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
