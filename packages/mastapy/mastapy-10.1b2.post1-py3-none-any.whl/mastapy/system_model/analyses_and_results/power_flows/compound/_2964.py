...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2953
...
class ImportedFEComponentCompoundPowerFlow(_2953.AbstractShaftOrHousingCompoundPowerFlow):
    '''ImportedFEComponentCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4156.ImportedFEComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4156.ImportedFEComponentPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4156.ImportedFEComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4156.ImportedFEComponentPowerFlow))
        return value
