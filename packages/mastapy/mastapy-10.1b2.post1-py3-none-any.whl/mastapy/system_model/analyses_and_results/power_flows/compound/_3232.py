...
class SynchroniserCompoundPowerFlow(_3173.SpecialisedAssemblyCompoundPowerFlow):
    '''SynchroniserCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4118.SynchroniserPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4118.SynchroniserPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4118.SynchroniserPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4118.SynchroniserPowerFlow))
        return value
