...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2070, _1971, _1973, _4918
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3154
...
class RootAssemblyCompoundPowerFlow(_3154.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_1971.DesignState':
        ...
        return constructor.new(_1971.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_1973.DutyCycle':
        ...
        return constructor.new(_1973.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_4918.SubGroupInSingleDesignState':
        ...
        return constructor.new(_4918.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
