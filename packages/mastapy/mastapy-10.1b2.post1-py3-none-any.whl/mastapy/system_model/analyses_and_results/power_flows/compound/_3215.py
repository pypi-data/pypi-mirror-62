...
class ZerolBevelGearCompoundPowerFlow(_3187.BevelGearCompoundPowerFlow):
    '''ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4101.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4101.ZerolBevelGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4101.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4101.ZerolBevelGearPowerFlow))
        return value
