...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2101, _1970, _1968, _4916
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3090
...
class RootAssemblyCompoundPowerFlow(_3090.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_2101.AbstractStaticLoadCaseGroup':
        ...
        return constructor.new(_2101.AbstractStaticLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_4916.SubGroupInSingleDesignState':
        ...
        return constructor.new(_4916.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
