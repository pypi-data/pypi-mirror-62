...
from mastapy.system_model.analyses_and_results.power_flows import _3180
from mastapy.system_model.analyses_and_results.power_flows.compound import _3296
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow(_3296.KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3180.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3180.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3180.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3180.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow))
        return value
