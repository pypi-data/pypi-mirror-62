...
class BearingCompoundPowerFlow(_3158.ConnectorCompoundPowerFlow):
    '''BearingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4157.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4157.BearingPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4157.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4157.BearingPowerFlow))
        return value
