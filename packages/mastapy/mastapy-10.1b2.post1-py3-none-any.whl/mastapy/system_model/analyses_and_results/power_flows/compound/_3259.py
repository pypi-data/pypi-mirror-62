...
from mastapy.system_model.analyses_and_results.power_flows import _3139
from mastapy.system_model.analyses_and_results.power_flows.compound import _3270
...
class ConceptCouplingCompoundPowerFlow(_3270.CouplingCompoundPowerFlow):
    '''ConceptCouplingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3139.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3139.ConceptCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3139.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3139.ConceptCouplingPowerFlow))
        return value
