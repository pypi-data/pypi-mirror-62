...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3213, _3266, _3195
...
class WormGearSetCompoundPowerFlow(_3195.GearSetCompoundPowerFlow):
    '''WormGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_382.WormGearSetDutyCycleRating':
    ...
    @property
    def worm_gear_set_duty_cycle_rating(self) -> '_382.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_382.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDutyCycleRating) if self.wrapped.WormGearSetDutyCycleRating else None
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_3213.WormGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundPowerFlow, constructor.new(_3213.WormGearCompoundPowerFlow))
        return value

    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_3266.WormGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundPowerFlow, constructor.new(_3266.WormGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_4100.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4100.WormGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4100.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4100.WormGearSetPowerFlow))
        return value
