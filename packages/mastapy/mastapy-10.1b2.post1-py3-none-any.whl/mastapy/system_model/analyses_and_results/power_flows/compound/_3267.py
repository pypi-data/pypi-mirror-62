...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3288
...
class ConicalGearSetCompoundPowerFlow(_3288.GearSetCompoundPowerFlow):
    '''ConicalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_451.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_451.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_451.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
