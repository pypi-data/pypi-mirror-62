...
from mastapy.system_model.analyses_and_results.power_flows import _4247
...
class FaceGearCompoundPowerFlow(_3063.GearCompoundPowerFlow):
    '''FaceGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4247.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4247.FaceGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4247.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4247.FaceGearPowerFlow))
        return value
