...
from mastapy.system_model.analyses_and_results.power_flows import _4244
from mastapy.system_model.analyses_and_results.power_flows.compound import _3022
...
class ShaftCompoundPowerFlow(_3022.AbstractShaftOrHousingCompoundPowerFlow):
    '''ShaftCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4244.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4244.ShaftPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4244.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4244.ShaftPowerFlow))
        return value
