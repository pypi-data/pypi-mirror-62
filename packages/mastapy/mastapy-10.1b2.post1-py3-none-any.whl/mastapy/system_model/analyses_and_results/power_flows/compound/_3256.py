...
from mastapy.system_model.analyses_and_results.power_flows import _3133
...
class ClutchHalfCompoundPowerFlow(_3272.CouplingHalfCompoundPowerFlow):
    '''ClutchHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3133.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3133.ClutchHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3133.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3133.ClutchHalfPowerFlow))
        return value
