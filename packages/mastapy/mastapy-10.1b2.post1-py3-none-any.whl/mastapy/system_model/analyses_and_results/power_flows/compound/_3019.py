...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3023
...
class ClutchCompoundPowerFlow(_3023.CouplingCompoundPowerFlow):
    '''ClutchCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4093.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4093.ClutchPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4093.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4093.ClutchPowerFlow))
        return value
