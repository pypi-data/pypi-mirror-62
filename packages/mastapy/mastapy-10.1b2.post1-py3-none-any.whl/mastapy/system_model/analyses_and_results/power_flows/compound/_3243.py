...
from mastapy.system_model.analyses_and_results.power_flows import _3123
from mastapy.system_model.analyses_and_results.power_flows.compound import _3248
...
class BevelDifferentialGearCompoundPowerFlow(_3248.BevelGearCompoundPowerFlow):
    '''BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3123.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3123.BevelDifferentialGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3123.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3123.BevelDifferentialGearPowerFlow))
        return value
