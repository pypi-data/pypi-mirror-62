...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2069, _2034, _2036, _4927
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3153
...
class RootAssemblyCompoundPowerFlow(_3153.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_2069.AbstractStaticLoadCaseGroup':
        ...
        return constructor.new(_2069.AbstractStaticLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_4927.SubGroupInSingleDesignState':
        ...
        return constructor.new(_4927.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
