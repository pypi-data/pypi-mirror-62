...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3008
...
class StraightBevelPlanetGearCompoundPowerFlow(_3008.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
