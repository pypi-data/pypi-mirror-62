...
class SynchroniserSleeveCompoundPowerFlow(_3103.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4185.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4185.SynchroniserSleevePowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4185.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4185.SynchroniserSleevePowerFlow))
        return value
