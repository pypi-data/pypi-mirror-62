...
class WormGearCompoundPowerFlow(_2995.GearCompoundPowerFlow):
    '''WormGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_353.WormGearDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_353.WormGearDutyCycleRating':
        ...
        return constructor.new(_353.WormGearDutyCycleRating)(self.wrapped.WormGearDutyCycleRating) if self.wrapped.WormGearDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4206.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4206.WormGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4206.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4206.WormGearPowerFlow))
        return value
