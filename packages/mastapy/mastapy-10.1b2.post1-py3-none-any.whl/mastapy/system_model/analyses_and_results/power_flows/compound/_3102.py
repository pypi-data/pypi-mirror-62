...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3103
...
class SynchroniserHalfCompoundPowerFlow(_3103.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4183.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4183.SynchroniserHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4183.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4183.SynchroniserHalfPowerFlow))
        return value
