...
from mastapy.system_model.analyses_and_results.power_flows import _3170
from mastapy.system_model.analyses_and_results.power_flows.compound import _3236
...
class HypoidGearCompoundPowerFlow(_3236.AGMAGleasonConicalGearCompoundPowerFlow):
    '''HypoidGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3170.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3170.HypoidGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3170.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3170.HypoidGearPowerFlow))
        return value
