...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3177, _3253, _3195
...
class ConceptGearSetCompoundPowerFlow(_3195.GearSetCompoundPowerFlow):
    '''ConceptGearSetCompoundPowerFlow
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_3177.ConceptGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundPowerFlow, constructor.new(_3177.ConceptGearCompoundPowerFlow))
        return value

    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_3253.ConceptGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundPowerFlow, constructor.new(_3253.ConceptGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_4182.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4182.ConceptGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4182.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4182.ConceptGearSetPowerFlow))
        return value
