...
class TorqueConverterCompoundPowerFlow(_3091.CouplingCompoundPowerFlow):
    '''TorqueConverterCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4186.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4186.TorqueConverterPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4186.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4186.TorqueConverterPowerFlow))
        return value
