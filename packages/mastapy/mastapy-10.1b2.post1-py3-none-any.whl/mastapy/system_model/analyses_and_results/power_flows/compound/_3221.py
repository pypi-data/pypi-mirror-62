...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3223
...
class ConceptCouplingHalfCompoundPowerFlow(_3223.CouplingHalfCompoundPowerFlow):
    '''ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4107.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4107.ConceptCouplingHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4107.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4107.ConceptCouplingHalfPowerFlow))
        return value
