...
class RollingRingCompoundPowerFlow(_3223.CouplingHalfCompoundPowerFlow):
    '''RollingRingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4114.RollingRingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4114.RollingRingPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4114.RollingRingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4114.RollingRingPowerFlow))
        return value
