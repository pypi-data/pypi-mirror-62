...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3268
...
class InterMountableComponentConnectionCompoundPowerFlow(_3268.ConnectionCompoundPowerFlow):
    '''InterMountableComponentConnectionCompoundPowerFlow
