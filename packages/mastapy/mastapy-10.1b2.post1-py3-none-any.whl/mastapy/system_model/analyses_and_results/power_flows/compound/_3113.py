...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3115
...
class PlanetaryConnectionCompoundPowerFlow(_3115.ShaftToMountableComponentConnectionCompoundPowerFlow):
    '''PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4194.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4194.PlanetaryConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_4194.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_4194.PlanetaryConnectionPowerFlow))
        return value
