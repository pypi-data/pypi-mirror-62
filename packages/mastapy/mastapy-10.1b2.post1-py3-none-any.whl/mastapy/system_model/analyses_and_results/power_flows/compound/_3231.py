...
class SpringDamperHalfCompoundPowerFlow(_3223.CouplingHalfCompoundPowerFlow):
    '''SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4117.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4117.SpringDamperHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4117.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4117.SpringDamperHalfPowerFlow))
        return value
