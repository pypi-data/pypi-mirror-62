...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3353
...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_3353.ConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
