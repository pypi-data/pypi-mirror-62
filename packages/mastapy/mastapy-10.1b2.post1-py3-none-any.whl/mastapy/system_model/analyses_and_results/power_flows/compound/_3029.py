...
from mastapy.system_model.analyses_and_results.power_flows import _4227
from mastapy.system_model.analyses_and_results.power_flows.compound import _3026
...
class ExternalCADModelCompoundPowerFlow(_3026.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4227.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4227.ExternalCADModelPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4227.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4227.ExternalCADModelPowerFlow))
        return value
