...
from mastapy.system_model.analyses_and_results.power_flows import _3160
from mastapy.system_model.analyses_and_results.power_flows.compound import _3258
...
class ExternalCADModelCompoundPowerFlow(_3258.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3160.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3160.ExternalCADModelPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3160.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3160.ExternalCADModelPowerFlow))
        return value
