...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2995
...
class CylindricalGearCompoundPowerFlow(_2995.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_477.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_477.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_477.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4184.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4184.CylindricalGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4184.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4184.CylindricalGearPowerFlow))
        return value
