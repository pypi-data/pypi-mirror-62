...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3207
...
class StraightBevelPlanetGearCompoundPowerFlow(_3207.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
