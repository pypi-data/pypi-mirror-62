...
class MeasurementComponentCompoundPowerFlow(_3044.VirtualComponentCompoundPowerFlow):
    '''MeasurementComponentCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4233.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4233.MeasurementComponentPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4233.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4233.MeasurementComponentPowerFlow))
        return value
