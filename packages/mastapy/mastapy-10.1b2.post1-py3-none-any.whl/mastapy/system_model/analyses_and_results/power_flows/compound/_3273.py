...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3241
...
class CVTBeltConnectionCompoundPowerFlow(_3241.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
