...
class SynchroniserHalfCompoundPowerFlow(_3234.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4119.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4119.SynchroniserHalfPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4119.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4119.SynchroniserHalfPowerFlow))
        return value
