...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3021
...
class SpecialisedAssemblyCompoundPowerFlow(_3021.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
