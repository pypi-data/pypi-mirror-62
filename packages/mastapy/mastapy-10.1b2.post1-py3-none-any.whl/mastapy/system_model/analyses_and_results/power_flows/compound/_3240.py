...
from mastapy.system_model.analyses_and_results.power_flows import _3119
from mastapy.system_model.analyses_and_results.power_flows.compound import _3269
...
class BearingCompoundPowerFlow(_3269.ConnectorCompoundPowerFlow):
    '''BearingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3119.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3119.BearingPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3119.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3119.BearingPowerFlow))
        return value
