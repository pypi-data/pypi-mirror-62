...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3326
...
class CVTBeltConnectionCompoundPowerFlow(_3326.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
