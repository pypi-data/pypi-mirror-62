...
class MassDiscCompoundPowerFlow(_3044.VirtualComponentCompoundPowerFlow):
    '''MassDiscCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4232.MassDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4232.MassDiscPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4232.MassDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4232.MassDiscPowerFlow))
        return value
