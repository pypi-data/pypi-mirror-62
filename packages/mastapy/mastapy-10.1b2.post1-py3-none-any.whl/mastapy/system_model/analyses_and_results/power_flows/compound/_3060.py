...
from mastapy.system_model.analyses_and_results.power_flows import _4259
from mastapy.system_model.analyses_and_results.power_flows.compound import _3063
...
class CylindricalGearCompoundPowerFlow(_3063.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_481.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_481.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_481.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4259.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4259.CylindricalGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4259.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4259.CylindricalGearPowerFlow))
        return value
