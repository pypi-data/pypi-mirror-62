...
class BeltDriveCompoundPowerFlow(_3173.SpecialisedAssemblyCompoundPowerFlow):
    '''BeltDriveCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4103.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4103.BeltDrivePowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4103.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4103.BeltDrivePowerFlow))
        return value
