...
from mastapy.system_model.analyses_and_results.power_flows import _4242
from mastapy.system_model.analyses_and_results.power_flows.compound import _3044
...
class UnbalancedMassCompoundPowerFlow(_3044.VirtualComponentCompoundPowerFlow):
    '''UnbalancedMassCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4242.UnbalancedMassPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4242.UnbalancedMassPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4242.UnbalancedMassPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4242.UnbalancedMassPowerFlow))
        return value
