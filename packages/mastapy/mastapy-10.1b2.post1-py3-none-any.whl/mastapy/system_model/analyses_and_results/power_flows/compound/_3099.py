...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3091
...
class SpringDamperCompoundPowerFlow(_3091.CouplingCompoundPowerFlow):
    '''SpringDamperCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4180.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4180.SpringDamperPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4180.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4180.SpringDamperPowerFlow))
        return value
