...
from mastapy.system_model.analyses_and_results.power_flows import _3188
from mastapy.system_model.analyses_and_results.power_flows.compound import _3321
...
class PlanetaryConnectionCompoundPowerFlow(_3321.ShaftToMountableComponentConnectionCompoundPowerFlow):
    '''PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3188.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3188.PlanetaryConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_3188.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_3188.PlanetaryConnectionPowerFlow))
        return value
