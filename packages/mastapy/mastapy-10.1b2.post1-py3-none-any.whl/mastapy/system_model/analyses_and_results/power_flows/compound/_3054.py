...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3052
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3052.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
