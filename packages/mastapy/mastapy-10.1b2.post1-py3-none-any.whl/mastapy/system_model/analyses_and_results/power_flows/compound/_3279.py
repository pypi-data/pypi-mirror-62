...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3276
...
class CylindricalPlanetGearCompoundPowerFlow(_3276.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
