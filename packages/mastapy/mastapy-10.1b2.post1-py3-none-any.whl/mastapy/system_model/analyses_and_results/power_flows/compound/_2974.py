...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2952
...
class SpecialisedAssemblyCompoundPowerFlow(_2952.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
