...
from mastapy.system_model.analyses_and_results.power_flows import _4239
...
class PowerLoadCompoundPowerFlow(_3044.VirtualComponentCompoundPowerFlow):
    '''PowerLoadCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4239.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4239.PowerLoadPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4239.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4239.PowerLoadPowerFlow))
        return value
