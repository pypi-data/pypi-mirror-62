...
from mastapy.system_model.analyses_and_results.power_flows import _3168
...
class GuideDxfModelCompoundPowerFlow(_3258.ComponentCompoundPowerFlow):
    '''GuideDxfModelCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3168.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3168.GuideDxfModelPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3168.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3168.GuideDxfModelPowerFlow))
        return value
