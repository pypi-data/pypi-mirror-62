...
class TorqueConverterPumpCompoundPowerFlow(_3092.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4187.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4187.TorqueConverterPumpPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4187.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4187.TorqueConverterPumpPowerFlow))
        return value
