...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3181
...
class HypoidGearCompoundPowerFlow(_3181.AGMAGleasonConicalGearCompoundPowerFlow):
    '''HypoidGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4200.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4200.HypoidGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4200.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4200.HypoidGearPowerFlow))
        return value
