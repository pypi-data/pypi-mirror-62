...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3135
...
class StraightBevelPlanetGearCompoundPowerFlow(_3135.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
