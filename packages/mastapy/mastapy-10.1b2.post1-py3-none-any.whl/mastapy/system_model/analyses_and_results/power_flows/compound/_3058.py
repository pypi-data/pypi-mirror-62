...
class ConicalGearCompoundPowerFlow(_3063.GearCompoundPowerFlow):
    '''ConicalGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_550.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_550.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_550.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
