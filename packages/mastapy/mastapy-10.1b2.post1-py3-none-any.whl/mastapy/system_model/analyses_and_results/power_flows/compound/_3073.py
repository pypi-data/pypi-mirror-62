...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3061
...
class PlanetaryGearSetCompoundPowerFlow(_3061.CylindricalGearSetCompoundPowerFlow):
    '''PlanetaryGearSetCompoundPowerFlow
