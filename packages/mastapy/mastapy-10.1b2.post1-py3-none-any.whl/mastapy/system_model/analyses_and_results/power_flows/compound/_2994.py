...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2992
...
class CylindricalPlanetGearCompoundPowerFlow(_2992.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
