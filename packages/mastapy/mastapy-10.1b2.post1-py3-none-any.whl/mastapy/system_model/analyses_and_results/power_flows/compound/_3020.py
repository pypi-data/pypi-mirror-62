...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2075, _4925, _2041, _2043,
    _4926
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3031
...
class RootAssemblyCompoundPowerFlow(_3031.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_4925.AbstractDesignStateLoadCaseGroup':
        ...
        if _4925.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_4925.AbstractDesignStateLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_design_state(self) -> '_2041.DesignState':
        ...
        if _2041.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_2041.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_2043.DutyCycle':
        ...
        if _2043.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_2043.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_4926.SubGroupInSingleDesignState':
        ...
        if _4926.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_4926.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
