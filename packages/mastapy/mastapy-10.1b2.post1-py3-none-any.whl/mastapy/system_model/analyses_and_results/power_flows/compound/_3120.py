...
class TorqueConverterConnectionCompoundPowerFlow(_3118.CouplingConnectionCompoundPowerFlow):
    '''TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4201.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4201.TorqueConverterConnectionPowerFlow))
        return value

    @property
    def connection_power_flow_load_cases(self) -> 'List[_4201.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionPowerFlowLoadCases, constructor.new(_4201.TorqueConverterConnectionPowerFlow))
        return value
