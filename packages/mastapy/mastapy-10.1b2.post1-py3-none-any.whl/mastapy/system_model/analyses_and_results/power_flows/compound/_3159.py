...
class DatumCompoundPowerFlow(_3157.ComponentCompoundPowerFlow):
    '''DatumCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4162.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4162.DatumPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4162.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4162.DatumPowerFlow))
        return value
