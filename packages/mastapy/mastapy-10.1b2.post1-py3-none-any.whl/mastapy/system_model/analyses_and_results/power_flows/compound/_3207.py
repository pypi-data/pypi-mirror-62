...
from mastapy.system_model.analyses_and_results.power_flows import _4211
from mastapy.system_model.analyses_and_results.power_flows.compound import _3187
...
class StraightBevelDiffGearCompoundPowerFlow(_3187.BevelGearCompoundPowerFlow):
    '''StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4211.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4211.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4211.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4211.StraightBevelDiffGearPowerFlow))
        return value
