...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3238
...
class BevelGearSetCompoundPowerFlow(_3238.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
