...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3027
...
class ShaftHubConnectionCompoundPowerFlow(_3027.ConnectorCompoundPowerFlow):
    '''ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4177.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4177.ShaftHubConnectionPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4177.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4177.ShaftHubConnectionPowerFlow))
        return value
