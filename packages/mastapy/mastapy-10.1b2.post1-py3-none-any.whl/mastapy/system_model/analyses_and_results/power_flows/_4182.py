...
from mastapy.system_model.analyses_and_results.power_flows import _4181, _4139, _4199
...
class ConceptGearSetPowerFlow(_4199.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_4181.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_4181.ConceptGearPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_4139.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_4139.ConceptGearMeshPowerFlow))
        return value
