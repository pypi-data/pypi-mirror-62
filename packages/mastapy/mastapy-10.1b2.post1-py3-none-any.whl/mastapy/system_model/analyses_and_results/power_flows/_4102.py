...
from mastapy.system_model.analyses_and_results.power_flows import _4101, _4153, _4192
...
class ZerolBevelGearSetPowerFlow(_4192.BevelGearSetPowerFlow):
    '''ZerolBevelGearSetPowerFlow
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4101.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsPowerFlow, constructor.new(_4101.ZerolBevelGearPowerFlow))
        return value

    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4153.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesPowerFlow, constructor.new(_4153.ZerolBevelGearMeshPowerFlow))
        return value
