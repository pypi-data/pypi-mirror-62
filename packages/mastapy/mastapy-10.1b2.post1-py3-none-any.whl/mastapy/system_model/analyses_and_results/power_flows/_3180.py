...
class KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow(_3174.KlingelnbergCycloPalloidConicalGearMeshPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_334.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
