...
class ConceptGearMeshPowerFlow(_4154.GearMeshPowerFlow):
    '''ConceptGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_557.ConceptGearMeshRating':
        ...
        return constructor.new(_557.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
