...
class ConceptGearPowerFlow(_4262.GearPowerFlow):
    '''ConceptGearPowerFlow
    ...
    @property
    def component_detailed_analysis(self) -> '_556.ConceptGearRating':
        ...
        return constructor.new(_556.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
