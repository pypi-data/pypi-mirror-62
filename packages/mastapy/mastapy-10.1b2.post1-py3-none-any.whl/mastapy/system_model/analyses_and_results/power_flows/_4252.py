...
from mastapy.system_model.analyses_and_results.power_flows import _4251, _4202, _4256
...
class BevelDifferentialGearSetPowerFlow(_4256.BevelGearSetPowerFlow):
    '''BevelDifferentialGearSetPowerFlow
    ...
    @property
    def rating(self) -> '_400.BevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_400.BevelGearSetRating':
        ...
        return constructor.new(_400.BevelGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_set_rating(self) -> '_359.ZerolBevelGearSetRating':
        ...
        if _359.ZerolBevelGearSetRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_359.ZerolBevelGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_set_rating(self) -> '_386.StraightBevelGearSetRating':
        ...
        if _386.StraightBevelGearSetRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_set_rating(self) -> '_387.SpiralBevelGearSetRating':
        ...
        if _387.SpiralBevelGearSetRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_4251.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsPowerFlow, constructor.new(_4251.BevelDifferentialGearPowerFlow))
        return value

    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_4202.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesPowerFlow, constructor.new(_4202.BevelDifferentialGearMeshPowerFlow))
        return value
