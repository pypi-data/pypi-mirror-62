...
from mastapy.system_model.analyses_and_results.power_flows import _4910
...
class PartPowerFlow(_4721.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_738.SMTBitmap':
        ...
        return constructor.new(_738.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
    ...
    @property
    def power_flow(self) -> '_4910.PowerFlow':
        ...
        return constructor.new(_4910.PowerFlow)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow else None
