...
from mastapy.system_model.analyses_and_results.power_flows import _3132, _3150
...
class ClutchPowerFlow(_3150.CouplingPowerFlow):
    '''ClutchPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3132.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3132.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
