...
from mastapy.system_model.analyses_and_results.power_flows import _4204, _4148, _4203
...
class KlingelnbergCycloPalloidHypoidGearSetPowerFlow(_4203.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    '''KlingelnbergCycloPalloidHypoidGearSetPowerFlow
    ...
    @property
    def rating(self) -> '_410.KlingelnbergCycloPalloidHypoidGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_410.KlingelnbergCycloPalloidHypoidGearSetRating':
        ...
        return constructor.new(_410.KlingelnbergCycloPalloidHypoidGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_power_flow(self) -> 'List[_4204.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsPowerFlow, constructor.new(_4204.KlingelnbergCycloPalloidHypoidGearPowerFlow))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_power_flow(self) -> 'List[_4148.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesPowerFlow, constructor.new(_4148.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow))
        return value
