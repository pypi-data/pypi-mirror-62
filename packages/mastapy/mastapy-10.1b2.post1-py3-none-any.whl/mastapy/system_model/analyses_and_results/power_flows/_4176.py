...
from mastapy.system_model.analyses_and_results.power_flows import _4909, _4165
...
class RootAssemblyPowerFlow(_4165.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_4909.PowerFlow':
        ...
        return constructor.new(_4909.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
