...
class BevelDifferentialGearMeshPowerFlow(_4142.BevelGearMeshPowerFlow):
    '''BevelDifferentialGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_431.BevelGearMeshRating':
        ...
        return constructor.new(_431.BevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def rating_of_type_zerol_bevel_gear_mesh_rating(self) -> '_359.ZerolBevelGearMeshRating':
        ...
        if _359.ZerolBevelGearMeshRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
        ...
        return constructor.new(_359.ZerolBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def rating_of_type_straight_bevel_gear_mesh_rating(self) -> '_424.StraightBevelGearMeshRating':
        ...
        if _424.StraightBevelGearMeshRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
        ...
        return constructor.new(_424.StraightBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def rating_of_type_spiral_bevel_gear_mesh_rating(self) -> '_426.SpiralBevelGearMeshRating':
        ...
        if _426.SpiralBevelGearMeshRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
        ...
        return constructor.new(_426.SpiralBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
