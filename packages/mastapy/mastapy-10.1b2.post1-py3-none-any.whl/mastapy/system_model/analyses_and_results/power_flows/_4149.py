...
class KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow(_4147.KlingelnbergCycloPalloidConicalGearMeshPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_428.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_428.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
