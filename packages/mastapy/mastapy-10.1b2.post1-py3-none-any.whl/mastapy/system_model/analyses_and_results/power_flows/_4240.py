...
from mastapy.system_model.analyses_and_results.power_flows import _4910, _4229
...
class RootAssemblyPowerFlow(_4229.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_4910.PowerFlow':
        ...
        return constructor.new(_4910.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
