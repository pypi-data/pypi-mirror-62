...
from mastapy.system_model.analyses_and_results.power_flows import _4090, _4142, _4181
...
class ZerolBevelGearSetPowerFlow(_4181.BevelGearSetPowerFlow):
    '''ZerolBevelGearSetPowerFlow
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4090.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsPowerFlow, constructor.new(_4090.ZerolBevelGearPowerFlow))
        return value
    ...
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4142.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesPowerFlow, constructor.new(_4142.ZerolBevelGearMeshPowerFlow))
        return value
