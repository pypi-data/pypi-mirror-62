...
class ShaftHubConnectionPowerFlow(_4161.ConnectorPowerFlow):
    '''ShaftHubConnectionPowerFlow
    ...
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1162.AGMA6123SplineJointRating':
        ...
        if _1162.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1164.DIN5466SplineRating':
        ...
        if _1164.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1166.GBT17855SplineJointRating':
        ...
        if _1166.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1168.SAESplineJointRating':
        ...
        if _1168.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1170.SplineJointRating':
        ...
        if _1170.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1170.SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
    ...
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1180.KeywayRating':
        ...
        if _1180.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1187.InterferenceFitRating':
        ...
        if _1187.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
