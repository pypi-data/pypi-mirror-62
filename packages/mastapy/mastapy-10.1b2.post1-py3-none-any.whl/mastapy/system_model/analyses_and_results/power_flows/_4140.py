...
class FaceGearMeshPowerFlow(_4154.GearMeshPowerFlow):
    '''FaceGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_478.FaceGearMeshRating':
        ...
        return constructor.new(_478.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
