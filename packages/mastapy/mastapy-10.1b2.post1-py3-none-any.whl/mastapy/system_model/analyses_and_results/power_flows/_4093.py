...
from mastapy.system_model.analyses_and_results.power_flows import _4122, _4097
...
class ClutchPowerFlow(_4097.CouplingPowerFlow):
    '''ClutchPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_4122.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_4122.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
