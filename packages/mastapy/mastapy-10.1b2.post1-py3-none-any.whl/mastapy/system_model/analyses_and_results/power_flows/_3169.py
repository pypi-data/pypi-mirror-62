...
from mastapy.system_model.analyses_and_results.power_flows import _3115
...
class HypoidGearMeshPowerFlow(_3115.AGMAGleasonConicalGearMeshPowerFlow):
    '''HypoidGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_367.HypoidGearMeshRating':
