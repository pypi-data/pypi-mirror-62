...
from mastapy.system_model.analyses_and_results.power_flows import _4217, _4152, _4199
...
class WormGearSetPowerFlow(_4199.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4217.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_4217.WormGearPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_4152.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_4152.WormGearMeshPowerFlow))
        return value
