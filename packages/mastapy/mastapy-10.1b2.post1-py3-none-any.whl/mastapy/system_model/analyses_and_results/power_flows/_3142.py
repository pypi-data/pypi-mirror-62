...
from mastapy.system_model.analyses_and_results.power_flows import _3141, _3140, _3167
...
class ConceptGearSetPowerFlow(_3167.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_3141.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_3141.ConceptGearPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_3140.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_3140.ConceptGearMeshPowerFlow))
        return value
