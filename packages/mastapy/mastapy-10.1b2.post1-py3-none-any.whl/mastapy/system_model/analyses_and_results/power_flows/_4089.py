...
from mastapy.system_model.analyses_and_results.power_flows import _4206, _4141, _4188
...
class WormGearSetPowerFlow(_4188.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4206.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_4206.WormGearPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_4141.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_4141.WormGearMeshPowerFlow))
        return value
