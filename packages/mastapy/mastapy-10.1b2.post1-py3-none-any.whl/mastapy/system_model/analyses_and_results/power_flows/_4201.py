...
from mastapy.system_model.analyses_and_results.power_flows import _4200, _4146, _4186
...
class HypoidGearSetPowerFlow(_4186.AGMAGleasonConicalGearSetPowerFlow):
    '''HypoidGearSetPowerFlow
    ...
    @property
    def hypoid_gears_power_flow(self) -> 'List[_4200.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsPowerFlow, constructor.new(_4200.HypoidGearPowerFlow))
        return value

    @property
    def hypoid_meshes_power_flow(self) -> 'List[_4146.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesPowerFlow, constructor.new(_4146.HypoidGearMeshPowerFlow))
        return value
