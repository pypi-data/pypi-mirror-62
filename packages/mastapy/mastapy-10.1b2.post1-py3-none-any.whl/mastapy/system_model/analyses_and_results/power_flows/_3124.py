...
from mastapy.system_model.analyses_and_results.power_flows import _3123, _3122, _3129
...
class BevelDifferentialGearSetPowerFlow(_3129.BevelGearSetPowerFlow):
    '''BevelDifferentialGearSetPowerFlow
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3123.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsPowerFlow, constructor.new(_3123.BevelDifferentialGearPowerFlow))
        return value

    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3122.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesPowerFlow, constructor.new(_3122.BevelDifferentialGearMeshPowerFlow))
        return value
