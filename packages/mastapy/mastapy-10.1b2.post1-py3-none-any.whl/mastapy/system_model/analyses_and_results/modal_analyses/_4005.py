...
class UnbalancedMassModalAnalysis(_4006.VirtualComponentModalAnalysis):
    '''UnbalancedMassModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2312.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2312.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
