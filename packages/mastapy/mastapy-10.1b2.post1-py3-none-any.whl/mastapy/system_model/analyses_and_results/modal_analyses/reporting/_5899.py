...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5902
...
class CalculateFullFEResultsForMode(_1.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_5902.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_5902.ModalCMSResultsForModeAndFE))
        return value
