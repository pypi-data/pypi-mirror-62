...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5909
...
class CalculateFullFEResultsForMode(_1.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_5909.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_5909.ModalCMSResultsForModeAndFE))
        return value
