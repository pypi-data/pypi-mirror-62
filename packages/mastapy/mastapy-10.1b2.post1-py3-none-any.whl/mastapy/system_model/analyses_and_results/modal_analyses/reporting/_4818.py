...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4813
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_1.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4813.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4813.ComponentPerModeResult))
        return value
