...
class PerModeResultsReport(_63.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_60.TableAndChartOptions':
    ...
    def display_option(self, value: '_60.TableAndChartOptions'):
