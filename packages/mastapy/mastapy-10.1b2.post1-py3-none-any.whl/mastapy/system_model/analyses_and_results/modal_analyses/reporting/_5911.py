...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5907
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_1.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_5907.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_5907.ComponentPerModeResult))
        return value
