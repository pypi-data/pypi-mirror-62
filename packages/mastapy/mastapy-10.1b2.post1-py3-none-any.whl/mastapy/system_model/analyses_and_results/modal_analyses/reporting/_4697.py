...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4692
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_1.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4692.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4692.ComponentPerModeResult))
        return value
