...
class CalculateFullFEResultsForMode(_1.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4694.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4694.ModalCMSResultsForModeAndFE))
        return value
