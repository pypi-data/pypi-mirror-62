...
from mastapy.utility.report import _47
...
class PerModeResultsReport(_47.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_45.TableAndChartOptions':
    ...
    def display_option(self, value: '_45.TableAndChartOptions'):
