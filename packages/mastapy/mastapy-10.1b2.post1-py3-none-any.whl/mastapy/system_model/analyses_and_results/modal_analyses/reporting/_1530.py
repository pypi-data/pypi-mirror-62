...
from mastapy.utility.enums import _44
...
class PerModeResultsReport(_46.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_44.TableAndChartOptions':
        ...
        return constructor.new(_44.TableAndChartOptions)(value) if value else None

    @display_option.setter
    def display_option(self, value: '_44.TableAndChartOptions'):
