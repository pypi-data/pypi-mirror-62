...
from mastapy.utility.modal_analysis import _1430
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results import _2120
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2120.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1430.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1430.DesignEntityExcitationDescription))
        return value
