...
class ModalCMSResultsForModeAndFE(_1.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_1475.ModalCMSResults':
        ...
        return constructor.new(_1475.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
