...
class ModalCMSResultsForModeAndFE(_1.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_223.ModalCMSResults':
        ...
        return constructor.new(_223.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
