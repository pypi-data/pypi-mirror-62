...
class PerModeResultsReport(_1382.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1436.TableAndChartOptions':
    ...
    def display_option(self, value: '_1436.TableAndChartOptions'):
