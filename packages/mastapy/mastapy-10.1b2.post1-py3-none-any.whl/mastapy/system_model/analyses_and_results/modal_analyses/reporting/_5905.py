...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5908
...
class CalculateFullFEResultsForMode(_1.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_5908.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_5908.ModalCMSResultsForModeAndFE))
        return value
