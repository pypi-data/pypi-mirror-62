...
class ModalCMSResultsForModeAndFE(_1.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_183.ModalCMSResults':
        ...
        return constructor.new(_183.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
