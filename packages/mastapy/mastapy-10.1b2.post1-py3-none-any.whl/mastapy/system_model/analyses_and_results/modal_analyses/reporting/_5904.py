...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_1.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_5900.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_5900.ComponentPerModeResult))
        return value
