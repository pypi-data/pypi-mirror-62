...
class PerModeResultsReport(_58.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_57.TableAndChartOptions':
    ...
    def display_option(self, value: '_57.TableAndChartOptions'):
