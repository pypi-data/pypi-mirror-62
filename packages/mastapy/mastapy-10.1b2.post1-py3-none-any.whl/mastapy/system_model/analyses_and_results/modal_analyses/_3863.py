...
from mastapy.system_model.analyses_and_results.modal_analyses import _3980, _3915, _3962
...
class WormGearSetModalAnalysis(_3962.GearSetModalAnalysis):
    '''WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_3980.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_3980.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_3915.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_3915.WormGearMeshModalAnalysis))
        return value
