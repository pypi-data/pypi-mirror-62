...
class StraightBevelGearModalAnalysis(_4018.BevelGearModalAnalysis):
    '''StraightBevelGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2370.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2370.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
