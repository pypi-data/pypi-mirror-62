...
from mastapy.system_model.analyses_and_results.modal_analyses import _3972, _3913, _3955
...
class SpiralBevelGearSetModalAnalysis(_3955.BevelGearSetModalAnalysis):
    '''SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_3972.SpiralBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysis, constructor.new(_3972.SpiralBevelGearModalAnalysis))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_3913.SpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysis, constructor.new(_3913.SpiralBevelGearMeshModalAnalysis))
        return value
