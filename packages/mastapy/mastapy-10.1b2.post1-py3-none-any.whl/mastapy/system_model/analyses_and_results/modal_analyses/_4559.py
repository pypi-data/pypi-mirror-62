...
from mastapy.system_model.analyses_and_results.modal_analyses import _4582, _4612, _4639
...
class AbstractAssemblyModalAnalysis(_4639.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4582.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4582.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4612.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4612.GearMeshModalAnalysis))
        return value
