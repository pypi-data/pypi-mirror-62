...
class StraightBevelSunGearModalAnalysis(_4038.StraightBevelDiffGearModalAnalysis):
    '''StraightBevelSunGearModalAnalysis
    ...
    @property
    def component_design(self) -> '_2019.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2376.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2376.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
