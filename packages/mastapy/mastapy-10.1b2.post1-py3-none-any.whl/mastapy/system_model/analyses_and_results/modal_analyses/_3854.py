...
class WormGearSetModalAnalysis(_3953.GearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2266.WormGearSetSystemDeflection':
        ...
        return constructor.new(_2266.WormGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
