...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5914, _5911, _5913
...
class PartModalAnalysis(_4721.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_5894.ModalAnalysis':
        ...
        return constructor.new(_5894.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None
    ...
    @property
    def shaft_excitation_details(self) -> 'List[_5911.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_5911.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_5911.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_5911.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_5913.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_5913.SingleExcitationResultsModalAnalysis))
        return value
