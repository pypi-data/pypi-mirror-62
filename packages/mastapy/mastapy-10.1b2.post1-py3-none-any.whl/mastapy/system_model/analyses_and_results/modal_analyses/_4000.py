...
from mastapy.system_model.analyses_and_results.modal_analyses import _3997
...
class PlanetCarrierModalAnalysis(_3997.MountableComponentModalAnalysis):
    '''PlanetCarrierModalAnalysis
    ...
    @property
    def component_load_case(self) -> '_2303.PlanetCarrierLoadCase':
        ...
        return constructor.new(_2303.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2302.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2302.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
