...
class ModalAnalysisBarModelFEExportOptions(_1.APIBase):
    ...
    @property
    def mode_options(self) -> '_178.EigenvalueOptions':
        ...
        return constructor.new(_178.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
