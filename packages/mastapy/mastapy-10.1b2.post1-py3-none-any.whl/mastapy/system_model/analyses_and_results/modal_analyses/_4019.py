...
from mastapy.system_model.analyses_and_results.modal_analyses import _4013
...
class BevelGearSetModalAnalysis(_4013.AGMAGleasonConicalGearSetModalAnalysis):
    '''BevelGearSetModalAnalysis
