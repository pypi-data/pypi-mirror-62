...
from mastapy.system_model.analyses_and_results.modal_analyses import _3958, _3908, _3962
...
class CylindricalGearSetModalAnalysis(_3962.GearSetModalAnalysis):
    '''CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_3958.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysis, constructor.new(_3958.CylindricalGearModalAnalysis))
        return value

    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_3908.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysis, constructor.new(_3908.CylindricalGearMeshModalAnalysis))
        return value
