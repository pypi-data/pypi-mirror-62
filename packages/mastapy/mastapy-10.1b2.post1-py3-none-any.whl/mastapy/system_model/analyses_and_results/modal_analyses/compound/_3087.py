...
from mastapy.system_model.analyses_and_results.modal_analyses import _3974
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3067
...
class StraightBevelDiffGearCompoundModalAnalysis(_3067.BevelGearCompoundModalAnalysis):
    '''StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3974.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3974.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3974.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3974.StraightBevelDiffGearModalAnalysis))
        return value
