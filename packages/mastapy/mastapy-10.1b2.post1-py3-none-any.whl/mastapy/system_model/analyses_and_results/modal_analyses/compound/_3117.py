...
class TorqueConverterPumpCompoundModalAnalysis(_3103.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3886.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3886.TorqueConverterPumpModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3886.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3886.TorqueConverterPumpModalAnalysis))
        return value
