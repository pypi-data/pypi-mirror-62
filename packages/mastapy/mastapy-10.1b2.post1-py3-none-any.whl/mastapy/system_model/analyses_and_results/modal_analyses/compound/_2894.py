...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2890
...
class StraightBevelPlanetGearCompoundModalAnalysis(_2890.StraightBevelDiffGearCompoundModalAnalysis):
    '''StraightBevelPlanetGearCompoundModalAnalysis
