...
from mastapy.system_model.analyses_and_results.modal_analyses import _3986
...
class BoltedJointCompoundModalAnalysis(_2924.SpecialisedAssemblyCompoundModalAnalysis):
    '''BoltedJointCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3986.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3986.BoltedJointModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3986.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3986.BoltedJointModalAnalysis))
        return value
