...
class BoltedJointCompoundModalAnalysis(_4789.SpecialisedAssemblyCompoundModalAnalysis):
    '''BoltedJointCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4576.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4576.BoltedJointModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4576.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4576.BoltedJointModalAnalysis))
        return value
