...
from mastapy.system_model.analyses_and_results.modal_analyses import _3990
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2907
...
class ExternalCADModelCompoundModalAnalysis(_2907.ComponentCompoundModalAnalysis):
    '''ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3990.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3990.ExternalCADModelModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3990.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3990.ExternalCADModelModalAnalysis))
        return value
