...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3041
...
class AbstractAssemblyCompoundModalAnalysis(_3041.PartCompoundModalAnalysis):
    '''AbstractAssemblyCompoundModalAnalysis
