...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3075
...
class ConicalGearSetCompoundModalAnalysis(_3075.GearSetCompoundModalAnalysis):
    '''ConicalGearSetCompoundModalAnalysis
