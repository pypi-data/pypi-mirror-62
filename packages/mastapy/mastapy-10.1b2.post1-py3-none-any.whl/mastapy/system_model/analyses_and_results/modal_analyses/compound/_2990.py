...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2991
...
class CVTBeltConnectionCompoundModalAnalysis(_2991.BeltConnectionCompoundModalAnalysis):
    '''CVTBeltConnectionCompoundModalAnalysis
