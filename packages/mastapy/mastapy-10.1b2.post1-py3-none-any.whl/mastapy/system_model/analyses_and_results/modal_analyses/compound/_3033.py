...
class BearingCompoundModalAnalysis(_3037.ConnectorCompoundModalAnalysis):
    '''BearingCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3920.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3920.BearingModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3920.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3920.BearingModalAnalysis))
        return value
