...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2912
...
class RootAssemblyCompoundModalAnalysis(_2912.AssemblyCompoundModalAnalysis):
    '''RootAssemblyCompoundModalAnalysis
