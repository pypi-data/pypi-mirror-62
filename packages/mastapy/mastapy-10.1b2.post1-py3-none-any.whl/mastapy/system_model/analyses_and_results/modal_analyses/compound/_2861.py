...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2860, _2936, _2878
...
class ConceptGearSetCompoundModalAnalysis(_2878.GearSetCompoundModalAnalysis):
    '''ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_2860.ConceptGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundModalAnalysis, constructor.new(_2860.ConceptGearCompoundModalAnalysis))
        return value

    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_2936.ConceptGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundModalAnalysis, constructor.new(_2936.ConceptGearMeshCompoundModalAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3935.ConceptGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3935.ConceptGearSetModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3935.ConceptGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3935.ConceptGearSetModalAnalysis))
        return value
