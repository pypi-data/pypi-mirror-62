...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2865
...
class BevelGearSetCompoundModalAnalysis(_2865.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    '''BevelGearSetCompoundModalAnalysis
