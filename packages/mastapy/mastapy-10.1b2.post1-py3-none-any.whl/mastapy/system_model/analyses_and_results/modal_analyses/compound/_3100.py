...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3102
...
class ConceptCouplingCompoundModalAnalysis(_3102.CouplingCompoundModalAnalysis):
    '''ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3869.ConceptCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3869.ConceptCouplingModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3869.ConceptCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3869.ConceptCouplingModalAnalysis))
        return value
