...
from mastapy.system_model.analyses_and_results.modal_analyses import _3810
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2856
...
class BeltDriveCompoundModalAnalysis(_2856.SpecialisedAssemblyCompoundModalAnalysis):
    '''BeltDriveCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3810.BeltDriveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3810.BeltDriveModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3810.BeltDriveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3810.BeltDriveModalAnalysis))
        return value
