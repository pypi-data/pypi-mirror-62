...
class TorqueConverterCompoundModalAnalysis(_3102.CouplingCompoundModalAnalysis):
    '''TorqueConverterCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3885.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3885.TorqueConverterModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3885.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3885.TorqueConverterModalAnalysis))
        return value
