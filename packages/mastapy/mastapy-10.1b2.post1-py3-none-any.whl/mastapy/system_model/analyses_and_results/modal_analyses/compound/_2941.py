...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2946
...
class ConicalGearSetCompoundModalAnalysis(_2946.GearSetCompoundModalAnalysis):
    '''ConicalGearSetCompoundModalAnalysis
