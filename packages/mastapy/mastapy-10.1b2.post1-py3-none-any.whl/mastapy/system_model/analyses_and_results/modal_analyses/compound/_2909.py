...
from mastapy.system_model.analyses_and_results.modal_analyses import _3989
...
class DatumCompoundModalAnalysis(_2907.ComponentCompoundModalAnalysis):
    '''DatumCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3989.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3989.DatumModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3989.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3989.DatumModalAnalysis))
        return value
