...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2878
...
class ConicalGearSetCompoundModalAnalysis(_2878.GearSetCompoundModalAnalysis):
    '''ConicalGearSetCompoundModalAnalysis
