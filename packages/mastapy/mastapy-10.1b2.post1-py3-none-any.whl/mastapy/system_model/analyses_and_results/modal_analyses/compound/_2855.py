...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2844
...
class RootAssemblyCompoundModalAnalysis(_2844.AssemblyCompoundModalAnalysis):
    '''RootAssemblyCompoundModalAnalysis
