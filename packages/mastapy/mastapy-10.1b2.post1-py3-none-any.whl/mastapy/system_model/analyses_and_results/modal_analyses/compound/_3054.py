...
class UnbalancedMassCompoundModalAnalysis(_3055.VirtualComponentCompoundModalAnalysis):
    '''UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3941.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3941.UnbalancedMassModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3941.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3941.UnbalancedMassModalAnalysis))
        return value
