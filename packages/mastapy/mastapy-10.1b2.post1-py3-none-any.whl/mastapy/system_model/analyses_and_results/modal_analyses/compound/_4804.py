...
class SynchroniserCompoundModalAnalysis(_4789.SpecialisedAssemblyCompoundModalAnalysis):
    '''SynchroniserCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4670.SynchroniserModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4670.SynchroniserModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4670.SynchroniserModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4670.SynchroniserModalAnalysis))
        return value
