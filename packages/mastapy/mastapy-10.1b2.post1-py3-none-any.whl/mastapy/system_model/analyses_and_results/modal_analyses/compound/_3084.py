...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3072
...
class PlanetaryGearSetCompoundModalAnalysis(_3072.CylindricalGearSetCompoundModalAnalysis):
    '''PlanetaryGearSetCompoundModalAnalysis
