...
from mastapy.system_model.analyses_and_results.modal_analyses import _4040
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2938
...
class StraightBevelGearCompoundModalAnalysis(_2938.BevelGearCompoundModalAnalysis):
    '''StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4040.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4040.StraightBevelGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4040.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4040.StraightBevelGearModalAnalysis))
        return value
