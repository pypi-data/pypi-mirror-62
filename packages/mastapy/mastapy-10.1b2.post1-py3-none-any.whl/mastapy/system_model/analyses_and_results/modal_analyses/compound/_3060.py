...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3059, _3134, _3075
from mastapy.system_model.analyses_and_results.modal_analyses import _3947
...
class FaceGearSetCompoundModalAnalysis(_3075.GearSetCompoundModalAnalysis):
    '''FaceGearSetCompoundModalAnalysis
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_3059.FaceGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundModalAnalysis, constructor.new(_3059.FaceGearCompoundModalAnalysis))
        return value

    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_3134.FaceGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundModalAnalysis, constructor.new(_3134.FaceGearMeshCompoundModalAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3947.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3947.FaceGearSetModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3947.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3947.FaceGearSetModalAnalysis))
        return value
