...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2877
...
class ConceptGearCompoundModalAnalysis(_2877.GearCompoundModalAnalysis):
    '''ConceptGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3934.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3934.ConceptGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3934.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3934.ConceptGearModalAnalysis))
        return value
