...
from mastapy.system_model.analyses_and_results.modal_analyses import _3817
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2905
...
class ClutchCompoundModalAnalysis(_2905.CouplingCompoundModalAnalysis):
    '''ClutchCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3817.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3817.ClutchModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3817.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3817.ClutchModalAnalysis))
        return value
