...
from mastapy.system_model.analyses_and_results.modal_analyses import _3996
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2926
...
class MeasurementComponentCompoundModalAnalysis(_2926.VirtualComponentCompoundModalAnalysis):
    '''MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3996.MeasurementComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3996.MeasurementComponentModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3996.MeasurementComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3996.MeasurementComponentModalAnalysis))
        return value
