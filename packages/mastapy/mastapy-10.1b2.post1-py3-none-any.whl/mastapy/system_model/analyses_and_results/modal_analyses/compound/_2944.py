...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2942
...
class CylindricalPlanetGearCompoundModalAnalysis(_2942.CylindricalGearCompoundModalAnalysis):
    '''CylindricalPlanetGearCompoundModalAnalysis
