...
class BoltCompoundModalAnalysis(_3036.ComponentCompoundModalAnalysis):
    '''BoltCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3921.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3921.BoltModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3921.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3921.BoltModalAnalysis))
        return value
