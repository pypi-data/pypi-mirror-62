...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3071, _3139, _3075
...
class CylindricalGearSetCompoundModalAnalysis(_3075.GearSetCompoundModalAnalysis):
    '''CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_3071.CylindricalGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundModalAnalysis, constructor.new(_3071.CylindricalGearCompoundModalAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_3139.CylindricalGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundModalAnalysis, constructor.new(_3139.CylindricalGearMeshCompoundModalAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3959.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3959.CylindricalGearSetModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3959.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3959.CylindricalGearSetModalAnalysis))
        return value
