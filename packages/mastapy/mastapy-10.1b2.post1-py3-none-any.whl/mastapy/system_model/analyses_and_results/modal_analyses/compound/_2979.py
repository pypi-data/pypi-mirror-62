...
class RollingRingCompoundModalAnalysis(_2974.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3941.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3941.RollingRingModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3941.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3941.RollingRingModalAnalysis))
        return value
