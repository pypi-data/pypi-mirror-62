...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4838
...
class StraightBevelDiffGearMeshCompoundModalAnalysis(_4838.BevelGearMeshCompoundModalAnalysis):
    '''StraightBevelDiffGearMeshCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4782.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4782.StraightBevelDiffGearMeshModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_4782.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_4782.StraightBevelDiffGearMeshModalAnalysis))
        return value
