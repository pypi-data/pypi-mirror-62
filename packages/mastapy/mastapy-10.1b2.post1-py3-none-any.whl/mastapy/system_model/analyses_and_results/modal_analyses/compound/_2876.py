...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2874
...
class CylindricalPlanetGearCompoundModalAnalysis(_2874.CylindricalGearCompoundModalAnalysis):
    '''CylindricalPlanetGearCompoundModalAnalysis
