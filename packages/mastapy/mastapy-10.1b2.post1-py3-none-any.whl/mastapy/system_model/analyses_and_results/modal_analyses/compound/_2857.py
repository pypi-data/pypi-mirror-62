...
from mastapy.system_model.analyses_and_results.modal_analyses import _3931
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2858
...
class UnbalancedMassCompoundModalAnalysis(_2858.VirtualComponentCompoundModalAnalysis):
    '''UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3931.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3931.UnbalancedMassModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3931.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3931.UnbalancedMassModalAnalysis))
        return value
