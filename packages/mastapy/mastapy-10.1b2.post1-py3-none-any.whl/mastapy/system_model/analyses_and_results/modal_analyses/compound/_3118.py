...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3103
...
class TorqueConverterTurbineCompoundModalAnalysis(_3103.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3887.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3887.TorqueConverterTurbineModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3887.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3887.TorqueConverterTurbineModalAnalysis))
        return value
