...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2839
...
class ExternalCADModelCompoundModalAnalysis(_2839.ComponentCompoundModalAnalysis):
    '''ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3916.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3916.ExternalCADModelModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3916.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3916.ExternalCADModelModalAnalysis))
        return value
