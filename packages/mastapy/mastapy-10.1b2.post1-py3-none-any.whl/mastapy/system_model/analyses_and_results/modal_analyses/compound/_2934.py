...
from mastapy.system_model.analyses_and_results.modal_analyses import _4014
...
class BevelDifferentialGearCompoundModalAnalysis(_2938.BevelGearCompoundModalAnalysis):
    '''BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4014.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4014.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4014.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4014.BevelDifferentialGearModalAnalysis))
        return value
