...
from mastapy.system_model.analyses_and_results.modal_analyses import _4002
...
class PowerLoadCompoundModalAnalysis(_2926.VirtualComponentCompoundModalAnalysis):
    '''PowerLoadCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4002.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4002.PowerLoadModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4002.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4002.PowerLoadModalAnalysis))
        return value
