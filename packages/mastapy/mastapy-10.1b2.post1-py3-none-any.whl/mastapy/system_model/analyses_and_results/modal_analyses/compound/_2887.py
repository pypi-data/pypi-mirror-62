...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2875
...
class PlanetaryGearSetCompoundModalAnalysis(_2875.CylindricalGearSetCompoundModalAnalysis):
    '''PlanetaryGearSetCompoundModalAnalysis
