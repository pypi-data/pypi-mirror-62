...
class CylindricalGearMeshCompoundModalAnalysis(_3148.GearMeshCompoundModalAnalysis):
    '''CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3908.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3908.CylindricalGearMeshModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_3908.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_3908.CylindricalGearMeshModalAnalysis))
        return value
