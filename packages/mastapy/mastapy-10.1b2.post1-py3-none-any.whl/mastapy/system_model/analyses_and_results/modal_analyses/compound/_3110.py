...
class SpringDamperCompoundModalAnalysis(_3102.CouplingCompoundModalAnalysis):
    '''SpringDamperCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3879.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3879.SpringDamperModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_3879.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_3879.SpringDamperModalAnalysis))
        return value
