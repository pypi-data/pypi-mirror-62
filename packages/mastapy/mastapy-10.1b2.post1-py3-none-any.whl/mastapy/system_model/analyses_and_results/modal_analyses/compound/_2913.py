...
from mastapy.system_model.analyses_and_results.modal_analyses import _3993
...
class GuideDxfModelCompoundModalAnalysis(_2907.ComponentCompoundModalAnalysis):
    '''GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3993.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3993.GuideDxfModelModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3993.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3993.GuideDxfModelModalAnalysis))
        return value
