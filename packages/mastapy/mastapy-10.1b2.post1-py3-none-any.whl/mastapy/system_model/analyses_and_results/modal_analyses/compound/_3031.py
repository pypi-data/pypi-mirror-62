...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3048
...
class AbstractAssemblyCompoundModalAnalysis(_3048.PartCompoundModalAnalysis):
    '''AbstractAssemblyCompoundModalAnalysis
