...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2837
...
class AbstractShaftOrHousingCompoundModalAnalysis(_2837.ComponentCompoundModalAnalysis):
    '''AbstractShaftOrHousingCompoundModalAnalysis
