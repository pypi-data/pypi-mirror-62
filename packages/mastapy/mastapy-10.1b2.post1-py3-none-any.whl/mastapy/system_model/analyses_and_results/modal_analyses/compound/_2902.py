...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2919
...
class AbstractAssemblyCompoundModalAnalysis(_2919.PartCompoundModalAnalysis):
    '''AbstractAssemblyCompoundModalAnalysis
