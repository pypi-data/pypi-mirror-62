...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3055
...
class MassDiscCompoundModalAnalysis(_3055.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3931.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3931.MassDiscModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_3931.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_3931.MassDiscModalAnalysis))
        return value
