...
from mastapy.system_model.analyses_and_results.modal_analyses import _4735, _4734, _4681
...
class HypoidGearSetModalAnalysis(_4681.AGMAGleasonConicalGearSetModalAnalysis):
    '''HypoidGearSetModalAnalysis
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4735.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4735.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4734.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4734.HypoidGearMeshModalAnalysis))
        return value
