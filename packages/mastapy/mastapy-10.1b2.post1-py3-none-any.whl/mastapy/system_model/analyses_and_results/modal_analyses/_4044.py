...
class WormGearModalAnalysis(_4025.GearModalAnalysis):
    '''WormGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2378.WormGearSystemDeflection':
        ...
        return constructor.new(_2378.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
