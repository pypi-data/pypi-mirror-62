...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5901
...
class ConnectionModalAnalysis(_3269.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_5895.ModalAnalysis':
        ...
        return constructor.new(_5895.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def excited_modes_summary(self) -> 'List[_5901.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_5901.SingleExcitationResultsModalAnalysis))
        return value
