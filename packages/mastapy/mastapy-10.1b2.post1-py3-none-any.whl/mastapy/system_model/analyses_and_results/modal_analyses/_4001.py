...
class PointLoadModalAnalysis(_4006.VirtualComponentModalAnalysis):
    '''PointLoadModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2304.PointLoadSystemDeflection':
        ...
        return constructor.new(_2304.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
