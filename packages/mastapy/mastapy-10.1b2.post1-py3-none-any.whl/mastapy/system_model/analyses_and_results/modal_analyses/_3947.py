...
from mastapy.system_model.analyses_and_results.modal_analyses import _3946, _3903, _3962
...
class FaceGearSetModalAnalysis(_3962.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_3946.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_3946.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_3903.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_3903.FaceGearMeshModalAnalysis))
        return value
