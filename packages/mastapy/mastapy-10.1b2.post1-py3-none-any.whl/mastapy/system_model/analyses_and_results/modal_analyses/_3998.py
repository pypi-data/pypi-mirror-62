...
from mastapy.system_model.analyses_and_results.modal_analyses import _3988
...
class OilSealModalAnalysis(_3988.ConnectorModalAnalysis):
    '''OilSealModalAnalysis
    ...
    @property
    def component_load_case(self) -> '_2299.OilSealLoadCase':
        ...
        return constructor.new(_2299.OilSealLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2298.OilSealSystemDeflection':
        ...
        return constructor.new(_2298.OilSealSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
