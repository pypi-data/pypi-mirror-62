...
class FlexiblePinAssemblyModalAnalysis(_4004.SpecialisedAssemblyModalAnalysis):
    '''FlexiblePinAssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2285.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2285.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
