...
class ModalAnalysisBarModelFEExportOptions(_1.APIBase):
    ...
    @property
    def mode_options(self) -> '_179.EigenvalueOptions':
        ...
        return constructor.new(_179.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
