...
from mastapy.nodal_analysis.component_mode_synthesis import _183
...
class ImportedFEComponentModalAnalysis(_4560.AbstractShaftOrHousingModalAnalysis):
    '''ImportedFEComponentModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_183.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_183.ModalCMSResults))
        return value
