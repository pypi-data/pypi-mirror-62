...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4701, _4698, _4700
...
class PartModalAnalysis(_6311.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4632.ModalAnalysis':
        ...
        return constructor.new(_4632.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def results_for_modes(self) -> 'List[_4701.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4701.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4698.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4698.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4698.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4698.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4700.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4700.SingleExcitationResultsModalAnalysis))
        return value
