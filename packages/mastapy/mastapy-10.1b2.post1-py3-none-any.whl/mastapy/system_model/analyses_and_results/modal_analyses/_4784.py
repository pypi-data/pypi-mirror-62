...
from mastapy.system_model.analyses_and_results.modal_analyses import _4783, _4782, _4693
...
class StraightBevelDiffGearSetModalAnalysis(_4693.BevelGearSetModalAnalysis):
    '''StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4783.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4783.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4782.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4782.StraightBevelDiffGearMeshModalAnalysis))
        return value
