...
from mastapy.system_model.analyses_and_results.modal_analyses import _4587, _4586, _4614
...
class ConceptGearSetModalAnalysis(_4614.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4587.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4587.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4586.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4586.ConceptGearMeshModalAnalysis))
        return value
