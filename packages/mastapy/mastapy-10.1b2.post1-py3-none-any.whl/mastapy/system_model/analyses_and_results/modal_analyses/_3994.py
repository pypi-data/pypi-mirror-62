...
from mastapy.system_model.analyses_and_results.modal_analyses import _3983
...
class ImportedFEComponentModalAnalysis(_3983.AbstractShaftOrHousingModalAnalysis):
    '''ImportedFEComponentModalAnalysis
    ...
    @property
    def component_load_case(self) -> '_2291.ImportedFEComponentLoadCase':
        ...
        return constructor.new(_2291.ImportedFEComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2290.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2290.ImportedFEComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_222.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_222.ModalCMSResults))
        return value
