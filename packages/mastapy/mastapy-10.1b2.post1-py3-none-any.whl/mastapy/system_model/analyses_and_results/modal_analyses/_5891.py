...
from mastapy.system_model.analyses_and_results.modal_analyses import _5887
...
class ModalAnalysisOptions(_1.APIBase):
    ...
    @property
    def frequency_response_options_for_reports(self) -> '_5887.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_5887.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports else None
