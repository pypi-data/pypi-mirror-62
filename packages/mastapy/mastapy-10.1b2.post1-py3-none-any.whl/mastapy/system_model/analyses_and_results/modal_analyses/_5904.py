...
from mastapy.system_model.analyses_and_results.modal_analyses import _5905
...
TMeasurement = TypeVar('TMeasurement', bound='_1071.MeasurementBase')


class WhineWaterfallReferenceValues(_5905.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
