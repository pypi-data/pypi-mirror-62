...
from mastapy.system_model.analyses_and_results.modal_analyses import _5894, _3992
...
class RootAssemblyModalAnalysis(_3992.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_5894.ModalAnalysis':
        ...
        return constructor.new(_5894.ModalAnalysis)(self.wrapped.ModalAnalysisInputs) if self.wrapped.ModalAnalysisInputs else None

    @property
    def system_deflection_results(self) -> '_2308.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2308.RootAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
