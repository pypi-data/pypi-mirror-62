...
class FaceGearModalAnalysis(_4025.GearModalAnalysis):
    '''FaceGearModalAnalysis
    ...
    @property
    def component_load_case(self) -> '_2320.FaceGearLoadCase':
        ...
        return constructor.new(_2320.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2319.FaceGearSystemDeflection':
        ...
        return constructor.new(_2319.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
