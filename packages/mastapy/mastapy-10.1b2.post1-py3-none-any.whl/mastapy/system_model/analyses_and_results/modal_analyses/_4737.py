...
from mastapy.nodal_analysis.component_mode_synthesis import _1475
...
class ImportedFEComponentModalAnalysis(_4678.AbstractShaftOrHousingModalAnalysis):
    '''ImportedFEComponentModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_1475.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_1475.ModalCMSResults))
        return value
