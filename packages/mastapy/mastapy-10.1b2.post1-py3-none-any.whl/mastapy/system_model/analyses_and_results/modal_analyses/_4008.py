...
from mastapy.system_model.analyses_and_results.system_deflections import _2175
...
class ConceptGearModalAnalysis(_4025.GearModalAnalysis):
    '''ConceptGearModalAnalysis
    ...
    @property
    def component_load_case(self) -> '_2317.ConceptGearLoadCase':
        ...
        return constructor.new(_2317.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2175.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2175.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
