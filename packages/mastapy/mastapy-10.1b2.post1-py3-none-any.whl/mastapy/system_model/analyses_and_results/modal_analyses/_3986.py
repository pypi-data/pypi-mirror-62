...
class BoltedJointModalAnalysis(_4004.SpecialisedAssemblyModalAnalysis):
    '''BoltedJointModalAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_2277.BoltedJointLoadCase':
        ...
        return constructor.new(_2277.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def system_deflection_results(self) -> '_2162.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2162.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
