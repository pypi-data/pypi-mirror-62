...
class TorqueConverterPumpModalAnalysis(_4596.CouplingHalfModalAnalysis):
    '''TorqueConverterPumpModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2251.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2251.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
