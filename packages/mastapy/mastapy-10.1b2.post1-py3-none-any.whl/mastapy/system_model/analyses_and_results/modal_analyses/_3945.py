...
from mastapy.system_model.analyses_and_results.modal_analyses import _3944, _3902, _3962
...
class ConceptGearSetModalAnalysis(_3962.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_3944.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_3944.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_3902.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_3902.ConceptGearMeshModalAnalysis))
        return value
