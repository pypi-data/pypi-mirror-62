...
class ModalAnalysisOptions(_1.APIBase):
    ...
    def frequency_response_options_for_reports(self) -> '_4611.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4611.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports else None
