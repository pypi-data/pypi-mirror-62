...
class MeasurementComponentModalAnalysis(_4006.VirtualComponentModalAnalysis):
    '''MeasurementComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2294.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2294.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
