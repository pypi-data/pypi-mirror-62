...
class ClutchHalfModalAnalysis(_3866.CouplingHalfModalAnalysis):
    '''ClutchHalfModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2159.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2159.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
