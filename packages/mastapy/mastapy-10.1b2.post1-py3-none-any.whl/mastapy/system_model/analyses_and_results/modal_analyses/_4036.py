...
class SpiralBevelGearModalAnalysis(_4018.BevelGearModalAnalysis):
    '''SpiralBevelGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2362.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2362.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
