...
from mastapy.system_model.analyses_and_results.modal_analyses import _5895, _3928
...
class RootAssemblyModalAnalysis(_3928.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_5895.ModalAnalysis':
        ...
        return constructor.new(_5895.ModalAnalysis)(self.wrapped.ModalAnalysisInputs) if self.wrapped.ModalAnalysisInputs else None
