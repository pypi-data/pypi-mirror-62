...
from mastapy.math_utility import (
    _1221, _1234, _1214, _1226,
    _1220, _1212, _1219, _1230
)
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _5893, _5903, _5902, _5899,
    _5904
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _6190, _6193, _6194
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6191, _6192
from mastapy.utility.units_and_measurements.measurements import (
    _1328, _1283, _1375, _1289,
    _1280, _1285, _1303, _1370,
    _1297, _1344
)
from mastapy.utility.property import _1459
...
class WhineWaterfallSettings(_1.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1234.TranslationRotation':
        ...
        return constructor.new(_1234.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1234.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_5893.CoordinateSystemForWhine':
        ...
        return constructor.new(_5893.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_5893.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_5903.WhineWaterfallExportOption':
        ...
        return constructor.new(_5903.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_5903.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_6190.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_6190.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_5902.WaterfallChartSettings':
        ...
        return constructor.new(_5902.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_5899.OrderCutsChartSettings':
        ...
        return constructor.new(_5899.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_6191.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_6191.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_6192.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_6192.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1328.LengthVeryShort]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1328.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1283.AngleSmall]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1283.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1375.VelocitySmall]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1375.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1289.AngularVelocity]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1289.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1280.Acceleration]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1280.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1285.AngularAcceleration]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1285.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1303.Force]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1303.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1370.Torque]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1370.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1297.Energy]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1297.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_5904.WhineWaterfallReferenceValues[_1344.PowerSmall]':
        ...
        return constructor.new(_5904.WhineWaterfallReferenceValues)[_1344.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_6193.ResultLocationSelectionGroups':
        ...
        return constructor.new(_6193.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_6194.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_6194.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1459.EnumWithBool[_1230.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1459.EnumWithBool)[_1230.ResultOptionsFor3DVector])
        return value
