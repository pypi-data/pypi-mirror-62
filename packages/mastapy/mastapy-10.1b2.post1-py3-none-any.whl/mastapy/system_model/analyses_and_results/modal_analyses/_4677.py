...
from mastapy.system_model.part_model.gears import (
    ...
    _2041, _2043, _2046, _2049,
    _2052, _2054, _2056, _2058,
    _2059, _2061, _2063, _2065,
    _2069, _2071
)
from mastapy.system_model.part_model.couplings import (
    _2089, _2091, _2094, _2096,
    _2098, _2100, _2109, _2111,
    _2113, _2118
)
from mastapy.system_model.analyses_and_results.modal_analyses import _4700, _4730, _4757
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2185, _2188, _2190, _2193,
    _2195, _2200, _2202, _2206,
    _2212, _2214, _2218, _2224,
    _2227, _2231, _2232, _2233,
    _2242, _2244, _2246, _2250,
    _2255, _2258, _2261, _2273,
    _2279, _2282, _2288, _2290,
    _2294, _2296, _2299, _2306,
    _2312, _2319, _2322
)
...
class AbstractAssemblyModalAnalysis(_4757.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def component_design(self) -> '_1959.AbstractAssembly':
    ...
    @property
    def assembly_design(self) -> '_1959.AbstractAssembly':
        ...
        return constructor.new(_1959.AbstractAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_assembly(self) -> '_1958.Assembly':
        ...
        if _1958.Assembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_bolted_joint(self) -> '_1966.BoltedJoint':
        ...
        if _1966.BoltedJoint.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_flexible_pin_assembly(self) -> '_1975.FlexiblePinAssembly':
        ...
        if _1975.FlexiblePinAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_root_assembly(self) -> '_1993.RootAssembly':
        ...
        if _1993.RootAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_1993.RootAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_specialised_assembly(self) -> '_1995.SpecialisedAssembly':
        ...
        if _1995.SpecialisedAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_1995.SpecialisedAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def assembly_design_of_type_gear_set(self) -> '_2049.GearSet':
        ...
        if _2049.GearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_belt_drive(self) -> '_2089.BeltDrive':
        ...
        if _2089.BeltDrive.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_coupling(self) -> '_2096.Coupling':
        ...
        if _2096.Coupling.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_cvt(self) -> '_2098.CVT':
        ...
        if _2098.CVT.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_rolling_ring_assembly(self) -> '_2109.RollingRingAssembly':
        ...
        if _2109.RollingRingAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_synchroniser(self) -> '_2113.Synchroniser':
        ...
        if _2113.Synchroniser.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2113.Synchroniser)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4700.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4700.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4730.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4730.GearMeshModalAnalysis))
        return value

    @property
    def system_deflection_results(self) -> '_2185.AbstractAssemblySystemDeflection':
