...
from mastapy.system_model.analyses_and_results.modal_analyses import _4025
...
class CylindricalGearModalAnalysis(_4025.GearModalAnalysis):
    '''CylindricalGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2385.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2385.CylindricalGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def system_deflection_results_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2386.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2386.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
        ...
        return constructor.new(_2386.CylindricalGearSystemDeflectionTimestep)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def system_deflection_results_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2335.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2335.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
        ...
        return constructor.new(_2335.CylindricalGearSystemDeflectionWithLTCAResults)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def system_deflection_results_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2339.CylindricalPlanetGearSystemDeflection':
        ...
        if _2339.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
        ...
        return constructor.new(_2339.CylindricalPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
