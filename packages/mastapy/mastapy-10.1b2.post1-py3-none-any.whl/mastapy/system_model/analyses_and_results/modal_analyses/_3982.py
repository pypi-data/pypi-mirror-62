...
from mastapy.system_model.part_model.gears import (
    ...
    _1993, _1995, _1998, _2001,
    _2004, _2006, _2008, _2010,
    _2011, _2013, _2015, _2017,
    _2021, _2023
)
from mastapy.system_model.part_model.couplings import (
    _2045, _2046, _2048, _2050,
    _2052, _2056, _2058, _2060,
    _2064
)
from mastapy.system_model.analyses_and_results.modal_analyses import _3987, _3981, _3999
...
class AbstractAssemblyModalAnalysis(_3999.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def assembly_design_of_type_conical_gear_set(self) -> '_1993.ConicalGearSet':
        ...
        if _1993.ConicalGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_1993.ConicalGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_cylindrical_gear_set(self) -> '_1995.CylindricalGearSet':
        ...
        if _1995.CylindricalGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_face_gear_set(self) -> '_1998.FaceGearSet':
        ...
        if _1998.FaceGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_gear_set(self) -> '_2001.GearSet':
        ...
        if _2001.GearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2001.GearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_hypoid_gear_set(self) -> '_2004.HypoidGearSet':
        ...
        if _2004.HypoidGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2006.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2006.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2006.KlingelnbergCycloPalloidConicalGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2008.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2008.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2010.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2010.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_planetary_gear_set(self) -> '_2011.PlanetaryGearSet':
        ...
        if _2011.PlanetaryGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2011.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def assembly_design_of_type_worm_gear_set(self) -> '_2021.WormGearSet':
        ...
        if _2021.WormGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_belt_drive(self) -> '_2045.BeltDrive':
        ...
        if _2045.BeltDrive.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
            raise CastException('Failed to cast assembly_design to BeltDrive. Expected: {}.'.format(self.wrapped.AssemblyDesign.__class__.__qualname__))

        return constructor.new(_2045.BeltDrive)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def assembly_design_of_type_coupling(self) -> '_2050.Coupling':
        ...
        if _2050.Coupling.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_cvt(self) -> '_2052.CVT':
        ...
        if _2052.CVT.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2052.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_rolling_ring_assembly(self) -> '_2056.RollingRingAssembly':
        ...
        if _2056.RollingRingAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2056.RollingRingAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def assembly_design_of_type_synchroniser(self) -> '_2060.Synchroniser':
        ...
        if _2060.Synchroniser.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
        ...
        return constructor.new(_2060.Synchroniser)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_3987.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_3987.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_3981.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_3981.GearMeshModalAnalysis))
        return value
