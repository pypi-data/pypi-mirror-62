...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2921
...
class ConicalGearSteadyStateSynchronousResponse(_2921.GearSteadyStateSynchronousResponse):
    '''ConicalGearSteadyStateSynchronousResponse
