...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2919
...
class FaceGearMeshSteadyStateSynchronousResponse(_2919.GearMeshSteadyStateSynchronousResponse):
    '''FaceGearMeshSteadyStateSynchronousResponse
