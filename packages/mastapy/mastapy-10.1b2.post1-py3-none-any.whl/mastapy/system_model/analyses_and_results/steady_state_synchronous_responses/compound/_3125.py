...
class ImportedFEComponentCompoundSteadyStateSynchronousResponse(_3068.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    '''ImportedFEComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3001.ImportedFEComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3001.ImportedFEComponentSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_3001.ImportedFEComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_3001.ImportedFEComponentSteadyStateSynchronousResponse))
        return value
