...
class StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse(_4798.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    '''StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4759.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4759.StraightBevelDiffGearMeshSteadyStateSynchronousResponse))
        return value

    @property
    def connection_steady_state_synchronous_response_load_cases(self) -> 'List[_4759.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseLoadCases, constructor.new(_4759.StraightBevelDiffGearMeshSteadyStateSynchronousResponse))
        return value
