...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _4774
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _4820
...
class TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(_4820.CouplingHalfCompoundSteadyStateSynchronousResponse):
    '''TorqueConverterTurbineCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4774.TorqueConverterTurbineSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4774.TorqueConverterTurbineSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_4774.TorqueConverterTurbineSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_4774.TorqueConverterTurbineSteadyStateSynchronousResponse))
        return value
