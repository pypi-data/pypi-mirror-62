...
class BeltDriveCompoundSteadyStateSynchronousResponse(_4868.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    '''BeltDriveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4670.BeltDriveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4670.BeltDriveSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_steady_state_synchronous_response_load_cases(self) -> 'List[_4670.BeltDriveSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseLoadCases, constructor.new(_4670.BeltDriveSteadyStateSynchronousResponse))
        return value
