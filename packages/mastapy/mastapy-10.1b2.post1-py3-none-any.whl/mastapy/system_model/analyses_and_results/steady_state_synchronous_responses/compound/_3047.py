...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2926
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2990
...
class ImportedFEComponentCompoundSteadyStateSynchronousResponse(_2990.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    '''ImportedFEComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2926.ImportedFEComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2926.ImportedFEComponentSteadyStateSynchronousResponse))
        return value

    @property
    def component_steady_state_synchronous_response_load_cases(self) -> 'List[_2926.ImportedFEComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseLoadCases, constructor.new(_2926.ImportedFEComponentSteadyStateSynchronousResponse))
        return value
