...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3036, _3034, _2957
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2957.BevelGearSetSteadyStateSynchronousResponse):
    '''SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3036.SpiralBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSteadyStateSynchronousResponse, constructor.new(_3036.SpiralBevelGearSteadyStateSynchronousResponse))
        return value
    ...
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3034.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3034.SpiralBevelGearMeshSteadyStateSynchronousResponse))
        return value
