...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3066, _3064, _2957
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2957.BevelGearSetSteadyStateSynchronousResponse):
    '''ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3066.ZerolBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSteadyStateSynchronousResponse, constructor.new(_3066.ZerolBevelGearSteadyStateSynchronousResponse))
        return value
    ...
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3064.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3064.ZerolBevelGearMeshSteadyStateSynchronousResponse))
        return value
