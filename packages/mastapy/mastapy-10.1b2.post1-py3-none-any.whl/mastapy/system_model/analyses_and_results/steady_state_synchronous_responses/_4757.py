...
class SteadyStateSynchronousResponse(_4872.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3150.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3150.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
