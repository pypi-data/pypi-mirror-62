...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2901
...
class BearingSteadyStateSynchronousResponse(_2901.ConnectorSteadyStateSynchronousResponse):
    '''BearingSteadyStateSynchronousResponse
