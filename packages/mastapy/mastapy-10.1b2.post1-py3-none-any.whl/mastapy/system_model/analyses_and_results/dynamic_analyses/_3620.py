...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3737, _3672, _3719
...
class WormGearSetDynamicAnalysis(_3719.GearSetDynamicAnalysis):
    '''WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_3737.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsDynamicAnalysis, constructor.new(_3737.WormGearDynamicAnalysis))
        return value

    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_3672.WormGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesDynamicAnalysis, constructor.new(_3672.WormGearMeshDynamicAnalysis))
        return value
