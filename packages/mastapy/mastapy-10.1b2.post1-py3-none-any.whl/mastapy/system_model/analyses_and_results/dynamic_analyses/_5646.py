...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5634
...
class BevelGearMeshDynamicAnalysis(_5634.AGMAGleasonConicalGearMeshDynamicAnalysis):
    '''BevelGearMeshDynamicAnalysis
