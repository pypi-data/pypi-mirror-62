...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5777
...
class BevelGearSetDynamicAnalysis(_5777.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''BevelGearSetDynamicAnalysis
