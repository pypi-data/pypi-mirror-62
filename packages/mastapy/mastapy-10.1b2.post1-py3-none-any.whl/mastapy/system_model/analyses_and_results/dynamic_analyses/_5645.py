...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5633
...
class BevelGearDynamicAnalysis(_5633.AGMAGleasonConicalGearDynamicAnalysis):
    '''BevelGearDynamicAnalysis
