...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5804
...
class ConicalGearSetCompoundDynamicAnalysis(_5804.GearSetCompoundDynamicAnalysis):
    '''ConicalGearSetCompoundDynamicAnalysis
