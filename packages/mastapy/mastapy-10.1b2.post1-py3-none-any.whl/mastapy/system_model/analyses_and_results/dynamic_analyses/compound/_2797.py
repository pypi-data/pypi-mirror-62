...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2790
...
class CVTCompoundDynamicAnalysis(_2790.BeltDriveCompoundDynamicAnalysis):
    '''CVTCompoundDynamicAnalysis
