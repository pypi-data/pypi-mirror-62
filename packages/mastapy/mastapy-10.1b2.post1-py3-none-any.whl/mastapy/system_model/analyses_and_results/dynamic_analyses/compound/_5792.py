...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5672
...
class CylindricalGearCompoundDynamicAnalysis(_5802.GearCompoundDynamicAnalysis):
    '''CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5672.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5672.CylindricalGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5672.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5672.CylindricalGearDynamicAnalysis))
        return value
