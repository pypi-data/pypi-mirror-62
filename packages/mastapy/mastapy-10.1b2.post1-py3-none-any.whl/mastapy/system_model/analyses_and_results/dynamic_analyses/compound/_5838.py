...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5751
...
class SpecialisedAssemblyCompoundDynamicAnalysis(_5751.AbstractAssemblyCompoundDynamicAnalysis):
    '''SpecialisedAssemblyCompoundDynamicAnalysis
