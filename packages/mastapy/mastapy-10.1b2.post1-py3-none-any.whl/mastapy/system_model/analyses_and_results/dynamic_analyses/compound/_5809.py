...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5691
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5752
...
class ImportedFEComponentCompoundDynamicAnalysis(_5752.AbstractShaftOrHousingCompoundDynamicAnalysis):
    '''ImportedFEComponentCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5691.ImportedFEComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5691.ImportedFEComponentDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5691.ImportedFEComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5691.ImportedFEComponentDynamicAnalysis))
        return value
