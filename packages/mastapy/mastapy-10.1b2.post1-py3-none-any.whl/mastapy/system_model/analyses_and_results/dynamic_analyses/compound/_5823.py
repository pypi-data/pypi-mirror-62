...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5705
...
class OilSealCompoundDynamicAnalysis(_5785.ConnectorCompoundDynamicAnalysis):
    '''OilSealCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5705.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5705.OilSealDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5705.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5705.OilSealDynamicAnalysis))
        return value
