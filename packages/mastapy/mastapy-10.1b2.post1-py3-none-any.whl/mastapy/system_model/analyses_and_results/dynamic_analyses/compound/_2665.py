...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3492
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2669
...
class ClutchHalfCompoundDynamicAnalysis(_2669.CouplingHalfCompoundDynamicAnalysis):
    '''ClutchHalfCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3492.ClutchHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3492.ClutchHalfDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_3492.ClutchHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_3492.ClutchHalfDynamicAnalysis))
        return value
