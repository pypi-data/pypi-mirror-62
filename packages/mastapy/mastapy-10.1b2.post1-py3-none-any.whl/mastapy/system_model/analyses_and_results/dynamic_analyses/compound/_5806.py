...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5688
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5753
...
class HypoidGearCompoundDynamicAnalysis(_5753.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    '''HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5688.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5688.HypoidGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5688.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5688.HypoidGearDynamicAnalysis))
        return value
