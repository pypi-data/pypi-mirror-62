...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5707
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5837
...
class PlanetaryConnectionCompoundDynamicAnalysis(_5837.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    '''PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5707.PlanetaryConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5707.PlanetaryConnectionDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5707.PlanetaryConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5707.PlanetaryConnectionDynamicAnalysis))
        return value
