...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2722, _2770, _2703
...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(_2703.BevelGearSetCompoundDynamicAnalysis):
    '''StraightBevelDiffGearSetCompoundDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_compound_dynamic_analysis(self) -> 'List[_2722.StraightBevelDiffGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundDynamicAnalysis, constructor.new(_2722.StraightBevelDiffGearCompoundDynamicAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_compound_dynamic_analysis(self) -> 'List[_2770.StraightBevelDiffGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundDynamicAnalysis, constructor.new(_2770.StraightBevelDiffGearMeshCompoundDynamicAnalysis))
        return value
