...
class TorqueConverterCompoundDynamicAnalysis(_2609.CouplingCompoundDynamicAnalysis):
    '''TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3649.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3649.TorqueConverterDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3649.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3649.TorqueConverterDynamicAnalysis))
        return value
