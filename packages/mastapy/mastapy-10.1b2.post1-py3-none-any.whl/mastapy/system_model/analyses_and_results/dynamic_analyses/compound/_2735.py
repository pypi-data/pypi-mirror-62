...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2737
...
class ConceptCouplingCompoundDynamicAnalysis(_2737.CouplingCompoundDynamicAnalysis):
    '''ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3633.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3633.ConceptCouplingDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3633.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3633.ConceptCouplingDynamicAnalysis))
        return value
