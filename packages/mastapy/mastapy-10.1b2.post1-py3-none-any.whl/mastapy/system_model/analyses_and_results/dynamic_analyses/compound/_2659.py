...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3604
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2640
...
class WormGearCompoundDynamicAnalysis(_2640.GearCompoundDynamicAnalysis):
    '''WormGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3604.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3604.WormGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_3604.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_3604.WormGearDynamicAnalysis))
        return value
