...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5783
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5911
...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_5911.BevelGearMeshCompoundDynamicAnalysis):
    '''BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5783.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5783.BevelDifferentialGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5783.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5783.BevelDifferentialGearMeshDynamicAnalysis))
        return value
