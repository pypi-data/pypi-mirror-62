...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5759
...
class CVTCompoundDynamicAnalysis(_5759.BeltDriveCompoundDynamicAnalysis):
    '''CVTCompoundDynamicAnalysis
