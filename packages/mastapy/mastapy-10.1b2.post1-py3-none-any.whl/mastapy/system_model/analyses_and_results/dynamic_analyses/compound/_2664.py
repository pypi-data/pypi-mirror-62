...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3491
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2668
...
class ClutchCompoundDynamicAnalysis(_2668.CouplingCompoundDynamicAnalysis):
    '''ClutchCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3491.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3491.ClutchDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3491.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3491.ClutchDynamicAnalysis))
        return value
