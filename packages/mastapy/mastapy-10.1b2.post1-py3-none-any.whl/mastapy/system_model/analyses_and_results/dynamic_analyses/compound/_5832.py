...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5715
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5788
...
class RollingRingCompoundDynamicAnalysis(_5788.CouplingHalfCompoundDynamicAnalysis):
    '''RollingRingCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5715.RollingRingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5715.RollingRingDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5715.RollingRingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5715.RollingRingDynamicAnalysis))
        return value
