...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5712
...
class PulleyCompoundDynamicAnalysis(_5788.CouplingHalfCompoundDynamicAnalysis):
    '''PulleyCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5712.PulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5712.PulleyDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5712.PulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5712.PulleyDynamicAnalysis))
        return value
