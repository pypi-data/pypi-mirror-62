...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2692, _2768, _2710
...
class ConceptGearSetCompoundDynamicAnalysis(_2710.GearSetCompoundDynamicAnalysis):
    '''ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_2692.ConceptGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundDynamicAnalysis, constructor.new(_2692.ConceptGearCompoundDynamicAnalysis))
        return value

    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_2768.ConceptGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundDynamicAnalysis, constructor.new(_2768.ConceptGearMeshCompoundDynamicAnalysis))
        return value
