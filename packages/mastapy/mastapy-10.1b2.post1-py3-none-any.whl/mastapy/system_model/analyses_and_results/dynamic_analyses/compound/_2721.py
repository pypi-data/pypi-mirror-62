...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2720, _2779, _2703
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_2703.BevelGearSetCompoundDynamicAnalysis):
    '''SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_2720.SpiralBevelGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundDynamicAnalysis, constructor.new(_2720.SpiralBevelGearCompoundDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_2779.SpiralBevelGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundDynamicAnalysis, constructor.new(_2779.SpiralBevelGearMeshCompoundDynamicAnalysis))
        return value
