...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2710
...
class ConicalGearSetCompoundDynamicAnalysis(_2710.GearSetCompoundDynamicAnalysis):
    '''ConicalGearSetCompoundDynamicAnalysis
