...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2510
...
class BearingCompoundDynamicAnalysis(_2510.ConnectorCompoundDynamicAnalysis):
    '''BearingCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3674.BearingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3674.BearingDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_3674.BearingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_3674.BearingDynamicAnalysis))
        return value
