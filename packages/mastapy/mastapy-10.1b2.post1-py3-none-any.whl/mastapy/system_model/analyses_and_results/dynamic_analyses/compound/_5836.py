...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5718
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5785
...
class ShaftHubConnectionCompoundDynamicAnalysis(_5785.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5718.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5718.ShaftHubConnectionDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5718.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5718.ShaftHubConnectionDynamicAnalysis))
        return value
