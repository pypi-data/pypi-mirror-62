...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5687
...
class GuideDxfModelCompoundDynamicAnalysis(_5774.ComponentCompoundDynamicAnalysis):
    '''GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5687.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5687.GuideDxfModelDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5687.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5687.GuideDxfModelDynamicAnalysis))
        return value
