...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2579
...
class PlanetaryGearSetCompoundDynamicAnalysis(_2579.CylindricalGearSetCompoundDynamicAnalysis):
    '''PlanetaryGearSetCompoundDynamicAnalysis
