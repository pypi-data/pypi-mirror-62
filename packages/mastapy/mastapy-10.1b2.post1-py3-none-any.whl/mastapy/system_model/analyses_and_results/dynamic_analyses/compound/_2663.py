...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3490
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2619
...
class BeltDriveCompoundDynamicAnalysis(_2619.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3490.BeltDriveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3490.BeltDriveDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3490.BeltDriveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3490.BeltDriveDynamicAnalysis))
        return value
