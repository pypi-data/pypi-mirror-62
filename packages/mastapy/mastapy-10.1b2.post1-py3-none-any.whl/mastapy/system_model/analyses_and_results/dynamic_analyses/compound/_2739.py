...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2732
...
class CVTCompoundDynamicAnalysis(_2732.BeltDriveCompoundDynamicAnalysis):
    '''CVTCompoundDynamicAnalysis
