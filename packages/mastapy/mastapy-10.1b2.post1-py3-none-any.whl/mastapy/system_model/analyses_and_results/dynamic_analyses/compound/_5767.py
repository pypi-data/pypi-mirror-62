...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5755
...
class BevelGearSetCompoundDynamicAnalysis(_5755.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
