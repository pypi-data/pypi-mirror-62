...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2694, _2769, _2710
...
class FaceGearSetCompoundDynamicAnalysis(_2710.GearSetCompoundDynamicAnalysis):
    '''FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_2694.FaceGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundDynamicAnalysis, constructor.new(_2694.FaceGearCompoundDynamicAnalysis))
        return value

    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_2769.FaceGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundDynamicAnalysis, constructor.new(_2769.FaceGearMeshCompoundDynamicAnalysis))
        return value
