...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2730, _2782, _2703
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_2703.BevelGearSetCompoundDynamicAnalysis):
    '''ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_2730.ZerolBevelGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCompoundDynamicAnalysis, constructor.new(_2730.ZerolBevelGearCompoundDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_2782.ZerolBevelGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCompoundDynamicAnalysis, constructor.new(_2782.ZerolBevelGearMeshCompoundDynamicAnalysis))
        return value
