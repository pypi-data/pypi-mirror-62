...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5679
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5774
...
class ExternalCADModelCompoundDynamicAnalysis(_5774.ComponentCompoundDynamicAnalysis):
    '''ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5679.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5679.ExternalCADModelDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5679.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5679.ExternalCADModelDynamicAnalysis))
        return value
