...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2698, _2767, _2703
...
class BevelDifferentialGearSetCompoundDynamicAnalysis(_2703.BevelGearSetCompoundDynamicAnalysis):
    '''BevelDifferentialGearSetCompoundDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_compound_dynamic_analysis(self) -> 'List[_2698.BevelDifferentialGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsCompoundDynamicAnalysis, constructor.new(_2698.BevelDifferentialGearCompoundDynamicAnalysis))
        return value

    @property
    def bevel_differential_meshes_compound_dynamic_analysis(self) -> 'List[_2767.BevelDifferentialGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesCompoundDynamicAnalysis, constructor.new(_2767.BevelDifferentialGearMeshCompoundDynamicAnalysis))
        return value
