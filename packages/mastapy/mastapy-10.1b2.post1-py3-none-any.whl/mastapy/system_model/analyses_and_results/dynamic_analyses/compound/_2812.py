...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2813
...
class CVTBeltConnectionCompoundDynamicAnalysis(_2813.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
