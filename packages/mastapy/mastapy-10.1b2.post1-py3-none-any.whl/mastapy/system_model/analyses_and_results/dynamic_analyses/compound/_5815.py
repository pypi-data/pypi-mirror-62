...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5697
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis(_5812.KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5697.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_5697.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis))
        return value
