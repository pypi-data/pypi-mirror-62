...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2564, _2640, _2582
...
class ConceptGearSetCompoundDynamicAnalysis(_2582.GearSetCompoundDynamicAnalysis):
    '''ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_2564.ConceptGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundDynamicAnalysis, constructor.new(_2564.ConceptGearCompoundDynamicAnalysis))
        return value

    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_2640.ConceptGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundDynamicAnalysis, constructor.new(_2640.ConceptGearMeshCompoundDynamicAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3709.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3709.ConceptGearSetDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3709.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3709.ConceptGearSetDynamicAnalysis))
        return value
