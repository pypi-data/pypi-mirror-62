...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2596, _2652, _2575
...
class StraightBevelGearSetCompoundDynamicAnalysis(_2575.BevelGearSetCompoundDynamicAnalysis):
    '''StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_2596.StraightBevelGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundDynamicAnalysis, constructor.new(_2596.StraightBevelGearCompoundDynamicAnalysis))
        return value

    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_2652.StraightBevelGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundDynamicAnalysis, constructor.new(_2652.StraightBevelGearMeshCompoundDynamicAnalysis))
        return value
