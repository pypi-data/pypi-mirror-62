...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2706, _2774, _2710
...
class CylindricalGearSetCompoundDynamicAnalysis(_2710.GearSetCompoundDynamicAnalysis):
    '''CylindricalGearSetCompoundDynamicAnalysis
    ...
    @property
    def cylindrical_gears_compound_dynamic_analysis(self) -> 'List[_2706.CylindricalGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundDynamicAnalysis, constructor.new(_2706.CylindricalGearCompoundDynamicAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_dynamic_analysis(self) -> 'List[_2774.CylindricalGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundDynamicAnalysis, constructor.new(_2774.CylindricalGearMeshCompoundDynamicAnalysis))
        return value
