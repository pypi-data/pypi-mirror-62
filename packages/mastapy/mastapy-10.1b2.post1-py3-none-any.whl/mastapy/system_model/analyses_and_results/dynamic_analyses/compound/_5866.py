...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5748
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5765
...
class ZerolBevelGearCompoundDynamicAnalysis(_5765.BevelGearCompoundDynamicAnalysis):
    '''ZerolBevelGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5748.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5748.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5748.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5748.ZerolBevelGearDynamicAnalysis))
        return value
