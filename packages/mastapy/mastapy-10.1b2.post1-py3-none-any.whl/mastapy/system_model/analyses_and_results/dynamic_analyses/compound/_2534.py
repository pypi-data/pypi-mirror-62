...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2542
...
class AGMAGleasonConicalGearCompoundDynamicAnalysis(_2542.ConicalGearCompoundDynamicAnalysis):
    '''AGMAGleasonConicalGearCompoundDynamicAnalysis
