...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2514
...
class RootAssemblyCompoundDynamicAnalysis(_2514.AssemblyCompoundDynamicAnalysis):
    '''RootAssemblyCompoundDynamicAnalysis
