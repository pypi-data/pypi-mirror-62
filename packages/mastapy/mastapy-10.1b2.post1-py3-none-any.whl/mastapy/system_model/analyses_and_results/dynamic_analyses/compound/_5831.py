...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5713
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5838
...
class RollingRingAssemblyCompoundDynamicAnalysis(_5838.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''RollingRingAssemblyCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5713.RollingRingAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5713.RollingRingAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_5713.RollingRingAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_5713.RollingRingAssemblyDynamicAnalysis))
        return value
