...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2755
...
class CVTBeltConnectionCompoundDynamicAnalysis(_2755.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
