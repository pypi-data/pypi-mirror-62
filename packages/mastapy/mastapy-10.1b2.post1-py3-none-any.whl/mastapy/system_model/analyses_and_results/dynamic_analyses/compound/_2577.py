...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2582
...
class ConicalGearSetCompoundDynamicAnalysis(_2582.GearSetCompoundDynamicAnalysis):
    '''ConicalGearSetCompoundDynamicAnalysis
