...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5794
...
class PlanetaryGearSetCompoundDynamicAnalysis(_5794.CylindricalGearSetCompoundDynamicAnalysis):
    '''PlanetaryGearSetCompoundDynamicAnalysis
