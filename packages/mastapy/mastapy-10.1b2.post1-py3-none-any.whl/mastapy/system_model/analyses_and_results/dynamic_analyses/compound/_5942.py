...
class ExternalCADModelCompoundDynamicAnalysis(_5919.ComponentCompoundDynamicAnalysis):
    '''ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5821.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5821.ExternalCADModelDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_5821.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_5821.ExternalCADModelDynamicAnalysis))
        return value
