...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2767
...
class WormGearCompoundDynamicAnalysis(_2767.GearCompoundDynamicAnalysis):
    '''WormGearCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3737.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3737.WormGearDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_3737.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_3737.WormGearDynamicAnalysis))
        return value
