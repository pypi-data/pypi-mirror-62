...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5725
...
class SpringDamperCompoundDynamicAnalysis(_5786.CouplingCompoundDynamicAnalysis):
    '''SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5725.SpringDamperDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5725.SpringDamperDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_5725.SpringDamperDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_5725.SpringDamperDynamicAnalysis))
        return value
