...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5740
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5786
...
class TorqueConverterCompoundDynamicAnalysis(_5786.CouplingCompoundDynamicAnalysis):
    '''TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5740.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5740.TorqueConverterDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_5740.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_5740.TorqueConverterDynamicAnalysis))
        return value
