...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2600, _2653, _2582
...
class WormGearSetCompoundDynamicAnalysis(_2582.GearSetCompoundDynamicAnalysis):
    '''WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_2600.WormGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundDynamicAnalysis, constructor.new(_2600.WormGearCompoundDynamicAnalysis))
        return value

    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_2653.WormGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundDynamicAnalysis, constructor.new(_2653.WormGearMeshCompoundDynamicAnalysis))
        return value
