...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5758
...
class CVTBeltConnectionCompoundDynamicAnalysis(_5758.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
