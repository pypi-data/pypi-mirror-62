...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5719
...
class PlanetaryConnectionDynamicAnalysis(_5719.ShaftToMountableComponentConnectionDynamicAnalysis):
    '''PlanetaryConnectionDynamicAnalysis
