...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3628, _3680, _3719
...
class ZerolBevelGearSetDynamicAnalysis(_3719.BevelGearSetDynamicAnalysis):
    '''ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_3628.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsDynamicAnalysis, constructor.new(_3628.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_3680.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesDynamicAnalysis, constructor.new(_3680.ZerolBevelGearMeshDynamicAnalysis))
        return value
