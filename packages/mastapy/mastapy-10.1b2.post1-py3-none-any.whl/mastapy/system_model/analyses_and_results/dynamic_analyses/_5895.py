...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5893, _5894, _5789
...
class ZerolBevelGearSetDynamicAnalysis(_5789.BevelGearSetDynamicAnalysis):
    '''ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_5893.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsDynamicAnalysis, constructor.new(_5893.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_5894.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesDynamicAnalysis, constructor.new(_5894.ZerolBevelGearMeshDynamicAnalysis))
        return value
