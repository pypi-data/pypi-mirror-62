...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3598, _3528, _3579
...
class StraightBevelDiffGearSetDynamicAnalysis(_3579.BevelGearSetDynamicAnalysis):
    '''StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_3598.StraightBevelDiffGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsDynamicAnalysis, constructor.new(_3598.StraightBevelDiffGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_3528.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesDynamicAnalysis, constructor.new(_3528.StraightBevelDiffGearMeshDynamicAnalysis))
        return value
