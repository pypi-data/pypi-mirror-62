...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5875, _5876, _5789
...
class StraightBevelGearSetDynamicAnalysis(_5789.BevelGearSetDynamicAnalysis):
    '''StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_5875.StraightBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsDynamicAnalysis, constructor.new(_5875.StraightBevelGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_5876.StraightBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesDynamicAnalysis, constructor.new(_5876.StraightBevelGearMeshDynamicAnalysis))
        return value
