...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5635
...
class BevelGearSetDynamicAnalysis(_5635.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''BevelGearSetDynamicAnalysis
