...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3740, _3678, _3719
...
class StraightBevelGearSetDynamicAnalysis(_3719.BevelGearSetDynamicAnalysis):
    '''StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_3740.StraightBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsDynamicAnalysis, constructor.new(_3740.StraightBevelGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_3678.StraightBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesDynamicAnalysis, constructor.new(_3678.StraightBevelGearMeshDynamicAnalysis))
        return value
