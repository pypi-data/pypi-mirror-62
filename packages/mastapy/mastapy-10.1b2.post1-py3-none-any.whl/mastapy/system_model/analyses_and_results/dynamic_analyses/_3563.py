...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _4906, _3552
...
class RootAssemblyDynamicAnalysis(_3552.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_4906.DynamicAnalysis':
        ...
        return constructor.new(_4906.DynamicAnalysis)(self.wrapped.DynamicAnalysisInputs) if self.wrapped.DynamicAnalysisInputs else None
