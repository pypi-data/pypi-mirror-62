...
class ConnectionDynamicAnalysis(_6464.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5819.DynamicAnalysis':
        ...
        return constructor.new(_5819.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
