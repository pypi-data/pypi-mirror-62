...
from mastapy.system_model.analyses_and_results.analysis_cases import _6303
...
class ConnectionDynamicAnalysis(_6303.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5677.DynamicAnalysis':
        ...
        return constructor.new(_5677.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
