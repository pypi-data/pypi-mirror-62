...
from mastapy.system_model.analyses_and_results.analysis_cases import _2420
...
class ConnectionDynamicAnalysis(_2420.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_4911.DynamicAnalysis':
        ...
        return constructor.new(_4911.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
