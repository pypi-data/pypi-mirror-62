...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5640, _5641, _5647
...
class BevelDifferentialGearSetDynamicAnalysis(_5647.BevelGearSetDynamicAnalysis):
    '''BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_5640.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsDynamicAnalysis, constructor.new(_5640.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_5641.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesDynamicAnalysis, constructor.new(_5641.BevelDifferentialGearMeshDynamicAnalysis))
        return value
