...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _4911, _3692
...
class RootAssemblyDynamicAnalysis(_3692.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_4911.DynamicAnalysis':
        ...
        return constructor.new(_4911.DynamicAnalysis)(self.wrapped.DynamicAnalysisInputs) if self.wrapped.DynamicAnalysisInputs else None
