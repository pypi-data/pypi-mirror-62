...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3519
...
class PlanetaryConnectionDynamicAnalysis(_3519.ShaftToMountableComponentConnectionDynamicAnalysis):
    '''PlanetaryConnectionDynamicAnalysis
