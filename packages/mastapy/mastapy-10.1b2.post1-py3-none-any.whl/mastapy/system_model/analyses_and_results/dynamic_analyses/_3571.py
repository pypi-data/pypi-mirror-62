...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3570, _3527, _3586
...
class FaceGearSetDynamicAnalysis(_3586.GearSetDynamicAnalysis):
    '''FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_3570.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsDynamicAnalysis, constructor.new(_3570.FaceGearDynamicAnalysis))
        return value

    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_3527.FaceGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesDynamicAnalysis, constructor.new(_3527.FaceGearMeshDynamicAnalysis))
        return value
