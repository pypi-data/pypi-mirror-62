...
class TorqueConverterConnectionGearWhineAnalysis(_5267.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2310.TorqueConverterConnectionSystemDeflection':
