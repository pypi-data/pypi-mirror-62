...
class BeltConnectionGearWhineAnalysis(_3701.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2145.BeltConnectionSystemDeflection':
        ...
        return constructor.new(_2145.BeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
