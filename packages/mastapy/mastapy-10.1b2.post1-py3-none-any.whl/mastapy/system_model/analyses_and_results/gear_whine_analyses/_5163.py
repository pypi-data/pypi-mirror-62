...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5161, _5162, _5169
...
class FaceGearSetGearWhineAnalysis(_5169.GearSetGearWhineAnalysis):
    '''FaceGearSetGearWhineAnalysis
    ...
    @property
    def face_gears_gear_whine_analysis(self) -> 'List[_5161.FaceGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsGearWhineAnalysis, constructor.new(_5161.FaceGearGearWhineAnalysis))
        return value

    @property
    def face_meshes_gear_whine_analysis(self) -> 'List[_5162.FaceGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesGearWhineAnalysis, constructor.new(_5162.FaceGearMeshGearWhineAnalysis))
        return value
