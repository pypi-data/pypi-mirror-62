...
class StraightBevelGearMeshGearWhineAnalysis(_5116.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2238.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2238.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
