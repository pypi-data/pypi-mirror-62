...
class AbstractPeriodicExcitationDetail(_1.APIBase):
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6241.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        return constructor.new(_6241.ElectricMachineHarmonicLoadDataFromExcel)(self.wrapped.HarmonicLoadData) if self.wrapped.HarmonicLoadData else None

    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6242.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if self.wrapped.HarmonicLoadData.__class__.__qualname__ != 'ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        return constructor.new(_6242.ElectricMachineHarmonicLoadDataFromJMAG)(self.wrapped.HarmonicLoadData) if self.wrapped.HarmonicLoadData else None

    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6243.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if self.wrapped.HarmonicLoadData.__class__.__qualname__ != 'ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        return constructor.new(_6243.ElectricMachineHarmonicLoadDataFromMotorCAD)(self.wrapped.HarmonicLoadData) if self.wrapped.HarmonicLoadData else None

    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6244.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6244.PointLoadHarmonicLoadData)(self.wrapped.HarmonicLoadData) if self.wrapped.HarmonicLoadData else None

    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6245.UnbalancedMassHarmonicLoadData':
        ...
        return constructor.new(_6245.UnbalancedMassHarmonicLoadData)(self.wrapped.HarmonicLoadData) if self.wrapped.HarmonicLoadData else None
