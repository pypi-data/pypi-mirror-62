...
class RollingRingAssemblyGearWhineAnalysis(_3749.SpecialisedAssemblyGearWhineAnalysis):
    '''RollingRingAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2230.RollingRingAssemblySystemDeflection':
        ...
        return constructor.new(_2230.RollingRingAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
