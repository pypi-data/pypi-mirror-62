...
class StraightBevelGearGearWhineAnalysis(_3836.BevelGearGearWhineAnalysis):
    '''StraightBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2382.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2382.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
