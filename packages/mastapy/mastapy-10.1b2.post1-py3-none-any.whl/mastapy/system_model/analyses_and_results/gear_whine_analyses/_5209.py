...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5195
...
class SingleNodePeriodicExcitationWithReferenceShaft(_5195.PeriodicExcitationWithReferenceShaft):
    '''SingleNodePeriodicExcitationWithReferenceShaft
