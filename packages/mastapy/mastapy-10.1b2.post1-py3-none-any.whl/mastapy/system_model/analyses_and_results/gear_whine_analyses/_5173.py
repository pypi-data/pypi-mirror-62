...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5209
...
class GeneralPeriodicExcitationDetail(_5209.SingleNodePeriodicExcitationWithReferenceShaft):
    '''GeneralPeriodicExcitationDetail
