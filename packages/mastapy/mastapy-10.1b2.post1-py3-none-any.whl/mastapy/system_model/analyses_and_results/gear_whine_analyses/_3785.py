...
class FaceGearMeshGearWhineAnalysis(_3799.GearMeshGearWhineAnalysis):
    '''FaceGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2202.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2202.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
