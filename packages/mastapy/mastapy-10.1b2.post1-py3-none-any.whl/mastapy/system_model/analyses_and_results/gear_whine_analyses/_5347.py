...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5345, _5346, _5247
...
class SpiralBevelGearSetGearWhineAnalysis(_5247.BevelGearSetGearWhineAnalysis):
    '''SpiralBevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2290.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5345.SpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5345.SpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_gears_gear_whine_analysis(self) -> 'List[_5345.SpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsGearWhineAnalysis, constructor.new(_5345.SpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5346.SpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5346.SpiralBevelGearMeshGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_gear_whine_analysis(self) -> 'List[_5346.SpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesGearWhineAnalysis, constructor.new(_5346.SpiralBevelGearMeshGearWhineAnalysis))
        return value
