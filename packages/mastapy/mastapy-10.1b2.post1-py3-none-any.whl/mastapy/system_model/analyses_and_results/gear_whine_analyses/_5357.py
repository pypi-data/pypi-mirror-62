...
class StraightBevelPlanetGearGearWhineAnalysis(_5351.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2066.StraightBevelPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2301.StraightBevelPlanetGearSystemDeflection':
