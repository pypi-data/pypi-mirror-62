...
from mastapy.system_model.analyses_and_results.analysis_cases import _6300
...
class GearWhineAnalysis(_6300.CompoundAnalysisCase):
    '''GearWhineAnalysis
    ...
    @property
    def single_mesh_whine_analyses(self) -> 'List[_5341.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleMeshWhineAnalyses, constructor.new(_5341.SingleMeshWhineAnalysis))
        return value
