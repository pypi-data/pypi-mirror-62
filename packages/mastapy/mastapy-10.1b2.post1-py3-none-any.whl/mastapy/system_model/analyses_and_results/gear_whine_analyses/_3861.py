...
class StraightBevelSunGearGearWhineAnalysis(_3856.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2388.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2388.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
