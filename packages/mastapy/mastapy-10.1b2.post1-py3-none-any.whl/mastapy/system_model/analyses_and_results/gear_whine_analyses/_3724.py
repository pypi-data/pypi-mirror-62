...
class WormGearMeshGearWhineAnalysis(_3726.GearMeshGearWhineAnalysis):
    '''WormGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2304.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2304.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
