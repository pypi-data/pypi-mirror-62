...
class PlanetaryConnectionGearWhineAnalysis(_5208.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2214.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2214.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
