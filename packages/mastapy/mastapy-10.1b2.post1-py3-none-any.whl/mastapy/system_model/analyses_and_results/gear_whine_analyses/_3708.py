...
class SpringDamperConnectionGearWhineAnalysis(_3707.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2283.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2283.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
