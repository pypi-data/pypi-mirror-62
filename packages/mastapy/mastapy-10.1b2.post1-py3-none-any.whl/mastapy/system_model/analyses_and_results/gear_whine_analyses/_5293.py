...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5291, _5292, _5299
...
class FaceGearSetGearWhineAnalysis(_5299.GearSetGearWhineAnalysis):
    '''FaceGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2242.FaceGearSetSystemDeflection':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5291.FaceGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5291.FaceGearGearWhineAnalysis))
        return value

    @property
    def face_gears_gear_whine_analysis(self) -> 'List[_5291.FaceGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsGearWhineAnalysis, constructor.new(_5291.FaceGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5292.FaceGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5292.FaceGearMeshGearWhineAnalysis))
        return value

    @property
    def face_meshes_gear_whine_analysis(self) -> 'List[_5292.FaceGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesGearWhineAnalysis, constructor.new(_5292.FaceGearMeshGearWhineAnalysis))
        return value
