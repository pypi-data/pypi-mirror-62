...
class ClutchConnectionGearWhineAnalysis(_3707.CouplingConnectionGearWhineAnalysis):
    '''ClutchConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2157.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2157.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
