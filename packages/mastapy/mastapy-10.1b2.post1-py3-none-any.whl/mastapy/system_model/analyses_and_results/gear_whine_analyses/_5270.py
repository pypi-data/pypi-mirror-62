...
from mastapy.system_model.connections_and_sockets import _1816
...
class CVTBeltConnectionGearWhineAnalysis(_5238.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1816.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2225.CVTBeltConnectionSystemDeflection':
