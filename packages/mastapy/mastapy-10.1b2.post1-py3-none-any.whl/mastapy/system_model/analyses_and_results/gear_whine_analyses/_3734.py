...
class DatumGearWhineAnalysis(_3732.ComponentGearWhineAnalysis):
    '''DatumGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2192.DatumSystemDeflection':
        ...
        return constructor.new(_2192.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
