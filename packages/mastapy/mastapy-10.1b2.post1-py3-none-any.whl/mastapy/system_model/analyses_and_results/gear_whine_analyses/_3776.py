...
class RollingRingConnectionGearWhineAnalysis(_3774.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2245.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2245.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
