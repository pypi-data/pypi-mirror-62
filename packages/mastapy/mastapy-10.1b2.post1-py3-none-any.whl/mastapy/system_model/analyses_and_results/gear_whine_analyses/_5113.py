...
class BevelDifferentialPlanetGearGearWhineAnalysis(_5110.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2140.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2140.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
