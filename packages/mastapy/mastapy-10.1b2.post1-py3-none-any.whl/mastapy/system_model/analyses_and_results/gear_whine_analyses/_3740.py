...
class MassDiscGearWhineAnalysis(_3751.VirtualComponentGearWhineAnalysis):
    '''MassDiscGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2218.MassDiscSystemDeflection':
        ...
        return constructor.new(_2218.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
