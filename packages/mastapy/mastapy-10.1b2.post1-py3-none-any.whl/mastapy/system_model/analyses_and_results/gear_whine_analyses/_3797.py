...
class WormGearMeshGearWhineAnalysis(_3799.GearMeshGearWhineAnalysis):
    '''WormGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2312.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2312.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
