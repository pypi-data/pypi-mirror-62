...
class ShaftHubConnectionGearWhineAnalysis(_5136.ConnectorGearWhineAnalysis):
    '''ShaftHubConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2223.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2223.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
