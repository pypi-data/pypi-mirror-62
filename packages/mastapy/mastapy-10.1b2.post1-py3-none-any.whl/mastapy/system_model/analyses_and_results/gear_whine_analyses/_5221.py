...
class StraightBevelGearGearWhineAnalysis(_5115.BevelGearGearWhineAnalysis):
    '''StraightBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2240.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2240.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
