...
class ConnectorGearWhineAnalysis(_5322.MountableComponentGearWhineAnalysis):
    '''ConnectorGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2221.ConnectorSystemDeflection':
