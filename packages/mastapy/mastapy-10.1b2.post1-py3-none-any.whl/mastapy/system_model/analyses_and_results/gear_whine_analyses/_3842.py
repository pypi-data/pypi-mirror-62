...
class CylindricalPlanetGearGearWhineAnalysis(_3840.CylindricalGearGearWhineAnalysis):
    '''CylindricalPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2198.CylindricalPlanetGearSystemDeflection':
