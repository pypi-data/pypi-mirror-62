...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6189
...
class PeriodicExcitationWithReferenceShaft(_6189.AbstractPeriodicExcitationDetail):
    '''PeriodicExcitationWithReferenceShaft
