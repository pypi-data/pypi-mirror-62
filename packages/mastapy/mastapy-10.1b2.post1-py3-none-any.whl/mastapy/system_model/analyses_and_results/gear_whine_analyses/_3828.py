...
class FaceGearGearWhineAnalysis(_3843.GearGearWhineAnalysis):
    '''FaceGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2204.FaceGearSystemDeflection':
        ...
        return constructor.new(_2204.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
