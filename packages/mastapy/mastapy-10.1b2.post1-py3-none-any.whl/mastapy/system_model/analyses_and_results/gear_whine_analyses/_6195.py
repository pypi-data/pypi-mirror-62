...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6192
...
class ElectricMachineRotorYForcePeriodicExcitationDetail(_6192.ElectricMachinePeriodicExcitationDetail):
    '''ElectricMachineRotorYForcePeriodicExcitationDetail
