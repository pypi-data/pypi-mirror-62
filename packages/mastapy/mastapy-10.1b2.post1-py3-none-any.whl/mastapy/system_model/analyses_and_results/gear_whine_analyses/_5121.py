...
class ClutchGearWhineAnalysis(_5138.CouplingGearWhineAnalysis):
    '''ClutchGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2149.ClutchSystemDeflection':
        ...
        return constructor.new(_2149.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
