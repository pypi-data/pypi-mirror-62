...
class BearingGearWhineAnalysis(_5266.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1662.RollingBearingSpeedResults':
        ...
        return constructor.new(_1662.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2191.BearingSystemDeflection':
