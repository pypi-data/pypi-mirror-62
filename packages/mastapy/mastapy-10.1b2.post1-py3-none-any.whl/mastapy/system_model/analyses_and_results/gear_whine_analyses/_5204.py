...
from mastapy.system_model.analyses_and_results.static_loads import _5995
from mastapy.system_model.analyses_and_results.system_deflections import _2221
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5139
...
class RollingRingGearWhineAnalysis(_5139.CouplingHalfGearWhineAnalysis):
    '''RollingRingGearWhineAnalysis
    ...
    @property
    def component_load_case(self) -> '_5995.RollingRingLoadCase':
        ...
        return constructor.new(_5995.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2221.RollingRingSystemDeflection':
        ...
        return constructor.new(_2221.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
