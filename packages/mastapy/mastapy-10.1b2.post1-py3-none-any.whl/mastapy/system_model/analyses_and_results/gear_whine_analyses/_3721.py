...
class KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis(_3719.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2214.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2214.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
