...
class SingleMeshWhineAnalysis(_3378.StaticLoadAnalysisCase):
    '''SingleMeshWhineAnalysis
    ...
    @property
    def excitation_detail(self) -> '_6182.AbstractPeriodicExcitationDetail':
        ...
        return constructor.new(_6182.AbstractPeriodicExcitationDetail)(self.wrapped.ExcitationDetail) if self.wrapped.ExcitationDetail else None
    ...
    def excitation_detail_of_type_unbalanced_mass_excitation_detail(self) -> '_6211.UnbalancedMassExcitationDetail':
        ...
        if _6211.UnbalancedMassExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
