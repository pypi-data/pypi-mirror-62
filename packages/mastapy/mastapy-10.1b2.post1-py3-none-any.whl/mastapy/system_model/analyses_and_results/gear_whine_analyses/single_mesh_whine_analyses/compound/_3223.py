...
class TorqueConverterCompoundSingleMeshWhineAnalysis(_3209.CouplingCompoundSingleMeshWhineAnalysis):
    '''TorqueConverterCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2064.TorqueConverter':
    ...
    @property
    def assembly_design(self) -> '_2064.TorqueConverter':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4304.TorqueConverterSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4304.TorqueConverterSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_4304.TorqueConverterSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_4304.TorqueConverterSingleMeshWhineAnalysis))
        return value
