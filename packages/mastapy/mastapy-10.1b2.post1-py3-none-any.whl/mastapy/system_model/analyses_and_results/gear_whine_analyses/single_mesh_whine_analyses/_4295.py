...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _6227, _4284
...
class RootAssemblySingleMeshWhineAnalysis(_4284.AssemblySingleMeshWhineAnalysis):
    '''RootAssemblySingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis_inputs(self) -> '_6227.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_6227.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysisInputs) if self.wrapped.SingleMeshWhineAnalysisInputs else None
