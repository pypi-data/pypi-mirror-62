...
class ConceptCouplingHalfCompoundSingleMeshWhineAnalysis(_3343.CouplingHalfCompoundSingleMeshWhineAnalysis):
    '''ConceptCouplingHalfCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4226.ConceptCouplingHalfSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4226.ConceptCouplingHalfSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_4226.ConceptCouplingHalfSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_4226.ConceptCouplingHalfSingleMeshWhineAnalysis))
        return value
