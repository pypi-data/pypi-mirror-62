...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5336
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses.compound import _5410
...
class RollingRingCompoundSingleMeshWhineAnalysis(_5410.CouplingHalfCompoundSingleMeshWhineAnalysis):
    '''RollingRingCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2051.RollingRing':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5336.RollingRingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5336.RollingRingSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_5336.RollingRingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_5336.RollingRingSingleMeshWhineAnalysis))
        return value
