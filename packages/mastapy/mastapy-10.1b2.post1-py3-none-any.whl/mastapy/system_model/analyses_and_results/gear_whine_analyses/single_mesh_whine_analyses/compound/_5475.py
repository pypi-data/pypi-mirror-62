...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5359
...
class SynchroniserCompoundSingleMeshWhineAnalysis(_5460.SpecialisedAssemblyCompoundSingleMeshWhineAnalysis):
    '''SynchroniserCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2056.Synchroniser':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5359.SynchroniserSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5359.SynchroniserSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5359.SynchroniserSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5359.SynchroniserSingleMeshWhineAnalysis))
        return value
