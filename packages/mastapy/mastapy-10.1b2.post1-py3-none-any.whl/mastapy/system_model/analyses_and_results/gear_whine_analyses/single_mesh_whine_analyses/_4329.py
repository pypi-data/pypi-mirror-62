...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4328, _4269, _4311
...
class SpiralBevelGearSetSingleMeshWhineAnalysis(_4311.BevelGearSetSingleMeshWhineAnalysis):
    '''SpiralBevelGearSetSingleMeshWhineAnalysis
    ...
    @property
    def spiral_bevel_gears_single_mesh_whine_analysis(self) -> 'List[_4328.SpiralBevelGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSingleMeshWhineAnalysis, constructor.new(_4328.SpiralBevelGearSingleMeshWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_single_mesh_whine_analysis(self) -> 'List[_4269.SpiralBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSingleMeshWhineAnalysis, constructor.new(_4269.SpiralBevelGearMeshSingleMeshWhineAnalysis))
        return value
