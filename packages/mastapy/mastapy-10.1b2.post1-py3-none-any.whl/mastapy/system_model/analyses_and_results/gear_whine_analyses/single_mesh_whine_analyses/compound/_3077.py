...
from mastapy.system_model.part_model import _1863
...
class DatumCompoundSingleMeshWhineAnalysis(_3075.ComponentCompoundSingleMeshWhineAnalysis):
    '''DatumCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1863.Datum':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4269.DatumSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4269.DatumSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_4269.DatumSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_4269.DatumSingleMeshWhineAnalysis))
        return value
