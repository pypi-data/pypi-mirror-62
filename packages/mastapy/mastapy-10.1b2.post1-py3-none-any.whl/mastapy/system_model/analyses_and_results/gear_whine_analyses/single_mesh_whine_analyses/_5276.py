...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5327
...
class ComponentSingleMeshWhineAnalysis(_5327.PartSingleMeshWhineAnalysis):
    '''ComponentSingleMeshWhineAnalysis
