...
class PartToPartShearCouplingCompoundSingleMeshWhineAnalysis(_5544.CouplingCompoundSingleMeshWhineAnalysis):
    '''PartToPartShearCouplingCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5463.PartToPartShearCouplingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5463.PartToPartShearCouplingSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5463.PartToPartShearCouplingSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5463.PartToPartShearCouplingSingleMeshWhineAnalysis))
        return value
