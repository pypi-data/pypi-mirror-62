...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5328
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses.compound import _5459
...
class PlanetaryConnectionCompoundSingleMeshWhineAnalysis(_5459.ShaftToMountableComponentConnectionCompoundSingleMeshWhineAnalysis):
    '''PlanetaryConnectionCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1777.PlanetaryConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5328.PlanetaryConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5328.PlanetaryConnectionSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5328.PlanetaryConnectionSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5328.PlanetaryConnectionSingleMeshWhineAnalysis))
        return value
