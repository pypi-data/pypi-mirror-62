...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5341, _5258
...
class RootAssemblySingleMeshWhineAnalysis(_5258.AssemblySingleMeshWhineAnalysis):
    '''RootAssemblySingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis_inputs(self) -> '_5341.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5341.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysisInputs) if self.wrapped.SingleMeshWhineAnalysisInputs else None
