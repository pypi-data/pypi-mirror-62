...
from mastapy.system_model.part_model.gears import _1893
...
class FaceGearCompoundSingleMeshWhineAnalysis(_3113.GearCompoundSingleMeshWhineAnalysis):
    '''FaceGearCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1893.FaceGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4290.FaceGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4290.FaceGearSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_4290.FaceGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_4290.FaceGearSingleMeshWhineAnalysis))
        return value
