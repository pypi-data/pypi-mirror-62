...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5348
...
class SpringDamperCompoundSingleMeshWhineAnalysis(_5408.CouplingCompoundSingleMeshWhineAnalysis):
    '''SpringDamperCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2054.SpringDamper':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5348.SpringDamperSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5348.SpringDamperSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5348.SpringDamperSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5348.SpringDamperSingleMeshWhineAnalysis))
        return value
