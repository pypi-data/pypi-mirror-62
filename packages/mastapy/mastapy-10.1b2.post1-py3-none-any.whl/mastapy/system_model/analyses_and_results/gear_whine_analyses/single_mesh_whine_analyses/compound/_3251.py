...
class SpiralBevelGearMeshCompoundSingleMeshWhineAnalysis(_3243.BevelGearMeshCompoundSingleMeshWhineAnalysis):
    '''SpiralBevelGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4332.SpiralBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4332.SpiralBevelGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_4332.SpiralBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_4332.SpiralBevelGearMeshSingleMeshWhineAnalysis))
        return value
