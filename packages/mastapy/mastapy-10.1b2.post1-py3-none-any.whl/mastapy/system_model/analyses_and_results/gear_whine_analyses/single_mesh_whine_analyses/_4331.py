...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4330, _4260, _4311
...
class StraightBevelDiffGearSetSingleMeshWhineAnalysis(_4311.BevelGearSetSingleMeshWhineAnalysis):
    '''StraightBevelDiffGearSetSingleMeshWhineAnalysis
    ...
    @property
    def straight_bevel_diff_gears_single_mesh_whine_analysis(self) -> 'List[_4330.StraightBevelDiffGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSingleMeshWhineAnalysis, constructor.new(_4330.StraightBevelDiffGearSingleMeshWhineAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_single_mesh_whine_analysis(self) -> 'List[_4260.StraightBevelDiffGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSingleMeshWhineAnalysis, constructor.new(_4260.StraightBevelDiffGearMeshSingleMeshWhineAnalysis))
        return value
