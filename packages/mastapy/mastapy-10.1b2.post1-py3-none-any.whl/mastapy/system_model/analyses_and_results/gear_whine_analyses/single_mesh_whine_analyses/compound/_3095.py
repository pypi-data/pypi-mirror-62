...
class ShaftCompoundSingleMeshWhineAnalysis(_3071.AbstractShaftOrHousingCompoundSingleMeshWhineAnalysis):
    '''ShaftCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4287.ShaftSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4287.ShaftSingleMeshWhineAnalysis))
        return value

    @property
    def component_single_mesh_whine_analysis_load_cases(self) -> 'List[_4287.ShaftSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSingleMeshWhineAnalysisLoadCases, constructor.new(_4287.ShaftSingleMeshWhineAnalysis))
        return value
