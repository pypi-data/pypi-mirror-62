...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses.compound import _3092
...
class FlexiblePinAssemblyCompoundSingleMeshWhineAnalysis(_3092.SpecialisedAssemblyCompoundSingleMeshWhineAnalysis):
    '''FlexiblePinAssemblyCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1865.FlexiblePinAssembly':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4271.FlexiblePinAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4271.FlexiblePinAssemblySingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_4271.FlexiblePinAssemblySingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_4271.FlexiblePinAssemblySingleMeshWhineAnalysis))
        return value
