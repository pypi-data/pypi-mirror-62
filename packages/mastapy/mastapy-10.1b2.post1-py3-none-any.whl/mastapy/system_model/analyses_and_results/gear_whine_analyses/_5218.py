...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5115
...
class StraightBevelDiffGearGearWhineAnalysis(_5115.BevelGearGearWhineAnalysis):
    '''StraightBevelDiffGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2237.StraightBevelDiffGearSystemDeflection':
        ...
        return constructor.new(_2237.StraightBevelDiffGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
