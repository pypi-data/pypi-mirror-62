...
class ShaftHubConnectionGearWhineAnalysis(_3806.ConnectorGearWhineAnalysis):
    '''ShaftHubConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2257.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2257.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
