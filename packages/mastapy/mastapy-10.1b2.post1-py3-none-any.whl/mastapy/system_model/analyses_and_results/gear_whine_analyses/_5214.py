...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5212, _5213, _5117
...
class SpiralBevelGearSetGearWhineAnalysis(_5117.BevelGearSetGearWhineAnalysis):
    '''SpiralBevelGearSetGearWhineAnalysis
    ...
    @property
    def spiral_bevel_gears_gear_whine_analysis(self) -> 'List[_5212.SpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsGearWhineAnalysis, constructor.new(_5212.SpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_gear_whine_analysis(self) -> 'List[_5213.SpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesGearWhineAnalysis, constructor.new(_5213.SpiralBevelGearMeshGearWhineAnalysis))
        return value
