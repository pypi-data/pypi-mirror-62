...
from mastapy.system_model.analyses_and_results.analysis_cases import _6461
...
class GearWhineAnalysis(_6461.CompoundAnalysisCase):
    '''GearWhineAnalysis
    ...
    @property
    def single_mesh_whine_analyses(self) -> 'List[_5477.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleMeshWhineAnalyses, constructor.new(_5477.SingleMeshWhineAnalysis))
        return value
