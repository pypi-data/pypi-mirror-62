...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3733
...
class ShaftHubConnectionGearWhineAnalysis(_3733.ConnectorGearWhineAnalysis):
    '''ShaftHubConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2249.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2249.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
