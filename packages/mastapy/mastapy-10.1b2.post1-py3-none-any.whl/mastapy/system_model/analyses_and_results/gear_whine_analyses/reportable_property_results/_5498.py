...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5503, _5499
...
class GearWhineAnalysisResultsPropertyAccessor(_1.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_5503.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_5503.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_5499.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_5499.ResultsForOrder))
        return value
