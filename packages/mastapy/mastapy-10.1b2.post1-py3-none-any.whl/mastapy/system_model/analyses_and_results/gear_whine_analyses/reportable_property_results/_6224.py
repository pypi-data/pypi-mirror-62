...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _6237, _6233
...
class GearWhineAnalysisResultsPropertyAccessor(_1.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_6237.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_6237.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_6233.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_6233.ResultsForOrder))
        return value
