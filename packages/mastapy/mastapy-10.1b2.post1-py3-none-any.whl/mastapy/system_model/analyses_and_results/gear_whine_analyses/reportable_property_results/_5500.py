...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5502, _5491
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_1.APIBase, Generic[TLinearMeasurement, TLinearDerivativeMeasurement]):
    ...
    @property
    def magnitude(self) -> '_5502.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic[TLinearMeasurement, TLinearDerivativeMeasurement]':
        ...
        return constructor.new(_5502.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)[TLinearMeasurement, TLinearDerivativeMeasurement](self.wrapped.Magnitude) if self.wrapped.Magnitude else None

    @property
    def data_points(self) -> 'List[_5491.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic[TLinearMeasurement]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPoints, constructor.new(_5491.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)[TLinearMeasurement])
        return value
