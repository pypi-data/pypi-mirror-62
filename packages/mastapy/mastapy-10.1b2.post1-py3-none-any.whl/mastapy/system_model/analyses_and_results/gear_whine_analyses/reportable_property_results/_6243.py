...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _6239
...
class SingleWhineAnalysisResultsPropertyAccessor(_1.APIBase):
    ...
    @property
    def orders(self) -> 'List[_6239.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_6239.ResultsForOrder))
        return value
