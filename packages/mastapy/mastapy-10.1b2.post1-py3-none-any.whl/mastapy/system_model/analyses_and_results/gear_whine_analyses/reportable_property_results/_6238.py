...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _6243, _6239
...
class GearWhineAnalysisResultsPropertyAccessor(_1.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_6243.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_6243.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_6239.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_6239.ResultsForOrder))
        return value
