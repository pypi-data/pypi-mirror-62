...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5180
...
class BeltConnectionGearWhineAnalysis(_5180.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2135.BeltConnectionSystemDeflection':
        ...
        return constructor.new(_2135.BeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
