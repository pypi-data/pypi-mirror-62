...
class ConceptGearMeshGearWhineAnalysis(_3799.GearMeshGearWhineAnalysis):
    '''ConceptGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2173.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2173.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
