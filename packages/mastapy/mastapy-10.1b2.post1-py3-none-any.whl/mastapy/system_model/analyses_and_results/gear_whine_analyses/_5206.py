...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5102
...
class ShaftGearWhineAnalysis(_5102.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4651.ShaftModalAnalysis':
