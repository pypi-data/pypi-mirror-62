...
class CVTGearWhineAnalysis(_3748.BeltDriveGearWhineAnalysis):
    '''CVTGearWhineAnalysis
    ...
    @property
    def assembly_design(self) -> '_2022.CVT':
    ...
    @property
    def system_deflection_results(self) -> '_2188.CVTSystemDeflection':
        ...
        return constructor.new(_2188.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
