...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5245
...
class ExcitationSourceSelectionGroup(_5245.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5245.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5245.ExcitationSourceSelectionBase))
        return value
