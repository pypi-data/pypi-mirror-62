...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5248, _5245
...
class ExcitationSourceSelection(_5245.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5248.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5248.HarmonicSelection))
        return value
