...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _6194
...
class ResultLocationSelectionGroup(_1.APIBase):
    ...
    @property
    def response_locations(self) -> 'List[_6194.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResponseLocations, constructor.new(_6194.ResultNodeSelection))
        return value
