...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _6003
...
class FESurfaceResultSelection(_6003.ResultNodeSelection):
    '''FESurfaceResultSelection
