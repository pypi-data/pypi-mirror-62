...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _6188
...
class ComponentSelection(_6188.ResultNodeSelection):
    '''ComponentSelection
