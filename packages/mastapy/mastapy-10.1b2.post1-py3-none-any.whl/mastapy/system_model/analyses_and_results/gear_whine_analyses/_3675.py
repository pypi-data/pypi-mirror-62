...
class BeltDriveGearWhineAnalysis(_3749.SpecialisedAssemblyGearWhineAnalysis):
    '''BeltDriveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2146.BeltDriveSystemDeflection':
        ...
        return constructor.new(_2146.BeltDriveSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
