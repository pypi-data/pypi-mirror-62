...
class ExternalCADModelGearWhineAnalysis(_3732.ComponentGearWhineAnalysis):
    '''ExternalCADModelGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2193.ExternalCADModelSystemDeflection':
        ...
        return constructor.new(_2193.ExternalCADModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
