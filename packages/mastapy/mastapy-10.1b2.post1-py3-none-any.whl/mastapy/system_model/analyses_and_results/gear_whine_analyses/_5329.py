...
class PlanetaryConnectionGearWhineAnalysis(_5341.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2274.PlanetaryConnectionSystemDeflection':
