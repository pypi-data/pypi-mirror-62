...
class GuideDxfModelGearWhineAnalysis(_3805.ComponentGearWhineAnalysis):
    '''GuideDxfModelGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2209.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2209.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
