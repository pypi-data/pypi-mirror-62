...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6196, _6189
...
class GearMeshTEExcitationDetail(_6189.AbstractPeriodicExcitationDetail):
    '''GearMeshTEExcitationDetail
    ...
    def get_compliance_and_force_data(self, excitation_type: '_6217.TEExcitationType') -> '_6196.ComplianceAndForceData':
        ...
        return constructor.new(_6196.ComplianceAndForceData)(method_result) if method_result else None
