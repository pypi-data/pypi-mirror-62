...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5211, _5165
...
class GearWhineAnalysisOptions(_1.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_4635.ModalAnalysisOptions':
        ...
        return constructor.new(_4635.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
