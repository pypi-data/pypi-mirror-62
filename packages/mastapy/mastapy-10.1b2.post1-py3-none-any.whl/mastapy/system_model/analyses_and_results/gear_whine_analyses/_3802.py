...
class BearingGearWhineAnalysis(_3806.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2151.BearingSystemDeflection':
        ...
        return constructor.new(_2151.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
