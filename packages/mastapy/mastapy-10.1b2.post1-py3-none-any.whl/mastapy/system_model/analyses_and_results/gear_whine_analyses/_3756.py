...
class CVTPulleyGearWhineAnalysis(_3757.PulleyGearWhineAnalysis):
    '''CVTPulleyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2187.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2187.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
