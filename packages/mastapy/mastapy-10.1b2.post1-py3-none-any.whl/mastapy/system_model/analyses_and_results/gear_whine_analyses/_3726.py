...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3701
...
class GearMeshGearWhineAnalysis(_3701.InterMountableComponentConnectionGearWhineAnalysis):
    '''GearMeshGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1806.GearMesh':
