...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3673, _3725, _3764
...
class ZerolBevelGearSetGearWhineAnalysis(_3764.BevelGearSetGearWhineAnalysis):
    '''ZerolBevelGearSetGearWhineAnalysis
    ...
    @property
    def zerol_bevel_gears_gear_whine_analysis(self) -> 'List[_3673.ZerolBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsGearWhineAnalysis, constructor.new(_3673.ZerolBevelGearGearWhineAnalysis))
        return value

    @property
    def zerol_bevel_meshes_gear_whine_analysis(self) -> 'List[_3725.ZerolBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesGearWhineAnalysis, constructor.new(_3725.ZerolBevelGearMeshGearWhineAnalysis))
        return value
