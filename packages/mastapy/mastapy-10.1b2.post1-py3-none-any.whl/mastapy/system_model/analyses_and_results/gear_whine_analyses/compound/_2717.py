...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3729
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2721
...
class BearingCompoundGearWhineAnalysis(_2721.ConnectorCompoundGearWhineAnalysis):
    '''BearingCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3729.BearingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3729.BearingGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_3729.BearingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_3729.BearingGearWhineAnalysis))
        return value
