...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2825
...
class PlanetaryGearSetCompoundGearWhineAnalysis(_2825.CylindricalGearSetCompoundGearWhineAnalysis):
    '''PlanetaryGearSetCompoundGearWhineAnalysis
