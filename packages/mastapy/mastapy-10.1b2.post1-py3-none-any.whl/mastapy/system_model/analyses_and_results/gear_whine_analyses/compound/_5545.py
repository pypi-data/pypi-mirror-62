...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5143
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5555
...
class CylindricalGearCompoundGearWhineAnalysis(_5555.GearCompoundGearWhineAnalysis):
    '''CylindricalGearCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5143.CylindricalGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5143.CylindricalGearGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5143.CylindricalGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5143.CylindricalGearGearWhineAnalysis))
        return value
