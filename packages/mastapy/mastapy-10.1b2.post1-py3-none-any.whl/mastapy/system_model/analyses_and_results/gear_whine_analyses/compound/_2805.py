...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2794
...
class RootAssemblyCompoundGearWhineAnalysis(_2794.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
