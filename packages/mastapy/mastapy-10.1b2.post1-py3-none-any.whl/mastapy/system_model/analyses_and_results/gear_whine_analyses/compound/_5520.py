...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5508
...
class BevelGearSetCompoundGearWhineAnalysis(_5508.AGMAGleasonConicalGearSetCompoundGearWhineAnalysis):
    '''BevelGearSetCompoundGearWhineAnalysis
