...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2922
...
class RootAssemblyCompoundGearWhineAnalysis(_2922.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
