...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5202
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5591
...
class RollingRingAssemblyCompoundGearWhineAnalysis(_5591.SpecialisedAssemblyCompoundGearWhineAnalysis):
    '''RollingRingAssemblyCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5202.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5202.RollingRingAssemblyGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_5202.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_5202.RollingRingAssemblyGearWhineAnalysis))
        return value
