...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5511
...
class CVTBeltConnectionCompoundGearWhineAnalysis(_5511.BeltConnectionCompoundGearWhineAnalysis):
    '''CVTBeltConnectionCompoundGearWhineAnalysis
