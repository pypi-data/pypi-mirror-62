...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5108
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5563
...
class BeltConnectionCompoundGearWhineAnalysis(_5563.InterMountableComponentConnectionCompoundGearWhineAnalysis):
    '''BeltConnectionCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5108.BeltConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5108.BeltConnectionGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5108.BeltConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5108.BeltConnectionGearWhineAnalysis))
        return value
