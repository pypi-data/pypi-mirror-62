...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2974, _3027, _2956
...
class WormGearSetCompoundGearWhineAnalysis(_2956.GearSetCompoundGearWhineAnalysis):
    '''WormGearSetCompoundGearWhineAnalysis
    ...
    @property
    def worm_gears_compound_gear_whine_analysis(self) -> 'List[_2974.WormGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundGearWhineAnalysis, constructor.new(_2974.WormGearCompoundGearWhineAnalysis))
        return value

    @property
    def worm_meshes_compound_gear_whine_analysis(self) -> 'List[_3027.WormGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundGearWhineAnalysis, constructor.new(_3027.WormGearMeshCompoundGearWhineAnalysis))
        return value
