...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2976, _3028, _2949
...
class ZerolBevelGearSetCompoundGearWhineAnalysis(_2949.BevelGearSetCompoundGearWhineAnalysis):
    '''ZerolBevelGearSetCompoundGearWhineAnalysis
    ...
    @property
    def zerol_bevel_gears_compound_gear_whine_analysis(self) -> 'List[_2976.ZerolBevelGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCompoundGearWhineAnalysis, constructor.new(_2976.ZerolBevelGearCompoundGearWhineAnalysis))
        return value

    @property
    def zerol_bevel_meshes_compound_gear_whine_analysis(self) -> 'List[_3028.ZerolBevelGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCompoundGearWhineAnalysis, constructor.new(_3028.ZerolBevelGearMeshCompoundGearWhineAnalysis))
        return value
