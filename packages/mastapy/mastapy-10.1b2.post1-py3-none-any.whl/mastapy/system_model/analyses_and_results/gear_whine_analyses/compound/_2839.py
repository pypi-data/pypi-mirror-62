...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2838, _2897, _2821
...
class SpiralBevelGearSetCompoundGearWhineAnalysis(_2821.BevelGearSetCompoundGearWhineAnalysis):
    '''SpiralBevelGearSetCompoundGearWhineAnalysis
    ...
    @property
    def spiral_bevel_gears_compound_gear_whine_analysis(self) -> 'List[_2838.SpiralBevelGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundGearWhineAnalysis, constructor.new(_2838.SpiralBevelGearCompoundGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_compound_gear_whine_analysis(self) -> 'List[_2897.SpiralBevelGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundGearWhineAnalysis, constructor.new(_2897.SpiralBevelGearMeshCompoundGearWhineAnalysis))
        return value
