...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2711
...
class CVTBeltConnectionCompoundGearWhineAnalysis(_2711.BeltConnectionCompoundGearWhineAnalysis):
    '''CVTBeltConnectionCompoundGearWhineAnalysis
