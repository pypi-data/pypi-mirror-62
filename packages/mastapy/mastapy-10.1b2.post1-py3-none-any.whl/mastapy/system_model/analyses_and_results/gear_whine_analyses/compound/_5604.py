...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5598
...
class StraightBevelPlanetGearCompoundGearWhineAnalysis(_5598.StraightBevelDiffGearCompoundGearWhineAnalysis):
    '''StraightBevelPlanetGearCompoundGearWhineAnalysis
