...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2732
...
class AbstractAssemblyCompoundGearWhineAnalysis(_2732.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
