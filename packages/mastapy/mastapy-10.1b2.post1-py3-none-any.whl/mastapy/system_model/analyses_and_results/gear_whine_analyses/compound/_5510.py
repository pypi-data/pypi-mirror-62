...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5107
...
class BearingCompoundGearWhineAnalysis(_5538.ConnectorCompoundGearWhineAnalysis):
    '''BearingCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5107.BearingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5107.BearingGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5107.BearingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5107.BearingGearWhineAnalysis))
        return value
