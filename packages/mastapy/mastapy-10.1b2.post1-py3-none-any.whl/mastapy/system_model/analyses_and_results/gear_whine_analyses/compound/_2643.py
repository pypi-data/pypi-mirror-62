...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2632
...
class RootAssemblyCompoundGearWhineAnalysis(_2632.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
