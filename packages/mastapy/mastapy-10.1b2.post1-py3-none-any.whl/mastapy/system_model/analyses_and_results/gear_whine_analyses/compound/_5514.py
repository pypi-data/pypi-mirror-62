...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5111
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5519
...
class BevelDifferentialGearMeshCompoundGearWhineAnalysis(_5519.BevelGearMeshCompoundGearWhineAnalysis):
    '''BevelDifferentialGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5111.BevelDifferentialGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5111.BevelDifferentialGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5111.BevelDifferentialGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5111.BevelDifferentialGearMeshGearWhineAnalysis))
        return value
