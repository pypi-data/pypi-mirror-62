...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5557
...
class ConicalGearSetCompoundGearWhineAnalysis(_5557.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
