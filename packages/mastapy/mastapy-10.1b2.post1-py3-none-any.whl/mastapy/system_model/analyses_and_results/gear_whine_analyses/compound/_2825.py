...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2824, _2892, _2828
...
class CylindricalGearSetCompoundGearWhineAnalysis(_2828.GearSetCompoundGearWhineAnalysis):
    '''CylindricalGearSetCompoundGearWhineAnalysis
    ...
    @property
    def cylindrical_gears_compound_gear_whine_analysis(self) -> 'List[_2824.CylindricalGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundGearWhineAnalysis, constructor.new(_2824.CylindricalGearCompoundGearWhineAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_gear_whine_analysis(self) -> 'List[_2892.CylindricalGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundGearWhineAnalysis, constructor.new(_2892.CylindricalGearMeshCompoundGearWhineAnalysis))
        return value
