...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2801
...
class AbstractAssemblyCompoundGearWhineAnalysis(_2801.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
