...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2816, _2885, _2821
...
class BevelDifferentialGearSetCompoundGearWhineAnalysis(_2821.BevelGearSetCompoundGearWhineAnalysis):
    '''BevelDifferentialGearSetCompoundGearWhineAnalysis
    ...
    @property
    def bevel_differential_gears_compound_gear_whine_analysis(self) -> 'List[_2816.BevelDifferentialGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsCompoundGearWhineAnalysis, constructor.new(_2816.BevelDifferentialGearCompoundGearWhineAnalysis))
        return value

    @property
    def bevel_differential_meshes_compound_gear_whine_analysis(self) -> 'List[_2885.BevelDifferentialGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesCompoundGearWhineAnalysis, constructor.new(_2885.BevelDifferentialGearMeshCompoundGearWhineAnalysis))
        return value
