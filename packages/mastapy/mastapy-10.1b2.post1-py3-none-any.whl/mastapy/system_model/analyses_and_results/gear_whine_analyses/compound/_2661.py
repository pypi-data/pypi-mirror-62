...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2666
...
class ConicalGearSetCompoundGearWhineAnalysis(_2666.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
