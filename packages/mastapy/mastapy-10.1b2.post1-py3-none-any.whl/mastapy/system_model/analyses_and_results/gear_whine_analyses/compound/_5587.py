...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5509
...
class RootAssemblyCompoundGearWhineAnalysis(_5509.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
