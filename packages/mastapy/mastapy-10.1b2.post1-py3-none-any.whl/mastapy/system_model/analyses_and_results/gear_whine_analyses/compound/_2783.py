...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3677
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2787
...
class ClutchHalfCompoundGearWhineAnalysis(_2787.CouplingHalfCompoundGearWhineAnalysis):
    '''ClutchHalfCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3677.ClutchHalfGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3677.ClutchHalfGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_3677.ClutchHalfGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_3677.ClutchHalfGearWhineAnalysis))
        return value
