...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2622
...
class SpecialisedAssemblyCompoundGearWhineAnalysis(_2622.AbstractAssemblyCompoundGearWhineAnalysis):
    '''SpecialisedAssemblyCompoundGearWhineAnalysis
