...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2784
...
class SpecialisedAssemblyCompoundGearWhineAnalysis(_2784.AbstractAssemblyCompoundGearWhineAnalysis):
    '''SpecialisedAssemblyCompoundGearWhineAnalysis
