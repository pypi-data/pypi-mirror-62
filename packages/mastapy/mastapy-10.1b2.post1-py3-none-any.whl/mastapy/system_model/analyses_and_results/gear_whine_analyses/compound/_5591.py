...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5504
...
class SpecialisedAssemblyCompoundGearWhineAnalysis(_5504.AbstractAssemblyCompoundGearWhineAnalysis):
    '''SpecialisedAssemblyCompoundGearWhineAnalysis
