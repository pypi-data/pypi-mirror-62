...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2953
...
class PlanetaryGearSetCompoundGearWhineAnalysis(_2953.CylindricalGearSetCompoundGearWhineAnalysis):
    '''PlanetaryGearSetCompoundGearWhineAnalysis
