...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2652
...
class HypoidGearCompoundGearWhineAnalysis(_2652.AGMAGleasonConicalGearCompoundGearWhineAnalysis):
    '''HypoidGearCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3838.HypoidGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3838.HypoidGearGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_3838.HypoidGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_3838.HypoidGearGearWhineAnalysis))
        return value
