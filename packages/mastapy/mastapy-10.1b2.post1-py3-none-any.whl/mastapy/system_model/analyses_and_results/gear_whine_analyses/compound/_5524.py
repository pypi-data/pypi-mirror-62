...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5120
...
class ClutchConnectionCompoundGearWhineAnalysis(_5540.CouplingConnectionCompoundGearWhineAnalysis):
    '''ClutchConnectionCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5120.ClutchConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5120.ClutchConnectionGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5120.ClutchConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5120.ClutchConnectionGearWhineAnalysis))
        return value
