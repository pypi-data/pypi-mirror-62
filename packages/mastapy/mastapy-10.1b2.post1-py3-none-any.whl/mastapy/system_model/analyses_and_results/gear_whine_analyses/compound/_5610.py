...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5231
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5539
...
class TorqueConverterCompoundGearWhineAnalysis(_5539.CouplingCompoundGearWhineAnalysis):
    '''TorqueConverterCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5231.TorqueConverterGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5231.TorqueConverterGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_5231.TorqueConverterGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_5231.TorqueConverterGearWhineAnalysis))
        return value
