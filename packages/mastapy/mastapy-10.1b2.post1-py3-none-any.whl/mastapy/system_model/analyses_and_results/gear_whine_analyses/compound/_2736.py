...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2725
...
class RootAssemblyCompoundGearWhineAnalysis(_2725.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
