...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2859
...
class CVTPulleyCompoundGearWhineAnalysis(_2859.PulleyCompoundGearWhineAnalysis):
    '''CVTPulleyCompoundGearWhineAnalysis
