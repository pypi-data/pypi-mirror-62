...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5207
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5538
...
class ShaftHubConnectionCompoundGearWhineAnalysis(_5538.ConnectorCompoundGearWhineAnalysis):
    '''ShaftHubConnectionCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5207.ShaftHubConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5207.ShaftHubConnectionGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5207.ShaftHubConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5207.ShaftHubConnectionGearWhineAnalysis))
        return value
