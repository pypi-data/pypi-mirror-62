...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _3001
...
class CVTBeltConnectionCompoundGearWhineAnalysis(_3001.BeltConnectionCompoundGearWhineAnalysis):
    '''CVTBeltConnectionCompoundGearWhineAnalysis
