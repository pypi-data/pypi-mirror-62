...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2759
...
class ConicalGearSetCompoundGearWhineAnalysis(_2759.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
