...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3734
...
class DatumCompoundGearWhineAnalysis(_2720.ComponentCompoundGearWhineAnalysis):
    '''DatumCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3734.DatumGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3734.DatumGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_3734.DatumGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_3734.DatumGearWhineAnalysis))
        return value
