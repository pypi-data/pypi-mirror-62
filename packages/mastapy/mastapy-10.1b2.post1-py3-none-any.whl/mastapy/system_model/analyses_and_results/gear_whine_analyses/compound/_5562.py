...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5179
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5505
...
class ImportedFEComponentCompoundGearWhineAnalysis(_5505.AbstractShaftOrHousingCompoundGearWhineAnalysis):
    '''ImportedFEComponentCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5179.ImportedFEComponentGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5179.ImportedFEComponentGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5179.ImportedFEComponentGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5179.ImportedFEComponentGearWhineAnalysis))
        return value
