...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5648
...
class RootAssemblyCompoundGearWhineAnalysis(_5648.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
