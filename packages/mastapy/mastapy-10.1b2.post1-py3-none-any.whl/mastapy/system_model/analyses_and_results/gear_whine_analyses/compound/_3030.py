...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _3005
...
class GearMeshCompoundGearWhineAnalysis(_3005.InterMountableComponentConnectionCompoundGearWhineAnalysis):
    '''GearMeshCompoundGearWhineAnalysis
