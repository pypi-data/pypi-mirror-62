...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2678
...
class StraightBevelPlanetGearCompoundGearWhineAnalysis(_2678.StraightBevelDiffGearCompoundGearWhineAnalysis):
    '''StraightBevelPlanetGearCompoundGearWhineAnalysis
