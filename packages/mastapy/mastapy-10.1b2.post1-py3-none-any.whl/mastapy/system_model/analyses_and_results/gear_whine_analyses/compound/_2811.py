...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2810, _2886, _2828
...
class ConceptGearSetCompoundGearWhineAnalysis(_2828.GearSetCompoundGearWhineAnalysis):
    '''ConceptGearSetCompoundGearWhineAnalysis
    ...
    @property
    def concept_gears_compound_gear_whine_analysis(self) -> 'List[_2810.ConceptGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundGearWhineAnalysis, constructor.new(_2810.ConceptGearCompoundGearWhineAnalysis))
        return value

    @property
    def concept_meshes_compound_gear_whine_analysis(self) -> 'List[_2886.ConceptGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundGearWhineAnalysis, constructor.new(_2886.ConceptGearMeshCompoundGearWhineAnalysis))
        return value
