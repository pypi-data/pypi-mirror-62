...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5647
...
class BevelGearSetCompoundGearWhineAnalysis(_5647.AGMAGleasonConicalGearSetCompoundGearWhineAnalysis):
    '''BevelGearSetCompoundGearWhineAnalysis
