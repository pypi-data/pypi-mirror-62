...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2873
...
class CVTBeltConnectionCompoundGearWhineAnalysis(_2873.BeltConnectionCompoundGearWhineAnalysis):
    '''CVTBeltConnectionCompoundGearWhineAnalysis
