...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3731
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2737
...
class BoltedJointCompoundGearWhineAnalysis(_2737.SpecialisedAssemblyCompoundGearWhineAnalysis):
    '''BoltedJointCompoundGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1860.BoltedJoint':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3731.BoltedJointGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3731.BoltedJointGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_3731.BoltedJointGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_3731.BoltedJointGearWhineAnalysis))
        return value
