...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _3003
...
class ShaftToMountableComponentConnectionCompoundGearWhineAnalysis(_3003.ConnectionCompoundGearWhineAnalysis):
    '''ShaftToMountableComponentConnectionCompoundGearWhineAnalysis
