...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3675
...
class BeltDriveCompoundGearWhineAnalysis(_2737.SpecialisedAssemblyCompoundGearWhineAnalysis):
    '''BeltDriveCompoundGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1918.BeltDrive':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3675.BeltDriveGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3675.BeltDriveGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_3675.BeltDriveGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_3675.BeltDriveGearWhineAnalysis))
        return value
