...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2827
...
class ConceptGearCompoundGearWhineAnalysis(_2827.GearCompoundGearWhineAnalysis):
    '''ConceptGearCompoundGearWhineAnalysis
