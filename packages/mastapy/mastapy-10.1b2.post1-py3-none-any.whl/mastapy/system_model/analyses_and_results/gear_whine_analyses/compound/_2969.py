...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2968, _3016, _2949
...
class StraightBevelDiffGearSetCompoundGearWhineAnalysis(_2949.BevelGearSetCompoundGearWhineAnalysis):
    '''StraightBevelDiffGearSetCompoundGearWhineAnalysis
    ...
    @property
    def straight_bevel_diff_gears_compound_gear_whine_analysis(self) -> 'List[_2968.StraightBevelDiffGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundGearWhineAnalysis, constructor.new(_2968.StraightBevelDiffGearCompoundGearWhineAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_compound_gear_whine_analysis(self) -> 'List[_3016.StraightBevelDiffGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundGearWhineAnalysis, constructor.new(_3016.StraightBevelDiffGearMeshCompoundGearWhineAnalysis))
        return value
