...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2663
...
class PlanetaryGearSetCompoundGearWhineAnalysis(_2663.CylindricalGearSetCompoundGearWhineAnalysis):
    '''PlanetaryGearSetCompoundGearWhineAnalysis
