...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5177
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5507
...
class HypoidGearMeshCompoundGearWhineAnalysis(_5507.AGMAGleasonConicalGearMeshCompoundGearWhineAnalysis):
    '''HypoidGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5177.HypoidGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5177.HypoidGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5177.HypoidGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5177.HypoidGearMeshGearWhineAnalysis))
        return value
