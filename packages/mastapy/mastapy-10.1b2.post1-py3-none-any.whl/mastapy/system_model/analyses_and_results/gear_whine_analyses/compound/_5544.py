...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5583
...
class CVTPulleyCompoundGearWhineAnalysis(_5583.PulleyCompoundGearWhineAnalysis):
    '''CVTPulleyCompoundGearWhineAnalysis
