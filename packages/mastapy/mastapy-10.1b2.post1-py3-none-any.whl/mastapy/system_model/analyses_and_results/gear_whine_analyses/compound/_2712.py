...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2717
...
class CoaxialConnectionCompoundGearWhineAnalysis(_2717.ShaftToMountableComponentConnectionCompoundGearWhineAnalysis):
    '''CoaxialConnectionCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3765.CoaxialConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3765.CoaxialConnectionGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_3765.CoaxialConnectionGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_3765.CoaxialConnectionGearWhineAnalysis))
        return value
