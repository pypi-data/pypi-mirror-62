...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2987
...
class CVTPulleyCompoundGearWhineAnalysis(_2987.PulleyCompoundGearWhineAnalysis):
    '''CVTPulleyCompoundGearWhineAnalysis
