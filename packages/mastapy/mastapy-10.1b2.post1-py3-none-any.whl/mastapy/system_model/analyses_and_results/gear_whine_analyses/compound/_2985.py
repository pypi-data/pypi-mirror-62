...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2978
...
class CVTCompoundGearWhineAnalysis(_2978.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
