...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2943
...
class BevelGearSetCompoundGearWhineAnalysis(_2943.AGMAGleasonConicalGearSetCompoundGearWhineAnalysis):
    '''BevelGearSetCompoundGearWhineAnalysis
