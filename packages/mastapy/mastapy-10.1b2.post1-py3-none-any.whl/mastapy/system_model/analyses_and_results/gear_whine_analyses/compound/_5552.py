...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5162
...
class FaceGearMeshCompoundGearWhineAnalysis(_5556.GearMeshCompoundGearWhineAnalysis):
    '''FaceGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5162.FaceGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5162.FaceGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5162.FaceGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5162.FaceGearMeshGearWhineAnalysis))
        return value
