...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2639
...
class AbstractAssemblyCompoundGearWhineAnalysis(_2639.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
