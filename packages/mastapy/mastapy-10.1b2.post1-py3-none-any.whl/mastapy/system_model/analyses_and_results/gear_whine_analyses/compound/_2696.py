...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2697
...
class CVTPulleyCompoundGearWhineAnalysis(_2697.PulleyCompoundGearWhineAnalysis):
    '''CVTPulleyCompoundGearWhineAnalysis
