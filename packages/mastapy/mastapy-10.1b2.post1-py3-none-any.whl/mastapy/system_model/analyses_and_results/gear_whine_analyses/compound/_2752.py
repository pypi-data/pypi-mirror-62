...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2746
...
class BevelGearSetCompoundGearWhineAnalysis(_2746.AGMAGleasonConicalGearSetCompoundGearWhineAnalysis):
    '''BevelGearSetCompoundGearWhineAnalysis
