...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5129
...
class ConceptGearCompoundGearWhineAnalysis(_5555.GearCompoundGearWhineAnalysis):
    '''ConceptGearCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5129.ConceptGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5129.ConceptGearGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5129.ConceptGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5129.ConceptGearGearWhineAnalysis))
        return value
