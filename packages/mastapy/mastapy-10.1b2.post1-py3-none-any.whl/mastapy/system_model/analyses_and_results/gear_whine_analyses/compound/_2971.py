...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2970, _3026, _2949
...
class StraightBevelGearSetCompoundGearWhineAnalysis(_2949.BevelGearSetCompoundGearWhineAnalysis):
    '''StraightBevelGearSetCompoundGearWhineAnalysis
    ...
    @property
    def straight_bevel_gears_compound_gear_whine_analysis(self) -> 'List[_2970.StraightBevelGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundGearWhineAnalysis, constructor.new(_2970.StraightBevelGearCompoundGearWhineAnalysis))
        return value

    @property
    def straight_bevel_meshes_compound_gear_whine_analysis(self) -> 'List[_3026.StraightBevelGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundGearWhineAnalysis, constructor.new(_3026.StraightBevelGearMeshCompoundGearWhineAnalysis))
        return value
