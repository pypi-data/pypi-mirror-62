...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2828
...
class ConicalGearSetCompoundGearWhineAnalysis(_2828.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
