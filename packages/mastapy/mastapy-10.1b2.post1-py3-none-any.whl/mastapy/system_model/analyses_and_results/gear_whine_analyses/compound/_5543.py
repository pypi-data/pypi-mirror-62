...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5512
...
class CVTCompoundGearWhineAnalysis(_5512.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
