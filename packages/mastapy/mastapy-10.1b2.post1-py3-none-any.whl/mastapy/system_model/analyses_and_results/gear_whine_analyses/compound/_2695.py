...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2688
...
class CVTCompoundGearWhineAnalysis(_2688.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
