...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2956
...
class ConicalGearSetCompoundGearWhineAnalysis(_2956.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
