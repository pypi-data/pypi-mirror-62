...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5547
...
class PlanetaryGearSetCompoundGearWhineAnalysis(_5547.CylindricalGearSetCompoundGearWhineAnalysis):
    '''PlanetaryGearSetCompoundGearWhineAnalysis
