...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5577
...
class AbstractAssemblyCompoundGearWhineAnalysis(_5577.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
