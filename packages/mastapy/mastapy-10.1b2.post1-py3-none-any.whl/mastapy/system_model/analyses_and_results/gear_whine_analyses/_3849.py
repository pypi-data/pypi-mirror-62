...
class KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis(_3847.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2222.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2222.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
