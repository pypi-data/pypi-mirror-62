...
class StraightBevelDiffGearMeshGearWhineAnalysis(_3714.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelDiffGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2290.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2290.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
