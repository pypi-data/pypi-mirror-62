...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6216
...
class GeneralPeriodicExcitationDetail(_6216.SingleNodePeriodicExcitationWithReferenceShaft):
    '''GeneralPeriodicExcitationDetail
