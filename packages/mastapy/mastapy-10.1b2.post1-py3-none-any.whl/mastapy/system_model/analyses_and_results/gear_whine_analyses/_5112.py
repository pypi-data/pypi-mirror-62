...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5110, _5111, _5117
...
class BevelDifferentialGearSetGearWhineAnalysis(_5117.BevelGearSetGearWhineAnalysis):
    '''BevelDifferentialGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2138.BevelDifferentialGearSetSystemDeflection':
        ...
        return constructor.new(_2138.BevelDifferentialGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def bevel_differential_gears_gear_whine_analysis(self) -> 'List[_5110.BevelDifferentialGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsGearWhineAnalysis, constructor.new(_5110.BevelDifferentialGearGearWhineAnalysis))
        return value

    @property
    def bevel_differential_meshes_gear_whine_analysis(self) -> 'List[_5111.BevelDifferentialGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesGearWhineAnalysis, constructor.new(_5111.BevelDifferentialGearMeshGearWhineAnalysis))
        return value
