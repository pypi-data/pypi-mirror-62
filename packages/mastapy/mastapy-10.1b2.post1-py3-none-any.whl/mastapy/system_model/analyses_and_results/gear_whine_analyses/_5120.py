...
class ClutchConnectionGearWhineAnalysis(_5137.CouplingConnectionGearWhineAnalysis):
    '''ClutchConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2147.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2147.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
