...
class RollingRingConnectionGearWhineAnalysis(_3701.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2231.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2231.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
