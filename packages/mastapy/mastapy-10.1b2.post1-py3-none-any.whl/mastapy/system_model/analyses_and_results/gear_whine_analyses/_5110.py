...
class BevelDifferentialGearGearWhineAnalysis(_5115.BevelGearGearWhineAnalysis):
    '''BevelDifferentialGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2139.BevelDifferentialGearSystemDeflection':
        ...
        return constructor.new(_2139.BevelDifferentialGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
