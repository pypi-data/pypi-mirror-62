...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5101
...
class PeriodicExcitationWithReferenceShaft(_5101.AbstractPeriodicExcitationDetail):
    '''PeriodicExcitationWithReferenceShaft
