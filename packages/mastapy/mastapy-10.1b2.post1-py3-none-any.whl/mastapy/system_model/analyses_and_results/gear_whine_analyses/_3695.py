...
class TorqueConverterPumpGearWhineAnalysis(_3681.CouplingHalfGearWhineAnalysis):
    '''TorqueConverterPumpGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2267.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2267.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
