...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6215
...
class SingleNodePeriodicExcitationWithReferenceShaft(_6215.PeriodicExcitationWithReferenceShaft):
    '''SingleNodePeriodicExcitationWithReferenceShaft
