...
from mastapy.system_model.connections_and_sockets import _1766
...
class CVTBeltConnectionGearWhineAnalysis(_5108.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1766.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2168.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2168.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
