...
class StraightBevelGearMeshGearWhineAnalysis(_3787.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2310.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2310.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
