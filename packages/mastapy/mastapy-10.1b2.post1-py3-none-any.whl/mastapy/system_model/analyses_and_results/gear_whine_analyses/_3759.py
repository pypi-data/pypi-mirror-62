...
class RollingRingGearWhineAnalysis(_3754.CouplingHalfGearWhineAnalysis):
    '''RollingRingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2247.RollingRingSystemDeflection':
        ...
        return constructor.new(_2247.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
