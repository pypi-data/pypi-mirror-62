...
class SpringDamperConnectionGearWhineAnalysis(_3780.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2291.SpringDamperConnectionSystemDeflection':
