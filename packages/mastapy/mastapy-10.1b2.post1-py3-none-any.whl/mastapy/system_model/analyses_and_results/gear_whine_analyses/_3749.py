...
class ClutchGearWhineAnalysis(_3753.CouplingGearWhineAnalysis):
    '''ClutchGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2166.ClutchSystemDeflection':
        ...
        return constructor.new(_2166.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
