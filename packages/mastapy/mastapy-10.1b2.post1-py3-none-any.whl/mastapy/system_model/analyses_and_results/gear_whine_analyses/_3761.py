...
class SpringDamperGearWhineAnalysis(_3753.CouplingGearWhineAnalysis):
    '''SpringDamperGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2261.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2261.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
