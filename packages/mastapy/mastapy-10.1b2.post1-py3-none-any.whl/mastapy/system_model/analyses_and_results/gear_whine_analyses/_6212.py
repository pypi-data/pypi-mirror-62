...
from mastapy.system_model.analyses_and_results.modal_analyses import _5898
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6192, _6191
...
class GearWhineAnalysisOptions(_1.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_5898.ModalAnalysisOptions':
        ...
        return constructor.new(_5898.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
