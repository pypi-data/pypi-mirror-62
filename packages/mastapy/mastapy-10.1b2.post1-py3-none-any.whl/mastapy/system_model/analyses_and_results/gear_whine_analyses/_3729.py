...
class BearingGearWhineAnalysis(_3733.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2144.BearingSystemDeflection':
        ...
        return constructor.new(_2144.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
