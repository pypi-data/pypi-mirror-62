...
class UnbalancedMassGearWhineAnalysis(_3824.VirtualComponentGearWhineAnalysis):
    '''UnbalancedMassGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2341.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2341.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
