...
class SpringDamperGearWhineAnalysis(_3680.CouplingGearWhineAnalysis):
    '''SpringDamperGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2253.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2253.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
