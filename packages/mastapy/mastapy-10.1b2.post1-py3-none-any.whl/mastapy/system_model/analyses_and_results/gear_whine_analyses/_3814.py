...
class MeasurementComponentGearWhineAnalysis(_3824.VirtualComponentGearWhineAnalysis):
    '''MeasurementComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2230.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2230.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
