...
class FlexiblePinAssemblyGearWhineAnalysis(_5210.SpecialisedAssemblyGearWhineAnalysis):
    '''FlexiblePinAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2187.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2187.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
