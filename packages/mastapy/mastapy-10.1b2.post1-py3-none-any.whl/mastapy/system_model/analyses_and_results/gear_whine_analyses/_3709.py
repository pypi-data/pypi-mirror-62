...
class TorqueConverterConnectionGearWhineAnalysis(_3707.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2285.TorqueConverterConnectionSystemDeflection':
        ...
        return constructor.new(_2285.TorqueConverterConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
