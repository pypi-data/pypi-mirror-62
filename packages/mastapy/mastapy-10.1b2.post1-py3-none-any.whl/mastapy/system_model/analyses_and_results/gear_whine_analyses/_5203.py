...
class RollingRingConnectionGearWhineAnalysis(_5180.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2220.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2220.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
