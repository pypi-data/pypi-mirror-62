...
class ShaftGearWhineAnalysis(_3801.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_3943.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2076.ShaftSystemDeflection':
        ...
        return constructor.new(_2076.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
