...
from mastapy.system_model.analyses_and_results.static_loads import _6021
from mastapy._internal import conversion, constructor
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5124, _5101
...
class GearMeshTEExcitationDetail(_5101.AbstractPeriodicExcitationDetail):
    '''GearMeshTEExcitationDetail
    ...
    def get_compliance_and_force_data(self, excitation_type: '_6021.TEExcitationType') -> '_5124.ComplianceAndForceData':
        ...
        return constructor.new(_5124.ComplianceAndForceData)(method_result) if method_result else None
