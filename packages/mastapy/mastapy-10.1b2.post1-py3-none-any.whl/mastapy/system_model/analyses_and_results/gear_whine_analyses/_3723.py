...
class StraightBevelGearMeshGearWhineAnalysis(_3714.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2302.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2302.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
