...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3746, _3798, _3837
...
class ZerolBevelGearSetGearWhineAnalysis(_3837.BevelGearSetGearWhineAnalysis):
    '''ZerolBevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2232.ZerolBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2232.ZerolBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def zerol_bevel_gears_gear_whine_analysis(self) -> 'List[_3746.ZerolBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsGearWhineAnalysis, constructor.new(_3746.ZerolBevelGearGearWhineAnalysis))
        return value

    @property
    def zerol_bevel_meshes_gear_whine_analysis(self) -> 'List[_3798.ZerolBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesGearWhineAnalysis, constructor.new(_3798.ZerolBevelGearMeshGearWhineAnalysis))
        return value
