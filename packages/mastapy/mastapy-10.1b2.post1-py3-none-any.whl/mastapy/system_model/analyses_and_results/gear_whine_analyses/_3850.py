...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3849, _3793, _3848
...
class KlingelnbergCycloPalloidHypoidGearSetGearWhineAnalysis(_3848.KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2221.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
        ...
        return constructor.new(_2221.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_gear_whine_analysis(self) -> 'List[_3849.KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsGearWhineAnalysis, constructor.new(_3849.KlingelnbergCycloPalloidHypoidGearGearWhineAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_gear_whine_analysis(self) -> 'List[_3793.KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesGearWhineAnalysis, constructor.new(_3793.KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis))
        return value
