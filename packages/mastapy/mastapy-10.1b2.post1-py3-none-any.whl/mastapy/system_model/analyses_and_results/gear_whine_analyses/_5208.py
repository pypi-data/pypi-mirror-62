...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5135
...
class ShaftToMountableComponentConnectionGearWhineAnalysis(_5135.ConnectionGearWhineAnalysis):
    '''ShaftToMountableComponentConnectionGearWhineAnalysis
