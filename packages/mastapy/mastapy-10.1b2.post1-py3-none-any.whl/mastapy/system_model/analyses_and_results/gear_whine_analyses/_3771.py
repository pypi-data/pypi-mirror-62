...
class BeltConnectionGearWhineAnalysis(_3774.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2152.BeltConnectionSystemDeflection':
        ...
        return constructor.new(_2152.BeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
