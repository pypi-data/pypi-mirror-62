...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6210, _3810
...
class RootAssemblyGearWhineAnalysis(_3810.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_6210.GearWhineAnalysis':
        ...
        return constructor.new(_6210.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None

    @property
    def system_deflection_results(self) -> '_2248.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2248.RootAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
