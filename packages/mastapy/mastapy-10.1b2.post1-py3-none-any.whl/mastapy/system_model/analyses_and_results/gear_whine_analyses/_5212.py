...
class SpiralBevelGearGearWhineAnalysis(_5115.BevelGearGearWhineAnalysis):
    '''SpiralBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2231.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2231.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
