...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5171, _5102
from mastapy.system_model.part_model import _1926
from mastapy.system_model.analyses_and_results.static_loads import _5964
...
class ImportedFEComponentGearWhineAnalysis(_5102.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4619.ImportedFEComponentModalAnalysis':
    ...
    @property
    def export(self) -> '_5171.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5171.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def component_load_case(self) -> '_5964.ImportedFEComponentLoadCase':
        ...
        return constructor.new(_5964.ImportedFEComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2195.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2195.ImportedFEComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
