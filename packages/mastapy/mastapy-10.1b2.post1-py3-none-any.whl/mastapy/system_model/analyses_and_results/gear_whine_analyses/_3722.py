...
class SpiralBevelGearMeshGearWhineAnalysis(_3714.BevelGearMeshGearWhineAnalysis):
    '''SpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2300.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2300.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
