...
class BoltGearWhineAnalysis(_3732.ComponentGearWhineAnalysis):
    '''BoltGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2156.BoltSystemDeflection':
        ...
        return constructor.new(_2156.BoltSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
