...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3858, _3796, _3837
...
class StraightBevelGearSetGearWhineAnalysis(_3837.BevelGearSetGearWhineAnalysis):
    '''StraightBevelGearSetGearWhineAnalysis
    ...
    @property
    def straight_bevel_gears_gear_whine_analysis(self) -> 'List[_3858.StraightBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsGearWhineAnalysis, constructor.new(_3858.StraightBevelGearGearWhineAnalysis))
        return value

    @property
    def straight_bevel_meshes_gear_whine_analysis(self) -> 'List[_3796.StraightBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesGearWhineAnalysis, constructor.new(_3796.StraightBevelGearMeshGearWhineAnalysis))
        return value
