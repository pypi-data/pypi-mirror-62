...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4920, _4919
...
class ParametricStudyVariable(_2116.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4920.ParametricStudyDimension':
        ...
        return constructor.new(_4920.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4920.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4919.MonteCarloDistribution':
        ...
        return constructor.new(_4919.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4919.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
