...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3983, _4035, _4074
...
class ZerolBevelGearSetParametricStudyTool(_4074.BevelGearSetParametricStudyTool):
    '''ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_3983.ZerolBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsParametricStudyTool, constructor.new(_3983.ZerolBevelGearParametricStudyTool))
        return value

    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4035.ZerolBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesParametricStudyTool, constructor.new(_4035.ZerolBevelGearMeshParametricStudyTool))
        return value
