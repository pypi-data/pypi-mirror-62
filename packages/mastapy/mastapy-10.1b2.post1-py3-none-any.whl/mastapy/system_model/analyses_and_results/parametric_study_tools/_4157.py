...
class StraightBevelDiffGearParametricStudyTool(_4137.BevelGearParametricStudyTool):
    '''StraightBevelDiffGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2366.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2366.StraightBevelDiffGearSystemDeflection))
        return value
