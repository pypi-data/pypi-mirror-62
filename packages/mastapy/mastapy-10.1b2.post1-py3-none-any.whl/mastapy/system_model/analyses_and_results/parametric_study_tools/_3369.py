...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3357
...
class BevelGearSetParametricStudyTool(_3357.AGMAGleasonConicalGearSetParametricStudyTool):
    '''BevelGearSetParametricStudyTool
