...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4133, _4084, _4138
...
class BevelDifferentialGearSetParametricStudyTool(_4138.BevelGearSetParametricStudyTool):
    '''BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4133.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsParametricStudyTool, constructor.new(_4133.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4084.BevelDifferentialGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesParametricStudyTool, constructor.new(_4084.BevelDifferentialGearMeshParametricStudyTool))
        return value
