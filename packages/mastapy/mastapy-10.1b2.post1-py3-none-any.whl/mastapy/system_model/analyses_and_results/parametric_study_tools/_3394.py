...
class CylindricalGearMeshParametricStudyTool(_3410.GearMeshParametricStudyTool):
    '''CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2171.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2171.CylindricalGearMeshSystemDeflection))
        return value
