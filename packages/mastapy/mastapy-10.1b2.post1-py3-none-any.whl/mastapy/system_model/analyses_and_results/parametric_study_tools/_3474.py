...
from mastapy.system_model.analyses_and_results.analysis_cases import _6462
...
class ConnectionParametricStudyTool(_6462.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3526.ParametricStudyTool':
        ...
        return constructor.new(_3526.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
