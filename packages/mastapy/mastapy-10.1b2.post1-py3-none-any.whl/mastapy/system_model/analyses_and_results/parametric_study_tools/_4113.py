...
class ImportedFEComponentParametricStudyTool(_4102.AbstractShaftOrHousingParametricStudyTool):
    '''ImportedFEComponentParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2290.ImportedFEComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2290.ImportedFEComponentSystemDeflection))
        return value
