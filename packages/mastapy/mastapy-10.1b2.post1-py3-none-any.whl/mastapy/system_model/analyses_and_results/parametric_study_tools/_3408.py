...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3407, _3406, _3412
...
class FaceGearSetParametricStudyTool(_3412.GearSetParametricStudyTool):
    '''FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_3407.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsParametricStudyTool, constructor.new(_3407.FaceGearParametricStudyTool))
        return value

    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_3406.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesParametricStudyTool, constructor.new(_3406.FaceGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2185.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2185.FaceGearSetSystemDeflection))
        return value
