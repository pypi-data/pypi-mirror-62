...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3368
...
class BevelDifferentialGearParametricStudyTool(_3368.BevelGearParametricStudyTool):
    '''BevelDifferentialGearParametricStudyTool
