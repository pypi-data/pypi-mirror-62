...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3411
...
class CylindricalGearParametricStudyTool(_3411.GearParametricStudyTool):
    '''CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2177.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2177.CylindricalGearSystemDeflection))
        return value
