...
class MeasurementComponentParametricStudyTool(_4125.VirtualComponentParametricStudyTool):
    '''MeasurementComponentParametricStudyTool
    ...
    @property
    def component_load_case(self) -> '_2295.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2295.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2294.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2294.MeasurementComponentSystemDeflection))
        return value
