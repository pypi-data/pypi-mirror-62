...
class GearParametricStudyTool(_4052.MountableComponentParametricStudyTool):
    '''GearParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_337.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_337.GearDutyCycleRating))
        return value
