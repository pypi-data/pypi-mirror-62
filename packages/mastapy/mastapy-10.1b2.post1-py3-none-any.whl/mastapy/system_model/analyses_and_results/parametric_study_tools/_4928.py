...
from mastapy.system_model.analyses_and_results.static_loads import _4931, _4932
from mastapy.system_model import _1737
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4929, _4930
...
class ParametricStudyToolOptions(_1.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_4932.ParametricStudyType':
        ...
        return constructor.new(_4932.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_4932.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1737.ExternalFullFELoader':
        ...
        return constructor.new(_1737.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4929.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4929.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4930.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4930.ParametricStudyVariable))
        return value
