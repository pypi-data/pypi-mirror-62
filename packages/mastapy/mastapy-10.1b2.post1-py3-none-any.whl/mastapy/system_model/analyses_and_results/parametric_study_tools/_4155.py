...
class SpiralBevelGearParametricStudyTool(_4137.BevelGearParametricStudyTool):
    '''SpiralBevelGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2362.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2362.SpiralBevelGearSystemDeflection))
        return value
