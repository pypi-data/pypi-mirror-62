...
class PlanetCarrierParametricStudyTool(_4116.MountableComponentParametricStudyTool):
    '''PlanetCarrierParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2302.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2302.PlanetCarrierSystemDeflection))
        return value
