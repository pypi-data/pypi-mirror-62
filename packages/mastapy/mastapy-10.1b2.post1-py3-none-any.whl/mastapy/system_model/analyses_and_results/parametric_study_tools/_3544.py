...
class ShaftHubConnectionParametricStudyTool(_3475.ConnectorParametricStudyTool):
    '''ShaftHubConnectionParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2283.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2283.ShaftHubConnectionSystemDeflection))
        return value
