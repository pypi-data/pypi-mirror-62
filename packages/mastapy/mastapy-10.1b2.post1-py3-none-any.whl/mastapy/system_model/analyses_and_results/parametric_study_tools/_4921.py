...
class ParametricStudyDOEResultVariable(_1242.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1244.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1244.PropertyTargetForDominantCandidateSearch'):
