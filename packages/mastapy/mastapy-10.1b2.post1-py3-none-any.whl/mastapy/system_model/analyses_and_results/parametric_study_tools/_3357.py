...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3385
...
class AGMAGleasonConicalGearSetParametricStudyTool(_3385.ConicalGearSetParametricStudyTool):
    '''AGMAGleasonConicalGearSetParametricStudyTool
