...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4099, _4034, _4081
...
class WormGearSetParametricStudyTool(_4081.GearSetParametricStudyTool):
    '''WormGearSetParametricStudyTool
    ...
    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4034.WormGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesParametricStudyTool, constructor.new(_4034.WormGearMeshParametricStudyTool))
        return value
