...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3442
...
class ShaftParametricStudyTool(_3442.AbstractShaftOrHousingParametricStudyTool):
    '''ShaftParametricStudyTool
    ...
    @property
    def shaft_duty_cycle_results(self) -> 'List[_20.ShaftDamageResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDutyCycleResults, constructor.new(_20.ShaftDamageResults))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2286.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2286.ShaftSystemDeflection))
        return value
