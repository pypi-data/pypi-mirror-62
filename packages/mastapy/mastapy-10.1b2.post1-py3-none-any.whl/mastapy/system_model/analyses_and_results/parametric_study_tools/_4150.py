...
class KlingelnbergCycloPalloidHypoidGearParametricStudyTool(_4148.KlingelnbergCycloPalloidConicalGearParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2353.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2353.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value
