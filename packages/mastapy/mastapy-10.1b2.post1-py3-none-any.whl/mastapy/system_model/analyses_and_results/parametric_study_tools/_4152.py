...
class KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool(_4148.KlingelnbergCycloPalloidConicalGearParametricStudyTool):
    '''KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2357.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2357.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
