...
from mastapy.bearings.bearing_results import _1534
...
class BearingParametricStudyTool(_4043.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def component_load_case(self) -> '_2319.BearingLoadCase':
        ...
        return constructor.new(_2319.BearingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def bearing_duty_cycle_results(self) -> 'List[_1534.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1534.LoadedBearingDutyCycle))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2151.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2151.BearingSystemDeflection))
        return value
