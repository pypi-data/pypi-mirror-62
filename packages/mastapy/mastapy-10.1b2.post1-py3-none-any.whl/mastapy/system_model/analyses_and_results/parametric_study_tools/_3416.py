...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3415, _3414, _3357
...
class HypoidGearSetParametricStudyTool(_3357.AGMAGleasonConicalGearSetParametricStudyTool):
    '''HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_3415.HypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsParametricStudyTool, constructor.new(_3415.HypoidGearParametricStudyTool))
        return value

    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_3414.HypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesParametricStudyTool, constructor.new(_3414.HypoidGearMeshParametricStudyTool))
        return value
