...
from mastapy.system_model.analyses_and_results.static_loads import _5882, _5981
from mastapy.system_model import _1728
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3440, _3441
...
class ParametricStudyToolOptions(_1.APIBase):
    ...
    def analysis_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_AnalysisType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_AnalysisType.implicit_type()
    ...
    def analysis_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_AnalysisType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_AnalysisType.implicit_type().type_()
    ...
    @property
    def parametric_study_type(self) -> '_5981.ParametricStudyType':
        ...
        return constructor.new(_5981.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_5981.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1728.ExternalFullFELoader':
        ...
        return constructor.new(_1728.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3440.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3440.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3441.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3441.ParametricStudyVariable))
        return value
