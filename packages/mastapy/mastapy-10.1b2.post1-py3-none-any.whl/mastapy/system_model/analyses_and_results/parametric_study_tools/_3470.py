...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3469, _3468, _3500
...
class ConceptGearSetParametricStudyTool(_3500.GearSetParametricStudyTool):
    '''ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_3469.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsParametricStudyTool, constructor.new(_3469.ConceptGearParametricStudyTool))
        return value

    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_3468.ConceptGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesParametricStudyTool, constructor.new(_3468.ConceptGearMeshParametricStudyTool))
        return value
