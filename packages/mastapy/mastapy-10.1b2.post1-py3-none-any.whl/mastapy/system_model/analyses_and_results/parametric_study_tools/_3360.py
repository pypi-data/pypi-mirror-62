...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3418
...
class BeltConnectionParametricStudyTool(_3418.InterMountableComponentConnectionParametricStudyTool):
    '''BeltConnectionParametricStudyTool
