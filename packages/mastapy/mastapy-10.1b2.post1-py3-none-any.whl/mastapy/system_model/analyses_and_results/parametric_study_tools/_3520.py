...
class OilSealParametricStudyTool(_3475.ConnectorParametricStudyTool):
    '''OilSealParametricStudyTool
    ...
    @property
    def component_load_case(self) -> '_6131.OilSealLoadCase':
        ...
        return constructor.new(_6131.OilSealLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2269.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2269.OilSealSystemDeflection))
        return value
