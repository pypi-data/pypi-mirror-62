...
class MassDiscParametricStudyTool(_4125.VirtualComponentParametricStudyTool):
    '''MassDiscParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2292.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2292.MassDiscSystemDeflection))
        return value
