...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3431
...
class GearParametricStudyTool(_3431.MountableComponentParametricStudyTool):
    '''GearParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_287.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_287.GearDutyCycleRating))
        return value
