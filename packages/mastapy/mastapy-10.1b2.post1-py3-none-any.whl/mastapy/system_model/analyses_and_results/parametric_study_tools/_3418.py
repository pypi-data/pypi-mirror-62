...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3386
...
class InterMountableComponentConnectionParametricStudyTool(_3386.ConnectionParametricStudyTool):
    '''InterMountableComponentConnectionParametricStudyTool
