...
class DutyCycleResultsForSingleBearing(_1.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1534.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1534.LoadedBearingDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
