...
class StraightBevelGearParametricStudyTool(_4137.BevelGearParametricStudyTool):
    '''StraightBevelGearParametricStudyTool
    ...
    @property
    def component_load_case(self) -> '_2371.StraightBevelGearLoadCase':
        ...
        return constructor.new(_2371.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2370.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2370.StraightBevelGearSystemDeflection))
        return value
