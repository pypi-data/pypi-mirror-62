...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4924, _4047
...
class RootAssemblyParametricStudyTool(_4047.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4924.ParametricStudyTool':
        ...
        return constructor.new(_4924.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
