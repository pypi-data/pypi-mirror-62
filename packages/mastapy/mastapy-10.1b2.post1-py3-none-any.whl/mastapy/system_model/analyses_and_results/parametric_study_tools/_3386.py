...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3438
from mastapy.system_model.analyses_and_results.analysis_cases import _6301
...
class ConnectionParametricStudyTool(_6301.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3438.ParametricStudyTool':
        ...
        return constructor.new(_3438.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
