...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3412
...
class ConicalGearSetParametricStudyTool(_3412.GearSetParametricStudyTool):
    '''ConicalGearSetParametricStudyTool
