...
class DutyCycleResultsForSingleBearing(_1.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1523.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1523.LoadedBearingDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
