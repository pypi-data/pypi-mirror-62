...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3441
...
class SpecialisedAssemblyParametricStudyTool(_3441.AbstractAssemblyParametricStudyTool):
    '''SpecialisedAssemblyParametricStudyTool
