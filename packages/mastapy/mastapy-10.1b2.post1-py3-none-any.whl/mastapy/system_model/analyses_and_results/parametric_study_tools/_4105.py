...
class BoltedJointParametricStudyTool(_4123.SpecialisedAssemblyParametricStudyTool):
    '''BoltedJointParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2162.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2162.BoltedJointSystemDeflection))
        return value
