...
class ExternalCADModelParametricStudyTool(_4106.ComponentParametricStudyTool):
    '''ExternalCADModelParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2283.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2283.ExternalCADModelSystemDeflection))
        return value
