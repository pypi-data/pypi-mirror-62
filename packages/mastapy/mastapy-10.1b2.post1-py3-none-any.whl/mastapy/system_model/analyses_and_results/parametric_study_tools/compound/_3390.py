...
from mastapy.system_model.part_model.couplings import _1936
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3992
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3389
...
class SynchroniserSleeveCompoundParametricStudyTool(_3389.SynchroniserPartCompoundParametricStudyTool):
    '''SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1936.SynchroniserSleeve':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3992.SynchroniserSleeveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3992.SynchroniserSleeveParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3992.SynchroniserSleeveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3992.SynchroniserSleeveParametricStudyTool))
        return value
