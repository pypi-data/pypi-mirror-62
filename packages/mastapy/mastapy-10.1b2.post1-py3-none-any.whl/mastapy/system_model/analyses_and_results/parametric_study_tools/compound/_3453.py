...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3452, _3409, _3468
...
class FaceGearSetCompoundParametricStudyTool(_3468.GearSetCompoundParametricStudyTool):
    '''FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_3452.FaceGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundParametricStudyTool, constructor.new(_3452.FaceGearCompoundParametricStudyTool))
        return value

    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_3409.FaceGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundParametricStudyTool, constructor.new(_3409.FaceGearMeshCompoundParametricStudyTool))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_4055.FaceGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4055.FaceGearSetParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_4055.FaceGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_4055.FaceGearSetParametricStudyTool))
        return value
