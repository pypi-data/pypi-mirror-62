...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3409
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3574
...
class FlexiblePinAssemblyCompoundParametricStudyTool(_3574.SpecialisedAssemblyCompoundParametricStudyTool):
    '''FlexiblePinAssemblyCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3409.FlexiblePinAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3409.FlexiblePinAssemblyParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3409.FlexiblePinAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3409.FlexiblePinAssemblyParametricStudyTool))
        return value
