...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3381
...
class CVTPulleyCompoundParametricStudyTool(_3381.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
