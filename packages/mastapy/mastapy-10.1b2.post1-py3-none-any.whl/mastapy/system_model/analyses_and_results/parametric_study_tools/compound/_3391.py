...
class TorqueConverterCompoundParametricStudyTool(_3377.CouplingCompoundParametricStudyTool):
    '''TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1937.TorqueConverter':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3993.TorqueConverterParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3993.TorqueConverterParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3993.TorqueConverterParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3993.TorqueConverterParametricStudyTool))
        return value
