...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3441
...
class AbstractAssemblyCompoundParametricStudyTool(_3441.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
