...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3482, _3420, _3461
...
class StraightBevelGearSetCompoundParametricStudyTool(_3461.BevelGearSetCompoundParametricStudyTool):
    '''StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_3482.StraightBevelGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundParametricStudyTool, constructor.new(_3482.StraightBevelGearCompoundParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_3420.StraightBevelGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundParametricStudyTool, constructor.new(_3420.StraightBevelGearMeshCompoundParametricStudyTool))
        return value
