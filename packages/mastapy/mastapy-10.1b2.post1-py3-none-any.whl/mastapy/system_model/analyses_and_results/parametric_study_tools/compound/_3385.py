...
from mastapy.system_model.part_model.couplings import _1931
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3987
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3377
...
class SpringDamperCompoundParametricStudyTool(_3377.CouplingCompoundParametricStudyTool):
    '''SpringDamperCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1931.SpringDamper':
    ...
    @property
    def assembly_design(self) -> '_1931.SpringDamper':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3987.SpringDamperParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3987.SpringDamperParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3987.SpringDamperParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3987.SpringDamperParametricStudyTool))
        return value
