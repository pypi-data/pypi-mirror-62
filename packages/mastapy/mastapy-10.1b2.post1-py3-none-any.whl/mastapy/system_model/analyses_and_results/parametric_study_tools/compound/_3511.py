...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3379
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3522
...
class ConceptCouplingCompoundParametricStudyTool(_3522.CouplingCompoundParametricStudyTool):
    '''ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3379.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3379.ConceptCouplingParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3379.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3379.ConceptCouplingParametricStudyTool))
        return value
