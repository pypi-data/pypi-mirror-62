...
class SynchroniserCompoundParametricStudyTool(_3446.SpecialisedAssemblyCompoundParametricStudyTool):
    '''SynchroniserCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1933.Synchroniser':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3989.SynchroniserParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3989.SynchroniserParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3989.SynchroniserParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3989.SynchroniserParametricStudyTool))
        return value
