...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3566
...
class CVTPulleyCompoundParametricStudyTool(_3566.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
