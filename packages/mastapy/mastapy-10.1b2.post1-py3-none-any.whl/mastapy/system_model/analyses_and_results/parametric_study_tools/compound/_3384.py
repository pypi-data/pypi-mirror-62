...
from mastapy.system_model.part_model.couplings import _1929
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3986
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3446
...
class RollingRingAssemblyCompoundParametricStudyTool(_3446.SpecialisedAssemblyCompoundParametricStudyTool):
    '''RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1929.RollingRingAssembly':
    ...
    @property
    def assembly_design(self) -> '_1929.RollingRingAssembly':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3986.RollingRingAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3986.RollingRingAssemblyParametricStudyTool))
        return value

    @property
    def assembly_parametric_study_tool_load_cases(self) -> 'List[_3986.RollingRingAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyParametricStudyToolLoadCases, constructor.new(_3986.RollingRingAssemblyParametricStudyTool))
        return value
