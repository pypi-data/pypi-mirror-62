...
from mastapy.system_model.part_model.couplings import _1934
...
class SynchroniserHalfCompoundParametricStudyTool(_3389.SynchroniserPartCompoundParametricStudyTool):
    '''SynchroniserHalfCompoundParametricStudyTool
    ...
    @property
    def component_design(self) -> '_1934.SynchroniserHalf':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3990.SynchroniserHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3990.SynchroniserHalfParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3990.SynchroniserHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3990.SynchroniserHalfParametricStudyTool))
        return value
