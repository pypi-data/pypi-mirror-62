...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3447
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3612
...
class BearingCompoundParametricStudyTool(_3612.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3447.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3447.BearingParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3447.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3447.BearingParametricStudyTool))
        return value
