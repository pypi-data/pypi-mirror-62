...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3468
...
class ConicalGearSetCompoundParametricStudyTool(_3468.GearSetCompoundParametricStudyTool):
    '''ConicalGearSetCompoundParametricStudyTool
