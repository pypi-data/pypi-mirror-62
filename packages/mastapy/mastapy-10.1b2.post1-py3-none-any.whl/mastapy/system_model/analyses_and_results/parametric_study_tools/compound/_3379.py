...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3372
...
class CVTCompoundParametricStudyTool(_3372.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
