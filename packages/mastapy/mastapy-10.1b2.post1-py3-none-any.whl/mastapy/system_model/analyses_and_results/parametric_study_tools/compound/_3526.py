...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3495
...
class CVTCompoundParametricStudyTool(_3495.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
