...
class DutyCycleResultsForSingleShaft(_1.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_20.ShaftDamageResults':
        ...
        return constructor.new(_20.ShaftDamageResults)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
