...
from mastapy.system_model.analyses_and_results.static_loads import _4928, _4929
from mastapy.system_model import _1737
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4926, _4927
...
class ParametricStudyToolOptions(_1.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_4929.ParametricStudyType':
        ...
        return constructor.new(_4929.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_4929.ParametricStudyType'):
    ...
    @property
    def step_results(self) -> 'List[_4926.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4926.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4927.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4927.ParametricStudyVariable))
        return value
