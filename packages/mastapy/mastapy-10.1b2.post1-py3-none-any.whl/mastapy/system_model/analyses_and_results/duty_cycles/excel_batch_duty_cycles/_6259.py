...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6263, _6260, _6262
from mastapy.utility import _1277
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_1.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6263.MASTAFileDetails':
        ...
        return constructor.new(_6263.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6260.ExcelFileDetails':
        ...
        return constructor.new(_6260.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1277.SelectableFolder':
        ...
        return constructor.new(_1277.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6262.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6262.ExcelSheetDesignStateSelector))
        return value
