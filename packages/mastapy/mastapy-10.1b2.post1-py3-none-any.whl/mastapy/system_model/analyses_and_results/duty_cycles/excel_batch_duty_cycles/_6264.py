...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6265
...
class ExcelBatchDutyCycleCreator(_1.APIBase):
    ...
    @property
    def batch_details(self) -> '_6265.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6265.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
