...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6258, _6255, _6257
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_1.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6258.MASTAFileDetails':
        ...
        return constructor.new(_6258.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6255.ExcelFileDetails':
        ...
        return constructor.new(_6255.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6257.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6257.ExcelSheetDesignStateSelector))
        return value
