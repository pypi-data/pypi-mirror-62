...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6269, _6266, _6268
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_1.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6269.MASTAFileDetails':
        ...
        return constructor.new(_6269.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6266.ExcelFileDetails':
        ...
        return constructor.new(_6266.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6268.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6268.ExcelSheetDesignStateSelector))
        return value
