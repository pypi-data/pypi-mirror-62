...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _5870
...
class ExcelBatchDutyCycleCreator(_1.APIBase):
    ...
    @property
    def batch_details(self) -> '_5870.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_5870.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
