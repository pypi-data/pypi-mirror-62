...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6260, _6257, _6259
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_1.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6260.MASTAFileDetails':
        ...
        return constructor.new(_6260.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6257.ExcelFileDetails':
        ...
        return constructor.new(_6257.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1274.SelectableFolder':
        ...
        return constructor.new(_1274.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6259.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6259.ExcelSheetDesignStateSelector))
        return value
