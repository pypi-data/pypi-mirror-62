...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6018
...
class ExcelBatchDutyCycleCreator(_1.APIBase):
    ...
    @property
    def batch_details(self) -> '_6018.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6018.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
