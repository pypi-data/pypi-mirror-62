...
from mastapy.system_model.analyses_and_results.analysis_cases import _3317
...
class PartCompoundAnalysis(_3317.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_729.SMTBitmap':
        ...
        return constructor.new(_729.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
