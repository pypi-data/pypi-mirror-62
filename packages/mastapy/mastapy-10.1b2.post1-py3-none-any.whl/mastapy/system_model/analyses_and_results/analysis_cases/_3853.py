...
from mastapy.system_model.analyses_and_results.analysis_cases import _4922
...
class StaticLoadAnalysisCase(_4922.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_1969.StaticLoadCase':
        ...
        return constructor.new(_1969.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
