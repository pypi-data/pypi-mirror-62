...
class StaticLoadAnalysisCase(_4923.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_2035.StaticLoadCase':
        ...
        return constructor.new(_2035.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
