...
from mastapy.system_model import _1733
from mastapy.system_model.analyses_and_results import _2120, _2119
...
class AnalysisCase(_2119.Context):
    '''AnalysisCase
    ...
    def results_for(self, design_entity: '_1733.DesignEntity') -> '_2120.DesignEntityAnalysis':
        ...
        return constructor.new(_2120.DesignEntityAnalysis)(method_result) if method_result else None
