...
class TimeSeriesLoadAnalysisCase(_6298.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6022.TimeSeriesLoadCase':
        ...
        return constructor.new(_6022.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
