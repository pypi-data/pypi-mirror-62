...
class TimeSeriesLoadAnalysisCase(_4925.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_4924.TimeSeriesLoadCase':
        ...
        return constructor.new(_4924.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
