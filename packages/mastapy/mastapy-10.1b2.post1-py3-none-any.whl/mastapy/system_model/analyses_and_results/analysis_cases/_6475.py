...
class TimeSeriesLoadAnalysisCase(_6459.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6176.TimeSeriesLoadCase':
        ...
        return constructor.new(_6176.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
