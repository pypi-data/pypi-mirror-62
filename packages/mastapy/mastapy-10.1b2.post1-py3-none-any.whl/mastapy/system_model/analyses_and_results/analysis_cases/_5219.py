...
from mastapy.system_model.analyses_and_results import _2119, _2118
...
class AnalysisCase(_2118.Context):
    '''AnalysisCase
    ...
    def results_for(self, design_entity: '_1733.DesignEntity') -> '_2119.DesignEntityAnalysis':
        ...
        return constructor.new(_2119.DesignEntityAnalysis)(method_result) if method_result else None
