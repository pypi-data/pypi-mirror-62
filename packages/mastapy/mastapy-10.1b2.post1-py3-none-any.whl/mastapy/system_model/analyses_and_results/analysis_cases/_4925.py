...
from mastapy.system_model.analyses_and_results import _2112, _2111
...
class AnalysisCase(_2111.Context):
    '''AnalysisCase
    ...
    def results_for(self, design_entity: '_1727.DesignEntity') -> '_2112.DesignEntityAnalysis':
        ...
        return constructor.new(_2112.DesignEntityAnalysis)(method_result) if method_result else None
