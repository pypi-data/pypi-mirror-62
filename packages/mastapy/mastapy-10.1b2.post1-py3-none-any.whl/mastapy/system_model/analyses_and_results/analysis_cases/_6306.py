...
from mastapy.system_model.analyses_and_results import _2104, _2102
...
class DesignEntityCompoundAnalysis(_2102.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2104.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2104.DesignEntitySingleContextAnalysis))
        return value
