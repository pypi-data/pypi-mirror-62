...
class TimeSeriesLoadAnalysisCase(_4923.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_4922.TimeSeriesLoadCase':
        ...
        return constructor.new(_4922.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
