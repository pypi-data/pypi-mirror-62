...
from mastapy.system_model.analyses_and_results.analysis_cases import _3390
...
class PartCompoundAnalysis(_3390.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_738.SMTBitmap':
        ...
        return constructor.new(_738.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
