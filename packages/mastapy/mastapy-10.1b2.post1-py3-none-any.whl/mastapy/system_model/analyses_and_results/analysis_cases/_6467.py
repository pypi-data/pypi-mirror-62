...
from mastapy.system_model.analyses_and_results import _2161, _2159
...
class DesignEntityCompoundAnalysis(_2159.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2161.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2161.DesignEntitySingleContextAnalysis))
        return value
