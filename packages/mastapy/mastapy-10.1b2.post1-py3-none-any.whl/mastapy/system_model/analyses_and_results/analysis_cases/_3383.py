...
from mastapy.system_model.analyses_and_results import _2115, _2113
...
class DesignEntityCompoundAnalysis(_2113.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2115.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2115.DesignEntitySingleContextAnalysis))
        return value
