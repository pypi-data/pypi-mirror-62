...
class PartCompoundAnalysis(_3379.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_718.SMTBitmap':
        ...
        return constructor.new(_718.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
