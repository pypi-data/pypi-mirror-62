...
from mastapy.system_model.analyses_and_results import _2121, _2119
...
class DesignEntityCompoundAnalysis(_2119.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2121.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2121.DesignEntitySingleContextAnalysis))
        return value
