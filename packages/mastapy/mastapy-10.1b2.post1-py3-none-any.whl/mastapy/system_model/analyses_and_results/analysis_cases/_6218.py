...
class TimeSeriesLoadAnalysisCase(_5219.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_5218.TimeSeriesLoadCase':
        ...
        return constructor.new(_5218.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
