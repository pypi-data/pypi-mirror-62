...
from mastapy.system_model.analyses_and_results import _2113, _2112
...
class AnalysisCase(_2112.Context):
    '''AnalysisCase
    ...
    def results_for(self, design_entity: '_1727.DesignEntity') -> '_2113.DesignEntityAnalysis':
        ...
        return constructor.new(_2113.DesignEntityAnalysis)(method_result) if method_result else None
