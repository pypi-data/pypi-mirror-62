...
from mastapy.system_model.analyses_and_results import _2114, _2112
...
class DesignEntityCompoundAnalysis(_2112.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2114.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2114.DesignEntitySingleContextAnalysis))
        return value
