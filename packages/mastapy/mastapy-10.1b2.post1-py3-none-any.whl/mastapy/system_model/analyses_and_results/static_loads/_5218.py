...
class TimeSeriesLoadCase(_6069.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5993.MBDAnalysisOptions':
        ...
        return constructor.new(_5993.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
