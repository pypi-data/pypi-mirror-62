...
from mastapy.system_model.analyses_and_results.static_loads import _2391, _2313, _2364
...
class WormGearSetLoadCase(_2364.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_2391.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_2391.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_2313.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_2313.WormGearMeshLoadCase))
        return value
