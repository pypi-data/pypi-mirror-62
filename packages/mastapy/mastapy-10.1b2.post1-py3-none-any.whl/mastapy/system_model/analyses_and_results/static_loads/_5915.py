...
from mastapy.system_model.analyses_and_results.static_loads import _5966
...
class CouplingConnectionLoadCase(_5966.InterMountableComponentConnectionLoadCase):
    '''CouplingConnectionLoadCase
