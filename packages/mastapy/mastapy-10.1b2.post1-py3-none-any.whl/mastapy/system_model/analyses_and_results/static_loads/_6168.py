...
from mastapy.system_model.analyses_and_results.static_loads import _6166, _6167, _6042
...
class StraightBevelGearSetLoadCase(_6042.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6166.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6166.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6167.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6167.StraightBevelGearMeshLoadCase))
        return value
