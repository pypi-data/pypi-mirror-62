...
from mastapy.system_model import _1733, _1734, _1735
from mastapy.system_model.analyses_and_results.mbd_analyses import _4949
from mastapy.system_model.analyses_and_results.static_loads import _6028, _5931, _6031
from mastapy.system_model.imported_fes import _1851
from mastapy.system_model.part_model import _1937
from mastapy.math_utility.control import _1233
...
class PowerLoadLoadCase(_6031.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1733.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1733.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1733.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_4949.WheelSlipType':
        ...
        return constructor.new(_4949.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_4949.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1735.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1735.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1735.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1233.PIDControlSettings':
        ...
        return constructor.new(_1233.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None
    ...
    @property
    def pid_control_settings(self) -> '_1233.PIDControlSettings':
        ...
        return constructor.new(_1233.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_5931.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_5931.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
