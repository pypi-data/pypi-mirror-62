...
from mastapy.system_model.analyses_and_results.load_case_groups import _6176, _6177, _2066
...
class StaticLoadCase(_6069.LoadCase):
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_322.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_322.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def clutch_engagements(self) -> 'List[_6176.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6176.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6177.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6177.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_2066.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
