...
from mastapy.system_model.analyses_and_results.static_loads import _5967
...
class KlingelnbergCycloPalloidSpiralBevelGearLoadCase(_5967.KlingelnbergCycloPalloidConicalGearLoadCase):
    '''KlingelnbergCycloPalloidSpiralBevelGearLoadCase
