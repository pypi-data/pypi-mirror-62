...
class TimeSeriesLoadCase(_5875.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_4899.MBDAnalysisOptions':
        ...
        return constructor.new(_4899.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
