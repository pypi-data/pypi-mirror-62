...
class PlanetaryGearSetLoadCase(_6073.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1125.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1125.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2059.PlanetaryGearSet':
