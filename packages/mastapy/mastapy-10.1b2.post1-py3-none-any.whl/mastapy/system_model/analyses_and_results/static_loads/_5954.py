...
from mastapy.system_model.analyses_and_results.static_loads import _5960
...
class HarmonicLoadDataBase(_1.APIBase):
    ...
    def data_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType.implicit_type()
    ...
    def data_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType.implicit_type().type_()
    ...
    @property
    def excitations(self) -> 'List[_1184.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_1184.FourierSeries))
        return value

    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6319.MeasurementType'):
    ...
    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6319.MeasurementType'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
    ...
    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_1184.FourierSeries'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
