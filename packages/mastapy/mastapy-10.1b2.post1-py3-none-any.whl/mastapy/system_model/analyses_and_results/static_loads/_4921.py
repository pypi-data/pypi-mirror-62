...
class TimeSeriesLoadCase(_6061.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5986.MBDAnalysisOptions':
        ...
        return constructor.new(_5986.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
