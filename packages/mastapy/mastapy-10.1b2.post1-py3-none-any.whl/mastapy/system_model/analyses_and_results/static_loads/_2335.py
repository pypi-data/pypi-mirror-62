...
from mastapy.system_model.analyses_and_results.static_loads import _6293, _2332
...
class PlanetCarrierLoadCase(_2332.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6293.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6293.PlanetarySocketManufactureError))
        return value
