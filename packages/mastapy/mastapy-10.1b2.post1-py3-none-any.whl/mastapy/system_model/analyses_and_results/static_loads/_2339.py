...
class CylindricalGearSetLoadCase(_2345.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_294.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_294.CoefficientOfFrictionCalculationMethod)(value) if value else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_294.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def reset_micro_geometry(self) -> '_6295.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6295.ResetMicroGeometryOptions)(value) if value else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6295.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def overridden_micro_geometry(self) -> '_1039.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1039.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None

    @property
    def ltca(self) -> '_957.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_957.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA else None

    @property
    def cylindrical_gears_load_case(self) -> 'List[_2337.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_2337.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_2255.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_2255.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_6246.CylindricalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6246.CylindricalGearSetHarmonicLoadData)(method_result) if method_result else None
