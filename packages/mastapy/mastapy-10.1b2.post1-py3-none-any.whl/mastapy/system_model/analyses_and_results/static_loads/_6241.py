...
from mastapy.system_model.analyses_and_results.static_loads import _2064, _2065, _6247
...
class ElectricMachineHarmonicLoadData(_6247.SpeedDependentHarmonicLoadData):
    ...
    @property
    def force_distribution(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
