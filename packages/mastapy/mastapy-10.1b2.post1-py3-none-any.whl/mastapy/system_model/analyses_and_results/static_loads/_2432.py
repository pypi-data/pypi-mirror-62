...
from mastapy.system_model.analyses_and_results.static_loads import _6286, _2429
...
class PlanetCarrierLoadCase(_2429.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6286.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6286.PlanetarySocketManufactureError))
        return value
