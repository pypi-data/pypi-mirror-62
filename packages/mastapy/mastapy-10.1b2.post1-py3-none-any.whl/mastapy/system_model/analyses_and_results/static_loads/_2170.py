...
from mastapy.system_model.analyses_and_results.static_loads import _2374, _2262, _2339
...
class WormGearSetLoadCase(_2339.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_2374.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_2374.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_2262.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_2262.WormGearMeshLoadCase))
        return value
