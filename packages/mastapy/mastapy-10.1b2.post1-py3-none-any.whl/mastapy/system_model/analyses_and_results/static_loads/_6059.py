...
class ConicalGearSetHarmonicLoadData(_6100.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_152.TESpecificationType':
        ...
        return constructor.new(_152.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_152.TESpecificationType'):
