...
from mastapy.system_model.analyses_and_results import _2122
...
class PartLoadCase(_2122.PartAnalysis):
    '''PartLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6244.HarmonicLoadDataBase':
        ...
        return constructor.new(_6244.HarmonicLoadDataBase)(method_result) if method_result else None
