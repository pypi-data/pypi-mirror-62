...
from mastapy.system_model.analyses_and_results.static_loads import _2445, _2397, _2450
...
class BevelDifferentialGearSetLoadCase(_2450.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_2445.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_2445.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_2397.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_2397.BevelDifferentialGearMeshLoadCase))
        return value
