...
from mastapy.system_model.analyses_and_results.static_loads import _1972, _2454, _2424
...
class RootAssemblyLoadCase(_2424.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def load_case(self) -> '_1972.StaticLoadCase':
        ...
        return constructor.new(_1972.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None

    @property
    def supercharger_rotor_sets(self) -> 'List[_2454.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_2454.CylindricalGearSetLoadCase))
        return value
