...
from mastapy.system_model.analyses_and_results.static_loads import _2375, _2309, _2357
...
class SpiralBevelGearSetLoadCase(_2357.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_2375.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_2375.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_2309.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_2309.SpiralBevelGearMeshLoadCase))
        return value
