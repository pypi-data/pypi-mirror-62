...
from mastapy.system_model.analyses_and_results.static_loads import _2065
...
class HarmonicLoadDataBase(_1.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_972.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_972.FourierSeries))
        return value

    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_2066.MeasurementType'):
    ...
    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_2066.MeasurementType'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
    ...
    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_972.FourierSeries'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
