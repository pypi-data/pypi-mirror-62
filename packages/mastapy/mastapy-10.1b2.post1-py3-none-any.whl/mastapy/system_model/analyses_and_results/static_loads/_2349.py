...
from mastapy.system_model.analyses_and_results.static_loads import _2348, _2297, _2364
...
class FaceGearSetLoadCase(_2364.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_2348.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_2348.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_2297.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_2297.FaceGearMeshLoadCase))
        return value
