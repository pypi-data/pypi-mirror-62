...
from mastapy.system_model.analyses_and_results.load_case_groups import _6181, _6182, _2041
...
class StaticLoadCase(_6069.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_321.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_321.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_321.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_6212.GearWhineAnalysisOptions':
        ...
        return constructor.new(_6212.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_6181.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6181.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6182.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6182.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_2041.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
