...
from mastapy.system_model.analyses_and_results.static_loads import _6294
...
class PlanetarySocketManufactureError(_1.APIBase):
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6294.PlanetManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6294.PlanetManufactureError))
        return value
