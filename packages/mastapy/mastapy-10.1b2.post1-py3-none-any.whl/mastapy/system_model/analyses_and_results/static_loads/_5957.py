...
from mastapy.system_model.analyses_and_results.static_loads import _5960, _5956, _5937
...
T = TypeVar('T', bound='_5937.ElectricMachineHarmonicLoadImportOptionsBase')


class HarmonicLoadDataImportFromMotorPackages(_5956.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
