...
from mastapy.system_model import _1732
...
class ConceptCouplingLoadCase(_2188.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1732.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1732.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1732.ConceptCouplingSpeedRatioSpecificationMethod'):
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1259.PIDControlSettings':
        ...
        return constructor.new(_1259.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
