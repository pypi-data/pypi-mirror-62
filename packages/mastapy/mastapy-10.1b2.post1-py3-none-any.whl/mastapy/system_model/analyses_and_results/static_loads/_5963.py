...
from mastapy.system_model.analyses_and_results.static_loads import _5961, _5962, _5881
...
class HypoidGearSetLoadCase(_5881.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_5961.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_5961.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_5962.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_5962.HypoidGearMeshLoadCase))
        return value
