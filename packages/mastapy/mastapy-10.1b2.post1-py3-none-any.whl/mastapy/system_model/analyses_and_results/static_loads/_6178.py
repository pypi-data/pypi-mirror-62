...
class TorqueConverterLoadCase(_6065.CouplingLoadCase):
    '''TorqueConverterLoadCase
    ...
    def lock_up_clutch_rule(self) -> 'enum_with_selected_value.EnumWithSelectedValue_TorqueConverterLockupRule':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_TorqueConverterLockupRule.implicit_type()
    ...
    def lock_up_clutch_rule(self, value: 'enum_with_selected_value.EnumWithSelectedValue_TorqueConverterLockupRule.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_TorqueConverterLockupRule.implicit_type().type_()
