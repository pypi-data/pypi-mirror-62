...
from mastapy.system_model.analyses_and_results.static_loads import _2316, _6283, _6244
...
class GearSetHarmonicLoadData(_6244.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6283.GearMeshTEOrderType':
        ...
        return constructor.new(_6283.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6283.GearMeshTEOrderType'):
