...
from mastapy.system_model.analyses_and_results.static_loads import _5927
...
class DataFromJMAGPerSpeed(_1.APIBase):
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_5927.DataFromJMAGPerMeanTorque]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPerMeanTorque, constructor.new(_5927.DataFromJMAGPerMeanTorque))
        return value
