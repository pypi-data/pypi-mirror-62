...
from mastapy.system_model.analyses_and_results.static_loads import _2467, _2409, _2450
...
class SpiralBevelGearSetLoadCase(_2450.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_2467.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_2467.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_2409.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_2409.SpiralBevelGearMeshLoadCase))
        return value
