...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4875
...
from mastapy.system_model.analyses_and_results.static_loads import _6000
...
class GearSetLoadCase(_6000.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_4875.GearMeshStiffnessModel':
        ...
        return constructor.new(_4875.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_4875.GearMeshStiffnessModel'):
