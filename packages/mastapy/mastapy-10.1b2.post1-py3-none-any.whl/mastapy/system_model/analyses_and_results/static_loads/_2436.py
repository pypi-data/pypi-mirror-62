...
from mastapy.system_model.part_model import _1941, _1915, _1924
...
from mastapy.system_model.analyses_and_results.static_loads import _2414
...
class SpecialisedAssemblyLoadCase(_2414.AbstractAssemblyLoadCase):
    '''SpecialisedAssemblyLoadCase
    ...
    @property
    def assembly_design(self) -> '_1941.SpecialisedAssembly':
        ...
        return constructor.new(_1941.SpecialisedAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
