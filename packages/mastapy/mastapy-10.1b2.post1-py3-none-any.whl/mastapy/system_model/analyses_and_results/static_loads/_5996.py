...
from mastapy.system_model.analyses_and_results.static_loads import _6008, _5925, _5883
...
class RootAssemblyLoadCase(_5883.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1233.PIDControlSettings':
        ...
        return constructor.new(_1233.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None
    ...
    @property
    def load_case(self) -> '_6008.StaticLoadCase':
        ...
        return constructor.new(_6008.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None

    @property
    def supercharger_rotor_sets(self) -> 'List[_5925.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_5925.CylindricalGearSetLoadCase))
        return value
