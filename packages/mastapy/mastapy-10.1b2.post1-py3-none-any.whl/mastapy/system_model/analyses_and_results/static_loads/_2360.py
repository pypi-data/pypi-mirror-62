...
from mastapy.system_model.analyses_and_results.static_loads import _6272, _2363
...
class CylindricalGearLoadCase(_2363.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6272.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_1030.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1030.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
