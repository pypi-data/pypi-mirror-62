...
from mastapy.system_model.analyses_and_results.static_loads import _2195, _2183
...
class CVTLoadCase(_2183.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_2195.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2195.CVTPulleyLoadCase))
        return value
