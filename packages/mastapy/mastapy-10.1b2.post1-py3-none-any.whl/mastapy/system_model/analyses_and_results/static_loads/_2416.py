...
from mastapy.system_model.analyses_and_results.static_loads import _2420
...
class BearingLoadCase(_2420.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def component_design(self) -> '_1912.Bearing':
    ...
    @property
    def friction_coefficients(self) -> '_1634.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1634.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None
