...
from mastapy.gears import _273
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6058
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5172
from mastapy.system_model.analyses_and_results.load_case_groups import _5083, _5084, _5085
from mastapy.system_model.analyses_and_results.static_loads import _5875
...
class StaticLoadCase(_5875.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_273.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_273.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6058.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6058.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5172.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5172.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5083.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5083.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5084.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5084.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5085.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
