...
from mastapy.system_model.analyses_and_results.static_loads import _2441, _2399, _2457
...
class FaceGearSetLoadCase(_2457.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_2441.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_2441.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_2399.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_2399.FaceGearMeshLoadCase))
        return value
