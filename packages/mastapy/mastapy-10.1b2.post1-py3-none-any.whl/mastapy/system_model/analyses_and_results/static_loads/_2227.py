...
from mastapy.system_model.analyses_and_results.static_loads import _2045, _5090
from mastapy.system_model.analyses_and_results import _2118
...
class ConnectionLoadCase(_2118.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_2045.StaticLoadCase':
        ...
        return constructor.new(_2045.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_5090.TimeSeriesLoadCase':
        ...
        return constructor.new(_5090.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
