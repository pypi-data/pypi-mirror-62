...
from mastapy.system_model.analyses_and_results.static_loads import _2071, _6286, _6278
...
class HarmonicLoadDataImportFromMotorPackages(_6286.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
