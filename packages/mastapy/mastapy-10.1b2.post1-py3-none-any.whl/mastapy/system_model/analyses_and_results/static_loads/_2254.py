...
from mastapy.system_model.analyses_and_results.static_loads import _2255, _2241
...
class CVTLoadCase(_2241.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_2255.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2255.CVTPulleyLoadCase))
        return value
