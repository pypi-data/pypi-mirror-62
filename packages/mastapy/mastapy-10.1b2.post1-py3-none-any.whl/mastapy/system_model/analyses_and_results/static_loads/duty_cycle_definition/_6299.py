...
class DesignStateOptions(_1463.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1736.DutyCycleImporterDesignEntityMatch[_2066.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1736.DutyCycleImporterDesignEntityMatch)[_2066.DesignState])
        return value
