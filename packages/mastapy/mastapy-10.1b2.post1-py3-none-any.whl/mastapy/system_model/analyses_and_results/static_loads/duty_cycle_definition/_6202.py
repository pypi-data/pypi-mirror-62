...
from mastapy.math_utility import _1051
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6193
from mastapy.utility_gui import _1479
...
class PointLoadInputOptions(_1479.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1051.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6193.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6193.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6193.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
