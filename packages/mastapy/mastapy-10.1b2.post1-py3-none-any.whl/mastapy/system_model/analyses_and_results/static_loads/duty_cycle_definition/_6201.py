...
from mastapy.utility.file_access_helpers import _1318
from mastapy.utility_gui import _1480
...
class MultiTimeSeriesDataInputFileOptions(_1480.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1318.TextFileDelimiterOptions':
        ...
        return constructor.new(_1318.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
