...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6312, _6307
...
class TorqueInputOptions(_6307.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6312.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6312.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6312.TorqueValuesObtainedFrom'):
