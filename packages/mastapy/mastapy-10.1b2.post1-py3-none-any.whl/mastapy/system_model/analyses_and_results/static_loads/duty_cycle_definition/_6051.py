...
from mastapy.system_model.analyses_and_results.static_loads import _5965
from mastapy._internal import constructor, conversion, enum_with_selected_value_runtime
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6041, _6052, _6043, _6040,
    _6044, _6046, _6053, _6050,
    _6042, _6045, _6039
)
from mastapy.utility.file_access_helpers import _1434
...
class TimeSeriesImporter(_1.APIBase):
    ...
    @property
    def import_type(self) -> '_5965.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_5965.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_5965.ImportType'):
    ...
    def destination_design_state_column(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DestinationDesignState':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_DestinationDesignState.implicit_type()
    ...
    def destination_design_state_column(self, value: 'enum_with_selected_value.EnumWithSelectedValue_DestinationDesignState.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_DestinationDesignState.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def time_step_input(self) -> '_6052.TimeStepInputOptions':
        ...
        return constructor.new(_6052.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6043.GearRatioInputOptions':
        ...
        return constructor.new(_6043.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6040.DesignStateOptions':
        ...
        return constructor.new(_6040.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6044.LoadCaseNameOptions':
        ...
        return constructor.new(_6044.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6046.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6046.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6053.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6053.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6050.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6050.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6042.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6042.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6045.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6045.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6039.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6039.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1434.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1434.ColumnTitle))
        return value
