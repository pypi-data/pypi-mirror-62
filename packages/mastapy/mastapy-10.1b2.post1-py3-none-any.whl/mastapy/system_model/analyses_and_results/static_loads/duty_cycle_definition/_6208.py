...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6209, _6203
...
class TorqueInputOptions(_6203.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6209.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6209.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6209.TorqueValuesObtainedFrom'):
