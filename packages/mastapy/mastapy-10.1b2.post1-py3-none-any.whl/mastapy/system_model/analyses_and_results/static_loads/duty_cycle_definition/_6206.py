...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6196, _6207, _6198, _6195,
    _6199, _6201, _6208, _6205,
    _6197, _6200, _6194
)
...
class TimeSeriesImporter(_1.APIBase):
    ...
    @property
    def import_type(self) -> '_6115.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6115.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6115.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6207.TimeStepInputOptions':
        ...
        return constructor.new(_6207.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6198.GearRatioInputOptions':
        ...
        return constructor.new(_6198.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6195.DesignStateOptions':
        ...
        return constructor.new(_6195.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6199.LoadCaseNameOptions':
        ...
        return constructor.new(_6199.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6201.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6201.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6208.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6208.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6205.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6205.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6197.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6197.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6200.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6200.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6194.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6194.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1317.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1317.ColumnTitle))
        return value
