...
from mastapy.system_model.analyses_and_results.static_loads import _6285
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6294, _6304, _6296, _6293,
    _6297, _6299, _6305, _6303,
    _6295, _6298, _6292
)
...
class TimeSeriesImporter(_1.APIBase):
    ...
    @property
    def import_type(self) -> '_6285.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6285.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6285.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6304.TimeStepInputOptions':
        ...
        return constructor.new(_6304.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6296.GearRatioInputOptions':
        ...
        return constructor.new(_6296.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6293.DesignStateOptions':
        ...
        return constructor.new(_6293.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6297.LoadCaseNameOptions':
        ...
        return constructor.new(_6297.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6299.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6299.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6305.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6305.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6303.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6303.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6295.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6295.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6298.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6298.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6292.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6292.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1442.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1442.ColumnTitle))
        return value
