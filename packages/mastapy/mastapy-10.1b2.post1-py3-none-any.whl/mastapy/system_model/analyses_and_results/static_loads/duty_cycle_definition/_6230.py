...
from mastapy.system_model.analyses_and_results.static_loads import _6291
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6300, _6310, _6302, _6299,
    _6303, _6305, _6311, _6309,
    _6301, _6304, _6298
)
from mastapy.utility.file_access_helpers import _1449
...
class TimeSeriesImporter(_1.APIBase):
    ...
    @property
    def import_type(self) -> '_6291.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6291.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6291.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6310.TimeStepInputOptions':
        ...
        return constructor.new(_6310.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6302.GearRatioInputOptions':
        ...
        return constructor.new(_6302.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6299.DesignStateOptions':
        ...
        return constructor.new(_6299.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6303.LoadCaseNameOptions':
        ...
        return constructor.new(_6303.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6305.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6305.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6311.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6311.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6309.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6309.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6301.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6301.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6304.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6304.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6298.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6298.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1449.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1449.ColumnTitle))
        return value
