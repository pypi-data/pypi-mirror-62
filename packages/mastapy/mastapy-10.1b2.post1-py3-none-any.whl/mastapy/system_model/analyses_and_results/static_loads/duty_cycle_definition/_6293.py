...
from mastapy.system_model.analyses_and_results.load_case_groups import _1848
from mastapy.system_model import _1730
...
class DesignStateOptions(_1457.ColumnInputOptions):
    '''DesignStateOptions
    ...
    @property
    def design_state_destinations(self) -> 'List[_1730.DutyCycleImporterDesignEntityMatch[_1848.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1730.DutyCycleImporterDesignEntityMatch)[_1848.DesignState])
        return value
