...
from mastapy.utility.file_access_helpers import _1450
from mastapy.utility_gui import _1464
...
class MultiTimeSeriesDataInputFileOptions(_1464.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1450.TextFileDelimiterOptions':
        ...
        return constructor.new(_1450.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
