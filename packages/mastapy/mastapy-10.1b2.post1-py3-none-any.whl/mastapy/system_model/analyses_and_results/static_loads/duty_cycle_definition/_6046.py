...
from mastapy.utility.file_access_helpers import _1435
from mastapy.utility_gui import _1453
...
class MultiTimeSeriesDataInputFileOptions(_1453.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1435.TextFileDelimiterOptions':
        ...
        return constructor.new(_1435.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
