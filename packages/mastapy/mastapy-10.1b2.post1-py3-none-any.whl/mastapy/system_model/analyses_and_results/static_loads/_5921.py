...
from mastapy.system_model.analyses_and_results.static_loads import _5922, _5946
...
class CylindricalGearLoadCase(_5946.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_5922.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_958.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_958.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
