...
from mastapy.system_model.analyses_and_results.static_loads import _5948, _5949, _5954
...
class GearSetHarmonicLoadData(_5954.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_5949.GearMeshTEOrderType':
        ...
        return constructor.new(_5949.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_5949.GearMeshTEOrderType'):
