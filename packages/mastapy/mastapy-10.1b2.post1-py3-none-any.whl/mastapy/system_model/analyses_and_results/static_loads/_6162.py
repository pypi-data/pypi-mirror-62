...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6213
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5302
from mastapy.system_model.analyses_and_results.load_case_groups import _5213, _5214, _5215
...
class StaticLoadCase(_6023.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_144.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_144.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6213.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6213.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5302.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5302.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5213.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5213.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5214.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5214.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5215.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
