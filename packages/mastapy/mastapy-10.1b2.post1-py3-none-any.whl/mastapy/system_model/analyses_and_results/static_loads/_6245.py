...
class ConicalGearSetHarmonicLoadData(_6251.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_327.TESpecificationType':
        ...
        return constructor.new(_327.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_327.TESpecificationType'):
