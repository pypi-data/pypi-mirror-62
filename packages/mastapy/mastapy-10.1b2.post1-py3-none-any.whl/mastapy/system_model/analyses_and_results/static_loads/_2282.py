...
from mastapy.system_model.analyses_and_results.static_loads import _2067, _5218
from mastapy.system_model.analyses_and_results import _2117
...
class ConnectionLoadCase(_2117.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_2067.StaticLoadCase':
        ...
        return constructor.new(_2067.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_5218.TimeSeriesLoadCase':
        ...
        return constructor.new(_5218.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
