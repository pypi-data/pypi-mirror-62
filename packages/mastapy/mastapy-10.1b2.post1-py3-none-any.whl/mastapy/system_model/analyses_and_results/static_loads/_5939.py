...
from mastapy.system_model.analyses_and_results.static_loads import _5937
...
class ElectricMachineHarmonicLoadMotorCADImportOptions(_5937.ElectricMachineHarmonicLoadImportOptionsBase):
    '''ElectricMachineHarmonicLoadMotorCADImportOptions
