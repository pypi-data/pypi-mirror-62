...
from mastapy.system_model.analyses_and_results.static_loads import _2071
from mastapy._internal import constructor, conversion
from mastapy.math_utility import _877
from mastapy.units_and_measurements import _2072
...
class HarmonicLoadDataBase(_1.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_877.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_877.FourierSeries))
        return value

    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_2072.MeasurementType'):
    ...
    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_2072.MeasurementType'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
    ...
    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_877.FourierSeries'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
