...
from mastapy.system_model.analyses_and_results.static_loads import _6292, _6286, _6277
...
class HarmonicLoadDataExcelImport(_6286.HarmonicLoadDataImportBase['_6277.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6292.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6292.NamedSpeed))
        return value
