...
class FlexiblePinAssemblyLoadCase(_6000.SpecialisedAssemblyLoadCase):
    '''FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1246.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1246.LoadCaseOverrideOption'):
