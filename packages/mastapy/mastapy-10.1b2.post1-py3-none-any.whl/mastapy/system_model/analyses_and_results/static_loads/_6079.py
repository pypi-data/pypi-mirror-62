...
from mastapy.utility.enums import _1319
...
class ElectricMachineDetail(_1323.NamedDatabaseItem):
    '''ElectricMachineDetail
    ...
    @property
    def flow_rate_specification_method(self) -> '_1319.PropertySpecificationMethod':
        ...
        return constructor.new(_1319.PropertySpecificationMethod)(value) if value else None

    @flow_rate_specification_method.setter
    def flow_rate_specification_method(self, value: '_1319.PropertySpecificationMethod'):
