...
from mastapy.system_model.analyses_and_results.static_loads import _5920, _5886
...
class CVTLoadCase(_5886.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_5920.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5920.CVTPulleyLoadCase))
        return value
