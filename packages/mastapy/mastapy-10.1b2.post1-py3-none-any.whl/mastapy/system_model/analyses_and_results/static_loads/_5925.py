...
from mastapy.gears.gear_designs.cylindrical import _924
...
class CylindricalGearSetLoadCase(_5951.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_251.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_251.CoefficientOfFrictionCalculationMethod)(value) if value else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_251.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def reset_micro_geometry(self) -> '_5992.ResetMicroGeometryOptions':
        ...
        return constructor.new(_5992.ResetMicroGeometryOptions)(value) if value else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_5992.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def overridden_micro_geometry(self) -> '_963.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_963.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None

    @property
    def ltca(self) -> '_924.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_924.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA else None

    @property
    def cylindrical_gears_load_case(self) -> 'List[_5921.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_5921.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_5923.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_5923.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_5924.CylindricalGearSetHarmonicLoadData':
        ...
        return constructor.new(_5924.CylindricalGearSetHarmonicLoadData)(method_result) if method_result else None
