...
from mastapy.system_model.analyses_and_results.static_loads import _6163, _6164, _6042
...
class StraightBevelDiffGearSetLoadCase(_6042.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6163.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6163.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6164.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6164.StraightBevelDiffGearMeshLoadCase))
        return value
