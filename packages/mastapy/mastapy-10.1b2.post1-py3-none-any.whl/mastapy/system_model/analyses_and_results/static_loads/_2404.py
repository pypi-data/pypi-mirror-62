...
class CylindricalGearMeshLoadCase(_2413.GearMeshLoadCase):
    '''CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_595.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_595.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents else None
