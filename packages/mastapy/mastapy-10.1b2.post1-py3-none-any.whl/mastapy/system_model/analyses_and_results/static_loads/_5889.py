...
from mastapy.system_model.analyses_and_results.static_loads import _5887, _5888, _5894
...
class BevelDifferentialGearSetLoadCase(_5894.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_5887.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_5887.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_5888.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_5888.BevelDifferentialGearMeshLoadCase))
        return value
