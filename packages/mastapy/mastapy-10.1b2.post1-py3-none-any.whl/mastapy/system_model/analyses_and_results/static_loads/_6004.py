...
from mastapy.system_model.analyses_and_results.static_loads import _6002, _6003, _5894
...
class SpiralBevelGearSetLoadCase(_5894.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6002.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_6002.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6003.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_6003.SpiralBevelGearMeshLoadCase))
        return value
