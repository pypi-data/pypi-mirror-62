...
from mastapy.system_model.analyses_and_results.static_loads import _6130, _6106, _6086
...
class HarmonicLoadDataExcelImport(_6106.HarmonicLoadDataImportBase['_6086.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6130.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6130.NamedSpeed))
        return value
