...
from mastapy.system_model.analyses_and_results.load_case_groups import _6176, _6177
from mastapy.system_model.analyses_and_results.static_loads import _5909
...
class StaticLoadCase(_5909.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_325.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_325.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_325.PlanetaryRatingLoadSharingOption'):
