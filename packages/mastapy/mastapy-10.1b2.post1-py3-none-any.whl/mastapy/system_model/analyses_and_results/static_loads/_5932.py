...
from mastapy.system_model.analyses_and_results.static_loads import _5931
...
class ElectricMachineHarmonicLoadDataFromExcel(_5931.ElectricMachineHarmonicLoadData):
    '''ElectricMachineHarmonicLoadDataFromExcel
