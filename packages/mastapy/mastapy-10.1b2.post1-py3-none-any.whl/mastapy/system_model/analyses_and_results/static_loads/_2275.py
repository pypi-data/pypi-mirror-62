...
class BearingLoadCase(_2280.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def friction_coefficients(self) -> '_1676.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1676.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None
