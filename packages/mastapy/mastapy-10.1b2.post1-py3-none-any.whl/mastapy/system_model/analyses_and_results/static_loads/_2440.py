...
from mastapy.system_model.analyses_and_results.static_loads import _2233, _2398, _2457
...
class ConceptGearSetLoadCase(_2457.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_2233.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_2233.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_2398.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_2398.ConceptGearMeshLoadCase))
        return value
