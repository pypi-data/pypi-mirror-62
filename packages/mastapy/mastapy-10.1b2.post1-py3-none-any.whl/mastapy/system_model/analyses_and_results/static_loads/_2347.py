...
from mastapy.system_model.analyses_and_results.static_loads import _2346, _2296, _2364
...
class ConceptGearSetLoadCase(_2364.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_2346.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_2346.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_2296.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_2296.ConceptGearMeshLoadCase))
        return value
