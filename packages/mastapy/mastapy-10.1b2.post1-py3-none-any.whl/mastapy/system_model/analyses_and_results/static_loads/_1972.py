...
from mastapy.system_model.analyses_and_results.load_case_groups import _6175, _6176
from mastapy.system_model.analyses_and_results.static_loads import _5908
...
class StaticLoadCase(_5908.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_314.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_314.PlanetaryRatingLoadSharingOption'):
