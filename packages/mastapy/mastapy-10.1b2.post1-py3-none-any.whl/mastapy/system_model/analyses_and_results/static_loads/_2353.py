...
from mastapy.system_model.analyses_and_results.static_loads import _2352, _2295, _2357
...
class BevelDifferentialGearSetLoadCase(_2357.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_2352.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_2352.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_2295.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_2295.BevelDifferentialGearMeshLoadCase))
        return value
