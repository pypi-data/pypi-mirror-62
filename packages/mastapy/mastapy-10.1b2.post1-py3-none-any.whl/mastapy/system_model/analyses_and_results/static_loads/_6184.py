...
from mastapy.math_utility import _1058, _1063
...
class UnbalancedMassHarmonicLoadData(_6155.SpeedDependentHarmonicLoadData):
    '''UnbalancedMassHarmonicLoadData
    ...
    def degree_of_freedom(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DegreesOfFreedom':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_DegreesOfFreedom.implicit_type()
    ...
    def degree_of_freedom(self, value: 'enum_with_selected_value.EnumWithSelectedValue_DegreesOfFreedom.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_DegreesOfFreedom.implicit_type().type_()
