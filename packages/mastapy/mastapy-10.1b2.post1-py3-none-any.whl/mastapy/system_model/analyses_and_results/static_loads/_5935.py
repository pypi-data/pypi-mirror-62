...
from mastapy.system_model.analyses_and_results.static_loads import _5931, _5937
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_5931.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
