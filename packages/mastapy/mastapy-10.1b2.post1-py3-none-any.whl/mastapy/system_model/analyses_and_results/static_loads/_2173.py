...
from mastapy.system_model.analyses_and_results.static_loads import _2171, _2262, _2324
...
class ZerolBevelGearSetLoadCase(_2324.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_2171.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_2171.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_2262.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_2262.ZerolBevelGearMeshLoadCase))
        return value
