...
from mastapy.system_model.analyses_and_results.static_loads import _6296, _6247, _2344
...
class PowerLoadLoadCase(_2344.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def wheel_slip_model(self) -> '_6043.WheelSlipType':
        ...
        return constructor.new(_6043.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_6043.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
