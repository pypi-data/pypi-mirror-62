...
from mastapy.system_model.analyses_and_results.static_loads import _6274, _6287, _6279
...
class HarmonicLoadDataJMAGImport(_6287.HarmonicLoadDataImportFromMotorPackages['_6279.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6274.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6274.DataFromJMAGPerSpeed))
        return value
