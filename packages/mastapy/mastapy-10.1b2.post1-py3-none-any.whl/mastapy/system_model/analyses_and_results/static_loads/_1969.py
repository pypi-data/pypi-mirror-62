...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6208
from mastapy.system_model.analyses_and_results.load_case_groups import _6170, _6171
...
class StaticLoadCase(_6061.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6308.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6308.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_6208.GearWhineAnalysisOptions':
        ...
        return constructor.new(_6208.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_6170.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6170.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6171.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6171.ConceptSynchroGearEngagementStatus))
        return value
