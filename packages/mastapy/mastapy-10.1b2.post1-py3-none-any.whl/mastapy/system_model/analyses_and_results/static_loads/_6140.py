...
from mastapy.system_model.analyses_and_results.static_loads import _6139, _6129
...
class PlanetCarrierLoadCase(_6129.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6139.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6139.PlanetarySocketManufactureError))
        return value
