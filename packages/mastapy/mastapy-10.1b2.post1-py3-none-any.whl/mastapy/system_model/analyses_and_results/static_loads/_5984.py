...
class PlanetaryGearSetLoadCase(_5925.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1246.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1246.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2004.PlanetaryGearSet':
