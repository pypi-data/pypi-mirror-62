...
from mastapy.system_model.analyses_and_results.static_loads import _5928, _5957, _5938
...
class HarmonicLoadDataJMAGImport(_5957.HarmonicLoadDataImportFromMotorPackages['_5938.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_5928.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_5928.DataFromJMAGPerSpeed))
        return value
