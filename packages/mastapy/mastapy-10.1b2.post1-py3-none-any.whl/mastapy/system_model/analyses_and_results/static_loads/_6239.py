...
class ConicalGearSetHarmonicLoadData(_6245.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_330.TESpecificationType':
        ...
        return constructor.new(_330.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_330.TESpecificationType'):
