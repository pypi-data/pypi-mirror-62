...
from mastapy.system_model.analyses_and_results.static_loads import _2194, _2182
...
class CVTLoadCase(_2182.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def assembly_design(self) -> '_2052.CVT':
    ...
    @property
    def pulleys(self) -> 'List[_2194.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2194.CVTPulleyLoadCase))
        return value
