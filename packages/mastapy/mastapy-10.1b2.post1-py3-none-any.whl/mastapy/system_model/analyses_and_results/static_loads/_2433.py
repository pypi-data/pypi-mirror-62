...
from mastapy.system_model.analyses_and_results.static_loads import _6244, _2438
...
class PointLoadLoadCase(_2438.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6244.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6244.PointLoadHarmonicLoadData)(method_result) if method_result else None
