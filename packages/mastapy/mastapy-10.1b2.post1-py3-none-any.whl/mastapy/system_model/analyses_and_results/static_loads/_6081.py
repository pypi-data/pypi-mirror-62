...
from mastapy.system_model.analyses_and_results.static_loads import _6181, _6110, _6155
...
class ElectricMachineHarmonicLoadData(_6155.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
    ...
    @property
    def excitations(self) -> 'List[_1063.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_1063.FourierSeries))
        return value
