...
from mastapy.nodal_analysis.varying_input_components import _124, _125
from mastapy.system_model.analyses_and_results.static_loads import _6252, _2344
...
class PointLoadLoadCase(_2344.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    @property
    def force_x(self) -> '_124.ForceInputComponent':
        ...
        return constructor.new(_124.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None

    @property
    def force_y(self) -> '_124.ForceInputComponent':
        ...
        return constructor.new(_124.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None

    @property
    def axial_load(self) -> '_124.ForceInputComponent':
        ...
        return constructor.new(_124.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None

    @property
    def moment_x(self) -> '_125.MomentInputComponent':
        ...
        return constructor.new(_125.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None

    @property
    def moment_y(self) -> '_125.MomentInputComponent':
        ...
        return constructor.new(_125.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None

    @property
    def moment_z(self) -> '_125.MomentInputComponent':
        ...
        return constructor.new(_125.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6252.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6252.PointLoadHarmonicLoadData)(method_result) if method_result else None
