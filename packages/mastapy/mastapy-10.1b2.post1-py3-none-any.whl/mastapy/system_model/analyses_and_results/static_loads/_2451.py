...
from mastapy.system_model.analyses_and_results.static_loads import _6262, _2456
...
class ConicalGearLoadCase(_2456.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6262.ConicalGearManufactureError':
