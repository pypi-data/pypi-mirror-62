...
from mastapy.system_model.analyses_and_results.static_loads import _5979, _5956, _5936
...
class HarmonicLoadDataExcelImport(_5956.HarmonicLoadDataImportBase['_5936.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_5979.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_5979.NamedSpeed))
        return value
