...
from mastapy.system_model.analyses_and_results.static_loads import _2070, _2071, _6253
from mastapy.system_model.imported_fes import _1881
...
class ElectricMachineHarmonicLoadData(_6253.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
