...
from mastapy.system_model.analyses_and_results.static_loads import _5973, _5974, _5969
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_5969.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_5973.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsLoadCase, constructor.new(_5973.KlingelnbergCycloPalloidSpiralBevelGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_5974.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesLoadCase, constructor.new(_5974.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase))
        return value
