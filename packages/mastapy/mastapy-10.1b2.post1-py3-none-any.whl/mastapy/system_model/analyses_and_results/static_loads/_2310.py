...
from mastapy.system_model.analyses_and_results.static_loads import _2045, _2339, _2288
...
class RootAssemblyLoadCase(_2288.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def load_case(self) -> '_2045.StaticLoadCase':
        ...
        return constructor.new(_2045.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None

    @property
    def supercharger_rotor_sets(self) -> 'List[_2339.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_2339.CylindricalGearSetLoadCase))
        return value
