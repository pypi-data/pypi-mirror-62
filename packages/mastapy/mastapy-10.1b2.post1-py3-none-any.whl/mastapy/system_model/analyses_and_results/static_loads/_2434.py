...
from mastapy.system_model import _1736, _1737, _1738
from mastapy.system_model.analyses_and_results.mbd_analyses import _6036
from mastapy.system_model.analyses_and_results.static_loads import _6290, _6267, _2438
...
class PowerLoadLoadCase(_2438.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1736.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1736.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1736.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_6036.WheelSlipType':
        ...
        return constructor.new(_6036.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_6036.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1738.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1738.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1738.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_design(self) -> '_1938.PowerLoad':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6267.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6267.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
