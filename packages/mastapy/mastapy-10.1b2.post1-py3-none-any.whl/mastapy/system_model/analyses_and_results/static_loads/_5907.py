...
from mastapy.system_model.analyses_and_results.static_loads import _5905, _5906, _5951
...
class ConceptGearSetLoadCase(_5951.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_5905.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_5905.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_5906.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_5906.ConceptGearMeshLoadCase))
        return value
