...
from mastapy.system_model.part_model.gears import (
    _1976, _1978, _1982, _1997,
    _2006, _2008, _2010, _2016
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.bevel import _697, _695, _696
from mastapy.system_model.analyses_and_results.static_loads import _5912
...
class AGMAGleasonConicalGearSetLoadCase(_5912.ConicalGearSetLoadCase):
    '''AGMAGleasonConicalGearSetLoadCase
    ...
    @property
    def assembly_design(self) -> '_1976.AGMAGleasonConicalGearSet':
    ...
    @property
    def overridden_manufacturing_config_micro_geometry(self) -> '_697.ConicalSetMicroGeometryConfigBase':
        ...
        return constructor.new(_697.ConicalSetMicroGeometryConfigBase)(self.wrapped.OverriddenManufacturingConfigMicroGeometry) if self.wrapped.OverriddenManufacturingConfigMicroGeometry else None

    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_manufacturing_config(self) -> '_695.ConicalSetManufacturingConfig':
        ...
        if _695.ConicalSetManufacturingConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
        ...
        return constructor.new(_695.ConicalSetManufacturingConfig)(self.wrapped.OverriddenManufacturingConfigMicroGeometry) if self.wrapped.OverriddenManufacturingConfigMicroGeometry else None

    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_micro_geometry_config(self) -> '_696.ConicalSetMicroGeometryConfig':
        ...
        if _696.ConicalSetMicroGeometryConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
        ...
        return constructor.new(_696.ConicalSetMicroGeometryConfig)(self.wrapped.OverriddenManufacturingConfigMicroGeometry) if self.wrapped.OverriddenManufacturingConfigMicroGeometry else None
