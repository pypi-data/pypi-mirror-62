...
class TimeSeriesLoadCase(_5909.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5988.MBDAnalysisOptions':
        ...
        return constructor.new(_5988.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
