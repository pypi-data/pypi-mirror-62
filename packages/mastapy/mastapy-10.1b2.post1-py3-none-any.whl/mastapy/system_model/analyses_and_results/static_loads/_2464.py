...
from mastapy.system_model.analyses_and_results.static_loads import _2460
...
class KlingelnbergCycloPalloidSpiralBevelGearLoadCase(_2460.KlingelnbergCycloPalloidConicalGearLoadCase):
    '''KlingelnbergCycloPalloidSpiralBevelGearLoadCase
