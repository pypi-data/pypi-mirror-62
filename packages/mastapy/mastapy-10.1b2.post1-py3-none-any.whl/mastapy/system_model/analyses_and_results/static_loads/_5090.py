...
class TimeSeriesLoadCase(_5915.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5994.MBDAnalysisOptions':
        ...
        return constructor.new(_5994.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
