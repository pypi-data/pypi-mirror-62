...
from mastapy.system_model.analyses_and_results.static_loads import _5988, _6031
...
class PointLoadLoadCase(_6031.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_5988.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_5988.PointLoadHarmonicLoadData)(method_result) if method_result else None
