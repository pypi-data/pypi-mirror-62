...
from mastapy.system_model.analyses_and_results.static_loads import _6068, _6034
...
class CVTLoadCase(_6034.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6068.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6068.CVTPulleyLoadCase))
        return value
