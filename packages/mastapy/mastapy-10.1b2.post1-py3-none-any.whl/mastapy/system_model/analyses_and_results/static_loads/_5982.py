...
class PartLoadCase(_2105.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6008.StaticLoadCase':
        ...
        return constructor.new(_6008.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_6022.TimeSeriesLoadCase':
        ...
        return constructor.new(_6022.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None

    def get_harmonic_load_data_for_import(self) -> '_5954.HarmonicLoadDataBase':
        ...
        return constructor.new(_5954.HarmonicLoadDataBase)(method_result) if method_result else None
