...
from mastapy.system_model.analyses_and_results.static_loads import _6247, _6278
...
T = TypeVar('T', bound='_6278.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6247.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
