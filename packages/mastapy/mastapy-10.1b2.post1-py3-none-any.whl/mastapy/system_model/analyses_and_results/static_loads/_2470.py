...
from mastapy.system_model.analyses_and_results.static_loads import _2469, _2400, _2450
...
class StraightBevelDiffGearSetLoadCase(_2450.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_2469.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_2469.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_2400.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_2400.StraightBevelDiffGearMeshLoadCase))
        return value
