...
from mastapy.system_model.analyses_and_results.static_loads import _5987
...
class PlanetarySocketManufactureError(_1.APIBase):
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_5987.PlanetManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_5987.PlanetManufactureError))
        return value
