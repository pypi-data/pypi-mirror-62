...
from mastapy.system_model.analyses_and_results.static_loads import _2380, _2269, _2345
...
class WormGearSetLoadCase(_2345.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_2380.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_2380.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_2269.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_2269.WormGearMeshLoadCase))
        return value
