...
from mastapy.system_model import _1742, _1743, _1744
from mastapy.system_model.analyses_and_results.mbd_analyses import _6044
from mastapy.system_model.analyses_and_results.static_loads import _6296, _6247, _2316
from mastapy.system_model.imported_fes import _1860
from mastapy.system_model.part_model import _1944
from mastapy.math_utility.control import _1259
from mastapy.nodal_analysis.varying_input_components import _126
...
class PowerLoadLoadCase(_2316.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1742.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1742.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1742.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_6044.WheelSlipType':
        ...
        return constructor.new(_6044.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_6044.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1744.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1744.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1744.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1259.PIDControlSettings':
        ...
        return constructor.new(_1259.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_126.NonDimensionalInputComponent':
        ...
        return constructor.new(_126.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1259.PIDControlSettings':
        ...
        return constructor.new(_1259.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6247.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6247.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
