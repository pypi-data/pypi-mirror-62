...
from mastapy.system_model.analyses_and_results.load_case_groups import _6169, _6170
...
class StaticLoadCase(_6126.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_316.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_316.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_316.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def clutch_engagements(self) -> 'List[_6169.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6169.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6170.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6170.ConceptSynchroGearEngagementStatus))
        return value
