...
from mastapy.system_model.analyses_and_results.static_loads import _6263, _2456
...
class CylindricalGearLoadCase(_2456.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6263.CylindricalGearManufactureError':
