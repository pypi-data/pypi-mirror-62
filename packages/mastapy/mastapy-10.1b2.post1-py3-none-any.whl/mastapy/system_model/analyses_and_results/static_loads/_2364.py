...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5969
...
class GearSetLoadCase(_2340.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5969.GearMeshStiffnessModel':
        ...
        return constructor.new(_5969.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5969.GearMeshStiffnessModel'):
