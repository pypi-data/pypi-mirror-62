...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6213
from mastapy.system_model.analyses_and_results.load_case_groups import _6175, _6176, _2044
from mastapy.system_model.analyses_and_results.static_loads import _5915
...
class StaticLoadCase(_5915.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_317.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_317.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_317.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6314.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6314.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_6213.GearWhineAnalysisOptions':
        ...
        return constructor.new(_6213.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_6175.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6175.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6176.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6176.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_2044.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
