...
from mastapy.system_model.analyses_and_results.static_loads import _6027, _5960, _6001
...
class ElectricMachineHarmonicLoadData(_6001.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    def torque_ripple_input_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType.implicit_type()
    ...
    def torque_ripple_input_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType.implicit_type().type_()
    ...
    @property
    def force_distribution(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
