...
from mastapy.system_model.analyses_and_results.static_loads import _5999
...
class PlanetaryConnectionLoadCase(_5999.ShaftToMountableComponentConnectionLoadCase):
    '''PlanetaryConnectionLoadCase
