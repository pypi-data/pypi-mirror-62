...
class PlanetarySocketManufactureError(_1.APIBase):
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6141.PlanetManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6141.PlanetManufactureError))
        return value
