...
from mastapy.utility import _1270
...
from mastapy.bearings.tolerances import _1502, _1507
from mastapy.bearings.bearing_results.rolling import _1645
...
class BearingLoadCase(_2323.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def include_fitting_effects(self) -> '_1270.LoadCaseOverrideOption':
        ...
        return constructor.new(_1270.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1270.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1270.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1270.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1270.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1270.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_5923.BearingStiffnessModel':
        ...
        return constructor.new(_5923.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5923.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5923.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1502.RaceDetail':
        ...
        return constructor.new(_1502.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1502.RaceDetail':
        ...
        return constructor.new(_1502.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None

    @property
    def left_support_detail(self) -> '_1507.SupportDetail':
        ...
        return constructor.new(_1507.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def right_support_detail(self) -> '_1507.SupportDetail':
        ...
        return constructor.new(_1507.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def inner_ring_detail(self) -> '_1502.RaceDetail':
        ...
        return constructor.new(_1502.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None

    @property
    def friction_coefficients(self) -> '_1645.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1645.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def outer_ring_detail(self) -> '_1502.RaceDetail':
        ...
        return constructor.new(_1502.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None

    @property
    def inner_support_detail(self) -> '_1507.SupportDetail':
        ...
        return constructor.new(_1507.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1507.SupportDetail':
        ...
        return constructor.new(_1507.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None
