...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4094, _4093, _4100
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4100.BevelGearSetModalAnalysisAtAStiffness):
    '''BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4094.BevelDifferentialGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysisAtAStiffness, constructor.new(_4094.BevelDifferentialGearModalAnalysisAtAStiffness))
        return value

    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4093.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysisAtAStiffness, constructor.new(_4093.BevelDifferentialGearMeshModalAnalysisAtAStiffness))
        return value
