...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _5517, _5516, _5433
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_5433.BevelGearSetModalAnalysisAtAStiffness):
    '''StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_5517.StraightBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtAStiffness, constructor.new(_5517.StraightBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_5516.StraightBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtAStiffness, constructor.new(_5516.StraightBevelGearMeshModalAnalysisAtAStiffness))
        return value
