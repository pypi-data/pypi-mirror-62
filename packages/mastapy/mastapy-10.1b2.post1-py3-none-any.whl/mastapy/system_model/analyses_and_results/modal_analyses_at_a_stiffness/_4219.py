...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4218, _4217, _4244
...
class ConceptGearSetModalAnalysisAtAStiffness(_4244.GearSetModalAnalysisAtAStiffness):
    '''ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4218.ConceptGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtAStiffness, constructor.new(_4218.ConceptGearModalAnalysisAtAStiffness))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4217.ConceptGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtAStiffness, constructor.new(_4217.ConceptGearMeshModalAnalysisAtAStiffness))
        return value
