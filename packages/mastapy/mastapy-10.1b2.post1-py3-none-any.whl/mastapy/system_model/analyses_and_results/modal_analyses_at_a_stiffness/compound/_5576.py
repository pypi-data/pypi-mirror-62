...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5545
...
class CVTCompoundModalAnalysisAtAStiffness(_5545.BeltDriveCompoundModalAnalysisAtAStiffness):
    '''CVTCompoundModalAnalysisAtAStiffness
