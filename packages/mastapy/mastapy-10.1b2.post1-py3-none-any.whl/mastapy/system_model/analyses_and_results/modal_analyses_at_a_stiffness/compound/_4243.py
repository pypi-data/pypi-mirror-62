...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4212
...
class CVTCompoundModalAnalysisAtAStiffness(_4212.BeltDriveCompoundModalAnalysisAtAStiffness):
    '''CVTCompoundModalAnalysisAtAStiffness
