...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _5445, _5444, _5471
...
class ConceptGearSetModalAnalysisAtAStiffness(_5471.GearSetModalAnalysisAtAStiffness):
    '''ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_5445.ConceptGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtAStiffness, constructor.new(_5445.ConceptGearModalAnalysisAtAStiffness))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_5444.ConceptGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtAStiffness, constructor.new(_5444.ConceptGearMeshModalAnalysisAtAStiffness))
        return value
