...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4126, _4125, _4138
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4138.GearSetModalAnalysisAtAStiffness):
    '''CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4126.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtAStiffness, constructor.new(_4126.CylindricalGearModalAnalysisAtAStiffness))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4125.CylindricalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtAStiffness, constructor.new(_4125.CylindricalGearMeshModalAnalysisAtAStiffness))
        return value
