...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4121
...
class ConceptCouplingModalAnalysisAtAStiffness(_4121.CouplingModalAnalysisAtAStiffness):
    '''ConceptCouplingModalAnalysisAtAStiffness
