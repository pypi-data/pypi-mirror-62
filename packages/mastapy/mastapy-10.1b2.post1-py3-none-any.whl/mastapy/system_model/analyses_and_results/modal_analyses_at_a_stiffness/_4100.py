...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4088
...
class BevelGearSetModalAnalysisAtAStiffness(_4088.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    '''BevelGearSetModalAnalysisAtAStiffness
