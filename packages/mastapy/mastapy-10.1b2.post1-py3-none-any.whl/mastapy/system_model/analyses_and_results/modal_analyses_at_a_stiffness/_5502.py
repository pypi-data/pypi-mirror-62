...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _5489, _5422
...
class RootAssemblyModalAnalysisAtAStiffness(_5422.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_5489.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_5489.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
