...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _5532, _5531, _5471
...
class WormGearSetModalAnalysisAtAStiffness(_5471.GearSetModalAnalysisAtAStiffness):
    '''WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_5532.WormGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtAStiffness, constructor.new(_5532.WormGearModalAnalysisAtAStiffness))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_5531.WormGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtAStiffness, constructor.new(_5531.WormGearMeshModalAnalysisAtAStiffness))
        return value
