...
class SpringDamperConnection(_1827.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1722.ComponentDampingOption':
        ...
        return constructor.new(_1722.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1722.ComponentDampingOption'):
