...
from mastapy.system_model.connections_and_sockets.gears import _1857
...
class KlingelnbergSpiralBevelGearTeethSocket(_1857.KlingelnbergConicalGearTeethSocket):
    '''KlingelnbergSpiralBevelGearTeethSocket
