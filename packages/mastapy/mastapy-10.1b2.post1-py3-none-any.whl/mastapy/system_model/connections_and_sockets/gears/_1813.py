...
class SpiralBevelGearMesh(_1793.BevelGearMesh):
    '''SpiralBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_848.SpiralBevelGearMeshDesign':
    ...
    @property
    def spiral_bevel_gear_mesh_design(self) -> '_848.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_848.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMeshDesign) if self.wrapped.SpiralBevelGearMeshDesign else None
