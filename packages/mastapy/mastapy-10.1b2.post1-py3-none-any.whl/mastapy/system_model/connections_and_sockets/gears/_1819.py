...
class WormGearMesh(_1803.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_836.WormGearMeshDesign':
        ...
        return constructor.new(_836.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
