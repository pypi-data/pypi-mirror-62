...
class ConceptGearMesh(_1853.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_902.ConceptGearMeshDesign':
        ...
        return constructor.new(_902.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
