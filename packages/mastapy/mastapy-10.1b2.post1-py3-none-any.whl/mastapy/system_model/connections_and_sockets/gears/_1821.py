...
class ZerolBevelGearMesh(_1793.BevelGearMesh):
    '''ZerolBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_831.ZerolBevelGearMeshDesign':
    ...
    @property
    def zerol_bevel_gear_mesh_design(self) -> '_831.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_831.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMeshDesign) if self.wrapped.ZerolBevelGearMeshDesign else None
