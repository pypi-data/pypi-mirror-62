...
class KlingelnbergCycloPalloidHypoidGearMesh(_1858.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidHypoidGearMesh
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_734.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_734.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign else None
