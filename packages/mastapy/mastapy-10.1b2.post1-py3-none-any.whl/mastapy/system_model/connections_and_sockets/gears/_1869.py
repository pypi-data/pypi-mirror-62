...
class WormGearMesh(_1853.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_714.WormGearMeshDesign':
        ...
        return constructor.new(_714.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
