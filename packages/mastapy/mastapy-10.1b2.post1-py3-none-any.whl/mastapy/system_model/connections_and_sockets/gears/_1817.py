...
class StraightBevelGearMesh(_1793.BevelGearMesh):
    '''StraightBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_844.StraightBevelGearMeshDesign':
    ...
    @property
    def straight_bevel_gear_mesh_design(self) -> '_844.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_844.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMeshDesign) if self.wrapped.StraightBevelGearMeshDesign else None
