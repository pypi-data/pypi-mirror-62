...
class ConceptGearMesh(_1803.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1023.ConceptGearMeshDesign':
        ...
        return constructor.new(_1023.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
