...
class FaceGearMesh(_1803.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_869.FaceGearMeshDesign':
        ...
        return constructor.new(_869.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
