...
class StraightBevelDiffGearMesh(_1793.BevelGearMesh):
    '''StraightBevelDiffGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_840.StraightBevelDiffGearMeshDesign':
    ...
    @property
    def straight_bevel_diff_gear_mesh_design(self) -> '_840.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_840.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMeshDesign) if self.wrapped.StraightBevelDiffGearMeshDesign else None
