...
from mastapy.gears.gear_designs.worm import _463
...
class WormGearMesh(_1812.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_463.WormGearMeshDesign':
        ...
        return constructor.new(_463.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
