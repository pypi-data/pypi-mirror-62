...
from mastapy import _4, _321, _1
...
from mastapy.gears import _293, _301
...
from mastapy.system_model.part_model.configurations import _1968, _1969, _1970
from mastapy.system_model.analyses_and_results.load_case_groups import _1971, _1973
from mastapy.system_model.analyses_and_results.static_loads import _1972
from mastapy.utility.model_validation import _1277
from mastapy.system_model.database_access import _1763
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _1975
...
from mastapy.gears.gear_designs.creation_options import _1074, _1077
from mastapy.nodal_analysis import _104
from mastapy.bearings.bearing_designs.rolling import _1703
...
class Design(_1.APIBase):
    ...
    @property
    def gear_set_design_group(self) -> '_301.GearSetDesignGroup':
        ...
        return constructor.new(_301.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_1967.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_1967.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None
    ...
    @property
    def gear_set_configurations(self) -> 'List[_1967.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_1967.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_1968.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_1968.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_1969.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_1969.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_1970.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_1970.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_1971.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_1971.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_1972.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_1972.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_1973.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_1973.DutyCycle))
        return value
    ...
    @property
    def gear_set_config(self) -> '_1974.GearSetConfiguration':
        ...
        return constructor.new(_1974.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @property
    def status(self) -> '_1277.Status':
        ...
        return constructor.new(_1277.Status)(self.wrapped.Status) if self.wrapped.Status else None
    ...
    def remove_synchroniser_shift(self, shift: '_1975.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_1975.SynchroniserShift':
        ...
        return constructor.new(_1975.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_1975.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_1971.DesignState':
        ...
        return constructor.new(_1971.DesignState)(method_result) if method_result else None

    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_1973.DutyCycle':
        ...
        return constructor.new(_1973.DutyCycle)(method_result) if method_result else None

    def design_state_named(self, name: 'str') -> '_1971.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_1973.DutyCycle':
    ...
    def all_parts_of_type_hypoid_gear(self) -> 'List[_1995.HypoidGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1995.HypoidGear.TYPE](), constructor.new(_1995.HypoidGear))

    def all_parts_of_type_hypoid_gear_set(self) -> 'List[_1996.HypoidGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1996.HypoidGearSet.TYPE](), constructor.new(_1996.HypoidGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> 'List[_1997.KlingelnbergCycloPalloidConicalGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1997.KlingelnbergCycloPalloidConicalGear.TYPE](), constructor.new(_1997.KlingelnbergCycloPalloidConicalGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> 'List[_1998.KlingelnbergCycloPalloidConicalGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1998.KlingelnbergCycloPalloidConicalGearSet.TYPE](), constructor.new(_1998.KlingelnbergCycloPalloidConicalGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> 'List[_1999.KlingelnbergCycloPalloidHypoidGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1999.KlingelnbergCycloPalloidHypoidGear.TYPE](), constructor.new(_1999.KlingelnbergCycloPalloidHypoidGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> 'List[_2000.KlingelnbergCycloPalloidHypoidGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2000.KlingelnbergCycloPalloidHypoidGearSet.TYPE](), constructor.new(_2000.KlingelnbergCycloPalloidHypoidGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> 'List[_2001.KlingelnbergCycloPalloidSpiralBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2001.KlingelnbergCycloPalloidSpiralBevelGear.TYPE](), constructor.new(_2001.KlingelnbergCycloPalloidSpiralBevelGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> 'List[_2002.KlingelnbergCycloPalloidSpiralBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2002.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE](), constructor.new(_2002.KlingelnbergCycloPalloidSpiralBevelGearSet))

    def all_parts_of_type_planetary_gear_set(self) -> 'List[_2003.PlanetaryGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2003.PlanetaryGearSet.TYPE](), constructor.new(_2003.PlanetaryGearSet))
    ...
    def all_parts_of_type_spiral_bevel_gear_set(self) -> 'List[_2005.SpiralBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2005.SpiralBevelGearSet.TYPE](), constructor.new(_2005.SpiralBevelGearSet))

    def all_parts_of_type_straight_bevel_diff_gear(self) -> 'List[_2006.StraightBevelDiffGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2006.StraightBevelDiffGear.TYPE](), constructor.new(_2006.StraightBevelDiffGear))

    def all_parts_of_type_straight_bevel_diff_gear_set(self) -> 'List[_2007.StraightBevelDiffGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2007.StraightBevelDiffGearSet.TYPE](), constructor.new(_2007.StraightBevelDiffGearSet))

    def all_parts_of_type_straight_bevel_gear(self) -> 'List[_2008.StraightBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2008.StraightBevelGear.TYPE](), constructor.new(_2008.StraightBevelGear))

    def all_parts_of_type_straight_bevel_gear_set(self) -> 'List[_2009.StraightBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2009.StraightBevelGearSet.TYPE](), constructor.new(_2009.StraightBevelGearSet))
    ...
    def all_parts_of_type_worm_gear_set(self) -> 'List[_2013.WormGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2013.WormGearSet.TYPE](), constructor.new(_2013.WormGearSet))

    def all_parts_of_type_zerol_bevel_gear(self) -> 'List[_2014.ZerolBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2014.ZerolBevelGear.TYPE](), constructor.new(_2014.ZerolBevelGear))

    def all_parts_of_type_zerol_bevel_gear_set(self) -> 'List[_2015.ZerolBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2015.ZerolBevelGearSet.TYPE](), constructor.new(_2015.ZerolBevelGearSet))

    def all_parts_of_type_belt_drive(self) -> 'List[_2016.BeltDrive]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2016.BeltDrive.TYPE](), constructor.new(_2016.BeltDrive))

    def all_parts_of_type_clutch(self) -> 'List[_2017.Clutch]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2017.Clutch.TYPE](), constructor.new(_2017.Clutch))

    def all_parts_of_type_clutch_half(self) -> 'List[_2018.ClutchHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2018.ClutchHalf.TYPE](), constructor.new(_2018.ClutchHalf))

    def all_parts_of_type_concept_coupling(self) -> 'List[_2019.ConceptCoupling]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2019.ConceptCoupling.TYPE](), constructor.new(_2019.ConceptCoupling))

    def all_parts_of_type_concept_coupling_half(self) -> 'List[_2020.ConceptCouplingHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2020.ConceptCouplingHalf.TYPE](), constructor.new(_2020.ConceptCouplingHalf))

    def all_parts_of_type_coupling(self) -> 'List[_2021.Coupling]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2021.Coupling.TYPE](), constructor.new(_2021.Coupling))

    def all_parts_of_type_coupling_half(self) -> 'List[_2022.CouplingHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2022.CouplingHalf.TYPE](), constructor.new(_2022.CouplingHalf))

    def all_parts_of_type_cvt(self) -> 'List[_2023.CVT]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2023.CVT.TYPE](), constructor.new(_2023.CVT))

    def all_parts_of_type_cvt_pulley(self) -> 'List[_2024.CVTPulley]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2024.CVTPulley.TYPE](), constructor.new(_2024.CVTPulley))

    def all_parts_of_type_pulley(self) -> 'List[_2025.Pulley]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2025.Pulley.TYPE](), constructor.new(_2025.Pulley))

    def all_parts_of_type_rolling_ring(self) -> 'List[_2026.RollingRing]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2026.RollingRing.TYPE](), constructor.new(_2026.RollingRing))

    def all_parts_of_type_rolling_ring_assembly(self) -> 'List[_2027.RollingRingAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2027.RollingRingAssembly.TYPE](), constructor.new(_2027.RollingRingAssembly))
    ...
    def all_parts_of_type_spring_damper(self) -> 'List[_2029.SpringDamper]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2029.SpringDamper.TYPE](), constructor.new(_2029.SpringDamper))

    def all_parts_of_type_spring_damper_half(self) -> 'List[_2030.SpringDamperHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2030.SpringDamperHalf.TYPE](), constructor.new(_2030.SpringDamperHalf))

    def all_parts_of_type_synchroniser(self) -> 'List[_2031.Synchroniser]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2031.Synchroniser.TYPE](), constructor.new(_2031.Synchroniser))

    def all_parts_of_type_synchroniser_half(self) -> 'List[_2032.SynchroniserHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2032.SynchroniserHalf.TYPE](), constructor.new(_2032.SynchroniserHalf))

    def all_parts_of_type_synchroniser_part(self) -> 'List[_2033.SynchroniserPart]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2033.SynchroniserPart.TYPE](), constructor.new(_2033.SynchroniserPart))
    ...
    def all_parts_of_type_torque_converter(self) -> 'List[_2035.TorqueConverter]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2035.TorqueConverter.TYPE](), constructor.new(_2035.TorqueConverter))

    def all_parts_of_type_torque_converter_pump(self) -> 'List[_2036.TorqueConverterPump]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2036.TorqueConverterPump.TYPE](), constructor.new(_2036.TorqueConverterPump))

    def all_parts_of_type_torque_converter_turbine(self) -> 'List[_2037.TorqueConverterTurbine]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2037.TorqueConverterTurbine.TYPE](), constructor.new(_2037.TorqueConverterTurbine))
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2038.BeltCreationOptions':
        ...
        return constructor.new(_2038.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2039.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2039.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2040.ShaftCreationOptions':
        ...
        return constructor.new(_2040.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_1074.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_1074.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2041.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2041.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_1077.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_1077.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1703.RollingBearing'):
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1277.Status':
        ...
        return constructor.new(_1277.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_321.TaskProgress') -> '_1277.Status':
        ''' 'Save' is the original name of this method.
