...
from mastapy.system_model.drawing import _1807, _1806
...
class ContourDrawStyle(_113.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1321.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1321.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1321.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1807.ScalingDrawStyle':
        ...
        return constructor.new(_1807.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1806.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1806.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
