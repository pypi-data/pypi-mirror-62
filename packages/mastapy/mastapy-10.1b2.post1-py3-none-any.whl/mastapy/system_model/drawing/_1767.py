...
from mastapy.system_model.analyses_and_results.system_deflections import _2111
...
class ShaftDeflectionDrawingNodeItem(_1.APIBase):
    ...
    @property
    def node_detail(self) -> '_114.ForceAndDisplacementResults':
        ...
        return constructor.new(_114.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2111.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2111.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2111.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2111.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
