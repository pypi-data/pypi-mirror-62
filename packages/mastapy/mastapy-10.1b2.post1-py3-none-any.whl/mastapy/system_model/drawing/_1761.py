...
from mastapy.math_utility.measured_vectors import _105
from mastapy.system_model.analyses_and_results.system_deflections import _2103
...
class ShaftDeflectionDrawingNodeItem(_1.APIBase):
    ...
    @property
    def node_detail(self) -> '_105.ForceAndDisplacementResults':
        ...
        return constructor.new(_105.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2103.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2103.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2103.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2103.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
