...
from mastapy.system_model.drawing import _1767
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_1.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2076.ShaftSystemDeflection':
        ...
        return constructor.new(_2076.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection else None

    @property
    def node_results(self) -> 'List[_1767.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1767.ShaftDeflectionDrawingNodeItem))
        return value
