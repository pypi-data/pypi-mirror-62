...
from mastapy.system_model.drawing import _1757, _1756
from mastapy.geometry import _242
...
class ContourDrawStyle(_242.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1437.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1437.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1437.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1757.ScalingDrawStyle':
        ...
        return constructor.new(_1757.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1756.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1756.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
