...
from mastapy.utility.enums import _1451
from mastapy._internal import constructor, conversion
from mastapy.system_model.drawing import _1766, _1765
from mastapy.geometry import _285
...
class ContourDrawStyle(_285.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1451.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1451.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1451.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1766.ScalingDrawStyle':
        ...
        return constructor.new(_1766.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1765.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1765.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
