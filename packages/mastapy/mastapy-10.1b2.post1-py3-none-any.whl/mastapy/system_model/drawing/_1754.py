...
from mastapy.system_model.drawing import _1758
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_1.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2226.ShaftSystemDeflection':
        ...
        return constructor.new(_2226.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection else None

    @property
    def node_results(self) -> 'List[_1758.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1758.ShaftDeflectionDrawingNodeItem))
        return value
