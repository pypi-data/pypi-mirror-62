...
class ComponentsConnectedResult(_1.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_1916.ConnectedSockets':
        ...
        return constructor.new(_1916.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
