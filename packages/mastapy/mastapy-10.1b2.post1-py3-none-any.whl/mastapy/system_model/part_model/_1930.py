...
class MountableComponent(_1914.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_1945.Shaft', offset: Optional['float'] = float('nan')) -> '_1762.CoaxialConnection':
        ...
        return constructor.new(_1762.CoaxialConnection)(method_result) if method_result else None
