...
class WindTurbineSingleBladeDetails(_1.APIBase):
    ...
    @property
    def edgewise_modes(self) -> '_2020.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2020.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes else None

    @property
    def flapwise_modes(self) -> '_2020.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2020.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes else None
