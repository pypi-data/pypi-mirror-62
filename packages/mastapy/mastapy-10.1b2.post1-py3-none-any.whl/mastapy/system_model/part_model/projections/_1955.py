...
from mastapy.system_model.part_model.projections import _1954
...
class SpecifiedParallelPartGroupDrawingOrder(_1.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_1954.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_1954.SpecifiedConcentricPartGroupDrawingOrder))
        return value
