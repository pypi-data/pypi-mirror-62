...
from mastapy.system_model.part_model.projections import _2023
...
class SpecifiedParallelPartGroupDrawingOrder(_1.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2023.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2023.SpecifiedConcentricPartGroupDrawingOrder))
        return value
