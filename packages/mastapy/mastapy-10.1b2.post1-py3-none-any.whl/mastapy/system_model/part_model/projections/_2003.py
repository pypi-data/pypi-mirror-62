...
from mastapy.system_model.part_model.projections import _2002
...
class SpecifiedParallelPartGroupDrawingOrder(_1.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2002.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2002.SpecifiedConcentricPartGroupDrawingOrder))
        return value
