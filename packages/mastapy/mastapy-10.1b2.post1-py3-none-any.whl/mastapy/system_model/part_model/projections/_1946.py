...
class SpecifiedParallelPartGroupDrawingOrder(_1.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_1945.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_1945.SpecifiedConcentricPartGroupDrawingOrder))
        return value
