...
from mastapy.system_model.part_model import _1950
...
class WindTurbineSingleBladeDetails(_1.APIBase):
    ...
    @property
    def edgewise_modes(self) -> '_1950.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_1950.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes else None

    @property
    def flapwise_modes(self) -> '_1950.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_1950.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes else None
