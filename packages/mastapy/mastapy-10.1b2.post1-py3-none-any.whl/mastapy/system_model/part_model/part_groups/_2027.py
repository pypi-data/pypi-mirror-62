...
from mastapy.system_model.part_model.part_groups import _2025, _2026, _2029
...
class ConcentricPartGroupParallelToThis(_1.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2025.ConcentricOrParallelPartGroup':
        ...
        return constructor.new(_2025.ConcentricOrParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2026.ConcentricPartGroup':
        ...
        if _2026.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2026.ConcentricPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2029.ParallelPartGroup':
        ...
        if _2029.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2029.ParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None
