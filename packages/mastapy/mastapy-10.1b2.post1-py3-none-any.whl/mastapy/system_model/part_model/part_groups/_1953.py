...
from mastapy.system_model.part_model.part_groups import _1950, _1952, _1949
...
class ParallelPartGroup(_1949.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_1950.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_1950.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_1952.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_1952.DesignMeasurements))
        return value
