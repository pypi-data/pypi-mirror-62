...
class DesignMeasurements(_1.APIBase):
    ...
    @property
    def component_connections(self) -> 'List[_1773.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1773.ComponentMeasurer))
        return value
