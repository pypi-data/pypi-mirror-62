...
from mastapy.system_model.part_model.part_groups import _1949, _1950, _1953
...
class ConcentricPartGroupParallelToThis(_1.APIBase):
    ...
    @property
    def parallel_group(self) -> '_1949.ConcentricOrParallelPartGroup':
        ...
        return constructor.new(_1949.ConcentricOrParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_1950.ConcentricPartGroup':
        ...
        if _1950.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_1950.ConcentricPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_1953.ParallelPartGroup':
        ...
        if _1953.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_1953.ParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None
