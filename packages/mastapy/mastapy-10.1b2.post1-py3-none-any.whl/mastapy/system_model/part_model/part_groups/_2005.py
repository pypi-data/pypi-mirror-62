...
from mastapy.math_utility.measured_vectors import _1048
from mastapy.utility.units_and_measurements.measurements import _1191
from mastapy.system_model.part_model.part_groups import _2006, _2004
...
class ConcentricPartGroup(_2004.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def radial_position(self) -> '_1048.Vector2D[_1191.LengthShort]':
        ...
        return constructor.new(_1048.Vector2D)[_1191.LengthShort](self.wrapped.RadialPosition) if self.wrapped.RadialPosition else None

    @property
    def parallel_groups(self) -> 'List[_2006.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2006.ConcentricPartGroupParallelToThis))
        return value
