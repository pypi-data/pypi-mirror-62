...
from mastapy.system_model.connections_and_sockets import _1767
...
class DesignMeasurements(_1.APIBase):
    ...
    @property
    def component_connections(self) -> 'List[_1767.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1767.ComponentMeasurer))
        return value
