...
from mastapy.system_model.part_model.part_groups import _2026, _2028, _2025
...
class ParallelPartGroup(_2025.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2026.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2026.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2028.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2028.DesignMeasurements))
        return value
