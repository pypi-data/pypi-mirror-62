...
from mastapy.system_model.part_model.part_groups import _1956, _1957, _1960
...
class ConcentricPartGroupParallelToThis(_1.APIBase):
    ...
    @property
    def parallel_group(self) -> '_1956.ConcentricOrParallelPartGroup':
        ...
        return constructor.new(_1956.ConcentricOrParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_1957.ConcentricPartGroup':
        ...
        if _1957.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_1957.ConcentricPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_1960.ParallelPartGroup':
        ...
        if _1960.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_1960.ParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None
