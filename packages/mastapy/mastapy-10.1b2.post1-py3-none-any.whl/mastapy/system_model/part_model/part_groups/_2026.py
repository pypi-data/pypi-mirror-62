...
from mastapy.math_utility.measured_vectors import _1086
from mastapy.utility.units_and_measurements.measurements import _1098
from mastapy.system_model.part_model.part_groups import _2027, _2025
...
class ConcentricPartGroup(_2025.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def radial_position(self) -> '_1086.Vector2D[_1098.LengthShort]':
        ...
        return constructor.new(_1086.Vector2D)[_1098.LengthShort](self.wrapped.RadialPosition) if self.wrapped.RadialPosition else None

    @property
    def parallel_groups(self) -> 'List[_2027.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2027.ConcentricPartGroupParallelToThis))
        return value
