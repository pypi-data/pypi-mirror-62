...
from mastapy.system_model.part_model.part_groups import _1957, _1959, _1956
...
class ParallelPartGroup(_1956.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_1957.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_1957.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_1959.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_1959.DesignMeasurements))
        return value
