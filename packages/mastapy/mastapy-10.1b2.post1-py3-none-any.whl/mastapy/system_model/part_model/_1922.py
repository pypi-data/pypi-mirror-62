...
class FlexiblePinAssembly(_1940.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_1987.CylindricalGear':
        ...
        return constructor.new(_1987.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
