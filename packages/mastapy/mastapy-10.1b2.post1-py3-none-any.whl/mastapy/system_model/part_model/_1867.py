...
from mastapy.system_model.part_model import _1857
...
class ImportedFEComponent(_1857.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_104.ImportedFE':
        ...
        return constructor.new(_104.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_104.ImportedFE':
        ...
        return constructor.new(_104.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_104.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_104.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_104.ImportedFE') -> 'bool':
