...
class FlexiblePinAssembly(_1874.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_1890.CylindricalGear':
        ...
        return constructor.new(_1890.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
