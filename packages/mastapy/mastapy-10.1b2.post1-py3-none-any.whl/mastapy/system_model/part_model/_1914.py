...
from mastapy.math_utility import _1174, _1175
from mastapy.system_model.connections_and_sockets import _1763, _1780
...
class Component(_1933.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1174.CoordinateSystem3D':
        ...
        return constructor.new(_1174.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1763.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1763.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1174.CoordinateSystem3D') -> '_1780.RealignmentResult':
        ...
        return constructor.new(_1780.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1780.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1175.CoordinateSystemEditor':
        ...
        return constructor.new(_1175.CoordinateSystemEditor)(method_result) if method_result else None
