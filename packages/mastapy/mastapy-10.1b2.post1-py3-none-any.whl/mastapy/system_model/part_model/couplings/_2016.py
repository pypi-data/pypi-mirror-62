...
from mastapy.system_model.part_model.couplings import _2078, _2020
from mastapy.system_model.analyses_and_results.mbd_analyses import _2176
...
class Clutch(_2020.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2078.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2078.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2078.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_2176.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_2176.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_2176.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1832.ClutchConnection':
        ...
        return constructor.new(_1832.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
