...
from mastapy.system_model.part_model.couplings import _2062, _2064, _2041
...
class TorqueConverter(_2041.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2062.TorqueConverterPump':
        ...
        return constructor.new(_2062.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2064.TorqueConverterTurbine':
        ...
        return constructor.new(_2064.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
