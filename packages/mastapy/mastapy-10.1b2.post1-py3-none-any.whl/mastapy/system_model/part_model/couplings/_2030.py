...
from mastapy.system_model.part_model.couplings import _2084, _2031
...
class SynchroniserHalf(_2031.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2084.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2084.SynchroniserCone))
        return value
