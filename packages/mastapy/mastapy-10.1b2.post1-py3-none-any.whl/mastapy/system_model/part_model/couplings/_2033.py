...
from mastapy.system_model.part_model.couplings import _2034, _2035, _2020
...
class TorqueConverter(_2020.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2034.TorqueConverterPump':
        ...
        return constructor.new(_2034.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2035.TorqueConverterTurbine':
        ...
        return constructor.new(_2035.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
