...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2139
...
class Clutch(_1975.Coupling):
    ...
    @property
    def spring_type(self) -> '_2139.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_2139.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_2139.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
