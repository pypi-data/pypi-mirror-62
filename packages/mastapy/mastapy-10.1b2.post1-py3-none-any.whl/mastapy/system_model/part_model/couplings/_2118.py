...
from mastapy.system_model.part_model.couplings import _2119, _2121, _2096
...
class TorqueConverter(_2096.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2119.TorqueConverterPump':
        ...
        return constructor.new(_2119.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2121.TorqueConverterTurbine':
        ...
        return constructor.new(_2121.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
