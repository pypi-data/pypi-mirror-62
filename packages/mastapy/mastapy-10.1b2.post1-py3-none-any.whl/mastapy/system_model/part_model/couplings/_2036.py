...
from mastapy.system_model.part_model.couplings import _2038, _2041
from mastapy.system_model.analyses_and_results.mbd_analyses import _4844
...
class Clutch(_2041.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2038.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2038.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2038.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_4844.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_4844.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_4844.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1823.ClutchConnection':
        ...
        return constructor.new(_1823.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
