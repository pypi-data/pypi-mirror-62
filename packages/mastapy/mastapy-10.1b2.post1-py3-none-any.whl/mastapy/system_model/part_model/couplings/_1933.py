...
from mastapy.system_model.part_model.couplings import _1936, _1934
...
class Synchroniser(_1874.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_1936.SynchroniserSleeve':
        ...
        return constructor.new(_1936.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_1934.SynchroniserHalf':
        ...
        return constructor.new(_1934.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_1934.SynchroniserHalf':
        ...
        return constructor.new(_1934.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1826.ClutchConnection':
        ...
        return constructor.new(_1826.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1826.ClutchConnection':
        ...
        return constructor.new(_1826.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
