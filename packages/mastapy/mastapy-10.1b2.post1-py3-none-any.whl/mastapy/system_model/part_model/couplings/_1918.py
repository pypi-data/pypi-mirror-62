...
from mastapy.system_model.part_model.couplings import _2070, _1927
...
class BeltDrive(_1874.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2070.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2070.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2070.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_1927.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_1927.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1764.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1764.BeltConnection))
        return value
