...
from mastapy.system_model.part_model.couplings import _1924
...
class RollingRing(_1924.CouplingHalf):
    '''RollingRing
    ...
    @property
    def largest_end(self) -> '_313.Hand':
    ...
    @largest_end.setter
    def largest_end(self, value: '_313.Hand'):
