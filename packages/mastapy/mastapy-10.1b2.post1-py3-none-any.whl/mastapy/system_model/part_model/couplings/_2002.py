...
class ShaftHubConnection(_1916.Connector):
    '''ShaftHubConnection
    ...
    @property
    def twod_spline_drawing(self) -> '_729.SMTBitmap':
        ...
        return constructor.new(_729.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
