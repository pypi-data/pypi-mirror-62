...
from mastapy.system_model.part_model.couplings import _2035, _2045
...
class BeltDrive(_1940.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2035.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2035.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2035.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2045.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2045.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1761.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1761.BeltConnection))
        return value
