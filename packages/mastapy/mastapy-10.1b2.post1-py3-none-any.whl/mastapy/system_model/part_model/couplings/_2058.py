...
from mastapy.system_model.part_model.couplings import _2057, _2059
...
class SynchroniserHalf(_2059.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2057.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2057.SynchroniserCone))
        return value
