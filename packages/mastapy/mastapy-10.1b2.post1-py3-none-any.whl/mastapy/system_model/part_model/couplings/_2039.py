...
class ConceptCoupling(_2041.Coupling):
    '''ConceptCoupling
    ...
    @property
    def coupling_type(self) -> '_50.CouplingType':
        '''CouplingType: 'CouplingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CouplingType)
        return constructor.new(_50.CouplingType)(value) if value else None

    @coupling_type.setter
    def coupling_type(self, value: '_50.CouplingType'):
