...
from mastapy.nodal_analysis import _1343
from mastapy.system_model.part_model.couplings import _2096
...
class ConceptCoupling(_2096.Coupling):
    '''ConceptCoupling
    ...
    @property
    def coupling_type(self) -> '_1343.CouplingType':
        '''CouplingType: 'CouplingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CouplingType)
        return constructor.new(_1343.CouplingType)(value) if value else None

    @coupling_type.setter
    def coupling_type(self, value: '_1343.CouplingType'):
