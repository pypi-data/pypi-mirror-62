...
from mastapy.system_model.part_model.couplings import (
    _2073, _2076, _2072, _2075,
    _2074
)
from mastapy.detailed_rigid_connectors.splines import (
    _1148, _1132, _1153, _1127,
    _1130, _1134, _1137, _1139,
    _1146, _1158
)
...
from mastapy.system_model.part_model import _1862
...
class ShaftHubConnection(_1862.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2073.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2073.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2073.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def twod_spline_drawing(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1127.CustomSplineJointDesign':
        ...
        if _1127.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1127.CustomSplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1130.DIN5480SplineJointDesign':
        ...
        if _1130.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1130.DIN5480SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1134.GBT3478SplineJointDesign':
        ...
        if _1134.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1134.GBT3478SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1137.ISO4156SplineJointDesign':
        ...
        if _1137.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1137.ISO4156SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None
    ...
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1139.JISB1603SplineJointDesign':
        ...
        if _1139.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1146.SAESplineJointDesign':
        ...
        if _1146.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1158.StandardSplineJointDesign':
        ...
        if _1158.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1158.StandardSplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def interference_fit_design(self) -> '_1184.InterferenceFitDesign':
        ...
        return constructor.new(_1184.InterferenceFitDesign)(self.wrapped.InterferenceFitDesign) if self.wrapped.InterferenceFitDesign else None
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2074.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2074.RigidConnectorToothLocation))
        return value
