...
from mastapy.system_model.part_model.couplings import _2060, _2058
...
class Synchroniser(_1940.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2060.SynchroniserSleeve':
        ...
        return constructor.new(_2060.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2058.SynchroniserHalf':
        ...
        return constructor.new(_2058.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2058.SynchroniserHalf':
        ...
        return constructor.new(_2058.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1823.ClutchConnection':
        ...
        return constructor.new(_1823.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1823.ClutchConnection':
        ...
        return constructor.new(_1823.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
