...
from mastapy.system_model.part_model.couplings import _2068, _2026
...
class BeltDrive(_1938.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def pulleys(self) -> 'List[_2026.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2026.Pulley))
        return value
