...
from mastapy.system_model.part_model.couplings import _1938, _1939, _1923
...
class TorqueConverter(_1923.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_1938.TorqueConverterPump':
        ...
        return constructor.new(_1938.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_1939.TorqueConverterTurbine':
        ...
        return constructor.new(_1939.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
