...
from mastapy.system_model.part_model.couplings import _2093, _2096
...
class Clutch(_2096.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2093.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2093.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2093.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_4968.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_4968.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_4968.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1873.ClutchConnection':
        ...
        return constructor.new(_1873.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
