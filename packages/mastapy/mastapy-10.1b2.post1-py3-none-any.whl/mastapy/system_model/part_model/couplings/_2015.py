...
from mastapy.system_model.part_model.couplings import _2077, _2024
...
class BeltDrive(_1947.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2077.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2077.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2077.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2024.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2024.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1770.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1770.BeltConnection))
        return value
