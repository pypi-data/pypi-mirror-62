...
from mastapy.system_model.part_model.couplings import _1923
...
class ConceptCoupling(_1923.Coupling):
    '''ConceptCoupling
    ...
    @property
    def coupling_type(self) -> '_77.CouplingType':
        '''CouplingType: 'CouplingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CouplingType)
        return constructor.new(_77.CouplingType)(value) if value else None

    @coupling_type.setter
    def coupling_type(self, value: '_77.CouplingType'):
