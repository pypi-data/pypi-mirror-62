...
from mastapy.system_model.part_model.couplings import _2077, _1935
...
class SynchroniserHalf(_1935.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2077.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2077.SynchroniserCone))
        return value
