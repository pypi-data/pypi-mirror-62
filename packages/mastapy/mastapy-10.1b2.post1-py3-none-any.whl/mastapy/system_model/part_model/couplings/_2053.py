...
from mastapy.system_model.part_model.couplings import (
    _2047, _2050, _2046, _2049,
    _2048
)
from mastapy.detailed_rigid_connectors.splines import (
    _1105, _1090, _1110, _1085,
    _1088, _1092, _1095, _1096,
    _1103, _1115
)
...
from mastapy.system_model.part_model import _1917
...
class ShaftHubConnection(_1917.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2047.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2047.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2047.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1105.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1105.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_1105.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1110.SplineJointDesign':
        ...
        return constructor.new(_1110.SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1085.CustomSplineJointDesign':
        ...
        if _1085.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1085.CustomSplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1088.DIN5480SplineJointDesign':
        ...
        if _1088.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1088.DIN5480SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1092.GBT3478SplineJointDesign':
        ...
        if _1092.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1092.GBT3478SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1095.ISO4156SplineJointDesign':
        ...
        if _1095.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1095.ISO4156SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1096.JISB1603SplineJointDesign':
        ...
        if _1096.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1096.JISB1603SplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1103.SAESplineJointDesign':
        ...
        if _1103.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1103.SAESplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1115.StandardSplineJointDesign':
        ...
        if _1115.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
        ...
        return constructor.new(_1115.StandardSplineJointDesign)(self.wrapped.SplineJointDesign) if self.wrapped.SplineJointDesign else None

    @property
    def interference_fit_design(self) -> '_1140.InterferenceFitDesign':
        ...
        return constructor.new(_1140.InterferenceFitDesign)(self.wrapped.InterferenceFitDesign) if self.wrapped.InterferenceFitDesign else None

    @property
    def nonlinear_stiffness(self) -> '_53.DiagonalNonlinearStiffness':
        ...
        return constructor.new(_53.DiagonalNonlinearStiffness)(self.wrapped.NonlinearStiffness) if self.wrapped.NonlinearStiffness else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2048.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2048.RigidConnectorToothLocation))
        return value
