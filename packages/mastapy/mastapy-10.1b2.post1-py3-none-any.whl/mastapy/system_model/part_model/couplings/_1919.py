...
from mastapy.system_model.part_model.couplings import _2071, _1923
from mastapy.system_model.analyses_and_results.mbd_analyses import _2168
...
class Clutch(_1923.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2071.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2071.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2071.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_2168.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_2168.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_2168.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1826.ClutchConnection':
        ...
        return constructor.new(_1826.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
