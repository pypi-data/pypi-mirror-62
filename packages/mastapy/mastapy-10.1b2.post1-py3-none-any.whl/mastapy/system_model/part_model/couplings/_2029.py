...
from mastapy.system_model.part_model.couplings import _2032, _2030
...
class Synchroniser(_1947.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2032.SynchroniserSleeve':
        ...
        return constructor.new(_2032.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2030.SynchroniserHalf':
        ...
        return constructor.new(_2030.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2030.SynchroniserHalf':
        ...
        return constructor.new(_2030.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1832.ClutchConnection':
        ...
        return constructor.new(_1832.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1832.ClutchConnection':
        ...
        return constructor.new(_1832.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
