...
class ComponentsConnectedResult(_1.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_2013.ConnectedSockets':
        ...
        return constructor.new(_2013.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
