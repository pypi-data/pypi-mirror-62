...
class MountableComponent(_1967.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')) -> '_1812.CoaxialConnection':
        ...
        return constructor.new(_1812.CoaxialConnection)(method_result) if method_result else None
