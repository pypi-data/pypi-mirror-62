...
from mastapy.bearings.tolerances import (
    _1513, _1514, _1515, _1524,
    _1520, _1527, _1516, _1528,
    _1521
)
from mastapy.bearings.bearing_results import _1561, _1562
from mastapy.bearings import (
    _1492, _1499, _1488, _1484
)
...
class Bearing(_1970.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1514.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1514.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1514.BearingToleranceDefinitionOptions'):
    ...
    @property
    def journal_bearing_type(self) -> '_1499.JournalBearingType':
        ...
        return constructor.new(_1499.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1499.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1488.BearingDampingMatrixOption':
        ...
        return constructor.new(_1488.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1488.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def efficiency_rating_method(self) -> 'overridable.Overridable_BearingEfficiencyRatingMethod':
        ...
        return constructor.new(overridable.Overridable_BearingEfficiencyRatingMethod)(self.wrapped.EfficiencyRatingMethod) if self.wrapped.EfficiencyRatingMethod else None
    ...
    def efficiency_rating_method(self, value: 'overridable.Overridable_BearingEfficiencyRatingMethod.implicit_type()'):
        wrapper_type = overridable.Overridable_BearingEfficiencyRatingMethod.TYPE
    ...
    @property
    def ring_tolerance_inner(self) -> '_1515.InnerRingTolerance':
        ...
        return constructor.new(_1515.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1524.RingTolerance':
        ...
        return constructor.new(_1524.RingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1515.InnerRingTolerance':
        ...
        if _1515.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1515.InnerRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1520.OuterRingTolerance':
        ...
        if _1520.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1520.OuterRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_outer(self) -> '_1520.OuterRingTolerance':
        ...
        return constructor.new(_1520.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1524.RingTolerance':
        ...
        return constructor.new(_1524.RingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1515.InnerRingTolerance':
        ...
        if _1515.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1515.InnerRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1520.OuterRingTolerance':
        ...
        if _1520.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1520.OuterRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def inner_support_detail(self) -> '_1527.SupportDetail':
        ...
        return constructor.new(_1527.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1527.SupportDetail':
        ...
        return constructor.new(_1527.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1527.SupportDetail':
        ...
        return constructor.new(_1527.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1527.SupportDetail':
        ...
        return constructor.new(_1527.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1516.InnerSupportTolerance':
        ...
        return constructor.new(_1516.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1528.SupportTolerance':
        ...
        return constructor.new(_1528.SupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1516.InnerSupportTolerance':
        ...
        if _1516.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1516.InnerSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1521.OuterSupportTolerance':
        ...
        if _1521.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1521.OuterSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_outer(self) -> '_1521.OuterSupportTolerance':
        ...
        return constructor.new(_1521.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1528.SupportTolerance':
        ...
        return constructor.new(_1528.SupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1516.InnerSupportTolerance':
        ...
        if _1516.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1516.InnerSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1521.OuterSupportTolerance':
        ...
        if _1521.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1521.OuterSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def simple_bearing_detail_property(self) -> '_1709.BearingDesign':
        ...
        return constructor.new(_1709.BearingDesign)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1710.DetailedBearing':
        ...
        if _1710.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1710.DetailedBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1711.DummyRollingBearing':
        ...
        if _1711.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1711.DummyRollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1712.LinearBearing':
        ...
        if _1712.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1712.LinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1713.NonLinearBearing':
        ...
        if _1713.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1713.NonLinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1714.AngularContactBallBearing':
        ...
        if _1714.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1714.AngularContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1715.AngularContactThrustBallBearing':
        ...
        if _1715.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1715.AngularContactThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1716.AsymmetricSphericalRollerBearing':
        ...
        if _1716.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1716.AsymmetricSphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1717.AxialThrustCylindricalRollerBearing':
        ...
        if _1717.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1717.AxialThrustCylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1718.AxialThrustNeedleRollerBearing':
        ...
        if _1718.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1718.AxialThrustNeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1719.BallBearing':
        ...
        if _1719.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1719.BallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1721.BarrelRollerBearing':
        ...
        if _1721.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1721.BarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1726.CylindricalRollerBearing':
        ...
        if _1726.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1726.CylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1727.DeepGrooveBallBearing':
        ...
        if _1727.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1727.DeepGrooveBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1729.FourPointContactBallBearing':
        ...
        if _1729.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1729.FourPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1731.MultiPointContactBallBearing':
        ...
        if _1731.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1731.MultiPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1732.NeedleRollerBearing':
        ...
        if _1732.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1732.NeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1733.NonBarrelRollerBearing':
        ...
        if _1733.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1733.NonBarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1734.RollerBearing':
        ...
        if _1734.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1734.RollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1737.RollingBearing':
        ...
        if _1737.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1737.RollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1738.SelfAligningBallBearing':
        ...
        if _1738.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1738.SelfAligningBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1740.SphericalRollerBearing':
        ...
        if _1740.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1740.SphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1741.SphericalRollerThrustBearing':
        ...
        if _1741.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1741.SphericalRollerThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1742.TaperRollerBearing':
        ...
        if _1742.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1742.TaperRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1743.ThreePointContactBallBearing':
        ...
        if _1743.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1743.ThreePointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1744.ThrustBallBearing':
        ...
        if _1744.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1744.ThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1745.ToroidalRollerBearing':
        ...
        if _1745.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1745.ToroidalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1758.PadFluidFilmBearing':
        ...
        if _1758.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1758.PadFluidFilmBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1760.PlainGreaseFilledJournalBearing':
        ...
        if _1760.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1760.PlainGreaseFilledJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1762.PlainJournalBearing':
        ...
        if _1762.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1762.PlainJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1764.PlainOilFedJournalBearing':
        ...
        if _1764.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1764.PlainOilFedJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1765.TiltingPadJournalBearing':
        ...
        if _1765.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1765.TiltingPadJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1766.TiltingPadThrustBearing':
        ...
        if _1766.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1766.TiltingPadThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1768.ConceptAxialClearanceBearing':
        ...
        if _1768.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1768.ConceptAxialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1769.ConceptClearanceBearing':
        ...
        if _1769.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1769.ConceptClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1770.ConceptRadialClearanceBearing':
        ...
        if _1770.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1770.ConceptRadialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def detail(self) -> '_1709.BearingDesign':
        ...
        return constructor.new(_1709.BearingDesign)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_detailed_bearing(self) -> '_1710.DetailedBearing':
        ...
        if _1710.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1710.DetailedBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1711.DummyRollingBearing':
        ...
        if _1711.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1711.DummyRollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_linear_bearing(self) -> '_1712.LinearBearing':
        ...
        if _1712.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1712.LinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1713.NonLinearBearing':
        ...
        if _1713.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1713.NonLinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1714.AngularContactBallBearing':
        ...
        if _1714.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1714.AngularContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1715.AngularContactThrustBallBearing':
        ...
        if _1715.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1715.AngularContactThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1716.AsymmetricSphericalRollerBearing':
        ...
        if _1716.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1716.AsymmetricSphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1717.AxialThrustCylindricalRollerBearing':
        ...
        if _1717.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1717.AxialThrustCylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1718.AxialThrustNeedleRollerBearing':
        ...
        if _1718.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1718.AxialThrustNeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_ball_bearing(self) -> '_1719.BallBearing':
        ...
        if _1719.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1719.BallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1721.BarrelRollerBearing':
        ...
        if _1721.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1721.BarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1726.CylindricalRollerBearing':
        ...
        if _1726.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1726.CylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1727.DeepGrooveBallBearing':
        ...
        if _1727.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1727.DeepGrooveBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1729.FourPointContactBallBearing':
        ...
        if _1729.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1729.FourPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1731.MultiPointContactBallBearing':
        ...
        if _1731.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1731.MultiPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1732.NeedleRollerBearing':
        ...
        if _1732.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1732.NeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1733.NonBarrelRollerBearing':
        ...
        if _1733.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1733.NonBarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_roller_bearing(self) -> '_1734.RollerBearing':
        ...
        if _1734.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1734.RollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1737.RollingBearing':
        ...
        if _1737.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1737.RollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1738.SelfAligningBallBearing':
        ...
        if _1738.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1738.SelfAligningBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1740.SphericalRollerBearing':
        ...
        if _1740.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1740.SphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1741.SphericalRollerThrustBearing':
        ...
        if _1741.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1741.SphericalRollerThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1742.TaperRollerBearing':
        ...
        if _1742.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1742.TaperRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1743.ThreePointContactBallBearing':
        ...
        if _1743.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1743.ThreePointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1744.ThrustBallBearing':
        ...
        if _1744.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1744.ThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1745.ToroidalRollerBearing':
        ...
        if _1745.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1745.ToroidalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1758.PadFluidFilmBearing':
        ...
        if _1758.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1758.PadFluidFilmBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1760.PlainGreaseFilledJournalBearing':
        ...
        if _1760.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1760.PlainGreaseFilledJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1762.PlainJournalBearing':
        ...
        if _1762.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1762.PlainJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1764.PlainOilFedJournalBearing':
        ...
        if _1764.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1764.PlainOilFedJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1765.TiltingPadJournalBearing':
        ...
        if _1765.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1765.TiltingPadJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1766.TiltingPadThrustBearing':
        ...
        if _1766.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1766.TiltingPadThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1768.ConceptAxialClearanceBearing':
        ...
        if _1768.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1768.ConceptAxialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1769.ConceptClearanceBearing':
        ...
        if _1769.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1769.ConceptClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1770.ConceptRadialClearanceBearing':
        ...
        if _1770.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1770.ConceptRadialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def axial_internal_clearance_tolerance(self) -> '_1962.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_1962.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_1992.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_1992.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None

    @property
    def overridden_lubrication_detail(self) -> '_75.LubricationDetail':
        ...
        return constructor.new(_75.LubricationDetail)(self.wrapped.OverriddenLubricationDetail) if self.wrapped.OverriddenLubricationDetail else None

    @property
    def friction_coefficients(self) -> '_1661.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1661.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def mounting(self) -> 'List[_1964.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_1964.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1484.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')) -> '_1968.ComponentsConnectedResult':
        ...
        return constructor.new(_1968.ComponentsConnectedResult)(method_result) if method_result else None

    def try_attach_right_side_to(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')) -> '_1968.ComponentsConnectedResult':
