...
from mastapy.system_model.part_model import _2019, _1862
...
class OilSeal(_1862.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_2019.OilSealMaterialType':
        ...
        return constructor.new(_2019.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_2019.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1534.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1534.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
