...
from mastapy.math_utility import _1053, _1054
from mastapy.system_model.connections_and_sockets import _1813, _1830
...
class Component(_1987.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6482.SMTBitmap':
        ...
        return constructor.new(_6482.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1053.CoordinateSystem3D':
        ...
        return constructor.new(_1053.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1813.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1813.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1053.CoordinateSystem3D') -> '_1830.RealignmentResult':
        ...
        return constructor.new(_1830.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1830.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1054.CoordinateSystemEditor':
        ...
        return constructor.new(_1054.CoordinateSystemEditor)(method_result) if method_result else None
