...
class ImportedFEComponent(_1908.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1861.ImportedFE':
        ...
        return constructor.new(_1861.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1861.ImportedFE':
        ...
        return constructor.new(_1861.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_1861.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1861.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1861.ImportedFE') -> 'bool':
