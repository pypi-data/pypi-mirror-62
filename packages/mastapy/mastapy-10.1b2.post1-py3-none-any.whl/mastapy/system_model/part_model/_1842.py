...
from mastapy.system_model import _1739
from mastapy.system_model.part_model import _2021, _1876
...
class PowerLoad(_1876.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2021.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2021.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None
