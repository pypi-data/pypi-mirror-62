...
from mastapy.system_model.part_model import _1968, _1984
...
class Connector(_1984.MountableComponent):
    '''Connector
    ...
    def house_in(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')) -> '_1815.Connection':
        ...
        return constructor.new(_1815.Connection)(method_result) if method_result else None

    def try_house_in(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')) -> '_1968.ComponentsConnectedResult':
