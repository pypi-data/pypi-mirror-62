...
class SpiralBevelGear(_2036.BevelGear):
    '''SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_725.SpiralBevelGearDesign':
    ...
    @property
    def spiral_bevel_gear_design(self) -> '_725.SpiralBevelGearDesign':
        ...
        return constructor.new(_725.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGearDesign) if self.wrapped.SpiralBevelGearDesign else None
