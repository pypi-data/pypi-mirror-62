...
class StraightBevelDiffGear(_2036.BevelGear):
    '''StraightBevelDiffGear
    ...
    @property
    def bevel_gear_design(self) -> '_717.StraightBevelDiffGearDesign':
    ...
    @property
    def straight_bevel_diff_gear_design(self) -> '_717.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_717.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGearDesign) if self.wrapped.StraightBevelDiffGearDesign else None
