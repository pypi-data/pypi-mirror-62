...
class KlingelnbergCycloPalloidSpiralBevelGear(_2053.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidSpiralBevelGear
    ...
    @property
    def conical_gear_design(self) -> '_729.KlingelnbergCycloPalloidSpiralBevelGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_729.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_729.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign else None
