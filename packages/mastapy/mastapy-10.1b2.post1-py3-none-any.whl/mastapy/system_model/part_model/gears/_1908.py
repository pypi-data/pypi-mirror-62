...
class StraightBevelDiffGear(_1884.BevelGear):
    '''StraightBevelDiffGear
    ...
    @property
    def bevel_gear_design(self) -> '_491.StraightBevelDiffGearDesign':
    ...
    @property
    def straight_bevel_diff_gear_design(self) -> '_491.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_491.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGearDesign) if self.wrapped.StraightBevelDiffGearDesign else None
