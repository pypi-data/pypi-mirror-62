...
from mastapy.gears import _254
from mastapy.gears.gear_designs.cylindrical import _899
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2025
from mastapy.system_model.part_model.gears import _1987, _1994
...
class CylindricalGearSet(_1994.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_899.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_899.CylindricalGearSetDesign':
        ...
        return constructor.new(_899.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSetDesign) if self.wrapped.CylindricalGearSetDesign else None

    @property
    def supercharger_rotor_set(self) -> '_2025.SuperchargerRotorSet':
        ...
        return constructor.new(_2025.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_1987.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_1987.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1799.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1799.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_899.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_899.CylindricalGearSetDesign))
        return value
