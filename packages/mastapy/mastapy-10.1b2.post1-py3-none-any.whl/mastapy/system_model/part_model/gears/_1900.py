...
from mastapy.system_model.part_model.gears import _1889
...
class KlingelnbergCycloPalloidConicalGearSet(_1889.ConicalGearSet):
    '''KlingelnbergCycloPalloidConicalGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_381.KlingelnbergConicalGearSetDesign':
    ...
    @property
    def klingelnberg_conical_gear_set_design(self) -> '_381.KlingelnbergConicalGearSetDesign':
        ...
        return constructor.new(_381.KlingelnbergConicalGearSetDesign)(self.wrapped.KlingelnbergConicalGearSetDesign) if self.wrapped.KlingelnbergConicalGearSetDesign else None

    @property
    def klingelnberg_conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_379.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _379.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.KlingelnbergConicalGearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_379.KlingelnbergCycloPalloidSpiralBevelGearSetDesign)(self.wrapped.KlingelnbergConicalGearSetDesign) if self.wrapped.KlingelnbergConicalGearSetDesign else None

    @property
    def klingelnberg_conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_380.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _380.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.KlingelnbergConicalGearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_380.KlingelnbergCycloPalloidHypoidGearSetDesign)(self.wrapped.KlingelnbergConicalGearSetDesign) if self.wrapped.KlingelnbergConicalGearSetDesign else None
