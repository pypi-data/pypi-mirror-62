...
class StraightBevelDiffGear(_1981.BevelGear):
    '''StraightBevelDiffGear
    ...
    @property
    def bevel_gear_design(self) -> '_839.StraightBevelDiffGearDesign':
    ...
    @property
    def straight_bevel_diff_gear_design(self) -> '_839.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_839.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGearDesign) if self.wrapped.StraightBevelDiffGearDesign else None
