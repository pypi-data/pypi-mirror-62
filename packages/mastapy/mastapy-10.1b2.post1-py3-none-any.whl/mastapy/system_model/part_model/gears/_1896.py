...
from mastapy.gears.gear_designs.worm import _375
...
from mastapy.gears.gear_designs.cylindrical import _384, _385
...
class GearSet(_1874.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_373.GearSetDesign':
        ...
        return constructor.new(_373.GearSetDesign)(self.wrapped.ActiveGearSetDesign) if self.wrapped.ActiveGearSetDesign else None
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_375.WormGearSetDesign':
        ...
        if _375.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_375.WormGearSetDesign)(self.wrapped.ActiveGearSetDesign) if self.wrapped.ActiveGearSetDesign else None
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_383.FaceGearSetDesign':
        ...
        if _383.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_384.CylindricalGearSetDesign':
        ...
        if _384.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_384.CylindricalGearSetDesign)(self.wrapped.ActiveGearSetDesign) if self.wrapped.ActiveGearSetDesign else None

    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_385.CylindricalPlanetaryGearSetDesign':
        ...
        if _385.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_385.CylindricalPlanetaryGearSetDesign)(self.wrapped.ActiveGearSetDesign) if self.wrapped.ActiveGearSetDesign else None

    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_386.ConicalGearSetDesign':
        ...
        if _386.ConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_387.ConceptGearSetDesign':
        ...
        if _387.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    def set_active_gear_set_design(self, gear_set_design: '_373.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_373.GearSetDesign'):
