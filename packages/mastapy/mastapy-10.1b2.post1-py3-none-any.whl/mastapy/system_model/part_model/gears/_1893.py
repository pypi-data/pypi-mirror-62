...
from mastapy.gears.gear_designs.face import _505
...
class FaceGear(_1895.Gear):
    ...
    @property
    def face_gear_design(self) -> '_505.FaceGearDesign':
        ...
        return constructor.new(_505.FaceGearDesign)(self.wrapped.FaceGearDesign) if self.wrapped.FaceGearDesign else None
