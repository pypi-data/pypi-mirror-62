...
class StraightBevelPlanetGear(_1908.StraightBevelDiffGear):
    '''StraightBevelPlanetGear
    ...
    @property
    def planetary_details(self) -> '_324.PlanetaryDetail':
        ...
        return constructor.new(_324.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None
