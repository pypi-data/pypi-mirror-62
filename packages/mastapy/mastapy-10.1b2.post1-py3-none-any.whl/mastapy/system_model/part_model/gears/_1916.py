...
class ZerolBevelGear(_1884.BevelGear):
    '''ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_426.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_426.ZerolBevelGearDesign':
        ...
        return constructor.new(_426.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGearDesign) if self.wrapped.ZerolBevelGearDesign else None
