...
from mastapy.system_model.part_model.gears import _1895
...
class CylindricalGear(_1895.Gear):
    '''CylindricalGear
    ...
    @property
    def cylindrical_gear_design(self) -> '_600.CylindricalGearDesign':
        ...
        return constructor.new(_600.CylindricalGearDesign)(self.wrapped.CylindricalGearDesign) if self.wrapped.CylindricalGearDesign else None
