...
class StraightBevelGear(_1981.BevelGear):
    '''StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_843.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_843.StraightBevelGearDesign':
        ...
        return constructor.new(_843.StraightBevelGearDesign)(self.wrapped.StraightBevelGearDesign) if self.wrapped.StraightBevelGearDesign else None
