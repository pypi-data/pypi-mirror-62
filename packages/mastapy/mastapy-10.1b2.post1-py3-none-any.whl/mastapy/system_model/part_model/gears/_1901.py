...
class KlingelnbergCycloPalloidHypoidGear(_1899.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidHypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_536.KlingelnbergCycloPalloidHypoidGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_536.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_536.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign else None
