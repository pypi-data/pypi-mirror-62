...
from mastapy.system_model.part_model.gears import _1878
...
class HypoidGear(_1878.AGMAGleasonConicalGear):
    '''HypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_471.HypoidGearDesign':
    ...
    @property
    def hypoid_gear_design(self) -> '_471.HypoidGearDesign':
        ...
        return constructor.new(_471.HypoidGearDesign)(self.wrapped.HypoidGearDesign) if self.wrapped.HypoidGearDesign else None
