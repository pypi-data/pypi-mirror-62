...
class WormGear(_1992.Gear):
    ...
    @property
    def worm_gear_design(self) -> '_835.WormGearDesign':
        ...
        return constructor.new(_835.WormGearDesign)(self.wrapped.WormGearDesign) if self.wrapped.WormGearDesign else None
