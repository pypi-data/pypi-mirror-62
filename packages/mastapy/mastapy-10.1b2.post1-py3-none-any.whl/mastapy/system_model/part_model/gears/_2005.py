...
class SpiralBevelGear(_1981.BevelGear):
    '''SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_847.SpiralBevelGearDesign':
    ...
    @property
    def spiral_bevel_gear_design(self) -> '_847.SpiralBevelGearDesign':
        ...
        return constructor.new(_847.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGearDesign) if self.wrapped.SpiralBevelGearDesign else None
