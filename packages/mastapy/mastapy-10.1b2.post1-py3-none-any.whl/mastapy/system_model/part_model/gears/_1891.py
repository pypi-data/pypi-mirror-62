...
from mastapy.system_model.part_model.gears import _1890, _1896
...
class CylindricalGearSet(_1896.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_384.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_384.CylindricalGearSetDesign':
        ...
        return constructor.new(_384.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSetDesign) if self.wrapped.CylindricalGearSetDesign else None

    @property
    def supercharger_rotor_set(self) -> '_2059.SuperchargerRotorSet':
        ...
        return constructor.new(_2059.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_1890.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_1890.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1802.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1802.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_384.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_384.CylindricalGearSetDesign))
        return value
