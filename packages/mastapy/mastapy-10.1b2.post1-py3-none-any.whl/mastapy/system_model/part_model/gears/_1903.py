...
from mastapy.system_model.part_model.gears import _1899
...
class KlingelnbergCycloPalloidSpiralBevelGear(_1899.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidSpiralBevelGear
    ...
    @property
    def conical_gear_design(self) -> '_529.KlingelnbergCycloPalloidSpiralBevelGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_529.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_529.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign else None
