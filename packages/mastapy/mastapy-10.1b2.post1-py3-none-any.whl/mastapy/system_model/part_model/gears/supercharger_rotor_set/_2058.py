...
class SuperchargerRotorSet(_94.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2060.YVariableForImportedData':
        ...
        return constructor.new(_2060.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2060.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2053.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2053.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2055.RotorSpeedInputOptions':
        ...
        return constructor.new(_2055.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2050.BoostPressureInputOptions':
        ...
        return constructor.new(_2050.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2052.PressureRatioInputOptions':
        ...
        return constructor.new(_2052.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2051.InputPowerInputOptions':
        ...
        return constructor.new(_2051.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2054.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2054.RotorSetMeasuredPoint))
        return value
