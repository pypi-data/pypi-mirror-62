...
class SuperchargerRotorSet(_89.NamedDatabaseItem):
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2067.YVariableForImportedData':
        ...
        return constructor.new(_2067.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2067.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2060.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2060.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2062.RotorSpeedInputOptions':
        ...
        return constructor.new(_2062.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2057.BoostPressureInputOptions':
        ...
        return constructor.new(_2057.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2059.PressureRatioInputOptions':
        ...
        return constructor.new(_2059.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2058.InputPowerInputOptions':
        ...
        return constructor.new(_2058.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2061.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2061.RotorSetMeasuredPoint))
        return value
