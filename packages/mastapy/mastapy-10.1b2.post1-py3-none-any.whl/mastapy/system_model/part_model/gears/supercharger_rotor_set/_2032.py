...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import (
    _2034, _2027, _2029, _2024,
    _2026, _2025, _2028
)
from mastapy.utility.databases import _87
...
class SuperchargerRotorSet(_87.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2034.YVariableForImportedData':
        ...
        return constructor.new(_2034.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2034.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2027.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2027.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2029.RotorSpeedInputOptions':
        ...
        return constructor.new(_2029.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2024.BoostPressureInputOptions':
        ...
        return constructor.new(_2024.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2026.PressureRatioInputOptions':
        ...
        return constructor.new(_2026.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2025.InputPowerInputOptions':
        ...
        return constructor.new(_2025.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2028.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2028.RotorSetMeasuredPoint))
        return value
