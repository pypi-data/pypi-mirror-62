...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2032
...
class SuperchargerRotorSetDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_2032.SuperchargerRotorSet':
        ...
        return constructor.new(_2032.SuperchargerRotorSet)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_2032.SuperchargerRotorSet':
        ...
        return constructor.new(_2032.SuperchargerRotorSet)(method_result) if method_result else None

    def can_be_removed(self, supercharger_rotor_set: '_2032.SuperchargerRotorSet') -> 'bool':
    ...
    def rename(self, supercharger_rotor_set: '_2032.SuperchargerRotorSet', new_name: 'str') -> 'bool':
    ...
    def remove(self, supercharger_rotor_set: '_2032.SuperchargerRotorSet'):
    ...
    def get_all_items(self) -> 'Iterable[_2032.SuperchargerRotorSet]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_2032.SuperchargerRotorSet))

    def save_changes(self, supercharger_rotor_set: '_2032.SuperchargerRotorSet'):
