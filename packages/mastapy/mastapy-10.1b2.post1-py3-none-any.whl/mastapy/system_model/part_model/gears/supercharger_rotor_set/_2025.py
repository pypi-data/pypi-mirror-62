...
class SuperchargerRotorSet(_1439.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2027.YVariableForImportedData':
        ...
        return constructor.new(_2027.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2027.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2020.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2020.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2022.RotorSpeedInputOptions':
        ...
        return constructor.new(_2022.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2017.BoostPressureInputOptions':
        ...
        return constructor.new(_2017.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2019.PressureRatioInputOptions':
        ...
        return constructor.new(_2019.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2018.InputPowerInputOptions':
        ...
        return constructor.new(_2018.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2021.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2021.RotorSetMeasuredPoint))
        return value
