...
class SuperchargerRotorSet(_1323.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2082.YVariableForImportedData':
        ...
        return constructor.new(_2082.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2082.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2075.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2075.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2077.RotorSpeedInputOptions':
        ...
        return constructor.new(_2077.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2072.BoostPressureInputOptions':
        ...
        return constructor.new(_2072.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2074.PressureRatioInputOptions':
        ...
        return constructor.new(_2074.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2073.InputPowerInputOptions':
        ...
        return constructor.new(_2073.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2076.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2076.RotorSetMeasuredPoint))
        return value
