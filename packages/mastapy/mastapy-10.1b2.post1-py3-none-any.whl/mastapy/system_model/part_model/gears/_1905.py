...
from mastapy.system_model.part_model.gears import _1890, _1892, _1891
...
class PlanetaryGearSet(_1891.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_1890.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_1890.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_1892.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_1892.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_1890.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_1890.CylindricalGear))
        return value

    def add_sun(self) -> '_1890.CylindricalGear':
    ...
    def add_planet(self) -> '_1890.CylindricalGear':
