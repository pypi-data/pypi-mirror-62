...
from mastapy.gears import _308, _309
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model.gears import (
    _1891, _1889, _1915, _1900
)
from mastapy.system_model.analyses_and_results.static_loads import _1849
from mastapy.gears.analysis import _1122
from mastapy.system_model.analyses_and_results.load_case_groups import _2477
...
class GearSetConfiguration(_1.APIBase):
    ...
    @property
    def gear_set_design_group(self) -> '_308.GearSetDesignGroup':
        ...
        return constructor.new(_308.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None
    ...
    def implementation_detail_results_for(self, analysis_case: '_1849.StaticLoadCase', gear_set_mode: '_309.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1122.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1122.GearSetGroupDutyCycle)(method_result) if method_result else None

    def implementation_detail_results_for_group(self, analysis_case: '_2477.AbstractStaticLoadCaseGroup', gear_set_mode: '_309.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1122.GearSetGroupDutyCycle':
        ''' 'ImplementationDetailResultsFor' is the original name of this method.
    ...
    def perform_implementation_detail_analysis(self, static_load: '_1849.StaticLoadCase', gear_set_mode: '_309.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_2477.AbstractStaticLoadCaseGroup', gear_set_mode: '_309.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
