...
from mastapy.system_model.part_model import _1870
...
class Gear(_1870.MountableComponent):
    '''Gear
    ...
    def shaft(self) -> '_1877.Shaft':
        ...
        return constructor.new(_1877.Shaft)(self.wrapped.Shaft) if self.wrapped.Shaft else None
