...
class ConceptGear(_1895.Gear):
    ...
    @property
    def concept_gear_design(self) -> '_636.ConceptGearDesign':
        ...
        return constructor.new(_636.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign else None
