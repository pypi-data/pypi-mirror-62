...
class ZerolBevelGear(_1981.BevelGear):
    '''ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_830.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_830.ZerolBevelGearDesign':
        ...
        return constructor.new(_830.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGearDesign) if self.wrapped.ZerolBevelGearDesign else None
