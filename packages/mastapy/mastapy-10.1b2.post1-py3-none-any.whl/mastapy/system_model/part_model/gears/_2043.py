...
from mastapy.system_model.part_model.gears import _2042, _2049
...
class CylindricalGearSet(_2049.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_778.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_778.CylindricalGearSetDesign':
        ...
        return constructor.new(_778.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSetDesign) if self.wrapped.CylindricalGearSetDesign else None

    @property
    def supercharger_rotor_set(self) -> '_2080.SuperchargerRotorSet':
        ...
        return constructor.new(_2080.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2042.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2042.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1849.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1849.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_778.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_778.CylindricalGearSetDesign))
        return value
