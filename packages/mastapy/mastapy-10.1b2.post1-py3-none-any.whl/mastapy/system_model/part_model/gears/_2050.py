...
from mastapy.gears import _131, _132
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model.gears import (
    _2043, _2041, _2069, _2054
)
from mastapy.system_model.analyses_and_results.static_loads import _6162
from mastapy.gears.analysis import _949
from mastapy.system_model.analyses_and_results.load_case_groups import _5212
...
class GearSetConfiguration(_1.APIBase):
    ...
    def implementation_detail_results_for(self, analysis_case: '_6162.StaticLoadCase', gear_set_mode: '_132.GearSetModes', run_all_planetary_meshes: 'bool') -> '_949.GearSetGroupDutyCycle':
        ...
        return constructor.new(_949.GearSetGroupDutyCycle)(method_result) if method_result else None

    def implementation_detail_results_for_group(self, analysis_case: '_5212.AbstractStaticLoadCaseGroup', gear_set_mode: '_132.GearSetModes', run_all_planetary_meshes: 'bool') -> '_949.GearSetGroupDutyCycle':
        ''' 'ImplementationDetailResultsFor' is the original name of this method.
    ...
    def perform_implementation_detail_analysis(self, static_load: '_6162.StaticLoadCase', gear_set_mode: '_132.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_5212.AbstractStaticLoadCaseGroup', gear_set_mode: '_132.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
