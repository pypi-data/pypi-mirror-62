...
class StraightBevelGear(_1884.BevelGear):
    '''StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_470.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_470.StraightBevelGearDesign':
        ...
        return constructor.new(_470.StraightBevelGearDesign)(self.wrapped.StraightBevelGearDesign) if self.wrapped.StraightBevelGearDesign else None
