...
class FaceGear(_2047.Gear):
    ...
    @property
    def active_gear_design(self) -> '_745.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_745.FaceGearDesign':
        ...
        return constructor.new(_745.FaceGearDesign)(self.wrapped.FaceGearDesign) if self.wrapped.FaceGearDesign else None
