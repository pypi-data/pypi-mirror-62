...
from mastapy.system_model.part_model.gears import _1886, _1896
...
class ConceptGearSet(_1896.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_1886.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1886.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1798.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1798.ConceptGearMesh))
        return value
