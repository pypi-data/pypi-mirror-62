...
from mastapy.system_model.part_model.import_from_cad import _1965, _1966
...
class ConnectorFromCAD(_1966.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_1965.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_1965.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_1965.HousedOrMounted'):
