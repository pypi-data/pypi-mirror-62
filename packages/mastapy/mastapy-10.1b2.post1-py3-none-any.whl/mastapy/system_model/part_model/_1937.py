...
from mastapy.system_model.part_model import _1944, _1942
...
class PowerLoad(_1942.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_1944.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_1944.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None
