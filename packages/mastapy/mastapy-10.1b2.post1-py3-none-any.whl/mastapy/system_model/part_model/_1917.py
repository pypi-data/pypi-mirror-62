...
from mastapy.system_model.part_model import _1915, _1930
...
class Connector(_1930.MountableComponent):
    '''Connector
    ...
    def house_in(self, shaft: '_1945.Shaft', offset: Optional['float'] = float('nan')) -> '_1765.Connection':
        ...
        return constructor.new(_1765.Connection)(method_result) if method_result else None

    def try_house_in(self, shaft: '_1945.Shaft', offset: Optional['float'] = float('nan')) -> '_1915.ComponentsConnectedResult':
