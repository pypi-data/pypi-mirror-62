...
from mastapy.math_utility import _1216, _1217
from mastapy.system_model.connections_and_sockets import _1766, _1783
from mastapy.system_model.part_model import _1854
...
class Component(_1854.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_755.SMTBitmap':
        ...
        return constructor.new(_755.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1216.CoordinateSystem3D':
        ...
        return constructor.new(_1216.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1766.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1766.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1216.CoordinateSystem3D') -> '_1783.RealignmentResult':
        ...
        return constructor.new(_1783.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1783.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1217.CoordinateSystemEditor':
        ...
        return constructor.new(_1217.CoordinateSystemEditor)(method_result) if method_result else None
