...
from mastapy.system_model.part_model import (
    _1918, _1914, _1910, _1913,
    _1926, _1937, _1936, _1931,
    _1933, _1907, _1908, _1912,
    _1917, _1921, _1922, _1923,
    _1928, _1929, _1930, _1934,
    _1938, _1940, _1941, _1942
)
from mastapy.system_model.part_model.gears import (
    _2010, _1997, _2006, _1988,
    _1986, _2014, _1999, _1975,
    _1976, _1977, _1978, _1979,
    _1980, _1981, _1982, _1983,
    _1984, _1985, _1987, _1989,
    _1990, _1991, _1992, _1994,
    _1996, _1998, _2000, _2001,
    _2002, _2003, _2004, _2005,
    _2007, _2008, _2009, _2011,
    _2012, _2013, _2015, _2016
)
from mastapy.system_model.part_model.couplings import (
    _2053, _2034, _2036, _2037,
    _2039, _2040, _2041, _2042,
    _2043, _2044, _2045, _2051,
...
from mastapy.bearings import _1457, _1482
...
class Assembly(_1907.AbstractAssembly):
    '''Assembly
    ...
    @property
    def components_with_unknown_scalar_mass(self) -> 'List[_1914.Component]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownScalarMass, constructor.new(_1914.Component))
        return value

    @property
    def straight_bevel_gear_sets(self) -> 'List[_2010.StraightBevelGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearSets, constructor.new(_2010.StraightBevelGearSet))
        return value

    @property
    def hypoid_gear_sets(self) -> 'List[_1997.HypoidGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearSets, constructor.new(_1997.HypoidGearSet))
        return value

    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2006.SpiralBevelGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearSets, constructor.new(_2006.SpiralBevelGearSet))
        return value

    @property
    def shaft_hub_connections(self) -> 'List[_2053.ShaftHubConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftHubConnections, constructor.new(_2053.ShaftHubConnection))
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_1988.CylindricalGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_1988.CylindricalGearSet))
        return value

    @property
    def conical_gear_sets(self) -> 'List[_1986.ConicalGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearSets, constructor.new(_1986.ConicalGearSet))
        return value

    @property
    def worm_gear_sets(self) -> 'List[_2014.WormGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearSets, constructor.new(_2014.WormGearSet))
        return value

    @property
    def klingelnberg_cyclo_palloid_gear_sets(self) -> 'List[_1999.KlingelnbergCycloPalloidConicalGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidGearSets, constructor.new(_1999.KlingelnbergCycloPalloidConicalGearSet))
        return value

    @property
    def shafts(self) -> 'List[_1945.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shafts, constructor.new(_1945.Shaft))
        return value

    @property
    def bearings(self) -> 'List[_1910.Bearing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_1910.Bearing))
        return value

    @property
    def bolted_joints(self) -> 'List[_1913.BoltedJoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltedJoints, constructor.new(_1913.BoltedJoint))
        return value

    @property
    def imported_fes(self) -> 'List[_1926.ImportedFEComponent]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEs, constructor.new(_1926.ImportedFEComponent))
        return value

    @property
    def component_details(self) -> 'List[_1914.Component]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDetails, constructor.new(_1914.Component))
        return value

    @property
    def power_loads(self) -> 'List[_1937.PowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_1937.PowerLoad))
        return value

    @property
    def point_loads(self) -> 'List[_1936.PointLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_1936.PointLoad))
        return value

    @property
    def oil_seals(self) -> 'List[_1931.OilSeal]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OilSeals, constructor.new(_1931.OilSeal))
        return value

    def get_part_named(self, name: 'str') -> '_1933.Part':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1933.Part.TYPE](name if name else None)
        return constructor.new(_1933.Part)(method_result) if method_result else None
    ...
    def get_part_named_of_type_abstract_assembly(self, name: 'str') -> '_1907.AbstractAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1907.AbstractAssembly.TYPE](name if name else None)
        return constructor.new(_1907.AbstractAssembly)(method_result) if method_result else None

    def get_part_named_of_type_abstract_shaft_or_housing(self, name: 'str') -> '_1908.AbstractShaftOrHousing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1908.AbstractShaftOrHousing.TYPE](name if name else None)
        return constructor.new(_1908.AbstractShaftOrHousing)(method_result) if method_result else None

    def get_part_named_of_type_bearing(self, name: 'str') -> '_1910.Bearing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1910.Bearing.TYPE](name if name else None)
        return constructor.new(_1910.Bearing)(method_result) if method_result else None

    def get_part_named_of_type_bolt(self, name: 'str') -> '_1912.Bolt':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1912.Bolt.TYPE](name if name else None)
        return constructor.new(_1912.Bolt)(method_result) if method_result else None

    def get_part_named_of_type_bolted_joint(self, name: 'str') -> '_1913.BoltedJoint':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1913.BoltedJoint.TYPE](name if name else None)
        return constructor.new(_1913.BoltedJoint)(method_result) if method_result else None

    def get_part_named_of_type_component(self, name: 'str') -> '_1914.Component':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1914.Component.TYPE](name if name else None)
        return constructor.new(_1914.Component)(method_result) if method_result else None

    def get_part_named_of_type_connector(self, name: 'str') -> '_1917.Connector':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1917.Connector.TYPE](name if name else None)
        return constructor.new(_1917.Connector)(method_result) if method_result else None

    def get_part_named_of_type_datum(self, name: 'str') -> '_1918.Datum':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1918.Datum.TYPE](name if name else None)
        return constructor.new(_1918.Datum)(method_result) if method_result else None

    def get_part_named_of_type_external_cad_model(self, name: 'str') -> '_1921.ExternalCADModel':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1921.ExternalCADModel.TYPE](name if name else None)
        return constructor.new(_1921.ExternalCADModel)(method_result) if method_result else None

    def get_part_named_of_type_flexible_pin_assembly(self, name: 'str') -> '_1922.FlexiblePinAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1922.FlexiblePinAssembly.TYPE](name if name else None)
        return constructor.new(_1922.FlexiblePinAssembly)(method_result) if method_result else None

    def get_part_named_of_type_guide_dxf_model(self, name: 'str') -> '_1923.GuideDxfModel':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1923.GuideDxfModel.TYPE](name if name else None)
        return constructor.new(_1923.GuideDxfModel)(method_result) if method_result else None

    def get_part_named_of_type_imported_fe_component(self, name: 'str') -> '_1926.ImportedFEComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1926.ImportedFEComponent.TYPE](name if name else None)
        return constructor.new(_1926.ImportedFEComponent)(method_result) if method_result else None

    def get_part_named_of_type_mass_disc(self, name: 'str') -> '_1928.MassDisc':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1928.MassDisc.TYPE](name if name else None)
        return constructor.new(_1928.MassDisc)(method_result) if method_result else None

    def get_part_named_of_type_measurement_component(self, name: 'str') -> '_1929.MeasurementComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1929.MeasurementComponent.TYPE](name if name else None)
        return constructor.new(_1929.MeasurementComponent)(method_result) if method_result else None

    def get_part_named_of_type_mountable_component(self, name: 'str') -> '_1930.MountableComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1930.MountableComponent.TYPE](name if name else None)
        return constructor.new(_1930.MountableComponent)(method_result) if method_result else None

    def get_part_named_of_type_oil_seal(self, name: 'str') -> '_1931.OilSeal':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1931.OilSeal.TYPE](name if name else None)
        return constructor.new(_1931.OilSeal)(method_result) if method_result else None

    def get_part_named_of_type_planet_carrier(self, name: 'str') -> '_1934.PlanetCarrier':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1934.PlanetCarrier.TYPE](name if name else None)
        return constructor.new(_1934.PlanetCarrier)(method_result) if method_result else None

    def get_part_named_of_type_point_load(self, name: 'str') -> '_1936.PointLoad':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1936.PointLoad.TYPE](name if name else None)
        return constructor.new(_1936.PointLoad)(method_result) if method_result else None

    def get_part_named_of_type_power_load(self, name: 'str') -> '_1937.PowerLoad':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1937.PowerLoad.TYPE](name if name else None)
        return constructor.new(_1937.PowerLoad)(method_result) if method_result else None

    def get_part_named_of_type_root_assembly(self, name: 'str') -> '_1938.RootAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1938.RootAssembly.TYPE](name if name else None)
        return constructor.new(_1938.RootAssembly)(method_result) if method_result else None

    def get_part_named_of_type_specialised_assembly(self, name: 'str') -> '_1940.SpecialisedAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1940.SpecialisedAssembly.TYPE](name if name else None)
        return constructor.new(_1940.SpecialisedAssembly)(method_result) if method_result else None

    def get_part_named_of_type_unbalanced_mass(self, name: 'str') -> '_1941.UnbalancedMass':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1941.UnbalancedMass.TYPE](name if name else None)
        return constructor.new(_1941.UnbalancedMass)(method_result) if method_result else None

    def get_part_named_of_type_virtual_component(self, name: 'str') -> '_1942.VirtualComponent':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1942.VirtualComponent.TYPE](name if name else None)
        return constructor.new(_1942.VirtualComponent)(method_result) if method_result else None

    def get_part_named_of_type_shaft(self, name: 'str') -> '_1945.Shaft':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1945.Shaft.TYPE](name if name else None)
        return constructor.new(_1945.Shaft)(method_result) if method_result else None

    def get_part_named_of_type_agma_gleason_conical_gear(self, name: 'str') -> '_1975.AGMAGleasonConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1975.AGMAGleasonConicalGear.TYPE](name if name else None)
        return constructor.new(_1975.AGMAGleasonConicalGear)(method_result) if method_result else None

    def get_part_named_of_type_agma_gleason_conical_gear_set(self, name: 'str') -> '_1976.AGMAGleasonConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1976.AGMAGleasonConicalGearSet.TYPE](name if name else None)
        return constructor.new(_1976.AGMAGleasonConicalGearSet)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_gear(self, name: 'str') -> '_1977.BevelDifferentialGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1977.BevelDifferentialGear.TYPE](name if name else None)
        return constructor.new(_1977.BevelDifferentialGear)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_gear_set(self, name: 'str') -> '_1978.BevelDifferentialGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1978.BevelDifferentialGearSet.TYPE](name if name else None)
        return constructor.new(_1978.BevelDifferentialGearSet)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_planet_gear(self, name: 'str') -> '_1979.BevelDifferentialPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1979.BevelDifferentialPlanetGear.TYPE](name if name else None)
        return constructor.new(_1979.BevelDifferentialPlanetGear)(method_result) if method_result else None

    def get_part_named_of_type_bevel_differential_sun_gear(self, name: 'str') -> '_1980.BevelDifferentialSunGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1980.BevelDifferentialSunGear.TYPE](name if name else None)
        return constructor.new(_1980.BevelDifferentialSunGear)(method_result) if method_result else None

    def get_part_named_of_type_bevel_gear(self, name: 'str') -> '_1981.BevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1981.BevelGear.TYPE](name if name else None)
        return constructor.new(_1981.BevelGear)(method_result) if method_result else None

    def get_part_named_of_type_bevel_gear_set(self, name: 'str') -> '_1982.BevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1982.BevelGearSet.TYPE](name if name else None)
        return constructor.new(_1982.BevelGearSet)(method_result) if method_result else None

    def get_part_named_of_type_concept_gear(self, name: 'str') -> '_1983.ConceptGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1983.ConceptGear.TYPE](name if name else None)
        return constructor.new(_1983.ConceptGear)(method_result) if method_result else None

    def get_part_named_of_type_concept_gear_set(self, name: 'str') -> '_1984.ConceptGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1984.ConceptGearSet.TYPE](name if name else None)
        return constructor.new(_1984.ConceptGearSet)(method_result) if method_result else None

    def get_part_named_of_type_conical_gear(self, name: 'str') -> '_1985.ConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1985.ConicalGear.TYPE](name if name else None)
        return constructor.new(_1985.ConicalGear)(method_result) if method_result else None

    def get_part_named_of_type_conical_gear_set(self, name: 'str') -> '_1986.ConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1986.ConicalGearSet.TYPE](name if name else None)
        return constructor.new(_1986.ConicalGearSet)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_gear(self, name: 'str') -> '_1987.CylindricalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1987.CylindricalGear.TYPE](name if name else None)
        return constructor.new(_1987.CylindricalGear)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_gear_set(self, name: 'str') -> '_1988.CylindricalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1988.CylindricalGearSet.TYPE](name if name else None)
        return constructor.new(_1988.CylindricalGearSet)(method_result) if method_result else None

    def get_part_named_of_type_cylindrical_planet_gear(self, name: 'str') -> '_1989.CylindricalPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1989.CylindricalPlanetGear.TYPE](name if name else None)
        return constructor.new(_1989.CylindricalPlanetGear)(method_result) if method_result else None

    def get_part_named_of_type_face_gear(self, name: 'str') -> '_1990.FaceGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1990.FaceGear.TYPE](name if name else None)
        return constructor.new(_1990.FaceGear)(method_result) if method_result else None

    def get_part_named_of_type_face_gear_set(self, name: 'str') -> '_1991.FaceGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1991.FaceGearSet.TYPE](name if name else None)
        return constructor.new(_1991.FaceGearSet)(method_result) if method_result else None
    ...
    def get_part_named_of_type_gear_set(self, name: 'str') -> '_1994.GearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1994.GearSet.TYPE](name if name else None)
        return constructor.new(_1994.GearSet)(method_result) if method_result else None

    def get_part_named_of_type_hypoid_gear(self, name: 'str') -> '_1996.HypoidGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1996.HypoidGear.TYPE](name if name else None)
        return constructor.new(_1996.HypoidGear)(method_result) if method_result else None

    def get_part_named_of_type_hypoid_gear_set(self, name: 'str') -> '_1997.HypoidGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1997.HypoidGearSet.TYPE](name if name else None)
        return constructor.new(_1997.HypoidGearSet)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear(self, name: 'str') -> '_1998.KlingelnbergCycloPalloidConicalGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1998.KlingelnbergCycloPalloidConicalGear.TYPE](name if name else None)
        return constructor.new(_1998.KlingelnbergCycloPalloidConicalGear)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self, name: 'str') -> '_1999.KlingelnbergCycloPalloidConicalGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_1999.KlingelnbergCycloPalloidConicalGearSet.TYPE](name if name else None)
        return constructor.new(_1999.KlingelnbergCycloPalloidConicalGearSet)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self, name: 'str') -> '_2000.KlingelnbergCycloPalloidHypoidGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2000.KlingelnbergCycloPalloidHypoidGear.TYPE](name if name else None)
        return constructor.new(_2000.KlingelnbergCycloPalloidHypoidGear)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self, name: 'str') -> '_2001.KlingelnbergCycloPalloidHypoidGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2001.KlingelnbergCycloPalloidHypoidGearSet.TYPE](name if name else None)
        return constructor.new(_2001.KlingelnbergCycloPalloidHypoidGearSet)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self, name: 'str') -> '_2002.KlingelnbergCycloPalloidSpiralBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2002.KlingelnbergCycloPalloidSpiralBevelGear.TYPE](name if name else None)
        return constructor.new(_2002.KlingelnbergCycloPalloidSpiralBevelGear)(method_result) if method_result else None

    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self, name: 'str') -> '_2003.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2003.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE](name if name else None)
        return constructor.new(_2003.KlingelnbergCycloPalloidSpiralBevelGearSet)(method_result) if method_result else None

    def get_part_named_of_type_planetary_gear_set(self, name: 'str') -> '_2004.PlanetaryGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2004.PlanetaryGearSet.TYPE](name if name else None)
        return constructor.new(_2004.PlanetaryGearSet)(method_result) if method_result else None

    def get_part_named_of_type_spiral_bevel_gear(self, name: 'str') -> '_2005.SpiralBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2005.SpiralBevelGear.TYPE](name if name else None)
        return constructor.new(_2005.SpiralBevelGear)(method_result) if method_result else None

    def get_part_named_of_type_spiral_bevel_gear_set(self, name: 'str') -> '_2006.SpiralBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2006.SpiralBevelGearSet.TYPE](name if name else None)
        return constructor.new(_2006.SpiralBevelGearSet)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_diff_gear(self, name: 'str') -> '_2007.StraightBevelDiffGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2007.StraightBevelDiffGear.TYPE](name if name else None)
        return constructor.new(_2007.StraightBevelDiffGear)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_diff_gear_set(self, name: 'str') -> '_2008.StraightBevelDiffGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2008.StraightBevelDiffGearSet.TYPE](name if name else None)
        return constructor.new(_2008.StraightBevelDiffGearSet)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_gear(self, name: 'str') -> '_2009.StraightBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2009.StraightBevelGear.TYPE](name if name else None)
        return constructor.new(_2009.StraightBevelGear)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_gear_set(self, name: 'str') -> '_2010.StraightBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2010.StraightBevelGearSet.TYPE](name if name else None)
        return constructor.new(_2010.StraightBevelGearSet)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_planet_gear(self, name: 'str') -> '_2011.StraightBevelPlanetGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2011.StraightBevelPlanetGear.TYPE](name if name else None)
        return constructor.new(_2011.StraightBevelPlanetGear)(method_result) if method_result else None

    def get_part_named_of_type_straight_bevel_sun_gear(self, name: 'str') -> '_2012.StraightBevelSunGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2012.StraightBevelSunGear.TYPE](name if name else None)
        return constructor.new(_2012.StraightBevelSunGear)(method_result) if method_result else None

    def get_part_named_of_type_worm_gear(self, name: 'str') -> '_2013.WormGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2013.WormGear.TYPE](name if name else None)
        return constructor.new(_2013.WormGear)(method_result) if method_result else None

    def get_part_named_of_type_worm_gear_set(self, name: 'str') -> '_2014.WormGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2014.WormGearSet.TYPE](name if name else None)
        return constructor.new(_2014.WormGearSet)(method_result) if method_result else None

    def get_part_named_of_type_zerol_bevel_gear(self, name: 'str') -> '_2015.ZerolBevelGear':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2015.ZerolBevelGear.TYPE](name if name else None)
        return constructor.new(_2015.ZerolBevelGear)(method_result) if method_result else None

    def get_part_named_of_type_zerol_bevel_gear_set(self, name: 'str') -> '_2016.ZerolBevelGearSet':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2016.ZerolBevelGearSet.TYPE](name if name else None)
        return constructor.new(_2016.ZerolBevelGearSet)(method_result) if method_result else None

    def get_part_named_of_type_belt_drive(self, name: 'str') -> '_2034.BeltDrive':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2034.BeltDrive.TYPE](name if name else None)
        return constructor.new(_2034.BeltDrive)(method_result) if method_result else None

    def get_part_named_of_type_clutch(self, name: 'str') -> '_2036.Clutch':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2036.Clutch.TYPE](name if name else None)
        return constructor.new(_2036.Clutch)(method_result) if method_result else None

    def get_part_named_of_type_clutch_half(self, name: 'str') -> '_2037.ClutchHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2037.ClutchHalf.TYPE](name if name else None)
        return constructor.new(_2037.ClutchHalf)(method_result) if method_result else None

    def get_part_named_of_type_concept_coupling(self, name: 'str') -> '_2039.ConceptCoupling':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2039.ConceptCoupling.TYPE](name if name else None)
        return constructor.new(_2039.ConceptCoupling)(method_result) if method_result else None

    def get_part_named_of_type_concept_coupling_half(self, name: 'str') -> '_2040.ConceptCouplingHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2040.ConceptCouplingHalf.TYPE](name if name else None)
        return constructor.new(_2040.ConceptCouplingHalf)(method_result) if method_result else None

    def get_part_named_of_type_coupling(self, name: 'str') -> '_2041.Coupling':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2041.Coupling.TYPE](name if name else None)
        return constructor.new(_2041.Coupling)(method_result) if method_result else None

    def get_part_named_of_type_coupling_half(self, name: 'str') -> '_2042.CouplingHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2042.CouplingHalf.TYPE](name if name else None)
        return constructor.new(_2042.CouplingHalf)(method_result) if method_result else None

    def get_part_named_of_type_cvt(self, name: 'str') -> '_2043.CVT':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2043.CVT.TYPE](name if name else None)
        return constructor.new(_2043.CVT)(method_result) if method_result else None

    def get_part_named_of_type_cvt_pulley(self, name: 'str') -> '_2044.CVTPulley':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2044.CVTPulley.TYPE](name if name else None)
        return constructor.new(_2044.CVTPulley)(method_result) if method_result else None

    def get_part_named_of_type_pulley(self, name: 'str') -> '_2045.Pulley':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2045.Pulley.TYPE](name if name else None)
        return constructor.new(_2045.Pulley)(method_result) if method_result else None

    def get_part_named_of_type_rolling_ring(self, name: 'str') -> '_2051.RollingRing':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2051.RollingRing.TYPE](name if name else None)
        return constructor.new(_2051.RollingRing)(method_result) if method_result else None

    def get_part_named_of_type_rolling_ring_assembly(self, name: 'str') -> '_2052.RollingRingAssembly':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2052.RollingRingAssembly.TYPE](name if name else None)
        return constructor.new(_2052.RollingRingAssembly)(method_result) if method_result else None

    def get_part_named_of_type_shaft_hub_connection(self, name: 'str') -> '_2053.ShaftHubConnection':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2053.ShaftHubConnection.TYPE](name if name else None)
        return constructor.new(_2053.ShaftHubConnection)(method_result) if method_result else None

    def get_part_named_of_type_spring_damper(self, name: 'str') -> '_2054.SpringDamper':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2054.SpringDamper.TYPE](name if name else None)
        return constructor.new(_2054.SpringDamper)(method_result) if method_result else None

    def get_part_named_of_type_spring_damper_half(self, name: 'str') -> '_2055.SpringDamperHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2055.SpringDamperHalf.TYPE](name if name else None)
        return constructor.new(_2055.SpringDamperHalf)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser(self, name: 'str') -> '_2056.Synchroniser':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2056.Synchroniser.TYPE](name if name else None)
        return constructor.new(_2056.Synchroniser)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_half(self, name: 'str') -> '_2058.SynchroniserHalf':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2058.SynchroniserHalf.TYPE](name if name else None)
        return constructor.new(_2058.SynchroniserHalf)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_part(self, name: 'str') -> '_2059.SynchroniserPart':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2059.SynchroniserPart.TYPE](name if name else None)
        return constructor.new(_2059.SynchroniserPart)(method_result) if method_result else None

    def get_part_named_of_type_synchroniser_sleeve(self, name: 'str') -> '_2060.SynchroniserSleeve':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2060.SynchroniserSleeve.TYPE](name if name else None)
        return constructor.new(_2060.SynchroniserSleeve)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter(self, name: 'str') -> '_2061.TorqueConverter':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2061.TorqueConverter.TYPE](name if name else None)
        return constructor.new(_2061.TorqueConverter)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter_pump(self, name: 'str') -> '_2062.TorqueConverterPump':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2062.TorqueConverterPump.TYPE](name if name else None)
        return constructor.new(_2062.TorqueConverterPump)(method_result) if method_result else None

    def get_part_named_of_type_torque_converter_turbine(self, name: 'str') -> '_2064.TorqueConverterTurbine':
        ''' 'GetPartNamed' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2064.TorqueConverterTurbine.TYPE](name if name else None)
        return constructor.new(_2064.TorqueConverterTurbine)(method_result) if method_result else None

    def add_part(self, part_type: 'Assembly.PartType', name: 'str') -> '_1933.Part':
    ...
    def add_oil_seal(self, name: Optional['str'] = 'Oil Seal') -> '_1931.OilSeal':
    ...
    def add_power_load(self, name: Optional['str'] = 'Power Load') -> '_1937.PowerLoad':
    ...
    def add_point_load(self, name: Optional['str'] = 'Point Load') -> '_1936.PointLoad':
    ...
    def add_datum(self, name: Optional['str'] = 'Datum') -> '_1918.Datum':
    ...
    def add_imported_fe_component(self, name: Optional['str'] = 'Imported FE') -> '_1926.ImportedFEComponent':
    ...
    def add_measurement_component(self, name: Optional['str'] = 'Measurement Component') -> '_1929.MeasurementComponent':
    ...
    def add_mass_disc(self, name: Optional['str'] = 'Mass Disc') -> '_1928.MassDisc':
    ...
    def add_unbalanced_mass(self, name: Optional['str'] = 'Unbalanced Mass') -> '_1941.UnbalancedMass':
    ...
    def add_straight_bevel_differential_gear_set(self, name: Optional['str'] = 'Straight Bevel Differential Gear Set') -> '_2008.StraightBevelDiffGearSet':
    ...
    def add_spiral_bevel_differential_gear_set(self, name: Optional['str'] = 'Spiral Bevel Differential Gear Set') -> '_1978.BevelDifferentialGearSet':
    ...
    def add_zerol_bevel_differential_gear_set(self, name: Optional['str'] = 'Zerol Bevel Differential Gear Set') -> '_1978.BevelDifferentialGearSet':
    ...
    def add_planetary_gear_set(self, name: Optional['str'] = 'Planetary Gear Set') -> '_2004.PlanetaryGearSet':
    ...
    def add_spiral_bevel_gear_set(self, name: Optional['str'] = 'Spiral Bevel Gear Set') -> '_2006.SpiralBevelGearSet':
    ...
    def add_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self, name: Optional['str'] = 'Klingelnberg Cyclo Palloid Spiral Bevel Gear Set') -> '_2003.KlingelnbergCycloPalloidSpiralBevelGearSet':
    ...
    def add_klingelnberg_cyclo_palloid_hypoid_gear_set(self, name: Optional['str'] = 'Klingelnberg Cyclo Palloid Hypoid Gear Set') -> '_2001.KlingelnbergCycloPalloidHypoidGearSet':
    ...
    def add_straight_bevel_gear_set(self, name: Optional['str'] = 'Straight Bevel Gear Set') -> '_2010.StraightBevelGearSet':
    ...
    def add_hypoid_gear_set(self, name: Optional['str'] = 'Hypoid Gear Set') -> '_1997.HypoidGearSet':
    ...
    def add_worm_gear_set(self, name: Optional['str'] = 'Worm Gear Set') -> '_2014.WormGearSet':
    ...
    def add_zerol_bevel_gear_set(self, name: Optional['str'] = 'Zerol Bevel Gear Set') -> '_2016.ZerolBevelGearSet':
    ...
    def add_clutch(self, name: Optional['str'] = 'Clutch') -> '_2036.Clutch':
    ...
    def add_synchroniser(self, name: Optional['str'] = 'Synchroniser') -> '_2056.Synchroniser':
    ...
    def add_rolling_ring(self, name: Optional['str'] = 'Rolling Ring') -> '_2051.RollingRing':
    ...
    def add_concept_coupling(self, name: Optional['str'] = 'Concept Coupling') -> '_2039.ConceptCoupling':
    ...
    def add_cvt(self, name: Optional['str'] = 'CVT') -> '_2043.CVT':
    ...
    def add_spring_damper(self, name: Optional['str'] = 'Spring Damper') -> '_2054.SpringDamper':
    ...
    def add_torque_converter(self, name: Optional['str'] = 'Torque Converter') -> '_2061.TorqueConverter':
    ...
    def add_bolted_joint(self, name: Optional['str'] = 'Bolted Joint') -> '_1913.BoltedJoint':
    ...
    def add_belt_drive_with_options(self, belt_creation_options: Optional['_2030.BeltCreationOptions'] = None) -> '_2034.BeltDrive':
    ...
    def add_belt_drive(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2034.BeltDrive':
        ''' 'AddBeltDrive' is the original name of this method.
    ...
    def add_planet_carrier_with_options(self, planet_carrier_creation_options: Optional['_2032.PlanetCarrierCreationOptions'] = None) -> '_1934.PlanetCarrier':
    ...
    def add_planet_carrier(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_1934.PlanetCarrier':
        ''' 'AddPlanetCarrier' is the original name of this method.
    ...
    def add_shaft_with_options(self, shaft_creation_options: '_2033.ShaftCreationOptions') -> '_1945.Shaft':
    ...
    def add_shaft(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_1945.Shaft':
        ''' 'AddShaft' is the original name of this method.
    ...
    def add_cylindrical_gear_pair_with_options(self, cylindrical_gear_pair_creation_options: Optional['_992.CylindricalGearPairCreationOptions'] = None) -> '_1988.CylindricalGearSet':
    ...
    def add_cylindrical_gear_pair(self, centre_distance: 'float') -> '_1988.CylindricalGearSet':
        ''' 'AddCylindricalGearPair' is the original name of this method.
    ...
    def add_cylindrical_gear_set_with_options(self, cylindrical_gear_linear_train_creation_options: Optional['_2031.CylindricalGearLinearTrainCreationOptions'] = None) -> '_1988.CylindricalGearSet':
    ...
    def add_cylindrical_gear_set(self, name: 'str', centre_distances: 'List[float]') -> '_1988.CylindricalGearSet':
        ''' 'AddCylindricalGearSet' is the original name of this method.
    ...
    def add_cylindrical_gear_set_extended(self, name: 'str', normal_pressure_angle: 'float', helix_angle: 'float', normal_module: 'float', pinion_hand: '_265.Hand', centre_distances: 'List[float]') -> '_1988.CylindricalGearSet':
        ''' 'AddCylindricalGearSet' is the original name of this method.
    ...
    def add_spiral_bevel_gear_set_with_options(self, spiral_bevel_gear_set_creation_options: Optional['_995.SpiralBevelGearSetCreationOptions'] = None) -> '_2006.SpiralBevelGearSet':
        ''' 'AddSpiralBevelGearSet' is the original name of this method.
    ...
    def add_bearing(self, name: 'str') -> '_1910.Bearing':
    ...
    def import_fe_mesh_from_file(self, file_name: 'str', stiffness_matrix: '_72.NodalMatrix') -> '_1926.ImportedFEComponent':
    ...
    def add_axial_clearance_bearing(self, name: 'str', contact_diameter: 'float') -> '_1910.Bearing':
    ...
    def add_shaft_hub_connection(self, name: 'str') -> '_2053.ShaftHubConnection':
    ...
    def add_rolling_bearing_from_catalogue(self, catalogue: '_1457.BearingCatalog', designation: 'str', name: 'str') -> '_1910.Bearing':
    ...
    def add_bearing_with_name_and_rolling_bearing_type(self, name: 'str', type_: '_1482.RollingBearingType') -> '_1910.Bearing':
        ''' 'AddBearing' is the original name of this method.
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(self, name: 'str', type_: '_1482.RollingBearingType', designation: 'str') -> '_1910.Bearing':
        ''' 'AddBearing' is the original name of this method.
