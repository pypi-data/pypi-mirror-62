...
from mastapy.system_model.part_model import _1861
...
class MountableComponent(_1861.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_1877.Shaft', offset: Optional['float'] = float('nan')) -> '_1765.CoaxialConnection':
        ...
        return constructor.new(_1765.CoaxialConnection)(method_result) if method_result else None
