...
from mastapy.system_model.part_model import _2010, _2018, _1870
...
class PlanetCarrier(_1870.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2010.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2010.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2010.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2018.LoadSharingModes':
        ...
        return constructor.new(_2018.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2018.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def planetary_sockets(self) -> 'List[_1781.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1781.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_1877.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_1877.Shaft', offset: Optional['float'] = float('nan')):
