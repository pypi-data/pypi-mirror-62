...
from mastapy.system_model.part_model import _1909, _1927, _1930
...
class PlanetCarrier(_1930.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_1909.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_1909.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_1909.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_1927.LoadSharingModes':
        ...
        return constructor.new(_1927.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_1927.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def planetary_sockets(self) -> 'List[_1778.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1778.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_1945.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_1945.Shaft', offset: Optional['float'] = float('nan')):
