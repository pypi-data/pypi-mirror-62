...
from mastapy.system_model.part_model import _1961, _1981, _1984
from mastapy.system_model.connections_and_sockets import _1828
...
class PlanetCarrier(_1984.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_1961.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_1961.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_1961.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_1981.LoadSharingModes':
        ...
        return constructor.new(_1981.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_1981.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def planetary_sockets(self) -> 'List[_1828.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1828.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2000.Shaft', offset: Optional['float'] = float('nan')):
