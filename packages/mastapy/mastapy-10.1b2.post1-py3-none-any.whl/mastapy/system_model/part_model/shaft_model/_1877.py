...
class Shaft(_1857.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2016.GuideImage':
        ...
        return constructor.new(_2016.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_1870.MountableComponent', offset: 'float'):
