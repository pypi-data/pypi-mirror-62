...
class ShaftBow(_1.APIBase):
    ...
    @property
    def linear_displacement(self) -> 'List[_1078.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinearDisplacement, constructor.new(_1078.Vector4D))
        return value
