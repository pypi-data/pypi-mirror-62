...
class Shaft(_1916.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1932.GuideImage':
        ...
        return constructor.new(_1932.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None

    @property
    def active_definition(self) -> '_70.SimpleShaftDefinition':
        ...
        return constructor.new(_70.SimpleShaftDefinition)(self.wrapped.ActiveDefinition) if self.wrapped.ActiveDefinition else None
    ...
    def mount_component(self, component: '_1938.MountableComponent', offset: 'float'):
