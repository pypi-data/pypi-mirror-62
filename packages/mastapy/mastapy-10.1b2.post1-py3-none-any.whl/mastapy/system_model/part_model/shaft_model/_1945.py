...
class Shaft(_1908.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1924.GuideImage':
        ...
        return constructor.new(_1924.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_1930.MountableComponent', offset: 'float'):
