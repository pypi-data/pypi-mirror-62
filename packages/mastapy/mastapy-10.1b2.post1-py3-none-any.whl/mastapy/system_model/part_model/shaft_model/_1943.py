...
class Shaft(_1907.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1923.GuideImage':
        ...
        return constructor.new(_1923.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_1929.MountableComponent', offset: 'float'):
