...
from mastapy.system_model.part_model import _1932, _1917
...
class OilSeal(_1917.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_1932.OilSealMaterialType':
        ...
        return constructor.new(_1932.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_1932.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1535.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1535.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
