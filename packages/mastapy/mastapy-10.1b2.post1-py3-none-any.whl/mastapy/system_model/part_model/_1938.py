...
from mastapy.geometry import _243
from mastapy.system_model.part_model.projections import _1948
from mastapy.system_model.part_model.part_groups import _1953
...
class RootAssembly(_1906.Assembly):
    '''RootAssembly
    ...
    @property
    def packaging_limits(self) -> '_243.PackagingLimits':
        ...
        return constructor.new(_243.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_1948.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_1948.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_1953.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_1953.ParallelPartGroup))
        return value
