...
from mastapy import _4, _334, _1
...
from mastapy.system_model.part_model import (
    _1940, _1938, _1939, _1935,
    _1908, _1909, _1910, _1912,
    _1914, _1915, _1916, _1919,
    _1920, _1923, _1924, _1925,
    _1928, _1930, _1931, _1932,
    _1933, _1936, _1937, _1941,
    _1942, _1943
)
from mastapy.gears import _293, _300
from mastapy.gears.materials import _598
from mastapy.utility import _1266, _1265, _1264
from mastapy.system_model import _1743, _1742
from mastapy.shafts import _63
from mastapy.detailed_rigid_connectors.splines import _1129
from mastapy._internal.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _1975, _1996, _1976, _1977,
    _1978, _1979, _1980, _1981,
    _1982, _1983, _1984, _1985,
    _1986, _1987, _1988, _1989,
    _1990, _1991, _1992, _1993,
    _1995, _1997, _1998, _1999,
    _2000, _2001, _2002, _2003,
...
from mastapy.system_model.part_model.configurations import _2031, _2032, _2033
from mastapy.system_model.analyses_and_results.load_case_groups import _2034, _2036
from mastapy.system_model.analyses_and_results.static_loads import _2035
from mastapy.utility.model_validation import _1388
from mastapy.system_model.database_access import _1763
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2037
...
from mastapy.gears.gear_designs.creation_options import _1059, _1062
from mastapy.nodal_analysis import _104
from mastapy.bearings.bearing_designs.rolling import _1674
...
class Design(_1.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1456.MASTAGUI':
        ...
        return constructor.new(_1456.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    def transverse_contact_ratio_requirement(self) -> '_293.ContactRatioRequirements':
        ...
        return constructor.new(_293.ContactRatioRequirements)(value) if value else None
    ...
    @property
    def file_save_details_most_recent(self) -> '_1266.FileHistoryItem':
        ...
        return constructor.new(_1266.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1743.TransmissionTemperatureSet':
        ...
        return constructor.new(_1743.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None

    @property
    def shafts(self) -> '_63.ShaftSafetyFactorSettings':
        ...
        return constructor.new(_63.ShaftSafetyFactorSettings)(self.wrapped.Shafts) if self.wrapped.Shafts else None
    ...
    @property
    def file_save_details_all(self) -> '_1265.FileHistory':
        ...
        return constructor.new(_1265.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_1975.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_1975.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1742.SystemReporting':
        ...
        return constructor.new(_1742.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1844.BatchOperations':
        ...
        return constructor.new(_1844.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None
    ...
    @property
    def gear_set_configurations(self) -> 'List[_1975.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_1975.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2031.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2031.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2032.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2032.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2033.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2033.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_2034.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_2034.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_2035.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_2035.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_2036.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_2036.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_1939.RootAssembly':
        ...
        return constructor.new(_1939.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_1996.GearSetConfiguration':
        ...
        return constructor.new(_1996.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @property
    def status(self) -> '_1388.Status':
        ...
        return constructor.new(_1388.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1763.Databases':
        ...
        return constructor.new(_1763.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    def save(self, file_name: 'str', save_results: 'bool') -> '_1388.Status':
        ...
        return constructor.new(_1388.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_334.TaskProgress') -> '_1388.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2037.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2037.SynchroniserShift':
        ...
        return constructor.new(_2037.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2037.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_2034.DesignState':
        ...
        return constructor.new(_2034.DesignState)(method_result) if method_result else None

    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_2036.DutyCycle':
        ...
        return constructor.new(_2036.DutyCycle)(method_result) if method_result else None

    def all_parts_of_type_assembly(self) -> 'List[_1908.Assembly]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1908.Assembly.TYPE](), constructor.new(_1908.Assembly))

    def all_parts_of_type_abstract_assembly(self) -> 'List[_1909.AbstractAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1909.AbstractAssembly.TYPE](), constructor.new(_1909.AbstractAssembly))

    def all_parts_of_type_abstract_shaft_or_housing(self) -> 'List[_1910.AbstractShaftOrHousing]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1910.AbstractShaftOrHousing.TYPE](), constructor.new(_1910.AbstractShaftOrHousing))

    def all_parts_of_type_bearing(self) -> 'List[_1912.Bearing]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1912.Bearing.TYPE](), constructor.new(_1912.Bearing))

    def all_parts_of_type_bolt(self) -> 'List[_1914.Bolt]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1914.Bolt.TYPE](), constructor.new(_1914.Bolt))

    def all_parts_of_type_bolted_joint(self) -> 'List[_1915.BoltedJoint]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1915.BoltedJoint.TYPE](), constructor.new(_1915.BoltedJoint))

    def all_parts_of_type_component(self) -> 'List[_1916.Component]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1916.Component.TYPE](), constructor.new(_1916.Component))

    def all_parts_of_type_connector(self) -> 'List[_1919.Connector]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1919.Connector.TYPE](), constructor.new(_1919.Connector))

    def all_parts_of_type_datum(self) -> 'List[_1920.Datum]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1920.Datum.TYPE](), constructor.new(_1920.Datum))

    def all_parts_of_type_external_cad_model(self) -> 'List[_1923.ExternalCADModel]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1923.ExternalCADModel.TYPE](), constructor.new(_1923.ExternalCADModel))

    def all_parts_of_type_flexible_pin_assembly(self) -> 'List[_1924.FlexiblePinAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1924.FlexiblePinAssembly.TYPE](), constructor.new(_1924.FlexiblePinAssembly))

    def all_parts_of_type_guide_dxf_model(self) -> 'List[_1925.GuideDxfModel]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1925.GuideDxfModel.TYPE](), constructor.new(_1925.GuideDxfModel))

    def all_parts_of_type_imported_fe_component(self) -> 'List[_1928.ImportedFEComponent]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1928.ImportedFEComponent.TYPE](), constructor.new(_1928.ImportedFEComponent))

    def all_parts_of_type_mass_disc(self) -> 'List[_1930.MassDisc]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1930.MassDisc.TYPE](), constructor.new(_1930.MassDisc))

    def all_parts_of_type_measurement_component(self) -> 'List[_1931.MeasurementComponent]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1931.MeasurementComponent.TYPE](), constructor.new(_1931.MeasurementComponent))

    def all_parts_of_type_mountable_component(self) -> 'List[_1932.MountableComponent]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1932.MountableComponent.TYPE](), constructor.new(_1932.MountableComponent))

    def all_parts_of_type_oil_seal(self) -> 'List[_1933.OilSeal]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1933.OilSeal.TYPE](), constructor.new(_1933.OilSeal))

    def all_parts_of_type_planet_carrier(self) -> 'List[_1936.PlanetCarrier]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1936.PlanetCarrier.TYPE](), constructor.new(_1936.PlanetCarrier))

    def all_parts_of_type_point_load(self) -> 'List[_1937.PointLoad]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1937.PointLoad.TYPE](), constructor.new(_1937.PointLoad))

    def all_parts_of_type_power_load(self) -> 'List[_1938.PowerLoad]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1938.PowerLoad.TYPE](), constructor.new(_1938.PowerLoad))

    def all_parts_of_type_root_assembly(self) -> 'List[_1939.RootAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1939.RootAssembly.TYPE](), constructor.new(_1939.RootAssembly))

    def all_parts_of_type_specialised_assembly(self) -> 'List[_1941.SpecialisedAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1941.SpecialisedAssembly.TYPE](), constructor.new(_1941.SpecialisedAssembly))

    def all_parts_of_type_unbalanced_mass(self) -> 'List[_1942.UnbalancedMass]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1942.UnbalancedMass.TYPE](), constructor.new(_1942.UnbalancedMass))

    def all_parts_of_type_virtual_component(self) -> 'List[_1943.VirtualComponent]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1943.VirtualComponent.TYPE](), constructor.new(_1943.VirtualComponent))

    def all_parts_of_type_shaft(self) -> 'List[_1946.Shaft]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1946.Shaft.TYPE](), constructor.new(_1946.Shaft))

    def all_parts_of_type_agma_gleason_conical_gear(self) -> 'List[_1976.AGMAGleasonConicalGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1976.AGMAGleasonConicalGear.TYPE](), constructor.new(_1976.AGMAGleasonConicalGear))

    def all_parts_of_type_agma_gleason_conical_gear_set(self) -> 'List[_1977.AGMAGleasonConicalGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1977.AGMAGleasonConicalGearSet.TYPE](), constructor.new(_1977.AGMAGleasonConicalGearSet))

    def all_parts_of_type_bevel_differential_gear(self) -> 'List[_1978.BevelDifferentialGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1978.BevelDifferentialGear.TYPE](), constructor.new(_1978.BevelDifferentialGear))

    def all_parts_of_type_bevel_differential_gear_set(self) -> 'List[_1979.BevelDifferentialGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1979.BevelDifferentialGearSet.TYPE](), constructor.new(_1979.BevelDifferentialGearSet))

    def all_parts_of_type_bevel_differential_planet_gear(self) -> 'List[_1980.BevelDifferentialPlanetGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1980.BevelDifferentialPlanetGear.TYPE](), constructor.new(_1980.BevelDifferentialPlanetGear))

    def all_parts_of_type_bevel_differential_sun_gear(self) -> 'List[_1981.BevelDifferentialSunGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1981.BevelDifferentialSunGear.TYPE](), constructor.new(_1981.BevelDifferentialSunGear))

    def all_parts_of_type_bevel_gear(self) -> 'List[_1982.BevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1982.BevelGear.TYPE](), constructor.new(_1982.BevelGear))

    def all_parts_of_type_bevel_gear_set(self) -> 'List[_1983.BevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1983.BevelGearSet.TYPE](), constructor.new(_1983.BevelGearSet))

    def all_parts_of_type_concept_gear(self) -> 'List[_1984.ConceptGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1984.ConceptGear.TYPE](), constructor.new(_1984.ConceptGear))

    def all_parts_of_type_concept_gear_set(self) -> 'List[_1985.ConceptGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1985.ConceptGearSet.TYPE](), constructor.new(_1985.ConceptGearSet))

    def all_parts_of_type_conical_gear(self) -> 'List[_1986.ConicalGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1986.ConicalGear.TYPE](), constructor.new(_1986.ConicalGear))

    def all_parts_of_type_conical_gear_set(self) -> 'List[_1987.ConicalGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1987.ConicalGearSet.TYPE](), constructor.new(_1987.ConicalGearSet))

    def all_parts_of_type_cylindrical_gear(self) -> 'List[_1988.CylindricalGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1988.CylindricalGear.TYPE](), constructor.new(_1988.CylindricalGear))

    def all_parts_of_type_cylindrical_gear_set(self) -> 'List[_1989.CylindricalGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1989.CylindricalGearSet.TYPE](), constructor.new(_1989.CylindricalGearSet))

    def all_parts_of_type_cylindrical_planet_gear(self) -> 'List[_1990.CylindricalPlanetGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1990.CylindricalPlanetGear.TYPE](), constructor.new(_1990.CylindricalPlanetGear))

    def all_parts_of_type_face_gear(self) -> 'List[_1991.FaceGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1991.FaceGear.TYPE](), constructor.new(_1991.FaceGear))

    def all_parts_of_type_face_gear_set(self) -> 'List[_1992.FaceGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1992.FaceGearSet.TYPE](), constructor.new(_1992.FaceGearSet))

    def all_parts_of_type_gear(self) -> 'List[_1993.Gear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1993.Gear.TYPE](), constructor.new(_1993.Gear))

    def all_parts_of_type_gear_set(self) -> 'List[_1995.GearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1995.GearSet.TYPE](), constructor.new(_1995.GearSet))

    def all_parts_of_type_hypoid_gear(self) -> 'List[_1997.HypoidGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1997.HypoidGear.TYPE](), constructor.new(_1997.HypoidGear))

    def all_parts_of_type_hypoid_gear_set(self) -> 'List[_1998.HypoidGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1998.HypoidGearSet.TYPE](), constructor.new(_1998.HypoidGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> 'List[_1999.KlingelnbergCycloPalloidConicalGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1999.KlingelnbergCycloPalloidConicalGear.TYPE](), constructor.new(_1999.KlingelnbergCycloPalloidConicalGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> 'List[_2000.KlingelnbergCycloPalloidConicalGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2000.KlingelnbergCycloPalloidConicalGearSet.TYPE](), constructor.new(_2000.KlingelnbergCycloPalloidConicalGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> 'List[_2001.KlingelnbergCycloPalloidHypoidGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2001.KlingelnbergCycloPalloidHypoidGear.TYPE](), constructor.new(_2001.KlingelnbergCycloPalloidHypoidGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> 'List[_2002.KlingelnbergCycloPalloidHypoidGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2002.KlingelnbergCycloPalloidHypoidGearSet.TYPE](), constructor.new(_2002.KlingelnbergCycloPalloidHypoidGearSet))

    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> 'List[_2003.KlingelnbergCycloPalloidSpiralBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2003.KlingelnbergCycloPalloidSpiralBevelGear.TYPE](), constructor.new(_2003.KlingelnbergCycloPalloidSpiralBevelGear))

    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> 'List[_2004.KlingelnbergCycloPalloidSpiralBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2004.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE](), constructor.new(_2004.KlingelnbergCycloPalloidSpiralBevelGearSet))

    def all_parts_of_type_planetary_gear_set(self) -> 'List[_2005.PlanetaryGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2005.PlanetaryGearSet.TYPE](), constructor.new(_2005.PlanetaryGearSet))

    def all_parts_of_type_spiral_bevel_gear(self) -> 'List[_2006.SpiralBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2006.SpiralBevelGear.TYPE](), constructor.new(_2006.SpiralBevelGear))

    def all_parts_of_type_spiral_bevel_gear_set(self) -> 'List[_2007.SpiralBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2007.SpiralBevelGearSet.TYPE](), constructor.new(_2007.SpiralBevelGearSet))

    def all_parts_of_type_straight_bevel_diff_gear(self) -> 'List[_2008.StraightBevelDiffGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2008.StraightBevelDiffGear.TYPE](), constructor.new(_2008.StraightBevelDiffGear))

    def all_parts_of_type_straight_bevel_diff_gear_set(self) -> 'List[_2009.StraightBevelDiffGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2009.StraightBevelDiffGearSet.TYPE](), constructor.new(_2009.StraightBevelDiffGearSet))

    def all_parts_of_type_straight_bevel_gear(self) -> 'List[_2010.StraightBevelGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2010.StraightBevelGear.TYPE](), constructor.new(_2010.StraightBevelGear))

    def all_parts_of_type_straight_bevel_gear_set(self) -> 'List[_2011.StraightBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2011.StraightBevelGearSet.TYPE](), constructor.new(_2011.StraightBevelGearSet))

    def all_parts_of_type_straight_bevel_planet_gear(self) -> 'List[_2012.StraightBevelPlanetGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2012.StraightBevelPlanetGear.TYPE](), constructor.new(_2012.StraightBevelPlanetGear))

    def all_parts_of_type_straight_bevel_sun_gear(self) -> 'List[_2013.StraightBevelSunGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2013.StraightBevelSunGear.TYPE](), constructor.new(_2013.StraightBevelSunGear))

    def all_parts_of_type_worm_gear(self) -> 'List[_2014.WormGear]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2014.WormGear.TYPE](), constructor.new(_2014.WormGear))

    def all_parts_of_type_worm_gear_set(self) -> 'List[_2015.WormGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2015.WormGearSet.TYPE](), constructor.new(_2015.WormGearSet))
    ...
    def all_parts_of_type_zerol_bevel_gear_set(self) -> 'List[_2017.ZerolBevelGearSet]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2017.ZerolBevelGearSet.TYPE](), constructor.new(_2017.ZerolBevelGearSet))

    def all_parts_of_type_belt_drive(self) -> 'List[_2038.BeltDrive]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2038.BeltDrive.TYPE](), constructor.new(_2038.BeltDrive))

    def all_parts_of_type_clutch(self) -> 'List[_2039.Clutch]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2039.Clutch.TYPE](), constructor.new(_2039.Clutch))

    def all_parts_of_type_clutch_half(self) -> 'List[_2040.ClutchHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2040.ClutchHalf.TYPE](), constructor.new(_2040.ClutchHalf))

    def all_parts_of_type_concept_coupling(self) -> 'List[_2041.ConceptCoupling]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2041.ConceptCoupling.TYPE](), constructor.new(_2041.ConceptCoupling))

    def all_parts_of_type_concept_coupling_half(self) -> 'List[_2042.ConceptCouplingHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2042.ConceptCouplingHalf.TYPE](), constructor.new(_2042.ConceptCouplingHalf))

    def all_parts_of_type_coupling(self) -> 'List[_2043.Coupling]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2043.Coupling.TYPE](), constructor.new(_2043.Coupling))

    def all_parts_of_type_coupling_half(self) -> 'List[_2044.CouplingHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2044.CouplingHalf.TYPE](), constructor.new(_2044.CouplingHalf))

    def all_parts_of_type_cvt(self) -> 'List[_2045.CVT]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2045.CVT.TYPE](), constructor.new(_2045.CVT))

    def all_parts_of_type_cvt_pulley(self) -> 'List[_2046.CVTPulley]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2046.CVTPulley.TYPE](), constructor.new(_2046.CVTPulley))

    def all_parts_of_type_pulley(self) -> 'List[_2047.Pulley]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2047.Pulley.TYPE](), constructor.new(_2047.Pulley))

    def all_parts_of_type_rolling_ring(self) -> 'List[_2048.RollingRing]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2048.RollingRing.TYPE](), constructor.new(_2048.RollingRing))

    def all_parts_of_type_rolling_ring_assembly(self) -> 'List[_2049.RollingRingAssembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2049.RollingRingAssembly.TYPE](), constructor.new(_2049.RollingRingAssembly))

    def all_parts_of_type_shaft_hub_connection(self) -> 'List[_2050.ShaftHubConnection]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2050.ShaftHubConnection.TYPE](), constructor.new(_2050.ShaftHubConnection))

    def all_parts_of_type_spring_damper(self) -> 'List[_2051.SpringDamper]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2051.SpringDamper.TYPE](), constructor.new(_2051.SpringDamper))

    def all_parts_of_type_spring_damper_half(self) -> 'List[_2052.SpringDamperHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2052.SpringDamperHalf.TYPE](), constructor.new(_2052.SpringDamperHalf))

    def all_parts_of_type_synchroniser(self) -> 'List[_2053.Synchroniser]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2053.Synchroniser.TYPE](), constructor.new(_2053.Synchroniser))

    def all_parts_of_type_synchroniser_half(self) -> 'List[_2054.SynchroniserHalf]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2054.SynchroniserHalf.TYPE](), constructor.new(_2054.SynchroniserHalf))

    def all_parts_of_type_synchroniser_part(self) -> 'List[_2055.SynchroniserPart]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2055.SynchroniserPart.TYPE](), constructor.new(_2055.SynchroniserPart))

    def all_parts_of_type_synchroniser_sleeve(self) -> 'List[_2056.SynchroniserSleeve]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2056.SynchroniserSleeve.TYPE](), constructor.new(_2056.SynchroniserSleeve))

    def all_parts_of_type_torque_converter(self) -> 'List[_2057.TorqueConverter]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2057.TorqueConverter.TYPE](), constructor.new(_2057.TorqueConverter))

    def all_parts_of_type_torque_converter_pump(self) -> 'List[_2058.TorqueConverterPump]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2058.TorqueConverterPump.TYPE](), constructor.new(_2058.TorqueConverterPump))

    def all_parts_of_type_torque_converter_turbine(self) -> 'List[_2059.TorqueConverterTurbine]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2059.TorqueConverterTurbine.TYPE](), constructor.new(_2059.TorqueConverterTurbine))

    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1264.ExternalFullFEFileOption'] = _1264.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2060.BeltCreationOptions':
        ...
        return constructor.new(_2060.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2061.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2061.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2062.ShaftCreationOptions':
        ...
        return constructor.new(_2062.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_1059.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_1059.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2063.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2063.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_1062.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_1062.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_104.NodalMatrix':
        ...
        return constructor.new(_104.NodalMatrix)(method_result) if method_result else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1674.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_2034.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_2036.DutyCycle':
