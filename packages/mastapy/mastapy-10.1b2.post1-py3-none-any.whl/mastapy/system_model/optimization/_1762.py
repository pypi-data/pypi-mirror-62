...
from mastapy.system_model.optimization import _1754
...
class OptimizationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1754.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1754.CylindricalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1754.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1754.CylindricalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_optimisation_strategy: '_1754.CylindricalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, cylindrical_gear_optimisation_strategy: '_1754.CylindricalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_optimisation_strategy: '_1754.CylindricalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1754.CylindricalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1754.CylindricalGearOptimisationStrategy))

    def save_changes(self, cylindrical_gear_optimisation_strategy: '_1754.CylindricalGearOptimisationStrategy'):
