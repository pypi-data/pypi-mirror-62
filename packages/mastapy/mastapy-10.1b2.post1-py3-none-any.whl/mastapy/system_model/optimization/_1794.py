...
from mastapy.system_model.optimization import _1792
...
class ConicalGearOptimizationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1792.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1792.ConicalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1792.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1792.ConicalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, conical_gear_optimisation_strategy: '_1792.ConicalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, conical_gear_optimisation_strategy: '_1792.ConicalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, conical_gear_optimisation_strategy: '_1792.ConicalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1792.ConicalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1792.ConicalGearOptimisationStrategy))

    def save_changes(self, conical_gear_optimisation_strategy: '_1792.ConicalGearOptimisationStrategy'):
