...
class OptimizationStep(_1.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1749.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1749.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1749.MicroGeometryOptimisationTarget'):
