...
from mastapy.system_model.optimization import _1758
...
class OptimizationStep(_1.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1758.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1758.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1758.MicroGeometryOptimisationTarget'):
