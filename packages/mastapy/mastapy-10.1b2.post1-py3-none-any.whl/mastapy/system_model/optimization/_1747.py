...
class CylindricalGearSetOptimizer(_1.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1748.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1748.MeasuredAndFactorViewModel))
        return value
