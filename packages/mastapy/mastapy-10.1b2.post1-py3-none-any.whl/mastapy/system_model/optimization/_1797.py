...
from mastapy.system_model.optimization import _1798
...
class CylindricalGearSetOptimizer(_1.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1798.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1798.MeasuredAndFactorViewModel))
        return value
