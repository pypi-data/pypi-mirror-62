...
from mastapy.system_model.optimization import _1757
...
class CylindricalGearSetOptimizer(_1.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1757.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1757.MeasuredAndFactorViewModel))
        return value
