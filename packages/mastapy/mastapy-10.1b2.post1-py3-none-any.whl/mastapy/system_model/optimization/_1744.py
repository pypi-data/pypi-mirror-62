...
from mastapy.system_model.optimization import _1742
...
class ConicalGearOptimizationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1742.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1742.ConicalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1742.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1742.ConicalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, conical_gear_optimisation_strategy: '_1742.ConicalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, conical_gear_optimisation_strategy: '_1742.ConicalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, conical_gear_optimisation_strategy: '_1742.ConicalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1742.ConicalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1742.ConicalGearOptimisationStrategy))

    def save_changes(self, conical_gear_optimisation_strategy: '_1742.ConicalGearOptimisationStrategy'):
