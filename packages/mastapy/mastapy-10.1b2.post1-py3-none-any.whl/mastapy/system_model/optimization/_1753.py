...
from mastapy.system_model.optimization import _1745
...
class OptimizationStrategyDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_1745.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1745.CylindricalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1745.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1745.CylindricalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_optimisation_strategy: '_1745.CylindricalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, cylindrical_gear_optimisation_strategy: '_1745.CylindricalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_optimisation_strategy: '_1745.CylindricalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1745.CylindricalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1745.CylindricalGearOptimisationStrategy))

    def save_changes(self, cylindrical_gear_optimisation_strategy: '_1745.CylindricalGearOptimisationStrategy'):
