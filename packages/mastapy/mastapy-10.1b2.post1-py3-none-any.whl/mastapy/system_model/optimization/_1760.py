...
from mastapy.system_model.optimization import _1761, _1759
...
TStep = TypeVar('TStep', bound='_1759.OptimizationStep')


class OptimizationStrategy(_1761.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
