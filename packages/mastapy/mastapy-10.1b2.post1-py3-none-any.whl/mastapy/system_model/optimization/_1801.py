...
from mastapy.system_model.optimization import _1802, _1800
...
TStep = TypeVar('TStep', bound='_1800.OptimizationStep')


class OptimizationStrategy(_1802.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
