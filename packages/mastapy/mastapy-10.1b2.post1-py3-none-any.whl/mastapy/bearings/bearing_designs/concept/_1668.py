...
from mastapy.bearings.bearing_designs.concept import _1723, _1724
...
class ConceptAxialClearanceBearing(_1724.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1723.BearingNodePosition':
        ...
        return constructor.new(_1723.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1723.BearingNodePosition'):
