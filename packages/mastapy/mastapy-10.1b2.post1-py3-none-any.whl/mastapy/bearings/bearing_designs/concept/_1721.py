...
from mastapy.bearings.bearing_designs.concept import _1720, _1722
...
class ConceptAxialClearanceBearing(_1722.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1720.BearingNodePosition':
        ...
        return constructor.new(_1720.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1720.BearingNodePosition'):
