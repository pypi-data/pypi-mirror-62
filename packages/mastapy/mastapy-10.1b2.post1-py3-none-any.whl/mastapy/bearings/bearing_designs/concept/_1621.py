...
from mastapy.bearings.bearing_designs.concept import _1730, _1622
...
class ConceptAxialClearanceBearing(_1622.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1730.BearingNodePosition':
        ...
        return constructor.new(_1730.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1730.BearingNodePosition'):
