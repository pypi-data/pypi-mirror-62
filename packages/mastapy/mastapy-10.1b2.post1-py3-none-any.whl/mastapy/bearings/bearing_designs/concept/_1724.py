...
from mastapy.bearings.bearing_designs.concept import _1729, _1725
...
class ConceptAxialClearanceBearing(_1725.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1729.BearingNodePosition':
        ...
        return constructor.new(_1729.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1729.BearingNodePosition'):
