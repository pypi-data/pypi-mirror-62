...
from mastapy.bearings.bearing_designs.concept import _1717, _1719
...
class ConceptAxialClearanceBearing(_1719.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1717.BearingNodePosition':
        ...
        return constructor.new(_1717.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1717.BearingNodePosition'):
