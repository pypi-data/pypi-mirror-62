...
from mastapy.bearings.bearing_designs.concept import _1727, _1729
...
class ConceptAxialClearanceBearing(_1729.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1727.BearingNodePosition':
        ...
        return constructor.new(_1727.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1727.BearingNodePosition'):
