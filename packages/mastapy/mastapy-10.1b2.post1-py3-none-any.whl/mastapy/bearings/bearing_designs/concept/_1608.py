...
from mastapy.bearings.bearing_designs.concept import _1722, _1723
...
class ConceptAxialClearanceBearing(_1723.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1722.BearingNodePosition':
        ...
        return constructor.new(_1722.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1722.BearingNodePosition'):
