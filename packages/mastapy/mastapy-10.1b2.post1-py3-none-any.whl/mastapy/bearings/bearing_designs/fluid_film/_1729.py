...
class PlainJournalHousing(_1.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1525.DefaultOrUserInput':
        ...
        return constructor.new(_1525.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1525.DefaultOrUserInput'):
