...
from mastapy.bearings.bearing_designs.fluid_film import _1615
...
class TiltingPadThrustBearing(_1615.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1494.TiltingPadTypes':
        ...
        return constructor.new(_1494.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1494.TiltingPadTypes'):
