...
class PlainJournalHousing(_1.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1532.DefaultOrUserInput':
        ...
        return constructor.new(_1532.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1532.DefaultOrUserInput'):
