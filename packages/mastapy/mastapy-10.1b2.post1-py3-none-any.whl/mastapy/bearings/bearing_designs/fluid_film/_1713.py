...
class PlainJournalHousing(_1.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1520.DefaultOrUserInput':
        ...
        return constructor.new(_1520.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1520.DefaultOrUserInput'):
