...
from mastapy.bearings.bearing_designs.fluid_film import _1708
...
class TiltingPadThrustBearing(_1708.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1485.TiltingPadTypes':
        ...
        return constructor.new(_1485.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1485.TiltingPadTypes'):
