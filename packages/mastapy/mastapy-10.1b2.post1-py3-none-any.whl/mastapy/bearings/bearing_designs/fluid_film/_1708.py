...
class PadFluidFilmBearing(_1660.DetailedBearing):
    '''PadFluidFilmBearing
    ...
    def rotational_direction(self) -> 'enum_with_selected_value.EnumWithSelectedValue_RotationalDirections':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_RotationalDirections.implicit_type()
    ...
    def rotational_direction(self, value: 'enum_with_selected_value.EnumWithSelectedValue_RotationalDirections.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_RotationalDirections.implicit_type().type_()
