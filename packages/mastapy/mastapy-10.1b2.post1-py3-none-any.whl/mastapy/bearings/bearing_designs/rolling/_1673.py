...
class BearingProtectionDetailsModifier(_1.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1674.BearingProtectionLevel':
        ...
        return constructor.new(_1674.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1674.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1674.BearingProtectionLevel'):
