...
from mastapy.bearings.bearing_designs.rolling import _1669
...
class ThrustBallBearing(_1669.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1476.OuterRingMounting':
        ...
        return constructor.new(_1476.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1476.OuterRingMounting'):
