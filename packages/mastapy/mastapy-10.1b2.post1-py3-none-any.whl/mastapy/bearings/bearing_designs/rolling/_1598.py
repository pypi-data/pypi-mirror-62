...
from mastapy.bearings.bearing_designs.rolling import _1700, _1607
...
class BallBearing(_1607.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1700.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1700.BallBearingShoulderDefinition))
        return value
