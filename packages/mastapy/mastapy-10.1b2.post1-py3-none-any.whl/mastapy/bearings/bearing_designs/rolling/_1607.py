...
from mastapy.bearings import (
    _1488, _1490, _1467, _1478,
    _1493, _1469
)
from mastapy.bearings.bearing_designs.rolling import (
    _1710, _1706, _1705, _1704,
    _1709, _1701
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1265
from mastapy.materials import _236
from mastapy.bearings.bearing_designs import _1589
...
class RollingBearing(_1589.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1467.BearingCatalog':
        ...
        return constructor.new(_1467.BearingCatalog)(value) if value else None
    ...
    def static_capacity_calculation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod)(self.wrapped.StaticCapacityCalculation) if self.wrapped.StaticCapacityCalculation else None
    ...
    def static_capacity_calculation(self, value: 'enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.TYPE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.implicit_type()
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def type_information(self) -> '_1704.BearingTypeExtraInformation':
        ...
        return constructor.new(_1704.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1469.BearingCageMaterial':
        ...
        return constructor.new(_1469.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1469.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1709.SleeveType':
        ...
        return constructor.new(_1709.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1265.FileHistory':
        ...
        return constructor.new(_1265.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1701.BearingProtection':
        ...
        return constructor.new(_1701.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_236.BearingMaterial':
        ...
        return constructor.new(_236.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_236.BearingMaterial':
        ...
        return constructor.new(_236.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_236.BearingMaterial':
        ...
        return constructor.new(_236.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
