...
from mastapy.bearings.bearing_designs.rolling import _1735, _1736, _1734
...
class NonBarrelRollerBearing(_1734.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1735.RollerEndShape':
        ...
        return constructor.new(_1735.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1735.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1736.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1736.RollerRibDetail))
        return value
