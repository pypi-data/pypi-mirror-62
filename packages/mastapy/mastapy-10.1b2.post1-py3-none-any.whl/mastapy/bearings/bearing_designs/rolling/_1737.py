...
from mastapy.bearings import (
    _1505, _1507, _1484, _1485,
    _1486, _1487
)
from mastapy.bearings.bearing_designs.rolling import (
    _1746, _1730, _1728, _1725,
    _1739, _1722
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1119
from mastapy.materials import _53
from mastapy.bearings.bearing_designs import _1710
...
class RollingBearing(_1710.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1484.BearingCatalog':
        ...
        return constructor.new(_1484.BearingCatalog)(value) if value else None
    ...
    def basic_dynamic_load_rating_calculation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod.implicit_type()
    ...
    def basic_dynamic_load_rating_calculation(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    def basic_static_load_rating_calculation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod.implicit_type()
    ...
    def basic_static_load_rating_calculation(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def type_information(self) -> '_1725.BearingTypeExtraInformation':
        ...
        return constructor.new(_1725.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1487.BearingCageMaterial':
        ...
        return constructor.new(_1487.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1487.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1739.SleeveType':
        ...
        return constructor.new(_1739.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1119.FileHistory':
        ...
        return constructor.new(_1119.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1722.BearingProtection':
        ...
        return constructor.new(_1722.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_53.BearingMaterial':
        ...
        return constructor.new(_53.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_53.BearingMaterial':
        ...
        return constructor.new(_53.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_53.BearingMaterial':
        ...
        return constructor.new(_53.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
