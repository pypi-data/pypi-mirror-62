...
from mastapy.bearings.bearing_designs.rolling import _1680
...
class ThrustBallBearing(_1680.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1485.OuterRingMounting':
        ...
        return constructor.new(_1485.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1485.OuterRingMounting'):
