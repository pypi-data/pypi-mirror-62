...
class RollingBearing(_1671.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def type_information(self) -> '_1686.BearingTypeExtraInformation':
        ...
        return constructor.new(_1686.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def sleeve_type(self) -> '_1699.SleeveType':
        ...
        return constructor.new(_1699.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1683.BearingProtection':
        ...
        return constructor.new(_1683.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_238.BearingMaterial':
        ...
        return constructor.new(_238.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_238.BearingMaterial':
        ...
        return constructor.new(_238.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_238.BearingMaterial':
        ...
        return constructor.new(_238.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
