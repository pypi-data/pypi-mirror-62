...
from mastapy.bearings.bearing_designs.rolling import _1698, _1668
...
class BallBearing(_1668.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1698.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1698.BallBearingShoulderDefinition))
        return value
