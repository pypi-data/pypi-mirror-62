...
from mastapy.bearings import _1463
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings.bearing_designs.rolling import _1686, _1683
...
class TaperRollerBearing(_1683.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1463.BearingMeasurementType':
        ...
        return constructor.new(_1463.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1463.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1686.RollerRibDetail':
        ...
        return constructor.new(_1686.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
