...
from mastapy.bearings.bearing_designs.rolling import _1670, _1687
...
class BallBearing(_1687.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1670.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1670.BallBearingShoulderDefinition))
        return value
