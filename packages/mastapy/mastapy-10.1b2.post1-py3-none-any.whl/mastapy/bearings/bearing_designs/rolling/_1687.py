...
from mastapy.bearings import (
    _1479, _1481, _1457, _1469,
    _1484, _1459
)
from mastapy.bearings.bearing_designs.rolling import (
    _1696, _1680, _1678, _1675,
    _1689, _1672
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1240
from mastapy.materials import _195
from mastapy.bearings.bearing_designs import _1660
...
class RollingBearing(_1660.DetailedBearing):
    '''RollingBearing
    ...
    def arrangement(self) -> 'enum_with_selected_value.EnumWithSelectedValue_RollingBearingArrangement':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_RollingBearingArrangement.implicit_type()
    ...
    def arrangement(self, value: 'enum_with_selected_value.EnumWithSelectedValue_RollingBearingArrangement.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_RollingBearingArrangement.implicit_type().type_()
    ...
    def inner_race_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
    ...
    def inner_race_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def catalogue(self) -> '_1457.BearingCatalog':
        ...
        return constructor.new(_1457.BearingCatalog)(value) if value else None
    ...
    @property
    def static_capacity_factor(self) -> 'float':
        '''float: 'StaticCapacityFactor' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.StaticCapacityFactor
    ...
    def dynamic_capacity_calculation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DynamicCapacityCalculationMethod':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_DynamicCapacityCalculationMethod.implicit_type()
        return enum_with_selected_value_runtime.create(self.wrapped.DynamicCapacityCalculation, value) if self.wrapped.DynamicCapacityCalculation else None
    ...
    def dynamic_capacity_calculation(self, value: 'enum_with_selected_value.EnumWithSelectedValue_DynamicCapacityCalculationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_DynamicCapacityCalculationMethod.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
        self.wrapped.DynamicCapacityCalculation = value

    @property
    def static_capacity_calculation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod':
        '''enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod: 'StaticCapacityCalculation' is the original name of this property.'''

        value = enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.implicit_type()
        return enum_with_selected_value_runtime.create(self.wrapped.StaticCapacityCalculation, value) if self.wrapped.StaticCapacityCalculation else None

    @static_capacity_calculation.setter
    def static_capacity_calculation(self, value: 'enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_StaticCapacityCalculationMethod.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def type_information(self) -> '_1675.BearingTypeExtraInformation':
        ...
        return constructor.new(_1675.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1459.BearingCageMaterial':
        ...
        return constructor.new(_1459.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1459.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1689.SleeveType':
        ...
        return constructor.new(_1689.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1240.FileHistory':
        ...
        return constructor.new(_1240.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1672.BearingProtection':
        ...
        return constructor.new(_1672.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_195.BearingMaterial':
        ...
        return constructor.new(_195.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_195.BearingMaterial':
        ...
        return constructor.new(_195.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_195.BearingMaterial':
        ...
        return constructor.new(_195.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
