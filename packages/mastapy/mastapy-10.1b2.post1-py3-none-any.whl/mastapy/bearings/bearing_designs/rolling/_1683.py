...
from mastapy.bearings.bearing_designs.rolling import _1685, _1686, _1684
...
class NonBarrelRollerBearing(_1684.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1685.RollerEndShape':
        ...
        return constructor.new(_1685.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1685.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1686.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1686.RollerRibDetail))
        return value
