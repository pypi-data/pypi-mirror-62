...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1701, _1700
...
class XmlBearingTypeMapping(_1.APIBase):
    ...
    @property
    def files(self) -> 'List[_1701.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1701.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1700.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1700.AbstractXmlVariableAssignment))
        return value
