...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1700
...
class RollingBearingImporter(_1.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1700.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1700.XmlBearingTypeMapping))
        return value
