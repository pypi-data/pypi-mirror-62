...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1712, _1711
...
class XmlBearingTypeMapping(_1.APIBase):
    ...
    @property
    def files(self) -> 'List[_1712.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1712.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1711.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1711.AbstractXmlVariableAssignment))
        return value
