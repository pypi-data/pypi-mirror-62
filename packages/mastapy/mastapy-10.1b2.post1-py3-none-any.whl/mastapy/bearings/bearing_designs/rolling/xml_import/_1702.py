...
class RollingBearingImporter(_1.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1703.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1703.XmlBearingTypeMapping))
        return value
