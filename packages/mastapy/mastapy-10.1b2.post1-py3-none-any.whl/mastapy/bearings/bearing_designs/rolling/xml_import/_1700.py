...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1698, _1697
...
class XmlBearingTypeMapping(_1.APIBase):
    ...
    @property
    def files(self) -> 'List[_1698.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1698.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1697.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1697.AbstractXmlVariableAssignment))
        return value
