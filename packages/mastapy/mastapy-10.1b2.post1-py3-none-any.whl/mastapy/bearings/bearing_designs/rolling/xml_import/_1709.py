...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1710
...
class RollingBearingImporter(_1.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1710.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1710.XmlBearingTypeMapping))
        return value
