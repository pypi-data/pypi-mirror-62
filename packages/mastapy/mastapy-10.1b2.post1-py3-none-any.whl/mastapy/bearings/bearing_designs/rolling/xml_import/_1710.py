...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1708, _1707
...
class XmlBearingTypeMapping(_1.APIBase):
    ...
    @property
    def files(self) -> 'List[_1708.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1708.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1707.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1707.AbstractXmlVariableAssignment))
        return value
