...
from mastapy.bearings import _1495
...
class LinearBearing(_1709.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1495.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1495.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1495.BearingStiffnessMatrixOption'):
