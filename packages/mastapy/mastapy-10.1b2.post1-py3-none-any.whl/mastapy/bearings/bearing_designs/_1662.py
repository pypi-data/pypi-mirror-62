...
from mastapy.bearings import _1468
...
class LinearBearing(_1659.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1468.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1468.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1468.BearingStiffnessMatrixOption'):
