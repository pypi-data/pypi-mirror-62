...
from mastapy.bearings.bearing_designs import _1588
...
class LinearBearing(_1588.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1477.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1477.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1477.BearingStiffnessMatrixOption'):
