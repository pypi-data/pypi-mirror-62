...
from mastapy.bearings import _1471
from mastapy.bearings.bearing_designs import _1645
...
class LinearBearing(_1645.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1471.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1471.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1471.BearingStiffnessMatrixOption'):
