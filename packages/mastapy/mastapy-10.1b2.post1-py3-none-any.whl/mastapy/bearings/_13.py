...
class BearingSettings(_68.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life(self) -> '_1486.RatingLife':
        ...
        return constructor.new(_1486.RatingLife)(value) if value else None

    @failure_probability_for_rating_life.setter
    def failure_probability_for_rating_life(self, value: '_1486.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1479.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1479.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1479.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
