...
from mastapy.bearings.bearing_results.fluid_film import _1693
...
class LoadedPlainJournalBearingResults(_1534.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1693.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1693.LoadedPlainJournalBearingRow))
        return value
