...
class LoadedPlainJournalBearingRow(_1.APIBase):
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_739.SMTBitmap':
        ...
        return constructor.new(_739.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
