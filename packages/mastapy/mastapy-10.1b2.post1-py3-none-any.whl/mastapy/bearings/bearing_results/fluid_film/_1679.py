...
from mastapy.bearings.bearing_results.fluid_film import _1680
...
class LoadedPlainJournalBearingResults(_1528.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1680.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1680.LoadedPlainJournalBearingRow))
        return value
