...
class LoadedPlainJournalBearingRow(_1.APIBase):
    ...
    def row(self) -> '_1466.BearingRow':
        ...
        return constructor.new(_1466.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6321.SMTBitmap':
        ...
        return constructor.new(_6321.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
