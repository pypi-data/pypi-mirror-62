...
from mastapy.bearings.bearing_results.fluid_film import _1652
...
class LoadedPlainJournalBearingResults(_1529.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1652.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1652.LoadedPlainJournalBearingRow))
        return value
