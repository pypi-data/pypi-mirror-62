...
from mastapy.bearings.bearing_results.fluid_film import _1663
from mastapy.bearings.bearing_results import _1539
...
class LoadedPlainJournalBearingResults(_1539.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1663.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1663.LoadedPlainJournalBearingRow))
        return value
