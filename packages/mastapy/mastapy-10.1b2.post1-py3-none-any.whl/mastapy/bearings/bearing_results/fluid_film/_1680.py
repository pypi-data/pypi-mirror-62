...
class LoadedPlainJournalBearingRow(_1.APIBase):
    ...
    def row(self) -> '_1470.BearingRow':
        ...
        return constructor.new(_1470.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_718.SMTBitmap':
        ...
        return constructor.new(_718.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
