...
class LoadedPlainJournalBearingRow(_1.APIBase):
    ...
    def row(self) -> '_1476.BearingRow':
        ...
        return constructor.new(_1476.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_738.SMTBitmap':
        ...
        return constructor.new(_738.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
