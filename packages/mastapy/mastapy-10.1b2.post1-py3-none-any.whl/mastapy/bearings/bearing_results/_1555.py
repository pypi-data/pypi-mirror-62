...
from mastapy.bearings.bearing_results import _1558
...
class LoadedDetailedBearingResults(_1558.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_75.LubricationDetail':
        ...
        return constructor.new(_75.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
