...
class LoadedDetailedBearingResults(_1532.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_217.LubricationDetail':
        ...
        return constructor.new(_217.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
