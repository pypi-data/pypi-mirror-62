...
from mastapy.bearings.bearing_results import _1565
...
class BearingStiffnessMatrixReporter(_1.APIBase):
    ...
    @property
    def rows(self) -> 'List[_1565.StiffnessRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1565.StiffnessRow))
        return value
