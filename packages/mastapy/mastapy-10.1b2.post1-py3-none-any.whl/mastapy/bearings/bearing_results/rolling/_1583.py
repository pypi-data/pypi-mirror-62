...
from mastapy.bearings.bearing_results.rolling import _1582, _1620
...
class LoadedAsymmetricSphericalRollerBearingRow(_1620.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1582.LoadedAsymmetricSphericalRollerBearingResults':
