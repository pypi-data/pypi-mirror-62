...
from mastapy.bearings.bearing_results.rolling import (
    _1595, _1576, _1579, _1602,
    _1607, _1626, _1642, _1645,
    _1594, _1624
)
...
class LoadedBallBearingRow(_1624.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1595.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1594.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1594.LoadedBallBearingRaceResults))
        return value
