...
from mastapy.bearings.bearing_results.rolling.skf_module import _1682, _1684
...
class Viscosities(_1684.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1682.OperatingViscosity':
        ...
        return constructor.new(_1682.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
