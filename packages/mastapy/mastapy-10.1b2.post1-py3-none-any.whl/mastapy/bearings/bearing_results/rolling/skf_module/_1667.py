...
from mastapy.bearings.bearing_results.rolling.skf_module import _1668, _1684
...
class AdjustedSpeed(_1684.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1668.AdjustmentFactors':
        ...
        return constructor.new(_1668.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
