...
from mastapy.bearings.bearing_results.rolling import _1642, _1596
...
class LoadedThreePointContactBallBearingRow(_1596.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1642.LoadedThreePointContactBallBearingResults':
