...
from mastapy.bearings.bearing_results.rolling import _1550
...
class LoadedAngularContactThrustBallBearingResults(_1550.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
