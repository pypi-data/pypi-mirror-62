...
from mastapy.bearings.bearing_results.rolling import _1561
...
class LoadedAxialThrustNeedleRollerBearingResults(_1561.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
