...
from mastapy.bearings.bearing_results.rolling import _1575
...
class LoadedAngularContactThrustBallBearingElement(_1575.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
