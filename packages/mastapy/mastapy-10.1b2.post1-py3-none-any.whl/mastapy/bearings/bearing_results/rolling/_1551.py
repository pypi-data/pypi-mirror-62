...
from mastapy.bearings.bearing_results.rolling import _1550, _1570
...
class LoadedAngularContactBallBearingRow(_1570.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1550.LoadedAngularContactBallBearingResults':
        ...
        return constructor.new(_1550.LoadedAngularContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
