...
from mastapy.bearings.bearing_results.rolling import _1588
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1588.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
