...
from mastapy.bearings.bearing_results.rolling import _1556, _1594
...
class LoadedAsymmetricSphericalRollerBearingRow(_1594.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1556.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1556.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
