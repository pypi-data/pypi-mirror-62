...
from mastapy.bearings.bearing_results.rolling import _1564, _1562
...
class LoadedAxialThrustNeedleRollerBearingRow(_1562.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1564.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1564.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
