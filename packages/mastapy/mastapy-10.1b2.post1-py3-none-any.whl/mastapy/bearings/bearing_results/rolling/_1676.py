...
from mastapy.bearings.bearing_results import _1526
from mastapy.bearings.bearing_results.rolling import _1551
from mastapy.utility import _351
...
class RollingBearingFrictionCoefficients(_351.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1526.EquivalentLoadFactors':
        ...
        return constructor.new(_1526.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1526.EquivalentLoadFactors':
        ...
        return constructor.new(_1526.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors else None

    @property
    def iso14179_settings(self) -> '_1551.ISO14179Settings':
        ...
        return constructor.new(_1551.ISO14179Settings)(self.wrapped.ISO14179Settings) if self.wrapped.ISO14179Settings else None
