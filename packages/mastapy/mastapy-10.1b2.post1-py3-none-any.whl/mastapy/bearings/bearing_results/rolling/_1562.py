...
from mastapy.bearings.bearing_results.rolling import _1561, _1589
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1589.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1561.LoadedAxialThrustCylindricalRollerBearingResults':
        ...
        return constructor.new(_1561.LoadedAxialThrustCylindricalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
