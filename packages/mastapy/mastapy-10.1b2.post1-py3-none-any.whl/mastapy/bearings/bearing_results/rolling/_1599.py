...
from mastapy.bearings.bearing_results.rolling import _1663, _1614
...
class LoadedCylindricalRollerBearingResults(_1614.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1663.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1663.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
