...
from mastapy.bearings.bearing_results.rolling import _1579, _1577
...
class LoadedAngularContactThrustBallBearingRow(_1577.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1579.LoadedAngularContactThrustBallBearingResults':
