...
from mastapy.bearings.bearing_results.rolling import _1659, _1604
...
class LoadedRollerBearingElement(_1604.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1659.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1659.ResultsAtRollerOffset))
        return value
