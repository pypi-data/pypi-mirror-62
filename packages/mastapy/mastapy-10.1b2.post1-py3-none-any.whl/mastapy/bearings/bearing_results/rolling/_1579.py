...
from mastapy.bearings.bearing_results.rolling import _1576
...
class LoadedAngularContactThrustBallBearingResults(_1576.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
