...
from mastapy.bearings.bearing_results.rolling import _1553, _1551
...
class LoadedAngularContactThrustBallBearingRow(_1551.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1553.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1553.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
