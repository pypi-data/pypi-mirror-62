...
class ISO14179SettingsPerBearingType(_1243.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1482.RollingBearingType':
        ...
        return constructor.new(_1482.RollingBearingType)(value) if value else None
    ...
    @property
    def iso14179_settings(self) -> '_1545.ISO14179Settings':
        ...
        return constructor.new(_1545.ISO14179Settings)(self.wrapped.ISO14179Settings) if self.wrapped.ISO14179Settings else None
