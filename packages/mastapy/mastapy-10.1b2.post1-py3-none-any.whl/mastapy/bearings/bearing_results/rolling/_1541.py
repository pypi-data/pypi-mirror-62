...
class BallBearingRaceContactGeometry(_1.APIBase):
    ...
    @property
    def race_centre(self) -> '_1169.Vector2D[_1312.LengthShort]':
        ...
        return constructor.new(_1169.Vector2D)[_1312.LengthShort](self.wrapped.RaceCentre) if self.wrapped.RaceCentre else None

    @property
    def ball_centre(self) -> '_1169.Vector2D[_1312.LengthShort]':
        ...
        return constructor.new(_1169.Vector2D)[_1312.LengthShort](self.wrapped.BallCentre) if self.wrapped.BallCentre else None
