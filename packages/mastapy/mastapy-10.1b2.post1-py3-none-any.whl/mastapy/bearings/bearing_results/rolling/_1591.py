...
from mastapy.bearings.bearing_results.rolling import _1590, _1588
...
class LoadedAxialThrustNeedleRollerBearingRow(_1588.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1590.LoadedAxialThrustNeedleRollerBearingResults':
