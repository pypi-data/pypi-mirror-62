...
from mastapy.bearings.tolerances import _1488, _1486
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings import _1475
...
class InterferenceTolerance(_1486.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1488.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1488.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1475.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1475.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1475.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
