...
from mastapy.bearings.tolerances import _1526, _1523
...
class RoundnessSpecification(_1122.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1526.RoundnessSpecificationType':
        ...
        return constructor.new(_1526.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1526.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def roundness_distribution(self) -> 'List[_1523.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1523.RaceRoundnessAtAngle))
        return value
