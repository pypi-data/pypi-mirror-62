...
from mastapy.bearings import _1457, _1482, _1472
from mastapy.math_utility import _1168
...
class RollingBearingDatabase(_1.APIBase):
    ...
    def get_all_items(self) -> 'Iterable[_1687.RollingBearing]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1687.RollingBearing))

    def save_changes(self, rolling_bearing: '_1687.RollingBearing'):
    ...
    def add_to_database(self, bearing: '_1687.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1687.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1457.BearingCatalog', type_: '_1482.RollingBearingType', bore_range: '_1168.Range', outer_diameter_range: '_1168.Range', width_range: '_1168.Range', dynamic_capacity_range: '_1168.Range', number_of_rows: 'int', material_type: '_1472.HybridSteelAll') -> 'List[_1687.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1457.BearingCatalog', type_: '_1482.RollingBearingType') -> 'List[_1687.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1687.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1457.BearingCatalog') -> '_1687.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        return constructor.new(_1687.RollingBearing)(method_result) if method_result else None

    def search_for_rolling_bearing_with_catalog(self, catalog: '_1457.BearingCatalog') -> 'List[_1687.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1687.RollingBearing))

    def create_bearing(self, type_: '_1482.RollingBearingType', designation: Optional['str'] = 'None') -> '_1687.RollingBearing':
