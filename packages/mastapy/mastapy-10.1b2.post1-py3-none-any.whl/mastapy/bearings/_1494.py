...
from mastapy.bearings import (
    _1504, _1503, _1496, _1497
)
from mastapy._internal import conversion, enum_with_selected_value_runtime, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1685
...
class BearingSettings(_1127.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life(self) -> '_1503.RatingLife':
        ...
        return constructor.new(_1503.RatingLife)(value) if value else None

    @failure_probability_for_rating_life.setter
    def failure_probability_for_rating_life(self, value: '_1503.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1496.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1496.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1496.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(self) -> 'enum_with_selected_value.EnumWithSelectedValue_FluidFilmTemperatureOptions':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_FluidFilmTemperatureOptions.implicit_type()
    ...
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(self, value: 'enum_with_selected_value.EnumWithSelectedValue_FluidFilmTemperatureOptions.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_FluidFilmTemperatureOptions.implicit_type().type_()
        value = conversion.mp_to_pn_enum(value)
        value = wrapper_type[enclosed_type](value if value else None)
    ...
    @property
    def skf_credentials(self) -> '_1685.SKFCredentials':
        ...
        return constructor.new(_1685.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
