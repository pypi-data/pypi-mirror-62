...
class SimpleShaftDefinition(_87.NamedDatabaseItem):
    '''SimpleShaftDefinition
    ...
    @property
    def radial_holes(self) -> 'List[_60.ShaftRadialHole]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RadialHoles, constructor.new(_60.ShaftRadialHole))
        return value

    @property
    def grooves(self) -> 'List[_46.ShaftGroove]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Grooves, constructor.new(_46.ShaftGroove))
        return value
