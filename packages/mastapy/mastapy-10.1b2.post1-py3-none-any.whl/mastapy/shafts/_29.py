...
class ShaftPointStressCycleReporting(_1.APIBase):
    ...
    def nominal_stress(self) -> '_28.ShaftPointStressCycle':
        ...
        return constructor.new(_28.ShaftPointStressCycle)(self.wrapped.NominalStress) if self.wrapped.NominalStress else None
    ...
    def stress(self) -> '_28.ShaftPointStressCycle':
        ...
        return constructor.new(_28.ShaftPointStressCycle)(self.wrapped.Stress) if self.wrapped.Stress else None
