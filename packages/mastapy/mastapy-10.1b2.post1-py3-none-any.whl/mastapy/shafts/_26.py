...
class ShaftMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_25.ShaftMaterial':
        ...
        return constructor.new(_25.ShaftMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_25.ShaftMaterial':
        ...
        return constructor.new(_25.ShaftMaterial)(method_result) if method_result else None

    def can_be_removed(self, shaft_material: '_25.ShaftMaterial') -> 'bool':
    ...
    def rename(self, shaft_material: '_25.ShaftMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, shaft_material: '_25.ShaftMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_25.ShaftMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_25.ShaftMaterial))

    def save_changes(self, shaft_material: '_25.ShaftMaterial'):
