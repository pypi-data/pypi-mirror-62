...
class ShaftMaterial(_77.Material):
    '''ShaftMaterial
    ...
    @property
    def curve_model(self) -> '_13.FkmSnCurveModel':
        '''FkmSnCurveModel: 'CurveModel' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CurveModel)
        return constructor.new(_13.FkmSnCurveModel)(value) if value else None

    @curve_model.setter
    def curve_model(self, value: '_13.FkmSnCurveModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def material_group(self) -> '_12.FkmMaterialGroup':
        ...
        return constructor.new(_12.FkmMaterialGroup)(value) if value else None

    @material_group.setter
    def material_group(self, value: '_12.FkmMaterialGroup'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def consequence_of_failure(self) -> '_9.ConsequenceOfFailure':
        ...
        return constructor.new(_9.ConsequenceOfFailure)(value) if value else None

    @consequence_of_failure.setter
    def consequence_of_failure(self, value: '_9.ConsequenceOfFailure'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def casting_factor_condition(self) -> '_8.CastingFactorCondition':
        ...
        return constructor.new(_8.CastingFactorCondition)(value) if value else None

    @casting_factor_condition.setter
    def casting_factor_condition(self, value: '_8.CastingFactorCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
