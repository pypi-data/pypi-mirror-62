...
class ShaftSectionDamageResults(_1.APIBase):
    ...
    @property
    def left_end(self) -> '_61.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_61.ShaftSectionEndDamageResults)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_61.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_61.ShaftSectionEndDamageResults)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
