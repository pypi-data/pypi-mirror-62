...
from mastapy.shafts import _34, _14
...
class ShaftSettings(_1127.PerMachineSettings):
    '''ShaftSettings
    ...
    def shaft_rating_method_selector(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ShaftRatingMethod':
        ...
        value = enum_with_selected_value.EnumWithSelectedValue_ShaftRatingMethod.implicit_type()
    ...
    def shaft_rating_method_selector(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ShaftRatingMethod.implicit_type()'):
        ...
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_ShaftRatingMethod.implicit_type().type_()
    ...
    def shaft_rating_method(self) -> '_34.ShaftRatingMethod':
        ...
        return constructor.new(_34.ShaftRatingMethod)(value) if value else None
    ...
    @property
    def version_of_miners_rule(self) -> '_14.FkmVersionOfMinersRule':
        ...
        return constructor.new(_14.FkmVersionOfMinersRule)(value) if value else None

    @version_of_miners_rule.setter
    def version_of_miners_rule(self, value: '_14.FkmVersionOfMinersRule'):
