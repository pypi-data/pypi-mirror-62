...
from mastapy.shafts import _55
...
class ShaftProfile(_1.APIBase):
    ...
    @property
    def points(self) -> 'List[_55.ShaftProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Points, constructor.new(_55.ShaftProfilePoint))
        return value
