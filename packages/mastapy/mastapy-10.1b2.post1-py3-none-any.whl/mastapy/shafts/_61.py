...
class ShaftSectionEndDamageResults(_1.APIBase):
    ...
    def sn_curve(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurve) if self.wrapped.SNCurve else None

    @property
    def din743201212_alternate_strength(self) -> '_71.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_71.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212AlternateStrength) if self.wrapped.DIN743201212AlternateStrength else None

    @property
    def din743201212_yielding_strength(self) -> '_71.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_71.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212YieldingStrength) if self.wrapped.DIN743201212YieldingStrength else None
    ...
    @property
    def sn_curve_axial(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveAxial) if self.wrapped.SNCurveAxial else None

    @property
    def sn_curve_bending_x(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveBendingX) if self.wrapped.SNCurveBendingX else None

    @property
    def sn_curve_bending_y(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveBendingY) if self.wrapped.SNCurveBendingY else None

    @property
    def sn_curve_torsional(self) -> '_80.SNCurve':
        ...
        return constructor.new(_80.SNCurve)(self.wrapped.SNCurveTorsional) if self.wrapped.SNCurveTorsional else None

    @property
    def stress_cycles(self) -> 'List[_53.ShaftPointStressCycleReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StressCycles, constructor.new(_53.ShaftPointStressCycleReporting))
        return value

    @property
    def din743201212_yielding_amplitude(self) -> 'List[_71.StressMeasurementShaftAxialBendingTorsionalComponentValues]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DIN743201212YieldingAmplitude, constructor.new(_71.StressMeasurementShaftAxialBendingTorsionalComponentValues))
        return value
