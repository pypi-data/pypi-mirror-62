...
from mastapy.shafts import _52
...
class ShaftPointStressCycleReporting(_1.APIBase):
    ...
    @property
    def nominal_stress(self) -> '_52.ShaftPointStressCycle':
        ...
        return constructor.new(_52.ShaftPointStressCycle)(self.wrapped.NominalStress) if self.wrapped.NominalStress else None

    @property
    def stress(self) -> '_52.ShaftPointStressCycle':
        ...
        return constructor.new(_52.ShaftPointStressCycle)(self.wrapped.Stress) if self.wrapped.Stress else None
