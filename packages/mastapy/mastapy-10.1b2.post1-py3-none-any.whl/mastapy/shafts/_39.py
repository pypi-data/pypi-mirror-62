...
from mastapy.shafts import _40, _22
...
class ShaftSurfaceFinishSection(_22.ShaftFeature):
    '''ShaftSurfaceFinishSection
    ...
    @property
    def surface_roughness(self) -> '_40.ShaftSurfaceRoughness':
        ...
        return constructor.new(_40.ShaftSurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None
