...
class ShaftProfilePoint(_1.APIBase):
    ...
    @property
    def stress_concentration_factors(self) -> '_16.ProfilePointFilletStressConcentrationFactors':
        ...
        return constructor.new(_16.ProfilePointFilletStressConcentrationFactors)(self.wrapped.StressConcentrationFactors) if self.wrapped.StressConcentrationFactors else None
