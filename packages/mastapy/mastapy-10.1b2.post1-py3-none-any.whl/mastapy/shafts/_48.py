...
from mastapy.shafts import _69, _45
...
class ShaftKey(_45.ShaftFeature):
    '''ShaftKey
    ...
    @property
    def surface_finish(self) -> '_69.SurfaceFinishes':
        ...
        return constructor.new(_69.SurfaceFinishes)(value) if value else None

    @surface_finish.setter
    def surface_finish(self, value: '_69.SurfaceFinishes'):
