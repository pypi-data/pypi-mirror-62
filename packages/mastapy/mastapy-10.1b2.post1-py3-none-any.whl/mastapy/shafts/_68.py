...
from mastapy.utility.databases import _79
...
class SimpleShaftDefinition(_79.NamedDatabaseItem):
    '''SimpleShaftDefinition
    ...
    @property
    def shaft_material(self) -> '_47.ShaftMaterial':
        ...
        return constructor.new(_47.ShaftMaterial)(self.wrapped.ShaftMaterial) if self.wrapped.ShaftMaterial else None
    ...
    @property
    def grooves(self) -> 'List[_45.ShaftGroove]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Grooves, constructor.new(_45.ShaftGroove))
        return value

    @property
    def surface_finish_sections(self) -> 'List[_65.ShaftSurfaceFinishSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SurfaceFinishSections, constructor.new(_65.ShaftSurfaceFinishSection))
        return value
