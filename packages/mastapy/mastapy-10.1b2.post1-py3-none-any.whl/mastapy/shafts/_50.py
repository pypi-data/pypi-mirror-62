...
from mastapy.shafts import _49
...
class ShaftMaterialDatabase(_1.APIBase):
    ...
    @property
    def item(self) -> '_49.ShaftMaterial':
        ...
        return constructor.new(_49.ShaftMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_49.ShaftMaterial':
        ...
        return constructor.new(_49.ShaftMaterial)(method_result) if method_result else None

    def can_be_removed(self, shaft_material: '_49.ShaftMaterial') -> 'bool':
    ...
    def rename(self, shaft_material: '_49.ShaftMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, shaft_material: '_49.ShaftMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_49.ShaftMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_49.ShaftMaterial))

    def save_changes(self, shaft_material: '_49.ShaftMaterial'):
