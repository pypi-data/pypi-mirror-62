...
class SimpleShaftDefinition(_94.NamedDatabaseItem):
    '''SimpleShaftDefinition
    ...
    @property
    def shaft_material(self) -> '_49.ShaftMaterial':
        ...
        return constructor.new(_49.ShaftMaterial)(self.wrapped.ShaftMaterial) if self.wrapped.ShaftMaterial else None

    @property
    def default_surface_roughness(self) -> '_63.ShaftSurfaceRoughness':
        ...
        return constructor.new(_63.ShaftSurfaceRoughness)(self.wrapped.DefaultSurfaceRoughness) if self.wrapped.DefaultSurfaceRoughness else None

    @property
    def outer_profile(self) -> '_54.ShaftProfile':
        ...
        return constructor.new(_54.ShaftProfile)(self.wrapped.OuterProfile) if self.wrapped.OuterProfile else None

    @property
    def inner_profile(self) -> '_54.ShaftProfile':
        ...
        return constructor.new(_54.ShaftProfile)(self.wrapped.InnerProfile) if self.wrapped.InnerProfile else None
    ...
    @property
    def radial_holes(self) -> 'List[_57.ShaftRadialHole]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RadialHoles, constructor.new(_57.ShaftRadialHole))
        return value

    @property
    def grooves(self) -> 'List[_47.ShaftGroove]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Grooves, constructor.new(_47.ShaftGroove))
        return value

    @property
    def surface_finish_sections(self) -> 'List[_64.ShaftSurfaceFinishSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SurfaceFinishSections, constructor.new(_64.ShaftSurfaceFinishSection))
        return value
