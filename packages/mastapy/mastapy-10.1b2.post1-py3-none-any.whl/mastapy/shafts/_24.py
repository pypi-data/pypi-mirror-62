...
from mastapy.shafts import _43, _22
...
class ShaftKey(_22.ShaftFeature):
    '''ShaftKey
    ...
    @property
    def surface_finish(self) -> '_43.SurfaceFinishes':
        ...
        return constructor.new(_43.SurfaceFinishes)(value) if value else None

    @surface_finish.setter
    def surface_finish(self, value: '_43.SurfaceFinishes'):
