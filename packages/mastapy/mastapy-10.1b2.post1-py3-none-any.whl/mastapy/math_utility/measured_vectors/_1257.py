...
from mastapy.utility.units_and_measurements import _1054
...
TLinearMeasurement = TypeVar('TLinearMeasurement', bound='_1054.MeasurementBase')
TAngularMeasurement = TypeVar('TAngularMeasurement', bound='_1054.MeasurementBase')
