...
from mastapy.utility.units_and_measurements.measurements import _1303, _1370
...
class AbstractForceAndDisplacementResults(_1.APIBase):
    ...
    @property
    def force(self) -> '_1254.VectorWithLinearAndAngularComponents[_1303.Force, _1370.Torque]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1303.Force, _1370.Torque](self.wrapped.Force) if self.wrapped.Force else None
