...
class AbstractForceAndDisplacementResults(_1.APIBase):
    ...
    @property
    def force(self) -> '_1227.VectorWithLinearAndAngularComponents[_1289.Force, _1358.Torque]':
        ...
        return constructor.new(_1227.VectorWithLinearAndAngularComponents)[_1289.Force, _1358.Torque](self.wrapped.Force) if self.wrapped.Force else None
