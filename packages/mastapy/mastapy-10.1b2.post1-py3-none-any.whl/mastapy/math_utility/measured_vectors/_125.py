...
from mastapy.utility.units_and_measurements.measurements import _1336, _1291
...
class ForceAndDisplacementResults(_1248.AbstractForceAndDisplacementResults):
    ...
    @property
    def displacement(self) -> '_1254.VectorWithLinearAndAngularComponents[_1336.LengthVeryShort, _1291.AngleSmall]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1336.LengthVeryShort, _1291.AngleSmall](self.wrapped.Displacement) if self.wrapped.Displacement else None
