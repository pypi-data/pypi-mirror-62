...
from mastapy.utility.units_and_measurements.measurements import _1327, _1283
...
class ForceAndDisplacementResults(_1248.AbstractForceAndDisplacementResults):
    ...
    @property
    def displacement(self) -> '_1254.VectorWithLinearAndAngularComponents[_1327.LengthVeryShort, _1283.AngleSmall]':
        ...
        return constructor.new(_1254.VectorWithLinearAndAngularComponents)[_1327.LengthVeryShort, _1283.AngleSmall](self.wrapped.Displacement) if self.wrapped.Displacement else None
