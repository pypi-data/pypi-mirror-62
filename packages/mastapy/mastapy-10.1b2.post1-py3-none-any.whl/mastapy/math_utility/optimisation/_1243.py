...
from mastapy.math_utility.optimisation import _1244, _1242
...
class ParetoOptimistaionVariable(_1242.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1244.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1244.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1244.PropertyTargetForDominantCandidateSearch'):
