...
from mastapy.math_utility.optimisation import _1044
...
class ParetoOptimisationStrategyChartInformation(_1.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1044.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1044.ParetoOptimisationStrategyBars))
        return value
