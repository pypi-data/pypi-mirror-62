...
from mastapy.math_utility.optimisation import _1240
...
class InputSetter(_1.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1240.ParetoOptimisationInput':
        ...
        return constructor.new(_1240.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
