...
from mastapy.math_utility.optimisation import _1247, _1246
...
class ParetoOptimisationVariableBase(_1.APIBase):
    ...
    @property
    def specification_type(self) -> '_1247.TargetingPropertyTo':
        ...
        return constructor.new(_1247.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1247.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1246.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1246.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1246.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
