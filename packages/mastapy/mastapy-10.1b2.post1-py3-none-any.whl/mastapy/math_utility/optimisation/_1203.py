...
from mastapy.math_utility.optimisation import _1209
...
class InputSetter(_1.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1209.ParetoOptimisationInput':
        ...
        return constructor.new(_1209.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
