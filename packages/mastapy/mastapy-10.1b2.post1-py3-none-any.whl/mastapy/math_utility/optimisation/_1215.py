...
from mastapy.math_utility.optimisation import _1216, _1214
...
class ParetoOptimistaionVariable(_1214.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1216.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1216.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1216.PropertyTargetForDominantCandidateSearch'):
