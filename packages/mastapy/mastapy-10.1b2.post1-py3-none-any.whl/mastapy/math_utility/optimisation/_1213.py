...
from mastapy.math_utility.optimisation import _1212
...
class ParetoOptimisationStrategyChartInformation(_1.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1212.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1212.ParetoOptimisationStrategyBars))
        return value
