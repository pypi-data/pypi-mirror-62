...
from mastapy.math_utility.optimisation import _1095, _1093
...
class ParetoOptimistaionVariable(_1093.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1095.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1095.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1095.PropertyTargetForDominantCandidateSearch'):
