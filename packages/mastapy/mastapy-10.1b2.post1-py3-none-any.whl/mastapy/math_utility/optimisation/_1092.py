...
class ParetoOptimisationStrategyChartInformation(_1.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1091.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1091.ParetoOptimisationStrategyBars))
        return value
