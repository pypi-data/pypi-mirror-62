...
from mastapy.math_utility.optimisation import _1003
...
class ParetoOptimisationStrategyChartInformation(_1.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1003.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1003.ParetoOptimisationStrategyBars))
        return value
