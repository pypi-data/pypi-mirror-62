...
from mastapy.math_utility.optimisation import _1240, _1241, _1073
...
class ParetoOptimisationStrategy(_89.NamedDatabaseItem):
    ...
    @property
    def charts(self) -> 'List[_1073.ParetoOptimisationStrategyChartInformation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Charts, constructor.new(_1073.ParetoOptimisationStrategyChartInformation))
        return value
