...
from mastapy.math_utility.optimisation import _1240, _1241, _1080
...
class ParetoOptimisationStrategy(_94.NamedDatabaseItem):
    '''ParetoOptimisationStrategy
    ...
    @property
    def charts(self) -> 'List[_1080.ParetoOptimisationStrategyChartInformation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Charts, constructor.new(_1080.ParetoOptimisationStrategyChartInformation))
        return value
