...
from mastapy.math_utility import _1187
...
class MassProperties(_1.APIBase):
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_1187.InertiaTensor':
        ...
        return constructor.new(_1187.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_1187.InertiaTensor':
        ...
        return constructor.new(_1187.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass else None
