...
class GriddedSurface(_1.APIBase):
    ...
    def data_value_interpolated_at(self, row_value: 'float', column_value: 'float', row_extrapolation_option: '_1183.ExtrapolationOptions', column_extrapolation_option: '_1183.ExtrapolationOptions') -> 'float':
