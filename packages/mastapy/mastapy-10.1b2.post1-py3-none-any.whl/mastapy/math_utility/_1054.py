...
class CoordinateSystemEditor(_1.APIBase):
    ...
    @property
    def coordinate_system_for_rotation_origin(self) -> '_1056.CoordinateSystemForRotationOrigin':
        ...
        return constructor.new(_1056.CoordinateSystemForRotationOrigin)(value) if value else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1056.CoordinateSystemForRotationOrigin'):
    ...
    @property
    def rotation_axis(self) -> '_1073.RotationAxis':
        '''RotationAxis: 'RotationAxis' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RotationAxis)
        return constructor.new(_1073.RotationAxis)(value) if value else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1073.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RotationAxis = value

    @property
    def coordinate_system_for_rotation_axes(self) -> '_1055.CoordinateSystemForRotation':
        ...
        return constructor.new(_1055.CoordinateSystemForRotation)(value) if value else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1055.CoordinateSystemForRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def containing_assembly_image(self) -> '_6482.SMTBitmap':
        '''SMTBitmap: 'ContainingAssemblyImage' is the original name of this property.'''

        return constructor.new(_6482.SMTBitmap)(self.wrapped.ContainingAssemblyImage) if self.wrapped.ContainingAssemblyImage else None

    @containing_assembly_image.setter
    def containing_assembly_image(self, value: '_6482.SMTBitmap'):
    ...
    @property
    def root_assembly_image(self) -> '_6482.SMTBitmap':
        '''SMTBitmap: 'RootAssemblyImage' is the original name of this property.'''

        return constructor.new(_6482.SMTBitmap)(self.wrapped.RootAssemblyImage) if self.wrapped.RootAssemblyImage else None

    @root_assembly_image.setter
    def root_assembly_image(self, value: '_6482.SMTBitmap'):
        value = value.wrapped if value else None
    ...
    @property
    def modified_coordinate_system_for_rotation(self) -> '_1053.CoordinateSystem3D':
        ...
        return constructor.new(_1053.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForRotation) if self.wrapped.ModifiedCoordinateSystemForRotation else None

    @property
    def modified_coordinate_system_for_translation(self) -> '_1053.CoordinateSystem3D':
        ...
        return constructor.new(_1053.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForTranslation) if self.wrapped.ModifiedCoordinateSystemForTranslation else None
