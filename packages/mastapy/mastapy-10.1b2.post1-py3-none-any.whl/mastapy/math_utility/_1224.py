...
from mastapy.math_utility import _215
...
class MassProperties(_1.APIBase):
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_215.InertiaTensor':
        ...
        return constructor.new(_215.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_215.InertiaTensor':
        ...
        return constructor.new(_215.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass else None
