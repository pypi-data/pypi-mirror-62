...
from mastapy.math_utility import _1179, _1197
...
class CoordinateSystem3D(_1.APIBase):
    ...
    def axis(self, degree_of_freedom: '_1179.DegreesOfFreedom') -> 'Vector3D':
    ...
    def transform_to_world_from_this(self) -> '_1197.TransformMatrix3D':
        ...
        return constructor.new(_1197.TransformMatrix3D)(method_result) if method_result else None

    def transform_from_world_to_this(self) -> '_1197.TransformMatrix3D':
    ...
    def transformed_by(self, transform: '_1197.TransformMatrix3D') -> 'CoordinateSystem3D':
