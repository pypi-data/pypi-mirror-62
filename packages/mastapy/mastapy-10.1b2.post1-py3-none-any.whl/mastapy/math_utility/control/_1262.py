...
from mastapy.math_utility import _1229
...
class PIDControlSettings(_1.APIBase):
    ...
    @property
    def update_method(self) -> '_1229.PIDControlUpdateMethod':
        ...
        return constructor.new(_1229.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1229.PIDControlUpdateMethod'):
