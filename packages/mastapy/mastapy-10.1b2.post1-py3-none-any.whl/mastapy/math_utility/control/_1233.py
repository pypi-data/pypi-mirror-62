...
from mastapy.math_utility import _1192
...
class PIDControlSettings(_1.APIBase):
    ...
    @property
    def update_method(self) -> '_1192.PIDControlUpdateMethod':
        ...
        return constructor.new(_1192.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1192.PIDControlUpdateMethod'):
