...
[boto3.Route53Resolver 1.12.14](https://boto3.amazonaws.com/v1/documentation/api/1.12.14/reference/services/route53resolver.html#Route53Resolver) service
...
```bash
python -m pip install boto3-stubs[mypy-boto3-route53resolver]
```
