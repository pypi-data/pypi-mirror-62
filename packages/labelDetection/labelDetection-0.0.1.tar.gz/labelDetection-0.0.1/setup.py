...
'keras-retinanet==0.5.1','numpy==1.14.6','mxnet_mkl==1.6.0b20191025','pycocotools==2.0.0','Pillow==7.0.0','pyqt5==5.10.1','mxnet==1.5.1.post0','progressbar2==3.47.0','sip==4.19.8','scikit_learn==0.22.1','future==0.17.1','pandas==0.23.4','imageio==2.5.0','scikit-image==0.14.2']
about = {}
...
required_packages.append('Mask_RCNN')
