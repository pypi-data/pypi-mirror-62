...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ssm", "1.27.0", __name__, "aws-ssm@1.27.0.jsii.tgz")
...
class ParameterOptions():
    def __init__(self, *, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, simple_name: typing.Optional[bool]=None, tier: typing.Optional["ParameterTier"]=None):
...
class StringListParameterProps(ParameterOptions):
    def __init__(self, *, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, simple_name: typing.Optional[bool]=None, tier: typing.Optional["ParameterTier"]=None, string_list_value: typing.List[str]):
...
class StringParameterProps(ParameterOptions):
    def __init__(self, *, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, simple_name: typing.Optional[bool]=None, tier: typing.Optional["ParameterTier"]=None, string_value: str, type: typing.Optional["ParameterType"]=None):
