...
class ListAssociationsForLicenseConfigurationPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssociationsForLicenseConfiguration.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/license-manager.html#LicenseManager.Paginator.ListAssociationsForLicenseConfiguration.paginate)
        """
...
class ListLicenseConfigurationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListLicenseConfigurations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/license-manager.html#LicenseManager.Paginator.ListLicenseConfigurations.paginate)
        """
...
class ListLicenseSpecificationsForResourcePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListLicenseSpecificationsForResource.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/license-manager.html#LicenseManager.Paginator.ListLicenseSpecificationsForResource.paginate)
        """
...
class ListResourceInventoryPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListResourceInventory.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/license-manager.html#LicenseManager.Paginator.ListResourceInventory.paginate)
        """
...
class ListUsageForLicenseConfigurationPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListUsageForLicenseConfiguration.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/license-manager.html#LicenseManager.Paginator.ListUsageForLicenseConfiguration.paginate)
        """
