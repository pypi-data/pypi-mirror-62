...
if K.backend() == 'theano':
    from ..DenseNet import  theano_backend as K_BACKEND
    # import DenseNet.theano_backend as K_BACKEND
else:
    from ..DenseNet import tensorflow_backend as K_BACKEND
    # import DenseNet.tensorflow_backend as K_BACKEND
