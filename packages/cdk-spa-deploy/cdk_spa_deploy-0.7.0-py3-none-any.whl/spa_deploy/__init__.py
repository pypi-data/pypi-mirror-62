...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk-spa-deploy", "0.7.0", __name__, "cdk-spa-deploy@0.7.0.jsii.tgz")


@jsii.data_type(jsii_type="cdk-spa-deploy.HostedZoneConfig", jsii_struct_bases=[], name_mapping={'index_doc': 'indexDoc', 'website_folder': 'websiteFolder', 'zone_name': 'zoneName'})
class HostedZoneConfig():
    def __init__(self, *, index_doc: str, website_folder: str, zone_name: str):
        """
        :param index_doc: -
...
class SPADeploy(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-spa-deploy.SPADeploy"):
    ...
    def create_basic_site(self, *, index_doc: str, website_folder: str, certificate_arn: typing.Optional[str]=None, cf_aliases: typing.Optional[typing.List[str]]=None, export_website_url_name: typing.Optional[str]=None, export_website_url_output: typing.Optional[bool]=None) -> None:
        ...
        """
        config = SPADeployConfig(index_doc=index_doc, website_folder=website_folder, certificate_arn=certificate_arn, cf_aliases=cf_aliases, export_website_url_name=export_website_url_name, export_website_url_output=export_website_url_output)

        return jsii.invoke(self, "createBasicSite", [config])

    @jsii.member(jsii_name="createSiteFromHostedZone")
    def create_site_from_hosted_zone(self, *, index_doc: str, website_folder: str, zone_name: str) -> None:
        ...
        :param zone_name: -
        """
        config = HostedZoneConfig(index_doc=index_doc, website_folder=website_folder, zone_name=zone_name)

        return jsii.invoke(self, "createSiteFromHostedZone", [config])

    @jsii.member(jsii_name="createSiteWithCloudfront")
    def create_site_with_cloudfront(self, *, index_doc: str, website_folder: str, certificate_arn: typing.Optional[str]=None, cf_aliases: typing.Optional[typing.List[str]]=None, export_website_url_name: typing.Optional[str]=None, export_website_url_output: typing.Optional[bool]=None) -> None:
...
@jsii.data_type(jsii_type="cdk-spa-deploy.SPADeployConfig", jsii_struct_bases=[], name_mapping={'index_doc': 'indexDoc', 'website_folder': 'websiteFolder', 'certificate_arn': 'certificateARN', 'cf_aliases': 'cfAliases', 'export_website_url_name': 'exportWebsiteUrlName', 'export_website_url_output': 'exportWebsiteUrlOutput'})
class SPADeployConfig():
    def __init__(self, *, index_doc: str, website_folder: str, certificate_arn: typing.Optional[str]=None, cf_aliases: typing.Optional[typing.List[str]]=None, export_website_url_name: typing.Optional[str]=None, export_website_url_output: typing.Optional[bool]=None):
        """
        :param index_doc: -
        :param website_folder: -
        :param certificate_arn: -
