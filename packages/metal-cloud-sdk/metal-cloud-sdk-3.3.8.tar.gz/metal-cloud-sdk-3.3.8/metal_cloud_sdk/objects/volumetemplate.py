...
class VolumeTemplate(object):
	...
	def __init__(self, volume_template_label, volume_template_size_mbytes, os_template_pre_boot_architecture):
		self.volume_template_label = volume_template_label;
		self.volume_template_size_mbytes = volume_template_size_mbytes;
		self.os_template_pre_boot_architecture = os_template_pre_boot_architecture;
	...
	"""
	The pre-boot architecture of the OS template.
	"""
	os_template_pre_boot_architecture = None;
