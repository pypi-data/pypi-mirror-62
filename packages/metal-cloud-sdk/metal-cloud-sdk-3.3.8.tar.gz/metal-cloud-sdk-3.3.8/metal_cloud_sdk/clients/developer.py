...
class Developer(Client):
	...
	""" 872 functions available on endpoint. """
	...
	def datacenter_tags_add(self, strUserID, strDatacenterName, arrDatacenterTagsNames):
	...
	def datacenter_tags_set(self, strUserID, strDatacenterName, arrDatacenterTagsNames):
	...
	def datacenter_tags_remove(self, strUserID, strDatacenterName, arrDatacenterTagsNames):
	...
	def infrastructure_deploy_custom_stages(self, strInfrastructureID, strStageDefinitionType):
	...
	def infrastructure_deploy_custom_stage_move_into_runlevel(self, strInfrastructureID, nStageDefinitionID, strStageRunGroup, nSourceRunLevel, nDestinationRunLevel):
	...
	def os_asset_make_public(self, nOSAssetID):
		...
		objOSAsset = self.rpc("os_asset_make_public", arrParams)
		for strKeyOSAsset in objOSAsset:
			objOSAsset[strKeyOSAsset] = Deserializer.deserialize(objOSAsset[strKeyOSAsset])
		return objOSAsset
	...
	def os_asset_make_private(self, nOSAssetID, strUserIDOwner):
		...
		objOSAsset = self.rpc("os_asset_make_private", arrParams)
		for strKeyOSAsset in objOSAsset:
			objOSAsset[strKeyOSAsset] = Deserializer.deserialize(objOSAsset[strKeyOSAsset])
		return objOSAsset
	...
	def server_firmware_component_schedule_upgrade(self, nServerComponentID, strServerComponentFirmwareNewVersion = None, strScheduleUpdateTimestamp = None):
	...
	def os_asset_tags_add(self, nOSAssetID, arrOSAssetTagsNames):
		...
		return Deserializer.deserialize(self.rpc("os_asset_tags_add", arrParams))
	...
	def os_asset_tags_set(self, nOSAssetID, arrOSAssetTagsNames):
		...
		return Deserializer.deserialize(self.rpc("os_asset_tags_set", arrParams))
	...
	def os_asset_tags_remove(self, nOSAssetID, arrOSAssetTagsNames):
		...
		return Deserializer.deserialize(self.rpc("os_asset_tags_remove", arrParams))
