...
def classify(features, labels, model = 'all', resample_method = None, scoring = 'roc_auc_ovo', cv = 10, n_iter = 10):
    ...
    def which_model(X, y, model = 'all'):
        ...
        if model == 'all':
            ...
            pipelines.append(('Extra Tree', skl_pipeline([('Standardization', StandardScaler()),
            ...
            et_pipe = skl_pipeline([('Standardization', StandardScaler()), ('ET', ExtraTreeClassifier(random_state = 9999))])
    ...
    def evaluate(clf, X_test, y_test):
        ...
        if 'log' in clf.best_estimator_.get_params().values():
            ...
            model = SGDClassifier(**clf.best_params_)
