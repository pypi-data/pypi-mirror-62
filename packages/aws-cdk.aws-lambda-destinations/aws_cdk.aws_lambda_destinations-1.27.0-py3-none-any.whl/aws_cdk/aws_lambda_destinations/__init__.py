...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda-destinations", "1.27.0", __name__, "aws-lambda-destinations@1.27.0.jsii.tgz")
...
class EventBridgeDestination(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-destinations.EventBridgeDestination"):
    ...
    def bind(self, _scope: aws_cdk.core.Construct, fn: aws_cdk.aws_lambda.IFunction, *, type: aws_cdk.aws_lambda.DestinationType) -> aws_cdk.aws_lambda.DestinationConfig:
...
class LambdaDestination(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-destinations.LambdaDestination"):
    ...
    def __init__(self, fn: aws_cdk.aws_lambda.IFunction, *, response_only: typing.Optional[bool]=None) -> None:
        """
        :param fn: -
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, scope: aws_cdk.core.Construct, fn: aws_cdk.aws_lambda.IFunction, *, type: aws_cdk.aws_lambda.DestinationType) -> aws_cdk.aws_lambda.DestinationConfig:
        """Returns a destination configuration.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-lambda-destinations.LambdaDestinationOptions", jsii_struct_bases=[], name_mapping={'response_only': 'responseOnly'})
class LambdaDestinationOptions():
    def __init__(self, *, response_only: typing.Optional[bool]=None):
...
__all__ = ["EventBridgeDestination", "LambdaDestination", "LambdaDestinationOptions", "SnsDestination", "SqsDestination", "__jsii_assembly__"]
