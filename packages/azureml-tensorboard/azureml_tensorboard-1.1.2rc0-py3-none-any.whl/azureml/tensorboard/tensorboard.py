...
class Tensorboard(object):
    ...
    :param runs: An empty list or a list of one or more experiment runs to attach to the Tensorboard instance.
    :type runs: list
    ...
    def __init__(self, runs, local_root=None, port=6006):
        ...
        :param runs: An empty list or a list of one or more experiment runs to attach to this Tensorboard instance.
        :type runs: list
        :param local_root: An optional local directory to store the run logs in.
        :type local_root: str
        :param port: The port to run this Tensorboard instance on.
