...
class ListChannelsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListChannels.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/mediapackage.html#MediaPackage.Paginator.ListChannels.paginate)
        """
...
class ListHarvestJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListHarvestJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/mediapackage.html#MediaPackage.Paginator.ListHarvestJobs.paginate)
        """
...
class ListOriginEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListOriginEndpoints.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/mediapackage.html#MediaPackage.Paginator.ListOriginEndpoints.paginate)
        """
