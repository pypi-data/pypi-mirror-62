...
[boto3.IoTDataPlane 1.12.14](https://boto3.amazonaws.com/v1/documentation/api/1.12.14/reference/services/iot-data.html#IoTDataPlane) service
...
```bash
python -m pip install boto3-stubs[mypy-boto3-iot-data]
```
