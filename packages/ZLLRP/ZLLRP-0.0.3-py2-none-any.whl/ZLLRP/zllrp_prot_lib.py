...
class ZLLRP:
    def __init__(self):
        ...
        try:
            with open("mssage_list_map.json", "r") as fp:
        ...
        try:
            with open("parameter_list_map.json", "r") as fp:
...
class ZLLRPSelSpec(dict):
    def __init__(self, reader_type, sel_spec_id, priority=0, state=0,
                 antennas=None, duration_ms=0, report_every_n_tags=1):
        ...
        self["SelectSpec"] = {
            ...
            'SelectSpecStopTrigger': {
                ...
                'DurationValue': duration_ms  # millisecond
            },
            'AntennaSpec': {
                'AntennaIDs': antennas,
