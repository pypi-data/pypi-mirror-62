...
class PartOffer:
    ...
    def __repr__(self):
        return '{}: {}'.format(self.seller, self.sku)
...
class Seller:
    ...
    def __init__(self, sellerobj):
        ...
        display_flag = sellerobj.get('display_flag')
        has_ecommerce = sellerobj.get('has_ecommerce')
        homepage_url = sellerobj.get('homepage_url')
        id = sellerobj.get('id')
        name = sellerobj.get('name')
        uid = sellerobj.get('uid')
