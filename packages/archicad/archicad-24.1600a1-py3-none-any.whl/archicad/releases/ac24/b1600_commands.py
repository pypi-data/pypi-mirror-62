...
from .b1600_types import NavigatorItemId, LayoutParameters, Subset, FolderParameters, NavigatorItemIdWrapper, ExecutionResult, ElementIdArrayItem, BoundingBox2DOrError, BoundingBox3DOrError, ClassificationSystemId, ClassificationItemArrayItem, ClassificationSystem, PropertyUserId, ClassificationSystemIdArrayItem, ElementClassificationOrError, ClassificationItemIdArrayItem, ClassificationItemOrError, PropertyIdArrayItem, PropertyDefinitionOrError, ClassificationItemId, NavigatorTreeId, NavigatorTree, PropertyIdOrError, PropertyValuesOrErrorForElement, ElementClassification, ElementPropertyValue
...
class AC24Commands:
	...
	def CreateLayout(self, layoutName: str, layoutParameters: LayoutParameters, masterNavigatorItemId: NavigatorItemId, parentNavigatorItemId: NavigatorItemId) -> NavigatorItemId:
		...
		CreateLayout_parameters.get_classinfo().add_field('layoutName', str)
	...
	def GetElementsByType(self, elementType: str) -> List[ElementIdArrayItem]:
		...
		GetElementsByType_parameters.get_classinfo().add_field('elementType', str)
	...
	def RenameNavigatorItem(self, navigatorItemId: NavigatorItemId, newName: Optional[str] = None, newId: Optional[str] = None):
		...
		"""
		class Object_5181aaac_d5c0_4b24_851e_9ad00a50aa19(_ACBaseType):
			__slots__ = ("navigatorItemId", "newName", )
			def __init__(self, navigatorItemId: NavigatorItemId, newName: Optional[str] = None):
				self.navigatorItemId: NavigatorItemId = navigatorItemId
				self.newName: Optional[str] = newName

		Object_5181aaac_d5c0_4b24_851e_9ad00a50aa19.get_classinfo().add_field('navigatorItemId', NavigatorItemId)
		Object_5181aaac_d5c0_4b24_851e_9ad00a50aa19.get_classinfo().add_field('newName', Optional[str])

		class Object_40685eeb_f427_4c0f_9508_771797f87971(_ACBaseType):
			__slots__ = ("navigatorItemId", "newId", )
			def __init__(self, navigatorItemId: NavigatorItemId, newId: Optional[str] = None):
				self.navigatorItemId: NavigatorItemId = navigatorItemId
				self.newId: Optional[str] = newId

		Object_40685eeb_f427_4c0f_9508_771797f87971.get_classinfo().add_field('navigatorItemId', NavigatorItemId)
		Object_40685eeb_f427_4c0f_9508_771797f87971.get_classinfo().add_field('newId', Optional[str])

		class Object_c5ee5de1_3207_4639_8819_f1b6ddab7748(_ACBaseType):
		...
		Object_c5ee5de1_3207_4639_8819_f1b6ddab7748.get_classinfo().add_field('navigatorItemId', NavigatorItemId)
		Object_c5ee5de1_3207_4639_8819_f1b6ddab7748.get_classinfo().add_field('newName', str)
		Object_c5ee5de1_3207_4639_8819_f1b6ddab7748.get_classinfo().add_field('newId', str)

		parametersConstructUnion = _ConstructUnion(Union[Object_5181aaac_d5c0_4b24_851e_9ad00a50aa19, Object_40685eeb_f427_4c0f_9508_771797f87971, Object_c5ee5de1_3207_4639_8819_f1b6ddab7748])

		result = post_command(self.__req, json.dumps({"command": "API.RenameNavigatorItem", "parameters": parametersConstructUnion(navigatorItemId, newName, newId).to_dict()}))
		if not result["succeeded"]:
			raise UnsucceededCommandCall(result)
