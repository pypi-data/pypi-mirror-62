...
class DescribeBatchPredictionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeBatchPredictions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/machinelearning.html#MachineLearning.Paginator.DescribeBatchPredictions.paginate)
        """
...
class DescribeDataSourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDataSources.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/machinelearning.html#MachineLearning.Paginator.DescribeDataSources.paginate)
        """
...
class DescribeEvaluationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEvaluations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/machinelearning.html#MachineLearning.Paginator.DescribeEvaluations.paginate)
        """
...
class DescribeMLModelsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeMLModels.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/machinelearning.html#MachineLearning.Paginator.DescribeMLModels.paginate)
        """
