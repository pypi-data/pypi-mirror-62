...
def BotFrameworkConfig_from_subscription(subscription , region , bot_Id )  :
    return _speech_py_impl.BotFrameworkConfig_from_subscription(subscription, region, bot_Id)
