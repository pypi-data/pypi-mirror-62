...
class jSalesforce(Salesforce):
    ...
    def get_hiring(self, employee_id, service_id):
    ...
    def create_salary(self, data):
        """Creates a salary and checks for missing inputs or unallowed inputs."""
        allowed_keys = {
            "Mitarbeiter__c",
            "Service__c",
            "Anstellung__c",
    ...
    def create_invoice(self, data):
        """Creates a invoice and checks for missing inputs or unallowed inputs."""
        allowed_keys = {
            "Account__c",
            "Service__c",
            "Leistungsquartal__c",
