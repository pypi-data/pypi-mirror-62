...
setup(name='DLStudio',
      ...
      url='https://engineering.purdue.edu/kak/distDLS/DLStudio-1.0.6.html',
      download_url='https://engineering.purdue.edu/kak/distDLS/DLStudio-1.0.6.tar.gz',
      description='An early version of an educational module that is being developed to make it easier to experiment with different deep learning networks in PyTorch',
      long_description='''
