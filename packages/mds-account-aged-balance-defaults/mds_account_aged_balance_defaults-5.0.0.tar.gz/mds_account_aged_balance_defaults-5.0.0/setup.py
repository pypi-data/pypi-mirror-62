...
MODULE = 'account_aged_balance_defaults'
PREFIX = 'mds'
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Tryton module to add defaults to the aged-balance-sheet in accounting.',
    ...
    keywords='tryton account defaults settings',
