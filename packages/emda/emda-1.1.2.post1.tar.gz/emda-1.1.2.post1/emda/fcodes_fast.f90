...
subroutine prepare_hkl(hf1,nx,ny,nz,mode,h,k,l,ampli,phase)
  ...
  real*8, dimension(nx*ny*ny/2),intent(out) :: ampli, phase
  ! locals
  integer,   dimension(3)          :: nxyz
...
subroutine setbin(nbin,low_res,high_res,res_arr)
...
subroutine binarr_1d(res_arr,resol_1d,bin_idx,nbin,nx)
  implicit none
...
subroutine bin_idx_with_given_nbin(uc,nbin,res_arr,bin_idx,nx,ny,nz)
  ...
  !
  call get_resol(uc,real(0),real(0),real(0),low_res)
