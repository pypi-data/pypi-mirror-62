...
class Executor(base_executor.BaseExecutor):
  ...
  def _IncrementColumnUsageCounter(pipeline               ,
                                   total_columns_count     ,
  ...
  @beam.typehints.with_output_types(beam.pvalue.PDone)
  def _WriteExamples(pcoll                         , file_format      ,
  ...
  def _ReadMetadata(self, data_format      ,
                    schema_path      )                                    :
  ...
  def _DecodeInputs(pcoll                         ,
    ...
    def decode_example(kv                               )                   :  # pylint: disable=invalid-name
  ...
  def _CreatePipeline(
      self, unused_transform_output_path      )                 :
  ...
  def _ShouldDecodeAsRawExample(self, data_format                  )        :
  ...
  def _AssertSameTFXIOSchema(self, datasets                    )        :
    if not datasets:
      return
