...
class StorageClient(object):
    ...
    def __init__(self, project_id):
        ...
        if 'prod' in project_id:
            self.dmp_id = 'vaknlprod'
        elif 'dev' in project_id:
            self.dmp_id = 'vaknldev'
        elif 'zandbak' in project_id:
            self.dmp_id = 'vaknl-zandbak'

        self.storage_client = storage.Client(project=self.dmp_id)
    ...
    def storage_to_bigquery(self, objects: list, table_ref, write_disposition):
        ...
        bucket_name = f'storage_to_bigquery-{self.dmp_id}'  # General bucked name for this process
