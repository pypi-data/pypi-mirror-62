...
#                    self.params['ttv_'+inst] = 0.
        ...
        for th, b, key in zip(self.theta_0, self.bounds, self.fitkeys):
            ...
            #::: currently no avoidance for normal or trunc_normal, these get caught in the likelihood function only
