...
def derive(samples, mode):
    ...
    for companion in companions:
        ...
        # except:
        #     derived_samples[companion+'_R_star/a'] = None
        #     derived_samples[companion+'_R_companion/a'] = None
        #     derived_samples[companion+'_R_companion_(R_earth)'] = None
        #     derived_samples[companion+'_R_companion_(R_jup)'] = None
        ...
        # except:
        #     derived_samples[companion+'_a_(R_sun)'] = None
        #     derived_samples[companion+'_a_(AU)'] = None
        ...
        for inst in config.BASEMENT.settings['inst_phot']:
            ...
            for i in tqdm( range(N_less_samples) ):
                ...
                if config.BASEMENT.settings['secondary_eclipse'] is True:
                    ...
                    if config.BASEMENT.settings['phase_curve'] is True:
