...
from .composition import ConfirmationDialog, Option, OptionGroup, PlainText
...
class OverflowMenu(Input):
    ...
    def __init__(
        ...
        **input_attributes,
        ...
        """
        super().__init__(options=options, confirm=confirm, **input_attributes)
...
class ChannelSelect(Select):
    ...
    @classmethod
    def parse_value(cls, action):
        return action.get("selected_channel")  # todo validate this
...
class UserSelect(Select):
    ...
    @classmethod
    def parse_value(cls, action):
        return action.get("selected_user")  # todo validate this
