...
def atom_cfg():
    ...
    # [atom_num, name, atom_mass, ele_configuration, ionization_energy]
    dict_pt = {
    ...
    'B' : [5,  'Boron', 10.81, '1s2 2s2 2p', 8.2980],
    'C' : [6,  'Carbon', 12.011, '1s2 2s2 2p2', 11.2603],
    'N' : [7,  'Nitrogen', 14.007, '1s2 2s2 2p3', 14.5341],
    'O' : [8,  'Oxygen', 15.999, '1s2 2s2 2p4', 13.6181],
    'F' : [9,  'Fluorine', 18.998, '1s2 2s2 2p5', 17.4228],
    'Ne': [10, 'Neon', 20.180, '1s2 2s2 2p6', 21.5645],
    'Na': [11, 'Sodium', 22.990, '[Ne]3s', 5.1391],
    'Mg': [12, 'Magnesium', 24.305, '[Ne]3s2', 7.6462],
    'Al': [13, 'Aluminum', 26.982, '[Ne]3s2 3p', 5.9858],
    'Si': [14, 'Silicon', 28.085, '[Ne]3s2 3p2', 8.1517],
    'P' : [15, 'Phosphorus', 30.974, '[Ne]3s2 3p3', 10.4867],
    'S' : [16, 'Sulfur', 32.06, '[Ne]3s2 3p4', 10.3600],
    'Cl': [17, 'Chlorine', 35.45, '[Ne]3s2 3p5', 12.9676],
    'Ar': [18, 'Argon', 39.948, '[Ne]3s2 3p6', 15.7596],
    'K' : [19, 'Potassium', 39.098, '[Ar]4s', 4.3407],
    'Ca': [20, 'Calcium', 40.078, '[Ar]4s2', 6.1132],
    'Sc': [21, 'Scandium', 44.956, '[Ar]3d 4s2', 6.5615],
    'Ti': [22, 'Titanium', 47.867, '[Ar]3d2 4s2', 6.8281],
    'V' : [23, 'Vanadium', 50.942, '[Ar]3d3 4s2', 6.7462],
    'Cr': [24, 'Chromium', 51.996, '[Ar]3d5 4s', 6.7665],
    'Mn': [25, 'Manganese', 54.938, '[Ar]3d5 4s2', 7.4340],
    'Fe': [26, 'Iron', 55.845, '[Ar]3d6 4s2', 7.9025],
    'Co': [27, 'Cobalt', 58.933, '[Ar]3d7 4s2', 7.8810],
    'Ni': [28, 'Nickel', 58.693, '[Ar]3d8 4s2', 7.6399],
    'Cu': [29, 'Copper', 63.546, '[Ar]3d10 4s', 7.7264],
    'Zn': [30, 'Zinc', 65.38, '[Ar]3d10 4s2', 9.3942],
    'Ga': [31, 'Gallium', 69.723, '[Ar]3d10 4s2 4p', 5.9993],
    'Ge': [32, 'Germanium', 72.630, '[Ar]3d10 4s2 4p2', 7.8994],
    'As': [33, 'Arsenic', 74.922, '[Ar]3d10 4s2 4p3', 9.7886],
    'Se': [34, 'Selenium', 78.971, '[Ar]3d10 4s2 4p4', 9.7524],
    'Br': [35, 'Bromine', 79.904, '[Ar]3d10 4s2 4p5', 11.8138],
    'Kr': [36, 'Krypton', 83.798, '[Ar]3d10 4s2 4p6', 13.9996],
    'Rb': [37, 'Rubidium', 85.468, '[Kr]5s', 4.1771],
    'Sr': [38, 'Strontium', 87.62, '[kr]5s2', 5.6949],
    'Y' : [39, 'Yttrium', 88.906, '[Kr]4d 5s2', 6.2173],
    'Zr': [40, 'Zirconium', 91.224, '[Kr]4d2 5s2', 6.6341],
    'Nb': [41, 'Niobium', 92.906, '[Kr]4d4 5s', 6.7589],
    'Mo': [42, 'Molybdenum', 95.95, '[Kr]4d5 5s', 7.0924],
    'Tc': [43, 'Technetium', 97, '[Kr]4d5 5s2', 7.1194],
    'Ru': [44, 'Ruthenium', 101.07, '[Kr]4d7 5s', 7.3605],
    'Rh': [45, 'Rhodium', 102.91, '[Kr]4d8 5s', 7.4589],
    'Pd': [46, 'Palladium', 106.42, '[Kr]4d10', 8.3369],
    'Ag': [47, 'Silver', 107.87, '[Kr]4d10 5s', 7.5762],
    'Cd': [48, 'Cadmium', 112.41, '[Kr]4d10 5s2', 8.9938],
    'In': [49, 'Indium', 114.82, '[Kr]4d10 5s2 5p', 5.7864],
    'Sn': [50, 'Tin', 118.71, '[Kr]4d10 5s2 5p2', 7.3439],
    'Sb': [51, 'Antimony', 121.76, '[Kr]4d10 5s2 5p3', 8.6084],
    'Te': [52, 'Tellurium', 127.6, '[Kr]4d10 5s2 5p4', 9.0097],
    'I' : [53, 'Iodine', 126.90, '[Kr]4d10 5s2 5p5', 10.4513],
    'Xe': [54, 'Xenon', 131.29, '[Kr]4d10 5s2 5p6', 12.1298],
    'Cs': [55, 'Cesium', 132.91, '[Xe]6s', 3.8939],
    'Ba': [56, 'Barium', 137.33, '[Xe]6s2', 5.2117],
    'La': [57, 'Lanthanum', 138.91, '[Xe]5d 6s2', 5.5769],
    'Ce': [58, 'Cerium', 140.12, '[Xe]4f 5d 6s2', 5.5386],
    'Pr': [59, 'Praseodymium', 140.91, '[Xe]4f3 6s2', 5.4702],
    'Nd': [60, 'Neodymium', 144.24, '[Xe]4f4 6s2', 5.5250],
    'Pm': [61, 'Promethium', 145, '[Xe]4f5 6s2', 5.577],
    'Sm': [62, 'Samarium', 150.36, '[Xe]4f6 6s2', 5.6437],
