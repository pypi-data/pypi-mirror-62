        ...
        if result < 100000:
            ...
            if int_ecr >= 65535:
                ...
                if result[0] < 100000:
                    ...
                    transData["Sub_reason"] = float(result[4])/10
...
def __CollectSubsidy(int_ecr,list_subsidy):
    ...
    if result < 100000:
        for x in range(0,20,4):
            ...
            print( str(int.from_bytes(output[x],'big')))
            print( str(int.from_bytes(output[x+1],'big')))
            print( str(int.from_bytes(output[x+2],'big')))
            print( str(int.from_bytes(output[x+3],'big')))
            print(str(y))
