...
# from tests.utils.mocks import send_uploads_to_file
# send_uploads_to_file()

scrybe.init("scrybe e2e client testing")
pd.set_option('max_columns', 200)


df_train = pd.read_csv('tests/data/train.csv')
...
# To Profile: python -m cProfile -o ~/tmp/perf_profiles/perf_test_titanic.out tests/perf/perf_test_titanic.py
