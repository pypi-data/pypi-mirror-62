...
devices_conf = [{'key': MonitoringName.CHARGE, 'value_type': 0, 'delay': 10},  # todo think about delay
                {'key': MonitoringName.ALARM, 'value_type': 3, 'delay': 10},
                {'key': MonitoringName.TEST, 'value_type': 3, 'delay': 10}]
