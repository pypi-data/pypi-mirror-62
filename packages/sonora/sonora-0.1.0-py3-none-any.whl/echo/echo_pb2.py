...
_ECHOREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.gateway.testing.EchoRequest.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_ECHORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.gateway.testing.EchoResponse.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="message_count",
            full_name="grpc.gateway.testing.EchoResponse.message_count",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_SERVERSTREAMINGECHOREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.gateway.testing.ServerStreamingEchoRequest.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="message_count",
            full_name="grpc.gateway.testing.ServerStreamingEchoRequest.message_count",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.gateway.testing.ServerStreamingEchoRequest.message_interval",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_SERVERSTREAMINGECHORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.gateway.testing.ServerStreamingEchoResponse.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CLIENTSTREAMINGECHOREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.gateway.testing.ClientStreamingEchoRequest.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CLIENTSTREAMINGECHORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message_count",
            full_name="grpc.gateway.testing.ClientStreamingEchoResponse.message_count",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_SERVERSTREAMINGECHOREQUEST.fields_by_name[
    "message_interval"
...
] = _SERVERSTREAMINGECHOREQUEST
DESCRIPTOR.message_types_by_name[
    "ServerStreamingEchoResponse"
] = _SERVERSTREAMINGECHORESPONSE
DESCRIPTOR.message_types_by_name[
    "ClientStreamingEchoRequest"
] = _CLIENTSTREAMINGECHOREQUEST
DESCRIPTOR.message_types_by_name[
    "ClientStreamingEchoResponse"
] = _CLIENTSTREAMINGECHORESPONSE
...
EchoRequest = _reflection.GeneratedProtocolMessageType(
    "EchoRequest",
    (_message.Message,),
    dict(
...
EchoResponse = _reflection.GeneratedProtocolMessageType(
    "EchoResponse",
    (_message.Message,),
    dict(
...
ServerStreamingEchoRequest = _reflection.GeneratedProtocolMessageType(
    "ServerStreamingEchoRequest",
    (_message.Message,),
    dict(
...
ServerStreamingEchoResponse = _reflection.GeneratedProtocolMessageType(
    "ServerStreamingEchoResponse",
    (_message.Message,),
    dict(
...
ClientStreamingEchoRequest = _reflection.GeneratedProtocolMessageType(
    "ClientStreamingEchoRequest",
    (_message.Message,),
    dict(
...
ClientStreamingEchoResponse = _reflection.GeneratedProtocolMessageType(
    "ClientStreamingEchoResponse",
    (_message.Message,),
    dict(
