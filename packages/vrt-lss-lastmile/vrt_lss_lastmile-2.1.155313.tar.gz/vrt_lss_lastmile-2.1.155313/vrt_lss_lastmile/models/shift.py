...
class Shift(object):
    ...
    def __init__(self, key=None, shift_type=None, resource_key=None, availability_time=None, working_time=None, start_location_key=None, finish_location_key=None, tariff=None):  # noqa: E501
    ...
    def shift_type(self, shift_type):
        ...
        if shift_type not in allowed_values:
            raise ValueError(
