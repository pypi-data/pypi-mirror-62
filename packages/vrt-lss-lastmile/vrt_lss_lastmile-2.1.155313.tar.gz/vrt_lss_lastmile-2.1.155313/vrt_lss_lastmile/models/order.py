...
class Order(object):
    ...
    def __init__(self, key=None, order_features=None, order_restrictions=None, performer_restrictions=None, performer_blacklist=None, cargos=None, demands=None):  # noqa: E501
