...
setup(
    ...
    description='Classes for implementing execution mail.',
    long_description=long_description,

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_mail',
    ...
    packages=find_packages('manhattan_mail'),
    package_dir={'': 'manhattan_mail'},
