...
[boto3.CostExplorer 1.12.13](https://boto3.amazonaws.com/v1/documentation/api/1.12.13/reference/services/ce.html#CostExplorer) service
...
```bash
python -m pip install boto3-stubs[mypy-boto3-ce]
```
