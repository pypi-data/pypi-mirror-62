...
class FirewallGroupDetails(object):
    ...
    def __init__(self, id=None, name=None, description=None, org_ref=None, edge_gateway_ref=None, network_provider_scope=None, status=None, ip_addresses=None):
        """
    ...
    def ip_addresses(self):
        ...
        Ip Addresses included in the group. This can support IPv4 and IPv6 addresses in single, range, and CIDR formats.
