...
class RefreshOnChange(object):
    ...
    def __init__(self, decorator_type=None):
        """
        RefreshOnChange - a model defined in Swagger
        """
    ...
    def decorator_type(self):
        """
        Gets the decorator_type of this RefreshOnChange.

        :return: The decorator_type of this RefreshOnChange.
        :rtype: str
        """
    ...
    def decorator_type(self, decorator_type):
        """
        Sets the decorator_type of this RefreshOnChange.

        :param decorator_type: The decorator_type of this RefreshOnChange.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RefreshOnChange):
            return False
