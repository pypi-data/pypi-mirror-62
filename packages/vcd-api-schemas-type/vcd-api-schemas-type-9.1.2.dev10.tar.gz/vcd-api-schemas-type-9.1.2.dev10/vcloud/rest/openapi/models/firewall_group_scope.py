...
class FirewallGroupScope(object):
    """
    ...
    def __init__(self, org_ref=None, edge_gateway_ref=None, network_provider_scope=None):
        """
        FirewallGroupScope - a model defined in Swagger
        """
    ...
    def org_ref(self, org_ref):
        """
        Sets the org_ref of this FirewallGroupScope.
        The organization that this firewall group belongs to. This property is read-only and cannot be updated. 

        :param org_ref: The org_ref of this FirewallGroupScope.
    ...
    def edge_gateway_ref(self):
        """
        Gets the edge_gateway_ref of this FirewallGroupScope.
        The edge gateway that this firewall group is scoped to. This means that this firewall group can be used when configuring firewall rules for the edge gateway. This property is required and cannot be updated. 

        :return: The edge_gateway_ref of this FirewallGroupScope.
        :rtype: EntityReference
        """
    ...
    def edge_gateway_ref(self, edge_gateway_ref):
        """
        Sets the edge_gateway_ref of this FirewallGroupScope.
        The edge gateway that this firewall group is scoped to. This means that this firewall group can be used when configuring firewall rules for the edge gateway. This property is required and cannot be updated. 

        :param edge_gateway_ref: The edge_gateway_ref of this FirewallGroupScope.
        :type: EntityReference
        """
    ...
    def network_provider_scope(self):
        """
        Gets the network_provider_scope of this FirewallGroupScope.
        ...
        :return: The network_provider_scope of this FirewallGroupScope.
        :rtype: str
        """
    ...
    def network_provider_scope(self, network_provider_scope):
        """
        Sets the network_provider_scope of this FirewallGroupScope.
        The network provider scope that this object belongs to. This is a read-only property and is determined by the input context entity ID during object creation. 

        :param network_provider_scope: The network_provider_scope of this FirewallGroupScope.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FirewallGroupScope):
            return False
