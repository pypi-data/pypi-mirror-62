...
class UploadSpec(object):
    ...
    def __init__(self, file_name=None, size=None, checksum=None, checksum_algo='sha1'):
        """
        UploadSpec - a model defined in Swagger
        """

        self._file_name = None
        self._size = None
        self._checksum = None
        self._checksum_algo = None
    ...
    def file_name(self):
        """
        Gets the file_name of this UploadSpec.

        :return: The file_name of this UploadSpec.
        :rtype: str
        """
    ...
    def file_name(self, file_name):
        """
        Sets the file_name of this UploadSpec.

        :param file_name: The file_name of this UploadSpec.
        :type: str
        """
    ...
    def size(self):
        """
        Gets the size of this UploadSpec.

        :return: The size of this UploadSpec.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        """
        Sets the size of this UploadSpec.

        :param size: The size of this UploadSpec.
        :type: int
        """
        if size is None:
    ...
    def checksum(self):
        """
        Gets the checksum of this UploadSpec.

        :return: The checksum of this UploadSpec.
        :rtype: str
        """
    ...
    def checksum(self, checksum):
        """
        Sets the checksum of this UploadSpec.

        :param checksum: The checksum of this UploadSpec.
        :type: str
        """
    ...
    @property
    def checksum_algo(self):
        """
        Gets the checksum_algo of this UploadSpec.

        :return: The checksum_algo of this UploadSpec.
        :rtype: str
        """
        return self._checksum_algo

    @checksum_algo.setter
    def checksum_algo(self, checksum_algo):
        """
        Sets the checksum_algo of this UploadSpec.

        :param checksum_algo: The checksum_algo of this UploadSpec.
        :type: str
        """
        allowed_values = ["sha1", "sha256"]
        if checksum_algo not in allowed_values:
            raise ValueError(
                "Invalid value for `checksum_algo` ({0}), must be one of {1}"
                .format(checksum_algo, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UploadSpec):
            return False
