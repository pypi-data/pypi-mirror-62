...
class IkeStatus(object):
    ...
    """
    swagger_types = {
        'ike_service_status': 'IkeServiceStatus',
        'fail_reason': 'str'
    }
    ...
    def __init__(self, ike_service_status=None, fail_reason=None):
        """
        IkeStatus - a model defined in Swagger
        """

        self._ike_service_status = None
        self._fail_reason = None

        if ike_service_status is not None:
          self.ike_service_status = ike_service_status
        if fail_reason is not None:
          self.fail_reason = fail_reason

    @property
    def ike_service_status(self):
        """
        Gets the ike_service_status of this IkeStatus.
        The overall IKE Session service status.

        :return: The ike_service_status of this IkeStatus.
        :rtype: IkeServiceStatus
        """
        return self._ike_service_status

    @ike_service_status.setter
    def ike_service_status(self, ike_service_status):
        """
        Sets the ike_service_status of this IkeStatus.
        The overall IKE Session service status.

        :param ike_service_status: The ike_service_status of this IkeStatus.
        :type: IkeServiceStatus
        """

        self._ike_service_status = ike_service_status

    @property
    def fail_reason(self):
        """
        Gets the fail_reason of this IkeStatus.
        The reason for the IKE Session establishment failure. This will only be set if the status is DOWN.

        :return: The fail_reason of this IkeStatus.
        :rtype: str
        """
    ...
    def fail_reason(self, fail_reason):
        """
        Sets the fail_reason of this IkeStatus.
        The reason for the IKE Session establishment failure. This will only be set if the status is DOWN.

        :param fail_reason: The fail_reason of this IkeStatus.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, IkeStatus):
            return False
