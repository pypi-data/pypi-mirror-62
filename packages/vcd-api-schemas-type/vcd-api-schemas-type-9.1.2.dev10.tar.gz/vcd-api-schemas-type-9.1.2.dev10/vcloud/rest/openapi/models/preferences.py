...
class Preferences(object):
    ...
    def result_total(self):
        """
        Gets the result_total of this Preferences.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this Preferences.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this Preferences.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this Preferences.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this Preferences.
        How many pages there are in total.

        :return: The page_count of this Preferences.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this Preferences.
        How many pages there are in total.

        :param page_count: The page_count of this Preferences.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this Preferences.
        The page that was fetched, 1-indexed.

        :return: The page of this Preferences.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this Preferences.
        The page that was fetched, 1-indexed.

        :param page: The page of this Preferences.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this Preferences.
        Result count for page that was fetched.

        :return: The page_size of this Preferences.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this Preferences.
        Result count for page that was fetched.

        :param page_size: The page_size of this Preferences.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this Preferences.
        Association info for each result.

        :return: The associations of this Preferences.
    ...
    def associations(self, associations):
        """
        Sets the associations of this Preferences.
        Association info for each result.

        :param associations: The associations of this Preferences.
    ...
    def values(self):
        """
        Gets the values of this Preferences.
        The list of user preferences.

        :return: The values of this Preferences.
        :rtype: list[Preference]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Preferences.
        The list of user preferences.

        :param values: The values of this Preferences.
