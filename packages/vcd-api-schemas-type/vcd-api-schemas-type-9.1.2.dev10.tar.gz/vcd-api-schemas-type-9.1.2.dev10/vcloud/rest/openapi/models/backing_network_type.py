...
class BackingNetworkType(object):
    """
    ...
    IMPORTED_T_LOGICAL_SWITCH = "IMPORTED_T_LOGICAL_SWITCH"
    OPAQUE_NETWORK = "OPAQUE_NETWORK"
    NSXT_FIXED_SEGMENT = "NSXT_FIXED_SEGMENT"
    NSXT_FLEXIBLE_SEGMENT = "NSXT_FLEXIBLE_SEGMENT"
    ...
    def __init__(self):
        """
        BackingNetworkType - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BackingNetworkType):
            return False
