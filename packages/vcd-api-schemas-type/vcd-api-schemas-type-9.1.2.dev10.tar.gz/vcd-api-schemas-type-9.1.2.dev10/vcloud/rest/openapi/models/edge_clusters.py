...
class EdgeClusters(object):
    ...
    def __init__(self, result_total=None, page_count=None, page=None, page_size=None, associations=None, values=None):
        """
        EdgeClusters - a model defined in Swagger
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this EdgeClusters.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this EdgeClusters.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this EdgeClusters.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this EdgeClusters.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this EdgeClusters.
        How many pages there are in total.

        :return: The page_count of this EdgeClusters.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this EdgeClusters.
        How many pages there are in total.

        :param page_count: The page_count of this EdgeClusters.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this EdgeClusters.
        The page that was fetched, 1-indexed.

        :return: The page of this EdgeClusters.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this EdgeClusters.
        The page that was fetched, 1-indexed.

        :param page: The page of this EdgeClusters.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this EdgeClusters.
        Result count for page that was fetched.

        :return: The page_size of this EdgeClusters.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this EdgeClusters.
        Result count for page that was fetched.

        :param page_size: The page_size of this EdgeClusters.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this EdgeClusters.
        Association info for each result.

        :return: The associations of this EdgeClusters.
    ...
    def associations(self, associations):
        """
        Sets the associations of this EdgeClusters.
        Association info for each result.

        :param associations: The associations of this EdgeClusters.
    ...
    def values(self):
        """
        Gets the values of this EdgeClusters.

        :return: The values of this EdgeClusters.
        :rtype: list[EdgeCluster]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this EdgeClusters.

        :param values: The values of this EdgeClusters.
        :type: list[EdgeCluster]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeClusters):
            return False
