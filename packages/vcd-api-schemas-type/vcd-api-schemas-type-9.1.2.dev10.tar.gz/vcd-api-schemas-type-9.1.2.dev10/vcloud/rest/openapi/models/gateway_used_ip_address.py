...
class GatewayUsedIpAddress(object):
    """
    ...
    def __init__(self, network_ref=None, ip_address=None, category=None):
        """
        GatewayUsedIpAddress - a model defined in Swagger
        """
    ...
    def network_ref(self):
        """
        Gets the network_ref of this GatewayUsedIpAddress.
        The external network that this IP Address belongs to.

        :return: The network_ref of this GatewayUsedIpAddress.
    ...
    def network_ref(self, network_ref):
        """
        Sets the network_ref of this GatewayUsedIpAddress.
        The external network that this IP Address belongs to.

        :param network_ref: The network_ref of this GatewayUsedIpAddress.
    ...
    def ip_address(self):
        """
        Gets the ip_address of this GatewayUsedIpAddress.
        The IP address in used.

        :return: The ip_address of this GatewayUsedIpAddress.
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """
        Sets the ip_address of this GatewayUsedIpAddress.
        The IP address in used.

        :param ip_address: The ip_address of this GatewayUsedIpAddress.
        :type: str
        """
    ...
    def category(self):
        """
        Gets the category of this GatewayUsedIpAddress.
        The catagory that an IP can be used for.

        :return: The category of this GatewayUsedIpAddress.
        :rtype: GatewayUsedIpAddressCategory
        """
    ...
    def category(self, category):
        """
        Sets the category of this GatewayUsedIpAddress.
        The catagory that an IP can be used for.

        :param category: The category of this GatewayUsedIpAddress.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, GatewayUsedIpAddress):
            return False
