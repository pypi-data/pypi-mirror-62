...
class UniversalEgressRoutes(object):
    """
    ...
    def __init__(self, egress_points=None, universal_routes=None):
        """
        UniversalEgressRoutes - a model defined in Swagger
        """

        self._egress_points = None
        self._universal_routes = None

        if egress_points is not None:
          self.egress_points = egress_points
        if universal_routes is not None:
          self.universal_routes = universal_routes

    @property
    def egress_points(self):
        """
        Gets the egress_points of this UniversalEgressRoutes.
        The list of Egress Points for routing configuration. This is read-only.

        :return: The egress_points of this UniversalEgressRoutes.
        :rtype: EgressPoints
        """
        return self._egress_points

    @egress_points.setter
    def egress_points(self, egress_points):
        """
        Sets the egress_points of this UniversalEgressRoutes.
        The list of Egress Points for routing configuration. This is read-only.

        :param egress_points: The egress_points of this UniversalEgressRoutes.
        :type: EgressPoints
        """

        self._egress_points = egress_points

    @property
    def universal_routes(self):
        """
        Gets the universal_routes of this UniversalEgressRoutes.
        The list of Universal Routes for routing configuration. 

        :return: The universal_routes of this UniversalEgressRoutes.
        :rtype: UniversalRoutes
        """
        return self._universal_routes

    @universal_routes.setter
    def universal_routes(self, universal_routes):
        """
        Sets the universal_routes of this UniversalEgressRoutes.
        The list of Universal Routes for routing configuration. 

        :param universal_routes: The universal_routes of this UniversalEgressRoutes.
        :type: UniversalRoutes
        """

        self._universal_routes = universal_routes
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UniversalEgressRoutes):
            return False
