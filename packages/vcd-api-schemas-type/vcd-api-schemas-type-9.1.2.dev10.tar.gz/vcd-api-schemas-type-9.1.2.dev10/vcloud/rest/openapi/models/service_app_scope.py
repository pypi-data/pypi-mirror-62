...
class ServiceAppScope(object):
    ...
    """
    VMC = "VMC"
    VMC_REFRESH_TOKEN = "VMC_REFRESH_TOKEN"
    VMC_CLIENT_CREDENTIAL = "VMC_CLIENT_CREDENTIAL"
    ...
    def __init__(self):
        """
        ServiceAppScope - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ServiceAppScope):
            return False
