...
class IpRanges(object):
    ...
    def __init__(self, values=None):
        """
        IpRanges - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this IpRanges.

        :return: The values of this IpRanges.
        :rtype: list[IpRange]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this IpRanges.

        :param values: The values of this IpRanges.
        :type: list[IpRange]
        """
