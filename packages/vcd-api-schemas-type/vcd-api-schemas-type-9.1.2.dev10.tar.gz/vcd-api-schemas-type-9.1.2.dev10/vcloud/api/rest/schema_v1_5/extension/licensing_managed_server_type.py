...
class LicensingManagedServerType(object):
    """
    ...
    def __init__(self, vim_object_ref=None,cpu=None,memory_installed=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LicensingManagedServerType):
            return False
