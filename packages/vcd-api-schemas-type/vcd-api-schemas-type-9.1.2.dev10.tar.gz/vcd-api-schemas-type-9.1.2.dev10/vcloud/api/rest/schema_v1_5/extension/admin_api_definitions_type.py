...
class AdminApiDefinitionsType(VCloudExtensibleType):
    """
    ...
    """
    swagger_types = {
        'api_definition': 'list[AdminApiDefinitionType]'
    }
    ...
    def __init__(self, api_definition=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdminApiDefinitionsType):
            return False
