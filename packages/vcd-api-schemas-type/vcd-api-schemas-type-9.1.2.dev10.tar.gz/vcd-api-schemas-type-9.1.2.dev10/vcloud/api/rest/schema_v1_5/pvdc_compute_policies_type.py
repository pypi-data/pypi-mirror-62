...
class PvdcComputePoliciesType(ResourceType):
    """
    ...
    """
    swagger_types = {
        'compute_policy': 'list[PvdcComputePolicyType]'
    }
    ...
    def __init__(self, compute_policy=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PvdcComputePoliciesType):
            return False
