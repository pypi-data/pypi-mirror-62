...
class QueryResultAclRuleRecordType(QueryResultRecordType):
    ...
    def __init__(self, name=None,org=None,org_access=None,principal=None,principal_access=None,principal_type=None,resource_class_action=None,service_resource=None,service_resource_access=None):
        self._name = None
        self._org = None
