...
class ImportedDiskType(VCloudExtensibleType):
    """
    ...
    def __init__(self, vdc_storage_profile=None,instance_id=None,iops=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportedDiskType):
            return False
