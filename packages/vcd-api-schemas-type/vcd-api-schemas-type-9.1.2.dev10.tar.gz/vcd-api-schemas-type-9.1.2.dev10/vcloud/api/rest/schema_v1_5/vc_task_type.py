...
class VcTaskType(object):
    ...
    def __init__(self, description=None,end_time=None,error_message=None,moref=None,name=None,object_moref=None,object_name=None,object_type=None,start_time=None,status=None,virtual_center_id=None):
