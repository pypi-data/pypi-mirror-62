...
class RightsBundle(object):
    ...
    def __init__(self, name=None, id=None, description=None, bundle_key=None, read_only=None, publish_all=False):
        """
        RightsBundle - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this RightsBundle.

        :return: The name of this RightsBundle.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this RightsBundle.

        :param name: The name of this RightsBundle.
        :type: str
        """
        if name is None:
    ...
    def id(self):
        """
        Gets the id of this RightsBundle.

        :return: The id of this RightsBundle.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this RightsBundle.

        :param id: The id of this RightsBundle.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this RightsBundle.

        :return: The description of this RightsBundle.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RightsBundle.

        :param description: The description of this RightsBundle.
        :type: str
        """
    ...
    def bundle_key(self):
        """
        Gets the bundle_key of this RightsBundle.

        :return: The bundle_key of this RightsBundle.
        :rtype: str
        """
    ...
    def bundle_key(self, bundle_key):
        """
        Sets the bundle_key of this RightsBundle.

        :param bundle_key: The bundle_key of this RightsBundle.
        :type: str
        """
    ...
    def read_only(self):
        """
        Gets the read_only of this RightsBundle.

        :return: The read_only of this RightsBundle.
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """
        Sets the read_only of this RightsBundle.

        :param read_only: The read_only of this RightsBundle.
        :type: bool
        """
    ...
    def publish_all(self):
        """
        Gets the publish_all of this RightsBundle.
        Read-only value indicating publishAll state 

        :return: The publish_all of this RightsBundle.
        :rtype: bool
        """
    ...
    def publish_all(self, publish_all):
        """
        Sets the publish_all of this RightsBundle.
        Read-only value indicating publishAll state 

        :param publish_all: The publish_all of this RightsBundle.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RightsBundle):
            return False
