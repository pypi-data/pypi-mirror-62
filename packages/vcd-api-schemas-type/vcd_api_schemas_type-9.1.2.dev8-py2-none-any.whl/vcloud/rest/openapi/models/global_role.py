...
class GlobalRole(object):
    ...
    def __init__(self, name=None, id=None, description=None, bundle_key=None, read_only=None, publish_all=False):
        """
        GlobalRole - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this GlobalRole.

        :return: The name of this GlobalRole.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this GlobalRole.

        :param name: The name of this GlobalRole.
        :type: str
        """
        if name is None:
    ...
    def id(self):
        """
        Gets the id of this GlobalRole.

        :return: The id of this GlobalRole.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this GlobalRole.

        :param id: The id of this GlobalRole.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this GlobalRole.

        :return: The description of this GlobalRole.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this GlobalRole.

        :param description: The description of this GlobalRole.
        :type: str
        """
    ...
    def bundle_key(self):
        """
        Gets the bundle_key of this GlobalRole.

        :return: The bundle_key of this GlobalRole.
        :rtype: str
        """
    ...
    def bundle_key(self, bundle_key):
        """
        Sets the bundle_key of this GlobalRole.

        :param bundle_key: The bundle_key of this GlobalRole.
        :type: str
        """
    ...
    def read_only(self):
        """
        Gets the read_only of this GlobalRole.

        :return: The read_only of this GlobalRole.
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """
        Sets the read_only of this GlobalRole.

        :param read_only: The read_only of this GlobalRole.
        :type: bool
        """
    ...
    def publish_all(self):
        """
        Gets the publish_all of this GlobalRole.
        Read-only value indicating publishAll state 

        :return: The publish_all of this GlobalRole.
        :rtype: bool
        """
    ...
    def publish_all(self, publish_all):
        """
        Sets the publish_all of this GlobalRole.
        Read-only value indicating publishAll state 

        :param publish_all: The publish_all of this GlobalRole.
        :type: bool
        """
