...
class LdapTestResult(object):
    ...
    """
    swagger_types = {
        'connection_test': 'LdapConnectionTestResult',
        'settings_test': 'list[LdapSettingsTestResult]'
    }
    ...
    def __init__(self, connection_test=None, settings_test=None):
        """
        LdapTestResult - a model defined in Swagger
        """

        self._connection_test = None
        self._settings_test = None

        if connection_test is not None:
          self.connection_test = connection_test
        if settings_test is not None:
          self.settings_test = settings_test

    @property
    def connection_test(self):
        """
        Gets the connection_test of this LdapTestResult.

        :return: The connection_test of this LdapTestResult.
        :rtype: LdapConnectionTestResult
        """
        return self._connection_test

    @connection_test.setter
    def connection_test(self, connection_test):
        """
        Sets the connection_test of this LdapTestResult.

        :param connection_test: The connection_test of this LdapTestResult.
    ...
    def settings_test(self):
        """
        Gets the settings_test of this LdapTestResult.

        :return: The settings_test of this LdapTestResult.
        :rtype: list[LdapSettingsTestResult]
        """
        return self._settings_test

    @settings_test.setter
    def settings_test(self, settings_test):
        """
        Sets the settings_test of this LdapTestResult.

        :param settings_test: The settings_test of this LdapTestResult.
        :type: list[LdapSettingsTestResult]
        """

        self._settings_test = settings_test
