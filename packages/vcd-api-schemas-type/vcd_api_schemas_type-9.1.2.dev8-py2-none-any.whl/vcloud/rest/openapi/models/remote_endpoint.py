...
class RemoteEndpoint(object):
    ...
    def __init__(self, remote_id=None, remote_address=None, remote_networks=None):
        """
        RemoteEndpoint - a model defined in Swagger
        """

        self._remote_id = None
        self._remote_address = None
        self._remote_networks = None
    ...
    def remote_id(self):
        """
        Gets the remote_id of this RemoteEndpoint.
        This Remote ID is needed to uniquely identify the peer site. The Remote ID is the public IP Address of the remote device terminating the VPN Tunnel. When NAT is configured on the Remote ID, enter the private IP Address of the Remote Site. If remote ID is not set, VCD will set the remote Id to the remote address. 

        :return: The remote_id of this RemoteEndpoint.
        :rtype: str
        """
    ...
    def remote_id(self, remote_id):
        """
        Sets the remote_id of this RemoteEndpoint.
        This Remote ID is needed to uniquely identify the peer site. The Remote ID is the public IP Address of the remote device terminating the VPN Tunnel. When NAT is configured on the Remote ID, enter the private IP Address of the Remote Site. If remote ID is not set, VCD will set the remote Id to the remote address. 

        :param remote_id: The remote_id of this RemoteEndpoint.
        :type: str
        """
    ...
    def remote_address(self):
        """
        Gets the remote_address of this RemoteEndpoint.
        ...
        :return: The remote_address of this RemoteEndpoint.
        :rtype: str
        """
    ...
    def remote_address(self, remote_address):
        """
        Sets the remote_address of this RemoteEndpoint.
        IPV4 Address of the remote endpoint on the remote site. This is the Public IPv4 Address of the remote device terminating the VPN connection.

        :param remote_address: The remote_address of this RemoteEndpoint.
        :type: str
        """
        if remote_address is None:
            raise ValueError("Invalid value for `remote_address`, must not be `None`")
    ...
    def remote_networks(self):
        """
        Gets the remote_networks of this RemoteEndpoint.
        ...
        :return: The remote_networks of this RemoteEndpoint.
        :rtype: list[str]
        """
        return self._remote_networks

    @remote_networks.setter
    def remote_networks(self, remote_networks):
        """
        Sets the remote_networks of this RemoteEndpoint.
        List of remote networks. These must be specified in normal Network CIDR format. Specifying no value is interpreted as 0.0.0.0/0

        :param remote_networks: The remote_networks of this RemoteEndpoint.
        :type: list[str]
        """

        self._remote_networks = remote_networks
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RemoteEndpoint):
            return False
