...
class Subnets(object):
    ...
    def __init__(self, values=None):
        """
        Subnets - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this Subnets.

        :return: The values of this Subnets.
        :rtype: list[Subnet]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Subnets.

        :param values: The values of this Subnets.
        :type: list[Subnet]
        """
