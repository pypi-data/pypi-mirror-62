...
class NetworkProviderContext(object):
    """
    ...
    def __init__(self, org_ref=None, context_entity_id=None, network_provider_scope=None):
        """
        NetworkProviderContext - a model defined in Swagger
        """
    ...
    def org_ref(self, org_ref):
        """
        Sets the org_ref of this NetworkProviderContext.
        The organization that this object belongs to. This property is required during creation and cannot be updated. 

        :param org_ref: The org_ref of this NetworkProviderContext.
    ...
    def context_entity_id(self):
        """
        Gets the context_entity_id of this NetworkProviderContext.
        The context under which this object is created. The context can the id of either the organization vDC or the network provider. This field is required on object creation and is unset on object reads. This same context ID can be used in the context filter field when querying for the list of objects. 

        :return: The context_entity_id of this NetworkProviderContext.
        :rtype: str
        """
    ...
    def context_entity_id(self, context_entity_id):
        """
        Sets the context_entity_id of this NetworkProviderContext.
        The context under which this object is created. The context can the id of either the organization vDC or the network provider. This field is required on object creation and is unset on object reads. This same context ID can be used in the context filter field when querying for the list of objects. 

        :param context_entity_id: The context_entity_id of this NetworkProviderContext.
        :type: str
        """
    ...
    def network_provider_scope(self):
        """
        Gets the network_provider_scope of this NetworkProviderContext.
        ...
        :return: The network_provider_scope of this NetworkProviderContext.
        :rtype: str
        """
    ...
    def network_provider_scope(self, network_provider_scope):
        """
        Sets the network_provider_scope of this NetworkProviderContext.
        The network provider scope that this object belongs to. This is a read-only property and is determined by the input context entity ID during object creation. 

        :param network_provider_scope: The network_provider_scope of this NetworkProviderContext.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NetworkProviderContext):
            return False
