...
class Proxy(object):
    ...
    def __init__(self, name=None, id=None, parent_id=None, enabled=True, tenant_visible=False, target_host=None, active=False, token=None, default_proxy=False, parent_proxy_id=None, ui_url='', proxy_type=None):
        """
    ...
    def parent_id(self):
        """
        Gets the parent_id of this Proxy.
        URN of the parent VSPHERE. This is not editable once the proxy has been created.

        :return: The parent_id of this Proxy.
        :rtype: str
        """
    ...
    def parent_id(self, parent_id):
        """
        Sets the parent_id of this Proxy.
        URN of the parent VSPHERE. This is not editable once the proxy has been created.

        :param parent_id: The parent_id of this Proxy.
        :type: str
        """
    ...
    def default_proxy(self):
        """
        Gets the default_proxy of this Proxy.
        True if this is the default proxy for the parent VSPHERE. A proxy being the default for the VSPHERE means that this proxy's UI will be launched when the VSPHERE tile is clicked in the H5 Tenant UI of VCD. If no default proxy is set, clicking the VSPHERE tile will be a no-op. 

        :return: The default_proxy of this Proxy.
        :rtype: bool
        """
    ...
    def default_proxy(self, default_proxy):
        """
        Sets the default_proxy of this Proxy.
        True if this is the default proxy for the parent VSPHERE. A proxy being the default for the VSPHERE means that this proxy's UI will be launched when the VSPHERE tile is clicked in the H5 Tenant UI of VCD. If no default proxy is set, clicking the VSPHERE tile will be a no-op. 

        :param default_proxy: The default_proxy of this Proxy.
        :type: bool
        """
    ...
    def parent_proxy_id(self):
        """
        Gets the parent_proxy_id of this Proxy.
        ...
        :return: The parent_proxy_id of this Proxy.
        :rtype: str
        """
    ...
    def parent_proxy_id(self, parent_proxy_id):
        """
        Sets the parent_proxy_id of this Proxy.
        The URN of the parent proxy. If a proxy has a parent, the proxy is activated along with its parent and shares the token with its parent. Each proxy may only have one parent. A parent proxy cannot have a parent of its own. 

        :param parent_proxy_id: The parent_proxy_id of this Proxy.
        :type: str
        """
