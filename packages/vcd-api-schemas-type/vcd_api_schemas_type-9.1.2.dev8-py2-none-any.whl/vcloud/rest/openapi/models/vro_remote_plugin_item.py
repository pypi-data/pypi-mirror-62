...
class VroRemotePluginItem(object):
    """
    ...
    def __init__(self, name=None, type_href=None, selectable=None, can_have_children=None):
        """
        VroRemotePluginItem - a model defined in Swagger
        """

        self._name = None
        self._type_href = None
        self._selectable = None
        self._can_have_children = None

        if name is not None:
          self.name = name
        if type_href is not None:
    ...
    def name(self):
        """
        Gets the name of this VroRemotePluginItem.

        :return: The name of this VroRemotePluginItem.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this VroRemotePluginItem.

        :param name: The name of this VroRemotePluginItem.
        :type: str
        """
    ...
    def type_href(self):
        """
        Gets the type_href of this VroRemotePluginItem.

        :return: The type_href of this VroRemotePluginItem.
        :rtype: str
        """
        return self._type_href

    @type_href.setter
    def type_href(self, type_href):
        """
        Sets the type_href of this VroRemotePluginItem.

        :param type_href: The type_href of this VroRemotePluginItem.
        :type: str
        """

        self._type_href = type_href

    @property
    def selectable(self):
        """
        Gets the selectable of this VroRemotePluginItem.

        :return: The selectable of this VroRemotePluginItem.
        :rtype: bool
        """
    ...
    def selectable(self, selectable):
        """
        Sets the selectable of this VroRemotePluginItem.

        :param selectable: The selectable of this VroRemotePluginItem.
        :type: bool
        """
    ...
    def can_have_children(self):
        """
        Gets the can_have_children of this VroRemotePluginItem.

        :return: The can_have_children of this VroRemotePluginItem.
        :rtype: bool
        """
    ...
    def can_have_children(self, can_have_children):
        """
        Sets the can_have_children of this VroRemotePluginItem.

        :param can_have_children: The can_have_children of this VroRemotePluginItem.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VroRemotePluginItem):
            return False
