...
class UiBrandingMenuItem(object):
    """
    ...
    def __init__(self, name=None, menu_item_type=None, url=None):
        """
        UiBrandingMenuItem - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this UiBrandingMenuItem.

        :return: The name of this UiBrandingMenuItem.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this UiBrandingMenuItem.

        :param name: The name of this UiBrandingMenuItem.
        :type: str
        """
    ...
    def menu_item_type(self):
        """
        Gets the menu_item_type of this UiBrandingMenuItem.

        :return: The menu_item_type of this UiBrandingMenuItem.
        :rtype: str
        """
    ...
    def menu_item_type(self, menu_item_type):
        """
        Sets the menu_item_type of this UiBrandingMenuItem.

        :param menu_item_type: The menu_item_type of this UiBrandingMenuItem.
        :type: str
        """
        if menu_item_type is None:
            raise ValueError("Invalid value for `menu_item_type`, must not be `None`")
        allowed_values = ["link", "section", "override", "separator"]
    ...
    def url(self):
        """
        Gets the url of this UiBrandingMenuItem.

        :return: The url of this UiBrandingMenuItem.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        """
        Sets the url of this UiBrandingMenuItem.

        :param url: The url of this UiBrandingMenuItem.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UiBrandingMenuItem):
            return False
