...
class Cells(object):
    ...
    def result_total(self):
        """
        Gets the result_total of this Cells.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this Cells.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this Cells.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this Cells.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this Cells.
        How many pages there are in total.

        :return: The page_count of this Cells.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this Cells.
        How many pages there are in total.

        :param page_count: The page_count of this Cells.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this Cells.
        The page that was fetched, 1-indexed.

        :return: The page of this Cells.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this Cells.
        The page that was fetched, 1-indexed.

        :param page: The page of this Cells.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this Cells.
        Result count for page that was fetched.

        :return: The page_size of this Cells.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this Cells.
        Result count for page that was fetched.

        :param page_size: The page_size of this Cells.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this Cells.
        Association info for each result.

        :return: The associations of this Cells.
    ...
    def associations(self, associations):
        """
        Sets the associations of this Cells.
        Association info for each result.

        :param associations: The associations of this Cells.
    ...
    def values(self):
        """
        Gets the values of this Cells.

        :return: The values of this Cells.
        :rtype: list[Cell]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Cells.

        :param values: The values of this Cells.
        :type: list[Cell]
        """
