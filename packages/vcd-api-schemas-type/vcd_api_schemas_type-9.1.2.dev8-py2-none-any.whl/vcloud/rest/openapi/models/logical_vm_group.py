...
class LogicalVmGroup(object):
    ...
    def __init__(self, id=None, description='', name=None, named_vm_group_references=None, pvdc_id=None):
        """
        LogicalVmGroup - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this LogicalVmGroup.
        UUID for LogicalVmGroup. This is immutable. 

        :return: The id of this LogicalVmGroup.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this LogicalVmGroup.
        UUID for LogicalVmGroup. This is immutable. 

        :param id: The id of this LogicalVmGroup.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this LogicalVmGroup.

        :return: The description of this LogicalVmGroup.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this LogicalVmGroup.

        :param description: The description of this LogicalVmGroup.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this LogicalVmGroup.
        Display name. 

        :return: The name of this LogicalVmGroup.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this LogicalVmGroup.
        Display name. 

        :param name: The name of this LogicalVmGroup.
        :type: str
        """
        if name is None:
    ...
    def named_vm_group_references(self):
        """
        Gets the named_vm_group_references of this LogicalVmGroup.
        List of named vm groups associated with logical vm group. 

        :return: The named_vm_group_references of this LogicalVmGroup.
    ...
    def named_vm_group_references(self, named_vm_group_references):
        """
        Sets the named_vm_group_references of this LogicalVmGroup.
        List of named vm groups associated with logical vm group. 

        :param named_vm_group_references: The named_vm_group_references of this LogicalVmGroup.
    ...
    def pvdc_id(self):
        """
        Gets the pvdc_id of this LogicalVmGroup.
        URN for Provider vDC. 

        :return: The pvdc_id of this LogicalVmGroup.
        :rtype: str
        """
    ...
    def pvdc_id(self, pvdc_id):
        """
        Sets the pvdc_id of this LogicalVmGroup.
        URN for Provider vDC. 

        :param pvdc_id: The pvdc_id of this LogicalVmGroup.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LogicalVmGroup):
            return False
