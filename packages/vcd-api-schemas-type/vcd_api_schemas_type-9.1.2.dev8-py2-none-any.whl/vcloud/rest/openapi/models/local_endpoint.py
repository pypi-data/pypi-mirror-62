...
class LocalEndpoint(object):
    ...
    def __init__(self, local_id=None, local_address=None, local_networks=None):
        """
        LocalEndpoint - a model defined in Swagger
        """
    ...
    def local_id(self):
        """
        Gets the local_id of this LocalEndpoint.
        The local identifier for the endpoint.

        :return: The local_id of this LocalEndpoint.
        :rtype: str
        """
    ...
    def local_id(self, local_id):
        """
        Sets the local_id of this LocalEndpoint.
        The local identifier for the endpoint.

        :param local_id: The local_id of this LocalEndpoint.
        :type: str
        """
    ...
    def local_address(self, local_address):
        """
        Sets the local_address of this LocalEndpoint.
        The IPV4 Address for the endpoint. This has to be a suballocated IP on the Edge Gateway. This is required.

        :param local_address: The local_address of this LocalEndpoint.
        :type: str
        """
        if local_address is None:
            raise ValueError("Invalid value for `local_address`, must not be `None`")
    ...
    def local_networks(self):
        """
        Gets the local_networks of this LocalEndpoint.
        ...
        :return: The local_networks of this LocalEndpoint.
        :rtype: list[str]
        """
    ...
    def local_networks(self, local_networks):
        """
        Sets the local_networks of this LocalEndpoint.
        List of local networks. These must be specified in normal Network CIDR format. Specifying no value is interpreted as 0.0.0.0/0.

        :param local_networks: The local_networks of this LocalEndpoint.
        :type: list[str]
        """
        if local_networks is None:
            raise ValueError("Invalid value for `local_networks`, must not be `None`")
