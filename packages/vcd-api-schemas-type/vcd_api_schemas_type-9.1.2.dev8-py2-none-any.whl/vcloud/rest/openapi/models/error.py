...
class Error(object):
    ...
    def __init__(self, minor_error_code=None, message=None, stack_trace=None):
        """
    ...
    def minor_error_code(self):
        """
        Gets the minor_error_code of this Error.

        :return: The minor_error_code of this Error.
        :rtype: str
        """
    ...
    def minor_error_code(self, minor_error_code):
        ...
        :param minor_error_code: The minor_error_code of this Error.
        :type: str
        """
        if minor_error_code is None:
            raise ValueError("Invalid value for `minor_error_code`, must not be `None`")
