...
class NsxVTransportZones(object):
    """
    ...
    def __init__(self, values=None):
        """
        NsxVTransportZones - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this NsxVTransportZones.

        :return: The values of this NsxVTransportZones.
        :rtype: list[NsxVTransportZone]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this NsxVTransportZones.

        :param values: The values of this NsxVTransportZones.
        :type: list[NsxVTransportZone]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NsxVTransportZones):
            return False
