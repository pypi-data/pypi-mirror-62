...
class PresentationElement(object):
    """
    ...
    def __init__(self, element_type=None, description=None, display_name=None, hidden=None, id=None, messages=None):
        """
        PresentationElement - a model defined in Swagger
        """
    ...
    def element_type(self):
        """
        Gets the element_type of this PresentationElement.

        :return: The element_type of this PresentationElement.
        :rtype: str
        """
    ...
    def element_type(self, element_type):
        """
        Sets the element_type of this PresentationElement.

        :param element_type: The element_type of this PresentationElement.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this PresentationElement.

        :return: The description of this PresentationElement.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this PresentationElement.

        :param description: The description of this PresentationElement.
        :type: str
        """
    ...
    def display_name(self):
        """
        Gets the display_name of this PresentationElement.

        :return: The display_name of this PresentationElement.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this PresentationElement.

        :param display_name: The display_name of this PresentationElement.
        :type: str
        """
    ...
    def hidden(self):
        """
        Gets the hidden of this PresentationElement.

        :return: The hidden of this PresentationElement.
        :rtype: bool
        """
        return self._hidden
    ...
    def hidden(self, hidden):
        """
        Sets the hidden of this PresentationElement.

        :param hidden: The hidden of this PresentationElement.
        :type: bool
        """
    ...
    def id(self):
        """
        Gets the id of this PresentationElement.

        :return: The id of this PresentationElement.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this PresentationElement.

        :param id: The id of this PresentationElement.
        :type: str
        """
    ...
    def messages(self):
        """
        Gets the messages of this PresentationElement.

        :return: The messages of this PresentationElement.
    ...
    def messages(self, messages):
        """
        Sets the messages of this PresentationElement.

        :param messages: The messages of this PresentationElement.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PresentationElement):
            return False
