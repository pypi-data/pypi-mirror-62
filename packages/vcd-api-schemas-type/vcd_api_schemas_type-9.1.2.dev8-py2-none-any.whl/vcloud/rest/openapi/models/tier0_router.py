...
class Tier0Router(object):
    ...
    def __init__(self, id=None, description=None, display_name=None):
        """
        Tier0Router - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this Tier0Router.
        The unique id of the router. Field is sortable.

        :return: The id of this Tier0Router.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Tier0Router.
        The unique id of the router. Field is sortable.

        :param id: The id of this Tier0Router.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this Tier0Router.
        The description of the router.

        :return: The description of this Tier0Router.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this Tier0Router.
        The description of the router.

        :param description: The description of this Tier0Router.
        :type: str
        """
    ...
    def display_name(self):
        """
        Gets the display_name of this Tier0Router.
        Name used in NSX-T's logs or GUI. Field is sortable.

        :return: The display_name of this Tier0Router.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this Tier0Router.
        Name used in NSX-T's logs or GUI. Field is sortable.

        :param display_name: The display_name of this Tier0Router.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tier0Router):
            return False
