...
class NsxVTransportZone(object):
    """
    ...
    def __init__(self, id=None, name=None, type=None):
        """
        NsxVTransportZone - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this NsxVTransportZone.
        The unique id of the transport zone on the NSX manager.

        :return: The id of this NsxVTransportZone.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this NsxVTransportZone.
        The unique id of the transport zone on the NSX manager.

        :param id: The id of this NsxVTransportZone.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this NsxVTransportZone.
        Name of Transport Zone in NSX Manager.

        :return: The name of this NsxVTransportZone.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this NsxVTransportZone.
        Name of Transport Zone in NSX Manager.

        :param name: The name of this NsxVTransportZone.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this NsxVTransportZone.
        Type of a transport zone.

        :return: The type of this NsxVTransportZone.
        :rtype: NsxVTransportZoneType
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this NsxVTransportZone.
        Type of a transport zone.

        :param type: The type of this NsxVTransportZone.
        :type: NsxVTransportZoneType
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NsxVTransportZone):
            return False
