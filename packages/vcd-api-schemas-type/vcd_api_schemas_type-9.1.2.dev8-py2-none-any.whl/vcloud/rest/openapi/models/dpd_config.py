...
class DpdConfig(object):
    ...
    def __init__(self, probe_interval=None):
        """
        DpdConfig - a model defined in Swagger
        """
    ...
    def probe_interval(self):
        """
        Gets the probe_interval of this DpdConfig.
        ...
        :return: The probe_interval of this DpdConfig.
        :rtype: int
        """
    ...
    def probe_interval(self, probe_interval):
        """
        Sets the probe_interval of this DpdConfig.
        The value of the probe interval in seconds. This defines a periodic interval for DPD probes. The minimum is 3 seconds and the maximum is 60 seconds.

        :param probe_interval: The probe_interval of this DpdConfig.
        :type: int
        """
        if probe_interval is None:
            raise ValueError("Invalid value for `probe_interval`, must not be `None`")
        if probe_interval is not None and probe_interval > 60:
            raise ValueError("Invalid value for `probe_interval`, must be a value less than or equal to `60`")
        if probe_interval is not None and probe_interval < 3:
            raise ValueError("Invalid value for `probe_interval`, must be a value greater than or equal to `3`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DpdConfig):
            return False
