...
class UniversalRoutes(object):
    ...
    swagger_types = {
        ...
        'values': 'list[UniversalRoute]',
        'provider_scopes_to_force_unconfigure': 'list[str]'
    }

    attribute_map = {
        'keep_alive_timer': 'keepAliveTimer',
        'values': 'values',
        'provider_scopes_to_force_unconfigure': 'providerScopesToForceUnconfigure'
    }

    def __init__(self, keep_alive_timer=None, values=None, provider_scopes_to_force_unconfigure=None):
        """
        UniversalRoutes - a model defined in Swagger
        """

        self._keep_alive_timer = None
        self._values = None
        self._provider_scopes_to_force_unconfigure = None

        if keep_alive_timer is not None:
          self.keep_alive_timer = keep_alive_timer
        if values is not None:
          self.values = values
        if provider_scopes_to_force_unconfigure is not None:
          self.provider_scopes_to_force_unconfigure = provider_scopes_to_force_unconfigure

    @property
    def keep_alive_timer(self):
        """
        Gets the keep_alive_timer of this UniversalRoutes.
        ...
        :return: The keep_alive_timer of this UniversalRoutes.
        :rtype: int
        """
    ...
    def keep_alive_timer(self, keep_alive_timer):
        """
        Sets the keep_alive_timer of this UniversalRoutes.
        The Keep Alive Timer is the frequency (in seconds) at which the Universal Router seeds Keep Alive messages to its egress peers.

        :param keep_alive_timer: The keep_alive_timer of this UniversalRoutes.
        :type: int
        """
    ...
    def values(self):
        """
        Gets the values of this UniversalRoutes.
        The list of Universal Routes.

        :return: The values of this UniversalRoutes.
        :rtype: list[UniversalRoute]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this UniversalRoutes.
        The list of Universal Routes.

        :param values: The values of this UniversalRoutes.
        :type: list[UniversalRoute]
        """

        self._values = values

    @property
    def provider_scopes_to_force_unconfigure(self):
        """
        Gets the provider_scopes_to_force_unconfigure of this UniversalRoutes.
        ...
        :return: The provider_scopes_to_force_unconfigure of this UniversalRoutes.
        :rtype: list[str]
        """
        return self._provider_scopes_to_force_unconfigure

    @provider_scopes_to_force_unconfigure.setter
    def provider_scopes_to_force_unconfigure(self, provider_scopes_to_force_unconfigure):
        """
        Sets the provider_scopes_to_force_unconfigure of this UniversalRoutes.
        The list network provider scopes whose route will be unconfigure forcefully. This means that a route that is in state that normally shouldn't be unconfigurable (i.e. NSX or remote vCD site is down) will still be unconfigured. Errors may be ignored. Note that this force option also affects any route update where a network provider's egress point is modified/changed. vCD will first unconfigure any existing egress point before configuring the new egress point. 

        :param provider_scopes_to_force_unconfigure: The provider_scopes_to_force_unconfigure of this UniversalRoutes.
        :type: list[str]
        """

        self._provider_scopes_to_force_unconfigure = provider_scopes_to_force_unconfigure
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UniversalRoutes):
            return False
