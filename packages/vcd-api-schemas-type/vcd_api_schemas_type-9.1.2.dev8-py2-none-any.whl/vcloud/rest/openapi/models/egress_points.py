...
class EgressPoints(object):
    ...
    def __init__(self, values=None):
        """
        EgressPoints - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this EgressPoints.
        The list of Universal Egress Points.

        :return: The values of this EgressPoints.
        :rtype: list[EgressPoint]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this EgressPoints.
        The list of Universal Egress Points.

        :param values: The values of this EgressPoints.
        :type: list[EgressPoint]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EgressPoints):
            return False
