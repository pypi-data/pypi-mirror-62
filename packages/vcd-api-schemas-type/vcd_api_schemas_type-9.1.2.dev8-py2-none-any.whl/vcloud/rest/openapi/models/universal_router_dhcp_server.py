...
class UniversalRouterDhcpServer(object):
    """
    ...
    """
    swagger_types = {
        'egress_ref': 'EntityReference',
        'server_address': 'str'
    }

    attribute_map = {
        'egress_ref': 'egressRef',
        'server_address': 'serverAddress'
    }

    def __init__(self, egress_ref=None, server_address=None):
        """
        UniversalRouterDhcpServer - a model defined in Swagger
        """

        self._egress_ref = None
        self._server_address = None

        if egress_ref is not None:
          self.egress_ref = egress_ref
    ...
    def egress_ref(self):
        """
        Gets the egress_ref of this UniversalRouterDhcpServer.

        :return: The egress_ref of this UniversalRouterDhcpServer.
        :rtype: EntityReference
        """
        return self._egress_ref

    @egress_ref.setter
    def egress_ref(self, egress_ref):
        """
        Sets the egress_ref of this UniversalRouterDhcpServer.

        :param egress_ref: The egress_ref of this UniversalRouterDhcpServer.
        :type: EntityReference
        """

        self._egress_ref = egress_ref

    @property
    def server_address(self):
        """
        Gets the server_address of this UniversalRouterDhcpServer.

        :return: The server_address of this UniversalRouterDhcpServer.
        :rtype: str
        """
    ...
    def server_address(self, server_address):
        """
        Sets the server_address of this UniversalRouterDhcpServer.

        :param server_address: The server_address of this UniversalRouterDhcpServer.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UniversalRouterDhcpServer):
            return False
