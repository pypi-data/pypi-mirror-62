...
class Tier0Routers(object):
    ...
    def __init__(self, values=None):
        """
        Tier0Routers - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this Tier0Routers.

        :return: The values of this Tier0Routers.
        :rtype: list[Tier0Router]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Tier0Routers.

        :param values: The values of this Tier0Routers.
        :type: list[Tier0Router]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tier0Routers):
            return False
