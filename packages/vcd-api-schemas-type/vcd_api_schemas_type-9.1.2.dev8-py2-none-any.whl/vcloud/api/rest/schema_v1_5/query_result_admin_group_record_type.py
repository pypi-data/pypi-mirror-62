...
class QueryResultAdminGroupRecordType(QueryResultRecordType):
    ...
    def __init__(self, identity_provider_type=None,is_read_only=None,name=None,org=None,role_name=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueryResultAdminGroupRecordType):
            return False
