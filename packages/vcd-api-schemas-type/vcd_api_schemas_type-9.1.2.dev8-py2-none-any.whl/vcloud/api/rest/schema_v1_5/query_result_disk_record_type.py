...
class QueryResultDiskRecordType(QueryResultRecordType):
    ...
    def __init__(self, bus_sub_type=None,bus_type=None,bus_type_desc=None,datastore=None,datastore_name=None,is_attached=None,name=None,owner_name=None,size_b=None,status=None,storage_profile=None,storage_profile_name=None,task=None,vdc=None,vdc_name=None):
