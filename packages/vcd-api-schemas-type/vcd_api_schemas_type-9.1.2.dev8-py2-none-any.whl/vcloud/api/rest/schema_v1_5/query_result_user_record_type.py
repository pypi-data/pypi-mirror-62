...
class QueryResultUserRecordType(QueryResultRecordType):
    ...
    def __init__(self, deployed_vm_quota=None,full_name=None,identity_provider_type=None,is_enabled=None,is_ldap_user=None,name=None,number_of_deployed_v_ms=None,number_of_stored_v_ms=None,stored_vm_quota=None):
