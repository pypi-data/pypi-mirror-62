...
class AllocationVappVdcTemplateSpecificationType(VdcTemplateSpecificationType):
    """
    ...
    def __init__(self, cpu_allocation_mhz=None,cpu_limit_mhz_per_vcpu=None,memory_allocation_mb=None,cpu_guaranteed_percentage=None,memory_guaranteed_percentage=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllocationVappVdcTemplateSpecificationType):
            return False
