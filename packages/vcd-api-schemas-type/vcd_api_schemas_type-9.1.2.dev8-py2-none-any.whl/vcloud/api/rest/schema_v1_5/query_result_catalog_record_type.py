...
class QueryResultCatalogRecordType(QueryResultRecordType):
    ...
    def __init__(self, creation_date=None,description=None,is_published=None,is_shared=None,name=None,number_of_media=None,number_of_v_app_templates=None,org_name=None,owner=None,owner_name=None,publish_subscription_type=None,status=None,version=None):
