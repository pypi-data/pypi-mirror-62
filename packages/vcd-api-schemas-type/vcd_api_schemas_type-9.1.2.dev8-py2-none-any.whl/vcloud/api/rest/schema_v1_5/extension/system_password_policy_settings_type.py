...
class SystemPasswordPolicySettingsType(ResourceType):
    """
    ...
    swagger_types = {
        ...
        'admin_account_lockout_enabled': 'bool',
    ...
    attribute_map = {
        ...
        'admin_account_lockout_enabled': 'adminAccountLockoutEnabled',
        'invalid_logins_before_lockout': 'invalidLoginsBeforeLockout',
        'account_lockout_interval_minutes': 'accountLockoutIntervalMinutes'
    }

    def __init__(self, account_lockout_enabled=None,admin_account_lockout_enabled=None,invalid_logins_before_lockout=None,account_lockout_interval_minutes=None):
        self._account_lockout_enabled = None
        self._admin_account_lockout_enabled = None
        ...
        if admin_account_lockout_enabled is not None:
            self.admin_account_lockout_enabled = admin_account_lockout_enabled
    ...
    @property
    def admin_account_lockout_enabled(self):
        return self._admin_account_lockout_enabled
    
    @admin_account_lockout_enabled.setter
    def admin_account_lockout_enabled(self, admin_account_lockout_enabled):
        self._admin_account_lockout_enabled = admin_account_lockout_enabled
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemPasswordPolicySettingsType):
            return False
