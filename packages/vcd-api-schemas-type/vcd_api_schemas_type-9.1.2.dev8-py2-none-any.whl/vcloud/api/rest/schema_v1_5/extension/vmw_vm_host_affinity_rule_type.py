...
class VMWVmHostAffinityRuleType(AffinityRuleType):
    """
    ...
    def __init__(self, host_group_name=None,vm_group_name=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMWVmHostAffinityRuleType):
            return False
