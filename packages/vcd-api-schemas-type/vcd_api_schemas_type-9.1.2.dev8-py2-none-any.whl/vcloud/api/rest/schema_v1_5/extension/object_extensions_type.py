...
class ObjectExtensionsType(ResourceType):
    """
    ...
    """
    swagger_types = {
        'object_extension': 'list[ObjectExtensionType]'
    }

    attribute_map = {
        'object_extension': 'objectExtension'
    }

    def __init__(self, object_extension=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectExtensionsType):
            return False
