...
class AdminServiceLinksType(VCloudExtensibleType):
    """
    ...
    """
    swagger_types = {
        'service_link': 'list[AdminServiceLinkType]'
    }
    ...
    def __init__(self, service_link=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdminServiceLinksType):
            return False
