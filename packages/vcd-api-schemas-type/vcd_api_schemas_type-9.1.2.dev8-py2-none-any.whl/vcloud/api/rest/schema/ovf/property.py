...
class Property(object):
    ...
    def __init__(self, label=None,description=None,value_element=None,key=None,password=None,qualifiers=None,type=None,user_configurable=None,value_attrib=None,other_attributes=None):
        self._label = None
