...
class VMWReservationPoolVdcTemplateSpecificationType(VMWVdcTemplateSpecificationType):
    """
    ...
    def __init__(self, cpu_allocation_mhz=None,memory_allocation_mb=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMWReservationPoolVdcTemplateSpecificationType):
            return False
