...
class ImportVmAsVAppTemplateParamsType(ParamsType):
    ...
    def __init__(self, vm_name=None,v_app_scoped_local_id=None,computer_name=None,vm_mo_ref=None,vdc=None,vdc_storage_profile=None,catalog=None,gold_master=None,source_move=None):
        self._vm_name = None
