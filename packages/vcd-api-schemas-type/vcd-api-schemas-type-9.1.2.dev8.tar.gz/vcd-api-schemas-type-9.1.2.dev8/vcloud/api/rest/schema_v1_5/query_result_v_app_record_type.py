...
class QueryResultVAppRecordType(QueryResultRecordType):
    ...
    def __init__(self, creation_date=None,is_auto_nature=None,is_busy=None,is_deployed=None,is_enabled=None,is_expired=None,is_in_maintenance_mode=None,is_public=None,name=None,owner_name=None,status=None,vdc=None,vdc_name=None):
