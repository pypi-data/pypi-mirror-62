...
class PayGoVdcSummaryType(VCloudExtensibleType):
    """
    ...
    def __init__(self, memory_consumption_mb=None,cpu_consumption_mhz=None,storage_consumption_mb=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayGoVdcSummaryType):
            return False
