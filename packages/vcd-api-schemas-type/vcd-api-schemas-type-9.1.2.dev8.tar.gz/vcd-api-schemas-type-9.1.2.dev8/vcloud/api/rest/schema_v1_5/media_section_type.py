...
class MediaSectionType(VCloudExtensibleType):
    """
    ...
    """
    swagger_types = {
        'media_settings': 'list[MediaSettingsType]'
    }
    ...
    def __init__(self, media_settings=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MediaSectionType):
            return False
