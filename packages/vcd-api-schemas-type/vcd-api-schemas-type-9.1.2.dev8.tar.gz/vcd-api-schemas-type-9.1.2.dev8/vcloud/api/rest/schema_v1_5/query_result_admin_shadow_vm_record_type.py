...
class QueryResultAdminShadowVMRecordType(QueryResultRecordType):
    ...
    def __init__(self, datastore_name=None,is_busy=None,is_deleted=None,is_published=None,name=None,org=None,primary_v_app_name=None,primary_v_app_template=None,primary_vm=None,primary_vm_catalog=None,primary_vm_owner=None,primary_vm_name=None,shadow_v_app=None,status=None,vc_name=None):
