...
class NatPortForwardingRuleType(VCloudExtensibleType):
    ...
    def __init__(self, external_ip_address=None,external_port=None,internal_ip_address=None,internal_port=None,protocol=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NatPortForwardingRuleType):
            return False
