...
class CatalogsListType(VCloudExtensibleType):
    ...
    """
    swagger_types = {
        'catalog_reference': 'list[ReferenceType]'
    }
    ...
    def __init__(self, catalog_reference=None):
        self._catalog_reference = None
    ...
    def catalog_reference(self):
        return self._catalog_reference
    
    @catalog_reference.setter
    def catalog_reference(self, catalog_reference):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CatalogsListType):
            return False
