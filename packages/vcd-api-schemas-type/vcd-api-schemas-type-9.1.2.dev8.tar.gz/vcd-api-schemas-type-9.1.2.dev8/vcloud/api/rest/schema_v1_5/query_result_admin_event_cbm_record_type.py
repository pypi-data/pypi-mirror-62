...
class QueryResultAdminEventCBMRecordType(QueryResultRecordType):
    ...
    def __init__(self, details=None,entity=None,entity_name=None,entity_type=None,event_id=None,event_status=None,event_type=None,org=None,org_name=None,product_version=None,service_namespace=None,time_stamp=None,user_name=None):
        self._details = None
        self._entity = None
