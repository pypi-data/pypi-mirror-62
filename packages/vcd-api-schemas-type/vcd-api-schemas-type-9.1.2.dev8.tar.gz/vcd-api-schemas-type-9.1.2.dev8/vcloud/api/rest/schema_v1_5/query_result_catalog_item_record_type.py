...
class QueryResultCatalogItemRecordType(QueryResultRecordType):
    ...
    def __init__(self, catalog=None,catalog_name=None,creation_date=None,entity=None,entity_name=None,entity_type=None,is_expired=None,is_published=None,is_vdc_enabled=None,name=None,owner=None,owner_name=None,status=None,vdc=None,vdc_name=None):
        self._catalog = None
