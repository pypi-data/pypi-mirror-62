...
class VirtualDiskDescType(object):
    ...
    def __init__(self, any=None,capacity=None,capacity_allocation_units=None,disk_id=None,file_ref=None,format=None,parent_ref=None,populated_size=None,other_attributes=None):
        self._any = None
        self._capacity = None
