...
class UiTheme(object):
    ...
    def __init__(self, theme_type=None, name=None):
        """
        UiTheme - a model defined in Swagger
        """
    ...
    def theme_type(self):
        """
        Gets the theme_type of this UiTheme.

        :return: The theme_type of this UiTheme.
        :rtype: str
        """
        return self._theme_type

    @theme_type.setter
    def theme_type(self, theme_type):
        """
        Sets the theme_type of this UiTheme.

        :param theme_type: The theme_type of this UiTheme.
        :type: str
        """
        if theme_type is None:
            raise ValueError("Invalid value for `theme_type`, must not be `None`")
    ...
    def name(self):
        """
        Gets the name of this UiTheme.

        :return: The name of this UiTheme.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this UiTheme.

        :param name: The name of this UiTheme.
        :type: str
        """
        if name is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UiTheme):
            return False
