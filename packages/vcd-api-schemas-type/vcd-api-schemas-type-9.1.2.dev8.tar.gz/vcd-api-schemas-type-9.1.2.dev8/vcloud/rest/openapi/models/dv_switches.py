...
class DvSwitches(object):
    ...
    def __init__(self, result_total=None, page_count=None, page=None, page_size=None, associations=None, values=None):
        """
        DvSwitches - a model defined in Swagger
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this DvSwitches.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this DvSwitches.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this DvSwitches.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this DvSwitches.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this DvSwitches.
        How many pages there are in total.

        :return: The page_count of this DvSwitches.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this DvSwitches.
        How many pages there are in total.

        :param page_count: The page_count of this DvSwitches.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this DvSwitches.
        The page that was fetched, 1-indexed.

        :return: The page of this DvSwitches.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this DvSwitches.
        The page that was fetched, 1-indexed.

        :param page: The page of this DvSwitches.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this DvSwitches.
        Result count for page that was fetched.

        :return: The page_size of this DvSwitches.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this DvSwitches.
        Result count for page that was fetched.

        :param page_size: The page_size of this DvSwitches.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this DvSwitches.
        Association info for each result.

        :return: The associations of this DvSwitches.
    ...
    def associations(self, associations):
        """
        Sets the associations of this DvSwitches.
        Association info for each result.

        :param associations: The associations of this DvSwitches.
    ...
    def values(self):
        """
        Gets the values of this DvSwitches.

        :return: The values of this DvSwitches.
        :rtype: list[DvSwitch]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this DvSwitches.

        :param values: The values of this DvSwitches.
        :type: list[DvSwitch]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DvSwitches):
            return False
