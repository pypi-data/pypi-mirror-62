...
class ExecutionContext(object):
    ...
    def __init__(self, parameters=None):
        """
        ExecutionContext - a model defined in Swagger
        """
    ...
    def parameters(self):
        """
        Gets the parameters of this ExecutionContext.

        :return: The parameters of this ExecutionContext.
    ...
    def parameters(self, parameters):
        """
        Sets the parameters of this ExecutionContext.

        :param parameters: The parameters of this ExecutionContext.
