...
class CreateCustomEntityTypeAction(object):
    """
    ...
    def __init__(self, workflow_id=None, workflow_input_parameter=None):
        """
        CreateCustomEntityTypeAction - a model defined in Swagger
        """
    ...
    def workflow_id(self):
        """
        Gets the workflow_id of this CreateCustomEntityTypeAction.
        uuid of workflow. 

        :return: The workflow_id of this CreateCustomEntityTypeAction.
        :rtype: str
        """
    ...
    def workflow_id(self, workflow_id):
        """
        Sets the workflow_id of this CreateCustomEntityTypeAction.
        uuid of workflow. 

        :param workflow_id: The workflow_id of this CreateCustomEntityTypeAction.
        :type: str
        """
    ...
    def workflow_input_parameter(self):
        """
        Gets the workflow_input_parameter of this CreateCustomEntityTypeAction.
        Name of input parameter of given workflow to which this custom entity type should be mapped. 

        :return: The workflow_input_parameter of this CreateCustomEntityTypeAction.
        :rtype: str
        """
    ...
    def workflow_input_parameter(self, workflow_input_parameter):
        """
        Sets the workflow_input_parameter of this CreateCustomEntityTypeAction.
        Name of input parameter of given workflow to which this custom entity type should be mapped. 

        :param workflow_input_parameter: The workflow_input_parameter of this CreateCustomEntityTypeAction.
        :type: str
        """
        if workflow_input_parameter is None:
            raise ValueError("Invalid value for `workflow_input_parameter`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CreateCustomEntityTypeAction):
            return False
