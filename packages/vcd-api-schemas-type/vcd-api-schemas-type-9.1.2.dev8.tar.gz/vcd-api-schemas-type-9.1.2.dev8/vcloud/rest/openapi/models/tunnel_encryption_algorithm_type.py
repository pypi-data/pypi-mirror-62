...
class TunnelEncryptionAlgorithmType(object):
    """
    ...
    def __init__(self):
        """
        TunnelEncryptionAlgorithmType - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TunnelEncryptionAlgorithmType):
            return False
