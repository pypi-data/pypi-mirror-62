...
class FirewallGroups(object):
    ...
    swagger_types = {
        ...
        'values': 'list[FirewallGroupSummary]'
    }
    ...
    def __init__(self, result_total=None, page_count=None, page=None, page_size=None, associations=None, values=None):
        """
        FirewallGroups - a model defined in Swagger
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this FirewallGroups.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this FirewallGroups.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this FirewallGroups.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this FirewallGroups.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this FirewallGroups.
        How many pages there are in total.

        :return: The page_count of this FirewallGroups.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this FirewallGroups.
        How many pages there are in total.

        :param page_count: The page_count of this FirewallGroups.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this FirewallGroups.
        The page that was fetched, 1-indexed.

        :return: The page of this FirewallGroups.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this FirewallGroups.
        The page that was fetched, 1-indexed.

        :param page: The page of this FirewallGroups.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this FirewallGroups.
        Result count for page that was fetched.

        :return: The page_size of this FirewallGroups.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this FirewallGroups.
        Result count for page that was fetched.

        :param page_size: The page_size of this FirewallGroups.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this FirewallGroups.
        Association info for each result.

        :return: The associations of this FirewallGroups.
    ...
    def associations(self, associations):
        """
        Sets the associations of this FirewallGroups.
        Association info for each result.

        :param associations: The associations of this FirewallGroups.
    ...
    def values(self):
        """
        Gets the values of this FirewallGroups.

        :return: The values of this FirewallGroups.
        :rtype: list[FirewallGroupSummary]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this FirewallGroups.

        :param values: The values of this FirewallGroups.
        :type: list[FirewallGroupSummary]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FirewallGroups):
            return False
