...
class AllocatedIpAddress(object):
    """
    ...
    swagger_types = {
        ...
        'ip_address': 'str',
        'deployed': 'bool',
        'allocation_type': 'AllocatedIpAddressAllocationType',
    ...
    def __init__(self, id=None, entity_id=None, entity_name=None, v_app_name=None, ip_address=None, deployed=None, allocation_type=None, network_ref=None, org_ref=None):
        """
        AllocatedIpAddress - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this AllocatedIpAddress.
        Unique identifier for record. This is to support UI operations.

        :return: The id of this AllocatedIpAddress.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this AllocatedIpAddress.
        Unique identifier for record. This is to support UI operations.

        :param id: The id of this AllocatedIpAddress.
        :type: str
        """
    ...
    def entity_id(self):
        """
        Gets the entity_id of this AllocatedIpAddress.
        Id of the entity to which the IP address is allocated such as a VM.

        :return: The entity_id of this AllocatedIpAddress.
        :rtype: str
        """
    ...
    def entity_id(self, entity_id):
        """
        Sets the entity_id of this AllocatedIpAddress.
        Id of the entity to which the IP address is allocated such as a VM.

        :param entity_id: The entity_id of this AllocatedIpAddress.
        :type: str
        """
    ...
    def entity_name(self):
        """
        Gets the entity_name of this AllocatedIpAddress.
        Name of the entity to which the IP address is allocated.

        :return: The entity_name of this AllocatedIpAddress.
        :rtype: str
        """
    ...
    def entity_name(self, entity_name):
        """
        Sets the entity_name of this AllocatedIpAddress.
        Name of the entity to which the IP address is allocated.

        :param entity_name: The entity_name of this AllocatedIpAddress.
        :type: str
        """
    ...
    def v_app_name(self):
        """
        Gets the v_app_name of this AllocatedIpAddress.
        Name of the vApp whose VM is using allocated IP address.

        :return: The v_app_name of this AllocatedIpAddress.
        :rtype: str
        """
    ...
    def v_app_name(self, v_app_name):
        """
        Sets the v_app_name of this AllocatedIpAddress.
        Name of the vApp whose VM is using allocated IP address.

        :param v_app_name: The v_app_name of this AllocatedIpAddress.
        :type: str
        """
    ...
    def ip_address(self):
        """
        Gets the ip_address of this AllocatedIpAddress.
        The allocated IP address.

        :return: The ip_address of this AllocatedIpAddress.
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """
        Sets the ip_address of this AllocatedIpAddress.
        The allocated IP address.

        :param ip_address: The ip_address of this AllocatedIpAddress.
        :type: str
        """
    ...
    def deployed(self):
        """
        Gets the deployed of this AllocatedIpAddress.
        Whether the entity using this IP address is currently deployed.

        :return: The deployed of this AllocatedIpAddress.
        :rtype: bool
        """
    ...
    def deployed(self, deployed):
        """
        Sets the deployed of this AllocatedIpAddress.
        Whether the entity using this IP address is currently deployed.

        :param deployed: The deployed of this AllocatedIpAddress.
        :type: bool
        """
    ...
    def allocation_type(self):
        """
        Gets the allocation_type of this AllocatedIpAddress.
        The possible allocation types for allocated network address like VSM allocated, VM allocated or NAT routed.

        :return: The allocation_type of this AllocatedIpAddress.
        :rtype: AllocatedIpAddressAllocationType
        """
    ...
    def allocation_type(self, allocation_type):
        """
        Sets the allocation_type of this AllocatedIpAddress.
        The possible allocation types for allocated network address like VSM allocated, VM allocated or NAT routed.

        :param allocation_type: The allocation_type of this AllocatedIpAddress.
    ...
    def network_ref(self):
        """
        Gets the network_ref of this AllocatedIpAddress.
        The vApp network or Org vDC network to which this entity is connected. 

        :return: The network_ref of this AllocatedIpAddress.
    ...
    def network_ref(self, network_ref):
        """
        Sets the network_ref of this AllocatedIpAddress.
        The vApp network or Org vDC network to which this entity is connected. 

        :param network_ref: The network_ref of this AllocatedIpAddress.
    ...
    def org_ref(self):
        """
        Gets the org_ref of this AllocatedIpAddress.
        The organization that this entity belongs to. 

        :return: The org_ref of this AllocatedIpAddress.
        :rtype: EntityReference
        """
    ...
    def org_ref(self, org_ref):
        """
        Sets the org_ref of this AllocatedIpAddress.
        The organization that this entity belongs to. 

        :param org_ref: The org_ref of this AllocatedIpAddress.
        :type: EntityReference
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AllocatedIpAddress):
            return False
