...
class DvSwitch(object):
    ...
    def __init__(self, backing_ref=None, virtual_center=None):
        """
        DvSwitch - a model defined in Swagger
        """
    ...
    def backing_ref(self):
        """
        Gets the backing_ref of this DvSwitch.
        Contains the backing id and name of the distributed virtual switch.

        :return: The backing_ref of this DvSwitch.
        :rtype: BackingRef
        """
    ...
    def backing_ref(self, backing_ref):
        """
        Sets the backing_ref of this DvSwitch.
        Contains the backing id and name of the distributed virtual switch.

        :param backing_ref: The backing_ref of this DvSwitch.
        :type: BackingRef
        """
    ...
    def virtual_center(self):
        """
        Gets the virtual_center of this DvSwitch.
        The entity reference for the vCenter that contains this distributed virtual switch.

        :return: The virtual_center of this DvSwitch.
    ...
    def virtual_center(self, virtual_center):
        """
        Sets the virtual_center of this DvSwitch.
        The entity reference for the vCenter that contains this distributed virtual switch.

        :param virtual_center: The virtual_center of this DvSwitch.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DvSwitch):
            return False
