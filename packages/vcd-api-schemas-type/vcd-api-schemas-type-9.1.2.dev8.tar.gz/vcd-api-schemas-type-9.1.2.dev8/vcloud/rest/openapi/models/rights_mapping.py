...
class RightsMapping(object):
    ...
    def __init__(self, name=None, id=None, description=None, bundle_key=None, read_only=None):
        """
        RightsMapping - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this RightsMapping.

        :return: The name of this RightsMapping.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this RightsMapping.

        :param name: The name of this RightsMapping.
        :type: str
        """
        if name is None:
    ...
    def id(self):
        """
        Gets the id of this RightsMapping.

        :return: The id of this RightsMapping.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this RightsMapping.

        :param id: The id of this RightsMapping.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this RightsMapping.

        :return: The description of this RightsMapping.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RightsMapping.

        :param description: The description of this RightsMapping.
        :type: str
        """
    ...
    def bundle_key(self):
        """
        Gets the bundle_key of this RightsMapping.

        :return: The bundle_key of this RightsMapping.
        :rtype: str
        """
    ...
    def bundle_key(self, bundle_key):
        """
        Sets the bundle_key of this RightsMapping.

        :param bundle_key: The bundle_key of this RightsMapping.
        :type: str
        """
    ...
    def read_only(self):
        """
        Gets the read_only of this RightsMapping.

        :return: The read_only of this RightsMapping.
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """
        Sets the read_only of this RightsMapping.

        :param read_only: The read_only of this RightsMapping.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RightsMapping):
            return False
