...
class EdgeGatewaySubnets(object):
    """
    ...
    def __init__(self, values=None):
        """
        EdgeGatewaySubnets - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this EdgeGatewaySubnets.

        :return: The values of this EdgeGatewaySubnets.
        :rtype: list[EdgeGatewaySubnet]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this EdgeGatewaySubnets.

        :param values: The values of this EdgeGatewaySubnets.
        :type: list[EdgeGatewaySubnet]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeGatewaySubnets):
            return False
