...
class EgressPointReference(object):
    """
    ...
    def __init__(self, egress_point_id=None, vdc_ref=None, gateway_ref=None):
        """
        EgressPointReference - a model defined in Swagger
        """
    ...
    def egress_point_id(self):
        """
        Gets the egress_point_id of this EgressPointReference.
        The id of the Universal Egress Point reference.

        :return: The egress_point_id of this EgressPointReference.
        :rtype: str
        """
    ...
    def egress_point_id(self, egress_point_id):
        """
        Sets the egress_point_id of this EgressPointReference.
        The id of the Universal Egress Point reference.

        :param egress_point_id: The egress_point_id of this EgressPointReference.
        :type: str
        """
    ...
    def vdc_ref(self):
        """
        Gets the vdc_ref of this EgressPointReference.
        The Org vDC of the Universal Egress Point reference.

        :return: The vdc_ref of this EgressPointReference.
    ...
    def vdc_ref(self, vdc_ref):
        """
        Sets the vdc_ref of this EgressPointReference.
        The Org vDC of the Universal Egress Point reference.

        :param vdc_ref: The vdc_ref of this EgressPointReference.
    ...
    def gateway_ref(self):
        """
        Gets the gateway_ref of this EgressPointReference.
        The Edge Gateway of the Universal Egress Point reference.

        :return: The gateway_ref of this EgressPointReference.
        :rtype: EntityReference
        """
    ...
    def gateway_ref(self, gateway_ref):
        """
        Sets the gateway_ref of this EgressPointReference.
        The Edge Gateway of the Universal Egress Point reference.

        :param gateway_ref: The gateway_ref of this EgressPointReference.
        :type: EntityReference
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EgressPointReference):
            return False
