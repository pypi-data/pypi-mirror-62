...
class CustomEntityTypeAction(object):
    """
    ...
    swagger_types = {
        'name': 'str',
        'workflow_id': 'str',
        'workflow_input_parameter': 'str'
    }

    attribute_map = {
        'name': 'name',
        'workflow_id': 'workflowId',
        'workflow_input_parameter': 'workflowInputParameter'
    }

    def __init__(self, name=None, workflow_id=None, workflow_input_parameter=None):
        """
        CustomEntityTypeAction - a model defined in Swagger
        """

        self._name = None
        self._workflow_id = None
        self._workflow_input_parameter = None

        self.name = name
        self.workflow_id = workflow_id
        if workflow_input_parameter is not None:
          self.workflow_input_parameter = workflow_input_parameter

    @property
    def name(self):
        """
        Gets the name of this CustomEntityTypeAction.
        Name of workflow 

        :return: The name of this CustomEntityTypeAction.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CustomEntityTypeAction.
        Name of workflow 

        :param name: The name of this CustomEntityTypeAction.
        :type: str
        """
        if name is None:
    ...
    def workflow_id(self):
        """
        Gets the workflow_id of this CustomEntityTypeAction.
        UUID of workflow. 

        :return: The workflow_id of this CustomEntityTypeAction.
        :rtype: str
        """
    ...
    def workflow_id(self, workflow_id):
        """
        Sets the workflow_id of this CustomEntityTypeAction.
        UUID of workflow. 

        :param workflow_id: The workflow_id of this CustomEntityTypeAction.
        :type: str
        """
    ...
    @property
    def workflow_input_parameter(self):
        """
        Gets the workflow_input_parameter of this CustomEntityTypeAction.
        Name of input parameter of given workflow to which this custom entity type should be mapped. 

        :return: The workflow_input_parameter of this CustomEntityTypeAction.
        :rtype: str
        """
        return self._workflow_input_parameter

    @workflow_input_parameter.setter
    def workflow_input_parameter(self, workflow_input_parameter):
        """
        Sets the workflow_input_parameter of this CustomEntityTypeAction.
        Name of input parameter of given workflow to which this custom entity type should be mapped. 

        :param workflow_input_parameter: The workflow_input_parameter of this CustomEntityTypeAction.
        :type: str
        """

        self._workflow_input_parameter = workflow_input_parameter
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CustomEntityTypeAction):
            return False
