...
class CustomEntity(object):
    ...
    def __init__(self, id=None, name=None, custom_entity_type_id=None):
        """
        CustomEntity - a model defined in Swagger
        """

        self._id = None
        self._name = None
        self._custom_entity_type_id = None

        if id is not None:
          self.id = id
        self.name = name
        if custom_entity_type_id is not None:
          self.custom_entity_type_id = custom_entity_type_id
    ...
    def id(self):
        ...
        :return: The id of this CustomEntity.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this CustomEntity.
        UUID of custom entity 

        :param id: The id of this CustomEntity.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this CustomEntity.

        :return: The name of this CustomEntity.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CustomEntity.

        :param name: The name of this CustomEntity.
        :type: str
        """
        if name is None:
    ...
    @property
    def custom_entity_type_id(self):
        """
        Gets the custom_entity_type_id of this CustomEntity.
        This refers to UUID of custom entity type 

        :return: The custom_entity_type_id of this CustomEntity.
        :rtype: str
        """
        return self._custom_entity_type_id

    @custom_entity_type_id.setter
    def custom_entity_type_id(self, custom_entity_type_id):
        """
        Sets the custom_entity_type_id of this CustomEntity.
        This refers to UUID of custom entity type 

        :param custom_entity_type_id: The custom_entity_type_id of this CustomEntity.
        :type: str
        """

        self._custom_entity_type_id = custom_entity_type_id
