...
class CommonNsxTRouterFields(object):
    """
    ...
    def __init__(self, id=None, description=None, display_name=None):
        """
        CommonNsxTRouterFields - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this CommonNsxTRouterFields.
        The unique id of the router. Field is sortable.

        :return: The id of this CommonNsxTRouterFields.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this CommonNsxTRouterFields.
        The unique id of the router. Field is sortable.

        :param id: The id of this CommonNsxTRouterFields.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this CommonNsxTRouterFields.
        The description of the router.

        :return: The description of this CommonNsxTRouterFields.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this CommonNsxTRouterFields.
        The description of the router.

        :param description: The description of this CommonNsxTRouterFields.
        :type: str
        """
    ...
    def display_name(self):
        """
        Gets the display_name of this CommonNsxTRouterFields.
        Name used in NSX-T's logs or GUI. Field is sortable.

        :return: The display_name of this CommonNsxTRouterFields.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this CommonNsxTRouterFields.
        Name used in NSX-T's logs or GUI. Field is sortable.

        :param display_name: The display_name of this CommonNsxTRouterFields.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CommonNsxTRouterFields):
            return False
