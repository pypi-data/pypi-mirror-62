...
class UniversalRouters(object):
    ...
    def __init__(self, values=None):
        """
        UniversalRouters - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this UniversalRouters.

        :return: The values of this UniversalRouters.
        :rtype: list[UniversalRouter]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this UniversalRouters.

        :param values: The values of this UniversalRouters.
        :type: list[UniversalRouter]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UniversalRouters):
            return False
