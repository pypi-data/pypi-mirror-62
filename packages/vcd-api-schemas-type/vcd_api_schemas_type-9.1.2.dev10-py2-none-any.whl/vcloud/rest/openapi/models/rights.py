...
class Rights(object):
    ...
    def __init__(self, result_total=None, page_count=None, page=None, page_size=None, associations=None, values=None):
        """
        Rights - a model defined in Swagger
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this Rights.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this Rights.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this Rights.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this Rights.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this Rights.
        How many pages there are in total.

        :return: The page_count of this Rights.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this Rights.
        How many pages there are in total.

        :param page_count: The page_count of this Rights.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this Rights.
        The page that was fetched, 1-indexed.

        :return: The page of this Rights.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this Rights.
        The page that was fetched, 1-indexed.

        :param page: The page of this Rights.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this Rights.
        Result count for page that was fetched.

        :return: The page_size of this Rights.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this Rights.
        Result count for page that was fetched.

        :param page_size: The page_size of this Rights.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this Rights.
        Association info for each result.

        :return: The associations of this Rights.
    ...
    def associations(self, associations):
        """
        Sets the associations of this Rights.
        Association info for each result.

        :param associations: The associations of this Rights.
    ...
    def values(self):
        """
        Gets the values of this Rights.
        The current page of rights.

        :return: The values of this Rights.
        :rtype: list[Right]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Rights.
        The current page of rights.

        :param values: The values of this Rights.
        :type: list[Right]
        """
