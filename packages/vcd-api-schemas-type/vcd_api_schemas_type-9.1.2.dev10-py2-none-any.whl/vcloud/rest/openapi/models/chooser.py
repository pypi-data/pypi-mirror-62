...
class Chooser(object):
    ...
    def __init__(self, decorator_type=None, sdk_object=None, type=None):
        """
        Chooser - a model defined in Swagger
        """

        self._decorator_type = None
    ...
    def decorator_type(self):
        """
        Gets the decorator_type of this Chooser.

        :return: The decorator_type of this Chooser.
        :rtype: str
        """
        return self._decorator_type

    @decorator_type.setter
    def decorator_type(self, decorator_type):
        """
        Sets the decorator_type of this Chooser.

        :param decorator_type: The decorator_type of this Chooser.
        :type: str
        """
        if decorator_type is None:
            raise ValueError("Invalid value for `decorator_type`, must not be `None`")
    ...
    def sdk_object(self):
        """
        Gets the sdk_object of this Chooser.

        :return: The sdk_object of this Chooser.
        :rtype: SdkObject
        """
    ...
    def sdk_object(self, sdk_object):
        """
        Sets the sdk_object of this Chooser.

        :param sdk_object: The sdk_object of this Chooser.
        :type: SdkObject
        """
    ...
    def type(self):
        """
        Gets the type of this Chooser.

        :return: The type of this Chooser.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this Chooser.

        :param type: The type of this Chooser.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Chooser):
            return False
