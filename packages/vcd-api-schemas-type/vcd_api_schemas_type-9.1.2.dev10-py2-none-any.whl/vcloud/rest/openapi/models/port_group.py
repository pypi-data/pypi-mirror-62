...
class PortGroup(object):
    ...
    def backing_ref(self):
        """
        Gets the backing_ref of this PortGroup.
        Contains the backing id and name of the standard portgroup.

        :return: The backing_ref of this PortGroup.
        :rtype: BackingRef
        """
    ...
    def backing_ref(self, backing_ref):
        """
        Sets the backing_ref of this PortGroup.
        Contains the backing id and name of the standard portgroup.

        :param backing_ref: The backing_ref of this PortGroup.
        :type: BackingRef
        """
    ...
    def virtual_center(self):
        """
        Gets the virtual_center of this PortGroup.
        The entity reference for the vCenter that contains this portgroup.

        :return: The virtual_center of this PortGroup.
    ...
    def virtual_center(self, virtual_center):
        """
        Sets the virtual_center of this PortGroup.
        The entity reference for the vCenter that contains this portgroup.

        :param virtual_center: The virtual_center of this PortGroup.
