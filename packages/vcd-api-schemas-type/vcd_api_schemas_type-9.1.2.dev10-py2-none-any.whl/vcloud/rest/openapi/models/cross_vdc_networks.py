...
class CrossVdcNetworks(object):
    ...
    def __init__(self, result_total=None, page_count=None, page=None, page_size=None, associations=None, values=None):
        """
        CrossVdcNetworks - a model defined in Swagger
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this CrossVdcNetworks.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this CrossVdcNetworks.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this CrossVdcNetworks.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this CrossVdcNetworks.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this CrossVdcNetworks.
        How many pages there are in total.

        :return: The page_count of this CrossVdcNetworks.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this CrossVdcNetworks.
        How many pages there are in total.

        :param page_count: The page_count of this CrossVdcNetworks.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this CrossVdcNetworks.
        The page that was fetched, 1-indexed.

        :return: The page of this CrossVdcNetworks.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this CrossVdcNetworks.
        The page that was fetched, 1-indexed.

        :param page: The page of this CrossVdcNetworks.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this CrossVdcNetworks.
        Result count for page that was fetched.

        :return: The page_size of this CrossVdcNetworks.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this CrossVdcNetworks.
        Result count for page that was fetched.

        :param page_size: The page_size of this CrossVdcNetworks.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this CrossVdcNetworks.
        Association info for each result.

        :return: The associations of this CrossVdcNetworks.
    ...
    def associations(self, associations):
        """
        Sets the associations of this CrossVdcNetworks.
        Association info for each result.

        :param associations: The associations of this CrossVdcNetworks.
    ...
    def values(self):
        """
        Gets the values of this CrossVdcNetworks.

        :return: The values of this CrossVdcNetworks.
        :rtype: list[CrossVdcNetwork]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this CrossVdcNetworks.

        :param values: The values of this CrossVdcNetworks.
        :type: list[CrossVdcNetwork]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CrossVdcNetworks):
            return False
