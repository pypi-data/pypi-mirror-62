...
class Services(object):
    ...
    def result_total(self):
        """
        Gets the result_total of this Services.
        How many results there are in total (i.e., considering all pages).

        :return: The result_total of this Services.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this Services.
        How many results there are in total (i.e., considering all pages).

        :param result_total: The result_total of this Services.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this Services.
        How many pages there are in total.

        :return: The page_count of this Services.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this Services.
        How many pages there are in total.

        :param page_count: The page_count of this Services.
        :type: int
        """
    ...
    def page(self):
        """
        Gets the page of this Services.
        The page that was fetched, 1-indexed.

        :return: The page of this Services.
        :rtype: int
        """
        return self._page
    ...
    def page(self, page):
        """
        Sets the page of this Services.
        The page that was fetched, 1-indexed.

        :param page: The page of this Services.
        :type: int
        """
    ...
    def page_size(self):
        """
        Gets the page_size of this Services.
        Result count for page that was fetched.

        :return: The page_size of this Services.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this Services.
        Result count for page that was fetched.

        :param page_size: The page_size of this Services.
        :type: int
        """
    ...
    def associations(self):
        """
        Gets the associations of this Services.
        Association info for each result.

        :return: The associations of this Services.
    ...
    def associations(self, associations):
        """
        Sets the associations of this Services.
        Association info for each result.

        :param associations: The associations of this Services.
    ...
    def values(self):
        """
        Gets the values of this Services.
        The current page of services.

        :return: The values of this Services.
        :rtype: list[Service]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this Services.
        The current page of services.

        :param values: The values of this Services.
        :type: list[Service]
        """
