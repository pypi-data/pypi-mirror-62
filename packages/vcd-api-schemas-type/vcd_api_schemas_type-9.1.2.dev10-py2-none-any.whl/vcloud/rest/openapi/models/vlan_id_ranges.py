...
class VlanIdRanges(object):
    ...
    def __init__(self, values=None):
        """
        VlanIdRanges - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this VlanIdRanges.

        :return: The values of this VlanIdRanges.
        :rtype: list[VlanIdRange]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this VlanIdRanges.

        :param values: The values of this VlanIdRanges.
        :type: list[VlanIdRange]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VlanIdRanges):
            return False
