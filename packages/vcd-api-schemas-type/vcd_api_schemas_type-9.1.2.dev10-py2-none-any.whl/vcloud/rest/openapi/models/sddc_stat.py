...
class SddcStat(object):
    ...
    def __init__(self, num_total=None, num_used=None, num_reserved=None):
        """
        SddcStat - a model defined in Swagger
        """

        self._num_total = None
        self._num_used = None
        self._num_reserved = None

        if num_total is not None:
          self.num_total = num_total
        if num_used is not None:
          self.num_used = num_used
        if num_reserved is not None:
          self.num_reserved = num_reserved

    @property
    def num_total(self):
        """
        Gets the num_total of this SddcStat.
        Total resource allocation.

        :return: The num_total of this SddcStat.
        :rtype: int
        """
    ...
    def num_total(self, num_total):
        """
        Sets the num_total of this SddcStat.
        Total resource allocation.

        :param num_total: The num_total of this SddcStat.
        :type: int
        """
        if num_total is not None and num_total < 0:
            raise ValueError("Invalid value for `num_total`, must be a value greater than or equal to `0`")
    ...
    def num_used(self):
        """
        Gets the num_used of this SddcStat.
        Used resource allocation.

        :return: The num_used of this SddcStat.
        :rtype: int
        """
        return self._num_used

    @num_used.setter
    def num_used(self, num_used):
        """
        Sets the num_used of this SddcStat.
        Used resource allocation.

        :param num_used: The num_used of this SddcStat.
        :type: int
        """
        if num_used is not None and num_used < 0:
            raise ValueError("Invalid value for `num_used`, must be a value greater than or equal to `0`")
    ...
    def num_reserved(self):
        """
        Gets the num_reserved of this SddcStat.
        Reserved resource allocation.

        :return: The num_reserved of this SddcStat.
        :rtype: int
        """
        return self._num_reserved

    @num_reserved.setter
    def num_reserved(self, num_reserved):
        """
        Sets the num_reserved of this SddcStat.
        Reserved resource allocation.

        :param num_reserved: The num_reserved of this SddcStat.
        :type: int
        """
        if num_reserved is not None and num_reserved < 0:
            raise ValueError("Invalid value for `num_reserved`, must be a value greater than or equal to `0`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SddcStat):
            return False
