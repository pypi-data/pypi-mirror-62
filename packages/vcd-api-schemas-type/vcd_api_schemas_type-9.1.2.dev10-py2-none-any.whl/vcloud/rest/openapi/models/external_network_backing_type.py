...
class ExternalNetworkBackingType(object):
    """
    ...
    def __init__(self):
        """
        ExternalNetworkBackingType - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ExternalNetworkBackingType):
            return False
