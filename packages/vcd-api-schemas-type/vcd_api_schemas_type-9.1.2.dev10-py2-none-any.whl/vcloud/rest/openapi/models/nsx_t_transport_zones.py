...
class NsxTTransportZones(object):
    """
    ...
    def __init__(self, values=None):
        """
        NsxTTransportZones - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this NsxTTransportZones.

        :return: The values of this NsxTTransportZones.
        :rtype: list[NsxTTransportZone]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this NsxTTransportZones.

        :param values: The values of this NsxTTransportZones.
        :type: list[NsxTTransportZone]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NsxTTransportZones):
            return False
