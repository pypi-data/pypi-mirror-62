...
class AllocatedIpAddressAllocationType(object):
    """
    ...
    allowed enum values
    """
    VM_ALLOCATED = "VM_ALLOCATED"
    NAT_ROUTED = "NAT_ROUTED"
    VSM_ALLOCATED = "VSM_ALLOCATED"
    ...
    def __init__(self):
        """
        AllocatedIpAddressAllocationType - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AllocatedIpAddressAllocationType):
            return False
