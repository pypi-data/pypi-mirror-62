...
class ApplicationPortProfileScopeType(object):
    """
    ...
    def __init__(self):
        """
        ApplicationPortProfileScopeType - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApplicationPortProfileScopeType):
            return False
