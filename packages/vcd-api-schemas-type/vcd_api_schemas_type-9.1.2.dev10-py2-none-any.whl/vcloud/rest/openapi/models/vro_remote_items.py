...
class VroRemoteItems(object):
    ...
    """
    swagger_types = {
        'remote_items': 'list[VroRemoteItem]',
        'result_total': 'int',
        'page_count': 'int'
    }
    ...
    def __init__(self, remote_items=None, result_total=None, page_count=None):
        """
        VroRemoteItems - a model defined in Swagger
        """
    ...
    def remote_items(self):
        """
        Gets the remote_items of this VroRemoteItems.

        :return: The remote_items of this VroRemoteItems.
        :rtype: list[VroRemoteItem]
        """
        return self._remote_items

    @remote_items.setter
    def remote_items(self, remote_items):
        """
        Sets the remote_items of this VroRemoteItems.

        :param remote_items: The remote_items of this VroRemoteItems.
        :type: list[VroRemoteItem]
        """
    ...
    def result_total(self):
        """
        Gets the result_total of this VroRemoteItems.

        :return: The result_total of this VroRemoteItems.
        :rtype: int
        """
    ...
    def result_total(self, result_total):
        """
        Sets the result_total of this VroRemoteItems.

        :param result_total: The result_total of this VroRemoteItems.
        :type: int
        """
    ...
    def page_count(self):
        """
        Gets the page_count of this VroRemoteItems.

        :return: The page_count of this VroRemoteItems.
        :rtype: int
        """
    ...
    def page_count(self, page_count):
        """
        Sets the page_count of this VroRemoteItems.

        :param page_count: The page_count of this VroRemoteItems.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VroRemoteItems):
            return False
