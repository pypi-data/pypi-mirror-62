...
class ExtensionPointSummary(object):
    """
    ...
    """
    swagger_types = {
        'extension_point_registrations': 'dict(str, list[ExtensionPoint])'
    }

    attribute_map = {
        'extension_point_registrations': 'extensionPointRegistrations'
    }

    def __init__(self, extension_point_registrations=None):
        """
        ExtensionPointSummary - a model defined in Swagger
        """

        self._extension_point_registrations = None

        if extension_point_registrations is not None:
          self.extension_point_registrations = extension_point_registrations

    @property
    def extension_point_registrations(self):
        """
        Gets the extension_point_registrations of this ExtensionPointSummary.

        :return: The extension_point_registrations of this ExtensionPointSummary.
        :rtype: dict(str, list[ExtensionPoint])
        """
        return self._extension_point_registrations

    @extension_point_registrations.setter
    def extension_point_registrations(self, extension_point_registrations):
        """
        Sets the extension_point_registrations of this ExtensionPointSummary.

        :param extension_point_registrations: The extension_point_registrations of this ExtensionPointSummary.
        :type: dict(str, list[ExtensionPoint])
        """

        self._extension_point_registrations = extension_point_registrations
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ExtensionPointSummary):
            return False
