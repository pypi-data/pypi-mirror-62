...
class NsxTTransportZone(object):
    """
    ...
    def __init__(self, id=None, name=None, type=None):
        """
        NsxTTransportZone - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this NsxTTransportZone.
        The unique id of the transport zone on the NSX-T manager.

        :return: The id of this NsxTTransportZone.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this NsxTTransportZone.
        The unique id of the transport zone on the NSX-T manager.

        :param id: The id of this NsxTTransportZone.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this NsxTTransportZone.
        Name of Transport Zone in NSX-T Manager.

        :return: The name of this NsxTTransportZone.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this NsxTTransportZone.
        Name of Transport Zone in NSX-T Manager.

        :param name: The name of this NsxTTransportZone.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this NsxTTransportZone.
        Type of a transport zone.

        :return: The type of this NsxTTransportZone.
        :rtype: NsxTTransportZoneType
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this NsxTTransportZone.
        Type of a transport zone.

        :param type: The type of this NsxTTransportZone.
        :type: NsxTTransportZoneType
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NsxTTransportZone):
            return False
