...
class ExternalNetworkBackings(object):
    """
    ...
    """
    swagger_types = {
        'values': 'list[ExternalNetworkBacking]'
    }
    ...
    def __init__(self, values=None):
        """
        ExternalNetworkBackings - a model defined in Swagger
        """
    ...
    def values(self):
        """
        Gets the values of this ExternalNetworkBackings.

        :return: The values of this ExternalNetworkBackings.
        :rtype: list[ExternalNetworkBacking]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this ExternalNetworkBackings.

        :param values: The values of this ExternalNetworkBackings.
        :type: list[ExternalNetworkBacking]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ExternalNetworkBackings):
            return False
