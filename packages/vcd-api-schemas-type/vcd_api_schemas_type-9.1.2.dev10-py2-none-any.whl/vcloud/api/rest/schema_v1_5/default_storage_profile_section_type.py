...
class DefaultStorageProfileSectionType(SectionType):
    """
    ...
    def __init__(self, storage_profile=None,any=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DefaultStorageProfileSectionType):
            return False
