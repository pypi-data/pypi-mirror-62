...
class NetworkAssignmentType(VCloudExtensibleType):
    ...
    def __init__(self, container_network=None,inner_network=None):
        self._container_network = None
        self._inner_network = None

        if container_network is not None:
            self.container_network = container_network
        if inner_network is not None:
    ...
    def inner_network(self):
        return self._inner_network
    
    @inner_network.setter
    def inner_network(self, inner_network):
        self._inner_network = inner_network
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkAssignmentType):
            return False
