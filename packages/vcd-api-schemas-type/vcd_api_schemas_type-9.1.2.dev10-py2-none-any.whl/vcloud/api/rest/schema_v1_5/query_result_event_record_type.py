...
class QueryResultEventRecordType(QueryResultRecordType):
    ...
    def __init__(self, entity=None,entity_name=None,entity_type=None,event_status=None,event_type=None,org_name=None,service_namespace=None,time_stamp=None,user_name=None):
        self._entity = None
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueryResultEventRecordType):
            return False
