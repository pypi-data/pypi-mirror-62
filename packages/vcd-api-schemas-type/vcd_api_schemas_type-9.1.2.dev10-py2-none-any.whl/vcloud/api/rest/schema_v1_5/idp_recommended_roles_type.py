...
class IdpRecommendedRolesType(ResourceType):
    """
    ...
    """
    swagger_types = {
        'idp_recommended_roles': 'list[str]'
    }
    ...
    def __init__(self, idp_recommended_roles=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdpRecommendedRolesType):
            return False
