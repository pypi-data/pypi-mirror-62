...
class OrganizationResourcePoolSetType(ResourceType):
    """
    ...
    """
    swagger_types = {
        'resource_pool_vim_object_ref': 'list[VimObjectRefType]'
    }
    ...
    def __init__(self, resource_pool_vim_object_ref=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrganizationResourcePoolSetType):
            return False
