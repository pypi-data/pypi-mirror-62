...
class QueryResultOrgVdcStorageProfileRecordType(QueryResultRecordType):
    ...
    def __init__(self, iops_allocated=None,iops_limit=None,is_default_storage_profile=None,is_enabled=None,is_vdc_busy=None,name=None,number_of_conditions=None,storage_limit_mb=None,storage_used_mb=None,vdc=None,vdc_name=None):
