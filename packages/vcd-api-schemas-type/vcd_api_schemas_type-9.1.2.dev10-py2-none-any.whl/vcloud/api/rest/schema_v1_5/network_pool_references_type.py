...
class NetworkPoolReferencesType(VCloudExtensibleType):
    """
    ...
    """
    swagger_types = {
        'network_pool_reference': 'list[ReferenceType]'
    }
    ...
    def __init__(self, network_pool_reference=None):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkPoolReferencesType):
            return False
