...
- **nlpaudiovideo**
   - Automatically extracts text from audio or video files.
       - This allows users to integrate text from audio and video in unique and powerful ways with machine learnig (NLPCLASSIFY).
	   - Files must be .mp3, .mp4, .wav

- **nlpocr**
   - Automatically extracts text from image files.
       - This allows users to integrate text from images or scanned documents in unique and powerful ways with machine learnig (NLPCLASSIFY).
...
**12. maads.nlpclassify(username,password,company,email, iscategory,maads_rest_url,csvfile,theserverfolder,csvonly,trainingpercentage,retrainingdays,retraindeploy)**
...
**13. maads.nlpaudiovideo(username,password,company,email, maads_rest_url,thefile,theservderfolder)**
...
**14. maads.nlpocr(username,password,company,email, maads_rest_url,thefile,theservderfolder)**
