...
**Main functions:**
   ...
   - **hyperpredictions**
	 ...
	 GET http://[maads server website]:[port]/?hyperpredict=[optimal algo key],[[input data]],[MAADSTOKEN]
...
1. **maads.dotraining(MAADSTOKEN,CSV_local_file, feature_analysis, remove_outliers, has_seasonality, dependent_variable, maadsurl,theserverlocalname,summer,winter,shoulder,trainingpercentage,retrainingdays,retraindeploy,shuffle)**
...
**3. maads.hyperpredictions(MAADSTOKEN,host,port,pkey,inputdata,use_reverse_proxy,microserviceid)**
...
**12. maads.nlpclassify(MAADSTOKEN,iscategory,maads_rest_url,csvfile,theserverlocalname,csvonly,trainingpercentage,retrainingdays,retraindeploy)**
