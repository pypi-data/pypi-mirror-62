...
def hyperpredictions(maadstoken,pkey,theinputdata,host,port,username='',password='',company='',email=''):
    if '_nlpclassify' not in pkey:
      ...
      theinputdata=buf2
    value="%s,%s,%s,%s,%s,%s,[%s]" % (username,password,company,email,pkey,maadstoken,theinputdata)
