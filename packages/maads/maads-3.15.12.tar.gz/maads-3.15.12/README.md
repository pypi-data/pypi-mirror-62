...
**Main functions:**
   ...
   - **hyperpredictions**
	 ...
	 GET http://[maads server website]:[port]/?hyperpredict=[username],[password],[company],[email],[optimal algo key],[[input data]]
...
**3. maads.hyperpredictions(MAADSTOKEN,host,port,pkey,inputdata)**
