from pydiagrams.Architecture import ArchitectureContext
...
with ArchitectureContext() as a:            
	...
	# Payment Acquirers -------------------------------------------------------------
	pay = a.System('Payment Acquirers'
	...
	gcf = a.System('Gift Card Fulfilment'
			,modules  = ['AB Note', 'Blackhawk']
			)
	
	# Oracle EBS --------------------------------------------------------------------
	ebs = a.System('Oracle EBS'
			,entities = ['Journals']
	...
	# SPS Commerce ------------------------------------------------------------------
	sps = a.System('SPS Commerce'
			,modules  = ['Orders', 'Products', 'Shipments']
			)
	
	# Data Enrichment ---------------------------------------------------------------
	de = a.System('Data Enrichment'
			,modules  = ['BOA', 'COBRA']
			)
	...
	with a.IntegrationSet('Informatica', isMiddleware=True):
	# Integrations
	...
	with a.IntegrationSet('Internal', isMiddleware=False):
	# Integrations
	...
	with a.IntegrationSet('Third Party', isMiddleware=False):
	# Integrations
