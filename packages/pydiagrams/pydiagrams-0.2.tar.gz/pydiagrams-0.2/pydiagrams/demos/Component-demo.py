from pydiagrams.Component import ComponentContext
...
with ComponentContext(Helper, 'Component-demo-grouping') as g:
    with g.Package("Some Group") as g1:
        g1.Interface('HTTP') - g1.Component('First Component')
        ac = g1.Component('Another Component')

    with g.Node('Other Groups') as g2:
        g2.Interface('FTP') - g2.Component('Second Component')
        # Access components by looking for their label
        # rather than accessing via a  variable
        g1['First Component'] >> g2['FTP']

    with g.Cloud() as g3:
        ex1 = g3.Component('Example 1')

    with g.Database('MySql') as db:
        with db.Folder('This is my folder') as fg1:
            f3 = fg1.Component('Folder 3')
        with db.Frame('Foo') as fg2:
            f4 = fg2.Component('Frame 4')
...
with ComponentContext(Helper, 'Component-demo-groupnode') as b:
    ...
    with b.Node('Group Node') as n2:
        c1 = n2.Component('component')
    
    n1 >> c1
    
    with b.Database('RMS') as db:
        rs = db.Rectangle('rag_skus')
