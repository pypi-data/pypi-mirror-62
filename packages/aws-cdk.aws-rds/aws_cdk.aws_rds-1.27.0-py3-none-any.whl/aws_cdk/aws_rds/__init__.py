...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-rds", "1.27.0", __name__, "aws-rds@1.27.0.jsii.tgz")
...
class DatabaseSecretProps():
    def __init__(self, *, username: str, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, master_secret: typing.Optional[aws_cdk.aws_secretsmanager.ISecret]=None):
