...
class FormulasApi(object):
    ...
    def clear_cache_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/formulas/functions/clearCache', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_constant_name_list_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/formulas/constants', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_function_group(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_function_group(function_group_id=function_group_id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str function_group_id: functionGroupId of the desired function or index (required)
        :return: FunctionGroupModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_function_group_with_http_info(**kwargs)
        else:
            (data) = self.get_function_group_with_http_info(**kwargs)
            return data

    def get_function_group_with_http_info(self, **kwargs):
        """
        Get documentation details about a specific function group or index
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_function_group_with_http_info(function_group_id=function_group_id_value, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_function_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'function_group_id' is set
        if ('function_group_id' not in params) or (params['function_group_id'] is None):
            raise ValueError("Missing the required parameter `function_group_id` when calling `get_function_group`")


        collection_formats = {}

        path_params = {}
        if 'function_group_id' in params:
            path_params['functionGroupId'] = params['function_group_id']
        ...
        return self.api_client.call_api('/formulas/functionGroup/{functionGroupId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FunctionGroupModel',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_functions(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_functions(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_functions_with_http_info(**kwargs)
        else:
            (data) = self.get_functions_with_http_info(**kwargs)
            return data

    def get_functions_with_http_info(self, **kwargs):
        """
        Get a list of the functions available for use in a calculation
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_functions_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/formulas/functions', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FunctionDescriptions',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
