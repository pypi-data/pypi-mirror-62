...
class MonitorsApi(object):
    ...
    def post_counter_data(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_counter_data(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CounterDatumV1 body: Data for this counter
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.post_counter_data_with_http_info(**kwargs)
        else:
            (data) = self.post_counter_data_with_http_info(**kwargs)
            return data

    def post_counter_data_with_http_info(self, **kwargs):
        """
        Increment or decrement a counter
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_counter_data_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_counter_data" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/system/monitors/counter', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
