...
setup(
    ...
    author='Yoel Cortes-Pena',
    install_requires=['biosteam>=2.2.2'],
    python_requires=">=3.6",
    package_data=
    ...
    url='https://github.com/yoelcortes/Bioindustrial-Park/tree/master/biorefineries/BioSTEAM 2.x.x/biorefineries',
    download_url='https://github.com/yoelcortes/Bioindustrial-Park/tree/master/biorefineries/BioSTEAM 2.x.x/biorefineries',
