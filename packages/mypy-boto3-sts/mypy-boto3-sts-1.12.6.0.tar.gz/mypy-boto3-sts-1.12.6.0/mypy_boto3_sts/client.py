...
class STSClient:
    """
    [STS.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client)
    """
    ...
    def assume_role(
        ...
        """
        [Client.assume_role documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.assume_role)
        """
    ...
    def assume_role_with_saml(
        ...
        """
        [Client.assume_role_with_saml documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.assume_role_with_saml)
        """
    ...
    def assume_role_with_web_identity(
        ...
        """
        [Client.assume_role_with_web_identity documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.assume_role_with_web_identity)
        """

    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.can_paginate)
        """
    ...
    def decode_authorization_message(
        ...
        """
        [Client.decode_authorization_message documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.decode_authorization_message)
        """
    ...
    def get_access_key_info(self, AccessKeyId: str) -> ClientGetAccessKeyInfoResponseTypeDef:
        """
        [Client.get_access_key_info documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.get_access_key_info)
        """
    ...
    def get_caller_identity(
        ...
        """
        [Client.get_caller_identity documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.get_caller_identity)
        """
    ...
    def get_federation_token(
        ...
        """
        [Client.get_federation_token documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.get_federation_token)
        """
    ...
    def get_session_token(
        ...
        """
        [Client.get_session_token documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/sts.html#STS.Client.get_session_token)
        """
