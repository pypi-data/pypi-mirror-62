...
A `full
client <http://rasdaman.org/browser/applications/rasdapy3/rasql.py>`__
with a similar interface as the C++ rasql client is available that
...
`corresponding
class <http://rasdaman.org/browser/applications/rasdapy3/rasdapy/models>`__.
...
the `rasdaman documentation <http://doc.rasdaman.org/>`__.
