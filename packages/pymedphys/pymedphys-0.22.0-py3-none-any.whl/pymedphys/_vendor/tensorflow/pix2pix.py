...
# Vendored from https://github.com/tensorflow/examples/blob/35bd45af2d/tensorflow_examples/models/pix2pix/pix2pix.py
...
class Pix2pix(object):
  ...
  """
    ...
    def train_step(self, input_image, target_image):  # pylint: disable = method-hidden
