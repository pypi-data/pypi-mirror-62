...
from pi._requires.jinja2.utils import concat, internalcode, Markup
from pi._requires.jinja2.environment import TemplateModule
from pi._requires.jinja2.runtime import LoopContextBase, _last_iteration
...
def patch_template():
    from pi._requires.jinja2 import Template
...
def patch_runtime():
    from pi._requires.jinja2.runtime import BlockReference, Macro
...
def patch_filters():
    from pi._requires.jinja2.filters import FILTERS
    from pi._requires.jinja2.asyncfilters import ASYNC_FILTERS
