...
def create_parser(parser):
    ...
    optional_group.add_argument("-i", "--images", help="Path folder with test images (ground truth)", widget="DirChooser",)

    optional_group.add_argument(
        "-b", "--boxfiles", help="path to folder with box files (ground truth)", widget="DirChooser",
    )
