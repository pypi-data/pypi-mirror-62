...
#A balancesheet from a csv file: balance_sheet_3yr.csv
...
#A balancesheet from a csv file: income_statement_12m.csv

#print multiple multiple line charts
finPy.multiLinecharts('income_statement_12m.csv')
```
