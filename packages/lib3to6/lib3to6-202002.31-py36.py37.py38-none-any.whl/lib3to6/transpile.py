...
def parse_module_header(module_source):
    shebang = False
    coding = None
    line = None
    header_lines = []
...
def transpile_module(cfg, module_source):
    ...
    src_version = '{0}.{1}'.format(ver.major, ver.minor)
...
def transpile_module_data(cfg, module_source_data):
