...
PARAMETERS = [
    ...
    Parameter(
        ...
        default='2 MHz',
        options=[
            ('2 MHz', 2000000), ('1 MHz', 1000000),
            ('500 kHz', 500000), ('200 kHz', 200000), ('100 kHz', 100000),
            ('50 kHz', 50000), ('20 kHz', 20000), ('10 kHz', 10000),
            ('5 kHz', 5000), ('2 kHz', 2000), ('1 kHz', 1000),
            ('500 Hz', 500), ('200 Hz', 200), ('100 Hz', 100),
            ('50 Hz', 50), ('20 Hz', 20), ('10 Hz', 10)],
        units='Hz',
        flags=['skip_update']
    ),
