...
class FEIEntrySystem3Client:
    ...
    def get_event_entries(self, event_id, **kwargs):
        """
        ...
        :param event_id: Event Code to retrieve.
        ...
        :return: Array of Entry elements.
        """
        url = urljoin(self._base_url, '/user/events/{event_id}/entries'.format(event_id=event_id))
        response = self._session.get(url, params=kwargs)
        return self._handle_json_response(response)
