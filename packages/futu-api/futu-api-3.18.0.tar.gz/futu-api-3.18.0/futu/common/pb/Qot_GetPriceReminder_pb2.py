...
_S2C = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='itemList', full_name='Qot_GetPriceReminder.S2C.itemList', index=0,
...
_S2C.fields_by_name['itemList'].message_type = _PRICEREMINDERITEM
