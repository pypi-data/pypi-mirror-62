...
def __dir__():
    return ("Command", "Default", "Object", "cdir", "dispatch", "execute", "locked", "parse_cli", "stamp", "strip", "workdir")
...
from lo.hdl import Command, dispatch
from lo.shl import parse_cli, execute
