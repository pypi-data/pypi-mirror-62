...
use bot <cmd> to edit localy and botctl to edit on the system installed botd service:
...
::
 ...
 > bot meet ~bart@127.0.0.1
 > bot rss rss https://news.ycombinator.com/rss
...
| botfather on #dunkbots irc.freenode.net
    ...
    zip_safe=True,
    install_requires=["feedparser", "libobj>=8"],
    packages=["bot"],
    scripts=["bin/bot", "bin/botctl", "bin/botd", "bin/botsh", "bin/botsrv", "bin/botudp"],
