...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-config", "1.27.0", __name__, "aws-config@1.27.0.jsii.tgz")
...
class CfnAggregationAuthorizationProps():
    def __init__(self, *, authorized_account_id: str, authorized_aws_region: str, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class CfnConformancePackProps():
    def __init__(self, *, conformance_pack_name: str, delivery_s3_bucket: str, conformance_pack_input_parameters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnConformancePack.ConformancePackInputParameterProperty"]]]]]=None, delivery_s3_key_prefix: typing.Optional[str]=None, template_body: typing.Optional[str]=None, template_s3_uri: typing.Optional[str]=None):
...
class CfnOrganizationConformancePackProps():
    def __init__(self, *, delivery_s3_bucket: str, organization_conformance_pack_name: str, conformance_pack_input_parameters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnOrganizationConformancePack.ConformancePackInputParameterProperty"]]]]]=None, delivery_s3_key_prefix: typing.Optional[str]=None, excluded_accounts: typing.Optional[typing.List[str]]=None, template_body: typing.Optional[str]=None, template_s3_uri: typing.Optional[str]=None):
