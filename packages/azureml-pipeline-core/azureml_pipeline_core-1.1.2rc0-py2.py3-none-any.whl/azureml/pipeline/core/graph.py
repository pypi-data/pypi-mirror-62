...
class ModuleDef(object):
    ...
    def __init__(self, name, description=None, input_port_defs=None, output_port_defs=None, param_defs=None,
                 ...
                 module_type=None, step_type=None, arguments=None):
        """
    ...
    def step_type(self):
        """
        Get step type. Example values are "PythonScriptStep", "HyperDriveStep", "ModuleStep".
...
class PipelineDataset(object):
    ...
    def is_dataset(dset):
        ...
        if isinstance(dset, Dataset) or isinstance(dset, DatasetDefinition):
            ...
            return True
        return isinstance(dset, DatasetConsumptionConfig)
