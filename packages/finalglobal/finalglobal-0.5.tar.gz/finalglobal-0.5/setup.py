...
setup(
  name = 'finalglobal',         # How you named your package folder (MyLib)
  ...
  download_url = 'https://github.com/firatoncu/finalglobal/archive/v0.5.tar.gz',    # I explain this later on
