...
class ExceptionType(IntEnum):
    ...
    SHEET_TYPE = 16,
    SPARKLINE = 14,
    UNDISCLOSED_INFORMATION = 21,
    UNSUPPORTED_FEATURE = 19,
    UNSUPPORTED_STREAM = 20,
...
from com.aspose.cells import PowerQueryFormulaItemCollection
...
class _Workbook(object):
    ...
    def __init__(self, *args):
        ...
        elif args[0].__class__.__name__ == 'bytes':
            sb = StreamBuffer()
            sb.write(args[0])
            if len(args) == 1:
                super(Workbook, self).__init__(sb.toInputStream())
            else:
                super(Workbook, self).__init__(sb.toInputStream(), args[1])
        else:
            super(Workbook, self).__init__(*args)
