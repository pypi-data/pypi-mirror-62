...
"""
This module contains error handling features for Hawat application.
"""
...
def _make_payload(status_code, message = None, exception = None):
    ...
    if exception:
        ...
        if current_user.is_authenticated and current_user.has_role(hawat.const.HAWAT_ROLE_DEVELOPER):
