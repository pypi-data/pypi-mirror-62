...
from tensorflow_probability.python.bijectors._numpy import invert
from tensorflow_probability.python.bijectors._numpy import scale as tfb_scale
from tensorflow_probability.python.bijectors._numpy import shift as tfb_shift
