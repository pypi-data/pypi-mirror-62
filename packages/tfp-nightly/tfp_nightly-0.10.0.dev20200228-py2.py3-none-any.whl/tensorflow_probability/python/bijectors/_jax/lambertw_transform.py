...
from tensorflow_probability.python.bijectors._jax import scale as tfb_scale
from tensorflow_probability.python.bijectors._jax import shift as tfb_shift
