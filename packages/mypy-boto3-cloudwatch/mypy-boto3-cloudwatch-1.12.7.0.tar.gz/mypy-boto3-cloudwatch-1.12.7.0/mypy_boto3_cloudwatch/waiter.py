...
class AlarmExistsWaiter(Boto3Waiter):
    """
    [Waiter.AlarmExists documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.7/reference/services/cloudwatch.html#CloudWatch.Waiter.AlarmExists)
    """
    ...
    def wait(
        ...
        """
        [AlarmExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.7/reference/services/cloudwatch.html#CloudWatch.Waiter.AlarmExists.wait)
        """
