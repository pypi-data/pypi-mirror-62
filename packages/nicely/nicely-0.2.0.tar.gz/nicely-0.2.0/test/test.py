...
'''class:Test_0<
    ...
    __init_subclass__ = <built-in method __init_su ...,
    __module__        = __main__,
...
if hasattr(math, '__file__') and 'travis' in math.__file__:
    check(math,
"""module:math<
    __doc__     = '''
...
>
""",
        max_map = 16, max_str = 80, sort = True, ignore = (r'__(file|loader|spec)__'),
    )
