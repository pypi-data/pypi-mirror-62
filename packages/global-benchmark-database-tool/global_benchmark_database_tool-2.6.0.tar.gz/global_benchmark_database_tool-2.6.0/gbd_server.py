...
DATABASE = None
gbd_api = None
app = Flask(__name__, static_folder=os.path.dirname(os.path.abspath(__file__))+"/gbd_server/static", template_folder=os.path.dirname(os.path.abspath(__file__))+"/gbd_server/templates")
