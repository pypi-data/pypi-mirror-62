...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appsync", "1.27.0", __name__, "aws-appsync@1.27.0.jsii.tgz")
...
class ApiKeyConfig(AuthMode):
    def __init__(self, *, api_key_desc: str, expires: typing.Optional[str]=None):
...
class AuthorizationConfig():
    def __init__(self, *, additional_authorization_modes: typing.Optional[typing.Mapping[typing.Any, typing.Any]]=None, default_authorization: typing.Optional["AuthMode"]=None):
...
class GraphQLApiProps():
    def __init__(self, *, name: str, authorization_config: typing.Optional["AuthorizationConfig"]=None, log_config: typing.Optional["LogConfig"]=None, schema_definition: typing.Optional[str]=None, schema_definition_file: typing.Optional[str]=None):
