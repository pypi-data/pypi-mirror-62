...
class BatchNorm(normalization.BatchNormalization):
    def __init__(self,  momentum=0.1, affine=True, track_running_stats=True, use_v2_behavior=True,fused=False,**kwargs):
        """
        ...
        super(BatchNorm, self).__init__(axis=-1, momentum=momentum, epsilon=_epsilon, center=affine, scale=affine, renorm=track_running_stats,fused=fused,beta_initializer='zeros', gamma_initializer='ones', moving_mean_initializer='zeros', moving_variance_initializer='ones',**kwargs)
        self.affine = affine
