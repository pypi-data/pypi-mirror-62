...
def summary(model, input_size, batch_size=-1, device="cuda"):
    ...
    print("--------------------------------------------------------------------------------------------------------------------------------")
    line_new = "{0:^60s} {1:^25s}  {2:^25s} {3:^12s}  {4:^15s}  {5:^15s}".format("Layer (type)", "Output Shape","Weight Shape","Bias Shape", "Param #", "FLOPS #")
    print(line_new)
    print("==============================================================================")
    total_params = 0
    total_output = 0
    ...
    for layer in summary:
        ...
        line_new = "{0:<60s} {1:<25s}  {2:<25s} {3:<12s}  {4:<15}  {5:<15}".format(
            layer,
