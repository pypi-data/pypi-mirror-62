...
__all__ = ['MaxPool2d','MaxPool1d','MaxPool3d','MaxUnpool1d','MaxUnpool2d','MaxUnpool3d','AvgPool1d','AvgPool2d','AvgPool3d','GlobalAvgPool2d','AdaptiveAvgPool2d']
...
class MaxPool1d(_PoolNd):
    ...
    def forward(self, *x):
        ...
        return F.max_pool1d(x, self.kernel_size, self.strides, self.padding, self.dilation, self.ceil_mode, self.return_indices )
...
class MaxPool2d(_PoolNd):
    ...
    def forward(self, *x):
        ...
        return F.max_pool2d(x, self.kernel_size, self.strides,
...
class MaxPool3d(_PoolNd):
    ...
    def forward(self, input):
        return F.max_pool3d(input, self.kernel_size, self.strides,
                            self.padding, self.dilation, self.ceil_mode,
                            self.return_indices )
...
class MaxUnpool1d(_PoolNd):
    ...
    def forward(self, x, indices, output_size=None):
        return F.max_unpool1d(x, indices, self.kernel_size, self.strides,
...
class MaxUnpool3d(_PoolNd):
    ...
    def forward(self, x, indices, output_size=None):
        return F.max_unpool3d(x, indices, self.kernel_size, self.strides,
                              self.padding, output_size)
...
class AvgPool1d(_PoolNd):
    ...
    def forward(self, input):
        return F.avg_pool1d(
            input, self.kernel_size, self.strides, self.padding, self.ceil_mode,
...
class AvgPool2d(_PoolNd):
    ...
    def forward(self, *x):
        ...
        return F.avg_pool2d(x, self.kernel_size, self.strides,
...
class AvgPool3d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True, name='', **kwargs):
        ...
        self.divisor_override  =kwargs.get('divisor_override',None)
    def forward(self, input):
        return F.avg_pool3d(input, self.kernel_size, self.strides,
                            self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override)
