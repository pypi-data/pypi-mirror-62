...
import numpy as np
import segyio
from segyio import TraceField, TraceSortingFormat
...
def segymodel_to_vtrmodel(filename, dims=None):
    """
    ...
    :type filename: str
    :param dims: geometry of the model: (nx1, nx2, nx3)
    :type dims: tuple(int)
    """
...
def segymodel_to_vtrfile(segy_filename, vtr_filename, dims=None):
    """
    ...
    vtr = segymodel_to_vtrmodel(segy_filename, dims)
