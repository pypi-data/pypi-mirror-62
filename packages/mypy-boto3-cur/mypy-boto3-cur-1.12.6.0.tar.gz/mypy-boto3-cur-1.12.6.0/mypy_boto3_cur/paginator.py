...
class DescribeReportDefinitionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeReportDefinitions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.6/reference/services/cur.html#CostandUsageReportService.Paginator.DescribeReportDefinitions.paginate)
        """
