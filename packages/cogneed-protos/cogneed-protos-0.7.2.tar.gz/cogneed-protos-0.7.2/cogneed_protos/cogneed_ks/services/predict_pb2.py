...
_PREDICTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=cogneed__protos_dot_cogneed__ks_dot_models_dot_mfcc__audio__pb2._MFCCAUDIO,
