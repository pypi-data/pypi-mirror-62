...
class FloatConverter(TypeConverter):
    ...
    :param decimal_mark: Dot "." or  comma "," for different regions' standard symbol for the decimal place. Will infer number separators automatically from decimal symbol. i.e. comma for a dot decimal place (1,234.567) or dot for a comma decimal place (1.234,567).
    """
