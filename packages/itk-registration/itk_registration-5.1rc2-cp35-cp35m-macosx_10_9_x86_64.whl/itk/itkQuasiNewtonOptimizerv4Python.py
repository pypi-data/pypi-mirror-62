...
class itkQuasiNewtonOptimizerv4TemplateD(itkGradientDescentOptimizerv4Python.itkGradientDescentOptimizerv4TemplateD):
    """Proxy of C++ itkQuasiNewtonOptimizerv4TemplateD class."""
    ...
    def __New_orig__() -> "itkQuasiNewtonOptimizerv4TemplateD_Pointer":
        """__New_orig__() -> itkQuasiNewtonOptimizerv4TemplateD_Pointer"""
        return _itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD___New_orig__()

    __New_orig__ = staticmethod(__New_orig__)

    def Clone(self) -> "itkQuasiNewtonOptimizerv4TemplateD_Pointer":
        """Clone(itkQuasiNewtonOptimizerv4TemplateD self) -> itkQuasiNewtonOptimizerv4TemplateD_Pointer"""
    ...
    def StartOptimization(self, doOnlyInitialization: 'bool'=False) -> "void":
        """
        StartOptimization(itkQuasiNewtonOptimizerv4TemplateD self, bool doOnlyInitialization=False)
        StartOptimization(itkQuasiNewtonOptimizerv4TemplateD self)
        """
    ...
    def SetMaximumIterationsWithoutProgress(self, _arg: 'unsigned long const') -> "void":
        """SetMaximumIterationsWithoutProgress(itkQuasiNewtonOptimizerv4TemplateD self, unsigned long const _arg)"""
        return _itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_SetMaximumIterationsWithoutProgress(self, _arg)


    def SetMaximumNewtonStepSizeInPhysicalUnits(self, _arg: 'double const') -> "void":
        """SetMaximumNewtonStepSizeInPhysicalUnits(itkQuasiNewtonOptimizerv4TemplateD self, double const _arg)"""
    ...
    def GetNewtonStep(self) -> "itkArrayD const &":
        """GetNewtonStep(itkQuasiNewtonOptimizerv4TemplateD self) -> itkArrayD"""
    ...
    def EstimateNewtonStepOverSubRange(self, subrange: 'itkIndex2') -> "void":
        """EstimateNewtonStepOverSubRange(itkQuasiNewtonOptimizerv4TemplateD self, itkIndex2 subrange)"""
    ...
    def cast(obj: 'itkLightObject') -> "itkQuasiNewtonOptimizerv4TemplateD *":
        """cast(itkLightObject obj) -> itkQuasiNewtonOptimizerv4TemplateD"""
...
itkQuasiNewtonOptimizerv4TemplateD.Clone = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_Clone, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD.StartOptimization = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_StartOptimization, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD.SetMaximumIterationsWithoutProgress = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_SetMaximumIterationsWithoutProgress, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD.SetMaximumNewtonStepSizeInPhysicalUnits = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_SetMaximumNewtonStepSizeInPhysicalUnits, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD.GetNewtonStep = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_GetNewtonStep, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD.EstimateNewtonStepOverSubRange = new_instancemethod(_itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_EstimateNewtonStepOverSubRange, None, itkQuasiNewtonOptimizerv4TemplateD)
itkQuasiNewtonOptimizerv4TemplateD_swigregister = _itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_swigregister
itkQuasiNewtonOptimizerv4TemplateD_swigregister(itkQuasiNewtonOptimizerv4TemplateD)

def itkQuasiNewtonOptimizerv4TemplateD___New_orig__() -> "itkQuasiNewtonOptimizerv4TemplateD_Pointer":
    """itkQuasiNewtonOptimizerv4TemplateD___New_orig__() -> itkQuasiNewtonOptimizerv4TemplateD_Pointer"""
    return _itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD___New_orig__()

def itkQuasiNewtonOptimizerv4TemplateD_cast(obj: 'itkLightObject') -> "itkQuasiNewtonOptimizerv4TemplateD *":
    """itkQuasiNewtonOptimizerv4TemplateD_cast(itkLightObject obj) -> itkQuasiNewtonOptimizerv4TemplateD"""
    return _itkQuasiNewtonOptimizerv4Python.itkQuasiNewtonOptimizerv4TemplateD_cast(obj)
