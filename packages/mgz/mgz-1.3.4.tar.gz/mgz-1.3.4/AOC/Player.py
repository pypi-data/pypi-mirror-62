...
def PlayerStart(builder): builder.StartObject(15)
...
def PlayerAddCivilianPopulation(builder, civilianPopulation): builder.PrependFloat32Slot(10, civilianPopulation, 0.0)
def PlayerAddMilitaryPopulation(builder, militaryPopulation): builder.PrependFloat32Slot(11, militaryPopulation, 0.0)
def PlayerAddPercentMapExplored(builder, percentMapExplored): builder.PrependFloat32Slot(12, percentMapExplored, 0.0)
def PlayerAddVictoryPoints(builder, victoryPoints): builder.PrependStructSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(victoryPoints), 0)
def PlayerAddTechs(builder, techs): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(techs), 0)
