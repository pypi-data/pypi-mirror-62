    ...
    def constructFromBytes(
        ...
        for chunkStart in range(0,len(imageData),MAX_PAYLOAD_SIZE):
            ...
            if chunkStart == 0:
                ...
                chunkPacket.encode(np.ceil(len(imageData) / MAX_PAYLOAD_SIZE), imageData[chunkStart:chunkEnd])
