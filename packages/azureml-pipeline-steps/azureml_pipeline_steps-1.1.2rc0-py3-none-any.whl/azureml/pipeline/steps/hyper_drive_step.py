...
class HyperDriveStep(PipelineStep):
    ...
    _run_config_with_no_telemetry_param_name = 'HDRunConfigWithNoTelemetry'
    ...
    def create_node(self, graph, default_datastore, context):
        ...
        """
        hyperdrive_config, no_telemetry_config = self._get_hyperdrive_config(context._workspace,
                                                                             context._experiment_name)
        self._params[HyperDriveStep._run_config_param_name] = json.dumps(hyperdrive_config)
        self._params[HyperDriveStep._run_config_with_no_telemetry_param_name] = json.dumps(no_telemetry_config)
        ...
        def _get_param_def(param_name):
            is_metadata_param = param_name in (HyperDriveStep._run_config_param_name,
                                               HyperDriveStep._run_config_with_no_telemetry_param_name,
    ...
    def _get_hyperdrive_config(self, workspace, experiment_name):
        ...
        hyperdrive_config_with_no_telemetry = hyperdrive_dto.as_dict()
        hyperdrive_config_with_no_telemetry['platform_config']['Definition'].pop('TelemetryValues')

        return hyperdrive_config, hyperdrive_config_with_no_telemetry
