...
class DatabricksStep(_DatabricksStepBase):
    ...
    .. remarks::
        ...
        The following example shows how to use DatabricksStep in an Azure Machine Learning Pipeline. In this
        example, a notebook in the Databricks workspace is run.
