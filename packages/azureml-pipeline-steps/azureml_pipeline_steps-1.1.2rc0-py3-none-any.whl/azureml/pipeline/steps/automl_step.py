...
class AutoMLStep(PipelineStep):
    """Creates an automated ML step in an Azure Machine Learning pipeline.
...
class AutoMLStepRun(AutoMLRun):
    ...
    :class:`azureml.train.automl.runtime.AutoMLStep` via the :class:`azureml.pipeline.core.StepRun` class.
