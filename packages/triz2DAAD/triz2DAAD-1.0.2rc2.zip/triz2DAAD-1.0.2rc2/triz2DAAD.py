...
def imprimeDEF_ENG():
        ...
        if statusLine:
                ...
                print(' #define sb_fg_colour 3   ; Status bar foreground (ink) colour.', file=f)
        if dsf:
                print('#endif', file=f)
        else:
                print('#ENDIF', file=f)
...
def imprimePRO5(helpMessage1, helpMessage2, listRooms2):
        ...
        print('', file=f)
        if dsf:
                print('; Bloquea acciones "TODO" en MSX2.', file=f)
                print('', file=f)
                print('#ifdef "MSX2"', file=f)
                print('>', file=f)
...
def imprimePRO5_ENG(helpMessage1, helpMessage2, listRooms2):
        ...
        print('', file=f)
        if dsf:
                print('; Block "ALL" actions in MSX2.', file=f)
                print('', file=f)
                print('#ifdef "MSX2"', file=f)
                print('>', file=f)
                print('_       TODO    NOTDONE', file=f)
...
print()
print('Triz2DAAD versión 1.0.2rc2 200222 (c) 2019-20 Pedro Fernández')     
