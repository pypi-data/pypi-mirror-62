...
class _SpecRenderer(BaseRenderer):
    ...
    def render(self, data: Swagger, media_type=None, renderer_context=None):
...
class _UIRenderer(BaseRenderer):
    ...
    def render(self, swagger: Swagger, accepted_media_type=None, renderer_context=None):
...
class SwaggerUIRenderer(_UIRenderer):
    ...
    def set_context(self, renderer_context: Dict, swagger: Swagger = None):
