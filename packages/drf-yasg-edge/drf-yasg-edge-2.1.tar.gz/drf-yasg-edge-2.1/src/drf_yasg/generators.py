...
from typing import List, Union, Optional, Callable, Dict, Tuple, Type
...
class EndpointEnumerator(_EndpointEnumerator):
    def __init__(
        self,
        patterns: List = None,
        urlconf: Union[str, ModuleType, None] = None,
    ...
    def unescape_path(self, path: str) -> str:
...
class OpenAPISchemaGenerator:
    ...
    def get_security_definitions(self) -> Optional[Dict[str, Dict]]:
    ...
    def get_security_requirements(
        self, security_definitions: Dict[str, Dict]
    ...
    def create_view(
        self, callback: Callable, method: str, request: Optional[Request] = None
    ):
    ...
    def coerce_path(self, path: str, view: APIView):
    ...
    def get_operation_keys(self, subpath: str, method: str, view) -> List[str]:
    ...
    def get_paths_object(self, paths: Dict[str, openapi.PathItem]) -> openapi.Paths:
    ...
    def get_path_item(
        ...
        operations: Dict[str, openapi.Operation],
    ) -> openapi.PathItem:
    ...
    def get_overrides(self, view, method: str) -> Dict:
    ...
    def get_path_parameters(
        self, path: str, view_cls: Type[APIView]
