...
class SwaggerAutoSchema(ViewInspector):
    def __init__(
        ...
        request,
        overrides,
        operation_keys: Optional[List[str]] = None,
    ):
    ...
    def get_operation(
        self, operation_keys: Optional[List[str]] = None
    ) -> openapi.Operation:
    ...
    def get_view_serializer(self) -> serializers.Serializer:
    ...
    def get_request_serializer(
        self
    ) -> Union[serializers.Serializer, openapi.Schema, openapi.SchemaRef, None]:
    ...
    def get_request_form_parameters(
        self,
        serializer: Union[serializers.Serializer, openapi.Schema, openapi.SchemaRef],
    ):
    ...
    def make_body_parameter(self, schema: openapi.Schema) -> openapi.Parameter:
    ...
    def get_default_response_serializer(
        self
    ) -> Union[serializers.Serializer, openapi.Schema, openapi.SchemaRef, None]:
    ...
    def get_default_responses(self) -> Dict[str, openapi.Schema]:
    ...
    def get_response_serializers(self) -> Dict:
    ...
    def get_response_schemas(self, response_serializers) -> Dict[str, openapi.Response]:
    ...
    def get_operation_id(self, operation_keys: Tuple[str, ...] = None) -> str:
    ...
    def split_summary_from_description(self, description) -> Tuple[str, str]:
        ...
        summary_max_len = (
            120
        )  # OpenAPI 2.0 spec says summary should be under 120 characters
    ...
    def get_security(self) -> List[Dict[str, List[str]]]:
    ...
    def get_tags(self, operation_keys=None) -> List[str]:
