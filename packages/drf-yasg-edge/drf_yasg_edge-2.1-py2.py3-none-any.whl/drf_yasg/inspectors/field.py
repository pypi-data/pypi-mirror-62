...
class InlineSerializerInspector(SerializerInspector):
    ...
    def add_manual_parameters(
        self, serializer: serializers.Serializer, parameters: List[openapi.Parameter]
    ...
    def get_request_parameters(
        self, serializer: serializers.Serializer, in_: str
    ) -> List[openapi.Parameter]:
    ...
    def get_property_name(self, field_name: str) -> str:
        return field_name

    def get_parameter_name(self, field_name: str) -> str:
        return field_name

    def get_serializer_ref_name(self, serializer: serializers.Serializer) -> str:
        return get_serializer_ref_name(serializer)

    def _has_ref_name(self, serializer: serializers.Serializer):
...
def get_queryset_field(
    queryset: models.QuerySet, field_name: str
) -> Tuple[models.Model, models.Field]:
...
def get_model_field(model: models.Model, field_name: str) -> Optional[models.Field]:
...
def get_queryset_from_view(
    view: APIView, serializer: Optional[serializers.Serializer] = None
...
def get_parent_serializer(field: serializers.Field) -> Optional[serializers.Serializer]:
...
def get_related_model(model: models.Model, source: str) -> Optional[models.Model]:
...
def find_regex(regex_field: serializers.Field) -> Optional[str]:
...
def find_limits(field: serializers.Field) -> OrderedDict:
...
def decimal_field_type(field: serializers.Field):
...
def get_basic_type_info(field: serializers.Field) -> Optional[OrderedDict]:
...
def get_origin_type(hint_class: Type) -> Type:
    return getattr(hint_class, "__origin__", None) or hint_class


def hint_class_issubclass(hint_class: Type, check_class: Type):
...
def get_basic_type_info_from_hint(hint_class: Type) -> Optional[OrderedDict]:
