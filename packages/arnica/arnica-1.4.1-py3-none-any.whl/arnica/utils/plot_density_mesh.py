...
def _plot_skin(tuple_data, tuple_labels):
    """Plot skin as hist2d"""
...
def heat_map_mesh(x_crd, y_crd, z_crd, show=False, save=True):
    """ heat map plot of skin """

    plt.rcParams['image.cmap'] = 'Blues'

    radius = np.hypot(y_crd, z_crd)
    _plot_skin((x_crd, radius), ('$x$', '$r$'))
    _plot_skin((x_crd, z_crd), ('$y$', '$z$'))
    _plot_skin((x_crd, y_crd), ('$x$', '$y$'))
    _plot_skin((z_crd, y_crd), ('$z$', '$y$'))
