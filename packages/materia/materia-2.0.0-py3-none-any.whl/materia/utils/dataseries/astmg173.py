...
class ASTMG173(SPDSpectrum):
    def __init__(self):
        # wavelengths in nanometers, global tilt spectrum in watts per square-meter per nanometer
        # taken directly from https://rredc.nrel.gov/solar//spectra/am1.5/ASTMG173/ASTMG173.html, accessed at 16:52 EST 17 Feb. 2019
        x_unit = materia.nanometer
        y_unit = materia.watt / (materia.meter ** 2 * materia.nanometer)
        ...
        x = materia.Qty(value=wavs, unit=x_unit)
        y = materia.Qty(value=vals, unit=y_unit)
