...
class CIE1931ColorMatchingFunctionX(Spectrum):
    def __init__(self):
        ...
        y = materia.Qty(value=xbar, unit=materia.unitless)
...
class CIE1931ColorMatchingFunctionY(Spectrum):
    def __init__(self):
        ...
        x = materia.Qty(value=wavs, unit=materia.nanometer)
        y = materia.Qty(value=ybar, unit=materia.unitless)
...
class CIE1931ColorMatchingFunctionZ(Spectrum):
    def __init__(self):
        ...
        x = materia.Qty(value=wavs, unit=materia.nanometer)
        y = materia.Qty(value=zbar, unit=materia.unitless)
