...
name = 'm9s_nereid_shipping'
download_url = 'https://gitlab.com/m9s/nereid_shipping.git'
local_version = []
...
setup(name=name,
    version=version,
    description='Tryton Nereid Shipping Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/nereid_shipping.git',
        },
    keywords='',
    package_dir={'trytond.modules.nereid_shipping': '.'},
    packages=(
        ['trytond.modules.nereid_shipping'] +
        ['trytond.modules.nereid_shipping.%s' % p for p in find_packages()]
        ),
    package_data={
