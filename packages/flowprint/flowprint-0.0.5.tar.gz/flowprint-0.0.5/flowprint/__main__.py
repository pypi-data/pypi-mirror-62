...
if __name__ == "__main__":
    ...
    # Train browser input arguments
    group_data_browser = parser.add_argument_group("Browser input")
    group_data_browser.add_argument('-m', '--browser'    , type=str, nargs='+')
    group_data_browser.add_argument('-n', '--non-browser', type=str, nargs='+')
...
FlowPrint parameters:
  ...
  -m, --browser     PATHS... data for     browser training data (optional)
  -n, --non-browser PATHS... data for non-browser training data (optional)
...
""".format(
    ...
    # --browser and --non-browser should be added both or not at all
    if bool(args.browser) != bool(args.non_browser):
        print(parser.format_help())
        raise RuntimeError("--browser and --non-browser should both be "
