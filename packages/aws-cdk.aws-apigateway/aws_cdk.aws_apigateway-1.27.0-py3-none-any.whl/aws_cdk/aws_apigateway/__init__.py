...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-apigateway", "1.27.0", __name__, "aws-apigateway@1.27.0.jsii.tgz")
...
class EndpointConfiguration():
    def __init__(self, *, types: typing.List["EndpointType"], vpc_endpoints: typing.Optional[typing.List[aws_cdk.aws_ec2.IVpcEndpoint]]=None):
...
class LambdaAuthorizerProps():
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None):
...
class RequestAuthorizer(Authorizer, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigateway.RequestAuthorizer"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, identity_sources: typing.List["IdentitySource"], handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class RequestAuthorizerProps(LambdaAuthorizerProps):
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, identity_sources: typing.List["IdentitySource"]):
    ...
    @builtins.property
    def identity_sources(self) -> typing.List["IdentitySource"]:
...
class TokenAuthorizerProps(LambdaAuthorizerProps):
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, identity_source: typing.Optional[str]=None, validation_regex: typing.Optional[str]=None):
