...
from tuxpub.filters import datetimeformat, file_type, file_name, file_size, folder_name
...
def create_app():
    ...
    def fallback(dummy=""):
        ...
        # XXX can this be combined?
        files = list(s3_handler.gen_files(url))
        folders = list(s3_handler.gen_folders(url))
