...
with open(os.path.join(os.getcwd(),'regex/name_stop_words.txt'), 'r') as file:
	name_stop_words = [r.strip() for r in file.readlines()]

with open(os.path.join(os.getcwd(), 'regex/phones_regex.txt'), 'r') as file:
	phone_regex = [r.strip() for r in file.readlines()]

with open(os.path.join(os.getcwd(), 'regex/email_keywords.txt'), 'r') as file:
	email_keywords = [w.strip() for w in file.readlines()]

with open(os.path.join(os.getcwd(), 'regex/js_keywords.txt'), 'r') as file:
