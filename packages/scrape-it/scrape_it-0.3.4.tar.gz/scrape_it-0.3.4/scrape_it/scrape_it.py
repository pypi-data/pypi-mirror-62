...
Currently these files are not used until I will figure out
how to package them up for distibution in the package. :)
"""
...
name_stop_words = ['homepage', 'online', 'home',
					'title', 'welcome', 'https']

phone_regex = [r'[(-,. ]*[0-9]{2,4}[)-,. ]+[0-9]{5,7}', r'[+0-9]*[( -.,]+[0-9]{3}[-) .,]+[0-9]{3}[-) .,]+[0-9]{4}',
