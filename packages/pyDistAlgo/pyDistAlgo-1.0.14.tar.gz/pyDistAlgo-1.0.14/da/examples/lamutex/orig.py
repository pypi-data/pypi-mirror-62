...
PatternExpr_372 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern378_')]), da.pat.TuplePattern([da.pat.ConstantPattern('done')])])
...
class P(da.DistProcess):
    ...
    def run(self):
        ...
        super()._label('_st_label_361', block=False)
        _st_label_361 = 0
        while (_st_label_361 == 0):
            _st_label_361 += 1
            if PatternExpr_372.match_iter(self._PReceivedEvent_3, _BoundPattern378_=self.parent(), SELF_ID=self._id):
                _st_label_361 += 1
            else:
                super()._label('_st_label_361', block=True)
                _st_label_361 -= 1
