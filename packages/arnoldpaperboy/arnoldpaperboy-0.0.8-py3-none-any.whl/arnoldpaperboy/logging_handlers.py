...
import google.cloud.logging.handlers.transports.background_thread
...
class StackdriverLoggingHandler(CloudLoggingHandler):
    ...
    def __init__(self, *args, tier='', app='', **kwargs):
        ...
        """
        # monkey-patch the cloud logger's grace period for sending pending logs
        google.cloud.logging.handlers.transports.background_thread._DEFAULT_GRACE_PERIOD = 30
