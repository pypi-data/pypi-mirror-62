...
"""stackdriver logger related helper functions
"""
...
class PassingLoggerAdapter(LoggerAdapter):
    ...
    def __init__(self, logger, extra=None):
        ...
        # A LoggerAdapter does not have a manager, but logger.Logger.log needs
        # it to see if logger is enabled.

    @property
    def manager(self):
        """
        .. autoattribute:: logger.Logger.manager
        """
    ...
    def process(self, msg, kwargs):
        ...
        try:
            # logger.Logger does not have a process.
    ...
    def log(self, level, msg, *args, **kwargs):
        ...
        if self.isEnabledFor(level):
            ...
            if isinstance(self.logger, logging.Logger):
                # logger.Logger.log throws a hissy fit if it gets too many
...
class AnnotatedLogger:
    ...
    only the 'logger = logger.getLogger(__name__)' at the top of the file is necessary, and an
...
def autolog(logger_name='logger',
            ...
            metric_name=None,
            metric_labels=None):
    """Decorate a function for logger candy.
    ...
    def decorator(function):
        ...
        def wrapper(*args, **kwargs):
            ...
            # this decorator instead of the decorated function when logger before and after.
            ...
            if metric:
                ...
                if metric_labels:
                    labels = {k:v for k, v in {**logger_extra, **overrides} if k in metric_labels}
                else:
                    labels = {k:v for k, v in {**logger_extra, **overrides} if k.startswith('arg_')}
                send_metric(
                    custom_metric_name,
                    duration_seconds,
                    labels=labels,
