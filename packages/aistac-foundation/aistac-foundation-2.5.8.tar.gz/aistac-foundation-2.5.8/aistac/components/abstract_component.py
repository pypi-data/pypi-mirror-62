...
class AbstractComponent(ABC):
    ...
    def report_environ(self):
        ...
        for environ in [self._ENV_PM_PATH, self._ENV_PM_TYPE, self._ENV_PM_MODULE, self._ENV_PM_HANDLER,
                        ...
                        f'AISTAC_{manager}_PATH_SOURCE', f'AISTAC_{manager}_PATH_PERSIST', f'AISTAC_{manager}_MODULE',
                        f'AISTAC_{manager}_MODULE_SOURCE',  f'AISTAC_{manager}_MODULE_PERSIST',
                        f'AISTAC_{manager}_HANDLER_SOURCE', f'AISTAC_{manager}_HANDLER_PERSIST',
                        ]:
