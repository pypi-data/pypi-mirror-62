...
class AbstractComponentTest(unittest.TestCase):
    ...
    def test_report_eviron(self):
        ...
        control = {'AISTAC_PM_PATH': '/Users/doatridge/code/projects/prod/aistac-foundation/tests/components/work',
                   'AISTAC_PM_TYPE': 'yaml', 'AISTAC_PM_MODULE': 'Not Set', 'AISTAC_PM_HANDLER': 'Not Set',
                   'AISTAC_DEFAULT_PATH': 'Not Set', 'AISTAC_DEFAULT_SOURCE_PATH': 'Not Set',
                   'AISTAC_DEFAULT_PERSIST_PATH': 'Not Set', 'AISTAC_DEFAULT_MODULE': 'Not Set',
                   'AISTAC_DEFAULT_SOURCE_MODULE': 'Not Set', 'AISTAC_DEFAULT_PERSIST_MODULE': 'Not Set',
                   'AISTAC_DEFAULT_SOURCE_HANDLER': 'Not Set', 'AISTAC_DEFAULT_PERSIST_HANDLER': 'Not Set',
                   'AISTAC_control_PATH': 'Not Set', 'AISTAC_control_PATH_SOURCE': 'Not Set',
                   'AISTAC_control_PATH_PERSIST': 'Not Set', 'AISTAC_control_MODULE': 'Not Set',
                   'AISTAC_control_MODULE_SOURCE': 'Not Set', 'AISTAC_control_MODULE_PERSIST': 'Not Set',
                   'AISTAC_control_HANDLER_SOURCE': 'Not Set', 'AISTAC_control_HANDLER_PERSIST': 'Not Set'}
        self.assertDictEqual(control, result)
