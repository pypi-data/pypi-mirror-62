    ...
    try:
        ...
        if not yes:
            if order_id is None:
                ...
                confirm = input('Are you sure you want to delete Order %s ? [yes/No]' % order_id)
            if confirm.lower() != 'yes':
                return
...
def order_stop(backend, order_id, kitchen, yes):
    ...
    try:
        ...
        if not yes:
            confirm = input('Are you sure you want to stop Order %s? [yes/No]' % order_id)
            if confirm.lower() != 'yes':
                return
...
def orderrun_stop(backend, kitchen, order_run_id, yes):
    ...
    try:
        ...
        if not yes:
            confirm = input('Are you sure you want to stop Order-Run %s ? [yes/No]' % order_run_id)
            if confirm.lower() != 'yes':
                return
...
def order_resume(backend, orderrun_id, kitchen, yes):
    ...
    try:
        ...
        if not yes:
            confirm = input('Are you sure you want to resume Order-Run %s ? [yes/No]' % orderrun_id)
            if confirm.lower() != 'yes':
                return
...
def secret_delete(backend, path, kitchen, yes):
    ...
    try:
        ...
        if not yes:
            confirm = input('Are you sure you want to delete Secret %s? [yes/No]' % path)
            if confirm.lower() != 'yes':
                return
