...
class ListBackupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBackups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/dynamodb.html#DynamoDB.Paginator.ListBackups.paginate)
        """
...
class ListTablesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTables.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/dynamodb.html#DynamoDB.Paginator.ListTables.paginate)
        """
...
class ListTagsOfResourcePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTagsOfResource.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/dynamodb.html#DynamoDB.Paginator.ListTagsOfResource.paginate)
        """
...
class QueryPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Query.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/dynamodb.html#DynamoDB.Paginator.Query.paginate)
        """
...
class ScanPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Scan.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/dynamodb.html#DynamoDB.Paginator.Scan.paginate)
        """
