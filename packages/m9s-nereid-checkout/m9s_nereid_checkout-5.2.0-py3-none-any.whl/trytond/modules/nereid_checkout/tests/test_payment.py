...
class TestCheckoutPayment(BaseTestCheckout):
    ...
    def test_0100_guest_credit_card(self):
        ...
        with app.test_client() as c:
            ...
            _process_sale_by_completing_payments([sale])
    ...
    def test_0110_guest_alternate_payment(self):
        ...
        # Define a new payment gateway
        cheque_method = _create_cheque_payment_method()
    ...
    def test_0230_validate_payment_profile(self):
        ...
        with app.test_client() as c:
            ...
            self.assertTrue(
                "Not a valid choice" in rv.data.decode('utf-8')
            )
    ...
    def test_0310_guest_user_payment_using_credit_card(self):
        ...
        auth_gateway = _create_auth_net_gateway_for_site()

        with app.test_client() as c:
            _create_guest_order(c, 10)
    ...
    def test_0330_registered_user_payment_using_payment_profile(self):
        ...
        with app.test_client() as c:
            ...
            gateway = _create_auth_net_gateway_for_site()
    ...
    def test_0320_registered_user_payment_using_alternate_method(self):
        ...
        with app.test_client() as c:
            ...
            payment_method = _create_cheque_payment_method()
    ...
    def test_3340_regd_new_invalid_credit_card_details(self):
        ...
        with app.test_client() as c:
            ...
            headers = Headers([('Referer', '/en/checkout/payment')])
        ...
        with app.test_client() as c:
            ...
            # This will show a flash error message
            self.assertEqual(rv.status_code, 200)
