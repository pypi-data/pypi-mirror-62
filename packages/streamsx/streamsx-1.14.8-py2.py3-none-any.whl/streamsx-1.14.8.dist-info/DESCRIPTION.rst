 ...
 * `Composite transformations for topologies <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.composite.html>`_

 * Python type hints are used to define stream schemas and verify topologies at declaration time.
     * `Setting stream schema from type hints <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.topology.html#stream>`_
     * `Type checking at topology declaration time <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.topology.html#callables>`_
 * Higher level `build <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.context.html#streamsx.topology.context.build>`_ and `run <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.context.html#streamsx.topology.context.run>`_ functions.
...
See `streamsx.topology <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.topology.html#module-streamsx.topology>`_
...
See `streamsx.spl <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.spl.spl.html#module-streamsx.spl.spl>`_
...
See `streamsx.rest <https://streamsxtopology.readthedocs.io/en/v1.14.8/streamsx.rest.html#module-streamsx.rest>`_

Documentation
=============

`Full package documentation. <https://streamsxtopology.readthedocs.io/en/v1.14.8>`_
