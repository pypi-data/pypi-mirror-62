...
class AbstractRunner(ABC):
    def __init__(self, starting_date = None, running_date = None, drop_token=None, dropbox_backup = True, hourly_pkl_file_name='hourly_candels.pkl',aggregated_pkl_file_name='hourly_to_mix.pkl', signals_list = None, local_root_directory='../data/', user = 'napoleon', add_turn_over = False):
        super().__init__()
