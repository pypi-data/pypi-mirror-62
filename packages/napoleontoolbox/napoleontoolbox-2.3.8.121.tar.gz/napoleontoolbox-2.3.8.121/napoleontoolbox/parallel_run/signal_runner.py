...
class AbstractRunner(ABC):
    ...
    @abstractmethod
    def runTrial(self,saver, seed, trigger, signal_type, look_back_window, threshold, contravariant, idios):
        pass


class SimpleSignalRunner(AbstractRunner):
    def runTrial(self, saver, seed, trigger, signal_type, idios_string):
        idios = json.loads(idios_string)
        meArg = (seed,  trigger, signal_type,  idios_string)
        ...
        check_run_existence = saver.checkRunExistence(savingKey)
