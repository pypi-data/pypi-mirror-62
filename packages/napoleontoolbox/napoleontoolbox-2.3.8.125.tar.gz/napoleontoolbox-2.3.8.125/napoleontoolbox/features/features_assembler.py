...
class FeaturesAssembler(AbstractAssembler):
    ...
    def preprocessReturns(self, lookback_window, ts_fresh_indices = ['SPXT'], add_signal_predictor = False):
