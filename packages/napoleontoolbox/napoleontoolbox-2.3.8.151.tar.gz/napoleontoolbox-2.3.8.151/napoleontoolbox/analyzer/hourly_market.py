...
class MarketAnalyzer:
    ...
    parser_metrics = {
        'sharpe': {'f': metrics.sharpe, 'p': {'period': 252*24}},
        'calmar': {'f': metrics.calmar, 'p': {'period': 252*24}},
        'annual_return': {'f': metrics.annual_return, 'p': {'period': 252*24}},
        'annual_volatility': {'f': metrics.annual_volatility, 'p': {'period': 252*24}},
        'mdd': {'f': metrics.mdd, 'p': {}},
    }
    metrics = []
    m = 0
