...
def rolling_ensembling(X, w_mat_predictors_list, w_mat_target, n=252, s=63,ret=True, ensembling_model = 'mean', period = 252, **kwargs):
    ...
    if ensembling_model == 'mean':
        ...
        w_mat = pd.DataFrame(data = np_mean_weights,index=w_mat_predictors_list[0].index, columns=w_mat_predictors_list[0].columns)
