...
__kernel void generate_neutrons(__global float16* neutrons,
    ...
    float const E_max, float const str_area,
    float const toff_min, float const toff_max, float const flux,
  ...
  neutron.sa += rand(&neutron, global_addr)*(toff_max - toff_min) + toff_min;
