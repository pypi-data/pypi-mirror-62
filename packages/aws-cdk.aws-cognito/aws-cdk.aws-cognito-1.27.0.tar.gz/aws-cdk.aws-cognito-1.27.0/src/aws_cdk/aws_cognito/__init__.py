...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cognito", "1.27.0", __name__, "aws-cognito@1.27.0.jsii.tgz")
...
class AutoVerifiedAttrs():
    def __init__(self, *, email: typing.Optional[bool]=None, phone: typing.Optional[bool]=None):
        """Attributes that can be automatically verified for users in a user pool.

        :param email: Whether the email address of the user should be auto verified at sign up. Default: - true, if email is turned on for ``signIn``. false, otherwise.
...
class CfnUserPool(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.CfnUserPool"):
    ...
    class AccountRecoverySettingProperty():
        def __init__(self, *, recovery_mechanisms: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnUserPool.RecoveryOptionProperty"]]]]]=None):
            """
    ...
    class RecoveryOptionProperty():
        def __init__(self, *, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None):
            """
    ...
    class UsernameConfigurationProperty():
        def __init__(self, *, case_sensitive: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None):
            """
...
class SignInAliases():
    def __init__(self, *, email: typing.Optional[bool]=None, phone: typing.Optional[bool]=None, preferred_username: typing.Optional[bool]=None, username: typing.Optional[bool]=None):
...
class UserInvitationConfig():
    def __init__(self, *, email_body: typing.Optional[str]=None, email_subject: typing.Optional[str]=None, sms_message: typing.Optional[str]=None):
...
class UserPool(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.UserPool"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, auto_verify: typing.Optional["AutoVerifiedAttrs"]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_aliases: typing.Optional["SignInAliases"]=None, sms_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param auto_verify: Attributes which Cognito will look to verify automatically upon user sign up. EMAIL and PHONE are the only available options. Default: - If ``signIn`` include email and/or phone, they will be included in ``autoVerifiedAttributes`` by default. If absent, no attributes will be auto-verified.
        ...
        :stability: experimental
        """
        props = UserPoolProps(auto_verify=auto_verify, lambda_triggers=lambda_triggers, self_sign_up_enabled=self_sign_up_enabled, sign_in_aliases=sign_in_aliases, sms_role=sms_role, sms_role_external_id=sms_role_external_id, user_invitation=user_invitation, user_pool_name=user_pool_name, user_verification=user_verification)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.UserPoolProps", jsii_struct_bases=[], name_mapping={'auto_verify': 'autoVerify', 'lambda_triggers': 'lambdaTriggers', 'self_sign_up_enabled': 'selfSignUpEnabled', 'sign_in_aliases': 'signInAliases', 'sms_role': 'smsRole', 'sms_role_external_id': 'smsRoleExternalId', 'user_invitation': 'userInvitation', 'user_pool_name': 'userPoolName', 'user_verification': 'userVerification'})
class UserPoolProps():
    def __init__(self, *, auto_verify: typing.Optional["AutoVerifiedAttrs"]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_aliases: typing.Optional["SignInAliases"]=None, sms_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None):
    ...
    def auto_verify(self) -> typing.Optional["AutoVerifiedAttrs"]:
        ...
        - If ``signIn`` include email and/or phone, they will be included in ``autoVerifiedAttributes`` by default.
...
class UserVerificationConfig():
    def __init__(self, *, email_body: typing.Optional[str]=None, email_style: typing.Optional["VerificationEmailStyle"]=None, email_subject: typing.Optional[str]=None, sms_message: typing.Optional[str]=None):
        """User pool configuration for user self sign up.

        :param email_body: The email body template for the verification email sent to the user upon sign up. See https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-templates.html to learn more about message templates. Default: 'Hello {username}, Your verification code is {####}'
        ...
        :param sms_message: The message template for the verification SMS sent to the user upon sign up. See https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-templates.html to learn more about message templates. Default: 'The verification code to your new account is {####}'
