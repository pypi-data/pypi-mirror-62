...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cognito", "1.26.0", __name__, "aws-cognito@1.26.0.jsii.tgz")
...
class UserPool(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.UserPool"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, auto_verified_attributes: typing.Optional[typing.List["UserPoolAttribute"]]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_type: typing.Optional["SignInType"]=None, sms_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, username_alias_attributes: typing.Optional[typing.List["UserPoolAttribute"]]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolProps(auto_verified_attributes=auto_verified_attributes, lambda_triggers=lambda_triggers, self_sign_up_enabled=self_sign_up_enabled, sign_in_type=sign_in_type, sms_role=sms_role, sms_role_external_id=sms_role_external_id, user_invitation=user_invitation, username_alias_attributes=username_alias_attributes, user_pool_name=user_pool_name, user_verification=user_verification)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.UserPoolProps", jsii_struct_bases=[], name_mapping={'auto_verified_attributes': 'autoVerifiedAttributes', 'lambda_triggers': 'lambdaTriggers', 'self_sign_up_enabled': 'selfSignUpEnabled', 'sign_in_type': 'signInType', 'sms_role': 'smsRole', 'sms_role_external_id': 'smsRoleExternalId', 'user_invitation': 'userInvitation', 'username_alias_attributes': 'usernameAliasAttributes', 'user_pool_name': 'userPoolName', 'user_verification': 'userVerification'})
class UserPoolProps():
    def __init__(self, *, auto_verified_attributes: typing.Optional[typing.List["UserPoolAttribute"]]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_type: typing.Optional["SignInType"]=None, sms_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, username_alias_attributes: typing.Optional[typing.List["UserPoolAttribute"]]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None):
