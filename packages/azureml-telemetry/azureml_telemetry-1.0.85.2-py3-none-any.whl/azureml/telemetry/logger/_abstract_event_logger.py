...
from azureml.telemetry.contracts import StandardFieldKeys
...
class AbstractEventLogger(ABC):
    ...
    def _redact_fill_props_with_context(telemetry_entry, white_listed_properties=None):
        ...
        :param white_listed_properties: list of property names from extension properties and context that
