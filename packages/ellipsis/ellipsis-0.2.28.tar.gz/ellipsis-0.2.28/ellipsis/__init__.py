...
def projectsNewMap(mapName, dataSourceName, area, timeSeries, token, dryRun = False, useMask = False, model = None, saveHistoric = None, measurements = None, visualizations = None, aggregationZoom = None, overwrite = False ):
    body = {'name':mapName, 'dataSource':dataSourceName, 'area':area, 'timeSeries': timeSeries, 'dryRun':dryRun, 'useMask':useMask, 'overwrite':overwrite }
