...
class ParticleDistributionCMS:
    ...
    def length_1jet_events():
        return len(self.event_list_1)

    def length_2jet_events():
        return len(self.event_list_2)

    def length_3jet_events():
        return len(self.event_list_3)

    def length_4jet_events():
        return len(self.event_list_4)


    def add_event4vectors_1jet():
    ...
    def max_event_njet(n):
        if n == 1:
            return max(event_mass_1jet)
        elif n == 2:
            return max(event_mass_2jet)
        elif n == 3:
            return max(event_mass_3jet)
        elif n == 4:
            return max(event_mass_4jet)
        else:
