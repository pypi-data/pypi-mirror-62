...
from passcaptcha import util
from passcaptcha.audio import SolveAudio
from passcaptcha.base import Base
from passcaptcha.exceptions import (SafePassage, ButtonError, IframeError, PageError)
from passcaptcha.image import SolveImage
from passcaptcha.util import get_random_proxy
...
class Solver(Base):
    ...
    parent.window.recapReady = function(){
        ...
        recaptcha_url = ("https://www.recaptcha.net/recaptcha/api.js"
    ...
    async def use_jquery(self):
        """Injecting jquery references"""
