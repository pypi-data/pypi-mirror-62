...
from spectral_libraries.io.imports import import_library, import_library_metadata, import_library_as_array, \
...
from spectral_libraries.algorithms.ies import Ies
    ...
    def _run_ies(self, test_mode=False):
        ...
        try:
            ...
            ies_selection, ies_metadata = Ies().execute(library=self.library/self.libraryScaleValue.value(),
                                                        ...
                                                        p=self.progressBar, log=self.log)
            ...
            save_ies_metadata(metadata=ies_metadata, library_path=self.library_object.source(),
