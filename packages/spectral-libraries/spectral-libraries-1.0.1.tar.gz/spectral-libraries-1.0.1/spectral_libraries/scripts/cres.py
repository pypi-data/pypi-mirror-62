...
2006-02 [IDL] Written by Kerry Halligan in IDL
2006-12 [IDL] Modified by Kerry Halligan: Major re-writes on handling checking number of bands and subsetting to bbl.
2007-01 [IDL] Modified by Kerry Halligan: Warn user if bbl is different between spectral libraries and image.
2016-01 [IDL] Modified by Kenneth Dudley: Minor name changes.
