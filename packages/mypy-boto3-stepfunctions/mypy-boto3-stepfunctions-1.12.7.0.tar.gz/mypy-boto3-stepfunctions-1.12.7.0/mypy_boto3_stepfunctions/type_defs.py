...
__all__ = (
    ...
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationscloudWatchLogsLogGroupTypeDef",
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationsTypeDef",
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationTypeDef",
...
ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationscloudWatchLogsLogGroupTypeDef = TypedDict(
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationscloudWatchLogsLogGroupTypeDef",
    {"logGroupArn": str},
    total=False,
)

ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationsTypeDef = TypedDict(
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationsTypeDef",
    {
        "cloudWatchLogsLogGroup": ClientDescribeStateMachineForExecutionResponseloggingConfigurationdestinationscloudWatchLogsLogGroupTypeDef
    },
    total=False,
)

ClientDescribeStateMachineForExecutionResponseloggingConfigurationTypeDef = TypedDict(
    "ClientDescribeStateMachineForExecutionResponseloggingConfigurationTypeDef",
    {
        "level": Literal["ALL", "ERROR", "FATAL", "OFF"],
        "includeExecutionData": bool,
...
ClientDescribeStateMachineForExecutionResponseTypeDef = TypedDict(
    "ClientDescribeStateMachineForExecutionResponseTypeDef",
    {
        ...
        "roleArn": str,
        "updateDate": datetime,
        "loggingConfiguration": ClientDescribeStateMachineForExecutionResponseloggingConfigurationTypeDef,
    },
    total=False,
)
