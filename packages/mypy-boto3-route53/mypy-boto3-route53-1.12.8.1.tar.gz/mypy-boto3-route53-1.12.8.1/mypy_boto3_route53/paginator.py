...
class ListHealthChecksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListHealthChecks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/route53.html#Route53.Paginator.ListHealthChecks.paginate)
        """
...
class ListHostedZonesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListHostedZones.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/route53.html#Route53.Paginator.ListHostedZones.paginate)
        """
...
class ListQueryLoggingConfigsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListQueryLoggingConfigs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/route53.html#Route53.Paginator.ListQueryLoggingConfigs.paginate)
        """
...
class ListResourceRecordSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListResourceRecordSets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/route53.html#Route53.Paginator.ListResourceRecordSets.paginate)
        """
...
class ListVPCAssociationAuthorizationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListVPCAssociationAuthorizations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/route53.html#Route53.Paginator.ListVPCAssociationAuthorizations.paginate)
        """
