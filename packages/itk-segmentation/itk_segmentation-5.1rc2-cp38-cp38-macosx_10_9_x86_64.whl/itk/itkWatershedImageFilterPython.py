...
class itkWatershedImageFilterID2(itkImageToImageFilterAPython.itkImageToImageFilterID2IUL2):
    ...
    Get/SetThreshold() and Get/SetLevel() methods.  \\sphinx
    \\sphinxexample{Segmentation/Watersheds/SegmentWithWater
    shedImageFilter,Watershed Image Filter} \\endsphinx
