...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "1.27.0", __name__, "aws-codebuild@1.27.0.jsii.tgz")
...
class CfnProject(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnProject"):
    ...
    def file_system_locations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ProjectFileSystemLocationProperty"]]]]]:
    ...
    def file_system_locations(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "ProjectFileSystemLocationProperty"]]]]]):
    ...
    class ProjectFileSystemLocationProperty():
        def __init__(self, *, identifier: str, location: str, mount_point: str, type: str, mount_options: typing.Optional[str]=None):
            """
...
class CfnProjectProps():
    ...
    @builtins.property
    def file_system_locations(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnProject.ProjectFileSystemLocationProperty"]]]]]:
        """``AWS::CodeBuild::Project.FileSystemLocations``.
...
class CfnReportGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnReportGroup"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, export_config: typing.Union[aws_cdk.core.IResolvable, "ReportExportConfigProperty"], type: str, name: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnReportGroupProps(export_config=export_config, type=type, name=name)
    ...
    class ReportExportConfigProperty():
        def __init__(self, *, export_config_type: str, s3_destination: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnReportGroup.S3ReportExportConfigProperty"]]]=None):
            """
    ...
    class S3ReportExportConfigProperty():
        def __init__(self, *, bucket: str, encryption_disabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, encryption_key: typing.Optional[str]=None, packaging: typing.Optional[str]=None, path: typing.Optional[str]=None):
            """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CfnReportGroupProps", jsii_struct_bases=[], name_mapping={'export_config': 'exportConfig', 'type': 'type', 'name': 'name'})
class CfnReportGroupProps():
    def __init__(self, *, export_config: typing.Union[aws_cdk.core.IResolvable, "CfnReportGroup.ReportExportConfigProperty"], type: str, name: typing.Optional[str]=None):
...
class SourceConfig():
    def __init__(self, *, source_property: "CfnProject.SourceProperty", build_triggers: typing.Optional["CfnProject.ProjectTriggersProperty"]=None, source_version: typing.Optional[str]=None):
...
class BitBucketSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, owner: str, repo: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None):
...
class CodeCommitSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, repository: aws_cdk.aws_codecommit.IRepository, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None):
...
class GitHubEnterpriseSourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, https_clone_url: str, branch_or_ref: typing.Optional[str]=None, clone_depth: typing.Optional[jsii.Number]=None, ignore_ssl_errors: typing.Optional[bool]=None, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, webhook_filters: typing.Optional[typing.List["FilterGroup"]]=None):
...
class S3SourceProps(SourceProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, bucket: aws_cdk.aws_s3.IBucket, path: str, version: typing.Optional[str]=None):
