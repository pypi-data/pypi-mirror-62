...
// отсутствуют методы СтрШаблон, СтрСоеденить, СтрРазделить.
...
Функция РеквизитыФормыВСтруктуру()
	...
	НастройкиВыгрузкиРасширений = Новый Структура("ПапкаВыгрузки, ИмяПапки", ПапкаВыгрузкиБезСлеша, ?(ВыгружатьРасширенияВПапкуLib, "lib", "spec"));
