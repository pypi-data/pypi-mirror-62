...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.10.0-alpha.1582669613+g3df1c05'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.10.0-alpha.1582669613+g3df1c05`
                """)
            else:
                raise
