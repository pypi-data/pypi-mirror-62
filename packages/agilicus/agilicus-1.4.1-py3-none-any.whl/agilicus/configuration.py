...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of agilicus.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the agilicus.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = agilicus.Configuration(
        signing_info = agilicus.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.agilicus.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("agilicus")
    ...
    def auth_settings(self):
        ...
        if self.access_token is not None:
            auth['creator-or-authorizer-bearer-jwt'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'JWT',
                'key': 'Authorization',
        ...
        if self.access_token is not None:
            auth['creator-or-owner-bearer-jwt'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'JWT',
                'key': 'Authorization',
        ...
        if self.access_token is not None:
            auth['creator-or-owner-or-user-bearer-jwt'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'JWT',
                'key': 'Authorization',
        ...
        if self.access_token is not None:
            auth['creator-or-user-bearer-jwt'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'JWT',
                'key': 'Authorization',
        ...
        if self.access_token is not None:
            auth['creator-self-owner-bearer-jwt'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'JWT',
                'key': 'Authorization',
