...
class User(object):
    ...
    def __init__(self, member_of=None, id=None, external_id=None, enabled=None, first_name=None, last_name=None, email=None, provider=None, roles=None, org_id=None, type=None, created=None, updated=None, local_vars_configuration=None):  # noqa: E501
