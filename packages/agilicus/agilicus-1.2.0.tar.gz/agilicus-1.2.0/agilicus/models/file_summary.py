...
class FileSummary(object):
    ...
    def __init__(self, id=None, name=None, tag=None, label=None, size=None, last_accessed=None, created=None, updated=None, local_vars_configuration=None):  # noqa: E501
