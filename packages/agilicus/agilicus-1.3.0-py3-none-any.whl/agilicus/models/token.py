...
class Token(object):
    ...
    def __init__(self, sub=None, org=None, root_org=None, roles=None, jti=None, iat=None, exp=None, hosts=None, aud=None, session=None, local_vars_configuration=None):  # noqa: E501
