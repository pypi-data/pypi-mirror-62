...
class RuleBodyJson(object):
    ...
    def __init__(self, name=None, exact_match=None, match_type=None, pointer=None, local_vars_configuration=None):  # noqa: E501
        """RuleBodyJson - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this RuleBodyJson.  # noqa: E501

        The name that refers to a specific constraint.  # noqa: E501

        :return: The name of this RuleBodyJson.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RuleBodyJson.

        The name that refers to a specific constraint.  # noqa: E501

        :param name: The name of this RuleBodyJson.  # noqa: E501
        :type: str
        """
    ...
    def exact_match(self):
        """Gets the exact_match of this RuleBodyJson.  # noqa: E501

        The value that's matched against and should be exactly the same to satisfy the rule.  # noqa: E501

        :return: The exact_match of this RuleBodyJson.  # noqa: E501
        :rtype: str
        """
    ...
    def exact_match(self, exact_match):
        """Sets the exact_match of this RuleBodyJson.

        The value that's matched against and should be exactly the same to satisfy the rule.  # noqa: E501

        :param exact_match: The exact_match of this RuleBodyJson.  # noqa: E501
        :type: str
        """
    ...
    @property
    def match_type(self):
        """Gets the match_type of this RuleBodyJson.  # noqa: E501

        The type of the value that's matched against.  # noqa: E501

        :return: The match_type of this RuleBodyJson.  # noqa: E501
        :rtype: str
        """
    ...
    def match_type(self, match_type):
        """Sets the match_type of this RuleBodyJson.

        The type of the value that's matched against.  # noqa: E501

        :param match_type: The match_type of this RuleBodyJson.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pointer(self):
        """Gets the pointer of this RuleBodyJson.  # noqa: E501
        ...
        :return: The pointer of this RuleBodyJson.  # noqa: E501
        :rtype: str
        """
    ...
    def pointer(self, pointer):
        """Sets the pointer of this RuleBodyJson.

        The json pointer path that system follows to store or retrieve data. The pointers are defined in (https://tools.ietf.org/html/rfc6901).   # noqa: E501

        :param pointer: The pointer of this RuleBodyJson.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuleBodyJson):
            return False
