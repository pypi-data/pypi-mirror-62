...
class ServicesApi(object):
    ...
    def put_service(self, service_id, **kwargs):  # noqa: E501
        """Create or update a Service.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_service(service_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_service_with_http_info(service_id, **kwargs)  # noqa: E501

    def put_service_with_http_info(self, service_id, **kwargs):  # noqa: E501
        """Create or update a Service.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_service_with_http_info(service_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('service_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_id` when calling `put_service`")  # noqa: E501

        if self.api_client.client_side_validation and 'service_id' in local_var_params and not re.search(r'^[a-zA-Z0-9-]+$', local_var_params['service_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `service_id` when calling `put_service`, must conform to the pattern `/^[a-zA-Z0-9-]+$/`")  # noqa: E501
        collection_formats = {}
