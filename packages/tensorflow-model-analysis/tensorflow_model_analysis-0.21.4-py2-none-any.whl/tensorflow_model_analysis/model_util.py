...
from tensorflow_model_analysis.types_compat import Any, Callable, Dict, List, Optional, Sequence, Set, Text
...
def get_model_spec(eval_config,
                   model_name):
...
def find_input_name_in_features(features,
                                input_name):
...
def model_construct_fn(  # pylint: disable=invalid-name
    eval_saved_model_path = None,
    add_metrics_callbacks = None,
    include_default_metrics = None,
...
class DoFnWithModels(beam.DoFn):
  ...
  def __init__(self, model_loaders):
