...
from tensorflow_model_analysis.types_compat import Any, Callable, Dict, Iterable, List, NamedTuple, Optional, Text, Type, Union
...
class MetricComputation(
  ...
  def __new__(cls, keys, preprocessor,
              combiner):
...
class Metric(object):
  ...
  def __init__(self, create_computations_fn,
               **kwargs):
    """Initializes metric.
