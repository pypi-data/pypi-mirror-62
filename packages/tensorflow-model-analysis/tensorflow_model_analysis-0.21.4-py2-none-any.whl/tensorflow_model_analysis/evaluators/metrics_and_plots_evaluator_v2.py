...
import copy
import datetime
from tensorflow_model_analysis.types_compat import Any, Dict, Iterable, List, Optional, Text, Tuple, Type, Union
...
def _EvaluateMetricsAndPlots(  # pylint: disable=invalid-name
    ...
    metrics_key = constants.METRICS_KEY,
    plots_key = constants.PLOTS_KEY,
    validations_key = constants.VALIDATIONS_KEY):
