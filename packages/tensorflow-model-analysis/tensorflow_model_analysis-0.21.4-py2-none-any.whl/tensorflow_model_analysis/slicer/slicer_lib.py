...
from tensorflow_model_analysis.types_compat import Any, Callable, Dict, Generator, Iterable, List, Optional, Text, Tuple, Union
...
class _FanoutSlicesDoFn(beam.DoFn):
  ...
  def __init__(self, key_filter_fn):
...
def FilterOutSlices(  # pylint: disable=invalid-name
  ...
  class FilterOutSmallSlicesDoFn(beam.DoFn):
    ...
    def __init__(self, error_metric_key):
