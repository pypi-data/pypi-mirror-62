...
from tensorflow_model_analysis.types_compat import Dict, List, Optional, NamedTuple, Text
...
class _CalibrationHistogramCombiner(beam.CombineFn):
  ...
  def _bucket_index(self, prediction):
