...
import requests
import ssl
from iqoapi.http.login import Login
from iqoapi.http.loginv2 import Loginv2
from iqoapi.http.getprofile import Getprofile
from iqoapi.http.auth import Auth
from iqoapi.http.token import Token
from iqoapi.http.appinit import Appinit
from iqoapi.http.billing import Billing
from iqoapi.http.buyback import Buyback
from iqoapi.http.changebalance import Changebalance
from iqoapi.ws.client import WebsocketClient

from iqoapi.ws.chanels.ssid import Ssid
from iqoapi.ws.chanels.subscribe import *
from iqoapi.ws.chanels.unsubscribe import *
from iqoapi.ws.chanels.setactives import SetActives
from iqoapi.ws.chanels.candles import GetCandles
from iqoapi.ws.chanels.buyv2 import Buyv2
from iqoapi.ws.chanels.buyv3 import Buyv3

from iqoapi.ws.chanels.api_game_betinfo import Game_betinfo
from iqoapi.ws.chanels.instruments import Get_instruments
from iqoapi.ws.chanels.get_financial_information import GetFinancialInformation
from iqoapi.ws.chanels.strike_list import Strike_list


from iqoapi.ws.chanels.traders_mood import Traders_mood_subscribe
from iqoapi.ws.chanels.traders_mood import Traders_mood_unsubscribe
from iqoapi.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from iqoapi.ws.chanels.get_order import Get_order
from iqoapi.ws.chanels.get_deferred_orders import GetDeferredOrders
from iqoapi.ws.chanels.get_positions import *
 
from iqoapi.ws.chanels.get_available_leverages import Get_available_leverages
from iqoapi.ws.chanels.cancel_order import Cancel_order
from iqoapi.ws.chanels.close_position import Close_position
from iqoapi.ws.chanels.get_overnight_fee import Get_overnight_fee
from iqoapi.ws.chanels.heartbeat import Heartbeat

 
from iqoapi.ws.chanels.digital_option import *
from iqoapi.ws.chanels.api_game_getoptions import *
from iqoapi.ws.chanels.sell_option import Sell_Option
from iqoapi.ws.chanels.change_tpsl import Change_Tpsl
from iqoapi.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from iqoapi.ws.objects.timesync import TimeSync
from iqoapi.ws.objects.profile import Profile
from iqoapi.ws.objects.candles import Candles
from iqoapi.ws.objects.listinfodata import ListInfoData
from iqoapi.ws.objects.betinfo import Game_betinfo_data
import iqoapi.global_value as global_value
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <iqoapi.http.resource.Resource>`.
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <iqoapi.http.changebalance.Changebalance>`.
        """
...
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <iqoapi.http.getprofile.Getprofile>`.
        """
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <iqoapi.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <iqoapi.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <iqoapi.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <iqoapi.ws.chanels.candles.GetCandles>`.
        """
