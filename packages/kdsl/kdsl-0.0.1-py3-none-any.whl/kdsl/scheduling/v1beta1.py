...
import attr
import kdsl.meta.v1
import kdsl.scheduling.v1beta1
...
class PriorityClassList(K8sObjectBase):
    ...
    """
    items: Sequence[Union[kdsl.scheduling.v1beta1.PriorityClass,
        kdsl.scheduling.v1beta1.PriorityClassTypedDict]] = attr.ib(metadata
        ={'yaml_name': 'items'})
...
class PriorityClassListTypedDict(PriorityClassListOptionalTypedDict, total=
    (True)):
    items: Sequence[Union[kdsl.scheduling.v1beta1.PriorityClass,
        kdsl.scheduling.v1beta1.PriorityClassTypedDict]]
