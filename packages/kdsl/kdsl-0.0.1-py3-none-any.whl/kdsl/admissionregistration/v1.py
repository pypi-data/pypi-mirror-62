...
class WebhookClientConfig(K8sObjectBase):
    ...
    caBundle: Optional[str] = attr.ib(default=None, metadata={'yaml_name':
        'caBundle'})
    service: Optional[Union[kdsl.admissionregistration.v1.ServiceReference,
        kdsl.admissionregistration.v1.ServiceReferenceTypedDict]] = attr.ib(
        default=None, metadata={'yaml_name': 'service'})
    url: Optional[str] = attr.ib(default=None, metadata={'yaml_name': 'url'})


@attr.s(kw_only=True)
class ValidatingWebhookConfigurationList(K8sObjectBase):
    """
    ...
    items: Sequence[Union[
        kdsl.admissionregistration.v1.ValidatingWebhookConfiguration,
        kdsl.admissionregistration.v1.ValidatingWebhookConfigurationTypedDict]
...
@attr.s(kw_only=True)
class ValidatingWebhookConfiguration(K8sResourceBase):
    """
    ...
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
        'yaml_name': None})
    webhooks: Optional[Sequence[Union[
        kdsl.admissionregistration.v1.ValidatingWebhook,
        kdsl.admissionregistration.v1.ValidatingWebhookTypedDict]]] = attr.ib(
        default=None, metadata={'yaml_name': 'webhooks'})


@attr.s(kw_only=True)
class ValidatingWebhook(K8sObjectBase):
    """
    ...
    """
    admissionReviewVersions: Sequence[str] = attr.ib(metadata={'yaml_name':
        'admissionReviewVersions'})
    clientConfig: Union[kdsl.admissionregistration.v1.WebhookClientConfig,
        kdsl.admissionregistration.v1.WebhookClientConfigTypedDict] = attr.ib(
    ...
    failurePolicy: Optional[str] = attr.ib(default=None, metadata={
        'yaml_name': 'failurePolicy'})
    matchPolicy: Optional[str] = attr.ib(default=None, metadata={
        'yaml_name': 'matchPolicy'})
    ...
    objectSelector: Optional[Union[kdsl.meta.v1.LabelSelector,
        kdsl.meta.v1.LabelSelectorTypedDict]] = attr.ib(default=None,
        metadata={'yaml_name': 'objectSelector'})
    rules: Optional[Sequence[Union[
        kdsl.admissionregistration.v1.RuleWithOperations,
        kdsl.admissionregistration.v1.RuleWithOperationsTypedDict]]] = attr.ib(
        default=None, metadata={'yaml_name': 'rules'})
...
@attr.s(kw_only=True)
class RuleWithOperations(K8sObjectBase):
    """
    ...
    apiGroups: Optional[Sequence[str]] = attr.ib(default=None, metadata={
        'yaml_name': 'apiGroups'})
    apiVersions: Optional[Sequence[str]] = attr.ib(default=None, metadata={
        'yaml_name': 'apiVersions'})
    operations: Optional[Sequence[str]] = attr.ib(default=None, metadata={
        'yaml_name': 'operations'})
    resources: Optional[Sequence[str]] = attr.ib(default=None, metadata={
        'yaml_name': 'resources'})
    scope: Optional[str] = attr.ib(default=None, metadata={'yaml_name':
        'scope'})


@attr.s(kw_only=True)
class MutatingWebhookConfigurationList(K8sObjectBase):
    """
    ...
    """
    items: Sequence[Union[
        kdsl.admissionregistration.v1.MutatingWebhookConfiguration,
        kdsl.admissionregistration.v1.MutatingWebhookConfigurationTypedDict]
        ] = attr.ib(metadata={'yaml_name': 'items'})
    apiVersion: Optional[str] = attr.ib(default=None, metadata={'yaml_name':
        'apiVersion'})
    kind: Optional[str] = attr.ib(default=None, metadata={'yaml_name': 'kind'})
...
@attr.s(kw_only=True)
class MutatingWebhookConfiguration(K8sResourceBase):
    """
    ...
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
        'yaml_name': None})
    webhooks: Optional[Sequence[Union[
        kdsl.admissionregistration.v1.MutatingWebhook,
        kdsl.admissionregistration.v1.MutatingWebhookTypedDict]]] = attr.ib(
        default=None, metadata={'yaml_name': 'webhooks'})


@attr.s(kw_only=True)
class MutatingWebhook(K8sObjectBase):
    """
    ...
    objectSelector: Optional[Union[kdsl.meta.v1.LabelSelector,
        kdsl.meta.v1.LabelSelectorTypedDict]] = attr.ib(default=None,
        metadata={'yaml_name': 'objectSelector'})
    reinvocationPolicy: Optional[str] = attr.ib(default=None, metadata={
        'yaml_name': 'reinvocationPolicy'})
    rules: Optional[Sequence[Union[
        kdsl.admissionregistration.v1.RuleWithOperations,
        kdsl.admissionregistration.v1.RuleWithOperationsTypedDict]]] = attr.ib(
        default=None, metadata={'yaml_name': 'rules'})
...
class WebhookClientConfigTypedDict(TypedDict, total=(False)):
    caBundle: str
    service: Union[kdsl.admissionregistration.v1.ServiceReference,
        kdsl.admissionregistration.v1.ServiceReferenceTypedDict]
    url: str


class ValidatingWebhookConfigurationListOptionalTypedDict(TypedDict, total=
    (False)):
    apiVersion: str
    kind: str
...
class ValidatingWebhookConfigurationListTypedDict(
    ValidatingWebhookConfigurationListOptionalTypedDict, total=(True)):
    items: Sequence[Union[
        kdsl.admissionregistration.v1.ValidatingWebhookConfiguration,
        kdsl.admissionregistration.v1.ValidatingWebhookConfigurationTypedDict]]


class ValidatingWebhookConfigurationOptionalTypedDict(TypedDict, total=(False)
    ):
    annotations: Mapping[str, str]
    labels: Mapping[str, str]
    webhooks: Sequence[Union[
        kdsl.admissionregistration.v1.ValidatingWebhook,
        kdsl.admissionregistration.v1.ValidatingWebhookTypedDict]]


class ValidatingWebhookConfigurationTypedDict(
    ValidatingWebhookConfigurationOptionalTypedDict, total=(True)):
    name: str


class ValidatingWebhookOptionalTypedDict(TypedDict, total=(False)):
    failurePolicy: str
    matchPolicy: str
    namespaceSelector: Union[kdsl.meta.v1.LabelSelector,
        kdsl.meta.v1.LabelSelectorTypedDict]
    objectSelector: Union[kdsl.meta.v1.LabelSelector,
        kdsl.meta.v1.LabelSelectorTypedDict]
    rules: Sequence[Union[kdsl.admissionregistration.v1.RuleWithOperations,
        kdsl.admissionregistration.v1.RuleWithOperationsTypedDict]]
    timeoutSeconds: int


class ValidatingWebhookTypedDict(ValidatingWebhookOptionalTypedDict, total=
    (True)):
    admissionReviewVersions: Sequence[str]
    clientConfig: Union[kdsl.admissionregistration.v1.WebhookClientConfig,
        kdsl.admissionregistration.v1.WebhookClientConfigTypedDict]
    name: str
    sideEffects: str
...
class MutatingWebhookConfigurationListOptionalTypedDict(TypedDict, total=(
    False)):
    apiVersion: str
    kind: str
    metadata: Union[kdsl.meta.v1.ListMeta, kdsl.meta.v1.ListMetaTypedDict]
...
class MutatingWebhookConfigurationListTypedDict(
    MutatingWebhookConfigurationListOptionalTypedDict, total=(True)):
    items: Sequence[Union[
        kdsl.admissionregistration.v1.MutatingWebhookConfiguration,
        kdsl.admissionregistration.v1.MutatingWebhookConfigurationTypedDict]]


class MutatingWebhookConfigurationOptionalTypedDict(TypedDict, total=(False)):
    annotations: Mapping[str, str]
    labels: Mapping[str, str]
    webhooks: Sequence[Union[kdsl.admissionregistration.v1.MutatingWebhook,
        kdsl.admissionregistration.v1.MutatingWebhookTypedDict]]


class MutatingWebhookConfigurationTypedDict(
    MutatingWebhookConfigurationOptionalTypedDict, total=(True)):
    name: str


class MutatingWebhookOptionalTypedDict(TypedDict, total=(False)):
    failurePolicy: str
    matchPolicy: str
    namespaceSelector: Union[kdsl.meta.v1.LabelSelector,
        kdsl.meta.v1.LabelSelectorTypedDict]
...
class MutatingWebhookTypedDict(MutatingWebhookOptionalTypedDict, total=(True)):
    admissionReviewVersions: Sequence[str]
    clientConfig: Union[kdsl.admissionregistration.v1.WebhookClientConfig,
        kdsl.admissionregistration.v1.WebhookClientConfigTypedDict]
    name: str
