...
class TokenReviewStatus(K8sObjectBase):
    ...
    error: Optional[str] = attr.ib(default=None, metadata={'yaml_name':
        'error'})
    user: Optional[Union[kdsl.authentication.v1.UserInfo,
        kdsl.authentication.v1.UserInfoTypedDict]] = attr.ib(default=None,
...
class TokenReview(K8sResourceBase):
    ...
    spec: Union[kdsl.authentication.v1.TokenReviewSpec,
        kdsl.authentication.v1.TokenReviewSpecTypedDict] = attr.ib(metadata
        ={'yaml_name': 'spec'})
...
class TokenReviewStatusTypedDict(TypedDict, total=(False)):
    ...
    authenticated: bool
    error: str
    user: Union[kdsl.authentication.v1.UserInfo,
        kdsl.authentication.v1.UserInfoTypedDict]
...
class TokenReviewTypedDict(TokenReviewOptionalTypedDict, total=(True)):
    name: str
    spec: Union[kdsl.authentication.v1.TokenReviewSpec,
        kdsl.authentication.v1.TokenReviewSpecTypedDict]
