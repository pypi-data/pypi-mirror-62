...
class APIServiceStatus(K8sObjectBase):
    ...
    conditions: Optional[Sequence[Union[
        kdsl.apiregistration.v1beta1.APIServiceCondition,
        kdsl.apiregistration.v1beta1.APIServiceConditionTypedDict]]] = attr.ib(
...
class APIServiceSpec(K8sObjectBase):
    ...
    service: Union[kdsl.apiregistration.v1beta1.ServiceReference,
        kdsl.apiregistration.v1beta1.ServiceReferenceTypedDict] = attr.ib(
...
class APIServiceList(K8sObjectBase):
    ...
    :param metadata: None
    """
    items: Sequence[Union[kdsl.apiregistration.v1beta1.APIService,
        kdsl.apiregistration.v1beta1.APIServiceTypedDict]] = attr.ib(metadata
        ={'yaml_name': 'items'})
...
class APIService(K8sResourceBase):
    ...
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
        'yaml_name': None})
    spec: Optional[Union[kdsl.apiregistration.v1beta1.APIServiceSpec,
        kdsl.apiregistration.v1beta1.APIServiceSpecTypedDict]] = attr.ib(
...
class APIServiceStatusTypedDict(TypedDict, total=(False)):
    conditions: Sequence[Union[
        kdsl.apiregistration.v1beta1.APIServiceCondition,
        kdsl.apiregistration.v1beta1.APIServiceConditionTypedDict]]
...
class APIServiceSpecTypedDict(APIServiceSpecOptionalTypedDict, total=(True)):
    ...
    service: Union[kdsl.apiregistration.v1beta1.ServiceReference,
        kdsl.apiregistration.v1beta1.ServiceReferenceTypedDict]
    versionPriority: int
...
class APIServiceListTypedDict(APIServiceListOptionalTypedDict, total=(True)):
    items: Sequence[Union[kdsl.apiregistration.v1beta1.APIService,
        kdsl.apiregistration.v1beta1.APIServiceTypedDict]]
...
class APIServiceOptionalTypedDict(TypedDict, total=(False)):
    ...
    spec: Union[kdsl.apiregistration.v1beta1.APIServiceSpec,
        kdsl.apiregistration.v1beta1.APIServiceSpecTypedDict]
