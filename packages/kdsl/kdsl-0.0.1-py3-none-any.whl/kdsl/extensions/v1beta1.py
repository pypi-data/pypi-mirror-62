...
class IngressSpec(K8sObjectBase):
    ...
    """
    backend: Optional[Union[kdsl.extensions.v1beta1.IngressBackend,
        kdsl.extensions.v1beta1.IngressBackendTypedDict]] = attr.ib(default
        =None, metadata={'yaml_name': 'backend'})
    rules: Optional[Sequence[Union[kdsl.extensions.v1beta1.IngressRule,
        kdsl.extensions.v1beta1.IngressRuleTypedDict]]] = attr.ib(default=
        None, metadata={'yaml_name': 'rules'})
    tls: Optional[Sequence[Union[kdsl.extensions.v1beta1.IngressTLS,
        kdsl.extensions.v1beta1.IngressTLSTypedDict]]] = attr.ib(default=
...
class IngressRule(K8sObjectBase):
    ...
    http: Optional[Union[kdsl.extensions.v1beta1.HTTPIngressRuleValue,
        kdsl.extensions.v1beta1.HTTPIngressRuleValueTypedDict]] = attr.ib(
...
class IngressList(K8sObjectBase):
    ...
    """
    items: Sequence[Union[kdsl.extensions.v1beta1.Ingress,
        kdsl.extensions.v1beta1.IngressTypedDict]] = attr.ib(metadata={
        'yaml_name': 'items'})
...
class Ingress(K8sResourceBase):
    ...
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
        'yaml_name': None})
    spec: Optional[Union[kdsl.extensions.v1beta1.IngressSpec,
        kdsl.extensions.v1beta1.IngressSpecTypedDict]] = attr.ib(default=
...
class HTTPIngressRuleValue(K8sObjectBase):
    ...
    """
    paths: Sequence[Union[kdsl.extensions.v1beta1.HTTPIngressPath,
        kdsl.extensions.v1beta1.HTTPIngressPathTypedDict]] = attr.ib(metadata
        ={'yaml_name': 'paths'})
...
class HTTPIngressPath(K8sObjectBase):
    ...
    """
    backend: Union[kdsl.extensions.v1beta1.IngressBackend,
        kdsl.extensions.v1beta1.IngressBackendTypedDict] = attr.ib(metadata
        ={'yaml_name': 'backend'})
...
class IngressSpecTypedDict(TypedDict, total=(False)):
    backend: Union[kdsl.extensions.v1beta1.IngressBackend,
        kdsl.extensions.v1beta1.IngressBackendTypedDict]
    rules: Sequence[Union[kdsl.extensions.v1beta1.IngressRule,
        kdsl.extensions.v1beta1.IngressRuleTypedDict]]
    tls: Sequence[Union[kdsl.extensions.v1beta1.IngressTLS,
        kdsl.extensions.v1beta1.IngressTLSTypedDict]]


class IngressRuleTypedDict(TypedDict, total=(False)):
    host: str
    http: Union[kdsl.extensions.v1beta1.HTTPIngressRuleValue,
        kdsl.extensions.v1beta1.HTTPIngressRuleValueTypedDict]
...
class IngressListTypedDict(IngressListOptionalTypedDict, total=(True)):
    items: Sequence[Union[kdsl.extensions.v1beta1.Ingress,
        kdsl.extensions.v1beta1.IngressTypedDict]]
...
class IngressOptionalTypedDict(TypedDict, total=(False)):
    ...
    spec: Union[kdsl.extensions.v1beta1.IngressSpec,
        kdsl.extensions.v1beta1.IngressSpecTypedDict]
...
class HTTPIngressRuleValueTypedDict(TypedDict, total=(True)):
    paths: Sequence[Union[kdsl.extensions.v1beta1.HTTPIngressPath,
        kdsl.extensions.v1beta1.HTTPIngressPathTypedDict]]
