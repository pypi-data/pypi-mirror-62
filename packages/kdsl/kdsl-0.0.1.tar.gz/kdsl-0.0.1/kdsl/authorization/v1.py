...
class SubjectRulesReviewStatus(K8sObjectBase):
    ...
    nonResourceRules: Sequence[Union[kdsl.authorization.v1.NonResourceRule,
        kdsl.authorization.v1.NonResourceRuleTypedDict]] = attr.ib(metadata
        ={'yaml_name': 'nonResourceRules'})
    resourceRules: Sequence[Union[kdsl.authorization.v1.ResourceRule,
        kdsl.authorization.v1.ResourceRuleTypedDict]] = attr.ib(metadata={
...
class SubjectAccessReviewSpec(K8sObjectBase):
    ...
    nonResourceAttributes: Optional[Union[
        ...
        kdsl.authorization.v1.NonResourceAttributesTypedDict]] = attr.ib(
    ...
    resourceAttributes: Optional[Union[
        ...
        kdsl.authorization.v1.ResourceAttributesTypedDict]] = attr.ib(default
        =None, metadata={'yaml_name': 'resourceAttributes'})
...
class SubjectAccessReview(K8sResourceBase):
    ...
    spec: Union[kdsl.authorization.v1.SubjectAccessReviewSpec,
        kdsl.authorization.v1.SubjectAccessReviewSpecTypedDict] = attr.ib(
...
class SelfSubjectRulesReviewSpec(K8sObjectBase):
    """
    | Kubernates API object: io.k8s.api.authorization.v1.SelfSubjectRulesReviewSpec
...
class SelfSubjectRulesReview(K8sResourceBase):
    ...
    name: str = attr.ib(metadata={'yaml_name': None})
    spec: Union[kdsl.authorization.v1.SelfSubjectRulesReviewSpec,
        kdsl.authorization.v1.SelfSubjectRulesReviewSpecTypedDict] = attr.ib(
        metadata={'yaml_name': 'spec'})
    annotations: Optional[Mapping[str, str]] = attr.ib(default=None,
        metadata={'yaml_name': None})
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
...
class SelfSubjectAccessReview(K8sResourceBase):
    ...
    name: str = attr.ib(metadata={'yaml_name': None})
    spec: Union[kdsl.authorization.v1.SelfSubjectAccessReviewSpec,
        kdsl.authorization.v1.SelfSubjectAccessReviewSpecTypedDict] = attr.ib(
        metadata={'yaml_name': 'spec'})
    annotations: Optional[Mapping[str, str]] = attr.ib(default=None,
        metadata={'yaml_name': None})
    labels: Optional[Mapping[str, str]] = attr.ib(default=None, metadata={
...
class SubjectRulesReviewStatusTypedDict(
    ...
    incomplete: bool
    nonResourceRules: Sequence[Union[kdsl.authorization.v1.NonResourceRule,
        kdsl.authorization.v1.NonResourceRuleTypedDict]]
    resourceRules: Sequence[Union[kdsl.authorization.v1.ResourceRule,
        kdsl.authorization.v1.ResourceRuleTypedDict]]
...
class SubjectAccessReviewSpecTypedDict(TypedDict, total=(False)):
    ...
    nonResourceAttributes: Union[
        kdsl.authorization.v1.NonResourceAttributes,
        kdsl.authorization.v1.NonResourceAttributesTypedDict]
    resourceAttributes: Union[kdsl.authorization.v1.ResourceAttributes,
        kdsl.authorization.v1.ResourceAttributesTypedDict]
    uid: str
    user: str
...
class SubjectAccessReviewTypedDict(SubjectAccessReviewOptionalTypedDict,
    ...
    name: str
    spec: Union[kdsl.authorization.v1.SubjectAccessReviewSpec,
        kdsl.authorization.v1.SubjectAccessReviewSpecTypedDict]
...
class SelfSubjectRulesReviewTypedDict(SelfSubjectRulesReviewOptionalTypedDict,
    ...
    name: str
    spec: Union[kdsl.authorization.v1.SelfSubjectRulesReviewSpec,
        kdsl.authorization.v1.SelfSubjectRulesReviewSpecTypedDict]
...
class SelfSubjectAccessReviewTypedDict(SelfSubjectAccessReviewOptionalTypedDict
    ...
    name: str
    spec: Union[kdsl.authorization.v1.SelfSubjectAccessReviewSpec,
        kdsl.authorization.v1.SelfSubjectAccessReviewSpecTypedDict]
