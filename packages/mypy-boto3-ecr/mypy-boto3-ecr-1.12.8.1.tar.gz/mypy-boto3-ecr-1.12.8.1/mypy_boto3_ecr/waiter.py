...
class ImageScanCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ImageScanComplete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecr.html#ECR.Waiter.ImageScanComplete.wait)
        """
...
class LifecyclePolicyPreviewCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [LifecyclePolicyPreviewComplete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/ecr.html#ECR.Waiter.LifecyclePolicyPreviewComplete.wait)
        """
