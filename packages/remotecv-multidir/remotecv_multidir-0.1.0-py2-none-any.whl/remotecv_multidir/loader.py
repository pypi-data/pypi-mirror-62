...
def load_sync(path):
    ...
    """
    for idx, next_dir in enumerate(multidir_config.REMOTECV_MULTIDIR_LOADER_DIRS):
    ...
    if not multidir_config.REMOTECV_MULTIDIR_LOADER_DIRS:
