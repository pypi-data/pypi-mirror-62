...
def main():
	...
	field_poly=FieldPoly.synthesize(cities_count=10,hole_count=0,hole_cities_count=5,poly_extent=1000)
	sub_area=2*1e4
	logger.debug('field_poly.geometry.area: %s',field_poly.geometry.area)
	ratio=field_poly.geometry.area/sub_area
	logger.debug('ratio: %s',ratio)
	
	coordinates=field_poly.get_subparcel_centers(sub_area,show='11',grid_factor=0.1)
