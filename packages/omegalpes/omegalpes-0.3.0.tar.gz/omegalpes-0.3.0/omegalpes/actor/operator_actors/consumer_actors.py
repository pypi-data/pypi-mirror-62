...
class Consumer(OperatorActor):
    ...
    **Description**
    ...
    # Economic objectives
    def minimize_consumption_cost(self, obj_operated_unit_list=None, weight=1):
        """
    ...
    # CONSTRAINTS #
    # Energy constraints
    def energy_consumption_minimum(self, min_e_tot,
    ...
    def energy_consumption_maximum(self, max_e_tot,
                                   cst_operated_unit_list=None):
        """
