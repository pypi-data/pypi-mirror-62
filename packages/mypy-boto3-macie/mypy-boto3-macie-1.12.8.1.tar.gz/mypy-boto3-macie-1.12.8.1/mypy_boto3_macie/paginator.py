...
class ListMemberAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMemberAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/macie.html#Macie.Paginator.ListMemberAccounts.paginate)
        """
...
class ListS3ResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListS3Resources.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/macie.html#Macie.Paginator.ListS3Resources.paginate)
        """
