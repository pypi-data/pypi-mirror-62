...
class PipelineException(ClientException):
    ...
    def __init__(self, exception_message, error_detail=None, **kwargs):
        ...
        if error_detail is not None:
            ...
            super().__init__(exception_message="PipelineException: {0}".format(exception_message), **kwargs)
...
class TransformException(ClientException):
    ...
    def __init__(self, exception_message, error_detail=None, **kwargs):
        ...
        if error_detail is not None:
            ...
            super().__init__(exception_message="TransformException: {0}".format(exception_message), **kwargs)
    ...
    def __init__(self, exception_message, error_detail=None, **kwargs):
        ...
        if error_detail is not None:
            super().__init__("TransformValueException: {0}, {1}"
                             .format(exception_message, error_detail), **kwargs)
        else:
            super().__init__("TransformValueException: {0}".format(exception_message), **kwargs)
    ...
    def __init__(self, exception_message, error_detail=None, **kwargs):
        ...
        if error_detail is not None:
            super().__init__(exception_message="NotTimeSeriesDataFrameException: {0}, {1}".format(
                exception_message, error_detail), **kwargs)
        else:
...
class DataFrameValueException(ClientException):
    ...
    def __init__(self, exception_message, has_pii=False):
        ...
        super().__init__("Data frame value is invalid. {0}".format(exception_message), has_pii=has_pii)
...
class ColumnTypeNotSupportedException(ForecastingConfigException):
    ...
    def __init__(self, exception_message, error_detail=None, **kwargs):
        ...
        if error_detail is not None:
            ...
            super().__init__("ColumnTypeNotSupportedException: {0}".format(exception_message), **kwargs)
