...
setup(
    ...
    download_url = 'https://github.com/fifth-partners/fp-utils/archive/1.1.3.tar.gz',
    ...
    'pymongo', 'datetime', 'bs4', 'pathlib','pandas','numpy','requests','oath2client','python-dotenv','boto3'],
    classifiers = [
