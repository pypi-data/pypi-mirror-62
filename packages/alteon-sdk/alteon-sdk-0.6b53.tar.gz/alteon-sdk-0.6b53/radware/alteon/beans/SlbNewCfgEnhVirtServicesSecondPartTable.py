...
class EnumSlbVirtServiceBasicConnmgtStatus(BaseBeanEnum):
    disabled = 0
    muxenabled = 2


class SlbNewCfgEnhVirtServicesSecondPartTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.BasicConnmgtStatus = EnumSlbVirtServiceBasicConnmgtStatus.enum(kwargs.get('BasicConnmgtStatus', None))
