...
class FastviewPerWebAppStatsTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.CompiledPages = kwargs.get('CompiledPages', None)
        self.PeakCompiledPages = kwargs.get('PeakCompiledPages', None)
        self.TotCompiledPages = kwargs.get('TotCompiledPages', None)
