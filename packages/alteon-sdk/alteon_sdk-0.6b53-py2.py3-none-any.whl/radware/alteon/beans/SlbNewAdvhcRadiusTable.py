...
class EnumSlbAdvhcRadiusDownType(BaseBeanEnum):
    accounting = 1
    authentication = 2
    any = 3


class SlbNewAdvhcRadiusTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.DownType = EnumSlbAdvhcRadiusDownType.enum(kwargs.get('DownType', None))
