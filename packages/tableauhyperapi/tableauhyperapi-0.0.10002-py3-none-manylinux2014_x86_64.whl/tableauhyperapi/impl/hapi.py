...
HYPER_ERROR_CATEGORY_POSIX: int = lib.HYPER_ERROR_CATEGORY_POSIX
HYPER_ERROR_CATEGORY_WINDOWS: int = lib.HYPER_ERROR_CATEGORY_WINDOWS
HYPER_ERROR_CATEGORY_API: int = lib.HYPER_ERROR_CATEGORY_API
HYPER_ERROR_CATEGORY_PROCESS_EXIT_CODE: int = lib.HYPER_ERROR_CATEGORY_PROCESS_EXIT_CODE

# hyper_error_code_t
HYPER_ERRC_GENERIC: int = lib.HYPER_ERRC_GENERIC
HYPER_ERRC_LIBPQ_ERROR: int = lib.HYPER_ERRC_LIBPQ_ERROR
HYPER_ERRC_CONNECT_FAILED: int = lib.HYPER_ERRC_CONNECT_FAILED
HYPER_ERRC_GET_TABLE_DEFINITION_FAILED: int = lib.HYPER_ERRC_GET_TABLE_DEFINITION_FAILED
HYPER_ERRC_TABLE_INSERTION_FAILED: int = lib.HYPER_ERRC_TABLE_INSERTION_FAILED
HYPER_ERRC_ADD_COLUMN_FAILED: int = lib.HYPER_ERRC_ADD_COLUMN_FAILED
HYPER_ERRC_CREATE_TABLE_FAILED: int = lib.HYPER_ERRC_CREATE_TABLE_FAILED
HYPER_ERRC_CREATE_DATABASE_FAILED: int = lib.HYPER_ERRC_CREATE_DATABASE_FAILED
HYPER_ERRC_DROP_DATABASE_FAILED: int = lib.HYPER_ERRC_DROP_DATABASE_FAILED
HYPER_ERRC_NEXT_ROW_FAILED: int = lib.HYPER_ERRC_NEXT_ROW_FAILED
HYPER_ERRC_EXECUTE_QUERY_FAILED: int = lib.HYPER_ERRC_EXECUTE_QUERY_FAILED
HYPER_ERRC_INVALID_DATA_DESERIALIZED: int = lib.HYPER_ERRC_INVALID_DATA_DESERIALIZED
HYPER_ERRC_HYPER_STARTUP_FAILED: int = lib.HYPER_ERRC_HYPER_STARTUP_FAILED
HYPER_ERRC_HYPER_CONNECTION_BUSY: int = lib.HYPER_ERRC_HYPER_CONNECTION_BUSY
HYPER_ERRC_NON_SCALAR_RESULT: int = lib.HYPER_ERRC_NON_SCALAR_RESULT
HYPER_ERRC_FORCE_KILL_INSTANCE: int = lib.HYPER_ERRC_FORCE_KILL_INSTANCE
HYPER_ERRC_NON_ZERO_PROCESS_EXIT_CODE: int = lib.HYPER_ERRC_NON_ZERO_PROCESS_EXIT_CODE
...
hyper_unload_database: Callable = lib.hyper_unload_database
