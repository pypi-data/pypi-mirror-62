...
class Catalog:
    ...
    def create_database(self, database_path: Union[str, Path]):
        """
    ...
    def create_database_if_not_exists(self, database_path: Union[str, Path]):
        """
    ...
    def attach_database(self, database_path: Union[str, Path], alias: Optional[Union[str, Name, DatabaseName]] = None):
    ...
    def drop_database(self, database_path: Union[str, Path]):
    ...
    def drop_database_if_exists(self, database_path: Union[str, Path]):
