...
from typing import List, Dict, Any, Union, Optional, ClassVar, Iterable
...
class SiteKey:
    ...
    schema: ClassVar[Dict] = {
        ...
        "validEventTypes": {
            "type": "list",
            "required": True,
            "schema": {"type": "integer", "allowed": list(event_type_codes.values())},
        },
        "customizations": {
            "type": "dict",
            "required": True,
...
class RootUserDoc(FirebaseDoc):
    ...
    schema: ClassVar[dict] = {
        ...
        "currentAppVersion": {"type": "string", "required": True, "nullable": True},
        "defaultSiteKey": {"type": "string", "required": True, "nullable": True},
        "private_data": {"type": "dict", "schema": RootUserPrivateDoc.schema},
        "tokens": {
            "type": "list",
