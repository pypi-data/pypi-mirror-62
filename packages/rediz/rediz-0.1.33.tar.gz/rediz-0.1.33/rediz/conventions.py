...
class RedizConventions(object):
    ...
    @staticmethod
    def vanity_words():
        return ['f1eece','feedab1e','bef1eaed','1abe1ed','facade','defaced','daffed','cabbed','baff1ed','accede','2faced','faded','beaded','decade','ebbed',
             ...
             'flee','beef','babe','ee1','dad','deadfa11','fadab1e','1ad1ed','be1aced']
