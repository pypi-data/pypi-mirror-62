...
from rasax.community.database.data import TEMPLATE_ANNOTATION_KEYS, Template
...
class Domain(Base):
    ...
    carry_over_slots_to_new_session = sa.Column(sa.Boolean)
    ...
    def _get_session_config(self) -> Dict[Text, Union[bool, float]]:
        ...
        if self.carry_over_slots_to_new_session is not None:
            session_config[CARRY_OVER_SLOTS_KEY] = self.carry_over_slots_to_new_session
