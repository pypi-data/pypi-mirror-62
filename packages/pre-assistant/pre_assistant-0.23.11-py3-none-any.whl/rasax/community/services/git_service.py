...
"""
    ...
    def commit_and_push_changes_to(
        ...
        return self._push(branch_name, is_committing_to_target_branch)
    ...
    def _push(
        ...
        if not push_succeeded and not pushing_to_target_branch:
            ...
            metrics.track_git_changes_pushed(branch_name)
            return {
                "remote_branch": branch_name,
                "committed_to_target_branch": pushing_to_target_branch,
            }
    ...
    def get_repository_status(self) -> Dict[Text, Union[Text, bool]]:
