...
class SQLEventConsumer(EventConsumer):
    ...
    def __init__(
        ...
        password: Optional[Text] = None,should_run_liveness_endpoint: bool = False,
    ):
        from rasa.core.brokers.sql import SQLProducer, SQLBrokerEvent

        self.producer = SQLBrokerEvent(dialect, host, port, db, username, password)
