...
from rasax.community.constants import RASA_PRODUCTION_ENVIRONMENT
...
from rasax.community.database import Environment, Project, LocalPassword
...
class SettingsService(DbService):
    ...
    def get(self, team: Text, project_id: Text) -> Optional[Dict[Text, Text]]:
    ...
    def dump_config(
        ...
        if utils.should_dump():
            self._dump_config(team, project_id, filename)
    ...
    def save_config(
        ...
        self.dump_config(team, project_id)
