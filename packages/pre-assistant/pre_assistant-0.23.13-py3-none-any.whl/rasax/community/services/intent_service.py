...
from rasax.community.database.intent import Intent, TemporaryIntentExample
...
from rasax.community.services.user_goal_service import GOAL_INTENTS_KEY, GOAL_NAME_KEY
