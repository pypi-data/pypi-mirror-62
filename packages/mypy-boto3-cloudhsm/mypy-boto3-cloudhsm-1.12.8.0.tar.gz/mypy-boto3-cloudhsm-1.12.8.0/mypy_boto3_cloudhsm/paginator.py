...
class ListHapgsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListHapgs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/cloudhsm.html#CloudHSM.Paginator.ListHapgs.paginate)
        """
...
class ListHsmsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListHsms.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/cloudhsm.html#CloudHSM.Paginator.ListHsms.paginate)
        """
...
class ListLunaClientsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListLunaClients.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/cloudhsm.html#CloudHSM.Paginator.ListLunaClients.paginate)
        """
