...
#todo
"""
1) For now __version__ = "1.1.0" it is possible to run the code always using the mandatory params ... hence it is not possible calculate them from the 'optional paramter' as written in the README.md
