...
class ListBuildsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBuilds.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codebuild.html#CodeBuild.Paginator.ListBuilds.paginate)
        """
...
class ListBuildsForProjectPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBuildsForProject.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codebuild.html#CodeBuild.Paginator.ListBuildsForProject.paginate)
        """
...
class ListProjectsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListProjects.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/codebuild.html#CodeBuild.Paginator.ListProjects.paginate)
        """
