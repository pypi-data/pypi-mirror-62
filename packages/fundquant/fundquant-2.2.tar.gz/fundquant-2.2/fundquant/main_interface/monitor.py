...
class IndexMonitor:
    ...
    def _etf_statistic_to_df(self, statistics: list) -> pandas.DataFrame:
        ...
        for stat in statistics:
            ...
            pe_mav20_signal.append('吸' if stat.last_pe < stat.pe_less_prob_10y_20d_avg else '抛')
            pe_mav250_signal.append('吸' if stat.last_pe < stat.pe_less_prob_10y_250d_avg else '抛')
