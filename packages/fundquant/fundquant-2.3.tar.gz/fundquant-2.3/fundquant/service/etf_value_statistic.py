...
class EtfStatistic:
    def __init__(self, etf_tack: EtfTrackConfig):
        ...
        self.strategy = etf_tack.strategy
        ...
        self.pe_less_prob_10y_1y_ago = None

        # pe 均线
        self.pe_less_prob_10y_20d_avg = None
        self.pe_less_prob_10y_250d_avg = None
    ...
    def compute(self):
        ...
        pe_less_prob_10y_1y_ago = len(pe_df[pe_df['pe'] <= pe_df.iloc[-252]['pe']]) / len(pe_df)

        pe_less_prob_10y_20d_avg = pe_df.iloc[-20:-1]['pe'].mean()
        pe_less_prob_10y_1y_avg = pe_df.iloc[-250:-1]['pe'].mean()
        ...
        self.pe_less_prob_10y_1y_ago = round(pe_less_prob_10y_1y_ago * 100, 1)
        self.pb_less_prob_10y = round(pb_less_prob_10y * 100, 1)

        self.pe_less_prob_10y_20d_avg = round(pe_less_prob_10y_20d_avg, 1)
        self.pe_less_prob_10y_250d_avg = round(pe_less_prob_10y_1y_avg, 1)
