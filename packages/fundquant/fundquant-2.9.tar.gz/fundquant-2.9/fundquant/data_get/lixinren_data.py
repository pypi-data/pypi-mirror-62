...
class LixinrenData:
    def __init__(self, cookie: str = ''):
        if cookie == '':
            self.cookie = 'jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1Y2IxNzIxNzIzM2RiNTc3MzIwMGFkZGIiLCJpYXQiOjE1ODI5MDk4NTksImV4cCI6MTU4NDExOTQ1OX0.rQ9TXKppWFUsERB2dRvu1pXA9MHvEcmlWf-MPprRLj4'
        else:
            self.cookie = cookie
...
if __name__ == '__main__':
    ...
    p._persist_index_data(1000000030165, 'H30165', '房地产', 'HSI')
