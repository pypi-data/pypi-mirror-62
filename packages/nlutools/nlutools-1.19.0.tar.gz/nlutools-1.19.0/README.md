...
from nlutools import tools as nlu
# 默认使用e成词向量
nlu.simi_words('深度学习', topn=10, type="ifchange")  # 10表示最多返回10个最相似的词
# 或者传入多个词
nlu.simi_words(['深度学习', '机器学习'], 10, "tencent")
```
...
from nlutools import tools as nlu
# 使用腾讯词向量
nlu.simi_score('深度学习', '机器学习', type='tencent')
# 使用ifchange词向量
nlu.simi_score('深度学习', '机器学习', type='ifchange')
```
...
```python
from nlutools import tools as nlu
nlu.sent_simi('你家的地址是多少', '你住哪里', 1000, type="ifchange")
```
