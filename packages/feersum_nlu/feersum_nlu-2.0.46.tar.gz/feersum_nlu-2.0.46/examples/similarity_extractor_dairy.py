...
instance_name = 'sim-word-extractor-dairy'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to dairy.",
                                                    similar_words=["dairy", "cream", "cheese", "milk"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Is dairy like cream and butter healthy?")
