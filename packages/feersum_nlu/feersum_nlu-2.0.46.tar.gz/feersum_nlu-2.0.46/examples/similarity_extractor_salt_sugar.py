...
instance_name = 'sim-word-extractor-salt-sugar'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to salt.",
                                                    similar_words=["salt", "sodium", "nitrate", "nitrates", "msg",
                                                                   "monosodium", "flavour", "tasty", "season", "taste",
                                                                   "spice",
                                                                   "sugar", "sugars", "sweet", "concentrated",
                                                                   "cold drinks", "coke", "cakes", "chocolate", "biscuits",
                                                                   "treacle", "glucose", "syrup", "lactose",
                                                                   "molasses", "sucrose", "honey", "maltose",
                                                                   "isomaltose", "maltodextrin", "dextrose", "fructose"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Can I have salt and other nitrates? What is low sodium?")
