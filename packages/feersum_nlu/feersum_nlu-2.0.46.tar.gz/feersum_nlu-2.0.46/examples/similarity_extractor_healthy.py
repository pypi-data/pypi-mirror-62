...
instance_name = 'sim-word-extractor-healthy'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to questions in health.",
                                                    similar_words=["health", "healthy", "eat", "avoid", "mustn't eat",
                                                                   "unhealthy"],
                                                    threshold=0.75,
...
text_input = feersum_nlu.TextInput("What is healthy to eat?")
