...
instance_name = 'sim-word-extractor-sugar'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to sugar.",
                                                    similar_words=["sugar", "sugars", "sweet", "concentrated",
...
text_input = feersum_nlu.TextInput("Can I have cake or sweets?")
