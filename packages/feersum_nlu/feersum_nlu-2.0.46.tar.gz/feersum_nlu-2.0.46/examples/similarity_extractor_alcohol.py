...
instance_name = 'sim-word-extractor-alcohol'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to alcoholic beverages.",
                                                    similar_words=["alcohol", "wine", "beer", "beers"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Can I have a glass of wine and two beers please?")
