...
instance_name = 'sim-word-extractor-pharma'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to Pharma Dynamics.",
                                                    similar_words=["pharma", "ginger", "from the heart",
                                                                   "chatbot", "program"],
                                                    threshold=0.75,
...
text_input = feersum_nlu.TextInput("Who is Pharma Dynamics and what is Ginger?")
