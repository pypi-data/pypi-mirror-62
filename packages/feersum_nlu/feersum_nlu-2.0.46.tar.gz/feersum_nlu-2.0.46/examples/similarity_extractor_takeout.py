...
instance_name = 'sim-word-extractor-takeout'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to takeout.",
                                                    similar_words=["takeout", "take-out", "take out",
                                                                   "go out", "restaurant", "cafe",
...
text_input = feersum_nlu.TextInput("What should I eat at a restaurant?")
