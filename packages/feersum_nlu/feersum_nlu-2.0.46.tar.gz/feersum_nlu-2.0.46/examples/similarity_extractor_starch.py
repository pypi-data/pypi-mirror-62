...
instance_name = 'sim-word-extractor-starch'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to starch.",
                                                    similar_words=["starch", "starchy", "carbs", "carbohydrates", "carb",
                                                                   "hungry", "bread", "crumbs", "pasta"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Can I eat starch? What are carbs? breadcrumbs")
