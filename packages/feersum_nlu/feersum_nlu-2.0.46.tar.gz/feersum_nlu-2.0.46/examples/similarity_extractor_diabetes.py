...
instance_name = 'sim-word-extractor-diabetes'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to diabetes.",
                                                    similar_words=["diabetes", "gestational diabetes", "gdm"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("What is diabetes and GDM?")
