...
instance_name = 'sim-word-extractor-breakfast_lunch_snack'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to breakfast.",
                                                    similar_words=["breakfast", "lunch", "lunchbox",
                                                                   "snack", "snacks", "protein bar",
                                                                   "between meal"],
                                                    threshold=0.80,
...
text_input = feersum_nlu.TextInput("What is a healthy lunch?")
