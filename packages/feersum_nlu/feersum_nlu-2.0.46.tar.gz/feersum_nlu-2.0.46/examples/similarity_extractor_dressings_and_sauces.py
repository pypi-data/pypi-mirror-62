...
instance_name = 'sim-word-extractor-dressings-and-sauces'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to dressings and sauces.",
                                                    similar_words=["sauce", "sauces", "dressing", "dressings",
                                                                   "mayonnaise", "mayo"],
                                                    threshold=0.75,
...
text_input = feersum_nlu.TextInput("What salad dressings and sauces may I have?")
