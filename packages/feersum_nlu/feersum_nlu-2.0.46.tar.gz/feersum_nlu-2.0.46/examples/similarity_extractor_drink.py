...
instance_name = 'sim-word-extractor-drink'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to drinking like water and juice.",
                                                    similar_words=["water", "juice", "drink", "thirsty", "thirsty"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("What can I have when I'm thirsty?")
