...
instance_name = 'sim-word-extractor-protein'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extract entities related to protein and meat.",
                                                    similar_words=["meat", "protein", "fish", "chicken", "beef", "egg",
                                                                   "game", "goat", "ostrich", "tripe", "trotter"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Should I eat beef, chicken, fish or other meats.")
