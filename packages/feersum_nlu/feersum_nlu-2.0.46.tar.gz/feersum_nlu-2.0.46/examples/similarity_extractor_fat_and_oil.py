...
instance_name = 'sim-word-extractor-kids'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to kids and fussy eaters",
                                                    similar_words=["kids", "child", "fussy", "son", "daughter"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("How do I get fussy eaters to eat more vegetables?")
