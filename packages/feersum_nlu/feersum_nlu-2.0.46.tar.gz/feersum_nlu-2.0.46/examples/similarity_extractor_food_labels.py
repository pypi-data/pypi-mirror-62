...
instance_name = 'sim-word-extractor-food-labels'

similarity_ent_create_details = \
    feersum_nlu.SimWordEntityExtractorCreateDetails(name=instance_name,
                                                    desc="Extracts entities related to food labels.",
                                                    similar_words=["label", "labels",
                                                                   "nutritional info", "nutrition info",
                                                                   "heart mark", "heart logo"],
                                                    threshold=0.75,
                                                    word_manifold="feers_wm_eng",
                                                    # This is one of the built-in word embeddings.
                                                    load_from_store=False)

text_input = feersum_nlu.TextInput("Where is the nutrition info?")
