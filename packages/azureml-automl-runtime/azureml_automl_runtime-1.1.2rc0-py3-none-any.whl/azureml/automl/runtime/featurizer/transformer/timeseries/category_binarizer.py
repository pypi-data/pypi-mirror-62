...
from automl.client.core.common.exceptions import UntrainedModelException
...
class CategoryBinarizer(AzureMLForecastTransformerBase):
    ...
    def transform(self, X, y=None):
        ...
        """
        if not self._is_fit:
            raise UntrainedModelException.create_without_pii(target='CategoryBinarizer')
        ...
        if len(missing_cols) > 0:
            error = 'CategoryBinarizer.transform: Missing columns'
