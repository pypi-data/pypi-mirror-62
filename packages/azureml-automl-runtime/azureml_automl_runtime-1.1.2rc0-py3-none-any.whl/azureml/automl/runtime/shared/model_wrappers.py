...
from automl.client.core.common.exceptions import ArgumentException, UntrainedModelException
from automl.client.core.common.exceptions import InvalidArgumentException
from automl.client.core.common.exceptions import PredictionException
...
from automl.client.core.common.types import GrainType
...
class SparseNormalizer(TransformerMixin, _AbstractModelWrapper):
    ...
    def transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="SparseNormalizer").\
...
class SparseScaleZeroOne(BaseEstimator, TransformerMixin, _AbstractModelWrapper):
    ...
    def fit(self, X, y=None):
        ...
        try:
            ...
            raise FitException.from_exception(e, has_pii=True, target="SparseScaleZeroOne").\
                with_generic_msg(_generic_fit_error_message.format(self.__class__.__name__))
    ...
    def transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target='SparseScaleZeroOne').\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
        X.data = (X.data + 1) / 2
        return X
...
class PreprocWrapper(TransformerMixin, _AbstractModelWrapper):
    ...
    def transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="PreprocWrapper").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
    ...
    def inverse_transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="PreprocWrapper_Inverse"). \
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
...
class TruncatedSVDWrapper(BaseEstimator, TransformerMixin, _AbstractModelWrapper):
    ...
    def transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="TruncatedSVDWrapper").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
    ...
    def inverse_transform(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="TruncatedSVDWrapper_Inverse").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
        ...
        for grain, df_one in X.groupby(self.grain_column_names):
            ...
            if self._ts_transformer.dict_latest_date.get(grain) is not None:
                ...
                if hasgap:
                    ...
                    dtime_imputer = self._ts_transformer.pipeline.get_pipeline_step(
                        constants.TimeSeriesInternal.IMPUTE_NA_FINAL)
                    if dtime_imputer is not None:
                        tsdf_ext = dtime_imputer.transform(tsdf_ext)
...
class PipelineWithYTransformations(sklearn.pipeline.Pipeline):
    ...
    def predict(self, X):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="PipelineWithYTransformations").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
...
class QuantileTransformerWrapper(BaseEstimator, TransformerMixin):
    ...
    def transform(self, y):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="QuantileTransformerWrapper").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
    ...
    def inverse_transform(self, y):
        ...
        try:
            ...
            raise TransformException.from_exception(e, has_pii=True, target="QuantileTransformerWrapper_Inverse").\
                with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
        ...
        if self.y_min is None:
            ...
            if self.safe:
                ...
                try:
                    ...
                    raise TransformException.from_exception(e, has_pii=True, target="LogTransformer").\
                        with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
            else:
                raise ArgumentException.create_without_pii(
    ...
    def return_y(self, y, power, invert=False):
        ...
        if invert:
            try:
                ...
                raise TransformException.from_exception(e, has_pii=True, target="PowerTransformer").\
                    with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
        else:
            return y_inter
    ...
    def fit(self, y, y_min=None):
        ...
        if self.lambda_val is None or self.fitted:
            try:
                ...
                raise TransformException.from_exception(e, has_pii=True, target="BoxCoxTransformer").\
                    with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
        return self
    ...
    def inverse_transform(self, y):
        ...
        if self.lambda_val is None:
            ...
            try:
                ...
                raise TransformException.from_exception(e, has_pii=True, target="BoxCoxTransformer_Inverse").\
                    with_generic_msg(_generic_transform_error_message.format(self.__class__.__name__))
