...
class BackgroundTask:
    def __init__(self, id, method, delay, name=None, max_callings=None,initial_delay=0):
...
class ThreadedBackgroundTaskManager():
    ...
    def register_background_task(self,method, minimum_call_delay=None, max_callings=None,name=None,delay=0):
        ...
        self._background_tasks[task_id] = BackgroundTask(
            id=task_id, method=method, delay=minimum_call_delay, max_callings=max_callings,name=name,initial_delay=delay
        )
