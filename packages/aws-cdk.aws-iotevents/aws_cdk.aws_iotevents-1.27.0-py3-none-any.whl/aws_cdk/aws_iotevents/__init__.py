...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iotevents", "1.27.0", __name__, "aws-iotevents@1.27.0.jsii.tgz")
...
class CfnDetectorModelProps():
    def __init__(self, *, detector_model_definition: typing.Optional[typing.Union[typing.Optional["CfnDetectorModel.DetectorModelDefinitionProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, detector_model_description: typing.Optional[str]=None, detector_model_name: typing.Optional[str]=None, evaluation_method: typing.Optional[str]=None, key: typing.Optional[str]=None, role_arn: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
