...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, pulp_created=None, repository=None, name=None, repository_version=None, pulp_href=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
