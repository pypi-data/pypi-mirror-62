...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, repository_version=None, pulp_href=None, pulp_created=None, name=None, base_path=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
