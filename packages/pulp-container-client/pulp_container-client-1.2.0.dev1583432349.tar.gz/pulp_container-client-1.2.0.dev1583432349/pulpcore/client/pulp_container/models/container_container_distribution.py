...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, name=None, pulp_created=None, base_path=None, repository=None, repository_version=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
