...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, pulp_created=None, name=None, repository_version=None, pulp_href=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
