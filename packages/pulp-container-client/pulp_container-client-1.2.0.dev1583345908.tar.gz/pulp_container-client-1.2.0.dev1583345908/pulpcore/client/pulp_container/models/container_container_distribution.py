...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, repository=None, repository_version=None, content_guard=None, name=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
