...
class Video():
    ...
    def getdbmysql(self, key, mode=0):
        try:
            ...
            sql_cmd ='select * from {}'.format(key)
    ...
    #从服务器查询个股url
    def getMidfromDB(self, left, right, type='mid'):
        sqlStr = "SELECT * FROM user_bilibili WHERE {} BETWEEN \"{}\" AND \"{}\"".format(type, left, right)
