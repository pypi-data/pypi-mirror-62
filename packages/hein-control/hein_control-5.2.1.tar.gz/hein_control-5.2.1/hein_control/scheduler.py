...
class SamplingScheduler(object):
    ...
    def __init__(self,
                 *actions: Union[str, callable, Action],
        ...
        self._default_actions: List[ConfiguredAction] = []
    ...
    @property
    def default_actions(self) -> List[ConfiguredAction]:
        """list of default actions associated with the Scheduler"""
        return self._default_actions
    ...
    def add_default_action(self,
                           action: Union[str, callable, Action, ConfiguredAction],
        ...
        # if not a configured action, create instance
