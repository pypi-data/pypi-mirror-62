...
if __name__ in ['__main__', 'builtins']:
    ...
    time_range = ('2019-10-01T16:00:00.000', '2020-01-01T16:15:00.000')
    ids = ids_from_server(index='appevents', time_range=time_range)
    id_subset = list(richest_ids(ids=ids, top=30).keys())
    ...
    pipeline(name='glance_small', ids=id_subset, dir=hlp.DATA_DIR, indices=('notifications','sessions',),
