...
########## WIRELESS CLIENT
    ...
    def trafficAnalysis_clientUsageWlan (self, filter_type, filter_value, date_range, interval='90000', rate='tx+rx', frequence='2.4G+5G', page=1, limit=1000):
        '''clientUsageWlan return number total of clients in zone, name of device and total bytes consumed
           Params: (self, filter_type, filter_value, date_range, interval='90000', rate='tx+rx', frequence='2.4G+5G', page=1, limit=1000)
