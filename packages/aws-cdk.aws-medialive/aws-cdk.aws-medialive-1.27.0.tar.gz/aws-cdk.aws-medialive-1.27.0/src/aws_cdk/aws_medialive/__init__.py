...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-medialive", "1.27.0", __name__, "aws-medialive@1.27.0.jsii.tgz")
...
class CfnChannel(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-medialive.CfnChannel"):
    ...
    class MultiplexProgramChannelDestinationSettingsProperty():
        def __init__(self, *, multiplex_id: typing.Optional[str]=None, program_name: typing.Optional[str]=None):
            """
