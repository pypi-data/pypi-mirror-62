...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-route53-targets", "1.27.0", __name__, "aws-route53-targets@1.27.0.jsii.tgz")
...
__all__ = ["ApiGateway", "ApiGatewayDomain", "BucketWebsiteTarget", "ClassicLoadBalancerTarget", "CloudFrontTarget", "InterfaceVpcEndpointTarget", "LoadBalancerTarget", "__jsii_assembly__"]
