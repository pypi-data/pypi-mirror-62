...
class SoldProperty(Model):
    ...
    def parking(self, parking: List[str]):
        ...
        :type parking: List[str]
        """
        allowed_values = ["Attached", "Carport", "Detached", "Driveway", "Parking Pad", "Rear Drive Access", "RV Parking", "Outdoor Stalls", "220 Volt Wiring", "Street Parking", "None"]  # noqa: E501
