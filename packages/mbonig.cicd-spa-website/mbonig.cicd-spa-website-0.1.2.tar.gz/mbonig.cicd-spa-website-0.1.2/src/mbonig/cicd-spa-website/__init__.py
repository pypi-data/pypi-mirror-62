...
__jsii_assembly__ = jsii.JSIIAssembly.load("cicd-spa-website", "0.1.2", __name__, "cicd-spa-website@0.1.2.jsii.tgz")


class CicdSpaWebsite(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cicd-spa-website.CicdSpaWebsite"):
...
@jsii.data_type(jsii_type="cicd-spa-website.CicdSpaWebsiteProps", jsii_struct_bases=[aws_cdk.core.StackProps], name_mapping={'description': 'description', 'env': 'env', 'stack_name': 'stackName', 'tags': 'tags', 'github_source': 'githubSource', 'url': 'url', 'build_spec': 'buildSpec', 'certificate': 'certificate', 'hosted_zone': 'hostedZone'})
...
@jsii.data_type(jsii_type="cicd-spa-website.ReducedGitHubSourceActionProps", jsii_struct_bases=[], name_mapping={'oauth_token': 'oauthToken', 'owner': 'owner', 'repo': 'repo', 'branch': 'branch'})
