...
id = "c6afb0789517073ea7423d2422b1ba844a050ef9"
date = "2020-02-25 23:42:33 +0000"
branch = "None"
tag = "lalsuite-v6.69"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "c6afb0789517073ea7423d2422b1ba844a050ef9":
        return
    msg = "Program id (c6afb0789517073ea7423d2422b1ba844a050ef9) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
