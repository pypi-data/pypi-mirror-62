...
class DescribeProjectVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeProjectVersions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/rekognition.html#Rekognition.Paginator.DescribeProjectVersions.paginate)
        """
...
class DescribeProjectsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeProjects.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/rekognition.html#Rekognition.Paginator.DescribeProjects.paginate)
        """
...
class ListCollectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCollections.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/rekognition.html#Rekognition.Paginator.ListCollections.paginate)
        """
...
class ListFacesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFaces.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/rekognition.html#Rekognition.Paginator.ListFaces.paginate)
        """
...
class ListStreamProcessorsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreamProcessors.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.8/reference/services/rekognition.html#Rekognition.Paginator.ListStreamProcessors.paginate)
        """
