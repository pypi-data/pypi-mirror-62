...
from re_coommon.baselibrary import BaseUrl
from re_coommon.baselibrary import printfunc, closeResult
from re_coommon.baselibrary.utils.core.requests_core import USER_AGENT, set_proxy
...
class BaseRequest(object):
    ...
    def base_request(self, url, sn=None, endstring="", marks=[], **kwargs):
        """
        网络请求的基本结构
        :param url:  请求的url
