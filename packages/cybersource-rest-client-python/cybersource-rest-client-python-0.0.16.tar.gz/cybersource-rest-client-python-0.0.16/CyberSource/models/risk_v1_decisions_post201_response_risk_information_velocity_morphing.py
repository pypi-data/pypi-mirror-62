...
class RiskV1DecisionsPost201ResponseRiskInformationVelocityMorphing(object):
    """
    ...
    def __init__(self, count=None, field_name=None, information_code=None):
        """
        RiskV1DecisionsPost201ResponseRiskInformationVelocityMorphing - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskV1DecisionsPost201ResponseRiskInformationVelocityMorphing):
            return False
