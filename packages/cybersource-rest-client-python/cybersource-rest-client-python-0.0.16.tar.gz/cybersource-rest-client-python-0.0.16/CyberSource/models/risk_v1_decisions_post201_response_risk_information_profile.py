...
class RiskV1DecisionsPost201ResponseRiskInformationProfile(object):
    """
    ...
    def __init__(self, name=None, desination_queue=None, selector_rule=None):
        """
        RiskV1DecisionsPost201ResponseRiskInformationProfile - a model defined in Swagger
        """
    ...
    def desination_queue(self):
        """
        Gets the desination_queue of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        Name of the queue where orders that are not automatically accepted are sent. 

        :return: The desination_queue of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        :rtype: str
        """
    ...
    def desination_queue(self, desination_queue):
        """
        Sets the desination_queue of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        Name of the queue where orders that are not automatically accepted are sent. 

        :param desination_queue: The desination_queue of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        :type: str
        """
    ...
    def selector_rule(self):
        """
        Gets the selector_rule of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        ...
        :return: The selector_rule of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        :rtype: str
        """
    ...
    def selector_rule(self, selector_rule):
        """
        Sets the selector_rule of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        Name of the profile selector rule that chooses the profile to use for the transaction. If no profile selector exists, the value is Default Active Profile. 

        :param selector_rule: The selector_rule of this RiskV1DecisionsPost201ResponseRiskInformationProfile.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskV1DecisionsPost201ResponseRiskInformationProfile):
            return False
