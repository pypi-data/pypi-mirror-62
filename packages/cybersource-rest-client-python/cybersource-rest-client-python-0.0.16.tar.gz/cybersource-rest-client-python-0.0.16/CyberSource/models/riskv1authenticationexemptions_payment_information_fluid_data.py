...
class Riskv1authenticationexemptionsPaymentInformationFluidData(object):
    """
    ...
    def __init__(self, value=None, key_serial_number=None, descriptor=None, encoding=None):
        """
        Riskv1authenticationexemptionsPaymentInformationFluidData - a model defined in Swagger
        """
    ...
    def value(self):
        """
        Gets the value of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        ...
        :return: The value of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        Represents the encrypted payment data BLOB. The entry for this field is dependent on the payment solution a merchant uses.  For details, see [Creating an Online Authorization](https://developer.cybersource.com/api/developer-guides/dita-payments/CreatingOnlineAuth.html) for the specific payment- solution entry. 

        :param value: The value of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :type: str
        """
        if value is None:
    ...
    def key_serial_number(self):
        """
        Gets the key_serial_number of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        ...
        :return: The key_serial_number of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def key_serial_number(self, key_serial_number):
        """
        Sets the key_serial_number of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        The encoded or encrypted value that a payment solution returns for an authorization request. For details about the valid values for a key, see [Creating an Online Authorization](https://developer.cybersource.com/api/developer-guides/dita-payments/CreatingOnlineAuth.html) 

        :param key_serial_number: The key_serial_number of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :type: str
        """
    ...
    def descriptor(self):
        """
        Gets the descriptor of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        ...
        :return: The descriptor of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def descriptor(self, descriptor):
        """
        Sets the descriptor of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        The identifier for a payment solution, which is sending the encrypted payment data to CyberSource for decryption. Valid values: - Samsung Pay: `RklEPUNPTU1PTi5TQU1TVU5HLklOQVBQLlBBWU1FTlQ=` **NOTE**: For other payment solutions, the value may be specific to the customer's mobile device. For example, the descriptor for a Bluefin payment encryption would be a device-generated descriptor.  For details about the list of payment solution identifiers, see [Creating an Online Authorization](https://developer.cybersource.com/api/developer-guides/dita-payments/CreatingOnlineAuth.html).  For details about the encrypted payment data, see the `encrypted_payment_descriptor` field description in the [Card-Present Processing Using the SCMP API Guide](https://apps.cybersource.com/library/documentation/dev_guides/Retail_SCMP_API/html/). 

        :param descriptor: The descriptor of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :type: str
        """
    ...
    def encoding(self):
        """
        Gets the encoding of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        Encoding method used to encrypt the payment data.  Valid value: Base64 

        :return: The encoding of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def encoding(self, encoding):
        """
        Sets the encoding of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        Encoding method used to encrypt the payment data.  Valid value: Base64 

        :param encoding: The encoding of this Riskv1authenticationexemptionsPaymentInformationFluidData.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Riskv1authenticationexemptionsPaymentInformationFluidData):
            return False
