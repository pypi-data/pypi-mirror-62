...
class RiskV1DecisionsPost201ResponseRiskInformationInfoCodes(object):
    """
    ...
    def __init__(self, velocity=None, address=None, customer_list=None, identity_change=None, internet=None, phone=None, suspicious=None, global_velocity=None):
        """
        RiskV1DecisionsPost201ResponseRiskInformationInfoCodes - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskV1DecisionsPost201ResponseRiskInformationInfoCodes):
            return False
