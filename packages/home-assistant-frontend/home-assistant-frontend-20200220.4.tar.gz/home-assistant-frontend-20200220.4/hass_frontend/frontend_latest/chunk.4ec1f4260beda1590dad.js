/*! For license information please see chunk.4ec1f4260beda1590dad.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[131],{110:function(e,t,i){"use strict";i(3),i(111),i(42);var r=i(56),a=i(5),n=i(4);Object(a.a)({is:"paper-icon-button",_template:n.a`
    <style>
      :host {
    ...
    <iron-icon id="icon" src="[[src]]" icon="[[icon]]"
               alt$="[[alt]]"></iron-icon>
  `,hostAttributes:{role:"button",tabindex:"0"},behaviors:[r.a],registered:function(){this._template.setAttribute("strip-whitespace","")},properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(e,t){var i=this.getAttribute("aria-label");i&&t!=i||this.setAttribute("aria-label",e)}})},129:function(e,t,i){"use strict";i(3),i(42);var r=i(130),a=i(56),n=i(5),o=i(4),s=i(61);const c=o.a`<style>
  :host {
    display: inline-block;
    white-space: nowrap;
    cursor: pointer;
