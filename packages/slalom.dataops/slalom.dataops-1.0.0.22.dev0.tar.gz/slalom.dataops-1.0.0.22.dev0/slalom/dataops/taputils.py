...
def _build_all_standalone(source_image=None, plugins_index=None, push=False):
...
def _get_plugin_info(alias, plugins_index=None):
    plugins = _get_plugins_list(plugins_index)
    for name, source, alias in plugins:
...
def _build_all_composite(source_image=None, plugins_index=None, push=False):
    plugins = _get_plugins_list(plugins_index)
    for tap in plugins:
