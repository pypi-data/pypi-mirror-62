...
class Colony:
    ...
    def __init__(self, account: str, **kwargs):
        ...
        self.token_response = self.login_with_token_or_credentials(account, gateway, kwargs)
    ...
    def login_with_token_or_credentials(self, account, gateway, kwargs):
        return kwargs.get("access_token") if kwargs.get("access_token") else \
