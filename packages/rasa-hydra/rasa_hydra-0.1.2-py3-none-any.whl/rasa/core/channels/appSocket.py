...
HYDRA_CHANNEL = "OMNI_IOSAPP_00001"
...
class AppInput(InputChannel):
    ...
    def from_credentials(cls, credentials):
        ...
        return cls(credentials.get("user_message_evt", "user_uttered"),
                   ...
                   credentials.get("socketio_path", "/ios_socket.io"),
                   )
    ...
    def blueprint(self, on_new_message):
        ...
        async def disconnect(sid):
            ...
            output_channel = AppOutput(sio, sid, self.namespace, self.bot_message_evt)
