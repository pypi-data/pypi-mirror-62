...
def add_commands(parser):
    ...
    if parser_admin is not None:
        ...
        parser_edition = admin_subparsers.add_parser('edition', help='Enable/disable an edtion on a group/project')
        parser_edition.set_defaults(config=get_config)

        edition_subparsers = parser_edition.add_subparsers(title='Available edition commands', metavar='')
        parsers['admin edition enable'] = editions.add_enable_command(edition_subparsers, [])
        parsers['admin edition disable'] = editions.add_disable_command(edition_subparsers, [])
    ...
    if enable_beta_commands:
        ...
        ingest_subparsers = parser_ingest.add_subparsers(title='Available ingest commands', metavar='')
