...
def get_remote_file(file_name: str,
    ...
    _url_root = 'https://gitlab.com/iiit-public/plenpy-binaries/raw/master/'
...
def _fetch_file(url: str,
    ...
    for tries in range(4):
        try:
            ...
            logger.info(f'Try {tries + 1}. Download from {url} ({size_str})')
        ...
        raise IOError('Unable to download {os.path.basename(file_name)}. '
