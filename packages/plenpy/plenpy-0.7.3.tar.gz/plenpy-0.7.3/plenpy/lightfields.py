...
class LightField(SpectralArray):
    ...
    def _2d_to_4d(data: ndarray,
        ...
        of subaperture views. See also the inverse :func:`to_2d`.
        ...
        See Also:
            The inverse function :func:`to_2d`.
        """
    ...
    def save(self,
        ...
        See also :func:`to_2d`. If more than 3 color channels are found,
        ...
        hsi = spectral.SpectralImage(LightField.to_2d(self))
    ...
    def show_2d(self, method='SAI', cmap: str = 'gray', plt_show: bool = True):
        """ Show the 4D light field as 2D representation.
         ...
         The conversion is calculated using :func:`to_2d`.
        ...
        if num_ch > 3:
            ...
            im = self
        plt.figure()
        plt.imshow(np.squeeze(np.asarray(LightField.to_2d(im, method=method))), cmap=cmap)
