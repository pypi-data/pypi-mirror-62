...
"""
A setuptools based setup module for june.
...
with open(path.join(here, 'june', 'june.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    name='june-py',
    version=__version__,
    description='A python API wrapper for June',
    long_description=long_description,
    url='https://github.com/energieid/june',
    author='EnergieID.be',
    ...
    keywords='june data monitoring api',
