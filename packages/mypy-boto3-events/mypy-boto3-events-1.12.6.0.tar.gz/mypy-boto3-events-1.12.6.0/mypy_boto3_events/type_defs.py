...
_RequiredClientCreateEventBusTagsTypeDef = TypedDict(
    "_RequiredClientCreateEventBusTagsTypeDef", {"Key": str}
)
_OptionalClientCreateEventBusTagsTypeDef = TypedDict(
    "_OptionalClientCreateEventBusTagsTypeDef", {"Value": str}, total=False
)


class ClientCreateEventBusTagsTypeDef(
    _RequiredClientCreateEventBusTagsTypeDef, _OptionalClientCreateEventBusTagsTypeDef
):
    pass
