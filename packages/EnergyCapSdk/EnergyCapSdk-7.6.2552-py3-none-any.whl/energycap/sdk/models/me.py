...
class Me(Model):
    ...
    :param place: User's topmost place
    :type place: ~energycap.sdk.models.TopmostPlace
    :param cost_center: User's topmost cost center
    ...
    :param preference: Display prefernces for the user
    ...
    :param currency_unit: Currency unit configured for the user's owner
    ...
    :param permissions: Permissions to which the user has access via their
     User Role
