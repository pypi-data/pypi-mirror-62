...
from azureml.automl.core import dataset_utilities, package_utilities
...
class AzureAutoMLClient:
    ...
    def _create_parent_run_for_remote(self, run_config_object, X=None, y=None, sample_weight=None,
        ...
        try:
            ...
            logging_utilities.log_traceback(e, self.logger)
            self._raise_feature_unavailable_exception(e)
            _raise_exception(e)
    ...
    def _raise_feature_unavailable_exception(self, e: AzureMLServiceException) -> None:
        if is_error_code(e, ErrorHierarchy.FEATUREUNAVAILABLE_ERROR) is True:
            ...
            try:
                ...
                pass
            raise FeatureUnavailableException(error_message) from None
