...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-batch", "1.27.0", __name__, "aws-batch@1.27.0.jsii.tgz")
...
class ComputeEnvironmentProps():
    def __init__(self, *, allocation_strategy: typing.Optional["AllocationStrategy"]=None, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional["ComputeResources"]=None, enabled: typing.Optional[bool]=None, managed: typing.Optional[bool]=None, service_role: typing.Optional[aws_cdk.aws_iam.IRole]=None):
        ...
        :param compute_resources: The details of the compute resources managed by this environment. If specified, and this is an managed compute environment, the property will be ignored. By default, AWS Batch managed compute environments use a recent, approved version of the Amazon ECS-optimized AMI for compute resources. Default: - AWS-managed compute resources
    ...
    def allocation_strategy(self) -> typing.Optional["AllocationStrategy"]:
        """The allocation strategy to use for the compute resource in case not enough instances ofthe best fitting instance type can be allocated.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-batch.ComputeResources", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'bid_percentage': 'bidPercentage', 'compute_resources_tags': 'computeResourcesTags', 'desiredv_cpus': 'desiredvCpus', 'ec2_key_pair': 'ec2KeyPair', 'image': 'image', 'instance_role': 'instanceRole', 'instance_types': 'instanceTypes', 'maxv_cpus': 'maxvCpus', 'minv_cpus': 'minvCpus', 'security_groups': 'securityGroups', 'spot_fleet_role': 'spotFleetRole', 'type': 'type', 'vpc_subnets': 'vpcSubnets'})
class ComputeResources():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, bid_percentage: typing.Optional[jsii.Number]=None, compute_resources_tags: typing.Optional[aws_cdk.core.Tag]=None, desiredv_cpus: typing.Optional[jsii.Number]=None, ec2_key_pair: typing.Optional[str]=None, image: typing.Optional[aws_cdk.aws_ec2.IMachineImage]=None, instance_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, instance_types: typing.Optional[typing.List[aws_cdk.aws_ec2.InstanceType]]=None, maxv_cpus: typing.Optional[jsii.Number]=None, minv_cpus: typing.Optional[jsii.Number]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, spot_fleet_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, type: typing.Optional["ComputeResourceType"]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None):
        ...
        :param instance_role: The IAM role applied to EC2 resources in the compute environment. Default: - a new role will be created.
        ...
        :param minv_cpus: The minimum number of EC2 vCPUs that an environment should maintain (even if the compute environment state is DISABLED). Each vCPU is equivalent to 1,024 CPU shares. You must specify at least one vCPU. Default: 1
...
class ComputeEnvironment(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-batch.ComputeEnvironment"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, allocation_strategy: typing.Optional["AllocationStrategy"]=None, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional["ComputeResources"]=None, enabled: typing.Optional[bool]=None, managed: typing.Optional[bool]=None, service_role: typing.Optional[aws_cdk.aws_iam.IRole]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param allocation_strategy: The allocation strategy to use for the compute resource in case not enough instances ofthe best fitting instance type can be allocated. This could be due to availability of the instance type in the region or Amazon EC2 service limits. If this is not specified, the default is BEST_FIT, which will use only the best fitting instance type, waiting for additional capacity if it's not available. This allocation strategy keeps costs lower but can limit scaling. If you are using Spot Fleets with BEST_FIT then the Spot Fleet IAM Role must be specified. BEST_FIT_PROGRESSIVE will select an additional instance type that is large enough to meet the requirements of the jobs in the queue, with a preference for an instance type with a lower cost. SPOT_CAPACITY_OPTIMIZED is only available for Spot Instance compute resources and will select an additional instance type that is large enough to meet the requirements of the jobs in the queue, with a preference for an instance type that is less likely to be interrupted. Default: AllocationStrategy.BEST_FIT
        ...
        :stability: experimental
        """
        props = ComputeEnvironmentProps(allocation_strategy=allocation_strategy, compute_environment_name=compute_environment_name, compute_resources=compute_resources, enabled=enabled, managed=managed, service_role=service_role)
...
class JobDefinitionProps():
    def __init__(self, *, container: "JobDefinitionContainer", job_definition_name: typing.Optional[str]=None, node_props: typing.Optional["IMultiNodeProps"]=None, parameters: typing.Optional[typing.Mapping[str,str]]=None, retry_attempts: typing.Optional[jsii.Number]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None):
...
class JobQueue(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-batch.JobQueue"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, compute_environments: typing.Optional[typing.List["JobQueueComputeEnvironment"]]=None, enabled: typing.Optional[bool]=None, job_queue_name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class JobQueueComputeEnvironment():
    def __init__(self, *, compute_environment: "IComputeEnvironment", order: jsii.Number):
...
class JobQueueProps():
    def __init__(self, *, compute_environments: typing.Optional[typing.List["JobQueueComputeEnvironment"]]=None, enabled: typing.Optional[bool]=None, job_queue_name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None):
        ...
        if compute_environments is not None: self._values["compute_environments"] = compute_environments
        if enabled is not None: self._values["enabled"] = enabled
        if job_queue_name is not None: self._values["job_queue_name"] = job_queue_name
        if priority is not None: self._values["priority"] = priority

    @builtins.property
    def compute_environments(self) -> typing.Optional[typing.List["JobQueueComputeEnvironment"]]:
...
__all__ = ["AllocationStrategy", "CfnComputeEnvironment", "CfnComputeEnvironmentProps", "CfnJobDefinition", "CfnJobDefinitionProps", "CfnJobQueue", "CfnJobQueueProps", "ComputeEnvironment", "ComputeEnvironmentProps", "ComputeResourceType", "ComputeResources", "IComputeEnvironment", "IJobDefinition", "IJobQueue", "IMultiNodeProps", "INodeRangeProps", "JobDefinition", "JobDefinitionContainer", "JobDefinitionProps", "JobQueue", "JobQueueComputeEnvironment", "JobQueueProps", "__jsii_assembly__"]
