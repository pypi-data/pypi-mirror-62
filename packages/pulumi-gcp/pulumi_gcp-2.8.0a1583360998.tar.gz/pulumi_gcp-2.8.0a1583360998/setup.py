...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.8.0-alpha.1583360998+g006ec1c6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.8.0-alpha.1583360998+g006ec1c6`
                """)
            else:
                raise
