...
from .dataaccess._nyc_tlc_fhv_blob_info import NycTlcFhvBlobInfo
...
class NycTlcFhv(TimePublicData, TabularOpenDatasetFactory):
    ...
    .. remarks::
        ...
        .. code-block:: python
            ...
            end_date = parser.parse('2018-06-06')
            start_date = parser.parse('2018-05-01')
            NycTlcFhv.env = environ.PandasEnv()
            nyc_tlc_df = NycTlcFhv().filter(environ.PandasEnv(), start_date, end_date)
    ...
    _blobInfo = NycTlcFhvBlobInfo()

    data = BlobParquetDescriptor(_blobInfo)

    time_column_name = 'pickupDateTime'
