...
"""Blob info of NYC Taxi yellow trip data."""

from .base_blob_info import BaseBlobInfo


class NycTlcYellowBlobInfo(BaseBlobInfo):
    """Blob info of NYC TLC yellow data."""

    def __init__(self):
        """Initialize Blob Info."""
        self.registry_id = 'nyc_tlc_yellow'
        self.blob_account_name = 'azureopendatastorage'
        self.blob_container_name = "nyctlc"
        self.blob_relative_path = "yellow/"
        self.blob_sas_token = (
