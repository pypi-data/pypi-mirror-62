...
"""Blob info of Chicago Safety Data."""

from .base_blob_info import BaseBlobInfo


class ChicagoSafetyBlobInfo(BaseBlobInfo):
    """Blob info of Chicago Safety Data."""

    def __init__(self):
        """Initialize Blob Info."""
        self.registry_id = 'city_safety_chicago'
        self.blob_account_name = 'azureopendatastorage'
        self.blob_container_name = "citydatacontainer"
        self.blob_relative_path = "Safety/Release/city=Chicago/"
        self.blob_sas_token = (
