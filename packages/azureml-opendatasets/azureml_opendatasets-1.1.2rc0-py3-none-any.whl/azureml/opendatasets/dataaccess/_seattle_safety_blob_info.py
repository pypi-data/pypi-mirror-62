...
"""Blob info of Seattle Safety Data."""

from .base_blob_info import BaseBlobInfo


class SeattleSafetyBlobInfo(BaseBlobInfo):
    """Blob info of Seattle Safety Data."""

    def __init__(self):
        """Initialize Blob Info."""
        self.registry_id = 'city_safety_seattle'
        self.blob_account_name = 'azureopendatastorage'
        self.blob_container_name = "citydatacontainer"
        self.blob_relative_path = "Safety/Release/city=Seattle/"
        self.blob_sas_token = (
