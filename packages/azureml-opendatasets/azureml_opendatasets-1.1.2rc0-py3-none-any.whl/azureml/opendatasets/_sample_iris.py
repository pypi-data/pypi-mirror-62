...
from .dataaccess._sample_iris_blob_info import SampleIrisBlobInfo


class SampleIris:
    """Represents the Sample Iris dataset."""
    _blobInfo = SampleIrisBlobInfo()
