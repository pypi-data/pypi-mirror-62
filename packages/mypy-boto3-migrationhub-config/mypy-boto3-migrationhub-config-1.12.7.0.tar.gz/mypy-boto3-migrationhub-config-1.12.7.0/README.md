...
[boto3.MigrationHubConfig 1.12.7](https://boto3.amazonaws.com/v1/documentation/api/1.12.7/reference/services/migrationhub-config.html#MigrationHubConfig) service
