...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_copy.setMinimumSize(QSize(0, 26))
        self.pushButton_copy.setMaximumSize(QSize(16777215, 26))
        ...
        QWidget.setTabOrder(self.lineEdit_1_date, self.comboBox_2_revision)
        QWidget.setTabOrder(self.comboBox_2_revision, self.lineEdit_3_project_no)
        QWidget.setTabOrder(self.lineEdit_3_project_no, self.lineEdit_4_project_stage)
        QWidget.setTabOrder(self.lineEdit_4_project_stage, self.lineEdit_5_title)
        QWidget.setTabOrder(self.lineEdit_5_title, self.comboBox_6_type)
        QWidget.setTabOrder(self.comboBox_6_type, self.comboBox_7_security_status)
        QWidget.setTabOrder(self.comboBox_7_security_status, self.checkBox_replace_spaces)
        QWidget.setTabOrder(self.checkBox_replace_spaces, self.lineEdit_out_result)
        QWidget.setTabOrder(self.lineEdit_out_result, self.pushButton_copy)
