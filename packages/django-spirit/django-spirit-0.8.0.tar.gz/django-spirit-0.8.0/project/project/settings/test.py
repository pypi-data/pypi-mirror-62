...
ST_MARKDOWN_PLUGINS = [
    {'renderer': 'spirit.core.utils.markdown.contrib.math.MathRendererMixin',
     'inline': 'spirit.core.utils.markdown.contrib.math.MathInlineMixin',
     'block': 'spirit.core.utils.markdown.contrib.math.MathBlockMixin',
     'meta': 'spirit.core.utils.markdown.contrib.math.MathMeta'}
]
