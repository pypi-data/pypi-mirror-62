...
###############################################################################################################
    ...
    downerguides = downerguides[(downerguides['Distance from Amino Acid (bp)'] >= 0)]  #Remove guides if they are less than 0 base pairs away from the amino acid
    upperguides = upperguides[(upperguides['Distance from Amino Acid (bp)'] <= 0)]  #Remove guides if they are more than 0 base pairs away from the amino acid
