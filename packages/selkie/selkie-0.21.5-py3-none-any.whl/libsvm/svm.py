...
from seal.core.io import Dest
libfn = str(Dest/'_inst/lib/libsvm.so.2')

# This is set at the bottom of this file
libsvm = None
...
if path.exists(libfn):
    ...
    print('WARNING: LIBSVM library not found: %s' % libfn, file=sys.stderr)
