...
class RouteStatistics(object):
    ...
    def __init__(self, distance=None, duration=None, stopping_time=None, time_window=None):  # noqa: E501
        """RouteStatistics - a model defined in Swagger"""  # noqa: E501
        self._distance = None
        self._duration = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RouteStatistics, dict):
