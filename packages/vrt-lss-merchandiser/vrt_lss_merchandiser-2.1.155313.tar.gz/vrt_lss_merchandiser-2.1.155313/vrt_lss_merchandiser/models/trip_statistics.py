...
class TripStatistics(object):
    ...
    def __init__(self, trip_key=None, statistics=None, stop_statistics=None, total_load=None, max_load=None):  # noqa: E501
