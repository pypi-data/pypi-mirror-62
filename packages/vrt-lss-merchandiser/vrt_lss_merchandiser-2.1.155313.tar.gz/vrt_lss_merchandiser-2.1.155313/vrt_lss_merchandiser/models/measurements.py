...
class Measurements(object):
    ...
    def __init__(self, driving_time=None, waiting_time=None, working_time=None, arriving_time=None, departure_time=None, total_time=None, time_window=None, distance=None):  # noqa: E501
