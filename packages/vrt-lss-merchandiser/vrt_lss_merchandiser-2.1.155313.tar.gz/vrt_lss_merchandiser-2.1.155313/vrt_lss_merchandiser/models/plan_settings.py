...
class PlanSettings(object):
    ...
    def __init__(self, configuration='optimize_money', planning_time=20, result_ttl=20, result_timezone=0, predict_slots=0, flight_distance=False, traffic_jams=True, transport_factor=None, routing=None):  # noqa: E501
        """PlanSettings - a model defined in Swagger"""  # noqa: E501
    ...
    def configuration(self):
        ...
        Название конфигурации планирования  # noqa: E501
    ...
    def planning_time(self):
        ...
        Время планирования в минутах  # noqa: E501
    ...
    def result_ttl(self):
        ...
        Время жизни результата планирования в минутах, старт отсчета начинается от времени завершения планирования  # noqa: E501
    ...
    def predict_slots(self):
        ...
        Количество одновременных запросов для подсказки временных окон, если 0 - то данные для подсказки окон не подготавливаются  # noqa: E501
    ...
    def flight_distance(self):
        """Gets the flight_distance of this PlanSettings.  # noqa: E501

        Использовать для расчетов расстояния по прямой (true - по прямой, false - по дорогам)  # noqa: E501

        :return: The flight_distance of this PlanSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def flight_distance(self, flight_distance):
        """Sets the flight_distance of this PlanSettings.

        Использовать для расчетов расстояния по прямой (true - по прямой, false - по дорогам)  # noqa: E501

        :param flight_distance: The flight_distance of this PlanSettings.  # noqa: E501
        :type: bool
        """
    ...
    def traffic_jams(self):
        """Gets the traffic_jams of this PlanSettings.  # noqa: E501

        Учитывать пробки при планировании маршрутов  # noqa: E501

        :return: The traffic_jams of this PlanSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def traffic_jams(self, traffic_jams):
        """Sets the traffic_jams of this PlanSettings.

        Учитывать пробки при планировании маршрутов  # noqa: E501

        :param traffic_jams: The traffic_jams of this PlanSettings.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PlanSettings, dict):
