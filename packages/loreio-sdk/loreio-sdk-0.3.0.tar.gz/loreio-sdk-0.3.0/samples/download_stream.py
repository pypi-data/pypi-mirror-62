...
parser.add_argument('--url', default='wss://ui.getlore.io/storyteller', type=unicode)
...
print "\n  Using start_date = {}, end_date = {}".format(args.start_date, args.end_date)
...
(status, seqno, _) = spyglass.sync_cmd('session', [args.project_id])
...
for (status, seqno, data) in spyglass.streaming_cmd('chart',
                                                    chart_args, 
                                                    {'stream': None,
