...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fi', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'eo', 'zh-min-nan',
        'hy', 'bg', 'he', 'da', 'ce', 'sk', 'kk', 'min', 'hr', 'et', 'lt',
        'be', 'azb', 'el', 'sl', 'gl', 'arz', 'az', 'simple', 'ur', 'nn', 'hi',
        'th', 'ka', 'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'tg', 'lv', 'ast',
        'mg', 'af', 'tt', 'oc', 'bn', 'bs', 'ky', 'sq', 'zh-yue', 'tl', 'new',
        'te', 'be-tarask', 'ml', 'br', 'pms', 'nds', 'su', 'ht', 'lb', 'jv',
        'sco', 'mr', 'sw', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv',
        'lmo', 'an', 'ne', 'pa', 'yo', 'bar', 'io', 'wuu', 'gu', 'als', 'ku',
        'scn', 'kn', 'ckb', 'bpy', 'ia', 'qu', 'vec', 'mn', 'bat-smg', 'wa',
        'or', 'si', 'cdo', 'gd', 'yi', 'am', 'nap', 'ilo', 'bug', 'xmf', 'hsb',
        'mai', 'diq', 'map-bms', 'fo', 'mzn', 'sd', 'li', 'nv', 'eml', 'sah',
        'os', 'sa', 'ps', 'ace', 'frr', 'mrj', 'zh-classical', 'mhr', 'hif',
        'bcl', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se', 'rue', 'mi',
        'vls', 'crh', 'bh', 'nah', 'nds-nl', 'shn', 'gan', 'sc', 'vep', 'as',
        'ab', 'glk', 'bo', 'myv', 'co', 'so', 'tk', 'fiu-vro', 'kv', 'lrc',
        'csb', 'gv', 'sn', 'udm', 'ie', 'zea', 'pcd', 'ay', 'ha', 'kab', 'nrm',
        'ug', 'lez', 'stq', 'kw', 'haw', 'mwl', 'gn', 'lfn', 'gom', 'lij',
        'rm', 'lo', 'lad', 'frp', 'koi', 'mt', 'fur', 'dsb', 'dty', 'olo',
        'ang', 'ext', 'ln', 'cbk-zam', 'dv', 'bjn', 'ksh', 'gag', 'pfl', 'gor',
        'pi', 'pag', 'sat', 'av', 'ban', 'bxr', 'xal', 'krc', 'tyv', 'za',
        'pap', 'kaa', 'pdc', 'rw', 'szy', 'to', 'nov', 'kl', 'arc', 'jam',
        'tpi', 'kbp', 'kbd', 'tet', 'ig', 'wo', 'zu', 'ki', 'na', 'tcy', 'jbo',
        'inh', 'roa-rup', 'lbe', 'bi', 'ty', 'kg', 'mdf', 'lg', 'atj', 'srn',
        'xh', 'gcr', 'ltg', 'chr', 'sm', 'got', 'ak', 'pih', 'fj', 'om', 'tn',
        'cu', 'tw', 'ts', 'rmy', 'bm', 'st', 'chy', 'rn', 'tum', 'ny', 'nqo',
        'ch', 'ss', 'mnw', 'pnt', 'ady', 'iu', 'ks', 've', 'ee', 'ik', 'sg',
        'ff', 'dz', 'ti', 'din', 'cr',
    ]
