...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/custom-resources", "1.27.0", __name__, "custom-resources@1.27.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/custom-resources.AwsSdkCall", jsii_struct_bases=[], name_mapping={'action': 'action', 'service': 'service', 'api_version': 'apiVersion', 'catch_error_pattern': 'catchErrorPattern', 'output_path': 'outputPath', 'parameters': 'parameters', 'physical_resource_id': 'physicalResourceId', 'region': 'region'})
class AwsSdkCall():
    def __init__(self, *, action: str, service: str, api_version: typing.Optional[str]=None, catch_error_pattern: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Any=None, physical_resource_id: typing.Optional["PhysicalResourceId"]=None, region: typing.Optional[str]=None):
        """An AWS SDK call.
...
__all__ = ["AwsCustomResource", "AwsCustomResourceProps", "AwsSdkCall", "PhysicalResourceId", "Provider", "ProviderProps", "__jsii_assembly__"]
