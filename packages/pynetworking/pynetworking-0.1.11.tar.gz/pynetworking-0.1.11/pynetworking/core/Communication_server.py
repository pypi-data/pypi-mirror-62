...
from pynetworking.core.Communication_general import Communicator, Connector, SocketAddress, Functions, to_server_id
...
class ClientCommunicator(Connector):
    ...
    def __init__(self, id_: int, address: SocketAddress, connection: socket.socket, on_close):
        ...
        if pynetworking.core.Communication_general.ENCRYPTED_COMMUNICATION:
            exchange_keys(self)
