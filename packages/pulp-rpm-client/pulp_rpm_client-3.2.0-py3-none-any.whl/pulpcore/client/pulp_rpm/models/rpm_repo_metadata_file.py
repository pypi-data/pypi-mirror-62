...
class RpmRepoMetadataFile(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, artifact=None, data_type=None, checksum_type=None, checksum=None, local_vars_configuration=None):  # noqa: E501
