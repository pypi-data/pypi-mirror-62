...
class Model:
    def __init__(self,
        ...
        self.agent = Agent(state_size = window_size, 
...
class Agent:
    ...
    def __init__(self, state_size, window_size, trend, skip):
        ...
        self.model = QModel(self.state_size, self.OUTPUT_SIZE, self.LAYER_SIZE, self.LEARNING_RATE)
        self.model_negative = QModel(self.state_size, self.OUTPUT_SIZE, self.LAYER_SIZE, self.LEARNING_RATE)
    ...
    def run_sequence(self, initial_money):
...
def predict(model, sess, dftest, params={}):
    ...
    model.agent.trend = dftest
    res = model.agent.run_sequence(model.initial_reward ) #TODO needs an example function to work
    return res
...
def test(filename= '../dataset/GOOG-year.csv'):
    ...
    ###  Train
    model = Model( window_size, close, skip, 200, initial_money)
