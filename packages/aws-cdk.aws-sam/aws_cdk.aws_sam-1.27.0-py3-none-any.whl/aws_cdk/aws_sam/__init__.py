...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sam", "1.27.0", __name__, "aws-sam@1.27.0.jsii.tgz")
...
class CfnApi(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sam.CfnApi"):
    ...
    class CorsConfigurationProperty():
        def __init__(self, *, allow_origin: str, allow_credentials: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, allow_headers: typing.Optional[str]=None, allow_methods: typing.Optional[str]=None, max_age: typing.Optional[str]=None):
            """
...
class CfnFunction(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sam.CfnFunction"):
    ...
    class S3KeyFilterProperty():
        def __init__(self, *, rules: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnFunction.S3KeyFilterRuleProperty"]]]):
            """
    ...
    class S3NotificationFilterProperty():
        def __init__(self, *, s3_key: typing.Union[aws_cdk.core.IResolvable, "CfnFunction.S3KeyFilterProperty"]):
            """
