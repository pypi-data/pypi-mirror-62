...
template <typename CxxBase>
struct Pyfrc__PIDCommand : PyBasefrc__PIDCommand<CxxBase> {
    using PyBasefrc__PIDCommand<CxxBase>::PyBasefrc__PIDCommand;
...
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,double, CxxBase, "returnPIDInput", ReturnPIDInput,);    }
#endif

#ifndef RPYGEN_DISABLE_UsePIDOutput_d
    void UsePIDOutput(double output) override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,void, CxxBase, "usePIDOutput", UsePIDOutput,output);    }
#endif
