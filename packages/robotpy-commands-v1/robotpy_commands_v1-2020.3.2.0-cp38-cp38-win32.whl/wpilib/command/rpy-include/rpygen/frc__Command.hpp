...
template <typename CxxBase>
struct Pyfrc__Command : PyBasefrc__Command<CxxBase> {
    using PyBasefrc__Command<CxxBase>::PyBasefrc__Command;
...
RPYBUILD_OVERLOAD_PURE_NAME(Command,bool, CxxBase, "isFinished", IsFinished,);    }
#endif
...
PYBIND11_OVERLOAD_NAME(void, CxxBase, "_cancel", _Cancel,);    }
#endif
  ...
  #endif
#endif
#ifndef RPYBLD_DISABLE_AssertUnlocked_KRTstd__string
  ...
  #endif
#endif
#ifndef RPYBLD_DISABLE_SetParent_PTfrc__CommandGroup
