...
template <typename CxxBase>
struct Pyfrc__PIDSubsystem : PyBasefrc__PIDSubsystem<CxxBase> {
    using PyBasefrc__PIDSubsystem<CxxBase>::PyBasefrc__PIDSubsystem;
...
PYBIND11_OVERLOAD_NAME(void, CxxBase, "setAbsoluteTolerance", SetAbsoluteTolerance,absValue);    }
#endif

#ifndef RPYGEN_DISABLE_SetPercentTolerance_d
    void SetPercentTolerance(double percent) override {
PYBIND11_OVERLOAD_NAME(void, CxxBase, "setPercentTolerance", SetPercentTolerance,percent);    }
#endif

#ifndef RPYGEN_DISABLE_KOnTarget_v
    bool OnTarget() const override {
PYBIND11_OVERLOAD_NAME(bool, CxxBase, "onTarget", OnTarget,);    }
#endif

#ifndef RPYGEN_DISABLE_ReturnPIDInput_v
    double ReturnPIDInput() override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDSubsystem,double, CxxBase, "returnPIDInput", ReturnPIDInput,);    }
#endif

#ifndef RPYGEN_DISABLE_UsePIDOutput_d
    void UsePIDOutput(double output) override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDSubsystem,void, CxxBase, "usePIDOutput", UsePIDOutput,output);    }
#endif
