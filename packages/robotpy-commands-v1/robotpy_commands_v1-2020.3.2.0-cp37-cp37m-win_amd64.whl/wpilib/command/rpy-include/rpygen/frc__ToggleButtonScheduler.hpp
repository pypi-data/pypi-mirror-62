...
template <typename CxxBase>
struct Pyfrc__ToggleButtonScheduler : PyBasefrc__ToggleButtonScheduler<CxxBase> {
    using PyBasefrc__ToggleButtonScheduler<CxxBase>::PyBasefrc__ToggleButtonScheduler;
