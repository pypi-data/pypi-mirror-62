...
class PythonPackage:
    ...
    project = None
    """attribute PythonPackage.project (string): name of project package under 'src'."""

    version = None
    """attribute PythonPackage.version (string): The project's version"""
    ...
    def _get_version(self):
        ...
        try:
            ...
            if not self._package_fallback:
                raise
            version_from_current_package = require(self.project)[0].version
