...
class CheckedCall:
    ...
    stdout = None
    """attribute CheckedCall.stdout (string): command's standard output"""

    stderr = None
    """attribute CheckedCall.stderr (string): command's standard error"""

    success = False
    """attribute CheckedCall.success (bool): True if exit-code was 0, False otherwise"""
