...
class Workspace(Resource):
    ...
    def __init__(self, location=None, tags=None, description=None, friendly_name=None,
                 ...
                 application_insights=None, cmk_keyvault=None, resource_cmk_uri=None, hbi_workspace=False,
                 identity_tenant_id=None, identity_principal_id=None, identity_type=None, sku='Basic',
                 image_build_compute=None, service_provisioned_resource_group=None):
