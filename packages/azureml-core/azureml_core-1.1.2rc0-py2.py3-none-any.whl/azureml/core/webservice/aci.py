...
class AciWebservice(Webservice):
    ...
    :vartype container_resource_requirements: azureml.core.webservice.ContainerResourceRequirements
    ...
    :var azureml.core.webserivce.AciWebservice.scoring_uri: The scoring endpoint for the Webservice
    ...
    :var azureml.core.webserivce.AciWebservice.models: A list of Models deployed to the Webservice
    :vartype models: builtin.list[azureml.core.Model]
    :var azureml.core.webserivce.AciWebservice.swagger_uri: The swagger endpoint for the Webservice
...
class ContainerResourceRequirements(object):
    ...
    Specify AciServiceDeploymentConfiguration values using the ``deploy_configuration`` method of the
