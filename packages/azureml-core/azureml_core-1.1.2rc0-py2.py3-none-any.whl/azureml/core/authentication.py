...
class AbstractAuthentication(object):
    ...
    def __init__(self, cloud=None):
        ...
        :type cloud: str
        """
        from azureml._vendor.azure_cli_core.cloud import _Clouds
...
class MsiAuthentication(AbstractAuthentication):
    ...
    identity](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview)
