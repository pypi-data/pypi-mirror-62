...
class Workspace(object):
    ...
    * `Azure Machine Learning
    ...
    def __init__(self, subscription_id, resource_group, workspace_name, auth=None, _location=None,
                 _disable_service_check=False, _workspace_id=None, sku='basic'):
    ...
    def from_config(path=None, auth=None, _logger=None, _file_name=None):
        ...
        return Workspace.get(workspace_name, auth=auth, subscription_id=subscription_id, resource_group=resource_group)
    ...
    def delete(self, delete_dependent_resources=False, no_wait=False):
        ...
        :param delete_dependent_resources: Set delete_dependent_resources=True for deleting
            workspace associated resources, i.e. container registry, storage account, key vault and
    ...
    def get_details(self):
        ...
        .. remarks::
            ...
            * `imageBuildCompute`: The compute target for image build.
            ...
            For more information on these key-value pairs, see :meth:`create`.
    ...
    def compute_targets(self):
        ...
        :return: Dictionary with key as compute target name and value as a azureml.core.ComputeTarget object.
    ...
    def datastores(self):
        ...
        :return: A dictionary where key is a datastore name and value is a :class:`azureml.core.datastore.Datastore`
            object.
    ...
    def datasets(self):
        ...
        :return: A dictionary where key is a dataset name and value is a :class:`azureml.core.dataset.Dataset`
            object.
    ...
    def experiments(self):
        ...
        :return: Dictionary with key as experiment name and value as an azureml.core.Experiment object.
    ...
    def environments(self):
        ...
        :return: Dictionary with key as environment name and value as the azureml.core.Environment object.
    ...
    def images(self):
        ...
        :return: A dictionary where key is an image name and value is an :class:`azureml.core.image.Image` object.
    ...
    def _get_or_create(name, auth=None, subscription_id=None, resource_group=None,
                       location=None, sku='basic', friendly_name=None, storage_account=None, key_vault=None,
    ...
    def _create_legacy(auth, subscription_id, resource_group_name, workspace_name,
        ...
        workspace_object = Workspace(subscription_id, resource_group_name, workspace_name,
                                     auth=auth, _disable_service_check=True, _location=location, sku=sku)
    ...
    def update(self, friendly_name=None, description=None, tags=None, image_build_compute=None):
        """Update friendly name, description, tags or image build compute associated to a workspace.
        ...
        workspace_autorest = _commands.update_workspace(self._auth, self._resource_group,
                                                        ...
                                                        tags=tags, image_build_compute=image_build_compute)
    ...
    def setup():
        ...
        """
        # Load the workspace
        module_logger.warning("setup() is now deprecated. Instead, please use create() to create a new workspace, "
            ...
            try:
                ...
                if choice == "1":
                    ...
                    ws = Workspace.create(name=ws_parameters.workspace_name,
                                          ...
                                          create_resource_group=True, sku='basic')
                    ws.write_config()
