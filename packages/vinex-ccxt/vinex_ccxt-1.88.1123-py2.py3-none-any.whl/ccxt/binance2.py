...
class binance2(Exchange):
    ...
    def fetch_markets(self, params={}):
        ...
        if type == 'spot':
            ...
            is_margin = True
            marketType = 'margin'
            method = 'publicGetExchangeInfo'            # margin use market data like spot
            method_margin = 'sapiGetMarginAllPairs'
        elif type == 'futures':
            is_future = True
            marketType = 'future'
        ...
        # Filter markets in margin
        if is_margin:
            response = getattr(self, method_margin)(query)
            market_ids = set([t['symbol'] for t in response])

            result_filtered = [t for t in result if t['id'] in market_ids]
    ...
    def fetch_balance(self, params={}):
        ...
        # {
        #     'borrowEnabled': True,
        #     'marginLevel': '1.46046732',
        #     'totalAssetOfBtc': '2.03041186',
        #     'totalLiabilityOfBtc': '1.39024806',
        #     'totalNetAssetOfBtc': '0.64016380',
        #     'tradeEnabled': True,
        ...
        #     }, {
        #         'asset': 'USDT',
        #         'borrowed': '12745.24427193',
        #         'free': '0.13364993',
        #         'interest': '0.95589336',
        #         'locked': '0.00000000',
        #         'netAsset': '-12746.06651536'
        #     }]
        # }
        ...
        if type == 'spot':
            ...
            balances = self.safe_value(response, 'userAssets', [])
            for i in range(0, len(balances)):
                balance = balances[i]
                currencyId = self.safe_string(balance, 'asset')
                code = self.safe_currency_code(currencyId)
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        # Margin:
        # [{
        #     'clientOrderId': 'and_ceb9331a4c9e477cbe684b477003bbe2',
        #     'cummulativeQuoteQty': '551.15959400',
        #     'executedQty': '2.20270000',
