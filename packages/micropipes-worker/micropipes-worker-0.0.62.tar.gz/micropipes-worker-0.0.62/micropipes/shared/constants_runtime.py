...
MQ_RUNTIME_STATS_DETAILED_ADD = 'runtime.stats_detailed.add'
MQ_RUNTIME_STATS_DETAILED_CUSTOMER_ADD = 'runtime.stats_detailed.customer.add'

MQ_RUNTIME_BINDINGS = [MQ_RUNTIME_LOGS_ADD, MQ_RUNTIME_STATS_ADD, MQ_RUNTIME_STATS_CUSTOMER_ADD]
MQ_RUNTIME_BINDINGS_VMETRICS = [MQ_RUNTIME_STATS_ADD, MQ_RUNTIME_STATS_CUSTOMER_ADD, MQ_RUNTIME_STATS_DETAILED_ADD, MQ_RUNTIME_STATS_DETAILED_CUSTOMER_ADD]
